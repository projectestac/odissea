 ...
 * Generalitat de Catalunya (https://github.com/projectestac/agora)
 *
 * @copyright  2012 Generalitat de Catalunya
...
if ($confirm and confirm_sesskey()) {
    ...
    foreach ($rs as $user) {
        ...
        if (!is_siteadmin($user) and $USER->id != $user->id and $DB->update_record('user', $user)) {
            ...
            $OUTPUT->notification(get_string('capitalizenot', 'local_agora', fullname($user, true)), 'notifysuccess');
        }
    }
    $rs->close();
