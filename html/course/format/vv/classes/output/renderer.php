 ...
 *
 * @package format_vv
 * @copyright 2024 Vicens Vives
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace format_vv\output;

use format_topics\output\renderer as section_renderer;
use moodle_page;

/**
 * Basic renderer for Vicens Vives format.
 *
 * @copyright 2024 Vicens Vives
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class renderer extends section_renderer {
    ...
    public function section_title($section, $course) {
        return $this->render(course_get_format($course)
            ->inplace_editable_render_section_name($section, false, false));
    }
