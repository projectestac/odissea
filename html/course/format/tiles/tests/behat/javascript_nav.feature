...
Feature: Interface can be enhabced with JS nav if allowed by site admin
  ...
  Scenario: Open section 1 then close and open section 2 with JS as student
    ...
    And I should not see "Test chat name s2" in the "#format-tiles-multi-section-page" "css_element"
    ...
    And I wait until the page is ready
    And I should not see "Test book name s1" in the "#format-tiles-multi-section-page" "css_element"
    And I should see "Test chat name s2" in the "#format-tiles-multi-section-page" "css_element"
  ...
  Scenario: Open section 1 then close and open section 2 without JS as student
    ...
    And I wait until the page is ready
    And I should see "Test book name s1"
    And I should not see "Test chat name s2" in the "#single_section_tiles" "css_element"
    ...
    And I should see "Test chat name s2" in the "#single_section_tiles" "css_element"

    And I am on "Course 1" course homepage
    And I click on tile "3"
    And I wait until the page is ready
    And I should not see "Test chat name s2" in the "#single_section_tiles" "css_element"
    And I should not see "Test choice name hidden" in the "#single_section_tiles" "css_element"
