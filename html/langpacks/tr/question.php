...
$string['copy'] = 'Buradan {$a} kopyala ve bağlantıları değiştir.';
...
$string['donothing'] = 'Dosyaları kopyalamayın/taşımayın ya da bağlantıları değiştirmeyin.';
...
$string['ignorebroken'] = 'Kırık bağlantıları yok say';
...
$string['noprobs'] = 'Soru veritabanında hiçbir sorun bulunamadı.';
