...
$string['browsemodewithname'] = 'Önizleme modu: {$a}';
...
$string['privacy:metadata:scoes_track:value'] = 'Verilen ögenin değeri';
...
$string['privacy:metadata:timemodified'] = 'İzlenen ögenin en son değiştirildiği saat';
...
$string['title'] = 'Başlık';
$string['toc'] = 'TOC';
$string['toggletableofcontents'] = 'İçindekiler tablosunu aç/kapat';
