...
$string['backup_shortnamehelp'] = 'Kurs adı yedekleme dosya adının içinde geçsin.';
...
Bu yanlışlıkla silinen ve geri alması çok zor olan dolaşım ve ayarlar gibi blokları korumak için tasarlanmıştır.';
...
$string['cacheapplicationhelp'] = 'Önbelleğe alınmış ögeler belirli bir zaman sürecinde tüm kullanıcılar arasında paylaşılır.';
...
$string['configcourserequestnotify2'] = 'Bir kurs istendiğinde bilgilendirilecek kullanıcılar. Yalnızca kurs listelerini onaylayabilecek kullanıcılar burada listelenmiştir.';
...
$string['configcustommenuitems'] = 'urada özel bir menü yapılandırılabilir. Her bir menü ögesini yeni bir satıra şu formatla girin: menü metni, bağlantı URL\'si (isteğe bağlı), araç ipucu başlığı (isteğe bağlı) ve dil kodu (isteğe bağlı). Ögeler dikey çizgi (|) karakteriyle ayrılmalıdır. Tire (-) ile başlayan satırlar bir önceki üst menünün alt ögesi olarak görünür, üç kare (###) ise ayırıcı çizgi oluşturur. Örneğin:
<pre>
Kurslar
-Tüm kurslar|/course/
-Kurs arama|/course/search.php
-###\\n-SSS|https://example.org/faq\\n-Mobil uygulama|https://example.org/app|Uygulamamızı indirin</pre>';
...
$string['configdefaultuserroleid'] = 'Giriş yapan tüm kullanıcılara site seviyesinde  burada belirttiğiniz rolün yetkileri verilecektir. EK olarak, her bir kullanıcıya istediğiniz rol verilebilir. Varsayılan rol Kimliği doğrulanmış kullancı rolüdür. Bu, başka rolleri olan kullanıcılarla karışıklığa sebep olmaz, tüm kullanıcıların site seviyesinde faydalı bir şey yapabilmesini garanti eder (forum iletilerini okuma, kaynaklara bakma gibi).';
...
$string['configdndallowtextandlinks'] = 'Kurs sayfasında metin ve bağlantılar için sürükle bırakı etkinleştirin veya kapatın. Firefox içinde veya farklı tarayıcılar arasında metin sürüklemenin güvenilmez olduğunu unutmayın; hiç bir veri yüklenmemesi ya da bozuk metin yüklemesi ile sonuçlanabilir.';
...
$string['configfiltermatchonepertext'] = 'Otomatik bağlama filtreleri, sayfadaki her bir metin ögesinde bulunan ilk eşleşen metin örneği için yalnızca tek bir bağlantı oluşturur. Diğerleri görmezden gelinir. "Her sayfada bir kez filtre eşleşmesi" etkinleştirildiğinde bu ayarın hiçbir etkisi yoktur.';
...
$string['configfrontpagecourselimit'] = 'Maksimum kurs sayısı';
...
$string['configgradeexport'] = 'Notları dışa vermede not defteri dışa verim biçimlerinden hangilerinin birincil metod olacağına karar verin. Böylece, seçili takma programlar ayarlanır ve her not için \'en son dışa verilmiş\' alanı kullanır. Örneğin, bu dışa verilmiş kayıtların "yeni" ya da "güncellenmiş" olarak tanımlanmasıyla sonuçlanır. Bundan emin değilseniz hiçbir şeyi seçmeden bırakın.';
...
$string['configidnumber'] = 'Şunları seçebilirsiniz: (a) Kullanıcılara hiçbir zaman ID no sorulmaz, (b) Kullanıcılara ID no sorulur ve bunu boş bırakmasına izin verilir, (c) Kullanıcılara ID no sorulur ama bunu boş bırakamaz. Belirtilirse Kullanıcının ID Numarası profilinde gösterilir.';
...
$string['configproxybypass'] = 'Vekil sunucu kullanmaması gereken (kısmi) internet adreslerinin ya da IP\'lerin virgül ile ayrılmış listesi.Bir virgülle ayrı ögeler ve boşluk yok, örneğin 192.168.0.0/16,*.mydomain.com.';
...
$string['configrecaptchapublickey'] = 'Kayıt ve site destek formunda reCAPTCHA gesini görüntülemek için kullanılan karakter dizesi (site anahtarı). ReCAPTCHA anahtarları <a target="_blank" href="https://www.google.com/recaptcha"> Google reCAPTCHA </a> \'dan edinilebilir.';
...
$string['customusermenuitems'] = 'Kullanıcı menü ögeleri';
...
$string['debugnone'] = 'Hiç : Hiçbir hata ya da uyarıyı gösterme';
...
$string['oauthrefreshtokenexpired'] = 'Sitenizdeki {$a->siteurl} OAuth 2 hizmeti {$a->issuer} için yenileme jetonunun süresi dolmuştur. Bu durum, bu hizmeti kullanan tüm eklentilerin işlevselliğini sınırlayacaktır. Sorunu gidermek için OAuth 2 Hizmetleri yapılandırma sayfasına gidin ve bu hizmetin tablo satırındaki "Sistem hesabını bağla" simgesine tıklayın. Her seferinde OAuth 2 sistemi için aynı hizmet hesabını kullanarak oturum açtığınızdan emin olun.';
...
$string['upgradeforumread'] = 'Moodle 1.5 sürümünde forum iletilerin izleme özelliği eklendi.<br/> Bu işlevselliği kullanmak için <a href="{$a}">tablolarınızı güncellemeniz gerekiyor</a>.';
$string['upgradeforumreadinfo'] = 'Moodle 1.5\'e forum iletilerini okundu/okunmadı olarak izlemek için yeni bir özellik eklendi. Bu işlevselliği kullanabilmek için mevcut tüm mesajlardaki izleme bilgilerini güncellemeniz gerekiyor. Sitenizin büyüklüğüne göre bu işlem biraz uzun (saatlerce) sürebilir ve veritabanını bayağı yorabilir; Bu yüzden, sakin bir zamanda bu işlemi gerçekleştirmeniz en iyisidir. Ancak, güncelleme sırasında siteniz işlevselliğine devam edecek ve kullanıcılar bundan etkilenmeyecektir. Bu işlemi başlattığınızda bitmesine izin verin (tarayıcınız penceresini sürekli açık bırakın). Pencereyi kapatarak işleme son verdiğinizde kaygılanmanıza gerek yok; çünkü tekrar baştan başlayabilirsiniz..<br/><br/>Güncelleme işlemini şimdi başlatmak istiyor musunuz?';
