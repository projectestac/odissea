...
$string['addbadge_help'] = 'Bu rozet gereksinimine eklenmesi gereken tüm rozetleri seçin. Birden çok öge seçmek için CTRL tuşunu basılı tutun.';
$string['addbadgecriteria'] = 'Rozet ölçütü ekle';
$string['addcohort'] = 'Topluluk ekle';
$string['addcohort_help'] = 'Bu rozet gereksinimine eklenmesi gereken tüm topluluk seçin. Birden çok öge seçmek için CTRL tuşunu basılı tutun.';
$string['addcompetency'] = 'Yetkinlik ekle';
$string['addcompetency_help'] = 'Bu rozet gereksinimine eklenmesi gereken tüm yetkinlikleri seçin. Birden çok öge seçmek için CTRL tuşunu basılı tutun.';
$string['addcourse'] = 'Kurs ekle';
$string['addcourse_help'] = 'Bu rozet gerekliliğine eklenmesi gereken tüm kursları seçin. Birden fazla öge seçmek için CTRL tuşunu basılı tutun.';
...
$string['badgesnavigation'] = 'Rozet gezintisi';
...
$string['canvascredentialsprovider'] = 'Canvas Kimlik Bilgileri';
$string['canvasregions'] = 'Canvas Kimlik Bilgileri bölgeleri';
$string['canvasregions_desc'] = 'Canvas Kimlik Bilgileri bölgelerinin içeriğini yapılandırabilirsiniz. Her satır boru karakterleriyle ayrılmıştır ve 1) bölge adı, 2) sırt çantası URL\'si ve 3) sırt çantası API URL\'sinden oluşur.';
...
$string['error:cannotsendtobackpack'] = '<strong>Rozet, dijital portföyünüze eklenemedi</strong><br />
Rozet sağlayıcınız şu mesajı gönderiyor: \'{$a}\'.<br /><br />
Rozeti indirip el ile portföyünüze eklemeyi deneyebilir ya da daha sonra tekrar deneyebilirsiniz.';
...
$string['includeauthdetails'] = 'Rozet sağlayıcı hesabına bağlan';
$string['includeauthdetails_desc'] = 'Rozet verici kimlik bilgilerinizi girerek dijital cüzdan sağlayıcınıza bağlanın.';
$string['includeauthdetails_help'] = 'Bu dijital cüzdana dışa aktarılan her rozetle birlikte verici kimlik bilgilerinizi gönderir.';
$string['includeauthdetailscanvas'] = 'Bir Canvas Yetkinlik Belgesi veren hesaba bağlan';
$string['includeauthdetailscanvas_desc'] = 'Canvas Kimlik Bilgilerinizi girerek kartınızı düzenleyen kuruluşun hesabını bağlayın.';
$string['includeauthdetailscanvas_help'] = 'Canvas Credentials\'a aktarılan rozetlerde, rozetleri veren kurum olarak kuruluşunuz gösterilir. Bu sayede rozetleri alan kişileri takip edebilir ve güncellemeleri yönetebilirsiniz.';
$string['includeauthdetailscanvas_subtitle'] = '(Canvas Credentials ücretli planı gerektirir)';
...
$string['namewithimagelink'] = 'Resimli ve bağlantılı isim';
...
$string['wrongrole'] = 'Kullanmak istediğiniz rol size atanmamıştır.';
$string['year'] = 'Yıl';
