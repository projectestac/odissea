...
$string['gradualreindex_confirm'] = '{$a} ögesini yeniden indekslemek istediğinizden emin misiniz? Bu işlem biraz zaman alabilir, ancak mevcut veriler yeniden indeksleme sırasında kullanılabilir durumda kalacaktır.';
...
$string['performsearch'] = 'Arama yap';
...
$string['queueheading'] = 'Ek indeksleme kuyruğu ({$a} öge)';
...
$string['sitewidesearch'] = 'Site genelinde arama';
