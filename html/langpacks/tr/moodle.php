...
$string['adminhelpassignadmins'] = 'Yöneticiler istedikleri her şeyi yapabilir ve site içerisinde her yere gidebilirler';
...
$string['deletecheckfull'] = 'Kullanıcı {$a} \'yı, profil ayrıntıları, kayıtlar, grup ve kohort üyeliği ve bazı kullanıcı etkinlik verileri gibi veriler dahil olmak üzere silmek istediğinizden emin misiniz?';
...
$string['forcepasswordchange_help'] = 'İşaretlendiğinde, kullanıcı bir sonraki oturum açışında şifresini değiştirmesi istenir.';
...
$string['insertcontentsection'] = '\'{$a->sectionname}\' bölümüne içerik ekle';
...
$string['loginrequired'] = 'Giriş gerekli';
...
Arama kutusuna hiçbirşey yazmadan ara butonuna tıklarsanız,  gelişmiş arama seçeneklerine ulaşırsınız.';
