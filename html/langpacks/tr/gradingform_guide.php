...
$string['confirmdeletecriterion'] = 'Bu ögeyi silmek istediğinizden emin misiniz?';
...
$string['regrademessage1'] = 'Şimdiye kadar puanlama kullanılan bir değerledirme kılavuzu değişiklikleri kaydetmek üzeresiniz. Mevcut puanları gözden geçirilmesi gerekip gerekmediğini lütfen belirtiniz. Bunu ayarlarsanız, değerlendirme kılavuzu ögeleri yeniden düzenlenene kadar öğrencilerden gizlenecektir.';
$string['regrademessage5'] = 'Önceden puanlamada kullanılmış bir değerlendirme kılavuzunda  önemli değişiklikler yapmak üzeresiniz. Not defteri değeri değişmeyecek, ancak değerlendirici kılavuzu ögeleri yeniden düzenlenene kadar öğrencilerden gizlenecektir.';
