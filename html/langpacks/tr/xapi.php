...
/**
 * Strings for component 'xapi', language 'tr', version '4.5'.
 *
 * @package     xapi
 * @category    string
...
$string['privacy:xapistate'] = 'xAPI durumu';
$string['xapicleanup'] = 'Depolanan xAPI durumları temizleme';
$string['xapicleanupperiod'] = 'xAPI durumlarını temizle';
$string['xapicleanupperiod_help'] = 'Seçilen dönemde güncellenmeyen depolanmış xAPI\'leri kaldırın';
