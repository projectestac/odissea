...
/**
 * Strings for component 'quiz', language 'tr', version '4.5'.
 *
 * @package     quiz
 * @category    string
...
$string['cannotstartgradesmismatch'] = 'Bu sınavda uygulama yapılamıyor. Sınav {$a->grade} kademeli olarak ayarlanır. Fakat soruların hiçbirinin puan değeri belirtilmemiş. Bu hata sayfadaki \'Sınavı düzen\' den düzeltilebilir.';
$string['cannotstartmissingquestion'] = 'Bu sınavda uygulama yapılamıyor. Sınav tanımı, var olmayan bir soru içeriyor.';
$string['cannotstartnoquestions'] = 'Bu sınavda uygulama yapılamaz.  Bu sınav henüz yapılandırılmadı. Hiçbir soru eklenmedi';
...
$string['closebeforeopen'] = 'Kapanış tarihi, açılış tarihinden sonra olmalıdır.';
...
$string['eventquizgradeitemcreated'] = 'Sınav not ögesi oluşturuldu';
$string['eventquizgradeitemdeleted'] = 'Sınav not ögesi silindi';
$string['eventquizgradeitemorderchanged'] = 'Sınav notu öğe sırası değişti';
$string['eventquizgradeitemupdated'] = 'Sınav notu öğe güncellendi';
...
$string['eventslotgradeitemupdated'] = 'Yuva not öğesi güncellendi';
...
$string['eventslotversionupdated'] = 'Slot sürümü güncellendi';
...
$string['gradeitemdefaultname'] = 'Yeni sınıf öğesi {$a}';
$string['gradeitemdelete'] = 'Yeni Not Öğesi {$a}';
$string['gradeitemedit'] = 'Not öğesinin adını düzenle {$a}';
$string['gradeitemmarkscheme'] = 'Not öğeleri atama';
$string['gradeitemnewname'] = '{$a} not öğesi için yeni ad';
$string['gradeitemnoneselected'] = '[hiçbiri]';
$string['gradeitemnoslots'] = 'Bu testte henüz soru yok. Lütfen önce soruları ekleyin, ardından not öğelerini ayarlamak için buraya dönün.';
$string['gradeitems'] = 'Not ögeleri';
$string['gradeitemsautosetup'] = 'Her bölüm için bir not ayarlayın';
$string['gradeitemsetup'] = 'Not öğeleri kurulumu';
$string['gradeitemsnoneyet'] = 'Sınav içinde not öğeleri oluşturun. Not sonuçlarını farklı alanlara ayırmak için bu not öğelerine sorular veya sınav bölümleri ayarlayın.';
$string['gradeitemsremoveall'] = 'Kurulumu sıfırla';
$string['gradeitemsremoveallconfirm'] = 'Not ögeleri kurulumu sıfırlansın mı?';
$string['gradeitemsremoveallmessage'] = 'Bu işlem tüm not öğelerini silecek ve bunlardan soru ve bölüm ayarlamalarını kaldıracaktır.<br><br>Bu işlem soru ve bölümlerin kendilerini veya sınıv içindeki mevcut denemeleri etkilemeyecektir.';
$string['gradeitemsremovealltitle'] = 'Not ögeleri kurumunu sıfırla';
...
$string['lastautosave'] = 'Son kaydedilen: {$a}';
$string['layout'] = 'Düzen';
...
$string['messageprovider:quiz_open_soon'] = 'Sınav yakında açılıyor';
$string['messageprovider:submission'] = 'Öğrencilerinizin sınav gönderi bildirimleri';
$string['min'] = 'Minimum';
$string['minutes'] = 'Dakika';
$string['missingcategory'] = 'Eksik soru kategorisi';
...
$string['nodataset'] = 'hiçbir şey - bu bir joker karakter değil';
...
$string['openclosedatesupdated'] = 'Başlama ve bitiş tarihleri';
...
$string['overridecannotchange'] = 'Geçersiz kılma oluşturulduktan sonra kullanıcı veya grup değiştirilemez.';
$string['overridecannotsetbothgroupanduser'] = 'Hem grup hem de kullanıcı aynı anda ayarlanamaz.';
...
$string['overrideinvalidattempts'] = 'Deneme sayısı değeri sıfırdan büyük olmalıdır.';
$string['overrideinvalidexistingid'] = 'Herhangi bir geçersiz kılma mevcut değil.';
$string['overrideinvalidgroup'] = 'Verilen grup mevcut değil.';
$string['overrideinvalidquiz'] = 'Sınav kimlik seti mevcut değil.';
$string['overrideinvalidtimelimit'] = 'Zaman sınırı sıfırdan büyük olmalıdır.';
$string['overrideinvaliduser'] = 'Belirtilen kullanıcı mevcut değil';
$string['overridemissingdelete'] = '{$a} kimliklerini geçersiz kıl, mevcut olmadıkları veya verilen sınavın bir parçası olmadıkları için silinemedi';
$string['overridemultiplerecordsexist'] = 'Aynı kullanıcı/grup için birden fazla geçersiz kılma işlemi uygulanamaz';
$string['overridemustsetuserorgroup'] = 'Bir kullanıcı veya grup ayarlanmalıdır';
...
$string['quizopendatesoonhtml'] = '<p>Merhaba {$a->firstname}, </p>
 <p>{$a->coursename} kursundaki <strong>{$a->quizname}</strong> sınavı yakında başlıyor.
 <p><strong>Açılış: {$a->timeopen}</strong></p>
 <p><strong>Kapanış: {$a->timeclose}</strong></p>
 <p><a href="{$a->url}">Sınava git</a></p>';
$string['quizopendatesoonsubject'] = 'Açılış tarihi {$a->timeopen}: {$a->quizname}';
...
$string['quizsetupnavigation'] = 'Sınav kurulum gezintisi';
...
$string['remove'] = 'Sil';
$string['removeallgroupoverrides'] = 'Tüm kullanıcı geçersiz kılmalaı';
$string['removeallquizattempts'] = 'Bütün sınav denemeleri';
...
$string['savemanualgradingfailed'] = 'Değişiklik kaydedilmedi. Lütfen aşağıdaki mesajı kontrol edin ve tekrar deneyin.';
...
$string['sendnotificationopendatesoon'] = 'Kullanıcıyı yaklaşan sınav açılış tarihi hakkında bilgilendirin';
...
$string['summaryofattempts'] = 'Demeleriniz';
$string['summaryofattemptscaption'] = 'Deneme {$a} özeti';
