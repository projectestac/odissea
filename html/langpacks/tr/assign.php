...
$string['attemptreopenmethod_automatic_help'] = 'Her deneme sonrasında, değerlendirme işleminin tamamlanmasının ardından bir sonraki deneme otomatik olarak erişime açılır.';
$string['attemptreopenmethod_help'] = 'Bu ayar, öğrencilere bu ödev için kaç deneme hakkı verileceğini kontrol eder. Her deneme için not ve geri bildirim kaydedilir ve öğretmen ve öğrenci tarafından görüntülenebilir. Seçenekler şunlardır:

* Manuel olarak - Her denemeden sonra, Gönderimler sayfası veya Not Veren sayfası aracılığıyla bir sonraki denemeyi onaylayabilirsiniz.
* Otomatik olarak - Her denemeden sonra, bir sonraki deneme notlandırıldıktan sonra otomatik olarak verilir.
* Geçene kadar otomatik olarak - Her denemeden sonra, öğrenci geçer notu alana kadar bir sonraki deneme notlandırıldıktan sonra otomatik olarak verilir.';
...
$string['attemptreopenmethod_untilpass_help'] = 'Her denemeden sonra, değerlendirme tamamlanınca bir sonraki deneme otomatik olarak açılır; bu, öğrenci geçme notuna ulaşana kadar devam eder.';
...
$string['markingworkflow_help'] = 'Etkinleştirilirse, puanlar öğrencilere açıklanmadan önce bir dizi iş akışı aşamasından geçer. Bu, puanların tüm öğrencilere aynı anda duyurulmasını sağlar.';
...
$string['quickgrading_help'] = 'Hızlı notlandırma, doğrudan gönderimler tablosu üzerinden not (ve kazanım) girişi yapmanıza olanak tanır. Hızlı puanlama, gelişmiş puanlamaya uyumlu değildir ve birden çok değerlendirici olduğunda önerilmez.';
...
$string['teamsubmission_help'] = 'u ayar etkinleştirilirse, öğrenciler varsayılan gruplama setine veya özel bir gruplamaya göre gruplara ayrılacaktır. Bir grup teslimatı, grup üyeleri arasında paylaşılacak ve grubun tüm üyeleri, teslimat üzerindeki birbirlerinin değişikliklerini görebilecektir. Not: Halihazırda teslimatlar (veya gönderimler) varsa bu ayarı değiştiremezsiniz.';
