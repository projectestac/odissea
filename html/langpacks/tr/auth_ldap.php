...
$string['auth_ldap_expiration_desc'] = 'Süresi dolmuş parola denetimini devre dışı bırakmak için \'{$a->no}\' ögesini veya parola geçerlilik süresini doğrudan LDAP sunucusundan okumak için \'{$a->ldapserver}\' öğesini seçin.';
