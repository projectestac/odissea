...
/**
 * Strings for component 'portfolio_picasa', language 'tr', version '4.5'.
 *
...
$string['noauthtoken'] = 'Google\'dan yetkilendirme kimliği alınmamış. Lütfen google hesabınızda Moodle sitenize izin verdiğinizden emin olun.';
$string['nooauthcredentials'] = 'OAuth kimlik bilgileri gerekiyor.';
$string['nooauthcredentials_help'] = 'Picasa portföy eklentisini kullanmak için portföy ayarlarında OAuth kimlik bilgilerini yapılandırmalısınız.';
...
$string['secret'] = 'Gizllilik';
$string['sendfailed'] = '{$a} dosyası picasa\'ya aktarılırken hata oluştu';
