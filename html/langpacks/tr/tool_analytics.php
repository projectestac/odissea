...
$string['invalidanalysables'] = 'Geçersiz site ögeleri';
$string['invalidanalysablesinfo'] = 'Bu sayfa, bu tahmin modeli tarafından kullanılamayan analiz edilebilir ögeleri listeler. Listelenen ögeler ne tahmin modelini eğitmek için ne de tahmin modeli onlar için tahminler elde etmek için kullanılamaz.';
$string['invalidanalysablestable'] = 'Geçersiz site analiz edilebilir ögeler tablosu';
...
$string['modelinvalidanalysables'] = '"{$a}" modeli için geçersiz analiz edilebilir ögeler';
...
$string['nodatatopredict'] = 'Tahmin almak için yeni öge yok.';
$string['nodatatotrain'] = 'Eğitim için kullanılabilecek yeni bir veri yok.';
$string['noinvalidanalysables'] = 'Bu site herhangi bir geçersiz analiz edilebilir öge içermiyor.';
