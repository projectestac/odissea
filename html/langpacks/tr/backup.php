...
$string['asyncrestorecompletedetail'] = 'Geri yükleme işlemi başarıyla tamamlandı. Devam\'ı tıklamak sizi <a href="{$a}">geri yüklenen ögeye ilişkin derse</a> götürür.';
...
$string['cannotfindassignablerole'] = 'Yedeklemede {$a} rolü, atamaya sahip olduğunuz hiçbir rol için oluşturulamıyor.';
...
$string['includeditems'] = 'Dahile edilen ögeler:';
...
$string['privacy:metadata:backup_controllers:type'] = 'Üzerinde çalışılan ögenin türü, ör. etkinlik.';
