...
$string['issuersmtpsystememail'] = 'SMTP e-posta';
$string['issuersmtpsystememail_help'] = 'Belirtilirse, bu e-posta SMTP aracılığıyla e-posta göndermek için bir sistem hesabını bağlamak için kullanılacaktır. Bu, bazı OAuth 2 hizmetleri (ör. Microsoft) için gereklidir. Bunun gerekli olup olmadığını görmek için OAuth 2 hizmetinizin belgelerini kontrol edin.';
...
$string['issueruseinsmtpwithoauth'] = 'Yalnızca XOAUTH2 ile SMTP';
