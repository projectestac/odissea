...
/**
 * Strings for component 'repository_url', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['privacy:metadata'] = 'Το πρόσθετο «Λήψη (εικόνων) από διεύθυνση URL» δεν αποθηκεύει ούτε μεταβιβάζει κανένα προσωπικό δεδομένο.';
$string['rename'] = 'Όνομα';
