...
/**
 * Strings for component 'atto_title', language 'el', branch 'MOODLE_38_STABLE'
 *
 * @package   atto_title
...
$string['h3'] = 'Επικεφαλίδα (μεγάλη)';
$string['h4'] = 'Επικεφαλίδα (μεσαία)';
$string['h5'] = 'Επικεφαλίδα (μικρή)';
$string['p'] = 'Παράγραφος';
