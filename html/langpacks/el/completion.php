...
/**
 * Strings for component 'completion', language 'el', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['completionexpectedfor'] = '{$a->instancename} πρέπει να ολοκληρωθεί';
...
$string['showcompletionconditions'] = 'Εμφάνιση συνθηκών ολοκλήρωσης δραστηριότητας';
$string['showcompletionconditions_help'] = 'Οι συνθήκες ολοκλήρωσης δραστηριότητας εμφανίζονται στη λίστα δραστηριοτήτων στη σελίδα του μαθήματος. Αυτή η ρύθμιση καθορίζει εάν οι συνθήκες ολοκλήρωσης δραστηριότητας εμφανίζονται επίσης κάτω από κάθε δραστηριότητα στη σελίδα του μαθήματος.';
$string['showinguser'] = 'Εμφάνιση χρήστη';
$string['studentsmust'] = 'Οι φοιτητές πρέπει να';
$string['todo'] = 'Εκκρεμότητες';
