...
/**
 * Strings for component 'qtype_easyonamejs', language 'el', version '4.5'.
 *
...
$string['autofeedbackdisabled'] = 'Απενεργοποιημένο';
$string['autofeedbackenabled'] = 'Ενεργοποιημένο';
$string['casenotrandom'] = 'Ορισμός δομής';
$string['caserandom'] = 'Δημιουργία τυχαίας δομής';
$string['caseuserandom'] = 'Θέλετε να ορίζετε εσείς τη δομή ή να δημιουργείται μια τυχαία δομή κάθε φορά;';
$string['correct_answer'] = 'Σωστή απάντηση';
$string['correctansweris'] = 'Η σωστή απάντηση είναι: {$a}.';
$string['correctanswers'] = 'Οδηγίες';
$string['implicithall'] = 'όλα';
$string['implicithoff'] = 'Όχι';
