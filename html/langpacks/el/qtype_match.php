...
/**
 * Strings for component 'qtype_match', language 'el', version '4.5'.
 *
 * @package     qtype_match
 * @category    string
...
$string['privacy:metadata'] = 'Το πρόσθετο τύπου ερωτήσεων αντιστοίχισης επιτρέπει στους συγγραφείς ερωτήσεων να ορίζουν προεπιλεγμένες επιλογές ως προτιμήσεις χρήστη.';
