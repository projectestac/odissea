...
/**
 * Strings for component 'block_moderator_guide', language 'el', version '4.4'.
 *
...
$string['addguide'] = 'Προσθήκη οδηγού';
$string['addtemplate'] = 'Προσθήκη υποδείγματος';
$string['author'] = 'Αρχικός συγγραφέας';
$string['cancel'] = 'Άκυρο';
$string['completed'] = 'Ολοκληρώθηκε';
$string['configmoderation'] = 'Συντονισμός';
...
$string['editguide'] = 'Επεξεργασία οδηγού';
$string['edittemplate'] = 'Τροποποίηση υποδείγματος';
$string['guide'] = 'Οδηγός';
$string['guides'] = 'Οδηγοί';
...
$string['moderator_guide:canviewcomplete'] = 'Μπορεί να δει την κατάσταση ολοκλήρωσης';
$string['moderatorcomment'] = 'Σχόλιο συντονιστή';
$string['name'] = 'Όνομα';
$string['noguidesforthiscourse'] = 'Κανένας οδηγός για αυτό το μάθημα.';
$string['organization'] = 'Οργάνωση';
$string['organizations'] = 'Οργανώσεις';
$string['pluginname'] = 'Οδηγός συντονιστή';
$string['previewguide'] = 'Προεπισκόπηση';
