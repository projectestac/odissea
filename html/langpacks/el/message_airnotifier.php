...
/**
 * Strings for component 'message_airnotifier', language 'el', version '4.5'.
 *
...
$string['airnotifierfielderror'] = 'Παρακαλούμε, καταργήστε τυχόν κενά διαστήματα ή περιττούς χαρακτήρες από το ακόλουθο πεδίο: {$a}';
...
$string['checkconfiguration'] = 'Ελέγξτε και δοκιμάστε τις ρυθμίσεις προωθητικής ειδοποίησης';
...
$string['enableprocessor'] = 'Ενεργοποίηση ειδοποιήσεων για κινητά';
...
$string['messageprovidersempty'] = 'Δεν υπάρχουν ενεργοποιημένες ειδοποιήσεις για κινητά στις προεπιλεγμένες προτιμήσεις ειδοποιήσεων.';
...
$string['sendtest'] = 'Αποστολή δοκιμαστικής προωθητικής ειδοποίησης στις συσκευές μου';
$string['sendtestconfirmation'] = 'Θα σταλεί μια δοκιμαστική προωθητική ειδοποίηση στις συσκευές που χρησιμοποιείτε για να συνδεθείτε σε αυτόν τον ιστότοπο. Παρακαλούμε, βεβαιωθείτε ότι οι συσκευές σας είναι συνδεδεμένες στο Διαδίκτυο και ότι η εφαρμογή για κινητά δεν είναι ανοιχτή (καθώς οι προωθητικές ειδοποιήσεις εμφανίζονται μόνο όταν λαμβάνονται στο παρασκήνιο).';
$string['serverconnectivityerror'] = 'Αυτός ο ιστότοπος δεν μπορεί να συνδεθεί στον εξυπηρετητή ειδοποιήσεων {$a}';
...
$string['userdevices'] = 'Συσκευές χρήστη';
