...
/**
 * Strings for component 'assign', language 'el', version '4.5'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduedigesthtml'] = '<p>Γεια σου {$a->firstname},</p>
<p>Οι παρακάτω εργασίες πρέπει να παραδοθούν στις <strong>{$a->duedate}</strong>.</p>
{$a->digest}';
...
$string['attemptreopenmethod'] = 'Χορήγηση προσπαθειών';
$string['attemptreopenmethod_automatic'] = 'Αυτόματα';
$string['attemptreopenmethod_automatic_help'] = 'Μετά από κάθε προσπάθεια, η επόμενη χορηγείται αυτόματα.';
$string['attemptreopenmethod_help'] = 'Αυτή η ρύθμιση ελέγχει τον τρόπο με τον οποίο χορηγούνται προσπάθειες στους μαθητές για αυτή την εργασία. Για κάθε προσπάθεια, ο βαθμός και η ανατροφοδότηση αποθηκεύονται και μπορούν να προβληθούν από τον διδάσκοντα και τον μαθητή. Οι διαθέσιμες επιλογές είναι οι εξής:

* Χειροκίνητα - Μετά από κάθε προσπάθεια, μπορείτε να χορηγήσετε την επόμενη μέσω της σελίδας Υποβολών ή της σελίδας Βαθμολόγησης.
* Αυτόματα - Μετά από κάθε προσπάθεια, η επόμενη χορηγείται αυτόματα.
* Αυτόματα μέχρι να περάσει - Μετά από κάθε προσπάθεια, η επόμενη χορηγείται αυτόματα, έως ότου ο μαθητής επιτύχει τον βαθμό επιτυχίας.';
$string['attemptreopenmethod_manual'] = 'Χειροκίνητα';
$string['attemptreopenmethod_manual_help'] = 'Μετά από κάθε προσπάθεια, μπορείτε να χορηγήσετε την επόμενη μέσω της σελίδας Υποβολών ή της σελίδας Βαθμολόγησης.';
$string['attemptreopenmethod_none'] = 'Ποτέ';
$string['attemptreopenmethod_untilpass'] = 'Αυτόματα μέχρι να επιτύχει';
$string['attemptreopenmethod_untilpass_help'] = 'Μετά από κάθε προσπάθεια, η επόμενη θα χορηγείται αυτόματα, έως ότου ο μαθητής επιτύχει τον βαθμό επιτυχίας.';
...
$string['blindmarkingenabledwarning'] = 'Οι ανώνυμες υποβολές είναι ενεργοποιημένες για αυτήν τη δραστηριότητα. Οι βαθμοί δε θα προστεθούν στο βαθμολόγιο έως ότου αποκαλυφθούν οι ταυτότητες των μαθητών μέσω του μενού ενεργειών βαθμολόγησης.';
...
$string['defaultgradescale'] = 'Κλίμακα βαθμολόγησης';
$string['defaultgradescale_help'] = 'Η προεπιλεγμένη κλίμακα βαθμολόγησης για νέες εργασίες. Μόνο οι βασικές κλίμακες είναι διαθέσιμες.';
$string['defaultgradetype'] = 'Τύπος βαθμού';
$string['defaultgradetype_help'] = 'Ο προεπιλεγμένος τύπος βαθμού για νέες αναθέσεις εργασιών';
...
$string['deleteallsubmissions'] = 'Όλες οι υποβολές';
...
$string['gradeactions'] = 'Ενέργειες βαθμού';
...
$string['maxattempts'] = 'Επιτρεπόμενες προσπάθειες';
...
$string['messageprovider:assign_due_digest'] = 'Ειδοποίηση για εργασία που λήγει σε 7 ημέρες';
$string['messageprovider:assign_due_soon'] = 'Ειδοποίηση για εργασία που λήγει σύντομα';
$string['messageprovider:assign_notification'] = 'Ειδοποιήσεις αναθέσεων';
$string['messageprovider:assign_overdue'] = 'Ειδοποίηση εκπρόθεσμης εργασίας';
...
$string['sendnotificationduedatesoon'] = 'Ειδοποίηση του χρήστη για την επερχόμενη ημερομηνία λήξης της εργασίας';
$string['sendnotificationduedigest'] = 'Ειδοποίηση χρήστη για εργασίες που οφείλονται σε 7 ημέρες';
$string['sendnotificationoverdue'] = 'Ειδοποίηση χρήστη για μια εργασία που είναι εκπρόθεσμη';
...
$string['submissionactions'] = 'Ενέργειες υποβολής';
...
$string['viewgrader'] = 'Προβολή βαθμολογητή';
