...
/**
 * Strings for component 'block_rss_client', language 'el', version '4.1'.
 *
...
$string['addfeed'] = 'Προσθήκη διεύθυνσης URL, τροφοδοσίας RSS:';
...
$string['editafeed'] = 'Επεξεργασία μιας τροφοδοσίας';
$string['editfeeds'] = 'Επεξεργασία, εγγραφή ή απεγγραφή από τροφοδοσίες ειδήσεων RSS/Atom';
...
$string['feeds'] = 'Τροφοδοσίες RSS ειδήσεων';
$string['feedsaddedit'] = 'Προσθήκη/επεξεργασία τροφοδοσιών RSS';
$string['feedsconfigurenewinstance'] = 'Πατήστε εδώ για να ρυθμίσετε αυτό το μπλοκ ώστε να εμφανίζει τροφοδοσίες RSS.';
$string['feedsconfigurenewinstance2'] = 'Κάντε κλικ στο εικονίδιο επεξεργασίας για να διαμορφώσετε αυτό το μπλοκ ώστε να εμφανίζει τροφοδοσίες RSS.';
$string['feedupdated'] = 'Ενημερώθηκε η τροφοδοσία RSS ειδήσεων';
$string['feedurl'] = 'Διεύθυνση URL τροφοδοσίας RSS';
$string['findmorefeeds'] = 'Εύρεση περισσοτέρων τροφοδοσιών RSS';
$string['managefeeds'] = 'Διαχείριση όλων των RSS τροφοδοσιών μου';
$string['nofeeds'] = 'Δεν έχουν οριστεί τροφοδοσίες RSS για αυτή τη σελίδα.';
...
$string['rss_client:createsharedfeeds'] = 'Δημιουργία κοινόχρηστων τροφοδοσιών RSS';
...
$string['timeout'] = 'Χρόνος σε λεπτά πριν μια RSS τροφοδοσία λήξει στην κρυφή μνήμη. Σημειώστε πως αυτός ο χρόνος ορίζει τον ελάχιστο χρόνο πριν την λήξη· η τροφοδοσία θα ανανεωθεί στην κρυφή μνήμη κατά την επόμενη εκτέλεση της εντολής χρονοπρογραμματισμού cron μετά την λήξη. Συνιστώμενες τιμές είναι 30 λεπτά ή μεγαλύτερες.';
