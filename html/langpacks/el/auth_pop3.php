...
/**
 * Strings for component 'auth_pop3', language 'el', version '3.11'.
 *
 * @package     auth_pop3
 * @category    string
...
$string['auth_pop3mailbox_key'] = 'Ταχυδρομικό κουτί';
...
$string['auth_pop3port'] = 'Θύρα εξυπηρετητή (110 είναι η πιο συχνή, 995 είναι η συνηθισμένη για SSL)';
$string['auth_pop3port_key'] = 'Θύρα';
$string['auth_pop3type'] = 'Ο τύπος του εξυπηρετητή. Εάν ο εξυπηρετητής σας χρησιμοποιεί ασφάλεια μέσω πιστοποιητικών, επιλέξτε pop3cert.';
$string['auth_pop3type_key'] = 'Τύπος';
$string['pluginname'] = 'Εξυπηρετητής POP3';
$string['privacy:metadata'] = 'Το πρόσθετο αυθεντικοποίησης εξυπηρετητή POP3 δεν αποθηκεύει κανένα προσωπικό στοιχείο.';
