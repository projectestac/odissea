...
/**
 * Strings for component 'antivirus', language 'el', branch 'MOODLE_38_STABLE'
 *
 * @package   antivirus
...
$string['virusfounduser'] = 'Το αρχείο που ανεβάσατε, {$a->filename}, σαρώθηκε από αντι-ιικό πρόγραμμα και βρέθηκε να περιέχει ιό! Το ανέβασμα του αρχείου σας ΔΕΝ ήταν επιτυχές.';
