...
Αν χρησιμοποιήσετε το «εσωτερικά», <i>πρέπει</i> να παρέχετε μια διεύθυνση ηλε.ταχυδρομείου στο αντίστοιχο πεδίο της εξωτερικής βάσης δεδομένων και πρέπει να εκτελείτε το admin/cron.php καθώς και το auth/db/cli/sync_users.php τακτικά.
Το Moodle θα στείλει ένα μήνυμα ηλε.ταχυδρομείου στους νέους χρήστες με έναν προσωρινό κωδικό πρόσβασης.
</p>';
