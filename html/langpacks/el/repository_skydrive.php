...
/**
 * Strings for component 'repository_skydrive', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['configplugin'] = 'Διαμόρφωση Microsoft OneDrive (κλασικό)';
...
$string['pluginname'] = 'Microsoft OneDrive (κλασικό)';
$string['privacy:metadata'] = 'Το πρόσθετο αποθετηρίου «Microsoft OneDrive (κλασικό)» δεν αποθηκεύει κανένα προσωπικό δεδομένο αλλά μεταβιβάζει δεδομένα χρήστη από το Moodle προς το απομακρυσμένο σύστημα.';
$string['secret'] = 'Μυστικό';
$string['skydrive:view'] = 'Εμφάνιση OneDrive (κλασικό)';
