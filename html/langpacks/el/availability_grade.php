...
/**
 * Strings for component 'availability_grade', language 'el', version '4.4'.
 *
...
$string['error_backwardrange'] = 'Όταν καθορίζεται διάστημα (εύρος) βαθμών, το ελάχιστο όριο πρέπει να είναι χαμηλότερο από το μέγιστο.';
...
$string['requires_max'] = 'Πάρετε ένα κατάλληλο σκορ στο <strong>{$a}</strong>';
$string['requires_min'] = 'Πετύχετε το απαιτούμενο σκορ στο <strong>{$a}</strong>';
$string['requires_notany'] = 'Δεν έχετε βαθμό στο <strong>{$a}</strong>';
$string['requires_notgeneral'] = 'Δεν πάρετε ένα συγκεκριμένο σκορ στο <strong>{$a}</strong>';
$string['requires_range'] = 'Πάρετε ένα συγκεκριμένο σκορ στο <strong>{$a}</strong>';
$string['title'] = 'Βαθμός';
