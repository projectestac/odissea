...
/**
 * Strings for component 'cachestore_mongodb', language 'el', version '4.4'.
 *
...
$string['pleaseupgrademongo'] = 'Χρησιμοποιείτε μια παλιά έκδοση της επέκτασης PHP Mongo (< 1.3). Η υποστήριξη για παλιές εκδόσεις της επέκτασης Mongo θα διακοπεί στο μέλλον. Παρακαλούμε εξετάστε την αναβάθμιση.';
