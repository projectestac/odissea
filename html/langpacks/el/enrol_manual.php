...
/**
 * Strings for component 'enrol_manual', language 'el', version '3.11'.
 *
...
$string['browsecohorts'] = 'Πλοήγηση στα σύνολα χρηστών';
...
$string['sendexpirynotificationstask'] = 'Εργασία αποστολής ειδοποιήσεων λήξης χειροκίνητης εγγραφής';
$string['status'] = 'Ενεργοποίηση χειροκίνητων εγγραφών';
$string['status_desc'] = 'Επιτρέπεται η πρόσβαση στο μάθημα από εσωτερικά εγγεγραμμένους χρήστες. Αυτό θα πρέπει να διατηρείται ενεργοποιημένο στις περισσότερες περιπτώσεις.';
...
$string['wsusercannotassign'] = 'Δεν έχετε το δικαίωμα να αναθέσετε αυτόν τον ρόλο ({$a->roleid}) σε αυτόν τον χρήστη ({$a->userid}) σε αυτό το μάθημα ({$a->courseid}).';
