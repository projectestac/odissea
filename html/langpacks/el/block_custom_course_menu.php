...
$string['nocourses'] = 'Δεν είστε εγγεγραμμένος/-η σε κανένα μάθημα.';
$string['pluginname'] = 'Προσαρμοσμένο μενού μαθήματος';
$string['privacy:metadata'] = 'Το πρόσθετο δεν αποθηκεύει κανένα δεδομένο χρήστη.';
$string['showsearch'] = 'Εμφάνιση αναζήτησης μαθήματος';
