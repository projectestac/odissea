...
/**
 * Strings for component 'auth_imap', language 'el', version '3.11'.
 *
 * @package     auth_imap
 * @category    string
...
$string['auth_imaphost_key'] = 'Host (Κεντρικός Η/Υ)';
...
$string['auth_imaptype_key'] = 'Τύπος';
$string['pluginname'] = 'Χρήση εξυπηρετητή IMAP';
$string['privacy:metadata'] = 'Το πρόσθετο αυθεντικοποίησης εξυπηρετητή IMAP δεν αποθηκεύει κανένα προσωπικό στοιχείο.';
