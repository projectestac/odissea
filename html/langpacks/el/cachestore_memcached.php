...
/**
 * Strings for component 'cachestore_memcached', language 'el', version '3.8'.
 *
...
$string['hash_help'] = 'Καθορίζει τον αλγόριθμο κατατεμαχισμού (hash function) που θα χρησιμοποιηθεί. Κάθε αλγόριθμος έχει τα υπερ και τα κατά. Επιλέξτε τον προεπιλεγμένο αν δεν τα γνωρίζετε ή δεν σας ενδιαφέρουν.';
