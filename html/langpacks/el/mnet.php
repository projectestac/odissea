...
/**
 * Strings for component 'mnet', language 'el', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['authfail_nosessionexists'] = 'Αποτυχία εξουσιοδότησης: η σύνοδος mnet δεν υπάρχει.';
$string['authfail_sessiontimedout'] = 'Αποτυχία εξουσιοδότησης: η σύνοδος mnet έληξε.';
...
$string['error7026'] = 'Το κλειδί με το οποίο υπογράφτηκε το μήνυμα σας διαφέρει από το κλειδί το οποίο έχει ο απομακρυσμένος κεντρικός υπολογιστής έχει σε αρχείο για τον εξυπηρετητή σας. Επιπλέον, ο απομακρυσμένος κεντρικός υπολογιστής προσπάθησε να βρει και να φέρει το τρέχον κλειδί σας και απέτυχε. Παρακαλούμε ανταλλάξτε χειροκίνητα κλειδιά με τον απομακρυσμένο κεντρικό υπολογιστή και δοκιμάστε ξανά.';
...
$string['remoteuserinfo'] = 'Το προφίλ βρέθηκε & ανακτήθηκε από <a href="{$a->remoteurl}">{$a->remotename}</a>';
...
$string['serviceswesubscribeto'] = 'Υπηρεσίες στο {$a} στις οποίες έχουμε δήλωση εγγραφής.';
...
$string['trustedhostsexplain'] = '<p>Ο μηχανισμός των έμπιστων κεντρικών υπολογιστών επιτρέπει σε συγκεκριμένους υπολογιστές να εκτελούν κλήσεις μέσω XML-RPC σε οποιοδήποτε μέρος του Moodle API. Αυτό είναι διαθέσιμο σε σενάρια για να ελέγχουν την συμπεριφορά του Moodle και μπορεί να είναι μια πολύ επικίνδυνη επιλογή αν το ενεργοποιήσετε. Εάν έχετε αμφιβολίες, αφήστε το απενεργοποιημένο.</p>
