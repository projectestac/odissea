...
/**
 * Strings for component 'glossary', language 'el', version '3.8'.
 *
 * @package     glossary
 * @category    string
...
$string['casesensitive_help'] = 'Αυτή η ρύθμιση καθορίζει εάν η διάκριση πεζών και κεφαλαίων γραμμάτων είναι απαραίτητη στην αυτόματη δημιουργία συνδέσμων σε κάθε καταχώρηση γλωσσαρίου.';
$string['cat'] = 'κατηγ.';
...
* Εγκυκλοπαίδεια - Όπως ο «Πλήρης με τον συγγραφέα», αλλά οι συνημμένες εικόνες εμφανίζονται μέσα στην γραμμή (inline).
...
$string['errorparsingxml'] = 'Παρουσιάστηκαν σφάλματα κατά την ανάλυση αυτού του αρχείου. Σιγουρευτείτε ότι η σύνταξή του είναι έγκυρη στην XML.';
...
$string['noentries'] = 'Δε βρέθηκαν καταχωρήσεις σε αυτό το τμήμα';
...
$string['notapproved'] = 'αυτή η καταχώρηση γλωσσαρίου δεν έχει εγγριθεί ακόμη.';
...
$string['privacy:metadata:glossary_entries:timemodified'] = 'Η χρονοσφραγίδα που δείχνει πότε η καταχώρηση γλωσσαρίου τροποποιήθηκε από τον χρήστη';
