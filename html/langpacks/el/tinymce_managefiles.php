...
/**
 * Strings for component 'tinymce_managefiles', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['allfilesok'] = 'Δεν υπάρχουν αρχεία που λείπουν ή δεν χρησιμοποιούνται';
$string['deleteselected'] = 'Διαγραφή επιλεγμένων αρχείων';
$string['hasmissingfiles'] = 'Προειδοποίηση! Τα ακόλουθα αρχεία που αναφέρονται στην περιοχή κειμένου φαίνεται να λείπουν:';
