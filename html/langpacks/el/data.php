...
$string['exportaszip_help'] = 'Η λειτουργία εξαγωγής ως συμπιεσμένο αρχείο (zip) σας επιτρέπει να αποθηκεύσετε τα υποδείγματα και τα πεδία ως μια συμπιεσμένη προρύθμιση έτοιμη προς λήψη. Το (ληφθέν) zip μπορεί κατόπιν να εισαχθεί σε κάποιο άλλο μάθημα.';
...
$string['fromfile_help'] = 'Η λειτουργία εισαγωγής από συμπιεσμένο αρχείο (zip) σας επιτρέπει να περιηγηθείτε προς και να ανεβάσετε μια συμπιεσμένη προρύθμιση από υποδείγματα και πεδία.';
