...
/**
 * Strings for component 'data', language 'el', version '3.8'.
 *
 * @package     data
 * @category    string
...
$string['fromfile_help'] = 'Η λειτουργία εισαγωγής από συμπιεσμένο αρχείο (zip) σας επιτρέπει να περιηγηθείτε προς και να ανεβάσετε ένα πρότυπο zip από φόρμες και πεδία.';
