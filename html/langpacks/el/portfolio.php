...
/**
 * Strings for component 'portfolio', language 'el', branch 'MOODLE_38_STABLE'
 *
 * @package   portfolio
...
$string['err_uniquename'] = 'Το όνομα του χαρτοφυλακίου πρέπει να είναι μοναδικό (ανά πρόσθετο)';
...
$string['highdbsizethresholddesc'] = 'Αριθμός των εγγραφών στη βάση δεδομένων πάνω του οποίου θεωρείται ότι θα χρειαστούν μεγάλο χρονικό διάστημα για την μεταφορά';
$string['highfilesizethreshold'] = 'Μεγάλο μέγεθος αρχείου για μεταφορά';
$string['highfilesizethresholddesc'] = 'Αρχεία με μέγεθος μεγαλύτερο από αυτό το όριο θα θεωρούνται ότι θα χρειαστούν μεγάλο χρονικό διάστημα για μεταφορά';
...
$string['instanceismisconfigured'] = 'Το στιγμιότυπο του χαρτοφυλακίου είναι μη ορθά ρυθμισμένο, οπότε παραλείπεται. Το σφάλμα ήταν: {$a}';
...
$string['pluginismisconfigured'] = 'Το πρόσθετο χαρτοφυλακίου είναι μη ορθά ρυθμισμένο, οπότε παραλείπεται. Το σφάλμα ήταν: {$a}';
...
$string['somepluginsdisabled'] = 'Κάποια πρόσθετα χαρτοφυλακίου έχουν απενεργοποιηθεί εξ ολοκλήρου διότι είτε είναι μη ορθά ρυθμισμένα είτε βασίζονται σε κάτι άλλο το οποίο είναι:';
