...
/**
 * Strings for component 'qtype_calculated', language 'el', version '4.5'.
 *
...
$string['choosedatasetproperties_help'] = 'Ένα σύνολο δεδομένων είναι ένα σύνολο τιμών που εισάγονται στη θέση ενός μπαλαντέρ. Μπορείτε να δημιουργήσετε ένα ιδιωτικό σύνολο δεδομένων για μια συγκεκριμένη ερώτηση ή ένα κοινόχρηστο σύνολο δεδομένων που μπορεί να χρησιμοποιηθεί και για άλλες υπολογιζόμενες ερωτήσεις εντός της κατηγορίας.';
...
$string['editdatasets_link'] = '';
$string['existingcategory1'] = 'θα χρησιμοποιήσει ένα υπάρχον κοινόχρηστο σύνολο δεδομένων';
...
$string['keptcategory1'] = 'θα χρησιμοποιηθεί το ίδιο υπάρχον κοινόχρηστο σύνολο δεδομένων όπως και πριν';
...
$string['newcategory1'] = 'θα χρησιμοποιηθεί ένα νέο κοινόχρηστο σύνολο δεδομένων';
...
$string['nosharedwildcard'] = 'Δεν υπάρχει κοινόχρηστος χαρακτήρας μπαλαντέρ σε αυτήν την κατηγορία';
...
$string['pluginname'] = 'Υπολογιζόμενη';
...
$string['pluginnameadding'] = 'Προσθήκη μιας υπολογιζόμενης ερώτησης';
$string['pluginnameediting'] = 'Τροποποίηση μιας υπολογιζόμενης ερώτησης';
$string['pluginnamesummary'] = 'Οι υπολογιζόμενης ερωτήσεις είναι σαν τις αριθμητικές ερωτήσεις αλλά οι αριθμοί που χρησιμοποιούνται διαλέγονται τυχαία από ένα σύνολο όταν διεξάγεται το κουίζ.';
$string['possiblehdr'] = 'Πιθανοί χαρακτήρες μπαλαντέρ παρουσιάζονται μόνο στο κείμενο της ερώτησης';
$string['privacy:metadata'] = 'Το πρόσθετο τύπου ερώτησης Υπολογιζόμενη δεν αποθηκεύει κανένα προσωπικό δεδομένο.';
...
$string['sharedwildcard'] = 'Κοινόχρηστο μπαλαντέρ {<strong>{$a}</strong>}';
...
$string['synchronize'] = 'Συγχρονίστε τα δεδομένα από κοινόχρηστα σύνολα δεδομένων με άλλες ερωτήσεις σε ένα κουίζ';
$string['synchronizeno'] = 'Χωρίς συγχρονισμό';
$string['synchronizeyes'] = 'Με συγχρονισμό';
$string['synchronizeyesdisplay'] = 'Συγχρονίστε και εμφανίστε το κοινόχρηστο όνομα του συνόλου δεδομένων ως πρόθεμα του ονόματος ερωτήματος';
