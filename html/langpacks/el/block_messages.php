...
/**
 * Strings for component 'block_messages', language 'el', version '3.11'.
 *
...
$string['privacy:metadata'] = 'Το μπλοκ «Μηνύματα» εμφανίζει μόνο δεδομένα αποθηκευμένα σε άλλες τοποθεσίες.';
