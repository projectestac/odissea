...
/**
 * Strings for component 'block_live_services', language 'el', version '4.4'.
 *
...
$string['calendarCreateLink'] = 'Νέο γεγονός';
$string['calendarEndDate'] = 'Ημερομηνία τέλους';
$string['calendarEndTime'] = 'Ώρα τέλους';
$string['calendarFetchFailure'] = 'μη διαθέσιμο σύστημα';
$string['calendarIconAltText'] = 'Προβολή';
$string['calendarManyEvents'] = 'επερχόμενα γεγονότα';
$string['calendarNoEvents'] = 'καθόλου επερχόμενα γεγονότα';
$string['calendarNotEnoughOptions'] = 'Όχι αρκετές επιλογές;';
$string['calendarOneEvent'] = '1 επερχόμενο γεγονός';
$string['calendarQuickItem'] = 'Νέο γεγονός';
$string['calendarSelect'] = 'Επιλογή';
$string['calendarSend'] = 'Αποστολή';
$string['calendarStartDate'] = 'Ημερομηνία έναρξης';
$string['calendarStartTime'] = 'Ώρα έναρξης';
$string['calendarToday'] = 'Σήμερα';
$string['calendarUntitled'] = 'Γεγονός χωρίς τίτλο';
$string['calendarViewLink'] = 'Προβολή';
$string['emailAttachments'] = 'Επισύναψη αρχείου';
$string['emailAttachmentsDone'] = 'Ολοκληρώθηκε';
$string['emailBody'] = 'Μήνυμα';
$string['emailCancel'] = 'Άκυρο';
$string['emailFetchFailure'] = 'μη διαθέσιμο σύστημα';
$string['emailFrom'] = 'Από';
$string['emailIconAltText'] = 'Εισερχόμενα';
$string['emailLoadingContacts'] = 'φόρτωση επαφών...';
$string['emailManyMessages'] = 'νέα μηνύματα';
$string['emailMessage'] = 'Μήνυμα';
$string['emailNoMessages'] = 'κανένα νέο μήνυμα';
$string['emailOneMessage'] = '1 νέο μήνυμα';
$string['emailOriginalMessage'] = 'Αρχικό μήνυμα';
$string['emailQuickMessage'] = 'Νέο μήνυμα ηλε.ταχυδρομείου';
$string['emailSend'] = 'Αποστολή';
$string['emailSendLink'] = 'Νέο μήνυμα ηλε.ταχυδρομείου';
$string['emailSent'] = 'Απεσταλμένα';
$string['emailSubject'] = 'Θέμα';
$string['emailTo'] = 'Προς';
$string['emailToTooltip'] = 'Διαχωρίστε πολλαπλά ονόματα με ερωτηματικά';
...
$string['identitySignInButtonText'] = 'Είσοδος';
$string['messengerClassmates'] = 'Συμμαθητές';
$string['messengerNoClassmatesInContacts'] = 'δεν υπάρχει κανένας συμμαθητής στην λίστα επαφών σας';
$string['messengerNoStudentsInContacts'] = 'δεν υπάρχει κανένας μαθητής στην λίστα επαφών σας';
$string['messengerNoTeachersInContacts'] = 'δεν υπάρχει κανένας διδάσκων στην λίστα επαφών σας';
$string['messengerPresenceLink'] = 'ενεργοποίηση παρουσίας';
$string['messengerStudents'] = 'Μαθητές';
$string['messengerTeachersHeader'] = 'Διδάσκοντες';
...
$string['serviceaccount'] = 'Λογαριασμός υπηρεσίας';
$string['showcalendar'] = 'Εμφάνιση ημερολογίου';
$string['showemail'] = 'Εμφάνιση ηλε.ταχυδρομείου';
$string['showmessenger'] = 'Εμφάνιση Messenger';
$string['showsearch'] = 'Εμφάνιση αναζήτησης';
