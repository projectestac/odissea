...
/**
 * Strings for component 'qtype_formulas', language 'el', version '4.4'.
 *
...
$string['abserror'] = 'Απόλυτο σφάλμα';
$string['addmorepartsblanks'] = 'Κενά για {no} ακόμη μέρη';
$string['algebraic_formula'] = 'Αλγεβρικός τύπος';
$string['answer'] = 'Απάντηση*';
$string['answercombinedunitmulti'] = 'Απάντηση και μονάδα για το μέρος {$a->part}';
$string['answercombinedunitsingle'] = 'Απάντηση και μονάδα';
$string['answercoordinatemulti'] = 'Απάντηση για το μέρος {$a->part} και την συντεταγμένη {$a->numanswer}';
$string['answercoordinatesingle'] = 'Απάντηση για τη συντεταγμένη {$a->numanswer}';
$string['answermark'] = 'Βαθμολογία για το μέρος*';
$string['answermulti'] = 'Απάντηση για το μέρος {$a->part}';
$string['answerno'] = 'Μέρος {$a}';
$string['answersingle'] = 'Απάντηση';
$string['answertype'] = 'Τύπος απάντησης';
$string['answertype_help'] = 'Υπάρχουν τέσσερις τύποι απαντήσεων.

Οι απαντήσεις αριθμού, αριθμητικών και αριθμητικών τύπων απαιτούν αριθμό ή μια λίστα αριθμών ως απάντηση.

Οι απαντήσεις αλγεβρικού τύπου απαιτούν μια συμβολοσειρά ή μια λίστα συμβολοσειρών ως απάντηση.
...
$string['choiceno'] = 'Όχι';
$string['choiceyes'] = 'Ναι';
$string['commonsiunit'] = 'Κοινή μονάδα SI';
...
$string['illegalformulasyntax'] = 'Ανεπίτρεπτη σύνταξη τύπου/φόρμουλας που αρχίζει με «{$a}»';
