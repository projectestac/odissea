...
/**
 * Strings for component 'error', language 'el', version '3.11'.
 *
 * @package     error
 * @category    string
...
$string['reverseproxyabused'] = 'Έχει ενεργοποιηθεί ο αντίστροφος διακομιστής διαμεσολάβησης, οπότε εξυπηρετητής σας τώρα δεν είναι προσβάσιμος απευθείας.<br />Παρακαλούμε επικοινωνήστε με το διαχειριστή του εξυπηρετητή σας.';
