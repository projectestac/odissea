...
/**
 * Strings for component 'qtype_ddmarker', language 'el', version '4.4'.
 *
...
Επιλέγοντας πρώτα ένα σχήμα (κύκλος, ορθογώνιο ή πολύγωνο), θα προσθέσει ένα νέο σχήμα ζώνης απόθεσης στην επάνω αριστερή πλευρά της προεπισκόπησης. Είναι ίσως χρήσιμο να ελαχιστοποιήσετε την ενότητα με τους δείκτες θέσης, ώστε να μπορείτε να δείτε την προεπισκόπηση κατά την επεξεργασία των ζωνών απόθεσης.
