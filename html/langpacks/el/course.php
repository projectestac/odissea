...
/**
 * Strings for component 'course', language 'el', version '4.4'.
 *
 * @package     course
 * @category    string
...
$string['target:coursecompletion_help'] = 'Αυτός ο στόχος περιγράφει αν ο μαθητής θεωρείται ότι κινδυνεύει να μην πληροί τις συνθήκες ολοκλήρωσης του μαθήματος.';
$string['target:coursedropout'] = 'Μαθητές που κινδυνεύουν να εγκαταλείψουν';
...
$string['targetlabelstudentcompletionyes'] = 'Μαθητής που κινδυνεύει να μην πληροί τις προϋποθέσεις ολοκλήρωσης του μαθήματος';
$string['targetlabelstudentdropoutno'] = 'Όχι σε κίνδυνο';
$string['targetlabelstudentdropoutyes'] = 'Μαθητής που κινδυνεύει να εγκαταλείψει';
$string['targetlabelstudentgradetopassno'] = 'Μαθητής που είναι πιθανό να πληροί το ελάχιστο βαθμό για να περάσει το μάθημα.';
