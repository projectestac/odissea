...
/**
 * Strings for component 'url', language 'el', version '3.11'.
 *
 * @package     url
 * @category    string
...
$string['modulename_help'] = 'Το άρθρωμα διεύθυνσης URL επιτρέπει στον διδάσκοντα να παρέχει έναν σύνδεσμο ιστού ως ένα πόρο μαθήματος. Σε οτιδήποτε είναι ελεύθερα διαθέσιμο εντός σύνδεσης, όπως έγγραφα ή εικόνες, μπορεί να δημιουργηθεί σύνδεσμος· η διεύθυνση URL δεν χρειάζεται να είναι η αρχική σελίδα ενός ιστοτόπου. Η διεύθυνση URL μιας συγκεκριμένης ιστοσελίδας μπορεί να αντιγραφεί και να επικολληθεί ή ένας διδάσκοντας μπορεί να χρησιμοποιήσει τον επιλογέα αρχείων και να επιλέξει έναν σύνδεσμο από ένα χώρο αποθήκευσης (αποθετήριο) όπως π.χ. το Flickr, το YouTube ή το Wikimedia (ανάλογα με το ποια αποθετήρια έχουν ενεργοποιηθεί για τον ιστότοπο).
...
$string['parametersheader_help'] = 'Αυτή η ενότητα σάς επιτρέπει να μεταφέρετε εσωτερικές πληροφορίες ως μέρος της διεύθυνσης URL. Αυτό είναι χρήσιμο εάν η διεύθυνση URL είναι μια διαδραστική ιστοσελίδα που λαμβάνει παραμέτρους, και θέλετε να μεταβιβάσετε κάτι όπως το όνομα του τρέχοντος χρήστη, για παράδειγμα. Εισαγάγετε το όνομα της παραμέτρου της διεύθυνσης URL στο πλαίσιο κειμένου και, στη συνέχεια, επιλέξτε την αντίστοιχη μεταβλητή ιστότοπου.';
