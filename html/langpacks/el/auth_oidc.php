...
$string['delete_token'] = 'Διαγραφή κουπονιού';
$string['delete_token_and_reference'] = 'Διαγραφή κουπονιού και αναφοράς';
...
$string['mismatched'] = 'Δεν ταιριάζουν';
$string['na'] = 'δ/υ';
...
$string['table_action'] = 'Ενέργεια';
$string['table_matching_details'] = 'Λεπτομέρειες';
$string['table_oidc_username'] = 'Όνομα χρήστη OIDC';
$string['table_token_unique_id'] = 'Μοναδικό αναγνωριστικό OIDC';
$string['token_deleted'] = 'Το κουπόνι διαγράφηκε με επιτυχία';
