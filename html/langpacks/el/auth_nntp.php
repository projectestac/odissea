...
/**
 * Strings for component 'auth_nntp', language 'el', version '3.11'.
 *
 * @package     auth_nntp
 * @category    string
...
$string['privacy:metadata'] = 'Το πρόσθετο αυθεντικοποίησης εξυπηρετητή NNTP δεν αποθηκεύει κανένα προσωπικό στοιχείο.';
