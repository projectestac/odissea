...
/**
 * Strings for component 'label', language 'el', version '4.4'.
 *
 * @package     label
 * @category    string
...
$string['configdndmedia'] = 'Ερώτηση για δημιουργία ταμπέλας όταν γίνεται μεταφορά & απόθεση αρχείων πολυμέσων σε ένα μάθημα';
$string['configdndresizeheight'] = 'Όταν δημιουργείται μια ταμπέλα από μια εικόνα που δημιουργείται με μεταφορά & απόθεση, να αλλάζει το μέγεθός της αν το ύψος της είναι μεγαλύτερο από αυτόν τον αριθμό εικονοστοιχείων (0 για μη αλλαγή μεγέθους)';
$string['configdndresizewidth'] = 'Όταν δημιουργείται μια ταμπέλα από μια εικόνα που δημιουργείται με μεταφορά & απόθεση, να αλλάζει το μέγεθός της αν το πλάτος της είναι μεγαλύτερο από αυτόν τον αριθμό εικονοστοιχείων (0 για μη αλλαγή μεγέθους)';
$string['dndmedia'] = 'Μεταφορά & απόθεση πολυμέσου';
$string['dndresizeheight'] = 'Αλλαγή ύψους μεταφοράς & απόθεσης';
$string['dndresizewidth'] = 'Αλλαγή πλάτους μεταφοράς & απόθεσης';
