...
/**
 * Strings for component 'grouptool', language 'el', version '4.4'.
 *
 * @package     grouptool
 * @category    string
...
$string['cfg_addinstanceset_head'] = 'Πρόσθετες ρυθμίσεις στιγμιοτύπου';
...
$string['cfg_instance_head'] = 'Προεπιλεγμένες ρυθμίσεις στιγμιοτύπου';
...
$string['forceregistration_help'] = 'Επισημαίνεται ότι οι ομάδες του ομαδοεργαλείου διαφέρουν ουσιαστικά από τις τυπικές ομάδες μαθήματος του Moodle. Τικάρετε το πλαίσιο επιλογής εάν θέλετε να εισαγάγετε τους χρήστες στην ομάδα ομαδοεργαλείου καθώς και στην τυπική ομάδα moodle.';
...
$string['groupselection_help'] = 'Επιλέξτε τις ομάδες/τα άτομα για τα οποία επιθυμείτε να αντιγράψετε τον επιλεγμένο βαθμό και ανατροφοδότηση αναφοράς ενεργοποιώντας τα αντίστοιχα πλαίσια επιλογής. Εάν εμφανίζεται μόνο 1 ομάδα, επιλέγετε την πηγή για την αντιγραφή του επιλεγμένου βαθμού χρησιμοποιώντας το αντίστοιχο κουμπί δεξιά της καταχώρησης.';
...
$string['grouptool:addinstance'] = 'Προσθήκη ενός στιγμιοτύπου ομαδοεργαλείου στο μάθημα.';
...
$string['grouptoolname_help'] = 'Το όνομα του στιγμιοτύπου ομαδοεργαλείου';
...
$string['userlist_alt'] = 'Εμφάνιση λίστας χρηστών και των καταχωρίσεών τους. Εξαγωγή δεδομένων σχετικά με τους χρήστες και τις ομάδες τους σε διαφορετικούς μορφότυπους (PDF, απλό κείμενο, Excel κλπ.).';
