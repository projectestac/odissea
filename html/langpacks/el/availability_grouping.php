...
/**
 * Strings for component 'availability_grouping', language 'el', version '3.11'.
 *
...
$string['requires_grouping'] = 'Ανήκετε σε μια ομάδα της ομαδοποίησης <strong>{$a}</strong>';
$string['requires_notgrouping'] = 'Δεν ανήκετε σε μια ομάδα της ομαδοποίησης <strong>{$a}</strong>';
