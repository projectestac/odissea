...
/**
 * Strings for component 'report_security', language 'el', version '3.11'.
 *
...
$string['check_frontpagerole_details'] = '<p>Ο προεπιλεγμένος ρόλος της αρχικής σελίδας δίνεται σε όλους τους καταχωρημένους χρήστες για τις δραστηριότητες αρχικής σελίδας. Επιβεβαιώστε ότι δεν επιτρέπονται επικίνδυνες δυνατότητες σε αυτό το ρόλο.</p><p>Συνιστάται να δημιουργηθεί ένας ειδικός ρόλος για το σκοπό αυτό και να μην χρησιμοποιηθεί ένας κλασικός τύπος ρόλου.</p>';
$string['check_frontpagerole_error'] = 'Εντοπίστηκε μη ορθά ορισμένος ρόλος αρχικής σελίδας «{$a}»!';
...
<p>Παρακαλούμε, επαληθεύστε την ακόλουθη λίστα από χρήστες και εξασφαλίστε ότι τους εμπιστεύεστε εντελώς σε αυτόν τον εξυπηρετητή:</p><p>{$a}</p>';
