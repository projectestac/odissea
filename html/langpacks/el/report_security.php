...
/**
 * Strings for component 'report_security', language 'el', version '3.8'.
 *
...
$string['check_emailchangeconfirmation_info'] = 'Οι χρήστες μπορούν να εισάγουν διευθύνσεις ηλε.ταχυδρομείου μόνο τπό επιτρεπόμενους τομείς.';
