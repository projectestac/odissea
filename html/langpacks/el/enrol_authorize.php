...
/**
 * Strings for component 'enrol_authorize', language 'el', version '3.11'.
 *
...
$string['adminconfighttps'] = 'Παρακαλώ βεβαιωθείτε ότι έχετε <a href="{$a->url}">«ενεργοποιήσει το loginhttps»</a> για τη χρήση αυτής της υπομονάδας λογισμικού<br />στη σελίδα Διαχείριση >> Μεταβλητές >> Ασφάλεια >> Ασφάλεια HTTP.';
...
$string['anauthcodedesc'] = 'Αν η πιστωτική κάρτα ενός χρήστη δεν μπορεί να χρεωθεί απευθείας μέσω διαδικτύου, αποκτήστε τον κωδικό εξουσιοδότησης μέσω τηλεφώνου από την τράπεζα του πελάτη.';
...
$string['ancaptureday'] = 'Ημέρα χρέωσης';
$string['ancapturedaydesc'] = 'Χρεώστε (αποδοχή πίστωσης) αυτόματα την πιστωτική κάρτα, εκτός εάν ένας εκπαιδευτικός ή διαχειριστής ελέγξει την παραγγελία εντός των καθορισμένων ημερών. (0 ημέρες σημαίνει ότι θα απενεργοποιήσει την εντολή προγραμματισμένης χρέωσης, επίσης σημαίνει χειροκίνητη εντολή εκπαιδευτικού ή διαχειριστή. Η συναλλαγή θα ακυρωθεί εάν απενεργοποιήσετε την προγραμματισμένη χρέωση ή αν δεν την ελέγξετε εντός 30 ημερών.)';
$string['anemailexpired'] = 'Ειδοποίηση λήξης';
$string['anemailexpireddesc'] = 'Αυτό είναι χρήσιμο για τη «χειροκίνητη χρέωση». Οι διαχειριστές ενημερώνονται για τον καθορισμένο αριθμό ημερών πριν από την εκπνοή των εκκρεμών εντολών.';
$string['anemailexpiredteacher'] = 'Ειδοποίηση λήξης - Δάσκαλος';
$string['anemailexpiredteacherdesc'] = 'Εάν έχετε ενεργοποιήσει τη «χειροκίνητη χρέωση» (βλέπε παραπάνω) και οι εκπαιδευτικοί μπορούν να διαχειριστούν τις πληρωμές, μπορούν επίσης να ειδοποιηθούν για τις λήγουσες εντολές. Αυτό θα στείλει ένα μήνυμα ηλεκτρονικού ταχυδρομείου σε κάθε καθηγητή του μαθήματος σχετικά με τον αριθμό των εκκρεμών παραγγελιών που λήγουν.';
...
$string['authorize:manage'] = 'Διαχείρηση εγγεγραμένων χρηστών';
...
$string['authorizedpendingcapture'] = 'Εξουσιοδότηση / Εκκρεμεί Σύλληψη';
...
$string['capturedpendingsettle'] = 'Διακανονισμός Σύλληψης/Εκκρεμότητας';
