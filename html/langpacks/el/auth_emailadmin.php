...
/**
 * Strings for component 'auth_emailadmin', language 'el', version '3.11'.
 *
...
$string['pluginname'] = 'Αυτο-καταχώρηση με χρήση ηλε.ταχυδρομείου με επιβεβαίωση διαχειριστή';
