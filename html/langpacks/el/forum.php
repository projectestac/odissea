...
/**
 * Strings for component 'forum', language 'el', version '3.11'.
 *
 * @package     forum
 * @category    string
...
$string['exporthumandates_help'] = 'Εάν οι ημερομηνίες πρέπει να εξάγονται σε μορφότυπο που να μπορεί να διαβαστεί από ανθρώπους ή ως χρονοσφραγίδες (ακολουθία αριθμών).';
