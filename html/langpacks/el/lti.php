...
/**
 * Strings for component 'lti', language 'el', version '4.5'.
 *
 * @package     lti
 * @category    string
...
<p>Εάν έχετε ένα κλειδί για τον καταναλωτή και κοινόχρηστο μυστικό, μπορείτε να το εισαγάγετε κατά την επεξεργασία του εξωτερικού στιγμιοτύπου εργαλείου (βεβαιωθείτε ότι οι προχωρημένες επιλογές είναι ορατές).</p>
...
$string['modulename_shortcut_link'] = '';
...
$string['organizationidguid_help'] = 'Ένα μοναδικό αναγνωριστικό για αυτό το στιγμιότυπο Moodle που μεταβιβάζεται στο εργαλείο ως GUID στιγμιοτύπου πλατφόρμας.

Εάν αυτό το πεδίο αφεθεί κενό, θα χρησιμοποιηθεί η προεπιλεγμένη τιμή.';
$string['organizationurl'] = 'Διεύθυνση URL  οργανισμού';
$string['organizationurl_help'] = 'Η βασική διεύθυνση URL αυτού του στιγμιοτύπου του Moodle. Αν το πεδίο παραμείνει κενό, θα χρησιμοποιηθεί μια προεπιλεγμένη τιμή βάσει των ρυθμίσεων του ιστοτόπου.';
...
$string['privacy:metadata:lti_submission:datesubmitted'] = 'Η χρονοσήμανση που δείχνει πότε έγινε η υποβολή';
$string['privacy:metadata:lti_submission:dateupdated'] = 'Η χρονοσήμανση που δείχνει πότε τροποποιήθηκε η υποβολή';
...
$string['registrationurl_help'] = 'Η διεύθυνση URL καταχώρησης πρέπει να είναι διαθέσιμη από τον πάροχο εργαλείου ως η τοποθεσία στην οποία πρέπει να σταλούν τα αιτήματα καταχώρησης.';
...
$string['share_email'] = 'Κοινή χρήση της διεύθυνσης ηλε.ταχυδρομείου αυτού που έκανε την εκκίνηση με το εργαλείο';
$string['share_email_admin'] = 'Κοινή χρήση της διεύθυνσης ηλε.ταχυδρομείου αυτού που έκανε την εκκίνηση με εργαλείο';
$string['share_email_admin_help'] = 'Καθορίστε εάν η διεύθυνση ηλε.ταχυδρομείου του χρήστη που θα εκκινήσει το εργαλείο θα χρησιμοποιηθεί από κοινού με τον πάροχο των εργαλείων. Ο πάροχος εργαλείων μπορεί να χρειαστεί τις διευθύνσεις ηλε.ταχυδρομείου του χρήστη που θα εκκινήσει το εργαλείο για να διακρίνει μεταξύ χρηστών με ίδιο όνομα στο περιβάλλον εργασίας ή να στέλνει μηνύματα ηλε.ταχυδρομείου στους χρήστες με βάση τις ενέργειες μέσα στο εργαλείο.';
$string['share_email_help'] = 'Καθορίστε εάν η διεύθυνση ηλε.ταχυδρομείου του χρήστη που ξεκινά το εργαλείο θα χρησιμοποιηθεί από κοινού με τον πάροχο του εργαλείου.
...
$string['share_name'] = 'Κοινή χρήση του ονόματος αυτού που έκανε την εκκίνηση με το εργαλείο';
$string['share_name_admin'] = 'Κοινή χρήση του ονόματος αυτού που έκανε την εκκίνηση με εργαλείο';
$string['share_name_admin_help'] = 'Καθορίστε εάν πρέπει να χρησιμοποιείται από κοινού το πλήρες όνομα του χρήστη που εκκινεί το εργαλείο με τον παροχέα εργαλείων.
...
$string['share_name_help'] = 'Καθορίστε εάν το πλήρες όνομα του χρήστη που ξεκινά το εργαλείο θα πρέπει να χρησιμοποιείται από κοινού με τον πάροχο του εργαλείου.
...
Σημειώστε ότι αυτή η ρύθμιση μπορεί να παρακαμφθεί στις ρυθμίσεις του εργαλείου.';
$string['share_roster'] = 'Επιτρέψτε στο εργαλείο να αποκτήσει πρόσβαση στο μαθητολόγιο αυτού του μαθήματος';
$string['share_roster_admin'] = 'Το εργαλείο μπορεί να έχει πρόσβαση στο μαθητολόγιο του μαθήματος';
...
$string['successfullyfetchedtoolconfigurationfromcontent'] = 'Επιτυχής εύρεση/λήψη ρυθμίσεων εργαλείου από το επιλεγμένο περιεχόμενο.';
...
$string['tooldetailsdeploymentid'] = 'Αναγνωριστικό εγκατάστασης/χρήσης';
