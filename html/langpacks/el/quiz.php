...
/**
 * Strings for component 'quiz', language 'el', version '4.4'.
 *
 * @package     quiz
 * @category    string
...
$string['addarandomquestion_success'] = 'Προστέθηκαν τυχαίες ερωτήσεις';
...
$string['attemptquiz'] = 'Προσπάθεια κουίζ';
...
$string['completedon'] = 'Ολοκληρώθηκε';
$string['completionattemptsexhausted'] = 'Βαθμός επιτυχίας ή ολοκλήρωση όλων των διαθέσιμων προσπαθειών';
...
$string['completionminattempts'] = 'Ελάχιστες προσπάθειες';
...
$string['continueattemptquiz'] = 'Συνεχίστε την προσπάθειά σας';
...
$string['edit_slotdisplaynumber_hint'] = 'Επεξεργασία αριθμού ερώτησης (μέγιστο 16 χαρακτήρες)';
$string['edit_slotdisplaynumber_label'] = 'Νέα τιμή για {$a}';
...
$string['emailmanualgradedsubject'] = 'Η προσπάθειά σας στο {$a->quizname} έχει βαθμολογηθεί';
...
$string['eventpagebreakcreated'] = 'Η αλλαγή σελίδας δημιουργήθηκε';
$string['eventpagebreakdeleted'] = 'Η αλλαγή σελίδας διαγράφηκε';
...
$string['eventquizgradeupdated'] = 'Ο βαθμός του κουίζ ενημερώθηκε';
$string['eventreportviewed'] = 'Η αναφορά κουίζ προβλήθηκε';
$string['eventsectionbreakcreated'] = 'Η αλλαγή ενότητας δημιουργήθηκε';
$string['eventsectionbreakdeleted'] = 'Η αλλαγή ενότητας διαγράφηκε';
$string['eventsectiontitleupdated'] = 'Ο τίτλος ενότητας ενημερώθηκε';
...
$string['gradeitemdefaultname'] = 'Νέο στοιχείο βαθμού {$a}';
$string['gradeitemdelete'] = 'Διαγραφή στοιχείου βαθμού {$a}';
$string['gradeitemedit'] = 'Επεξεργασία ονόματος στοιχείου βαθμού {$a}';
$string['gradeitemnewname'] = 'Νέο όνομα για το στοιχείο βαθμού {$a}';
$string['gradeitemnoslots'] = 'Αυτό το κουίζ δεν έχει ακόμη ερωτήσεις. Παρακαλούμε προσθέστε πρώτα ερωτήσεις και στη συνέχεια επιστρέψτε εδώ για να ρυθμίσετε τα στοιχεία βαθμολογίας.';
$string['gradeitems'] = 'Στοιχεία βαθμού';
$string['gradeitemsautosetup'] = 'Ρυθμίστε βαθμό για κάθε ενότητα';
...
$string['overridecannotchange'] = 'Ο χρήστης ή η ομάδα δεν μπορεί να αλλάξει μετά τη δημιουργία μιας παράκαμψης.';
...
$string['overrideinvalidattempts'] = 'Ο αριθμός των προσπαθειών πρέπει να είναι μεγαλύτερος από το μηδέν.';
$string['overrideinvalidexistingid'] = 'Η υπάρχουσα παράκαμψη δεν υπάρχει.';
$string['overrideinvalidgroup'] = 'Η συγκεκριμένη ομάδα δεν υπάρχει.';
$string['overrideinvalidtimelimit'] = 'Το χρονικό όριο πρέπει να είναι μεγαλύτερο του μηδενός.';
$string['overrideinvaliduser'] = 'Ο συγκεκριμένος χρήστης δεν υπάρχει.';
$string['overridemultiplerecordsexist'] = 'Πολλαπλές παρακάμψεις δεν μπορούν να γίνουν για τον ίδιο χρήστη/ομάδα.';
$string['overridemustsetuserorgroup'] = 'Πρέπει να οριστεί ένας χρήστης ή μια ομάδα.';
...
$string['previewquizstart'] = 'Προεπισκόπηση κουίζ';
...
$string['reopenedattemptwillbeinprogress'] = 'Η προσπάθεια θα παραμείνει ανοιχτή και μπορεί να συνεχιστεί.';
$string['reopenedattemptwillbeinprogressuntil'] = 'Η προσπάθεια θα παραμείνει ανοιχτή και μπορεί να συνεχιστεί μέχρι να κλείσει το κουίζ στις {$a}.';
$string['reopenedattemptwillbesubmitted'] = 'Η προσπάθεια θα υποβληθεί αμέσως για βαθμολόγηση.';
...
$string['submission_confirmation'] = 'Υποβολή όλων των απαντήσεών σας και ολοκλήρωση;';
$string['submission_confirmation_unanswered'] = 'Ερωτήσεις χωρίς απάντηση: {$a}';
