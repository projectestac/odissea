...
/**
 * Strings for component 'pdfparts', language 'el', version '3.11'.
 *
 * @package     pdfparts
 * @category    string
...
$string['modulename'] = 'Μέρη PDF';
$string['modulenameplural'] = 'Μέρη PDF';
$string['name'] = 'Όνομα';
$string['pages'] = 'Σελίδες';
$string['pages_help'] = 'π.χ. 1-3,5,8,10-12';
$string['pdfparts'] = 'Μέρη PDF';
$string['pdfpartsname_help'] = '';
$string['pluginname'] = 'Μέρη PDF';
...
$string['printheading'] = 'Εμφάνιση ονόματος πόρου';
$string['printheadingexplain'] = 'Να εμφανίζεται το όνομα PDF πάνω από το περιεχόμενο; Μερικοί τύποι εμφάνισης μπορεί να μην εμφανίσουν το όνομα πόρου ακόμη κι αν ενεργοποιηθεί.';
$string['printintroexplain'] = 'Να εμφανίζεται η περιγραφή PDF κάτω από το περιεχόμενο; Μερικοί τύποι εμφάνισης μπορεί να μην εμφανίσουν περιγραφή PDF ακόμη κι αν ενεργοποιηθεί.';
$string['selectfile'] = 'Επιλογή αρχείου PDF';
