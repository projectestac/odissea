...
$string['clone'] = 'Κλώνος';
$string['datetimeformat'] = '%d/%m/%Y, %H:%M %Z';
$string['defaultdescription'] = 'Περιγραφή';
$string['defaultlayoutcss'] = 'Διάταξη CSS';
$string['defaultoutageautostart'] = 'Αυτόματη έναρξη διακοπής λειτουργίας';
...
$string['defaulttitlevalue'] = 'Το σύστημα θα είναι εκτός λειτουργίας από τις {{start}} για {{duration}}';
...
$string['messageoutagebackonline'] = 'Επανήλθαμε εντός σύνδεσης!';
$string['messageoutagebackonlinedescription'] = 'Μπορείτε να συνεχίσετε την περιήγηση με ασφάλεια.';
$string['messageoutageongoing'] = 'Επαναφορά λειτουργίας στις {$a->stop}.';
