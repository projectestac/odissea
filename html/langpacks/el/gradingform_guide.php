...
/**
 * Strings for component 'gradingform_guide', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['regrademessage5'] = 'Πρόκειται να αποθηκεύσετε σημαντικές αλλαγές σε έναν οδηγό βαθμολόγησης που έχει ήδη χρησιμοποιηθεί για βαθμολόγηση. Η τιμή στο βαθμολόγιο θα παραμείνει αμετάβλητη, αλλά ο οδηγός βαθμολόγησης θα αποκρύπτεται από τους μαθητές εώς ότου το στοιχείο τους ξαναβαθμολογηθεί.';
$string['regradeoption0'] = 'Να μην γίνει επισήμανση για αναβαθμολόγηση';
$string['regradeoption1'] = 'Επισήμανση για αναβαθμολόγηση';
$string['remark_help'] = 'Εισαγάγετε τυχόν επιπλέον σχόλια σχετικά με αυτό το κριτήριο. Μπορείτε επίσης να επιλέξετε από τη λίστα των σχολίων που χρησιμοποιούνται συχνά χρησιμοποιώντας το κουμπί επιλογέα σχολίων που χρησιμοποιούνται συχνά.';
