...
/**
 * Strings for component 'bigbluebuttonbn', language 'el', version '4.5'.
 *
...
$string['end_session_confirm'] = 'Είστε βέβαιοι ότι θέλετε να τερματίσετε τη συνεδρία;';
$string['end_session_confirm_title'] = 'Να τερματιστεί η συνεδρία;';
...
$string['userlimitreached'] = 'Έχει επιτευχθεί ο μέγιστος αριθμός χρηστών που επιτρέπεται σε μια συνεδρία.';
