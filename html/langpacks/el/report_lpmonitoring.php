...
/**
 * Strings for component 'report_lpmonitoring', language 'el', version '3.11'.
 *
...
$string['colorsforscale'] = 'Χρώματα για την κλίμακα: {$a}';
$string['colorsforscalesaved'] = 'Τα χρώματα της κλίμακας {$a} αποθηκεύτηκαν με επιτυχία.';
$string['comment'] = 'Σχόλιο';
$string['comments'] = 'Σχόλια';
$string['commentsedit'] = 'Εμφάνιση ή προσθήκη σχολίων';
$string['commentseditshort'] = 'Εμφάνιση/προσθήκη';
$string['commentsnumber'] = '<strong>({$a})</strong> σχόλιο(-α)';
$string['course'] = 'Μάθημα';
$string['emptytemplate'] = 'Δεν βρέθηκαν μαθησιακά σχέδια';
$string['filter'] = 'Φίλτρο';
$string['filterboth'] = 'Και τα δύο';
$string['filterby'] = 'Φιλτράρισμα κατά';
$string['filterbyscalevalue'] = 'Φιλτράρισμα κατά τιμή κλίμακας';
$string['filtercourse'] = 'Στο μάθημα';
$string['filtermodule'] = 'Στην δραστηριότητα μαθήματος';
$string['finalrating'] = 'Τελική αξιολόγηση';
$string['finalratingcourse'] = 'Αξιολόγηση στο μάθημα';
$string['finalratingcoursemodule'] = 'Αξιολόγηση στην δραστηριότητα';
$string['forcerating'] = 'Αναγκαστική αξιολόγηση των χρηστών που έχουν ήδη αξιολογηθεί';
$string['incms'] = 'σε δραστηριότητες';
$string['incourses'] = 'σε μαθήματα';
$string['invalidframework'] = 'Μη έγκυρο πλαίσιο προσόντων';
$string['invalidscaleconfiguration'] = 'Μη έγκυρη διαμόρφωση κλίμακας';
$string['learningplancompetencies'] = 'Προσόντα μαθησιακού σχεδίου: {$a}';
$string['learningplanswithtag'] = 'Μαθησιακά σχέδια με αυτή την ετικέτα';
$string['linkedcms'] = 'Συνδεδεμένες δραστηριότητες';
$string['linkedusers'] = 'Συνδεδεμένοι χρήστες';
$string['nextuser'] = 'Επόμενος χρήστης';
$string['nodataavailable'] = 'Δεν υπάρχουν διαθέσιμα δεδομένα';
$string['nolearningplanavailable'] = 'Δεν υπάρχει κανένα σχέδιο μάθησης';
$string['nomatchingrecords'] = 'Δεν βρέθηκαν εγγραφές που ταιριάζουν';
$string['nopermissionsplanview'] = 'Λυπούμαστε, αλλά προς το παρόν δεν έχετε δικαιώματα προβολής σχεδίου μάθησης για {$a}';
