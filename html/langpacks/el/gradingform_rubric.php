...
/**
 * Strings for component 'gradingform_rubric', language 'el', version '4.4'.
 *
...
$string['restoredfromdraft'] = 'ΣΗΜΕΙΩΣΗ: Η τελευταία προσπάθεια βαθμολόγησης αυτού του ατόμου δεν αποθηκεύτηκε σωστά, οπότε επαναφέρθηκαν προσχέδια βαθμών. Εάν θέλετε να ακυρώσετε αυτές τις αλλαγές, χρησιμοποιήστε το κουμπί «Ακύρωση» παρακάτω.';
