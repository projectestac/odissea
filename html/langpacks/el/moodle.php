...
/**
 * Strings for component 'moodle', language 'el', version '3.8'.
 *
 * @package     moodle
 * @category    string
...
$string['defaulthomepageuser'] = 'Αρχική σελίδα';
$string['defaulthomepageuser_help'] = 'Η αρχική σας σελίδα είναι ο πρώτος σύνδεσμος στην πλοήγηση.';
...
$string['emailagain'] = 'Αποστολή ηλε.ταχυδρομείου (ξανά)';
...
$string['emojicategorysmileyspeople'] = 'Φατσούλες & άνθρωποι';
...
$string['modvisible_help'] = 'Εάν η διαθεσιμότητα έχει οριστεί σε «Εμφάνιση στη σελίδα του μαθήματος», η δραστηριότητα ή ο πόρος είναι διαθέσιμα στους μαθητές (υπόκεινται σε περιορισμούς πρόσβασης που μπορούν να οριστούν).

Εάν η διαθεσιμότητα έχει οριστεί σε «Απόκρυψη από τους μαθητές», η δραστηριότητα ή ο πόρος είναι διαθέσιμα μόνο σε χρήστες με δικαίωμα να προβάλλουν κρυφές δραστηριότητες (από προεπιλογή, οι χρήστες με ρόλο διδάσκοντα ή περιορισμένου διδάσκοντα).';
$string['modvisiblehiddensection'] = 'Διαθεσιμότητα';
$string['modvisiblehiddensection_help'] = 'Εάν η διαθεσιμότητα έχει οριστεί σε «Απόκρυψη από τους μαθητές», η δραστηριότητα ή ο πόρος είναι διαθέσιμα μόνο σε χρήστες με δικαίωμα να προβάλλουν κρυφές δραστηριότητες (από προεπιλογή, οι χρήστες με ρόλο διδάσκοντα ή περιορισμένου διδάσκοντα).

Αν το μάθημα περιέχει πολλές δραστηριότητες ή πόρους, η σελίδα μπορεί να απλουστευθεί, θέτοντας τη διαθεσιμότητα σε «Διατίθεται αλλά δεν εμφανίζεται στη σελίδα του μαθήματος». Σε αυτή την περίπτωση, ένας σύνδεσμος προς τη δραστηριότητα ή τον πόρο πρέπει να παρέχεται από αλλού, όπως από έναν πόρο σελίδας. Η δραστηριότητα θα εξακολουθεί να περιλαμβάνεται στο βαθμολόγιο και σε άλλες αναφορές.';
$string['modvisiblewithstealth'] = 'Διαθεσιμότητα';
$string['modvisiblewithstealth_help'] = 'Εάν η διαθεσιμότητα έχει οριστεί σε «Εμφάνιση στη σελίδα του μαθήματος», η δραστηριότητα ή ο πόρος είναι διαθέσιμα στους μαθητές (υπόκεινται σε περιορισμούς πρόσβασης που μπορούν να οριστούν).
...
$string['privacy:metadata:task_adhoc'] = 'Η κατάσταση των ad hoc εργασιών.';
