...
/**
 * Strings for component 'moodle', language 'el', version '4.5'.
 *
 * @package     moodle
 * @category    string
...
$string['activityorresource'] = 'Δραστηριότητα ή πόρος';
...
$string['addcontent'] = 'Προσθήκη περιεχομένου';
...
$string['addfilesdrop'] = 'Μπορείτε να μεταφέρετε και να αποθέσετε αρχεία εδώ για να τα ανεβάσετε ή να κάνετε κλικ για να τα επιλέξετε.';
...
$string['backupinfo'] = 'Δημιουργήστε ένα αντίγραφο αυτού του μαθήματος, συμπεριλαμβανομένου του ενημερωμένου περιεχομένου και δραστηριότητας. Μπορείτε να χρησιμοποιήσετε το αρχείο αντιγράφου ασφαλείας για να επαναφέρετε αυτό το μάθημα ή να το χρησιμοποιήσετε σε διαφορετικό ιστότοπο.';
...
$string['bulkcancel'] = 'Κλείσιμο μαζικής επεξεργασίας';
...
$string['coursesectiontitlebulkediting'] = 'Μαζική επεξεργασία {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'Μαζική επεξεργασία μαθηματος: {$a->course}';
...
$string['currenttheme'] = 'Τρέχον θέμα εμφάνισης';
...
$string['duplicatedsection'] = '{$a} (αντιγραφή)';
...
$string['editsectionsettings'] = 'Επεξεργασία ρυθμίσεων ενότητας';
$string['editsectiontitle'] = 'Επεξεργασία ενότητας: {$a}';
...
$string['enddatewithtaskenabled'] = 'Ημερομηνία λήξης μαθήματος';
...
$string['eventcourseended'] = 'Το μάθημα τελείωσε';
...
$string['eventcoursestarted'] = 'Το μάθημα ξεκίνησε';
...
$string['eventurlblocked'] = 'Η διεύθυνση URL έχει αποκλειστεί';
...
$string['importinfo'] = 'Εισαγάγετε στοιχεία από άλλα μαθήματα, όπως δραστηριότητες, μπλοκ ή συμβάντα ημερολογίου. Δε θα εισαχθούν δεδομένα χρήστη.';
...
$string['includesubcategories'] = 'Συμπερίληψη υποκατηγοριών';
...
$string['modshowcmtitle'] = 'Εμφάνιση δραστηριότητας';
...
$string['moodlenet:cannotconnecttoserver'] = 'Δεν είναι δυνατή η σύνδεση με τον διακομιστή MoodleNet';
$string['moodlenet:columnname'] = 'Όνομα';
$string['moodlenet:columnsenddate'] = 'Ημερομηνία αποστολής';
$string['moodlenet:columnsendstatus'] = 'Κατάσταση αποστολής';
$string['moodlenet:columntype'] = 'Τύπος';
$string['moodlenet:configoauthservice'] = 'Επιλέξτε μια υπηρεσία MoodleNet OAuth 2 για να ενεργοποιήσετε την κοινή χρήση σε αυτόν τον ιστότοπο του MoodleNet. Εάν η υπηρεσία δεν υπάρχει ακόμα, θα πρέπει να τη <a href="{$a}">δημιουργήσετε</a>.';
$string['moodlenet:deletedactivity'] = 'Διαγραμμένη δραστηριότητα';
$string['moodlenet:deletedcourse'] = 'Διαγραμμένο μάθημα';
$string['moodlenet:gotomoodlenet'] = 'Μετάβαση στα πρόχειρα του MoodleNet';
$string['moodlenet:sharefailtitle'] = 'Κάτι πήγε στραβά';
$string['moodlenet:sharenoticepartial'] = '';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} δραστηριότητες θα συμπεριληφθούν στο μάθημα.';
$string['moodlenet:sharesuccesstitle'] = 'Αποθηκευμένο στα πρόχειρα του MoodleNet';
$string['moodlenet:sharetomoodlenet'] = 'Κοινοποίηση στο MoodleNet';
$string['moodlenet:sharinglargefile'] = 'Τα μεγάλα αρχεία μπορεί να πάρουν λίγο χρόνο.';
$string['moodlenet:sharingstatus'] = 'Γίνεται κοινοποίηση στο MoodleNet';
$string['moodlenet:sharingto'] = 'Κοινοποίηση σε:';
...
$string['noresultsfor'] = 'Κανένα αποτέλεσμα για "{$a}"';
...
$string['pluginmissingfromdisk'] = '{$a->name} (Λείπει από τον δίσκο)';
...
$string['previewthemename'] = 'Προεπισκόπηση θέματος \'{$a}\'';
...
$string['resetcourseconfirm'] = 'Επαναφορά μαθήματος;';
$string['resetinfo'] = 'Αυτή η λειτουργία σας επιτρέπει να διαγράψετε όλα τα δεδομένα χρήστη και να επαναφέρετε το μάθημα στην αρχική του κατάσταση. Οι δραστηριότητες και οι ρυθμίσεις του μαθήματος παραμένουν αμετάβλητες.';
$string['resetinfoselect'] = 'Επιλέξτε τα δεδομένα που θέλετε να διαγράψετε ή να επαναφέρετε από τις παρακάτω κατηγορίες:';
$string['resetnotimplemented'] = 'Δεν υλοποιήθηκε η επαναρχικοποίηση';
$string['resetnotimplementedinfo'] = 'Αυτές οι δραστηριότητες δεν μπορούν να επαναφερθούν:';
...
$string['rolerenaming_help'] = 'Αλλάξτε τα εμφανιζόμενα ονόματα των ρόλων σε αυτό το μάθημα.';
$string['roles'] = 'Ρόλοι';
...
$string['searchgroups'] = 'Αναζήτηση ομάδων';
$string['searchitems'] = 'Αναζήτηση αντικειμένων';
...
$string['selecttheme'] = 'Επιλογή θέματος';
$string['selectthemename'] = 'Επιλογή θέματος \'{$a}\'';
$string['senddetails'] = 'Αποστολή των στοιχείων μου μέσω email';
$string['sent'] = 'Αποστολή';
$string['separate'] = 'Διαχωρισμός';
$string['separateandconnected'] = 'Ξεχωριστοί και Συνδεδεμένοι τρόποι γνώσης';
$string['separateandconnected1'] = 'Δείχνει περισσότερο ξεχωριστή γνώση';
$string['separateandconnected2'] = 'Ξεχωριστή και συνδεδεμένη';
$string['separateandconnected3'] = 'Δείχνει περισσότερο συνδεδεμένη γνώση';
...
$string['startdatewithtaskenabled'] = 'Ημερομηνία έναρξης μαθήματος';
$string['startdatewithtaskenabled_help'] = 'Η ημερομηνία που το μάθημα γίνεται ορατό στους μαθητές. Πριν από αυτήν την ημερομηνία, δεν θα μπορούν να έχουν πρόσβαση στο μάθημα.

Αυτή η ημερομηνία καθορίζει επίσης την έναρξη της πρώτης εβδομάδας για ένα μάθημα σε εβδομαδιαία μορφή και είναι η ημερομηνία έναρξης για τα αρχεία καταγραφής των δραστηριοτήτων του μαθήματος. Εάν επαναφέρετε το μάθημα και αλλάξετε αυτήν την ημερομηνία, όλες οι ημερομηνίες του μαθήματος θα μετακινηθούν σε σχέση με τη νέα ημερομηνία έναρξης.';
...
$string['statuschecks'] = 'Έλεγχοι κατάστασης';
...
$string['themepreviewdescription'] = '{$a} περιγραφή θέματος';
$string['themepreviewimage'] = '{$a} εικόνα προεπισκόπησης';
...
$string['usermatchedon'] = 'Αυτός ο χρήστης αντιστοιχεί στην αναζήτηση μέσω του παρακάτω πεδίου';
...
$string['userselectorsearchanywhere'] = 'οπουδήποτε';
$string['userselectorsearchexactmatchonly'] = 'μόνο ακριβείς αντιστοιχίσεις';
$string['userselectorsearchfromstart'] = 'από την αρχή';
$string['userselectorsearchmatching'] = 'Ταίριασμα:';
...
$string['viewallresults'] = 'Εμφάνιση όλων των αποτελεσμάτων για {$a}';
...
$string['viewresults'] = 'Εμφάνιση αποτελεσμάτων για {$a}';
...
Αν δεν το έχετε ήδη κάνει, θα πρέπει να επεξεργαστείτε τη σελίδα του προφίλ σας, ώστε να μπορέσουμε να μάθουμε περισσότερα για εσάς:
...
$string['wontrunfuturescheduledtask'] = 'Δεν θα εκτελεστεί εργασία που δεν έχει αποτύχει και έχει προγραμματιστεί να εκτελεστεί στο μέλλον';
