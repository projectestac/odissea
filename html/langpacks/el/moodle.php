...
/**
 * Strings for component 'moodle', language 'el', version '3.11'.
 *
 * @package     moodle
 * @category    string
...
$string['backupadhocpending'] = 'Εκκρεμεί η ad hoc εργασία αντιγράφου ασφαλείας μαθήματος';
...
$string['emaildisplaycourse'] = 'Η διεύθυνση ηλε.ταχυδρομείου μου να είναι ορατή μόνο σε συμμετέχοντες στο μάθημα.';
...
$string['emaildisplayhide'] = '(Κρυμμένο από όλους τους μη προνομιούχους χρήστες)';
...
$string['eventuserfeedbackgiven'] = 'Ο σύνδεσμος ανατροφοδότησης πατήθηκε';
$string['eventuserfeedbackremind'] = 'Ο σύνδεσμος υπενθύμισης ανατροφοδότησης αργότερα πατήθηκε';
...
$string['privacy:metadata:oauth2_refresh_token'] = 'Ανανέωση διακριτικού που χρησιμοποιείται στην επικοινωνία OAuth 2.0';
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'Το αναγνωριστικό του εκδότη στον οποίο αντιστοιχεί το διακριτικό';
$string['privacy:metadata:oauth2_refresh_token:scopehash'] = 'Το αναγνωριστικό του χρήστη στον οποίο αντιστοιχεί το διακριτικό';
$string['privacy:metadata:oauth2_refresh_token:timecreated'] = 'Η χρονική στιγμή κατά την οποία δημιουργήθηκε το διακριτικό';
$string['privacy:metadata:oauth2_refresh_token:timemodified'] = 'Η ώρα τελευταίας ενημέρωσης του διακριτικού';
$string['privacy:metadata:oauth2_refresh_token:token'] = 'Το διακριτικό ανανέωσης για τις αντίστοιχες εμβέλειες και το χρήστη';
$string['privacy:metadata:oauth2_refresh_token:userid'] = 'Το αναγνωριστικό του χρήστη στον οποίο αντιστοιχεί το διακριτικό';
...
$string['showactivitydates_help'] = 'Οι ημερομηνίες δραστηριότητας εμφανίζονται πάντα στη σελίδα δραστηριότητας. Αυτή η ρύθμιση καθορίζει εάν οι ημερομηνίες δραστηριότητας εμφανίζονται επίσης κάτω από κάθε δραστηριότητα στη σελίδα του μαθήματος.';
