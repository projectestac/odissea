...
/**
 * Strings for component 'moodle', language 'el', version '4.4'.
 *
 * @package     moodle
 * @category    string
...
$string['resetinfo'] = 'Διαγραφή των δεδομένα χρήστη και επαναφορά του μαθήματος στην αρχική του κατάσταση, διατηρώντας ανέπαφα τις δραστηριότητες και τις ρυθμίσεις.';
