...
$string['adminhelpsitesettings'] = 'Ορισμός της εμφάνισης της πρώτης σελίδας του ιστοτόπου';
...
$string['emaildisplay_help'] = 'Οι προνομιακοί χρήστες (όπως οι διδάσκοντες και οι διευθυντές) θα μπορούν πάντα να βλέπουν τη διεύθυνση ηλε.ταχυδρομείου σας.';
...
$string['frontpagedescriptionhelp'] = 'Αυτή η περίληψη μπορεί να εμφανίζεται στην πρώτη σελίδα με χρήση του μπλοκ «Περίληψη μαθήματος/ιστοτόπου».';
$string['frontpageenrolledcourselist'] = 'Μαθήματα που έχει γίνει εγγραφή';
$string['frontpageformat'] = 'Μορφότυπος πρώτης σελίδας';
$string['frontpageformatloggedin'] = 'Μορφότυπος πρώτης σελίδας μετά από σύνδεση';
...
$string['hiddensections_help'] = 'Αυτή η ρύθμιση καθορίζει εάν οι κρυμμένες ενότητες θα εμφανίζονται στους μαθητές σε συνεπτυγμένη μορφή (ίσως για ένα μάθημα σε εβδομαδιαίο μορφότυπο για να σηματοδοτεί διακοπές) ή θα είναι εντελώς κρυμμένες.';
$string['hiddensectionscollapsed'] = 'Οι ενότητες που έχετε αποκρύψει θα προβάλλονται σε συμπτυγμένη μορφή';
...
$string['opendrawerindex'] = 'Άνοιγμα συρταριού ευρετηρίου/δείκτη μαθήματος';
...
$string['restoretositeadding'] = 'Προειδοποίηση: Πρόκειται να κάνετε επαναφορά στην πρώτη σελίδα του ιστοτόπου, προσθέτοντας δεδομένα σε αυτήν!';
$string['restoretositedeleting'] = 'Προειδοποίηση: Πρόκειται να κάνετε επαναφορά στην πρώτη σελίδα του ιστοτόπου, διαγράφοντας δεδομένα από αυτήν!';
