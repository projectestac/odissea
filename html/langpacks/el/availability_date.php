...
/**
 * Strings for component 'availability_date', language 'el', version '3.11'.
 *
...
$string['full_from'] = 'Η ημερομηνία είναι μετά από <strong>{$a}</strong>';
$string['full_from_date'] = 'Η ημερομηνία είναι <strong>{$a}</strong> ή μετά';
