...
/**
 * Strings for component 'booking', language 'el', version '4.1'.
 *
 * @package     booking
 * @category    string
...
$string['privacy:metadata:booking_answers:timecreated'] = 'Χρονοσήμανση του πότε δημιουργήθηκε η κράτηση';
$string['privacy:metadata:booking_answers:timemodified'] = 'Χρονοσήμανση του πότε τροποποιήθηκε τελευταία φορά η κράτηση';
$string['privacy:metadata:booking_answers:userid'] = 'Χρήστης με κράτηση για αυτό το γεγονός';
