...
/**
 * Strings for component 'feedback', language 'el', version '4.4'.
 *
 * @package     feedback
 * @category    string
...
$string['completiondetail:submit'] = 'Υποβολή ανατροφοδότησης';
$string['completionsubmit'] = 'Εμφάνιση ως ολοκληρωμένου αν η ανατροφοδότηση υποβληθεί';
$string['configallowfullanonymous'] = 'Αν οριστεί σε «ναι», οι χρήστες μπορούν να ολοκληρώσουν μια δραστηριότητα ανατροφοδότησης στην πρώτη σελίδα χωρίς να απαιτείται να συνδεθούν.';
...
Τα σχόλια ανατροφοδότησης μπορεί να είναι ανώνυμα αν το επιθυμείτε και τα αποτελέσματα μπορούν να παρουσιαστούν σε όλους τους συμμετέχοντες ή να περιοριστούν μόνο στους διδάσκοντες. Οποιεσδήποτε δραστηριότητες ανατροφοδότησης στην πρώτη σελίδα ιστοτόπου ενδέχεται επίσης να ολοκληρωθούν από μη εγγεγραμμένους χρήστες.
...
$string['selected_dump'] = 'Τα επιλεγμένα ευρετήρια της μεταβλητής $SESSION εμφανίζονται μαζικά παρακάτω:';
$string['send'] = 'Αποστολή';
$string['send_message'] = 'Αποστολή ειδοποίησης';
