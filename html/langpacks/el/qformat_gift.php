...
/**
 * Strings for component 'qformat_gift', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['braceerror'] = 'Δεν ήταν δυνατή η εύρεση {...} γύρω από απαντήσεις';
$string['giftleftbraceerror'] = 'Δεν ήταν δυνατή η εύρεση {';
$string['giftmatchingformat'] = 'Οι απαντήσεις ερωτήσεων αντιστοίχισης είναι ακατάλληλα μορφοποιημένες';
$string['giftnonumericalanswers'] = 'Δεν βρέθηκαν απαντήσεις για την αριθμητική ερώτηση';
$string['giftnovalidquestion'] = 'Δεν βρέθηκε καμία έγκυρη ερώτηση';
$string['giftqtypenotset'] = 'Ο τύπος ερώτησης δεν έχει οριστεί';
