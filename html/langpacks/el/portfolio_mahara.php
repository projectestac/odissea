...
/**
 * Strings for component 'portfolio_mahara', language 'el', version '4.4'.
 *
...
$string['err_invalidhost_help'] = 'Αυτό το πρόσθετο είναι ρυθμισμένο λανθασμένα να δείχνει σε έναν μη έγκυρο (ή διαγραμμένο) κόμβο του MNet. Το πρόσθετο αυτό βασίζεται σε ομότιμους ιστοτόπους Δικτύωσης Moodle (MNet), με SSO IDP (πάροχο ταυτότητας ενιαίας σύνδεσης) που έχει δημοσιευτεί, με SSO_SP (παρόχους υπηρεσιών ενιαίας σύνδεσης) που έχουν εγγραφεί και με χαρτοφυλάκιο που έχει εγγραφεί <b>και</b> δημοσιευτεί.';
