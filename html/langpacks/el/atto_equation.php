...
/**
 * Strings for component 'atto_equation', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['cursorinfo'] = 'Ένα βέλος δείχνει τη θέση που θα εισαχθούν νέα στοιχεία από τη βιβλιοθήκη στοιχείων.';
$string['editequation'] = 'Επεξεργαστείτε την εξίσωση χρησιμοποιώντας το <a href="{$a}" target="_blank">TeX</a>';
$string['librarygroup1'] = 'Τελεστές';
