...
/**
 * Strings for component 'h5p', language 'el', version '3.11'.
 *
 * @package     h5p
 * @category    string
...
$string['couldNotParseJSONFromZip'] = 'Αδυναμία ανάλυσης JSON από το πακέτο: {$a->%fileName}';
...
$string['librariesmanagerdescription'] = '<p>Το H5P επιτρέπει στους χρήστες να δημιουργούν διαδραστικό περιεχόμενο παρέχοντας μια σειρά τύπων περιεχομένου.</p><p>Για να εξασφαλιστεί ότι χρησιμοποιούνται μόνο έμπιστοι τύποι περιεχομένου H5P στον ιστότοπό σας, χρειάζεται <i>είτε </i></p><ul><li>Ανέβασμα τύπων περιεχομένου H5P από το h5p.org <i>είτε </i></li><li><i>Ενεργοποίηση της προγραμματισμένης εργασίας «Λήψη διαθέσιμων τύπων περιεχομένου H5P από το h5p.org»</li></ul><p>Σημειώστε ότι οι χρήστες θα μπορούν να χρησιμοποιούν μόνο τους τύπους περιεχομένου H5P που είναι εγκατεστημένοι στον ιστότοπό σας.</p>';
...
$string['lockh5pdeploy'] = 'Δεν είναι δυνατή η πρόσβαση σε αυτό το περιεχόμενο H5P επειδή αναπτύσσεται ακόμη. Παρακαλώ δοκιμάστε ξανά αργότερα.';
...
$string['nopermissiontodeploy'] = 'Αυτό το αρχείο δεν μπορεί να εμφανιστεί επειδή έχει ανεβεί από ένα χρήστη χωρίς την απαιτούμενη δυνατότητα να εγκαταστήσει περιεχόμενο H5P.';
...
$string['task_h5p'] = 'Προγραμματισμένη εργασία H5P';
$string['task_h5p_description'] = 'Η προγραμματισμένη εργασία H5P κατεβάζει διαθέσιμους τύπους περιεχομένου H5P από το h5p.org.';
