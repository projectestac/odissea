...
/**
 * Strings for component 'qtype_easyostructure', language 'el', version '3.11'.
 *
...
$string['insertfromeditordesc'] = 'Δημιουργήστε τη δομή σας παραπάνω και κατόπιν κάντε κλικ στο πλήκτρο <b>«Εισαγωγή από τον επεξεργαστή κειμένου»</b>';
$string['insertfromtextarea'] = 'Εμφάνιση τρέχουσας δομής';
