...
/**
 * Strings for component 'logstore_legacy', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['eventlegacylogged'] = 'Καταγράφηκε κλασικού τύπου γεγονός';
$string['loglegacy'] = 'Καταγραφή κλασικών δεδομένων';
