...
$string['enableavailability_desc'] = 'Εάν ενεργοποιηθεί, σας επιτρέπει να θέσετε συνθήκες (με βάση ημερομηνία, βαθμό ή ολοκλήρωση) οι οποίες θα καθορίζουν εάν μια δραστηριότητα ή πόρος είναι προσβάσιμα.';
...
$string['list_and'] = 'Όλα τα εξής:';
$string['list_and_hidden'] = 'Όλα από (κρυμμένα αλλιώς):';
$string['list_or'] = 'Οποιαδήποτε από τα εξής:';
$string['list_or_hidden'] = 'Οποιαδήποτε (κρυμμένα αλλιώς):';
$string['list_root_and'] = 'Μη διαθέσιμο εκτός αν:';
$string['list_root_and_hidden'] = 'Μη διαθέσιμο (κρυφό) εκτός αν:';
...
$string['listheader_multi_before'] = 'ταιριάζει';
$string['listheader_multi_or'] = 'οποιαδήποτε';
$string['listheader_sign_before'] = 'Ο μαθητής';
$string['listheader_sign_neg'] = 'δεν πρέπει να';
$string['listheader_sign_pos'] = 'πρέπει να';
