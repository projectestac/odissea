...
/**
 * Strings for component 'resource', language 'el', version '4.1'.
 *
 * @package     resource
 * @category    string
...
$string['showsize_desc'] = 'Εμφάνιση του μεγέθους αρχείου στη σελίδα του μαθήματος;';
$string['showsize_help'] = 'Εμφανίζει το μέγεθος του αρχείου, π.χ. «3.1 MB», δίπλα από τους συνδέσμους προς στο αρχείο.
