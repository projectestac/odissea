...
/**
 * Strings for component 'attendanceregister', language 'el', version '4.1'.
 *
...
$string['mandatoryofflinespecifycourse_help'] = 'Ο καθορισμός ενός μαθήματος σε συνόδους εκτός σύνδεσης θα είναι υποχρεωτικός';
$string['maynotaddselfcertforother'] = 'Δεν μπορείτε να προσθέσετε σύνοδο εκτός σύνδεσης για άλλο χρήστη.';
...
$string['recalc_scheduled'] = 'Ο επανυπολογισμός συνόδων έχει χρονοπρογραμματιστεί. Θα εκτελεστεί στην επόμενη Cron';
$string['recalc_scheduled_on_next_cron'] = 'Ο επανυπολογισμός συνόδων έχει χρονοπρογραμματιστεί για εκτέλεση στην επόμενη Cron';
...
$string['sessiontimeout'] = 'Λήξη χρονικού ορίου συνόδου εντός σύνδεσης';
