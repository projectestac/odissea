...
/**
 * Strings for component 'tool_xmldb', language 'el', version '4.4'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['extraindexesfound'] = 'Βρέθηκαν επιπλέον ευρετήρια';
$string['field'] = 'Πεδίο';
...
$string['nomissingorextraindexesfound'] = 'Δεν βρέθηκαν χαμένα ή επιπλέον ευρετήρια, επομένως δεν απαιτείται περαιτέρω ενέργεια.';
...
$string['yesextraindexesfound'] = 'Βρέθηκαν τα ακόλουθα πρόσθετα ευρετήρια.';
