...
/**
 * Strings for component 'plugin', language 'el', version '4.4'.
 *
 * @package     plugin
 * @category    string
...
$string['incompatibleversion'] = 'Μη συμβατή έκδοση Moodle: {$a}';
...
$string['type_h5plib'] = 'Πλαίσιο H5P';
$string['type_h5plib_plural'] = 'Πλαίσια H5P';
...
$string['type_paygw'] = 'Πύλη πληρωμών';
$string['type_paygw_plural'] = 'Πύλες πληρωμών';
$string['type_paygwmanage'] = 'Διαχείριση πυλών πληρωμών';
...
$string['type_theme'] = 'Αισθητικό θέμα';
$string['type_theme_plural'] = 'Αισθητικά θέματα';
...
$string['updatepluginconfirmwarning'] = 'Παρακαλούμε, σημειώστε ότι το Moodle δεν θα δημιουργήσει αυτόματα αντίγραφο ασφαλείας της βάσης δεδομένων σας πριν από την αναβάθμιση. Συνιστάται ένθερμα να δημιουργήσετε τώρα ένα πλήρες ακριβές αντίγραφο ασφαλείας, για να αντιμετωπίσετε τη σπάνια περίπτωση που ο νέος κώδικας έχει σφάλματα που καθιστούν τον ιστότοπό σας μη διαθέσιμο ή ακόμα και καταστρέφει τη βάση δεδομένων σας. Προχωρήστε με δική σας ευθύνη.';
...
$string['validationmsg_targetexists_help'] = 'Ο φάκελος του πρόσθετου υπάρχει ήδη και θα αντικατασταθεί από το περιεχόμενο του πακέτου του πρόσθετου.';
