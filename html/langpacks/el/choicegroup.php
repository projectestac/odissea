...
/**
 * Strings for component 'choicegroup', language 'el', version '4.4'.
 *
 * @package     choicegroup
 * @category    string
...
$string['maxenrollments'] = 'Μέγιστο εγγραφών';
$string['maxenrollments_help'] = 'Αυτή η επιλογή επιτρέπει τον περιορισμό του αριθμού των εγγραφών ενός συμμετέχοντα σε ομάδες. Χρησιμοποιήστε την προεπιλεγμένη τιμή **0** αν δεν υπάρχει περιορισμός.';
$string['members/'] = 'Μέλη';
...
$string['notanswered'] = 'Δεν απαντήθηκε ακόμη';
...
$string['skipresultgraph'] = 'Παράλειψη του γραφήματος αποτελεσμάτων';
$string['sortgroupsby'] = 'Ταξινόμηση ομάδων κατά';
$string['spaceleft'] = 'θέση διαθέσιμη';
$string['spacesleft'] = 'θέσεις διαθέσιμες';
$string['systemdefault_date'] = 'Προεπιλογή συστήματος (αυτή τη στιγμή Ημερομηνία δημιουργίας ομάδας)';
$string['systemdefault_name'] = 'Προεπιλογή συστήματος (αυτή τη στιγμή Όνομα)';
