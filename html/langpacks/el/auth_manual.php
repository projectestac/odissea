...
/**
 * Strings for component 'auth_manual', language 'el', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_manual
...
$string['expiration_warning_desc'] = 'Αριθμός ημερών πριν από τη λήξη του κωδικού πρόσβασης, που αποστέλλεται μια ειδοποίηση.';
