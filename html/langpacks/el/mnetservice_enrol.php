...
/**
 * Strings for component 'mnetservice_enrol', language 'el', version '4.1'.
 *
...
$string['refetch'] = 'Ξανά εύρεσης/λήψη της ενημερωμένης κατάστασης από τους απομακρυσμένους Η/Υ δικτύου';
