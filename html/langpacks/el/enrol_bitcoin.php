...
/**
 * Strings for component 'enrol_bitcoin', language 'el', version '4.4'.
 *
...
$string['BTC'] = 'Bitcoin';
$string['EEK'] = 'Εσθονική κορώνα';
$string['JEP'] = 'Λίρα Τζέρσεϋ';
$string['MTL'] = 'Λίρα Μάλτας';
$string['TMM'] = 'Μανάτ του Τουρκμενιστάν';
$string['XAG'] = 'Ουγγιές αργύρου';
$string['XAU'] = 'Ουγγιές χρυσού';
$string['ZMW'] = 'Κουάτσα Ζάμπιας';
$string['apikey'] = 'Κλειδί API Bitcoin';
$string['apisecret'] = 'Μυστικό κλειδί API Bitcoin';
$string['assignrole'] = 'Ανάθεση ρόλου';
$string['bitcoin:manage'] = 'Διαχείριση εγγεγραμμένων χρηστών';
$string['bitcoin:unenrol'] = 'Ακύρωση εγγραφής χρηστών στο μάθημα';
$string['bitcoin:unenrolself'] = 'Ακύρωση εγγραφής στο μάθημα';
