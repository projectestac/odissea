...
/**
 * Strings for component 'workshopallocation_scheduled', language 'el', version '3.11'.
 *
...
$string['resultfailedconfig'] = 'Η προγραμματισμένη εκχώρηση έχει μη έγκυρες ρυθμίσεις';
