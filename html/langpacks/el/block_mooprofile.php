...
/**
 * Strings for component 'block_mooprofile', language 'el', version '4.1'.
 *
...
$string['displaylastaccess'] = 'Εμφάνιση τελευταίας πρόσβασης';
$string['displaymessage'] = 'Εμφάνιση μηνύματος';
$string['displayname'] = 'Εμφάνιση ονόματος';
$string['displayphone1'] = 'Εμφάνιση τηλεφωνικού αριθμού 1';
$string['displayphone2'] = 'Εμφάνιση τηλεφωνικού αριθμού 2';
