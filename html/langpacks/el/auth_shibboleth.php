...
/**
 * Strings for component 'auth_shibboleth', language 'el', version '4.1'.
 *
...
$string['auth_shib_convert_data_filepath_warning'] = 'Δεν μπορείτε να χρησιμοποιήσετε ένα αρχείο που βρίσκεται μέσα στον τρέχοντα κατάλογο δεδομένων ιστοτόπου ($CFG->dataroot) ως το API τροποποίησης δεδομένων.';
...
$string['auth_shib_instructions'] = 'Χρησιμοποιήστε το <a href="{$a}">Shibboleth login</a> για πρόσβαση μέσω Shibboleth, εάν το ίδρυμά σας το υποστηρίζει. Διαφορετικά, χρησιμοποιήστε την κανονική φόρμα σύνδεσης που εμφανίζεται εδώ.';
$string['auth_shib_instructions_help'] = 'Εδώ πρέπει να παρέχετε οδηγίες στους χρήστες για επεξήγηση του Shibboleth. Θα εμφανίζονται στην σελίδα σύνδεσης/εισόδου στον χώρο πληροφοριών. Αυτές οι πληροφορίες πρέπει να περιλαμβάνουν ένα σύνδεσμο προς «<b>{$a}</b>» στον οποίο θα κάνουν κλικ οι χρήστες όταν θέλουν να συνδεθούν.';
