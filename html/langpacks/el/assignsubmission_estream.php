...
/**
 * Strings for component 'assignsubmission_estream', language 'el', version '4.4'.
 *
...
$string['uploadok'] = 'Ανέβηκε με επιτυχία!<br /><br />Παρακαλούμε, κάντε κλικ στο «Αποθήκευση αλλαγών» για αποθήκευση.';
