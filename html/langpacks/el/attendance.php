...
/**
 * Strings for component 'attendance', language 'el', version '3.11'.
 *
 * @package     attendance
 * @category    string
...
$string['attendancefile_help'] = 'Το αρχείο πρέπει να είναι ένα αρχείο CSV με μια γραμμή επικεφαλίδων και πεδία για την αναγνώριση του χρήστη και την ώρα καταγραφής της συμμετοχής π.χ. (διεύθ. ηλε.ταχυδρομείου, χρόνοςσάρωσης) ή (όνομα χρήστη, ώρα)';
...
Η παρουσία σας στο %coursename% %enteryname% έχει πέσει κάτω από το %warningpercent% και αυτή τη στιγμή είναι %percent% - ελπίζουμε ότι είστε καλά!

Για να αξιοποιήσετε στο έπακρο αυτό το μάθημα, θα πρέπει να βελτιώσετε την παρουσία σας, παρακαλούμε επικοινωνήστε μαζί μας αν χρειάζεστε οποιαδήποτε περαιτέρω υποστήριξη.';
...
$string['enablecalendar_desc'] = 'Εάν ενεργοποιηθεί, θα δημιουργηθεί ένα γεγονός ημερολογίου για κάθε σύνοδο συμμετοχής. Αφού αλλάξετε αυτήν τη ρύθμιση, θα πρέπει να εκτελέσετε την αναφορά επαναρχικοποίησης ημερολογίου.';
...
Μπορείτε να χρησιμοποιήσετε αυτήν τη λειτουργία για να αποκρύψετε παλαιότερες συνόδους αντί να τις διαγράψετε. Μόνο ορατές σύνοδοι θα εμφανίζονται στο βαθμολόγιο.';
...
$string['indicator:cognitivedepth_help'] = 'Αυτός ο δείκτης βασίζεται στο βάθος κατανόησης που επιτεύχθηκε από τον μαθητή σε μια δραστηριότητα Παρουσίας.';
$string['indicator:cognitivedepthdef'] = 'Βάθος κατανόησης παρουσίας';
$string['indicator:socialbreadth'] = 'Κοινωνικό εύρος παρουσίας';
$string['indicator:socialbreadth_help'] = 'Αυτός ο δείκτης βασίζεται στο κοινωνικό εύρος που επιτεύχθηκε από τον μαθητή σε μια δραστηριότητα Παρουσίας.';
...
$string['mobilesessionto_help'] = 'Επιτρέπει στη λίστα των συνόδων να περιορίζεται ώστε να εμφανίζει μόνο ένα μικρό αριθμό απ μελλοντικές συνόδους.';
...
$string['modulename_help'] = 'Το άρθρωμα δραστηριότητας παρακολούθησης επιτρέπει σε έναν διδάσκοντα να σημειώνει τις παρουσίες κατά τη διάρκεια του μαθήματος και στους μαθητές να βλέπουν το δικό τους αρχείο παρουσιών.

Ο διδάσκοντας μπορεί να δημιουργήσει πολλαπλές συνόδους και να επισημάνει την κατάσταση παρουσίας ως «Παρόν», «Απών», «Καθυστερημένος», ή «Δικαιολογημένος» ή να τροποποιήσει τις καταστάσεις ανάλογα με τις ανάγκες.
...
$string['preferences_desc'] = 'Οι αλλαγές στους ορισμούς κατάστασης θα επηρεάσουν τις υπάρχουσες συνόδους παρουσίας και ενδέχεται να επηρεάσουν τη βαθμολόγηση.';
...
$string['priorto'] = 'Η ημερομηνία συνόδου είναι πριν από την ημερομηνία έναρξης του μαθήματος ({$a}) έτσι ώστε οι νέες σύνοδοι που έχουν προγραμματιστεί πριν από αυτήν την ημερομηνία να είναι κρυφές (μη προσβάσιμες). Μπορείτε να αλλάξετε την ημερομηνία έναρξης του μαθήματος ανά πάσα στιγμή (δείτε τις ρυθμίσεις μαθήματος) για να έχετε πρόσβαση σε προηγούμενες συνεδρίες.<br /><br />Παρακαλούμε, αλλάξτε την ημερομηνία συνόδου ή απλώς κάντε κλικ στο πλήκτρο «Προσθήκη συνόδου» ξανά για επιβεβαίωση!';
...
$string['warnafter_help'] = 'Οι προειδοποιήσεις προκαλούνται μόνο όταν ο χρήστης έχει λάβει τη συμμετοχή του για τουλάχιστον αυτόν τον αριθμό περιόδων σύνδεσης.';
