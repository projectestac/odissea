...
/**
 * Strings for component 'enrol_authorizedotnet', language 'el', version '4.5'.
 *
...
$string['authorizedotnet:config'] = 'Ρύθμιση παραμέτρων στιγμιοτύπων εγγραφών Authorize.net';
$string['authorizedotnet:manage'] = 'Διαχείριση εγγεγραμμένων χρηστών';
$string['authorizedotnet:unenrol'] = 'Ακύρωση εγγραφής χρηστών στο μάθημα';
$string['authorizedotnet:unenrolself'] = 'Ακύρωση εγγραφής στο μάθημα';
$string['cost'] = 'Κόστος εγγραφής';
$string['costerror'] = 'Το κόστος εγγραφής δεν είναι αριθμητικό';
$string['costorkey'] = 'Παρακαλούμε, επιλέξτε μια από τις ακόλουθες μεθόδους εγγραφής.';
$string['currency'] = 'Νόμισμα';
$string['defaultrole'] = 'Προεπιλεγμένη ανάθεση ρόλου';
$string['enrolenddate'] = 'Ημερομηνία τέλους';
$string['enrolenddate_help'] = 'Εάν ενεργοποιηθεί, οι χρήστες μπορούν να κάνουν εγγραφή μόνο μέχρι αυτή την ημερομηνία.';
...
$string['mailteachers'] = 'Ειδοποίηση διδασκόντων';
$string['pluginname'] = 'Authorize.net';
$string['status'] = 'Να επιτρέπονται εγγραφές Authorize.net';
$string['transactionkey'] = 'Κλειδί συναλλαγής Authorize.net';
