...
$string['all'] = 'Όλα';
$string['ariadayfilter'] = 'Στοιχεία φίλτρου χρονολογίου';
$string['ariadayfilteroption'] = '{$a} επιλογή φίλτρου';
$string['ariaeventlistitem'] = 'Η δραστηριότητα {$a->name} στο {$a->course} αναμένεται στις {$a->date}';
$string['ariaeventlistpagelimit'] = 'Εμφάνιση {$a} δραστηριοτήτων ανά σελίδα';
$string['ariaeventlistpaginationnavcourses'] = 'Δραστηριότητες χρονολογίου για την σελιδοποίηση του μαθήματος «{$a}»';
...
$string['next6months'] = 'Επόμενοι 6 μήνες';
$string['next7days'] = 'Επόμενες 7 ημέρες';
$string['nocoursesinprogress'] = 'Καθόλου μαθήματα σε εξέλιξη';
$string['noevents'] = 'Δεν οφείλονται καθόλου επερχόμενες δραστηριότητες';
$string['overdue'] = 'Εκπρόθεσμα';
$string['pluginname'] = 'Χρονολόγιο';
...
$string['timeline:myaddinstance'] = 'Προσθήκη στο Ταμπλό ενός νέου μπλοκ Χρονολόγιο';
