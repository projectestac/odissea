...
/**
 * Strings for component 'filters', language 'el', version '3.11'.
 *
 * @package     filters
 * @category    string
...
$string['coursevalue'] = 'αξία μαθήματος';
...
$string['limiterfor'] = '{$a} περιοριστής πεδίου';
...
$string['replacefilters'] = 'Αντικατάσταση φίλτρων';
