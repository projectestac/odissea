...
/**
 * Strings for component 'role', language 'el', version '3.8'.
 *
 * @package     role
 * @category    string
...
$string['category:viewcourselist'] = 'Εμφάνιση λίστας μαθημάτων στα οποία δεν είστε εγγεγραμμένοι';
...
$string['grade:sharegradingforms'] = 'Διαμοιρασμός φόρμας προχωρημένης βαθμολόγησης ως υποδείγματος';
...
$string['h5p:deploy'] = 'Επιτρέπει χρήση περιεχομένου H5P';
...
$string['managerdescription'] = 'Οι διαχειριστές μπορούν να έχουν πρόσβαση σε μαθήματα και να τα τροποποιούν, αλλά συνήθως δεν συμμετέχουν σε αυτά.';
