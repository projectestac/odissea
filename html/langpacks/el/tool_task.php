...
/**
 * Strings for component 'tool_task', language 'el', version '4.4'.
 *
 * @package     tool_task
 * @category    string
...
$string['adhocempty'] = 'Η ουρά εργασιών ειδικού σκοπού είναι κενή';
$string['adhocqueueold'] = 'Η παλαιότερη εργασία είναι {$a->age} που είναι μεγαλύτερη από {$a->max}';
$string['adhocqueuesize'] = 'Η ουρά εργασιών ειδικού σκοπού έχει {$a} εργασίες';
...
$string['backtoscheduledtasks'] = 'Επιστροφή στις χρονοπρογραμματισμένες εργασίες';
...
$string['checkadhocqueue'] = 'Η ουρά εργασιών ειδικού σκοπού';
...
$string['clearfaildelay_confirm'] = 'Σίγουρα θέλετε να εκκαθαρίσετε την καθυστέρηση αποτυχίας για την εργασία «{$a}»; Μετά την εκκαθάριση της καθυστέρησης, η εργασία θα εκτελεστεί σύμφωνα με το κανονικό της χρονοπρόγραμμα.';
...
$string['disabled_help'] = 'Οι απενεργοποιημένες χρονοπρογραμματισμένες εργασίες δεν εκτελούνται από το cron, ωστόσο μπορούν να εκτελεστούν χειρονακτικά μέσω του εργαλείου CLI (Command-Line Interface).';
$string['edittaskschedule'] = 'Επεξεργασία χρονοπρογράμματος εργασιών: {$a}';
$string['enablerunnow'] = 'Επιτρέψτε την επιλογή «Εκτέλεση τώρα» για χρονοπρογραμματισμένες εργασίες';
$string['enablerunnow_desc'] = 'Επιτρέπει στους διαχειριστές να εκτελούν αμέσως μια χρονοπρογραμματισμένη εργασία αμέσως, αντί να περιμένουν να εκτελούνται όπως έχει προγραμματιστεί. Το χαρακτηριστικό αυτό απαιτεί το «Μονοπάτι προς το εκτελέσιμο αρχείο της PHP» (pathtophp) να έχει οριστεί στις διαδρομές του συστήματος. Η εργασία εκτελείται στον εξυπηρετητή ιστού, επομένως ίσως θελήσετε να απενεργοποιήσετε αυτήν τη δυνατότητα για να αποφύγετε τυχόν προβλήματα επιδόσεων.';
$string['faildelay'] = 'Καθυστέρηση αποτυχίας';
$string['fromcomponent'] = 'Από το στοιχείο: {$a}';
$string['hostname'] = 'Όνομα κεντρικού Η/Υ';
$string['lastcronstart'] = 'Χρόνος από την τελευταία εκτέλεση cron: {$a}';
...
$string['pluginname'] = 'Ρυθμίσεις χρονοπρογραμματισμένων εργασιών';
$string['privacy:metadata'] = 'Το πρόσθετο «Ρυθμίσεις χρονοπρογραμματισμένων εργασιών» δεν αποθηκεύει κανένα προσωπικό δεδομένο.';
$string['resettasktodefaults'] = 'Επαναφορά του χρονοπρογράμματος εργασιών στις προεπιλογές';
$string['resettasktodefaults_help'] = 'Αυτό θα απορρίψει τυχόν τοπικές αλλαγές και θα επαναφέρει το χρονοπρόγραμμα αυτής της εργασίας πίσω στις αρχικές του ρυθμίσεις.';
...
$string['scheduledtaskchangesdisabled'] = 'Τροποποιήσεις στη λίστα των χρονοπρογραμματισμένων εργασιών έχουν αποτραπεί στις ρυθμίσεις του Moodle';
$string['scheduledtasks'] = 'Χρονοπρογραμματισμένες εργασίες';
