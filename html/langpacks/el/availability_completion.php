...
/**
 * Strings for component 'availability_completion', language 'el', version '4.5'.
 *
...
$string['option_complete'] = 'πρέπει να έχει επισημανθεί ως ολοκληρωμένη';
...
$string['requires_previous_complete'] = 'Η <strong>προηγούμενη δραστηριότητα με ολοκλήρωση</strong> είναι επισημασμένη ως ολοκληρωμένη';
