...
$string['completiondetail:reachend'] = 'Περάστε τη δραστηριότητα μέχρι το τέλος';
$string['completiondetail:timespent'] = 'Περάστε τουλάχιστον {$a} σε αυτήν τη δραστηριότητα';
...
$string['editinglesson'] = 'Επεξεργασία διδασκαλίας';
$string['editingquestionpage'] = 'Επεξεργασία σελίδας ερώτησης {$a}';
$string['editlesson'] = 'Επεξεργασία διδασκαλίας';
...
$string['emailsuccess'] = 'Οι ειδοποιήσεις στάλθηκαν με επιτυχία';
...
$string['lessonbeingpreviewed'] = 'Η διδασκαλία βρίσκεται υπό προεπισκόπηση.';
...
$string['manageoverrides'] = 'Διαχείριση παρακάμψεων';
...
$string['nooverridecreated'] = 'Δεν έχουν δημιουργηθεί παρακάμψεις.';
...
$string['selectreport'] = 'Επιλέξτε αναφορά';
