...
/**
 * Strings for component 'dataformview_interval', language 'el', version '3.11'.
 *
...
$string['interval'] = 'Διάστημα';
$string['lastpage'] = 'Τελευταία σελίδα';
$string['monthly'] = 'Μηνιαία';
$string['nextpage'] = 'Επόμενη σελίδα';
$string['pluginname'] = 'Διάστημα';
$string['randomentries'] = 'Τυχαίες καταχωρήσεις';
$string['randompage'] = 'Τυχαία σελίδα';
$string['refresh'] = 'Ανανέωση';
$string['selection'] = 'Ποιές καταχωρήσεις να επιλεγούν';
