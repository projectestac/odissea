...
/**
 * Strings for component 'tool_analytics', language 'el', version '4.5'.
 *
...
$string['clievaluationandpredictions'] = 'Μια χρονοπρογραμματισμένη εργασία εκτελείται για κάθε ενεργοποιημένο μοντέλο και εξάγει προβλέψεις. Η αξιολόγηση των μοντέλων μέσω της διεπαφής ιστού είναι απενεργοποιημένη. Μπορείτε να επιτρέψετε με χειροκίνητο τρόπο την εκτέλεση αυτών των διαδικασιών μέσω της διεπαφής ιστού, απενεργοποιώντας τη ρύθμιση αναλυτικής<a href="{$a}"> «onlycli»</a>(only command line interface: διεπαφή γραμμής εντολών μόνο).';
$string['clievaluationandpredictionsnoadmin'] = 'Μια χρονοπρογραμματισμένη εργασία εκτελείται για κάθε ενεργοποιημένο μοντέλο και εξάγει προβλέψεις. Η αξιολόγηση των μοντέλων μέσω της διεπαφής ιστού είναι απενεργοποιημένη. Μπορεί να επιτραπεί από ένα διαχειριστή του ιστοτόπου.';
...
$string['executescheduledanalysis'] = 'Εκτέλεση χρονοπρογραμματισμένης ανάλυσης';
...
$string['pluginname'] = 'Μοντέλα Αναλυτικής';
...
$string['trainmodels'] = 'Εκπαίδευση Μοντέλων';
...
$string['weeksenddateautomaticallyset'] = 'Η ημερομηνία λήξης ορίστηκε αυτόματα με βάση την ημερομηνία έναρξης και τον αριθμό των ενοτήτων';
