...
/**
 * Strings for component 'enrol_ldap', language 'el', version '3.11'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['autoupdate_settings_desc'] = '<p>Επιλέξτε πεδία για ενημέρωση όταν εκτελείται το χρονοδρομολογημένο σενάριο «Συγχρονισμός εγγραφών LDAP».</p><p>Όταν επιλεγεί τουλάχιστον ένα πεδίο, θα γίνει μια ενημέρωση.</p>';
...
$string['phpldap_noextension'] = 'Το άρθρωμα PHP  LDAP δεν φαίνεται να υπάρχει. Παρακαλούμε επιβεβαιώστε ότι είναι εγκατεστημένο και ενεργοποιημένο αν θέλετε να χρησιμοποιήσετε αυτό το πρόσθετο εγγραφής.';
