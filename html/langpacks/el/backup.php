...
/**
 * Strings for component 'backup', language 'el', version '3.11'.
 *
 * @package     backup
 * @category    string
...
$string['userdata_help'] = 'Εάν ενεργοποιηθεί, δεδομένα όπως δημοσιεύσεις φόρουμ, υποβολές αναθέσεων κ.λπ. θα αντιγραφούν στο νέο μάθημα για οποιουσδήποτε χρήστες με επιλεγμένο ρόλο στο «Συμπερίληψη εγγραφών ρόλων».';
