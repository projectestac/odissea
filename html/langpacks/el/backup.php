...
/**
 * Strings for component 'backup', language 'el', version '4.5'.
 *
 * @package     backup
 * @category    string
...
$string['questioncannotberestored'] = 'Δεν είναι δυνατή η δημιουργία της κατηγορίας ερωτήσεων «{$a->name}» κατά την επαναφορά';
