...
/**
 * Strings for component 'form', language 'el', branch 'MOODLE_38_STABLE'
 *
 * @package   form
...
$string['err_email'] = 'Πρέπει να εισάγετε μια έγκυρη διεύθυνση ηλε.ταχυδρομείου εδώ.';
$string['err_lettersonly'] = 'Πρέπει να εισάγετε μόνο γράμματα εδώ.';
$string['err_maxfiles'] = 'Δεν μπορείτε να επισυνάψετε περισσότερα από {$a} αρχεία εδώ.';
$string['err_maxlength'] = 'Δεν πρέπει να εισαγάγετε περισσότερους από {$a->format} χαρακτήρες εδώ.';
$string['err_minlength'] = 'Πρέπει να εισάγετε τουλάχιστον {$a->format} χαρακτήρες εδώ.';
...
$string['selecteditems'] = 'Επιλεγμένα στοιχεία:';
