...
/**
 * Strings for component 'report_eventlist', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['privacy:metadata'] = 'Το πρόσθετο «Λίστα γεγονότων» δεν αποθηκεύει κανένα προσωπικό δεδομένο.';
