...
/**
 * Strings for component 'scorm', language 'el', version '3.11'.
 *
 * @package     scorm
 * @category    string
...
$string['completiondetail:completionstatuscompletedandpassed'] = 'Ολοκληρώστε και περάστε τη δραστηριότητα';
