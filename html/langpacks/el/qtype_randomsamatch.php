...
/**
 * Strings for component 'qtype_randomsamatch', language 'el', version '4.1'.
 *
...
$string['subcats'] = 'Συμπερίληψη υποκατηγοριών';
$string['subcats_help'] = 'Εάν επιλεγεί, οι ερωτήσεις θα επιλεγούν και από τις υποκατηγορίες.';
