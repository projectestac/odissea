...
/**
 * Strings for component 'tool_lp', language 'el', version '3.11'.
 *
 * @package     tool_lp
 * @category    string
...
$string['cannotcreateuserplanswhentemplateduedateispassed'] = 'Δεν μπορούν να δημιουργηθούν νέα σχέδια μάθησης. Η ημερομηνία λήξης του υποδείγματος έχει εκπνεύσει ή εκπνέει.';
...
$string['deletetemplate'] = 'Διαγραφή υποδείγματος σχεδίου μάθησης «{$a}»;';
$string['deletetemplatewithplans'] = 'Αυτό το υπόδειγμα έχει συσχετισμένα σχέδια μάθησης. Πρέπει να δείξετε πως θα γίνεται η επεξεργασία αυτών των σχεδίων.';
...
$string['edittemplate'] = 'Επεξεργασία υποδείγματος σχεδίου μάθησης';
...
$string['listtemplatescaption'] = 'Λίστα υποδειγμάτων σχεδίου μάθησης';
...
$string['notemplates'] = 'Δεν δημιουργήθηκαν ακόμη καθόλου υποδείγματα σχεδίου μάθησης.';
...
$string['nouserplans'] = 'Δεν δημιουργήθηκε κανένα σχέδιο μάθησης ακόμη.';
...
$string['templateupdated'] = 'Το υπόδειγμα σχεδίου μάθησης ενημερώθηκε.';
...
$string['xplanscompletedoutofy'] = 'Ολοκληρώθηκαν {$a->x} από τα {$a->y} σχέδια μάθησης από αυτό το υπόδειγμα';
