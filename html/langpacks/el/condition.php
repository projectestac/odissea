...
/**
 * Strings for component 'condition', language 'el', version '3.11'.
 *
 * @package     condition
 * @category    string
...
$string['availableuntil'] = 'Επιτρέπεται η πρόσβαση εώς';
...
$string['completionconditionsection_help'] = 'Αυτή η ρύθμιση καθορίζει τις συνθήκες ολοκλήρωσης της δραστηριότητας που πρέπει να πληρούνται για την πρόσβαση στο τμήμα. Λάβετε υπόψη ότι η παρακολούθηση ολοκλήρωσης πρέπει πρώτα να οριστεί πριν από τη ρύθμιση μιας συνθήκης/προϋπόθεσης ολοκλήρωσης δραστηριότητας.

Μπορούν να οριστούν πολλαπλές συνθήκες ολοκλήρωσης δραστηριότητας, εάν είναι επιθυμητό. Σε αυτή την περίπτωση, η πρόσβαση στο τμήμα θα επιτρέπεται μόνο όταν πληρούνται ΟΛΕΣ οι συνθήκες ολοκλήρωσης της δραστηριότητας.';
...
$string['gradeconditionsection_help'] = 'Αυτή η ρύθμιση καθορίζει τυχόν συνθήκες βαθμών που πρέπει να πληρούνται για την πρόσβαση στο τμήμα.

Μπορούν να οριστούν πολλαπλές συνθήκες βαθμών εάν είναι επιθυμητό. Αν ναι, το τμήμα θα επιτρέψει την πρόσβαση μόνο όταν πληρούνται ΟΛΕΣ οι συνθήκες βαθμών .';
...
$string['groupingnoaccess'] = 'Δεν ανήκετε αυτήν την στιγμή σε μια ομάδα που έχει πρόσβαση σε αυτό το τμήμα.';
...
$string['showavailabilitysection'] = 'Πριν επιτραπεί η πρόσβαση στο τμήμα';
$string['showavailabilitysection_hide'] = 'Πλήρης απόκρυψη τμήματος';
$string['showavailabilitysection_show'] = 'Εμφάνιση τμήματος γκριζαρισμένου, με πληροφορίες περιορισμού';
