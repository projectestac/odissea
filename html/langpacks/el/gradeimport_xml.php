...
/**
 * Strings for component 'gradeimport_xml', language 'el', version '4.4'.
 *
...
$string['fileurl_help'] = 'Το πεδίο διεύθυνσης URL απομακρυσμένου αρχείου είναι για την εύρεση & ανάκτηση δεδομένων από έναν απομακρυσμένο εξυπηρετητή, π.χ. ένα πληροφοριακό σύστημα μαθητών.';
