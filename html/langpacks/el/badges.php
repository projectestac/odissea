...
/**
 * Strings for component 'badges', language 'el', version '3.8'.
 *
 * @package     badges
 * @category    string
...
$string['backpackemailverifypending'] = 'Ένα μήνυμα επαλήθευσης στάλθηκε μέσω ηλ.ταχυδρομείου στο <strong>{$a}</strong>. Κάντε κλικ στο σύνδεσμο επαλήθευσης στο μήνυμα για να ενεργοποιήσετε τη σύνδεση με το Σακίδιο (με τα διακριτικά) σας.';
...
$string['error:nobadges'] = 'Αυτήν τη στιγμή δεν υπάρχουν διακριτικά με ενεργοποιημένη την πρόσβαση για να προστεθούν ως κριτήρια. Ένα διακριτικό ιστοτόπου μπορεί να έχει μόνο άλλα διακριτικά ιστότοπου ως κριτήρια. Ένα διακριτικό μαθήματος μπορεί να έχει άλλα διακριτικά μαθημάτων ή σήματα ιστότοπου ως κριτήρια.';
