...
/**
 * Strings for component 'badges', language 'el', version '4.4'.
 *
 * @package     badges
 * @category    string
...
$string['awardedto'] = 'Απονεμήθηκε στον/στην {$a}';
...
$string['backpackconnected'] = 'Το σακίδιο είναι συνδεδεμένο';
$string['backpackconnection'] = 'Σύνδεση σακιδίου';
$string['backpackconnection_help'] = 'Η σύνδεση σε ένα σακίδιο σας επιτρέπει να κάνετε κοινή χρήση των σημάτων σας από αυτόν τον ιστότοπο και να εμφανίζετε δημόσιες συλλογές διακριτικών από το σακίδιο σας, στη σελίδα του προφίλ σας σε αυτόν τον ιστότοπο.';
...
$string['backpackdisconnected'] = 'Το σακίδιο έχει αποσυνδεθεί';
...
$string['backpackexporterror'] = 'Δεν είναι δυνατή η εξαγωγή του διακριτικού στο σακίδιο';
...
$string['backpackprovider'] = 'Πάροχος σακιδίου';
...
$string['coursebadgetitle'] = 'Διακριτικό μαθήματος {$a}';
...
$string['criteria_descr_0'] = 'Συμπληρώστε <strong>{$a}</strong> από τις απαιτήσεις της λίστας.';
...
$string['defaultissuercontact_desc'] = 'Μια διεύθυνση ηλε.ταχυδρομείου που συσχετίζεται με τον εκδότη διακριτικού. Για ένα σακίδιο Open Badges v2.0, αυτή χρησιμοποιείται για την αυθεντικοποίηση κατά την έκδοση διακριτικών σε ένα σακίδιο.';
...
$string['delexternalbackpack'] = 'Διαγραφή σακιδίου ιστοτόπου';
...
$string['includeauthdetails'] = 'Συμπερίληψη λεπτομερειών ελέγχου ταυτότητας με το σακίδιο';
...
$string['issuedby'] = 'Εκδόθηκε από {$a}';
$string['issuedon'] = 'Εκδόθηκε {$a}';
...
$string['localconnectto'] = 'Για να κάνετε κοινή χρήση αυτών των διακριτικών έξω από αυτόν τον ιστότοπο, πρέπει να <a href="{$a}">συνδεθείτε με μια υπηρεσία σακιδίου (με διακριτικά)</a>.';
...
$string['never'] = 'Ποτέ';
$string['newbackpack'] = 'Προσθήκη νέου σακιδίου';
...
$string['oauth2issuer'] = 'Υπηρεσίες OAuth 2';
...
$string['privacy:metadata:backpackoauth2'] = 'Πληροφορίες OAuth 2 όταν ο χρήστης συνδέεται σε ένα εξωτερικό σακίδιο';
$string['privacy:metadata:backpackoauth2:issuerid'] = 'Αναγνωριστικό υπηρεσίας OAuth 2';
$string['privacy:metadata:backpackoauth2:scope'] = 'Λίστα πεδίου εφαρμογής της σύνδεσης σακιδίου';
$string['privacy:metadata:backpackoauth2:token'] = 'Κουπόνι σύνδεσης σακίδιου';
$string['privacy:metadata:backpackoauth2:userid'] = 'Το αναγνωριστικό του χρήστη που συνδέεται με σακίδιο';
$string['privacy:metadata:backpackoauth2:usermodified'] = 'Το αναγνωριστικό του χρήστη που τροποποίησε τη σύνδεση';
...
$string['privacy:metadata:external:backpacks'] = 'Πληροφορίες που αποδίδονται σε κοινή χρήση όταν οι χρήστες υποβάλουν τα διακριτικά τους σε ένα εξωτερικό σακίδιο';
...
$string['privacy:metadata:manualaward'] = 'Ένα ιστορικό μη αυτόματα απονεμηθέντων βραβείων';
...
$string['sitebackpackdeleted'] = 'Το σακίδιο ιστοτόπου έχει διαγραφεί.';
$string['sitebackpacknotdeleted'] = 'Αδυναμία διαγραφής αυτού του σακιδίου διότι αυτή τη στιγμή είναι το προεπιλεγμένο του ιστοτόπου.';
...
$string['sitebadgetitle'] = 'Διακριτικό ιστότοπου {$a}';
...
$string['tagarea_badge'] = 'Διακριτικά';
