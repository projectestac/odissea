...
/**
 * Strings for component 'block_mnet_hosts', language 'el', branch 'MOODLE_38_STABLE'
 *
...
$string['error_localusersonly'] = 'Οι απομακρυσμένοι χρήστες δεν μπορούν να μεταπηδήσουν σε άλλους εξυπηρετητές δικτύου MNet από αυτόν τον κεντρικό Η/Υ.';
