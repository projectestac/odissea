...
$string['broken'] = 'Αυτός είναι ένας «κατεστραμμένος σύνδεσμος», δείχνει σε ένα αρχείο που δεν υπάρχει.';
...
$string['changepublishstatuscat'] = '<a href="{$a->caturl}">Η κατηγορία «{$a->name}»</a> στο μάθημα «{$a->coursename}» θα έχει την κατάσταση κοινής χρήσης της αλλαγμένη από <strong>«{$a->changefrom}» σε «{$a->changeto}»</strong>.';
...
Ορισμένες μορφές εισαγωγής, όπως το GIFT και το Moodle XML, επιτρέπουν την συμπερίληψη δεδομένων κατηγορίας και πλαισίου στο αρχείο εξαγωγής, επιτρέποντάς τους (προαιρετικά) να επαναδημιουργηθούν κατά την εισαγωγή. Εάν απαιτείται, πρέπει να επιλεγούν τα κατάλληλα πλαίσια επιλογής.';
...
$string['howquestionsbehave_link'] = '';
...
$string['ignorebroken'] = 'Αγνόηση κατεστραμμένων συνδέσμων';
...
$string['penaltyforeachincorrecttry_help'] = 'Όταν εκτελείτε τις ερωτήσεις σας χρησιμοποιώντας την συμπεριφορά «Διαδραστική με πολλαπλές προσπάθειες» ή την τακτική «Κατάσταση προσαρμογής», έτσι ώστε ο μαθητής να επιτρέπεται να κάνει αρκετές προσπάθειες για να βρει την σωστή απάντηση, τότε αυτή η επιλογή ελέγχει το πόσο τιμωρείται για κάθε λανθασμένη προσπάθεια.
...
$string['published'] = 'κοινόχρηστη';
$string['qbanknotfound'] = 'Το πρόσθετο τράπεζας ερωτήσεων «{$a}» δεν υπάρχει ή δεν αναγνωρίζεται.';
...
$string['questioncategories'] = 'Κατηγορίες ερωτήσεων';
...
$string['shareincontext'] = 'Κοινή χρήση στο πλαίσιο για {$a}';
...
$string['showquestiontext_off'] = 'Όχι';
$string['showquestiontext_plain'] = 'Ναι, μόνο κείμενο';
