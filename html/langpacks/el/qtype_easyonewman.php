...
/**
 * Strings for component 'qtype_easyonewman', language 'el', version '4.5'.
 *
...
$string['caseconformfalse'] = 'Λάθος';
$string['caseconformtrue'] = 'Σωστό';
$string['caseorientfalse'] = 'Λάθος';
$string['caseorientimportant'] = 'Σημαντικό προοπτικά';
