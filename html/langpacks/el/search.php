...
/**
 * Strings for component 'search', language 'el', version '4.5'.
 *
 * @package     search
 * @category    string
...
$string['checkdbadvice'] = 'Ελέγξτε αν η βάση δεδομένων έχει κάποιο πρόβλημα.';
...
$string['doctypenotsupported'] = 'Ο συγκεκριμένος τύπος εγγράφου δεν υποστηρίζεται ακόμη';
...
$string['gradualreindex_queued'] = 'Ζητήθηκε επαν-ευρετηρίαση για {$a->name} ({$a->count} πλαίσια). Η ευρετηρίαση αυτή θα εκτελεστεί από την χρονοπρογραμματισμένη εργασία «Ευρετηρίαση καθολικής αναζήτησης».';
...
$string['queueheading'] = 'Επιπρόσθετη ουρά ευρετηρίου ({$a} στοιχεία)';
...
$string['type'] = 'Τύπος';
$string['uncompleteindexingerror'] = 'Η δημιουργία ευρετηρίου δεν ολοκληρώθηκε. Παρακαλούμε, ξεκινήστε την ξανά.';
$string['versiontoolow'] = 'Λυπούμαστε, η καθολική αναζήτηση απαιτεί PHP έκδοση 5.0.0 ή νεότερη';
