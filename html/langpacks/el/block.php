...
/**
 * Strings for component 'block', language 'el', version '4.1'.
 *
 * @package     block
 * @category    string
...
$string['createdat_help'] = 'Η αρχική τοποθεσία στην οποία δημιουργήθηκε το μπλοκ. Οι ρυθμίσεις του μπλοκ μπορεί να προκαλέσουν την εμφάνισή του σε άλλες θέσεις (πλαίσια) μέσα στην αρχική τοποθεσία. Για παράδειγμα, ένα μπλοκ που δημιουργήθηκε σε μια σελίδα μαθήματος θα μπορούσε να εμφανιστεί σε δραστηριότητες μέσα σε αυτό το μάθημα. Ένα μπλοκ που δημιουργήθηκε στην πρώτη σελίδα μπορεί να εμφανίζεται σε ολόκληρο τον ιστότοπο.';
...
$string['deleteblockinprogress'] = 'Το μπλοκ {$a} καταργείται τώρα από αυτήν τη σελίδα';
...
$string['deletecheck_modal'] = 'Διαγραφή μπλοκ;';
...
$string['showonfrontpageandsubs'] = 'Εμφάνιση στην πρώτη σελίδα και σε οποιαδήποτε σελίδα προστεθεί στην πρώτη σελίδα';
