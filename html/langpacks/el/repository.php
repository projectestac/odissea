...
/**
 * Strings for component 'repository', language 'el', version '4.5'.
 *
 * @package     repository
 * @category    string
...
$string['cleancache'] = 'Καθαρισμός των αρχείων στη κρυφή μνήμη';
...
$string['createinstance'] = 'Δημιουργία ενός στιγμιοτύπου αποθετηρίου';
$string['createrepository'] = 'Δημιουργία ενός στιγμιοτύπου αποθετηρίου';
$string['createxxinstance'] = 'Δημιουργία στιγμιοτύπου «{$a}»';
...
$string['editrepositoryinstance'] = 'Επεξεργασία στιγμιοτύπου αποθετηρίου';
...
$string['erroruniquename'] = 'Το όνομα στιγμιοτύπου αποθετηρίου πρέπει να είναι μοναδικό';
...
$string['nolicenses'] = 'Δεν υπάρχουν διαθέσιμες άδειες χρήσης';
...
$string['privacy:metadata:repository_instances:typeid'] = 'Ο τύπος αναγνωριστικού του στιγμιοτύπου αποθετηρίου.';
...
$string['sectionbackup'] = 'Αντίγραφα ασφαλείας ενότητας';
