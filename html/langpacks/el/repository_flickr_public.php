...
/**
 * Strings for component 'repository_flickr_public', language 'el', version '3.11'.
 *
...
$string['privacy:metadata:repository_flickr_public:email_address'] = 'Η διεύθυνση ηλε.ταχυδρομείου του χρήστη του δημόσιου αποθετηρίου Flickr.';
...
$string['sharealike'] = 'Ναι, αρκεί οι άλλοι να διαμοιράζουν παρομοίως';
$string['tag'] = 'Ετικέτα';
