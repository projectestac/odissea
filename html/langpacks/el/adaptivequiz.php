...
$string['answerdistgraph_numrightwrong'] = 'Αριθ.Σωστών (-)  /  Αριθ.Λανθασμένων (+)';
$string['answerdistgraph_questiondifficulty'] = 'Επίπεδο ερώτησης';
$string['answerdistgraph_title'] = 'Κατανομή απαντήσεων για τον/την {$a->firstname} {$a->lastname}';
...
$string['attemptquestion_error'] = 'Τυπικό σφάλμα (&plusmn;&nbsp;x%)';
...
$string['backtomainreport'] = 'Πίσω στις κύριες αναφορές';
$string['backtoviewattemptreport'] = 'Πίσω στην εμφάνιση αναφοράς προσπάθειας';
$string['backtoviewreport'] = 'Πίσω στις κύριες αναφορές';
...
$string['completeattempterror'] = 'Σφάλμα κατά την προσπάθεια ολοκλήρωσης εγγραφής προσπάθειας';
...
$string['errorclosingattempt'] = 'Το ιστορικό της προσπάθειας δεν βρέθηκε';
$string['errorclosingattempt_alreadycomplete'] = 'Η προσπάθεια αυτή είναι ήδη ολοκληρωμένη. Δεν μπορεί να κλείσει χειροκίνητα.';
$string['errordeletingattempt'] = 'Το ιστορικό της προσπάθειας δεν βρέθηκε';
...
$string['graphlegend_target'] = 'Επίπεδο-στόχος';
...
$string['na'] = 'δ/υ';
$string['name'] = 'Όνομα';
$string['noattemptrecords'] = 'Δεν υπάρχουν εγγραφές προσπάθειας για αυτόν τον μαθητή';
...
$string['numright'] = 'Αριθ. σωστών';
$string['numwrong'] = 'Αριθ. λανθασμένων';
...
$string['score'] = 'Σκορ';
$string['scoring_table'] = 'Πίνακας σκορ';
...
$string['user'] = 'Χρήστης';
$string['value'] = 'Τιμή';
$string['viewreportbtn'] = 'Εμφάνιση αναφοράς';
