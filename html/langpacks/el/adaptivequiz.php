...
/**
 * Strings for component 'adaptivequiz', language 'el', version '4.5'.
 *
...
$string['abilityestimated'] = 'Εκτιμώμενη ικανότητα';
...
$string['attemptsuserprevious'] = 'Οι προηγούμενες προσπάθειές σας';
...
$string['completionattemptcompletedcminfo'] = 'Ολοκληρώστε μια προσπάθεια';
...
$string['reportanswersdistributionchartyaxislabel'] = 'Αριθμός απαντήσεων';
