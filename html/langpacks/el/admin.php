...
/**
 * Strings for component 'admin', language 'el', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['configautolangusercreation'] = 'Εάν ενεργοποιηθεί, όταν ο λογαριασμός ενός χρήστη δημιουργείται αυτόματα, κατά την πρώτη σύνδεση (π.χ. χρησιμοποιώντας αυθεντικοποίηση LDAP ή OAuth 2), η γλώσσα του προγράμματος περιήγησης του χρήστη ορίζεται ως η προτιμώμενη γλώσσα του. Διαφορετικά, ορίζεται ως η προτιμώμενη γλώσσα του χρήστη, η προεπιλεγμένη γλώσσα για τον ιστότοπο.';
...
$string['configuserquota'] = 'Ο μέγιστος αριθμός bytes που μπορεί να αποθηκεύσει ένας χρήστης στην ιδιωτική περιοχή αρχείων του. {$a->bytes} bytes == {$a->displaysize}';
...
$string['divertallemails'] = 'Εκτροπή ηλεκτρονικού ταχυδρομείου';
$string['divertallemailsdetail'] = 'Χρησιμοποιείται για προστασία σε περιβάλλοντα ανάπτυξης κατά τη δοκιμή μηνυμάτων ηλεκτρονικού ταχυδρομείου και δεν πρέπει να χρησιμοποιείται στην παραγωγή.';
$string['divertallemailsexcept'] = 'Εξαιρέσεις εκτροπής ηλεκτρονικού ταχυδρομείου';
$string['divertallemailsexcept_desc'] = 'Μια λίστα κανόνων εξαίρεσης ηλεκτρονικού ταχυδρομείου διαχωρισμένων είτε με κόμμα είτε με αλλαγή γραμμής.
Κάθε κανόνας ερμηνεύεται ως κανονική έκφραση, π.χ. <pre>simone@acme.com
.*@acme.com
fred(\\+.*)?@acme.com
</pre>';
$string['divertallemailsto'] = 'Εκτροπή όλων των μηνυμάτων ηλεκτρονικού ταχυδρομείου';
$string['divertallemailsto_desc'] = 'Εάν οριστεί τότε όλα τα μηνύματα ηλεκτρονικού ταχυδρομείου θα εκτραπούν σε αυτή τη μεμονωμένη διεύθυνση ηλεκτρονικού ταχυδρομείου.';
...
$string['downloadcoursecontentallowed'] = 'Διαθέσιμη δυνατότητα λήψης περιεχομένου μαθήματος';
$string['downloadcoursecontentallowed_desc'] = 'Εάν η δυνατότητα περιεχομένου του μαθήματος λήψης είναι διαθέσιμη σε μαθήματα. Όταν είναι διαθέσιμη, οι λήψεις περιεχομένου μαθημάτων μπορούν να ενεργοποιηθούν/απενεργοποιηθούν χρησιμοποιώντας τη ρύθμιση «Ενεργοποίηση λήψης περιεχομένου μαθήματος» στο μενού επεξεργασίας του μαθήματος (η προεπιλογή για αυτό μπορεί να οριστεί σε  <a href={$a} target="_blank">Προεπιλεγμένες ρυθμίσεις μαθήματος</a>).';
...
$string['profilevisible_help'] = '* Μη ορατό - Για ιδιωτικά δεδομένα ορατά μόνο σε διαχειριστές
...
$string['searchenginequeryonly_desc'] = 'Αυτή η μηχανή αναζήτησης θα χρησιμοποιηθεί μόνο για υποβολή ερωτημάτων, όχι για ευρετηρίαση. Χρησιμοποιώντας αυτήν τη δυνατότητα μπορείτε να δημιουργήσετε νέα ευρετήρια σε μια διαφορετική μηχανή αναζήτησης, ενώ τα ερωτήματα χρήστη συνεχίζουν να λειτουργούν από αυτήν.';
...
$string['searchmanagement_desc'] = 'Αυτές οι επιλογές είναι χρήσιμες κατά την πραγματοποίηση αλλαγών σε ιστότοπους με πολύ μεγάλα ευρετήρια αναζήτησης που χρειάζονται πολύ χρόνο για την αναδημιουργία τους.';
...
$string['taskbackupcleanup'] = 'Καθαρισμός εφεδρικών πινάκων, καταγραφών και αρχείων';
...
$string['userfeedbackencouragement'] = '<p>Το Moodle 3.9 περιλαμβάνει μια νέα λειτουργία που δίνει στους χρήστες τη δυνατότητα να παρέχουν την ανατροφοδότηση για το λογισμικό Moodle στο επιτελείο του Moodle HQ μέσω ενός εξωτερικού ιστοτόπου έρευνας που φιλοξενείται από το Moodle HQ. Δεν προωθούνται πληροφορίες αναγνώρισης χρήστη στον ιστότοπο έρευνας.</p>
