...
/**
 * Strings for component 'admin', language 'el', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['coursepage'] = 'Σελίδα μαθήματος';
...
$string['linkcoursesections'] = 'Πάντα χρήση συνδέσμων προς ενότητες μαθήματος';
$string['linkcoursesections_help'] = 'Προσπαθήστε πάντοτε να παρέχετε ένα σύνδεσμο για τις ενότητες μαθήματος. Οι ενότητες μαθήματος εμφανίζονται συνήθως ως σύνδεσμοι μόνο αν ο μορφότυπος του μαθήματος εμφανίζει μόνο μία ενότητα ανά σελίδα. Αν αυτή η ρύθμιση είναι ενεργοποιημένη, θα παρέχεται πάντα ένας σύνδεσμος.';
...
$string['moodleapp_help'] = '<p>Η δωρεάν εφαρμογή κινητού Moodle επιτρέπει στους χρήστες να έχουν πρόσβαση στα μαθήματά τους από κινητές συσκευές. Πρόσθετα χαρακτηριστικά/δυνατότητες της εφαρμογής είναι διαθέσιμα με ένα πακέτο εφαρμογής Pro (επαγγελματικό) ή Premium (με προνόμια).</p>
