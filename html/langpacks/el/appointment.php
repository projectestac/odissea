...
/**
 * Strings for component 'appointment', language 'el', version '4.5'.
 *
 * @package     appointment
 * @category    string
...
$string['appointment:addinstance'] = 'Προσθήκη στιγμιοτύπου';
...
$string['appointment:viewattendees'] = 'Εμφάνιση της λίστας παρουσιών και των παρόντων';
...
$string['approvalreqd_help'] = 'Όταν το «Απαιτείται έγκριση» είναι επιλεγμένο, ένας εκπαιδευόμενος θα χρειάζεται έγκριση από τον διευθυντή του για να του επιτραπεί να παρακολουθήσει μια σύνοδο Ραντεβού.';
...
$string['cancellationinstrmngr_help'] = 'Όταν επιλεγεί **Αποστολή ειδοποίησης στον διευθυντή**, το κείμενο στο πεδίο **Ειδοποίηση για διευθυντή** αποστέλλεται στον διευθυντή του εκπαιδευόμενου, πληροφορώντας τον ότι μία κράτηση για μια σύνοδο Ραντεβού ακυρώθηκε.';
...
$string['emailmanagercancellation_help'] = 'Όταν επιλεγεί «Αποστολή ειδοποίησης στον διευθυντή», ένα μήνυμα ηλε.ταχυδρομείου αποστέλλεται στον διευθυντή του εκπαιδευόμενου, πληροφορώντας τον ότι η κράτηση για την σύνοδο Ραντεβού ακυρώθηκε.';
$string['emailmanagerconfirmation'] = '# Αποστολή ειδοποίησης στον διευθυντή';
$string['emailmanagerconfirmation_help'] = 'Όταν επιλεγεί «Αποστολή ειδοποίησης στον διευθυντή», ένα μήνυμα ηλε.ταχυδρομείου επιβεβαίωσης αποστέλλεται στον διευθυντή του μαθητευόμενου, όταν ο εκπαιδευόμενος έχει εγγραφεί για μια σύνοδο Ραντεβού.';
$string['emailmanagerreminder'] = '# Αποστολή ειδοποίησης στον διευθυντή';
$string['emailmanagerreminder_help'] = 'Όταν επιλεγεί «Αποστολή ειδοποίησης στον διευθυντή», ένα μήνυμα ηλε.ταχυδρομείου υπενθύμισης θα σταλεί στον διευθυντή του εκπαιδευόμενου λίγες ημέρες πριν την ημερομηνία έναρξης της συνόδου Ραντεβού.';
$string['empty'] = 'Κενό';
...
Αν εισαχθούν **Πολλαπλές διευθύνσεις ηλε.ταχυδρομείου**, πρέπει να διαχωρίζονται με κόμμα. Για παράδειγμα: giannis@paradeigma.gr,stamos@tomeas.gr';
$string['thirdpartywaitlist'] = 'Ειδοποίηση τρίτου-μέρους για συνόδους με λίστα αναμονής';
$string['thirdpartywaitlist_help'] = 'Αν επιλεγεί **Ειδοποίηση τρίτου-μέρους για συνόδους με λίστα αναμονής**, τότε όταν ένας εκπαιδευόμενος εγγραφεί για μια σύνοδο με λίστα αναμονής, θα ειδοποιείται το τρίτο μέρος. Αν δεν επιλεγεί **Ειδοποίηση τρίτου-μέρους για συνόδους με λίστα αναμονής**, το/τα τρίτα μέρη θα ειδοποιούνται μόνο όταν ένας χρήστης εγγραφεί (ή ακυρώσει) για μια χρονοπρογραμματισμένη σύνοδο.';
