...
/**
 * Strings for component 'grading', language 'ru', version '4.4'.
 *
 * @package     grading
 * @category    string
...
$string['manageactionshareconfirm'] = 'Вы собираетесь сохранить копию формы оценивания «{$a}» как новый общий шаблон. Другие пользователи сайта будут иметь возможность для своих элементов курса создавать новые формы оценивания, основанные на этом шаблоне.';
