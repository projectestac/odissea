...
/**
 * Strings for component 'hvp', language 'ru', version '4.5'.
 *
 * @package     hvp
 * @category    string
...
$string['agedescription'] = 'Целевая аудитория этого контента. Возможные форматы ввода, разделеные запятыми: «1,34-45,-50,59-».';
...
$string['assistivetechnologieslabel'] = 'Ярлык вспомогательных технологий';
...
$string['cancelpublishconfirmationdialogdescription'] = 'Вы уверены, что хотите отменить процес публикации?';
$string['cancelpublishconfirmationdialogtitle'] = 'Отменить публикацию';
...
$string['changehasbeensubmitted'] = 'Изменение было отправлено';
...
$string['completionpass_help'] = 'Если включено, то данный элемент считается выполненным, когда студент получает проходной балл  (указанный в разделе «Оценка» настроек H5P) или балл выше.';
...
$string['contentavailable'] = 'Обычно контент становится доступен в хабе в течение одного рабочего дня.';
...
$string['contenthub:changesettings'] = 'Изменить настройки аккаунта  <a href="{$a}">здесь</a>';
$string['contenthub:licenseagreementdescription'] = 'Пожалуйста, прочитайте следующее соглашение перед тем, как продолжить с';
$string['contenthub:licenseagreementmaintext'] = 'ЗАДАЧА';
$string['contenthub:nopermissions'] = 'У Вас нет разрешения для регистрации сайта с контентом хаба.';
$string['contenthub:register'] = '<a href="{$a}">Зарегистрируйте здесь</a> аккаунт в хабе H5P';
$string['contenthub:settings:heading'] = 'Настройки аккаунта хаба H5P';
$string['contenthubeditsharing'] = 'Редактировать информацию публикации';
$string['contenthubsearchdescription'] = 'Найти и скачать опубликованный контент из хаба H5P.';
$string['contenthubsearchenable'] = 'Включить опубликованный контент в хабе H5P.';
$string['contenthubshare'] = 'Опубликовать в хабе H5P.';
$string['contenthubsharinginprogress'] = 'Публикация...';
$string['contenthubsyncchanges'] = 'Синхронизировать изменения';
$string['contenthubunshare'] = 'Отменить публикацию';
$string['contentissyncing'] = 'Синхронизация контента';
$string['contentlicensetitle'] = 'Информация о лицензии контента';
$string['contentnotshared'] = 'Контент не опубликован в хабе.';
...
$string['contentupdatesoon'] = 'Ваш контент будет обновлен в ближайшее время';
...
$string['dropdownbutton'] = 'Кнопка выпадающего списка';
...
$string['fileexceedsmaxsize'] = 'Один из файлов внутри архива превышает максимально допустимый размер файла. (%file %used > %max)';
...
$string['gradeheading'] = 'Результаты для {$a}';
$string['gradetopassmustbeset'] = 'Проходной балл не может быть равен нулю, так как для этого элемента H5P установлен метод выполнения, при котором требуется получение проходного балла. Пожалуйста, задайте значение, не равное нулю.';
$string['gradetopassnotset'] = 'Для этого элемента H5P пока еще не задан проходной балл. Его можно установить в разделе «Оценка» в настройках элемента H5P.';
$string['h5pfile'] = 'Файл H5P';
$string['h5ptitle'] = 'Посетите H5P.org, чтобы узнать больше интересного контента.';
$string['helpchoosinglicense'] = 'Помогите мне выбрать тип лицензии';
$string['hide'] = 'Скрыть';
...
$string['hvp:contenthubregistration'] = 'Зарегистрируйте сайт с помощью H5P Content Hub';
...
$string['hvp:getembedcode'] = 'Просмотреть встроенный код H5P, если выставлен параметр «контролируется разрешением»';
...
$string['hvp:manage'] = 'Редактировать существующие элементы H5P';
...
$string['invalidage'] = 'Недопустимый формат ввода Типичного возраста. Возможные форматы ввода, разделенные запятыми: «10, 34-45, -50, -59-».';
...
$string['invalidhvp'] = 'Недопустимый элемент H5P';
...
$string['invalidlibrary'] = 'Недопустимая библиотека';
...
$string['invalidlibrarynamed'] = 'Библиотека H5P {$a->%library}, используемая в контенте, недопустима';
...
$string['invalidtoken'] = 'H5P получил недопустимый токен. Обновите страницу и попробуйте еще раз';
...
$string['isnowsubmitted'] = 'теперь отправлено в хаб H5P';
$string['javascriptloading'] = 'Ожидание JavaScript...';
$string['keywordexists'] = 'Ключевые слова уже существуют!';
$string['keywords'] = 'Ключевые слова';
$string['keywordsdescription'] = 'Вы можете добавить несколько ключевых слов, разделяя их запятыми. Нажмите «Enter» или «Добавить» для подтверждения ключевых слов.';
$string['keywordsexists'] = 'Ключевые слова уже существуют!';
...
$string['licensedetails'] = 'Данные о лицензии';
...
$string['longdescription'] = 'Длинное описание';
$string['longdescriptionplaceholder'] = 'Длинное описание вашего контента';
$string['lookforupdates'] = 'Искать обновления H5P';
$string['maintitle'] = 'Поделиться <strong>:title</strong>';
...
$string['noexport'] = 'Отсутствует файл экспорта';
...
$string['nohubregistration'] = 'Не зарегистрирован в хабе H5P';
...
$string['nopermissiontoviewcontenthubcache'] = 'Вам не разрешено просматривать метаданные для контента хаба.';
...
$string['offlinedialogretrymessage'] = 'Повторная попытка через :num....';
...
$string['olduploadoldcontent'] = 'Вы пытаетесь загрузить содержимое старой версии H5P. Пожалуйста, обновите контент на сервере, с которого он был отправлен, и попробуйте загрузить его ещё раз или включите хаб H5P, чтобы сервер обновил контент автоматически.';
...
$string['privacy:metadata:hvp_content_user_data:data_id'] = 'Определитель типа данных';
$string['privacy:metadata:hvp_events:content_title'] = 'Заголовок контента';
$string['privacy:metadata:hvp_events:created_at'] = 'Время создания события';
...
$string['privacy:metadata:hvp_xapi_results:interaction_type'] = 'Тип взаимодействия';
$string['privacy:metadata:hvp_xapi_results:max_score'] = 'Максимально возможный балл для события';
$string['privacy:metadata:hvp_xapi_results:parent_id'] = 'ID родительского элемента контента, к которому относится это событие. Значение null, если родительский элемент отсутствует.';
$string['privacy:metadata:hvp_xapi_results:raw_score'] = 'Набранный балл за событие.';
$string['privacy:metadata:hvp_xapi_results:response'] = 'Ответ, отправленный пользователем.';
$string['privacy:metadata:hvp_xapi_results:user_id'] = 'ID пользователя, который произвел действие.';
$string['publisherdescription'] = 'Описание издателя';
$string['publisherdescriptiontext'] = 'Это будет отображаться в разделе «Информация об издателе» в общедоступном контенте';
$string['publisherfielddescription'] = 'Это будет отображаться как «Имя издателя» в общедоступном контенте';
$string['publisherfieldtitle'] = 'Издатель';
$string['question'] = 'Вопрос';
$string['registeronhub'] = 'Зарегистрируйтесь в хабе H5P';
$string['registrationfailed'] = 'Произошла ошибка';
$string['registrationfaileddescription'] = 'На данный момент не удалось создать аккаунт. Произошла ошибка. Попробуйте позже.';
$string['registrationtitle'] = 'Регистрация в хабе H5P';
...
$string['removeoldmobileauthentries'] = 'Удалить старые записи авторизации H5P на мобильных устройствах';
$string['removetmpfiles'] = 'Удалить старые временные файлы H5P';
$string['reportingquestionsremaininglabel'] = 'неоцененные вопросы';
$string['reportingscaledscoredelimiter'] = ',';
$string['reportingscaledscorelabel'] = 'Балл в журнале оценок:';
$string['reportingscoredelimiter'] = 'из';
$string['reportingscorelabel'] = 'Балл:';
$string['reportnotsupported'] = 'Не поддерживается';
$string['reportsubmitgradelabel'] = 'Отправить оценку';
...
$string['reusecontent'] = 'Повторное использование контента';
$string['reusedescription'] = 'Повторно использовать этот контент.';
$string['reveal'] = 'Показать';
$string['reviewandsave'] = 'Проверить и сохранить';
$string['reviewandshare'] = 'Проверить и опубликовать';
$string['reviewinfo'] = 'Информация проверки';
$string['reviewmessage'] = 'Ознакомьтесь с приведенной ниже информацией перед её публикацией';
...
$string['search'] = 'Поиск';
$string['searchplaceholder'] = 'Наберите для поиска дисциплины';
$string['sendusagestatistics'] = 'Разрешить статистику использования';
$string['sendusagestatistics_help'] = 'Данные статистики использования будут автоматически передаваться, чтобы помочь разработчикам лучше понять, как используется H5P, и определить возможные направления для улучшений. Подробнее о том, какие данные собираются,<a {$a}> читайте на сайте h5p.org</a>.';
$string['settings'] = 'Настройки H5P';
$string['share'] = 'Поделиться';
$string['shared'] = 'Опубликовано';
$string['sharefailed'] = 'Ошибка публикации';
$string['sharetryagain'] = 'Произошла ошибка, попробуйте поделиться еще раз.';
$string['sharingnote'] = 'Все данные контента можно отредактировать после публикации';
...
$string['size'] = 'Размер';
$string['somekeywordsexists'] = 'Некоторые из этих ключевых слов уже существуют';
...
$string['subcontentwarning'] = 'Дополнительный контент (изображения, вопросы, и т.д.) предоставляются по лицензии  :license, если в инструменте для создания контента не указано иное';
...
$string['successfullyregistreddescription'] = 'Данные вашего аккаунта могут быть изменены';
...
$string['unpackedfilesexceedsmaxsize'] = 'Общий размер распакованных файлов превышает максимально допустимый. (%used > %max).';
...
$string['upgradeerrornotsupported'] = 'Параметры содержат %used, что не поддерживается.';
$string['upgradeerrorparamsbroken'] = 'Параметры повреждены.';
$string['upgradeerrorscript'] = 'Не удалось обновить скрипт для %lib.';
$string['upgradeerrortoohighversion'] = 'Параметры содержат %used, хотя поддерживаются только версии %supported или более ранние.';
