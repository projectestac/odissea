...
/**
 * Strings for component 'wiki', language 'ru', version '4.4'.
 *
 * @package     wiki
 * @category    string
...
$string['eventdiffviewed'] = 'Просмотрены изменения Вики';
$string['eventhistoryviewed'] = 'Просмотрена история Вики';
$string['eventmapviewed'] = 'Просмотрена карта страниц Вики';
...
$string['print'] = 'Печать';
$string['privacy:metadata:core_comment'] = 'Комментарии на странице Вики';
$string['privacy:metadata:core_files'] = 'Файлы, прикрепленные к подразделам вики';
...
$string['privacy:metadata:wiki_pages'] = 'Информация о страницах вики';
$string['privacy:metadata:wiki_pages:cachedcontent'] = 'Кэшированный контент в формате HTML';
$string['privacy:metadata:wiki_pages:pageviews'] = 'Количество просмотров страницы';
$string['privacy:metadata:wiki_pages:readonly'] = 'Доступна ли страница только для чтения';
...
$string['privacy:metadata:wiki_pages:timerendered'] = 'Время последнего представления страницы';
...
$string['privacy:metadata:wiki_subwikis'] = 'Информация о подразделе вики (в случае группового или индивидуального режима)';
$string['privacy:metadata:wiki_subwikis:groupid'] = 'Группа, имеющая подраздел вики';
...
$string['wiki:editpage'] = 'Редактировать страницы вики';
