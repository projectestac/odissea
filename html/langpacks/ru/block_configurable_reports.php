...
/**
 * Strings for component 'block_configurable_reports', language 'ru', version '4.5'.
 *
...
$string['displayprintbutton'] = 'Кнопка «Печать»';
$string['displayprintbuttondescription'] = 'Отобразить внизу отчета кнопку для печати';
$string['displayreportslist'] = 'Отображать список отчетов в теле блока';
$string['displaytotalrecords'] = 'Всего записей';
$string['displaytotalrecordsdescription'] = 'Отобразить общее количество результатов в отчете';
...
$string['embedlink'] = 'Ссылка для вставки';
$string['embedlinkdescription'] = 'Вы можете скопировать эту ссылку, чтобы вставить отчет в HTML-блок';
$string['embedoptions'] = 'Параметры вставки';
...
$string['export_slk'] = 'Экспорт в формате SYLK';
...
$string['listofsqlreports'] = 'Для переключения в полноэкранный режим редактирования нажмите клавишу F11 при нахождении курсора в редакторе. Для выхода из полноэкранного режима редактирования используйте клавишу  Esc. <br/><br/> <a href="http://docs.moodle.org/en/ad-hoc_contributed_reports" target="_blank">Список доступных SQL-отчетов</a>';
...
$string['reportlimitinfo'] = 'Ограничение количества строк, отображаемых в таблице отчета.
(Значение по умолчанию - 5000 строк. Желательно указать некоторое ограничение, чтобы пользователи не слишком нагружали базу данных)';
