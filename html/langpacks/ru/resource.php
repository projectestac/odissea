...
/**
 * Strings for component 'resource', language 'ru', version '4.5'.
 *
 * @package     resource
 * @category    string
...
* Внедрить - Файл отображается внутри страницы вместе с описанием
* Принудительное скачивание - Файл автоматически скачивается
...
* В фрейме - Файл отображается в отдельном фрейме под описанием файла
* В новой вкладке - Файл открывается в новой вкладке браузера с меню и адресной строкой';
...
$string['legacyfiles'] = 'Перенос старого файла курса';
