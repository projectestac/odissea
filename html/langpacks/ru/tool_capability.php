...
/**
 * Strings for component 'tool_capability', language 'ru', version '3.11'.
 *
...
$string['filters'] = 'Фильтровать результаты';
...
$string['nodifferences'] = 'В этом контексте нет различий между выбранными ролями.';
$string['onlydiff'] = 'Показать только различия';
