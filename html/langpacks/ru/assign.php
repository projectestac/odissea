...
/**
 * Strings for component 'assign', language 'ru', version '4.5'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduedigesthtml'] = '<p>Здравствуйте, {$a->firstname},</p>
<p>Следующие задания необходимо сдать до <strong>{$a->duedate}</strong>.</p>
{$a->digest}';
$string['assignmentduedigestitem'] = '<strong>{$a->assignmentname}</strong> в курсе {$a->coursename}<br/>
<strong>Срок: {$a->duetime}</strong><br/>
<a href="{$a->url}" aria-label="Перейти к {$a->assignmentname}">Перейти к элементу</a>';
$string['assignmentduedigestsubject'] = 'У вас есть задания, которые нужно сдать через 7 дней';
$string['assignmentduesoonhtml'] = '<p>Здравствуйте {$a->firstname}.</p>
<p>Скоро наступит срок сдачи задания <strong>{$a->assignmentname}</strong> по курсу {$a->coursename}.</p>
<p><strong>Срок сдачи: {$a->duedate}</strong></p>
<p><a href="{$a->url}">Перейти к заданию</a></p>';
$string['assignmentduesoonsubject'] = 'Срок сдачи {$a->assignmentname}: {$a->duedate}';
...
Вы можете посмотреть отзыв на странице отправки ответа на задание:
...
$string['assignmentmailsmall'] = 'Пользователь {$a->grader} дал отзыв на Ваш ответ на задание «{$a->assignment}». Вы можете посмотреть отзыв на странице отправки ответа на задание.';
$string['assignmentname'] = 'Название задания';
$string['assignmentoverduehtml'] = '<p>Здравствуйте, {$a->firstname}!</p>
<p>Задание <strong>{$a->assignmentname}</strong> по курсу {$a->coursename} надо было сдать до <strong>{$a->duedate}</strong>.</p>
<p>Вы все равно можете отправить свой ответ на задание {$a->cutoffsnippet}, но он будет отмечен как просроченный.</p>
<p><a href="{$a->url}">Перейти к заданию</a></p>';
$string['assignmentoverduehtmlcutoffsnippet'] = '<strong>по {$a->cutoffdate}</strong>';
$string['assignmentoverduesubject'] = 'Просрочено: {$a->assignmentname}';
...
$string['attemptreopenmethod_automatic'] = 'Автоматически';
$string['attemptreopenmethod_automatic_help'] = 'После каждой оцененной попытки следующая предоставляется автоматически.';
...
* Вручную — после каждой попытки вы можете предоставить следующую попытку на странице «Ответы на задание» или на странице оценщика.
* Автоматически — после каждой оцененной попытки следующая предоставляется автоматически.
* Автоматически (до проходного балла) — повторное представление студентом работы разрешается автоматически до тех пор, пока студент не достигнет значения проходного балла, установленного для этого задания.';
$string['attemptreopenmethod_manual'] = 'Вручную';
$string['attemptreopenmethod_manual_help'] = 'После каждой попытки вы можете предоставить следующую на странице «Ответы на задание» или на странице оценщика.';
$string['attemptreopenmethod_none'] = 'Никогда';
$string['attemptreopenmethod_untilpass'] = 'Автоматически (до проходного балла)';
$string['attemptreopenmethod_untilpass_help'] = 'После каждой оцененной попытки следующая будет предоставлена автоматически, пока студент не получит проходной балл.';
$string['attemptsettings'] = 'Настройки попытки';
$string['availability'] = 'Доступность';
$string['back'] = 'Назад';
$string['backtoassignment'] = 'Вернуться к заданию';
$string['batchoperationaddattempt'] = 'Добавить попытку';
...
$string['batchoperationconfirmsetmarkingallocation'] = 'Задать назначенных оценщиков для всех выбранных ответов на задание?';
...
$string['batchoperationdownloadselected'] = 'Скачать';
$string['batchoperationgrantextension'] = 'Продлить';
$string['batchoperationlock'] = 'Заблокировать';
$string['batchoperationremovesubmission'] = 'Удалить';
$string['batchoperationreverttodraft'] = 'Вернуть к черновику';
$string['batchoperationsdescription'] = 'С выбранными';
$string['batchoperationsetmarkingallocation'] = 'Назначить оценщика';
$string['batchoperationsetmarkingworkflowstate'] = 'Изменить состояние оценивания';
$string['batchoperationunlock'] = 'Разблокировать';
$string['batchsetallocatedmarker'] = 'Назначить оценщика для выбранных пользователей ({$a}).';
...
$string['blindmarkingenabledwarning'] = 'Для этого активного элемента разрешены анонимные ответы.';
$string['blindmarkingnogradewarning'] = 'Для этого активного элемента разрешены анонимные ответы. Оценки не будут добавлены в журнал оценок, пока личности учащихся не будут раскрыты через меню «Действия».';
$string['bulkactionsselection'] = 'Выбор массовых действий';
$string['cachedef_overrides'] = 'Информация о переопределении пользователя и группы';
$string['calendardue'] = '{$a} - срок сдачи';
$string['calendarextension'] = '{$a} истекает (продление)';
...
$string['completionsubmit'] = 'Отправить ответ на задание';
$string['configshowrecentsubmissions'] = 'Все могут видеть уведомления об ответах в отчетах о последних действиях.';
...
$string['cutoffdate'] = 'Запретить ответы после';
$string['cutoffdate_help'] = 'Если задано, то просроченные ответы не будут приниматься после этой даты.
Если не задано, то ответы будут приниматься всегда.';
...
$string['defaultgradescale'] = 'Шкала оценок';
$string['defaultgradescale_help'] = 'Шкала оценок по умолчанию, которая будет использоваться при создании новых заданий. Могут использоваться только стандартные шкалы уровня сайта.';
$string['defaultgradetype'] = 'Тип оценки';
$string['defaultgradetype_help'] = 'Тип оценки по умолчанию, который будет использоваться при создании новых заданий';
...
$string['downloadasfolders'] = 'Скачивать ответы в папках';
...
$string['errorgradechangessaveddetail'] = 'Не удалось сохранить изменения в оценке и отзыве.';
...
$string['eventremovesubmissionformviewed'] = 'Просмотрено подтверждение удаления ответа.';
...
$string['eventsubmissionconfirmationformviewed'] = 'Просмотрена форма подтверждения представленных ответов';
...
$string['eventsubmissionstatusviewed'] = 'Страница состояния представленных ответов просмотрена.';
...
$string['extensionduedatecurrent'] = 'Дата текущего продления';
$string['extensionduedatenone'] = 'Нет';
$string['extensionduedaterange'] = 'Разница между {$a->earliest} и {$a->latest}';
$string['extensionduedatewithout'] = 'Пользователи без текущего продления: {$a}';
...
{$a->url}';
$string['feedbackavailablehtml'] = 'Пользователь {$a->username} дал отзыв на ваш ответ на задание «<i>{$a->assignment}</i>».<br /><br />Вы можете увидеть его добавленным к <a href="{$a->url}">ответу на задание</a>.';
...
$string['gradeactions'] = 'Действия для оценивания';
$string['gradebelowzero'] = 'Оценка должна быть больше или равна нулю.';
$string['gradebreakdown'] = 'Оценка по критериям';
...
$string['gradedfollowupsubmit'] = 'Оценено - исправленный ответ';
...
$string['gradingdueduedatevalidation'] = 'Дата напоминания о выставлении оценки не может быть раньше срока сдачи работы.';
...
$string['includesuspendedparticipants'] = 'Включить заблокированных участников';
...
$string['locksubmissionforstudent'] = 'Запретить дальнейшее представление ответов студенту: (id={$a->id}, полное имя={$a->fullname}).';
...
$string['markingallocation'] = 'Использовать назначенных оценщиков';
$string['markingallocation_help'] = 'При включенном параметре (с использованием поэтапного оценивания) могут быть назначены оценщики для конкретных студентов.';
$string['markinganonymous'] = 'Разрешить частичное выставление оценок при оценивании вслепую.';
$string['markinganonymous_help'] = 'Включение этого параметра вместе с «Оцениванием вслепую» и «Поэтапным оцениванием» позволяет частично выставлять оценки при оценивании вслепую.';
$string['markingstate'] = 'Состояние оценивания';
...
$string['messageprovider:assign_due_digest'] = 'Задания, подлежащие выполнению, с уведомлением за 7 дней';
$string['messageprovider:assign_due_soon'] = 'Уведомление о наступающем сроке выполнения задания';
$string['messageprovider:assign_notification'] = 'Уведомление о задании';
$string['messageprovider:assign_overdue'] = 'Уведомление о просроченном задании';
...
$string['notifystudents'] = 'Уведомить студентов';
...
$string['page-mod-assign-view'] = 'Главная страница модуля «Задание» и страница представления ответа';
...
$string['privacy:metadata:assignworkflowfilter'] = 'Фильтр по различным этапам оценивания.';
...
$string['quickgrading_help'] = 'Быстрое оценивание позволяет добавить оценки (и показатели, навыки) прямо в таблице ответов. Быстрое оценивание не совместимо с «продвинутыми» методами оценивания и не рекомендуется, когда оценивание одновременно проводят несколько человек.';
...
$string['requireallteammemberssubmit_help'] = 'Этот параметр необходимо использовать вместе с параметром «Требовать нажатия кнопки «Отправить» в параметрах ответа.

Если «Да», то все члены группы студентов должны нажать кнопку «Отправить» для того, чтобы ответ группы считался отправленным. Если «Нет», то ответ группы будет считаться представленным, как только любой член группы студентов нажмет на кнопку «Отправить».';
...
$string['reverttodraft'] = 'Вернуть ответ к статусу черновика.';
$string['reverttodraftforgroup'] = 'Вернуть ответ группы {$a} к статусу черновика.';
$string['reverttodraftforstudent'] = 'Вернуть к статусу черновика ответ студента:
...
$string['sendnotificationduedatesoon'] = 'Уведомить пользователя о приближающейся дате сдачи задания';
$string['sendnotificationduedigest'] = 'Уведомить пользователя о заданиях, срок сдачи которых истекает через 7 дней';
$string['sendnotificationoverdue'] = 'Уведомить пользователя о просроченном задании';
...
$string['sendstudentnotifications_help'] = 'При включенном параметре студенты получают сообщение о обновлении оценки или отзыва.  Если для этого задания включено поэтапное оценивание  или оценки скрыты в отчете оценщика, то уведомления не будут отправляться до тех пор, пока оценка не станет «Опубликованной».';
...
$string['submissionactions'] = 'Действия для ответа';
...
Если этот параметр отключен, то файлы будут отображаться как на странице просмотра задания, так и на странице отправки ответа.';
...
$string['submissiondrafts_help'] = 'Должны ли студенты нажимать кнопку «Отправить», чтобы указать, что они закончили вносить изменения в свою работу и она готова к оцениванию?';
...
$string['submissionnotready'] = 'Это задание не готово к сдаче:';
...
$string['submissionstatementrequired'] = 'Перед отправкой ответа вам необходимо согласиться с этим заявлением.';
...
$string['submissionstatus_reopened'] = 'Разрешен повторный ответ';
...
$string['teamname'] = 'Группа: {$a}';
$string['teamsubmission'] = 'Групповой ответ студентов';
$string['teamsubmission_help'] = 'Если включено, то студенты будут разделены на группы по умолчанию или определенные потоки. Ответ группы будет распространен среди членов группы, и все её участники увидят изменения, внесенные друг другом в ответ. Примечание: Вы не можете изменить эту настройку, если уже есть ответы.';
...
$string['unlocksubmissionforstudent'] = 'Разрешить представить ответы студенту: (ID = {$a->id}, ФИО = {$a->fullname}).';
...
$string['viewgrader'] = 'Просмотр оценщика';
