...
$string['excludedtables'] = 'Некоторые таблицы не обновляются при использовании замены текста. Это таблицы конфигурации, журналов, событий и сеансов.';
...
$string['privacy:metadata'] = 'Плагин поиска и замены БД не хранит никаких личных данных.';
