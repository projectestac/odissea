...
$string['missingfieldtypes'] = 'Для указанных полей не установлены соответствующие типы полей, и они не будут включены в формы для добавления или редактирования записей.
Их ярлыки могут по-прежнему отображаться в форме, поэтому обновите «Добавить шаблон записи» соответствующим образом:';
