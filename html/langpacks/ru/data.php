...
/**
 * Strings for component 'data', language 'ru', version '4.5'.
 *
 * @package     data
 * @category    string
...
$string['addtemplate'] = 'Шаблон добавления записи';
...
$string['cannotapplypreset'] = 'Ошибка при использовании заготовки.';
...
$string['choosepreset'] = 'Файл заготовки';
...
$string['completionentriescount'] = 'Добавлены записи';
...
$string['createactivity'] = 'Создайте свои собственные поля для сбора данных или используйте заготовку с имеющимися полями.';
$string['createfields'] = 'Создайте поля для сбора различных типов данных..';
$string['createtemplates'] = 'Шаблоны определяют интерфейс вашей базы данных. После того, как вы создадите поля, шаблоны будут созданы автоматически. Кроме того, вы можете использовать заготовку с имеющимися полями и шаблонами.';
$string['csstemplate'] = 'Шаблон CSS';
$string['csvfailed'] = 'Невозможно прочитать исходные данные из файла CSV';
$string['csvfile'] = 'CSV-файл или ZIP-архив, содержащий файл CSV';
...
$string['datemodified'] = 'Последнее изменение:';
...
$string['deleteconfirm'] = 'Удалить заготовку {$a}?';
$string['deleted'] = 'удалено';
$string['deleteentry'] = 'Удалить запись';
$string['deletefield'] = 'Удалить поле';
$string['deletenotenrolled'] = 'Удалить записи незарегистрированных пользователей';
$string['deletewarning'] = 'Удаление заготовки удаляет ее из списка доступных заготовок во всех курсах.';
...
$string['errordatafilenotfound'] = 'Не удалось импортировать файл. Допустимые типы файлов: CSV или архив ZIP, содержащий файл CSV в формате, используемом для экспорта записей.';
...
$string['errorpresetexistsbutnotoverwrite'] = 'Уже есть заготовка с таким названием. Выберите другое название.';
$string['errorpresetnotfound'] = 'Заготовка с именем {$a} не найдена.';
...
$string['exportpreset'] = 'Экспорт заготовки';
$string['failedpresetdelete'] = 'Ошибка при удалении заготовки.';
...
$string['fieldheightlistview'] = 'Высота (в пикселях) при просмотре списком';
$string['fieldheightsingleview'] = 'Высота (в пикселях) при просмотре по одной записи';
...
$string['fields'] = 'Поля';
$string['fieldshelp'] = 'Создайте поля для сбора различных типов данных для ваших записей или настройте имеющиеся, если вы использовали заготовку. Поля определяют структуру записей в вашей базе данных.';
$string['fieldsinformationtags'] = 'Информация о поле';
$string['fieldsnavigation'] = 'Поля системы навигации';
$string['fieldtagdescription'] = 'Описание {$a}';
$string['fieldtagid'] = 'ID {$a}';
$string['fieldtagname'] = 'Имя {$а}';
$string['fieldupdated'] = 'Поле обновлено';
$string['fieldwidth'] = 'Ширина';
$string['fieldwidthlistview'] = 'Ширина (в пикселях) при просмотре списком';
$string['fieldwidthsingleview'] = 'Ширина (в пикселях) при просмотре по одной записи';
$string['file'] = 'Файл';
...
$string['headercsstemplate'] = 'Определяет пользовательские CSS стили для других шаблонов';
$string['headerjstemplate'] = 'Определяет пользовательский Javascript в шаблонах Списка, Одиночной записи или Добавления записи.';
...
$string['id'] = 'ID записи';
$string['importandapply'] = 'Импортировать и применить заготовку';
$string['importapreset'] = 'Импорт заготовки';
$string['importentries'] = 'Импорт записей';
$string['importpreset'] = 'Импортировать заготовку';
$string['importpreset_desc'] = 'Заготовка будет применяться к этой базе данных, создавая поля и шаблоны.
Она не появится в списке заготовок.';
$string['importpresetmissingcapability'] = 'У вас недостаточно прав для импорта заготовки.';
$string['importsuccess'] = 'Заготовка была успешно применена.';
$string['includeapproval'] = 'Включить состояние одобрения';
$string['includefiles'] = 'Включить файлы в экспорт.';
...
$string['listview'] = 'Просмотр списком';
$string['longitude'] = 'Долгота';
$string['manageapproved'] = 'Разрешить редактирование одобренных записей';
$string['manageapproved_help'] = 'Разрешить студентам редактировать или удалять свои записи после их одобрения. Отредактированные записи должны быть одобрены повторно.';
$string['managefields'] = 'Управление полями';
$string['mapexistingfield'] = 'Сопоставить с полем {$a}';
$string['mapnewfield'] = 'Создать новое поле';
$string['mapping:applypresets'] = 'Применение заготовки.';
$string['mapping:dialogtitle:usepreset'] = 'Применить заготовку {$a}?';
$string['mapping:fieldstocreate'] = 'Поля, которые необходимо создать: {$a}';
$string['mapping:fieldstodelete'] = 'Имеющиеся поля, которые надо удалить: {$a}';
$string['mapping:mapfields'] = 'Сопоставление полей';
$string['mapping:warningmessagedelete'] = 'Если подлежащие удалению поля имеют тот же тип, что и новые поля в применяемой заготовке, вы можете сопоставить их в Сопоставлении полей.';
$string['mapping:warningmessagedeleteandcreate'] = 'Если удаляемые поля имеют тот же тип, что и создаваемые поля, вы можете сопоставить их в Сопоставлении полей.';
...
$string['missingdata'] = 'Данные ID или объект должны быть представлены в поле class';
$string['missingfield'] = 'Программная ошибка: Вы должны указать поле и/или данные при определении класса поля.';
$string['missingfieldtype'] = 'Не найден тип поля для {$a->name}';
$string['missingfieldtypeimport'] = 'Следующие поля не были импортированы, так как соответствующие им типы полей не установлены:';
$string['missingfieldtypes'] = 'Для следующих полей не установлены соответствующие типы полей, и они не будут включены в форму добавления записей. Вам необходимо проверить шаблон добавления записи и удалить все указанные поля.';
...
$string['nofields'] = 'Полей пока нет';
...
$string['nopreviewavailable'] = 'Предварительный просмотр недоступен для {$a}';
$string['norecords'] = 'Пока нет записей';
$string['notapproved'] = 'В ожидании одобрения';
$string['notapprovederror'] = 'Запись еще не одобрена.';
$string['notemplates'] = 'Шаблонов пока нет';
...
$string['other'] = 'Другое';
$string['otherfields'] = 'Все остальные поля';
$string['overrwritedesc'] = 'Заменить существующую заготовку с этим названием и перезаписать её содержимое';
$string['overwrite'] = 'Заменить';
$string['overwritesettings'] = 'Перезаписать текущие настройки, такие как комментарии, оценки и т. д.';
...
$string['presetdeleted'] = 'Заготовка удалена.';
...
$string['presetnotselected'] = 'Заготовка не выбрана.';
$string['presets'] = 'Заготовки';
$string['presetshelp'] = 'Выберите заготовку для использования в качестве отправной точки.';
$string['preview'] = 'Предварительный просмотр {$a}';
$string['previewaction'] = 'Предварительный просмотр';
$string['privacy:metadata:commentpurpose'] = 'Комментарии к записям базы данных';
$string['privacy:metadata:data_content'] = 'Содержимое поля';
...
$string['privacy:metadata:data_records'] = 'Записи в базе данных';
...
$string['requireapproval_help'] = 'Учитель должен одобрить записи, прежде чем они станут видны всем.';
...
Это несовместимо с фильтром автоматического связывания базы данных.';
...
$string['resetalltemplates'] = 'Сбросить все шаблоны';
$string['resetalltemplatesconfirm'] = 'Вы собираетесь удалить все шаблоны для текущей заготовки. Если позже вы захотите восстановить шаблоны, вам нужно будет снова выбрать заготовку на вкладке «Заготовки».';
$string['resetalltemplatesconfirmtitle'] = 'Сбросить все шаблоны?';
$string['resetsettings'] = 'Сбросить фильтры';
$string['resettemplate'] = 'Сбросить шаблон';
$string['resettemplateconfirm'] = 'Это навсегда удалит {$a} для имеющейся заготовки.';
$string['resettemplateconfirmtitle'] = 'Сбросить шаблон?';
...
$string['saveaspreset'] = 'Сохранить как заготовку для этого сайта';
...
$string['saveaspresetmissingcapability'] = 'У пользователя нет прав на сохранение базы данных в качестве заготовки.';
$string['savedataaspreset'] = 'Сохранить все поля и шаблоны как заготовку для этого сайта';
$string['savesettings'] = 'Сохранить настройки';
$string['savesuccess'] = 'Заготовка сохранена. <a href="{$a->url}">Предварительный просмотр заготовки</a>';
$string['search'] = 'Поиск';
...
$string['singleview'] = 'Просмотр по одной записи';
$string['startbuilding'] = 'Начните создавать свою Базу данных';
...
$string['templatereset'] = 'Сбросить шаблон';
$string['templateresetall'] = 'Все шаблоны сброшены';
$string['templates'] = 'Шаблоны';
$string['templatesaved'] = 'Шаблон сохранен';
$string['templatesnavigation'] = 'Шаблоны системы навигации';
$string['text'] = 'Текст';
...
$string['unknown'] = 'Неизвестное поле';
...
$string['uploadrecords'] = 'Импортировать записи из файла';
$string['uploadrecords_help'] = 'Импортируйте записи, которые вы экспортировали из другой базы данных, либо через CSV, либо через архив ZIP, содержащий файл CSV (если файлы включены в экспорт).

В качестве альтернативы, чтобы создать CSV-файл для импорта, добавьте одну запись в базу данных, а затем экспортируйте ее. Отредактируйте файл CSV и добавьте больше записей.';
$string['uploadrecords_link'] = 'mod/data/import';
$string['url'] = 'URL';
$string['usedate'] = 'Включить в поиск';
$string['usepredefinedset'] = 'Использовать предопределенный набор';
$string['usepreset'] = 'Использовать эту заготовку';
...
$string['viewnavigation'] = 'Режим просмотра системы навигации';
$string['viewtemplates'] = 'Просмотр шаблонов';
...
$string['wrongdataid'] = 'Неправильный ID данных';
