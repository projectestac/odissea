...
/**
 * Strings for component 'media_videojs', language 'ru', version '4.4'.
 *
...
$string['configaudioextensions'] = 'Список разделенных запятыми поддерживаемых расширений аудиофайлов. VideoJS будет использовать встроенный видеоплеер браузера, если он доступен, или встроенные функции VideoJS.';
...
$string['configvideoextensions'] = 'Список разделенных запятыми поддерживаемых расширений видеофайлов. VideoJS будет использовать встроенный видеоплеер браузера, если он доступен.';
...
$string['pluginname_help'] = 'Оболочка JavaScript для видеофайлов, воспроизводимых встроенным видеоплеером браузера. (Поддержка форматов зависит от браузера.)';
