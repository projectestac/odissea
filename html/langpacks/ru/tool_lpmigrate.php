...
/**
 * Strings for component 'tool_lpmigrate', language 'ru', version '4.1'.
 *
...
$string['pluginname'] = 'Инструмент переноса компетенций';
$string['privacy:metadata'] = 'Плагин Инструмент переноса компетенций не хранит никаких личных данных.';
