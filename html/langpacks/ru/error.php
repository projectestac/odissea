...
$string['confirmsesskeybad'] = 'Произошла ошибка проверки ключа сессии (sessionkey), а это необходимо для проведения этой операции. Эта функция безопасности предотвращает случайное или злонамеренное выполнение важных функций от Вашего имени. Пожалуйста, убедитесь, что Вы действительно хотели выполнить это действие.';
...
$string['invalidsesskey'] = 'Ваша сессия, по-видимому, истекла. Пожалуйста, войдите снова.';
...
$string['sessioncannotobtainlock'] = '<p>Не удалось получить заблокированную сессию с идентификатором {$a->id} в течение {$a->acquiretimeout}.</p>
<p>Вероятно, другая страница ({$a->whohaslock}) все еще открыта в другой вкладке браузера или не сняла блокировку из-за ошибки.</p>
<p>Вы можете дождаться истечения времени блокировки сессии ({$a->lockexpire}) или перезапустить сессию браузера. Если эта ошибка повторяется, сообщите об этом администратору сервера.</p>';
$string['sessioncookiesdisable'] = 'Неверное использование require_key_login() - файлы cookie для сессий должны быть отключены!';
...
$string['sessionerroruser'] = 'Время Вашей сессии истекло. Войдите в систему еще раз.';
$string['sessionerroruser2'] = 'На сервере возникла ошибка, касающаяся Вашей сессии. Пожалуйста, войдите в систему снова или перезапустите браузер.';
