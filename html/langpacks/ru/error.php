...
$string['cannotaddcoursemoduletosection'] = 'Не удалось добавить новый элемент курса в эту секцию';
...
$string['cannotcreateorfindstructs'] = 'Ошибка поиска или создания структуры секций для этого курса';
...
$string['cannotmanualctrack'] = 'Элемент курса не предусматривает ручного отслеживания выполнения';
...
$string['cannotmarktopic'] = 'Не удалось отметить эту секцию в этом курсе';
...
$string['cannotviewprofile'] = 'Вы не можете просмотреть профиль этого пользователя';
...
$string['contentvisibilitynotfound'] = 'Видимость контента со значением «{$a}» не существует или не распознается.';
...
$string['couldnotverifyagedigitalconsent'] = 'Произошла ошибка при попытке проверить возраст цифровой дееспособности.<br />Пожалуйста, свяжитесь с администратором.';
...
$string['dbsessionbroken'] = 'Обнаружена серьезная проблема сеанса базы данных.<br /><br /> Пожалуйста, сообщите об этом администратору сервера.';
$string['dbsessionhandlerproblem'] = 'Не удалось установить сеанс базы данных. Сообщите об этом администратору сервера.';
$string['dbsessionmysqlpacketsize'] = 'Обнаружена серьезная ошибка сеанса.<br /><br />Пожалуйста, сообщите об этом администратору сервера. Эта проблема, скорее всего, вызвана слишком маленьким значением max_allowed_packet параметра MySQL.';
...
$string['dmlreadexception'] = 'Ошибка чтения из базы данных. Ни в коем случае не выполняйте выключение (перезагрузку) сервера, так как это может привести к необратимой потере данных!';
$string['dmltransactionexception'] = 'Ошибка транзакции базы данных';
$string['dmlwriteexception'] = 'Ошибка записи в базу данных';
$string['dndmaxbytes'] = 'Слишком большой файл. Максимально допустимый размер: {$a->size}.';
$string['dndread'] = 'Ошибка чтения файла';
$string['dndunkownfile'] = 'Этот тип файла не поддерживается';
$string['dndupload'] = 'При загрузке файла произошла неизвестная ошибка';
$string['downgradedcore'] = 'Ошибка: используемый вами код старше версии, записанной в базе данных.';
...
$string['editedpagenotfound'] = 'Системе не удалось определить текущую страницу. Попробуйте обновить страницу и повторить попытку.';
$string['emailfail'] = 'Не удалось отправить сообщение электронной почты';
$string['encryption_decryptfailed'] = 'Ошибка расшифрования';
$string['encryption_encryptfailed'] = 'Ошибка шифрования';
$string['encryption_invalidkey'] = 'Неправильный ключ';
$string['encryption_keyalreadyexists'] = 'Ключ уже существует';
$string['encryption_nokey'] = 'Ключ не найден';
$string['encryption_wrongmethod'] = 'Данные не соответствуют поддерживаемому методу шифрования';
...
$string['filenotfound'] = 'К сожалению, не удалось найти запрашиваемый файл';
...
$string['invalidcoursemoduleid'] = 'Недопустимый ID модуля курса: {$a}';
...
$string['invalidsection'] = 'Запись модуля курса содержит неверную секцию';
$string['invalidsesskey'] = 'Ваш сеанс, по-видимому, истек. Проверьте, вошли ли вы в систему, или вернитесь на предыдущую страницу и перезагрузите её.';
...
$string['maxdraftitemids'] = 'Ваши загрузки файлов временно ограничены после того, как вы загрузили большой объем файлов. Подождите и попробуйте еще раз.';
...
$string['missingcategoryrole'] = 'Не удалось назначить роль пользователю: отсутствующая роль для категории.';
...
$string['moodlenet:invalidshareformat'] = 'Неверный формат общего ресурса MoodleNet';
$string['moodlenet:invalidsharestatus'] = 'Неверный статус ресурса, размещаемого в MoodleNet';
$string['moodlenet:invalidsharetype'] = 'Неверный тип ресурса, размещаемого в MoodleNet';
$string['moodlenet:usernotconfigured'] = 'У вас нет разрешения на обмен контентом в MoodleNet, или ваша учетная запись настроена неправильно.';
...
$string['nopermissions'] = 'Извините, но у Вас нет прав делать это ({$a})';
$string['nopermissiontoaccesspage'] = 'У вас нет разрешения на доступ к этой странице.';
...
$string['nopermissiontoviewcalendar'] = 'Извините, но у вас нет разрешения на просмотр события календаря.';
...
$string['oauth2refreshtokenerror'] = 'Не удалось обновить токен OAuth 2. Статус HTTP для отдаленной конечной точки: {$a}';
$string['oauth2refreshtokentaskerror'] = 'Не удалось обновить токен OAuth 2 для одного или нескольких эмитентов. Подробные сведения см. в выходных данных задачи.';
$string['oauth2upgradetokenerror'] = 'Не удалось обновить токен OAuth 2. Статус HTTP для отдаленной конечной точки: {$a}';
...
$string['passwordexceeded'] = 'Пароль не может содержать более {$a} символов!';
...
$string['pluginnotexist'] = 'Плагин {$a} не существует';
...
$string['redissessionhandlerproblem'] = 'Не удалось настроить сеанс Redis. Пожалуйста, сообщите об этом администратору сервера.';
...
$string['restorechecksumfailed'] = 'Некоторые проблемы произошли при восстановлении данных сеанса. Пожалуйста проверьте в своем PHP ограничения размера памяти/пакета базы данных. Восстановление остановлено.';
...
$string['sessioncannotobtainlock'] = '<p>Не удалось получить заблокированный сеанс с идентификатором {$a->id} в течение {$a->acquiretimeout}.</p>
<p>Вероятно, другая страница ({$a->whohaslock}) все еще открыта в иной вкладке браузера или блокировка не снята из-за ошибки.</p>
<p>Вы можете дождаться истечения времени блокировки сеанса ({$a->lockexpire}) или перезапустить сеанс браузера. Если эта ошибка повторяется, сообщите об этом администратору сервера.</p>';
$string['sessioncookiesdisable'] = 'Неверное использование require_key_login() - файлы cookie для сеансов должны быть отключены!';
$string['sessiondiskfull'] = 'На диске заполнен раздел, в котором хранятся данные сеансов. Из-за этого сейчас невозможно войти в систему. Пожалуйста, сообщите об этом администратору сервера.';
...
$string['sessionexpired'] = 'Сеанс истёк';
...
$string['unknowncategory'] = 'Неизвестная категория с ID-номером категории «{$a}»';
...
$string['unknowncoursesection'] = 'Неизвестная секция в курсе «{$a}»';
...
$string['userisfilteredout'] = 'Этот пользователь не соответствует фильтрам и настройкам таблицы!';
...
$string['usernotaddedusernameexists'] = 'Пользователь не добавлен — уже имеется такой логин с другим адресом электронной почты.';
...
$string['verifyagedigitalconsentnotpossible'] = 'Извините, проверка возраста цифровой дееспособности в данный момент не возможна.';
