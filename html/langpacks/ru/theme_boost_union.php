...
$string['cachedef_fontawesomeicons'] = 'Карта значков FontAwesome';
...
$string['configtitlesnippets'] = 'Фрагменты SCSS';
...
$string['courselistingstylefields'] = 'Стиль полей курса в списке курсов';
$string['courselistingstylefields_desc'] = 'С помощью этой настройки вы можете управлять оформлением пользовательских полей курса в заголовке курса. Вы можете выбрать, отображать ли их в виде текста (отображать значение поля вместе с названием поля в виде подписи) или в виде значка (отображать только значение поля).';
...
$string['courseoverviewimagefallback'] = 'Резервное изображение для обзора курса.';
$string['courseoverviewimagefallback_desc'] = 'Изображение, которое вы загрузите сюда, будет использоваться в качестве резервного изображения для обзора курса, как только будет соответствующим образом настроен параметр «Источник изображения для обзора курса».<br />Обратите внимание: если вы настроите параметр «Источник изображения для обзора курса» на использование резервного изображения для обзора курса, но не загрузите сюда никакого изображения, геометрический узор все равно будет использоваться в качестве резервного.';
$string['courseoverviewimageheading'] = 'Изображения для обзора курса';
$string['courseoverviewimagesource_courseplusfallback'] = 'Изображение курса с резервным изображением обзора курса.';
$string['courseoverviewimagesource_coursepluspattern'] = 'Изображение курса с резервным вариантом в виде геометрического узора (без изменений, как это представлено в ядре Moodle).';
$string['courseoverviewimagesourcesetting'] = 'Источник изображения для обзора курса';
$string['courseoverviewimagesourcesetting_desc'] = 'С помощью этой настройки вы управляете источником изображения, отображаемого в блоке обзора курсов, на страницах категорий и в списке курсов на главной странице сайта. Основным источником этого изображения является изображение курса, загруженное в настройках конкретного курса. Если это изображение недоступно, вы можете выбрать, хотите ли вы отображать сгенерированный геометрический узор или резервное изображение для обзора курса.<br />Обратите внимание: если вы используете геометрический узор, вы можете настроить цвета узора на странице <a href="/admin/settings.php?section=coursecolors">настроек цветов курса</a>.';
...
$string['enablebuiltinsnippets'] = 'Включить встроенные фрагменты кода';
$string['enablebuiltinsnippets_desc'] = 'С помощью этой настройки вы можете включить или отключить встроенные фрагменты кода SCSS, поставляемые с базой кодовBoost Union. Если вы отключите эту настройку, все встроенные фрагменты кода SCSS будут игнорироваться и никогда не будут добавлены в стек SCSS.';
...
$string['enablefooterbutton_note'] = 'Обратите внимание: содержимое <a href="{$a->url}"> основного параметра Moodle «additionalhtmlfooter»</a> по умолчанию отображается в нижнем колонтитуле. Но если вы выберете здесь «Скрыть на всех устройствах», чтобы полностью скрыть нижний колонтитул, содержимое параметра «additionalhtmlfooter» больше нигде не будет отображаться. Чтобы обойти это ограничение, Boost Union переместит содержимое параметра «additionalhtmlfooter» в самый низ страницы.';
...
$string['enableuploadedsnippets'] = 'Разрешить загруженные фрагменты';
$string['enableuploadedsnippets_desc'] = 'С помощью этой настройки вы можете разрешить или запретить загрузку SCSS-фрагментов в настройках Boost Union. Если вы отключите эту настройку, загрузка SCSS-фрагментов будет невозможна, а все ранее загруженные фрагменты SCSS будут игнорироваться и никогда не будут добавлены в стек SCSS.';
...
$string['flavourscustomscsspre'] = 'Исходный необработанный SCSS';
$string['flavourscustomscsspre_help'] = 'С помощью этой настройки вы можете написать собственный исходный SCSS-код для особенного стиля. Он будет использоваться при создании CSS-кода, который будет отправлен в браузер сразу после применения особенного стиля.';
...
$string['flavoursnavbarcolor'] = 'Цвет панели навигации';
$string['flavoursnavbarcolor_help'] = 'Эта настройка цвета панели навигации будет переопределять цвет, заданный в параметрах внешнего вида Boost Union.';
...
$string['footerregionsheading'] = 'Области нижнего колонтитула';
$string['footerregionsheading_desc'] = 'С помощью указанных выше настроек макета можно не только включить области нижнего колонтитула, но и настроить их внешний вид.';
...
$string['footersuppressstandardfooter_configoverride_desc'] = 'Нижний колонтитул, выводимый плагином «{$a}», уже отключен с помощью <code>$CFG->hooks_callback_overrides</code> в вашем <code>config.php </code> файле. Чтобы настроить этот параметр здесь, вам необходимо удалить переопределение в файле <code>config.php</code>.';
...
$string['forguestsonly'] = 'Только для гостей и незарегистрированных пользователей.';
...
$string['imageposition_center_bottom'] = 'По центру по горизонтали, вниз по вертикали';
$string['imageposition_center_center'] = 'По центру по горизонтали и по вертикали';
$string['imageposition_center_top'] = 'По центру по горизонтали, вверх по вертикали';
$string['imageposition_left_bottom'] = 'Влево по горизонтали, вниз по вертикали';
$string['imageposition_left_center'] = 'Влево по горизонтали, по центру по вертикали';
$string['imageposition_left_top'] = 'Влево по горизонтали, вверх по вертикали';
$string['imageposition_right_bottom'] = 'Вправо по горизонтали, вниз по вертикали';
$string['imageposition_right_center'] = 'Вправо по горизонтали, по центру по вертикали';
$string['imageposition_right_top'] = 'Вправо по горизонтали, вверх по вертикали';
...
$string['loginlocalloginenablesetting_note'] = 'Обратите внимание: скрыв форму локального входа, вы рискуете тем, что администраторы больше не смогут войти в систему под локальной учетной записью, если возникнут проблемы с внешним провайдером идентификации. То же самое произойдет, если вообще не включены никакие другие методы аутентификации, кроме ручной аутентификации.<br /> Чтобы разрешить локальные входы в таких случаях,  будет автоматически включена <a href="{$a->url}">страница локального входа</a>. (подробности см. ниже). Пожалуйста, добавьте этот URL в закладки для вашей собственной подстраховки.';
$string['loginlocalloginformhead'] = 'Локальный вход';
$string['loginlocalloginlocalnotdisabled'] = 'Нет необходимости входить в систему на этой странице локального входа. Используйте <a href="{$a->url}">стандартную страницу входа</a>.';
...
$string['maxsitenamewidth'] = 'Максимальная ширина названия сайта в панели навигации';
$string['maxsitenamewidth_desc'] = 'Если у вас очень длинное название сайта и вы хотите предотвратить его некорректное отображение в панели навигации (особенно виджета кнопки редактирования) на экранах средней ширины, вы можете установить здесь максимальную ширину названия сайта в панели навигации. Если название сайта превышает эту ширину, оно будет обрезано многоточием (...). Вы можете ввести значение в пикселях (например, 200px), а также значение в процентах (например, 20%) или значение ширины области просмотра (например, 15vw). Если вы не укажете никакого значения, название сайта будет отображаться во всю свою ширину.';
...
$string['settingsoverview_snippets_desc'] = 'С помощью SCSS-фрагментов вы можете добавить дополнительные визуальные эффекты или улучшить внешний вид своего сайта Moodle.';
$string['settingsoverview_title'] = 'Обзор настроек Boost Union';
$string['showasbadge'] = 'Показать в виде значка';
$string['showastext'] = 'Показать в виде текста';
...
$string['showhintcourseguestenrolauthonly'] = 'Все зарегистрированные пользователи сайта Moodle могут свободно получить доступ к содержимому этого курса, не записываясь на него.';
$string['showhintcourseguestenrolauthonlyalways'] = 'Все зарегистрированные пользователи сайта Moodle могут получить доступ к содержимому этого курса, если знают пароль для гостевого доступа.';
$string['showhintcourseguestenrolcallforaction'] = 'Если вы не хотите предоставлять бесплатный доступ к этому курсу, отключите гостевой доступ или установите гостевой пароль в настройках курса.';
$string['showhintcourseguestenrolcallforactionalways'] = 'Если вы не хотите предоставлять гостевой доступ к этому курсу, отключите гостевой доступ в <a href="{$a->url}">настройках курса</a>.';
$string['showhintcourseguestenroleveryone'] = 'Все пользователи Moodle и даже пользователи без учетной записи Moodle могут свободно получать доступ к содержимому этого курса, не записываясь на курс.';
$string['showhintcourseguestenroleveryonealways'] = 'Все пользователи Moodle и даже пользователи без учетной записи Moodle могут получить доступ к содержимому этого курса без зачисления, если знают пароль для гостевого доступа.';
$string['showhintcourseguestenrolhint'] = 'В настоящее время этот курс доступен всем, и возможен <strong>гостевой доступ без пароля</strong>.';
$string['showhintcourseguestenrolhintalways'] = 'В настоящее время этот курс доступен всем, и возможен гостевой доступ по паролю.';
...
$string['showhintcourseguestenrolsetting_note'] = 'Примечание: Если вы хотите дополнить подсказку ссылкой на какой-либо курс, можно использовать заполнитель {&dollar;a->courseid}.';
...
$string['sliderfrontpagepositionsetting_beforeafter'] = 'Перед основным содержимым сайта (но после рекламных плиток)';
$string['sliderfrontpagepositionsetting_beforebefore'] = 'Перед основным содержимым сайта (и перед рекламными плитками)';
...
$string['smartmenusbyadmin'] = 'Показывать';
$string['smartmenusbyadmin_admins'] = 'Только администраторам сайта';
$string['smartmenusbyadmin_all'] = 'Всем пользователям';
$string['smartmenusbyadmin_help'] = 'Ограничьте видимость в зависимости от того, является ли пользователь администратором сайта или нет.';
$string['smartmenusbyadmin_nonadmins'] = 'Только не администраторам';
...
$string['smartmenusmenuitemcardimagealt'] = 'Альтернативный текст изображения на карточке';
$string['smartmenusmenuitemcardimagealt_help'] = 'Альтернативный текст для изображения на карточке этого пункта меню. Вы можете использовать заполнитель {menutitle}, чтобы вставить настроенный заголовок пункта меню в свой собственный альтернативный текст. Если вы оставите это поле пустым, в качестве альтернативного текста будет автоматически использоваться текст пункта меню.';
...
$string['smartmenusmenuitemdisplayallcourses'] = 'Показать скрытые курсы';
...
$string['smartmenusmenuitemdisplayonlyvisiblecourses'] = '';
$string['smartmenusmenuitemdisplayonlyvisiblecourses_help'] = 'При включенном параметре в списке курсов не будут отображаться скрытые курсы ни в одном умном меню, даже для администраторов и пользователей, имеющих права доступа moodle/course:viewhiddencourses для данного курса.';
...
$string['smartmenusmenuitememail'] = 'Адрес электронной почты получателя';
$string['smartmenusmenuitememail_help'] = 'Адрес электронной почты получателя для пункта меню. Он будет использован для создания ссылки mailto, которая откроется при нажатии на пункт меню.';
$string['smartmenusmenuitememail_required'] = 'Обязательно – введите действительный адрес электронной почты без префикса «mailto:».';
$string['smartmenusmenuitemhiddencoursesortingend'] = 'Показывать скрытые курсы в конце списка курсов';
$string['smartmenusmenuitemhiddencoursesortingtogether'] = 'Сортировать скрытые и видимые курсы вместе.';
$string['smartmenusmenuitemhiddencoursessorting'] = 'Сортировка скрытых курсов';
$string['smartmenusmenuitemhiddencoursessorting_help'] = 'Выберите способ сортировки скрытых курсов в списке курсов в динамических пунктах меню курсов.';
$string['smartmenusmenuitemhidehiddencourses'] = 'Не показывать скрытые курсы';
$string['smartmenusmenuitemicon'] = 'Иконка';
$string['smartmenusmenuitemicon_ajaxtoomanyicons'] = 'Слишком много значков ({$a}) для отображения. Нужно сузить область поиска.';
$string['smartmenusmenuitemicon_help'] = 'Значок, отображаемый рядом с заголовком пункта меню.<br /><br />Вы можете выбрать значок из основной библиотеки значков Moodle или использовать значок FontAwesome. Это важное различие:<ul><li>Значки Moodle:<br />Moodle определяет свои значки как «пиксельные значки» и сопоставляет значки FontAwesome с этими пиксельными значками. Конкретный сопоставленный значок FontAwesome не гарантирует стабильности навсегда и может измениться в будущих версиях ядра Moodle. Кроме того, существуют пиксельные значки ядра Moodle, которые имеют дополнительный цвет Bootstrap.</li><li>Значки FontAwesome:<br />Значки FontAwesome используются как есть, и их отображение останется стабильным в будущих релизах Moodle. Вполне возможно, что значок FontAwesome изменится, если ядро Moodle обновится до будущей версии FontAwesome.</li></ul>Если вы сомневаетесь и вам не нужно использовать определенный значок Moodle, вам следует предпочесть использовать здесь значок FontAwesome.';
$string['smartmenusmenuitemicon_noicon'] = 'Значок не выбран';
$string['smartmenusmenuitemicon_placeholder'] = 'Выберите значок';
$string['smartmenusmenuitemicon_sourcecore'] = 'Ядро Moodle';
...
$string['smartmenusmenuitemtitle_help'] = 'Заголовок меню. Он будет использоваться в качестве метки этого пункта меню.';
...
$string['smartmenusmenuitemtype_help'] = '<p>Выберите тип пункта меню, который вы хотите создать, выбрав один из вариантов: статический, mailto, заголовок, документация Moodle, динамические курсы и разделитель.</p><ul><li>Статический: Статический пункт меню — это просто ссылка на фиксированный URL-адрес, который не меняется.</li><li>Mailto: Пункт меню mailto открывает почтовый клиент пользователя по умолчанию для создания сообщения на указанный адрес электронной почты.</li><li>Заголовок: Пункт меню «Заголовок» используется для группировки связанных пунктов меню под общим заголовком.</p> Он не содержит ссылки и не является кликабельным.</li><li>Разделитель: Разделитель отображает горизонтальную линию в меню для визуального разделения групп пунктов меню.</li><li>Документация Moodle: Пункт меню «Документация Moodle» используется для ссылки на соответствующую статью MoodleDocs, аналогично ссылке MoodleDocs, расположенной в нижнем колонтитуле Moodle (значок вопросительного знака).</li><li>Динамические курсы: Пункт меню «Динамические курсы» используется для отображения списка курсов на основе определенных критериев, таких как категория курса, роль зачисления на курс, статус завершения курса или диапазон дат. Содержимое, отображаемое в пункте меню «Динамические курсы», будет автоматически обновляться по мере изменения критериев.</li></ul>';
$string['smartmenusmenuitemtypedivider'] = 'Разделитель';
$string['smartmenusmenuitemtypedocs'] = 'Документация Moodle';
...
$string['smartmenusmenulocation_help'] = '<p>Выберите место(а) отображения меню на странице:</p><ul><li>Основная навигация находится в верхней части страницы, где отображаются  элементы навигации по администрированию сайта и «В начало», «Личный кабинет», «Мои курсы».</li><li>Строка меню расположена над основной навигацией в верхней части страницы.</li><li>Доступ к меню пользователя можно получить, щелкнув пользователя или его аватар на панели навигации.</li><li>Нижняя панель расположена в нижней части экрана и может использоваться для навигации с помощью большого пальца для быстрого доступа к важным областям, таким как «В начало», «Личный кабинет», «Мои курсы».</li></ul><p>Обратите внимание, что при включении нижней панели значок «гамбургера» будет заменен логотипом вашего сайта, поскольку пользователи смогут перейти к основной навигации, используя нижнюю панель.</р>';
...
$string['smartmenusrestrictbyadminheader'] = 'Ограничить видимость в зависимости от статуса администратора сайта';
...
$string['snippetsbuiltinsnippetsheading'] = 'Встроенные фрагменты';
$string['snippetscreator'] = 'Разработчик';
$string['snippetsdescription'] = 'Описание';
$string['snippetsdetails'] = 'Подробности';
$string['snippetsdetailspreview'] = 'Предварительный просмотр';
$string['snippetsdisable'] = 'Запретить';
$string['snippetsenable'] = 'Разрешить';
$string['snippetsgoal'] = 'Цель';
$string['snippetsgoalaccessibility'] = 'Общедоступность';
$string['snippetsgoalbugfix'] = 'Исправление ошибки';
$string['snippetsgoaldevsonly'] = 'Только для разработчиков';
$string['snippetsgoaleaseofuse'] = 'Простота использования';
$string['snippetsgoaleyecandy'] = 'Приятно для глаз';
$string['snippetsnothingtodisplay'] = 'В настоящее время отсутствуют доступные SCSS-фрагменты. Пожалуйста, перейдите на вкладку «Настройки» и включите встроенные SCSS-фрагменты или загрузите свои собственные.';
$string['snippetsoverview'] = 'Обзор';
$string['snippetsoverview_desc'] = 'SCSS-фрагменты от Boost Union позволяют добавлять маленькие (или небольшие) фрагменты SCSS-кода на сайт Moodle. Это может быть особенно полезно для исправления небольших визуальных сбоев в ядре Moodle или для добавления визуальной привлекательности для вашего сайта Moodle.';
$string['snippetsoverview_notes'] = 'Чтобы использовать фрагменты CSS-кода, ознакомьтесь с этими основными инструкциями:';
$string['snippetsoverview_notes1'] = 'Фрагменты SCSS могут поступать из нескольких источников. Вы включаете и настраиваете каждый источник на вкладке «Настройки». Как только вы включите хотя бы один источник, вы увидите здесь список фрагментов.';
$string['snippetsoverview_notes2'] = 'Фрагменты SCSS добавляются в стек SCSS один за другим. Таким образом, порядок фрагментов на этой странице имеет ключевое значение.';
$string['snippetsoverview_notes3'] = 'После каждого изменения, внесенного на этой странице, кэш темы очищается. Это необходимо для того, чтобы скомпилированный SCSS-код, отправляемый в браузер, был актуальным, и может занять несколько секунд.';
$string['snippetsscope'] = 'Область применения';
$string['snippetsscopecourse'] = 'Курс';
$string['snippetsscopedashboard'] = 'Личный кабинет';
$string['snippetsscopeglobal'] = 'Глобальный';
$string['snippetsscopesitehome'] = 'Главная страница сайта';
$string['snippetssettings'] = 'Настройки';
$string['snippetsshowdetails'] = 'Показать подробности';
$string['snippetsshowthecode'] = 'Показать SCSS-код';
$string['snippetssnippets'] = 'SCSS-фрагменты';
$string['snippetssource'] = 'Источник';
$string['snippetssourcetheme_boost_union'] = 'Встроенная функция Boost Union';
$string['snippetssourceuploaded'] = 'Загрузить';
$string['snippetstestedon'] = 'Протестировано на';
$string['snippetstitle'] = 'Название';
$string['snippetstrackerissue'] = 'Отслеживание фрагментов';
$string['snippetsuploadedsnippetsheading'] = 'Загруженные фрагменты';
$string['snippetsuploadedsnippetsheading_desc'] = 'В дополнение к встроенным фрагментам SCSS, которые официально поддерживаются командой Boost Union, на Github есть <a href="{$a}" target="_blank">репозиторий SCSS-фрагментов </a>, который предназначен для сообщества пользователей SCSS-фрагментов Boost Union. Пожалуйста, ознакомьтесь в этом репозитории с инструкциями по использованию SCSS-фрагментов сообщества, а также с шаблоном для создания своих собственных локальных SCSS-фрагментов.';
$string['snippetsusagenote'] = 'Примечание по использованию';
$string['speciallinksmarkupheading'] = 'Разметка специальных ссылок';
$string['starredcourseslinktargetsetting'] = 'Цель ссылки значка шестеренки для избранных курсов (во всплывающем окне)';
$string['starredcourseslinktargetsetting_desc'] = 'С помощью этого параметра вы можете настроить цель ссылки значка шестеренки для курсов, отмеченных звездочкой (во всплывающем окне). По умолчанию значок шестеренки ссылается на страницу «Мои курсы». Однако вы также можете перейти по ссылке на страницу «Личный кабинет», особенно если вы отключили страницу «Мои курсы» в основной навигации.';
...
$string['tertiarysettings'] = 'Список настроек Boost Union';
...
$string['upgradenotice_2025041410'] = 'Параметр «Показывать подсказку для гостевого доступа» был обновлен и теперь поддерживает больше вариантов. Ваша существующая конфигурация (которая была установлена на «Да») теперь имеет новый параметр: «Да, но только если пароль для гостевого доступа не установлен».';
$string['upgradenotice_2025041413'] = 'Параметр «courselistinghowfields» был переименован в «courselistingshowfields» для исправления опечатки. Ваша существующая конфигурация изменена на новое название параметра.';
$string['upgradenotice_2025041416'] = 'Теперь разделители умного меню доступны в качестве отдельного типа пунктов меню. Имеющиеся разделители (созданные с использованием заголовка со знаками решетки) были автоматически преобразованы в  разделители нового типа.';
$string['uploadedsnippets'] = 'Загрузить фрагменты';
$string['uploadedsnippets_desc'] = 'Вы можете загрузить либо отдельные файлы с SCSS-фрагментами, либо ZIP-архив, содержащий несколько таких файлов. ZIP-архив будет автоматически распакован, и содержащиеся в нем SCSS-фрагменты станут доступны в этой файловой области в виде отдельных файлов.';
$string['uploadedsnippets_note'] = 'Структуру и синтаксис SCSS-фрагментов Boost Union можно найти в нашем <a href="{$a->url}" target="_blank">репозитории SCSS-фрагментов</a>. Там же вы найдете инструкции по использованию существующих фрагментов кода, созданных сообществом, и по добавлению новых фрагментов в сообщество.';
$string['usermenuheading'] = 'Меню пользователя';
$string['warningboostunioninactive'] = 'Тема Boost Union (или дочерняя тема Boost Union) в настоящее время не является активной. Настройки на этих страницах не будут иметь никакого эффекта, если вы не сделаете Boost Union активной темой или не разрешите использовать Boost Union в качестве темы для категорий/курсов/пользователей/глобальных групп.';
$string['warningslashargumentsdisabled'] = 'Внимание:  <a href="{$a->url}">Параметр slasharguments</a> в вашей конфигурации Moodle в настоящее время отключен. Однако этот параметр необходим для корректной работы следующего параметра Boost Union. Пожалуйста, включите параметр slasharguments, иначе следующий параметр Boost Union не будет иметь никакого эффекта.';
