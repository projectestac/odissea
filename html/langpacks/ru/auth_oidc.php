...
$string['cfg_authendpoint_desc'] = 'Используемый URI конечной точки авторизации от вашего провайдера идентификации.';
...
$string['cfg_clientid_desc'] = 'Ваш ID клиента, зарегистрированный у провайдера идентификации.';
$string['cfg_clientid_key'] = 'ID клиента';
$string['cfg_clientsecret_desc'] = 'Ваш ключ (Secret) клиента, зарегистрированный у провайдера идентификации. У некоторых провайдеров он также называется ключом.';
$string['cfg_clientsecret_key'] = 'Ключ клиента';
...
$string['cfg_tokenendpoint_desc'] = 'URI токена конечной точки вашего провайдера идентификации.';
$string['cfg_tokenendpoint_key'] = 'Токен конечной точки';
$string['cfg_tools'] = 'Инструменты';
$string['cfg_userrestrictioncasesensitive_desc'] = 'Это контролирует, используется ли параметр «/i» в регулярном выражении при сопоставлении ограничений  пользователя.<br/>
Если этот параметр включен, все проверки ограничений для пользователей будут выполняться с учетом регистра. Обратите внимание, если параметр отключен, любые шаблоны в регистрах букв будут проигнорированы.';
...
$string['errorauthnocreds'] = 'Настройте учетные данные клиента OpenID Connect.';
$string['errorauthnoendpoints'] = 'Настройте конечные точки сервера OpenID Connect.';
