...
$string['postisprivatereply'] = 'Это личный ответ. Он виден только вам и тем, у кого есть возможность просматривать личные ответы, например учителям или управляющим.';
