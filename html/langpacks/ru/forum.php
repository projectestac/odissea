...
$string['announcementsettings'] = 'Настройки по умолчанию форума объявлений';
$string['announcementsettings_help'] = 'Эти настройки определяют значения по умолчанию для всех форумов объявлений.';
...
$string['browsediscussions'] = 'Просмотр обсуждений';
$string['bynameondate'] = 'от {$a->name} - {$a->date}';
$string['cachedef_forum_count_discussions'] = 'Количество обсуждений на форуме';
...
$string['cannotmovenotvisible'] = 'Форум скрыт';
...
$string['cannotpindiscussions'] = 'К сожалению, у вас нет права закреплять обсуждения.';
...
$string['cannotuseseperategroupsandsingletopic'] = 'Изолированные группы нельзя использовать в форуме типа «Простое обсуждение»';
$string['cannotusesingletopicandseperategroups'] = 'Форум типа «Простое обсуждение» нельзя использовать с изолированными группами.';
$string['cannotviewpostyet'] = 'Вы не можете видеть сообщения других участников этого обсуждения, т.к. еще не разместили своё.';
...
$string['closegrader'] = 'Закрыть оценивание';
...
$string['completiondiscussions'] = 'Созданы обсуждения';
...
$string['completionposts'] = 'Созданы обсуждения или даны ответы на сообщения';
...
$string['completionpostsinforums'] = 'Сообщения в форумах';
$string['completionreplies'] = 'Даны ответы на сообщения';
...
$string['configlongpost'] = 'Любое сообщение, превышающее эту длину (в символах, не включая теги HTML), считается длинным.
Сообщения, отображаемые на главной странице сайта, страницах курсов в социальном формате или профилях пользователей, сокращаются до естественного разрыва где-то между значениями forum_shortpost и forum_longpost.';
...
$string['configtrackreadposts'] = 'Выберите «Да», если Вы хотите, чтобы каждый пользователь отслеживал, какие сообщения им прочитаны, а какие - нет.';
...
$string['cutoffdate'] = 'Конечная дата';
...
$string['discussionnowsubscribed'] = 'Вы будете получать уведомления о новых сообщениях в обсуждении «{$a->discussion}» из форума «{$a->forum}»';
...
$string['discussionsstartedincourse'] = 'Начались обсуждения в курсе {$a}';
...
$string['editdiscussion'] = 'Редактировать обсуждение';
$string['editdiscussiontopic'] = 'Изменить тему обсуждения';
...
$string['errordiscussionnotfound'] = 'Обсуждение не найдено';
...
$string['errorforumnotfound'] = 'Не найден форум, которому принадлежит это обсуждение';
...
$string['eventdiscussionlockupdated'] = 'Блокировка обсуждения обновлена';
...
$string['eventforumsubscriptionupdated'] = 'Обновлен режим подписки';
...
$string['forum:canmailnow'] = 'Можно публиковать сообщения на форуме вопросов и ответов без задержки на редактирование.';
...
$string['forum:cantogglefavourite'] = 'Помечать обсуждения';
...
$string['forumbodyhidden'] = 'Это сообщение в настоящее время скрыто, скорее всего, потому, что вам сначала нужно опубликовать сообщение в обсуждении и отправить уведомления о сообщениях на форуме.
Также может быть, что текущее время выходит за пределы периода отображения, заданного для сообщения.';
$string['forumgrader'] = 'Оценивание форума';
...
* Простое обсуждение - одиночная обсуждаемая тема, ответить на которую может каждый  (нельзя использовать с изолированными группами).
...
$string['gradeforrating'] = 'Оценка за оценивание: {$a->str_long_grade}';
$string['gradeforratinghidden'] = 'Оценка за оценивание скрыта';
$string['gradeforwholeforum'] = 'Оценка за форум: {$a->str_long_grade}';
$string['gradeforwholeforumhidden'] = 'Оценка за форум скрыта';
$string['gradeitem:forum'] = 'Форум';
$string['gradeitemnameforrating'] = '{$a->name} оценка';
$string['gradeitemnameforwholeforum'] = '{$a->name} за весь форум';
...
$string['noguestpost:title'] = 'Войдите, чтобы продолжить';
...
$string['nowsubscribed'] = 'Вы будете получать уведомления о новых сообщениях форума «{$a->forum}».';
...
$string['pinupdated'] = 'Настройка закрепления обновлена.';
...
$string['postisprivatereply'] = 'Это личный ответ. Он виден только вам и тем, у кого есть право просматривать личные ответы, например учителям.';
$string['postmailinfo'] = 'Это копия сообщения с сайта {$a}.';
...
$string['postsmadeincourse'] = 'Сообщения в курсе {$a}';
...
$string['privatereply_help'] = 'Когда вы отвечаете в частном порядке, ваше сообщение также видно пользователям, у которых есть право просматривать личные ответы, например учителям.';
$string['processingdigest'] = 'Создание дайджеста для {$a}';
$string['processingpost'] = 'Обрабатывается сообщение {$a}...';
$string['prune'] = 'Отделить';
$string['prunediscussion'] = 'Разделить обсуждение';
...
$string['qandanotify'] = 'Это форум «Вопрос-Ответ». Для того, чтобы увидеть ответы других участников на поставленный вопрос, Вам сначала необходимо разместить свой ответ';
$string['re'] = 'Re:';
...
$string['replypostdiscussion'] = 'Ответить на обсуждение';
...
$string['subject'] = 'Тема';
$string['subplugintype_forumreport'] = 'Отчет форума';
$string['subplugintype_forumreport_plural'] = 'Отчеты форума';
...
$string['subscriptionmodeconfirm'] = 'Вы действительно хотите изменить режим подписки на «{$a}»?';
...
$string['thisforumisthrottled'] = 'На этом форуме установлен лимит сообщений, которые Вы можете создать за заданный период времени - в настоящий момент количество сообщений - {$a->blockafter} за {$a->blockperiod}';
...
$string['togglesettingsdrawer'] = 'Переключить меню настроек';
$string['trackforum'] = 'Отслеживание непрочитанных сообщений';
$string['tracking'] = 'Следить';
$string['trackingoff'] = 'Выключить';
$string['trackingon'] = 'Принудительно';
$string['trackingoptional'] = 'Необязательно';
$string['trackingtype'] = 'Отслеживать прочтение сообщений';
...
$string['usernavigation'] = 'Навигация пользователя';
