...
/**
 * Strings for component 'tool_mobile', language 'ru', version '4.5'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['disabledfeatures_desc'] = 'Выберите здесь функции, которые вы хотите отключить в мобильном приложении для своего сайта. Обратите внимание, что некоторые перечисленные здесь функции могут быть уже отключены с помощью других настроек сайта. Увидеть изменения вы сможете после повторного входа в приложение.';
