...
$string['cachedef_contentbank_allowed_categories'] = 'Разрешенные категории курсов банка контента для текущего пользователя';
$string['cachedef_contentbank_allowed_courses'] = 'Разрешенные курсы банка контента для текущего пользователя';
...
$string['cachedef_course_image'] = 'Изображения курса';
$string['cachedef_course_user_dates'] = 'Пользовательские даты для курсов, установленных в режиме относительных дат';
$string['cachedef_courseactionsinstances'] = 'Загруженные примеры действий курса';
...
$string['cachedef_courseeditorstate'] = 'Кэш уровня сеанса для ключа состояния курса для обнаружения изменений курса в браузере';
$string['cachedef_coursehiddengroups'] = 'Количество групп на курсе с ограниченной видимостью';
$string['cachedef_coursemodinfo'] = 'Совокупная информация о модулях и разделах для каждого курса';
$string['cachedef_coursesectionspreferences'] = 'Настройки раздела курса';
...
$string['cachedef_file_imageinfo'] = 'Информация о файле изображения (например - размеры)';
...
$string['cachedef_grade_letters'] = 'Запросы буквенных оценок';
$string['cachedef_gradesetting'] = 'Настройки оценок курса';
...
$string['cachedef_modelfirstanalyses'] = 'Первый анализ по модели и анализируемые данные';
$string['cachedef_moodlenet_usercanshare'] = 'Пользователи могут делиться ресурсами с MoodleNet.';
$string['cachedef_navigation_cache'] = 'Кэш навигации';
...
$string['cachedef_portfolio_add_button_portfolio_instances'] = 'Экземпляры портфолио для класса portfolio_add_button';
...
$string['cachedef_theme_usedincontext'] = 'Тема используется в контексте переопределения темы по умолчанию.';
$string['cachedef_user_course_content_items'] = 'Элементы пользовательского контента (активные элементы, ресурсы и их подтипы) в курсе';
$string['cachedef_user_favourite_course_content_items'] = 'Помеченные пользователем элементы';
...
$string['cacheusage'] = 'Использование кэша';
$string['caching'] = 'Кэширование';
$string['canuselocalstore'] = 'Можно использовать локальное хранилище';
...
$string['default_session'] = 'Хранилище сеанса по умолчанию';
...
$string['editdefinitionmapping'] = 'Изменить сопоставление определений';
...
$string['locknamenotunique'] = 'Выбранное название уже используется. Выберите уникальное название.';
...
$string['store_default_session'] = 'Хранилище по умолчанию для кэша сеанса';
...
$string['storeresults_session'] = 'Запросы к хранилищу при использовании в качестве кэша сеанса.';
...
$string['updatedefinitionmapping'] = 'Изменить сопоставление определений';
$string['updatedefinitionsharing'] = 'Изменить общее использование определений';
$string['usage_items'] = 'Элементы';
$string['usage_mean'] = 'Средний размер элемента';
$string['usage_realtotal'] = 'Фактическое использование (если известно)';
$string['usage_samples'] = 'Кэшируемые элементы';
$string['usage_sd'] = 'Станд. откл.';
$string['usage_total'] = 'Расчетный объем';
$string['usage_totalmargin'] = 'Допустимая погрешность (95%)';
