...
/**
 * Strings for component 'cache', language 'ru', version '4.1'.
 *
 * @package     cache
 * @category    string
...
$string['cachedef_courseeditorstate'] = 'Кэш уровня сессии для ключа состояния курса для обнаружения изменений курса в браузере';
...
$string['cachedef_deprecatedcapabilities'] = 'Список устаревших возможностей системы';
