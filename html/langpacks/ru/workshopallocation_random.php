...
/**
 * Strings for component 'workshopallocation_random', language 'ru', version '4.4'.
 *
...
$string['nogroupusers'] = '<p> Предупреждение: Если в семинаре используется режим «Видимые группы» или режим «Изолированные группы», то пользователи ДОЛЖНЫ быть участниками хотя бы одной группы, чтобы одногруппники могли оценить их работы. Пользователи, не входящие в группы, могут делать новые самооценки или удалять существующие оценки.<p> Эти пользователи в настоящее время не являются членами группы: {$a}</p>';
