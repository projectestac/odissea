...
/**
 * Strings for component 'tiny_c4l', language 'ru', version '4.5'.
 *
 * @package     tiny_c4l
 * @category    string
...
$string['button_c4l'] = 'Компоненты для оформления';
$string['c4l:use'] = 'Использовать «‎Компоненты для оформления» TinyMCE';
...
$string['menuitem_c4l'] = 'Компоненты для оформления (C4L)';
...
$string['pluginname'] = 'Компоненты для оформления';
