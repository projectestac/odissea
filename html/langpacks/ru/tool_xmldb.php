...
/**
 * Strings for component 'tool_xmldb', language 'ru', version '3.11'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['addpersistent'] = 'Добавить обязательные постоянные поля';
...
$string['extraindexesfound'] = 'Найдены лишние индексы';
$string['field'] = 'Поле';
...
$string['keys'] = 'Ключи';
$string['listreservedwords'] = 'Список зарезервированных слов <br /> (используется для обновления  <a href="http://docs.moodle.org/en/XMLDB_reserved_words" target="_blank">зарезервированных слов XMLDB</a>)';
...
$string['nomasterprimaryuniquefound'] = 'Столбцы, на которые ссылается ваш внешний ключ, должны быть включены в первичный или уникальный КЛЮЧ в указанной таблице. Обратите внимание, что столбец, находящийся в УНИКАЛЬНОМ ИНДЕКСЕ, недостаточно хорош.';
$string['nomissingorextraindexesfound'] = 'Не найдены отсутствующие или лишние индексы, поэтому никаких дальнейших действий не требуется.';
...
$string['privacy:metadata'] = 'Плагин редактора XMLDB не хранит никаких личных данных.';
$string['reconcile_files'] = 'Искать файлы XMLDB, требующие согласования';
$string['reconcile_files_intro'] = 'Эта функция просматривает текущее содержимое всех файлов XMLDB, проверяя, соответствуют ли они результатам их создания в редакторе XMLDB.

Отобразится список файлов, которые необходимо согласовать (восстановить), и для их исправления следует использовать редактор XMLDB.';
$string['reconcile_files_no'] = 'Все файлы в порядке, никаких действий по согласованию не требуется';
$string['reconcile_files_yes'] = 'Найдены файлы для согласования:';
$string['reconcilefiles'] = 'Согласовать файлы XMLDB';
...
$string['yesextraindexesfound'] = 'Были найдены следующие лишние индексы.';
