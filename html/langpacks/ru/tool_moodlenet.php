...
$string['removalwarning_feature'] = 'Если вам необходимо продолжить использование MoodleNet, свяжитесь с администратором вашего сайта по поводу настройки собственного экземпляра MoodleNet.';
$string['removalwarning_service'] = 'После этой даты вы больше не сможете просматривать или добавлять контент в MoodleNet Central.';
$string['removalwarning_title'] = 'Сервис MoodleNet будет закрыт 20 апреля 2026 года.';
