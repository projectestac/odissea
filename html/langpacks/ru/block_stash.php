...
/**
 * Strings for component 'block_stash', language 'ru', version '4.5'.
 *
 * @package     block_stash
 * @category    string
...
$string['leaderboard'] = 'Показать таблицу лидеров';
$string['leaderboard_groups'] = 'Показывать в таблице лидеров только пользователей из моих групп';
$string['leaderboards'] = 'Таблица лидеров';
...
$string['mostitems'] = 'Большинство предметов';
$string['mostuniqueitems'] = 'Самые уникальные предметы';
...
$string['navleaderboadsettings'] = 'Настройки таблицы лидеров';
...
$string['settingupdated'] = 'Настройка обновлена.';
