...
/**
 * Strings for component 'hub', language 'ru', version '4.4'.
 *
 * @package     hub
 * @category    string
...
$string['coursesnodates'] = 'Количество курсов без установленной даты окончания ({$a})';
$string['coursesnumber'] = 'Количество курсов ({$a})';
$string['dbtype'] = 'Тип базы данных ({$a})';
...
$string['primaryauthtype'] = 'Основной тип аутентификации ({$a})';
