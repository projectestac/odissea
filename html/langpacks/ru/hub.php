...
/**
 * Strings for component 'hub', language 'ru', version '3.8'.
 *
 * @package     hub
 * @category    string
...
$string['sitecommnewsno'] = 'Нет, я не хочу получать электронные письма от штаб-квартиры Moodle';
...
$string['unregistrationerror'] = 'Во время попытки удаления сайта с Moodle.net произошла ошибка: {$a}';
...
$string['urlalreadyregistered'] = 'Похоже, что Ваш сайт уже зарегистрирован на Moodle.net, а значит что-то пошло не так. Свяжитесь с администратором Moodle.net, чтобы он сбросил Вашу регистрацию и Вы смогли бы попробовать снова.';
