...
$string['testwithtestclientdescription'] = 'Имитировать внешний доступ к службе с использованием тестового клиента веб-службы. Используйте включенный протокол с аутентификацией через токен. <strong>ПРЕДУПРЕЖДЕНИЕ: Поверяемые функции БУДУТ ВЫПОЛНЯТЬСЯ, поэтому будьте осторожны с тем, что вы выбираете для тестирования! </strong>';
...
$string['uploadfiles_help'] = 'При включенном параметре любой пользователь сможет загружать файлы с использованием ключей безопасности в свою область личных файлов или в область черновиков. На любые пользовательские файлы применяются квоты.';
