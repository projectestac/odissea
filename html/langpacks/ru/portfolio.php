...
/**
 * Strings for component 'portfolio', language 'ru', version '4.5'.
 *
 * @package     portfolio
 * @category    string
...
$string['alreadyexporting'] = 'Вы уже сделали экспорт активного портфолио в этом сеансе. Перед продолжением, Вы должны либо завершить этот экспорт или отменить его. Хотите продолжить? (Если нет, то он будет отменен).';
...
$string['confirmcancel'] = 'Вы уверены, что хотите отменить этот экспорт?';
...
$string['exportexceptionnoexporter'] = 'portfolio_export_exception было получено активным сеансом, а не экспортером объекта';
...
$string['returntowhereyouwere'] = 'Вернуться назад';
...
$string['singleinstancenomultiallowed'] = 'Доступен только один экземпляр плагина портфолио, несколько экспортов в сеансе не поддерживается. В сеансе уже есть активный экспорт, использующей этот плагин!';
