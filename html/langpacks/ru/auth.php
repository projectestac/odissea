...
/**
 * Strings for component 'auth', language 'ru', version '4.5'.
 *
 * @package     auth
 * @category    string
...
$string['auth_fieldlock_expl'] = '<p>Блокировка значения: Если параметр включен, то поле будет недоступно для непосредственного редактирования пользователями. Используйте эту опцию, если Вы управляете этими данными во внешней системе аутентификации. </p>';
...
$string['auth_loginpasswordtoggle'] = 'Переключение видимости пароля';
$string['auth_loginpasswordtoggle_desc'] = 'Добавьте значок к полю пароля на экране входа в систему, который позволит пользователям отображать или скрывать введенный пароль.';
$string['auth_loginrecaptcha'] = 'Использовать reCAPTCHA для входа в систему';
$string['auth_loginrecaptcha_desc'] = 'Добавьте на страницу входа элемент формы визуального/аудио подтверждения. Это снижает риск несанкционированных попыток входа в систему. Дополнительную информацию см. в разделе <a href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['emailupdatemessage'] = 'Здравствуйте, {$a->firstname}!

Вы запросили изменение адреса электронной почты для своей учетной записи на сайте {$a->site}.
Чтобы подтвердить это изменение, перейдите по следующей ссылке:
<a href="{$a->url}">Подтвердить изменение электронной почты</a>

Срок действия ссылки для подтверждения истекает через <strong>10 минут</strong>.
...
$string['errorminpasswordnonalphanum'] = 'Пароль должен содержать не менее {$a} специальных символов, таких как *, - или #.';
...
$string['informminpasswordnonalphanum'] = 'не менее {$a} специальных символов, таких как *, - или #.';
...
$string['limitconcurrentlogins_desc'] = 'При включенном параметре число одновременных входов через браузер для каждого пользователя будет ограничено. Самый старый сеанс будет прерван после достижения лимита. Пожалуйста, обратите внимание, что пользователи могут потерять всю несохраненную работу. Эта настройка не совместима с плагинами аутентификации Single Sign-On (SSO).';
...
$string['showloginform'] = 'Отображать форму входа';
$string['showloginform_desc'] = 'Если ваш сайт использует методы аутентификации, которые не требуют от людей ввода своего адреса электронной почты/логина и пароля, например OAuth2, вы можете скрыть стандартную форму входа.
Это несовместимо с методом аутентификации «Ручная регистрация».

Если вы не можете войти в систему и хотите отобразить форму входа, вы можете изменить эту конфигурацию с помощью командной строки: php admin/cli/cfg.php --name=showloginform --set=1.';
