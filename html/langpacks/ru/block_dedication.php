...
/**
 * Strings for component 'block_dedication', language 'ru', version '4.4'.
 *
...
$string['excludesessionslessthan'] = 'Исключает сеансы короче, чем {$a}';
$string['group'] = 'Группа';
...
$string['report_dedication'] = 'Отчет о затраченном времени';
$string['sessionduration'] = 'Длительность сессии';
$string['sessionstart'] = 'Начало сессии';
