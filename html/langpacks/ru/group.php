...
/**
 * Strings for component 'group', language 'ru', version '4.5'.
 *
 * @package     group
 * @category    string
...
$string['deleteselectedgroup'] = 'Удалить';
$string['disablemessagingaction'] = 'Отключить обмен сообщениями';
...
$string['enablemessagingaction'] = 'Включить обмен сообщениями';
...
$string['erroraddtogroup'] = 'Недопустимое значение для addtogroup. Оно должно быть равно 0, если нет группового режима, или 1, если необходимо создать новую группу.';
$string['erroraddtogroupgroupname'] = 'Нельзя указать имя группы, если установлено значение addtogroup.';
...
$string['groupmode_groupsseparate_help'] = 'Студенты делятся на группы и могут видеть работу только своей группы.';
$string['groupmode_groupsvisible_help'] = 'Студенты делятся на группы, но могут видеть работу других групп.';
$string['groupmode_help'] = '* Нет групп
* Изолированные группы: студенты делятся на группы и могут видеть работу только своей группы.
* Видимые группы: студенты делятся на группы, но могут видеть работу других групп.

Групповой режим, установленный на уровне курса, является режимом по умолчанию для всех элементов курса. Если групповой режим принудительно включен на уровне курса, его нельзя изменить для любого элемента курса.';
$string['groupmodeforce'] = 'Принудительный групповой режим';
$string['groupmodeforce_help'] = 'Групповой режим применяется для всех элементов курса и не может быть изменен в настройках элемента.';
$string['groupmy'] = 'Моя группа';
$string['groupname'] = 'Название группы';
$string['groupnameexists'] = 'В этом курсе уже существует группа с названием «{$a}», выберите другое название.';
...
$string['manageactions'] = 'Управление';
$string['memberofgroup'] = 'Участник группы: {$a}';
$string['members'] = 'Участники групп';
$string['membersofselectedgroup'] = 'Участники выбранной группы:';
$string['messagingdisabled'] = 'Обмен сообщениями отключен в группах ({$a})';
$string['messagingenabled'] = 'Обмен сообщениями включен в группах ({$a})';
$string['mygroups'] = 'Мои группы';
$string['namingscheme'] = 'Шаблон названия';
$string['namingscheme_help'] = 'Символ «@» используется для создания групп с названиями, содержащими буквы. Например, по шаблону «Группа @» будут созданы группы с названиями «Группа А», «Группа В», «Группа С», ...

Символ «#» используется для создания групп с названиями, содержащими числа. Например, по шаблону «Группа #» будут созданы группы с названиями «Группа 1», «Группа 2», «Группа 3», ...';
...
$string['participation'] = 'Показать группу в раскрывающемся меню для элементов с групповым режимом';
$string['participation_help'] = 'Должны ли участники группы иметь возможность выбирать эту группу для активных элементов в режиме изолированных или видимых групп? (Применимо только в том случае, если членство в группе видно всем или только участникам.)';
$string['participationshort'] = 'Участие';
...
$string['visibility'] = 'Видимость участников группы';
$string['visibility_help'] = '* Видно всем — все участники курса могут видеть, кто состоит в группе
* Видно только участникам — участники курса, не входящие в группу, не могут просматривать группу или ее участников
* Видно только свое членство — пользователь может видеть, что он в группе, но не может видеть других членов группы.
* Скрыто - только преподаватели могут просматривать группу и ее участников

Пользователи с правом просмотра скрытых групп всегда могут просматривать членство в группах.

Обратите внимание, что вы не можете изменить этот параметр, если в группе есть участники.';
$string['visibilityall'] = 'Видно всем';
$string['visibilitymembers'] = 'Видно только участникам';
$string['visibilitynone'] = 'Скрыто';
$string['visibilityown'] = 'Видно только свое членство';
$string['visibilityshort'] = 'Видимость';
