...
/**
 * Strings for component 'enrol_lti', language 'ru', version '4.5'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['cookiesarerequired'] = 'Файлы cookie блокируются вашим браузером';
$string['cookiesarerequiredinfo'] = 'Этот инструмент невозможно запустить, поскольку ваш браузер блокирует сторонние файлы cookie.
<br><br>
Чтобы использовать этот инструмент, попробуйте изменить настройки файлов cookie вашего браузера или использовать другой браузер.';
...
$string['lti:unenrol'] = 'Отчислять пользователей из курса';
