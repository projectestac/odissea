...
/**
 * Strings for component 'tool_generator', language 'ru', version '4.5'.
 *
...
$string['execute_cleanup'] = 'Сценарии очистки';
$string['execute_scenarios'] = 'Сценарии тестирования';
...
$string['progress_createusers'] = 'Создание учетных записей пользователей ({$a})';
...
$string['step_example'] = 'Пример шага:';
...
$string['testscenario'] = 'Создать сценарии тестирования';
$string['testscenario_description'] = 'При создании сценариев тестирования используется синтаксис ограниченных файлов функций для создания всех необходимых элементов для запуска ручного теста.';
$string['testscenario_errorparsing'] = 'Ошибка анализа файла функции: {$a}';
$string['testscenario_file'] = 'Файл функции';
$string['testscenario_filedesc'] = 'Загруженные файлы функций могут содержать только сценарии с шагами core_data_generator или некоторые конкретные шаги, которые не требуют пакета selenium. Все сценарии будут выполнены одновременно, за исключением тех, которые имеют тег @cleanup.';
$string['testscenario_filedesc_cleanup'] = 'Сценарии с тегом @cleanup будут выполняться только в том случае, если параметр «Выполнить»
установлен на «Очистка». Чтобы выполнить очистку через CLI, можно использовать параметр --cleanup.';
$string['testscenario_filedesc_list'] = 'Список шагов, которые можно использовать в файле функций тестового сценария:';
$string['testscenario_invalidfile'] = 'Файла неверного формата или содержит недопустимые шаги.';
$string['testscenario_invalidstep'] = 'Неизвестный шаг. Создание сценариев тестирования допускает только шаги core_data_generator.';
$string['testscenario_nosteps'] = 'В файле нет шагов для выполнения.';
$string['testscenario_notready'] = 'Библиотеки Composer и Behat не установлены.<br><br>Чтобы включить этот инструмент, выполните следующую команду: <strong>php admin/tool/generator/cli/runtestscenario.php</strong>';
$string['testscenario_outline'] = 'Схемы сценариев не поддерживаются.';
$string['testscenario_scenarionosteps'] = 'В этом сценарии нет никаких шагов.';
$string['testscenario_steps'] = 'Шаги сценария тестирования:';
