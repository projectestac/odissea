...
/**
 * Strings for component 'tool_generator', language 'ru', version '4.4'.
 *
...
$string['testscenario_filedesc'] = 'Загруженные файлы функций могут содержать только сценарии с шагами core_data_generator. Они еще не совместимы со схемами сценариев. Все сценарии будут выполнены одновременно, шаги в фоне будут игнорироваться.';
