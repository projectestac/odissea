...
/**
 * Strings for component 'cohort', language 'ru', version '4.5'.
 *
 * @package     cohort
 * @category    string
...
$string['bulkadd'] = 'Добавить в глобальную группу';
...
$string['cohortmember'] = 'Член глобальной группы';
...
$string['delcohortsconfirm'] = 'Это приведет к удалению глобальных групп и всех связанных с ними данных.';
$string['delcohortssuccess'] = 'Выбранные глобальные группы удалены';
$string['delconfirm'] = 'Это приведет к удалению глобальной группы «{$a}» и всех связанных с ней данных.';
$string['delsuccess'] = 'Глобальная группа удалена';
...
$string['editcohortidnumber'] = 'Редактировать идентификационный номер глобальной группы';
...
$string['idnumber'] = 'Идентификационный номер глобальной группы';
$string['invalidtheme'] = 'Тема глобальной группы не существует';
$string['memberofcohort'] = 'Член глобальной группы';
...
$string['newidnumberfor'] = 'Новый идентификационный номер для глобальной группы {$a}';
...
$string['useradded'] = 'Пользователь добавлен в глобальную группу «{$a}»';
$string['visible'] = 'Видимая';
