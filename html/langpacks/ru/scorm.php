...
$string['aicchacpkeepsessiondata'] = 'Хранить данные о сеансе AICC HACP';
$string['aicchacpkeepsessiondata_desc'] = 'Продолжительность времени (в днях) хранения данных о сеансе внешней AICC HACP  (большая длительность дополнит таблицу со старыми данными, но может быть полезна при отладке)';
$string['aicchacptimeout'] = 'Тайм-аут AICC HACP';
$string['aicchacptimeout_desc'] = 'Период времени в минутах, когда сеанс внешнего AICC HACP может оставаться открытым';
...
$string['browsemodewithname'] = 'Режим предварительного просмотра: {$a}';
$string['browserepository'] = 'Посмотреть  репозиторий';
$string['cachedef_elements'] = 'Кэш элементов';
...
$string['completiondetail:completionstatuscompletedorpassed'] = 'Завершить и пройти задание';
...
$string['completionstatusallscos'] = 'Все SCOs должны вернуть статус завершения';
$string['completionstatusallscos_help'] = 'Некоторые пакеты SCORM содержат несколько компонентов или «scos» — если эта опция включена, все scos в пакете должны возвращать соответствующий lesson_status, чтобы данное действие было отмечено как завершенное.';
...
$string['coursestruct'] = 'Структура контента';
...
$string['displaycoursestructure'] = 'Отображать структуру контента на входной странице';
...
$string['hidebrowse_help'] = 'Режим предварительного просмотра позволяет студенту ознакомиться с заданием, прежде чем приступить к его выполнению. Если режим предварительного просмотра отключен, кнопка предварительного просмотра недоступна.';
...
$string['hidetoc'] = 'Показать структуру контента';
...
$string['invalidhacpsession'] = 'Неверный сеанс HACP';
...
$string['largetrackupgrade'] = 'Выполнение следующего шага обновления может занять некоторое время. На вашем сайте есть записи SCORM ({$a}), которые необходимо перенести в новую таблицу. Наберитесь терпения, так как индикатор выполнения не отображается.';
...
$string['minimumscoregreater'] = 'Минимальный балл должен быть больше 0.';
...
$string['privacy:metadata:scorm_attempt'] = 'Попытки SCORM, предпринятые пользователем';
...
$string['toggletableofcontents'] = 'Переключение оглавления';
