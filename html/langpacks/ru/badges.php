...
/**
 * Strings for component 'badges', language 'ru', version '3.11'.
 *
 * @package     badges
 * @category    string
...
$string['criteria_9'] = 'Компетентости';
...
$string['nocompetencies'] = 'Не выбрано ни одной компетентности.';
...
$string['requiredcompetency'] = 'В критерий компетентности следует добавить хотя бы одну компетентность.';
...
$string['sitebackpack'] = 'Активная внешняя коллекция наград';
$string['sitebackpack_help'] = 'Внешняя коллекция наград, к которой пользователи могут подключиться с этого сайта. Обратите внимание, что изменение этого параметра после того, как пользователи подключили свои коллекции наград, потребует от каждого пользователя перейти на страницу настроек своей коллекции и отключиться, а затем снова подключиться.';
...
$string['sitebackpackverify'] = 'Подключение коллекции наград';
