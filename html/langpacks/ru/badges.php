...
$string['error:notifycoursedate'] = 'Предупреждение: значки, связанные с завершением курса и  выполнением элементов курса не могут быть выданы до даты начала курса.';
