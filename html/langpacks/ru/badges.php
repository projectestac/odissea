...
/**
 * Strings for component 'badges', language 'ru', version '4.5'.
 *
 * @package     badges
 * @category    string
...
$string['badgesnavigation'] = 'Навигация по значкам';
...
$string['canvascredentialsprovider'] = 'Учетные данные Canvas';
$string['canvasregions'] = 'Области учетных данных Canvas';
$string['canvasregions_desc'] = 'Вы можете настроить содержимое областей учётных данных Canvas. Каждая строка разделяется вертикальной чертой и содержит: 1) название области, 2) URL-адрес коллекции и 3) URL-адрес API коллекции.';
$string['claim'] = 'Заявка';
...
$string['contact'] = 'Контакт эмитента';
...
$string['error:cannotsendtobackpack'] = '<strong>Не удаётся добавить значок в коллекцию наград</strong><br />
Ваш поставщик коллекции наград отправляет следующее сообщение: «{$a}».<br /><br />
Вы можете попробовать скачать значок и добавить его в коллекцию наград вручную или повторить попытку позже.';
...
$string['includeauthdetails'] = 'Подключить учётную запись поставщика коллекции';
$string['includeauthdetails_desc'] = 'Введите учётные данные эмитента значка, чтобы подключить учётную запись поставщика коллекции.';
$string['includeauthdetails_help'] = 'Указывает данные вашего эмитента с каждым значком, экспортированным в эту коллекцию.';
$string['includeauthdetailscanvas'] = 'Подключить учётную запись эмитента Canvas';
$string['includeauthdetailscanvas_desc'] = 'Введите свои учетные данные Canvas, чтобы подключить учетную запись эмитента.';
$string['includeauthdetailscanvas_help'] = 'При экспорте значков в Canvas Credentials, ваша организация будет указана как эмитент. Это также позволит вам отслеживать получателей значков и управлять обновлениями.';
$string['includeauthdetailscanvas_subtitle'] = '(Требуется платный тарифный план Canvas Credentials)';
...
$string['namewithimagelink'] = 'Название с изображением и ссылкой';
