...
/**
 * Strings for component 'badges', language 'ru', branch 'MOODLE_38_STABLE'
 *
 * @package   badges
...
$string['addcompetency'] = 'Добавить компетентность';
$string['addcompetency_help'] = 'Выберите все компетентности, которые должны быть добавлены к требованию для этого значка. Удерживайте клавишу CTRL, чтобы выбрать несколько компетентностей.';
...
$string['allmethodcompetencies'] = 'Все выбранные компетентности были подтверждены.';
...
$string['anymethodcompetencies'] = 'Любая из выбранных компетентностей была подтверждена';
...
$string['defaultissuerpassword_help'] = 'На сайте требуется учетная запись с адресом электронной почты, указанным в настройках почты эмитента значка: Администрирование сайта > Значки > Настройки значков. Пароль для учетной записи должен быть введен здесь.';
