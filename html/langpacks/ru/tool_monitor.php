...
/**
 * Strings for component 'tool_monitor', language 'ru', version '4.5'.
 *
...
* Ссылка на расположение произошедшего события {link}
* Ссылка на область, где произошло событие {modulelink}
* Название модуля курса {modulename}
* Название правила {rulename}
* Описание {description}
* Событие {eventname}
* Полное название курса {coursefullname}
* Краткое название курса {courseshortname}';
