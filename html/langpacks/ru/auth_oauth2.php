...
/**
 * Strings for component 'auth_oauth2', language 'ru', version '4.5'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['confirmaccountemail'] = 'Здравствуйте, {$a->firstname}!

На сайте «{$a->sitename}» была запрошена новая учетная запись с использованием Вашего адреса электронной почты.

Чтобы подтвердить свою новую учетную запись, перейдите по следующей ссылке:

<a href="{$a->link}">Подтвердить новую учетную запись</a>

Если вам нужна помощь -  свяжитесь с администратором сайта
{$a->admin}

Если вы этого не сделаете, кто-то другой может попытаться взломать вашу учетную запись.
Пожалуйста, немедленно свяжитесь с администратором сайта.';
...
$string['confirmlinkedloginemail'] = 'Здравствуйте, {$a->firstname}!
...
Чтобы подтвердить это действие и связать эти учетные записи, перейдите по следующей ссылке:

<a href="{$a->link}">Связать учетные записи</a>
...
$string['loggedin'] = 'Пользователь успешно прошел аутентификацию у провайдера.';
...
$string['noconfiguredidps'] = 'Нет настроенных поставщиков OAuth2.';
...
$string['testidplogin'] = 'Тестовый вход с помощью:';
$string['userinfo'] = 'Данные пользователя от провайдера:';
