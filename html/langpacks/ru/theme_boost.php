...
$string['brandcolor'] = 'Фирменный цвет';
...
$string['presetfiles_desc'] = 'Файлы с предустановками (шаблоны) могут использоваться для существенного изменения внешнего вида темы.';
