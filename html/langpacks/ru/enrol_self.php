...
$string['newenrols'] = 'По умолчанию разрешить новые самозаписи';
...
$string['status'] = 'Разрешить самостоятельную запись на курс';
$string['status_desc'] = 'Использовать способ самостоятельной регистрации в новых курсах (отключен по умолчанию).';
$string['status_help'] = 'При включенном параметре вместе с отключенным параметром «По умолчанию разрешить новые самозаписи», доступ к курсу могут получить только пользователи, которые ранее самостоятельно записались на курс. Если параметр отключен, этот метод самостоятельной записи фактически отключается, так как все существующие самостоятельные записи на курс заблокированы, а новые пользователи не могут записаться на курс.';
