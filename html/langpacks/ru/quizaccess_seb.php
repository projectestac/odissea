...
/**
 * Strings for component 'quizaccess_seb', language 'ru', version '4.5'.
 *
...
$string['seb:manage_seb_configuremanually'] = 'Изменить настройки теста SEB: выбрать ручную настройку';
...
$string['seb:manage_seb_usesebclientconfig'] = 'Изменять настройки SEB для теста: Использовать конфигурацию пользователя SEB';
