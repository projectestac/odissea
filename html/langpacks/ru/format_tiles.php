...
/**
 * Strings for component 'format_tiles', language 'ru', version '4.1'.
 *
...
$string['registerintro5'] = 'Ваши данные будут храниться разработчиком в тайне, как указано в политике конфиденциальности, ссылка на которую приведена ниже. Спасибо за Вашу поддержку!';
$string['registermissingemail'] = 'Пожалуйста, заполните свой адрес электронной почты (ниже вы выбрали «Да» для электронных писем)';
$string['registerpickemailpref'] = 'Пожалуйста, выберите предпочтительный адрес электронной почты';
$string['registerpolicyagreedlinktext'] = 'Политика конфиденциальности и Соглашение об обработке данных';
