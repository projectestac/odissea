...
Для подтверждения этого запроса и создания нового пароля для своей учетной записи, пожалуйста, перейдите по адресу: <a href="{$a->link}">{$a->link}</a>.
...
Если вам нужна помощь, можете обратиться к администратору сайта
{$a->signoff}';
