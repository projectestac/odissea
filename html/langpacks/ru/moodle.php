...
/**
 * Strings for component 'moodle', language 'ru', version '4.1'.
 *
 * @package     moodle
 * @category    string
...
$string['addfilehere'] = 'Перетащите сюда файлы, чтобы добавить их внизу этого раздела.';
...
$string['emptysectionids'] = 'ID пустых разделов';
...
$string['hiddensections_help'] = 'Скрытые разделы могут отображаться студентам на странице курса как «недоступные» или быть полностью скрытыми.';
$string['hiddensectionscollapsed'] = 'Скрытые разделы отображаются как недоступные';
...
$string['sites'] = 'Сайты';
$string['sitesection'] = 'Включить верхнюю секцию';
...
$string['unexistingsectionid'] = 'ID раздела курса не найден';
