...
/**
 * Strings for component 'moodle', language 'ru', version '4.5'.
 *
 * @package     moodle
 * @category    string
...
$string['activityheader'] = 'Меню элементов курса';
$string['activityicon'] = 'Иконка {$a}';
...
$string['activitynotready'] = 'Активный элемент еще не готов';
$string['activityorresource'] = 'Элемент или ресурс';
$string['activityreport'] = 'Отчет по элементам';
$string['activityreports'] = 'Отчеты по элементам';
...
$string['addcontent'] = 'Добавить контент';
...
$string['addfilehere'] = 'Перетащите сюда файлы, чтобы добавить их внизу этой секции.';
$string['addfilesdrop'] = 'Вы можете перетащить сюда загружаемые файлы или нажать, чтобы их выбрать.';
$string['addinganew'] = 'Новое: {$a}';
$string['addinganewto'] = 'Добавить {$a->what} в {$a->to}';
$string['addingdatatoexisting'] = 'Добавление данных к существующим';
$string['additionalcustomnav'] = 'Дополнительная пользовательская навигация';
...
$string['addsections'] = 'Добавить секции';
...
$string['adminhelpsitesettings'] = 'Определите вид главной страницы сайта';
...
$string['backupinfo'] = 'Сделайте копию этого курса, включая все актуальное содержимое и активные элементы. Вы сможете использовать файл резервной копии для восстановления этого курса.';
$string['backuplogdetailed'] = 'Детальная информация о выполнении';
$string['backuploglaststatus'] = 'Последняя информация о выполнении';
...
$string['backupnotyetrun'] = 'Автоматическое резервное копирование ожидается';
...
$string['blocks'] = 'Блоки';
$string['blocks_main'] = 'Основные блоки контента';
$string['blocks_supplementary'] = 'Дополнительные блоки';
...
$string['bycourseorder'] = 'По порядку в курсе';
$string['byname'] = 'от {$a}';
...
$string['categoryheader'] = 'Меню категорий';
...
$string['categorypath'] = 'Путь к категории';
...
$string['changesmade'] = 'Внесены изменения';
...
$string['checkactual'] = 'Текущие';
$string['checkall'] = 'Отметить все';
$string['checkerror'] = 'Ошибка при получении результата проверки «{$a}». Проверьте консоль браузера для получения дополнительной информации.';
$string['checkexpected'] = 'Ожидаемые';
...
$string['checkloading'] = 'Получение результата проверки «{$a}»';
...
$string['closeblockdrawer'] = 'Закрыть боковую панель';
$string['closebuttontitle'] = 'Закрыть';
$string['closecourseindex'] = 'Закрыть оглавление курса';
$string['closedrawer'] = 'Закрыть панель';
$string['closewindow'] = 'Закрыть окно';
$string['collapse'] = 'Свернуть';
$string['collapseall'] = 'Свернуть всё';
$string['collapsecategory'] = 'Свернуть {$a}';
$string['comebacklater'] = 'Пожалуйста, зайдите позже.';
...
$string['confirmdeletesection'] = 'Вы абсолютно уверены, что хотите полностью удалить секцию «{$a}» и все элементы, содержащиеся в ней?';
...
$string['contextname'] = 'Название контекста';
$string['contextparent'] = 'Родитель';
$string['contexturl'] = 'Контекстный URL-адрес';
...
$string['cookiesenabled_help'] = 'На этом сайте используется два файла cookie:

Строго необходимым является файл cookie для сеансов, обычно называемый MoodleSession. Вы должны разрешить использование этого файла cookie в своем браузере, чтобы обеспечить непрерывность при переходах и оставаться в системе при просмотре сайта. Когда вы выходите из системы или закрываете браузер, этот файл cookie уничтожается (в вашем браузере и на сервере).

Другой файл cookie предназначен исключительно для удобства и обычно называется MOODLEID или аналогично. Он используется для сохранения вашего логина в браузере. Это означает, что когда вы вернетесь на этот сайт, поле логин на странице входа уже будет заполнено. Можно отказаться от использования этого файла cookie, но тогда вам придется каждый раз при открытии сайта вводить свой логин заново.';
$string['cookiesenabled_help_html'] = 'На этом сайте используется два файла cookie:<br/><br/>

Строго необходимым является файл cookie для сеансов, обычно называемый MoodleSession. Вы должны разрешить использование этого файла cookie в своем браузере, чтобы обеспечить непрерывность при переходах и оставаться в системе при просмотре сайта. Когда вы выходите из системы или закрываете браузер, этот файл cookie уничтожается (в вашем браузере и на сервере).<br/><br/>

Другой файл cookie предназначен исключительно для удобства и обычно называется MOODLEID или аналогично. Он используется для сохранения вашего логина в браузере. Это означает, что когда вы вернетесь на этот сайт, поле логин на странице входа уже будет заполнено. Можно отказаться от использования этого файла cookie, но тогда вам придется каждый раз при открытии сайта вводить свой логин заново.';
$string['cookiesenabledonlysession'] = 'В Вашем браузере должен быть разрешен прием cookies';
$string['cookiesenabledonlysession_help'] = 'На этом сайте используется один файл cookie для сеансов, обычно называемый MoodleSession. Вы должны разрешить использование этого файла cookie в своем браузере, чтобы обеспечить непрерывность при переходах и оставаться в системе при просмотре сайта. Когда вы выходите из системы или закрываете браузер, этот файл cookie уничтожается (в вашем браузере и на сервере).';
$string['cookiesnotenabled'] = 'К сожалению, в Вашем браузере отключены cookies';
$string['cookiesnotice'] = 'Уведомление о файлах cookie';
...
$string['courseapprovedemail'] = 'Запрошенный Вами курс одобрен: <a href="{$a->url}">{$a->name}</a>. Вам назначена роль «{$a->teacher}».';
$string['courseapprovedemail2'] = 'Запрошенный вами курс одобрен: <a href="{$a->url}">{$a->name}</a>.';
$string['courseapprovedfailed'] = 'Не удается сохранить курс, как одобренный!';
$string['courseapprovedsubject'] = 'Ваш запрос на создание курса одобрен.';
...
$string['coursedetails'] = 'Информация о курсах';
$string['coursedisplay'] = 'Представление курса';
$string['coursedisplay_help'] = 'Разделы курса могут отображаться все на одной странице или разбиты на несколько страниц.';
...
$string['courseduration'] = 'Продолжительность курса';
...
$string['courseheader'] = 'Меню курса';
...
$string['courseoverviewfiles'] = 'Изображение курса';
$string['courseoverviewfiles_help'] = 'Изображение курса отображается на странице «Мои курсы» и в списке доступных курсов на главной странице. Администраторы сайта могут разрешить дополнительные типы файлов и использование нескольких файлов. Если вы используете несколько файлов, все они будут отображаться в списке доступных курсов на главной странице.';
...
$string['courserequestroleerror'] = 'Роль создателей не дает права настраивать новые курсы. Ознакомьтесь с <a href="{$a}">политикой пользователя</a>.';
$string['courserequestsuccess'] = 'Ваш запрос на создание курса принят.';
...
$string['coursereuse'] = 'Повторное использование курса';
$string['coursereusenavigationmenu'] = 'Меню навигации повторно используемого курса';
...
$string['coursesectiontitlebulkediting'] = 'Массовое редактирование {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
$string['coursesectiontitleediting'] = 'Редактирование {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursesummary_help'] = 'Краткое описание вашего курса. Контент, добавленный сюда, доступен для поиска.';
$string['coursetitle'] = 'Курс: {$a->course}';
$string['coursetitlebulkediting'] = 'Массовое редактирование курса: {$a->course}';
$string['coursetitleediting'] = 'Редактирование курса: {$a->course}';
$string['courseupdates'] = 'Обновление курса';
$string['coursevisibility'] = 'Видимость курса';
$string['coursevisibility_help'] = '* Показать: курс отображается в списке курсов и студенты могут получить к нему доступ.
* Скрыть: доступ разрешен преподавателям и другим пользователям, имеющими возможность просматривать скрытые курсы.';
...
$string['defaultcoursestudentdescription'] = 'Обычно студенты обладают небольшим набором прав в рамках курса.';
...
$string['defaulthomepageuser_help'] = 'На какую страницу вы должны быть перенаправлены после входа на сайт?';
...
$string['deletecheckfull'] = 'Вы уверены, что хотите полностью удалить пользователя «{$a}», включая данные его профиля, зачисления на курсы, членство в группах и потоках, а также некоторые данные об активности пользователя?';
$string['deletechecktype'] = 'Вы уверены, что хотите удалить {$a->type}?';
...
$string['duplicatedsection'] = '{$a} (копия)';
...
$string['editgroupprofile'] = 'Редактировать описание группы';
...
$string['editmode'] = 'Режим редактирования';
...
$string['editsectionsettings'] = 'Редактировать настройки секции';
$string['editsectiontitle'] = 'Редактирование секции: {$a}';
...
На сайте «{$a->sitename}» был запрос на создание учетной записи с использованием Вашего адреса электронной почты.

Для подтверждения новой учетной записи перейдите по следующей ссылке:

<a href="{$a->link}">Подтвердить учетную запись</a>
...
$string['emaildisplay_help'] = '* Скрыто — только пользователи с соответствующими разрешениями, например учителя, могут просматривать ваш адрес электронной почты.
* Видно всем — все пользователи сайта могут просматривать ваш адрес электронной почты.
* Видно участникам курса — только участники курсов, на которые вы зачислены, могут видеть ваш адрес электронной почты.';
$string['emaildisplaycourse'] = 'Видно участникам курса';
$string['emaildisplaycoursemembersonly'] = '(Видно другим участникам курса)';
$string['emaildisplayeveryone'] = '(Видно всем)';
$string['emaildisplayhide'] = '(Скрыто от всех, кроме пользователей с соответствующими разрешениями)';
$string['emaildisplayno'] = 'Скрыто';
...
$string['emailonlyallowed'] = 'Этот адрес электронной почты не может быть использован. Разрешенные домены электронной почты: {$a}.';
$string['emailpasswordchangeinfo'] = 'Здравствуйте, {$a->firstname}!

Кто-то (вероятно, Вы) запросил новый пароль для Вашей учетной записи  «{$a->username}» на сайте «{$a->sitename}».

Для изменения пароля перейдите по следующей ссылке:

<a href="{$a->link}">Изменить пароль</a>
...
Для подтверждения этого действия и получения нового пароля по электронной почте перейдите по следующей ссылке:

<a href="{$a->link}">Получить новый пароль</a>
...
Для подтверждения этого запроса и создания нового пароля для своей учетной записи, перейдите по следующей ссылке:

<a href="{$a->link}">Восстановить пароль</a>

(Эта ссылка действительна в течение {$a->resetminutes} мин. с момента первого запроса восстановления пароля).
...
$string['emojicategorypeoplebody'] = 'Люди и тело';
$string['emojicategoryrecent'] = 'Последний';
$string['emojicategorysmileysemotion'] = 'Смайлики и эмоции';
$string['emojicategorysymbols'] = 'Символы';
$string['emojicategorytravelplaces'] = 'Путешествия и места';
$string['emptycmids'] = 'ID пустых модулей курса';
$string['emptydragdropregion'] = 'пустая область';
$string['emptysectionids'] = 'ID пустых секций';
$string['enable'] = 'Включить';
$string['encryptedcode'] = 'Зашифрованый код';
$string['enddate'] = 'Дата окончания курса';
$string['enddate_help'] = 'Дата окончания не ограничивает доступ студентов к курсу. Она определяет, будет ли курс указан как пройденный в Моих курсах.';
$string['enddatewithtaskenabled'] = 'Дата окончания курса';
$string['enddatewithtaskenabled_help'] = 'Дата, когда курс становится скрытым для студентов, и они больше не могут получить к нему доступ.';
...
$string['eventcourseended'] = 'Курс закончился';
...
$string['eventcoursestarted'] = 'Курс начался';
...
$string['eventmycoursesviewed'] = 'Мои курсы просмотрены.';
...
$string['eventsectionviewed'] = 'Раздел просмотрен';
$string['eventunknownlogged'] = 'Неизвестное событие';
$string['eventurlblocked'] = 'URL-адрес был заблокирован';
...
$string['explanationdigitalminor'] = 'Эта информация необходима для определения того, достигли ли Вы возраста цифровой дееспособности. Это возраст, начиная с которого человек вправе самостоятельно соглашаться с условиями использования и политиками, а его данные могут храниться и обрабатываться на законных основаниях.';
$string['extendperiod'] = 'Продлить на';
$string['extendsession'] = 'Продлить сеанс';
$string['failedloginattempts'] = 'Неудачных попыток авторизации после Вашего последнего входа: {$a->attempts}';
$string['failedtaskbody'] = '<p>Здравствуйте, {$a->firstname}!</p>
<p>Задача <b>{$a->taskname}</b> несколько раз завершилась неудачно и требует внимания.</p>
<p><a href="{$a->link}">Посмотреть задачу</a></p>';
$string['failedtaskcontexturlname'] = 'Отчет о состоянии';
$string['failedtasksubject'] = 'Задача не выполнена: {$a}';
...
    {$a}';
$string['forcepasswordresetnotice'] = 'Ваш текущий пароль больше не соответствует установленной политике паролей. Для входа в систему вам необходимо изменить свой пароль.
    {$a}';
$string['forcetheme'] = 'Назначенная тема';
...
$string['fullnamecourse_help'] = 'Полное название курса отображается на странице «Мои курсы» и в списке доступных курсов на главной странице.';
...
$string['go'] = 'Применить';
$string['gobacktosite'] = 'Вернуться на сайт';
...
$string['hiddensections_help'] = 'Скрытые секции могут отображаться студентам на странице курса как «недоступные» или быть полностью скрытыми.';
$string['hiddensectionscollapsed'] = 'Скрытые секции отображаются как недоступные';
...
$string['hidefromstudents'] = 'Скрыть на странице курса';
...
$string['hits'] = 'Обращений';
$string['hitsoncourse'] = 'Количество обращений пользователя {$a->username} к курсу {$a->coursename}';
$string['hitsoncoursetoday'] = 'Сегодняшние посещения {$a->coursename} {$a->username}';
$string['home'] = 'В начало';
$string['homeheader'] = 'Главное меню';
$string['hour'] = 'ч.';
$string['hours'] = 'час.';
...
$string['idnumbercourse_help'] = 'Используется только для подключения курса к внешним системам. Оставьте пустым, если у вас нет официального идентификатора курса.';
...
$string['idnumbermod'] = 'Идентификационный номер';
...
$string['importinfo'] = 'Импортируйте элементы из других курсов, например занятия, блоки или события календаря. Никакие пользовательские данные не будут импортированы.';
...
$string['includesubcategories'] = 'Включая подкатегории';
...
$string['indicator:activitiesdue_help'] = 'У пользователя есть текущие задания';
...
$string['indicator:nostudent'] = 'Зачисление студентов';
...
$string['inprogress'] = 'В ходе выполнения';
$string['insertcontentbefore'] = 'Вставить контент перед «{$a->activityname}»';
$string['insertcontentsection'] = 'Вставить контент в секцию «{$a->sectionname}»';
$string['insertresourceoractivitybefore'] = 'Вставьте активный элемент или ресурс перед «{$a->activityname}»';
...
$string['invalidtaskclassname'] = 'Неверный класс задачи {$a}';
$string['invalidtaskid'] = 'Недопустимый ID задачи';
...
$string['languagegood'] = 'Этот языковой пакет обновлен.';
$string['languageselector'] = 'Выбор языка';
$string['last'] = 'Последняя';
$string['lastaccess'] = 'Последняя активность';
...
$string['location'] = 'Месторасположение';
...
$string['loginagain'] = 'Войти повторно';
...
$string['loginrequired'] = 'Требуется вход в систему.';
...
$string['makeavailablecmtitle'] = 'Сделать активный элемент доступным';
...
$string['managecategories'] = 'Управление категориями курсов';
$string['managecategorythis'] = 'Управление категорией';
$string['managecombined'] = 'Управление категориями курсов и курсами';
...
$string['markedthistopic'] = 'Этот раздел выделен как текущая';
...
$string['maximumupload_help'] = 'Максимальный размер файла, разрешенный для загрузки студентами в курс. Кроме того, вы можете дополнительно ограничить максимальный размер загрузки для каждого активного элемента.';
$string['maxlengthreached'] = 'Достигнуто максимальное ограничение символов -{$a}';
$string['maxnumberweeks'] = 'Максимальное количество секций';
$string['maxnumberweeks_desc'] = 'Максимальное значение количества секций в выпадающем меню (распространяется только на конкретный формат курса).';
$string['maxnumcoursesincombo'] = 'Обзор <a href="{$a->link}">{$a->numberofcourses} курсов</a>.';
$string['maxsectionslimit'] = 'Невозможно создать новую секцию, так как она превышает максимально допустимое количество секций для этого курса ({$a})';
...
$string['messageprovider:coursecontentupdated'] = 'Изменения содержания курса';
...
$string['messageprovider:enrolcoursewelcomemessage'] = 'Приветственное сообщение для новых зачислений на курс';
...
$string['messageprovider:failedtaskmaxdelay'] = 'Достигнута максимальная задержка сбоя задачи';
...
$string['messageprovider:insights'] = 'Инсайты, сгенерированные моделями прогнозирования';
...
$string['messageprovider:messagecontactrequests'] = 'Сообщение уведомления запросов контактов';
$string['messageprovider:newlogin'] = 'Уведомления о новых входах';
...
$string['messageprovider:reportbuilderschedule'] = 'Рассылки построителя пользовательских отчетов';
...
$string['missinglastname'] = 'Отсутствует фамилия';
...
$string['modshowcmtitle'] = 'Показать активный элемент';
...
$string['modvisible_help'] = '* Отображать на странице курса: доступно для студентов (с учетом любых ограничений доступа, которые могут быть установлены).
* Скрыть на странице курса: недоступно для студентов.';
$string['modvisiblehiddensection'] = 'Доступность';
$string['modvisiblehiddensection_help'] = '* Скрыть на странице курса: недоступно для студентов.
* Сделать доступным, но не отображать на странице курса: доступно для студентов, если вы предоставите им ссылку. Активные элементы по-прежнему будут отображаться в журнале оценок и других отчетах.';
$string['modvisiblewithstealth'] = 'Доступность';
$string['modvisiblewithstealth_help'] = '* Отображать на странице курса: доступно для студентов (с учетом любых ограничений доступа, которые могут быть установлены).
* Скрыть на странице курса: недоступно для студентов.
* Сделать доступным, но не отображать на странице курса: доступно для студентов, если вы предоставите им ссылку. Активные элементы по-прежнему будут отображаться в журнале оценок и других отчетах.';
$string['month'] = 'Месяц';
$string['months'] = 'Месяцы';
$string['moodledocs'] = 'Документация Moodle';
$string['moodledocslink'] = 'Документация для этой страницы';
$string['moodlelogo'] = 'Логотип Moodle';
$string['moodlenet:cannotconnecttoserver'] = 'Не удается подключиться к серверу MoodleNet';
$string['moodlenet:columnname'] = 'Название';
$string['moodlenet:columnsenddate'] = 'Дата отправки';
...
$string['moodlenet:issuerisnotauthorized'] = 'Эмитент MoodleNet не авторизован';
$string['moodlenet:issuerisnotenabled'] = 'Эмитент MoodleNet не активирован';
$string['moodlenet:issuerisnotset'] = 'Эмитент MoodleNet не указан администрацией сайта';
$string['moodlenet:nosharedresources'] = 'В настоящее время нет общих ресурсов для отображения.';
$string['moodlenet:outboundsettings'] = 'Настройки исходящего трафика MoodleNet';
$string['moodlenet:packagingandsending'] = 'Упаковка вашего файла и отправка в MoodleNet...';
$string['moodlenet:sharefailtext'] = 'При отправке вашего контента в MoodleNet произошла ошибка.<br>Повторите попытку позже.';
$string['moodlenet:sharefailtextwithsitesupport'] = 'При отправке вашего контента в MoodleNet произошла ошибка.<br>Повторите попытку позже или <a href="{$a}">обратитесь в службу поддержки сайта</a>.';
$string['moodlenet:sharefailtitle'] = 'Что-то пошло не так';
$string['moodlenet:sharefilesizelimitexceeded'] = 'Размер совместно используемого ресурса ({$a->filesize} байт) превышает ограничение в {$a->filesizelimit} байт.';
$string['moodlenet:sharenoticeactivity'] = 'Этот активный элемент будет опубликован в MoodleNet в качестве ресурса.';
$string['moodlenet:sharenoticecourse'] = 'Этот курс будет опубликован в MoodleNet в качестве ресурса.';
$string['moodlenet:sharenoticepartial'] = 'Выбранные элементы будут опубликованы в MoodleNet в качестве ресурса.';
$string['moodlenet:sharenoticepartialactivitynumber'] = 'Элементы ({$a}) будут включены в курс';
$string['moodlenet:shareprogress'] = 'Ресурсы, опубликованные в MoodleNet';
$string['moodlenet:shareprogressinfo'] = 'В списке показаны курсы и элементы, которыми вы поделились в MoodleNet.<br>Нажмите на имя ресурса, чтобы просмотреть его в MoodleNet.';
$string['moodlenet:sharesuccesstext'] = 'Почти готово! Посетите свои проекты в MoodleNet, чтобы завершить передачу контента.';
$string['moodlenet:sharesuccesstitle'] = 'Сохранено в проекты MoodleNet';
$string['moodlenet:sharetomoodlenet'] = 'Поделиться в MoodleNet';
$string['moodlenet:sharetyperesource'] = 'ресурс';
$string['moodlenet:sharinglargefile'] = 'Передача больших файлов может занять некоторое время.';
$string['moodlenet:sharingstatus'] = 'Публикация в MoodleNet';
$string['moodlenet:sharingto'] = 'Поделиться с:';
$string['moodlerelease'] = 'Релиз Moodle';
$string['moodleservicesandsupport'] = 'Услуги и поддержка';
$string['moodleversion'] = 'Версия Moodle';
$string['more'] = 'подробнее';
$string['moreactions'] = 'Больше действий';
...
$string['movecoursemodule'] = 'Переместить активный элемент';
...
$string['multipleitemsfound'] = 'Найдено элементов: {$a}';
...
$string['newloginnotificationbodyfull'] = '<p>Здравствуйте, {$a->userfullname}.</p>
<p>В ваш аккаунт на сайт {$a->sitename} только что вошли с нового устройства.</p>
<ul>
<li>Ваш аккаунт: {$a->username} {$a->useremail}</li>
<li>{$a->logintime}</li>
<li>Устройство: {$a->logindevice}</li>
<li>IP: {$a->loginip}</li>
</ul>
<p>Если это были вы, то ничего делать не нужно.</p>
<p>Если вы не совершали такого действия - необходимо <a href="{$a->changepasswordlink}">сменить свой пароль</a>.</p>';
$string['newloginnotificationbodysmall'] = 'В ваш аккаунт {$a} только что вошли с нового устройства.';
$string['newloginnotificationtitle'] = 'Новый вход в ваш аккаунт {$a}';
...
$string['newsitemsnumber_help'] = 'Форум объявлений по умолчанию имеет принудительную подписку. Публиковать сообщения могут только преподаватели и другие пользователи с соответствующими разрешениями.

Если вам не нужен форум объявлений, установите это значение равным нулю.

Этот параметр также определяет количество последних объявлений, отображаемых в блоке «Последние объявления».';
...
Чтобы начать использование сайта «{$a->sitename}», перейдите по ссылке: <a href="{$a->link}">Вход на сайт</a>
...
$string['noresultsfor'] = 'Нет результатов для «{$a}»';
...
$string['oneitemfound'] = 'Найден 1 элемент.';
...
$string['paymentsorry'] = 'Благодарим Вас за оплату! К сожалению, платеж еще не обработан и Вы не записаны на курс «{$a->fullname}». Пожалуйста, подождите и попробуйте зайти на курс еще раз. Если у вас по-прежнему возникают проблемы, свяжитесь с {$a->teacher} или администратором сайта.';
$string['paymentthanks'] = 'Благодарим Вас за оплату! Вы записаны на курс «{$a}».';
...
$string['pluginitemid'] = 'ID элемента';
$string['pluginmissingfromdisk'] = '{$a->name} (Отсутствует на диске)';
...
$string['policyagreementclick'] = 'Соглашение о политике сайта';
...
$string['poweredbymoodle'] = 'На платформе <a href="https://moodle.com">Moodle</a>';
...
$string['previewthemename'] = 'Предварительный просмотр темы «{$a}»';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'Подробности процесса размещения общего ресурса в MoodleNet';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'ID связанного модуля курса';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'ID связанного курса';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = 'URL-адрес, возвращенный из MoodleNet после успешного размещения ресурса';
$string['privacy:metadata:moodlenet_share_progress:status'] = 'Результат размещения ресурса';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = 'Время размещения ресурса';
$string['privacy:metadata:moodlenet_share_progress:type'] = 'Тип размещенного ресурса';
$string['privacy:metadata:moodlenet_share_progress:userid'] = 'Пользователь, поделившийся ресурсом';
...
$string['recommended'] = 'Рекомендованные';
...
$string['resendemail'] = 'Повторно отправить письмо с подтверждением';
$string['reset'] = 'Очистка';
$string['resetcomponent'] = 'Компонент';
$string['resetcourse'] = 'Очистка курса';
$string['resetcourseconfirm'] = 'Сбросить курс?';
$string['resetcoursewarning'] = 'Вы уверены, что хотите сбросить курс «{$a}»?
<br/><br/>
Это удалит выбранные данные и сбросит курс в исходное состояние. Вы не сможете отменить это действие.';
$string['resetinfo'] = 'Эта функция позволяет очистить все пользовательские данные и сбросить курс в исходное состояние. Активные элементы и настройки курса останутся нетронутыми.';
$string['resetinfoselect'] = 'Ниже из категорий  выберите данные, которые вы хотите удалить или сбросить:';
$string['resetnotimplemented'] = 'Очистка не поддерживается';
$string['resetnotimplementedinfo'] = 'Эти активные элементы невозможно очистить:';
...
$string['resourcedisplaynew'] = 'В новой вкладке';
...
$string['restoreinfo'] = 'Используйте файл резервной копии, чтобы восстановить предыдущую версию курса или создать новый курс.';
...
$string['rolerenaming_help'] = 'Измените отображаемые названия ролей в этом курсе.';
$string['rolerenaming_success'] = 'Названия ролей курса обновлены.';
$string['roles'] = 'Роли';
$string['rss'] = 'RSS';
...
$string['searchgroups'] = 'Поиск групп';
$string['searchitems'] = 'Поиск элементов';
...
$string['sectionactionnotsupported'] = 'Действие секции «{$a}» здесь не поддерживается';
...
$string['selectdefault'] = 'Выбрать значения по умолчанию';
...
$string['selecttheme'] = 'Выбрать тему';
$string['selectthemename'] = 'Выбор темы «{$a}»';
...
$string['separateandconnected1'] = 'Наиболее отделенные сообщения';
$string['separateandconnected2'] = 'Отделенные и связанные сообщения';
$string['separateandconnected3'] = 'Наиболее связанные сообщения';
...
$string['sessiontimeoutsoon'] = 'Ваш сеанс истекает. Вы хотите продлить текущий сеанс?';
...
$string['shortnamecourse_help'] = 'Краткое название курса отображается в областях с ограниченным пространством. Оно должно быть уникальным.';
...
$string['showactivitydates'] = 'Показать даты активных элементов';
$string['showactivitydates_help'] = 'Показывать даты активного элемента на странице курса.';
...
$string['showgrades_help'] = 'Разрешить студентам видеть список всех своих оценок в курсе.';
...
$string['showreports_help'] = 'Разрешить студентам просматривать отчеты о своей собственной деятельности на странице своего профиля.';
...
$string['signoutofotherservices'] = 'Выйти из всех веб-приложений';
$string['signoutofotherservices_help'] = 'Выйти из всех устройств и систем, использующих веб-сервисы, таких, например, как мобильное приложение. Сеансы браузера останутся активными.';
$string['since'] = 'С';
...
$string['sites'] = 'Сайты';
$string['sitesection'] = 'Добавить настраиваемый контент';
...
$string['startdate_help'] = 'Эта дата определяет начало первой недели курса в еженедельном формате. Это также дата начала для отчетов по элементам курса. .

Если вы сбросите курс и измените эту дату, все даты курса будут сдвинуты относительно новой даты начала курса.';
$string['startdatewithtaskenabled'] = 'Дата начала курса';
$string['startdatewithtaskenabled_help'] = 'Дата, когда курс становится видимым для студентов. До этой даты они не смогут получить доступ к курсу.

Эта дата также определяет начало первой недели для курса в еженедельном формате и является датой начала для журналов занятий курса. Если вы сбросите настройки курса и измените эту дату, все даты курса будут перенесены относительно новой даты начала.';
...
$string['statsreport13'] = 'Курсы с наибольшим участием (число входов)';
$string['statsreport14'] = 'Курсы с наибольшим участием (сообщения/просмотры)';
...
$string['statuschecks'] = 'Проверка состояния';
$string['statuscritical'] = 'Критический';
$string['statusdone'] = 'Выполнено';
$string['statuserror'] = 'Ошибка';
$string['statusinfo'] = 'Информация';
$string['statusna'] = 'Н/Д';
$string['statusok'] = 'ОК';
$string['statusunknown'] = 'Неизвестно';
...
$string['subsectionmoveerror'] = 'Невозможно переместить эту подсекцию в другую подсекцию';
...
$string['textcopiedtoclipboard'] = 'Текст скопирован в буфер обмена';
...
$string['themepreviewdescription'] = 'Описание темы «{$a}»';
$string['themepreviewimage'] = 'Миниатюра изображения «{$a}»';
$string['themes'] = 'Темы';
...
$string['unabletocopytoclipboard'] = 'Не удалось скопировать текст в буфер обмена';
$string['unauthorisedlogin'] = 'Учетная запись пользователя «{$a}» недействительна на этом сайте';
$string['undecided'] = 'Нерешено';
$string['unexistingcmid'] = 'ID модуля курса не найден';
$string['unexistingsectionid'] = 'ID секции курса не найден';
...
$string['updatesevery'] = 'Обновляются каждые {$a} сек.';
...
$string['useractivity'] = 'Активность пользователей';
...
$string['usermatchedon'] = 'У этого пользователя поиску соответствует следующее поле';
$string['usermenu'] = 'Меню пользователя';
$string['usermenugoback'] = 'Вернуться в меню пользователя';
$string['username'] = 'Логин';
$string['usernameemail'] = 'Логин или адрес электронной почты';
...
$string['userselectorsearchanywhere'] = 'в любом месте';
$string['userselectorsearchexactmatchonly'] = 'только точные совпадения';
$string['userselectorsearchfromstart'] = 'с начала';
$string['userselectorsearchmatching'] = 'Совпадение:';
...
$string['validatehtml'] = 'Проверить HTML';
...
$string['viewallresults'] = 'Посмотреть все результаты ({$a})';
...
$string['viewresults'] = 'Посмотреть результаты для {$a}';
...
$string['wcagcheck'] = 'Проверка Руководства по обеспечению доступности веб-контента (WCAG)';
...
$string['welcomeback'] = 'Здравствуйте, {$a->firstname}! 👋';
...
$string['welcometosite'] = 'Добро пожаловать, {$a->firstname}! 👋';
...
$string['wontrunfuturescheduledtask'] = 'Не запускать задачу, которая не завершилась ошибкой и запланирована для выполнения в будущем';
$string['wordforstudent'] = 'Обращение для Студента';
$string['wordforstudenteg'] = 'например, Студент, Участник…';
$string['wordforstudents'] = 'Новое название вместо «Студенты»';
$string['wordforstudentseg'] = 'например, Студенты, Участники…';
$string['wordforteacher'] = 'Новое название вместо «Учитель»';
$string['wordforteachereg'] = 'например, Учитель, Инструктор, Тьютор…';
$string['wordforteachers'] = 'Новое название вместо «Учители»';
...
$string['youhaveupcomingactivitiesdueinfo'] = 'Уважаемый(ая) {$a},
...
$string['yourwordforx'] = 'Новое название вместо «{$a}»';
