...
$string['cookiesenabledonlysession_help'] = 'На этом сайте используется один файл cookie для сессий, обычно называемый MoodleSession. Вы должны разрешить использование этого файла cookie в своем браузере, чтобы обеспечить непрерывность при переходах и оставаться в системе при просмотре сайта. Когда вы выходите из системы или закрываете браузер, этот файл cookie уничтожаются (в вашем браузере и на сервере).';
...
$string['coursedisplay_help'] = 'Секции курса могут отображаться все на одной странице или разбиты на несколько страниц.';
...
$string['sessionforceclean'] = 'Из соображений безопасности созданные в этой сессии пользовательские сценарии были отключены.';
$string['sessiontimeoutsoon'] = 'Ваша сессия истекает. Вы хотите продлить текущую сессию?';
