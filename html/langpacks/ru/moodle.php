...
$string['enddate_help'] = 'Дата окончания курса определяет, будет ли курс указан как прошедший в обзоре курсов. Дата окончания курса также используется и в пользовательских отчетах. Пользователи по-прежнему могут зайти в курс после даты его окончания; другими словами, эта дата не ограничивает доступ.';
...
$string['showactivitydates_help'] = 'Даты всегда отображаются на странице активного элемента. Этот параметр определяет, будут ли даты отображаться под каждым активным элементом на странице курса.';
...
$string['showgrades_help'] = 'Многие элементы курса позволяют выставлять оценки. Этот параметр определяет, может ли студент посмотреть список всех своих оценок в курсе.';
