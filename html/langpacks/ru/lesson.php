...
/**
 * Strings for component 'lesson', language 'ru', version '4.5'.
 *
 * @package     lesson
 * @category    string
...
$string['completiontimespentgroup'] = 'Необходимо затратить время';
...
$string['lessonnotready2'] = 'Эта лекция ещё не готова к использованию.';
...
$string['numberofpagesviewednotice'] = 'Количество ответов на вопросы: {$a->nquestions} (Вы должны ответить как минимум на: {$a->minquestions})';
