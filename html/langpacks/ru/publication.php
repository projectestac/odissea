...
/**
 * Strings for component 'publication', language 'ru', version '4.4'.
 *
 * @package     publication
 * @category    string
...
$string['configobtainstudentapproval'] = 'Файлы будут опубликованы (сделаны видимыми для всех) только после одобрения студентом и преподавателем.';
