...
/**
 * Strings for component 'block_completion_progress', language 'ru', version '4.5'.
 *
...
$string['computeprogress'] = 'Расчет процентов прогресса';
...
$string['config_orderby'] = 'Сортировать панель по';
...
$string['forceiconsinbar'] = 'Включать значки в индикатор выполнения';
...
$string['overviewcachetime'] = 'Время кэширования вычисленных процентов';
$string['pluginname'] = 'Прогресс завершения элементов курса';
$string['privacy:metadata:block_completion_progress:blockinstanceid'] = 'Идентификатор экземпляра блока «Прогресс выполнения», к которому относится указанный процент.';
$string['privacy:metadata:block_completion_progress:percentage'] = 'Процент выполнения.';
$string['privacy:metadata:block_completion_progress:tableexplanation'] = 'Блок «Прогресс выполнения» кэширует проценты выполнения для сортировки таблицы «Обзор».';
$string['privacy:metadata:block_completion_progress:timemodified'] = 'Время, когда был рассчитан процент.';
$string['privacy:metadata:block_completion_progress:userid'] = 'Идентификатор пользователя, к которому относится этот процент.';
$string['progress'] = 'Прогресс';
$string['progressbar'] = 'Прогресс завершения элементов курса';
$string['progresscachetime'] = 'Вычислено {$a} назад';
...
$string['showlastincourse'] = 'В разделе «Обзор» отображается время последнего посещения курса студентом.';
