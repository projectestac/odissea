...
$string['activitychoosertabmode_desc'] = 'В окне выбора перечислены активные элементы и ресурсы, которые учитель может добавить в свой курс. Чтобы добавить элементы на вкладку «Рекомендованные», перейдите в раздел <a href=\'../course/recommendations.php\'>Рекомендованные элементы</a>.';
$string['activitychoosertabmodefive'] = 'Помеченные, Рекомендованные, Все';
$string['activitychoosertabmodefour'] = 'Помеченные, Рекомендованные, Все, Активные элементы, Ресурсы';
$string['activitychoosertabmodeone'] = 'Помеченные, Все, Активные элементы, Ресурсы, Рекомендованные';
$string['activitychoosertabmodesix'] = 'Помеченные, Рекомендованные, Активные элементы, Ресурсы';
...
$string['activitynavigation'] = 'Навигация по активным элементам';
$string['activitynavigation:jumptoactivity'] = 'Перейти к активному элементу';
$string['activitynavigation:nexta'] = 'Следующий активный элемент: {$a}';
$string['activitynavigation:preva'] = 'Предыдущий активный элемент: {$a}';
...
$string['communicationroomlink'] = 'Общение с участниками курса';
...
$string['coursecommunication_desc'] = 'Служба общения по умолчанию для новых курсов. Для существующих курсов по умолчанию провайдер не будет выбран.';
...
$string['defaultsettingscategory'] = 'Настройки по умолчанию';
...
$string['nocoursesections'] = 'Нет секций курса';
...
$string['pdfexportfont'] = 'Шрифт PDF';
$string['pdfexportfont_help'] = 'Шрифт, который будет использоваться для созданных PDF-файлов, таких как ответы на задания.';
...
$string['sectionlink'] = 'Постоянная ссылка';
$string['showstartedcoursestask'] = 'Показать курсы в день начала';
...
$string['totalactivities'] = 'Активные элементы: {$a}';
