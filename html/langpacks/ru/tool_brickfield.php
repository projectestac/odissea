...
/**
 * Strings for component 'tool_brickfield', language 'ru', version '4.5'.
 *
...
$string['checkdesc:boldisnotused'] = 'Жирный шрифт (b) использовать не следует. Вместо него нужно использовать «strong».';
...
$string['checkdesc:iisnotused'] = 'Курсив (i) использовать не следует. Вместо него нужно использовать «em».';
...
$string['errorlink'] = 'Редактировать ошибку для {$a}';
...
$string['messageprovider:warningcheckid'] = 'Предупреждение о недопустимых идентификаторах';
...
$string['notvalidated'] = 'Ваш инструментарий общедоступности работает во время проверки.';
