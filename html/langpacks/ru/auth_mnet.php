...
/**
 * Strings for component 'auth_mnet', language 'ru', version '4.5'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_session'] = 'Подробности каждого пользовательского сеанса MNet временно хранятся в удаленной системе.';
$string['privacy:metadata:mnet_session:expires'] = 'Время окончания срока сеанса.';
$string['privacy:metadata:mnet_session:mnethostid'] = 'MNet ID удаленной системы.';
$string['privacy:metadata:mnet_session:token'] = 'Уникальный идентификатор сеанса.';
