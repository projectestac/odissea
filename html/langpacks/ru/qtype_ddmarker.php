...
/**
 * Strings for component 'qtype_ddmarker', language 'ru', version '4.1'.
 *
...
$string['formerror_dragrequired'] = 'Вы должны добавить хотя бы один маркер к этому вопросу.';
...
$string['privacy:metadata'] = 'Плагин «Тип вопроса Перетаскивание маркеров» позволяет авторам вопросов устанавливать параметры по умолчанию как пользовательские настройки.';
