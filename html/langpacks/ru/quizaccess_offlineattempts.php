...
/**
 * Strings for component 'quizaccess_offlineattempts', language 'ru', version '4.1'.
 *
...
Примечание. Невозможно  в автономном режиме выполнить попытку теста, если у него есть ограничение по времени или требуется сетевой адрес; используется какое-либо поведение, отличное от отложенного отзыва (с CBM или без него) или в тесте используется последовательная навигация.';
...
$string['offlineattemptserror'] = 'Невозможно  в автономном режиме выполнить попытку теста, если у него есть ограничение по времени или требуется сетевой адрес; используется какое-либо поведение, отличное от отложенного отзыва (с CBM или без него) или в тесте используется последовательная навигация.';
...
$string['pluginname'] = 'Правило доступа к тесту: автономные попытки';
