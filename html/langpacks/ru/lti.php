...
$string['display_description_help'] = 'При выбранном параметре описание элемента курса (указанное выше), будет отображаться над содержимым поставляемого инструмента. Это описание может быть использовано для предоставления дополнительных инструкций при запуске инструмента, но это не обязательно. Описание никогда не отображается при запуске инструмента в новом окне.';
$string['display_name'] = 'Отображать название элемента курса при запуске';
$string['display_name_help'] = 'При выбранном параметре название элемента курса (указанное выше), будет отображаться над содержимым поставляемого инструмента. Вполне возможно, что у поставляемого инструмента тоже может отображаться название. Этот параметр может предотвратить повторное отображение названия элемента курса. Название никогда не отображается при запуске приложения в новом окне.';
