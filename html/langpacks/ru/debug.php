...
/**
 * Strings for component 'debug', language 'ru', version '4.5'.
 *
 * @package     debug
 * @category    string
...
$string['reactive_instances'] = 'Реагирующие экземпляры:';
$string['reactive_noinstances'] = 'На этой странице нет реагирующих экземпляров.';
...
$string['sessionmissing'] = 'Отсутствует объект сеанса «{$a}»';
