...
$string['cannotcreatepagebreak'] = 'Разрыв страницы не может быть добавлен в начале, и только один разрыв страницы может быть добавлен в конце.';
...
$string['check'] = 'Множественный выбор - разрешено несколько ответов';
$string['check_values'] = 'Возможные ответы';
$string['checkbox'] = 'Множественный выбор - разрешено несколько ответов (флажки)';
...
$string['complete_the_form'] = 'Ответить на вопросы';
...
$string['completionsubmit'] = 'Представлены ответы';
...
<li>Затем добавьте элемент, зависящий от значения предыдущего элемента<br />
...
$string['dependitem'] = 'Зависит от элемента';
$string['dependvalue'] = 'Зависит от значения';
...
$string['feedback:addinstance'] = 'Добавлять новый элемент обратной связи';
...
$string['feedbackupdated'] = 'Анкета обратная связь обновлена';
$string['file'] = 'Файл';
...
$string['label'] = 'Область «Текст и медиа»';
...
$string['multiplesubmit_help'] = 'Если установлено значение Да:

* Для анонимных опросов: участники могут отправлять неограниченное количество ответов и все ответы будут записаны.
* Для неанонимных опросов: участники могут отправлять неограниченное количество ответов, но будет записан только их последний ответ.';
