...
$string['configallowfullanonymous'] = 'Если установлено значение этого параметра «Да», то «Обратная связь» на главной странице может быть заполнена без входа в систему.';
