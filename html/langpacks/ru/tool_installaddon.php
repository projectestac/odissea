...
/**
 * Strings for component 'tool_installaddon', language 'ru', version '4.5'.
 *
...
$string['activitychooserfootertext'] = 'Больше элементов посмотрите на';
...
$string['marketplaceadminlinktext'] = 'Посмотрите новые плагины';
$string['marketplacelink'] = 'Торговая площадка Moodle';
