...
/**
 * Strings for component 'rating', language 'ru', version '4.1'.
 *
 * @package     rating
 * @category    string
...
$string['rolewarning_help'] = 'Для выставления оценок пользователям нужно иметь право «moodle/rating:rate» и необходимые права в рамках конкретного модуля. Вы можете дать другим ролям разрешение на оценку на странице Разрешения.';
