...
/**
 * Strings for component 'offlinequiz', language 'ru', version '4.5'.
 *
 * @package     offlinequiz
 * @category    string
...
$string['attendanceoverview'] = 'Посещаемость';
$string['attendances'] = 'Посещаемость';
$string['attendancesevaluationheadline'] = '2. Оценивание';
$string['attendancesheadline'] = 'Посещаемость';
$string['attendancespreparationheadline'] = '1. Подготовка';
$string['backtopreview'] = 'Показать предварительный просмотр';
...
$string['completiondetail:passgrade'] = 'Получить проходной балл';
$string['completionpass'] = 'Пройти для завершения';
$string['completionpass_help'] = 'Студенты проходят этот офлайн-тест только в том случае, если их оценка выше или равна проходному баллу, установленному в параметрах оценки';
...
$string['correctheader'] = 'Необходимо исправление:';
$string['correctionerrors'] = 'Формы с ошибками исправления:';
...
$string['defaultparticipantsusage'] = 'Зарегистрировать посещаемость';
$string['defaultparticipantsusagedesc'] = 'Определяет, следует ли по умолчанию регистрировать посещаемость в списках посещаемости.';
...
$string['documentschanged'] = 'Один или несколько вопросов в офлайн-тесте были изменены с момента создания документов.<br>Будущие результаты будут автоматически переоценены во время оценки в соответствии с текущей версией вопроса(ов), выбранного здесь. В документах по-прежнему отображается исходная версия вопроса(ов).';
$string['documentschangedwithresults'] = 'Один или несколько вопросов в офлайн-тесте были изменены с момента создания документов.<br>Существующие результаты были автоматически пересчитаны в соответствии с текущей версией вопроса(ов), выбранного здесь. В документах по-прежнему отображается исходная версия вопроса(ов).';
$string['done'] = 'готово';
...
$string['errormultiuserinlist'] = 'Пользователь указан в списках посещаемости более одного раза!';
$string['errorreport'] = 'Отчет об ошибках импорта';
$string['evaluated'] = 'Оценено:';
$string['evaluation'] = '2. Оценивание';
...
$string['legenddone'] = 'Шаг успешно выполнен (дальнейшие действия не требуются).';
$string['legendnextitem'] = 'Действия необходимы в дальнейшем рабочем процессе (возможно, зависящие от предыдущих шагов).';
$string['legendnoaction'] = 'Никаких действий не требуется.';
$string['legendwarning'] = 'Требуются немедленные действия.';
...
$string['offlinequizcontent'] = 'Содержание офлайн-теста';
...
$string['pagesinprocessing'] = 'В обработке:';
...
$string['participantsusage'] = 'Зарегистрировать посещаемость';
$string['participantsusage_help'] = 'Этот параметр определяет, можете ли вы регистрировать посещаемость участников с помощью списков посещаемости. Списки посещаемости предназначены для больших офлайн-тестов с большим количеством участников. Их можно использовать для проверки того, какие студенты участвовали в тесте и все ли результаты были оценены правильно.';
...
$string['point'] = 'точка';
$string['preparation'] = '1. Подготовка';
...
$string['privacy:metadata:offlinequiz:review'] = 'В этом столбце сохраняется информация о том, как проводится проверка.';
...
$string['privacy:metadata:offlinequiz:time'] = 'В столбце «Время» сохраняется дата проведения офлайн-теста.';
...
$string['privacy:metadata:offlinequiz_choices:slotnumber'] = 'Слот вопроса этого выбора.';
...
$string['questionandansweranalysis'] = 'Анализ вопросов и ответов';
...
$string['qversioncannotupdate'] = 'Версия вопроса не может быть обновлена';
$string['qversionnumbersdiffer'] = 'Количество ответов в старой и новой версии различается. Это может привести к несоответствиям.';
$string['qversionupdated'] = 'Версия вопроса обновлена';
$string['qversionupdatedwarning'] = 'Формы уже были созданы.<br>Если результаты имеются, они автоматически переоцениваются до текущей версии измененного вопроса, выбранного здесь. В документах по-прежнему отображается исходная версия вопроса.';
$string['qversionupdateerror'] = 'Произошла ошибка при обновлении версии вопроса.';
...
$string['recordupdateanddocscreated'] = 'Вопросы были обновлены, но поскольку формы уже созданы, предыдущая версия вопроса все еще активна. Чтобы перейти на новую версию, удалите формы и измените версию вручную.';
$string['recordupdateanddocscreatedversion'] = 'Вопросы были обновлены, но формы уже созданы. Проверьте, не внесли ли корректировки какие-либо изменения, влияющие на оценку.';
...
$string['resultsavailable'] = 'Количество доступных результатов:';
$string['review'] = 'Обзор';
...
$string['reviewoptions_help'] = 'С помощью этих параметров вы можете контролировать то, что студенты могут видеть после импорта результатов. Вы также можете определить время начала и окончания для отчета о результатах.

Чекбоксы означают:

**Попытка** - тексты вопросов и ответов будут показаны студентам. Студенты увидят, какие ответы они выбрали, но правильные ответы не будут указаны.

**Правильно ли** - этот параметр можно активировать только в том случае, если активирован параметр «Попытка». Если он активирован, студенты могут видеть, какие из выбранных ответов являются правильными (зеленый фон) или неправильными (красный фон).

**Оценки** - отображаются группа (например, B), баллы (полученная оценка, общая оценка за вопросы, полученная в процентах, например, 40/80 (50)) и оценка (например, 50 из максимальных 100). Кроме того, если выбран параметр «Попытка», для каждого вопроса отображаются набранный балл и максимальный балл.

**Отзыв на ответ** — отзыв, который зависит от ответа студента.

**Общий отзыв** — общий отзыв отображается студенту после импорта результатов. В отличие от отзыва на ответ, который зависит от типа вопроса и ответа студента, всем студентам отображается один и тот же текст общего отзыва. Вы можете использовать общий отзыв, чтобы предоставить студентам полностью проработанный ответ и, возможно, ссылку на дополнительную информацию, которую они могут использовать, если не поняли вопросы.

**Верные ответы** — показывает, какие ответы верны, а какие нет. Эта опция доступна только в том случае, если выбрана опция «Попытка».

**Отсканированная форма** — отображаются отсканированные формы ответов. Чекбоксы отмечены зелеными квадратами.

**Отсканированная форма с оценками** — отображаются отсканированные формы ответов. Чекбоксы отмечены зелеными квадратами. Плохие и отсутствующие оценки выделены. Кроме того, в таблице отображаются максимальная оценка и оценка, полученная за каждый вопрос.';
...
$string['showquestioninfo_help'] = 'С помощью этой опции вы можете выбрать, какая дополнительная информация о вопросе будет напечатана на листе вопросов.
Вы можете выбрать один из следующих вариантов:
<ul>
<li> Ничего
<li> Тип вопроса — в зависимости от типа вопроса будет напечатано: Одиночный выбор, Множественный выбор, Все или ничего (множественный выбор)
<li> Количество правильных ответов — будет напечатано количество правильных ответов
</ul>';
...
$string['subplugintype_offlinequiz_plural'] = 'Отчеты офлайн-теста';
$string['tabattendances'] = 'Посещаемость';
$string['tabattendancesoverview'] = 'Посещаемость';
$string['tabdownloadparticipantsforms'] = 'Формы';
$string['tabdownloadquizforms'] = 'Формы';
$string['tabeditgrades'] = 'Оценки';
$string['tabeditgroupquestions'] = 'Вопросы';
$string['tabeditparticipants'] = 'Участники';
$string['tabofflinequizcontent'] = 'Подготовка';
$string['tabofflinequizcorrect'] = 'Правильно';
$string['tabofflinequizupload'] = 'Загрузить';
$string['tabparticipantlists'] = 'Списки посещаемости';
$string['tabparticipantscorrect'] = 'Правильно';
$string['tabparticipantsupload'] = 'Загрузить';
$string['tabpreview'] = 'Формы';
$string['tabquestionandanswerstats'] = 'Анализ вопросов и ответов';
$string['tabquestionstats'] = 'Анализ вопросов';
$string['tabresults'] = 'Результаты';
$string['tabresultsoverview'] = 'Результаты';
$string['tabstatistics'] = 'Статистика';
$string['tabstatsoverview'] = 'Информация о тесте';
...
$string['useridviolation'] = 'Найдено несколько пользователей';
