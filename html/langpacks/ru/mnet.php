...
/**
 * Strings for component 'mnet', language 'ru', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['allowaccess'] = 'Разрешить доступ';
...
$string['denyaccess'] = 'Запретить доступ';
...
$string['expireyourkey'] = 'Удаление этого ключа';
$string['expireyourkeyexplain'] = 'Moodle автоматически изменяет Ваши ключи каждые 28 дней (по умолчанию), но Вы можете в любой момент <em>вручную</em> отметить этот ключ как просроченный. Это необходимо только в том случае, если Вы считаете, что ключ был скомпрометирован. Новый ключ будет создан автоматически сразу же после этого действия. <br />Удаление этого ключа сделает невозможным взаимодействие других приложений с Вашим сайтом до тех пор, пока Вы не свяжетесь с каждым из администраторов других сайтов сети MNet и не передадите им свой новый ключ.';
...
$string['leavedefault'] = 'Вместо этого использовать настройки по умолчанию';
