...
$string['hidden_all'] = 'Скрыто полностью, если студент не соответствует условиям';
$string['hidden_individual'] = 'Скрыто полностью, если студент не соответствует этому условию';
...
$string['list_root_and'] = 'Недоступно, пока не выполнены условия:';
$string['list_root_and_hidden'] = 'Недоступно (скрыто), пока не выполнено:';
$string['list_root_or'] = 'Недоступно, пока не выполнено одно из условий:';
