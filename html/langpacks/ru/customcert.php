...
/**
 * Strings for component 'customcert', language 'ru', version '4.5'.
 *
 * @package     customcert
 * @category    string
...
$string['downloadallissuedcertificates'] = 'Скачать все выданные сертификаты';
$string['downloadallsitecertificates'] = 'Скачать все сертификаты сайта';
$string['downloadallsitecertificatesdesc'] = 'Все сертификаты этого сайта будут скачаны в zip файле';
