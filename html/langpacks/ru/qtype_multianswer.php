...
/**
 * Strings for component 'qtype_multianswer', language 'ru', version '4.4'.
 *
...
$string['multichoicex'] = 'Множественный выбор {$a}';
...
$string['regradeissuenumsubquestionschanged'] = 'В вопросе изменено количество встроенных подвопросов.';
$string['storedqtype'] = 'Тип сохраненного вопроса {$a}';
