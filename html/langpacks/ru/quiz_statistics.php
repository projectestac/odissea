...
/**
 * Strings for component 'quiz_statistics', language 'ru', version '4.5'.
 *
...
$string['getstatslockprogress'] = 'Ожидание выполнения задачи. Пожалуйста, подождите или повторите попытку позже.';
$string['getstatslocktimeout'] = 'Тайм-аут блокировки расчета статистики';
$string['getstatslocktimeoutdesc'] = 'Продолжительность блокировки (в секундах) при попытке выполнить расчет статистики для теста. Этот параметр в первую очередь предназначен для тестирования, не изменяйте его, если вы не уверены в том, что делаете.';
$string['highestattempts'] = 'лучшие из оцененных попыток';
$string['highestattemptsavg'] = 'Средняя оценка из лучших оцененных попыток';
$string['intended_weight'] = 'Предполагаемый вес';
$string['kurtosis'] = 'Оценка распределения эксцесса (для {$a})';
$string['lastattempts'] = 'последние попытки';
$string['lastattemptsavg'] = 'Средняя оценка последних попыток';
$string['lastcalculated'] = 'Последний расчет был выполнен {$a->lastcalculated} назад; с тех пор было совершено попыток:  {$a->count}.';
...
$string['nostats'] = 'Не удалось завершить расчет статистики. Возможно, идет слишком длительный расчет. Пожалуйста, повторите попытку позже.';
...
$string['random_guess_score'] = 'Вероятность угадывания';
