...
/**
 * Strings for component 'qtype_calculated', language 'ru', version '4.4'.
 *
...
$string['illegalformulasyntax'] = 'С «{$a}» начинается недопустимый синтаксис формулы';
...
$string['setwildcardvalues'] = 'набор(ы) значений подстановочных знаков';
...
$string['youmustaddatleastoneitem'] = 'Вы должны добавить по меньшей мере один вариант набора данных, прежде чем сможете сохранить этот вопрос.';
...
$string['zerosignificantfiguresnotallowed'] = 'Верный ответ не может иметь ноль значащих цифр!';
