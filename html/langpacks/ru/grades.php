...
* Остальные столбцы должны иметь заголовки для существующих активных элементов или элементов оценки.
...
$string['norolesdefined'] = 'Нет ролей, определенных в Администрирование > Оценки > Основные настройки > Оцениваемые роли';
