...
/**
 * Strings for component 'portfolio_flickr', language 'ru', version '4.4'.
 *
...
$string['noauthtoken'] = 'Не удалось получить ключ аутентификации для использования в этом сеансе';
