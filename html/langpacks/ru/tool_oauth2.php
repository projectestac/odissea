...
$string['acceptrisk_help'] = 'Отключение проверки электронной почты может вызвать проблемы с безопасностью. При определенных обстоятельствах это потенциально позволяет пользователям аутентифицироваться под другим именем.';
