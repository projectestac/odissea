...
/**
 * Strings for component 'tool_oauth2', language 'ru', version '4.5'.
 *
 * @package     tool_oauth2
 * @category    string
...
$string['issuersmtpsystememail'] = 'Электронная почта SMTP';
$string['issuersmtpsystememail_help'] = 'Если указано, этот адрес электронной почты будет использоваться при подключении системной учетной записи для отправки электронной почты через SMTP. Это требуется для некоторых служб OAuth 2 (например, Microsoft). Проверьте документацию для вашей службы OAuth 2, чтобы узнать, требуется ли это.';
...
$string['issuerusein_help'] = 'Службы OAuth 2 могут использоваться для внутренних служб, на странице входа, SMTP с XOAUTH2 или как  страницей входа, так и внутренними службами, если это необходимо.';
...
$string['issueruseinsmtpwithoauth'] = 'Только SMTP с XOAUTH2';
