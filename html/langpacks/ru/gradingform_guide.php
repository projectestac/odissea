...
/**
 * Strings for component 'gradingform_guide', language 'ru', version '4.5'.
 *
...
$string['alwaysshowdefinition'] = 'Показывать студентам описания справочника';
...
$string['privacy:metadata:criterionid'] = 'ID критерия передового оценивания.';
