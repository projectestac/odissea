...
/**
 * Strings for component 'h5pactivity', language 'ru', version '4.5'.
 *
 * @package     h5pactivity
 * @category    string
...
$string['newsubmissions'] = 'Отправленные H5P';
...
$string['opencontentbank'] = '<a href="{$a}" target="_blank">Доступ к файлу H5P в банке контента</a> (открывается в новом окне).';
...
$string['privacy:metadata:userid'] = 'ID пользователя, который получил доступ к элементу H5P';
