...
/**
 * Strings for component 'tool_usertours', language 'ru', version '4.5'.
 *
...
$string['content_type_help'] = '* Вручную - содержимое вводится с помощью текстового редактора
* Идентификатор строки языка - в формате идентификатор строки,компонент (без пробела после запятой)';
$string['content_type_langstring'] = 'Идентификатор строки языка';
$string['content_type_manual'] = 'Вручную';
...
$string['description_help'] = 'Описание тура может быть добавлено в виде простого текста, при необходимости заключенного в многоязычные теги (для использования с многоязычным фильтром контента).

В качестве альтернативы ID строки языка может быть введен в формате identifier,component (без скобок или пробела после запятой).';
$string['displaystepnumbers'] = 'Отображать количество шагов';
$string['displaystepnumbers_help'] = 'Отображать ли количество шагов, например, 1/4, 2/4 и т. д., чтобы обозначить длину пользовательского тура.';
$string['done'] = 'Готово';
...
$string['endonesteptour'] = 'Понятно!';
$string['endtour'] = 'Закончить тур';
$string['endtourlabel'] = 'Метка кнопки «Закончить тур»';
$string['endtourlabel_help'] = 'При желании вы можете указать настраиваемую метку для кнопки завершения тура. Метка по умолчанию - «Понятно!» для одношаговых и «Закончить тур» для многошаговых туров.

В качестве альтернативы идентификатор строки языка может быть введен в формате identifier,component (без скобок или пробела после запятой).';
...
$string['invalid_lang_id'] = 'Недопустимый идентификатор языка';
$string['left'] = 'Слева';
...
$string['moodle_language_identifier'] = 'Идентификатор строки языка';
...
$string['name_help'] = 'Название тура может быть добавлено в виде простого текста, при необходимости заключенного в многоязычные теги (для использования с многоязычным фильтром контента).
...
$string['nextstep_sequence'] = 'Далее ({$a->position}/{$a->total})';
...
Для того, чтобы отобразить тур на главной странице сайта, используйте значение «FRONTPAGE».';
...
$string['resettouronpage'] = 'Начать тур для пользователя на этой странице';
...
$string['tour2_content_navigation'] = 'Навигация теперь осуществляется посредством этой боковой выдвижной панели. Используйте кнопку вверху, чтобы отобразить или скрыть ее. В области навигации вы увидите ссылки на разделы вашего курса.';
...
$string['tour_navigation_course_edit_teacher_title'] = 'Режим редактирования';
$string['tour_navigation_course_index_student_content'] = '@@PIXICON::tour/tour_course_student::tool_usertours@@<br>Просматривайте задания и отслеживайте свои успехи.';
$string['tour_navigation_course_index_student_title'] = 'Найдите свой путь';
$string['tour_navigation_course_index_teacher_content'] = '@@PIXICON::tour/tour_course_admin_2::tool_usertours@@<br>Перетащите элементы, чтобы изменить порядок содержимого курса.';
$string['tour_navigation_course_index_teacher_title'] = 'Каталог курса';
$string['tour_navigation_course_student_tour_des'] = 'Где просматривать активные элементы (задания) в курсе';
$string['tour_navigation_course_student_tour_name'] = 'Каталог курса';
$string['tour_navigation_course_teacher_tour_des'] = 'Режим редактирования, перетаскивание элементов и публикация объявлений в курсе';
$string['tour_navigation_course_teacher_tour_name'] = 'Редактирование курса';
$string['tour_navigation_dashboard_content'] = '@@PIXICON::tour/tour_dashboard::tool_usertours@@<br>Эта боковая панель может содержать больше функций.';
$string['tour_navigation_dashboard_title'] = 'Разверните, чтобы изучить';
$string['tour_navigation_dashboard_tour_des'] = 'Где можно найти блоки на панели инструментов';
$string['tour_navigation_dashboard_tour_name'] = 'Выдвижной блок';
$string['tour_navigation_mycourses_content'] = '@@PIXICON::tour/tour_mycourses::tool_usertours@@<br>Добавляйте, копируйте, удаляйте и скрывайте курсы из этого меню.';
$string['tour_navigation_mycourses_endtourlabel'] = 'Понятно!';
$string['tour_navigation_mycourses_title'] = 'Курсы и категории';
$string['tour_navigation_mycourses_tour_des'] = 'Параметры управления курсами на странице Мои курсы';
$string['tour_navigation_mycourses_tour_name'] = 'Управление курсом';
