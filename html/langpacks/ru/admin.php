...
/**
 * Strings for component 'admin', language 'ru', version '4.4'.
 *
 * @package     admin
 * @category    string
...
$string['oracledatabaseinuse'] = 'Поддержка базы данных Oracle будет удалена. Moodle 4.5 станет последней версией с поддержкой БД Oracle. Подробности см. в объявлении на сайте Moodle.org <a href="https://moodle.org/mod/forum/discuss.php?d=456122">Поддержка базы данных Oracle при прекращении поддержки LMS</a>.';
...
$string['themesettingscustom'] = 'Настройки пользовательской темы';
