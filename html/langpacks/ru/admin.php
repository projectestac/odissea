...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['croninfrequent'] = 'Время между двумя последними запусками сценария обслуживания cron составило более {$a} секунд. Рекомендуется настроить его для более частого запуска.';
...
$string['h5pgetcontenttypestask'] = 'Загрузите доступные типы контента H5P с h5p.org';
...
$string['task_adhoc_concurrency_limit'] = 'Ограничение одновременно выполняемых нерегламентированных задач';
$string['task_adhoc_concurrency_limit_desc'] = 'Число одновременно выполняемых нерегламентированных задач. Если ограничение велико, то запланированные задачи могут выполняться не регулярно, когда есть много таких задач. Значение 0 полностью отключает обработку нерегламентированных задач.';
$string['task_adhoc_max_runtime'] = 'Время выполнения нерегламентированной задачи';
$string['task_adhoc_max_runtime_desc'] = 'Время нерегламентированной задачи, прежде чем она будет освобождена. Рекомендуется низкая продолжительность, так как нет ограничений на количество нерегламентированных задач в очереди. Если это число слишком велико и имеется большая очередь нерегламентированных задач, запланированные задачи могут выполняться нерегулярно.';
...
$string['tasktype'] = 'Тип';
$string['task_type:adhoc'] = 'Нерегламентированная';
