...
/**
 * Strings for component 'admin', language 'ru', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['enabledashboard_help'] = 'По умолчанию в личном кабинете отображаются временная шкала, календарь и недавно просмотренные элементы. Вы можете установить по умолчанию для всех другую конфигурацию личного кабинета и позволить пользователям настраивать свою собственную конфигурацию. Если эта функция отключена, необходимо установить для параметра «Стартовая страница для пользователей» значение, отличное от «Личный кабинет».';
...
$string['iplookupinfo'] = 'Для поиска местоположений IP-адресов используется бесплатный онлайн-сервер NetGeo. Однако база данных больше не поддерживается и может выдавать неверные данные. Рекомендуется установить локальную копию бесплатной базы данных GeoLite2 City от компании MaxMind.<br />
...
$string['resetindentation'] = 'Сбросить отступ';
$string['resetindentation_help'] = 'Это удалит все ранее установленные отступы для курсов в формате {$a->format}.';
$string['resetindentation_title'] = 'Сбросить отступ на странице курса?';
$string['resetindentationsuccess'] = 'Отступ сброшен';
...
$string['sitesectionhelp'] = 'При включенном параметре верхняя секция будет отображаться на главной странице сайта.';
