...
/**
 * Strings for component 'admin', language 'ru', version '4.5'.
 *
 * @package     admin
 * @category    string
...
Чтобы немедленно разблокировать учетную запись, перейдите по ссылке ниже:

<a href="{$a->link}">Разблокировать учетную запись</a>
