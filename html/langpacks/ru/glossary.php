...
/**
 * Strings for component 'glossary', language 'ru', version '4.5'.
 *
 * @package     glossary
 * @category    string
...
$string['addsingleentry'] = 'Добавить запись';
...
$string['destination_help'] = 'Записи могут быть импортированы и добавлены в текущий глоссарий или в новый глоссарий, при этом новый глоссарий будет создан на основе информации из файла XML.';
...
$string['errreservedkeywords'] = 'Одно или несколько ключевых слов содержат специальный символ, который нельзя использовать.';
