...
/**
 * Strings for component 'backup', language 'ru', version '4.5'.
 *
 * @package     backup
 * @category    string
...
$string['asyncmessagebody'] = 'Уведомление';
...
$string['asyncmessagebodydetail'] = 'Уведомление, отправляемое после завершения асинхронного резервного копирования или восстановления.';
$string['asyncmessagesubject'] = 'Тема';
$string['asyncmessagesubjectdefault'] = 'Процесс {operation} Moodle успешно завершен.';
$string['asyncmessagesubjectdetail'] = 'Тема уведомления';
...
$string['automatedsetup'] = 'Настройки автоматического резервного копирования';
...
$string['backupautoactivitiesdescription'] = 'Устанавливает значение по умолчанию для включения активных элементов в резервную копию. Этот параметр должен быть включен для работоспособности корзины.';
...
$string['backupfile'] = 'Резервная копия';
...
$string['backupthenrestore'] = 'Резервная копии создана. Начато восстановление.';
...
$string['choosefilefromactivitybackup_help'] = 'Резервные копии этого активного элемента.';
$string['choosefilefromautomatedbackup'] = 'Автоматически созданные резервные копии';
$string['choosefilefromautomatedbackup_help'] = 'Автоматически созданные резервные копии.';
$string['choosefilefromcoursebackup'] = 'Область резервных копий курса';
$string['choosefilefromcoursebackup_help'] = 'Резервные копии этого курса.';
$string['choosefilefromuserbackup'] = 'Область для обезличенных резервных копий';
$string['choosefilefromuserbackup_help'] = 'Конфиденциальные резервные копии курсов с обезличенными данными пользователей.';
...
$string['config_overwrite_course_fullname'] = 'По умолчанию перезаписать полное имя курса из файла резервной копии. Для этого требуется выбор параметра «Заменить настройки курса» и текущий пользователь, должен иметь право изменять полное имя курса (moodle/course:changefullname)';
$string['config_overwrite_course_shortname'] = 'По умолчанию перезаписать краткое имя курса из файла резервной копии. Для этого требуется выбор параметра «Заменить настройки курса» и текущий пользователь, должен иметь право изменять краткое имя курса (moodle/course:changeshortname)';
$string['config_overwrite_course_startdate'] = 'По умолчанию перезаписывать дату начала курса из файла резервной копии. Для этого требуется выбор параметра «Заменить настройки курса» и текущий пользователь, должен иметь право изменять дату начала курса при восстановлении (moodle/restore:rolldates)';
...
$string['configgeneralcustomfield'] = 'Устанавливает значение по умолчанию для включения настраиваемых полей в резервную копию.';
...
$string['configgeneralxapistate'] = 'Задает значение по умолчанию для включения в резервную копию состояния пользователя в контенте, таком как активные элементы H5P.';
$string['configlegacyfiles'] = 'Устанавливает значение по умолчанию для включения устаревших файлов курсов в резервную копию. Устаревшие файлы курсов из версий Moodle до 2.0.';
$string['configloglifetime'] = 'Этот параметр определяет длительность хранения информации журналов событий о резервных копиях. Журналы, которые старше этого возраста, автоматически удаляются. Рекомендуется, чтобы это значение было маленьким, поскольку информация журналов о резервных копиях может быть очень обширной.';
...
$string['configrestorecustomfield'] = 'Устанавливает значение по умолчанию для восстановления настраиваемых полей.';
...
$string['configrestorexapistate'] = 'Задает значение по умолчанию для восстановления состояния пользователя в контенте, таком как активные элементы H5P.';
...
$string['copycoursedesc'] = 'Создайте копию этого курса в любой категории курсов.';
...
$string['enableasyncbackup_help'] = 'Если эта функция включена, все операции резервного копирования и восстановления будут выполняться асинхронно. Асинхронное резервное копирование и восстановление позволяет пользователям выполнять другие операции во время резервного копирования или восстановления. Это не влияет на импорт и экспорт.';
...
$string['generalcontentbankcontent'] = 'Включать содержимое банка контента';
$string['generalcustomfield'] = 'Включить настраиваемые поля';
...
$string['generallegacyfiles'] = 'Включать устаревшие файлы курса';
$string['generallogs'] = 'Включать журналы событий';
$string['generalpermissions'] = 'Включать переопределения разрешений';
$string['generalquestionbank'] = 'Включать банк вопросов';
$string['generalrestoredefaults'] = 'Основные настройки восстановления по умолчанию';
$string['generalrestoresettings'] = 'Основные настройки восстановления';
$string['generalroleassignments'] = 'Включать назначения ролей';
$string['generalsettings'] = 'Основные настройки резервного копирования';
...
$string['generalxapistate'] = 'Включать состояние пользователя в контент, такой как активные элементы H5P.';
...
$string['importfile'] = 'Загрузить файл резервной копии';
$string['importfromccmidtocourse'] = 'Импорт из модуля:{$a->srccmid} в курс: {$a->dstcourseid}';
$string['importfromcoursetocourse'] = 'Импорт из курса: {$a->srccourseid} в курс: {$a->dstcourseid}';
...
$string['includeuserinfo_instance'] = 'Включать данные пользователя {$a}';
$string['inprogress'] = 'Выполняется резервное копирование';
$string['jumptofinalstep'] = 'Переход к конечному этапу';
$string['keep'] = 'Сохранить';
$string['keptroles'] = 'Включать назначения ролей';
$string['keptroles_help'] = 'Пользователи с выбранными ролями будут записаны на новый курс. Никакие данные пользователя не будут скопированы, если не включен параметр «Включать данные пользователя».';
...
$string['managefiles_activity'] = 'Управление резервными копиями активного элемента';
$string['managefiles_automated'] = 'Управление автоматически созданными резервными копиями';
$string['managefiles_backup'] = 'Управление обезличенными резервными копиями';
$string['managefiles_course'] = 'Управление резервными копиями курса';
...
$string['questioncannotberestored'] = 'Вопросы «{$a->name}» не могут быть созданы при восстановлении';
...
$string['restoreexecutionsuccess'] = 'Курс успешно восстановлен.';
...
$string['restorenofilesbackuparea'] = 'Файлов резервных копий пока нет.';
$string['restorenofilesbackuparea_activity'] = 'Файлов резервных копий этого активного элемента пока нет.';
$string['restorenofilesbackuparea_automated'] = 'Автоматически созданных резервных копий пока нет.';
$string['restorenofilesbackuparea_backup'] = 'У вас пока нет обезличенных резервных копий.';
$string['restorenofilesbackuparea_course'] = 'Файлов резервных копий этого курса пока нет.';
...
$string['rootsettingcontentbankcontent'] = 'Включать содержимое банка контента';
$string['rootsettingcustomfield'] = 'Включать пользовательские поля';
...
$string['rootsettinglegacyfiles'] = 'Включать устаревшие файлы курса';
$string['rootsettinglogs'] = 'Включать журналы событий курса';
$string['rootsettingpermissions'] = 'Включать переопределения разрешений';
...
$string['rootsettinguserscompletion'] = 'Включать информацию о выполнении пользователем элементов курса';
$string['rootsettingxapistate'] = 'Включать состояние пользователя в контент, такой как активные элементы H5P.';
...
$string['section_prefix'] = 'Раздел {$a}:';
...
$string['skipmodifdays'] = 'Пропускать курсы, не изменившиеся';
...
$string['subsectioncontent'] = 'Содержимое подсекции';
...
$string['userdata'] = 'Включать пользовательские данные';
$string['userdata_help'] = 'Если включено, то данные пользователя, такие как сообщения форумов, отправленные задания и т. п.,  будут скопированы в новый курс для каждого пользователя, роль которого выбрана в разделе «Включать назначения ролей»';
