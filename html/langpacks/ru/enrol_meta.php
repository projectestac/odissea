...
$string['coursesort_help'] = 'Определяет, должен ли список подключаемых курсов быть отсортированным в заданном порядке (то есть, в порядке, указанном в «Администрирование сайта > Курсы > Управление курсами и категориями») или же в алфавитном порядке.';
