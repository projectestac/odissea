...
$string['enrolmetasynctask'] = 'Задача синхронизации способа записи «Метасвязь с курсом»';
...
$string['privacy:metadata:core_group'] = 'Плагин способа записи «Метасвязь с курсом» может создать новую группу или использовать существующую группу для добавления всех участников связанного курса.';
