...
/**
 * Strings for component 'tool_cohortroles', language 'ru', version '4.4'.
 *
...
$string['backgroundsync'] = 'Обратите внимание: новые назначения ролей глобальным группам не будут применены моментально. Изменение назначений ролей будет сделано запланированной задачей.';
