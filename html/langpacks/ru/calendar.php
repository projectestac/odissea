...
$string['coursecalendarlink'] = 'Календарь курса';
...
$string['errorrequiredurlorfile'] = 'Для импорта календаря требуется URL-адрес или файл.';
...
$string['eventnamelocation'] = 'Местоположение {$a->name}: {$a->location}';
...
$string['newmonthannouncement'] = 'Календарь сейчас установлен в {$a}.';
$string['nocalendarsubscriptions'] = 'Подписок на календари пока нет. Вы хотите {$a}';
$string['nocalendarsubscriptionsimportexternal'] = 'Пока нет подписок на календари. <a href="{$a}">Импортировать внешний календарь</a>';
...
$string['timeformat_12'] = '12-часовой (am/pm)';
