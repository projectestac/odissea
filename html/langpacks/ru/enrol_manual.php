...
/**
 * Strings for component 'enrol_manual', language 'ru', version '4.4'.
 *
...
$string['defaultstart'] = 'Начало зачисления по умолчанию';
...
$string['enrolusers'] = 'Зачисление пользователей на курс';
$string['enroluserscohorts'] = 'Зачислить выбранных пользователей и глобальные группы';
...
$string['sendexpirynotificationstask'] = 'Задача отправки уведомлений об истечении срока действия зачисления вручную';
...
$string['syncenrolmentstask'] = 'Задача синхронизации зачислений вручную';
