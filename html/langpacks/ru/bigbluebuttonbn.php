...
$string['bigbluebuttonbn:viewallrecordingformats'] = 'Видеть все форматы записи';
...
$string['cachedef_subplugins'] = 'Кэш, используемый установленными подпрограммами  для ускорения обнаружения необходимых модулей.';
...
$string['completionattendance'] = 'Требуется присутствие (в минутах)';
...
$string['completionattendancegroup'] = 'Требуется присутствие (в минутах)';
...
$string['config_checksum_algorithm'] = 'Алгоритм контрольной суммы сервера BigBlueButton';
$string['config_checksum_algorithm_description'] = 'SHA1 совместим со старыми серверами. SHA256 и SHA512 более безопасны. SHA512 соответствует стандарту FIPS 140-2.';
...
$string['config_preuploadpresentation'] = 'Файл презентации';
...
$string['config_preuploadpresentation_editable'] = 'Файл презентации на странице конференции';
$string['config_preuploadpresentation_editable_description'] = 'Возможность загрузки файла презентации в настройках конференции для отображения на её странице.';
$string['config_profile_picture_enabled'] = 'Показать фотографии участников';
$string['config_profile_picture_enabled_description'] = 'Следует ли показывать фотографии участников сеансов BigBlueButton?';
...
$string['config_recording_safe_formats'] = 'Форматы записи, доступные для просмотра всем';
$string['config_recording_safe_formats_description'] = 'Выберите форматы, которые доступны для просмотра всем.
Все остальные форматы доступны для просмотра только учителям и другим пользователям с правом mod/bigbluebuttonbn:viewallrecordingformats (видеть все форматы записей) и mod/bigbluebuttonbn:managerecordings (управлять записями).';
...
$string['config_welcome_default_description'] = 'Приветственное сообщение отображается, когда участники входят в комнату конференции. Если поле оставить пустым, будет использоваться языковая строка \'mod_form_field_welcome_default\'.';
...
$string['credentials_warning'] = 'Срок использования учетных данных сервера по умолчанию скоро истечет (см. примечание выше, чтобы получить новые учетные данные).';
...
$string['event_recording_link_deleted'] = 'Ссылка на запись удалена';
...
$string['managebbbextplugins'] = 'Управление плагинами расширения BigBlueButton';
...
$string['settings_credential_warning'] = 'Срок действия учетных данных плагина BigBlueButton по умолчанию скоро истечет. Дополнительную информацию см. в разделе <a href="{$a->settingslink}" target="_blank">Настройки BigBlueButton (откроется в новом окне)</a>.';
$string['settings_credential_warning_no_capability'] = 'Срок действия учетных данных сервера BigBlueButton скоро истечет. Обратитесь за помощью к администратору вашего сайта.';
$string['started_at'] = 'Начато';
$string['starts_at'] = 'Началось';
$string['subplugintype_bbbext'] = 'Расширение BigBlueButton';
$string['subplugintype_bbbext_plural'] = 'Расширения BigBlueButton';
