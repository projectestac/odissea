...
/**
 * Strings for component 'tool_analytics', language 'ru', version '4.4'.
 *
...
$string['alltimesplittingmethods'] = 'Все интервалы анализа';
$string['analysingsitedata'] = 'Анализируем сайт';
...
$string['clievaluationandpredictions'] = 'Запланированная задача проходит по всем включенным моделям и получает прогнозы. Оценка моделей через веб-интерфейс отключена. Вы можете разрешить выполнение этих процессов вручную через веб-интерфейс, отключив параметр <a href="{$a}">«только с командной строки»</a> в настройках аналитики.';
$string['clievaluationandpredictionsnoadmin'] = 'Запланированная задача проходит по всем включенным моделям и получает прогнозы. Оценка моделей через веб-интерфейс отключена. Её может включить администратор сайта.';
...
$string['edittrainedwarning'] = 'Эта модель уже прошла обучение. Обратите внимание, что изменение её показателей или интервала анализа удалит предыдущие прогнозы модели и запустит генерацию новых прогнозов.';
...
$string['insightsreport'] = 'Отчёт об инсайтах';
$string['invalidanalysables'] = 'Непригодные элементы сайта';
$string['invalidanalysablesinfo'] = 'На этой странице перечислены анализируемые элементы, которые не могут быть использованы данной моделью прогнозирования. Перечисленные элементы не могут быть использованы ни для обучения модели прогнозирования, ни для получения прогнозов по ним.';
...
$string['noactionsfound'] = 'Пользователи не выполняли никаких действий на основе сгененированных инсайтов.';
...
$string['predictmodels'] = 'Прогнозирование по моделям';
$string['predictorresultsin'] = 'Информация журнала прогноза в каталоге {$a}';
$string['previouspage'] = 'Предыдущая страница';
$string['privacy:metadata'] = 'Плагин «Модели аналитики» не хранит никаких персональных данных.';
