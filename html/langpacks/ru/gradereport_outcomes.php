...
/**
 * Strings for component 'gradereport_outcomes', language 'ru', version '4.5'.
 *
...
$string['privacy:metadata'] = 'В отчете об Оценках показателей отображаются только данные, хранящиеся в других местах.';
