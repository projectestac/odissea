...
/**
 * Strings for component 'blog', language 'ru', version '4.5'.
 *
 * @package     blog
 * @category    string
...
$string['blogattachment'] = 'Приложение к блогу';
...
$string['cannoteditentryorblog'] = 'Вы не можете редактировать эту запись или блог';
...
$string['entrytitlewithlink'] = 'Заголовок записи со ссылкой';
...
$string['linktooriginalentry'] = 'Оригинальная запись блога';
...
$string['publishtodraft'] = 'Черновик';
