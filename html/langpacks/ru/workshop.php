...
/**
 * Strings for component 'workshop', language 'ru', version '4.5'.
 *
 * @package     workshop
 * @category    string
...
Если эта функция включена, то также рекомендуется задать метод планового распределения. Если работы не распределяются, то оценивание не может быть проведено, даже если сам семинар находится в стадии оценивания.';
...
$string['submissionsallocation'] = 'Распределение представленных работ';
