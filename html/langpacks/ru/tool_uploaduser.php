...
/**
 * Strings for component 'tool_uploaduser', language 'ru', version '4.5'.
 *
...
$string['invaliduserdatavalues'] = 'Для пользователя {$a->username} обнаружены неверные данные ({$a->values}). Эти данные были исправлены или удалены.';
