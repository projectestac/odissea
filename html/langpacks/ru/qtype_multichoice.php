...
/**
 * Strings for component 'qtype_multichoice', language 'ru', version '4.5'.
 *
...
$string['privacy:metadata'] = 'Плагин «Тип вопроса Множественный выбор» позволяет авторам вопросов устанавливать параметры по умолчанию как пользовательские настройки.';
$string['privacy:preference:answernumbering'] = 'Какой тип нумерации следует использовать («1, 2, 3, ...»,«a, b, c, ...» и т.д.)';
