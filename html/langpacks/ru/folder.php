...
/**
 * Strings for component 'folder', language 'ru', version '4.1'.
 *
 * @package     folder
 * @category    string
...
$string['displayinline'] = 'Встроенное на странице курса';
...
$string['noautocompletioninline'] = 'Автоматическая отметка завершения просмотра каталога не может быть выбрана вместе с параметром «Встроенное на странице курса»';
