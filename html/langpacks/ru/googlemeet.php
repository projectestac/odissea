...
/**
 * Strings for component 'googlemeet', language 'ru', version '4.1'.
 *
 * @package     googlemeet
 * @category    string
...
$string['emailcontent_default'] = '<p>Здравствуйте, %userfirstname%!</p> <p>Напоминаем Вам о том, что в курсе «%coursename%» состоится мероприятие в Google Meet</p> <p><b>%googlemeetname%</b></p> <p>Когда: %eventdate% %duration% %timezone%</p> <p>Ссылка для входа: %url%</p>';
...
$string['modulename_help'] = 'Модуль «Google Meet™ для Moodle» позволяет учителю создавать собрание Google Meet как ресурс в курсе и после мероприятий делать доступными для студентов записи, сохранённые на Google Диске. <p>©2018 Google LLC Все права защищены.<br/> Google Meet и  логотип Google Meet logo — зарегистрированные торговые марки Google LLC.</p>';
...
$string['multieventdateexpanded_desc'] = 'Показывать настройки «Повторять дату мероприятия» в развёрнутом виде по умолчанию при создании нового собрания.';
...
$string['repeatasfollows'] = 'Повторять указанную выше дату мероприятия следующим образом';
