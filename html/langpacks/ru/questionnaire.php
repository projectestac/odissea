...
/**
 * Strings for component 'questionnaire', language 'ru', version '3.11'.
 *
...
$string['completionsubmit'] = 'Студент должен ответить на этот опрос, чтобы выполнить его';
...
$string['downloadtextformat_help'] = 'Эта функция позволяет сохранить все ответы анкетного опроса в файл в выбираемом поддерживаемом формате.
Вы можете включить в экспорт дополнительные элементы данных, а также выбрать автоматическую отправку файла выбранным пользователям.';
...
$string['notificationfull'] = 'Полная подача';
$string['notifications'] = 'Отправить уведомление о подаче';
$string['notifications_help'] = 'Отправить уведомление о подаче ролям с возможностью «mod/questionnaire:submissionnotification»';
$string['notificationsimple'] = 'Только уведомления';
...
$string['total'] = 'Всего';
$string['totalofnumbers'] = 'Общее количество введенных номеров';
