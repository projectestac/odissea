...
/**
 * Strings for component 'quiz', language 'ru', version '4.4'.
 *
 * @package     quiz
 * @category    string
...
$string['randomqnamecat'] = 'Случайно ({$a->category}) на основе условия фильтра';
$string['randomqnamecattags'] = 'Случайно ({$a->category}) на основе условия фильтра с тегами: {$a->tags}';
