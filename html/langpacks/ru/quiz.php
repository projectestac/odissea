...
/**
 * Strings for component 'quiz', language 'ru', version '4.5'.
 *
 * @package     quiz
 * @category    string
...
$string['addarandomquestion_success'] = 'Случайные вопросы добавлены';
...
$string['addpagebreakafter'] = 'Добавить разрыв страницы после вопроса {$a}';
...
$string['alwayslatest'] = 'Всегда последняя';
...
$string['attemptgradeddelay'] = 'Задержка уведомлений об оцененных попытках';
$string['attemptgradeddelay_desc'] = 'Перед отправкой уведомлений об оценке попытки применяется задержка, чтобы дать учителю время для изменения оценки.';
$string['attemptincomplete'] = 'Эта попытка ({$a}) еще не закончена.';
$string['attemptlast'] = 'Последняя попытка';
$string['attemptnumber'] = 'Попытка';
$string['attemptquiz'] = 'Пройти тест';
...
Это позволяет задать им аналогичный вопрос (выбранный случайным образом) или повторить тот же вопрос без необходимости завершения теста и начала другой попытки. Такая возможность в основном полезна для тренировочных тестов.
Эта настройка влияет только на те вопросы и поведение (например, немедленный отзыв или интерактивный с несколькими попытками), где возможно завершение студентом вопроса до того, как попытка будет отправлена.';
$string['canredoquestionsyes'] = 'Да, предоставить возможность ответить на подобный вопрос';
...
$string['closebeforeopen'] = 'Дата закрытия должна быть позже даты открытия.';
...
$string['completionattemptsexhausted'] = 'Проходной балл или все доступные попытки завершены';
...
$string['completiondetail:minattempts'] = 'Сделать попытки: {$a}';
$string['completiondetail:passorexhaust'] = 'Получить проходную оценку или выполнить все доступные попытки';
$string['completionminattempts'] = 'Минимальное количество попыток:';
$string['completionminattemptsdesc'] = 'Требуемое минимальное количество попыток: {$a}';
...
$string['completionpassorattemptsexhausteddesc'] = 'Студент должен получить проходной балл или исчерпать все доступные попытки для выполнения этого задания.';
...
$string['configoutcomesadvanced'] = 'При включенном параметре в форме редактирования теста «Показатели» относятся к дополнительным настройкам.';
...
$string['continueattemptquiz'] = 'Продолжить текущую попытку';
$string['continuepreview'] = 'Продолжить последний просмотр';
$string['copyingfrom'] = 'Создание копии вопроса «{$a}»';
...
$string['decimalplacesquestion'] = 'Десятичных знаков в оценках вопросов';
...
$string['edit_slotdisplaynumber_hint'] = 'Изменить номер вопроса (максимум 16 символов)';
$string['edit_slotdisplaynumber_label'] = 'Новое значение для {$a}';
...
$string['emailconfirmautosubmitsmall'] = 'Спасибо за отправленные ответы на тест «{$a->quizname}»';
...
$string['emailconfirmbodyautosubmit'] = 'Здравствуйте, {$a->username}!

Время для теста «{$a->quizname}» в курсе «{$a->coursename}» истекло. Ваши ответы были отправлены автоматически в {$a->submissiontime}.

Это сообщение подтверждает, что ваши ответы были сохранены.

Вы можете получить доступ к этому тесту по ссылке {$a->quizurl}.';
...
$string['emailmanualgradedbody'] = 'Здравствуйте, {$a->studentname}!

Ваши ответы на тест «{$a->quizname}» в курсе «{$a->coursename}» ({$a->successtimefinish}) оценены.

Вы сможете просмотреть свои оценки и отзывы, посетив «{$a->quizurl}» и просмотрев свою попытку.';
$string['emailmanualgradedsubject'] = 'Ваша попытка в тесте «{$a->quizname}» была оценена';
...
$string['eventattemptautosaved'] = 'Попытка теста сохранена автоматически';
$string['eventattemptdeleted'] = 'Попытка теста удалена';
$string['eventattemptmanualgradingcomplete'] = 'Завершено выставление оценок вручную за попытку в тесте';
$string['eventattemptpreviewstarted'] = 'Начата попытка предварительного просмотра теста';
$string['eventattemptquestionrestarted'] = 'Вопрос попытки теста перезапущен';
...
$string['eventattemptupdated'] = 'Попытка теста обновлена';
...
$string['eventpagebreakcreated'] = 'Разрыв страницы создан';
$string['eventpagebreakdeleted'] = 'Разрыв страницы удален';
$string['eventquestionmanuallygraded'] = 'Вопрос оценен вручную';
$string['eventquizattemptabandoned'] = 'Попытка пройти тест прекращена';
$string['eventquizattemptregraded'] = 'Попытка теста заново оценена';
$string['eventquizattemptreopened'] = 'Повторно открытая попытка теста';
...
$string['eventquizgradeitemcreated'] = 'Элемент оценки теста создан';
$string['eventquizgradeitemdeleted'] = 'Элемент оценки теста удален';
$string['eventquizgradeitemorderchanged'] = 'Порядок элементов оценки за тест изменен';
$string['eventquizgradeitemupdated'] = 'Элемент оценки теста обновлен';
$string['eventquizgradeupdated'] = 'Оценка теста обновлена';
$string['eventquizrepaginated'] = 'Тест повторно разбит на страницы';
$string['eventreportviewed'] = 'Отчет по тесту просмотрен';
$string['eventsectionbreakcreated'] = 'Разрыв раздела создан';
$string['eventsectionbreakdeleted'] = 'Разрыв раздела удален';
$string['eventsectionshuffleupdated'] = 'Перемешивание разделов обновлено';
$string['eventsectiontitleupdated'] = 'Название раздела обновлено';
$string['eventslotcreated'] = 'Вопрос создан';
$string['eventslotdeleted'] = 'Вопрос удален';
$string['eventslotdisplayedquestionnumberupdated'] = 'Отображаемый номер вопроса обновлен';
$string['eventslotgradeitemupdated'] = 'Оценка за вопрос обновлена';
$string['eventslotmarkupdated'] = 'Баллы за вопрос изменены';
$string['eventslotmoved'] = 'Вопрос перемещен';
$string['eventslotrequirepreviousupdated'] = 'Вопрос требует предварительного обновления';
$string['eventslotversionupdated'] = 'Версия вопроса обновлена';
$string['everynquestions'] = 'Каждые {$a} вопр.';
...
$string['gobacktoquiz'] = 'Вернуться к тесту';
...
$string['gradeitemdefaultname'] = 'Новый элемент оценки {$a}';
$string['gradeitemdelete'] = 'Удалить элемент оценки {$a}';
$string['gradeitemedit'] = 'Изменить название элемента оценки {$a}';
$string['gradeitemmarkscheme'] = 'Назначить элементы оценки';
$string['gradeitemnewname'] = 'Новое название для элемента оценки {$a}';
$string['gradeitemnoneselected'] = '[нет]';
$string['gradeitemnoslots'] = 'В этом тесте еще нет вопросов. Сначала добавьте вопросы, а затем вернитесь сюда, чтобы настроить элементы оценки.';
$string['gradeitems'] = 'Элементы оценивания';
$string['gradeitemsautosetup'] = 'Установить оценку для каждого раздела';
$string['gradeitemsetup'] = 'Настройка элементов оценки';
$string['gradeitemsnoneyet'] = 'Создайте элементы оценки для теста. Распределите вопросы или разделы теста по этим элементам оценки, чтобы распределить оценки результатов по различным областям.';
$string['gradeitemsremoveall'] = 'Сбросить настройки';
$string['gradeitemsremoveallconfirm'] = 'Сбросить настройки элементов оценки?';
$string['gradeitemsremoveallmessage'] = 'При этом будут удалены все элементы оценки и отменены назначения вопросов и разделов для них.<br><br>Это действие не повлияет ни на сами вопросы и разделы, ни на существующие попытки в тесте.';
$string['gradeitemsremovealltitle'] = 'Сбросить настройки элементов оценки';
...
$string['gradetopassoutof'] = 'Проходная оценка: {$a->grade} из {$a->maxgrade}';
...
$string['invalidrandomslot'] = 'Неверный ID места для случайного вопроса.';
...
$string['lastautosave'] = 'Последнее сохранение: {$a}';
$string['layout'] = 'Расположение';
$string['layoutasshown'] = 'Располагать на странице как отображено.';
$string['layoutasshownwithpages'] = 'Располагать на странице как отображено. <small>(Каждые {$a} вопр. автоматически располагать на новой странице.)</small>';
...
Выбрать «Оценки» можно только в том случае, если выбрано «Максимальные баллы».';
...
$string['maxmarks'] = 'Максимальные баллы';
$string['maxmarks_help'] = 'Максимальный балл, доступный за каждый вопрос.';
$string['messageprovider:attempt_grading_complete'] = 'Уведомление о том, что ваша попытка была оценена';
...
$string['messageprovider:quiz_open_soon'] = 'Тест скоро откроется';
$string['messageprovider:submission'] = 'Уведомления о попытках прохождения тестов';
$string['min'] = 'Минимум';
$string['minutes'] = 'мин.';
$string['missingcategory'] = 'Не указана категория вопросов';
...
$string['movequestionnumber'] = 'Переместить вопрос: {$a}';
...
$string['notenoughrandomquestions'] = 'В категории ID={$a->category} недостаточно вопросов, чтобы создать {$a->name} (ID={$a->id}).';
...
$string['notifyattemptsgradedtask'] = 'Отправлять уведомления о оценках попыток теста';
...
$string['outcomesadvanced'] = '«Показатели» относятся к дополнительным настройкам';
...
$string['overridecannotchange'] = 'Пользователя или группу нельзя изменить после создания переопределения.';
$string['overridecannotsetbothgroupanduser'] = 'И группу, и пользователя нельзя задать одновременно.';
...
$string['overrideinvalidattempts'] = 'Значение попыток должно быть больше нуля.';
$string['overrideinvalidexistingid'] = 'Указанное переопределение не существует';
$string['overrideinvalidgroup'] = 'Указанная группа не существует';
$string['overrideinvalidquiz'] = 'Заданный ID теста не существует';
$string['overrideinvalidtimelimit'] = 'Ограничение по времени должно быть больше нуля.';
$string['overrideinvaliduser'] = 'Указанный пользователь не существует';
$string['overridemissingdelete'] = 'Переопределения ID {$a} не могут быть удалены, поскольку они не существуют или не являются частью данного теста.';
$string['overridemultiplerecordsexist'] = 'Для одного и того же пользователя/группы невозможно выполнить несколько переопределений.';
$string['overridemustsetuserorgroup'] = 'Должны быть указаны пользователь или группа';
$string['overrides'] = 'Переопределения';
$string['overridesforquiz'] = 'Переопределения настроек: {$a}';
$string['overridesnoneforgroups'] = 'Для этого теста нет никаких переопределений групповых настроек.';
$string['overridesnoneforusers'] = 'Для этого теста нет никаких переопределений настроек пользователя.';
$string['overridessummary'] = 'Имеются переопределения настроек ({$a})';
$string['overridessummarygroup'] = 'Группы: {$a}';
$string['overridessummarythisgroup'] = 'Имеются переопределения настроек ({$a}) для этой группы';
$string['overridessummaryuser'] = 'Пользователи: {$a}';
$string['overridessummaryyourgroups'] = 'Имеются переопределения настроек ({$a}) для ваших групп';
...
$string['previewquizstart'] = 'Предварительный просмотр теста';
...
$string['privacy:metadata:quiz_attempts:gradednotificationsenttime'] = 'Время, когда пользователь был уведомлен о завершении ручной оценки его попытки.';
...
$string['questiondraftonly'] = 'Вопрос «{$a}» имеет статус «Черновик». Для использования вопроса в тесте посетите банк вопросов и установите статус «Готов».';
$string['questiondraftwillnotwork'] = 'Этот вопрос имеет статус «Черновик». Для использования вопроса в тесте посетите банк вопросов и установите статус «Готов».';
...
$string['questionversion'] = 'верс. {$a}';
$string['questionversionlatest'] = 'версия {$a} (последняя)';
...
$string['quiz:emailconfirmsubmission'] = 'Получать подтверждение при отправке собственной попытки теста';
$string['quiz:emailnotifyattemptgraded'] = 'Получать уведомление, когда ваша попытка будет оценена';
$string['quiz:emailnotifysubmission'] = 'Получать уведомления о попытках прохождения теста вашими студентами';
...
$string['quiz:reopenattempts'] = 'Повторно открывать не отправленные попытки теста';
$string['quiz:reviewmyattempts'] = 'Просматривать свои попытки';
$string['quiz:view'] = 'Просматривать информацию о тесте';
$string['quiz:viewoverrides'] = 'Видеть переопределения настроек теста';
...
$string['quizopendatesoonhtml'] = '<p>Здравствуйте, {$a->firstname}!</p>
<p>Скоро откроется тест <strong>{$a->quizname}</strong> в курсе {$a->coursename}.
<p><strong>Открывается: {$a->timeopen}</strong></p>
<p><strong>Закрывается: {$a->timeclose}</strong></p>
<p><a href="{$a->url}">Перейти к тесту</a></p>';
$string['quizopendatesoonsubject'] = 'Открывается в {$a->timeopen}: {$a->quizname}';
...
$string['quizsetupnavigation'] = 'Навигация по настройке теста';
$string['quiztimer'] = 'Таймер теста';
$string['quizwillopen'] = 'Этот тест откроется {$a}';
$string['random'] = 'Случайный вопрос';
$string['randomcatwithsubcat'] = '{$a} и подкатегории';
$string['randomcoursecatwithsubcat'] = 'Любая категория в категории курсов {$a}';
$string['randomcoursewithsubcat'] = 'Любая категория этого курса';
$string['randomcreate'] = 'Создать случайные вопросы';
$string['randomediting'] = 'Редактирование случайного вопроса';
$string['randomfaultynosubcat'] = 'Некорректный вопрос';
...
$string['randommodulewithsubcat'] = 'Любая категория этого теста';
...
$string['randomqname'] = 'Случайный вопрос в зависимости от условия фильтра';
$string['randomqnamecat'] = 'Случайный ({$a->category}) на основе условия фильтра';
$string['randomqnamecattags'] = 'Случайный ({$a->category}) на основе условия фильтра с тегами: {$a->tags}';
$string['randomqnametags'] = 'Случайный вопрос на основе условия фильтра с тегами: {$a}';
...
$string['randomsystemwithsubcat'] = 'Любая категория сайта';
...
$string['removepagebreakafter'] = 'Удалить разрыв страницы после вопроса {$a}';
...
$string['reopenattempt'] = 'Повторно открыть';
$string['reopenattemptareyousuremessage'] = 'Это повторно откроет попытку {$a->attemptnumber} пользователя {$a->attemptuser}?';
$string['reopenattemptareyousuretitle'] = 'Повторить попытку?';
$string['reopenattemptwrongstate'] = 'Попытка {$a->attemptid} находится в неправильном состоянии ({$a->state}) для повторного открытия.';
$string['reopenedattemptwillbeinprogress'] = 'Попытка останется открытой и может быть продолжена.';
$string['reopenedattemptwillbeinprogressuntil'] = 'Попытка останется открытой и может быть продолжена до закрытия теста {$a}.';
$string['reopenedattemptwillbesubmitted'] = 'Попытка будет немедленно отправлена для оценивания.';
...
$string['reportdisplayoptions'] = 'Параметры отображения';
...
$string['reportshowonly'] = 'Показать только попытки, которые';
...
$string['savemanualgradingfailed'] = 'Изменение не сохранено. Пожалуйста, проверьте сообщение ниже и попробуйте еще раз.';
...
$string['selectmultipleitems'] = 'Выбрать несколько элементов';
$string['selectmultipletoolbar'] = 'Выберите несколько панелей инструментов';
$string['selectnone'] = 'Убрать выделение';
$string['selectquestionslot'] = 'Выбрать вопрос {$a}';
$string['selectquestiontype'] = '- Выберите тип вопроса -';
$string['sendnotificationopendatesoon'] = 'Уведомить пользователя о приближающейся дате открытия теста';
...
$string['statefinished'] = 'Завершены';
...
$string['submission_confirmation'] = 'Отправить все свои ответы и закончить?';
$string['submission_confirmation_unanswered'] = 'Вопросы без ответа: {$a}';
...
$string['summaryofattempts'] = 'Ваши попытки';
$string['summaryofattemptscaption'] = 'Резюме попытки {$a}';
...
$string['timelimit_help'] = 'Если включено, то ограничение по времени указывается на начальной странице теста и в блоке навигации теста отображается таймер с обратным отсчетом.';
...
$string['updatefilterconditon'] = 'Обновить условия фильтра';
$string['updatefilterconditon_success'] = 'Условия фильтра обновлены';
