...
/**
 * Strings for component 'quiz', language 'ru', version '4.1'.
 *
 * @package     quiz
 * @category    string
...
$string['completiondetail:passgrade'] = 'Получить проходную оценку';
...
$string['completionpassdesc'] = 'Студент должен получить проходную оценку, чтобы выполнить этот элемент курса.';
...
$string['legacyquizaccessrulescron'] = 'Устаревшие правила cron доступа к тесту';
$string['legacyquizreportscron'] = 'Устаревшие отчеты cron о тестах';
$string['link'] = 'Ссылка';
