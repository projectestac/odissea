...
/**
 * Strings for component 'organizer', language 'ru', version '4.1'.
 *
 * @package     organizer
 * @category    string
...
$string['infobox_appointmentsstatus_pl'] = '{$а->tooless} крайний срок бронирования. На ближайшие временные интервалы ({$a->slots}) есть доступные места: {$a->places}.';
$string['infobox_appointmentsstatus_sg'] = '{$а->tooless} крайний срок бронирования. На ближайшие временные интервалы ({$a->slots}) есть доступные места: {$a->places}.';
