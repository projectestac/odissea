...
$string['audiobuttontitle'] = 'Înregistrare audio';
$string['audiotimelimit'] = 'Limita de timp a fișierului audio';
$string['audiotimelimit_desc'] = 'Durata maximă a fișierelor audio înregistrate.';
$string['audiotitle'] = 'Înregistrare audio';
...
$string['recordagain_title'] = 'Confirmă că înregistrezi din nou';
...
$string['uploadfailed'] = 'Încărcarea a eșuat cu eroarea:{$a->error}';
$string['uploadfailed404'] = 'Încărcare eșuată: fișierul este prea mare';
$string['uploading'] = 'Se încarcă- {$a->progress}%';
