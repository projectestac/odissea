...
/**
 * Strings for component 'webservice', language 'ro', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['deleteserviceconfirm'] = 'Ștergând serviciul, veți șterge și jetoanele conexe acestui serviciu. Sunteți sigur că doriți să ștergeți serviciul extern "{$a}"?';
...
$string['managetokens'] = 'Administrare jetoane';
...
$string['onlyseecreatedtokens'] = 'Puteți vizualiza doar jetoanele pe care le-ați creat.';
...
$string['tokenfilter'] = 'Filtru jetoane';
$string['tokenfilterreset'] = 'Afișează toate jetoanele';
$string['tokenfiltersubmit'] = 'Alegeți doar jetoanele care se potrivesc';
...
$string['webservicesoverview'] = 'Privire de ansamblu';
$string['webservicetokens'] = 'Jetoane servicii web';
