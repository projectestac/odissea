...
/**
 * Strings for component 'atto_poodll', language 'ro', version '4.4'.
 *
 * @package     atto_poodll
 * @category    string
...
$string['allowaudiomp3'] = 'Permite înregistrarea audio';
...
$string['allowwidgets'] = 'Permite elemente';
$string['audiomp3_desc'] = 'Înregistrare audio';
$string['browse'] = 'Caută';
$string['browserepositories'] = 'Caută în depozite...';
$string['cancel'] = 'Anulează';
$string['chooseinsert'] = 'Ce vrei să inserezi?';
$string['createpoodll'] = 'Creează poodll';
$string['dialogtitle'] = 'Creează fișier media';
$string['drawtheninsert'] = 'După ce ai desenat, apasă "Salvează imagine" then "Inserează."';
$string['enterurl'] = 'Inserați un URL';
$string['fieldsheader'] = 'Inserează detaliile pentru :';
$string['insert'] = 'Inserează';
$string['nofieldsheader'] = 'Inserează :';
...
$string['poodll:allowaudiomp3'] = 'Permite înregistrarea audio';
...
$string['poodll:allowwidgets'] = 'Adaugă elemente';
$string['poodll:visible'] = 'Vizibil';
$string['privacy:metadata'] = 'Plugin-ul atto_poodll nu stochează date personale.';
$string['recorderstoshow'] = 'Înregistrări de afișat';
$string['recordtheninsert'] = 'După înregistrare apasă "Încărcare", apoi "Inserare".';
$string['settings'] = 'PoodLL Anywhere(Atto)';
$string['show_audiomp3'] = 'Afișează Audio recorder';
...
$string['show_widgets'] = 'Afișează elemente';
$string['snapshot_desc'] = 'Fă o poză';
$string['snaptheninsert'] = 'După ce ai făcut fotografia apasă "Încarcă", apoi "Inserează".';
$string['unpoodll'] = 'Unpoodll';
$string['usewhiteboard'] = 'Alegeți tipul de whiteboard';
$string['video_desc'] = 'Înregistrează video';
$string['visible'] = 'Vizibil';
$string['whiteboard_desc'] = 'Desenează o imagine';
$string['whiteboardheading'] = 'Whiteboard';
$string['widgets_desc'] = 'Inserează un element';
