...
/**
 * Strings for component 'imscc', language 'ro', version '4.5'.
 *
 * @package     imscc
 * @category    string
...
$string['cc_import_req_libxml'] = 'EROARE: pentru a realiza operaţiunea de import Common Cartridge este necesară extensia LIBXML.';
$string['cc_import_req_libxmlminversion'] = 'EROARE: pentru a realiza operaţiunea de import Common Cartridge este necesară versiunea 2.6.30 a LIBXML sau orice altă versiune mai recentă.';
$string['cc_import_req_php5'] = 'EROARE: Importul cartușului comun necesită PHP 5 sau mai mare.';
