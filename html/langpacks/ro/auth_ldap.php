...
$string['diag_emptycontext'] = 'S-a găsit un context gol.';
...
$string['nodnforusername'] = 'Eroare la user_update_password(). Nu există DN pentru : {$a->username}';
...
$string['nouserstobeadded'] = 'Nu există postări ale utilizatorului pentru a fi adăugate';
