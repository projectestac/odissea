...
$string['adminhelpstickyblocks'] = 'Configurați blocuri dificile la nivel de Moodle';
...
$string['authenticateduserdescription'] = 'Toți utilizatorii conectați.';
...
$string['clicktochangeinbrackets'] = '{$a} (Faceți click, pentru a modifica)';
$string['clicktohideshow'] = 'Faceți click, pentru a extinde sau a derula';
$string['closeblockdrawer'] = 'Închide sertarul de block-uri';
...
$string['courseduration_desc'] = 'Durata cursului este utilizată, pentru a calcula data implicită de încheiere a cursului. Data de încheiere a cursului este utilizată, pentru a determina dacă un curs ar trebui inclus în lista de cursuri a unui utilizator. Poate fi folosită și de rapoarte personalizate. Utilizatorii pot intra în continuare în curs după data de încheiere.';
$string['courseenddateenabled'] = 'Data de finalizare a cursului activat implicit';
...
* cuvânt - găsiți orice potrivire a acestui cuvânt în text
* + cuvânt - vor fi găsite numai cuvinte potrivite exacte
...
$string['editgroupprofile'] = 'Editează profilul grupului';
$string['editinga'] = 'Editare {$a}';
...
$string['edittitleinstructions'] = 'Apăsați Părăsire, pentru a anula și Introduce, când ați terminat';
...
$string['emailpasswordsent'] = 'Vă mulțumim că ați confirmat schimbarea parolei.
Un e-mail care conține noua dumneavoastră parolă a fost trimis pe adresa dumneavoastră pe<br /><b>{$a->email}</b>.<br />
O nouă parolă a fost generată în mod automat - este posibil să doriți să
<a href="{$a->link}">schimbați parola dumneavoastră</a> cu ceva mai ușor de memorat.';
...
$string['explanationdigitalminor'] = 'Aceste informații sunt necesare pentru a determina dacă vârsta dumneavoastră depășește vârsta la care vă puteți da consimțământul online. Aceasta este vârsta la care o persoană poate consimți la termeni și condiții, iar datele sale sunt stocate și prelucrate legal.';
...
$string['indicator:potentialcognitivedef_help'] = 'Gradul în care cursul oferă un angajament cognitiv „profund”, de ex. transmiterea lucrărilor pentru feedback, posibilitatea de a revizui munca de către alții și posibilitatea de a revizui și a retrimite lucrarea.';
...
$string['lastname'] = 'Nume de famile';
...
$string['lookback'] = 'Priviți înapoi';
...
$string['maximumupload'] = 'Dimensiunea maximă de încărcare';
...
$string['messageselectadd'] = 'Transmite un mesaj';
...
$string['noneditingteacherdescription'] = 'Profesorii care nu pot edita, au posibilitatea de a preda cursuri și de a nota cursanții, dar nu pot modifica activitățile.';
...
$string['opendrawerblocks'] = 'Deschide sertarul de block-uri';
...
$string['passwordconfirmchange'] = 'Confirmați modificarea parolei';
...
$string['passwordnohelp'] = 'Nu este disponibil niciun ajutor pentru a găsi parola pierdută. Vă rugăm să contactați administratorul Moodle.';
$string['passwordpolicynomatch'] = 'Parola dvs. actuală nu mai corespunde politicii de parolă setate.
    {$a}';
$string['passwordrecovery'] = 'Da, ajută-mă să mă conectez';
$string['passwordsdiffer'] = 'Aceste parole nu corespund';
$string['passwordsent'] = 'Parola a fost transmisă';
$string['passwordsenttext'] = '<p>Un e-mail a fost transmis pe adresa dumneavoastră la {$a->email}.</p>
   <p><b>Vă rugăm să verificați adresa de e-mail în care veți găsi mesajul cu noua parolă</b></p>
   <p>Noua parolă a fost generată automat; așa că, s-ar putea să doriți
   <a href="{$a->link}">să-l schimbați cu ceva mai ușor de reținut</a>.</p>';
...
$string['publicsitefileswarning'] = 'Notă: fișierele plasate aici pot fi accesate de oricine';
...
$string['scalestip2'] = 'Pentru a crea scale personalizate de notare, faceți click pe link-ul Note din meniul de administrare a cursului, apoi alegeți Editare, Scală de notare.';
...
$string['shortnamecourse'] = 'Denumirea prescurtată a cursului';
...
$string['showallusers'] = 'Afișează toți utilizatorii';
...
$string['showgrades'] = 'Arată carnetul de note cursanților';
$string['showgrades_help'] = 'Permite cursanților să vadă o listă cu notele lor în pagina de curs.';
$string['showingacourses'] = 'Afișarea tuturor {$a} cursurilor';
...
$string['topichide'] = 'Ascunde acest subiect {$a}';
...
$string['updatesevery'] = 'Actualizează la fiecare {$a} secunde';
$string['updatethis'] = 'Actualizează {$a}';
$string['updatethiscourse'] = 'Actualizează acest curs';
$string['updatinga'] = 'Se actualizează: {$a}';
$string['updatingain'] = 'Se actualizează {$a->what} în {$a->in}';
...
$string['visible_help'] = 'Această setare determină dacă respectivul curs apare în lista cursurilor. În afară de profesori și administratori, utilizatorii nu au voie să intre în curs.';
...
$string['weekhide'] = 'Ascundeți săptămâna aceasta din {$a}';
$string['weeklyoutline'] = 'Schiță săptămânală';
$string['weeks'] = 'săptămâni';
$string['weekshow'] = 'Arată săptămâna aceasta pentru {$a}';
