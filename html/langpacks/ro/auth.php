...
$string['auth_changingemailaddress'] = 'Aţi solicitat schimbarea adresei de email, din {$a->oldemail} în {$a->newemail}. Din motive de securitate, vă trimitem un email la noua adresă pentru a ne asigura că sunteţi titularul acesteia. Noua adresă de email va fi actualizată imediat după ce veţi deschide URL-ul pe care vi-l trimitem în email. Link-ul de confirmare va expira în <b>10 minutes</b>';
...
$string['auth_updatelocal_expl'] = '<p> <b> Actualizare locală: </b> Dacă este activat, câmpul va fi actualizat (de la autentificare externă) de fiecare dată când utilizatorul se conectează sau apare o sincronizare a utilizatorului. Câmpurile setate pentru actualizare locală trebuie blocate. </p>';
...
$string['informminpassworddigits'] = 'cel puţin {$a} cifră(e)';
...
$string['limitconcurrentlogins'] = 'Limită autentificări simultane';
...
$string['unlockedifempty'] = 'Deblocat dacă este necompletat';
