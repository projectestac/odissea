...
$string['accountlocked'] = 'Contul tău este blocat. Ai primit un email cu link-ul pentru deblocare.';
$string['accounts'] = 'Conturi';
$string['accountunlocked'] = 'Contul tău este deblocat. Poți să te autentifici.';
...
$string['asyncbackupdisabled'] = 'Site-ul este în prezent configurat să folosească copii de siguranță sincrone. Copiile de siguranță asincrone oferă o experiență mai bună de utilizare, permițându-i utilizatorului să efectueze alte activități în timpul desfășurării unui back-up sau a unei restaurări.
Copiile de siguranță asincrone sunt activate în toate site-urile începând cu Moodle 4.5 LTS.
Copiile de siguranță sincrone vor fi eliminate din Moodle LMS, versiunea de după 4.5 LTS.';
...
$string['calendarexportsalt'] = 'Cheia de securizare pentru exportul calendarului.';
...
$string['configallowobjectembed'] = 'Ca măsură de securitate, utilizatorii cu rol de cursant nu au permisiunea de a insera  multimedia în texte folosind etichete EMBED și OBJECT în HTML, deşi multimedia poate fi totuși afișată folosind filtrul mediaplugins. Dacă doriţi să permiteţi folosirea acestor etichete, activaţi această opţiune.';
...
$string['configcalendarexportsalt'] = 'Acest text generat în mod aleatoriu este folosit la îmbunătăţirea securităţii jetoanelor de autentificare utilizate la exportul calendarelor. Atenţie: toate jetoanele actuale vor deveni invalide dacă modficaţi această cheie de securitate.';
...
$string['configgradeexportdefault'] = 'Alegeți care format de export al catalogului este metoda dumneavoastră implicită de export al notelor.';
...
$string['configproxybypass'] = 'Lista de nume de gazdă (parțiale) sau adrese IP care ar trebui să ocolească proxy-ul. Separați fiecare element prin virgule, fără spații. De exemplu: 192.168.0.0/16,*.mydomain.com.';
...
$string['confirmationpending'] = 'Confirmare în așteptare';
...
$string['courserequestnotifyemail'] = 'Utilizatorul {$a->user} a solicitat un nou curs la <a href="{$a->link}">{$a->link}</a>.';
...
$string['deleteduserx'] = 'Utilizator șters {$a}';
...
$string['enablecommunicationsubsystem'] = 'Activare furnizori de comunicare';
$string['enablecommunicationsubsystem_desc'] = 'Permite integrarea cu furnizorii de sisteme de comunicare, cum ar fi Matrix, pentru ca profesorii și cursanții să poată comunica mai ușor. Poți administra aceste integrări în <a href="settings.php?section=managecommunicationproviders">Plugin-uri</a>.';
...
$string['gradeexportdefault'] = 'Metoda implicită de export a notelor';
...
$string['group_customfield'] = 'Câmpuri personalizate ale grupului';
...
$string['grouping_customfield'] = 'Câmpuri personalizate ale grupării';
...
$string['hookcallbacknotcallable'] = 'Acest callback nu este callable. Asta se întâmplă deoarece clasa sau metoda nu există sau pentru că metoda nu este publică.';
$string['hookcallbacks'] = 'Callbacks';
$string['hookcallbacks_help'] = 'Lista de apeluri care vor fi apelate atunci când un hook este expediat.

Ordinea afișată este ordinea în care sunt apelate apelurile.

Un apel cu o prioritate mai mare va fi apelat înainte de unul cu prioritate mai mică.';
$string['hookclassmissing'] = 'Nu a fost găsită clasa hook';
$string['hookclassmissing_desc'] = 'The hook discovery agent has returned a class that does not exist.';
$string['hookconfigoverride'] = 'Suprascris';
...
$string['hookdescription'] = 'Descriere';
$string['hookdescriptionmissing'] = 'Hook nu are o metodă de descriere';
$string['hookname'] = 'Hook';
$string['hooksoverview'] = 'Hooks overview';
$string['hookunknown'] = 'Hook nu a fost găsit';
...
$string['maxcharacter'] = 'maxim {$a} caractere';
...
$string['noemaileverwarning'] = '<strong>Notă:</strong> Toate email-urile care trebuie să fie trimise au fost dezactivate';
...
$string['perfdebugdeferred'] = 'Așteaptă până se încheie rularea scriptului pentru a afișa rezultatul depanării ...';
...
$string['pluginsoverview'] = 'Privire de ansamblu asupra plugin-urilor';
...
$string['searchindexwhendisabled_desc'] = 'Permite cronului să creeze indexul de căutare chiar și atunci când căutarea este dezactivată. Acest lucru este util dacă doriți să construiți indexul înainte ca facilitatea de căutare să apară cursanților.';
...
$string['sessioncookie'] = 'Sufix cookie';
...
$string['sitesectionhelp'] = 'Afișați o secțiune în partea de sus a paginii în care puteți adăuga conținut personalizat.';
...
$string['smallscreensonly'] = 'Doar ecrane mici';
$string['smtp'] = 'SMTP';
...
$string['task_adhoc_failed_retention'] = 'Perioada de păstrare a sarcinilor ad-hoc finalizate fără succes';
$string['task_adhoc_failed_retention_desc'] = 'Perioada maximă în care sarcinile ad-hoc finalizate fără succes ar trebui să rămână în coadă odată ce au atins limita de reîncercare.';
...
$string['themedefinedinconfigphp'] = 'Tema nu poate fi schimbată deoarece este setată la {$a} în config.php.';
...
$string['themeeditsettingsname'] = 'Editare setări temă \'{$a}\'';
...
$string['themeselector'] = 'Teme';
$string['themesettings'] = 'Setări temă';
$string['themesettingsadvanced'] = 'Setări avansate ale temei';
$string['themesettingscustom'] = 'Setări temă particularizată';
$string['themesettingsname'] = 'Setări temă \'{$a}\'';
$string['themeusagereportname'] = 'Raport utilizare temă \'{$a}\'';
...
$string['userfeedbackencouragement'] = '<p>Moodle include o funcționalitate prin care li se oferă utilizatorilor posibilitatea de a oferi feedback despre software-ul Moodle printr-un site de sondaj extern găzduit de Moodle HQ. Nicio informație de identificare a utilizatorului nu este redirecționată către site-ul sondajului. </p>
...
<p> Feedback-ul utilizatorilor va ajuta Moodle HQ la îmbunătățirea software-ului Moodle. Pentru a activa această funcție, vă rugăm să accesați <a href="{$a}">Setări de feedback</a>. </p>';
...
$string['userfiltersdefault_desc'] = 'Alegeți filtrele pe care doriți să le afișați pe pagina „Acțiuni în bloc pentru utilizatori”. Pentru a selecta mai multe filtre, țineți apăsată tasta Ctrl. Filtrele neselectate vor fi în continuare accesibile în link-ul „Afișați mai multe”.';
