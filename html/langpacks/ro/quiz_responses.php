...
/**
 * Strings for component 'quiz_responses', language 'ro', version '4.5'.
 *
...
$string['privacy:preference:resp'] = 'Dacă se afișează coloanele de răspuns ale cursanților.';
$string['privacy:preference:right'] = 'Dacă se afișează coloanele cu răspunsul corect';
...
$string['showattempts'] = 'Afișează doar / încercări de download';
$string['showthe'] = 'Afișează';
$string['summaryofquestiontext'] = 'Rezumatul întrebării';
$string['summaryofresponse'] = 'Rezumatul răspunsului dat';
