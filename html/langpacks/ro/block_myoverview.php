...
$string['addtofavourites'] = 'Evidențiați acest curs';
$string['all'] = 'Toate';
$string['allincludinghidden'] = 'Toate (inclusiv cele ascunse)';
$string['aria:addtofavourites'] = 'Adaugă la favorite';
$string['aria:allcourses'] = 'Afișați toate cursurile, cu excepția cursurilor ascunse din listă';
...
$string['aria:courseactions'] = 'Acțiuni pentru curs';
...
$string['displaycategories_help'] = 'Afișează categoria cursului pe elementele cursului din tabloul de bord, de tip card, de tip listă sau de tip sumar curs.';
$string['favourites'] = 'Favorit';
$string['future'] = 'Viitoare';
$string['hidden'] = 'Cursuri ascunse din listă';
$string['hiddencourses'] = 'Ascunse din listă';
$string['hidecourse'] = 'Ascunde cursul din listă';
...
$string['list'] = 'Listă';
$string['myoverview:myaddinstance'] = 'Adaugă un nou block Cursurile mele în Panoul de bord';
...
$string['show'] = 'Resetează pentru a fi vizualizate';
$string['sortbylastaccessed'] = 'Sortează după ultima accesare';
$string['sortbyshortname'] = 'Sortează după denumirea prescurtată';
