...
/**
 * Strings for component 'logstore_standard', language 'ro', version '4.5'.
 *
...
$string['buffersize'] = 'Scrieți dimensiunea bufferului';
$string['jsonformat'] = 'Format JSON';
$string['jsonformat_desc'] = 'Utilizați formatul JSON standard în locul datelor serializate PHP în câmpul „alte” baze de date.';
$string['pluginname'] = 'Autentificare standard';
$string['pluginname_desc'] = 'Un plugin pentru jurnal stochează intrările de jurnal într-un tabel de baze de date Moodle.';
...
$string['privacy:metadata:log:timecreated'] = 'Data când a avut loc evenimentul';
$string['privacy:metadata:log:userid'] = 'ID-ul utilizatorului care a declanșat acest eveniment';
$string['taskcleanup'] = 'Curățare tabel jurnal';
