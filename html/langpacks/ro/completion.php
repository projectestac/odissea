...
/**
 * Strings for component 'completion', language 'ro', version '4.1'.
 *
 * @package     completion
 * @category    string
...
$string['completion_automatic'] = 'Afișează activitatea ca fiind finalizată atunci când sunt îndeplinite condițiile';
...
$string['completion_manual'] = 'Cursanții pot să seteze în mod manual activitatea lor ca fiind finalizată';
$string['completion_none'] = 'Nu se indică finalizarea activității';
...
$string['completionexpected'] = 'Finalizare estimată la';
$string['completionexpected_help'] = 'Această setare specifică data la care se așteaptă finalizarea activității. Când data upcoming, activitatea este listată în blocul Cronologie din Dashboard.';
...
$string['completionpassgrade_desc'] = 'Cursanții trebuie să obțină o notă de trecere pentru a finaliza această activitate.';
...
$string['completionusegrade_desc'] = 'Cursanții trebuie să primească o notă pentru a finaliza această activitate.';
...
$string['completionview_desc'] = 'Cursanții trebuie să vizualizeze activitatea pentru a o finaliza';
