...
/**
 * Strings for component 'block_course_list', language 'ro', version '4.1'.
 *
...
$string['course_list:addinstance'] = 'Adăugați un nou block cursuri';
$string['course_list:myaddinstance'] = 'Adăugați un nou block cursuri în Tabloul de bord';
$string['hideallcourseslink'] = 'Ascundeți linkul „Toate cursurile”';
$string['owncourses'] = 'Utilizatorul Administrator vede propriile cursuri';
$string['pluginname'] = 'Cursuri';
$string['privacy:metadata'] = 'Blocul Cursuri afișează doar date despre cursuri și nu stochează date în sine.';
