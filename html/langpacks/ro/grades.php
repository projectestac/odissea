...
$string['aggregatesonly'] = 'Afișează doar nota finală a cursului';
...
$string['aria-toggledropdown'] = 'Comutați următorul meniu derulant';
$string['aria:dropdowngrades'] = 'Elemente de notare găsite';
...
$string['calculationwarning'] = 'Această categorie utilizează un calcul de notă pentru totalul categoriei, mai degrabă decât o agregare de note.';
...
$string['errorcalculationbroken'] = 'Eroare la calcularea elementului notă {$a}.';
...
$string['erroroverweight'] = 'Ponderea totală depășește 100%.';
...
$string['errorunderweight'] = 'Ponderea totală este mai mică de 100%.';
...
$string['feedbackprovided'] = 'Feedback furnizat';
...
$string['filterfirstactive'] = 'Prima ({$a->first})';
$string['filterlastactive'] = 'Ultima ({$a->last})';
...
$string['full'] = 'Complet';
$string['fullmode'] = 'Afișează notele și mediile';
...
$string['gradesonly'] = 'Afișează doar note';
...
$string['linktoactivity'] = '{$a->name} activitate {$a->title}';
$string['lock'] = 'Blocare';
...
$string['missingitemtypeoreid'] = 'Cheia matricei (itemtype sau eid) lipsește';
...
$string['moveselectedto'] = 'Mută elemente selectate în:';
$string['movesitems'] = 'Mutare elemente';
...
$string['nonunhideableverbose'] = 'Pentru a afișa din nou această notă, trebuie să afișați din nou {$a->itemname}.';
...
$string['searchcollapsedcolumns'] = 'Caută coloane restrânse';
...
$string['showingaggregatesonly'] = 'Se afișează doar notele finale';
$string['showingfullmode'] = 'Se afișează notele și totalurile';
...
$string['viewfeedback'] = 'Vizualizare feedback';
