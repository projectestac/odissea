...
$string['allusersnum'] = 'Toți utilizatorii ({$a})';
$string['eventgradereportviewed'] = 'Raportul notelor utilizatorului a fost vizualizat';
$string['gotonextreport'] = 'Mergi la raportul următorului utilizator';
$string['gotopreviousreport'] = 'Mergi la raportul utilizatorului precedent';
$string['pluginname'] = 'Raportul utilizatorului';
