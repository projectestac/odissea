...
$string['assign:editothersubmission'] = 'Editează lucrarea altui cursant';
...
$string['assign:reviewgrades'] = 'Revezi notele';
...
$string['blindmarking_help'] = 'Trimitere răspuns anonim ascunde identitatea cursanților de persoanele care îi noteazp. Setările pentru Trimitere răspuns anonim vor fi blocate odată ce a fost trimise răspunsuri sau a fost dată o notă unui cursant în această sarcină.';
$string['blindmarkingenabledwarning'] = 'Trimitere răspuns anonim este activată pentru această activitate.';
...
$string['confirmbatchgradingoperation'] = 'Sunteți sigur(ă) că doriți să {$a->operation} pentru {$a->count}  studenți?';
...
$string['errornosubmissions'] = 'Nu există lucrări de downloadat';
$string['errorquickgradingvsadvancedgrading'] = 'Notele nu au fost salvate deoarece această sarcină utilizează în prezent notarea avansată';
$string['errorrecordmodified'] = 'Notele nu au fost salvate deoarece cineva a modificat una sau mai multe înregistrări mai recent decât atunci când ați încărcat dvs. pagina.';
...
$string['fixrescalednullgrades'] = 'Această sarcină conține câteva note eronate. Puteți <a href="{$a->link} "> remedia automat aceste note </a>. Acest lucru poate afecta nota totală a cursului.';
...
$string['gradingduedate'] = 'Amintește-mi să notez după data de';
$string['gradingduedate_help'] = 'Data preconizată până la  care notarea sarcinilor trimise ar trebui finalizată. Această dată este utilizată pentru a da prioritate notificărilor în tabloul de bord al profesorilor.';
...
$string['grantextensionforusers'] = 'Extindeți perioada de trimitere pentru {$a} studenți';
...
$string['hidegrader_help'] = 'Dacă este activată, identitatea oricărui utilizator care notează o sarcină nu este afișată, astfel încât cursanții nu pot vedea cine le-a notat sarcina.
...
$string['modulename_help'] = 'Modulul activitate de tip sarcină permite profesorului să comunice sarcini, să colecteze răspunsuri și să ofere note și feedback.

Cursanții pot trimite orice conținut digital (fișiere), cum ar fi documente procesate de text, foi de calcul, imagini sau clipuri audio și video. Alternativ sau, în plus, sarcina poate cere cursanților să introducă text direct în editorul de text. O sarcină poate fi, de asemenea, utilizată pentru a reaminti studenților sarcinile „din lumea reală” pentru a le finaliza offline, cum ar fi lucrările de artă și, prin urmare, să nu necesite conținut digital. Cursanții pot trimite lucrări individual sau ca membru al unui grup.

Atunci când examinează sarcinile, profesorii pot lăsa comentarii de feedback și pot încărca fișiere, cum ar fi răspunsurile cursanților marcate, documente cu comentarii sau feedback audio (vorbit). Sarcinile pot fi notate folosind o scală numerică sau personalizată sau o metodă avansată de notare, cum ar fi un barem. Notele finale sunt înregistrate în carnetul de note pentru fiecare cursant.';
...
$string['nogroupoverrides'] = 'În prezent nu există suprascrieri ale grupului.';
...
$string['nouseroverrides'] = 'În prezent nu există suprascrieri ale niciunui utilizator.';
...
$string['privacy:metadata:assigngrades'] = 'Stochează notele utilizatorilor pentru sarcina de lucru';
...
$string['quickgrading_help'] = 'Notarea rapidă vă permite să atribuiți note (și rezultate) direct în tabelul de răspunsuri. Notarea rapidă nu este compatibilă cu notarea avansată și nu este recomandată atunci când există mai mulți utilizatori care notează răspunsuri.';
...
$string['requiresubmissionstatement_help'] = 'Solicită cursanților să declare că răspunsul trimis este o lucrare proprie, aceasta se aplică tuturor răspunsurile trimise la această sarcină de lucru.';
...
$string['sendlatenotifications'] = 'Notificați profesorii cu privire la răspunsurile întârziate';
...
$string['sendnotifications'] = 'Notificați profesorii cu privire la răspunsuri';
...
$string['sendstudentnotifications'] = 'Notifică cursant';
...
$string['sendstudentnotificationsdefault'] = 'Setări implicite pentru "Notifică cursant"';
$string['sendstudentnotificationsdefault_help'] = 'Când se evaluează fiecare cursant, ar trebui să fie bifat în mod implicit „Notifică cursantul”?';
...
$string['submissiondrafts_help'] = 'Dacă este activat (opțiunea Da), cursanții vor trebui să facă clic pe un buton de trimitere răspuns pentru a se considera răspunsul ca fiind final. Acest lucru permite studenților să păstreze în sistem o versiune provizorie a răspunsului (draft).
...
$string['submissionnoteditable'] = 'Cursanții nu pot să editeze această lucrare';
...
$string['submissionstatementdefault'] = 'Această depunere a răspunsului este propria mea lucrare, cu excepția cazului în care am recunoscut utilizarea lucrărilor altor persoane.';
...
$string['submissionstatementteamsubmissionallsubmitdefault'] = 'Prezentarea este propria mea lucrare ca membru al grupului, cu excepția cazului în care am recunoscut utilizarea lucrărilor altor persoane.';
...
$string['submissionstatus_'] = 'Nu există răspunsuri';
$string['submissionstatus_draft'] = 'Draft (netrimis)';
$string['submissionstatus_marked'] = 'Notat';
$string['submissionstatus_new'] = 'nu există răspunsuri';
...
$string['unsavedchangesquestion'] = 'Există modificări nesalvate la note sau feedback. Doriți să salvați modificările și să continuați?';
