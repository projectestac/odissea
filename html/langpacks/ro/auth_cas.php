...
/**
 * Strings for component 'auth_cas', language 'ro', version '4.1'.
 *
 * @package     auth_cas
 * @category    string
...
$string['auth_cas_create_user'] = 'Activați dacă doriți să inserați utilizatorii autentificați-CAS în baza de date Moodle. Dcaă nu, atunci doar utilizatorii care există în baza de date Moodle se pot loga.';
