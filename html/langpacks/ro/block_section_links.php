...
$string['numsections2'] = 'Număr alternativ de secţiuni';
$string['numsections2_help'] = 'După ce numărul de secțiuni din curs atinge această valoare, se folosește Creșterea alternativă prin valoare.';
$string['pluginname'] = 'Legături secţiune';
$string['privacy:metadata'] = 'Blocul Legături secțiune afișează doar datele stocate în alte locații.';
$string['section_links:addinstance'] = 'Adaugă un nou block link-uri secțiune';
