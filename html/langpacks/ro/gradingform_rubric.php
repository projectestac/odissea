...
/**
 * Strings for component 'gradingform_rubric', language 'ro', version '4.1'.
 *
...
$string['alwaysshowdefinition'] = 'Permiteți utilizatorilor să previzualizeze rubrica (altfel va fi afișată numai după notare)';
...
$string['err_nocriteria'] = 'Rubrica trebuie să conțină cel puțin un criteriu';
...
$string['privacy:metadata:remark'] = 'Observații legate de criteriul rubricii evaluate.';
...
$string['rubricstatus'] = 'Status-ul rubricii curente';
$string['save'] = 'Salvează';
$string['saverubric'] = 'Salvați rubrica și pregătiți-o';
...
$string['showdescriptionstudent'] = 'Afișați descrierea rubricii celor care sunt notați';
$string['showdescriptionteacher'] = 'Afișați descrierea rubricii în timpul evaluării';
