...
$string['gdpr_art_6_1_a_description'] = 'Persoana vizată și-a dat consimțământul pentru prelucrarea datelor sale personale pentru unul sau mai multe scopuri specifice';
...
$string['gdpr_art_6_1_e_name'] = 'Sarcină publică (GDPR Art. 6.1 (e))';
...
$string['gdpr_art_9_2_c_description'] = 'Prelucrarea este necesară pentru a proteja interesele vitale ale persoanei vizate sau ale altei persoane fizice în cazul în care persoana vizată este incapabilă fizic sau juridic de a da consimțământul';
$string['gdpr_art_9_2_c_name'] = 'Protecția intereselor vitale (GDPR Art. 9.2 (c))';
$string['gdpr_art_9_2_d_description'] = 'Prelucrarea se desfășoară în cursul activităților sale legitime cu garanții adecvate de către o fundație, o asociație sau orice alt organism fără scop lucrativ cu scop politic, filozofic, religios sau sindical și cu condiția ca prelucrarea să se refere numai la membrii sau foștilor membri ai organismului sau persoanelor care au contact regulat cu acesta în legătură cu scopurile sale și că datele personale nu sunt divulgate în afara acelui organism fără consimțământul persoanelor vizate';
