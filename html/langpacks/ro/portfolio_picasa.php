...
/**
 * Strings for component 'portfolio_picasa', language 'ro', version '4.4'.
 *
...
$string['nooauthcredentials_help'] = 'Pentru a utiliza pluginul de portofoliu Picasa trebuie să configurați acreditările OAuth în setările portofoliului.';
...
$string['privacy:metadata'] = 'Acest plugin trimite date extern către un cont Picasa conectat. Nu stochează date local.';
$string['privacy:metadata:data'] = 'Datele personale trecute din subsistemul portofoliu.';
$string['secret'] = 'Secret';
$string['sendfailed'] = 'Fișierul {$a} nu putut fi transferat către Picasa';
