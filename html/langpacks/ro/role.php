...
$string['cohort:configurecustomfields'] = 'Configurați câmpuri personalizate pentru cohortă';
...
$string['confirmaddadmins'] = 'Sigur vrei să adaugi următorii utilizatori pe lista administratorilor site-ului?';
...
$string['confirmremoveadmins'] = 'Sigur vrei să ștergi următorii utilizatori din lista administratorilor site-ului?';
...
$string['course:configurecoursecommunication'] = 'Configurați setările de comunicare în curs';
...
$string['eventrolecreated'] = 'Rol creat';
...
$string['grade:manage'] = 'Administrare elemente de notare';
...
$string['group:configurecustomfields'] = 'Configurați câmpuri personalizate de grup/grupare';
...
$string['moodlenet:shareactivity'] = 'Partajează activități către MoodleNet';
$string['moodlenet:sharecourse'] = 'Partajează cursul în MoodleNet';
...
$string['reportbuilder:viewall'] = 'Vezi toate rapoartele personalizate';
...
$string['roleassignment'] = 'Atribuire rol';
...
$string['roleoriginalname'] = 'Denumire inițială';
...
$string['siteadministratorsconfigphp'] = 'Lista administratorilor site-ului nu poate fi modificată pentru că este definită în config.php.';
...
$string['webservice:managealltokens'] = 'Gestionați jetoanele de servicii web ale tuturor utilizatorilor';
