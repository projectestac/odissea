...
/**
 * Strings for component 'quiz_statistics', language 'ro', version '4.1'.
 *
...
$string['analysisofresponsesfor'] = 'Analiza răspunsurilor pentru {$a}';
...
$string['getstatslockprogress'] = 'Se așteaptă sarcina în curs. Vă rugăm să așteptați sau să încercați din nou mai târziu.';
...
$string['highestattempts'] = 'încercare nu nota cea mai mare';
...
$string['lastattempts'] = 'ultima încercare';
...
$string['nogradedattempts'] = 'Nu au fost făcute încercări la acest test sau toate încercările au întrebări care necesită notare manuală.';
...
$string['nostudentsingroup'] = 'Nu există studenți în acest grup încă';
...
$string['quizname'] = 'Numele chestionarului';
...
$string['slotstructureanalysis'] = 'Analiza structurală pentru întrebare a cu numărul {$a}';
$string['standarddeviation'] = 'Deviație standard (pentru {$a})';
$string['standarddeviationq'] = 'Deviație standard';
$string['standarderror'] = 'Eroare standard (pentru {$a})';
...
$string['statsfor'] = 'Statisticile testului (pentru {$a})';
