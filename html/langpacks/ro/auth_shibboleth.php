...
/**
 * Strings for component 'auth_shibboleth', language 'ro', version '4.1'.
 *
...
$string['shib_not_set_up_error'] = 'Autentificarea Shibboleth nu pare să fie configurată corect, deoarece nu există variabile de mediu Shibboleth pentru această pagină. Vă rugăm să consultați <a href="{$a}"> README </a> pentru instrucțiuni suplimentare despre cum să configurați autentificarea Shibboleth sau contactați administratorul web al acestei instalări Moodle.';
