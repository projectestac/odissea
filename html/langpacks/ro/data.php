...
$string['authorfirstname'] = 'Prenume';
$string['authorlastname'] = 'Nume';
...
$string['cannotapplypreset'] = 'Eroare la aplicarea presetării.';
$string['cannotdeletepreset'] = 'Eroare la ștergerea presetării';
...
$string['checkbox'] = 'Casetă de selecție';
...
$string['choosepreset'] = 'Fișier de presetări';
...
$string['createactivity'] = 'Creați-vă propriile câmpuri pentru a colecta date sau utilizați o presetare care include deja câmpuri.';
$string['createfields'] = 'Creați câmpuri pentru a colecta diferite tipuri de date.';
...
$string['data:manageuserpresets'] = 'Administrare presetări';
...
$string['date'] = 'Data';
$string['dateentered'] = 'Data inserării';
$string['datemodified'] = 'Ultima modificare';
...
$string['editfield'] = 'Editează câmp';
$string['editordisable'] = 'Dezactivează editor';
$string['editorenable'] = 'Activează editorul de cod';
$string['editpreset'] = 'Editează presetarea';
...
$string['emptypresetname'] = 'Numele sau fișierul cu presetări nu pot fi goale';
...
$string['entrieslefttoadd'] = 'Trebuie să adăugați încă {$a->entriesleft} intrări / înregistrări pentru a finaliza această activitate.';
...
$string['errorpresetexistsbutnotoverwrite'] = 'Există deja o presetare cu această denumire. Alegeți o denumire diferită.';
$string['errorpresetnotfound'] = 'Presetarea cu numele {$a} nu a fost găsit.';
...
$string['exportownentries'] = 'Exportați doar propriile articole? ({$a->mine}/{$a->all})';
$string['exportpreset'] = 'Exportă parametrul';
$string['failedpresetdelete'] = 'A intervenit o eroare la ştergerea unei presetări.';
$string['fieldadded'] = 'Câmp adăugat';
$string['fieldallowautolink'] = 'Permite autolink';
$string['fielddeleted'] = 'Câmp şters';
$string['fielddelimiter'] = 'Separator câmp';
...
$string['fieldmappings'] = 'Mapări câmpuri';
...
$string['foundnorecords'] = 'Nu s-au găsit înregistrări <a href="{$a->reseturl}">Resetați tot</a>';
$string['foundrecords'] = 'S-au găsit {$a->num} din {$a->max} înregistrări. <a href="{$a->reseturl}">Resetați tot</a>';
...
$string['headercsstemplate'] = 'Adăugați CSS personalizat pentru șabloane.';
$string['headerjstemplate'] = 'Adăugați JavaScript personalizat pentru Listă, Afișare element unic sau Șablon de adăugare articole.';
$string['headerlisttemplate'] = 'Defineşte aspectul pentru afișarea de tip Listă.';
$string['headerrsstemplate'] = 'Defineşte modul de prezentare al articolelor în fluxurile RSS';
$string['headersingletemplate'] = 'Defineşte aspectul pentru afișarea unui singur articol.';
$string['id'] = 'Identificatorul articolului';
$string['importandapply'] = 'Importă presetarea și aplică';
$string['importapreset'] = 'Importă o presetare';
$string['importentries'] = 'Importă postările';
$string['importpreset'] = 'Import presetare';
$string['importpreset_desc'] = 'Presetarea va fi aplicată acestei activități, creând câmpuri și șabloane.
Nu va apărea în lista de presetări.';
...
$string['jstemplate'] = 'JavaScript personalizat';
...
$string['listtemplate'] = 'Șablon de vizualizare listă';
$string['listview'] = 'Vizualizare sub formă de listă';
$string['longitude'] = 'Longitudine';
$string['manageapproved'] = 'Permiteți editarea articolelor aprobate';
$string['manageapproved_help'] = 'Permiteți studenților să-și editeze sau să-și șteargă intrările după ce au fost aprobate. Intrările editate vor trebui reaprobate.';
$string['managefields'] = 'Administrează câmpuri';
$string['mapexistingfield'] = 'Mapat la {$a}';
$string['mapnewfield'] = 'Creează un nou câmp';
$string['mapping:applypresets'] = 'Aplică presetarea';
$string['mapping:dialogtitle:usepreset'] = 'Aplici presetarea {$a}?';
$string['mapping:fieldstocreate'] = 'Câmpuri ce vor fi create: {$a}';
$string['mapping:fieldstodelete'] = 'Câmpuri existente ce vor fi șterse: {$a}';
$string['mapping:mapfields'] = 'Mapare câmpuri';
$string['mapping:warningmessagedelete'] = 'Dacă câmpurile care urmează să fie șterse sunt de același tip ca și câmpurile noi din presetarea pe care o aplicați, este posibil să le puteți mapa.';
$string['mapping:warningmessagedeleteandcreate'] = 'Dacă câmpurile care urmează să fie șterse sunt de același tip ca și câmpurile care urmează să fie create, este posibil să le puteți mapa.';
...
$string['maxentries'] = 'Numărul maxim de articole';
$string['maxentries_help'] = 'Numărul maxim de articole care sunt permise unui student pentru  acestă activitate.';
$string['maxsize'] = 'Dimensiune maximă';
$string['menu'] = 'Meniu';
$string['menuchoose'] = 'Alegeţi...';
$string['missingdata'] = 'ID-ul sau obiectul datelor trebuie furnizate pentru clasa de câmp.';
$string['missingfield'] = 'Eroare programator: trebuie să specificați câmpul și / sau datele atunci când definiți clasa câmpului.';
$string['missingfieldtype'] = 'Tipul de câmp pentru {$a->name} nu a fost găsit';
$string['missingfieldtypeimport'] = 'Următoarele câmpuri nu au fost importate deoarece tipurile de câmpuri corespunzătoare lor nu sunt instalate:';
$string['missingfieldtypes'] = 'Următoarele câmpuri nu au tipurile de câmp corespunzătoare instalate și nu vor fi incluse în formularul Adăugare articol. Trebuie să verificați pagina șablon Adăugare alticol și să eliminați orice nume de câmp.';
$string['modulename'] = 'Bază de date';
$string['modulename_help'] = 'Baza de date permite participanților să creeze, să întrețină și să caute o colecție de articole.

Structura articolelor este definită folosind diferite tipuri de câmpuri, cum ar fi text scurt, listă derulantă, zonă de text, URL, imagine sau fișier.

Având rol de profesor, puteți comenta și evalua articolele. De asemenea, puteți permite cursanților să evalueze și să comenteze articolele (evaluarea articolelor colegilor). Evaluările pot fi agregate pentru a forma o notă finală, care este înregistrată în carnetul de note.

Dacă filtrul creare link automat a bazei de date este activat, orice articol dintr-o bază de date va fi conectat automat la cuvinte sau expresii din cadrul cursului.

Puteți utiliza baza de date pentru a:

* Crea o colecție colaborativă de link-uri, cărți, recenzii de cărți, referințe de reviste etc.
* Afișați fotografii, postere, site-uri web sau poezii create de cursanți pentru comentarii și recenzii de la colegi.';
...
$string['newfield'] = 'Creează un câmp';
...
$string['nofields'] = 'Încă nu sunt câmpuri';
$string['nolisttemplate'] = 'Şablonul de listă nu este încă definit';
...
$string['presetdeleted'] = 'Presetare ștearsă.';
...
$string['presetnotselected'] = 'Nu a fost selectat niciun parametru.';
...
$string['privacy:metadata:data_content:fieldid'] = 'Identificatorul definiției câmpului';
$string['privacy:metadata:data_records'] = 'Înregistrări în activitatea  Bază de date';
$string['privacy:metadata:data_records:approved'] = 'Starea aprobării';
$string['privacy:metadata:data_records:groupid'] = 'Grup';
$string['privacy:metadata:data_records:timecreated'] = 'Data când a fost creată înregistrarea';
$string['privacy:metadata:data_records:timemodified'] = 'Data când ultima înregistrare a fost modificată';
...
$string['requiredentries_help'] = 'Dacă este setat, se afișează un mesaj care indică numărul de articole necesare pentru finalizare. Rețineți că această setare nu este conectată la finalizarea activității.

Pentru intrările necesare pentru finalizarea activității, ar trebui utilizată noua setare de finalizare a activității „Necesită articole”. Pentru a elimina complet această setare, setați-o la niciuna, apoi salvați modificările.
Vă rugăm să folosiți câmpurile obligatorii pentru articole în secțiunea Finalizare activitate.';
$string['requiredentriestoview'] = 'Articole obligatorii înainte de vizualizare';
$string['requiredentriestoview_help'] = 'Numărul de postări pe care un cursant trebuie să îl aibă  pentru a putea vizualiza articolele celorlalți cursanți.

Nu este compatibil cu filtrul din database auto-linking.';
...
$string['resetalltemplates'] = 'Resetați toate șabloanele';
...
$string['saveaspreset'] = 'Publicați presetarea pe acest site';
...
$string['saveaspresetmissingcapability'] = 'Utilizatorul nu are permisiunile de a salva baza de date sub formă de presetare.';
...
$string['searchresults'] = 'Articole conținând "{$a}"';
...
$string['singletemplate'] = 'Șablon de vizualizare un singur articol';
$string['singleview'] = 'Un singur articol';
$string['startbuilding'] = 'Începeți să vă construiți activitatea';
...
$string['templatereset'] = 'Resetare șablon';
$string['templateresetall'] = 'Resetează toate șabloanele';
$string['templates'] = 'Şabloane';
$string['templatesaved'] = 'Şablon salvat';
$string['templatesnavigation'] = 'Șabloane de navigație terțiară';
$string['text'] = 'Text';
...
$string['usepredefinedset'] = 'Utilizați set predefinit';
$string['usepreset'] = 'Utilizați această presetare';
$string['usestandard'] = 'Foloseşte o presetare';
...
$string['viewfromdate'] = 'Doar citire din';
$string['viewnavigation'] = 'Navigare terțiară în modul vizualizare';
$string['viewtemplates'] = 'Vezi șabloane';
$string['viewtodate'] = 'Doar citire, până la';
$string['viewtodatevalidation'] = 'Numai citirea până în prezent nu poate fi înainte de citirea numai din data.';
$string['wrongdataid'] = 'A fost furnizat un identificator greșit pentru date';
