...
$string['index_error_noinstances'] = 'Nu există instanțe ale camerei de discuții Bigbluebutton';
...
$string['nosuchinstance'] = 'Nu există această instanță {$a->entity} cu identificatorul: {$a->id}';
...
$string['view_error_import_no_courses'] = 'Nu există cursuri în care să poată fi căutate înregistrări.';
...
$string['view_error_no_group'] = 'Nu există grupuri încă. Vă rugăm să creați grupuri înainte de a încerca să vă înscrieți la întâlnire.';
$string['view_error_no_group_student'] = 'Nu ați fost înscris într-un grup. Vă rugăm să contactați profesorul.';
$string['view_error_no_group_teacher'] = 'Nu există grupuri. Vă rugăm să creați grupuri.';
...
$string['view_error_url_missing_parameters'] = 'Există parametri lipsă în acest URL';
