...
$string['ctrl_click'] = 'Prima a tecla Ctrl e o botão do rato para selecionar mais de uma sala';
$string['ctrl_click_type'] = 'Prima a tecla Ctrl e o botão do rato para selecionar mais de um tipo';
