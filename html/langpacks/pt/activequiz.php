...
/**
 * Strings for component 'activequiz', language 'pt', version '4.1'.
 *
 * @package     activequiz
 * @category    string
...
$string['groupattendance_help'] = 'Se ativar esta opção, o aluno que está a responder ao teste pode selecionar quais os alunos do seu grupo que estão presentes.';
