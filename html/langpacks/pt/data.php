...
$string['addtemplate'] = 'Adicionar modelo de entrada';
...
$string['entrieslefttoadd'] = 'Tem de adicionar mais {$a->entriesleft} entrada(s) para concluir esta atividade.';
...
$string['headerjstemplate'] = 'Adicionar JavaScript personalizado para manipular como são mostrados nos modelos Lista, Simples ou Adicionar entrada.';
...
$string['missingfieldtypes'] = 'Os campos a seguir não têm os seus tipos de campo correspondentes instalados e não serão incluídos no formulários de adicionar entradas. É necessário verificar o modelo de Adicionar entrada e remover todos os nomes de campo.';
...
$string['notapprovederror'] = 'A entrada ainda não foi aprovada.';
