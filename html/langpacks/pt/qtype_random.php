...
/**
 * Strings for component 'qtype_random', language 'pt', version '4.1'.
 *
...
$string['configselectmanualquestions'] = 'A pergunta aleatória pode selecionar uma pergunta com avaliação manual quando faz a escolha aleatória entre as perguntas duma categoria?';
...
$string['randomqplusname'] = 'Aleatória ({$a} e subcategorias)';
...
$string['randomqplusnametags'] = 'Aleatória ({$a->category} e subcategorias, palavras-chave: {$a->tags})';
