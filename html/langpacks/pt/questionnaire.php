...
$string['allresponses'] = 'Todas as respostas';
...
$string['attemptsallowed'] = 'Tentativas permitidas: {$a}';
$string['attemptstillinprogress'] = 'Resposta ao questionário em progresso. Guardado em:';
$string['autodeletereponse'] = 'Apagar automaticamente as respostas após [?]';
$string['autodeletereponse_desc'] = 'Ative esta definição para apagar automaticamente as respostas antigas com base no definido em "Apagar respostas antigas após". Desative para manter todas as respostas.';
...
$string['closed'] = 'O questionário fechou {$a}';
$string['closedate'] = 'Permitir respostas até';
$string['closesat'] = 'Fecha {$a}';
...
$string['configemailreportinglong'] = 'Permite que alguns relatórios sejam enviados diretamente para endereços de e-mail específicos.';
$string['configmaxsections'] = 'Máximo de secções de feedback';
$string['configremoveoldresponses'] = 'Configuração que será utilizada por predefinição em todos os novos questionários.';
...
$string['confirmdeletesection'] = 'Tem a certeza de que pretende apagar a secção de feedback "{$a}"?';
...
$string['downloadtextformat_help'] = 'Esta funcionalidade permite que descarregue as respostas do questionário num formato de ficheiro de sua escolha.
O ficheiro pode ser aberto num programa de folha de cálculo (por exemplo, MS Excel ou Open Office Calc) ou num pacote estatístico para processamento posterior.';
...
A permissão \'allowemailreporting\' tem de estar ativada nas configurações do módulo para aceder a esta funcionalidade.';
$string['emailroles'] = 'Enviar para os papéis';
...
$string['feedbackmessages'] = 'Mensagens da secção {$a}';
...
$string['feedbackoptions_help'] = 'As opções de feedback estão disponíveis se o questionário contém um dos seguintes tipos e configurações de questões: botões de rádio, lista pendente, sim/não ou classificação. Estas questões devem ser definidas como de **Resposta obrigatória**, o nome da questão **NÃO** pode estar em branco e as opções possíveis de resposta têm de conter um valor.';
...
$string['feedbacksectionheading'] = 'Feedback da secção {$a}';
...
$string['fullsubmissions'] = 'Submissões completas';
...
$string['leftpartdefault'] = 'e {$a->max} é o valor mínimo do intervalo.';
...
$string['middlepartdefault'] = ', {$a->centreval} é média';
$string['middlepartwithtwovalues'] = ', {$a->centreval1} e {$a->centreval2} são {$a->middlelabel}';
$string['middlepartwithtwovaluesdefault'] = ', {$a->centreval1} e {$a->centreval2} são médias';
...
$string['nopermissions'] = 'Lamentamos, mas não está autorizado a visualizar esta página ou a realizar esta ação.';
...
$string['printstrictdateformatting'] = 'Indique a data';
...
$string['removeoldresponses'] = 'Apagar respostas antigas';
$string['removeoldresponses_help'] = 'O sistema pode remover automaticamente as respostas após um determinado período de tempo.';
$string['removeoldresponsesafter'] = 'Apague as respostas antigas depois de';
$string['removeoldresponsesdefault'] = 'Nunca remover';
...
$string['responses_breakdown'] = '(Submissões: {$a->responses} | Em progresso: {$a->incomplete})';
$string['responsesnotsubmitted'] = 'Respostas não submetidas';
...
$string['resume_help'] = 'Ativar esta opção permite aos utilizadores guardar as suas respostas antes de submetê-las.
...
$string['rightpartdefault'] = 'e {$a->max} é o valor máximo do intervalo.';
$string['save'] = 'Guardar';
...
Os valores predefinidos são de 20 caracteres para o comprimento da caixa de texto e 25 caracteres para o comprimento máximo do texto.';
$string['textdownloadoptions'] = 'Opções de exportação no formato CSV';
...
$string['useridnumber'] = 'ID do utilizador';
