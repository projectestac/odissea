...
/**
 * Strings for component 'block_rss_client', language 'pt', version '4.5'.
 *
...
$string['choosefeedlabel'] = 'Selecione as listas a mostrar';
$string['clientchannellink'] = 'Site de origem...';
$string['clientnumentries'] = 'Número predefinido de notícias a mostrar por lista RSS.';
$string['clientshowchannellinklabel'] = 'Exibir hiperligação para a origem, se disponível';
$string['clientshowimagelabel'] = 'Mostrar imagem do canal, se disponível';
$string['configblock'] = 'Configurar este bloco';
$string['configmethodexisting'] = 'Selecionar lista RSS existente';
$string['configmethodnew'] = 'Adicionar nova lista RSS';
...
$string['displaydescriptionlabel'] = 'Exibir descrições das notícias';
$string['displaysettings'] = 'Configurações de visualização da lista RSS';
...
$string['feedurl'] = 'Hiperligação da lista';
$string['findmorefeeds'] = 'Pesquisar mais listas RSS';
$string['managefeeds'] = 'Gerir listas RSS';
$string['nofeeds'] = 'Ainda não existem listas RSS configuradas. Pode adicionar em \'Adicionar nova lista RSS\'.';
...
$string['shownumentrieslabel'] = 'Notícias a exibir';
