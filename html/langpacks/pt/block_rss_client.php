...
$string['customtitlelabel'] = 'Título (deixe vazio para utilizar o título fornecido pela Lista):';
...
$string['feedsconfigurenewinstance2'] = 'Clique no ícone de edição abaixo para configurar este bloco de modo que exiba listas RSS';
