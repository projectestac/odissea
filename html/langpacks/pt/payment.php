...
/**
 * Strings for component 'payment', language 'pt', version '4.4'.
 *
 * @package     payment
 * @category    string
...
$string['gotopaymentaccounts'] = 'Pode criar várias contas de pagamento usando qualquer um destes gateways na página \'{$a}\'';
