...
$string['removalwarning_feature'] = 'Se precisar de continuar a utilizar o MoodleNet, contacte o administrador do seu site para obter informações sobre como configurar uma instância do MoodleNet em alojamento próprio.';
$string['removalwarning_service'] = 'Após esta data, já não poderá navegar ou adicionar conteúdo no MoodleNet Central.';
$string['removalwarning_title'] = 'O serviço MoodleNet será desativado no dia 20 de abril de 2026.';
