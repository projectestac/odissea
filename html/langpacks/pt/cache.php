...
$string['cachedef_roledefs'] = 'Definições de papéis';
...
$string['locknamedesc'] = 'O nome tem de ser único e apenas pode conter os caracteres: a-z A-Z  _';
...
$string['rescandefinitions'] = 'Reexaminar as definições';
...
$string['storename_help'] = 'Isto define o nome da unidade de armazenamento. Este nome é usado para identificar a unidade de armazenamento no sistema e apenas pode  pode conter os caracteres a-z A-Z 0-9 -_ e espaços. Também deve ser único. Se tentar usar um nome que já esteja a ser usado será notificado com uma mensagem de erro.';
...
$string['supports_searchable'] = 'a pesquisar por chave';
