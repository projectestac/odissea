...
$string['storename_help'] = 'Define o nome da unidade de armazenamento. Este nome é usado para identificar a unidade de armazenamento no sistema e apenas pode conter os caracteres a-z A-Z 0-9 -_ e espaços. Tem de ser único. Se tentar usar um nome que já esteja a ser usado será notificado com uma mensagem de erro.';
