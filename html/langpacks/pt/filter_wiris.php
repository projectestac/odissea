...
/**
 * Strings for component 'filter_wiris', language 'pt', version '3.11'.
 *
...
$string['alloweditorpluginactive_help'] = 'Se ativar esta opção, o editor estará sempre disponível independentemente do filtro Matemática & Ciência por WIRIS estar desativado, ou não, na disciplina ou ao nível da atividade. Por predefinição, se o filtro Matemática & Ciência por WIRIS estiver desativado numa disciplina/atividade, o MathType por WIRIS também estará desativado na mesma disciplina/atividade.';
$string['area'] = 'área';
...
$string['clearcachedesc'] = 'Limpar a cache do filtro Matemática & Ciência por WIRIS';
...
$string['impossibletofindwirisfilterversion'] = 'Não é possível encontrar o ficheiro da versão do filtro Matemática & Ciência por WIRIS.';
$string['lookingforfilterfiles'] = 'A procurar ficheiros do filtro';
$string['lookingforwirisfilterversion'] = 'A procurar a versão do filtro Matemática & Ciência por WIRIS';
$string['lookingforwirisplugin'] = 'A procurar MathType por WIRIS para&nbsp;';
$string['lookingforwirispluginenabled'] = 'A procurar MathType por WIRIS para&nbsp;';
...
$string['wirisfilterversion'] = 'Versão do filtro Matemática & Ciência por WIRIS =&nbsp;';
$string['wirismatheditor'] = 'Editor de Matemática';
$string['wirismatheditor_help'] = 'Mostrar o botão Editor de MathType.';
$string['wirispluginfilterfor'] = 'Filtro Matemática & Ciência por WIRIS e MathType por WIRIS para&nbsp;';
$string['wirispluginfiltermustbeinstalled'] = 'O filtro Matemática & Ciência por WIRIS tem de estar instalado.';
