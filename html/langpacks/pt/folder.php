...
/**
 * Strings for component 'folder', language 'pt', version '4.5'.
 *
 * @package     folder
 * @category    string
...
$string['forcedownload'] = 'Forçar descarregamento dos ficheiros';
$string['forcedownload_help'] = 'Se determinados ficheiros, como por exemplo, imagens ou ficheiros HTML, devem ser exibidos, ou não, no navegador em vez de serem descarregados. Tenha em atenção que, por motivos de segurança, a configuração só deve ser desmarcada se todos os utilizadores com a permissão de gerir ficheiros na pasta forem utilizadores confiáveis.';
