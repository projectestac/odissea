...
$string['ariaeventlistpaginationnavcourses'] = 'Paginação de atividades no Cronograma da disciplina {$a}';
$string['ariaeventlistpaginationnavdates'] = 'Paginação de atividades no Cronograma';
...
$string['nocoursesinprogress'] = 'Não existem disciplinas em progresso';
...
$string['timeline:myaddinstance'] = 'Adicionar um novo bloco Cronograma ao Painel do utilizador';
$string['viewcourse'] = 'Visualizar disciplina';
