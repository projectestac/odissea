...
$string['errorminpasswordnonalphanum'] = 'A senha tem de ter, pelo menos, {$a} caracteres não alfanuméricos, tais como *, - ou #.';
...
$string['informminpasswordnonalphanum'] = 'pelo menos {$a} caracteres não alfanuméricos, tais como *, -, #';
