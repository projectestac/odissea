...
$string['guestnoeditmessage'] = 'Os visitantes não podem alterar as opções das mensagens';
$string['guestnoeditmessageother'] = 'Os visitantes não podem alterar as opções das mensagens de outro utilizador';
