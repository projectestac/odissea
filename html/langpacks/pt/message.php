...
$string['defaultmessageoutputs'] = 'Configurações da notificação';
...
$string['privacy:metadata:message_conversation_actions:timecreated'] = 'A data/hora em que a ação foi criada';
