...
$string['cssoverrides'] = 'Substituições CSS';
$string['cssoverridesdesc'] = 'Se este campo for usado, as regras de estilo aqui escritas serão anexadas à folha de estilos global para alterar a aparência da etiqueta personalizada. Para isto é necessário que o tema tenha sido ajustado para definir o ponto de inserção. Veja README.txt.';
...
$string['disabledsubtypesdesc'] = 'Qualquer subtipo mencionado neste campo será globalmente desativado para todo o site.';
...
$string['errorfailedloading'] = 'Falha ao carregar a classe para a etiqueta personalizada \'{$a}\'. A reverter para etiqueta personalizada "texto".';
...
$string['settings'] = 'Comnfigurações';
