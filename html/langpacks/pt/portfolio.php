...
$string['privacy:metadata:portfolio_log:time'] = 'Hora da transferência (No caso de transferências em espera, esta é o hora em que a transferência foi executada, não quando o utilizador a iniciou)';
