...
/**
 * Strings for component 'tool_assignmentupgrade', language 'pt', version '3.11'.
 *
...
$string['conversionfailed'] = 'A conversão do trabalho não ocorreu com sucesso. O registo da atualização foi: <br />{$a}';
$string['listnotupgraded'] = 'Listar trabalhos que ainda não foram atualizados';
...
$string['upgradeassignmentfailed'] = 'Resultado: A atualização falhou. O registo da atualização foi: <br/><div class="tool_assignmentupgrade_upgradelog">{$a->log}</div>';
