...
$string['expiredaction'] = 'Ação após cancelamento da inscrição';
...
$string['expiry_heading'] = 'Configurações do cancelamento';
$string['mailtoteacher_suject'] = 'Novo pedido de inscrição!';
$string['maxenrolled'] = 'Máximo de utilizadores inscritos';
$string['maxenrolled_help'] = 'Especifica o número máximo de utilizadores que podem inscrever-se automaticamente. 0 significa sem limite.';
...
$string['newapplicationnotification'] = 'Há um novo pedido de inscrição a aguardar aprovação.';
