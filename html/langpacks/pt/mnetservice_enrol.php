...
/**
 * Strings for component 'mnetservice_enrol', language 'pt', version '3.11'.
 *
...
$string['noroamingusers'] = 'Os utilizadores necessitam da permissão \'{$a}\' no contexto do sistema para serem inscritos em disciplinas remotas, mas atualmente não existem utilizadores com esta permissão. Clique no botão de continuar para atribuir a permissão necessária a um ou mais papéis no seu site.';
