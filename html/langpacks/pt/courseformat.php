...
$string['availability_hide'] = 'Oculto para os alunos';
$string['availability_hide_help'] = 'Não disponível para os alunos.';
$string['availability_show'] = 'Mostrar na página da disciplina';
$string['availability_show_help'] = 'Disponível para os alunos (sujeito a eventuais restrições de acesso que venham a ser definidas).';
$string['availability_stealth'] = 'Disponível mas oculto na página da disciplina';
$string['availability_stealth_help'] = 'Disponível para os alunos se fornecer uma hiperligação. As atividades continuarão a aparecer na pauta e em outros relatórios.';
$string['bulkcancel'] = 'Fechar ações em massa';
$string['bulkedit'] = 'Ações em massa';
...
$string['cm_duplicate_feedback_batch'] = 'Duplicadas {$a->count} atividades selecionadas.';
$string['cm_hide_feedback'] = '{$a->name} está ocultada.';
$string['cm_hide_feedback_batch'] = 'As {$a->count} atividades selecionadas estão ocultadas.';
$string['cm_moveleft_feedback'] = '{$a->name} foi movido para a esquerda.';
$string['cm_moveright_feedback'] = '{$a->name} foi movido para a direita.';
$string['cm_nogroups_feedback'] = 'O modo de grupo \'{$a->name}\' foi alterado para \'Não há grupos\'.';
$string['cm_separategroups_feedback'] = 'O modo de grupo \'{$a->name}\' foi alterado para \'Grupos separados\'.';
$string['cm_show_feedback'] = '{$a->name} está a ser mostrada.';
...
$string['cmsdelete_title'] = 'Apagar as atividades selecionadas?';
$string['cmsduplicate'] = 'Duplicar atividades';
$string['cmsmove'] = 'Mover atividades';
$string['cmsmove_info'] = 'Mover {$a} atividades para depois de';
...
$string['sectionmove_info'] = 'Mover "{$a}" para depois de';
$string['sectionmove_title'] = 'Mover secção';
$string['sectionsavailability'] = 'Disponibilidade das secções';
$string['sectionsavailability_title'] = 'Disponibilidade das secções';
$string['sectionsdelete'] = 'Apagar secções';
$string['sectionsdelete_info'] = 'Irá apagar {$a->count} secções e todos os dados de utilizadores existentes.';
$string['sectionsdelete_title'] = 'Apagar as secções selecionadas?';
$string['sectionsmove'] = 'Mover secções';
$string['sectionsmove_info'] = 'Mover {$a} secções para depois de';
$string['sectionsmove_title'] = 'Mover secções selecionadas';
$string['selectcm'] = 'Selecionar a atividade {$a}';
$string['selectsection'] = 'Selecionar a secção {$a}';
