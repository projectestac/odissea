...
Isto significa que atualizou o _Level up! _ mas não _Level up! Plus_. Embora façamos o nosso melhor para tentar evitar quaisquer problemas, alguns recursos podem não funcionar corretamente, incluindo o próprio _Level up! _. Recomendamos que atualize _Level up! Plus_ para a última versão. [Ler mais] ({$a->url})';
...
$string['promointroinstalled'] = 'O suplemento _Level up! Plus_ está instalado no seu sistema e todos os seus recursos foram ativados.';
