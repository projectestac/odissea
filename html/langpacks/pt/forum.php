...
/**
 * Strings for component 'forum', language 'pt', branch 'MOODLE_38_STABLE'
 *
 * @package   forum
...
$string['duedate_help'] = 'Acontece quando foi ultrapassada a data limite de publicação no fórum. Embora esta data seja exibida no calendário como a data de expiração do fórum, ainda será possível publicar no fórum após esta data. Para evitar publicações no fórum após uma determinada data, defina a data limite do fórum.';
...
$string['gradeitemnameforwholeforum'] = 'Avaliação global do fórum {$a->name}';
...
$string['nextuser'] = 'Guardar as alterações e prosseguir para o próximo utilizador';
...
$string['pinupdated'] = 'A opção de destacar a publicação foi atualizada.';
...
$string['postisprivatereply'] = 'Esta mensagem foi enviada em privado e não está visível para outros participantes.';
...
$string['privacy:digesttypenone'] = 'Não mantemos dados relacionados com preferências de resumos de fóruns para este fórum.';
...
$string['privacy:metadata:forum_digests'] = 'Informação sobre preferências de resumo para cada fórum.';
...
$string['privacy:metadata:forum_digests:userid'] = 'O ID do utilizador com preferência de resumo.';
...
$string['sendstudentnotifications_help'] = 'Se ativar esta opção, os alunos recebem uma mensagem sobre a atualização da nota ou comentário de feedback. Se a marcação do fluxo de trabalho estiver ativa neste trabalho, as notificações não serão enviadas até que a nota seja "Lançada".';
