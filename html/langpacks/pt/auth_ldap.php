...
/**
 * Strings for component 'auth_ldap', language 'pt', version '4.5'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_memberattribute_isdn'] = 'Esta configuração prevalece sobre os valores do atributo "member"';
...
$string['auth_ldap_no_mbstring'] = 'A extensão mbstring do PHP tem de estar instalado no servidor para seja possível criar utilizadores na Ative Directory.';
...
$string['auth_ldap_noextension'] = 'O extensão LDAP do PHP não está instalada ou não está ativada. Se pretende usar este módulo de autenticação, certifique-se de que a extensão está instalada e ativada.';
...
$string['sync_updateuserchunk'] = 'Defina este valor para o número de utilizadores que pretende atualizar por transação. Definir como 0 atualizará todos os utilizadores em apenas uma transação.';
$string['sync_updateuserchunk_key'] = 'Tamanho do bloco de utilizadores da atualização de sincronização';
