...
$string['errornomultiplier'] = 'Tem de especificar um multiplicador para esta unidade.';
$string['errorrepeatedunit'] = 'Não pode ter duas unidades com o mesmo nome.';
$string['geometric'] = 'Geométrico';
$string['invalidnumber'] = 'Tem de inserir um número válido.';
$string['invalidnumbernounit'] = 'Tem inserir um número válido. Não inclua a unidade na sua resposta.';
...
$string['manynumerical'] = 'A unidade é opcional. Se indicada, é usada para converter a resposta para a Unidade 1 antes de ser avaliada.';
...
$string['notenoughanswers'] = 'Tem que indicar pelo menos uma resposta.';
$string['nounitdisplay'] = 'Sem avaliação das unidades';
...
$string['privacy:preference:multichoicedisplay'] = 'Se as unidades são exibidas como elemento de entrada de texto, seleção de múltipla escolha ou uma lista pendente.';
...
$string['privacy:preference:unitpenalty'] = 'Qual a fração (0-1) da nota da resposta ou da nota da pergunta que deve ser aplicada?';
$string['privacy:preference:unitrole'] = 'Se a unidade é obrigatória, opcional ou não esperada.';
$string['privacy:preference:unitsleft'] = 'Se a unidade é mostrada à esquerda (por exemplo, $, £) ou à direita (por exemplo, kg, km, cm).';
...
$string['studentunitanswer'] = 'Unidade da resposta é indicada';
...
$string['unitgraded'] = 'A unidade deve ser indicada e será avaliada.';
...
$string['youmustenteramultiplierhere'] = 'Tem que indicar um multiplicador aqui';
