...
/**
 * Strings for component 'editor', language 'pt', branch 'MOODLE_38_STABLE'
 *
 * @package   editor
...
$string['move'] = 'Mover';
$string['multi'] = 'Multi';
$string['mustenterurl'] = 'Tem de introduzir um URL';
...
$string['rows'] = 'Linhas';
$string['searchandreplace'] = 'Procurar e substituir';
