...
$string['bulklegend'] = 'Inserção de notas em massa';
...
$string['selectagrade'] = 'Selecione um item de avaliação';
$string['selectgradeitemlink'] = 'Selecione um item de avaliação';
