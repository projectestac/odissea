...
/**
 * Strings for component 'filters', language 'pt', version '4.5'.
 *
 * @package     filters
 * @category    string
...
$string['addfilter'] = 'Adicionar filtro';
$string['anycategory'] = 'qualquer categoria';
$string['anycourse'] = 'qualquer disciplina';
$string['anycourses'] = 'Inscrito em qualquer disciplina';
$string['anyfield'] = 'qualquer campo';
$string['anyrole'] = 'qualquer papel ';
$string['anyvalue'] = 'qualquer valor';
$string['applyto'] = 'Aplicar a';
$string['categoryrole'] = 'Papel na categoria';
...
$string['filtersettingsin'] = 'Configurações do filtros no contexto: {$a}';
$string['firstaccess'] = 'Primeiro acesso';
$string['globalrolelabel'] = '{$a->label} é {$a->value}';
$string['isactive'] = 'Ativo?';
$string['isafter'] = 'posterior a';
$string['isanyvalue'] = 'qualquer valor';
$string['isbefore'] = 'anterior a';
