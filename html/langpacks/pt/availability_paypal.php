...
/**
 * Strings for component 'availability_paypal', language 'pt', version '3.11'.
 *
...
$string['description'] = 'Exigir que os utilizadores façam um pagamento via PayPal para aceder à atividade ou ao recurso.';
$string['eitherdescription'] = 'efetuou um <a href="{$a}">pagamento via PayPal</a>';
$string['notdescription'] = 'não enviou um <a href="{$a}">pagamento via PayPal</a>';
