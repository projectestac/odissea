...
$string['clicktounsubscribe'] = 'Subscrição ativa para esta discussão. Clique para cancelar';
...
$string['configmaxeditingtime'] = 'A duração máxima é de 3600 segundos (= 60 minutos).';
...
$string['configpreferteachersmark'] = 'A resposta marcada como resolvida pelo responsável da disciplina tem prioridade sobre a resposta marcada como útil pelo iniciante da discussão.';
...
$string['configvotescalesolved'] = 'A reputação que um "marcar como resolvida" dá à publicação';
