...
/**
 * Strings for component 'tag', language 'pt', version '4.5'.
 *
 * @package     tag
 * @category    string
...
$string['combined'] = 'As palavras-chave estão combinadas';
$string['combineselected'] = 'Combinar as palavras-chave selecionadas';
$string['component'] = 'Componente';
$string['confirmdeletetag'] = 'Tem a certeza de que pretende apagar esta palavra-chave?';
$string['confirmdeletetags'] = 'Tem a certeza de que pretende apagar as palavras-chave selecionadas?';
$string['count'] = 'Utilizações';
...
$string['editcollname'] = 'Alterar o nome da coleção de palavras-chave';
$string['editisstandard'] = 'Alterar utilização das palavras-chave oficiais';
$string['editname'] = 'Editar a palavra-chave';
$string['editsearchable'] = 'Alterar pesquisáveis';
...
$string['eventtagcolldeleted'] = 'Coleção de palavras-chave eliminada';
$string['eventtagcollupdated'] = 'Coleção de palavras-chave atualizada';
...
$string['id'] = 'ID';
$string['inalltagcoll'] = 'Em qualquer local';
...
$string['namewithlink'] = 'Nome da palavra-chave com hiperligação';
...
$string['privacy:metadata:tag:name'] = 'O nome da palavra-chave - versão normalizada do nome.';
...
$string['privacy:metadata:taginstance:timecreated'] = 'Data e hora em que esta palavra-chave foi ligada ao objetivo';
$string['privacy:metadata:taginstance:timemodified'] = 'A data e hora em que esta palavra-chave foi modificada para o objetivo.';
...
$string['removetagfrommyinterests'] = 'Remover "{$a}" dos meus interesses';
$string['reset'] = 'Repor as palavras-chave assinaladas';
$string['resetfilter'] = 'Repor filtro';
$string['resetflag'] = 'Repor sinalizador';
$string['responsiblewillbenotified'] = 'A pessoa responsável será notificada';
$string['rssdesc'] = 'Esta lista RSS foi gerada automaticamente pelo Moodle e contém palavras-chave criadas pelos utilizadores.';
$string['rsstitle'] = 'Palavras-chave da disciplina na lista RSS do utilizador: {$a}';
$string['search'] = 'Pesquisar';
$string['searchable'] = 'Pesquisável';
$string['searchable_help'] = 'Se ativar esta opção, as palavras-chave nesta coleção de pesquisa poderão ser encontradas na página "Pesquisar palavras-chave". Se não selecionar esta opção, as palavras-chave continuarão a poder ser encontradas através de outras páginas de pesquisa.';
...
$string['selectcoll'] = 'Selecionar coleção de palavras-chave';
...
$string['showstandard_help'] = 'Ao inserir palavras-chave, podem ser sugeridas, ou forçadas, as palavras-chave oficiais, o que significa que não podem ser inseridas novas palavras-chave. Em alternativa, podem ser inseridas novas palavras-chave sem serem sugeridas as palavras-chave oficiais.';
$string['standardforce'] = 'Forçar';
$string['standardhide'] = 'Não sugerir';
$string['standardsuggest'] = 'Sugerir';
$string['standardtag'] = 'Oficial';
$string['suredeletecoll'] = 'Tem a certeza de que pretende apagar a coleção de palavras-chave "{$a}"?';
$string['tag'] = 'palavra-chave';
$string['tagarea'] = 'Área da palavra-chave';
...
$string['tagarea_tag'] = 'Tags relacionadas';
$string['tagarea_user'] = 'Interesses do utilizador';
$string['tagareaenabled'] = 'Ativa';
$string['tagareaname'] = 'Nome';
$string['tagareas'] = 'Áreas da palavras-chave';
$string['tagauthor'] = 'Autor da palavra-chave';
...
$string['taginstance'] = 'Instância da palavra-chave';
$string['tags'] = 'Palavras-chave';
$string['tagsaredisabled'] = 'As palavras-chave estão desativadas';
$string['thingstaggedwith'] = '"{$a->name}" é usada {$a->count} vezes';
$string['thingtaggedwith'] = '"{$a->name}" é usada uma vez';
