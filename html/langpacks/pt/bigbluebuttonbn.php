...
$string['bbbduetimeoverstartingtime'] = 'A hora de fim para esta atividade deve ser posterior à hora de início';
...
$string['bigbluebuttonbn:meeting'] = 'Criar instâncias com possibilidade de sessão online';
$string['bigbluebuttonbn:recording'] = 'Criar instâncias com possibilidade de gravação';
$string['bigbluebuttonbn:view'] = 'Visualizar sala/atividade';
$string['calendarstarts'] = '{$a} agendada';
$string['completionattendance'] = 'O aluno deve estar na reunião durante:';
$string['completionattendancedesc'] = 'O aluno deve comparecer à reunião e estar presente na sessão pelo menos {$a} minuto(s)';
$string['completionattendancegroup'] = 'Requer presença';
$string['completionattendancegroup_help'] = 'É necessário estar na reunião por (n) minutos para concluir a atividade';
$string['completionengagementchats'] = 'Eventos da conversação';
$string['completionengagementdesc'] = 'O aluno deve participar nas atividades durante a reunião';
...
$string['completionengagementtalktime'] = 'Tempo de conversa';
...
$string['config_clienttype'] = 'Configuração do tipo "Cliente Web"';
$string['config_clienttype_default'] = 'Tipo predefinido de Cliente Web';
$string['config_clienttype_default_description'] = 'Escolha o cliente clássico com Adobe Flash ou o novo HTML5.';
$string['config_clienttype_description'] = 'Esta configuração ativa/desativa a opção Cliente Web para cada sala.';
$string['config_clienttype_editable'] = 'A escolha do Cliente Web pode ser editada';
$string['config_clienttype_editable_description'] = 'Esta opção permite a escolha do tipo de Cliente Web (Adobe Flash/HTML5) a partir do formulário de edição da sala.';
...
$string['config_disablemic_editable'] = 'Desativar o microfone pode ser editado';
...
$string['config_disablenote_editable'] = 'Desativar notas partilhadas pode ser editado';
...
$string['config_disableprivatechat_editable'] = 'Desativar conversas privadas pode ser editado';
$string['config_disableprivatechat_editable_description'] = 'Desativar as conversas privadas por predefinição pode ser editado quando a instância é adicionada ou atualizada.';
$string['config_disablepublicchat_default'] = 'Desativar conversas públicas ativo por predefinição';
...
$string['config_disablepublicchat_editable'] = 'Desativar conversas públicas pode ser editado';
$string['config_disablepublicchat_editable_description'] = 'Desativar as conversas públicas por predefinição pode ser editado quando a instância é adicionada ou atualizada.';
...
$string['config_hideuserlist_editable'] = 'Ocultar lista de participantes pode ser editado';
...
$string['config_lockedlayout_default'] = 'Ativar bloqueio da estrutura ativo por predefinição';
$string['config_lockedlayout_default_description'] = 'Se ativar esta opção, o bloqueio da estrutura estará ativado por predefinição';
$string['config_lockedlayout_editable'] = 'Bloqueio da estrutura pode ser editado';
$string['config_lockedlayout_editable_description'] = 'O bloqueio da estrutura por predefinição pode ser editado quando a instância é adicionada ou atualizada.';
...
$string['config_lockonjoinconfigurable_default'] = 'Configuração de bloqueio ativada por predefinição';
$string['config_lockonjoinconfigurable_default_description'] = 'Se ativar esta opção, as configurações de bloqueio da sessão podem ser ativadas ou desativadas';
$string['config_lockonjoinconfigurable_editable'] = 'Configuração de bloqueio pode ser editada';
$string['config_lockonjoinconfigurable_editable_description'] = 'A configuração de bloqueio predefinida pode ser editada quando a instância é adicionada ou atualizada.';
...
$string['config_muteonstart_editable'] = 'Silencioso no início pode ser editado';
$string['config_muteonstart_editable_description'] = 'Se ativar esta opção, o modo \'Silencioso no início\' pode ser editado, por predefinição, quando a instância é adicionada ou atualizada.';
...
$string['config_preuploadpresentation_enabled'] = 'Pré-carregar a apresentação';
$string['config_preuploadpresentation_enabled_description'] = 'Se ativar esta opção, a funcionalidade de \'Pré-carregar a apresentação\' é permitida na interface do utilizador (IU) quando uma sala ou conferência é adicionada ou atualizada.';
...
$string['config_recording_icons_enabled'] = 'Gerir ícones de gravação';
$string['config_recording_icons_enabled_description'] = 'Se ativar esta opção, o painel de gestão das gravações mostra ícones para as ações de publicar/apagar publicação, proteger/desproteger e apagar.';
...
$string['config_recordings_deleted_default'] = 'Incluir gravações de atividades apagadas';
$string['config_recordings_deleted_default_description'] = 'Se ativar esta opção, a tabela de gravações incluirá gravações de atividades apagadas, caso existam.';
$string['config_recordings_deleted_editable'] = 'Incluir gravações de atividades apagadas pode ser editada';
$string['config_recordings_deleted_editable_description'] = 'Se ativar esta opção, a funcionalidade \'Incluir gravações de atividades apagadas\' pode ser editada, por predefinição, quando a instância é adicionada ou atualizada.';
...
$string['config_recordings_html_default'] = 'Interface do utilizador em HTML';
$string['config_recordings_html_default_description'] = 'Se ativar esta opção, a tabela de gravações é mostrada em HTML, por predefinição.';
$string['config_recordings_html_editable'] = 'Interface do utilizador em HTML pode ser editada';
$string['config_recordings_html_editable_description'] = 'Se ativar esta opção, a \'Interface do utilizador em HTML\' pode ser editada quando a instância for adicionada ou atualizada.';
...
$string['config_recordings_imported_editable'] = 'Mostrar apenas hiperligações importadas pode ser editado';
...
$string['config_recordings_preview_editable'] = 'Permitir pré-visualização pode ser editada';
...
$string['config_recordings_validate_url_description'] = 'Se ativar esta opção, o URL de reprodução será validado antes do utilizador aceder.';
...
$string['config_scheduled_duration_compensation'] = 'Tempo de compensação (minutos)';
$string['config_scheduled_duration_compensation_description'] = 'Minutos a acrescentar à hora prevista de fim da sessão quando calcular a duração da sessão.';
$string['config_scheduled_duration_enabled'] = 'Cálculo da duração ativo';
$string['config_scheduled_duration_enabled_description'] = 'A duração de uma sessão agendada é calculado com base na hora de início e fim.';
...
$string['config_userlimit_editable'] = 'Limite de utilizadores pode ser editado';
...
$string['config_voicebridge_editable'] = 'Elo de voz da conferência pode ser editado';
...
$string['config_waitformoderator_cache_ttl'] = 'Cache TTL de Aguardar por moderador (segundos)';
...
$string['config_waitformoderator_description'] = 'Estas configurações referem-se a esta fucionalidade';
...
$string['config_welcome_default'] = 'Mensagem predefinida de boas vindas';
$string['config_welcome_default_description'] = 'Substitui a mensagem predefinida que está configurada para o servidor BigBlueButton. A mensagem pode incluir palavras-chave (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) que serão substituídas automaticamente e também pode incluir tags html, como por exemplo: &lt;b>...&lt;/b>, &lt;br />, &lt;u>&lt;/u> or &lt;i>&lt;/i>';
...
$string['event_activity_viewed'] = 'A atividade foi visualizada';
...
$string['mod_form_block_clienttype'] = 'Tecnologia do Cliente Web';
$string['mod_form_block_clienttype_flash'] = 'Cliente baseado na tecnologia Adobe Flash';
$string['mod_form_block_clienttype_html5'] = 'Cliente baseado na tecnologia HTML5';
...
$string['mod_form_field_block_clienttype'] = 'Tecnologia do Cliente Web';
...
$string['mod_form_field_disableprivatechat'] = 'Desativar conversas em privado';
$string['mod_form_field_disablepublicchat'] = 'Desativar conversas públicas';
...
$string['mod_form_field_hideuserlist'] = 'Ocultar a lista de utilizadores';
...
$string['mod_form_field_lockedlayout'] = 'Bloquear a estrutura da sala';
$string['mod_form_field_lockonjoin'] = 'Ignorar o bloqueio das configurações';
$string['mod_form_field_lockonjoinconfigurable'] = 'Permitir ignorar o bloqueio das configurações';
...
$string['mod_form_field_wait'] = 'Os alunos devem aguardar até à entrada de um moderador';
...
$string['mod_form_locksettings'] = 'Configurações do bloqueio';
...
$string['privacy:metadata:bigbluebutton'] = 'Para aceder e criar em sessões do BigBlueButton, é necessário partilhar informação com o server';
...
$string['privacy:metadata:bigbluebuttonbn_logs'] = 'Guarda eventos acionados quando utiliza o plugin.';
$string['privacy:metadata:bigbluebuttonbn_logs:log'] = 'O tipo de evento acionado pelo utilizador.';
...
$string['privacy:metadata:bigbluebuttonbn_logs:timecreated'] = 'Hora de entrada';
...
$string['view_error_import_no_courses'] = 'Não existem disciplinas para procurar gravações.';
...
$string['view_error_meeting_not_running'] = 'Algo correu mal. A sessão não está a correr.';
...
$string['view_groups_selection'] = 'Selecione o grupo ao qual deseja juntar-se e confirme a ação';
...
$string['view_recording_publish_link_not_published'] = 'Esta hiperligação não pode ser publica novamente porque a gravação não está publicada';
