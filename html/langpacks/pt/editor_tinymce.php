...
/**
 * Strings for component 'editor_tinymce', language 'pt', version '4.4'.
 *
...
$string['advanced:newdocument'] = 'Tem a certeza de que pretende apagar tudo?';
...
$string['advanced:rich_text_area'] = 'Área de Rich Text';
...
$string['advanced_dlg:colorpicker_picker_title'] = 'Seletor de cor';
...
$string['advanced_dlg:link_is_email'] = 'O URL inserido parece ser um endereço de e-mail. Pretende acrescentar o prefixo \'mailto:\' necessário?';
$string['advanced_dlg:link_is_external'] = 'O URL inserido parece ser uma hiperligação externa. Pretende acrescentar o prefixo \'http://\' necessário?';
...
$string['advimage_dlg:missing_alt'] = 'Tem a certeza de que pretende continuar sem incluir uma descrição à imagem? Pode gerar problemas de acessibilidade em alguns navegadores.';
...
$string['advlink_dlg:is_email'] = 'O URL inserido parece ser um endereço de e-mail. Pretende acrescentar o prefixo \'mailto:\' necessário?';
$string['advlink_dlg:is_external'] = 'O URL inserido parece ser uma hiperligação externa. Pretende acrescentar o prefixo \'http://\' necessário?';
...
$string['advlink_dlg:mime'] = 'Tipo MIME de destino';
$string['advlink_dlg:popup'] = 'Pop-up JavaScript';
...
$string['aria:rich_text_area'] = 'Área de Rich Text';
...
Tem a certeza de que pretende restaurar o conteúdo guardado?';
...
$string['common:browse'] = 'Pesquisar';
...
$string['fullpage_dlg:src'] = 'Origem';
...
$string['iespell:download'] = 'Módulo de ortografia não-detetado. Pretende instalar agora?';
...
$string['media_dlg:preload_metadata'] = 'Pré-visualizar metadados do vídeo';
...
$string['table_dlg:mime'] = 'Tipo MIME de destino';
