...
/**
 * Strings for component 'h5p', language 'pt', version '3.11'.
 *
 * @package     h5p
 * @category    string
...
$string['author'] = 'Autor';
$string['authorcomments'] = 'Comentários ao autor';
...
$string['missinguploadpermissions'] = 'Tenha em atenção que as bibliotecas podem existir no ficheiro enviado, mas não tem permissão para carregar novas bibliotecas. Entre em contacto com o administrador do site.';
...
$string['notrustablefile'] = 'Este ficheiro não pode ser exibido porque foi carregado por um utilizador sem a permissão para atualizar os tipos de conteúdo H5P. Entre em contacto com o administrador do site para solicitar a instalação deste tipo de conteúdo.';
