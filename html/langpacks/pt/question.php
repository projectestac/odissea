...
$string['questionsinuse'] = '(*) As perguntas assinaladas com asterisco estão a ser usadas em algum lugar, por exemplo, num teste. Se prosseguir, estas perguntas não serão realmente apagadas, apenas ficarão ocultas.';
