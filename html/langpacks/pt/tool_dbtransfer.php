...
/**
 * Strings for component 'tool_dbtransfer', language 'pt', version '3.11'.
 *
...
$string['enablemaintenance_help'] = 'Esta opção ativa o modo de manutenção durante e depois da migração da base de dados, impedindo o acesso dos utilizadores até a migração estar completa. Tenha em atenção que para o funcionamento voltar ao normal, o administrador tem que apagar manualmente o ficheiro $CFG->dataroot/climaintenance.html depois de atualizar as configurações em \'config.php\'.';
