...
/**
 * Strings for component 'jazzquiz', language 'pt', version '4.5'.
 *
 * @package     jazzquiz
 * @category    string
...
$string['ask_teacher'] = 'Em caso de dúvida, pergunte ao professor.';
...
$string['guest_login'] = 'Não está inscrito na disciplina e, de momento, não existe sessão aberta do teste para visitantes.';
...
$string['no_guests'] = 'É possível que o professor ainda não tenha iniciado uma sessão do teste. Tente novamente mais tarde. Também é possível que tenha que autenticar-se como aluno e inscrever-se na disciplina para poder participar.';
