...
/**
 * Strings for component 'block_course_overview', language 'pt', version '3.11'.
 *
...
$string['addfavourite'] = 'Adicionar favorito';
...
$string['help'] = 'Ajuda';
$string['help_help'] = 'Clique em \'Personalizar esta página\' e arraste e largue para reordenar as disciplinas. Clique nos ícones das atividades para obter uma visão geral';
$string['keepfavourites'] = 'Manter favoritos na lista de disciplinas';
$string['keepfavouritesdesc'] = 'Mostrar disciplinas no separador principal mesmo que também estejam no separador dos favoritos';
$string['makefavourite'] = 'Marcar como favorito';
$string['message'] = 'mensagem';
$string['messages'] = 'Mensagens';
$string['morecoursestext'] = 'Mostrar \'Mais disciplinas\'';
$string['moveafterhere'] = 'Colocar a disciplina {$a->movingcoursename} a seguir à disciplina  {$a->currentcoursename}';
$string['movecourse'] = 'Mover a disciplina: {$a}';
...
$string['nocourses'] = 'Não existem disciplinas para mostrar';
$string['none'] = 'Nenhum';
...
$string['privacy:metadata:coursesortorder'] = 'Ordem das disciplinas (versão antiga)';
$string['privacy:metadata:favourites'] = 'Lista ordenada das disciplinas favoritas';
$string['privacy:metadata:numberofcourses'] = 'Número de disciplinas mostradas';
$string['privacy:metadata:sortorder'] = 'Definir ordem';
...
$string['setmaxcoursesdesc'] = 'Define o número máximo de disciplinas do utilizador a mostrar de uma só vez no bloco Descrição da disciplina.';
$string['setmaxcoursesmax'] = 'Definir o máximo de disciplinas possíveis';
$string['setmaxcoursesmaxdesc'] = 'Define o número máximo possível de disciplinas que o utilizador pode escolher para mostrar no bloco Descrição da disciplina.';
