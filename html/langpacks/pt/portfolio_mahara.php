...
/**
 * Strings for component 'portfolio_mahara', language 'pt', version '3.11'.
 *
...
$string['err_networkingoff_help'] = 'O MNet está de momento desativo. Ative-o antes de tentar configurar este módulo. Todas as instâncias deste módulo estarão ocultas até que o MNet seja ativado. As instâncias deverão ser definidas manualmente para ficarem visíveis novamente.';
...
$string['privacy:metadata'] = 'Este módulo envia dados externamente para uma aplicação Mahara. Não armazena dados localmente.';
