...
/**
 * Strings for component 'qtype_formulas', language 'pt', version '4.4'.
 *
...
$string['error_grading_error'] = 'Erro de avaliação! Talvez devido a ficheiro de importação incorreto ou corrupção da base de dados.';
...
$string['error_question_damaged'] = 'Erro: A pergunta está danificada, o número de fragmentos de texto e o número de partes da pergunta não são iguais.';
...
$string['numdataset'] = 'Número de conjuntos de dados';
