...
$string['messageprovidersempty'] = 'Não existem notificações móveis ativadas nas preferências predefinidas de notificação.';
$string['messageproviderslow'] = 'Apenas algumas notificações móveis estão ativadas nas preferências predefinidas de notificação.';
$string['moodleappsportallimitswarning'] = 'Tenha em atenção que o número de dispositivos do utilizador que podem receber notificações depende da sua assinatura da aplicação Moodle. Para mais detalhes, visite o <a href="{$a}" target="_blank">Portal das Aplicações móveis Moodle</a>.';
...
$string['userdevices'] = 'Dispositivos do utilizador';
