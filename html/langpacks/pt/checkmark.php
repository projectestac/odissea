...
/**
 * Strings for component 'checkmark', language 'pt', version '4.5'.
 *
 * @package     checkmark
 * @category    string
...
$string['custom_settings'] = 'Configurações personalizadas';
...
$string['invaliduserid'] = 'ID do utilizador incorreto';
