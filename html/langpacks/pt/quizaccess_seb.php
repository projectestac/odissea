...
$string['seb:manage_seb_allowcapturecamera'] = 'Modificar a configuração SEB do teste: Permitir o acesso do navegador à câmara';
$string['seb:manage_seb_allowcapturemicrophone'] = 'Modificar a configuração SEB do teste: Permitir o acesso do navegador ao microfone';
