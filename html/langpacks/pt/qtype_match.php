...
/**
 * Strings for component 'qtype_match', language 'pt', version '4.4'.
 *
 * @package     qtype_match
 * @category    string
...
$string['nomatchinganswerforq'] = 'Tem de especificar uma resposta para esta pergunta.';
$string['notenoughqsandas'] = 'Tem de inserir no mínimo {$a->q} perguntas e {$a->a} respostas.';
$string['notenoughquestions'] = 'Tem de inserir no mínimo {$a} pares de pergunta-resposta.';
