...
* Os alunos são impedidos de utilizar funcionalidades como as de copiar e colar, tanto quanto possível';
...
$string['configpopup'] = 'Forçar o teste a abrir numa janela pop-up e usar o JavaScript para restringir a possibilidade de copiar e colar, etc. durante as tentativas de resolução.';
...
$string['filloutthreequestions'] = 'Deve preencher pelo menos três perguntas com respostas correspondentes. Pode acrescentar respostas extra erradas, introduzindo a resposta e deixando a pergunta em branco. Os campos em que tanto a pergunta como a resposta estiverem em branco serão ignorados.';
