...
/**
 * Strings for component 'mnet', language 'pt', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['allowaccess'] = 'Permitir acesso';
...
$string['deletedhostinfo'] = 'O servidor foi apagado. Caso pretenda anular a operação, altere o estado da eliminação para \'Não\'.';
$string['deletedhosts'] = 'Servidores apagados: {$a}';
$string['deletehost'] = 'Eliminar servidor';
$string['deletekeycheck'] = 'Tem a certeza absoluta de que pretende apagar esta chave?';
...
$string['deny'] = 'Negar';
$string['denyaccess'] = 'Negar acesso';
...
$string['name'] = 'Nome';
$string['net'] = 'Rede';
$string['networksettings'] = 'Configurações da rede';
$string['never'] = 'Nunca';
...
$string['usernotfullysetup'] = 'A sua conta de utilizador está incompleta. Consulte a página do seu <a href="{$a}">fornecedor</a> e certifique-se de que o seu perfil está completo. Pode ser necessário reiniciar a sua sessão para que as alterações tenham efeito.';
