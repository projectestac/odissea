...
$string['privacy:metadata:preference:grade_report_aggregationposition'] = 'Se as colunas total da categoria e total da disciplina são, ou não, exibidas em primeiro ou em último lugar na pauta';
$string['privacy:metadata:preference:grade_report_averagesdecimalpoints'] = 'O número de casas decimais a mostrar em cada média ou se é usado o total de casas decimais configurado para a categoria ou item de avaliação (herdar)';
$string['privacy:metadata:preference:grade_report_averagesdisplaytype'] = 'Se a média (média) é exibida como nota simples, percentagem ou letras, ou se é usado o tipo de exibição configurado para a categoria ou item de avaliação (herdar)';
...
$string['privacy:metadata:preference:grade_report_rangesdecimalpoints'] = 'O número de casas decimais a mostrar em cada intervalo ou se se sobrepões a configuração de pontos decimais usados em cada categoria ou item de avaliação (herdar)';
$string['privacy:metadata:preference:grade_report_rangesdisplaytype'] = 'Se o intervalo é exibido em notas reais, percentagens ou letras, ou se é usado o tipo de exibição configurado para a categoria ou item de avaliação (herdar)';
...
$string['privacy:metadata:preference:grade_report_showaverages'] = 'Se deve exibir uma linha adicional com a média (média) em cada categoria e item de avaliação';
$string['privacy:metadata:preference:grade_report_showcalculations'] = 'Se  deve exibir um ícone da calculadora em cada categoria e item de avaliação com um indicador visual de que a nota foi calculado e exibida, ou não, com o modo de edição ativo';
$string['privacy:metadata:preference:grade_report_showeyecons'] = 'Se deve exibir o ícone mostrar/ocultar em cada avaliação para controlar a visibilidade do estudante';
$string['privacy:metadata:preference:grade_report_showlocks'] = 'Se deve exibir o ícone em cada avaliação para controlar se a nota pode ser atualizada automaticamente pela atividade relacionada quando o modo de edição está ativo';
$string['privacy:metadata:preference:grade_report_shownumberofgrades'] = 'Se deve, ou não, mostrar (entre parêntesis), ou não, após cada média, o número de notas usadas para cálculo da respetiva média';
