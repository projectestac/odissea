...
/**
 * Strings for component 'qtype_calculated', language 'pt', version '4.4'.
 *
...
$string['atleastoneanswer'] = 'Tem de indicar pelo menos uma resposta.';
...
$string['editdatasets_help'] = 'Os conjuntos de valores das variáveis podem ser criados inserindo um valor para cada variável e clicando em seguida no botão adicionar. Para gerar automaticamente 10 ou mais conjuntos de valores, selecione o número de conjuntos pretendido e clique no botão adicionar. Uma distribuição uniforme significa que qualquer valor dentro dos limites tem a mesma probabilidade de ocorrer. Numa distribuição log-uniforme os valores mais próximos do limite inferior têm maior probabilidade de ocorrer.';
...
$string['pluginname_help'] = 'A pergunta Numérica com variáveis permite criar perguntas numéricas com variáveis <strong>{x..}</strong> que são substituídas por diferentes valores em cada nova tentativa de resposta. Por exemplo, a pergunta "Qual a área do retângulo de comprimento {l} e largura {w}?" teria como fórmula correta de resposta "{l}*{w}" (onde * é o símbolo de multiplicação).';
...
$string['privacy:metadata'] = 'O módulo Pergunta do tipo Numérica com variáveis não armazena quaisquer dados pessoais.';
