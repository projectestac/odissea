...
/**
 * Strings for component 'block_point_view', language 'pt', version '4.5'.
 *
...
$string['blockonlyonmainpage'] = 'Este bloco não mostrará faixas de dificuldade ou reações nas páginas dos módulos de disciplina porque não é mostrado nos subcontextos desta disciplina.';
$string['bluetrack'] = 'Faixa azul';
$string['cleanupcoursereactions'] = 'Limpar <b>{$a}</b> reações da disciplina';
$string['cleanupreactions'] = 'Limpar reações';
$string['cleanupreactions_help'] = 'Limpar (apagar) reações dos utilizadores que já não estão inscritos na disciplina';
$string['cleanupreactionsconfirmation'] = 'Tem a certeza de que pretende limpar (apagar) as reações dos utilizadores que já não estão inscritos na disciplina <b>{$a}</b>? Essa ação é irreversível.';
$string['confirmshowinsubcontexts'] = 'Tem a certeza de que pretende tornar este bloco visível em subcontextos?<br>
(Esta ação pode ser revertida na configuração do bloco, em "Onde aparece este bloco").';
...
$string['noreactionsyet'] = 'Ainda não existe um módulo de disciplina com reações.';
...
$string['reactionscleanedupsuccessfully'] = 'As reações foram limpas com sucesso.';
$string['reactionsdetails'] = 'Detalhes das reações';
$string['reactionsresetsuccessfully'] = 'As reações foram reiniciadas com sucesso.';
$string['reactionsunavailable'] = 'Não pode adicionar ou remover a sua reação neste módulo.';
$string['redtrack'] = 'Faixa vermelha';
$string['resetcoursereactions'] = 'Reiniciar as reações da disciplina <b>{$a}</b>';
$string['resetreactions'] = 'Reiniciar reações';
$string['resetreactions_help'] = 'Reiniciar (apagar) todas as reações dos utilizadores na disciplina';
$string['resetreactionsbymodule'] = 'Reiniciar reações por módulo:';
$string['resetreactionsconfirmation'] = 'Tem a certeza de que pretende reiniciar (apagar) as reações de todos os utilizadores da disciplina <b>{$a}</b>? Esta ação não pode ser revertida.';
$string['resetreactionsheader'] = 'Limpar ou reiniciar reações';
$string['resetreactionsonmoduleconfirmation'] = 'Tem a certeza de que pretende reiniciar (apagar) todas as reações dos utilizadores neste módulo? Essa ação é irreversível.';
$string['showinsubcontexts'] = 'Mostrar este bloco em subcontextos.';
