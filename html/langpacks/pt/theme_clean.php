...
/**
 * Strings for component 'theme_clean', language 'pt', version '3.11'.
 *
 * @package     theme_clean
 * @category    string
...
$string['privacy:metadata'] = 'O tema Clean não armazena qualquer dado pessoal de nenhum utilizador.';
