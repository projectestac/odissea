...
$string['contextrolenotallowed'] = 'Papel \'<b>{$a}</b>\' não permitido neste contexto.';
...
$string['user:managesyspages'] = 'Configurar a estrutura predefinida das páginas públicas dos perfis de utilizadores';
