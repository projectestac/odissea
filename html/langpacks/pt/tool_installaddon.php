...
$string['installfromrepo_help'] = 'Será redirecionado para a diretoria de módulos do Moodle para procurar e instalar um módulo. Note que o nome completo do seu site, o URL e a versão Moodle também serão enviados por forma a facilitar-lhe o processo de instalação.';
