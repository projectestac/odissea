...
/**
 * Strings for component 'booktool_wordimport', language 'pt', version '3.11'.
 *
...
$string['privacy:metadata'] = 'A ferramenta de importação/exportação de ficheiros do Microsoft Word para Livros não armazena dados pessoais.';
