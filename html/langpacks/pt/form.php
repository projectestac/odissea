...
$string['err_alphanumeric'] = 'Só pode inserir letras e números neste campo.';
$string['err_email'] = 'Tem de inserir um e-mail válido neste campo.';
$string['err_lettersonly'] = 'Só pode inserir letras neste campo.';
$string['err_maxfiles'] = 'Não pode anexar mais de {$a} ficheiros aqui.';
$string['err_maxlength'] = 'Pode inserir até {$a->format} caracteres neste campo.';
$string['err_minlength'] = 'Tem de inserir pelo menos {$a->format} caracteres neste campo.';
...
$string['showadvanced'] = 'Mostrar opções avançadas';
$string['showless'] = 'Mostrar menos…';
$string['showmore'] = 'Mostrar mais…';
$string['somefieldsrequired'] = '{$a} Obrigatório';
