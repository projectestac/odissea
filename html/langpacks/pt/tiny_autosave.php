...
/**
 * Strings for component 'tiny_autosave', language 'pt', version '4.5'.
 *
...
$string['privacy:metadata:database:tiny_autosave:userid'] = 'O ID do utilizador que criou a sessão de guardar automaticamente';
