...
/**
 * Strings for component 'cachestore_mongodb', language 'pt', version '4.5'.
 *
...
$string['replicaset_help'] = 'O nome do conjunto de réplicas definido para se ligar. Se este nome for atribuído, o master será determinado utilizando o comando da base de dados ismaster nas seeds, para que o driver possa parar de ligar a um servidor que nem sequer foi listado.';
