...
/**
 * Strings for component 'tiny_h5p', language 'pt', version '4.5'.
 *
 * @package     tiny_h5p
 * @category    string
...
$string['buttontitle'] = 'Inserir conteúdo H5P';
...
$string['privacy:metadata'] = 'O módulo H5P para TinyMCE não armazena quaisquer dados pessoais.';
