...
$string['csvfileerror'] = 'Algo está errado com o formato do ficheiro CSV. Verifique se o número de títulos e colunas correspondem e se o delimitador e a codificação do ficheiro estão corretos: {$a}';
