...
$string['setuplink_desc'] = 'URL da página com opções para descarregar a Aplicação móvel Moodle da App Store e do Google Play. A hiperligação da página de descarga da aplicação é mostrada no rodapé da página e no perfil do utilizador. Deixe em branco para não mostrar a hiperligação.';
