...
$string['backupfailed'] = 'Restauro sem sucesso';
...
$string['enablelinebreakfilter_desc'] = 'Filtrar os títulos dos mosaicos para o caráter espaço de largura zero <code>&amp;#8203;</code> e, se presente e o título do mosaico for longo, substituir por "- " para permitir a quebra de linha. Caso contrário, não substituir (ou seja, não há quebra de linha).';
