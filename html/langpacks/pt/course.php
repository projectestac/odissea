...
$string['activitynavigation'] = 'Navegação nas atividades';
$string['activitynavigation:jumptoactivity'] = 'Ir para a atividade';
$string['activitynavigation:nexta'] = 'Atividade seguinte: {$a}';
$string['activitynavigation:preva'] = 'Atividade anterior: {$a}';
...
$string['targetlabelteachingyes'] = 'Utilizadores com permissões de ensino que têm acesso à disciplina';
