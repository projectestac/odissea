...
/**
 * Strings for component 'auth_cas', language 'pt', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_auth_name_description'] = 'Indique um nome para o método de autenticação do CAS que seja familiar para seus utilizadores.';
