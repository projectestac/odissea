...
$string['configgeneralcontentbankcontent'] = 'Define os valores predefinidos para incluir o conteúdo do banco de conteúdos na cópia de segurança.';
...
$string['configgeneralpermissions'] = 'Se ativar esta opção, as permissões dos papeis serão importadas. Isto pode substituir as permissões já existentes dos utilizadores inscritos.';
...
$string['configrestorepermissions'] = 'Se ativar esta opção, as permissões dos papeis serão restauradas. Isto pode substituir as permissões já existentes dos utilizadores inscritos.';
...
$string['copyprogressheading'] = 'Cópia das disciplinas em execução';
...
$string['generalpermissions'] = 'Incluir substituição de permissões';
...
$string['keep'] = 'Manter';
$string['keptroles'] = 'Incluir inscrições dos papeis';
$string['keptroles_help'] = 'Os utilizadores com os papeis selecionados serão inscritos na nova disciplina. Nenhum dado do utilizador será copiado, a menos que a opção \'Incluir dados do utilizador\' esteja ativada.';
...
$string['rootsettingpermissions'] = 'Incluir substituição de permissões';
...
$string['skipmodifprevhelp'] = 'Selecione se as disciplinas que não foram modificadas desde a última cópia de segurança devem ser, ou não, ignoradas. Esta ação requer a ativação do registo de atividade.';
...
$string['userdata'] = 'Incluir os dados do utilizador';
$string['userdata_help'] = 'Se ativar esta opção, dados como publicações no fórum, submissões de trabalhos, etc. serão copiados para a nova disciplina para qualquer utilizador com o papel selecionado em \'Incluir inscrições do papel\'.';
