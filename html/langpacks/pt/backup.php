...
$string['asyncemailenable'] = 'Ativar notificações';
$string['asyncemailenabledetail'] = 'Se ativar esta opção, os utilizadores receberão uma notificação quando um restauro/cópia de segurança assíncrona for concluída.';
$string['asyncgeneralsettings'] = 'Restauro/cópia de segurança assíncrona';
$string['asyncmessagebody'] = 'Notificação';
...
$string['asyncmessagebodydetail'] = 'Notificação a enviar quando um restauro/cópia de segurança assíncrona for concluída.';
$string['asyncmessagesubject'] = 'Assunto';
$string['asyncmessagesubjectdefault'] = '\'{operation}\' Moodle concluída com sucesso';
$string['asyncmessagesubjectdetail'] = 'Assunto da notificação';
...
$string['asyncrestoreinprogress_help'] = 'Os restauros assíncronos de disciplinas em andamento são mostrados aqui.';
...
$string['automatedminkepthelp'] = 'Caso as cópias de segurança com mais do que um determinado intervalo de tempo sejam apagadas, poderão ocorrer casos de disciplinas que se encontram inativas ficarem sem cópias de segurança. Para prevenir isto, deverá definir qual o número mínimo de cópias de segurança a manter.';
...
$string['backupfile'] = 'Ficheiro de cópia de segurança';
...
$string['backupthenrestore'] = 'Cópia de segurança completa. Iniciar para restaurar.';
...
$string['choosefilefromactivitybackup_help'] = 'Ficheiros de cópias de segurança desta atividade.';
$string['choosefilefromautomatedbackup'] = 'Cópias de segurança automáticas';
$string['choosefilefromautomatedbackup_help'] = 'Ficheiros de cópias de segurança realizadas automaticamente.';
$string['choosefilefromcoursebackup'] = 'Cópias de segurança de disciplina';
$string['choosefilefromcoursebackup_help'] = 'Ficheiros de cópias de segurança desta disciplina.';
$string['choosefilefromuserbackup'] = 'Área de cópias de segurança privadas';
$string['choosefilefromuserbackup_help'] = 'Ficheiros de cópias de segurança privadas de disciplinas, com informação dos utilizadores anónima.';
...
$string['configgeneralcustomfield'] = 'Define a predefinição para incluir campos personalizados nas cópias de segurança.';
...
$string['configgeneralxapistate'] = 'Define a predefinição para incluir nas cópias de segurança o estado do utilizador no conteúdo, como por exemplo, nas atividades H5P.';
...
$string['configloglifetime'] = 'Intervalo de tempo durante o qual pretende manter os registos de atividade (logs) das cópias de segurança. Os registos mais antigos do que o definido são automaticamente apagados. Recomenda-se manter este valor baixo porque a quantidade de registos de atividade relativos às cópias pode ser enorme.';
...
$string['configrestorecustomfield'] = 'Define a predefinição para restaurar campos personalizados.';
...
$string['configrestorexapistate'] = 'Define a predefinição para restaurar das cópias de segurança o estado do utilizador no conteúdo, como por exemplo, nas atividades H5P.';
...
$string['copycoursedesc'] = 'Criar uma cópia desta disciplina em qualquer categoria de disciplinas.';
...
$string['enableasyncbackup'] = 'Ativar cópias de segurança assíncronas';
$string['enableasyncbackup_help'] = 'Se ativar esta opção, todas as operações de cópia de segurança e de restauro serão executadas de forma assíncrona. Isto proporciona uma melhor experiência ao utilizador, permitindo que os utilizadores executem outras operações enquanto uma cópia de segurança ou um restauro está em andamento. Isto não afeta as importações e exportações.';
...
$string['generalcustomfield'] = 'Incluir campos personalizados';
...
$string['generalxapistate'] = 'Incluir o estado do utilizador no conteúdo';
...
$string['importfile'] = 'Carregar um ficheiro de cópia de segurança';
$string['importfromccmidtocourse'] = 'Importar de cmid: {$a->srccmid} para a disciplina: {$a->dstcourseid}';
$string['importfromcoursetocourse'] = 'Importar da disciplina: {$a->srccourseid} para a disciplina: {$a->dstcourseid}';
...
$string['managefiles_activity'] = 'Gerir cópias de segurança da atividade';
$string['managefiles_automated'] = 'Gerir cópias de segurança automáticas';
$string['managefiles_backup'] = 'Gerir cópias de segurança privadas';
$string['managefiles_course'] = 'Gerir cópias de segurança da disciplina';
...
$string['questioncannotberestored'] = 'As perguntas "{$a->name}" não podem ser criadas por restauro';
...
$string['restorenofilesbackuparea'] = 'Nenhum ficheiro de cópia de segurança.';
$string['restorenofilesbackuparea_activity'] = 'Nenhum ficheiro de cópia de segurança desta atividade.';
$string['restorenofilesbackuparea_automated'] = 'Nenhum ficheiro de cópia de segurança automática.';
$string['restorenofilesbackuparea_backup'] = 'Nenhum ficheiro de cópia de segurança privada.';
$string['restorenofilesbackuparea_course'] = 'Nenhum ficheiro de cópia de segurança desta disciplina.';
