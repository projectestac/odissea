...
$string['defaultheadingsub'] = 'Predefenições';
...
$string['resetalltogglealignment_help'] = 'Repõe o alinhamento dos botões de modo a respeitar o valor predefinido do site.';
