...
/**
 * Strings for component 'tool_langimport', language 'pt', version '4.5'.
 *
...
$string['langpacknotremoved'] = 'Ocorreu um erro: o pacote linguístico \'{$a}\' não foi completamente desinstalado. Verifique as permissões do ficheiro.';
...
$string['noenglishuninstall'] = 'O pacote linguístico Inglês não pode ser desinstalado.';
$string['noenglishuninstalltitle'] = 'Não é possível desinstalar';
