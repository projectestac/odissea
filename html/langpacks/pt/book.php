...
/**
 * Strings for component 'book', language 'pt', version '4.5'.
 *
 * @package     book
 * @category    string
...
* Disponibilizar material para leitura nas diferentes unidades de aprendizagem;
* Disponibilizar um manual com várias páginas;
* Disponibilizar um portefólio com trabalhos do aluno.';
...
$string['removeallbooktags'] = 'Todas as palavras-chave do livro';
