...
/**
 * Strings for component 'tool_cohortroles', language 'pt', version '4.5'.
 *
...
$string['backgroundsync'] = 'Nota: As novas atribuições de papéis do Grupo global não terão efeito imediato. As mudanças na atribuição de papéis serão efetuadas por uma tarefa agendada.';
...
$string['existingcohortroles'] = 'Atribuições de papéis do Grupo global existentes';
$string['managecohortroles'] = 'Atribuir papéis de utilizador ao Grupo global';
$string['noassignableroles'] = 'Atualmente, não existem papéis que possam ser atribuidos no contexto de utilizador. <a href="../../roles/manage.php">Gerir papéis</a>';
$string['nocohortroleassignmentssaved'] = 'Nenhuma atribuição de papéis do Grupo global foi guardada.';
$string['onecohortroleassignmentsaved'] = 'Foi guardada uma atribuição de papel do Grupo global.';
$string['pluginname'] = 'Gestão dos papéis do Grupo global';
...
$string['privacy:metadata:tool_cohortroles:id'] = 'O ID do registo do mapeamento de papel no Grupo global';
$string['privacy:metadata:tool_cohortroles:roleid'] = 'ID do papel';
$string['privacy:metadata:tool_cohortroles:timecreated'] = 'Data e hora em que o mapeamento de papéis ao Grupo global foi criado';
$string['privacy:metadata:tool_cohortroles:timemodified'] = 'A data e hora em que o mapeamento de papéis do Grupo global foi modificado';
$string['privacy:metadata:tool_cohortroles:userid'] = 'ID do utilizador';
$string['privacy:metadata:tool_cohortroles:usermodified'] = 'O ID do utilizador que modificou pela última vez o mapeamento de papéis ao Grupo global.';
