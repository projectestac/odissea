...
/**
 * Strings for component 'repository', language 'pt', version '4.5'.
 *
 * @package     repository
 * @category    string
...
$string['confirmdelete'] = 'Tem a certeza de que pretende apagar o repositório "{$a}"? Se escolher "Continuar e Descarregar", as referências a ficheiros com conteúdo externo serão descarregadas para o Moodle. Esta opção poderá demorar bastante tempo ser processada.';
...
$string['confirmdeleteselectedfile'] = 'Tem a certeza de que pretende apagar os ({$a}) ficheiros selecionados ?';
$string['confirmremove'] = 'Tem a certeza de que pretende apagar o módulo de repositório, incluindo as suas configurações e <strong>todas as suas instâncias</strong> - {$a}? Se escolher "Continuar e Descarregar", as referências a ficheiros com conteúdo externo serão descarregadas para o Moodle. Esta opção poderá demorar bastante tempo ser processada.';
...
$string['filenotnull'] = 'Tem de escolher um ficheiro para carregar.';
...
$string['makefilecontrolledlink'] = 'Criar um atalho de acesso controlado ao ficheiro';
...
$string['popupblockeddownload'] = 'A janela para descarregar está bloqueada. Desbloqueie as janelas pop-up no navegador e tente novamente.';
...
$string['uploaderror'] = 'Ocorreu um erro ao carregar o ficheiro';
