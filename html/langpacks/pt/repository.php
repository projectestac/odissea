...
/**
 * Strings for component 'repository', language 'pt', branch 'MOODLE_38_STABLE'
 *
 * @package   repository
...
$string['confirmdelete'] = 'Tem a certeza de que pretende apagar o repositório "{$a}"? Se escolher a opção "Continuar e descarregar", referências a ficheiros com conteúdo externo serão descarregadas para o Moodle. Esta opção poderá demorar bastante tempo a processar.';
$string['confirmdeletefile'] = 'Tem a certeza de que pretende apagar este ficheiro?';
$string['confirmdeletefilewithhref'] = 'Tem a certeza de que pretende apagar este ficheiro? Existem {$a} ligações que usam este ficheiro como origem. Se continuar, as ligações serão convertidas em cópias.';
...
$string['confirmrenamefile'] = 'Tem a certeza de que pretende renomear/mover este ficheiro? Existem {$a} ligações que usam este ficheiro como origem. Se continuar, as ligações serão convertidas em cópias.';
$string['confirmrenamefolder'] = 'Tem a certeza de que pretende renomear/mover esta pasta? Se continuar os ficheiros ligados a estes serão convertidos em cópias..';
...
$string['emptytype'] = 'Não foi possível criar o tipo de repositório: o nome do tipo está vazio';
...
$string['fileexists'] = 'O nome do ficheiro já está a ser usado. Por favor, selecione um nome diferente.';
