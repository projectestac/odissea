...
/**
 * Strings for component 'admin', language 'pt', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['configallowcoursethemes'] = 'Se ativar esta opção, será possível definir o tema de uma disciplina. O tema da disciplina prevalece sobre outras definições de tema (tema do site, do utilizador ou temas da sessão)';
...
$string['configenablesafebrowserintegration'] = 'Adicionar a opção \'Forçar Safe Exam Browser\' ao campo \'Segurança do Navegador\' na página de configurações da atividade Teste. Para mais informações, consulte a página <a href="https://www.safeexambrowser.org/" target="_blank">https://www.safeexambrowser.org/</a>.';
...
$string['configmessagingdefaultpressenter'] = 'Se \'Enter para enviar\' está ativado por predefinição nas configurações das mensagens dos utilizadores.';
...
$string['croninfrequent'] = 'O intervalo de tempo entre as duas últimas execuções do script de manutenção \'cron.php\' foi maior que {$a} segundos. Recomendamos que altere as configurações para que seja executado com maior frequência.';
...
$string['noreplydomaindetail'] = 'Configurações do endereço \'Não responder\' e domínios permitidos';
...
$string['purgeselectedcaches'] = 'Limpar caches selecionadas';
...
$string['settingdependenton'] = 'Esta configuração pode estar oculta, com base no valor de <strong>{$a}</strong>';
...
$string['task_adhoc_concurrency_limit'] = 'Limite de simultaneidade da tarefa ad hoc';
$string['task_adhoc_concurrency_limit_desc'] = 'O número permitido de execuções em simultâneo da tarefa ad hoc. Se o limite for alto, as tarefas agendadas poderão não ser executadas regularmente quando houver muitas tarefas ad hoc. Uma configuração de 0 desativará completamente o processamento de tarefas ad hoc.';
$string['task_adhoc_max_runtime'] = 'Duração da tarefa ad hoc';
$string['task_adhoc_max_runtime_desc'] = 'A duração de execução da tarefas ad hoc antes de ser dispensada. É recomendada uma duração baixa, pois não há limite para o número de tarefas ad hoc em fila. Se este número for muito alto e tiver uma fila de tarefas ad hoc grande, as tarefas agendadas poderão não ser executadas regularmente.';
...
$string['task_logmode_all'] = 'Armazenar a saída de registos de todos os trabalhos';
$string['task_logmode_desc'] = 'Pode escolher quando pretende que ocorra o registo de tarefas. Por predefinição, os registos são sempre capturados. Pode desativar completamente o registo ou alterar para apenas registar as tarefas que falharam.';
$string['task_logmode_failonly'] = 'Armazenar apenas registos para trabalhos que falharam';
...
$string['taskquestioncron'] = 'Processamento em segundo plano para limpeza das pré-visualizações de perguntas antigas';
$string['taskquestionstatscleanupcron'] = 'Processamento em segundo plano para limpeza da cache de estatísticas de perguntas antigas';
...
$string['task_scheduled_concurrency_limit'] = 'Limite de simultaneidade da tarefa agendada';
$string['task_scheduled_concurrency_limit_desc'] = 'O número de execuções da tarefa agendada que podem ser ocorrer simultaneamente. Se o limite for alto, o servidor poderá sofrer uma sobrecarga, o que irá afetar o desempenho. Uma configuração de 0 desativará completamente o processamento de tarefas agendadas.';
$string['task_scheduled_max_runtime'] = 'Tempo máxima para a execução da tarefa agendada';
$string['task_scheduled_max_runtime_desc'] = 'A duração de execução de uma tarefa agendada antes de ser dispensada.';
...
$string['testoutgoingmailconf_errorcommunications'] = 'O Moodle não conseguiu comunicar com o seu servidor de e-mail. Comece por verificar a configuração das mensagens de saída do Moodle.';
$string['testoutgoingmailconf_message'] = 'Esta é uma mensagem de teste. Por favor, não a considere. Se recebeu este e-mail, significa que configurou com sucesso as configurações de e-mail do seu site Moodle.';
...
$string['testoutgoingmaildetail'] = 'Antes de testar é necessário guardar a configuração.<br />{$a}';
...
Este aviso é frequentemente causado quando um pacote do Moodle é extraído de uma pasta comprimida (zip ou tgz) na mesma pasta de uma versão anterior do Moodle. Apesar disto ser aceitável para atualizações menores, é altamente desaconselhável em atualizações maiores do Moodle.
