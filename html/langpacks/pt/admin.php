...
/**
 * Strings for component 'admin', language 'pt', version '4.5'.
 *
 * @package     admin
 * @category    string
...
$string['configallowcoursethemes'] = 'Se ativar esta opção, será possível definir o tema de uma disciplina. O tema da disciplina prevalece sobre outras configurações do tema (tema do site, do utilizador, da categoria, do Grupo global ou temas definidos por URL).';
...
$string['configrecaptchapublickey'] = 'Sequência de caracteres (chave pública) utilizada para exibir o elemento reCAPTCHA no formulário de registo e no formulário de suporte do site. As chaves reCAPTCHA podem ser obtidas em <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['doesnotfitdetail'] = 'Mostrar configurações para os e-mails enviados pelo Moodle';
...
$string['geopluginapikey_desc'] = 'A chave API utilizada para aceder ao serviço GeoPlugin. Obtenha a sua própria chave em <a href="https://www.geoplugin.com/" target="_blank">geoplugin.com</a>.';
...
$string['loginpageautofocus'] = 'Foco automático do formulário da página de autenticação';
$string['loginpageautofocus_help'] = 'Se ativar esta opção, será melhorada a usabilidade da página de autenticação, mas o foco automático dos campos do formulário pode ser considerado desfavorável em termos de acessibilidade.';
...
$string['oracledatabaseinuse'] = 'O suporte para Oracle DB será removido. A versão 4.5 do Moodle será a última versão que suportará Oracle DB. Para mais detalhes, consulte o anúncio em moodle.org: <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank>Oracle database support in LMS deprecation</a>.';
...
$string['recaptchapublickey'] = 'Chave reCAPTCHA do site';
...
$string['riskmanagetrust'] = 'Os utilizadores poderiam alterar as configurações de conteúdo fiável de outros utilizadores';
