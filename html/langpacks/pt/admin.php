...
/**
 * Strings for component 'admin', language 'pt', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['configsmtpoauthservice'] = 'Selecione o serviço OAuth 2 que está configurado para comunicar com o servidor SMTP. Se o serviço ainda não existir, é necessário criá-lo. Tenha em atenção que é necessário configurar o tipo de autenticação SMTP para o XOAUTH2.';
...
$string['coursepage'] = 'Página da disciplina';
...
$string['iplookupinfo'] = 'O servidor online gratuito NetGeo é usado para procurar localizações de endereços IP. A base de dados já não é mantida e pode retornar dados incorretos. Recomenda-se a instalação de uma cópia local da base de dados gratuita GeoLite2 City da MaxMind.<br />
Se for fornecida uma chave Google Maps API V3, a localização do endereço IP será exibida usando o Google Maps. É necessária uma conta do Google e obter uma chave API do Google Maps. Se não  for fornecida uma chave Google Maps API V3, a localização do endereço IP será exibida usando o OpenStreetMap.';
...
$string['resetindentation'] = 'Repor indentação';
$string['resetindentation_help'] = 'Irá remover qualquer indentação anteriormente definida para disciplina em {$a->format}.';
$string['resetindentation_title'] = 'Repor indentação na página da disciplina?';
...
$string['tasklockcleanuptask'] = 'Limpar metadados da tarefas ad hoc';
...
$string['testoutgoingmailconf_fromemail_invalid'] = 'De contém um nome de utilizador ou e-mail inválido. Tem de ser um formato de e-mail válido ou um nome de utilizador existente no Moodle.';
...
$string['testoutgoingmailconf_subject'] = '{$a}: mensagem de teste. {$a->additional} Enviada: {$a->time}';
...
$string['unsupportedphpversion82'] = 'Versão 8.2 e superior do PHP não são suportadas.';
