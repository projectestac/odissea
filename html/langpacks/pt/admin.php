...
$string['configfullnamedisplay'] = 'Define como são mostrados os nomes completos, que na generalidade dos sites o formato mais comum é "nome + apelido". No entanto, é possível ocultar o apelido ou mostrar de acordo com o critério definido no pacote linguístico do idioma que estiver a ser usado (alguns idiomas têm convenções diferentes).
...
$string['confighiddenuserfields'] = 'Selecione os campos de informação do utilizador que pretende ocultar dos outros utilizadores, que não os professores e administradores. Isto aumentará a privacidade dos alunos. No Windows, pressione a tecla CTRL para selecionar vários campos.';
...
$string['configthemelist'] = 'Deixe vazio para permitir que qualquer tema válido seja utilizado. Se pretender encurtar o menu dos temas disponíveis, especifique aqui uma lista de nomes de temas separados por vírgulas (Não use espaços!). Exemplo: standard,orangewhite.';
...
$string['sitepolicy_help'] = 'URL da política do site que todos os utilizadores registados devem ver e concordar antes de acederem ao site. Tenha em atenção que esta configuração apenas terá efeito se o \'Controlador de políticas do site\' estiver definido como \'Predefinido (core)\'';
$string['sitepolicyguest'] = 'URL da política do site para visitantes';
$string['sitepolicyguest_help'] = 'O URL da política do site que todos os visitantes devem ver e concordar antes de acederem ao site. Tenha em atenção que esta configuração apenas terá efeito se o \'Controlador de políticas do site\' estiver definido como \'Predefinido (core)\'';
