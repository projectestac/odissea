...
/**
 * Strings for component 'tool_dataprivacy', language 'pt', version '4.5'.
 *
...
$string['dataretentionexplanation'] = 'Esta página mostra as categorias e finalidades predefinidas para reter dados do utilizador. Certas áreas podem ter categorias e finalidades mais específicas do que as listadas aqui.';
...
$string['defaultsinfo'] = 'As categorias e as finalidades predefinidas são aplicadas a todas as novas ou já existentes instâncias em que nenhum valor está definido.';
...
$string['errorinvalidrequeststatus'] = 'Estado da solicitação inválido!';
...
$string['gdpr_art_6_1_a_name'] = 'Consentimento (RGPD Art.º 6.º 1(a))';
...
$string['gdpr_art_6_1_b_name'] = 'Contrato (RGPD Art.º 6.º 1(b))';
...
$string['gdpr_art_6_1_c_name'] = 'Obrigação jurídica (RGPD Art.º 6.º 1(c))';
...
$string['gdpr_art_6_1_d_name'] = 'Interesses vitais (RGPD Art.º 6.º 1(d))';
...
$string['gdpr_art_6_1_e_name'] = 'Funções de interesse público (RGPD Art.º 6.º 1(e))';
$string['gdpr_art_6_1_f_description'] = 'O tratamento é necessário para efeito dos interesses legítimos prosseguidos pelo responsável pelo tratamento ou por terceiros, exceto se prevalecerem os interesses ou direitos e liberdades fundamentais do titular que exijam a proteção dos dados pessoais, em especial se o titular for um menor';
$string['gdpr_art_6_1_f_name'] = 'Interesses legítimos (RGPD Art.º 6.º 1(f))';
...
$string['gdpr_art_9_2_a_name'] = 'Consentimento explícito (RGPD Art.º 9.º 2(a))';
...
$string['gdpr_art_9_2_b_name'] = 'Legislação de segurança/proteção social (RGPD Art.º 9.º 2(b))';
...
$string['gdpr_art_9_2_c_name'] = 'Proteção dos interesses vitais (RGPD Art.º 9.º 2(c))';
...
$string['gdpr_art_9_2_d_name'] = 'Atividades legítimas relativas a membros de fundação, associação ou outro organismo sem fins lucrativos (RGPD Art.º 9.º 2(d))';
...
$string['gdpr_art_9_2_e_name'] = 'Dados tornados públicos pelo titular (RGPD Art.º 9.º 2(e))';
...
$string['gdpr_art_9_2_f_name'] = 'Processo judicial (RGPD Art.º 9.º 2(f))';
...
$string['gdpr_art_9_2_i_name'] = 'Saúde pública (RGPD Art.º 9.º 2(i))';
...
$string['privacyrequestexpiry_desc'] = 'O intervalo de tempo durante o qual as solicitações de dados aprovadas estarão disponíveis para transferência antes de expirarem. Se definido como zero, não há limite de tempo.';
$string['protected'] = 'Protegido';
$string['protectedlabel'] = 'A retenção destes dados tem um precedente legal mais elevado do que o pedido do utilizador para ser esquecido. Estes dados serão apagados após o período de retenção ter expirado.';
$string['purpose'] = 'Finalidade';
$string['purpose_help'] = 'A finalidade descreve a razão para processar os dados. Uma nova finalidade pode ser adicionada ou, se estiver selecionado herdar, é aplicada a finalidade de um contexto superior. Os contextos são (do nível mais baixo para o mais alto): Blocos > Módulos de atividade > Disciplinas > Categorias de disciplinas > Utilizador > Site.';
$string['purposecreated'] = 'Finalidade criada';
$string['purposedefault'] = 'Finalidade predefinida';
$string['purposedefault_help'] = 'A finalidade predefinida é a finalidade aplicada a qualquer nova instância. Se estiver selecionado herdar, é aplicada a finalidade de um contexto superior. Os contextos são (do nível mais baixo para o mais alto): Blocos > Módulos de atividade > Disciplinas > Categorias de disciplinas > Utilizador > Site.';
...
$string['requestcomments_help'] = 'Esta caixa permite que indique mais detalhes sobre a sua solicitação de dados.';
...
$string['requesttype_help'] = 'Selecione o motivo pelo qual gostaria de contactar o responsável pela privacidade. Tenha em atenção que a eliminação de todos os dados pessoais resultará na impossibilidade de se autenticar no site.';
...
* a data/hora da última autenticação do utilizador é comparada com o período de retenção dos utilizadores,
e
...
Se a disciplina não tiver data de fim e esta configuração estiver ativa, o utilizador não poderá ser apagado.';
...
$string['sensitivedatareasons_help'] = 'Selecione uma ou mais razões que isentam a proibição de tratamento de dados pessoais sensíveis relativas a esta finalidade. Para mais informações, consulte o n.º 2 do Art.º 9.º do RGPD';
...
$string['subjectscope_help'] = 'O âmbito do assunto lista os papéis que podem ser atribuídos neste contexto.';
...
$string['userlistexplanation'] = 'Este módulo tem um fornecedor base mas deve implementar também o fornecedor da lista de utilizadores para suporte total da funcionalidade de privacidade.';
$string['userlistnoncompliant'] = 'Falta o fornecedor da lista de utilizadores';
