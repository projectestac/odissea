...
$string['privacyrequestexpiry_desc'] = 'O período de tempo durante o qual as solicitações de dados aprovadas estarão disponíveis para transferência antes de expirarem. Se definido como zero, não há limite de tempo.';
...
$string['requesttype_help'] = 'Selecione o motivo pelo qual gostaria de entrar em contacto com o responsável pela privacidade. Tenha em atenção que a eliminação de todos os dados pessoais resultará na impossibilidade de se autenticar no site.';
