...
/**
 * Strings for component 'auth_mnet', language 'pt', version '4.5'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:city'] = 'A cidade do utilizador.';
$string['privacy:metadata:mnet_external:country'] = 'O país em que o utilizador está.';
$string['privacy:metadata:mnet_external:currentlogin'] = 'A autenticação atual deste utilizador.';
$string['privacy:metadata:mnet_external:department'] = 'O departamento em que este utilizador pode ser encontrado.';
$string['privacy:metadata:mnet_external:description'] = 'Detalhes gerais sobre este utilizador.';
$string['privacy:metadata:mnet_external:email'] = 'Um endereço de e-mail para contacto.';
$string['privacy:metadata:mnet_external:emailstop'] = 'Uma preferência para parar o envio de e-mails ao utilizador.';
$string['privacy:metadata:mnet_external:firstaccess'] = 'A data/hora em que este utilizador acedeu pela primeira vez ao site.';
$string['privacy:metadata:mnet_external:firstname'] = 'O nome do utilizador.';
$string['privacy:metadata:mnet_external:firstnamephonetic'] = 'Os detalhes fonéticos sobre o nome do utilizador.';
$string['privacy:metadata:mnet_external:id'] = 'ID do utilizador';
$string['privacy:metadata:mnet_external:idnumber'] = 'Um número de identificação atribuído pela instituição';
$string['privacy:metadata:mnet_external:imagealt'] = 'Texto alternativo para a imagem do utilizador.';
$string['privacy:metadata:mnet_external:institution'] = 'A instituição de que este utilizador é membro';
$string['privacy:metadata:mnet_external:lang'] = 'A preferência do utilizador para o idioma exibido.';
$string['privacy:metadata:mnet_external:lastaccess'] = 'A data e hora em que o utilizador acedeu pela última vez ao site.';
...
$string['privacy:metadata:mnet_external:maildisplay'] = 'A preferência de utilizador sobre a exibição do seu e-mail para outros utilizadores.';
$string['privacy:metadata:mnet_external:middlename'] = 'O nome do meio do utilizador';
$string['privacy:metadata:mnet_external:phone1'] = 'O número de telefone do utilizador.';
$string['privacy:metadata:mnet_external:phone2'] = 'Um número de telefone adicional do utilizador.';
$string['privacy:metadata:mnet_external:picture'] = 'Os detalhes de imagem associada a este utilizador.';
$string['privacy:metadata:mnet_external:policyagreed'] = 'A marca para indicar se o utilizador concordou com a política do site.';
$string['privacy:metadata:mnet_external:suspended'] = 'A marca para indicar se o utilizador foi suspenso deste sistema.';
...
$string['privacy:metadata:mnet_log:action'] = 'Ações levadas executadas pelo utilizador.';
$string['privacy:metadata:mnet_log:cmid'] = 'O ID do módulo da disciplina.';
$string['privacy:metadata:mnet_log:course'] = 'ID da disciplina do sistema remoto onde a ação ocorreu.';
$string['privacy:metadata:mnet_log:coursename'] = 'O nome completo da disciplina do sistema remoto onde a ação ocorreu.';
...
$string['privacy:metadata:mnet_log:ip'] = 'O endereço IP utilizado no momento em que a ação ocorreu.';
$string['privacy:metadata:mnet_log:module'] = 'O módulo do sistema remoto onde a ação ocorreu.';
$string['privacy:metadata:mnet_log:remoteid'] = 'ID remoto do utilizador que executou a ação no sistema remoto.';
$string['privacy:metadata:mnet_log:time'] = 'A data/hora em que a ação ocorreu.';
$string['privacy:metadata:mnet_log:url'] = 'URL do sistema remoto em que a ação ocorreu.';
$string['privacy:metadata:mnet_log:userid'] = 'ID local do utilizador que executou a ação.';
$string['privacy:metadata:mnet_session'] = 'Os detalhes de sessão de cada utilizador MNet num sistema remoto. Os dados são armazenados temporariamente.';
$string['privacy:metadata:mnet_session:expires'] = 'A  data/hora a que a sessão expira.';
$string['privacy:metadata:mnet_session:mnethostid'] = 'ID Mnet do sistema remoto.';
$string['privacy:metadata:mnet_session:token'] = 'Identificador de sessão exclusivo';
$string['privacy:metadata:mnet_session:useragent'] = 'User agent utilizado para aceder ao sistema remoto.';
$string['privacy:metadata:mnet_session:userid'] = 'ID do utilizador a mudar para o sistema remoto.';
