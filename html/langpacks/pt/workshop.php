...
$string['clearassessments_help'] = 'As notas calculadas para os trabalhos e avaliações serão apagadas. As informações introduzidas nas grelhas de avaliação serão guardadas, mas todos os avaliadores devem abrir a grelha de avaliação e submeter novamente para que as notas sejam calculadas de novo.';
...
$string['privacy:metadata:feedbackreviewerformat'] = 'Formato do texto do feedback do utilizador que fornece esta avaliação';
