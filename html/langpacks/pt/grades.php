...
$string['hidden_help'] = 'Se selecionar esta opção, as notas ficam ocultas para os alunos. Se pretender, pode definir uma data até à qual as notas estão ocultas enquanto termina o processo de avaliação.';
...
$string['overridesitedefaultgradedisplaytype_help'] = 'Se selecionar esta opção, as notas alfabéticas e os limites de intervalos para a disciplina podem ser configuradas, ao invés de serem usadas as configurações predefinidas do site.';
...
$string['selectuserlink'] = 'Selecione um utilizador';
