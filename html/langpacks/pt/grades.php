...
$string['addidnumbers'] = 'Adicionar número de identificação (ID)';
...
Esta opção determina se as notas vazias não são incluídas nos cálculos ou se são consideradas como nota mínima daquele item de avaliação. Por exemplo, se o aluno não tem nota num trabalho cuja nota varia entre 0 e 100, a nota considerada será 0.';
...
$string['aggregatesonly'] = 'Mostrar apenas os totais';
...
$string['aggregation_help'] = 'A forma de cálculo determina como é calculada a nota total da categoria, que pode ser:
...
$string['aggregationcoefextrasum_help'] = 'Se a opção \'Crédito extra\' está ativada, a nota máxima do item de avaliação não é adicionada à nota máxima da categoria, resultando na possibilidade de atingir a nota máxima (ou notas acima do máximo, se ativado pelo administrador) na categoria sem ter a nota máxima em todos os itens.';
$string['aggregationcoefextrasum_link'] = 'nota/cálculo';
$string['aggregationcoefextrasumabbr'] = '+';
$string['aggregationcoefextraweight'] = 'Peso do crédito extra';
$string['aggregationcoefextraweight_help'] = 'Se o crédito extra está configurado para um valor maior que 0, a nota comporta-se como crédito extra no cálculo. O número é o fator pelo qual a nota é multiplicada antes de adicioná-la ao total após o cálculo da média.';
...
$string['aggregationposition_help'] = 'Esta opção determina se as colunas \'Total da categoria\' e \'Total da disciplina\' são exibidas no primeiro ou no último lugar da pauta.';
$string['aggregationsvisible'] = 'Tipos de cálculo disponíveis';
$string['aggregationsvisiblehelp'] = 'Escolha os tipos de cálculo que estarão disponíveis para uso na pauta. Mantenha a tecla Ctrl pressionada para selecionar múltiplos itens.';
$string['allgrades'] = 'Todas as notas por categoria';
$string['allstudents'] = 'Todos os alunos';
$string['allusers'] = 'Todos os utilizadores';
$string['aria-toggledropdown'] = 'Alternar a seguinte lista pendente';
$string['aria:dropdowngrades'] = 'Encontrados elementos de avaliação';
$string['autosort'] = 'Ordenar de forma automática';
$string['availableidnumbers'] = 'Número de identificação (ID) disponíveis';
...
$string['badgrade'] = 'A nota indicada é inválida';
...
$string['calculationwarning'] = 'Esta categoria usa um cálculo de nota para o total da categoria em vez de uma agregação.';
...
$string['deletescale'] = 'Apagar escala';
...
$string['errorcalculationbroken'] = 'Erro no cálculo do item de avaliação \'{$a}\'.';
...
$string['erroroverweight'] = 'O peso total excede os 100%.';
...
$string['errorunderweight'] = 'O peso total é menor que 100%.';
...
$string['eventgradeexported'] = 'Nota exportada';
...
$string['excluded_help'] = 'Se ativar esta opção, a nota não será incluída em nenhum cálculo.';
...
$string['finalgrade_help'] = 'Se a opção \'Ajustar nota\' está ativada, pode inserir ou alterar a nota.';
...
$string['gradebooknavigationmenu'] = 'Menu de navegação da pauta';
...
$string['gradecategoryonmodform_help'] = 'Esta opção especifica a categoria em que a nota desta atividade é inserida na pauta.';
$string['gradecategorysettings'] = 'Configurações da categoria da pauta';
...
$string['gradeexportcustomprofilefields'] = 'Campos de perfil personalizados na exportação das notas';
...
$string['gradehistorylifetime_help'] = 'Isto especifica o intervalo de tempo durante o qual pretende manter o histórico das alterações nas tabelas relacionadas com a pauta. Recomenda-se que mantenha o maior tempo possível. Se tiver problemas de desempenho ou espaço limitado na base de dados, tente selecionar um valor mais baixo.';
...
$string['grademax_help'] = 'Esta opção determina a nota máxima quando são usados valores nas notas. A nota máxima de uma atividade é determinada na respetiva página de configurações.';
...
$string['gradepassgreaterthangrade'] = 'A nota de aprovação não pode ser maior que a nota máxima ({$a})';
...
$string['gradesonly'] = 'Mostrar apenas as notas';
$string['gradessettings'] = 'Configurações da nota';
...
$string['hidden_help'] = 'Se ativar esta opção, as notas ficam ocultas para os alunos. Se pretender, pode definir uma data até à qual as notas estão ocultas enquanto termina o processo de avaliação.';
...
$string['hidetotalifhiddenitems_help'] = 'Esta opção especifica se os totais com notas ocultas são, ou não, mostrados aos alunos ou substituídos por um hífen (-). Se mostrados, o total pode ser calculado excluindo ou incluindo os itens ocultos.
...
$string['idnumbers'] = 'Número de identificação (ID)';
...
Selecione e copie as colunas que pretende importar da folha de cálculo e cole-as neste campo.';
...
$string['importsettings'] = 'Configurações da importação';
...
$string['iteminfo_help'] = 'Use este campo para inserir mais informações sobre o item de avaliação. Esta informação não é exibida em nenhum outro lugar.';
...
$string['lessthanmin'] = 'A nota inserida em {$a->itemname} para {$a->username} é inferior ao mínimo permitido';
...
$string['linktoactivity'] = 'Atividade {$a->name} {$a->title}';
$string['lock'] = 'Bloquear';
$string['locked'] = 'Bloquear';
$string['locked_help'] = 'Se ativar esta opção, as notas deixam de ser atualizadas automaticamente através da atividade.';
...
$string['manageoutcomes'] = 'Gerir resultados da aprendizagem';
...
$string['minmaxtouse_help'] = 'Esta configuração determina se deve, ou não, utilizar as notas mínimas e máximas iniciais quando a nota foi atribuída, ou as notas mínimas e máximas especificadas nas configurações para o item de avaliação no momento em que a nota é mostrada na pauta.';
...
$string['missingitemtypeoreid'] = 'O índice do array (itemtype ou eid) está em falta';
...
$string['morethanmax'] = 'A nota inserida em {$a->itemname} para {$a->username} é superior ao máximo permitido';
$string['moveselectedto'] = 'Mover itens selecionados para:';
$string['movesitems'] = 'Mover itens';
...
$string['nocategoryname'] = 'Não foi inserido um nome para a categoria.';
$string['nocategoryview'] = 'Não existem categorias';
$string['nocourses'] = 'Não há disciplinas para mostrar';
$string['noexistingoutcomes'] = 'Não existem resultados da aprendizagem.';
$string['noexistingscales'] = 'Não existem escalas.';
...
$string['noidnumber'] = 'Sem número de identificação (ID)';
$string['nolettergrade'] = 'Não há Notas alfabéticas para';
$string['nomode'] = 'ND';
$string['nonnumericweight'] = 'Recebido valor não numérico para';
$string['nonunhideableverbose'] = 'Para mostrar esta nota, tem de desocultar \'{$a->itemname}\'.';
$string['nonunlockableverbose'] = 'Para desbloquear esta nota, tem de desbloquear \'{$a->itemname}\'.';
...
$string['notteachererror'] = 'Tem de ser professor para usar esta funcionalidade.';
...
$string['outcomesdisabled'] = 'Os resultados da aprendizagem não estão ativos';
...
$string['overridden_help'] = 'Se ativar esta opção, a nota deixa de ser alterada pela atividade.

Quando uma nota é ajustada na pauta, esta caixa de seleção é ativada automaticamente. No entanto, pode ser desativada para que a nota volte a depender da atividade.';
...
$string['overridesitedefaultgradedisplaytype_help'] = 'Se ativar esta opção, as notas alfabéticas e os limites de intervalos para a disciplina podem ser configuradas, ao invés de serem usadas as configurações predefinidas do site.';
...
$string['privacy:metadata:grades:timemodified'] = 'A data e hora em que a avaliação foi modificada pela última vez';
...
$string['privacy:metadata:history:timemodified'] = 'A data e hora em que a versão da nota ocorreu';
...
$string['privacy:metadata:outcomes:timemodified'] = 'A data e hora em que o resultado de aprendizagem foi modificado';
...
$string['privacy:metadata:scale:timemodified'] = 'A data e hora em que o registo foi modificado pela última vez';
...
$string['quickgrading_help'] = 'Se ativar esta opção, quando o modo de edição das notas está ativo, surge uma caixa para cada nota, permitindo editar várias notas ao mesmo tempo. As alterações serão guardadas e destacadas após clicar no botão \'Guardar\'.

Tenha em atenção que quando uma nota é ajustada diretamente na pauta, a nota deixará de ser alterada pela atividade a que a nota está relacionada.';
...
$string['searchcollapsedcolumns'] = 'Pesquisar colunas contraídas';
...
$string['selectauser'] = 'Selecione o utilizador';
$string['selectdestination'] = 'Selecionar destino de {$a}';
$string['selectgrouplink'] = 'Selecione um grupo';
$string['selectuserlink'] = 'Selecione o utilizador';
...
$string['setcategorieserror'] = 'Tem de definir as categorias da disciplina antes de atribuir pesos às categorias.';
...
$string['showcontributiontocoursetotal_help'] = 'Se deve, ou não, mostrar uma coluna de percentagens a indicar quanto é que cada item de avaliação contribui para a percentagem total do utilizador na disciplina (após aplicação da ponderação).';
...
$string['showingaggregatesonly'] = 'A mostrar apenas os totais';
$string['showingfullmode'] = 'A mostrar notas e totais';
...
$string['showonlyactiveenrol_help'] = 'Esta opção determina se apenas os utilizadores inscritos e ativos serão visíveis no relatório da pauta. Se ativar esta opção, os utilizadores suspensos não serão mostrados na pauta.';
...
$string['unlimitedgrades_help'] = 'Por predefinição, as notas são limitadas pelos valores máximo e mínimo de cada item de avaliação. Se ativar esta opção, estes limites serão removidos o que permite que notas superiores a 100% possam ser inseridas diretamente na pauta.';
...
$string['useridnumberwarning'] = 'Os utilizadores sem um número de identificação (ID) são excluídos da exportação, pois não podem ser importados';
...
$string['weightedascending'] = 'Ordenar por % ponderação ascendente';
$string['weighteddescending'] = 'Ordenar por % ponderação decrescente';
...
$string['weightoverride'] = 'Ajuste do peso';
...
$string['weightsedit'] = 'Editar pesos e créditos extra';
