...
/**
 * Strings for component 'filter_embedquestion', language 'pt', version '3.11'.
 *
...
$string['invalidquestion'] = 'A pergunta com ID "{$a->qid}" não existe na categoria "{$a->catname}".';
$string['invalidrandomquestion'] = 'Não é possível gerar uma pergunta aleatória da categoria "{$a}".';
$string['invalidtoken'] = 'Esta pergunta não pode ser incorporada aqui.';
