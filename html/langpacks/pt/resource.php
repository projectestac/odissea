...
/**
 * Strings for component 'resource', language 'pt', version '4.5'.
 *
 * @package     resource
 * @category    string
...
$string['configpopup'] = 'Quando se adiciona um recurso que pode ser apresentado numa nova janela pop-up, deve ser essa a opção predefinida?';
$string['configpopupdirectories'] = 'Devem as janelas pop-up apresentar, por predefinição, hiperligações para as pastas?';
$string['configpopupheight'] = 'Qual deve ser a altura predefinida para as janelas pop-up?';
$string['configpopuplocation'] = 'Devem as janelas pop-up apresentar, por predefinição, a barra de endereço?';
$string['configpopupmenubar'] = 'Devem as janelas pop-up apresentar, por predefinição, a barra de menus?';
$string['configpopupresizable'] = 'Devem as janelas pop-up ser, por predefinição, redimensionáveis?';
$string['configpopupscrollbars'] = 'Devem as janelas pop-up apresentar, por predefinição, a barra de scroll?';
$string['configpopupstatus'] = 'Devem as janelas pop-up apresentar, por predefinição, a barra de estado?';
$string['configpopuptoolbar'] = 'Devem as janelas pop-up apresentar, por predefinição, a barra de ferramentas?';
$string['configpopupwidth'] = 'Qual deve ser a largura predefinida para as janelas pop-up?';
...
$string['forcedownload'] = 'Forçar descarregamento';
...
$string['popupheightexplain'] = 'Altura predefinida da janela pop-up';
$string['popupresource'] = 'Este documento deve aparecer numa janela pop-up.';
$string['popupresourcelink'] = 'Se tal não acontecer, clique aqui: {$a}';
$string['popupwidth'] = 'Largura da janela pop-up (em píxeis)';
$string['popupwidthexplain'] = 'Largura predefinida da janela pop-up';
...
$string['showdate'] = 'Mostrar data de carregamento/modificação';
