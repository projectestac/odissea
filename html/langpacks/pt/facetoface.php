...
/**
 * Strings for component 'facetoface', language 'pt', version '3.11'.
 *
 * @package     facetoface
 * @category    string
...
$string['allowoverbook_help'] = 'Quando a opção "Permitir lista de espera" está marcada, os alunos poderão inscrever-se numa sessão da Atividade Presencial, mesmo que já esteja lotada.<br />

Quando um aluno inscreve-se numa sessão que já está ccompleta, receberá um e-mail avisando que foi colocado na lista de espera da sessão e será notificado quando a reserva estiver disponível.';
$string['allsessionsin'] = 'Todas as sessões em {$a}';
$string['alreadysignedup'] = 'Já está inscrito nesta atividade de Cara-a-Cara.';
$string['answer'] = 'Entrar';
$string['answercancel'] = 'Sair';
$string['approvalreqd'] = 'Aprovação necessária';
$string['approvalreqd_help'] = 'Quando a "Aprovação necessária" está ativa, o aluno precisará da aprovação do gestor para poder participar numa sessão presencial.';
...
Quando uma sessão presencial atinge a lotação completa, os detalhes da sessão deixam de aparecer na página da disciplina. Os detalhes aparecerão a cinzento na página "Ver todas as sessões" e o aluno não poderá inscrever-se na sessão.
 ';
...
$string['error:cannotsendconfirmationthirdparty'] = 'Uma mensagem de confirmação foi enviada para a sua conta de e-mail e para a conta de e-mail do seu gestor, mas ocorreu um erro ao enviar a mensagem de confirmação para o endereço de e-mail de terceiro.';
...
$string['error:signedupinothersession'] = 'Já está inscrito noutra sessão para esta atividade. Só se pode inscrever numa sessão por Atividade Presencial.';
...
Cada atividade é oferecida numa ou mais sessões idênticas. Essas sessões podem ocorrer em vários dias.
...
Os alunos podem visualizar e inscreverem-se nas sessões e a sua presença pode ser rastreada e registada na pauta.';
$string['modulenameplural'] = 'Atividade Presencial';
$string['moreinfo'] = 'Mais informações';
$string['multidate'] = '(vários horários)';
$string['nofacetofaces'] = 'Não existe Aividades Presenciais';
$string['none'] = 'nenhum';
...
$string['pluginadministration'] = 'Administração de Atividade Presencial';
...
**Mensagem:** é o texto do e-mail enviado ao aluno, informando-o de que o seu pedido para participar na sessão da Atividade Presencial foi enviado ao seu gestor para aprovação.

**Notificação para o gestor:** é o texto do e-mail enviado ao gestor do aluno a solicitar aprovação para participar da sessão da Atividade Presencial.';
$string['room'] = 'Sala';
...
$string['saveattendance'] = 'Guardar presenças';
...
$string['sessioninprogress'] = 'sessão a decorrer';
$string['sessionover'] = 'sessão termin ada';
$string['sessionrequiresmanagerapproval'] = 'Esta sessão requer aprovação para reservar.';
$string['sessionroles'] = 'Papeis na sessão';
...
$string['sessionstartdateandtime'] = '{$a->startdate}, {$a->starttime} - {$a->endtime} (fuso horário: {$a->timezone})';
$string['sessionstartfinishdateandtime'] = '{$a->startdate} - {$a->enddate}, {$a->starttime} - {$a->endtime} (fuso horário: {$a->timezone})';
...
$string['setting:defaultrequestsubjectdefault'] = 'Pedido de reserva de disciplina: [facetofacename], [starttime]-[finishtime]';
...
$string['setting:sessionroles_caption'] = 'Papeis na sessão:';
...
Quando é escolhido **Disciplina **, todas as sessões de Atividades Presenciais serão mostradas no calendário da disciplina e como evento da disciplina no calendário ao nível do site e visíveis para todos os utilizadores inscritos na disciplina.

Quando é escolhido **Nenhum**, as sessões da Atividade Presencial só serão mostradas como eventos do utilizador no calendário do participante confirmado, desde que a opção **Mostrar no calendário dutilizador** esteja selecionada.';
...
$string['suppressemail_help'] = 'Use esta opção se pretender adicionar/remover utilizadores "silenciosamente" de uma sessão. Quando esta opção é ativada, o e-mail de confirmação não é enviado para os utilizadores selecionados.';
$string['thirdpartyemailaddress'] = 'Endereços de e-mail de terceiros';
$string['thirdpartywaitlist'] = 'Notificar terceiros sobre sessões com lista de espera';
