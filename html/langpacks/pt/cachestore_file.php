...
/**
 * Strings for component 'cachestore_file', language 'pt', version '4.5'.
 *
...
$string['lockwait_help'] = 'O tempo máximo, em segundos, para aguardar um bloqueio exclusivo antes de ler ou guardar uma chave da cache. É usado apenas para definições de cache que exigem bloqueio de leitura ou escrita.';
