...
/**
 * Strings for component 'antivirus_clamav', language 'pt', version '4.5'.
 *
...
$string['pathtoclamdesc'] = 'Se o método de execução estiver configurado para "linha de comandos", indique o caminho para o Antivírus ClamAV aqui. No Linux será /usr/bin/clamscan ou /usr/bin/clamdscan.';
$string['pathtounixsocket'] = 'Socket de domínio Unix';
$string['pathtounixsocketdesc'] = 'Se o método de execução estiver configurado para "socket de domínio Unix", indique aqui o caminho para o Antivírus ClamAV. No Linux Debian isto será /var/run/clamav/clamd.ctl. Certifique-se de que o daemon clamav tem acesso de leitura aos ficheiros carregados e a forma mais fácil de garantir é adicionar o utilizador \'clamav\' ao seu grupo webserver (\'www-data\' no Linux Debian).';
...
$string['tcpsockethost'] = 'Servidor do socket TCP';
$string['tcpsockethostdesc'] = 'Nome do domínio do servidor ClamAV';
$string['tcpsocketport'] = 'Porta do socket TCP';
