...
/**
 * Strings for component 'flashcard', language 'pt', version '3.11'.
 *
 * @package     flashcard
 * @category    string
...
$string['nosubquestions'] = 'Erro: Faltam subperguntas para esta pergunta!';
...
$string['privacy:metadata:flashcard_card:userid'] = 'ID do utilizador que utiliza as cartas';
...
$string['privacy:metadata:flashcard_userdeck_state:userid'] = 'ID do utilizador que utiliza as cartas';
