...
/**
 * Strings for component 'editor_atto', language 'pt', branch 'MOODLE_38_STABLE'
 *
 * @package   editor_atto
...
$string['privacy:metadata:database:atto_autosave:timemodified'] = 'Data/hora de modificação do conteúdo';
