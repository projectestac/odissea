...
$string['highchartsmissing'] = 'Para ver o diagrama, descarregue a última versão da biblioteca Highcharts desde <a href="http://code.highcharts.com/"> http://code.highcharts.com/</a>. Copie o módulo highcharts.src.js da pasta \\core e o módulo exporting.src.js da pasta \\core\\modules ou, alternativamente, se preferir, as suas versões reduzidas highcharts.js e exporting.js respectivamente, para a pasta moodleroot/grade/report/gradedist/ js.';
...
$string['notification'] = 'Nota: A definição de notas alfabéticas aplica-se a todos os itens de avaliação na disciplina.';
$string['p'] = '(%)';
$string['percent'] = 'Percentagem';
$string['pluginname'] = 'Distribuição das notas';
$string['pluginname_help'] = 'Este relatório mostra a distribuição das notas de um determinado item de avaliação, baseado nos limites inferiores definidos para as notas alfabéticas. A funcionalidade de visualização permite que veja de imediato como as alterações nos limites inferiores das notas alfabéticas afetam a distribuição das notas. Se estiver satisfeito com os novos limites inferiores, as definições das notas alfabéticas podem ser alteradas de forma permanente.
Nota: A definição de nota alfabética aplica-se a todos os itens de avaliação na disciplina.';
$string['points'] = 'Pontos ({$a})';
$string['predecessor'] = 'O limite inferior de uma nota alfabética tem que ser menor do que o limite do seu antecessor.';
$string['printchart'] = 'Imprimir gráfico';
$string['privacy:null_reason'] = 'Este módulo não armazena qualquer informação pessoal. Apresenta uma interface que mostra visualmente e exporta a distribuição das notas dos elementos avaliados numa disciplina.';
