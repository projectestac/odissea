...
$string['criteriasetsave_help'] = 'Clique no botão e indique um nome exclusivo para o conjunto de critérios acima para que possa ser copiado facilmente para outros trabalhos.';
...
$string['criteriasetsmanage_help'] = 'Clique no botão para visualizar e gerir os seus conjuntos de critérios guardados.';
