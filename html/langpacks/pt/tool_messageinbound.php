...
/**
 * Strings for component 'tool_messageinbound', language 'pt', version '4.5'.
 *
...
$string['defaultexpiration_help'] = 'Quando um endereço de e-mail é gerado pelo handler, pode ser definido para expirar automaticamente após um intervalo de tempo e, por isso, já não pode ser usado novamente. É aconselhado definir um período de validade.';
...
$string['invalid_recipient_handler_name'] = 'Handler de remetente inválido';
