...
/**
 * Strings for component 'attendance', language 'pt', version '4.1'.
 *
 * @package     attendance
 * @category    string
...
$string['attendance:manualautomark'] = 'Permitir processo manual de registo automático';
...
$string['attendancereport'] = 'Assiduidade';
...
$string['attendanceuserreport'] = 'Relatório da assiduidade';
...
$string['automarkingcomplete'] = 'Registo automático concluído';
$string['automarkingnotavailableyet'] = 'Esta sessão está a usar o registo automático no fim da sessão e a sessão ainda não terminou.';
$string['automarkingnotenabled'] = 'O registo automático não está ativo nesta sessão';
...
$string['availability'] = 'Disponibilidade de autorregisto';
$string['availability_help'] = 'Restringir a disponibilidade deste estado. <br>Se a opção "Limitado" for selecionada, indique o número de minutos que este estado estará disponível após o início da sessão. É aplicável quando os alunos registam a própria assiduidade.';
$string['availabilityalways'] = 'Sempre';
$string['availabilitylimitedtime'] = 'Limitado';
$string['availabilityno'] = 'Não';
$string['availablebeforesession'] = 'Disponível antes do início da sessão';
$string['availablebeforesession_help'] = 'Quando os alunos registam a própria assiduidade, permitir que este estado possa ser escolhido antes do início da sessão.';
...
$string['canthidestatus'] = 'Não pode ocultar este estado porque já está em uso nesta atividade de assiduidade';
...
$string['customfields'] = 'Campos de sessão personalizados';
$string['date'] = 'Data';
$string['days'] = 'Dias';
...
$string['error:timenotreadable'] = 'O utilizador \'{$a->extuser}\' tem uma data de registo que não pode ser convertida por pela função \'strtotime\': {$a->scantime}';
...
$string['error:usernotfound'] = 'Não foi possível encontrar na disciplina o utilizador com o campo \'{$a->userfield}\' definido por \'{$a->extuser}\'';
...
$string['lasttaken'] = 'Assiduidades registadas pela última vez';
$string['manualtriggerauto'] = 'Ativar manualmente o registo automático';
...
$string['messagedselecteduserfailed'] = 'Ocorreu um erro ao enviar a mensagem para um ou mais utilizadores. Ative a depuração para mais informações.';
...
$string['passwordheader'] = 'Use a senha apresentada abaixo para registar a sua assiduidade';
...
$string['qrcodevalidbefore'] = 'Código QR válido até:';
...
$string['reportsessiondate'] = 'Data da sessão';
$string['reportsessionduration'] = 'Data da sessão';
$string['reportsessionlasttaken'] = 'Data/hora da última sessão (professor)';
...
$string['rotateqrcode_cleartemppass_task'] = 'Limpeza de senhas temporárias geradas pela funcionalidade de regeneração do código QR';
...
$string['saveandshownext'] = 'Guardar e mostrar a próxima página';
...
$string['sessiondescription'] = 'Descrição da sessão';
...
$string['statustotalcount'] = 'Estado {$a} - Total';
$string['statustotalcountcurrentweek'] = 'Estado {$a} - Total da semana atual';
$string['statustotalcountpreviousweek'] = 'Estado {$a} - Total da semana anterior';
...
$string['studentsearlyopentime'] = 'Abrir sessão mais cedo para registo';
$string['studentsearlyopentime_help'] = 'Permite que os professores abram a sessão mais cedo, o que possibilita que seja possível registar a assiduidade antes do horário de início real.';
$string['submit'] = 'Enviar';
$string['submitattendance'] = 'Registar assiduidade';
$string['submitattendancefuture'] = 'Informar ausência futura';
...
$string['timemodified'] = 'Data/hora da modificação';
$string['timetaken'] = 'Data/hora da assiduidade registada';
$string['to'] = 'às:&nbsp;';
$string['todate'] = '(até à data)';
$string['totalnumsessions'] = 'Total de sessões';
...
$string['updateattendance'] = 'Atualizar assiduidade';
...
$string['userexistingstatus'] = 'A sua assiduidade já foi registada como: <strong>{$a}</strong>. Se necessário, use o formulário abaixo para alterar.';
...
$string['usersessiongrade'] = 'Nota da sessão do utilizador';
$string['usersessionremarks'] = 'Comentários da sessão do utilizador';
$string['usersessiontaken'] = 'Sessão do uutilizador realizada';
$string['userstatus'] = 'Estado da sessão do utilizador';
