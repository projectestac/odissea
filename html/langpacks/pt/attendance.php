...
$string['attendancefile_help'] = 'O ficheiro tem de ser um ficheiro CSV com uma linha de cabeçalho e campos para identificar o utilizador e a assiduidade registada, por exemplo (e-mail, hora do registo) ou (nome de utilizador, hora)';
...
$string['keepsearching'] = 'Continuar a procurar';
...
$string['preventsharederror'] = 'O registo da própria assiduidade foi desativado na sessão porque esse dispositivo parece ter sido usado para registar a assiduidade de outro aluno.';
...
$string['privacy:metadata:ipaddress'] = 'Endereço IP de onde registada a assiduidade.';
$string['privacy:metadata:lasttaken'] = 'Data e hora de quando a participação na sessão foi registada pela última vez.';
$string['privacy:metadata:lasttakenby'] = 'ID do último utilizador que registou a assiduidade nesta sessão';
$string['privacy:metadata:notifyid'] = 'ID do aviso da assiduidade da sessão está associado com.';
...
$string['privacy:metadata:timemodified'] = 'Data/hora da última modificação da sessão';
$string['privacy:metadata:timesent'] = 'Data e hora do envio do aviso.';
$string['privacy:metadata:timetaken'] = 'Data/hora do registo da assiduidade pelo aluno.';
...
$string['sessionduplicate'] = 'Existe uma sessão duplicada na disciplina: {$a->course} e na assiduidade: {$a->activity}';
...
$string['uploadattendance'] = 'Carregar assiduidade por CSV';
