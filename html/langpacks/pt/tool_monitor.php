...
$string['frequency_help'] = 'O número necessário de eventos de um determinado intervalo de tempo para que seja enviada uma mensagem de notificação.';
...
$string['privacy:metadata:inactivedate'] = 'Intervalo de tempo, em dias, depois do qual uma subscrição inativa será removida completamente';
