...
$string['accessibilitysupportanonymouscheckbox'] = 'Prefiro enviar o meu pedido de suporte de acessibilidade de forma anónima.';
...
$string['accessibilitysupportusermail_desc'] = 'Aqui define o endereço de e-mail para o qual os pedidos de suporte da acessibilidade devem ser enviados. Se deixar este campo em branco, os pedidos serão enviados para o <a href="{$a->url}">contacto de suporte do site</a> configurado.';
$string['accessibilitysupportusermailsubject'] = 'Pedido de suporte de acessibilidade';
...
$string['alternativelogolinkurlsetting_desc'] = 'Com esta configuração, pode definir um URL alternativo que será utilizado como hiperligação no logótipo da barra de navegação. Pode utilizar esta configuração para, por exemplo, direcionar para o website da sua organização em vez da página inicial do Moodle, mantendo assim uma barra de navegação homogénea em todos os sistemas da sua organização.';
...
$string['categorylistingpresentation_nochange'] = 'Conforme apresentadoa pelo Moodle';
...
$string['courselistingpresentation_nochange'] = 'Conforme apresentada pelo Moodle';
...
$string['enablefooterbuttondesktop'] = 'Ativar apenas em computadores e tablets, ocultar em dispositivos móveis (inalterado em relação à configuração predefinida do Moodle)';
...
$string['enableimprintsetting'] = 'Ativar página de aviso legal';
...
$string['flavoursbackgroundimage_help'] = 'Com esta definição, irá substituir a imagem de fundo definida nas configurações do visual do Boost Union.';
...
$string['imprintcontentsetting'] = 'Conteúdo do aviso legal';
$string['imprintcontentsetting_desc'] = 'Nesta configuração, pode adicionar conteúdo Rich Text que será apresentado na página de aviso legal.';
$string['imprintdisabled'] = 'A página de aviso legal está desativada para este site. Não há nada para ver aqui.';
$string['imprintheading'] = 'Aviso legal';
$string['imprintlinkpositionboth'] = 'Adicionar hiperligação para a página de aviso legal na nota de rodapé e no ícone de rodapé (ponto de interrogação)';
$string['imprintlinkpositionfooter'] = 'Adicionar hiperligação para a página de aviso legal no ícone de rodapé (ponto de interrogação)';
$string['imprintlinkpositionfootnote'] = 'Adicione uma hiperligação para a página de aviso legal na nota de rodapé.';
$string['imprintlinkpositionnone'] = 'Não mostrar automaticamente a hiperligação para a página de aviso legal';
$string['imprintlinkpositionsetting'] = 'Posição da hiperligação da página  de aviso legal';
$string['imprintlinkpositionsetting_desc'] = 'Nesta configuração, pode definir se deve ser adicionada automaticamente uma hiperligação para a página de aviso legal à página do Moodle. Caso não pretenda exibir a hiperligação automaticamente, pode adicionar manualmente uma hiperligação para \'{$a->url}\' em qualquer parte do Moodle.';
$string['imprintpagetitlesetting_desc'] = 'Nesta configuração, pode definir o título da página de aviso legal. Este texto também será utilizado como hiperligação para a página de aviso legal se configurar adequadamente a opção \'Posição da hiperligação da página  de aviso legal\'.';
...
$string['navbarcolorsetting_light'] = 'Barra de navegação clara com cor de letra escura (conforme apresentada pelo Moodle)';
...
$string['settingsoverview_content_desc'] = 'Configurações para o conteúdo global do seu site Moodle estão localizadas aqui: rodapé, páginas estáticas, banners informativos, blocos de anúncios e menus deslizantes.';
...
$string['showviewcourseiconincoursemgntsesetting_desc'] = 'Por predefinição, na <a href="{$a}">página de gestão de disciplinas</a>, o Moodle exige que abra os detalhes da disciplina ou aceda às configurações da disciplina antes de clicar num elemento adicional da interface para o visualizar. Ao ativar esta configuração, pode adicionar um ícone "Ver disciplina" diretamente à lista de categorias na página de gestão de disciplinas.';
...
$string['slideranimationsetting'] = 'Tipo de animação do menu deslizante';
...
$string['sliderfrontpagepositionsetting'] = 'Posição do menu deslizante na página inicial do site';
...
$string['slidergeneralheading'] = 'Menu deslizante geral';
$string['sliderindicatornavsetting'] = 'Ativar indicador de navegação do menu deslizante';
