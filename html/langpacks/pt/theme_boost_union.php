...
$string['courseoverviewimagefallback'] = 'Imagem de referência para a visão global da disciplina';
$string['courseoverviewimagefallback_desc'] = 'A imagem que carregar aqui será utilizada como imagem de referência da disciplina assim que a definição "Origem da imagem de referência da disciplina" estiver configurada da mesma forma. <br />Nota: se configurar a opção "Origem da imagem de referência da disciplina" para utilizar a imagem de referência da disciplina, mas não carregar nenhuma imagem aqui, será utilizado o padrão geométrico como imagem de referência na mesma.';
$string['courseoverviewimageheading'] = 'Imagens da visão global da disciplina';
$string['courseoverviewimagesourcesetting'] = 'Origem da imagem da visão global da disciplina';
$string['courseoverviewimagesourcesetting_desc'] = 'Com esta configuração, controla a origem da imagem apresentada no bloco de visão global da disciplina, nas páginas de índice de categoria e na lista de disciplinas na página principal do site. A origem principal desta imagem é a imagem da disciplina, que é carregada nas configurações específicas da disciplina. Se esta imagem não estiver disponível, pode escolher se pretende apresentar um padrão geométrico gerado automaticamente ou uma imagem alternativa da visão global da disciplina. <br />Nota: Se utilizar o padrão geométrico, pode personalizar as cores do padrão na <a href="/admin/settings.php?section=coursecolors">página de configurações de cores da disciplina</a>.';
...
$string['footersuppressstandardfootercore_desc'] = 'Com esta configuração, pode suprimir completamente a saída do rodapé pelo componente principal \'{$a}\'. Os componentes principais podem adicionar conteúdo adicional ao rodapé através da implementação de um hook ou função específica. Este componente principal implementou este hook/função e pode adicionar conteúdo ao rodapé em determinadas circunstâncias.';
