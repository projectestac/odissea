...
/**
 * Strings for component 'qtype_multianswer', language 'pt', version '4.5'.
 *
...
$string['confirmquestionsaveasedited'] = 'Confirmo que desejo que a pergunta seja guardada como está';
...
$string['privacy:metadata'] = 'O módulo Pergunta do tipo Respostas incorporadas não armazena quaisquer dados pessoais.';
...
$string['questionsless'] = 'Menos {$a} pergunta(s) do que a pergunta de escolha múltipla guardada na base de dados';
...
$string['questionusedinquiz'] = 'Pergunta usada em {$a->nb_of_quiz} testes. Total de tentativas: {$a->nb_of_attempts}';
...
$string['youshouldnot'] = '<b>NÃO DEVE:</b>';
