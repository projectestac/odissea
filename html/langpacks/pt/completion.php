...
$string['completionexpected_help'] = 'Esta configuração especifica a data prevista para a conclusão da atividade. Quando a data está próxima, a atividade é listada no bloco Cronograma do Painel do utilizador.';
