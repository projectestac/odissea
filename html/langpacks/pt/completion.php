...
$string['completionexpected_help'] = 'Se ativar esta opção, esta configuração especifica a data prevista para a conclusão da atividade. Quando a data está próxima, a atividade é listada no bloco Cronograma do Painel do utilizador.';
...
$string['completionusegrade_desc'] = 'O aluno tem de ter uma nota para concluir a atividade';
...
$string['completionview_desc'] = 'O aluno tem de visualizar a atividade para a concluir';
