...
$string['already_queued'] = '<strong>{$a->username}</strong> já está em fila de espera do grupo <strong>{$a->groupname}</strong>!';
...
$string['cfg_groups_queues_limit_desc'] = 'Determina o número predefinido de diferentes alunos que podem ser colocados em fila num grupo ao mesmo tempo.';
...
$string['cfg_ifgroupdeleted_desc'] = 'Os grupos apagados devem ser recriados para a instância da Ferramenta de Grupos ou devem ser apagadas todas as referências (incluindo dados de grupo, registos e filas)? Nota: Se selecionar "Recriar grupo", os grupos serão recriados automaticamente após a eliminação em "Administração da disciplina / Utilizadores / Grupos"';
...
$string['cfg_importfields_desc'] = 'Define que campos da tabela de utilizadores devem ser comparados aos dados quando importar/cancelar de registo dos utilizadores. Os campos são pesquisados um a um até encontrar uma correspondência única. Valores possíveis/úteis são, por exemplo: nome de utilizador, número de identificação e e-mail. ATENÇÃO: não existe nenhuma verificação para nomes de campo corretos. Caracteres permitidos: a-z, A-Z e \',\'';
...
$string['cfg_max_queues_desc'] = 'Determina, por predefinição, em quantos grupos diferentes um utilizador pode ser colocado em fila ao mesmo tempo.';
...
$string['cfg_use_queue'] = 'Usar filas';
$string['cfg_use_queue_desc'] = 'Se ativar esta opção, por predefinição, serão usadas as filas de espera de registo em grupos completos.';
...
$string['cfg_users_queues_limit_desc'] = 'Determina o número predefinido de diferentes grupos que um utilizador pode ser colocado em fila ao mesmo tempo.';
...
$string['import_progress_search'] = 'Procurar utilizador';
...
$string['queues'] = 'Filas';
$string['queues_max'] = 'Max. de lugares simultâneos na fila por participante';
...
$string['too_many_queue_places'] = 'Não é possível colocar <strong>{$a->username}</strong> em fila de espera do grupo <strong>{$a->groupname}</strong> porque <strong>{$a->username}</strong> já está em fila de espera de muitos grupos!';
$string['too_many_regs'] = 'O utilizador já se encontra registado/em fila de espera de um grande número de grupos!';
$string['toolessregspresent'] = 'Pelo menos 1 utilizador está registado menos grupos, por isso, o mínimo de grupos para escolher tem que ser no máximo {$a}.';
...
$string['use_queue_help'] = 'Os alunos podem colocar-se na fila para grupos já preenchidos. Esta configuração só pode ser usada se o autorregistro estiver ativado e se estiver definido o limite do tamanho do grupo.';
$string['use_size'] = 'Ativado';
$string['user_has_too_less_regs'] = 'O cancelamento de registo/fila de espera não é possível porque <strong>{$a->username}</strong> está registado/em fila de espera em muito menos grupos!';
...
$string['you_are_already_queued'] = 'Já está está em fila de espera do grupo <strong>{$a->groupname}</strong>!';
$string['you_are_already_registered'] = 'Já está está registado no grupo <strong>{$a->groupname}</strong>!';
$string['you_are_not_in_queue_or_registered'] = 'Não está registado nem está em fila de espera do grupo <strong>{$a->groupname}</strong>';
$string['you_change_group_to_success'] = 'Mudança de grupo bem sucedida! Está agora registado no grupo <strong>{$a->groupname}</strong>!';
$string['you_have_too_less_regs'] = 'Cancelar registo/remover de fila não é possível porque está registado/em fila em muito menos grupos!';
$string['you_have_too_many_queue_places'] = 'Não é possível colocar-lhe em fila de espera do grupo <strong>{$a->groupname}</strong> porque já está em fila de muitos grupos!';
