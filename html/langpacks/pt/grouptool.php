...
$string['groupstatus_help'] = 'O estado atual de um grupo é visualizado pela cor:<ul><li>Verde - grupo ativo. O grupo está atribuído a esta Ferramenta de Grupos. Se o auto-registo estiver ativo, os alunos podem registar-se neste grupo.</li><li>Cinzento - grupo inativo. O grupo não está disponível nesta Ferramenta de Grupos.</li></ul>Ao clicar no símbolo, o estado pode ser alterado.';
