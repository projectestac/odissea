...
/**
 * Strings for component 'dialogue', language 'pt', version '3.11'.
 *
 * @package     dialogue
 * @category    string
...
$string['bulkopenrule'] = 'Abrir regra "Em grupo"';
$string['bulkopenrulenotifymessage'] = '<strong>Aviso:</strong><br/>Quando utiliza regras "Em grupo", as conversas não são iniciadas de imediato. As conversas só iniciam quando a função de sistema Cron é executada, normalmente a cada 30 minutos.';
$string['bulkopenrules'] = 'Regras "Em grupo"';
$string['cachedef_params'] = 'Params - interface de utilizador';
$string['cachedef_participants'] = 'Id\'s dos Participantes (informação básica)';
...
$string['cannotdeleteopenconversation'] = 'Não pode eliminar uma conversa aberta';
...
$string['conversationdeleteconfirm'] = 'Tem a certeza de que pretende apagar a conversa [{$a}]? Esta operação não pode ser desfeita.';
...
$string['conversationopened'] = 'Conversa foi iniciada';
...
$string['deleteconversation'] = 'Eliminar conversa';
$string['deletereply'] = 'Eliminar resposta';
...
$string['dialogue:delete'] = 'Eliminar as próprias';
$string['dialogue:deleteany'] = 'Eliminar qualquer uma';
...
$string['dialogue:replyany'] = 'Responder a qualquer uma';
$string['dialogue:viewany'] = 'Ver qualquer uma';
...
$string['draftconversationtrashed'] = 'Rascunho de conversa eliminado';
$string['draftlistdisplayheader'] = 'Lista de rascunhos';
$string['draftreply'] = 'Rascunho de resposta';
$string['draftreplytrashed'] = 'Rascunho de resposta eliminado';
...
$string['eventconversationdeleted'] = 'Conversa eliminada';
...
$string['groupmodenotifymessage'] = 'A atividade está a ser executada no modo de grupo, isso irá afetar quem pode iniciar uma conversa com e que conversas são mostradas.';
...
$string['noconversationsfound'] = 'Nenhuma conversa foi encontrada!';
$string['nodraftsfound'] = 'Sem rascunhos!';
...
$string['repliedby'] = '<strong>{$a->fullname}</strong> <small>respondida há </small> {$a->timeago}';
$string['repliedbyfullyear'] = '<strong>{$a->fullname}</strong> <small>respondida em</small> {$a->datefull} <small>({$a->time})</small>';
$string['repliedbyshortyear'] = '<strong>{$a->fullname}</strong> <small>respondida em</small> {$a->dateshort} <small>({$a->time})</small>';
$string['repliedbytoday'] = '<strong>{$a->fullname}</strong> <small>respondida às</small> {$a->time} <small>({$a->timepast} atrás)</small>';
...
$string['usecoursegroups_help'] = 'Se a disciplina tem grupos definidos, outra restrição será adicionada a quem uma conversa pode ser abertas com. *Dialogue* só pode ser aberto entre os membros do grupo a não ser que a pessoa que iniciar a conversa tenha a permissão de **"Aceder a todos os grupos"**.';
$string['usesearch'] = 'Utilize a pesquisa para encontrar pessoas com quem conversar';
$string['viewconversations'] = 'Ver conversas';
