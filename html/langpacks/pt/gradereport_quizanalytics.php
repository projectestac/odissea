...
$string['action'] = 'Ação';
$string['allusersdes'] = 'Esta secção reporta, com base em casos de erro ou ausência de resposta, as categorias que se revelaram como as mais desafiantes para todos os utilizadores que fizeram o teste.';
$string['apiversion'] = 'Indique a versão da API';
$string['apiversiondes'] = 'Por favor, indique a versão da sua API';
$string['attemptssnapshotdes'] = 'Esta secção é como uma recapitulação, mostrando os números-chave de toda a sua tentativa anterior.';
...
$string['cutoffdes'] = 'Definir percentagem limite (%) para todo o teste. Será usada para o gráfico de análise previsional.';
...
$string['impandpredicanalysis'] = 'Curva de Melhoramento e Análise Previsional';
...
$string['mixchartdes'] = 'Este gráfico mostra como melhorou todas as suas tentativas e o bloco escuro representa o número médio de tentativas necessárias para atingir a pontuação definida como limite (pelo administrador do site). O eixo X (horizontal) representa o número de tentativas.';
...
$string['pluginname'] = 'Análises dos testes';
$string['quesanalysis'] = 'Análises dos perguntas';
...
$string['setglobaldes'] = 'Definir limites de classificação para todos os testes. Quando verificado, reescreve as configurações de limite de classificação individual para cada teste.';
...
$string['timetaken'] = 'Instantâneo das tentativas (tempo gasto):&nbsp;';
...
$string['wrongandunattemptd'] = 'Tentativas mal sucedidas';
