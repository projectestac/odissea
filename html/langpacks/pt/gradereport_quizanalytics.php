...
/**
 * Strings for component 'gradereport_quizanalytics', language 'pt', version '4.4'.
 *
...
$string['challengingcategoris'] = 'Categorias desafiantes (para todos)';
$string['challengingcategorisforme'] = 'Categorias desafiantes (para mim)';
...
$string['hardestcategories'] = 'Categorias difíceis';
$string['hardestcategoriespercentage'] = 'Dificuldade em percentagem (%)';
...
$string['improvementcurve'] = 'Curva de progresso';
...
$string['myprogress'] = 'Progresso e previsões';
...
$string['numberofattempts'] = 'N.º de tentativas';
$string['partialcorrect'] = 'Parcialmente correta';
$string['peerperformance'] = 'Desempenho dos pares';
...
$string['questioncategory'] = 'Análise das categorias de perguntas';
$string['questionnumber'] = 'N.º da pergunta';
$string['questionpercatdes'] = 'O gráfico mostra o número de perguntas de cada categoria presentes no teste.';
$string['questionpercategory'] = 'Pergunta por categorias';
$string['questionreview'] = '(Clique para rever a pergunta e a última tentativa)';
$string['questionspercategory'] = 'Perguntas por categoria';
$string['questionstats'] = 'Estatísticas das perguntas e pontuação';
$string['quizname'] = 'Nome do teste';
$string['scorbrpercent'] = 'Pontuações por percentagem (todos os utilizadores)';
...
$string['zeroattempt'] = 'Responda a pelo menos uma pergunta.';
