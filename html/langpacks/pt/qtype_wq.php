...
/**
 * Strings for component 'qtype_wq', language 'pt', version '3.11'.
 *
 * @package     qtype_wq
 * @category    string
...
$string['info_test2_info'] = 'Verificar o filtro Matemática & Ciência por WIRIS';
$string['info_test2_infopage'] = 'página de informação';
$string['info_test2_name'] = 'Versão do filtro Matemática & Ciência por WIRIS';
$string['info_test2_rt1'] = 'O filtro Matemática & Ciência por WIRIS está corretamente instalado.';
$string['info_test2_rt2'] = 'O Testes Wiris requer o filtro Matemática & Ciência por WIRIS 3.17.20 ou superior. A versão instalada é';
$string['info_test2_rt3'] = 'Não é possível encontrar o ficheiro da versão do filtro Matemática & Ciência por WIRIS.';
...
$string['wirisquestionincorrect'] = 'O sistema não pode gerar uma das perguntas do teste. <br />Talvez haja um problema temporário na ligação. <br />Talvez o algoritmo da pergunta tenha um bug e falhe algumas vezes. <br />Talvez vá falhar sempre. <br />Não entre em pânico... <br />Pode repetir o teste, sem penalização, se clicar em Continuar. <br />Também pode comunicar aos professores que existe um problema com a pergunta: \'{$a->questionname}\\';
