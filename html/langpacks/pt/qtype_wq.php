...
/**
 * Strings for component 'qtype_wq', language 'pt', version '4.4'.
 *
 * @package     qtype_wq
 * @category    string
...
$string['wirisquestionincorrect'] = 'O sistema não pode gerar uma das perguntas do teste. <br />Talvez haja um problema temporário na ligação à Internet. <br />Talvez o algoritmo da pergunta tenha um bug e falhe algumas vezes. <br />Talvez vá falhar sempre. <br />Não entre em pânico... <br />Se clicar em Continuar, pode repetir o teste, sem penalização. <br />Também pode comunicar aos professores que existe um problema com a pergunta: \'{$a->questionname}\'';
