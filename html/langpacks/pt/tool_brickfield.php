...
/**
 * Strings for component 'tool_brickfield', language 'pt', version '4.1'.
 *
...
$string['bulkprocesscaches'] = 'Processar em massa a colocação em cache';
$string['bulkprocesscourses'] = 'Processar em massa a verificação de acessibilidade de lotes';
...
$string['checkdesc:imgaltistoolong'] = 'O texto alternativo da imagem (alt) não deve ter mais do que o máximo permitido de caracteres (125).';
...
$string['checkidvalidation'] = 'Tarefa para verificar a existência de ID de verificação inválidos';
