...
$string['combinedcontrolnamegapselect'] = 'ドロップダウンメニュ';
$string['combinedcontrolnamegapselectplural'] = 'ドロップダウンメニュ';
...
$string['pluginname_help'] = 'ミッシングワード選択問題ではドロップダウンメニュから選択するためレスポンデントを必要とします。1、2、3 ... と指定された正解の選択肢に対して[[1]]、[[2]]、[[3]] ... は問題テキスト内でそれぞれのプレースホルダとして使用されます。問題を難しくするためさらに答えの選択肢を追加することができます。それぞれのドロップダウンメニュで利用できる答えを制限するため答えの選択肢をグループ分けすることができます。';
$string['pluginnameadding'] = 'ミッシングワード選択問題の追加';
$string['pluginnameediting'] = 'ミッシングワード選択問題の編集';
$string['pluginnamesummary'] = 'ドロップダウンメニュを使って問題テキスト内の足りない言葉を埋めます。';
