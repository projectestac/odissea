...
/**
 * Strings for component 'qtype_gapselect', language 'ja', version '4.5'.
 *
...
$string['errorblankchoice'] = '選択肢をご確認ください: 選択肢 {$a} は空白です。';
$string['errormissingchoice'] = '問題テキストをご確認ください: {$a} は選択肢に見つかりませんでした! プレースホルダでの使用には存在する選択肢番号のみ許可されます。';
...
$string['privacy:metadata'] = 'ミッシングワード選択問題タイププラグインは問題作成者がユーザプレファレンスとしてデフォルトオプションを設定できます。';
...
$string['regradeissuenumchoiceschanged'] = 'グループ {$a} の選択肢数が変わりました。';
$string['regradeissuenumgroupsschanged'] = '選択肢のグループ数が変わりました。';
