...
/**
 * Strings for component 'auth_imap', language 'ja', version '3.11'.
 *
 * @package     auth_imap
 * @category    string
...
$string['auth_imapchangepasswordurl_key'] = 'パスワード変更URL';
...
$string['privacy:metadata'] = 'IMAPサーバ認証プラグインはどのような個人データも保存しません。';
