...
/**
 * Strings for component 'tool_moodlenet', language 'ja', version '4.5'.
 *
...
$string['removalwarning_feature'] = 'あなたがMoodleNetを引き続き利用する必要がある場合、セルフホスト型MoodleNetインスタンスの設定に関してサイト管理者にお問い合わせください。';
$string['removalwarning_service'] = 'この日付以降、MoodleNet Centralのコンテンツを閲覧または追加できなくなります。';
$string['removalwarning_title'] = 'MoodleNetサービスは2026年4月20日に終了します。';
