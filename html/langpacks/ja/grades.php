...
$string['encoding_help'] = 'データの使用する文字エンコーディングを選択してください (標準的なエンコーディングはUTF-8です)。間違って正しくないエンコーディングが選択された場合、インポートデータをプレビュする時点で簡単に確認できます。';
...
$string['importpreview'] = 'インポートプレビュ';
...
$string['linktoactivity'] = '{$a->name} 活動 ( {$a->title} ) へのリンク';
$string['lock'] = 'ロック';
$string['locked'] = 'ロック';
...
$string['refreshpreview'] = 'プレビュをリフレッシュする';
...
$string['rowpreviewnum'] = 'プレビュ行数';
$string['rowpreviewnum_help'] = 'インポートするデータはインポートの承認前にプレビュできます。この設定ではプレビュ時に何行表示するか決定します。';
