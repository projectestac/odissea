...
$string['importoutcomenofile'] = 'アップロードされたファイルが空または破損しています。このファイルが有効かどうか確認してください。問題は {$a} 行目で検出されました。これは最初の行 (ヘッダ行) のカラムと同数のカラムがデータ行に含まれていないか、インポートファイルに必要なヘッダ行が含まれていなことが原因です。有効なヘッダのあるファイルの例として、エクスポートされたファイルをご覧ください。';
...
$string['modgradeerrorbadscale'] = '無効な尺度が選択されました。あなたが以下の選択肢から尺度を選択したことを確認してください。';
