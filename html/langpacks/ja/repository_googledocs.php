...
/**
 * Strings for component 'repository_googledocs', language 'ja', version '4.4'.
 *
...
$string['fileoptions'] = 'ここでタイプおよび戻されるファイルのデフォルトを設定することができます。外部にリンクされているすべてのファイルが更新されるため、オーナがMoodleシステムアカウントになる点に留意してください。';
...
$string['servicenotenabled'] = 'アクセスが設定されていません。「Drive API」が有効にされているかご確認ください。';
