...
/**
 * Strings for component 'tool_filetypes', language 'ja', version '4.5'.
 *
...
* デフォルトでMIMEタイプを使用します。MIMEタイプに対応する言語ストリングがmimetypes.phpにある場合、それが使用されます。 そうではない場合、MIMEタイプ自体がユーザに表示されます。
