...
/**
 * Strings for component 'assignfeedback_file', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['feedbackzip_help'] = '1名またはそれ以上の学生のフィードバックファイル一覧を含むZIPファイルはファイル名のユーザフルネーム直後にある2番目の部分の参加者IDに基づき学生に割り当てられます。あなたがすべての提出をダウンロードして、いつくかのファイルにコメントを追加した後、再度ZIP圧縮してファイルすべてをアップロードできるようこの命名規則が使用されます。変更のないファイルは無視されます。';
