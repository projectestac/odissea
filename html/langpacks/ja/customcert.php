...
$string['emailothers_help'] = 'この設定を有効にした場合、ここで入力されたメールアドレス (カンマ区切り) 宛に証明書の利用可能時に証明書のコピーをメール送信します。';
...
$string['emailstudents_help'] = 'この設定を有効にした場合、証明書の利用可能時に証明書のコピーを学生にメール送信します。';
$string['emailstudentsubject'] = '{$a->coursefullname}: {$a->certificatename}';
$string['emailteachers'] = '教師にメールする';
$string['emailteachers_help'] = 'この設定を有効にした場合、証明書の利用可能時に証明書のコピーを教師にメール送信します。';
