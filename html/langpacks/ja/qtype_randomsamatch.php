...
/**
 * Strings for component 'qtype_randomsamatch', language 'ja', version '4.5'.
 *
...
$string['pluginname_help'] = '学生の視点からこれは組み合わせ問題のように見えます。異なる点は組み合わせのための名称または記述 (問題) 一覧が現在のカテゴリ内の記述問題からランダムに取得されることです。カテゴリ内に十分な未使用の記述問題が必要です。そうではない場合、エラーメッセージが表示されます。';
