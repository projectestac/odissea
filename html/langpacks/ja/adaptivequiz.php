...
/**
 * Strings for component 'adaptivequiz', language 'ja', version '3.11'.
 *
...
$string['errorclosingattempt'] = '受験記録は見つかりませんでした。';
$string['errorclosingattempt_alreadycomplete'] = 'この受験はすでに完了しているため、手動で閉じることはできません。';
$string['errordeletingattempt'] = '受験記録は見つかりませんでした。';
...
$string['na'] = '利用不可';
$string['name'] = '名称';
$string['noattemptrecords'] = 'この生徒の受験記録はありません';
