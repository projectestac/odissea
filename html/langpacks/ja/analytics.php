...
/**
 * Strings for component 'analytics', language 'ja', version '4.5'.
 *
 * @package     analytics
 * @category    string
...
$string['errorinvalidtimesplitting'] = '無効な分析間隔です。あなたが省略されていないクラス名を追加したことをご確認ください。';
...
$string['errornopredictresults'] = '予測プロセッサから戻された結果はありません。詳細はアウトプットディレクトリのコンテンツをご確認ください。';
...
$string['modeloutputdirwithdefaultinfo'] = '予測プロセッサがすべての評価情報を保存するディレクトリです。デバッグおよび調査に有用です。空白の場合、デフォルトとして {$a} が使用されます。';
