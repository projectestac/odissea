...
/**
 * Strings for component 'enrol_ldap', language 'ja', version '4.4'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['cannotupdatecourse'] = 'コースを更新できません: LDAPレコードからの必要なデータがありません! コースIDナンバ: {$a->idnumber}';
$string['cannotupdatecourse_duplicateshortname'] = 'コースを更新できません: 省略名が重複しています。IDナンバ「 {$a->idnumber} 」のコースをスキップします ...';
$string['category'] = '自動的に作成されるコースのためのカテゴリです。';
$string['category_key'] = 'カテゴリ';
$string['contexts'] = 'LDAPコンテクスト';
$string['couldnotfinduser'] = 'ユーザ「 {$a} 」が見つかりませんでした。スキップします。';
$string['course_fullname'] = '任意: 「フルネーム」を取得するLDAPフィールドです。';
$string['course_fullname_key'] = 'フルネーム';
$string['course_fullname_updateonsync'] = '同期スクリプトでフルネームを更新する';
$string['course_fullname_updateonsync_key'] = 'フルネームを更新する';
$string['course_idnumber'] = 'コースIDナンバを取得するLDAP属性です。通常、「cn」または「uid」です。';
$string['course_idnumber_key'] = 'IDナンバ';
...
$string['courseupdated'] = 'IDナンバ「 {$a->idnumber} 」のコースが正常に更新されました。';
$string['courseupdateskipped'] = 'IDナンバ「 {$a->idnumber} 」のコースは更新を必要としません。スキップします ...';
...
$string['duplicateshortname'] = 'コース作成に失敗しました。省略名が重複しています。IDナンバ「 {$a->idnumber} 」のコースをスキップします ...';
...
$string['idnumber_attribute'] = 'グループメンバシップに識別名が含まれている場合、LDAP認証設定のユーザ「IDナンバ」マッピングで指定されている属性と同じ属性を指定してください。';
$string['idnumber_attribute_key'] = 'IDナンバ属性';
...
<p>LDAPを使用してユーザを登録するにはユーザが有効なIDナンバフィールドを<strong>持つ必要</strong>があります。LDAPグループはユーザがコースに登録できるようメンバフィールドの中にIDナンバを持つ必要があります。あなたがすでにLDAP認証を使用している場合、通常これらは正常に動作します。</p>
