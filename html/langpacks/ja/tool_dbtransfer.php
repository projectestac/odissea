...
/**
 * Strings for component 'tool_dbtransfer', language 'ja', version '4.5'.
 *
...
$string['enablemaintenance_help'] = 'このオプションを有効にした場合、データベース移行中および移行後にメンテナンスモードが有効にされます。これで移行が完了するまですべてのユーザによるアクセスを防ぐことができます。サイト管理者は通常動作を再開させるためconfig.phpを更新した後に「 $CFG->dataroot/climaintenance.html 」ファイルを手動削除する必要があることに留意してください。';
