...
/**
 * Strings for component 'assignment', language 'ja', version '3.11'.
 *
 * @package     assignment
 * @category    string
...
$string['assignmentdisabled'] = 'レガシ「課題2.2」活動は無効にされています。';
$string['assignmentneedsupgrade'] = 'レガシ「課題2.2」活動は削除されました。';
$string['messageprovider:assignment_updates'] = '課題 (2.2) 通知';
$string['modulename'] = '課題2.2 (無効)';
$string['modulename_help'] = 'Moodleから削除されたレガシ活動モジュールです。';
$string['modulenameplural'] = '課題2.2 (無効)';
