...
/**
 * Strings for component 'availability', language 'ja', version '4.5'.
 *
...
$string['hidden_marker'] = '(そうではない場合は非表示)';
...
$string['list_and'] = 'すべて:';
$string['list_and_hidden'] = 'すべて (そうではない場合は非表示):';
$string['list_or'] = 'どれか:';
$string['list_or_hidden'] = 'どれか (そそうではない場合は非表示):';
...
$string['listheader_sign_before'] = '学生は';
...
$string['or'] = 'または';
$string['privacy:metadata'] = 'アクセス制限サブシステムはいかなる個人データも保存しません。';
