...
/**
 * Strings for component 'tool_xmldb', language 'ja', version '4.4'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['pendingchangescannotbesaved'] = 'このファイルに変更が加えられましたが、保存できません! ディレクトリおよび「install.xml」にウェブサーバの書込み権があるかご確認ください。';
$string['pendingchangescannotbesavedreload'] = 'このファイルに変更が加えられましたが、保存できません! ディレクトリおよび「install.xml」にウェブサーバの書込み権があるかご確認ください。確認後、あなたはこのページをリロードして変更を保存できます。';
