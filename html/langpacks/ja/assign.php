...
/**
 * Strings for component 'assign', language 'ja', branch 'MOODLE_38_STABLE'
 *
 * @package   assign
...
$string['assignmentisdue'] = '課題の提出期限が到来しています。';
...
$string['multipleteams_desc'] = 'グループで課題を提出する必要があります。あなたは2つ以上のグループのメンバーです。提出できるためにはあなたは1つのみのグループのメンバーである必要があります。あなたのグループメンバーシップを変更するには教師にご連絡ください。';
...
$string['noteam_desc'] = 'この課題はグループで提出する必要があります。あなたはどのグループにも属していないため提出を作成することはできません。グループに追加されるにはあなたの教師にご連絡ください。';
...
$string['privacy:metadata:assignquickgrading'] = 'クイック評定を使用するかどうか指定するユーザプリファレンスです。';
...
$string['privacy:metadata:groupid'] = 'ユーザがメンバーであるグループのIDです。';
...
$string['submissiondrafts_help'] = 'この設定を有効にした場合、学生は最終提出であると宣言するために「提出」ボタンをクリックする必要があります。この設定により学生はシステム上に下書きバージョンの課題を保持できるようになります。学生の課題提出後、この設定が「No」から「Yes」に変更された場合、提出は最終提出として再評定されます。';
...
$string['submissionstatementteamsubmissionallsubmit'] = 'すべてのグループメンバーの提出に関するグループ提出同意書';
$string['submissionstatementteamsubmissionallsubmitdefault'] = '他の人の作業結果であると私が認めたものを除き、この提出はグループメンバーとしての私自身の作業結果です。';
$string['submissionstatementteamsubmissionallsubmit_help'] = '学生がグループメンバーとして作業結果を提出する場合に同意が必要な同意書です。';
...
$string['ungroupedusersoptional'] = '設定「学生がグループで提出する」が有効にされていますが、何名かのユーザはグループに属していないか、2つ以上のグループに属しています。これらの学生が「デフォルトグループ」のメンバーとして提出することをご了承ください。';
