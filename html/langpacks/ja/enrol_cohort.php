...
/**
 * Strings for component 'enrol_cohort', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['privacy:metadata:core_group'] = 'コーホート同期プラグインは新しいグループを作成または既存のグループを使用してコーホートのメンバーすべてを追加することができます。';
$string['status'] = 'アクティブ';
