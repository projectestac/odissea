...
/**
 * Strings for component 'report_infectedfiles', language 'ja', version '4.1'.
 *
...
$string['author'] = '作成者';
$string['confirmdelete'] = '本当にこのファイルを削除してもよろしいですか?';
$string['confirmdeleteall'] = '本当にすべてのファイルを削除してもよろしいですか?';
$string['confirmdownload'] = '本当にこのファイルをダウンロードしてもよろしいですか?';
$string['confirmdownloadall'] = '本当にすべてのファイルをダウンロードしてもよろしいですか?';
