...
/**
 * Strings for component 'report_stats', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['eventreportviewed'] = '統計レポートが閲覧されました。';
$string['eventuserreportviewed'] = 'ユーザ統計レポートが閲覧されました。';
$string['nocapability'] = 'ユーザ統計レポートにアクセスできません。';
$string['page-report-stats-index'] = 'コース統計レポート';
...
$string['privacy:metadata'] = '統計プラグインはいかなる個人データも保存しません。';
