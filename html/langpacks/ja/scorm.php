...
$string['autocontinue_help'] = 'この設定を有効にした場合、自動的に次の利用可能な学習オブジェクトが起動されます。そうではない場合、「続ける」ボタンを使用してください。';
$string['autocontinuedesc'] = 'この設定を有効にした場合、次に続く学習オブジェクトが自動的に開始動されます。そうではない場合、「続ける」ボタンが使用されます。';
...
$string['browsemodewithname'] = 'プレビューモード: {$a}';
...
$string['popupsblocked'] = 'ポップアップウィンドウがブロックされたためSCORMモジュールの実行を停止します。再度開始する前にあなたのブラウザ設定をご確認ください。';
...
$string['title'] = 'タイトル';
$string['toc'] = 'TOC';
$string['toggletableofcontents'] = '目次を切り替える';
...
$string['updatefreq_help'] = 'これで外部パッケージを自動的にダウンロードおよび更新することができます。';
...
* 新しい受験を開始するオプションはコース構造ページ内の「Enter」ボタンの上にチェックボックスとして提供されます。あなたが2回以上の受験を許可したい場合、このページにユーザがアクセスできることをご確認ください。
