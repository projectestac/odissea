...
$string['completionattendancedesc'] = '学生はルームに入って少なくとも {$a} 分はセッションに参加する必要があります。';
...
$string['completionengagementdesc'] = 'ミーティング中、学生は活動に参加する必要があります。';
...
$string['config_clienttype'] = '「ウェブクライアント」タイプを編集する';
$string['config_clienttype_default'] = 'デフォルトWebクライアントタイプ';
$string['config_clienttype_default_description'] = '従来のAdobe Flashクライアントと新しいHTML5クライアントのいずれかを選択してください。';
$string['config_clienttype_description'] = 'ここではそれぞれのルームのWebクライアント選択の有効/無効を設定します。';
$string['config_clienttype_editable'] = 'ウェブクライアント選択を編集できる';
$string['config_clienttype_editable_description'] = 'このオプションではルーム編集フォームからWebクライアント (AdobeFlash/HTML5) を選択できるようにします。';
...
$string['mod_form_block_clienttype_flash'] = 'Adobe Flash技術に基づくクライアント';
$string['mod_form_block_clienttype_html5'] = 'HTML5技術に基づくクライアント';
