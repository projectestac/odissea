...
$string['event_recording_link_deleted'] = 'レコーディングリンクが削除されました。';
...
$string['general_error_no_answer'] = 'レスポンスが空です。BigBlueButtonサーバのURLを確認してしてください。また、BigBlueButtonサーバが稼働しているかどうかご確認ください。';
...
$string['general_error_unable_connect'] = '接続できません。BigBlueButtonサーバのURLおよびBigBlueButtonサーバの稼働状況をご確認ください。
詳細 : {$a}';
...
$string['index_error_checksum'] = 'チェックサムにエラーが発生しました。あなたが正しいシークレットを入力したことをご確認ください。';
$string['index_error_forciblyended'] = '手動で終了されたためこのセッションに参加できません。';
$string['index_error_noinstances'] = 'BigBlueButtonルームのインスタンスはありません。';
$string['index_error_unable_display'] = 'セッションを表示できません。BigBlueButtonサーバのURLおよびBigBlueButtonサーバの稼働状況をご確認ください。';
...
$string['view_error_unable_join'] = 'ルームに参加できません。BigBlueButtonサーバのURLおよびBigBlueButtonサーバの稼働状況をご確認ください。';
...
$string['view_groups_selection'] = 'あなたが参加したいグループを選択して操作をご確認ください。';
...
$string['view_message_conference_wait_for_moderator'] = 'モデレータの参加を待っています。';
