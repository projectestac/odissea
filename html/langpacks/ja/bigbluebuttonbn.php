...
$string['bigbluebuttonbn:meeting'] = 'ライブミーティング機能のあるインスタンスを作成する';
$string['bigbluebuttonbn:recording'] = 'レコーディング機能のあるインスタンスを作成する';
...
$string['completionengagementtalktime'] = 'トーク時間';
...
$string['config_lockedlayout_default'] = '「レイアウトロック」をデフォルトで有効にする';
$string['config_lockedlayout_default_description'] = 'この設定を有効にした場合、セッションレイアウトはロックされます。';
$string['config_lockedlayout_editable'] = '「レイアウトロック」を編集できる';
$string['config_lockedlayout_editable_description'] = 'デフォルトでの「レイアウトロック」はインスタンス追加または更新時に編集できます。';
...
$string['config_lockonjoinconfigurable_default'] = '「ロック設定」をデフォルトで有効にする';
$string['config_lockonjoinconfigurable_default_description'] = 'この設定を有効にした場合、セッションロック設定は上のコントロールで有効または無効にできます。';
$string['config_lockonjoinconfigurable_editable'] = '「ロック設定」を編集できる';
$string['config_lockonjoinconfigurable_editable_description'] = 'デフォルトでの「ロック設定」はインスタンス追加または更新時に編集できます。';
...
$string['config_recording_icons_enabled'] = 'レコーディング管理アイコン';
$string['config_recording_icons_enabled_description'] = 'この設定を有効にした場合、レコーディング管理パネルには公開/非公開および削除アクションのアイコンが表示されます。';
...
$string['config_recordings_deleted_default_description'] = 'この設定を有効にした場合、削除済み活動に属するレコーディングが存在する場合にそのレコーディングもレコーディングテーブルに含まれます。';
...
$string['config_recordings_html_default'] = '「UIのHTML化」をデフォルトで有効にする';
$string['config_recordings_html_default_description'] = 'この設定を有効にした場合、レコーディングテーブルはデフォルトでプレインHTMLで表示されます。';
$string['config_recordings_html_editable'] = '「UIのHTML化」機能を編集できる';
$string['config_recordings_html_editable_description'] = 'デフォルトでの「UIのHTML化」機能はインスタンス追加または更新時に編集できます。';
...
$string['config_recordings_validate_url'] = 'URLを検証する';
$string['config_recordings_validate_url_description'] = 'この設定を有効に場合、ユーザのアクセス前に再生URLが検証されます。';
...
$string['event_activity_viewed'] = '活動が閲覧されました。';
...
$string['mod_form_field_lockedlayout'] = 'ロックルームレイアウト';
$string['mod_form_field_lockonjoin'] = 'ロック設定を無視する';
$string['mod_form_field_lockonjoinconfigurable'] = 'ロック設定無視を許可する';
