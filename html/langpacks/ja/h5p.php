...
$string['address'] = 'アドレス';
$string['age'] = '標準的な年齢';
$string['ageDescription'] = 'このコンテンツのターゲットオーディエンスです。入力可能な形式をカンマで区切ってください: 1,34-45,-50,59-';
...
$string['contentUpdateSoon'] = 'まもなくあなたのコンテンツが更新されます。';
...
$string['icon'] = 'アイコン';
$string['iconDescription'] = '640x480px 選択されていない場合、コンテンツはカテゴリアイコンが使用します。';
...
$string['invalidAge'] = '典型的な年齢の入力形式が無効です。入力可能な形式はカンマで区切ってください: 1, 34-45, -50, -59-';
...
$string['isNowSubmitted'] = 'H5Pハブに送信済み';
$string['keywordExists'] = 'キーワードがすでに存在します!';
$string['keywords'] = 'キーワード';
$string['keywordsDescription'] = 'あなたはカンマで区切って複数キーワードを追加できます。キーワードを確定するには「Enter」または「追加」を押してください。';
...
$string['remove'] = '削除';
$string['removeChip'] = 'リストから:chipを削除する';
...
$string['reviewMessage'] = 'あなたが共有する前に下の情報をレビュしてください。';
$string['saveChanges'] = '変更を保存する';
$string['screenshots'] = 'スクリーンショット';
$string['screenshotsDescription'] = 'あなたのコンテンツのスクリーンショットを最大5件まで追加できます。';
$string['share'] = '共有';
$string['shareFailed'] = '共有に失敗しました。';
$string['shareTryAgain'] = '何か問題が発生したようです。もう一度共有してください。';
$string['shared'] = '共有済み';
$string['sharingNote'] = '共有後、すべてのコンテンツ詳細を編集できます。';
...
$string['size'] = 'サイズ';
$string['someKeywordsExits'] = 'すでに存在するキーワードもあります。';
$string['source'] = 'ソース';
