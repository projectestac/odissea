...
/**
 * Strings for component 'h5p', language 'ja', version '4.5'.
 *
 * @package     h5p
 * @category    string
...
$string['confirmdialogbody'] = 'あなたが続けたい場合、ご確認ください。この操作は元に戻せません。';
...
$string['copyrightWarning'] = '著作権で保護されたコンテンツはH5Pコンテンツハブで共有できません。コンテンツがクリエイティブコモンズのようなOERフレンドリなライセンスで提供されている場合、適切なライセンスを選択してください。そうではない場合、このコンテンツは共有できません。';
...
$string['offlineDialogBody'] = '私たちはこのタスクのあなたの完了に関する情報を送信できませんでした。あなたのインターネット接続をご確認ください。';
...
$string['shareTryAgain'] = 'H5P Hubと通信できませんでした。後ほど再度お試しください。';
$string['shared'] = '共有済み';
