...
$string['global_setting_use_private_comments'] = '個人的なメモを許可しますか？';
$string['global_setting_use_private_comments_desc'] = '参加者が個人的な注釈や個人的なメモを書けるようにする';
$string['global_setting_use_protected_comments'] = '非公開コメントを許可しますか？';
$string['global_setting_use_protected_comments_desc'] = '参加者が非公開の注釈やコメントを書き込めるようにする。このコメントは作成者と管理者だけが見ることができます。';
