...
$string['error:markasread'] = 'アイテムを既読にマークできませんでした。';
...
$string['global_setting_use_studentdrawing'] = '参加者にドローイングを許可しますか?';
$string['global_setting_use_studentdrawing_desc'] = 'ドローイングは匿名のため、コメントおよび報告できないことに留意してください。';
$string['global_setting_use_studenttextbox'] = '参加者にテキストボックスを許可しますか?';
$string['global_setting_use_studenttextbox_desc'] = 'テキストボックスアノテーションは匿名のため、コメントおよび報告できないことに留意してください。';
$string['global_setting_useprint'] = '保存および印刷を許可しますか?';
$string['global_setting_useprint_comments'] = 'コメントの保存および印刷を許可しますか?';
$string['global_setting_useprint_comments_desc'] = '参加者にアノテーションおよびコメントの保存および印刷を許可します。';
$string['global_setting_useprint_desc'] = '参加者にPDFドキュメントおよびそのコメントの保存および印刷を許可します。';
$string['global_setting_useprint_document'] = 'ドキュメントの保存および印刷を許可しますか?';
$string['global_setting_useprint_document_desc'] = '参加者にPDFドキュメントの保存および印刷を許可します。';
$string['global_setting_usevotes'] = 'コメントへの「いいね」を許可しますか?';
$string['global_setting_usevotes_desc'] = 'このオプションにより、ユーザは自分以外のユーザの投稿に「いいね」することができます。';
...
$string['setting_use_studentdrawing_help'] = '参加者によるアノテーションおよびコメントを除くPDFドキュメントの保存および印刷を許可します。';
...
$string['setting_useprint_comments'] = 'コメントを保存および印刷する';
$string['setting_useprint_comments_help'] = '参加者によるアノテーションおよびコメントの保存および印刷を許可します。';
$string['setting_useprint_document'] = 'PDFドキュメントを保存および印刷する';
$string['setting_useprint_document_help'] = '参加者によるPDFドキュメントの保存および印刷を許可します。';
