...
/**
 * Strings for component 'block_gismo', language 'ja', version '4.4'.
 *
 * @package     block_gismo
 * @category    string
...
$string['homepage_text'] = 'GISMOはMoodleコース管理システムからトラッキングデータを抽出するグラフィカルインタラクティブ学生モニタリングおよびトラッキングシステムです。GISMOはコースインストラクタおよび学生が学習活動の概要を取得できるよう有用なグラフ表現も生成します。<br />GISMOの使用を開始するには、このページのトップにあるメニューの1つを選択してください。<br />あなたがチュートリアルを閲覧したい場合、メニュー「ヘルプ > チュートリアル」をクリックしてください。';
