...
$string['errorremovenotpermitted'] = 'あなたには自動的に追加されたメンバー {$a} を削除するためのパーミッションがありません。';
...
$string['selectfromgroup'] = 'グループからメンバーを選択する';
$string['selectfromgrouping'] = 'グルーピングからメンバーを選択する';
