...
/**
 * Strings for component 'page', language 'ja', branch 'MOODLE_38_STABLE'
 *
 * @package   page
...
$string['configdisplayoptions'] = '利用可にしたいオプションすべてを選択してください。既存の設定は変更されません。複数フィールドを選択するにはCTRLキーを押したままにしてください。';
