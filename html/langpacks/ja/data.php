...
$string['fieldmappings_help'] = 'このメニュでは既存のデータベースのデータを保持することができます。フィールドのデータを保持するにはそのフィールドをデータが表示されることになる新しいフィールドにマップする必要があります。どのフィールドでも空白のまましてデータをコピーしないこともできます。新しいフィールドにマップされない古いフィールドおよび関連するすべてのデータは削除されます。

あなたは同じタイプのフィールドのみマップできます。そのため、それぞれのドロップダウンメニュには他のフィールドも表示される場合があります。古いフィールドを2個以上の新しいフィールドにマップしないよう気をつけてください。';
...
$string['multimenu'] = 'メニュ (複数選択)';
$string['multipletags'] = '重複タグが見つかりました! テンプレートは保存されませんでした。';
$string['newentry'] = '新しいエントリ';
$string['newfield'] = '新しいフィールドを作成する';
$string['newfield_help'] = 'フィールドにはデータを入力することができます。データベース活動内のそれぞれのエントリには参加者が年月日をドロップダウンメニュから選択できる日付フィールド、イメージをアップロードできる画像フィールド、1つまたはそれ以上のオプションを選択できるチェックボックスフィールドのように複数タイプのフィールドを配置できます。
