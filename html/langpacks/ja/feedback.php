...
$string['cannotcreatepagebreak'] = '最初に改ページは追加できません。最後に1ページのみ改ページを追加できます。';
...
$string['completionsubmit'] = 'フィードバックを送信する';
...
$string['multiplesubmit_help'] = 'この設定を有効にした場合:

* 匿名アンケートの場合: 参加者は無制限に回答を送信できます。すべての回答が記録されます。
* 匿名ではないアンケートの場合: 参加者は無制限に回答を送信できますが、最新の回答のみが記録されます。';
$string['name'] = '名称';
