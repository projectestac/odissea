...
/**
 * Strings for component 'webservice', language 'ja', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['cannotcreatetoken'] = 'サービス {$a} のウェブトークンを作成するためのパーミッションがありません。';
...
$string['errornotemptydefaultparamarray'] = 'ウェブサービス記述パラメータ「 {$a} 」は単一または多重構造となっています。 デフォルトでは空の配列のみ使用できます。ウェブサービス記述をご確認ください。';
$string['erroroptionalparamarray'] = 'ウェブサービス記述パラメータ「 {$a} 」は単一または多重構造となっています。VALUE_OPTIONALとして設定できません。ウェブサービス記述をご確認ください。';
...
$string['phpresponse'] = 'XML-RPC (PHP構造体)';
...
$string['selectedcapabilitydoesntexit'] = '現在設定されている必須ケイパビリティ ({$a}) はもやは存在しません。設定を変更した後、変更を保存してください。';
