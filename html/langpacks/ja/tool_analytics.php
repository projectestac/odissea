...
/**
 * Strings for component 'tool_analytics', language 'ja', version '4.4'.
 *
...
$string['clievaluationandpredictionsnoadmin'] = 'スケジュールタスクでは有効にされたモデルにより繰り返し予測を取得します。ウェブインタフェースによるモデル評価は無効にされます。これはサイト管理者によって有効にすることができます。';
$string['component'] = 'コンポーネント';
$string['componentcore'] = 'コア';
$string['componentselect'] = 'コンポーネント「 {$a} 」によって提供されたモデルすべてを選択する';
...
$string['restoredefaultnone'] = 'コアおよびインストール済みプラグインによって提供されたすべてのデフォルトモデルはすでに作成されています。新しいモデルが見つからなかったため、リストアするものはありません。';
