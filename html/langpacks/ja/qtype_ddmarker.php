...
/**
 * Strings for component 'qtype_ddmarker', language 'ja', version '4.5'.
 *
...
$string['addmoreitems'] = 'さらに {no} 個の空白のマーカを追加する';
$string['alttext'] = '代替テキスト';
$string['answer'] = '答え';
$string['bgimage'] = '背景イメージ';
$string['clearwrongparts'] = '間違って置かれたマーカをイメージの下のデフォルトスタートポジションに戻す';
$string['coords'] = '座標';
...
$string['dropbackground'] = 'マーカをドラッグするための背景イメージ';
...
$string['formerror_onlysometagsallowed'] = 'マーカのラベルとして「 {$a} 」タグのみ許可されます。';
...
$string['infinite'] = '無制限';
$string['marker'] = 'マーカ';
$string['marker_n'] = 'マーカ {no}';
$string['markers'] = 'マーカ';
$string['nolabel'] = 'ラベルテキストなし';
$string['noofdrags'] = 'マーカ数';
...
$string['showmisplaced'] = '正しいマーカがドロップされていないドロップゾーンをハイライトする';
$string['shuffleimages'] = '問題の受験ごとにドラッグアイテムをシャッフルする';
$string['stateincorrectlyplaced'] = 'どのマーカが間違って置かれたかを示す';
