...
/**
 * Strings for component 'install', language 'ja', version '4.5'.
 *
 * @package     install
 * @category    string
...
$string['dbconnectionerror'] = 'あなたが指定したデータベースに接続できませんでした。データベース設定をご確認ください。';
...
$string['directorysettingshead'] = 'このMoodleのインストール先をご確認ください。';
