...
/**
 * Strings for component 'mlbackend_python', language 'ja', version '4.5'.
 *
...
$string['pythonpackagenotinstalled'] = 'moodlemlbackend pythonパッケージがインストールされていないか問題があります。詳細はコマンドラインインタフェースより「 {$a} 」を実行してください。';
