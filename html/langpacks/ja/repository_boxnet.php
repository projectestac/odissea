...
/**
 * Strings for component 'repository_boxnet', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['privacy:metadata:repository_boxnet'] = 'Boxリポジトリプラグインはいかなる個人データも保存しません。しかし、ユーザデータをMoodleからリモートシステムに転送します。';
