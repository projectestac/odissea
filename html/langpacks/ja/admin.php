...
/**
 * Strings for component 'admin', language 'ja', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['configproxyfixunsafe_help'] = 'ここではMoodleBotユーザエージェントを追加してプロクシを使用することにより、プロキシを通らない内部コールの修正を試みます。';
$string['configproxyhost'] = '<b>サーバ</b>のインターネットアクセスにプロキシ (例 ファイアウォール) が必要な場合、プロキシのホスト名を入力してください。必要でない場合、空白にしてください。';
$string['configproxylogunsafe_help'] = 'ここではプロクシを通らない内部コールの記録を試みます。';
...
$string['profilefieldmaxlength_help'] = 'このフィールドを「ユーザIDを表示する」設定のフィールドで使用する場合、文字は半角255文字以下に制限してください。';
...
$string['proxyfixunsafe'] = 'プロクシされないコールを修正する';
$string['proxyhost'] = 'プロキシホスト';
$string['proxylogunsafe'] = 'プロクシされないコールを記録する';
...
$string['resetindentation'] = 'インデントをリセットする';
$string['resetindentation_help'] = 'これにより {$a->format} のコースに設定されたすべてのインデントが削除されます。';
$string['resetindentation_title'] = 'コースページのインデントをリセットしてもよろしいですか?';
$string['resetindentationsuccess'] = 'インデントリセット';
...
$string['sitesectionhelp'] = '選択した場合、トピックセクションがサイトサイトホームに表示されます。';
...
$string['taskquestionstatscleanupcron'] = '問題統計キャッシュを削除するためのバックグラウンド処理';
...
$string['testoutgoingmailconf_message'] = 'これはあなたのサイトの送信メールが正常に設定されたことを確認するためのテストメッセージです。送信: {$a}';
...
$string['testoutgoingmailconf_subject'] = '{$a}: テストメッセージ {$a->additional} 送信: {$a->time}';
