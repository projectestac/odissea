...
$string['configfilternavigationwithsystemcontext'] = '通常のフィルタリング使用は使用されるコンテクスト (例: コースコンテキスト) に関連しますが、サイトナビゲーションでは「コンテンツおよびヘッディング」フィルタリングを使用する場合、明示的にすべてをサイトのコンテクストでフィルタリングすることによりパフォーマンスの改善を期待できます。';
...
$string['unsupportedphpversion80'] = 'PHP version 8.0はサポートされません。';
