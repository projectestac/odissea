...
$string['asyncbackupdisabled'] = 'あなたのサイトは現在、同期バックアップを使用するように設定されています。非同期バックアップはより良いユーザエクスペリエンスを提供します。非同期バックアップはMoodle LMS 4.5 LTS以降、すべてのサイトで有効にされます。同期バックアップはMoodle LMS 4.5 LTS以降のバージョンからは削除されます。';
...
$string['oracledatabaseinuse'] = '私たちはMoodle LMSでのOracle DBサポートを変更します。Moodleバージョン4.5がデータベースアーキテクチャとしてOracleをサポートする最後のバージョンとなります。詳細情報は<a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank">こちら</a>をご覧ください。';
$string['order1'] = '1番目';
$string['order2'] = '2番目';
$string['order3'] = '3番目';
$string['order4'] = '4番目';
