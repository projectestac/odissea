...
このオプションを使用する場合、MoodleサイトおよびツールプロバイダがSSLをサポートしていることをご確認ください。';
...
$string['launch_url_help'] = 'ツールURLでは外部ツールのウェブアドレスを指定します。また、表示するリソース等の追加的な情報を含むことができます。ツールURLに何を入力するのか分からない場合、ツールプロバイダをご確認ください。
...
<p>コンシューマキーおよび共通秘密鍵がある場合、あなたは外部ツールインスタンスの設定時に入力することができます (拡張要素が表示されていることをご確認ください)。</p>
...
$string['register'] = '登録';
$string['register_warning'] = '登録ページを開くのにしばらく時間がかかります。表示されない場合、あなたが設定で正しいURLを入力したかご確認ください。Moodleがhttpsを使用している場合、あなたがhttpsをサポートするよう設定していること、そしてURLにhttpsを使用していることをご確認ください。';
