...
/**
 * Strings for component 'assignfeedback_offline', language 'ja', version '4.4'.
 *
...
$string['default_help'] = 'この設定を設定した場合、すべての新しい課題に関して、ワークシートによるオフライン評定がデフォルトで有効にされます。';
$string['downloadgrades'] = '評定ワークシートをダウンロードする';
$string['enabled'] = 'オフライン評定ワークシート';
$string['enabled_help'] = 'この設定を有効にした場合、教師の課題評定時に学生評点のワークシートをダウンロードおよびアップロードできるようになります。';
...
$string['gradesfile_help'] = '評点が修正された評定ワークシートです。このファイルは課題よりダウンロードされた学生評点およびIDカラムを含むUTF-8エンコーディングのCSVファイルである必要があります。';
$string['gradeupdate'] = '{$a->student} の評点を {$a->grade} に設定する';
$string['ignoremodified'] = 'Moodle内のレコードがスプレッドシートより新しい場合でもレコードの更新を許可します。';
$string['ignoremodified_help'] = '評定ワークシートがMoodleからダウンロードされた場合、それぞれの評点に関する最終更新日時を含みます。このワークシートがダウンロードされた後にMoodle内の評点が更新された場合、Moodleは評定アップロード時に更新情報の上書きを拒否します。このオプションを選択した場合、Moodleは安全チェックを無効にして、複数評定者による他の評定者の評定の上書きを可能とします。';
...
$string['privacy:nullproviderreason'] = 'このプラグインにはユーザ情報を保存するデータベースがありません。評定インタフェースを表示するためmod_assignのAPIのみ使用します。';
