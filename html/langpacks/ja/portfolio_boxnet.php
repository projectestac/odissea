...
/**
 * Strings for component 'portfolio_boxnet', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['existingfolder'] = 'ファイルを保存する既存フォルダ';
$string['folderclash'] = 'あなたが作成を依頼したフォルダはすでに存在しています!';
...
$string['notarget'] = 'あなたはファイルをアップロードする既存フォルダまたは新しいフォルダを指定する必要があります。';
