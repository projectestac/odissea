...
$string['activitylink_help'] = 'レッスンの最後にコース内の別の活動へのリンクを提供するにはドロップダウンメニュより活動を選択してください。';
...
$string['addaquestionpagehere'] = 'ここに問題ページを追加する';
...
$string['addnumerical'] = '数値問題ページを作成する';
$string['addpage'] = 'ページを追加する';
$string['addshortanswer'] = '記述問題ページを作成する';
$string['addtruefalse'] = '○/×問題ページを作成する';
$string['allotheranswers'] = 'すべての他の答え';
$string['allotheranswersjump'] = 'すべての他の答えのジャンプ';
$string['allotheranswersscore'] = 'すべての他の答えの評点';
$string['allowofflineattempts'] = 'モバイルアプリを使ったレッスンのオフライン受験を許可する';
$string['allowofflineattempts_help'] = 'この設定を有効にした場合、モバイルアプリユーザはレッスンをダウンロードしてオフラインで受験することができます。
すべての考えられる回答および正解も同様にダウンロードされます。
注意: 時間制限がある場合、レッスンをオフラインで受験することはできません。';
...
$string['deselectallattempts'] = 'すべての選択を解除する';
...
$string['displayinleftmenu'] = 'メニュに表示しますか?';
$string['displayleftif'] = 'メニュを表示するための最小評点';
$string['displayleftif_help'] = 'この設定ではレッスンメニュが表示される前に学生が特定の評点を取得する必要があるかどうか設定します。これにより最初の受験でレッスンすべてを通すことを学生に強制します。要求される評点を取得した後、学生はレビューのためにメニュを使用することができます。';
$string['displayleftmenu'] = 'メニュを表示する';
$string['displayleftmenu_help'] = 'この設定を有効にした場合、ページ一覧に移動できるメニュをユーザに表示できるようにします。';
$string['displayofgrade'] = '評点を表示する (学生のみ)';
$string['displayreview'] = '問題の再受験オプションを提供する';
$string['displayreview_help'] = 'この設定を有効にした場合、問題が不正解のときに学生が評点なしで再受験するまたはレッスンを続けるオプションを提供します。学生がクリックして別の問題に移動した場合、選択された (正しくない) 解答は保持されます。デフォルトでは間違った解答は「このページ」にジャンプして評点ゼロになるよう設定されています。そのため、あなたの学生が混乱しないよう正しくない解答の場合は異なるページにジャンプする設定をお勧めします。';
...
$string['edit'] = '編集';
$string['editbranchtable'] = 'コンテンツページを編集する';
$string['editcluster'] = 'クラスタを編集する';
...
$string['essayemailmessagesmall'] = '<p>あなたはこの作文問題で {$a->earned} / {$a->outof} を獲得しました。</p><p>あなたの {$a->lesson} レッスンの評点は {$a->newgrade}% に変更されました。</p>';
...
$string['eventhighscoreadded'] = 'レッスンハイスコアが追加されました。';
$string['eventhighscoresviewed'] = 'レッスンハイスコアが閲覧されました。';
...
$string['modattempts_help'] = 'この設定を有効にした場合、学生はレッスンを最初から振り返ることができます。';
...
$string['movepagehere'] = 'ここにページを移動する';
...
$string['nolessonattemptsgroup'] = 'このレッスンでは {$a} グループメンバによる受験はありません。';
$string['none'] = 'なし';
...
$string['notcompletedwithdate'] = '未完了 ({$a})';
...
$string['page-mod-lesson-view'] = 'レッスンページを表示またはプレビュする';
...
$string['pleasecheckoneormoreanswers'] = '1つまたはそれ以上の答えをチェックしてください';
...
$string['preview'] = 'プレビュ';
$string['previewlesson'] = '{$a} のプレビュ';
$string['previewpagenamed'] = 'ページをプレビュする: {$a}';
$string['previouspage'] = '前のページ';
$string['privacy:metadata:attempts'] = 'ページ受験のレコードです。';
$string['privacy:metadata:attempts:answerid'] = '解答IDです。';
$string['privacy:metadata:attempts:correct'] = '受験が正しいかどうか示します。';
$string['privacy:metadata:attempts:pageid'] = 'ページIDです。';
$string['privacy:metadata:attempts:retry'] = '受験番号です。';
$string['privacy:metadata:attempts:timeseen'] = '受験された日時です。';
$string['privacy:metadata:attempts:useranswer'] = 'ユーザの解答に関する詳細です。';
$string['privacy:metadata:attempts:userid'] = 'ユーザiDです。';
$string['privacy:metadata:branch'] = 'ページ閲覧のレコードです。';
$string['privacy:metadata:branch:flag'] = '次のページがランダムに計算されたかどうか示します。';
$string['privacy:metadata:branch:nextpageid'] = '次のページIDです。';
$string['privacy:metadata:branch:pageid'] = 'ページIDです。';
$string['privacy:metadata:branch:retry'] = '受験番号です。';
$string['privacy:metadata:branch:timeseen'] = 'ページが閲覧された日時です。';
$string['privacy:metadata:branch:userid'] = 'ユーザiDです。';
$string['privacy:metadata:grades'] = 'それぞれのレッスンの評定のレコードです。';
$string['privacy:metadata:grades:completed'] = '評定された日時です。';
$string['privacy:metadata:grades:grade'] = '評点です。';
$string['privacy:metadata:grades:userid'] = 'ユーザiDです。';
$string['privacy:metadata:overrides'] = 'レッスンごとのオーバーライドのレコードです。';
$string['privacy:metadata:overrides:available'] = 'レッスンを受験できるようになる日時です。';
$string['privacy:metadata:overrides:deadline'] = 'レッスンを完了する必要のある期限です。';
$string['privacy:metadata:overrides:maxattempts'] = '最大受験回数です。';
$string['privacy:metadata:overrides:password'] = 'レッスンにアクセスするためのパスワードです。';
$string['privacy:metadata:overrides:retake'] = '再受験が許可されるかどうか示します。';
$string['privacy:metadata:overrides:review'] = '再度問題を受験できるかどうか示します。';
$string['privacy:metadata:overrides:timelimit'] = 'レッスンを完了するための制限時間 (秒) です。';
$string['privacy:metadata:overrides:userid'] = 'ユーザiDです。';
$string['privacy:metadata:timer'] = 'レッスン受験のレコードです。';
$string['privacy:metadata:timer:completed'] = '受験が完了したかどうか示します。';
$string['privacy:metadata:timer:lessontime'] = '活動を記録した最終日時です。';
$string['privacy:metadata:timer:starttime'] = '受験の開始日時です。';
$string['privacy:metadata:timer:timemodifiedoffline'] = 'モバイルアプリによる活動を記録した最終日時です。';
$string['privacy:metadata:timer:userid'] = 'ユーザiDです。';
$string['privacy:metadata:userpref:lessonview'] = 'レッスン修正時の推奨表示モードです。';
$string['privacy:path:essayanswers'] = '作文問題';
$string['privacy:path:essayresponses'] = '日誌解答';
$string['privacy:path:pages'] = 'ページ';
...
$string['selectallattempts'] = 'すべての受験を選択する';
...
$string['studentoutoftimeforreview'] = '注意: あなたにはこのレッスンをレビューする時間がなくなりました。';
...
$string['withselectedattempts'] = '選択した受験に対して ...';
