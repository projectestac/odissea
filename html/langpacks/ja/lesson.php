...
$string['displayleftif_help'] = 'この設定ではレッスンメニューが表示される前に学生が特定の評点を取得する必要があるかどうか設定します。これで最初の受験でレッスンすべてを通すことを学生に強制します。要求される評点を取得した後、学生はレビューのためにメニューを使用することができます。';
$string['displayleftmenu'] = 'メニューを表示する';
$string['displayleftmenu_help'] = 'この設定を有効にした場合、ページ一覧に移動できるメニューをユーザに表示できるようにします。';
...
$string['emailsuccess'] = '通知が正常に送信されました。';
...
$string['lowtime'] = '最短時間';
$string['manageoverrides'] = 'オーバーライドを管理する';
...
$string['offlinedatamessage'] = 'あなたはこの受験にモバイルデバイスを使用しました。最新のデータは {$a} 前にこのサイトに保存されています。未保存の受験があるかどうかご確認ください。';
