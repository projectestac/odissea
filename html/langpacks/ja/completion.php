...
$string['activitycompletion'] = '完了コンディション';
...
$string['completion_automatic'] = '要件を追加する';
...
$string['completion_manual'] = '学生は手動で活動完了をマークする必要がある';
$string['completion_none'] = 'なし';
$string['completionactivitydefault'] = '活動デフォルトを使用する';
$string['completionanygrade_desc'] = '評点を問わず';
...
$string['completionexpected'] = 'タイムラインにリマインダを追加する';
$string['completionexpected_help'] = 'ここであなたは学生がこの活動に取り組むためのリマインダを設定できます。ダッシュボードのタイムラインブロックに「{$a} 必要アクション」と表示されます。';
...
$string['completionpassgrade_desc'] = '合格点';
...
$string['completionusegrade_desc'] = '評定を受ける';
...
$string['completionview_desc'] = '活動を閲覧する';
...
$string['coursecompletionsettings'] = 'コース完了設定';
...
$string['done'] = '完了';
$string['editconditions'] = 'コンディションを編集する';
$string['editcoursecompletionsettings'] = 'コース完了設定を編集する';
$string['emptyconditionsinfo'] = 'この活動に設定された完了コンディションはありません。';
$string['emptyconditionswarning'] = 'あなたは少なくとも1つの完了コンディションを追加する必要があります。';
...
$string['incompatibleplugin'] = 'この活動はデフォルトの完了設定をサポートしていません。完了条件は使用ごとに手動設定する必要があります。';
