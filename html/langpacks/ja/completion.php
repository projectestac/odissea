...
$string['completedwarningtext'] = 'この活動はすでに {$a} 名の参加者に完了マークされています。完了オプションの変更により、それらの完了ステータスを消去するため、混乱の原因となる可能性があります。そのため、完了オプションはロックされてます。あなたが絶対に必要な場合を除き、ロック解除しないことをお勧めします。';
