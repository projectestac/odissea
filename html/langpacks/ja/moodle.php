...
$string['idnumbercoursecategory_help'] = 'コースカテゴリのIDナンバは外部のシステムのカテゴリとマッチングする場合にのみ使用されます。また、サイト内のどこにも表示されることはありません。このカテゴリに関する公式のコード名がある場合はここに入力してください。そうではない場合、フィールドを空白のままにできます。';
$string['idnumbergroup'] = 'グループIDナンバ';
$string['idnumbergroup_help'] = 'グループのIDナンバは外部のシステムのコースとマッチングする場合にのみ使用されます。また、サイト内のどこにも表示されることはありません。このグループに関する公式のコード名がある場合はここに入力してください。そうではない場合、フィールドを空白のままにできます。';
$string['idnumbergrouping'] = 'グルーピングIDナンバ';
$string['idnumbergrouping_help'] = 'グルーピングのIDナンバは外部のシステムのコースとマッチングする場合にのみ使用されます。また、サイト内のどこにも表示されることはありません。このグルーピングに関する公式のコード名がある場合はここに入力してください。そうではない場合、フィールドを空白のままにできます。';
$string['idnumbermod'] = 'IDナンバ';
$string['idnumbermod_help'] = 'IDナンバを設定することで評定計算またはカスタムレポートのために活動またはリソースを識別する手段を提供します。そうではない場合、フィールドを空白のままにできます。
...
$string['messageprovider:failedtaskmaxdelay'] = 'タスクが最大失敗遅延に到達';
...
<a href="{$a->link}">こちらをクリックしてログイン</a>し、「 {$a->sitename} 」をご利用ください。

ご不明な点はサイト管理者にお問い合わせください。
{$a->signoff}';
