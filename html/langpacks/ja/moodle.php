...
$string['blockconfigbad'] = 'このブロックは正常に組み込まれていないため、設定インターフェースを表示できません。';
$string['blocks'] = 'ブロック';
...
$string['emaildisplaycoursemembersonly'] = '(他のコース参加者に開示する)';
$string['emaildisplayeveryone'] = '(すべての人に開示する)';
...
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'トークンと一致する発行者のIDです。';
...
$string['showactivitydates'] = '活動日を表示する';
$string['showactivitydates_help'] = '活動日付が常に活動ページに表示されます。この設定ではコースページのそれぞれの活動の下にも活動日付を表示するかどうか決定します。';
