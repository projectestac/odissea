...
/**
 * Strings for component 'moodle', language 'ja', version '4.5'.
 *
 * @package     moodle
 * @category    string
...
$string['accept'] = '承認';
$string['action'] = '操作';
$string['actionchoice'] = 'このファイル「 {$a} 」で何をしますか?';
$string['actions'] = '操作';
...
$string['activityorresource'] = '活動またはリソース';
...
$string['addfilesdrop'] = 'あなたはここにファイルをドラッグ&ドロップしてアップロードするか、クリックして選択できます。';
$string['addinganew'] = '新しい {$a}';
...
$string['backupinfo'] = 'すべてのコンテンツおよび最新の活動を含むこのコースのコピーを作成します。あなたはコースの復元にバックアップファイルを使用できます。';
...
$string['check'] = 'チェック';
$string['checkactual'] = '実';
$string['checkall'] = 'すべてをチェック';
$string['checkerror'] = 'チェック「 {$a} 」の結果取得エラーです。詳細はブラウザのコンソールでご確認ください。';
$string['checkexpected'] = '期待値';
...
$string['checkloading'] = 'チェック「 {$a} 」の結果を取得する';
...
$string['confirm'] = '確認';
$string['confirmaccount'] = 'アカウントを確認する';
...
$string['confirmednot'] = 'あなたの登録はまだ承認されていません。メールボックスで承認メールをご確認ください。';
...
$string['contextname'] = 'コンテクスト名';
$string['contextparent'] = '親';
...
$string['coursedisplay_help'] = 'コースセクションは1ページにまとめて表示することも、複数ページに分割して表示することもできます。';
...
$string['courseoverviewfiles_help'] = 'コースイメージはマイコースおよびホームページの利用可能なコース一覧に表示されます。サイト管理者は追加ファイルタイプおよび複数ファイルの使用を有効にできます。あなたが複数のファイルを使用する場合、それらはすべてホームページの利用可能なコース一覧に表示されます。';
...
$string['coursereusenavigationmenu'] = 'コース再利用ナビゲーションメニュー';
$string['courses'] = 'コース';
...
$string['coursesectiontitlebulkediting'] = 'バルク編集 {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'バルクコース編集: {$a->course}';
...
* 非表示: 教師および非表示のコースを表示できるケイパビリティのあるユーザにのみアクセスが制限されます。';
$string['create'] = '作成';
...
$string['defaulthomepageuser'] = 'スタートページ';
$string['defaulthomepageuser_help'] = 'サイトログイン後、どのページにリダイレクトさせますか?';
$string['delete'] = '削除';
$string['deleteablock'] = 'ブロックを削除する';
$string['deleteall'] = 'すべてを削除する';
$string['deleteallcannotundo'] = 'すべてを削除する - 元に戻せません。';
$string['deleteallcomments'] = 'すべてのコメント';
$string['deleteallratings'] = 'すべての評価';
...
$string['deletecheckfull'] = '本当にプｒファイル詳細、登録、グループ、コーホートメンバーシップおよび一部のユーザ活動データを含むユーザ {$a} を完全に削除してもよろしいですか?';
...
$string['duplicatedsection'] = '{$a} (コピー)';
...
$string['editgroupprofile'] = 'グループ説明を編集する';
...
$string['editsection'] = '設定を編集する';
$string['editsectionname'] = 'セクション名を編集する';
$string['editsectionsettings'] = 'セクション設定を編集する';
$string['editsectiontitle'] = 'セクションを設定する: {$a}';
...
$string['emailalreadysent'] = 'パスワードリセットメールはすでに送信されています。あなたのメールをご確認ください。';
$string['emailcharset'] = 'メール文字コード';
$string['emailconfirm'] = 'アカウントの確定';
$string['emailconfirmation'] = 'こんにちは {$a->fullname} さん
...
$string['emailonlyallowed'] = 'このメールアドレスは使用できません。許可されるメールドメインは次のとおりです: {$a}';
$string['emailpasswordchangeinfo'] = 'こんにちは {$a->fullname} さん

誰か (おそらくあなた) が「 {$a->usitename} 」 のアカウント「 {$a->username} 」に対して新しいパスワードをリクエストしました。

あなたのパスワードを変更するには以下のリンクをクリックしてください:

<a href="{$a->link}">パスワードを変更する</a>

クリックできない場合、ウェブブラウザウィンドウのアドレス欄にアドレスをコピー＆ペーストしてください。

分からないことがある場合、サイト管理者にご連絡ください:
{$a->admin}';
$string['emailpasswordchangeinfodisabled'] = 'こんにちは {$a->fullname} さん
...
$string['emailpasswordchangeinfofail'] = 'こんにちは {$a->fullname} さん

「 {$a->sitename} 」のあなたのアカウントへ新しいパスワードのリクエストがありました。

申し訳ありませんが、このサイトではパスワードをリセットすることができません。サイト管理者 {$a->admin} にご連絡ください。';
$string['emailpasswordchangeinfosubject'] = '{$a}: パスワード変更情報';
$string['emailpasswordconfirmation'] = 'こんにちは {$a->fullname} さん

誰か (おそらくあなた) が「 {$a->usitename} 」 のアカウント「 {$a->username} 」に対して新しいパスワードをリクエストしました。

これを確認してあなたのメールで新しいパスワードを受け取るには以下のリンクをクリックしてください:

<a href="{$a->link}">新しいパスワードを取得する</a>
...
$string['emailresetconfirmation'] = 'こんにちは {$a->fullname} さん

{$a->sitename} であなたのアカウント「 {$a->username} 」のパスワードリセットがリクエストされました。

このリクエストを確認してあなたのアカウントに新しいパスワードを設定するには以下のリンクをクリックしてください:

<a href="{$a->link}">パスワードをリセットする</a>

(このリンクは最初のリセットのリクエスト後、{$a->resetminutes} 分間有効です)

このパスワードリセットがあなたからリクエストされていない場合、作業は不要です。
...
$string['emojicategorypeoplebody'] = '人 & 身体';
...
$string['enddate_help'] = '終了日は学生のコースへのアクセスを制限するものではありません。ここではコースがマイコースに「過去」として表示されるかどうか決定します。';
$string['enddatewithtaskenabled'] = 'コース終了日';
$string['enddatewithtaskenabled_help'] = 'コースが秘匿されて学生がコースにアクセスできなくなる日付です。';
$string['english'] = '英語';
...
$string['errorwhenconfirming'] = 'エラーが発生したため、あなたのアカウントは認証されませんでした。メール本文のリンクをクリックして、このページにたどり着いた場合、リンクが記されている行が崩れていないかご確認ください。正しくリンクを動作させるためにコピー＆ペーストを使用してください。';
...
$string['eventcourseended'] = 'コースが終了しました。';
...
$string['eventcoursestarted'] = 'コースが開始しました。';
...
$string['eventsectionviewed'] = 'セクションが表示されました。';
$string['eventunknownlogged'] = '不明なイベント';
$string['eventurlblocked'] = 'URLがブロックされました。';
...
$string['failedtaskbody'] = '<p>こんにちは {$a->fullname} さん</p>
<p>タスク「 {$a->taskname} 」が複数回失敗したため注意が必要です。</p>
<p><a href="{$a->link}">タスクを確認する</a></p>';
$string['failedtaskcontexturlname'] = 'ステータスレポート';
$string['failedtasksubject'] = 'タスク失敗: {$a}';
$string['favourites'] = '星付き';
$string['feedback'] = 'フィードバック';
$string['file'] = 'ファイル';
$string['fileexists'] = 'ファイル名「 {$a} 」のファイルはすでに存在します。';
$string['filemissing'] = '{$a} が見つかりません。';
$string['filereaderror'] = 'ファイル「 {$a} 」を読み込めません。これが本当にフォルダではなくファイルであることをご確認ください。';
$string['files'] = 'ファイル';
...
$string['forcepasswordchange_help'] = 'この設定を有効にした場合、次回ログイン時、ユーザにパスワード変更が求められます。';
...
{$a}';
$string['forcepasswordresetnotice'] = 'あなたの現在のパスワードはパスワードポリシーに合致しないようになりました。ログインするにはあなたのパスワードをリセットする必要があります。
{$a}';
...
* 単一活動 - コースページには単一の活動またはリースのみ含まれます。
* ソーシャル - コースページのメインフォーラムを中心としたコースページです。ソーシャル活動ブロックで追加の活動またはリソースを追加できます。
* カスタムセクション - コースはカスタマイズ可能なセクションに分けられます。
* ウィークリーセクション - コースはコース開始日からそれぞれの週に対応するセクションに分けられます。';
...
$string['fullnamecourse_help'] = '長いコース名はマイコースおよびホームページの利用可能なコース一覧に表示されます。';
...
$string['hiddensections_help'] = '非表示セクションはコースページで学生に「利用できません」として表示するか、完全に秘匿できます。';
...
$string['highlightoff'] = 'ハイライトを解除する';
$string['hits'] = 'アクセス';
...
$string['idnumbercourse'] = 'コースIDナンバ';
$string['idnumbercourse_help'] = '外部システムとコースを接続するためだけに使用されます。あなたに公式コースIDがない場合、空白のままにしてください。';
$string['idnumbercoursecategory'] = 'カテゴリIDナンバ';
$string['idnumbercoursecategory_help'] = 'コースカテゴリのIDナンバは外部のシステムのカテゴリとマッチングする場合にのみ使用されます。また、サイト内のどこにも表示されることはありません。このカテゴリに関する公式のコード名がある場合はここに入力してください。そうでない場合、フィールドを空白のままにできます。';
$string['idnumbergroup'] = 'グループIDナンバ';
$string['idnumbergroup_help'] = 'グループのIDナンバは外部のシステムのコースとマッチングする場合にのみ使用されます。また、サイト内のどこにも表示されることはありません。このグループに関する公式のコード名がある場合はここに入力してください。そうでない場合、フィールドを空白のままにできます。';
$string['idnumbergrouping'] = 'グルーピングIDナンバ';
$string['idnumbergrouping_help'] = 'グルーピングのIDナンバは外部のシステムのコースとマッチングする場合にのみ使用されます。また、サイト内のどこにも表示されることはありません。このグルーピングに関する公式のコード名がある場合はここに入力してください。そうでない場合、フィールドを空白のままにできます。';
$string['idnumbermod'] = 'IDナンバ';
$string['idnumbermod_help'] = 'IDナンバを設定することで評定計算またはカスタムレポートのために活動またはリソースを識別する手段を提供します。そうでない場合、フィールドを空白のままにできます。

IDナンバは活動設定ページでのみ編集できますが評定可能な活動では評定表でも設定できます。';
$string['idnumbertaken'] = 'このIDナンバはすでに取得されています。';
...
$string['importinfo'] = '活動、ブロック、カレンダーイベント等、他のコースからアイテムをインポートしてください。ユーザデータはインポートされません。';
$string['inactive'] = '停止';
...
$string['includesubcategories'] = 'カテゴリを含む';
...
$string['insertcontentbefore'] = '「 {$a->activityname} 」の前にコンテンツを挿入する';
$string['insertcontentsection'] = 'セクション「 {$a->sectionname} 」にコンテンツを挿入する';
$string['insertresourceoractivitybefore'] = '「 {$a->activityname} 」の前に活動またはリソースを挿入する';
...
$string['invalidtaskclassname'] = '無効なタスククラス {$a} です。';
$string['invalidtaskid'] = '無効なタスククIDです。';
...
$string['locktimeout'] = 'ロック待ちの間に操作がタイムアウトしました。';
...
$string['makeavailablecmtitle'] = '活動を利用可能にする';
...
$string['markedthistopic'] = 'このトピックは現在のセクションとしてハイライトされています。';
$string['markthistopic'] = 'このセクションを現在のセクションとしてハイライトします。';
$string['match'] = '合致';
...
$string['maximumupload_help'] = '学生がコースにアップロードできる最大ファイルサイズです。加えて、あなたはそれぞれの活動に対して最大アップロードサイズを制限できます。';
$string['maxlengthreached'] = '{$a} の最大文字制限に達しました。';
...
$string['messageprovider:enrolcoursewelcomemessage'] = '新しいコース登録のウェルカムメッセージ';
$string['messageprovider:errors'] = 'サイトの重大なエラー';
$string['messageprovider:errors_help'] = '管理者が知る必要のある重大なエラーです。';
$string['messageprovider:failedtaskmaxdelay'] = 'タスクが最大失敗遅延に達しました。';
$string['messageprovider:gradenotifications'] = '評定通知';
$string['messageprovider:infected'] = 'アンチウイルス失敗通知';
...
$string['moodledocslink'] = 'このページのドキュメンテーション';
$string['moodlelogo'] = 'Moodleロゴ';
$string['moodlenet:cannotconnecttoserver'] = 'MoodleNetサーバに接続できません。';
$string['moodlenet:columnname'] = '名称';
$string['moodlenet:columnsenddate'] = '送信日';
$string['moodlenet:columnsendstatus'] = '送信ステータス';
$string['moodlenet:columntype'] = 'タイプ';
$string['moodlenet:configoauthservice'] = 'MoodleNetサイトへの共有を有効にするためにMoodleNet OAuth 2サービスを選択してください。まだサービスが存在しない場合、あなたは<a href="{$a}">作成する</a>必要があります。';
$string['moodlenet:deletedactivity'] = '削除済み活動';
$string['moodlenet:deletedcourse'] = '削除済みコース';
$string['moodlenet:eventresourceexported'] = 'リソースがエクスポートされました。';
$string['moodlenet:gotomoodlenet'] = 'MoodleNet下書きに移動する';
$string['moodlenet:issuerisnotauthorized'] = 'MoodleNetイシュアが承認されていません。';
$string['moodlenet:issuerisnotenabled'] = 'MoodleNetイシュアが有効にされていません。';
$string['moodlenet:issuerisnotset'] = 'MoodleNetイシュアがサイト管理で設定されていません。';
$string['moodlenet:nosharedresources'] = '現在、表示する共有リソースはありません。';
$string['moodlenet:outboundsettings'] = 'MoodleNet外向き設定';
$string['moodlenet:packagingandsending'] = 'あなたのファイルを圧縮してMoodleNetに送信しています ...';
$string['moodlenet:sharefailtext'] = 'あなたのコンテンツをMoodleNetに共有する際にエラーが発生しました。<br />後ほど再度お試しください。';
$string['moodlenet:sharefailtextwithsitesupport'] = 'あなたのコンテンツをMoodleNetに共有する際にエラーが発生しました。<br />後ほど再度お試しください。または<a href="{$a}">サポートにご連絡ください</a>。';
$string['moodlenet:sharefailtitle'] = '何か問題が発生しました。';
$string['moodlenet:sharefilesizelimitexceeded'] = '共有リソースのサイズ ({$a->filesize} bytes) が制限の {$a->filesizelimit} バイトを超えました。';
$string['moodlenet:sharenoticeactivity'] = 'この活動はリソースとしてMoodleNetと共有されます。';
$string['moodlenet:sharenoticecourse'] = 'このコースはリソースとしてMoodleNetと共有されています。';
$string['moodlenet:sharenoticepartial'] = '選択された活動はリソースとしてMoodleNetと共有されます。';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} 活動はコースに含まれます。';
$string['moodlenet:shareprogress'] = 'MoodleNet進捗状況共有';
$string['moodlenet:shareprogressinfo'] = 'リストにはあなたがMoodleNetに共有したコースおよび活動が表示されます。<br />MoodleNetで表示するにはリソース名をクリックしてください。';
$string['moodlenet:sharesuccesstext'] = 'ほぼ完了しました! MoodleNetの下書きにアクセスして、あなたのコンテンツ共有を完了させてください。';
$string['moodlenet:sharesuccesstitle'] = 'MoodleNet下書きに保存されました。';
$string['moodlenet:sharetomoodlenet'] = 'MoodleNetに共有する';
$string['moodlenet:sharetyperesource'] = 'リソース';
$string['moodlenet:sharinglargefile'] = '大きなファイルは時間を要する場合があります。';
$string['moodlenet:sharingstatus'] = 'MoodleNetに共有する';
$string['moodlenet:sharingto'] = '共有先:';
...
$string['moveup'] = '上へ';
$string['multipleitemsfound'] = '{$a} アイテムが見つかりました。';
$string['mustchangepassword'] = '新しいパスワードには現在のパスワードと異なるものを指定してください。';
$string['mustconfirm'] = 'あなたのアカウントをご確認ください。';
...
$string['newpasswordfromlost'] = '<strong>注意:</strong> 喪失パスワードリカバリ処理の一環として送信される2通のメールの<strong>2番目</strong>にあなたの<strong>現在のパスワード</strong>が送信されます。この画面を続ける前にあなたの新しいパスワードが記載されたメールを受信したことをご確認ください。';
$string['newpasswordtext'] = 'こんにちは {$a->fullname} さん
...
$string['newsitemsnumber_help'] = 'アナウンスメントフォーラムはデフォルトで強制購読が設定されています。教師および適切な権限を持つユーザのみ投稿できます。

あなたがアナウンスメントフォーラムを必要としない場合、この設定をゼロにしてください。

この設定は最新アナウンスメントブロックに表示される最近のアナウンスメント数にも影響します。';
$string['newuser'] = '新しいユーザ';
$string['newusernewpasswordsubj'] = '新しいユーザアカウント';
$string['newusernewpasswordtext'] = 'こんにちは {$a->fullname} さん
...
<a href="{$a->link}">ログインするためにクリックして</a>「 {$a->sitename} 」の利用を開始してください。
...
$string['noresultsfor'] = '「 {$a} 」の結果はありません。';
$string['normal'] = 'ノーマル';
...
$string['oneitemfound'] = '1 アイテムが見つかりました。';
...
$string['pluginmissingfromdisk'] = '{$a->name} (ディスクにありません)';
...
$string['policyagreementclick'] = 'サイト使用許諾';
$string['popup'] = 'ポップアップ';
...
$string['previewthemename'] = 'テーマ「 {$a} 」をプレビューする';
$string['previous'] = '前へ';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'MoodleNet進捗状況詳細';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = '関連コースモジュールID';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = '関連コースID';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = '共有成功後にMoodleNetから返されるURL';
$string['privacy:metadata:moodlenet_share_progress:status'] = '共有結果ステータス';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = '共有実施時間';
$string['privacy:metadata:moodlenet_share_progress:type'] = '実施された共有タイプ';
$string['privacy:metadata:moodlenet_share_progress:userid'] = '共有を実施したユーザ';
$string['privacy:metadata:oauth2_refresh_token'] = 'OAuth 2.0通信に使用されるトークンをリフレッシュする';
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'トークンと一致するイシュアのIDです。';
$string['privacy:metadata:oauth2_refresh_token:scopehash'] = 'トークンと一致するユーザのIDです。';
$string['privacy:metadata:oauth2_refresh_token:timecreated'] = 'トークンの作成日時です。';
$string['privacy:metadata:oauth2_refresh_token:timemodified'] = 'トークンの最終更新日時です。';
$string['privacy:metadata:oauth2_refresh_token:token'] = 'それぞれのスコープおよびユーザのリフレッシュトークンです。';
$string['privacy:metadata:oauth2_refresh_token:userid'] = 'トークンと一致するユーザのIDです。';
...
$string['resendemail'] = '確認メールを再送する';
$string['reset'] = 'リセット';
$string['resetcomponent'] = 'コンポーネント';
$string['resetcourse'] = 'コースをリセットする';
$string['resetcourseconfirm'] = 'コースをリセットしますか?';
$string['resetcoursewarning'] = '本当にコース「 {$a} 」をリセットしてもよろしいですか?
<br/><br/>
これは選択されたデータを削除およびコースを元の状態にリセットします。この操作は元に戻せません。';
$string['resetinfo'] = 'あなたはこの機能ですべてのユーザデータを消去およびコースを元の状態にリセットできます。コース活動および設定はそのまま残ります。';
$string['resetinfoselect'] = '以下のカテゴリから削除またはリセットしたいデータを選択してください:';
$string['resetnotimplemented'] = 'リセット未サポート';
$string['resetnotimplementedinfo'] = 'これらの活動はリセットできません:';
...
$string['restoreinfo'] = 'バックアップファイルを使用して以前のバージョンのコースを復元または新しいコースを作成します。';
...
$string['rolerenaming_help'] = 'このコースのロールの表示名を変更します。';
$string['rolerenaming_success'] = 'コースロール名が更新されました。';
$string['roles'] = 'ロール';
$string['rss'] = 'RSS';
...
$string['searchgroups'] = 'グループを検索する';
$string['searchitems'] = 'アイテムを検索する';
...
$string['sectionoutline'] = 'セクションアウトライン';
...
$string['selecttheme'] = 'テーマを選択する';
$string['selectthemename'] = 'テーマ「 {$a} 」を選択する';
$string['senddetails'] = '私のログイン情報をメール送信する';
$string['sent'] = '送信済み';
$string['separate'] = '分離';
$string['separateandconnected'] = '分離・関連認識';
$string['separateandconnected1'] = '主に分離認識の傾向がある';
$string['separateandconnected2'] = '分離認識と関連認識を同等に持っている';
$string['separateandconnected3'] = '主に関連認識の傾向がある';
...
$string['shortnamecourse_help'] = '限られたスペースに表示される名称です。これはユニークである必要があります。';
...
$string['showactivitydates'] = '活動日付を表示する';
$string['showactivitydates_help'] = 'コースページに活動日付を表示します。';
...
$string['showgrades_help'] = '学生がコースのすべての評定一覧を閲覧できるようにします。';
...
$string['showreports_help'] = '学生がプロファイルページから自分の活動レポートを閲覧できるようにします。';
...
$string['signoutofotherservices'] = 'すべてのウェブアプリからログアウトする';
$string['signoutofotherservices_help'] = 'モバイルアプリ等、ウェブサービスを使用するすべてのデバイスおよびシステムからログアウトします。ブラウザセッションは有効のままです。';
$string['since'] = '対象範囲';
$string['sincelast'] = '最終ログインより';
$string['site'] = 'サイト';
$string['sitedefault'] = 'サイトデフォルト';
$string['sitedefaultspecified'] = 'サイトデフォルト ({$a})';
...
$string['sites'] = 'サイト';
$string['sitesection'] = 'カスタムコンテンツを追加する';
...
$string['startdate_help'] = 'この日付はウィークリーフォーマットのコースにおける最初の週の開始を決定します。また、コース活動ログの開始日も決定します。

あなたがコースをリセットしてこの日付を変更した場合、新しい開始日に基づいてコース内すべての日付が移動されます。';
$string['startdatewithtaskenabled'] = 'コース開始日';
$string['startdatewithtaskenabled_help'] = 'コースが学生に公開される日付です。この日付以前、学生はコースにアクセスできません。

この日付はウィークリーフォーマットでコースの最初の週の開始日を決定します。また、これはコース活動ログの開始日でもあります。コースをリセットしてこの日付を変更した場合、コース内のすべての日付は新しい開始日に関連して移動されます。';
...
$string['status'] = 'ステータス';
$string['statuschecks'] = 'ステータスチェック';
$string['statuscritical'] = 'クリティカル';
$string['statusdone'] = '完了';
...
$string['subject'] = '件名';
$string['submit'] = '送信';
$string['subsectionmoveerror'] = 'このサブセクションを別のサブセクションに移動できません。';
$string['success'] = '成功';
...
$string['theme'] = 'テーマ';
$string['themepreviewdescription'] = '「 {$a} 」テーマ説明';
$string['themepreviewimage'] = '「 {$a} 」プレビューイメージ';
$string['themes'] = 'テーマ';
...
$string['togglesearch'] = '検索入力に切り替える';
...
$string['usermatchedon'] = 'このユーザを次のフィールドの検索で合致させる';
...
$string['userselectorsearchanywhere'] = 'どこでも';
$string['userselectorsearchexactmatchonly'] = '完全一致のみ';
$string['userselectorsearchfromstart'] = '最初から';
$string['userselectorsearchmatching'] = '一致:';
...
$string['viewallresults'] = 'すべての結果を表示する ({$a})';
...
$string['welcomeback'] = 'こんにちは {$a->fullname} さん! 👋';
...
$string['welcometosite'] = 'ようこそ {$a->fullname} さん! 👋';
...
$string['wontrunfuturescheduledtask'] = '失敗していなく，今後実行予定のタスクは実行しない';
