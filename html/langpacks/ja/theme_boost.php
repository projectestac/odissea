...
/**
 * Strings for component 'theme_boost', language 'ja', version '3.11'.
 *
 * @package     theme_boost
 * @category    string
...
$string['backgroundimage_desc'] = 'サイトの背景として表示するイメージです。ここであなたがアップロードした背景イメージはテーマプリセットファイルの背景イメージをオーバーライドします。';
$string['bootswatch'] = 'Bootswatch';
$string['bootswatch_desc'] = 'bootswatchはBootstrapのスタイルを変更するための一連のBootstrap変数およびCSSです。';
$string['brandcolor'] = 'ブランド色';
...
$string['privacy:drawernavclosed'] = '現在のナビゲーションドロワのプリファレンスはクローズです。';
$string['privacy:drawernavopen'] = '現在のナビゲーションドロワのプリファレンスはオープンです。';
$string['privacy:metadata'] = 'Boostテーマはすべてのユーザに関していかなる個人データも保存しません。';
$string['privacy:metadata:preference:draweropennav'] = 'ドロワメニューナビゲーションの表示および非表示に関するユーザプリファレンスです。';
$string['rawscss'] = '生SCSS';
$string['rawscss_desc'] = 'スタイルシートの最後に挿入されるSCSSまたはCSSコードを提供する場合、このフィールドを使用してください。';
$string['rawscsspre'] = '生先頭SCSS';
