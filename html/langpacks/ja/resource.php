...
/**
 * Strings for component 'resource', language 'ja', version '4.4'.
 *
 * @package     resource
 * @category    string
...
$string['filterfilesexplain'] = 'コンテンツフィルタのタイプを選択してください。この設定によりいくつかのFlashおよびJapaアプレットに問題が生じる可能性があることに留意してください。すべてのテキストファイルがUTF-8エンコーディングされていることを確認してください。';
$string['filtername'] = 'リソース名オートリンク';
$string['forcedownload'] = '強制的にダウンロードする';
...
$string['modulename_help'] = 'ファイルモジュールにおいて教師はコースリソースとしてファイルを提供することができます。可能な場合、ファイルはコースインタフェース内に表示されます。そうでない場合、学生にファイルのダウンロードが促されます。例えばHTMLページにイメージを埋め込むことができるようにファイルモジュールではファイルの組み込みがサポートされます。

ファイルを開くために学生は自分のコンピュータに適切なソフトウェアをインストールする必要があります。
