...
/**
 * Strings for component 'block_point_view', language 'ja', version '4.5'.
 *
...
$string['blockonlyonmainpage'] = 'このブロックはコースのサブコンテキストに表示されないため、コースモジュールページでは難易度トラックやリアクションは表示されません。';
$string['bluetrack'] = 'ブルートラック';
$string['cleanupcoursereactions'] = '<b>{$a}</b> コースのリアクションをクリーンアップする';
$string['cleanupreactions'] = 'リアクションをクリーンアップする';
$string['cleanupreactions_help'] = 'コースに在籍していないユーザーのリアクションをクリーンアップ（削除）する';
$string['cleanupreactionsconfirmation'] = 'コース <b>{$a}</b> に在籍していないユーザーのリアクションをクリーンアップ（削除）してもよいですか？この操作は元に戻せません。';
$string['confirmshowinsubcontexts'] = 'このブロックをサブコンテキストに表示してもよいですか？<br>（ブロックの設定にある「ブロックの表示場所」から元に戻すことができます。）';
...
$string['enableforfuturemodules'] = '今後追加されるモジュールも有効にする';
...
$string['eventreactionadded'] = 'リアクションを追加しました';
$string['eventreactionremoved'] = 'リアクションを削除しました';
$string['eventreactionupdated'] = 'リアクションを更新しました';
$string['forthismodule'] = 'このモジュール（{$a}）について：';
$string['greentrack'] = 'グリーントラック';
$string['header_activities'] = 'リアクションおよび難易度トラックを設定する';
$string['header_images'] = '絵文字設定';
$string['highlightactivityrows'] = 'コースページのアクティビティ行をハイライト表示する';
$string['highlightactivityrows_help'] = 'コースページのアクティビティにカーソルを合わせたとき、グレーのグラデーション背景を表示します。これはアクティビティのリアクションの縦位置を揃えるためのものですが、無効にしても問題ありません。';
$string['module'] = 'モジュール';
$string['noactivity'] = '活動なし';
$string['nonetrack'] = 'トラックなし';
$string['noreactionsyet'] = 'リアクションが設定されたコースモジュールはまだありません。';
...
$string['point_view:addreaction'] = 'リアクションゾーンを表示してリアクションを追加する';
...
$string['reactionscleanedupsuccessfully'] = 'リアクションのクリーンアップが正常に完了しました。';
...
$string['resetreactionsbymodule'] = 'モジュール別にリアクションをリセットする：';
$string['resetreactionsconfirmation'] = '本当にコース「 {$a} 」のすべてのユーザリアクションをリセット (削除) してもよろしいですか? この操作は元に戻せません。';
$string['resetreactionsheader'] = 'リアクションをクリーンアップまたはリセットする';
$string['resetreactionsonmoduleconfirmation'] = 'このモジュールのすべてのユーザーリアクションをリセット（削除）してもよいですか？この操作は元に戻せません。';
$string['showinsubcontexts'] = 'サブコンテキストにもこのブロックを表示する。';
