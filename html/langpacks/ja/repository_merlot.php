...
/**
 * Strings for component 'repository_merlot', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['configplugin'] = 'Merlot.org設定';
$string['licensekey'] = 'ライセンスキー';
$string['merlot:view'] = 'Merlotリポジトリを表示する';
$string['pluginname'] = 'Merlot.org';
$string['pluginname_help'] = 'Merlot.org';
$string['privacy:metadata:repository_merlot'] = 'Merlot.orgリポジトリプラグインはいかなる個人データも保存しません。しかし、ユーザデータをMoodleからリモートシステムに転送します。';
