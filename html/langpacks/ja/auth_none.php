...
/**
 * Strings for component 'auth_none', language 'ja', version '4.4'.
 *
 * @package     auth_none
 * @category    string
...
$string['auth_nonedescription'] = 'ユーザはログインしてすぐに有効なアカウントを作成することができます。外部サーバに対する認証およびメールによる確認も不要です。このオプションを使用する場合は注意してください - これで生じる可能性のあるセキュリティおよび管理問題を考慮してください。';
