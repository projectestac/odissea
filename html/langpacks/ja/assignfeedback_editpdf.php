...
/**
 * Strings for component 'assignfeedback_editpdf', language 'ja', version '4.5'.
 *
...
$string['red'] = '赤';
$string['result'] = '結果:';
$string['rotateleft'] = '左に90度回転する';
$string['rotateright'] = '右に90度回転する';
...
$string['test_ok'] = 'Ghostscriptのパスに問題はないようですが - 下のイメージ内にメッセージが表示されることをご確認ください。';
