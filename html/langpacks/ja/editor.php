...
/**
 * Strings for component 'editor', language 'ja', version '4.4'.
 *
 * @package     editor
 * @category    string
...
$string['acteditorshhdr'] = '利用可能なテキストエディタ';
$string['address'] = 'アドレス';
...
$string['cols'] = '列';
$string['configeditorplugins'] = 'あなたが使用したいテキストエディタを選択してください。また、テキストエディタを推奨順に並べてください。';
...
$string['linktargetother'] = 'その他 (順不同)';
