...
/**
 * Strings for component 'gradeimport_xml', language 'ja', version '4.5'.
 *
...
$string['importxml_help'] = '評定はユーザIDナンバおよび活動IDナンバを含むXMLファイルによりインポートすることができます。正しいフォーマットを取得するには最初にXMLファイルに評定をエクスポートしてファイルをご確認ください。';
