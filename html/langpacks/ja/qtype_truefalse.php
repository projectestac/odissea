...
/**
 * Strings for component 'qtype_truefalse', language 'ja', version '4.1'.
 *
...
$string['correctanswerfalse'] = '正解は「×」です。';
$string['correctanswertrue'] = '正解は「○」です。';
$string['false'] = '×';
...
$string['showstandardinstruction_help'] = '〇/×問題の解答の前に「1つ選択してください:」を表示するかどうか指定してください。';
$string['true'] = '○';
