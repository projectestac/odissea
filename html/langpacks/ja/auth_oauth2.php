...
$string['confirmaccountemail'] = 'こんにちは {$a->fullname} さん

あなたのメールアドレスを使用して「 {$a->sitename} 」の新しいアカウントがリクエストされました。

あなたの新しいアカウントを確認するには以下のリンクをクリックしてください:

<a href="{$a->link}">あなたのアカウントを確認する</a>
...
$string['confirmlinkedloginemail'] = 'こんにちは {$a->fullname} さん

あなたのメールアドレスを使用して {$a->issuername} のログイン {$a->linkedemail} をあなたの「 {$a->sitename} 」のアカウントにリンクするようリクエストがありました

このリクエストおよびログインへのリンクを確認するには次のリンクをクリックしてください:

<a href="{$a->link}">あなたのアカウントのリンク</a>
...
$string['emailpasswordchangeinfo'] = 'こんにちは {$a->fullname} さん
...
$string['key'] = 'キー';
$string['linkedlogins'] = '連携ログイン';
$string['linkedloginshelp'] = '連携ログインのヘルプです。';
...
$string['notwhileloggedinas'] = '別のユーザでのログイン中は連携ログインを管理できません。';
...
$string['privacy:metadata:auth_oauth2:issuerid'] = 'このOAuth 2ログインのOAuth 2イシュアのIDです。';
