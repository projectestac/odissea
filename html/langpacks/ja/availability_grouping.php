...
/**
 * Strings for component 'availability_grouping', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['description'] = '指定されたグルーピング内のグループに属している学生のみ許可します。';
$string['error_selectgrouping'] = 'あなたはグルーピングを選択する必要があります。';
$string['missing'] = '(不明のグルーピング)';
$string['pluginname'] = 'グルーピングによる制限';
$string['privacy:metadata'] = 'グルーピングによる制限プラグインはいかなる個人データも保存しません。';
