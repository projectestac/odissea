...
$string['assign'] = '割り当て';
$string['assigncohorts'] = 'コーホートメンバを割り当てる';
$string['assignto'] = 'コーホート「 {$a} 」メンバ';
...
$string['name'] = '名称';
$string['namecolumnmissing'] = 'CSVファイルのフォーマットに問題があります。正しいカラム名が含まれていることをご確認ください。ユーザをコーホートに追加するにはサイト管理の「ユーザをアップロードする」に移動してください。';
$string['namefieldempty'] = 'フィールド名は空白にできません。';
$string['newidnumberfor'] = 'コーホート {$a} の新しいIDナンバ';
...
$string['removeuserwarning'] = 'コーホートからユーザを削除した場合、ユーザ設定、評定、グループメンバシップおよびコースに関係するユーザ情報も含めて複数のコースからユーザが登録を解除されます。';
$string['search'] = '検索';
