...
$string['cannotforcelang'] = 'このコースの言語を強制するためのパーミッションがありません。';
$string['cannotgenerateshortnameupdatemode'] = '更新が許可されている場合に省略名を生成できません。';
$string['cannotreadbackupfile'] = 'バックアップファイルを読めません。';
$string['cannotrenamecoursenotexist'] = '存在しないコースをリネームできません。';
$string['cannotrenameidnumberconflict'] = '既存のコースとIDナンバが衝突しているため、コースをリネームできません。';
...
$string['couldnotresolvecatgorybyidnumber'] = 'IDナンバでカテゴリを解決できませんでした。';
$string['couldnotresolvecatgorybypath'] = 'パスでカテゴリを解決できませんでした。';
$string['coursecreated'] = 'コース作成';
$string['coursedeleted'] = 'コースが削除されました。';
$string['coursedeletionnotallowed'] = 'コース削除は許可されていません。';
$string['coursedoesnotexistandcreatenotallowed'] = 'コースはありませんが、コース作成は許可されていません。';
...
$string['courseidnumberincremented'] = 'コースIDナンバ増分 {$a->from} -> {$a->to}';
$string['courseprocess'] = 'コース処理';
$string['courserenamed'] = 'コースがリネームされました。';
$string['courserenamingnotallowed'] = 'コースのリネームは許可されていません。';
$string['coursereset'] = 'コースリセット';
$string['courseresetnotallowed'] = 'コースのリセットは許可されていません。';
$string['courserestored'] = 'コースがリストアされました。';
$string['coursescreated'] = 'コース作成: {$a}';
...
$string['csvfileerror'] = 'CSVファイルのフォーマットに問題があります。ヘッディングの数およびカラムが合致しているか、またセパレータおよびファイルエンコーディングが正しいかご確認ください: {$a}';
$string['csvline'] = '行';
...
$string['id'] = 'ID';
$string['idnumberalreadyinuse'] = 'IDナンバはすでにコースで使用されています。';
...
$string['shortnametemplate_help'] = 'コース省略名はナビゲーションに表示されます。あなたはここでテンプレート構文 (%f = フルネーム、%i = IDナンバ) または増分するための初期値を入力できます。';
...
$string['updatemissing'] = '不足しているデータをCSVデータおよびデフォルトで補完する';
$string['updatemode'] = '更新モード';
$string['updatemode_help'] = 'コースの更新を許可する場合、あなたは何を使ってコースを更新するのかツールに伝える必要があります。';
