...
$string['asyncmessagebodydefault'] = '{user_lastname} さん<br />あなたの {operation} (ID: {backupid}) が正常に完了しました!<br /><br />あなたはここで閲覧できます: {link}';
$string['asyncmessagebodydetail'] = '非同期リストアまたはバックアップ完了時に送信されるメッセージです。';
...
$string['asyncrestorecompletedetail'] = 'リストア処理が正常に完了しました。あなたは「続ける」をクリックすることで<a href="{$a}">リストア済みアイテムのコース</a>に移動します。';
...
$string['configgeneralcompetencies'] = 'コンピテンシーをバックアップに含むかどうかデフォルトを設定します。';
...
$string['pendingasyncedit'] = 'このコースに保留中の非同期バックアップがあります。バックアップが完了するまでこのコースを編集しないでください。';
