...
$string['asyncmessagebodydefault'] = '{user_lastname} さん<br />あなたの {operation} (ID: {backupid}) が正常に完了しました!<br /><br />あなたはここでアクセスできます: {link}';
...
$string['configlegacyfiles'] = 'バックアップにレガシーコースファイルを含む場合のデフォルトを設定してください。レガシーコースファイルはMoodle 2.0以前のバージョンです。';
...
$string['copydest'] = '宛先';
$string['copyfieldnotfound'] = '必須フィールドが見つかりませんでした。';
...
$string['generallegacyfiles'] = 'レガシーコースファイルを含む';
$string['generallogs'] = 'ログを含む';
$string['generalpermissions'] = 'パーミッショオーバーライドンを含む';
...
$string['rootsettinglegacyfiles'] = 'レガシーコースファイルを含む';
