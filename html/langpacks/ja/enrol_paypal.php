...
/**
 * Strings for component 'enrol_paypal', language 'ja', version '4.1'.
 *
...
$string['costorkey'] = '以下の登録方法から1つ選択してください。';
$string['currency'] = '通貨';
...
$string['paypal:unenrolself'] = 'コースから自分自身を登録解除する';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:txn_id'] = '登録された場合の購入者からの支払いに関するマーチャントのオリジナルトランザクションIDナンバです。';
