...
/**
 * Strings for component 'competency', language 'ja', version '3.11'.
 *
 * @package     competency
 * @category    string
...
$string['competenciesarenotenabled'] = 'コンピテンシーは有効にされていません。';
...
$string['enablecompetencies_desc'] = 'コンピテンシーで学習プランに沿ってユーザを評価できます。';
...
$string['evidence_competencyrule'] = 'コンピテンシーのルールが合致しません。';
...
$string['evidence_manualoverride'] = 'コンピテンシー評定が手動設定されました。';
$string['evidence_manualoverrideincourse'] = 'コンピテンシー評定がコース「 {$a} 」で手動設定されました。';
$string['evidence_manualoverrideinplan'] = 'コンピテンシー評定が学習プラン「 {$a} 」で手動設定されました。';
...
$string['nouserplanswithcompetency'] = 'このコンピテンシーに学習プランは含まれていません。';
...
$string['privacy:evidence:action:complete'] = '評価されていない場合、コンピテンシーを完了します。';
$string['privacy:evidence:action:log'] = 'ログアクションです。';
$string['privacy:evidence:action:override'] = 'コンピテンシー評価をオーバーライドします。';
$string['privacy:metadata:competency'] = 'コンピテンシーのレコードです。';
$string['privacy:metadata:competency_coursecomp'] = 'コースにリンクされたコンピテンシーのレコードです。';
$string['privacy:metadata:competency_coursecompsetting'] = 'コースで設定されたコンピテンシーのレコードです。';
$string['privacy:metadata:competency_evidence'] = 'コンピテンシーの状態に影響するエビデンスのレコードです。';
$string['privacy:metadata:competency_framework'] = 'コンピテンシーフレームワークのレコードです。';
$string['privacy:metadata:competency_modulecomp'] = 'モジュールにリンクされたコンピテンシーのレコードです。';
$string['privacy:metadata:competency_plan'] = '学習プランのレコードです。';
$string['privacy:metadata:competency_plancomp'] = '学習プラン内のコンピテンシーのレコードです。';
$string['privacy:metadata:competency_relatedcomp'] = 'コンピテンシー間の関係性に関するレコードです。';
...
$string['privacy:metadata:competency_templatecomp'] = '学習プランテンプレート内のコンピテンシーのレコードです。';
$string['privacy:metadata:competency_usercomp'] = 'コンピテンシーのユーザ状態のレコードです。';
$string['privacy:metadata:competency_usercompcourse'] = 'コース内コンピテンシーのユーザ状態のレコードです。';
$string['privacy:metadata:competency_usercompplan'] = '学習プラン内コンピテンシーの状態のレコードです。';
$string['privacy:metadata:competency_userevidence'] = '事前学習エビデンスのレコードです。';
$string['privacy:metadata:competency_userevidencecomp'] = '事前学習エビデンスに関連するコンピテンシーのレコードです。';
$string['privacy:metadata:core_comments'] = '学習プランおよびコンピテンシーに付けられたコメントです。';
$string['privacy:metadata:evidence:action'] = 'エビデンスと共に実行されたアクションのタイプです。';
$string['privacy:metadata:evidence:actionuserid'] = 'ユーザによって実行されたアクションです。';
...
$string['privacy:metadata:plan:reviewerid'] = '学習プランの評価者のIDです。';
...
$string['privacy:metadata:usercomp:grade'] = 'コンピテンシーに付与された評点です。';
$string['privacy:metadata:usercomp:proficiency'] = '熟達度に達しているか示します。';
$string['privacy:metadata:usercomp:reviewerid'] = '評価者のIDです。';
$string['privacy:metadata:usercomp:status'] = 'コンピテンシーのステータスです。';
$string['privacy:metadata:usercomp:userid'] = 'コンピテンシーのユーザのIDです。';
