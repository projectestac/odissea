...
$string['invalidcategoryid'] = '無効なカテゴリです。あなたの入力を確認してください。';
$string['invalidcourseid'] = '無効なコースです。あなたの入力を確認してください。';
...
$string['validationerror'] = '登録キーの検証に失敗しました。登録したサイトのURLおよびキーが正しいか確認してください。';
