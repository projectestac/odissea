...
/**
 * Strings for component 'tool_customlang', language 'ja', version '4.5'.
 *
...
$string['cliexportzipdone'] = 'ZIPアーカイブが作成されました: {$a}';
$string['cliexportzipfail'] = 'ZIPアーカイブ {$a} を作成できません。';
...
$string['markinguptodate_help'] = 'あなたのサイトでストリングがカスタマイズされた後、英語オリジナルまたはマスタ翻訳が修正された場合、カスタマイズされた翻訳は旧版となります。カスタマイズされた翻訳をレビューしてください。あなたが最新版であると確認した場合、チェックボックスをチェックしてください。そうではない場合、内容を編集してください。';
