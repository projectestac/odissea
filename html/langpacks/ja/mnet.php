...
/**
 * Strings for component 'mnet', language 'ja', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['allhosts_no_options'] = '複数ホストを表示している場合、利用できるオプションはありません。';
$string['allow'] = '許可';
...
$string['certdetails'] = '証明書詳細';
$string['configmnet'] = 'Moodleネットワーキングはこのサーバと他のサーバまたはサービスとの通信を可能にします。';
$string['couldnotgetcert'] = '{$a} で証明書が見つかりませんでした。<br>ホストが停止しているか、正しく設定されていません。';
$string['couldnotmatchcert'] = 'これは現在ウェブサーバで公開されている証明書と合致しません。';
$string['courses'] = 'コース';
...
$string['deleteoutoftime'] = 'あなたがこのキーを削除できる60秒の期限が切れました。再度お試しください。';
$string['deleteuserrecord'] = 'SSO ACL: {$a->host} のユーザ「 {$a->user} 」のレコードを削除します。';
...
$string['duplicate_usernames'] = 'あなたのユーザテーブルのカラム「mnethostid」および「username」の作成に失敗しました。<br />これは<a href="{$a}" target="_blank">ユーザテーブルのユーザ名が重複している</a>場合に発生します。<br>それでも、あなたのアップグレードは問題なく完了するはずです。上のリンクをクリックすることで新しいウィンドウにこの問題の解決に関するインストラクションが表示されます。アップグレード終了後、その手順を実行してください。<br/>';
$string['enabled_for_all'] = '(このサービスはすべてのホストで有効にされています)';
$string['enterausername'] = 'ユーザ名またはカンマ区切りのユーザ名のリストを入力してください。';
$string['error7020'] = '通常、このエラーはリモートサイトが正しくないwwwrootレコードを作成した場合に発生します。例えばhttps://www.yoursite.comの代わりにhttps://yoursite.comを使用した場合です。あなたのwwwroot (config.phpで設定) をリモートサイトの管理者に伝えて、あなたのホストに関するレコードの更新を依頼してください。';
...
$string['error7023'] = 'リモートサイトがあなたのサイトに関するレコードのすべてのキーを使用して、あなたのメッセージの複合化を試みました。複合化は失敗しました。リモートサイトのキーを手動で再作成することでこの問題を修正できます。あなたがリモートサイトと数ヶ月間通信していない場合を除き、この問題が発生することはありません。';
$string['error7024'] = 'あなたは暗号化されていないメッセージをリモートサイトに送信しましたが、リモートサイトはあなたのサイトからの暗号化されていない通信を受け付けません。これは非常に稀なケースです。このエラーが発生した場合、バグを記録 (問題になっているMoodleのバージョンに関する可能な限り詳細な情報等) することをお勧めします。';
$string['error7026'] = 'あなたのメッセージに署名されたキーはリモートホストがあなたのサーバのために保持しているキーとは異なります。さらにリモートホストがあなたの現在のキーの取得を試みましたが失敗しました。リモートホストのキーを手動再作成して再度お試しください。';
$string['error709'] = 'リモートサイトがあなたからのSSLキーの取得に失敗しました。';
$string['eventaccesscontrolcreated'] = 'アクセスコントロールが作成されました。';
$string['eventaccesscontrolupdated'] = 'アクセスコントロールが更新されました。';
$string['expired'] = 'この公開鍵の有効期限:';
$string['expires'] = '有効期限';
$string['expireyourkey'] = 'この公開鍵を削除する';
$string['expireyourkeyexplain'] = 'Moodleは (デフォルトで) 28日ごとに自動的に公開鍵をローテートしますが、あなたはこの公開鍵をいつでも「手動」で失効させることができます。これはあなたがこの公開鍵を信用できなくなった場合のみ有用です。公開鍵の交換は即座に自動実行されます。<br />この公開鍵を削除した場合、あなたが手動でそれぞれのMoodle管理者に連絡して新しい公開鍵を提供するまで他のシステムと通信できなくなります。';
$string['exportfields'] = 'エクスポートするフィールド';
$string['failedaclwrite'] = 'ユーザ「 {$a} 」に関するMNetアクセスコントロールリストの書き込みに失敗しました。';
$string['findlogin'] = 'ログインを探す';
$string['forbidden-function'] = 'この関数はRPCに対して有効にされていません。';
$string['forbidden-transport'] = 'あなたが使用を試みているトランスポートメソッドは許可されていません。';
$string['forcesavechanges'] = '変更を強制保存する';
$string['helpnetworksettings'] = 'MNeコミュニケーションを設定します。';
$string['hidelocal'] = 'ローカルユーザを秘匿する';
$string['hideremote'] = 'リモートユーザを秘匿する';
$string['host'] = 'ホスト';
$string['hostcoursenotfound'] = 'ホストまたはコースが見つかりませんでした。';
$string['hostdeleted'] = 'ホストが削除されました。';
$string['hostexists'] = 'このホスト名のレコードはすでに存在します (削除された可能性があります)。<a href="{$a}">レコードを編集する</a>';
$string['hostlist'] = 'ネットワークホスト一覧';
$string['hostname'] = 'ホスト名';
$string['hostnamehelp'] = 'リモートホストの完全修飾ドメイン名です。例) www.example.com';
$string['hostnotconfiguredforsso'] = 'このサーバにはリモートログインが設定されていません。';
$string['hostsettings'] = 'ホスト設定';
$string['http_self_signed_help'] = 'リモートホストにある自己署名型の自作SSL証明書を使用した接続を許可します。';
$string['http_verified_help'] = 'リモートホストにあるPHPの認証済みSSL証明書を使用した (HTTPS経由ではなく) HTTP経由の接続を許可します。';
$string['https_self_signed_help'] = 'リモートホストにあるPHPの自己署名型の自作SSL証明書を使用したHTTP経由の接続を許可します。';
$string['https_verified_help'] = 'リモートホストにある認証済みSSL証明書を使用した接続を許可します。';
$string['id'] = 'ID';
$string['idhelp'] = 'この値は自動的に割り当てられました。変更はできません。';
$string['importfields'] = 'インポートするフィールド';
$string['inspect'] = '調査';
$string['installnosuchfunction'] = 'コーディングエラー! 何かがファイル ({$a->file}) からmnet xmlrpc関数 ({$a->method}) のインストールを試みましたが、見つかりませんでした。!';
$string['installnosuchmethod'] = 'コーディングエラー! 何かがクラス ({$a->class}) 内mnet xmlrpcメソッド ({$a->method}) のインストールを試みましたが、見つかりませんでした。!';
$string['installreflectionclasserror'] = 'コーディングエラー! クラス「 {$a->class} 」内メソッド「 {$a->method} 」 のMNet内部調査に失敗しました。ご参考までにオリジナルエラーメッセージは次のとおりです: {$a->error}';
$string['installreflectionfunctionerror'] = 'コーディングエラー! クラス「 {$a->class} 」内関数「 {$a->method} 」 のMNet内部調査に失敗しました。ご参考までにオリジナルエラーメッセージは次のとおりです: {$a->error}';
$string['invalidaccessparam'] = '無効なアクセスパラメータです。';
$string['invalidactionparam'] = '無効なアクションパラメータです。';
$string['invalidhost'] = 'あなたは有効なホスト識別子を提供する必要があります。';
$string['invalidpubkey'] = 'このキーは有効なSSLキーではありません ({$a})。';
...
$string['issubscribed'] = 'あなたのホストのサービスに {$a} が登録しています。';
$string['keydeleted'] = 'あなたの公開鍵が正常に削除および置換されました。';
$string['keydeletedcancelled'] = 'キーに変更はありません。';
$string['keymismatch'] = 'あなたがこのホストのために保有している公開鍵は現在公開されている公開鍵とは異なります。現在公開されている鍵は次のとおりです:';
...
$string['mnet_session_prohibited'] = 'あなたのホームサーバからのユーザは現在 {$a} の散策を許可されていません。';
$string['mnetdisabled'] = 'MNetは<strong>無効</strong>にされています。';
$string['mnetidprovider'] = 'MNet IDプロバイダ';
$string['mnetidproviderdesc'] = '以前にログインを試みたユーザ名と一致する正しいメールアドレスを入力した場合、この機能を利用してログイン用リンクを取得できます。';
$string['mnetidprovidermsg'] = 'あなたの {$a} プロバイダにログインできるはずです。';
$string['mnetidprovidernotfound'] = '申し訳ございません、これ以上の情報は見つかりませんでした。';
$string['mnetpeers'] = 'ピア';
$string['mnetservices'] = 'サービス';
$string['mnetsettings'] = 'MNet設定';
$string['moodle_home_help'] = 'リモートホストのMNetアプリケーションのホームページへのパスです。 例 /moodle/';
$string['name'] = '名称';
$string['net'] = 'ネットワーキング';
$string['networksettings'] = 'ネットワーク設定';
$string['never'] = 'なし';
$string['noaclentries'] = 'SSOアクセスコントロールリストにエントリはありません。';
$string['noaddressforhost'] = '申し訳ございません、ホスト名 ({$a}) を解決できませんでした!';
$string['nocurl'] = 'PHP cURLライブラリがインストールされていません。';
$string['nolocaluser'] = 'リモートユーザに関するローカルレコードが存在しません。また、このホストではユーザが自動作成されないため、リモートユーザを作成できませんでした。あなたの管理者にご連絡ください!';
$string['nomodifyacl'] = 'あなたはMNETアクセスコントロールリストの変更を許可されていません。';
$string['nonmatchingcert'] = '証明書のサブジェクト:<br /><em>{$a->subject}</em><br />が次の証明書発行元のホストと一致しません:<br /><em>{$a->host}</em>';
$string['nopubkey'] = '公開鍵の検索時に問題が発生しました。<br />ホストがMNetを許可していないか、公開鍵が有効ではありません。';
$string['nosite'] = 'サイトレベルコースが見つかりませんでした。';
$string['nosuchfile'] = 'ファイル/関数 {$a} が存在しません。';
$string['nosuchfunction'] = '関数が見つからないか、RPCに対して関数が禁止されています。';
$string['nosuchmodule'] = '関数の指定が正しくないため、見つかりませんでした。次の形式を使用してください: mod/modulename/functionname';
$string['nosuchpublickey'] = '署名検証のための公開鍵を取得できません。';
$string['nosuchservice'] = 'このホストではRPCサービスが動作していません。';
$string['nosuchtransport'] = 'このIDのトランスポートは存在しません。';
...
* ホストおよびピアを確認する (推奨): ドメインおよびSSL証明書のイシュアを確認します。';
$string['ssoaccesscontrol'] = 'SSOアクセスコントロール';
$string['ssoacldescr'] = 'このページはリモートMoodleネットワークホストのユーザによるアクセスを許可/拒否するため使用してください。この機能はあなたがリモートユーザにSSOサービスを提供する時に動作します。あなたの「ローカル」ユーザが他のMoodleネットワークホストを散策できるような権限をコントロールするにはロールシステムでユーザに「mnetlogintoremote」ケイパビリティを付与してください。';
$string['ssoaclneeds'] = 'この機能を動作させるためにはネットーワキングを有効にしてください。さらにユーザを自動的に追加するにはMNet認証プラグインを有効にしてください。';
$string['strict'] = '厳格';
$string['subscribe'] = '登録';
$string['system'] = 'システム';
...
$string['warning'] = '警告';
$string['wrong-ip'] = 'あなたのIPアドレスは記録されているレコードと合致しません。';
$string['xmlrpc-missing'] = 'この機能を使用するにはあなたのPHPビルドにXML-RPCをインストールする必要があります。';
