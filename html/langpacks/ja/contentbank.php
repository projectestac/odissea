...
/**
 * Strings for component 'contentbank', language 'ja', version '4.5'.
 *
 * @package     contentbank
 * @category    string
...
$string['contentbankcustomfields'] = 'コンテンツバンクカスタムフィールド';
...
$string['displayunlisted'] = '未掲載のコンテンツを表示する';
...
$string['eventcontentreplaced'] = 'コンテンツがファイルに置換されました。';
...
$string['privacy:metadata:content:usermodified'] = '最後にコンテンツを修正したユーザです。';
...
$string['replacecontent'] = 'ファイルに置換する';
