...
/**
 * Strings for component 'error', language 'ja', version '3.11'.
 *
 * @package     error
 * @category    string
...
$string['movecatcontentstoselected'] = 'いくつかのカテゴリコンテンツは選択されたカテゴリに移動できません。';
...
$string['nopermissiontolock'] = 'ロックするためのパーミッションはありません!';
...
$string['oauth2refreshtokentaskerror'] = '1名以上のイシュアのOAuth 2トークンをリフレッシュできませんでした。詳細はタスクアウトプットをご覧ください。';
...
$string['pagenotexist'] = '<p>存在しないページの閲覧中にエラーが発生しました:</p>{$a}';
...
$string['pluginunsupported'] = 'プラグイン「 {$a->pluginname} 」 {$a->pluginversion} はこのバージョンのMoodle {$a->moodleversion} をサポートしません。サポートされるバージョンを探すためプラグイン情報を確認します。';
...
$string['sessioncookiesdisable'] = 'require_key_login() の使用が正しくありません - セッションクッキは無効にしてください!';
...
$string['storedfilecannotcreatefile'] = 'ローカルプールファイルのファイルプールを作成できません。datarootディレクトリのパーミッションおよび利用可能なディスクスペースを確認してください。';
$string['storedfilecannotcreatefiledirs'] = 'ローカルファイルのファイルプールを作成できません。datarootのパーミッションを確認してください。';
