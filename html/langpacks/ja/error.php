...
$string['csvfileerror'] = 'CSVファイルのフォーマットに問題があります。ヘッディング数およびカラム数が合致するか確認してください。また、デリミタおよびファイルエンコーディングが正しいか確認してください: {$a}';
...
$string['oauth2refreshtokentaskerror'] = '1名またはそれ以上の発行者のOAuth 2トークンをリフレッシュできませんでした。詳細はタスクアウトプットをご覧ください。';
