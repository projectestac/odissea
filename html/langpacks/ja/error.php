...
$string['cannotservefile'] = 'サーバ設定に問題があるため、ファイルを保存できません。';
...
$string['cannotviewcategory'] = 'あなたにはここでコース一覧を閲覧するためのパーミッションがありません。';
...
$string['contenttypenotfound'] = '「 {$a} 」コンテンツバンクタイプが存在しないか、認識されませんでした。';
...
$string['detectedbrokenplugin'] = '申し訳ございません、プラグイン「 {$a} 」に問題があるため、または古いため、継続できません。';
...
$string['encryption_decryptfailed'] = '暗号解読に失敗しました。';
...
$string['grouphasidnumber'] = 'グループ「 {$a} 」のIDナンバーは外部システムによって自動的に作成されたようです。あなたにはこのグループを削除するためのパーミッションがありません。';
$string['groupinghasidnumber'] = 'グルーピング「 {$a} 」にはIDナンバーが設定され、外部システムによって自動的に作成されたようです。あなたにはこのグルーピングを削除するためのパーミッションがありません。';
...
$string['invalidcoursemodule'] = '無効なコースモジュールID';
...
$string['listcantmovedown'] = '最後のピアのためアイテムの下への移動に失敗しました。';
...
$string['listcantmoveup'] = '最初のピアのためアイテムの上への移動に失敗しました。';
...
$string['oauth2refreshtokentaskerror'] = '1名以上の発行者のOAuth 2トークンをリフレッシュできませんでした。詳細はタスクアウトプットをご覧ください。';
