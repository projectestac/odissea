...
$string['addarandomquestion_success'] = 'ランダム問題が追加されました。';
...
$string['addpagebreakafter'] = '問題 {$a} の後に改ページを追加する';
...
$string['attempterrorinvalid'] = '無効な小テスト受験IDです。';
...
$string['cannotfindprevattempt'] = '続きを行う直近の受験が見つかりませんでした。';
...
$string['canredoquestions_desc'] = 'この設定を有効にした場合、特定の問題の受験を終了した時点で「問題をやり直す」ボタンが表示されます。これで小テスト全体を受験して送信せずに、また別の受験を開始せずに (ランダムに選択された) 類似の問題を受験または同じ問題を受験できます。このオプションは練習問題に有用です。

この設定は学生が受験を送信する前に問題を終了できるような問題および挙動 (例えば「即時フィードバック」または「複数受験インタラクティブ」) にのみ影響します。';
$string['canredoquestions_help'] = 'この設定を有効にした場合、問題の受験を終了した時点で「問題をやり直す」ボタンが表示されます。これで小テストの受験すべてを送信せずに、また別の小テストを開始せずに別バージョンの同一問題を受験できるようになります。このオプションは練習問題に有用です。
...
$string['closebeforeopen'] = '終了日時は公開日時の後にする必要があります。';
$string['closed'] = '終了';
...
$string['completionattemptsexhausted'] = '合格点または利用可能なすべての受験を完了した場合';
...
$string['eachattemptbuildsonthelast'] = '直近の受験の続きを行う';
$string['eachattemptbuildsonthelast_help'] = '複数回の受験が許可され、この設定が有効にされた場合、小テストの新たな受験のたびに直近の受験結果が反映されます。これにより複数回の受験を繰り返して小テストを完答することができます。';
$string['edit_slotdisplaynumber_hint'] = '質問番号 (最大16文字) を編集します。';
$string['edit_slotdisplaynumber_label'] = '{$a} の新しい値';
...
あなたがこの受験をまだ送信したいと思う場合、{$a->attemptsummaryurl} にアクセスして送信ボタンをクリックしてください。この作業は {$a->attemptgraceend} までに実施してください。そうではない場合、あなたの受験はカウントされないことになります。';
...
$string['eventquizattemptreopened'] = '小テスト受験再オープン';
...
$string['eventquizgradeitemcreated'] = '小テスト評定項目が作成されました。';
$string['eventquizgradeitemdeleted'] = '小テスト評定項目が削除されました。';
$string['eventquizgradeitemorderchanged'] = '小テスト評定項目順が変更されました。';
$string['eventquizgradeitemupdated'] = '小テスト評定項目が更新されました。';
...
$string['eventslotdisplayedquestionnumberupdated'] = 'スロット表示問題番号が更新されました。';
$string['eventslotgradeitemupdated'] = 'スロット評定項目が更新されました。';
...
$string['gradeitemdefaultname'] = '新しい評定項目 {$a}';
$string['gradeitemdelete'] = '評定項目 {$a} を削除する';
$string['gradeitemedit'] = '評定項目 {$a} の名称を編集する';
$string['gradeitemmarkscheme'] = '評定項目を割り当てる';
$string['gradeitemnewname'] = '評定項目 {$a} の新しい名称';
$string['gradeitemnoneselected'] = '[なし]';
$string['gradeitemnoslots'] = 'この小テストにはまだ問題がありません。まず問題を追加した上で評定項目を設定するためにここに戻ってきてください。';
$string['gradeitems'] = '評定項目';
$string['gradeitemsautosetup'] = 'それぞれのセクションの評点を設定する';
$string['gradeitemsetup'] = '評定項目セットアップ';
$string['gradeitemsnoneyet'] = 'あなたの小テスト内で評点項目を作成します。これらの評定項目に問題または小テストセクションを割り当てることで評定結果を異なる領域に分割できます。';
$string['gradeitemsremoveall'] = 'セットアップをリセットする';
$string['gradeitemsremoveallconfirm'] = '評定項目セットアップをリセットしますか?';
$string['gradeitemsremoveallmessage'] = 'これによりすべての評点項目が削除され問題およびセクションの割り当てが解除されます。<br /><br />この操作は問題およびセクション自体および小テスト内の既存の受験には影響しません。';
$string['gradeitemsremovealltitle'] = '評定項目セットアップをリセットする';
...
$string['marks'] = '素点';
$string['marks_help'] = '問題ごとの評点および全体の受験評点から取得できる評点です。あなたは最大評点が選択された場合のみ、評点を選択できます。';
$string['match'] = '組み合わせ';
$string['matchanswer'] = '組み合わせの答え';
$string['matchanswerno'] = '組み合わせの答え {$a}';
$string['max'] = '最大';
$string['maxmark'] = '最大評点';
$string['maxmarks'] = '最大評点';
$string['maxmarks_help'] = 'それぞれの問題で利用可能な最大評点です。';
...
$string['min'] = '最小';
$string['minutes'] = '分';
$string['missingcategory'] = '問題カテゴリがありません。';
...
$string['movequestionnumber'] = '問題を移動する: {$a}';
...
$string['overduehandlingautoabandon'] = '受験は制限時間内に送信される必要がありますが、そうではない場合はカウントされません';
...
$string['overridecannotchange'] = 'オーバーライド作成後、ユーザまたはグループを変更できません。';
$string['overridecannotsetbothgroupanduser'] = 'グループおよびユーザを同時に設定できません。';
...
$string['overrideinvalidattempts'] = '試行回数はゼロより大きくする必要があります。';
$string['overrideinvalidexistingid'] = '既存のオーバーライドが存在しません。';
$string['overrideinvalidgroup'] = '指定されたグループが存在しません。';
$string['overrideinvalidquiz'] = '小テストIDセットが存在しません。';
$string['overrideinvalidtimelimit'] = '制限時間はゼロより大きくする必要があります。';
$string['overrideinvaliduser'] = '指定されたユーザが存在しません。';
$string['overridemissingdelete'] = 'オーバーライドID {$a} が存在しないか指定された小テストの一部ではないため、削除できませんでした。';
$string['overridemultiplerecordsexist'] = '同じユーザ/グループに対して複数オーバーライドはできません。';
$string['overridemustsetuserorgroup'] = 'ユーザまたはグループを設定する必要があります。';
...
$string['quiz:reopenattempts'] = '未送信の小テスト受験を再オープンする';
...
$string['quizsetupnavigation'] = '小テストセットアップナビゲーション';
$string['quiztimer'] = '小テストタイマー';
$string['quizwillopen'] = 'この小テストは {$a} に公開されます。';
$string['random'] = 'ランダム問題';
$string['randomcatwithsubcat'] = '{$a} およびサブカテゴリ';
$string['randomcoursecatwithsubcat'] = 'コースカテゴリ {$a} 内のすべてのカテゴリ';
$string['randomcoursewithsubcat'] = 'このコース内のすべてのカテゴリ';
$string['randomcreate'] = 'ランダム問題を作成する';
$string['randomediting'] = 'ランダム問題を編集する';
$string['randomfaultynosubcat'] = '不適切な質問';
...
$string['randommodulewithsubcat'] = 'この小テストのすべてのカテゴリ';
$string['randomnosubcat'] = 'サブカテゴリからではなく、このカテゴリからのみの問題です。';
$string['randomnumber'] = 'ランダム問題数';
$string['randomqname'] = 'フィルタ条件に基づくランダム問題';
$string['randomqnamecat'] = 'フィルタコンディションに基づくランダム ({$a->category})';
$string['randomqnamecattags'] = 'タグ付きフィルタコンディションに基づくランダム ({$a->category}): {$a->tags}';
$string['randomqnametags'] = 'タグによるフィルタ条件に基づくランダム問題: {$a}';
...
$string['randomsystemwithsubcat'] = 'すべてのシステムレベルカテゴリ';
...
$string['removepagebreakafter'] = '問題 {$a} の後の改ページを削除する';
$string['removeselected'] = '選択したものを削除する';
$string['rename'] = 'リネーム';
$string['renderingserverconnectfailed'] = 'サーバ {$a} がRQPリクエストの処理に失敗しました。URLが正しいかご確認ください。';
$string['reopenattempt'] = '再オープン';
$string['reopenattemptareyousuremessage'] = 'これは  {$a->attemptuser} による受験 {$a->attemptnumber} を再オープンします。';
$string['reopenattemptareyousuretitle'] = '再オープンしてもよろしいですか?';
$string['reopenattemptwrongstate'] = '受験 {$a->attemptid} を再オープンするには状態 ({$a->state}) が正しくありません。';
$string['reopenedattemptwillbeinprogress'] = '受験は継続できるようオープンを保持します。';
$string['reopenedattemptwillbeinprogressuntil'] = '受験は継続できるようオープンを保持します。提出期限は {$a} です。';
$string['reopenedattemptwillbesubmitted'] = '受験は評定のため直ちに送信されます。';
...
$string['savemanualgradingfailed'] = '変更が保存されません。以下のメッセージを確認して再度お試しください。';
...
$string['showuserpicture_help'] = 'この設定を有効にした場合、受験中およびレビュー時に学生の氏名および画像が画面に表示されます。これで試験監督による試験時にユーザがその人自身でログインしているか確認を容易にします。';
...
これで学生が答えを共有することは難しくなりますが、教師と特定の問題に関して議論することも難しくなります。';
...
$string['updatefilterconditon'] = 'フィルタ条件を更新する';
$string['updatefilterconditon_success'] = 'フィルタ条件が正常に更新されました。';
