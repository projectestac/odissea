...
$string['activitynavigation'] = '活動ナビゲーション';
$string['activitynavigation:jumptoactivity'] = '活動にジャンプする';
$string['activitynavigation:nexta'] = '次の活動: {$a}';
$string['activitynavigation:preva'] = '前の活動: {$a}';
