...
$string['privacy:metadata:messages:smallmessage'] = 'メッセージの縮小版です。';
$string['privacy:metadata:messages:subject'] = 'メッセージの件名です。';
$string['privacy:metadata:messages:timecreated'] = 'メッセージの作成日時です。';
$string['privacy:metadata:messages:useridfrom'] = 'メッセージを送信したユーザのIDです。';
$string['privacy:metadata:notifications'] = '通知です。';
$string['privacy:metadata:notifications:component'] = '通知送信を担当するコンポーネントです。';
...
$string['privacy_desc'] = 'あなたにメッセージを送信できる人を制限できます。';
...
$string['removefromfavourites'] = '会話の星を解除する';
...
$string['selectnotificationtoview'] = '詳細を表示するにはサイドの通知一覧から選択してください。';
$string['selfconversation'] = 'パーソナルスペース';
$string['selfconversationdefaultmessage'] = '下書きメッセージ、リンク、ノート等を保存して後でアクセスできるようにします。';
$string['send'] = '送信';
$string['sendbulkmessage'] = '{$a} 人にメッセージを送信する';
$string['sendbulkmessagesent'] = '{$a} 人にメッセージが送信されました。';
$string['sendbulkmessagesentsingle'] = '1 人にメッセージが送信されました。';
$string['sendbulkmessagesingle'] = '1 人にメッセージを送信する';
...
$string['settings'] = '設定';
$string['showmessagewindownonew'] = '新しいメッセージがないメッセージウィンドウを表示する';
$string['showmessagewindowwithcount'] = '{$a} 件の新しいメッセージがあるメッセージウィンドウを表示する';
$string['shownotificationwindownonew'] = '新しい通知がない通知ウィンドウを表示する';
$string['shownotificationwindowwithcount'] = '{$a} 件の新しい通知がある通知ウィンドウを表示する';
$string['togglemessagemenu'] = 'メッセージドロワを切り替える';
$string['togglenotificationmenu'] = '通知メニューを切り替える';
...
$string['unblockcontact'] = 'コンタクトのブロックを解除する';
