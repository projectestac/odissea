...
/**
 * Strings for component 'qtype_essay', language 'ja', version '4.5'.
 *
 * @package     qtype_essay
 * @category    string
...
$string['privacy:metadata'] = '作文問題タイププラグインは問題作成者がユーザプレファレンスとしてデフォルトオプションを設定できます。';
