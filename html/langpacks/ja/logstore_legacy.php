...
/**
 * Strings for component 'logstore_legacy', language 'ja', version '4.5'.
 *
...
$string['loglegacy_help'] = 'このプラグインではログデータをレガシログテーブル (mdl_log) に記録します。この機能は新しく効率の良いロギングプラグインに置き換えられました。そのため、あなたが古いログテーブルを直接参照している古いカスタムレポートを使用している場合のみ、このプラグインを動作させてください。レガシログに書き込むことにより負荷を上げることになるため、パフォーマンスの理由から必要ではない場合はこのプラグインを無効にしてください。';
