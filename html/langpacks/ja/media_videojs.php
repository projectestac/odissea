...
/**
 * Strings for component 'media_videojs', language 'ja', version '4.5'.
 *
...
$string['configlimitsize'] = 'この設定が有効にされた場合、そしてビデオの幅および高さが指定されていない場合、デフォルトの幅および高さで表示します。そうではない場合、可能な最大幅に広げられます。';
