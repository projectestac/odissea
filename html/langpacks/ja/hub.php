...
/**
 * Strings for component 'hub', language 'ja', version '3.11'.
 *
 * @package     hub
 * @category    string
...
$string['policyagreed'] = 'プライバシ通知およびデータ処理規約';
$string['policyagreeddesc'] = '私は<a href="{$a}" target="_blank">プライバシ通知およびデータ処理規約</a>に同意します。';
