...
$string['errorcoursewronglypublished'] = 'Moodle.netから公開エラーが通知されました。後ほど再度お試しください。';
...
$string['policyagreed'] = 'プライバシー通知およびデータ処理規約';
$string['policyagreeddesc'] = '私は<a href="{$a}" target="_blank">プライバシー通知およびデータ処理規約</a>に同意します。';
