...
$string['audience'] = '対象者';
$string['audience_help'] = 'コース対象者を選択してください。';
...
$string['emailalert_help'] = 'この設定を有効にした場合、ハブ管理者からセキュリティ問題およびその他の重要なニュースに関するメールをあなたに送信します。';
$string['enrollable'] = '登録可';
$string['errorcoursewronglypublished'] = 'Moodle.netから公開エラーが返されました。後ほど再度お試しください。';
$string['errorotherhubsnotsupported'] = 'このページはカスタムサイトディレクトリへの登録には使用できなくなりました。';
...
$string['imageurl_help'] = 'このイメージはハブに表示されます。このイメージはハブからいつでも利用できるようにしてください。イメージの最大サイズは {$a->width} X {$a->height} です。';
$string['issuedbadgesnumber'] = '発行済みバッジ数 ({$a})';
$string['language'] = '言語';
$string['language_help'] = 'このコースの主言語です。';
$string['lasttimechecked'] = '最終確認日時';
$string['licence'] = 'ライセンス';
$string['licence_help'] = 'あなたのコース配布に関するライセンスを選択してください。';
