...
$string['allowcomments_help'] = 'この設定を有効にした場合、コメントを作成するためのパーミッションが与えられたすべてのユーザは用語集エントリにコメントを追加することができます。';
...
$string['errorparsingxml'] = 'ファイルの構文解析中にエラーが発生しました。有効なXML構文かどうかご確認ください。';
