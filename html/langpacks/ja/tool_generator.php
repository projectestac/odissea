...
この機能を使用して作成されたコースは大容量のデータベースおよびファイルシステム領域 (数十ギガバイト) を占有します。この領域を解放するにはあなたはコースを削除する (および様々なクリーンアップの実行を待つ) 必要があります。
...
$string['testscenario_invalidfile'] = 'ファイルフォーマットが有効ではないか、無効なステップが含まれています。';
