...
/**
 * Strings for component 'auth_db', language 'ja', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbdescription'] = 'ここではユーザ名およびパスワードが有効であるか確認するため、外部データベーステーブルを使用します。新しいアカウントを作成する場合、他のフィールドの情報もMoodleに複製されます。';
