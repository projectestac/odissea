...
/**
 * Strings for component 'block_xp', language 'ja', version '3.11'.
 *
 * @package     block_xp
 * @category    string
...
$string['admindefaultsettingsintro'] = 'これからコースに追加されるブロックは以下の設定にしたがいます．';
$string['anonymity'] = '名前を隠す';
$string['blockappearance'] = 'ブロックの表示';
$string['cheatguard'] = 'チート防止';
$string['configdescription'] = '追加説明';
$string['configdescription_help'] = '短い案内がブロック内の学習者レベルの下に表示されます．学習者がメッセージを非表示にすれば表示されなくなります．';
...
$string['defaultvisuals'] = 'デフォルトのビジュアル';
$string['deletecondition'] = '条件を削除する';
$string['deleterule'] = 'ルールを削除する';
$string['description'] = '説明';
$string['enablecheatguard'] = 'チート防止を有効にする';
$string['enablecheatguard_help'] = 'チート防止は、学生による経験値かせぎを防ぐ簡便な機能です．具体的には、同じページを繰り返し読み込んだり、ある動作を繰り返す行為を防止します．';
$string['enableinfos'] = '詳細ページを有効にする';
$string['enableinfos_help'] = '\'No’にすると、学習者は詳細ページを見ることができなくなります．';
$string['enableladder'] = '段位表示を有効にする';
$string['enableladder_help'] = '\'No\'にすると、学生は段位を見ることができません．';
...
$string['enablexpgain_help'] = 'No\'に設定したら、このコース内では経験値を増やすことはできません．これは経験値が変わるのを停止したり再開するのに使えます．

これは _block/xp:earnxp_ の変更によってもさらに書き換えることができます．';
$string['eventproperty'] = 'イベント名';
$string['infos'] = '詳細';
$string['ladder'] = '段位';
$string['level'] = 'レベル';
...
$string['reward'] = '報酬';
$string['visualsintro'] = 'レベル表示を変更するには画像をアップロードしてください．';
$string['xptogo'] = 'あと[{$a}]';
