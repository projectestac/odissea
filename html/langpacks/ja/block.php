...
/**
 * Strings for component 'block', language 'ja', version '3.11'.
 *
 * @package     block
 * @category    string
...
$string['createdat_help'] = 'ブロックが作成されるオリジナルロケーションです。ブロック設定によりオリジナルロケーション内の他のロケーション (コンテクスト) にブロックを表示できます。例えばコースページに作成されたブロックはそのコースの活動内に表示できます。フロントページに作成されたブロックはサイト全体を通して表示できます。';
...
$string['deleteblockcheck'] = '本当にこのタイトル「 {$a} 」のブロックを削除してもよろしいですか?';
