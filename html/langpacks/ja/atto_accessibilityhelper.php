...
/**
 * Strings for component 'atto_accessibilityhelper', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['listimages'] = 'テキストエディタ内のイメージ:';
$string['listlinks'] = 'テキストエディタ内のリンク:';
$string['liststyles'] = '現選択のスタイル:';
$string['noimages'] = 'イメージなし';
