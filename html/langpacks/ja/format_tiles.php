...
$string['cachedef_formatoptionelementids'] = '特定の要素（例：写真が設定されたコースセクション ID）に対して、フォーマットオプションが設定されている要素 ID の単純な配列。';
$string['cachedef_formatoptions'] = '要素 ID ごとのコースフォーマットオプションの値を保持する配列。例：コースセクション ID ごとの写真ファイル名。';
$string['cachedef_modalcmids'] = 'モーダル表示で起動する必要があるコースモジュール ID（コース単位）。';
$string['cachedef_videocmids'] = '動画として扱うコースモジュール ID（YouTube または Vimeo への URL 活動）。';
$string['changedcolour'] = 'タイルの色をコース{$a}のデフォルトに戻す';
$string['checkforproblemcourses'] = '問題のあるコースの確認と修正';
$string['clearphoto'] = 'このタイルをリセットする';
$string['clickiffailstoload'] = 'ページの読み込みに失敗したときにクリックする';
$string['close'] = '閉じる';
$string['closetopsection'] = 'トップのセクションを閉じる';
...
$string['coursephotomigrationincomplete'] = 'システムアップグレード後、タイルのアイコンや画像がまだ移行されていません。
不足している項目は、アップグレードから数時間以内に表示される予定です。';
...
$string['editoradvicesubtiles'] = 'このバージョンの Tiles プラグインでは、編集モードがオフの場合にのみ、活動がサブタイルとして表示されます。';
$string['editsectionname'] = 'タイル名を編集';
$string['embeddedurlerror'] = '上記のウィンドウで外部サイトの接続が拒否された場合は、こちらをご利用ください。';
$string['enablelinebreakfilter'] = '行区切りフィルタを有効にする';
$string['enablelinebreakfilter_desc'] = 'タイルタイトル内の不可視結合文字（{$a}）を検出し、タイトルが長い場合は行を折り返せるように「- 」に置き換えます。  それ以外の場合は、行区切りを入れないために何も挿入しません（置き換えなし）。';
...
$string['invalidsectionid'] = '無効なセクション ID「{$a}」';
...
$string['legacytiledata'] = '旧タイルデータ数\'';
$string['links'] = 'リンク';
$string['loading'] = '読み込み中';
$string['maxcoursesectionsallowed'] = 'この環境で許容されるコースセクションの最大数は{$a}です。';
$string['migratecoursedata'] = 'コースデータを移行';
$string['migratedcourseid'] = '移行済みコース ID {$a}';
$string['migratenow'] = '今すぐ移行';
...
$string['numbers'] = '番号';
$string['numbers_desc'] = 'このタイルの番号アイコンを選択';
$string['off'] = 'オフ';
$string['ok'] = 'OK';
$string['on'] = 'オン';
$string['onlywhenediting'] = '編集時のみ';
$string['other'] = 'その他';
...
$string['plugin_description'] = 'セクションや活動をタイルで表示する、写真・アイコン・色を自由にカスタマイズできる視覚的に豊かなフォーマットです。';
$string['pluginname'] = 'タイルフォーマット';
$string['previoustopic'] = '前のトピック';
$string['privacy:metadata:preference:format_tiles_high_contrast_mode'] = 'ユーザがハイコントラストモードを使用しているかどうか。';
...
$string['progress'] = '進展';
$string['progressincludesubsections'] = '進捗インジケータにサブセクションを含める？';
$string['progressincludesubsections_desc'] = 'タイルの進捗インジケータに、サブセクション内の活動の進捗も含めますか？';
$string['progresstitle'] = '{$a->numComplete} / {$a->numOutOf} 件完了（{$a->percent}%）';
...
$string['resetalltiles'] = 'タイルの写真とアイコンをリセット';
$string['resetalltilessure'] = 'このコースのタイルをリセットしますか？すべてのタイル写真が削除され、アイコンはデフォルトに戻ります。コンテンツ自体は削除されません。この操作は元に戻せません。不安な場合は、事前にコースをバックアップしてください。';
...
$string['resetincomplete'] = 'リセット未完了';
...
$string['seczerocollapsible'] = 'セクション 0 を折りたたみ可能にする';
$string['seczerocollapsible_desc'] = 'ユーザがコースのセクション 0 を折りたためるようにします。';
$string['selected'] = '選択中';
$string['setavailabletilecolours'] = '許可されたタイルの色（サイト全体）';
$string['setbackgroundphoto'] = '写真 / アイコンを設定';
...
$string['style'] = 'スタイル';
$string['subtileiconcolourbackground'] = 'サブタイルアイコンを単色背景の円で表示';
$string['subtileiconcolourbackground_desc'] = 'チェックすると、サブタイルのアイコンは白色アイコンとして単色の背景円に表示されます。チェックしない場合、アイコンは (1) アイコン自体が色付き、(2) 背景円は色付きですが単色ではありません。';
$string['subtileszeczerotoggled'] = 'トップセクションは、リスト形式とサブタイル形式の切り替えが可能です。';
$string['suremigratelegacyoptions'] = 'このコースの {$a} 件のタイル写真・アイコン設定を移行しますか？';
$string['sureresetcolours'] = 'コースのタイルカラーをデフォルトに戻してよろしいでしょうか？これは{$a}コースに影響します。';
$string['tilearialabel'] = '{$a}（詳細をポップアップで開くリンク）';
...
$string['tilesreset'] = 'このコースのタイル写真とアイコンがリセットされました。';
$string['tilestyle'] = 'タイルスタイル';
$string['tilestyle_desc'] = 'スタイル 1：写真タイルはタイトルを上部に表示、スタイル 2：タイトルを下部に表示します。';
$string['togglecompletion'] = 'クリックすると完了ステータスが切り替わります。';
$string['togglecompletioncomplete'] = 'クリックして完了状態に切り替え（完了）';
$string['togglecompletionincomplete'] = 'クリックして完了状態に切り替え（未完了）';
...
$string['unmigratedcoursesintro'] = '以下の {$a} コースは、システムアップグレード後にタイルアイコンや写真が完全に移行されていないようです。今すぐ処理するにはボタンをクリックしてください。待てばバックグラウンドの cron 処理で順次処理されますが、特定のコースをすぐに処理したい場合はボタンを押してください。';
$string['uploadnewphoto'] = '新しい写真のアップロード';
$string['uploadnewphoto_help'] = 'このタイルに使用する画像をアップロードする';
$string['usecourseindex'] = 'コースインデックスを使用';
$string['usecourseindex_desc'] = 'タイル形式のコースで、左側にコースインデックスを表示しますか？';
