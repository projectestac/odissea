...
/**
 * Strings for component 'quizaccess_offlineattempts', language 'ja', version '4.5'.
 *
...
注意: 時間制限が設定されている場合、ネットワークアドレスを必要とする場合、または遅延フィードバック (CBMあり、なし) 以外の問題動作を使用している場合、またはシーケンシャルナビゲーションを使用している場合、小テストをオフラインでは受験できません。';
