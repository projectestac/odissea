...
$string['cannotpreview'] = 'あなたはこれらの問題をプレビュできません。';
...
$string['notyourpreview'] = 'これはあなたのプレビュではありません。';
...
$string['previewquestion'] = '問題をプレビュする: {$a}';
...
$string['questionpreviewdefaults'] = '問題プレビュデフォルト';
$string['questionpreviewdefaults_desc'] = 'これらのデフォルトはユーザが問題バンク内の問題を最初にプレビュする時点で使用されます。ユーザが問題をプレビュした場合、パーソナルプリファレンスがユーザプリファレンスとして保存されます。';
$string['questions'] = '問題';
