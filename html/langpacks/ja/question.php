...
$string['cannotregradedifferentqtype'] = '異なるタイプの問題は再評定できません。';
...
$string['commentormark'] = 'コメントを追加または素点を更新する';
...
$string['deletecoursecategorywithquestions'] = 'このコースカテゴリに関連する問題バンクに問題が登録されています。あなたが続けた場合、問題が削除されてしまいます。問題バンクのインタフェースを使用して、最初に問題を移動してください。';
$string['deletequestioncheck'] = 'これで以下の問題およびすべてのバージョンが削除されます: <br /></br />{$a}';
$string['deletequestionscheck'] = 'これで以下の問題およびすべてのバージョンが削除されます: <br /></br />{$a}';
$string['deletequestiontitle'] = '問題を削除してもよろしいですか?';
$string['deletequestiontitle_plural'] = '問題を削除してもよろしいですか?';
$string['deleteselectedquestioncheck'] = 'これで以下の問題の選択されたバージョンが削除されます:<br /><br />{$a}';
$string['deleteversiontitle'] = '選択されたバージョンを削除してもよろしいですか?';
...
$string['generalfeedback_help'] = '全般的なフィードバックフィードバックは問題の受験後、学生に表示されるテキストです。問題タイプおよび学生の解答によって決まるフィードバックとは異なり、同じ全般に対するフィードバックテキストがすべての学生に表示されます。
...
$string['numquestionsandhidden'] = '{$a->numquestions} (+{$a->numhidden} 非表示 +{$a->numdraft} 下書き)';
...
$string['privacy:metadata:database:question:generalfeedback'] = 'この問題の全般的なフィードバックです。';
...
$string['privacy:metadata:database:question_bank_entries'] = '特定の問題バンクエントリに関する詳細です。';
$string['privacy:metadata:database:question_bank_entries:ownerid'] = '問題バンクエントリを所有している人です。';
...
$string['published'] = '共有';
$string['qbanknotfound'] = '「 {$a} 」問題バンクプラグインが存在しないか認識されません。';
$string['qtypeveryshort'] = 'T';
$string['question_version'] = '問題バージョン';
...
$string['questionbanknavigation'] = '問題バンク第3ナビゲーション';
...
$string['rightanswer_help'] = '自動的に生成される正解の概要です。これは制限できるため、あなたは問題の全般的なフィードバックの中で正解を説明して、このオプションを無効にしても良いでしょう。';
$string['save'] = '保存';
...
$string['showquestiontext'] = '問題リスト内に問題テキストを表示しますか?';
$string['showquestiontext_full'] = 'はい、イメージ、メディア等';
$string['showquestiontext_off'] = 'No';
$string['showquestiontext_plain'] = 'はい、テキストのみ';
