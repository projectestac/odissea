...
$string['deletequestioncheck'] = 'これにより以下の問題およびすべてのバージョンが削除されます: <br /></br />{$a}';
$string['deletequestionscheck'] = 'これにより以下の問題およびすべてのバージョンが削除されます: <br /></br />{$a}';
$string['deletequestiontitle'] = '問題を削除してもよろしいですか?';
$string['deletequestiontitle_plural'] = '問題を削除してもよろしいですか?';
$string['deleteselectedquestioncheck'] = 'これにより以下の問題の選択されたバージョンが削除されます:<br /><br />{$a}';
