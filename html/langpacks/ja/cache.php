...
$string['cachedef_portfolio_add_button_portfolio_instances'] = 'portfolio_add_buttonクラスのポートフォリオインスタンス';
...
$string['canuselocalstore'] = 'ローカルストア利用可能';
...
$string['defaultstoreactions'] = 'デフォルトストアは編集できません。';
...
$string['ex_unmetstorerequirements'] = '現在、あなたはこのストアを使用できません。必要条件を確認するにはドキュメンテーションをご覧ください。';
$string['gethit'] = 'Get - ヒット';
$string['getmiss'] = 'Get - ミス';
$string['inadequatestoreformapping'] = 'このストアはすべての既知の定義に対して必要条件を満たしていません。このストアの定義が不適切な場合、選択されたストアの代わりにオリジナルのデフォルトストアが使用されます。';
$string['invalidlock'] = '無効なロックです。';
$string['invalidplugin'] = '無効なプラグインです。';
$string['invalidstore'] = '無効なキャッシュストアが提供されました。';
$string['localstorenotification'] = 'このキャッシュはそれぞれのウェブサーバのストアに安全にマップできます。';
$string['lockdefault'] = 'デフォルト';
$string['locking'] = 'ロッキング';
$string['locking_help'] = 'ロッキングはデータがオーバライドされるのを防ぐためにキャッシュデータへのアクセスを1回につき1プロセスに制限するメカニズムです。ロッキングメソッドではどのようにロックが獲得およびチェックされるか決定します。';
$string['lockname'] = '名称';
$string['locknamedesc'] = '名称はユニークにする必要があります。また、次の文字のみ使用できます: a-zA-Z_';
...
$string['result'] = '結果';
$string['set'] = 'セット';
$string['sharedstorenotification'] = 'このキャッシュはすべてのウェブサーバで共有されるストアにマッピングされる必要があります。';
$string['sharing'] = '共有';
$string['sharing_all'] = 'すべて';
$string['sharing_help'] = 'あなたがクラスタをセットアップをしている場合、またはすべて同じストアを使用する複数サイトをセットアップしている場合、そしてデータを共有したい場合にどのようにキャッシュデータを共有するか決定できます。これは高度な設定であるため、変更前にその目的を確認してください。';
...
$string['storename_help'] = 'ここではストア名を設定します。ストア名はシステム内のストアを識別します。「a-z A-Z 0-9 -_ 」およびスペースのみ使用できます。また、ストア名はユニークである必要があります。すでに使用されている名称の使用を試みた場合、あなたはエラーメッセージを受信します。';
$string['storenamealreadyused'] = 'あなたはこのストアに関してユニークな名称を選択する必要があります。';
$string['storenameinvalid'] = '無効なストア名です。あなたは「a-z A-Z 0-9 -_ 」およびスペースのみ使用できます。';
...
$string['storerequiresattention_help'] = 'このストアインスタンスの利用準備はできていませんが、マッピングされています。この問題を修正することであなたのシステムのパフォーマンスを改善します。ストアバックエンドの利用準備およびPHP必要条件への合致を確認してください。';
