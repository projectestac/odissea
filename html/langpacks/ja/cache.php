...
$string['sharing_help'] = 'あなたがクラスタをセットアップをしている場合、またはすべて同じストアを使用する複数サイトをセットアップしている場合、そしてデータを共有したい場合にどのようにキャッシュデータを共有するか決定できます。これは高度な設定であるため、変更前にその目的をご確認ください。';
...
$string['storerequiresattention_help'] = 'このストアインスタンスの利用準備はできていませんが、マッピングされています。この問題を修正することであなたのシステムのパフォーマンスを改善します。ストアバックエンドの利用準備およびPHP必要条件への合致をご確認ください。';
