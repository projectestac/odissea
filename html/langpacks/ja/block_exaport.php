...
$string['block_exaport_confirm_profilefield_create'] = '必須のプロフィール・フィールドを追加しますか？';
...
$string['block_exaport_teachercanseeartifactsofstudents_body'] = '教師に権限を持たせるかはそれぞれのプロフィールで設定する必要があります。この機能は、上記のオプションが有効になっている場合のみ動作します。
...
$string['emailaccessmessage'] = 'こんにちは！{$a->sendername}さんがビュー"{$a->viewname}"を共有しました。ここで見ることができます： {a->url}';
$string['emailaccessmessageHTML'] = 'こんにちは！<br />{$a->送信者名}があなたと「{$a->viewname}」ビューを共有しました。<br /><a href="{$a->url}">こちら</a>から見ることができます。';
...
$string['exaport:viewartifactsfromstudents'] = '自分の生徒のポートフォリオのアーティファクトを見ることができる';
...
$string['myportfolio'] = '私のポートフォリオの成果物';
...
$string['privacy:metadata:block_exaportcate:source'] = 'スコア';
