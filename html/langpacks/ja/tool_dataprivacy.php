...
$string['allowfiltering'] = 'コースによるエクスポートのフィルタリングを許可する';
$string['allowfiltering_desc'] = 'この設定を有効にした場合、個人情報保護責任者はすべてのコースではなく、選択したコースからのユーザデータエクスポートを選択できます。この機能が有効な場合、 エクスポート要求は「保留」から開始され、バックグラウンドタスクが完了した後にのみ承認されます。';
$string['approve'] = '承認';
$string['approvedrequestsubmitted'] = 'あなたのリクエストが送信されました。まもなく処理されます。';
$string['approverequest'] = 'リクエストを承認する';
$string['approverequestall'] = 'リクエストを承認する (すべてのデータ)';
$string['approveselectedcourses'] = '選択したコースを承認する';
...
$string['cancelrequestconfirmation'] = 'このデータリクエストをキャンセルしてもよろしいですか?';
...
$string['confirmcontextdeletion'] = '本当に選択したコンテクストを削除してもよろしいですか? これで関連するサブコンテクストのすべてのユーザデータも削除されます。';
...
$string['errornoselectedcourse'] = 'あなたは少なくとも1つのコースを選択する必要があります。';
...
$string['filterexportdata'] = 'リクエストを承認する (選択したコースからのデータ)';
...
$string['nocoursetofilter'] = 'ユーザは選択するコースに登録されません。';
...
$string['requesttypeexportallowfiltering'] = '私の個人データをエクスポートする';
...
$string['selectcourses'] = 'エクスポートするコースを選択する';
