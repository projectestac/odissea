...
/**
 * Strings for component 'logstore_database', language 'ja', branch 'MOODLE_38_STABLE'
 *
...
$string['jsonformat'] = 'JSONフォーマット';
$string['jsonformat_desc'] = '「other」データベースフィールドでPHPシリアライズデータの代わりに標準JSONフォーマットを使用します。';
