...
$string['ignore'] = '無視';
$string['importimsfile'] = 'IMSエンタプライズファイルをインポートする';
$string['imsenterprise:config'] = 'IMSエンタプライズ登録インスタンスを設定する';
$string['imsenterprisecrontask'] = '登録ファイル処理';
$string['imsrolesdescription'] = 'IMSエンタプライズ仕様には8種類の異なるロールを含みます。ロールを無視する場合も含めてMoodleにこれらのロールを割り当ててください。';
...
$string['messageprovider:imsenterprise_enrolment'] = 'IMSエンタプライズ登録メッセージ';
...
ほとんどの場合、このことを心配する必要はありません。設定欄を空白にした場合、Moodleはターゲットが指定されているかどうか問わず常にデータを処理します。そうではない場合、出力するための正確な名称を<target>タグ内に記述してください。';
$string['roles'] = 'ロール';
$string['settingfullname'] = 'コースフルネームのIMS説明タグ';
$string['settingfullnamedescription'] = 'コースフィールドにフルネームが必要であるため、あなたは選択された説明タグをIMSエンタプライズファイル内に定義する必要があります。';
$string['settingshortname'] = 'コース省略名のIMS説明タグ';
$string['settingshortnamedescription'] = 'コースフィールドに省略名が必要であるため、あなたは選択された説明タグをIMSエンタプライズファイル内に定義する必要があります。';
...
いくつかの学生情報が<userid>フィールドに出力されない場合、この設定を有効にして<sourcedid>をMoodleのユーザIDに使用してください。そうではない場合、この設定を無効のままにしてください。';
$string['truncatecoursecodes'] = 'この長さにコースコードを切り詰める';
$string['truncatecoursecodes_desc'] = 'ここでは処理する前にコースコードを指定した長さに切り詰めることができます。コースコードを切り詰めたい場合、このボックスに文字長を入力してください。そうではない場合、このボックスを空白のままにすることによりコースコードは切り詰められません。';
