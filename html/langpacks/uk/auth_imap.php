...
/**
 * Strings for component 'auth_imap', language 'uk', version '4.1'.
 *
 * @package     auth_imap
 * @category    string
...
$string['auth_imapchangepasswordurl_key'] = 'URL для зміни пароля';
...
$string['auth_imapnotinstalled'] = 'Не вдається використати IMAP аутентифікацію. Модуль PHP IMAP не встановлено.';
