...
$string['groupmode_groupsseparate_help'] = 'Учні діляться на групи і можуть бачити лише роботу своєї групи.';
$string['groupmode_groupsvisible_help'] = 'Учні діляться на групи, але можуть бачити роботу інших груп.';
$string['groupmode_help'] = '* Немає груп
* Окремі групи: студенти поділені на групи й можуть бачити лише роботу своєї групи.
* Видимі групи: учні розділені на групи, але можуть бачити роботу інших груп.

Груповий режим, встановлений на рівні курсу, є режимом за замовчуванням для всіх видів діяльності. Якщо на рівні курсу встановлено груповий режим, його не можна змінити під час дії.';
$string['groupmodeforce'] = 'Примусовий режим роботи з групами';
$string['groupmodeforce_help'] = 'Груповий режим застосовується для всіх дій і не може бути змінений у дій.';
...
$string['participation_help'] = 'Чи повинні члени групи мати можливість вибирати цю групу для дій у режимі окремих або видимих груп? (Застосовується, лише якщо членство в групі видиме або видиме лише для учасників.)';
...
$string['visibility_help'] = '* Видимий - усі учасники курсу можуть бачити, хто входить до групи
...
$string['visibilityall'] = 'Видимість';
