...
/**
 * Strings for component 'moodle', language 'uk', version '4.1'.
 *
 * @package     moodle
 * @category    string
...
$string['courseapprovedemail'] = 'Замовлений Вами курс, {$a->name}, було схвалено і Вас призначено {$a->teacher}. Для доступу до Вашого нового курсу перейдіть до {$a->url}.';
$string['courseapprovedemail2'] = 'Замовлений Вами курс, {$a->name}, було схвалено. Для доступу до Вашого нового курсу перейдіть до {$a->url}.';
$string['courseapprovedfailed'] = 'Помилка запису курсу як схваленого!';
$string['courseapprovedsubject'] = 'Ваш курс було схвалено!';
...
$string['coursedisplay_help'] = 'Цей параметр визначає, чи буде увесь курс відображатися на одній сторінці або буде розділений на декілька сторінок.';
...
$string['courseoverviewfiles_help'] = 'Зображення курсу відображається в огляді курсу на інформаційній панелі. Адміністратор сайту може ввімкнути додаткові прийняті типи файлів і більше одного файлу. Якщо так, ці файли відображатимуться поруч із підсумком курсу на сторінці списку курсів.';
...
$string['coursepreferences'] = 'Переваги курсу';
...
$string['courserequestsuccess'] = 'Ваш запит на створення курсу було успішно збережено. Вам буде відправлено листа для інформування вас чи був схвалений ваш запит.';
...
$string['coursesummary_help'] = 'Резюме курсу відображається в списку курсів. При видачі результатів пошуку курсів резюме курсу додається до назви курсу.';
$string['coursetitle'] = 'Курс: {$a->course}';
$string['courseupdates'] = 'Відновлення курсу';
$string['coursevisibility'] = 'Видимість курсу';
$string['coursevisibility_help'] = 'Цей параметр визначає, чи відображатиметься курс у списку курсів та чи зможуть студенти отримати доступ до нього. Якщо встановлено значення "Приховати", доступ до нього доступний лише для користувачів, які мають можливість переглядати приховані курси (наприклад, вчителів).';
...
$string['deleteallcomments'] = 'Видалити всі коментарі';
$string['deleteallratings'] = 'Видалити всі рейтинги';
...
$string['emailconfirmation'] = 'Вітаємо,

На сайті ’{$a->sitename}\' запитано новий обліковий запис з адресою Вашої електронної пошти.

Щоб підтвердити обліковий запис, зверніться за посиланням на веб-адресу:

{$a->link}.

В більшості програм електронної пошти цей рядок буде виглядати як синій рядок гіперпосилання, на який Ви можете натиснути. Якщо це не спрацьовує, то скопіюйте цей рядок до адресного рядка вашого інтернет оглядача.
...
$string['emailonlyallowed'] = 'Даної адреси немає серед тих, які дозволені ({$a})';
...
Щоб підтвердити цей запит і встановити новий пароль для свого облікового запису, перейдіть за такою веб-адресою: {$a->link} (Це посилання дійсне протягом {$a->resetminutes} хвилин з моменту першого запиту на скидання.)
...
$string['enddate_help'] = 'Дата завершення курсу визначає, чи буде курс зазначений як минулий в огляді курсу. Дата завершення курсу також може використовуватися для спеціальних звітів. Зауважте, що користувачі все ще можуть зайти на курс після дати закінчення; іншими словами, дата не обмежує доступ.';
...
$string['fullnamecourse_help'] = 'Повна назва курсу відображається у верхній частині кожної сторінки курсу та в списку курсів.';
...
$string['gpl'] = 'Авторські права (C) 1999 р.

Мартін Дугіамас (https://moodle.com) Ця програма є безкоштовним програмним забезпеченням; ви можете розповсюджувати його та/або змінювати на умовах Загальної публічної ліцензії GNU, опублікованої Фондом вільного програмного забезпечення; або версія 2 Ліцензії, або (на ваш вибір) будь-яка пізніша версія.
...
Повну інформацію дивіться на сторінці інформації про ліцензію Moodle: https://docs.moodle.org/dev/License';
$string['gpl3'] = 'Авторські права (C) 1999 р. Мартін Дугіамас (https://moodle.com)

Ця програма є безкоштовним програмним забезпеченням: ви можете розповсюджувати її та/або змінювати її відповідно до умов Загальної публічної ліцензії GNU, опублікованої Фондом вільного програмного забезпечення, або версії 3 Ліцензії, або (на ваш вибір) будь-якої пізнішої версії.
...
$string['hiddensections_help'] = 'Чи відображаються приховані розділи студентам як недоступні (можливо, для курсу в тижневому форматі, щоб позначати свята) або повністю приховані.';
...
$string['hidepicture'] = 'Сховати малюнок';
...
$string['highlightoff'] = 'Прибрати виділення';
...
$string['idnumbercourse_help'] = 'Ідентифікатор курсу використовується тільки при зіставленні курсу від зовнішніх систем і не відображається ніде на сайті. Якщо курс має офіційний ідентифікатор, то він може бути введений, інакше поле можна залишити порожнім.';
...
$string['languagegood'] = 'Це найновіший пакет мови! :-)';
...
$string['maximumupload_help'] = 'Цей параметр визначає максимальний обсяг файлу, який може бути завантажений на курс, обмежений на рівні сайті налаштуваннями встановленими адміністратором. Діяльністі також включають налаштування максимального розміру файлу, для подальшого обмеження обсягу файлу.';
...
$string['moodledocslink'] = 'Довідка та документація';
...
$string['newsitemsnumber_help'] = 'Форум оголошень — це спеціальний форум, який створюється автоматично в курсі, має примусову підписку, встановлену за замовчуванням, і лише користувачі з відповідними правами (за замовчуванням викладачі) можуть писати на ньому. Цей параметр визначає, скільки останніх повідомлень відображатиметься в останньому блоці повідомлень. Якщо в курсі форум оголошень не потрібен, цей параметр потрібно встановити на нуль.';
...
На сайті \'{$a->sitename}\' для вас було створено новий обліковий запис, яким ви можете скористатися за допомогою тимчасового паролю.

Ваші поточні дані для входу:

  ім’я користувача (логін): {$a->username}
  пароль: {$a->newpassword}
    (вам потрібно буде змінити пароль
     після першого входження)

Для початку використання \'{$a->sitename}\' зайдіть на {$a->link}

У більшості поштових програм досить натиснути на це посилання і сторінка відкриється у вашому веб-оглядачі. Якщо цього не сталося, то просто скопіюйте це посилання в адресний рядок оглядача.

З найкращими побажаннями, адміністратор сайту \'{$a->sitename}\', $a->signoff';
...
$string['paymentinstant'] = 'Використайте кнопку нижче, для того щоб заплатити та зареєструватися протягом декількох хвилин!';
...
$string['paymentsorry'] = 'Спасибі за оплату! На жаль, ваша оплата ще не повністю опрацьована, і ви не зареєстровані для входу на курс "{$a->fullname}". Спробуйте, будь ласка, через кілька секунд, але, якщо проблема не зникне, повідомте {$a->teacher} або адміністратора.';
$string['paymentthanks'] = 'Спасибі за оплату! Тепер ви підписані на курс: <br />"{$a}"';
...
$string['policyagreementclick'] = 'Читати Угоду';
...
$string['registrationno'] = 'Так, надайте форму, щоб інші Moodler могли зв’язатися зі мною';
...
$string['resendemail'] = 'Повторно надіслати електронний лист';
$string['reset'] = 'Очистити';
$string['resetcomponent'] = 'Компонент';
$string['resetcourse'] = 'Очищення курсу';
$string['resetinfo'] = 'Ця сторінка дозволяє очистити курс від даних користувачів, залишаючи незмінними решту даних. Зверніть увагу, якщо ви підете далі, то всі дані користувачів на цьому курсі будуть видалені безповоротно!';
$string['resetnotimplemented'] = 'Скинути не здіснене';
...
$string['rolerenaming_help'] = 'Цей параметр дозволяє змінити показ назви ролі в курсі. Зміниться тільки назва ролі - на її права це  не вплине. Нова назва ролі буде відображатися на сторінці учасників курсу та скрізь в цьому курсі. Якщо перейменована роль відноситься до управлінських ролей курсу, то нова її назва буде відображатися як частина в списку курсів.';
$string['roles'] = 'Ролі';
$string['rss'] = 'RSS';
...
$string['shortnamecourse_help'] = 'Коротка назва курсу буде відображатися в навігаційному меню та використовуватися в темі при надсиланні електронних листів учасникам курсу.';
...
$string['showactivitydates_help'] = 'Дати активності завжди відображаються на сторінці активності. Цей параметр визначає, чи відображатимуться дати діяльності під кожним заняттям на сторінці курсу.';
...
$string['showgrades_help'] = 'Багато видів діяльності дозволяють виставляти оцінки. Цей параметр визначає, чи може студент переглядати список усіх своїх оцінок за курс.';
...
$string['showreports_help'] = 'Звіти про діяльність є для кожного учасника, який проявляє активність на курсі. Вони виглядають як список їх внесків, таких як повідомлення на форумах, виконання завдань, а також включають події доступу. Цей параметр визначає, чи будуть студенти бачити власні звіти про діяльність на сторінці свого профілю.';
...
$string['signoutofotherservices'] = 'Вийти всюди';
$string['signoutofotherservices_help'] = 'Якщо позначено цей пункт, обліковий запис буде виписано з усіх пристроїв і систем, які використовують веб-сервіси, наприклад, мобільне додаток.';
$string['since'] = 'З';
...
$string['sites'] = 'Сайти';
$string['sitesection'] = 'Включити верхню секцію';
...
$string['startdate_help'] = 'Цей параметр визначає початок першого тижня курсу у тижневому форматі. Він також визначає найранішу дату, на яку доступні журнали діяльності курсу. Якщо курс скинуто і дату початку курсу змінено, усі дати курсу будуть переміщені відносно нової дати початку.';
...
$string['supplyinfo'] = 'Більше інформації';
...
$string['userselectorsearchanywhere'] = 'Шукати будь-де в показаних полях';
...
Ви можете відредагувати дані свого профілю на {$a->profileurl} (якщо ви цього ще не зробили), щоб ми могли дізнатися про вас більше.';
