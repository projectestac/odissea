...
/**
 * Strings for component 'auth', language 'uk', version '4.1'.
 *
 * @package     auth
 * @category    string
...
$string['auth_changingemailaddress'] = 'Ви повинні підтвердити зміну ел.адреси з {$a->oldemail} на {$a->newemail}. З міркувань безпеки, на вашу ел.адресу ми надсилаємо листа з новою адресою для підтвердження її зміни. Ваша едреса ел.пошти буде змінена як тільки ви перейдете за посиланням, яке побачите в листі.';
...
$string['errorminpasswordnonalphanum'] = 'Пароль має містити принаймні {$a} спеціальних символів, наприклад *, - або #.';
