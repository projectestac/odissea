...
/**
 * Strings for component 'auth', language 'uk', version '4.5'.
 *
 * @package     auth
 * @category    string
...
$string['emailupdatemessage'] = 'Привіт, {$a->firstname},

Ви подали запит на зміну адреси електронної пошти для свого облікового запису на {$a->site}. Щоб підтвердити цю зміну, перейдіть за такою веб-адресою:

{$a->url}
Термін дії посилання для підтвердження закінчиться через <b>10 хвилин</b>.
...
$string['showloginform'] = 'Відобразити ручну форму входу';
$string['showloginform_desc'] = 'Якщо всі користувачі на сайті використовують такий метод автентифікації, як OAuth 2, який не потребує введення імені користувача та пароля, ви можете приховати форму входу вручну. Зауважте, що користувачі з ручними обліковими записами не зможуть увійти.

Якщо ви приховаєте форму входу вручну, а потім не зможете ввійти, ви можете відобразити її знову за допомогою командного рядка php admin/cli/cfg.php --name=showloginform --set=1';
