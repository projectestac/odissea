...
$string['activitychoosertabmode_desc'] = 'Засіб вибору завдань містить список завдань і ресурсів, які вчитель може додати до свого курсу. Щоб додати елементи на вкладку «Рекомендовані», перейдіть до <a href=\'../course/recommendations.php\'>Рекомендовані дії</a>.';
$string['activitychoosertabmodefive'] = 'Із зірочками, Рекомендовано, Усі';
$string['activitychoosertabmodefour'] = 'Із зірочкою, Рекомендовано, Усі, Діяльність, Ресурси';
$string['activitychoosertabmodeone'] = 'Відмічені, Усі, Заходи, Ресурси, Рекомендовані';
$string['activitychoosertabmodesix'] = 'Із зірочкою, Рекомендовано, Діяльність, Ресурси';
...
$string['communicationroomlink'] = 'Чат з учасниками курсу';
...
$string['coursecommunication_desc'] = 'Служба спілкування за замовчуванням для нових курсів. Для існуючих курсів за замовчуванням не буде вибрано жодного постачальника.';
...
$string['coursecount'] = 'Підрахунок курсу';
...
$string['defaultsettingscategory'] = 'Налаштування за замовчуванням';
...
$string['pdfexportfont_help'] = 'Шрифт, який буде використовуватися для створених PDF-файлів, наприклад для подання завдань.';
...
$string['sectionlink'] = 'Постійне посилання';
$string['showstartedcoursestask'] = 'Показати курси в дату початку';
...
$string['totalactivities'] = 'Діяльність: {$a}';
