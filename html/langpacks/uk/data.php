...
/**
 * Strings for component 'data', language 'uk', version '4.4'.
 *
 * @package     data
 * @category    string
...
$string['csvfile'] = 'CSV або ZIP, що містить файл CSV';
...
$string['errordatafilenotfound'] = 'Не вдалося імпортувати файл. Прийнятні типи файлів: CSV або ZIP, що містить файл CSV у форматі, що використовується для експорту записів.';
...
$string['fieldsinformationtags'] = 'Польова інформація';
$string['fieldsnavigation'] = 'Поля третинної навігації';
$string['fieldtagdescription'] = '{$a} опис';
$string['fieldtagid'] = 'Ідентифікатор {$a}';
$string['fieldtagname'] = '{$a} ім\'я';
...
$string['includefiles'] = 'Включати файли в експорт';
...
$string['other'] = 'Інше';
$string['otherfields'] = 'Всі інші поля';
...
$string['previewaction'] = 'Попередній перегляд';
...
$string['resettemplate'] = 'Скинути поточний шаблон';
...
$string['uploadrecords'] = 'Імпортувати записи';
$string['uploadrecords_help'] = 'Імпортуйте записи, які ви експортували з іншої бази даних, у форматі CSV або ZIP, що містить файл CSV (якщо файли включено до експорту).

Крім того, щоб створити файл CSV для імпорту, додайте один запис до бази даних, а потім експортуйте його. Відредагуйте файл CSV і додайте більше записів.';
