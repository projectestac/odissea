...
$string['completionattendance'] = 'Студент повинен бути присутнім на сесії для:';
...
$string['config_preuploadpresentation'] = 'Попереднє завантаження презентації';
...
$string['config_server_url_description'] = 'Облікові дані за замовчуванням призначені для безкоштовної служби <a href="https://bigbluebutton.org/free-bigbluebutton-service-for-moodle/" target="_blank">BigBlueButton для Moodle (відкривається в новому вікні)</a>, наданої Blindside Networks з такими обмеженнями:
<ol>
...
$string['config_shared_secret_description'] = 'Секрет безпеки вашого сервера BigBlueButton. Секрет за замовчуванням – це безкоштовна послуга BigBlueButton, що надається Blindside Networks.';
...
$string['config_welcome_default_description'] = 'Вітальне повідомлення відображається, коли учасники входять до кімнати. Якщо поле залишено порожнім, відобразиться повідомлення, встановлене на сервері BigBlueButton.';
