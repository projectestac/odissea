...
/**
 * Strings for component 'media_videojs', language 'uk', version '4.1'.
 *
...
$string['configaudioextensions'] = 'Розділений комами список підтримуваних розширень аудіофайлів. VideoJS спробує використовувати вбудований відеопрогравач браузера, якщо він доступний, або власну функціональність VideoJS.';
...
$string['configvideoextensions'] = 'Список підтримуваних розширень відеофайлів, розділених комами. VideoJS спробує використовувати вбудований відеопрогравач браузера, якщо він доступний.';
...
$string['pluginname_help'] = 'Обгортка JavaScript для відеофайлів, які відтворюються вбудованим відеопрогравачем браузера. (Підтримка форматів залежить від браузера.)';
