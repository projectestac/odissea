...
$string['correctitemsnumber'] = 'Виправити елементи: {$a}';
...
$string['draggableitemno'] = 'Перетягуваний елемент {no}';
$string['draggableitems'] = 'Перетягувані елементи';
...
$string['highlightresponse'] = 'Позначити відповідь як правильну або неправильну';
$string['horizontal'] = 'Горизонтально';
$string['incorrectitemsnumber'] = 'Помилкові елементи: {$a}';
...
$string['moved'] = '{$a->item} переміщено. Нове положення: {$a->position} з {$a->total}.';
$string['moveleft'] = 'Перемістити вліво';
$string['moveright'] = 'Перемістити вправо';
...
$string['notenoughsubsetitems'] = 'Набір повинен містити щонайменше {$a} елементів.';
...
$string['partialitemsnumber'] = 'Частково правильні варіанти: {$a}';
...
$string['regradeissuenumitemschanged'] = 'Кількість елементів, які можна перетягувати, змінилася.';
