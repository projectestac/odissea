...
/**
 * Strings for component 'logstore_standard', language 'uk', version '4.4'.
 *
...
$string['buffersize'] = 'Розмір буфера запису';
...
$string['pluginname'] = 'Стандартний журнал подій';
$string['pluginname_desc'] = 'Модуль журналу подій, який зберігає записи подій в таблиці бази даних Moodle.';
...
$string['taskcleanup'] = 'Очищення таблиці журналу подій';
