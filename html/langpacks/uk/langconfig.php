...
/**
 * Strings for component 'langconfig', language 'uk', version '4.4'.
 *
 * @package     langconfig
 * @category    string
...
$string['alphabet'] = 'А,Б,В,Г,Ґ,Д,Е,Є,Ж,З,И,І,Ї,Й,К,Л,М,Н,О,П,Р,С,Т,У,Ф,Х,Ц,Ч,Ш,Щ,Ь,Ю,Я';
$string['am'] = 'am';
$string['amcaps'] = 'AM';
...
$string['localewin'] = 'Ukranian.1251';
