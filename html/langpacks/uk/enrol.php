...
/**
 * Strings for component 'enrol', language 'uk', version '4.5'.
 *
 * @package     enrol
 * @category    string
...
$string['customwelcomemessageplaceholder'] = 'Привіт, {$a->firstname}, ти зарахований на курс {$a->coursename}.';
...
$string['plugindisabled'] = 'Плагін реєстрації {$a} вимкнено';
...
$string['sendcoursewelcomemessage'] = 'Надіслати вітальне повідомлення про курс';
$string['sendcoursewelcomemessage_help'] = 'Під час реєстрації користувача або когорти на курс їм може бути надіслано вітальне повідомлення електронною поштою. Якщо надіслано від контактної особи курсу (за замовчуванням це вчитель), і цю роль має більше ніж один користувач, електронний лист надсилається від першого користувача, якому призначено роль.';
