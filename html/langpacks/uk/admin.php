...
/**
 * Strings for component 'admin', language 'uk', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['configcookiehttponly'] = 'Включення нових функціональностей PHP 5.2.0 - браузери надсилають куки тільки за реальними http-запитами, куки недоступні скриптовим мовам. Це не підтримується всіма браузерами і може бути не повністю сумісним з даним кодом. Але це допоможе запобігти деяким видам XSS атак';
...
$string['configenableactivitychooser'] = 'Засіб вибору діяльності — це діалогове вікно з коротким описом кожного виду діяльності та ресурсу. Якщо вимкнено, натомість надаються окремі спадні меню ресурсів і дій.';
...
$string['configmodchooserdefault'] = 'Чи надавати користувачам типовий вибір діяльності?';
...
$string['configuseexternalyui'] = 'Замість того, щоб використовувати локальні файли, використовуйте інтернет файли, доступні на серверах Yahoo. УВАГА: Для цього потрібне підключення до інтернету, інакше AJAX не буде працювати на вашому сайті.';
...
$string['confirmdeletecomments'] = 'Ви збираєтеся видалити коментарі, впевнені?';
...
$string['cookiehttponly'] = 'Тільки http куки';
...
$string['enableactivitychooser'] = 'Увімкнути вибір активності';
...
$string['modchooserdefault'] = 'Типовий вибір діяльності';
...
$string['resetindentation'] = 'Скинути відступ';
$string['resetindentation_help'] = 'Це призведе до видалення будь-яких відступів, встановлених раніше для курсів у {$a->format}.';
$string['resetindentation_title'] = 'Скинути відступи на сторінці курсу?';
...
$string['useexternalyui'] = 'Використовувати онлайнові YUI бібліотеки';
