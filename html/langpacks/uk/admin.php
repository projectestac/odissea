...
/**
 * Strings for component 'admin', language 'uk', version '4.5'.
 *
 * @package     admin
 * @category    string
...
$string['configgeoipfile'] = 'Розташування файлу двійкових даних GeoIP City. Цей файл не є частиною дистрибутива Moodle і його потрібно отримати окремо від <a href="https://www.maxmind.com/">MaxMind</a>. Ви можете придбати комерційну версію або скористатися безкоштовною версією. Вам потрібно буде зареєструватися, щоб завантажити файл бази даних міста, що можна зробити на <a href="https://dev.maxmind.com/geoip/geoip2/geolite2/" >https://dev.maxmind.com/geoip/geoip2/geolite2/</a>. Після реєстрації та завантаження файлу розпакуйте його в каталог "{$a}" на вашому сервері.';
...
$string['geoipdbedition_desc'] = 'Виберіть випуск бази даних GeoIP для завантаження. Майте на увазі, що використання бази даних GeoIP2-City вимагає дійсної платної ліцензії.';
$string['geoipfile'] = 'GeoIP City DB';
$string['geoipmaxmindaccid'] = 'ID облікового запису MaxMind';
$string['geoipmaxmindaccid_desc'] = 'Ідентифікатор облікового запису, створеного в службі MaxMind API.';
$string['geoipmaxmindlicensekey'] = 'Ліцензійний ключ MaxMind';
$string['geoipmaxmindlicensekey_desc'] = 'Ліцензійний ключ облікового запису, створеного на сервісі MaxMind API.';
...
$string['importantupdates_content'] = '<p>У наступній версії Moodle 5.0, випуск якої заплановано на квітень 2025 року, дії в чаті та опитуванні будуть
бути видалено з ядра Moodle. Вони будуть доступні як плагіни в
<a href="https://moodle.org/plugins/">Каталог плагінів Moodle</a>.</p>
<p>Якщо ви бажаєте й надалі використовувати Chat або Survey на своєму сайті, ви зможете встановити їх як плагіни перед оновленням до Moodle 5.0.</p>';
$string['importantupdates_title'] = 'Важливе оновлення про чат та опитування';
...
$string['iplookupgeoplugin'] = 'Служба <a href="https://www.geoplugin.com">geoPlugin</a> зараз використовується для пошуку географічної інформації. Для більш точних результатів ми рекомендуємо встановити локальну копію бази даних MaxMind GeoIP City.';
$string['iplookupinfo'] = 'Безкоштовний онлайн-сервер NetGeo використовується для пошуку IP-адрес. Однак база даних більше не підтримується і може повертати неправильні дані. Рекомендується встановити локальну копію бази даних GeoIP від MaxMind.<br />
Якщо надано ключ Google Maps API V3, розташування IP-адреси відображається за допомогою Google Maps. Вам потрібен обліковий запис Google і заявка на отримання ключа Google Maps API. Якщо ключ Google Maps API V3 не надано, розташування IP-адреси відображається за допомогою OpenStreetMap.';
$string['iplookupmaxmindnote'] = 'Цей продукт містить дані GeoIP City, створені MaxMind, доступні на <a href="https://www.maxmind.com">https://www.maxmind.com</a>.';
...
$string['lockoutemailbody'] = 'Привіт, {$a->firstname},

Ваш обліковий запис із іменем користувача {$a->username} на сервері \'{$a->sitename}\'
було заблоковано після кількох недійсних спроб входу.

Щоб розблокувати обліковий запис, негайно перейдіть за наступною адресою

{$a->link}

У більшості поштових програм це має відображатися як синє посилання
яку можна просто натиснути. Якщо це не спрацює,
потім скопіюйте та вставте адресу в адресу
...
$string['registrationwarning'] = 'Не пропустіть важливі оновлення та сповіщення про безпеку.';
$string['registrationwarningcontactadmin'] = 'Цей сайт не зареєстрований. Будь ласка, попросіть свого адміністратора зареєструвати сайт, щоб вони не пропустили важливих оновлень.';
...
$string['storedprogressbarcleanuptask'] = 'Зберігається завдання з очищення бару прогресу';
...
$string['tasktype'] = 'Тип';
$string['taskupdategeoip2file'] = 'Оновіть файл GeoIP';
