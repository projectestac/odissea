...
$string['activitycompletion'] = 'Виконання діяльностей';
...
$string['badautocompletion'] = 'При виборі автоматичного відслідковування виконання, необхідно також включити принаймні одну вимогу (див. нижче).';
...
$string['completedunlockedtext'] = 'Після збереження змін, дані проходження для всіх студентів будуть стерті. Якщо ви зміните свою думку з цього приводу, не зберігайте форму.';
$string['completedwarning'] = 'Опції відслідковування виконання заблоковано';
$string['completedwarningtext'] = 'Цю дію вже позначено як виконану для {$a} учасника(ів). Зміна параметрів завершення призведе до видалення їх стану завершення і може призвести до плутанини. Таким чином, параметри були заблоковані, і їх не слід розблоковувати, якщо немає абсолютної необхідності.';
...
$string['completion_automatic'] = 'Показувати діяльність як виконану, коли виконано всі умови';
...
$string['completion_manual'] = 'Студент може самостійно позначати діяльність як виконану';
$string['completion_none'] = 'Не показувати виконання діяльності';
...
$string['completionexpected'] = 'Виконання планується до';
$string['completionexpected_help'] = 'Цей параметр визначає дату, коли очікується завершення діяльності. Коли наближається дата, діяльність відображається в блоці Часова шкала на інформаційній панелі.';
...
$string['completionpassgrade_desc'] = 'Студент повинен отримати прохідну оцінку, щоб виконати цю роботу';
...
$string['completionusegrade_desc'] = 'Для виконання цієї діяльності студент повинен отримати оцінку';
...
$string['completionview_desc'] = 'Для виконання цієї діяльності студент повинен переглянути її';
...
$string['enablecompletion_help'] = 'Якщо ввімкнено, умови завершення заняття можуть бути встановлені в налаштуваннях діяльності та/або умови завершення курсу. Рекомендується ввімкнути цю функцію, щоб важливі дані відображалися в огляді курсу на інформаційній панелі.';
