...
/**
 * Strings for component 'assign', language 'uk', version '4.5'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduedigesthtml'] = '<p>Вітаю, {$a->firstname},</p>
<p>Термін виконання наступних завдань: <strong>{$a->duedate}</strong>.</p>
{$a->дайджест}';
$string['assignmentduedigestitem'] = '<strong>{$a->assignmentname}</strong> у курсі {$a->coursename}<br/>
<strong>Термін: {$a->duetime}</strong><br/>
<a href="{$a->url}" aria-label="Go to {$a->assignmentname}">Перейти до активності</a>';
$string['assignmentduedigestsubject'] = 'Ви повинні виконати завдання через 7 днів';
$string['assignmentduesoonhtml'] = '<p>Вітаю, {$a->firstname},</p>
<p>Завдання <strong>{$a->assignmentname}</strong> з курсу {$a->coursename} має бути незабаром.</p>
<p><strong>Термін: {$a->duedate}</strong></p>
<p><a href="{$a->url}">Перейти до активності</a></p>';
$string['assignmentduesoonsubject'] = 'Термін виконання: {$a->due date}: {$an->assignment name}';
...
$string['assignmentoverduehtml'] = '<p>Вітаю, {$a->firstname},</p>
<p><strong>{$a->assignmentname}</strong> у курсі {$a->coursename} потрібно було виконати <strong>{$a->duedate}</strong>.</p>
<p>Можливо, ви все ще зможете подати своє завдання{$a->cutoffsnippet}, але ваше подання буде позначено як запізніле.</p>
<p><a href="{$a->url}">Перейти до активності</a></p>';
$string['assignmentoverduehtmlcutoffsnippet'] = '<strong>до {$a->cutoffdate}</strong>';
$string['assignmentoverduesubject'] = 'Прострочено: {$a->assignmentname}';
...
$string['attemptreopenmethod_automatic'] = 'Автоматично';
$string['attemptreopenmethod_automatic_help'] = 'Після кожної спроби наступну надано автоматично.';
$string['attemptreopenmethod_help'] = 'Цей параметр контролює, як учням надаються спроби виконати це завдання. Для кожної спроби оцінка та відгук зберігаються, і їх можуть переглядати викладач і студент. Доступні варіанти:

* Вручну – після кожної спроби ви можете надати наступну через сторінку «Подання» або сторінку «Грейдер».
* Автоматично – після кожної спроби наступна надається автоматично.
* Автоматично до проходження – після кожної спроби наступна буде надана автоматично, доки студент не отримає прохідний бал.';
$string['attemptreopenmethod_manual'] = 'Вручну';
$string['attemptreopenmethod_manual_help'] = 'Після кожної спроби ви можете надати наступну на сторінці «Подання» або на сторінці «Грейдер».';
$string['attemptreopenmethod_none'] = 'Ніколи';
$string['attemptreopenmethod_untilpass'] = 'Автоматично до виконання';
$string['attemptreopenmethod_untilpass_help'] = 'Після кожної спроби наступна буде надана автоматично, доки студент не отримає прохідний бал.';
$string['attemptsettings'] = 'Налаштування спроби';
$string['availability'] = 'Доступність';
$string['back'] = 'Назад';
$string['backtoassignment'] = 'Повернутися до завдання';
$string['batchoperationaddattempt'] = 'Грантова спроба';
...
$string['batchoperationdownloadselected'] = 'Завантажити';
$string['batchoperationgrantextension'] = 'Розширити';
$string['batchoperationlock'] = 'Блокувати';
$string['batchoperationremovesubmission'] = 'Видалити';
$string['batchoperationreverttodraft'] = 'Повернути до чернетки';
$string['batchoperationsdescription'] = 'З вибраними...';
$string['batchoperationsetmarkingallocation'] = 'Виділити маркер';
$string['batchoperationsetmarkingworkflowstate'] = 'Змінити стан маркування';
$string['batchoperationunlock'] = 'Розблокувати';
...
$string['blindmarkingenabledwarning'] = 'Для цієї діяльності ввімкнено анонімне надсилання. Оцінки не будуть додані до журналу оцінок, доки особи студентів не будуть виявлені в меню «Дії».';
$string['cachedef_overrides'] = 'Інформація про заміну користувача та групи';
$string['calendardue'] = 'Строк {$a} спливає';
$string['calendarextension'] = '{$a} настав (продовження)';
...
$string['defaultgradescale'] = 'Шкала оцінювання';
$string['defaultgradescale_help'] = 'Шкала оцінювання за умовчанням для нових завдань. Доступні тільки стандартні ваги.';
$string['defaultgradetype'] = 'Тип оцінки';
$string['defaultgradetype_help'] = 'Тип оцінки за умовчанням для нових завдань.';
...
$string['deleteallsubmissions'] = 'Всі подання';
...
$string['extensionduedaterange'] = 'Змінні від {$a->earliest} до {$a->latest}';
$string['extensionduedatewithout'] = 'Користувачі без поточного розширення: {$a}';
...
$string['gradeactions'] = 'Оцінка дій';
...
$string['includesuspendedparticipants'] = 'Включати відсторонених учасників';
...
$string['markingstate'] = 'Стан маркування';
...
$string['maxattempts'] = 'Дозволені спроби';
...
$string['messageprovider:assign_due_digest'] = 'Завдання мають бути повідомлені за 7 днів';
$string['messageprovider:assign_due_soon'] = 'Сповіщення про призначення незабаром';
$string['messageprovider:assign_notification'] = 'Розсилати повідомлення із задань';
$string['messageprovider:assign_overdue'] = 'Повідомлення про прострочене завдання';
...
$string['notifystudents'] = 'Повідомити студентів';
...
$string['removeallgroupoverrides'] = 'Усі перевизначення груп';
$string['removealluseroverrides'] = 'Усі перевизначення користувача';
...
$string['sendnotificationduedatesoon'] = 'Повідомити користувача про наближення терміну виконання завдання';
$string['sendnotificationduedigest'] = 'Повідомити користувача про завдання, які потрібно виконати за 7 днів';
$string['sendnotificationoverdue'] = 'Повідомити користувача про прострочене призначення';
...
$string['submissionactions'] = 'Дії подання';
...
$string['viewgrader'] = 'Переглянути грейдер';
