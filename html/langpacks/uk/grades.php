...
/**
 * Strings for component 'grades', language 'uk', version '4.1'.
 *
 * @package     grades
 * @category    string
...
$string['aggregatesonly'] = 'Змінити на Тільки об\'єднання';
...
$string['errorcalculationbroken'] = 'Можливо циклічне посилання або інша помилка у формулі';
...
$string['fullmode'] = 'Змінити на Повний вигляд';
...
$string['gradesonly'] = 'Змінити на Тільки оцінки';
...
$string['missingitemtypeoreid'] = 'Ключ масиву (itemtype або eid) відсутній з другого параметру grade_edit_tree_column_select::get_item_cell($item, $params)';
...
$string['showingaggregatesonly'] = 'Показано лише оцінки категорій';
$string['showingfullmode'] = 'Показано всі оцінки';
...
$string['singleview'] = 'Одиночний вид для {$a}';
