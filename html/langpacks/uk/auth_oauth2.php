...
/**
 * Strings for component 'auth_oauth2', language 'uk', version '4.5'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['confirmaccountemail'] = 'Привіт, {$a->firstname},
...
Якщо ви цього не зробили, хтось інший міг намагатися зламати ваш обліковий запис.
Негайно зверніться до адміністратора сайту.';
...
$string['confirmlinkedloginemail'] = 'Привіт, {$a->firstname},

Надіслано запит на пов’язування логіна {$a->issuername}
{$a->linkedemail} на ваш обліковий запис на \'{$a->sitename}\'
використовуючи вашу електронну адресу.

Щоб підтвердити цей запит і пов’язати ці логіни, перейдіть за цією веб-адресою:
