...
$string['cannotresetguestpwd'] = 'Ezin duzu gonbidatuen pasahitza berrabiarazi';
...
$string['cannotsaveagreement'] = 'Ezin da zure onespena gorde';
...
$string['contentvisibilitynotfound'] = '\'{$a}\' ikusgarritasun-ezarpena duen edukia ez da existitzen edo ez da aurkitu.';
...
$string['csvfewcolumns'] = 'Ez dago zutabe nahikorik, mesedez egiazta ezazu banatzailearen ezarpena';
$string['csvfileerror'] = 'Arazoren bat dago CSV fitxategiaren formatuarekin. Egiaztatu ezazu mesedez zutabe-goiburu eta zutabe kopuruak bat datozela eta zutabe-banatzailea zein fitxategiaren kodifikazioa egokiak direla. {$a}';
...
$string['encryption_invalidkey'] = 'Gako baliogabea';
$string['encryption_keyalreadyexists'] = 'Gakoa dagoeneko existitzen da';
$string['encryption_nokey'] = 'Gakoa ez da aurkitu';
$string['encryption_wrongmethod'] = 'Datuak ez datoz bat onartutako zifratze-metodoren batekin';
$string['enddatebeforestartdate'] = 'Ikastaroaren amaiera-data hasiera-data baino beranduagokoa izan behar da.';
$string['error'] = 'Errorea gertatu da';
$string['error_question_answers_missing_in_db'] = 'Ezin izan da "{$a->answer}" edukia duen erantzunik aurkitu datu-baseko question_answers taulan. Hau {$a->filequestionid} IDa duen galdera berreskuratzean gertatu da, {$a->dbquestionid} IDa duen datu-basean existitzen den galderarekin lotu dena.';
...
$string['expiredkey'] = 'Iraungitako gakoa';
...
$string['guestcantaccessprofiles'] = 'Gonbidatuek ez dute erabiltzaile-profiletarako sarbiderik. Zure kontuarekin sartu zaitez aurrera egiteko.';
$string['guestnocomment'] = 'Gonbidatuek ez dute mezuen iruzkinak egiteko baimenik';
$string['guestnoeditprofile'] = 'Erabiltzaile gonbidatuek ezin dute beren profila editatu.';
$string['guestnoeditprofileother'] = 'Ezinezkoa da gonbidatuen profila editatzea.';
$string['guestnorate'] = 'Gonbidatuek ez dute sarrerak kalifikatzeko baimenik';
$string['guestsarenotallowed'] = 'Gonbidatu-rola ez dauka honetarako baimenik';
...
$string['installproblem'] = 'Normalean ezinezkoa izaten da instalazioan gertatutako erroreetatik berreskuratzea, baliteke datu-base berri bat sortu behar izatea edo datu-base aurrizki ezberdin bat erabiltzea instalatzen berriro saiatu nahi baduzu.';
...
$string['invalidarguments'] = 'Ez da baliozko argumenturik eman';
...
$string['invalidkey'] = 'Gakoa ez da zuzena';
...
$string['invalidnumkey'] = 'Baliteke $conditions array-ak zenbakizkoak ez diren gakoak izatea. Konpondu ezazu kodea mesedez!';
...
$string['noguest'] = 'Hemen gonbidaturik ez!';
...
$string['nopermissiontoviewcalendar'] = 'Sentitzen dugu, baina ez daukazu egutegiko ekitaldia ikusteko baimenik.';
...
$string['oauth2refreshtokentaskerror'] = 'Ezin izan da emaile bat edo gehiagoren OAuth 2 tokena berriztu. Ikusi atazaren irteera xehetasunetarako.';
$string['oauth2upgradetokenerror'] = 'Ezin izan da OAuth 2 tokena eguneratu. Urruneko amaiera-puntuaren HTTP egoera: {$a}';
...
$string['pathdoesnotstartslash'] = 'Ez da baliozko argumenturik eman, bidea ez da barra batekin hasten!';
...
$string['restrictedcontextexception'] = 'Sentitzen dugu, kanpo-funtzioen exekuzioak testuinguruko murrizketak urratzen ditu.';
...
$string['upgraderunning'] = 'Gunea eguneratzen ari da. Mesedez, saiatu zaitez berriro beranduago.';
