...
/**
 * Strings for component 'qtype_multianswer', language 'eu', version '4.4'.
 *
...
$string['corruptedquestion'] = 'Galdera hau kaltetuta dago eta sisteman existitzen ez diren azpi-galderak barne ditu.';
...
$string['layouthorizontal'] = 'Aukera bakarreko botoietako errenkada horizontala';
...
$string['questioninquiz'] = '<ul>
  ...
  <li>aldatu galdera mota (zenbakizkoa, erantzun laburrekoa, aukera anizkoitzekoa).</li>
</ul>';
