...
$string['allattemptscontributetograde'] = 'Saiakera guztiak kontuan hartzen dira erabiltzailearen azken kalifikaziorako.';
$string['allstudents'] = 'Erakutsi {$a} guztiak';
$string['attemptsonly'] = 'Erakutsi saiakerak dituen {$a} soilik';
$string['attemptsprepage'] = 'Orri bakoitzean erakutsitako saiakerak';
...
$string['noattemptsonly'] = 'Erakutsi / jaitsi soilik saiakerarik ez dituen {$a}';
$string['noattemptstoregrade'] = 'Ez dago berriro kalifikatu beharreko saiakerarik';
...
$string['optnoattemptsonly'] = 'Saiakerarik ez duten {$a} baino ez';
$string['optonlyregradedattempts'] = 'berriro kalifikatu direnak / berriz kalifikatu behar direlako markatuta daudenak';
$string['overview'] = 'Kalifikazioak';
$string['overviewdownload'] = 'Laburpena jaitsi';
$string['overviewfilename'] = 'kalifikazioak';
$string['overviewreport'] = 'Kalifikazioen txostena';
$string['overviewreportgraph'] = 'Orokorrean kalifikazio-tarte ezberdinak lortzen dituzten ikasle-kopurua';
$string['overviewreportgraphgroup'] = 'Kalifikazio-tarte ezberdinak lortzen dituzten  \'{$a}\' taldeko ikasle kopuruak';
$string['pagesize'] = 'Orriaren tamaina';
$string['pluginname'] = 'Kalifikazioak';
...
$string['privacy:metadata:preference:quiz_overview_slotmarks'] = 'Galdera-tarte bakoitzaren kalifikazioak erakutsiko diren edo ez.';
...
$string['showdetailedmarks'] = 'Galdera bakoitzaren puntuazioak';
$string['showinggraded'] = 'Erabiltzaile bakoitzarentzat kalifikatutako saiakera soilik erakusten.';
$string['showinggradedandungraded'] = 'Erabiltzaile bakoitzarentzat kalifikatutako eta kalifikatu gabeko saiakerak erakusten. Erabiltzaile bakoitzarentzat kalifikatutako saiakera bakarra nabarmenduta dago. Galdetegi honetan kalifikazio-metodoa {$a} da.';
$string['studentingroup'] = '\'{$a->groupname}\' taldeko \'{$a->coursestudent}\'';
$string['studentingrouplong'] = '\'{$a->coursestudent}\' talde honetan';
