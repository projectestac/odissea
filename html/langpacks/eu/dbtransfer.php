...
/**
 * Strings for component 'dbtransfer', language 'eu', version '3.11'.
 *
 * @package     dbtransfer
 * @category    string
...
$string['importversionmismatchexception'] = 'Oraingo {$a->currentver} bertsioa ez dator bat esportatutako {$a->schemaver} bertsioarekin.';
