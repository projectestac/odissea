...
$string['availability_hide'] = 'Ezkutatu ikastaro-orrian';
$string['availability_hide_help'] = 'Ez eskuragarri ikasleentzat.';
$string['availability_show'] = 'Erakutsi ikastaro-orrian';
$string['availability_show_help'] = 'Eskuragarri ikasleentzat (zehaztutako eskuragarritasun-murrizketek - baleude - baimentzen badute).';
$string['availability_stealth'] = 'Jarri eskuragarri baina ez erakutsi ikastaro-orrian (jarduera sekretua)';
$string['availability_stealth_help'] = 'Eskuragarri ikasleentzat beste nonbait bertara doan esteka bat jartzen baduzu. Jarduerak kalifikazio-liburuan eta bestelako txostenetan agertuko dira.';
$string['bulkcancel'] = 'Itxi ekintza masiboak';
$string['bulkedit'] = 'Ekintza masiboak';
...
$string['cm_duplicate_feedback_batch'] = 'Aukeratutako {$a->count} jarduera bikoiztuta.';
$string['cm_hide_feedback'] = '{$a->name} ezkutuan dago orain.';
$string['cm_hide_feedback_batch'] = 'Aukeratutako {$a->count} jarduera ezkutuan daude orain.';
$string['cm_moveleft_feedback'] = '{$a->name} ezkerrera mugituta.';
$string['cm_moveright_feedback'] = '{$a->name} eskuinera mugituta.';
$string['cm_nogroups_feedback'] = '{$a->name}(r)en talde-modua "Talderik ez" izatera aldatuta.';
$string['cm_separategroups_feedback'] = '{$a->name}(r)en talde-modua "Taldeek ezin elkar ikusi" izatera aldatuta.';
$string['cm_show_feedback'] = '{$a->name} ikusgai dago orain.';
...
$string['cmsdelete_title'] = 'Ezabatu aukeratutako jarduerak?';
$string['cmsduplicate'] = 'Bikoiztu jarduerak';
$string['cmsmove'] = 'Mugitu jarduerak';
$string['cmsmove_info'] = 'Mugitu {$a} jarduera honen ondoren:';
...
$string['sectionmove_info'] = 'Mugitu {$a} honen ondoren:';
$string['sectionmove_title'] = 'Mugitu atala';
$string['sectionsavailability'] = 'Atalen eskuragarritasuna';
$string['sectionsavailability_title'] = 'Atalen eskuragarritasuna';
$string['sectionsdelete'] = 'Ezabatu atalak';
$string['sectionsdelete_info'] = 'Ekintza honek {$a->count} atal eta euren barnean dauden jarduera guztiak ezabatuko ditu.';
$string['sectionsdelete_title'] = 'Ezabatu aukeratutako atalak?';
$string['sectionsmove'] = 'Mugitu atalak';
$string['sectionsmove_info'] = 'Mugitu {$a} atal honen ondoren:';
$string['sectionsmove_title'] = 'Mugitu aukeratutako atalak';
$string['selectcm'] = 'Aukeratu {$a} jarduera';
$string['selectsection'] = 'Aukeratu {$a} atala';
