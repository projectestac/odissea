...
/**
 * Strings for component 'editor', language 'eu', version '4.4'.
 *
 * @package     editor
 * @category    string
...
$string['acteditorshhdr'] = 'Eskura dauden testu-editoreak';
...
$string['choosechar'] = 'Aukeratu karakterea';
$string['chooseicon'] = 'Aukeratu ikono bat';
$string['close'] = 'Itxi';
$string['closeafterreplace'] = 'Itxi ordezkatu ondoren';
$string['cols'] = 'Zutabeak';
$string['configeditorplugins'] = 'Mesedez, aukeratu zein plugin-editore erabili nahi duzun eta gomendatutako ordenan jarri itzazu.';
...
Badaude 3 zeharbide saiatzeko, nahi izanez gero: Ctrl-v ordez, erabili Shift-Insert. Erabili zure nabigatzaileko Editatu->Itsatsi botoiak. Aldatu zure nabigatzailearen aukerak; horretarako, editatu user.js fitxategia. Egin klik ONARTU botoian laguntza gehiago behar izanez gero eta UTZI editorera itzultzeko.';
...
$string['insertsmile'] = 'Txertatu aurpegiera';
...
$string['selectcolor'] = 'Aukeratu kolorea';
...
$string['superscript'] = 'Goi-indizea';
