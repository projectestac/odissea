...
/**
 * Strings for component 'qtype_match', language 'eu', version '4.4'.
 *
 * @package     qtype_match
 * @category    string
...
$string['notenoughqsandas'] = 'Gutxienez {$a->q} galdera eta {$a->a} erantzun eman behar d(it)uzu.';
$string['notenoughquestions'] = 'Gutxienez {$a} galdera eta bi erantzun eman behar dituzu.';
