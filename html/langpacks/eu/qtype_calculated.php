...
/**
 * Strings for component 'qtype_calculated', language 'eu', version '4.4'.
 *
...
$string['atleastonerealdataset'] = 'Galderaren testuan gutxienez datu-multzo erreal bat egon behar da';
$string['atleastonewildcard'] = 'Gutxienez aldagai bat izan behar da erantzunaren formulan edo galderaren testuan';
...
$string['forceregeneration'] = 'behartu berriz sortzera';
$string['forceregenerationall'] = 'behartu aldagai guztiak berriz sortzera';
$string['forceregenerationshared'] = 'behartu berriz sortzera soilik aldagaia ez partekatuak';
$string['functiontakesatleasttwo'] = '{$a} funtzioak gutxienez bi argumentu izan behar ditu';
$string['functiontakesnoargs'] = '{$a} funtzioak ez dauka argumenturik';
...
$string['itemscount'] = 'Elementu<br />kopurua';
$string['itemtoadd'] = 'Gehitzeko elementua';
$string['keptcategory1'] = 'lehendik existitzen den datu-multzo partekatu bera erabiliko du';
$string['keptcategory2'] = 'aurreko kategori bereko datu-multzo partekatutako fitxategi-multzoko fitxategia';
$string['keptcategory3'] = 'aurreko kategori bereko datu-multzo partekatutako esteka-multzoko esteka';
$string['keptlocal1'] = 'lehendik existitzen den datu-multzo pribatu bera erabiliko du';
...
$string['loguniformbit'] = 'hamartarrekin, banaketa loguniformea jarraituta';
$string['makecopynextpage'] = 'Hurrengo orria (galdera berria)';
$string['mandatoryhdr'] = 'Erantzunetan derrigor agertu beharreko aldagaiak';
$string['max'] = 'Geh.';
$string['min'] = 'Gutx.';
...
$string['newcategory1'] = 'datu-multzo partekatu berri bat erabiliko du';
...
$string['possiblehdr'] = 'Galderaren testuan baino ez dauden aldagai posibleak';
$string['privacy:metadata'] = 'Galdera kalkulatua galdera-mota pluginak ez du datu pertsonalik biltzen.';
$string['questiondatasets'] = 'Galderaren datu-multzoak';
$string['questiondatasets_help'] = 'Galdera bakoitzean erabiliko diren aldagaien datu-multzoak';
