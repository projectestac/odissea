...
/**
 * Strings for component 'chat', language 'eu', version '4.5'.
 *
 * @package     chat
 * @category    string
...
$string['noguests'] = 'Txat-gela honetan ezin gonbidatuak sartu';
...
$string['removemessages'] = 'Mezu guztiak';
...
$string['servermax'] = 'Gehieneko erabiltzaileak';
