...
/**
 * Strings for component 'webservice', language 'eu', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['entertoken'] = 'Idatzi segurtasun-gakoa/tokena:';
...
$string['errorcoursecontextnotvalid'] = 'Ezin duzu funtziorik exekutatu ikastaro testuinguruan (ikastaroaren IDa:{$a->courseid}). Testuinguruaren errore-mezua hau izan da: {$a->message}';
...
$string['servicescustom'] = 'Pertsonalizatutako zerbitzuak';
