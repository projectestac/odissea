...
$string['displaytitle_mod_pdf'] = 'PDFa';
...
$string['enablelinebreakfilter_desc'] = 'Iragazi lauzen izenburuak {{#linebreak}} gakoaren bila; izenburua luzeegia bada eta gakoa agertzen bada "-" karakterearekin ordezkatuko da lerro-jauzia baimentzeko. Bestela gakoa kenduko da (ez da lerro-jauzirik egingo).';
...
$string['maxcoursesectionsallowed'] = 'Ingurune honetan onartutako gehienezko ikastaroko atal-kopurua {$a} da.';
...
$string['usesubtilesseczero_help'] = 'Aukeratuz gero, 0 ataleko elementuak ere azpi-lauzetan erakutsiko dira. Azpi-lauzek ikastaroaren goiko aldean leku gehiegi okupatu dezaketenez, gomendagarria da aukera hau markatu gabe uztea, eta horrela 0 ataleko elementuak ohiko zerrendan erakutsiko dira.';
