...
$string['configabsolutedeadline'] = 'Egungo data eta ordua dira, data eta ordu aukeratzailearen lehenetsitako konpentsazio-balioak.';
...
$string['mymoodle_no_reg_slot'] = '{$a->booked} ordu-tarte erreserbatu dituzu eta oraindik ez zara iritsi gutxieneko {$a->slotsmin} ordu-tarteetara.';
$string['mymoodle_no_reg_slot_group'] = 'Zure {$a->groupname} taldeak {$a->booked} ordu-tarte erreserbatu ditu eta oraindik ez da iritsi gutxieneko {$a->slotsmin} ordu-tarteetara.';
...
$string['mymoodle_registered_group_short'] = '{$a->registered}/{$a->total} izena emandako taldeak gutxieneko {$a->slotsmin} tarteetatik';
$string['mymoodle_registered_short'] = '{$a->registered}/{$a->total} izena emandako ikasleek gutxieneko {$a->slotsmin} tarteak erreserbatu dituzte.';
$string['mymoodle_upcoming_app'] = 'Zure hitzordua burutuko da, eguna  {$a->date} ordua {$a->time} lekua {$a->location}';
$string['mymoodle_upcoming_app_group'] = 'Zure taldearen hitzordua, {$a->groupname}, hurrengo data eta lekuan burutuko da: eguna  {$a->date} ordua {$a->time} lekua {$a->location}';
...
$string['warningtext1'] = 'Aukeratutako tarteek balio ezberdinak dituzte eremu honetarako!';
