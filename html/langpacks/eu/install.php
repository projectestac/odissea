...
/**
 * Strings for component 'install', language 'eu', version '4.5'.
 *
 * @package     install
 * @category    string
...
$string['admindirsetting'] = 'Web ostalari gutxi batzuk /admin URL berezi gisa erabiltzen dute kontrol-panel edo antzekora sarbidea emateko. Zoritxarrez, honek Moodleko kudeaketa-orrien lehenetsitako kokapenarekin gatazka sortzen du. Hau konpondu dezakezu zure instalazioko admin direktorioa berrizendatuz, eta izen berria hemen sartuta. Adibidez <em>moodleadmin</em>. Honek Moodleko admin estekak konponduko du.';
$string['admindirsettinghead'] = 'Ezarri Admin direktorioa...';
$string['admindirsettingsub'] = 'Web ostalari gutxi batzuk /admin URL berezi gisa erabiltzen dute kontrol-panel edo antzekora sarbidea emateko. Zoritxarrez, honek Moodleko kudeaketa-orrien lehenetsitako kokapenarekin gatazka sortzen du. Hau konpondu dezakezu zure instalazioko admin direktorioa berrizendatuz, eta izen berria hemen sartuta. Adibidez <em>moodleadmin</em>. Honek Moodleko admin estekak konponduko du.';
...
$string['clisupportemail'] = 'Laguntzarako helbide elektronikoa';
...
$string['dbtype'] = 'Mota';
$string['directorysettings'] = '<p>Mesedez berretsi itzazu Moodle instalazio honen kokapenak.</p>
...
$string['invaliddbprefix'] = 'Aurrizki baliogabea. Aurrizkian soilik letra xeheak eta beheko gidoia (_) erabili daitezke.';
