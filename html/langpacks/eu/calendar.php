...
$string['calendarexporturl'] = 'Egutegiaren URLa';
...
$string['colpoll'] = 'Freskatze-bitartea';
...
$string['confirmsubscriptiondelete'] = 'Ziur zaude "{$a}" egutegi-harpidetza ezabatu nahi duzula?';
$string['copycalendarurl'] = 'Kopiatu egutegiaren URLa';
...
$string['eventsskipped'] = '{$a} ekitaldi alde batera utzi dira';
...
$string['eventsupdated'] = '{$a} ekitaldi eguneratu dira';
...
$string['exporthelp'] = '<p>Egutegiaren URLak egutegiko ekitaldiak beste egutegietara inportatzeko esteka dinamikoa eskaintzen du. Jatorrizko egutegiko edozein ekitaldi berri, aldaketa edo ezabatzea beste egutegietan <strong>aplikatuko</strong> da.</p>
<p>Egutegia-esportatzeak ekitaldien segurtasun-kopia bat sortzea ahalbidetzen dizu, gerora beste egutegietan inportatu ahal dena. Jatorrizko egutegiaren aldaketak <strong>ez dira aplikatuko</strong> beste egutegietan.</p>';
$string['forcecalendartype'] = 'Behartu egutegia';
$string['fri'] = 'Or';
$string['friday'] = 'Ostirala';
$string['fullcalendar'] = 'Egutegi osoa';
...
$string['managesubscriptions'] = 'Inportatu edo esportatu egutegiak';
...
$string['privacy:metadata:calendar:event'] = 'Egutegia osagaiak muineko azpisistemako erabiltzaileen egutegi-ekitaldien xehetasunak gordetzen ditu.';
...
$string['privacy:metadata:calendar:event_subscriptions'] = 'Egutegia osagaiak muineko azpisistemako erabiltzaileen egutegi-harpidetzen xehetasunak gordetzen ditu.';
...
$string['requiresaction'] = '{$a} jarduerak ekintzaren bat behar du';
$string['sat'] = 'Lr';
...
$string['subscriptionupdated'] = '\'{$a}\' egutegi-harpidetza eguneratu da';
$string['sun'] = 'Ig';
...
$string['yoursubscriptions'] = 'Inportatutako egutegiak';
