...
/**
 * Strings for component 'tool_monitor', language 'eu', version '4.5'.
 *
...
$string['deletesubscription'] = 'Ezabatu harpidetza';
...
$string['eventrulecreated'] = 'Araua sortu da';
...
$string['freqdesc'] = '{$a->freq} aldiz {$a->mins} minututan';
$string['frequency'] = 'Jakinarazpenen atalasea';
$string['frequency_help'] = 'Zehaztutako denbora-tartean gertatu beharreko ekitaldi-kopurua mezua bidaltzeko.';
...
$string['privacy:metadata:historysummary'] = 'Bidalitako jakinarazpen-mezuen historia gordetzen du';
$string['privacy:metadata:inactivedate'] = 'Aktibo ez dagoen harpidetza bat guztiz ezabatzeko igaro behar den denbora-tartea, egunetan.';
$string['privacy:metadata:lastnotificationsent'] = 'Harpidetza honentzat bidalitako azken jakinarazpenaren unea.';
...
$string['privacy:metadata:plugin'] = 'Pluginaren izena Frankenstyle estiloan';
...
$string['selectcourse'] = 'Sartu txosten honetan ikastaro-mailan balizko moduluen zerrenda lortzeko';
$string['subareyousure'] = 'Ziur zaude "{$a}" araurako harpidetza ezabatu nahi duzula?';
