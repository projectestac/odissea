...
/**
 * Strings for component 'logstore_database', language 'eu', version '3.11'.
 *
...
$string['databasetable_help'] = 'Agerraldiak gordeko diren taularen izena. Taula honek logstore_standard-ek erabiltzen duen taularen (mdl_logstore_standard_log) egitura identikoa izan behar du.';
...
$string['logguests'] = 'Erregistratu gonbidatuen ekintzak';
$string['other'] = 'Bestelako bat';
$string['participating'] = 'Partaidetza';
$string['pluginname'] = 'Kanpoko datu-baseko agerraldi-biltegia';
...
$string['testingsettings'] = 'Datu-basearen ezarpenak probatzen...';
$string['testsettings'] = 'Probatu konexioa';
