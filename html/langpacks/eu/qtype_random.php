...
/**
 * Strings for component 'qtype_random', language 'eu', version '4.5'.
 *
...
$string['randomqplusnamecoursecattags'] = 'Ausazkoa ({$a->category} ikastaro-kategoriaren barruko edozein kategoria, etiketak: {$a->tags}))';
