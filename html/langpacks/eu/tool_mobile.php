...
/**
 * Strings for component 'tool_mobile', language 'eu', version '4.5'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['forcedurlscheme'] = 'Zure pertsonalizatutako aplikazioa nabigatzaile leiho batean baino ez irekitzea baimendu nahi baduzu, zehaztu hemen bere URL eskema. App ofiziala baino ez baimendu nahi baduzu, balio lehenetsia ezarri ezazu.  Hutsik utzi ezazu edozein app baimendu nahi baduzu.';
