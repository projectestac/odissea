...
$string['confirmaddadmin'] = 'Ziur zaude <strong>{$a}</strong> erabiltzailea guneko kudeatzaile gisa gehitu nahi duzula?';
$string['confirmaddadmins'] = 'Ziur zaude hurrengo erabiltzaileak guneko kudeatzaileen zerrendara gehitu nahi dituzula?';
$string['confirmdeladmin'] = 'Ziur zaude <strong>{$a}</strong> erabiltzailea guneko kudeatzaileen zerrendatik kendu nahi duzula?';
