...
/**
 * Strings for component 'enrol_paypal', language 'eu', version '3.11'.
 *
...
$string['businessemail_desc'] = 'Zure PayPal business kontuko helbide elektronikoa';
$string['cost'] = 'Matrikulazioaren kostua';
$string['costerror'] = 'Matrikulazioaren kostua ez da zenbaki bat';
...
$string['enrolenddate_help'] = 'Gaituz gero, erabiltzaileak soilik data honetara arte matrikulatu daitezke.';
$string['enrolenddaterror'] = 'Matrikulazioaren amaiera-data ezin da izan hasiera-data baino lehenagokoa';
...
$string['mailadmins'] = 'Jakinarazi sistemako kudeatzaileei';
$string['mailstudents'] = 'Jakinarazi ikasleei';
$string['mailteachers'] = 'Jakinarazi irakasleei';
$string['messageprovider:paypal_enrolment'] = 'PayPal matrikulazioaren mezuak';
...
$string['paypalaccepted'] = 'Paypal ordainketak onartzen dira';
$string['pluginname'] = 'PayPal';
$string['pluginname_desc'] = 'PayPal moduluak ordaindutako ikastaroak konfiguratzeko aukera ematen du. Ikastaroren bateko kostua zero bada ikasleei ikastaroan sartzeko ez zaie ordaintzea eskatuko. Hemen gune mailako kostu bat zehaztu dezakezu balio lehenetsi gisa, eta gero ikastaro bakoitzean balio hori aldatu ahalko da. Ikastaro bakoitzeko kostuek guneko kostua baliogabetzen dute.';
$string['privacy:metadata:enrol_paypal:enrol_paypal'] = 'PayPal matrikulazioetarako PayPal transakzioen inguruko informazioa.';
$string['privacy:metadata:enrol_paypal:enrol_paypal:business'] = 'Ordainketaren jasotzailearen helbide elektronikoa edo PayPal kontuaren IDa (hau da, saltzailea).';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:receiver_email'] = 'Ordainketaren jasotzailearen helbide elektronikoa (hau da, saltzailea).';
$string['privacy:metadata:enrol_paypal:enrol_paypal:receiver_id'] = 'Ordainketaren jasotzailearen PayPal kontuaren IDa (hau da, saltzailea).';
$string['privacy:metadata:enrol_paypal:enrol_paypal:tax'] = 'Ordainketa egitean kobratutako zerga kopurua.';
$string['privacy:metadata:enrol_paypal:enrol_paypal:timeupdated'] = 'Moodleri PayPal-eko ordainketa buruz jakinarazi zaion unea.';
$string['privacy:metadata:enrol_paypal:enrol_paypal:txn_id'] = 'Saltzailearen jatorrizko transakzioaren eroslearen ordainketarako zenbaki identifikatzailea, kasua erregistratzeko erabilitakoa.';
$string['privacy:metadata:enrol_paypal:enrol_paypal:userid'] = 'Ikastaro-matrikulazioa erosi zuen erabiltzailearen IDa.';
$string['privacy:metadata:enrol_paypal:paypal_com'] = 'PayPal matrikulazio-pluginak erabiltzaile-datuak Moodletik PayPal-eko webgunera bidaltzen ditu.';
...
$string['processexpirationstask'] = 'PayPal matrikulazioen iraungitze-jakinarazpenen bidalketa ataza';
