...
$string['addpagebreakafter'] = 'Gehitu orri-jauzia {$a} galderaren ondoren';
...
$string['movequestionnumber'] = 'Mugitu galdera: {$a}';
...
$string['overridesforquiz'] = 'Ezarpen-salbuespenak: {$a}';
...
$string['randomqnamecattags'] = 'Ausazko galdera ({$a->category}) iragazkiaren baldintzetan oinarrituta hurrengo etiketekin:  {$a->tags}';
...
$string['removepagebreakafter'] = 'Kendu {$a} galderaren ondorengoko orri-jauzia';
