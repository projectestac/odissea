...
/**
 * Strings for component 'antivirus', language 'eu', version '4.5'.
 *
 * @package     antivirus
 * @category    string
...
$string['actantivirushdr'] = 'Eskura dauden antibirus-pluginak';
$string['antiviruscommonsettings'] = 'Antibirusen ezarpen orokorrak';
...
$string['emailadditionalinfo'] = 'Birus-motorrak xehetasun gehigarriak itzuli ditu:';
$string['emailauthor'] = 'Nork igota:';
$string['emailcontenthash'] = 'Edukiaren hash-a:';
$string['emailcontenttype'] = 'Eduki-mota:';
$string['emaildate'] = 'Igoera-data:';
$string['emailfilename'] = 'Fitxategiaren izena:';
$string['emailfilesize'] = 'Fitxategiaren tamaina:';
$string['emailgeoinfo'] = 'Geokokapena:';
$string['emailinfectedfiledetected'] = 'Kutsatutako fitxategia antzeman da';
$string['emailipaddress'] = 'IP helbidea:';
$string['emailreferer'] = 'Erreferentzia:';
$string['emailreport'] = 'Txostena:';
$string['emailscanner'] = 'Eskanerra:';
$string['emailscannererrordetected'] = 'Eskaneatze-errorea gertatu da';
