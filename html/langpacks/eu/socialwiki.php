...
/**
 * Strings for component 'socialwiki', language 'eu', version '4.4'.
 *
 * @package     socialwiki
 * @category    string
...
$string['defaultformat'] = 'Formatu lehenetsia';
$string['defaultformat_help'] = 'CEzarpen honek wiki orriak editatzerakoan erabiltzen den formatu lehenetsia zehazten du.
...
<ul> <li> HTML formatua: formatu lehenetsia eta erabiltzaile gehienentzako aukerarik onena da, HTML edukia zuzenean aldatzeko gaitasuna barne hartzen du. </li>
    <li> Creole formatua: wiki markup hizkuntza arina erabiltzaile aurreratuentzat. </li>
    <li> Nwiki formatua: Creole formatuaren antzeko interfazea markup multzo ezberdinekin. </li> </ul>
