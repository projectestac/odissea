...
/**
 * Strings for component 'block', language 'eu', version '4.4'.
 *
 * @package     block
 * @category    string
...
$string['addblock'] = 'Gehitu {$a} blokea';
...
$string['blocksdrawertoggle'] = 'Erakutsi/ezkutatu blokeen nabigazio-kutxa';
$string['blocksettings'] = 'Blokearen ezarpenak';
$string['bracketfirst'] = '{$a} (lehenengoa)';
$string['bracketlast'] = '{$a} (azkena)';
$string['configureblock'] = 'Editatu {$a} blokea';
