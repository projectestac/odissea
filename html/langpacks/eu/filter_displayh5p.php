...
/**
 * Strings for component 'filter_displayh5p', language 'eu', branch 'MOODLE_38_STABLE'
 *
...
- Wordpress: http://nirezerbitzaria.eus/wp-admin/admin-ajax.php?action=h5p_embed&id=[id]';
$string['filtername'] = 'Erakutsi H5P edukia';
$string['privacy:metadata'] = 'Erakutsi H5P edukia iragazkiak ez du inolako datu pertsonalik biltzen.';
