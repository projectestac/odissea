...
$string['audiobuttontitle'] = 'Grabatu audioa';
$string['audiotimelimit'] = 'Audioaren iraupen-muga';
$string['audiotimelimit_desc'] = 'Audio-klipen grabazioetako gehieneko iraupena.';
$string['audiotitle'] = 'Grabatu audioa';
...
$string['recordagain_title'] = 'Grabatu berriz baieztapena';
...
$string['uploadfailed'] = 'Igoerak errore batekin huts egin du: {$a->error}';
$string['uploadfailed404'] = 'Igoerak huts egin du: fitxategia handiegia da';
$string['uploading'] = 'Igotzen - %{$a->progress}';
