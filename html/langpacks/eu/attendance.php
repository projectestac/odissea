...
$string['attendance:import'] = 'Inportatu saioak fitxategitik (CSV)';
...
$string['attendance:manualautomark'] = 'Baimendu markatze automatikoaren eskuzko prozesua';
...
$string['attendancereport'] = 'Bertaratzea';
...
$string['attendanceuserreport'] = 'Bertaratzearen erregistroen txostena';
...
$string['automarkingcomplete'] = 'Markatze automatikoa osatuta';
$string['automarkingnotavailableyet'] = 'Saio hau saioaren amaierako markatze automatikoa erabiltzen ari da eta saioa ez da oraindik amaitu.';
$string['automarkingnotenabled'] = 'Markatze automatikoa ez dago gaituta saio honetan';
...
$string['availability'] = 'Norbere erregistroaren eskuragarritasuna';
$string['availability_help'] = 'Mugatu egoera honen eskuragarritasuna. <br> "Denbora mugatu batean" aukeratuz gero zehaztu ezazu egoera hau saioa hasi ondoren zenbat minutuz egongo den eskuragarri. Muga hau ikasleek euren bertaratzearen erregistroa egiten dutenean baino ez da erabiltzen.';
$string['availabilityalways'] = 'Beti';
$string['availabilitylimitedtime'] = 'Denbora-tarte mugatu batean';
$string['availabilityno'] = 'Ez';
$string['availablebeforesession'] = 'Eskuragarri saioa hasten denean';
$string['availablebeforesession_help'] = 'Ikasleek euren bertaratzea erregistratzen ari direnean, baimendu egoera hau saioaren hasiera heldu baino lehen.';
...
$string['cannottakethisgroup'] = 'Ez zara bertaratzearen erregistroaren saio honi dagokion taldeko kidea, eta ondorioz zure bertaratzea ez da gorde.';
$string['cantaddstatus'] = 'Egoera berria gehitzean akronimoa eta deskribapena zehaztu behar dira.';
$string['canthidestatus'] = 'Ezin duzu egoera hau ezkutatu dagoeneko erabiltzen ari delako bertaratzearen erregistroko jarduera honetan';
...
$string['closed'] = 'Saio hau ez dago norbere bertaratzearen erregistratzeko eskuragarri une honetan';
...
$string['customfields'] = 'Saioko eremu pertsonalizatuak';
$string['date'] = 'Data';
$string['days'] = 'Egunak';
...
$string['error:usernotfound'] = '{$a->userfield} eremuan {$a->extuser} balioa duen erabiltzailea ezin izan da ikastaro honetan aurkitu';
...
$string['eventsessionipshared'] = 'IP talka norbere bertaratzearen erregsitratzean';
...
$string['extrarestrictions'] = 'Murrizketa gehigarriak';
...
$string['invalidstatus'] = 'Egoera baliogabea aukeratu duzu, mesedez saiatu zaitez berriro.';
$string['iptimemissing'] = 'Desblokeatzeko minutu baliogabeak';
$string['jumpto'] = 'Joan hona';
$string['keepsearching'] = 'Jarraitu bilatzen';
$string['lasttaken'] = 'Azkenengoz jasotako bertaratzeak';
$string['manualtriggerauto'] = 'Eskuz abiarazi markatze automatikoa';
...
$string['messagedselecteduserfailed'] = 'Mezu bat pertsonaren bati bidaltzeak huts egin du. Gehiago jakiteko arazketa gaitu ezazu.';
...
$string['passwordheader'] = 'Erabili azpiko zerrendako pasahitza zure bertaratzea erregistratzeko';
...
$string['preventsharederror'] = 'Norbere bertaratzearen erregistroa desgaituta dago gailu hau dagoeneko saio honetako beste ikasle baten erregistroa egiteko erabili dela antzeman delako.';
...
$string['qrcodevalidafter'] = 'segundo';
$string['qrcodevalidbefore'] = 'QR kodea baliozkoa da hurrengo tarterako:';
...
$string['reportsessiondate'] = 'Saioaren data';
$string['reportsessionduration'] = 'Saioaren iraupena';
$string['reportsessionlasttaken'] = 'Saioa jasotako azken unea (irakaslea)';
...
$string['saveandshownext'] = 'Gorde eta erakutsi hurrengo orria';
...
$string['sessiondescription'] = 'Saioaren deskribapena';
...
$string['set_by_student'] = 'Norberak erregistratuta';
...
$string['statustotalcount'] = '{$a} Egoera - Kopurua guztira';
$string['statustotalcountcurrentweek'] = '{$a} Egoera - Aste honetako kopurua guztira';
$string['statustotalcountpreviousweek'] = '{$a} Egoera - Aurreko asteko kopurua guztira';
...
$string['studentsearlyopentime'] = 'Ireki saioa lehenago erregistratzeko';
$string['studentsearlyopentime_help'] = 'Aukera honek irakasleari saioa lehenago zabaltzeko aukera ematen dio, eta modu honetan bertaratzearen erregistroa saioaren benetako hasiera baino lehen egitea ahalbidetzen da.';
$string['submit'] = 'Bidali';
$string['submitattendance'] = 'Erregistratu bertaratzea';
$string['submitattendancefuture'] = 'Jakinarazi etorkizuneko hutsegite bat';
...
$string['timemodified'] = 'Aldaketa unea';
$string['timetaken'] = 'Bertaratzea jasotzeko unea';
$string['to'] = 'amaiera:';
$string['todate'] = 'orain arte';
$string['totalnumsessions'] = 'Saio kopurua guztira';
...
$string['updateattendance'] = 'Eguneratu bertaratzea';
...
$string['userexistingstatus'] = 'Zure bertaratzea <strong>{$a}</strong> gisa markatua izan da dagoeneko, aldatu behar izanez gero azpiko formularioa erabili ezazu.';
...
$string['usersessiongrade'] = 'Erabiltzailearen saioaren kalifikazioa';
$string['usersessionremarks'] = 'Erabiltzailearen saioaren iruzkinak';
$string['usersessiontaken'] = 'Erabiltzailearen saioaren jasotzea';
$string['userstatus'] = 'Erabiltzailearen saioaren egoera';
