...
$string['maxindexfilekb'] = 'Indexatzeko fitxategien gehienezko tamaina (kB)';
...
$string['minimumsolr4'] = 'Solr 4.0 da Moodlek behar duen gutxienezko bertsioa';
...
$string['solrhttpconnectiontimeout_desc'] = 'HTTP konexioaren denbora-muga datuen HTTP transferentzia-eragiketa egiteko baimentzen den gehienezko denbora (segundoetan) zehazten du.';
