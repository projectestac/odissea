...
/**
 * Strings for component 'auth_ldap', language 'eu', version '4.5'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_expireattr_desc'] = 'Hautazkoa: Pasahitzaren iraungitzea metatzen duen LDAP atributua baliogabetzen du.';
$string['auth_ldap_expireattr_key'] = 'Iraungitze-atributua';
$string['auth_ldap_graceattr_desc'] = 'Hautazkoa: Graziazko sarreren atributua baliogabetzen du';
...
$string['auth_ldap_memberattribute'] = 'Hautazkoa: Erabiltzailearen izenerako atributua baliogabetzen du, erabiltzaileak talde bateko kide direnean. Normalean \'partaide\'';
...
$string['auth_ldap_objectclass'] = 'Hautazkoa: ldap_user_type-n erabiltzaileak izendatzeko/bilatzeko erabilitako objectClass baliogabetzen du. Normalean ez duzu hau aldatu beharko.';
...
$string['auth_ldap_suspended_attribute'] = 'Hautazkoa: Atributu hau zehazten bada lokalki sortutako erabiltzaile-kontuak gaitzeko edo eteteko erabiliko da.';
$string['auth_ldap_suspended_attribute_key'] = 'Etendako atributua';
...
$string['auth_ldap_user_attribute'] = 'Hautazkoa: Erabiltzaileak izendatzeko edo bilatzeko atributua baliogabetzen du. \'cn\' izan ohi da.';
...
$string['auth_ntlmsso_ie_fastpath'] = 'Markatu NTLM SSO sarbide azkarra gaitzeko (hainbat pausu saihesten ditu erabiltzailearen nabigatzailea MS Internet Explorer bada).';
...
$string['auth_ntlmsso_remoteuserformat'] = '\'Autentifikazio-mota\' eremuan \'NTLM\' aukera baduzu, urruneko erabiltzaile-formatua zehaztu dezakezu hemen. Hutsik utziz gero, lehenetsitako DOMEINUA\\erabiltzailea formatua erabiliko da. Hautazko <b>%domain%</b> hitz-gakoa erabili dezakezu domeinua no agertzen den zehazteko, eta derrigorrezko <b>%username%</b> hitz-gakoa erabiltzailea non agertzen den zehazteko.<br /><br /> Asko zabaldutako formatu batzuk  <tt>%domain%\\%username%</tt> (MS Windows-en lehenetsitakoa), <tt>%domain%/%username%</tt>, <tt>%domain%+%username%</tt> eta soilik <tt>%username%</tt> dira (domeinuko atalik ez badago).';
...
$string['sync_updateuserchunk'] = 'Zehaztu hemen transakzio bakoitzean igo beharreko erabiltzaile kopurua. 0 jarriz gero erabiltzaile guztiak transakzio bakarrean igoko dira.';
$string['sync_updateuserchunk_key'] = 'Erabiltzaileen sinkronizazio eguneratzearen zatien tamaina';
