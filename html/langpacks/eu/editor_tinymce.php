...
/**
 * Strings for component 'editor_tinymce', language 'eu', version '4.1'.
 *
...
$string['advanced:rich_text_area'] = 'Testu aberastuko eremua';
...
$string['advlink_dlg:tabindex'] = 'Tabulazio-indizea (TabIndex)';
...
$string['aria:rich_text_area'] = 'Testu aberastuko eremua';
...
$string['emotions:emotions_desc'] = 'Emotikonoak';
$string['emotions_dlg:cool'] = 'Primeran';
$string['emotions_dlg:cry'] = 'Negarrez';
$string['emotions_dlg:desc'] = 'Emotikonoak';
...
$string['emotions_dlg:title'] = 'Txertatu emotikonoa';
...
$string['fullpage_dlg:font_face'] = 'Letra-mota';
$string['fullpage_dlg:font_size'] = 'Letra-tamaina';
$string['fullpage_dlg:fontface'] = 'Letra-mota';
...
$string['pluginname'] = 'TinyMCE HTML editorea (zaharkitua)';
...
$string['style_dlg:text_font'] = 'Letra-mota';
...
$string['table_dlg:row_limit'] = 'Gehieneko lerro kopurua ({$rows}) gainditu duzu.';
...
$string['xhtmlxtras_dlg:attribute_label_tabindex'] = 'Tabulazio-indizea (TabIndex)';
