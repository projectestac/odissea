...
/**
 * Strings for component 'auth_manual', language 'eu', version '3.11'.
 *
 * @package     auth_manual
 * @category    string
...
$string['privacy:metadata:preference:passwordupdatetime'] = 'Pasahitza aldatu zen azken aldiaren data.';
