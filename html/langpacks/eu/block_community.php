...
/**
 * Strings for component 'block_community', language 'eu', version '3.11'.
 *
...
$string['add'] = 'Gehitu';
$string['addcommunitycourse'] = 'Gehitu komunitate-ikastaroa';
...
$string['coursedesc'] = 'Deskribapena';
$string['courselang'] = 'Hizkuntza';
$string['coursename'] = 'Izena';
$string['courses'] = 'Ikastaroak';
$string['coverage'] = 'Etiketak: {$a}';
$string['donotrestore'] = 'Ez';
$string['dorestore'] = 'Bai';
$string['download'] = 'Jaitsi';
$string['downloadable'] = 'jaitsi ahal ditudan ikastaroak';
$string['downloadablecourses'] = 'Jaisteko ikastaroak';
$string['downloadconfirmed'] = 'Segurtasun-kopia zure fitxategi pribatuetan {$a} gorde da';
...
$string['hubtrusted'] = 'Bilgune honek Moodle.org-en konfiantza du';
...
$string['restorecourseinfo'] = 'Ikastaroa berreskuratu?';
