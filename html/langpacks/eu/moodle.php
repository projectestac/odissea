...
$string['addfilesdrop'] = 'Fitxategiak hartu eta hona eraman ditzakezu edo egin klik aukeratzeko.';
$string['addinganew'] = '{$a} berria';
...
$string['allowstealthmodules_help'] = 'Gaituz gero, jarduerak eskuragarri jarri daitezke baina ikastaroko orriko ataletan erakutsi gabe. Hori eginez gero, irakasleak jarduera sekretuetarako estekak beste nonbait jarri beharko ditu, esaterako orri batean. Jarduera sekretuak kalifikazio-txostenean eta bestelako txostenetan agertuko dira.';
...
$string['alreadyconfirmed'] = 'Erregistroa dagoeneko baieztatua izan da';
...
$string['backupfailed'] = 'Ikastaro batzuk ez dira gorde.';
...
$string['backupinfo'] = 'Egin ikastaro honen segurtasun-kopia bat, une honetako bere eduki eta jarduerekin. Segurtasun-kopia fitxategia ikastaroa berreskuratzeko erabili dezakezu.';
...
$string['bulkcancel'] = 'Itxi editatze masiboa';
...
$string['checkerror'] = 'Errorea \'{$a}\' egiaztapenaren emaitza eskuratzerakoan. Egiaztatu ezazu nabigatzailearen kontsola informazio gehiagorako.';
...
$string['checkloading'] = '\'{$a}\' egiaztapenaren emaitza eskuratzen';
...
$string['comebacklater'] = 'Etorri zaitez beranduago, mesedez.';
...
$string['confirmaccount'] = 'Berretsi kontua';
...
$string['contextname'] = 'Testuinguruaren izena';
$string['contextparent'] = 'Goragokoa';
$string['contexturl'] = 'Testuinguruaren URLa';
...
$string['courseapprovedemail'] = 'Zuk eskatutako ikastaroa onartu da, <a href="{$a->url}">{$a->name}</a>, eta bertan zuk {$a->teacher} rola daukazu.';
$string['courseapprovedemail2'] = 'Zuk eskatutako ikastaroa onartu da: <a href="{$a->url}">{$a->name}</a>.';
$string['courseapprovedfailed'] = 'Zure ikastaroa ez da onartutzat gorde!';
$string['courseapprovedsubject'] = 'Zure ikastaroa onartua izan da.';
...
$string['coursedisplay_help'] = 'Ikastaro-atalak orri bakarrean ala banatutako orrietan erakutsi daitezke.';
$string['coursedisplay_multi'] = 'Erakutsi atal bakarra orri bakoitzean';
...
$string['coursehelpnumberweeks'] = 'Ikastaroaren atal kopurua (soilik ikastaro formatu zehatz batzuetan du eragina).';
...
$string['coursehidden'] = 'Ikastaro hau une honetan ez dago eskuragarri ikasleentzat';
...
$string['courseoverviewfiles_help'] = 'Ikastaroko irudia Nire Ikastaroak eta Hasiera orriko eskuragarri dauden ikastaroen zerrendan erakusten da.
Guneko kudeatzaileek onartutako fitxategi-mota gehigarriak eta fitxategi anizkoitzen erabilera gaitu ditzakete. Fitxategi anitz erabiltzen badituzu, fitxategi guztiak erakutsiko dira Hasiera orriko eskuragarri dauden ikastaroen zerrendan.';
...
$string['coursereusenavigationmenu'] = 'Ikastaro-berrerabilpena nabigazio-menua';
...
$string['coursesectiontitlebulkediting'] = 'Editatze masiboa {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'Ikastaroaren editatze masiboa: {$a->course}';
...
* Ezkutatu: Sarbidea mugatuta dago, soilik irakasleek eta ezkutuan dauden ikastaroak ikusteko baimena duten erabiltzaileek dute sarbidea.';
$string['create'] = 'Sortu';
...
$string['documentation'] = 'Moodleko dokumentazioa';
...
$string['editgroupprofile'] = 'Editatu taldearen deskribapena';
...
$string['editsection'] = 'Editatu ezarpenak';
$string['editsectionname'] = 'Editatu atalaren izena';
$string['editsectionsettings'] = 'Editatu atalaren ezarpenak';
$string['editsectiontitle'] = 'Editatu atala: {$a}';
...
$string['emailonlyallowed'] = 'Helbide elektroniko hau ezin da erabili. Baimendutako helbide elektronikoen domeinuak hauek dira: {$a}.';
...
$string['emptysectionids'] = 'Hutsik dauden atalen IDak';
$string['enable'] = 'Gaitu';
$string['encryptedcode'] = 'Zifraturiko kodea';
$string['enddate'] = 'Ikastaroaren amaiera-data';
$string['enddate_help'] = 'Ikastaroaren amaiera-datak ez du ikasleen sarbidea mugatzen. Data hau ikastaro hau Nire ikastaroak orrian Martxan ala Iraganean atalean agertuko den zehazten du.';
$string['enddatewithtaskenabled'] = 'Ikastaroaren amaiera-data';
$string['enddatewithtaskenabled_help'] = 'Ikastaroa ikasleentzat ezkutatuko den data eta beraz horrez geroztik ez dute eskuragarri izango.';
...
$string['eventcourseended'] = 'Ikastaroa amaitu da';
...
$string['eventcoursesectionupdated'] = 'Ikastaro-atalak eguneratu dira';
$string['eventcoursessearched'] = 'Ikastaroak bilatu dira';
$string['eventcoursestarted'] = 'Ikastaroa hasi da';
...
$string['eventsectionviewed'] = 'Atala ikusita';
$string['eventunknownlogged'] = 'Ekitaldi ezezaguna';
$string['eventurlblocked'] = 'URLa blokeatua izan da';
...
$string['failedtaskbody'] = '<p>Kaixo, {$a->firstname}:</p>
<p><b>{$a->taskname}</b> atazak hainbat aldiz huts egin du eta zure arreta behar du.</p>
<p><a href="{$a->link}">Ikusi ataza</a></p>';
$string['failedtaskcontexturlname'] = 'Egoeraren txostena';
$string['failedtasksubject'] = 'Huts egindako ataza: {$a}';
...
* Atal pertsonalizatuak formatua - Ikastaroaren hasiera-orria gaika edo atalka dago antolatuta
* Astekako atalak formatua - Ikastaroa asteka antolatuta dago, hasiera- eta amaiera-data zehatzak dituela';
...
$string['from'] = 'Nondik';
$string['fromdate'] = 'Noiztik';
$string['fromsender'] = 'Igorlea';
...
$string['fullnamecourse_help'] = 'Nire Ikastaroak eta Hasiera orriko eskuragarri dauden ikastaroen zerrendan erakusten den izena.';
...
$string['hiddensections_help'] = 'Ezkutuko atalak ikasleei ikastaro-orrian \'ez eskuragarri\' gisa erakutsi ala guztiz ezkutatu daitezke.';
...
$string['highlightoff'] = 'Kendu nabarmentzea';
...
$string['idnumbercourse_help'] = 'Ikastaroa kanpo-sistemekin konektatzeko soilik erabilia. Hutsik utzi ezazu ikastaroaren ID ofizial bat ez baduzu.';
...
$string['importinfo'] = 'Inportatu edukiak beste ikastaro batzuetatik, hala nola jarduerak, blokeak edo egutegiko ekitaldiak. Ez da erabiltzaile-daturik inportatuko.';
...
$string['includesubcategories'] = 'Sartu azpikategoriak';
...
$string['invalidtaskclassname'] = 'Ataza-klase baliogabea {$a}';
$string['invalidtaskid'] = 'Ataza-ID baliogabea';
...
$string['languagegood'] = 'Hizkuntza pakete hau eguneratuta dago.';
...
$string['logout'] = 'Irten';
$string['logoutconfirm'] = 'Ziur zaude irten egin nahi duzula?';
...
$string['makeavailablecmtitle'] = 'Jarri jarduera eskuragarri';
...
$string['markedthistopic'] = 'Atal hau oraingo gisa dago nabarmendua';
$string['markthistopic'] = 'Nabarmendu atal hau oraingo gisa';
...
$string['messageprovider:enrolcoursewelcomemessage'] = 'Ikastaroko matrikulazio berrietarako ongi-etorri mezua';
...
$string['messageprovider:failedtaskmaxdelay'] = 'Ataza batek bere gehieneko huts egitearen ondoriozko atzerapenera iristea';
...
$string['modshowcmtitle'] = 'Erakutsi jarduera';
...
$string['moodledocslink'] = 'Orri honentzako dokumentazioa';
$string['moodlelogo'] = 'Moodleko logoa';
$string['moodlenet:cannotconnecttoserver'] = 'Ezin da MoodleNet zerbitzarira konektatu';
$string['moodlenet:columnname'] = 'Izena';
$string['moodlenet:columnsenddate'] = 'Bidaltze-data';
$string['moodlenet:columnsendstatus'] = 'Bidalketaren egoera';
$string['moodlenet:columntype'] = 'Mota';
$string['moodlenet:configoauthservice'] = 'Aukeratu MoodleNet OAuth 2 zerbitzua MoodleNet gune horretarako eduki-partekatzea gaitzeko. Zerbitzua oraindik existitzen ez bada aurretik <a href="{$a}">sortu</a> beharko duzu.';
$string['moodlenet:deletedactivity'] = 'Ezabatutako jarduera';
$string['moodlenet:deletedcourse'] = 'Ezabatutako ikastaroa';
$string['moodlenet:eventresourceexported'] = 'Baliabidea esportatuta';
$string['moodlenet:gotomoodlenet'] = 'Joan MoodleNet zirriborroetara';
$string['moodlenet:issuerisnotauthorized'] = 'MoodleNet emailea ez dago baimenduta';
$string['moodlenet:issuerisnotenabled'] = 'MoodleNet emailea ez dago gaituta';
$string['moodlenet:issuerisnotset'] = 'MoodleNet emailea ez dago gunearen kudeaketan zehaztuta';
$string['moodlenet:nosharedresources'] = 'Une honetan ez dago partekatutako baliabiderik erakusteko.';
$string['moodlenet:outboundsettings'] = 'MoodleNet-eko irteerako ezarpenak';
$string['moodlenet:packagingandsending'] = 'Zure fitxategia paketatzen eta MoodleNet-era bidaltzen...';
$string['moodlenet:sharefailtext'] = 'Errore bat gertatu da zure edukia MoodleNet-eta partekatzean.<br>Saiatu zaitez berriro beranduago.';
$string['moodlenet:sharefailtextwithsitesupport'] = 'Errore bat gertatu da zure edukia MoodleNet-eta partekatzean.<br>Saiatu zaitez berriro beranduago edo <a href="{$a}">jarri zaitez harremanetan zure guneko kudeatzailearekin</a>.';
$string['moodlenet:sharefailtitle'] = 'Zerbaitek huts egin du';
$string['moodlenet:sharefilesizelimitexceeded'] = 'Partekatutako baliabidearen tamainak ({$a->filesize} byte) gehieneko {$a->filesizelimit} byte tamaina gainditzen du.';
$string['moodlenet:sharenoticeactivity'] = 'Jarduera hau MoodleNet-en baliabide gisa partekatzen ari da.';
$string['moodlenet:sharenoticecourse'] = 'Ikastaro hau MoodleNet-en baliabide gisa partekatzen ari da.';
$string['moodlenet:sharenoticepartial'] = 'Aukeratutako jarduerak MoodleNet-en baliabide gisa partekatzen ari dira.';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} jarduerak ikastaroan gehituko dira.';
$string['moodlenet:shareprogress'] = 'MoodleNet-eko partekatzearen aurrerapena';
$string['moodlenet:shareprogressinfo'] = 'Zerrendan MoodleNet-era partekatu dituzun ikastaro eta jarduerak erakusten ditu.<br>Egin klik baliabidearen izenean MoodleNet-en ikusteko.';
$string['moodlenet:sharesuccesstext'] = 'Bukatzear zaude! Ikusi zure MoodleNet-eko zirriborroak zure edukia partekatzen amaitzeko.';
$string['moodlenet:sharesuccesstitle'] = 'MoodleNet-eko zirriborroetan gordeta';
$string['moodlenet:sharetomoodlenet'] = 'Partekatu MoodleNet-en';
$string['moodlenet:sharetyperesource'] = 'baliabidea';
$string['moodlenet:sharinglargefile'] = 'Fitxategi handiek denbora-tarte bat hartu dezakete.';
$string['moodlenet:sharingstatus'] = 'MoodleNet-era partekatzen';
$string['moodlenet:sharingto'] = 'Hona partekatzen:';
...
$string['newsitemsnumber_help'] = 'Albisteen foroak modu lehenetsian behartutako harpidetza du. Bertan soilik irakasleak eta beharrezko baimenak dituzten bestelako erabiltzaileek idatzi dezakete.

Albisteen fororik behar ez baduzu, hemen 0 zehaztu ezazu.

Ezarpen honek azken albisteak blokean zenbat albiste agertuko diren zehazten du.';
...
$string['opensinnewwindowbracketed'] = '(Leiho berri batean irekitzen da)';
$string['operator_and'] = 'eta';
$string['operator_andnot'] = 'eta';
$string['operator_or'] = 'edo';
...
$string['pathslasherror'] = 'Bidea ezin da barra batekin amaitu.';
...
$string['paymentsorry'] = 'Mila esker ordainketarengatik. Prozesatzen denean {$a->fullname} ikastaroan sartu ahal izango duzu. Mesedez pixka bat beranduago berriz sartzen saiatu zaitez. Arazoekin jarraitzen baduzu {$a->teacher} irakaslearekin edo gunearen kudeatzailearekin harremanetan jarri zaitez.';
$string['paymentthanks'] = 'Mila esker ordainketarengatik. Dagoeneko {$a} ikastaroan matrikulatuta zaude.';
...
$string['pluginitemid'] = 'Elementuaren IDa';
$string['pluginmissingfromdisk'] = '{$a->name} (Diskotik falta da)';
...
$string['policyagreementclick'] = 'Guneko politiken onespena';
$string['popup'] = 'popup';
...
$string['previewthemename'] = 'Aurreikusi \'{$a}\' azala';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'MoodleNet partekatze-aurrerapenaren xehetasunak';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'Lotutako ikastaro-moduluaren IDa.';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'Lotutako ikastaroaren IDa.';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = 'Partekatze arrakastatsu baten ondoren MoodleNet-etik itzulitako URLa.';
$string['privacy:metadata:moodlenet_share_progress:status'] = 'Partekatzearen emaitzaren egoera.';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = 'Partekatzea exekutatu zeneko unea.';
$string['privacy:metadata:moodlenet_share_progress:type'] = 'Exekutatutako partekatze-mota.';
$string['privacy:metadata:moodlenet_share_progress:userid'] = 'Partekatzea exekutatu zuen erabiltzailea.';
...
$string['required'] = 'Beharrezkoa(k)';
$string['requirespayment'] = 'Ikastaro hau ordainpekoa da';
$string['resendemail'] = 'Berriz bidali berrespen e-maila';
...
$string['restoreinfo'] = 'Erabili segurtasun-kopia fitxategi bat ikastaroaren aurretiko bertsio bat berreskuratzeko edo ikastaro berri bat sortzeko.';
...
$string['rolerenaming_help'] = 'Aldatu ikastaro honetako rolentzat erakusten diren izenak.';
$string['rolerenaming_success'] = 'Ikastaroko rolen izenak aldatuta.';
$string['roles'] = 'Rolak';
...
$string['scalestandard_help'] = 'Eskala estandarra gune mailan, ikastaro guztietan, erabil daiteke.';
...
$string['searchgroups'] = 'Bilatu taldeak';
$string['searchitems'] = 'Bilatu elementuak';
...
$string['selectgroupsseparate'] = 'Aukeratu taldeek ezin elkar ikustea';
$string['selectgroupsvisible'] = 'Aukeratu taldeek elkar ikusi ahal izatea';
...
$string['selecttheme'] = 'Aukeratu azala';
$string['selectthemename'] = 'Aukeratu \'{$a}\' azala';
...
$string['sessionforceclean'] = 'segurtasun neurri gisa, saio honetan erabiltzaileek sortutako script-ak desgaitu dira.';
...
$string['shortnamecourse_help'] = 'Leku gutxi dagoen lekuetan erakutsitako izena. Bakarra izan behar da.';
...
$string['showgrades_help'] = 'Baimendu ikasleek ikastaroko bere kalifikazio guztien zerrenda ikustea.';
...
$string['showreports_help'] = 'Baimendu ikasleek euren profil-orritik bere agerraldien txostena ikustea.';
...
$string['signoutofotherservices'] = 'Itxi saioa web aplikazio guztietatik';
$string['signoutofotherservices_help'] = 'Itxi saioa web-zerbitzuak erabiltzen dituzten gailu guztietan, hala nola Moodle aplikazioan. Nabigatzaileko saioak irekita jarraituko dute.';
...
$string['sites'] = 'Guneak';
$string['sitesection'] = 'Gehitu eduki pertsonalizatua';
...
$string['startdate_help'] = 'Data honek astekako formatua duen ikastaro bateko astearen hasiera zehazten du. Jardueretako erregistroetarako hasiera-data ere bada.

Ikastaroa berrabiarazi eta data hau aldatzen baduzu, ikastaroko data guztiak ere hasiera-data berriaren arabera aldatuko dira.';
$string['startdatewithtaskenabled'] = 'Ikastaroaren hasiera-data';
$string['startdatewithtaskenabled_help'] = 'Ikastaroa ikasleei erakutsiko zaien data. Data honen aurretik ikasleek ez dute sarbiderik izango.

Data honek astekako formatuaren lehen astearen hasiera zehazten du, baita ikastaroko jarduerak erregistratzeko hasiera-data ere. Ikastaroa berrabiarazi eta data hau aldatzen baduzu, ikastaroko data guztiak hasiera-data berriaren era berean aldatuko dira.';
...
$string['theme'] = 'Azala';
$string['themepreviewdescription'] = '\'{$a}\' azalaren deskribapena';
$string['themepreviewimage'] = '\'{$a}\' azalaren aurreikuspen-irudia';
...
$string['torecipient'] = 'Jasotzailea';
...
$string['unexistingsectionid'] = 'Ikastaro-atalaren IDa ez da aurkitu';
...
$string['usermatchedon'] = 'Erabiltzaile honek hurrengo eremuaren arabera egindako bilaketarekin bat datoz';
...
$string['userselectorsearchanywhere'] = 'edonon';
$string['userselectorsearchexactmatchonly'] = 'soilik zehazki bat datozenak';
$string['userselectorsearchfromstart'] = 'hasieratik';
$string['userselectorsearchmatching'] = 'Bat datozenak:';
...
$string['validatehtml'] = 'Balioztatu HTMLa';
...
$string['viewallresults'] = 'Ikusi emaitza guztiak ({$a})';
...
$string['viewresults'] = 'Ikusi {$a}(r)entzako emaitzak';
...
Dagoeneko egin ez baduzu, zure erabiltzaile-profila beheko estekan klik eginda editatu dezakezu zuri buruz gehiago jakin dezagun:
...
$string['wontrunfuturescheduledtask'] = 'Ez da exekutatuko huts egin duen eta etorkizunean exekutatzeko programatuta dagoen ataza';
