...
/**
 * Strings for component 'quiz_statistics', language 'eu', version '4.4'.
 *
...
$string['cic'] = 'Barne-tinkotasun koefizientea ({$a} kontuan hartuta)';
...
$string['detailedanalysisforvariant'] = 'Galdera honen {$a}. aldaerarentzako erantzunen analisi zehatzagoa';
...
$string['errorratio'] = 'Ratio-errorea ({$a} kontuan hartuta)';
...
$string['firstattempts'] = 'ikasleen lehenengo saiakerak';
...
$string['kurtosis'] = 'Emaitzen zapaltasun banaketa ({$a} kontuan hartuta)';
...
$string['standarddeviation'] = 'Desbiderapen estandarra ({$a} kontuan hartuta)';
$string['standarddeviationq'] = 'Desbiderapen estandarra';
$string['standarderror'] = 'Errore estandarra ({$a} kontuan hartuta)';
...
$string['statsfor'] = 'Galdetegiaren estatistikak (({$a} kontuan hartuta)';
