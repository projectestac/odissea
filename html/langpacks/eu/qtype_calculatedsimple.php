...
/**
 * Strings for component 'qtype_calculatedsimple', language 'eu', branch 'MOODLE_38_STABLE'
 *
...
$string['atleastonewildcard'] = 'Gutxienez aldagai bat <strong>{x..}</strong> izan behar da erantzun zuzenaren formuletan';
$string['converttocalculated'] = 'Gorde galdera kalkulatu berri gisa';
$string['findwildcards'] = 'Aurki itzazu erantzun zuzenaren formuletan dauden aldagaiak {x..}';
