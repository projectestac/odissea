...
$string['createddate'] = '{$a->date}-n {$a->username}(e)k sortuta';
...
$string['tableofcontents'] = 'Edukien taula';
...
$string['updatedpages_help'] = 'Duela gutxi eguneratutako wiki-orriak';
