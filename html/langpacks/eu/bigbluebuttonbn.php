...
$string['completionattendance_desc'] = 'Ikasleak saioan sartu eta bertan gutxienez {$a} minutuz egon behar du';
$string['completionattendance_event_desc'] = 'Ikaslea saioan sartu eta bertan gutxienez {$a} minutuz egon da';
...
$string['completionengagement_desc'] = 'Ikasleak bileran zeharreko jardueretan parte hartu behar du';
$string['completionengagementchats'] = 'Txatak';
$string['completionengagementchats_desc'] = 'Ikasleak {$a} txatetan parte hartu behar du jarduera osatzeko.';
$string['completionengagementchats_event_desc'] = '{$a} txat sortu ditu';
$string['completionengagementemojis'] = 'Emojiak';
$string['completionengagementemojis_desc'] = 'Ikasleak inkestetan {$a} emoji bidali behar ditu jarduera osatzeko.';
$string['completionengagementemojis_event_desc'] = '{$a} emoji sortu ditu';
...
$string['completionengagementpollvotes_desc'] = 'Ikasleak inkestetan {$a} aldiz botoa eman behar du jarduera osatzeko.';
...
$string['completionengagementraisehand_desc'] = 'Ikasleak eskua {$a} aldiz altxatu behar du jarduera osatzeko.';
...
$string['completionengagementtalks_desc'] = 'Ikasleak {$a} aldiz hitz egin behar du jarduera osatzeko';
...
$string['completionview_event_desc'] = 'Bilera-gelaren orria ikusi du.';
$string['config_checksum_algorithm'] = 'BigBlueButton Checksum Algoritmoa';
$string['config_checksum_algorithm_description'] = 'Zure BigBlueButton zerbitzariaren checksum algoritmoa.
(SHA1 protokoloak zerbitzarien bertsio zaharragoekin bateragarritasuna bermatzen du baina SHA512 protokoloak FIPS 140-2 betetzen du)';
...
$string['config_preuploadpresentation_editable_description'] = 'Aldez aurretik kargatutako aurkezpena erabiltzaile-interfazean editagarria da gela edo bilera gehitu edo eguneratzean.';
...
$string['email_body_recording_ready_in_course'] = 'ikastaroan';
...
$string['general_error_not_found'] = 'Ez da entitatea aurkitu: {$a}.';
...
$string['notification_instance_created_intro'] = '<a href="{$a->link}">{$a->name}</a> BigBlueButton gela sortu egin da.';
$string['notification_instance_created_small'] = '{$a->name} izeneko BigBlueButton gela berria sortu da';
$string['notification_instance_created_subject'] = 'BigBlueButton gela berria sortu da';
...
$string['notification_instance_updated_intro'] = '<a href="{$a->link}">{$a->name}</a> BigBlueButton gela eguneratua izan da.';
$string['notification_instance_updated_small'] = '{$a->name} BigBlueButton saioa eguneratu da';
$string['notification_instance_updated_subject'] = 'Zure BigBlueButton gela eguneratu da';
$string['notification_recording_ready_html'] = 'BigBlueButton-eko <b><a href="{$a->link}">{$a->name}</a></b> gelako saio baten grabazioa eskuragarri dago orain.';
$string['notification_recording_ready_plain'] = 'BigBlueButton-eko {$a->name} gelako saio baten grabazioa eskuragarri dago orain. Egin klik {$a->link} grabazioa ikusteko.';
$string['notification_recording_ready_small'] = 'BigBlueButton-eko {$a->name} gelaren grabazio bat dago eskuragarri.';
...
$string['report_join_info'] = 'Bilera-gelan {$a} aldiz sartu da';
$string['report_play_recording_info'] = 'Grabazioa {$a} aldiz erreproduzitu du';
$string['report_room_view'] = 'Bilera-gela ikusi du';
...
$string['taskname:check_dismissed_recordings'] = 'Bilatu baztertutako grabazioak';
