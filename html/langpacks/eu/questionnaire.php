...
/**
 * Strings for component 'questionnaire', language 'eu', version '4.5'.
 *
...
$string['allresponses'] = 'Erantzun guztiak';
...
$string['attemptsallowed'] = 'Baimendutako saiakerak: {$a}';
$string['attemptstillinprogress'] = 'Abian. Azkenengoz gordeta:';
$string['autodeletereponse'] = 'Ezabatu erantzunak automatikoki [?] igaro ondoren';
$string['autodeletereponse_desc'] = 'Gaitu ezazu ezarpen hau erantzun zaharrak automatikoki ezabatzeko "Ezabatu erantzun zaharrak epe hau igaro ondoren" ezarpenean zehaztutako denbora igaro ondoren.';
...
$string['centerlabel'] = 'Erdiko etiketa';
...
$string['cleanrecylebin'] = 'Hustu Galdeketaren \'Zakarrontzia\'';
...
$string['closed'] = 'Galdeketa hau {$a} itxi zen.';
$string['closedate'] = 'Erantzunak onartzeko amaiera-data:';
$string['closesat'] = 'Galdeketa hau {$a} itxiko da.';
...
$string['configremoveoldresponses'] = 'Galdeketa berri guztientzako erabiliko den ezarpena.';
...
$string['confirmdelpermanentlyq'] = 'Ziur zaude galdera hau behin-betiko ezabatu nahi duzula?';
...
$string['couldnotdelrespby'] = 'Ezin izan da {$a->user} erabiltzailearen {$a->rid} erantzuna ezabatu';
...
$string['deletepermanentlybutton'] = 'Behin-betiko ezabatu galdera';
$string['deletequestionsolderthan'] = 'Ezabatu hau baino zaharragoak diren galderak';
$string['deleteresp'] = 'Ezabatu erantzun hau';
$string['deletesection'] = 'Ezabatu atal hau';
$string['deletesettingdescription'] = 'Programatutako atazak ezabatze-eremuan dauden eta tarte hau baino zaharragoak diren galderak ezabatuko ditu.';
$string['deletingresp'] = 'Erantzuna ezabatzen';
$string['deletionquetions'] = 'Galderen ezabatze-eremua';
$string['deletionquetions_help'] = 'Ezabatutako edo umezurtz geratutako galderak lehenbizi hona eramango dira, zuzenean guztiz ezabatu beharrean. Galderak behin-betiko eskuz ezabatu daitezke erabiltzaile batek \'X\' ikonoa sakatuta, edo sistemak automatikoki ezabatuko ditu galderak astebeteren buruan. Erabili \'goranzko gezia\' botoia galdera bat berreskuratzeko.';
...
$string['enterpossibleanswers'] = 'Idatzi erantzun posibleak';
...
$string['file_help'] = 'Baimendu erabiltzaileak fitxategi bat bidaltzea (soilik birus arriskurik ez duten formatu sinpleak onartzen dira)';
...
$string['fullsubmissions'] = 'Bidalketa osoak';
...
$string['invalidincrement'] = 'Kontuan izan gehikuntza-balioa gehieneko balioa baino txikiagoa izan behar dela. Esaterako, eskala 1-10 bada, gehikuntza-balioa ziur aski 1 izango da.';
$string['invalidminmaxrange'] = 'Galdera mota honek onartzen duen gehieneko tartea -100 eta +100 artekoa da. Galdeketa gehienek 1-10 ala -10 eta +10 tarteak erabiliko dituzte.';
$string['invalidrange'] = 'Irristagailuaren gehieneko balioa gutxienezko balioa baino handiagoa izan behar da.';
...
$string['invalidstartingvalue'] = 'Hasierako balioa gutxieneko eta gehieneko balioen artean egon behar du, biak barne. Esaterako, eskala 1-10 bada, hasierako balioa 5 izan daiteke.';
...
$string['maxrange'] = 'Irristagailuaren gehieneko balioa (eskuina)';
$string['maxrange_help'] = 'Zehaztu irristagailuaren gehieneko balioa (eskuin aldeko muga). Lehenetsitako balioa 100 da, baina 1 eta 100 arteko edozein balio izan daiteke. Gutxieneko balioa negatiboa bada, gehieneko balioaren ondoan zeinu positiboa (+) erakutsiko da.';
...
$string['minrange_help'] = 'Zehaztu irristagailuaren gutxieneko balioa (ezker aldeko muga). Lehenetsitako balioa 1 da, baina gutxieneko balioa -100 da. Hemen zenbaki negatiboa erabiliz gero (-100 eta -1 artekoa), gehieneko balioaren ondoan zeinu positiboa (+) erakutsiko da.';
...
$string['notapplicablecolumn'] = 'ED/EE zutabea';
...
$string['notopen'] = 'Galdeketa hau ez da eskuragarri egongo {$a} arte.';
...
$string['possibleanswers'] = 'Elementuak / Erantzun posibleak';
$string['posteddata'] = 'Bidalitako datuekin iritsitako orria:';
$string['preview_label'] = 'Aurreikusi';
$string['preview_questionnaire'] = 'Galdeketaren aurreikuspena';
...
$string['printbutton'] = 'Inprimatu';
$string['printstrictdateformatting'] = 'Idatzi ezazu data';
...
$string['progressbar_info'] = 'Galdeketa {$a} osatua.';
...
$string['recylebindisabled'] = '<span class="timedeletednext7days">Ezabatze automatikoa desgaituta dago</span>';
...
$string['removeoldresponses'] = 'Ezabatu erantzun zaharrak';
$string['removeoldresponses_help'] = 'Sistemak erantzunak zehaztutako epe bat igaro ondoren automatikoki ezabatu ahal ditu.';
$string['removeoldresponsesafter'] = 'Ezabatu erantzun zaharrak epe hau igaro ondoren';
$string['removeoldresponsesdefault'] = 'Ez ezabatu inoiz';
...
$string['respondenttype'] = 'Erantzuna ematen dutenen erakutsi beharreko informazioa';
...
$string['responses_breakdown'] = '(Bidalketak: {$a->responses} | Abian: {$a->incomplete})';
$string['responsesnotsubmitted'] = 'Bidali gabeko erantzunak';
...
$string['restorebutton'] = 'Berreskuratu galdera hau';
...
$string['slider'] = 'Irristagailua';
$string['slider_help'] = 'Irristagailua galdera motaren bitartez erabiltzaileek bi balioen arteko tartean irristagailu bat mugituta balio bat aukeratuta erantzun ahalko dute. Erdiko balio bat ere zehaztu daiteke.';
$string['started'] = 'hasita';
$string['startingvalue'] = 'Irristagailuaren hasierako balioa';
$string['startingvalue_help'] = 'Irristagailuaren hasierako balioa erabiltzaileak galdera ikusterakoan irristagailuaren posizioa zehazten du. Lehenetsitako balioa 1 da tartea ezezaguna delako. hasierako balioa normalean tartearen erdiko puntuan kokatu nahiko duzu (tartea 1-100 bada erdiko puntua 50 litzateke).';
$string['stepvalue'] = 'Irristagailuaren gehikuntza-balioa';
$string['stepvalue_help'] = 'Irristagailuaren gehikuntza-balioak onartutako balio tartean erantzuteko eskaintzen den doitasun-maila zehazten du. 1 eta 100 arteko tartea duen galdera batean, adibidez, gehikuntza-balioa 1 bada erantzunak 70, 71, 72, 73... izan daitezke, baina gehikuntza-balioa 5 bada erantzunak 65, 70, 75, 80... soilik izan ahalko dira, eta doitasun-maila are murritzagoa litzateke 1-10 tartea eta gehikuntza-balioa 1 zehaztuz gero.';
...
$string['studentwhoresponded'] = 'Erantzun duten ikasleak';
$string['subject'] = 'Gaia';
...
$string['submitpreview'] = 'Bidali aurreikuspena';
...
$string['timedeletednext7days'] = '<span class="timedeletednext7days">Behin-betiko ezabatuko den unea: {$a}(e)ko gaua</strong>';
...
$string['useridnumber'] = 'Erabiltzailearen ID zenbakia';
...
$string['viewallxresponses'] = 'Ikusi {$a} erantzunak (guztiak)';
