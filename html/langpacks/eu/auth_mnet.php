...
/**
 * Strings for component 'auth_mnet', language 'eu', version '4.5'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:department'] = 'Erabiltzaile hau aurkitu daitekeen departamentua';
$string['privacy:metadata:mnet_external:description'] = 'Erabiltzaile honen inguruko xehetasun orokorrak.';
$string['privacy:metadata:mnet_external:email'] = 'Kontaktuaren helbide elektronikoa.';
$string['privacy:metadata:mnet_external:emailstop'] = 'Erabiltzaileari posta elektronikoz mezuak bidaltzea ekiditeko hobespena.';
$string['privacy:metadata:mnet_external:firstaccess'] = 'Erabiltzailea gunean lehen aldiz sartu zeneko unea.';
...
$string['privacy:metadata:mnet_external:lastaccess'] = 'Erabiltzailea gunean azken aldiz sartu zeneko unea.';
...
$string['privacy:metadata:mnet_log:course'] = 'Ekintza gertatu zeneko urruneko sistemako ikastaroaren IDa.';
$string['privacy:metadata:mnet_log:coursename'] = 'Ekintza gertatu zeneko urruneko sistemako ikastaroaren izen osoa.';
$string['privacy:metadata:mnet_log:hostid'] = 'Urruneko sistemako MNet IDa.';
$string['privacy:metadata:mnet_log:info'] = 'Ekintzaren inguruko informazio gehigarria.';
$string['privacy:metadata:mnet_log:ip'] = 'Ekintza gertatu zenean erabiltzailea erabiltzen ari zen IP helbidea.';
$string['privacy:metadata:mnet_log:module'] = 'Ekintza gertatu zeneko urruneko sistemako modulua.';
$string['privacy:metadata:mnet_log:remoteid'] = 'Ekintza egin zuen urruneko sistemako erabiltzailearen urruneko IDa.';
...
$string['sso_idp_description'] = 'Eman ezazu argitara zerbitzu hau zure erabiltzaileak {$a} Moodle gunera bertan berriz identifikatu gabe joan ahal izateko. <ul><li><em>Dependentzia</em>: Era berean, SSO zerbitzuan (Zerbitzu-hornitzailea) <strong>harpidetu</strong> beharko duzu hemen: {$a}.</li></ul><br />Harpidetu zerbitzu honetan {$a}-n autentifikatutako erabiltzaileei zure gunean saioa berriz hasi beharrik izan gabe sartzen uzteko. <ul><li><em>Dependentzia</em>: Era berean, SSO zerbitzua (Zerbitzu-hornitzailea) <strong>publikatu</strong> beharko duzu hemen: {$a}.</li></ul><br />';
$string['sso_idp_name'] = 'SSO (Nortasun-hornitzailea)';
$string['sso_mnet_login_refused'] = '{$a->user} izeneko erabiltzaileak ezin du {$a->host}-tik saioa hasi.';
...
$string['unknownhost'] = 'Ostalariz ezezaguna';
