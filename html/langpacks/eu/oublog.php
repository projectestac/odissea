...
/**
 * Strings for component 'oublog', language 'eu', version '4.5'.
 *
 * @package     oublog
 * @category    string
...
$string['completiondetail:comments'] = 'Egin iruzkinak: {$a}';
$string['completiondetail:posts'] = 'Egin {$a->name} sarrerak: {$a->number}';
...
$string['oublogsettingstask'] = 'OU Blogaren ezarpenen zeregina';
...
$string['restricttags_default'] = 'Aurrez definitutako etiketak lehenespenez gehitzen dira sarrera berri batean';
...
$string['restricttags_none'] = 'Beharrezkoa bada, etiketa indibidualak (komaz bereizita) gehi daitezke sarrera batean';
$string['restricttags_req'] = 'Aurrez definitutako edo banakako etiketak (komaz bereizita) aukeratu behar dira sarrera bat gehitzeko.';
$string['restricttags_req_set'] = 'Aurrez definitutako etiketak aukeratu behar dira sarrera bat gehitzeko';
$string['restricttags_set'] = 'Beharrezkoa bada, aurrez definitutako etiketak aukeratu daitezke argitalpen baterako';
...
$string['returntolabel'] = 'Itzuli hona:';
$string['rssfeed'] = 'RSS jarioa';
$string['savecheck'] = 'Gaitu gordetzeko egiaztapena';
$string['savecheck_desc'] = 'Gaitu saioa eta abar egiaztatzea argitalpen-formularioa bidaltzean.';
$string['savefailnetwork'] = 'sareko errore bat; webgunea aldi baterako ez dago erabilgarri edo ezin da atzitu';
$string['savefailsession'] = 'saioaren errore bat; zure saioa iraungi egin da jarduera ezagatik edo saioa ez duzulako hasi';
$string['savefailtext'] = '<p>Zoritxarrez, ezin dira zure aldaketak gorde une honetan.
Hau {$a} dela eta gertatzen da. </p>
<p>Gordetzeko aukera desgaituta dago blog honetan.
Aldaketak gordetzeko, editatutako blogaren edukia kopiatu behar duzu,
Editatu orrialdera sartu berriro eta gero zure aldaketak itsatsi.</p>';
...
$string['tags_help'] = 'Etiketak argitalpenak aurkitzen eta sailkatzen laguntzen dizuten ezaugarriak dira. Etiketak gehitzerakoan, bi edo gehiago erabiltzen badira, komaz bereizita egon behar dute. {$a}';
$string['tags_help_predefined'] = 'Goitibeherako etiketa zerrendan eskuragarri dauden etiketak hautatu behar dituzu.';
