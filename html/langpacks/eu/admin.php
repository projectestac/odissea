...
/**
 * Strings for component 'admin', language 'eu', version '3.8'.
 *
 * @package     admin
 * @category    string
...
$string['configallowcoursethemes'] = 'Aukera hau gaituz gero, ikastaroetan azala zehaztu ahal izango da. Ikastaroko azalak lehentasuna du beste (guneko, erabiltzailearen edo saioko) azalekiko';
...
$string['configcalendarexportsalt'] = 'Ausazko testu hau egutegiak esportatzeko orduan erabilitako fitxen autentifikazioaren segurtasuna hobetzeko erabiltzen da. Kontuan izan fitxa guztiak indargabetuko direla eraldaketa-kode hau aldatzen baduzu.';
...
$string['configdoctonewwindow'] = 'Aukera hau gaituz gero, Moodle Docs-etarako estekak leiho berrian erakutsiko dira.';
...
$string['croninfrequent'] = 'Cron mantenu-scriptaren azken bi exekuzioen artean {$a} segundo baino gehiago pasa dira. Maizago exekutatzeko konfiguratzea gomendatzen dugu.';
...
$string['doesnotfitdetail'] = 'Erakutsi Moodle-tik bidaltzen diren e-mailetarako ezarpenak';
...
$string['manageqtypes'] = 'Kudeatu galdera mota';
...
$string['maxtimelimit_desc'] = 'Moodle-k onartuko duen gehienezko PHP exekuzio-denbora mugatzeko inolako irteerarik erakutsi gabe, sartu hemen balio bat (segundoetan), 0 jarriz gero Moodle-ko lehenetsitako mugak aplikatuko dira. Bere muga propioak dituen frontend zerbitzari bat baduzu hemen balio baxuago bat ezarri PHP error mezuak jasotzeko. Muga hau ez zaie CLI script-ei aplikatzen.';
