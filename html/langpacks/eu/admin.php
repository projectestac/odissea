...
$string['asyncbackupdisabled'] = 'Zure gunea segurtasun-kopia sinkronoak erabiltzeko konfiguratuta dago une honetan. Segurtasun-kopia asinkronoek erabiltzaile-esperientzia hobea eskaintzen dute, erabiltzaileei segurtasun-kopia ala berreskuratzea martxan dagoen bitartean beste ekintza batzuk egitea ahalbidetuz.
Moodle LMS 4.5 LTS bertsiotik aurrera segurtasun-kopia asinkronoak gune guztietan gaituko dira.
...
$string['availabletoanyone'] = 'Eskuragarri gunean sartzen den edonorentzat';
$string['availabletoauthenticated'] = 'Autentifikatutako erabiltzaileentzako soilik';
...
$string['blockprotectblock'] = 'Babestu {$a} blokearen instantziak';
$string['blockprotected'] = '{$a} blokearen instantziak babestuta daude.';
$string['blocksettings'] = 'Kudeatu blokeak';
$string['blockunprotect'] = 'Kendu babesa';
$string['blockunprotectblock'] = 'Kendu babesa {$a} blokearen instantziei';
$string['blockunprotected'] = '{$a} blokearen instantziak dagoeneko ez daude babestuta.';
...
$string['cliupgradecompletenomaintenanceupgrade'] = 'Lehendik dauden cacheak garbitzeko erabiltzaileak kode berrira bideratzen direnean:
...
Garbiketa hauek modu isolatuan exekutatu beharko zenituzke, komandoen artean tarte bat utzita, web-zerbitzariaren gainkarga txikitzeko.';
...
$string['cliupgrademaintenancenotrequired'] = 'Eguneraketa honek EZ DU erabiltzaileentzako mantenu-modua beharko.';
$string['cliupgrademaintenancerequired'] = 'Eguneraketa honek erabiltzaileentzako mantenu-modua BEHARKO DU.';
...
$string['cliupgradesetlock'] = 'Eguneraketa soilik CLI bidez exekutatzeko blokeatu da.';
$string['cliupgradeunsetlock'] = 'Eguneraketa soilik CLI bidez egiteko lehendik zegoen blokeoa kendu da.';
$string['cliyesnoprompt'] = 'idatzi b (bai esateko) edo e (ez esateko)';
$string['close'] = 'Itxi';
$string['cohort_customfield'] = 'Kohorteen eremu pertsonalitzatuak';
...
$string['configallowguestmymoodle'] = 'Gaituz gero, gonbidatuek Aginte-panelerako sarbidea dute, eta bestela guneko hasiera-orrira bideratuko zaie.';
$string['configallowobjectembed'] = 'Segurtasun arrazoiak direla-eta, ikasle rola duten erabiltzaileek modu lehenetsian ez dute baimenik testuetan HTMLko EMBED eta OBJECT etiketak erabilita multimedia elementuak txertatzeko, baina hala ere multimedia elementuak erakutsi ahal dira multimedia pluginen iragazkiak erabilita. Etiketa horiek erabiltzea baimendu nahi baduzu aukera hau gaitu ezazu.';
...
$string['configallowthemechangeonurl'] = 'Gaituz gero, azala aldatu egin daiteke edozein Moodleko URLetan <br />?theme=azalarenizena gehituta (adibidez: niremoodlegunea.eus/?theme=afterburner) edo <br />&theme=azalarenizena gehituta (adibidez: niremoodlegunea.eus/course/view.php?id=2&theme=afterburner).';
...
$string['configallusersaresitestudents'] = 'Webgunearen hasiera-orriko jarduerei dagokienez, erabiltzaile guztiak ikasletzat hartu behar al dira? Hala balitz, onartutako partaide guztiek jardueratan parte ahal izango lukete, eta bestela gutxienez ikastaro batean parte hartzen dutenek soilik izango dute eskubide hori. Hasiera-orriko jardueretan soilik horretarako esleitutako kudeatzaileek eta irakasleek izango dute irakasle gisa parte hartzeko aukera.';
...
$string['configcustomusermenuitems'] = 'Erabiltzailearen menuaren edukiak konfigura ditzakezu (automatikoki gehitzen den irteera-menua izan ezik). Lerroak marra bertikalez banatzen dira eta egitura hau dute: 1) "langstringname, componentname" formatua duen katea edo testu laukoa, eta 2) URL bat. Bereizgailuak erabil daitezke, bereizgailua nahi duzun lekuan # karakterearen lerro bat edo gehiago gehituta.';
...
$string['configdocroot'] = 'Orri-oineko \'Orri honentzako dokumentazioa\' esteken bidezko Moodle Docs-etako testuinguru zehatzetarako bidea definitzen du. Eremu hau hutsik utziz gero, estekak ez dira erakutsiko.';
$string['configdoctonewwindow'] = 'Gaituz gero, Moodle Docs-etarako estekak leiho berrian erakutsiko dira.';
$string['configduration_high'] = 'Balio hau handiegia da. Gehieneko balioa {$a} da.';
$string['configduration_low'] = 'Balio hau txikiegia da. Gutxieneko balioa {$a} da.';
...
$string['configforcelogin'] = 'Normalean gunearen hasiera-orria eta ikastaroen zerrenda (baina ikastaroak ez) edonork irakur ditzake gunean saioa hasi beharrik gabe. Bisitariek EZEIN EDUKIRIK ikusi aurretik gunera pasahitzez sartzera behartu nahi badituzu, aukera hau aktibatu beharko duzu.';
...
$string['configgradeexportdefault'] = 'Aukeratu kalifikazio liburuko kalifikazioak esportatzeko zure metodo lehenetsia.';
...
$string['configintrosite'] = 'Orri honek hasiera-orria konfiguratzen eta zure gune berriari izena ematen ahalbidetzen dizu. Beranduago itzul zaitezke zerbait aldatzera orri nagusiko \'Gunearen kudeaketa\' menuaren bitartez.';
...
$string['configproxybypass'] = 'Proxy-a saihestu beharko luketen ostalari-izen edo IP-en (zati) zerrenda. Elementuak komaz banatu itzazu, espaziorik gabe, adibidez honela: 192.168.0.0/16,*.niredomeinua.com.';
$string['configproxyfixunsafe_help'] = 'Hau proxyaren bidez ez doazen barne-deiak konpontzen saiatzen da MoodleBot User Agent-a gehituz eta proxya erabiliz.';
...
$string['configproxylogunsafe_help'] = 'Hau proxyaren bidez ez doazen eta joan beharko litzatekeen barne-deiak erregistratzen saiatzen da.';
...
$string['configrecaptchapublickey'] = 'Izena emateko formularioan eta guneko laguntza-zerbitzurako formularioan reCAPTCHA elementua erakusteko karaktere-multzoa (gako publikoa). ReCAPTCHA gakoak <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a> gunean lor daitezke.';
...
$string['configservicespage'] = 'Idatzi zerbitzuak eta laguntza orriaren URLa ala hutsik utzi moodle.com webguneko Moodle zerbitzuak atalera estekatzeko. Esteka soilik guneko kudeatzaileei erakutsiko zaie.';
...
$string['configsessioncookiepath'] = 'Nabigatzaileek Moodleko cookie-ak bidaltzen dituzten lekua aldatu beharra baduzu, aukera hau alda dezakezu zure web-gunean azpidirektorio bat zehazteko. Bestela lehenetsitako balioak (\'/\') balioko dizu.';
...
$string['configsmtpoauthservice'] = 'Aukeratu SMTP zerbitzariarekin komunikatzeko konfiguratutako OAuth 2 zerbitzua. Zerbitzua oraindik existitzen ez bada, zerbitzua sortu beharko duzu. Kontuan izan ezarpen hau soilik funtzionatzen duela SMTP autentifikazio-mota (SMTP Auth Type) XOAUTH2 bada.';
...
$string['configsupportavailability'] = 'Orri-oineko guneko laguntza-zerbitzurako kontaktura sarbidea nork daukan zehazten du.';
$string['configsupportemail'] = 'Gune honetan SMTP konfiguratuta badago eta laguntza orria konfiguratu gabe badago, helbide elektroniko honetara bidaliko dira laguntza formularioaren bitartez egindako laguntza eskaerak. Bidalketak huts egiten badu, helbide elektroniko hau saioa hasi duten erabiltzaileei erakutsiko zaie.';
$string['configsupportname'] = 'Posta elektroniko edo webgune bidez laguntza orokorra eskaintzen duen pertsona ala erakundearen izena.';
$string['configsupportpage'] = 'Idatzi laguntza orriaren URLa ala hutsik utzi kontaktuko formulariora estekatzeko. Esteka gunearen orri-oinean erakusten da.';
...
$string['confirmationpending'] = 'Berrespenaren zai';
...
$string['confirmdeletecomments'] = 'Ziur zaude aukeratutako iruzkinak ezabatu nahi dituzula?';
$string['confirmed'] = 'Baieztatutakoak';
$string['contactsitesupport'] = 'Jarri harremanetan guneko laguntza-zerbitzuarekin';
...
$string['coursecolorheading_desc'] = 'Ikastaroko ezarpenetan irudia ezarrita ez duten ikastaroak patroi batekin osatutako kutxa batekin irudikatzen dira Nire Ikastaroak orrian. Patroian erabili beharreko koloreak azpian zehaztu daitezke.';
...
$string['coursecreationguide'] = 'Moodleko ikastaroak sortzeko gidaren URLa';
$string['coursecreationguide_help'] = 'Hasiberrientzako gida azkarraren bidea zehazten du, non bideo laburrak eta ikastaroak sortzeko laguntza orokorrak egongo diren. Gidarako esteka Nire ikastaroak orrian erakusten da erakusteko ikastarorik ez dagoenean. Esteka soilik ikastaroak sortzeko baimenak dituzten erabiltzaileek ikusiko dute.';
...
$string['courserequestnotifyemail'] = '{$a->user} erabiltzaileak ikastaro-eskaria egin du hemen: <a href="{$a->link}">{$a->link}</a>';
...
$string['cron_enabled_desc'] = 'Cron-a normalean gaituta egon beharko litzateke, baina ezarpen honek behin behinean desgaitzeko aukera ematen du, esaterako berrabiarazte baten aurretik. Desgaituta badago sistemak ez ditu atzeko planoko ataza berririk abiaraziko. Kontuan izan cron-a ez litzatekeela denbora luzez desgaituta utzi beharko, horrek funtzionalitate garrantzitsuen funtzionamendu egokia eragotziko lukeelako.';
...
$string['cron_keepalive'] = 'Mantendu bizirik (Keep Alive)';
$string['cron_keepalive_desc'] = 'Ataza gehigarriak bilatzen jarraitzeko denbora kopurua. Ezarpen hau erabilgarria da cron-a beti exekutatzen ari dela ziurtatzeko. Dedikatutako ataza-exekutatzaileak erabiltzen badituzu balio honetan 0 jarri ezazu, eta bestela ad hoc atazen konkurrentzia-mugaren antzeko balio bat jartzea gomendatzen da. Gehieneko balioa 15 minutu dira.';
...
$string['debugtemplateinfo'] = 'Erakutsi txantiloien informazioa';
$string['debugtemplateinfo_desc'] = 'Gaituz gero, renderizatzeko erabilitako txantiloiak HTML orriaren iruzkin gisa erakutsiko dira. Ezarpena aldatu ondoren cacheak garbitu behar dituzu. Arazte-lanerako eta behin-behinean soilik erabili ezazu, HTML balidazio-erroreak eragiten dituelako eta orriko script-ak apurtu ditzakeelako. Muineko funtzionalitatea ere apurtu dezake!';
...
$string['deleteduserx'] = 'Ezabatutako erabiltzailea {$a}';
...
$string['disableplugin'] = 'Desgaitu {$a} plugina';
...
$string['enablecommunicationsubsystem'] = 'Gaitu komunikazio-hornitzaileak';
$string['enablecommunicationsubsystem_desc'] = 'Baimendu Matrix bezalako komunikazio-hornitzaileekin integratzea, ikasle eta irakasleen arteko komunikazioa errazteko. Integrazio hauek hemendik kudeatu ditzakezu: <a href="settings.php?section=managecommunicationproviders">Pluginak</a>.';
...
$string['enabledashboard'] = 'Gaitu Aginte-panela';
$string['enabledashboard_help'] = 'Aginte-panelak Denbora-lerroa, Egutegia eta Duela gutxi ikusitako elementuak erakusten ditu modu lehenetsian. Jende guztiarentzako Aginte-panel ezberdin bat zehaztu dezakezu, baita norberak bere Aginte-panela pertsonalizatzea baimendu ere. Desgaituz gero, \'Hasiera-orria erabiltzaileentzat\' parametroan Aginte-panela ez den balioa zehaztu beharko duzu.';
...
$string['enablepdfexportfont'] = 'Gaitu PDF letra-motak';
$string['enablepdfexportfont_desc'] = 'Zure guneak PDF fitxategiak sortzerakoan letra-mota ezberdinak behar dituzten hizkuntzak baditu, ikastaroaren ezarpenetan letra-mota zehazteko aukera eman ahal duzu. Eskuragarri dauden letra-motak config.php fitxategiaren $CFG->pdfexportfont aldagaian zehaztu behar dituzu.';
$string['enableplugin'] = 'Gaitu {$a} plugina';
...
$string['enablesharingtomoodlenet'] = 'Gaitu MoodleNet-era partekatzea (irteera)';
$string['enablesharingtomoodlenet_desc'] = 'Baimendu erabiltzaileek ikastaroetako edukiak konfiguratutako MoodleNet instantziara partekatzea dagokien baimena badute.';
...
$string['enroladminnewcourse'] = 'Auto-matrikulatu kudeatzailea ikastaro berrietan';
$string['enroladminnewcourse_help'] = 'Kudeatzaile batek ikastaro berri bat gehitzen duenean, ikastaro berrian automatikoki matrikulatu eta sortzaile rola esleitu behar zaio?';
...
$string['environmentmariadbwrongdbtype'] = '$CFG->dbtype ezegokia. Zure config.php fitxategia editatu behar duzu, \'mysql\' beharrean \'mariadb\' jarrita.';
...
$string['eventshandlersinuse'] = 'Zure sistemako hurrengo pluginek baztertutako Events 1 API-aren kudeatzaileak erabiltzen dituzte: \'{$a}\'. Mesedez, eguneratu itzazu Events 2 API-ra. Ikusi https://docs.moodle.org/dev/Events_API#Event_dispatching_and_observers gehiago jakiteko.';
...
$string['favicon_desc'] = 'Favicona nabigatzailearen fitxan orriaren izenburuaren ondoan erakusten da. Favicon pertsonalizatua zehazten ez bada Moodle favicona erakutsiko da.';
...
$string['grouping_customfield'] = 'Talde-multzoen eremu pertsonalizatuak';
...
$string['hookcallbacknotcallable'] = 'Ezin zaio itzulera dei honi deitu. Honen arrazoia klasea ala metodoa ez existitzea izan daiteke, edo metodoa publikoa ez izatea.';
$string['hookcallbacks'] = 'Itzulera-deiak';
$string['hookcallbacks_help'] = 'Kakoa ematerakoan deituko diren itzulera-deien zerrenda.

Erakutsitako ordena itzulera-deiak egingo direnarena da.

Lehentasun altuagoa duen itzulera-dei bat lehentasun baxuagoa duen bat baino lehenago egingo da.';
$string['hookclassmissing'] = 'Ez da aurkitu kakoaren klasea';
$string['hookclassmissing_desc'] = 'Kakoa aurkitzeko agenteak existitzen ez den klasea itzuli du.';
$string['hookconfigoverride'] = 'Baliogabetua';
$string['hookconfigoverride_help'] = 'Itzulera-dei honen definizioa gunearen konfigurazio-fitxategian (config.php) baliogabetu da';
$string['hookdeprecates'] = 'Zaharkitutako itzulera-deiak (callbacks)';
$string['hookdescription'] = 'Deskribapena';
$string['hookdescriptionmissing'] = 'Kakoak ez dauka deskribapen-metodo bat';
$string['hookname'] = 'Kakoa';
$string['hooksoverview'] = 'Kakoen aurrebista';
$string['hookunknown'] = 'Ez da kakoa aurkitu';
$string['hookunknown_desc'] = 'Itzulera-dei honek entzuten duen objektua ez dago eskuragarri. Baliteke ezabatua edo berrizendatua izan izana, edo Moodleko bertsio honetan eskuragarri ez egotea.';
...
$string['linkcoursesections_help'] = 'Saiatu beti ikastaro-ataletara esteka bat ematen. Ikastaro-atalak normalean soilik ikastaro-formatuak orriko atal bakarra erakusten duenean erakusten dira esteka gisa. Ezarpen hau gaituta badago esteka beti emango da.';
...
$string['logo'] = 'Logoa';
$string['logo_desc'] = 'Logo handia azal batzuk apaintzeko erabiltzen dutena (hala nola azal estandarrak). Irudi hau nahiko erresoluzio handikoa izan daiteke erabilerarako txikitua izango delako (eta cacheatua izango da errendimendua hobetzeko). Normalean altuera baino zabalagoak diren logoak txukunago geratu ohi dira.';
$string['logocompact'] = 'Logo txikia';
$string['logocompact_desc'] = 'Goiko logoaren bertsio txikiago bat, hala nola enblema, ezkutu edo ikono bat. Irudia garbia izan beharko litzateke baita tamaina txikietan ere.';
...
$string['maxcharacter'] = '{$a} karaktere gehienez';
...
$string['messagingallusers'] = 'Baimendu gune mailako mezularitza';
...
$string['modassignmentinuse'] = 'Zure guneak oraindik ere Zeregina pluginaren 2.2 bertsioa erabiltzen du. Eguneratu baino lehen arazo hau konpondu dezakezu 1) Zure Zeregina pluginaren 2.2 bertsioaren jardueren segurtasun-kopia egin eta Zeregin berri gisa berreskuratuz; edo 2) Zeregin pluginaren 2.2 bertsioaren datuak datu-baseko tauletatik (assignment_) ezabatuz.';
$string['modassignmentsubpluginsexist'] = 'Zeregina 2.2ren baitako azpi-pluginak egon daitezke. mod/assignment direktorioa eta bertako azpiplugin guztiak kendu behar dira eguneratu baino lehen.';
...
$string['navshowfrontpagemods_help'] = 'Gaituz gero, hasiera-orriko jarduerak nabigazio blokean guneko orrien azpian erakutsiko dira. Ezarpen honek azal Klasikoan bakarrik eragiten du.';
...
$string['noemaileverwarning'] = '<strong>Oharra:</strong> Kanporako e-mail bidalketa desgaitua izan da';
...
$string['noteunneededblocks'] = 'Oharra: Erakusteko zehaztuta ere blokeak ez dira \'Gehitu bloke bat\' menuan agertuko azalaren \'Behar ez diren blokeak\' ezarpenean zehazten badira.';
...
$string['oracledatabaseinuse'] = 'Oracle DBko sostengua kendu egingo da. Moodleko 4.5 izango da Oracle datu-baseak sostengua duen azken bertsioa. Informazio gehiago ikusi moodle.org-ko iragarpena: <a href="https://moodle.org/mod/forum/discuss.php?d=456122">Oracle database support in LMS deprecation</a>.';
...
$string['perfdebugdeferred'] = 'Script-a amaitzeko zain errendimenduaren araztea erakusteko...';
...
$string['profilefieldmaxlength'] = 'Gehieneko karaktere kopurua';
$string['profilefieldmaxlength_help'] = 'Eremu hau \'Erakutsi erabiltzailearen identitatea\' ezarpenean erabiltzeko, gehienez 255 karaktere erabili behar dira.';
...
$string['profilevisible_help'] = '* Ez ikusgai - soilik guneko kudeatzaileek eta kudeatzaileek ikusi dezakeen datu pribatuetarako.
...
$string['proxyfixunsafe'] = 'Konpondu proxyaren bidez ez doazen deiak';
$string['proxyhost'] = 'Proxy ostalaria';
$string['proxylogunsafe'] = 'Erregistratu proxyaren bidez ez doazen deiak';
...
$string['replacefrontsearch'] = 'Hasiera-orriko ikastaro-bilaketetarako erabilia';
...
$string['resetindentation'] = 'Berrabiarazi koskatzea gune osoan';
$string['resetindentation_help'] = 'Ekintza honek aurretik zehaztutako koskatzeak ezabatuko ditu guneko {$a->format} formatuko ikastaro guztietan.';
$string['resetindentation_title'] = 'Berrabiarazi koskatzea gune osoan?';
$string['resetindentationsuccess'] = 'Koskatzearen berrabiarazita.';
...
$string['searchdefaultcategory_desc'] = 'Aukeratutako bilatze-kategoriako emaitzak modu lehenetsian erakutsiko dira.';
...
$string['searchmaxtopresults'] = 'Gehieneko emaitza onenak';
$string['searchmaxtopresults_desc'] = 'Ikastaroko edukien, ikastaroen eta erabiltzaileen bilaketa emaitzen aurretik erakusten diren emaitza onenen atalean gehienez erakutsiko den emaitza kopurua.';
$string['searchnotavailable'] = 'Bilaketa ez dago eskuragarri';
$string['searchoptions'] = 'Bilaketarako aukerak';
...
$string['searchteacherroles'] = 'Irakasle rolak';
$string['searchteacherroles_desc'] = 'Aukeratu itzazu bilaketa-emaitzetan erabiltzailea gorago agertzea eragingo duten rol guztiak.';
$string['searchtopresults'] = 'Emaitza onenak';
...
$string['servicespage'] = '\'Zerbitzuak eta laguntza\' esteka';
...
$string['sessioncookie'] = 'Cookie-aren atzizkia';
...
$string['sessiontimeout'] = 'Denbora-muga';
...
$string['settingzendexceptionignoreargs'] = 'Segurtasun neurri gisa, PHPko zend.exception_ignore_args ezarpena gaituta egotea irmoki gomendatzen da.';
...
$string['sitesectionhelp'] = 'Erakutsi atal bat orriaren goiko aldera eduki pertsonalizatua gehitu ahal izateko.';
...
$string['smallscreensonly'] = 'Pantaila txikiak soilik';
$string['smtp'] = 'SMTP';
...
$string['supportemailsubject'] = 'Guneko laguntza eskaera - {$a}';
...
$string['task_adhoc_failed_retention'] = 'Huts egindako ad-hoc atazen mantentze-epea';
$string['task_adhoc_failed_retention_desc'] = 'Huts egindako ad-hoc atazak ilaran gehienez egon beharreko denbora behin euren berriz saiatzeko muga gainditu dutenean.';
...
$string['task_dbreads'] = 'Datu-base irakurketak';
$string['task_dbstats'] = 'Datu-basea';
$string['task_dbwrites'] = 'Datu-base idazketak';
$string['task_duration'] = 'Iraupena';
$string['task_endtime'] = 'Amaiera unea';
$string['task_logmode'] = 'Noiz erregistratu';
$string['task_logmode_all'] = 'Gorde zeregin guztien irteeraren erregistroa';
$string['task_logmode_desc'] = 'Atazen erregistroa noiz gertatuko den erabaki dezakezu. Modu lehenetsian erregistro guztiak gordetzen dira. Erregistroa erabat desgaitu dezakezu, edo huts egiten duten atazen erregistroa baino ez gordetzea erabaki dezakezu.';
$string['task_logmode_failonly'] = 'Gorde soilik huts egin duten zereginen erregistroak';
$string['task_logmode_none'] = 'Ez gorde ezer';
$string['task_logoutput'] = 'Ataza-irteera';
...
$string['task_status'] = 'Atazaren egoera';
$string['task_status_desc'] = '\'{$a->name}\' ataza \'{$a->status}\' dago. Xehetasunetarako ikusi ezazu {$a->class}{$a->extradescription} <a href="{$a->gotourl}">Programatutako atazetan</a>.';
...
$string['taskautomatedbackup_report'] = 'Segurtasun-kopia automatizatuak txostena';
$string['taskbackupcleanup'] = 'Garbitu segurtasun-kopiak, agerraldiak eta fitxategiak';
$string['taskbadgesadhoc'] = 'Eman domina';
$string['taskbadgescron'] = 'Gehitu eman dominak ad-hoc atazak';
...
$string['tasklockcleanuptask'] = 'Garbitu ad-hoc atazen metadatuak';
...
$string['testoutgoingmailconf_fromemail'] = 'Igorlearen erabiltzaile-izena edo helbide elektronikoa';
$string['testoutgoingmailconf_fromemail_help'] = 'Eremu honek erabiltzaile horrek bidalitako mezua emulatzen du, baina benetako e-mailean erabilitako Igorlearen goiburua allowedemaildomains bezalako beste ezarpenen araberakoa izango da.';
$string['testoutgoingmailconf_fromemail_invalid'] = 'Igorlearen erabiltzaile-izen edo helbide elektroniko baliogabea. Helbide elektronikoko formatu baliagarria edo Moodlen existitzen den erabiltzaile-izen bat izan behar da.';
$string['testoutgoingmailconf_message'] = 'Mezu hau proba bat da zure guneko kanporako posta elektronikoaren konfigurazioa ondo dagoela baieztatzeko. Bidalitakoa: {$a}';
...
$string['testoutgoingmailconf_subject'] = '{$a->site}: proba-mezua. {$a->additional} Bidalitakoa: {$a->time}';
$string['testoutgoingmailconf_subjectadditional'] = 'Gai gehigarria';
...
$string['themedefinedinconfigphp'] = 'Azala ezin da hemen aldatu {$a} zehaztuta dagoelako config.php fitxategian.';
...
$string['themeeditsettingsname'] = 'Editatu azalaren ezarpenak \'{$a}\'';
...
$string['themeselector'] = 'Azalak';
$string['themesettings'] = 'Azalen ezarpenak';
$string['themesettingsadvanced'] = 'Azalaren ezarpen aurreratuak';
$string['themesettingscustom'] = 'Azal-ezarpen pertsonalizatuak';
$string['themesettingsname'] = 'Azalaren ezarpenak \'{$a}\'';
$string['themeusagereportname'] = 'Azalaren erabilera-txostena \'{$a}\'';
...
$string['unicoderequired'] = 'Datu guztiak Unicode (UTF-8)-n gorde behar dira. Instalazio berrietan datu-baseak UTF-8 karaktere-multzoa izan behar du karaktere-multzo lehenetsi gisa. Eguneraketa bat egiten ari bazara, UTF-8rako migrazio-prozesua jarraitu beharko zenuke.';
...
$string['unsupportedphpversion7'] = 'Ez dira PHP 7 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion71'] = 'Ez dira PHP 7.1 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion72'] = 'Ez dira PHP 7.2 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion73'] = 'Ez dira PHP 7.3 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion74'] = 'Ez dira PHP 7.4 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion80'] = 'Ez dira PHP 8.0 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion81'] = 'Ez dira PHP 8.1 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion82'] = 'Ez dira PHP 8.2 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion83'] = 'Ez dira PHP 8.3 edo goragoko bertsioak onartzen.';
$string['unsupportedphpversion84'] = 'Ez dira PHP 8.4 edo goragoko bertsioak onartzen.';
...
$string['upgradekeyreq'] = 'Eguneraketa-kodea behar da';
...
$string['userfeedbackencouragement'] = '<p>Moodlek erabiltzaileei softwareari buruzko feedbacka emateko aukera eskaintzen dien funtzioa dauka, Moodle HQk kudeatutako kanpoko inkesta bat erabiliz. Inkestaren gunera ez da erabiltzaileak identifikatzeko informaziorik bidaltzen.</p>
...
<p>Erabiltzaileen feedbacka Moodle HQ-rentzat lagungarria da Moodle softwarea hobetu ahal izateko. Funtzionalitate hau gaitzeko joan zaitez <a href="{$a}">Feedbackaren ezarpenak</a> atalera.</p>';
...
$string['userfiltersdefault_desc'] = 'Aukeratu itzazu \'Erabiltzaile-eragiketa masiboak\' orrian erakutsi beharreko iragazkiak. Hainbat iragazki aukeratzeko, mantendu Ctrl tekla sakatuta. Aukeratu gabeko iragazki guztiak \'Erakutsi gehiago\' estekan klik eginda egongo dira eskuragarri.';
