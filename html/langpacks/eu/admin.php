...
/**
 * Strings for component 'admin', language 'eu', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['invalidthemepreset'] = 'Aukeratutako aurrezarpen-fitxategia ez da itxura honekin bateragarria. SCSS konpilatze-errorea hurrengoa da: "{$a}"';
