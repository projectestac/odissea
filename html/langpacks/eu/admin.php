...
$string['configreverseproxyignore'] = 'Zure zerbitzaria X-Forwarded-For goiburua gehitzen duten alderantzizko proxy anitzen atzean badago, zehaztu ezazu erabiltzaileen benetako IP helbidea aurkitu ahal izateko komaz banatutako ezikusi beharreko alderantzizko proxy-en IP helbide edo azpisareen zerrenda.';
...
$string['configsmtpmaxbulk'] = 'SMTP saioko bidalitako gehienezko mezu-kopurua. Mezuak talde-multzoak arindu egin dezake e-mail bidalketa. 2tik beherako balioek e-mail bakoitzeko SMTP saio berria sortarazten dute.';
...
$string['maxsizeperdownloadcoursefile'] = 'Fitxategi bakoitzaren gehienezko tamaina';
$string['maxsizeperdownloadcoursefile_desc'] = 'Ikastaroaren edukia deskargatzean fitxategi bakoitzak izango duen gehienezko tamaina. Tamaina hau baino handiagoko fitxategiak deskargatik baztertuko dira.';
...
$string['profilingslow_help'] = 'Gutxienezko segundo kopuru bat zehaztuz gero hori baino motelagoak diren orriak profilatuko dira. Soilik script bakoitzerako existitzen den profila baino motelagoak diren profilak gordeko dira. Desgaitzeko 0 jarri. Kontuan izan ezarpen honek baztertze-ezarpenak begiratzen dituela.';
...
$string['task_adhoc_concurrency_limit_desc'] = 'Aldi berean exekutatu ahal diren ad hoc atazen gehienezko kopurua. Muga altua bada programatutako atazak erregularki ez exekutatzea gertatu liteke ad hoc ataza asko daudenean. 0 ezarriz gero ad hoc atazen exekuzioa guztiz desgaituko da.';
$string['task_adhoc_max_runtime'] = 'Ad hoc atazen gehienezko iraupena';
$string['task_adhoc_max_runtime_desc'] = 'Ad hoc ataza batek iraun dezakeen gehienezko denbora askatua izan baino lehen. Hemen iraupen txikia jartzea gomendatzen da ez dagoelako ilaratu daitezkeen ad hoc atazen mugarik. Zenbaki hau oso altua bada eta ad hoc atazen ilara luzea baduzu gertatu liteke programatutako atazak erregularki ez exekutatzea.';
...
$string['task_scheduled_max_runtime'] = 'Programatutako atazen exekuzioen gehienezko iraupena';
$string['task_scheduled_max_runtime_desc'] = 'Programatutako atazen exekuzioen gehienezko denbora askatua izan baino lehen.';
...
$string['userquota_desc'] = 'Erabiltzaile bakoitzak bere eremu pribatuan gorde ditzakeen datuen gehienezko tamaina.';
