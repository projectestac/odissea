...
/**
 * Strings for component 'admin', language 'eu', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['coursepage'] = 'Ikastaro-orria';
...
$string['resetindentation'] = 'Berrabiarazi koskatzea';
$string['resetindentation_help'] = 'Ekintza honek {$a->format} formatuko ikastaroetan aurretik zehaztutako koskatzeak ezabatuko ditu.';
$string['resetindentation_title'] = 'Berrabiarazi koskatzea ikastaro-orrian?';
$string['resetindentationsuccess'] = 'Koskatzearen berrabiarazpena';
...
$string['sitesectionhelp'] = 'Aukeratuz gero, gai batentzako atal bat erakutsiko da gunearen hasiera-orrian.';
