...
/**
 * Strings for component 'mimetypes', language 'eu', version '3.11'.
 *
 * @package     mimetypes
 * @category    string
...
$string['application/vnd.moodle.backup'] = 'Moodleren segurtasun-kopia';
...
$string['group:archive'] = 'Artxiboko fitxategiak';
