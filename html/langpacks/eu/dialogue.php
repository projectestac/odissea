...
/**
 * Strings for component 'dialogue', language 'eu', version '3.11'.
 *
 * @package     dialogue
 * @category    string
...
$string['configmaxattachments'] = 'Mezu batean gehi daitekeen gehienezko eranskin-kopuru lehenetsia.';
$string['configmaxbytes'] = 'Guneko elkarrizketa guztietarako gehienezko tamaina lehenetsia (ikastaroen mugen eta ezarpen lokalen menpekoa)';
...
$string['maxattachments_help'] = 'Ezarpen honek zehazten du mezu batean erants daitekeen gehienezko fitxategi-kopurua.';
$string['maxattachmentsize'] = 'Eranskinen gehienezko tamaina';
$string['maxattachmentsize_help'] = 'Ezarpen honek zehazten du mezu baten erants daitezkeen fitxategien gehienezko tamaina.';
