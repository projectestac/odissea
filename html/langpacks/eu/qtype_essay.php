...
$string['err_maxminmismatch'] = 'Gehienezko hitz kopurua gutxienezko hitz kopurua baino altuagoa izan behar da.';
$string['err_maxwordlimit'] = 'Gehienezko hitz kopurua gaituta dago baina ez dauka baliorik';
$string['err_maxwordlimitnegative'] = 'Gehienezko hitz kopurua ezin da zenbaki negatiboa izan';
$string['err_minwordlimit'] = 'Gutxienezko hitz kopurua gaituta dago baina ez dauka baliorik';
$string['err_minwordlimitnegative'] = 'Gutxienezko hitz kopurua ezin da zenbaki negatiboa izan';
...
$string['maxwordlimit'] = 'Gehienezko hitz kopurua';
...
$string['minwordlimit'] = 'Gutxienezko hitz kopurua';
...
$string['privacy:preference:maxbytes'] = 'Fitxategiaren gehienezko tamaina.';
...
$string['privacy:preference:responserequired'] = 'Ikaslea testua idaztera behartuta dagoen edo aukerazkoa den.';
...
$string['wordcounttoofew'] = 'Hitz kopurua: {$a->count}, gutxienezko {$a->limit} hitz-kopurua baino gutxiago.';
$string['wordcounttoomuch'] = 'Hitz kopurua: {$a->count}, gehienezko {$a->limit} hitz-kopurua baino gehiago.';
