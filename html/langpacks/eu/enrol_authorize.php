...
/**
 * Strings for component 'enrol_authorize', language 'eu', version '4.5'.
 *
...
$string['adminauthorizeccapture'] = 'Eskariaren berrikusketa aurreikusitako kobrantzaren ezarpenak';
$string['adminauthorizeemail'] = 'Posta elektronikoaren bidalketen ezarpenak';
...
$string['adminneworder'] = 'Kudeatzaile agurgarri hori:
  ...
  {$a->url}';
$string['adminnewordersubject'] = '{$a->course}: Ordainketa pendiente berria: ({$a->orderid})';
...
$string['authorize:unenrolself'] = 'Desmatrikulatu norbera ikastararotik';
$string['authorize:uploadcsv'] = 'Igo CSV fitxategia';
...
$string['reviewfailed'] = 'Berrikusketak kale egin du';
...
$string['uploadcsv'] = 'Igo CSV fitxategia';
...
$string['verifyaccountresult'] = '<b>Konprobazioaren emaitza: </b>{$a}';
