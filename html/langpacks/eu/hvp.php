...
/**
 * Strings for component 'hvp', language 'eu', version '4.5'.
 *
 * @package     hvp
 * @category    string
...
$string['acceptterms'] = 'Onartzen ditut <a href=":url" target="_blank">erabilera-baldintzak</a>';
...
$string['assistivetechnologieslabel'] = 'Laguntzarako-Teknologiak etiketa';
...
$string['cancelpublishconfirmationdialogtitle'] = 'Utzi partekatzea';
...
$string['changehasbeensubmitted'] = 'Aldaketa bat bidali da honetarako:';
...
$string['contactpersondescription'] = 'H5P kontakturako pertsonarekin harremanetan jarriko da partekatutako edukiarekin edozein kontu egonez gero. Kontakturako pertsonaren izena edo bestelako informazioa ez da publikatuko edo hirugarrenekoekin partekatuko.';
$string['contentavailable'] = 'Zure edukia normalean lanegun bateko tartean Bilgunean eskuragarri egongo da.';
$string['contentchanged'] = 'Eduki hau aldatu da azkenengoz erabili zenuenetik.';
$string['contentcopied'] = 'Edukia arbelera kopiatzen da';
$string['contenthub:changesettings'] = 'Aldatu kontuaren ezarpenak <a href="{$a}">hemen</a>';
$string['contenthub:licenseagreementdescription'] = 'Irakurri mesedez hurrengo onespena hurrengoarekin jarraitu aurretik:';
$string['contenthub:licenseagreementmaintext'] = 'EGITEKO';
$string['contenthub:licenseagreementtitle'] = 'Erabiltzaile-Lizentziaren Onespena (EULA)';
$string['contenthub:nopermissions'] = 'Ez duzu baimenik gunea eduki bilgunean erregistratzeko.';
$string['contenthub:register'] = 'Erregistratu kontu bat H5P Bilgunean <a href="{$a}">hemen</a>';
$string['contenthub:settings:box'] = 'Eduki Bilguneko Kontua';
$string['contenthub:settings:heading'] = 'H5P Bilguneko Kontuaren Ezarpenak';
$string['contenthubeditsharing'] = 'Editatu partekatze informazioa';
$string['contenthuboptions'] = 'H5P OER Bilgunearen Aukerak';
$string['contenthubsearchdescription'] = 'Bilatu eta deskargatu H5P Hub-etik partekatutako edukia.';
$string['contenthubsearchenable'] = 'Gaitu H5P Hub-etik partekatutako edukia';
$string['contenthubshare'] = 'Partekatu H5P Bilgunean';
$string['contenthubsharinginprogress'] = 'Partekatzen...';
$string['contenthubsyncchanges'] = 'Sinkronizatu aldaketak';
$string['contenthubunshare'] = 'Kendu partekatzea';
$string['contentissyncing'] = 'Edukia sinkronizatzen ari da.';
$string['contentlicensetitle'] = 'Edukiaren Lizentziaren Informazioa';
$string['contentnotshared'] = 'Edukia ez dago Bilgunean partekatuta.';
...
$string['contentupdatesoon'] = 'Zure eduki laster eguneratuko da';
...
$string['displayoptionauthoroff'] = 'Egileak kontrolatua, desgaituta modu lehenetsian';
$string['displayoptionauthoron'] = 'Egileak kontrolatua, gaituta modu lehenetsian';
...
$string['dropdownbutton'] = 'Aukera-botoia';
...
$string['enablesavecontentstate_help'] = 'Automatikoki gorde uneko H5P eduki interaktiboaren egoera erabiltzaile bakoitzarentzat. Horrela erabiltzaileak utzi zuen lekuan jarraitzeko aukera du.';
$string['failedtodownloadh5p'] = 'Eskatutako H5Paren deskargak huts egin du.';
$string['fileexceedsmaxsize'] = 'Paketeko fitxategietako batek gehieneko fitxategi-tamaina gainditzen du. (%file %used > %max)';
...
$string['gradeheading'] = '{$a}(e)rako emaitzak';
...
$string['hvp:contenthubregistration'] = 'Erregistratu gunea H5P Eduki Bilgunean';
...
$string['hvp:share'] = 'Partekatu edukia H5P OER Bilgunean';
...
$string['invalidhvp'] = 'H5P jarduera baliogabea';
...
$string['isnowsubmitted'] = 'H5P Bilgunera bidali da';
...
$string['keywordsexists'] = 'Hitz-gakoa dagoeneko existitzen da!';
...
$string['maximumgradeerror'] = 'Sartu zenbaki oso eta positibo baliagarria ekintza honetarako gehieneko puntuazio-gisa';
...
$string['modulename'] = 'H5P - Eduki interaktiboa';
...
$string['modulenameplural'] = 'H5P - Eduki interaktiboak';
...
$string['noexport'] = 'Esportatze-fitxategia falta da.';
$string['noextension'] = 'Igo duzun fitxategia ez da HTML5 pakete baliagarria (Ez dauka .h5p fitxategi-luzapena)';
$string['noh5ps'] = 'Ikastaro honetan ez dago H5P eduki interaktiborik.';
$string['nohubregistration'] = 'H5P Bilgunean erregistratu gabea';
...
$string['nopermissiontoviewcontenthubcache'] = 'Ez duzu eduki bilguneko metadatuak ikusteko baimenik.';
...
$string['privacy:metadata:hvp_xapi_results:max_score'] = 'Ekitaldian lortu daitekeen gehieneko puntuazioa.';
...
$string['registrationfaileddescription'] = 'Ezin izan dugu une honetan zure kontua sortu. Zerbaitek huts egin du. Saiatu zaitez berriro beranduago.';
$string['registrationtitle'] = 'H5P Bilgunearen Erregistroa';
$string['remove'] = 'Kendu';
...
$string['requiredinfo'] = 'Derrigorrezko Informazioa';
...
$string['reviewmessage'] = 'Berrikusi ezazu mesedez azpiko informazioa partekatu baino lehen';
...
$string['screenshots'] = 'Pantaila-irudiak';
$string['screenshotsdescription'] = 'Gehitu zure edukiaren bost pantaila-irudira arte';
$string['search'] = 'Bilatu';
$string['searchplaceholder'] = 'Idatzi diziplinak bilatzeko';
...
$string['sharetryagain'] = 'Zerbaitek huts egin du; saiatu zaitez berriro beranduago, mesedez.';
$string['sharingnote'] = 'Eduki guztien xehetasunak partekatu ondoren editatu daitezke.';
...
$string['size'] = 'Tamaina';
$string['somekeywordsexists'] = 'Hitz-gako hauetako batzuk dagoeneko existitzen dira';
...
$string['successfullyregistred'] = 'Zure H5P Bilguneko kontua ondo erregistratu da';
$string['successfullyregistreddescription'] = 'Zure kontuaren xehetasunak aldatu daitezke';
$string['successfullyupdated'] = 'Zure H5P Bilguneko kontuaren ezarpenak ondo eguneratu dira';
...
$string['unpackedfilesexceedsmaxsize'] = 'Erauzitako fitxategien guztirako tamainak baimendutako gehieneko tamaina gainditzen dute. (%used > %max)';
...
$string['uploadsizelargerthanpostsize'] = 'PHPn ezarritako igotzeko gehieneko tamaina argitaratze-tamaina baino handiago da. Hainbat instalaziotan honek arazoak sortu izan ditu.';
