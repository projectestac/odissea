...
/**
 * Strings for component 'my', language 'eu', version '4.1'.
 *
 * @package     my
 * @category    string
...
$string['coursemanagementoptions'] = 'Ikastaro-kudeaketako aukerak';
...
$string['error:dashboardisdisabled'] = 'Kudeatzaileak Aginte-panela desgaitu du.';
$string['managepages'] = 'Kudeatu orriak';
$string['mymoodle'] = 'Aginte-panela';
$string['nocourses'] = 'Ez dago ikastaroei buruzko informaziorik';
$string['noguest'] = 'Aginte-panela ez dago gonbidatuentzako eskuragarri';
$string['pinblocks'] = 'Konfiguratu nire Moodlerako ainguratutako blokeak';
$string['pinblocksexplan'] = 'Hemen ezartzen duzun edozin bloke ikusiko du (baina ezingo du editatu) Moodleren edozein erabiltzailek bere "Nire Moodle" orrian.';
$string['privacy:metadata:core_my:preference:user_home_page_preference'] = 'Erabiltzailearen hasiera-orriaren hobespena.';
