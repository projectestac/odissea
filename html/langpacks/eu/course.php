...
</br><br/>{$a->coursename} ikastaroko hainbat ikasle ez da inoiz ikastaroan sartu.';
...
</br><br/>{$a->coursename} ikastaroko hainbat ikasle ez da berriki ikastaroan sartu.';
$string['noteachinginfomessage'] = 'Kaixo {$a->userfirstname},

</br><br/>Datorren astean hasiera-data duten ikastaroak irakasle edo ikaslerik ez dutela antzeman da.';
...
</br><br/>{$a->coursename} ikastaroan bertan behera uzteko arriskuan dauden ikasleak daudela antzeman da.';
