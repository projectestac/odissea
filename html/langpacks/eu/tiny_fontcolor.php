...
/**
 * Strings for component 'tiny_fontcolor', language 'eu', version '4.4'.
 *
...
$string['errorupdatingthemescss'] = 'CSS klaseak ezin dira azalaren ezarpenetan gorde.';
$string['fontcolor:use'] = 'Erabili Tiny testuaren kolorea';
...
$string['usecssclassnames'] = 'Erabili CSS klase-izenak HTMLko kolore-kodeen gainean.';
$string['usecssclassnames_desc'] = 'Aukera hau markatuta badago, kolorea style atributu batean zehaztu ordez CSS klase-izen bat erabiltzen da. Kolorearen definizioa duten CSS klaseak azalaren SCSS ezarpenean kokatuko dira. Klase-izenak kolorearen izen deskriptibotik automatikoki sortuko dira. Ezarpen hau erabiltzean edukiak Moodle instantziatik kanpora transferitzea zailtzen du. Informazio gehiagorako irakurri ezazu dokumentazioa.';
