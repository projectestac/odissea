...
/**
 * Strings for component 'resource', language 'eu', version '4.5'.
 *
 * @package     resource
 * @category    string
...
$string['clicktodownload'] = 'Egin klik {$a} estekari fitxategia jaisteko.';
$string['clicktoopen2'] = 'Egin klik {$a} estekari fitxategia ikusteko.';
...
$string['configpopupheight'] = 'Zein altuera lehenetsi behar zaie popup leihoei?';
