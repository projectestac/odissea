...
/**
 * Strings for component 'gradereport_singleview', language 'eu', version '4.5'.
 *
...
$string['gradeitem'] = '{$a} kalifikazio-elementuaren kalifikazioak ikusten';
$string['gradeitemcannotbeoverridden'] = 'Kalifikazio-elementu hau ezin da baliogabetu.';
$string['gradeitemedit'] = '{$a} kalifikazio-elementuaren kalifikazioak editatzen';
$string['gradeuser'] = '{$a} erabiltzailearen kalifikazioak ikusten';
$string['gradeuseredit'] = '{$a} erabiltzailearen kalifikazioak editatzen';
$string['itemsperpage'] = 'Elementuak orriko';
$string['noscreens'] = 'Ez da aurkitu banakako ikuspegia pantaila egokirik.';
