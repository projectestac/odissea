...
/**
 * Strings for component 'mnet', language 'eu', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['currentkey'] = 'Oraingo gako publikoa';
...
$string['deleteoutoftime'] = 'Gako hau ezabatzeko 60 segundoko leihoa iraungi da. Mesedez, hasi berriz.';
...
$string['error7026'] = 'Zure mezua sinatzeko erabili zen gakoa ez da urruneko ostalariak zure zerbitzarirako duen gakoarekin bat etortzen. Horretaz gain, urruneko ostalaria zure oraingo gakoa eskuratzen saiatu da eta saiakerak huts egin du. Mesedez, urruneko ostalariaren gakoa eguneratu eta saiatu berriro.';
$string['error709'] = 'Urrutiko guneak ezin izan du SSL gakoa lortu zuretzat.';
...
$string['invalidpubkey'] = 'Gakoa ez da SSL gako baliagarria. ({$a})';
...
$string['ispublished'] = '{$a}(e)k zerbitzu hau gaitu du zuretzat.';
...
$string['notPEM'] = 'Gako hau ez dago PEM formatuan. Ez du funtzionatuko.';
...
$string['profilefielddesc'] = 'Hemen MNet bitartez erabiltzaile-kontu berriak sortzean edo eguneratzean bidaliko diren profil-eremuen zerrenda konfigura dezakezu. Hau MNet kide bakoitzarentzat ere baliogabe dezakezu. Kontuan izan eremu hauek beti bidaltzen direla eta ez direla hautazkoak: {$a}';
...
$string['publickey_help'] = 'Gako publikoa automatikoki lortzen da urrutiko zerbitzaritik.';
$string['publickeyrequired'] = 'Gako publikoa eman behar duzu.';
