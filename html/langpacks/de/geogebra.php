...
/**
 * Strings for component 'geogebra', language 'de', version '4.5'.
 *
 * @package     geogebra
 * @category    string
...
$string['height'] = 'Höhe';
$string['height_help'] = 'Wert in Pixel. Muss größer als Null sein.';
...
$string['width'] = 'Breite';
$string['width_help'] = 'Wert in Pixel. Muss größer als Null sein.';
