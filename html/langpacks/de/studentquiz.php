...
$string['approveselectedscheck'] = 'Möchten Sie wirklich die folgenden Fragen ablehnen/bestätigen?<br /><br />{$a}';
...
$string['emaildigestbody_section_content'] = 'Ihre Frage <b>{$a->questionname}</b> wurde von <b>{$a->actorname}</b> <b>{$a->actiontype}</b> <b>{$a->actorname}</b>';
$string['emaildigestbody_section_title'] = 'Benachrichtigun {$a->seq}, {$a->timestamp}';
...
$string['lastattempt_right_label'] = 'Letzter korrekter Versuch';
$string['lastattempt_wrong'] = '✗';
$string['lastattempt_wrong_label'] = 'Letzter inkorrekter Versuch';
...
$string['not_approved'] = '✗';
$string['notshowratingcomment'] = 'Hinweis: Bewertung und Kommentar sind im Vorschau-Modus für Ihre eigene Frage nicht verfügbar.';
...
$string['privacy:metadata:studentquiz_comment:usermodified'] = 'Id der/s Nutzer/in, die/der den Kommentar bearbeitete';
...
$string['privacy:metadata:studentquiz_comment_history:userid'] = 'Id der/s Nutzer/in, die/der den Kommentar bearbeitete';
...
$string['setting_question_publishing_help'] = 'Veröffentlichte Fragen erscheinen im Fragepool für andere Studierende. <br> Diese Einstellung kann nicht mehr verändert werden, wenn eine Frage in StudentQuiz erstellt wurde.';
...
$string['settings_comment_editor_toolbar_des'] = 'Die Liste der Plugins und die Reihenfolge, in der sie angezeigt werden, kann hier konfiguriert werden';
...
$string['studentquiz:emailnotifyquestion'] = 'E-Mail-Benachrichtigungs-Frage';
