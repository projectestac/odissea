...
$string['check_crawlers_details'] = '<p>Die Einstellung \'Offen für Suchmaschinen\' erlaubt es allen Suchmaschinen, die für Gäste offenen Kurse zu durchsuchen. Es ist nicht sinnvoll, diese Funktion zu aktivieren, wenn der Gastzugang deaktiviert ist.</p>';
$string['check_crawlers_error'] = 'Zugang für Suchmaschinen aktiviert, aber der Gastzugang ist deaktiviert.';
$string['check_crawlers_info'] = 'Suchmaschinen können auf Kursinhalte als Gäste zugreifen.';
$string['check_crawlers_name'] = 'Zugang für Suchmaschinen aktiviert';
$string['check_crawlers_ok'] = 'Zugang für Suchmaschinen deaktiviert';
...
$string['check_openprofiles_ok'] = 'Eine Anmeldung ist notwendig, um Nutzerprofile sehen zu können.';
