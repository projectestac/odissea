...
/**
 * Strings for component 'group', language 'de', version '4.5'.
 *
 * @package     group
 * @category    string
...
$string['deleteallgroupings'] = 'Alle Gruppierungen';
$string['deleteallgroups'] = 'Alle Gruppen';
...
$string['groupingnameexists'] = 'In diesem Kurs gibt es bereits eine Gruppierung \'{$a}\'. Wählen Sie einen anderen Namen.';
...
$string['nogroups'] = 'In diesem Kurs gibt es bisher keine Gruppen.';
...
$string['number'] = 'Anzahl von Gruppen oder Mitgliedern';
$string['numgroups'] = 'Anzahl von Gruppen';
$string['nummembers'] = 'Mitglieder pro Gruppe';
...
$string['removegroupingsmembers'] = 'Alle Gruppen aus den Gruppierungen';
$string['removegroupsmembers'] = 'Alle Gruppenmitglieder';
