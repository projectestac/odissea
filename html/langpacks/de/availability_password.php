...
/**
 * Strings for component 'availability_password', language 'de', version '3.11'.
 *
...
$string['passwordintro'] = 'Der Zugriff zu <em>{$a}</em> ist durch ein Kennwort geschützt.<br />Wenn Sie das Kennwort nicht kennen, fragen Sie bitte Ihre Trainer/innen.';
$string['passwordprotection'] = 'Kennwort erforderlich';
$string['permanently'] = 'Dauerhaft';
$string['pluginname'] = 'Voraussetzung: Kennwort';
$string['privacy:metadata:availability_password_grant'] = 'Info zu allen Nutzer/innen, die das Kennwort für die gegebene Aktivität korrekt eingegeben haben.';
$string['privacy:metadata:availability_password_grant:cmid'] = 'Aktivitäts-ID, für die das Kennwort eingegeben wurde.';
$string['privacy:metadata:availability_password_grant:courseid'] = 'Kurs-ID, in dem das Kennwort eingegeben wurde.';
...
$string['requires_nopassword'] = 'Sie haben ein falsches Kennwort eingegeben.';
$string['requires_password'] = 'Sie geben das richtige Kennwort ein.';
$string['title'] = 'Kennwort';
$string['untillogout'] = 'Bis zum Logout';
