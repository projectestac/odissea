...
$string['icon'] = 'Icon';
$string['iconDescription'] = '640x480px. Wenn nicht ausgewählt, wird der Inhalt das Kategorie-Icon verwenden.';
...
$string['shareTryAgain'] = 'Die Verbindung zum H5P-Hub konnte nicht hergestellt werden. Versuchen Sie es später nochmal.';
