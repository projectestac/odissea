...
/**
 * Strings for component 'form', language 'de', version '4.1'.
 *
 * @package     form
 * @category    string
...
$string['err_lettersonly'] = 'Sie dürfen hier nur Buchstaben eingeben.';
$string['err_maxfiles'] = 'Sie können hier höchstens {$a} Dateien anhängen.';
$string['err_maxlength'] = 'Sie dürfen nur maximal {$a->format} Zeichen eingeben.';
$string['err_minlength'] = 'Sie müssen hier mindestens {$a->format} Buchstaben eingeben.';
...
$string['novalueclicktoset'] = 'Anklicken zur Texteingabe';
$string['optional'] = 'Optional';
$string['othersettings'] = 'Andere Einstellungen';
$string['passwordunmaskedithint'] = 'Kennwort ändern';
$string['passwordunmaskinstructions'] = 'Drücken Sie Enter, um Änderungen zu speichern';
...
$string['somefieldsrequired'] = '{$a} notwendig';
