...
$string['backupfailed'] = 'Wiederherstellung fehlgeschlagen';
...
$string['dataprefquestion'] = '<p>Um die Verwendung dieser Website zu vereinfachen, speichern wir in Ihrem Browser Funktionsinformationen, z.B. den Inhalt der zuletzt geöffneten Kachel. Dies bleibt für kurze Zeit auf Ihrem Computer, falls Sie diese Seite erneut besuchen. Wir verwenden es nicht zur Verfolgung. Ist das in Ordnung?</p>
<p>Wir werden uns an Ihre Wahl erinnern, bis Sie Ihren Browserverlauf gelöscht haben. Klicken Sie zum Deaktivieren auf "Abbrechen" (dies kann zu langen Ladezeiten der Seite führen).</p>';
