...
/**
 * Strings for component 'adaptivequiz', language 'de', version '4.4'.
 *
...
$string['attemptquestion_rightwrong'] = 'Antwort Richtig/Falsch';
...
$string['errorfetchingquest'] = 'Es konnte keine Frage mit der Schwierigkeit {$a->level} abgerufen werden';
...
$string['reportanswersdistributionchartdisplaystacked'] = 'Als gestapelte Balken anzeigen';
$string['reportanswersdistributionchartnumrightlabel'] = 'Anzahl richtig beantworteter Fragen';
$string['reportanswersdistributionchartnumwronglabel'] = 'Anzahl falsch beantworteter Fragen';
$string['reportanswersdistributionchartxaxislabel'] = 'Frage-Schwierigkeit';
$string['reportanswersdistributionchartyaxislabel'] = 'Anzahl der Fragen';
$string['reportattemptadmanswerright'] = 'C';
$string['reportattemptadmanswerwrong'] = 'W';
$string['reportattemptadmchartadmdifflabel'] = 'Schwierigkeit bei der Testdurchführung';
$string['reportattemptadmcharttargetdifflabel'] = 'Ziel-Schwierigkeit';
