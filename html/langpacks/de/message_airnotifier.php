...
$string['configairnotifieraccesskey'] = 'Zugriffsschlüssel für die Verbindung zum Airnotifier-Server. Sie erhalten einen Zugriffsschlüssel, indem Sie unten auf den Link "Zugriffsschlüssel anfordern" klicken (nur für registrierte Websites) oder indem Sie ein Konto im <a href="https://apps.moodle.com">Moodle Apps Portal</a> erstellen.';
