...
$string['completionattemptsexhausteddesc'] = 'Abgeschlossen, wenn alle verfügbaren Versuche ausgeschöpft sind';
...
$string['completionpass'] = 'Erreichen der Bestehensnote notwendig';
...
$string['configgrademethod'] = 'Welche Methode soll zur Berechnung der Teilnehmendenbewertung im Test herangezogen werden, wenn mehrere Versuche erlaubt sind?';
...
$string['gradetopassmustbeset'] = 'Die Bestehensnote kann nicht Null sein, da dieser Test als Aktivitätsabschluss eine Bestehensnote verlangt. Setzen Sie bitte einen Wert ungleich Null.';
$string['gradetopassnotset'] = 'Dieser Test hat noch keine Bestehensgrenze. Sie können diese im Abschnitt \'Bewertung\' bei den Testeinstellungen festlegen.';
...
$string['marks'] = 'Punkte';
$string['marks_help'] = 'Bewertungen für jede Frage und das Gesamtergebnis für den Versuch.';
...
$string['reportattemptsthatare'] = 'Versuche von';
...
$string['upgradesure'] = '<div>Das Testmodul nimmt eine Reihe von weitreichenden Veränderungen an den Datenbanktabellen vor. Diese Upgrade-Funktion wurde noch nicht sehr umfassend getestet. Sie sollten daher unbedingt eine Sicherung Ihrer Datenbank vornehmen, bevor Sie fortfahren.</div>';
