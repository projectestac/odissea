...
$string['nopublicationsincourse'] = 'In diesem Kurs gibt es keine Studierendenordner.';
...
$string['notice_uploadnoapproval'] = 'Dateien, die Sie hier hochladen, werden sofort für andere sichtbar geschaltet. Trainer/innen behalten sich das Recht vor die Sichtbarkeit Ihrer Dateien wieder aufzuheben.';
$string['notice_uploadrequireapproval'] = 'Dateien, die Sie hier hochladen, werden erst nach Überprüfung durch die Trainer/innen für andere sichtbar.';
...
$string['studentapproval_help'] = 'In der Spalte "Status" wird die Rückmeldung angezeigt:
