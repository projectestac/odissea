...
/**
 * Strings for component 'qtype_kprime', language 'de', version '3.11'.
 *
...
$string['configshuffleanswers'] = 'Standardmäßige Einstellung für das Mischen von Optionen in KPrim-Fragen.';
$string['correctresponse'] = 'Richtige Antwort';
$string['deletedchoice'] = 'Diese Auswahl wurde nach Beginn des Versuchs gelöscht.';
...
$string['privacy:metadata'] = 'Der Fragetyp \'Kprim\' speichert keine personenbezogenen Daten.';
...
$string['scoringkprimeonezero'] = 'Kprim 1/0';
$string['scoringkprimeonezero_help'] = 'Bei der Auswahl „Kprim 1/0“ erhalten Kandidat/innen die volle Punktzahl, wenn alle Wahlantworten richtig bewertet wurden und sonst null Punkte.';
...
$string['shuffleanswers_help'] = 'Wenn diese Option aktiviert ist, werden die Antworten bei jedem Versuch in einer zufälligen Reihenfolge angezeigt, vorausgesetzt, dass "Fragen mischen" in den Aktivitätseinstellungen ebenfalls aktiviert ist.';
$string['stem'] = 'Stamm';
