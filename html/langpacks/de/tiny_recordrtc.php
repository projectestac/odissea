...
/**
 * Strings for component 'tiny_recordrtc', language 'de', version '4.1'.
 *
...
$string['audiobuttontitle'] = 'Audio aufnehmen';
$string['audiotimelimit'] = 'Audio-Zeitlimit';
$string['audiotimelimit_desc'] = 'Maximal erlaubte Aufnahmezeit für Audio-Clips (in Sekunden)';
$string['audiotitle'] = 'Audio aufnehmen';
...
$string['recordagain_desc'] = 'Sie haben bereits einige Inhalte aufgezeichnet. Durch die Neuaufnahme wird dieser Inhalt entfernt. <br>Machen Sie wirklich die Aufnahme zurücksetzen?';
$string['recordagain_title'] = '\'Aufnahme wiederholen\' bestätigen';
$string['recordingfailed'] = 'Aufnahme fehlgeschlagen. Versuchen Sie es noch einmal.';
...
$string['uploadfailed'] = 'Hochladen fehlgeschlagen mit Fehler: {$a->error}';
$string['uploadfailed404'] = 'Hochladen fehlgeschlagen: Datei zu groß';
$string['uploading'] = 'Hochladen - {$a->progress}%';
