...
/**
 * Strings for component 'auth_lti', language 'de', version '4.5'.
 *
 * @package     auth_lti
 * @category    string
...
$string['mustbeloggedin'] = 'Melden Sie sich an, um Ihr bestehendes Konto zu verknüpfen.';
...
$string['privacy:metadata:auth_lti:userid'] = 'ID des Nutzerkontos, zu dem die LTI-Anmeldung verbunden ist';
