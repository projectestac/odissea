...
/**
 * Strings for component 'hotpot', language 'de', version '4.5'.
 *
 * @package     hotpot
 * @category    string
...
$string['outputformat_hp_6_jcloze_html'] = 'JCloze (v6) aus html';
$string['outputformat_hp_6_jcloze_html_dropdown'] = 'DropDown aus html';
...
$string['outputformat_hp_6_jcloze_html_jgloss'] = 'JGloss aus html';
$string['outputformat_hp_6_jcloze_xml_anctscan'] = 'ANCT-Scan aus JCloze HP6 xml';
$string['outputformat_hp_6_jcloze_xml_dropdown'] = 'DropDown aus JCloze HP6 xml';
$string['outputformat_hp_6_jcloze_xml_findit_a'] = 'FindIt (a) aus JCloze HP6 xml';
$string['outputformat_hp_6_jcloze_xml_findit_b'] = 'FindIt (b) aus JCloze HP6 xml';
$string['outputformat_hp_6_jcloze_xml_jgloss'] = 'JGloss aus JCloze HP6 xml';
$string['outputformat_hp_6_jcloze_xml_v6'] = 'JCloze (v6) xml aus HP6.XML';
$string['outputformat_hp_6_jcloze_xml_v6_autoadvance'] = 'JCloze (v6) aus xml (Auto-advance)';
$string['outputformat_hp_6_jcross_html'] = 'JCross (v6) aus html';
$string['outputformat_hp_6_jcross_xml_v6'] = 'JCross (v6) aus xml';
$string['outputformat_hp_6_jmatch_html'] = 'JMatch (v6) aus html';
$string['outputformat_hp_6_jmatch_html_sort'] = 'JMatch Sort aus html';
$string['outputformat_hp_6_jmatch_xml_flashcard'] = 'JMatch (flashcard) aus xml';
$string['outputformat_hp_6_jmatch_xml_jmemori'] = 'JMemori aus xml';
$string['outputformat_hp_6_jmatch_xml_sort'] = 'JMatch Sort aus xml';
$string['outputformat_hp_6_jmatch_xml_v6'] = 'JMatch (v6) aus xml';
$string['outputformat_hp_6_jmatch_xml_v6_plus'] = 'JMatch (v6+) aus xml';
$string['outputformat_hp_6_jmix_html'] = 'JMix (v6) aus html';
$string['outputformat_hp_6_jmix_xml_v6'] = 'JMix (v6) aus xml';
$string['outputformat_hp_6_jmix_xml_v6_plus'] = 'JMix (v6+) aus xml';
$string['outputformat_hp_6_jmix_xml_v6_plus_deluxe'] = 'JMix (v6+ with prefix, suffix with distractors) aus xml';
$string['outputformat_hp_6_jmix_xml_v6_plus_keypress'] = 'JMix (v6+ with key press) aus xml';
$string['outputformat_hp_6_jquiz_html'] = 'JQuiz (v6) aus html';
$string['outputformat_hp_6_jquiz_xml_v6'] = 'JQuiz (v6) aus xml';
$string['outputformat_hp_6_jquiz_xml_v6_autoadvance'] = 'JQuiz (v6) aus xml (Auto-advance)';
$string['outputformat_hp_6_jquiz_xml_v6_exam'] = 'JQuiz (v6) aus xml (Exam)';
$string['outputformat_hp_6_rhubarb_html'] = 'Rhubarb (v6) aus html';
$string['outputformat_hp_6_rhubarb_xml'] = 'Rhubarb (v6) aus xml';
$string['outputformat_hp_6_sequitur_html'] = 'Sequitur (v6) aus html';
$string['outputformat_hp_6_sequitur_html_incremental'] = 'Sequitur (v6) aus html, incremental scoring';
$string['outputformat_hp_6_sequitur_xml'] = 'Sequitur (v6) aus xml';
$string['outputformat_hp_6_sequitur_xml_incremental'] = 'Sequitur (v6) aus xml, incremental scoring';
...
$string['privacy:metadata:hotpot_attempts'] = 'Infos zu Nutzerversuchen bei HotPot-Aktivitäten';
$string['privacy:metadata:hotpot_attempts:attempt'] = 'Versuch, der die Anzahl der Versuche der Person zeigt';
$string['privacy:metadata:hotpot_attempts:clickreportid'] = 'Clickreportid, die die ID des Klicks der Person angibt';
$string['privacy:metadata:hotpot_attempts:endtime'] = 'Zeit, wann die Versuche der Person beendet wurden';
$string['privacy:metadata:hotpot_attempts:hotpotid'] = 'ID der Versuche von HotPot-Aktivitäten';
$string['privacy:metadata:hotpot_attempts:penalties'] = 'Abzüge, die die Person für die Versuche erhalten hat';
$string['privacy:metadata:hotpot_attempts:score'] = 'Punktzahl, die die Person für die Versuche erhalten hat';
$string['privacy:metadata:hotpot_attempts:starttime'] = 'Zeit, wann die Versuche von der Person gestartet wurden';
$string['privacy:metadata:hotpot_attempts:status'] = 'Status, der den Status der Versuche der Person angibt';
$string['privacy:metadata:hotpot_attempts:timefinish'] = 'Zeit, wann die Versuche von der Person beendet wurden';
$string['privacy:metadata:hotpot_attempts:timemodified'] = 'Zeit, wann die HotPot-Versuche von der Person geändert wurden';
$string['privacy:metadata:hotpot_attempts:timestart'] = 'Zeit, wann die Versuche von der Person gestartet wurden';
$string['privacy:metadata:hotpot_attempts:userid'] = 'ID der Person, die die HotPot-Aktivitäten versucht';
