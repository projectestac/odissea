...
/**
 * Strings for component 'enrol_ldap', language 'de', version '3.11'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['course_shortname_key'] = 'Kurzer Kursname';
