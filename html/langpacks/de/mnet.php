...
/**
 * Strings for component 'mnet', language 'de', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['addnewhost'] = 'Neuen Host hinzufügen';
...
$string['configmnet'] = 'MNet ermöglicht den Datenaustausch dieses Servers mit anderen Servern oder Services.';
...
$string['deletedhosts'] = 'Gelöschte Hosts: {$a}';
$string['deletehost'] = 'Host entfernen';
$string['deletekeycheck'] = 'Möchten Sie diesen PublicKey wirklich löschen?';
$string['deleteoutoftime'] = 'Das Zeitfenster zum Löschen des PublicKey beträgt 60 Sekunden und ist abgelaufen. Versuchen Sie es nochmal.';
...
$string['error7026'] = 'Der Schlüssel, mit dem Ihre Nachricht signiert wurde, unterscheidet sich vom Schlüssel, den der Remote-Server für Ihre Website gespeichert hat. Zusätzlich ist der Remote-Server bei dem Versuch gescheitert, Ihren aktuellen Schlüssel automatisch zu holen. Greifen Sie manuell ein (re-key) und versuchen Sie es nochmal.';
...
$string['mnetidprovidermsg'] = 'Die Anmeldung bei Ihrem Provider {$a} sollte möglich sein.';
...
$string['privacy:metadata'] = 'Das MNet Plugin speichert keine personenbezogenen Daten.';
...
$string['registerallhostsexplain'] = 'Diese Funktion ermöglicht die automatische Registrierung aller Server, die eine Verbindung herstellen wollen. Das bedeutet, es wird ein Datensatz in der Hostliste angelegt und der PublicKey für alle anfragenden Systeme zur Verfügung gestellt. <br />Weiter unten können Sie Dienste für "Alle Hosts" konfigurieren und Services aktivieren, die unterschiedslos allen bereitgestellt werden.';
...
$string['servicesavailableonhost'] = 'Verfügbare Services auf {$a}';
$string['serviceswepublish'] = 'Von uns veröffentlichte Services für {$a}';
$string['serviceswesubscribeto'] = 'Von uns abonnierte Services von {$a}';
