...
$string['alternatelogin'] = 'Bei der Eingabe einer URL wird diese als alternative Anmeldeseite verwandt. Die Seite sollte ein Formular enthalten, dessen Aktionsfunktion auf <strong>\'{$a}\'</strong> gesetzt ist und außerdem die Eingabefelder <strong>username</strong> und <strong>password</strong> zurück liefert.<br />Seien Sie sehr sorgfältig bei der Angabe der URL, denn mit einer falschen URL schließen Sie sich selber vom Zugriff zur Website aus. Lassen Sie das Feld leer, um die standardmäßige Anmeldeseite zu verwenden.';
$string['alternateloginurl'] = 'Alternative Anmelde-URL';
...
$string['auth_loginpasswordtoggle_desc'] = 'Icon im Kennwortfeld hinzufügen, das Nutzer/innen beim Anmelden erlaubt, ihr eingegebenes Kennwort im Klartext anzuzeigen.';
$string['auth_loginrecaptcha'] = 'reCAPTCHA für die Anmeldung aktivieren';
$string['auth_loginrecaptcha_desc'] = 'Fügen Sie der Anmeldeseite ein visuelles/akustisches Bestätigungselement hinzu. Dies verringert das Risiko unberechtigter Anmeldeversuche. Weitere Infos finden Sie unter <a href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['guestloginbutton'] = 'Gastanmeldung';
...
$string['update_onlogin'] = 'Bei jeder Anmeldung';
