...
$string['mgmt_cat_analytics_desc'] = 'Werkzeuge zur Analyse des Engagements von Teilnehmer/innen und ihrer Leistungen in Testfragen.';
$string['mgmt_cat_analytics_title'] = 'Analyse';
$string['mgmt_cat_dataexport_desc'] = 'Werkzeuge zum Exportieren von Daten zu Testversuchen für Analyse- und Forschungszwecke.';
$string['mgmt_cat_dataexport_title'] = 'Datenexport';
$string['mgmt_cat_maintenance_desc'] = 'Werkzeuge zur Pflege von Fragensammlungen und zur Gewährleistung der Datenbankintegrität.';
$string['mgmt_cat_maintenance_title'] = 'Wartung';
$string['mgmt_cat_prototype_desc'] = 'Werkzeuge zur Verwaltung und Analyse von CodeRunner-Fragenprototypen.';
$string['mgmt_cat_prototype_title'] = 'Verwaltung der Prototypen';
$string['mgmt_cat_testing_desc'] = 'Werkzeuge zum Testen von Fragen und zum Durchsuchen von Fragensammlungen.';
$string['mgmt_cat_testing_title'] = 'Prüfung und Validierung';
$string['mgmt_intro'] = 'Zentrale Anlaufstelle für die Verwaltungs- und Management-Tools von CodeRunner. Wählen Sie unten eine Kategorie aus, um auf die gewünschten Tools zuzugreifen.';
$string['mgmt_open_tool'] = 'Extras öffnen →';
$string['mgmt_page_heading'] = 'CodeRunner Einstellungsseite';
$string['mgmt_page_title'] = 'CodeRunner Einstellungen';
$string['mgmt_tool_analytics_quiztrajectory_desc'] = 'Punktzahl von Teilnehmer/innen bei einem ausgewählten Test im Zeitverlauf darstellen. Dies ist nur für adaptive Verhaltenstest aussagekräftig. Vertikale gepunktete Linien zeigen an, wann ein/e Teilnehmer/in eine Pause eingelegt hat, die länger war als der festgelegte Schwellenwert für die Inaktivitätslücke.';
$string['mgmt_tool_analytics_quiztrajectory_title'] = 'Entwicklung der Punktezahl';
$string['mgmt_tool_analytics_studenttime_desc'] = 'Verweildauer von Teilnehmer/innen in einem Kurs auf dem Server anhand der Moodle-Protokollereignisse einschätzen. Ein/e Teilnehmer/in gilt als inaktiv, wenn die Zeit zwischen zwei Klicks den festgelegten Schwellenwert für die Inaktivitätslücke überschreitet. Filterung nach Aktivität, Gruppe und Datumsbereich sind möglich.';
$string['mgmt_tool_analytics_studenttime_title'] = 'Verweildauer von Teilnehmer/innen am Server';
$string['mgmt_tool_bulktester_desc'] = 'Mehrere CodeRunner-Fragen gleichzeitig testen, um sicherzustellen, dass diese korrekt funktionieren. Führen Sie alle Tests für ausgewählte Fragengruppen durch und sehen Sie sich die detaillierten Ergebnisse an.';
$string['mgmt_tool_bulktester_title'] = 'Sammelüberpüfung der Fragen';
$string['mgmt_tool_cachepurge_desc'] = 'Der CodeRunner-Job „Cache löschen“ wird für ausgewählte Kurse oder Kontexte ausgeführt. Dies reduziert den Speicherplatzbedarf. Erforderlich nach Updates der Jobe-Server, die die Ausführungsergebnisse beeinflussen könnten.';
$string['mgmt_tool_cachepurge_title'] = 'Cache leeren';
$string['mgmt_tool_deleteold_desc'] = 'Bereinigen Sie überladene Fragensammlungen, indem Sie alte Fragenversionen löschen und nur die aktuellste Version jeder Frage (sowie alle anderen, die ausdrücklich in Tests verwendet werden) beibehalten. Funktioniert für alle Fragetypen. Nur für Administratoren.';
$string['mgmt_tool_deleteold_title'] = 'Löschen alter Fragenversionen';
$string['mgmt_tool_downloadattempts_anon_desc'] = 'Exportieren Sie zur weiteren Analyse anonymisierte Daten von Testantworten.  Dabei werden personenbezogene Daten entfernt, damit die Daten in Studien verwendet werden können, die einer datenschutzrechtlichen Genehmigung unterliegen.';
$string['mgmt_tool_downloadattempts_anon_title'] = 'Testantworten herunterladen (anonymisiert)';
$string['mgmt_tool_downloadattempts_desc'] = 'Exportieren Sie zur weiteren Analyse die Daten von Testantworten. Laden Sie die Antworten der Schüler/-innen, die Programmbeispiele und die Ergebnisse in verschiedenen Formaten herunter, um die Benotung zu überprüfen und zu analysieren.';
$string['mgmt_tool_downloadattempts_title'] = 'Testantworten herunterladen';
$string['mgmt_tool_prototypeusage_desc'] = 'Analysiert, welche Prototypen in einer ausgewählten Fragenbank oder einem ausgewählten Fragenkontext verwendet werden. Zeigt Nutzungsstatistiken und ungenutzte Prototypen innerhalb des ausgewählten Kontexts an.';
$string['mgmt_tool_prototypeusage_title'] = 'Verwendung als Prototyp';
$string['mgmt_tool_questionbrowser_desc'] = 'Durchsuchen der Fragen in CodeRunner. Zeigt den Fragetext, die Antwort, die Schlagwörter sowie die Verwendungshäufigkeit der Fragen an. Fragen in der Fragenbank in der Vorschau anzeigen oder bearbeiten.  Nützlich zum Suchen und Überprüfen von Fragen.';
...
$string['noquestionstopurge'] = 'Keiner der Kontexte, auf die Sie Zugriff haben, enthält zwischengespeicherte Ergebnisse.';
...
$string['purgeoldcacheentriestaskname'] = 'Alte Cache-Einträge des Coderunner-Dateispeichers löschen – Prozess';
...
$string['qb_add_rule'] = '+ Regel hinzufügen';
$string['qb_advanced_filters'] = 'Erweiterte Filtereinstellungen';
$string['qb_advanced_filters_hint'] = 'Erstellen von komplexen Filterregeln mit UND/ODER-Logik';
$string['qb_alert_bad_regex'] = 'Ungültiges Regex-Muster';
$string['qb_alert_max_rules'] = 'Maximal 6 Filterregeln zulässig';
$string['qb_alert_no_bank_params'] = 'Fehlende Parameter der Fragensammlung';
$string['qb_alert_no_id'] = 'Keine Frage-ID für die Vorschau verfügbar';
$string['qb_any'] = 'Jede/r';
$string['qb_apply_filters'] = 'Filter anwenden';
$string['qb_available_contexts'] = 'Verfügbare Kontexte ({$a})';
$string['qb_btn_answer'] = 'Antwort';
$string['qb_btn_close'] = 'Schließen';
$string['qb_btn_json'] = 'JSON';
$string['qb_btn_preview'] = 'Vorschau';
$string['qb_btn_question'] = 'Frage';
$string['qb_clear'] = 'Löschen';
$string['qb_coderunner_type'] = 'CodeRunner-Typ';
$string['qb_col_actions'] = 'Aktion';
$string['qb_col_category'] = 'Kategorie ↕';
$string['qb_col_name'] = 'Name ↕';
$string['qb_col_tags'] = 'Schlagwort ↕';
$string['qb_col_usedin'] = 'Verwendet in ↕';
$string['qb_data'] = 'Daten';
$string['qb_exclude'] = 'Ausgeschlossen';
$string['qb_export_csv'] = 'Export CSV';
$string['qb_export_json'] = 'Export JSON';
$string['qb_field'] = 'Datenfeld';
$string['qb_filter_tip'] = 'Tipp: Alle Filter werden mit der UND-Logik verknüpft. Erweiterte Filter bieten ODER-Optionen.';
$string['qb_filters'] = 'Filter';
$string['qb_include'] = 'Einbeziehen';
$string['qb_index_instructions'] = '<strong>Anleitung:</strong> Auf „Fragen durchsuchen“ klicken, um den Fragenbrowser für diesen Kontext zu öffnen.';
$string['qb_index_intro'] = 'Auswählen eines Kontexts, um CodeRunner-Fragen mit erweiterten Metadaten und Filterfunktionen zu durchsuchen.';
$string['qb_index_title'] = 'CodeRunner-Fragenbrowser';
$string['qb_lines_of_code'] = 'Codezeilen';
$string['qb_loaded_questions'] = '{$a} Fragen wurden geladen';
$string['qb_loading'] = 'Laden...';
$string['qb_loading_questions'] = 'Fragen werden geladen, bitte warten…';
$string['qb_mode'] = 'Modus';
$string['qb_moodle5_notice'] = 'Moodle >= 5.0 erkannt. Auflistung erfolgt nach Kurs und anschließend nach Fragenkatalog.';
$string['qb_no_answer'] = 'Keine Antwort verfügbar.';
$string['qb_no_matches'] = 'Es wurden keine Fragen gefunden, die den aktuellen Filtern entsprechen.';
