...
/**
 * Strings for component 'tool_licensemanager', language 'de', version '4.5'.
 *
...
$string['createlicense'] = 'Nutzerdefinierte Lizenz erstellen';
$string['createlicensebuttontext'] = 'Lizenz erstellen';
...
$string['fullname'] = 'Vollständiger Lizenzname';
$string['fullnamerequirederror'] = 'Sie müssen einen vollständigen Lizenznamen eingeben.';
$string['invalidurl'] = 'Ungültige Quell-URL';
$string['license'] = 'Lizenz';
$string['licensemanager'] = 'Lizenzen verwalten';
$string['movelicensedownname'] = 'Lizenz \'{$a}\' nach unten verschieben';
$string['movelicenseupname'] = 'Lizenz \'{$a}\' nach oben verschieben';
$string['pluginname'] = 'Lizenzverwaltung';
$string['privacy:metadata'] = 'Die Lizenzverwaltung speichert keine personenbezogenen Daten';
$string['shortname'] = 'Kurzbezeichnung der Lizenz';
$string['shortnamerequirederror'] = 'Sie müssen eine Kurzbezeichnung für die Lizenz eingeben.';
