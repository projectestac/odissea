...
/**
 * Strings for component 'qtype_essay', language 'de', version '4.5'.
 *
 * @package     qtype_essay
 * @category    string
...
$string['maxwordlimitboundary'] = 'Diese Frage darf mit höchstens {$a->limit} Wörtern beantwortet werden. Sie versuchen aber {$a->count} Wörter einzureichen. Formulieren Sie Ihre Antwort kürzer und versuchen Sie es nochmal.';
...
$string['minwordlimitboundary'] = 'Die Antwort auf diese Frage muss mindestens {$a->limit} Wörter lang sein, Sie versuchen aber {$a->count} Wörter einzureichen. Formulieren Sie ihre Antwort länger und versuchen Sie es nochmal.';
...
$string['privacy:preference:responseformat'] = 'Wie ist das Antwortformat (HTML-Editor, einfacher Text, ...)?';
