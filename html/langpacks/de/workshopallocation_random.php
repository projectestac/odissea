...
/**
 * Strings for component 'workshopallocation_random', language 'de', branch 'MOODLE_38_STABLE'
 *
...
$string['allocationdeallocategraded'] = 'Eine Neuzuordnung kann nicht durchgeführt werden. <strong>{$a->reviewername}</strong>, hat bereits die Einreichung von: <strong>{$a->authorname}</strong> beurteilt.';
