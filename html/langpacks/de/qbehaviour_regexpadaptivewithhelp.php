...
/**
 * Strings for component 'qbehaviour_regexpadaptivewithhelp', language 'de', version '3.11'.
 *
...
$string['privacy:metadata'] = 'Das Plugin \'Frageverhalten RegExp adaptiver Modus mit Hilfe\' speichert keine personenbezogenen Daten.';
$string['submittedwithhelp'] = 'Senden (mit einer Anfrage nach Hilfe): {$a}';
$string['totalpenalties'] = 'Abzüge bisher: <strong>{$a}</strong>.';
