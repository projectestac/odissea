...
$string['logincontainerwidthsetting_desc'] = 'Mit dieser Einstellung können Sie die feste Breite des Anmeldebereichs in Moodle von 500px überschreiben. Standardmäßig verwendet Moodle auf mittleren und größeren Bildschirmen eine Breite von 500px. Sie können andere Pixelwerte wie 600px, aber auch Prozentwerte wie 90% oder die Breite des Viewports wie 50vw eingeben.';
...
$string['loginidploginenablesetting_core'] = 'Zusammenspiel der Moodle-Core-Einstellungen: Die Anmeldetasten für Identitätsanbieter werden von Authentifizierungs-Plugins wie OAuth2, CAS oder Shibboleth bereitgestellt. Sie können Authentifizierungs-Plugins auf der Seite mit den <a href="{$a->url}">Authentifizierungseinstellungen von Moodle</a> verwalten.';
...
$string['loginlocalloginenablesetting_desc'] = 'Mit dieser Einstellung legen Sie fest, ob der lokale Anmeldeanbieter auf der Anmeldeseite angezeigt wird. Standardmäßig ist er sichtbar und Nutzer/innen können sich wie gewohnt anmelden. Wenn Sie diese Einstellung deaktivieren, wird der lokale Anmeldeanbieter ausgeblendet. So können Sie nur Anmeldebuttons für externe Identitätsanbieter wie OAuth2 oder OIDC bereitstellen.';
$string['loginlocalloginenablesetting_note'] = 'Hinweis: Sobald Sie den lokalen Anmeldeanbieter ausblenden, besteht die Gefahr, dass sich Administratoren bei Problemen mit dem externen Identitätsanbieter nicht mehr mit einem lokalen Konto anmelden können. Dasselbe gilt, wenn ausschließlich die manuelle Authentifizierung aktiviert ist. Um lokale Anmeldungen in solchen Fällen dennoch zu ermöglichen, wird die <a href="{$a->url}">Seite für die lokale Anmeldung</a> (Details siehe unten) automatisch aktiviert. Speichern Sie bitte diese URL als Lesezeichen.';
...
$string['loginlocalshowintrosetting_desc'] = 'Mit dieser Einstellung legen Sie fest, ob eine Einleitung über dem lokalen Anmeldeformular angezeigt wird. Standardmäßig wird die Einleitung nicht angezeigt. Wenn Sie sie jedoch aktivieren, kann diese den Nutzer/innen helfen zu verstehen, welche Anmeldedaten sie im lokalen Anmeldeformular verwenden sollen, insbesondere wenn Sie mehrere Anmeldeanbieter anbieten oder deren Reihenfolge geändert haben.';
...
$string['loginorderheading_desc'] = 'Mit diesen Einstellungen legen Sie die Reihenfolge der Anmeldeanbieter im Anmeldeformular fest. Die angezeigte Reihenfolge richtet sich nach der Ordnungszahl (von der niedrigsten zur höchsten) und überspringt alle Anmeldeanbieter und Anmeldeformularelemente, die in Boost Union deaktiviert sind.';
