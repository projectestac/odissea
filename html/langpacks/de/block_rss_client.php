...
$string['addfeed'] = 'URL für RSS Feed hinzufügen';
$string['addheadlineblock'] = 'RSS Block hinzufügen';
...
$string['privacy:metadata:block_rss_client:preferredtitle'] = 'Angepasster Titel des RSS-Feeds';
$string['privacy:metadata:block_rss_client:shared'] = 'Falls der RRS Feed in allen Kursen verfügbar ist.';
$string['privacy:metadata:block_rss_client:skiptime'] = 'Zeit in Sekunden warten, um einen fehlgeschlagenen Abruf von RSS Feeds zu wiederholen.';
$string['privacy:metadata:block_rss_client:skipuntil'] = 'Maximale Zeit für den Versuch, einen fehlgeschlagenen RSS-Feed zu öffnen.';
$string['privacy:metadata:block_rss_client:tableexplanation'] = 'Die RSS-Blockinfos sind hier gespeichert.';
