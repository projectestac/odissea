...
/**
 * Strings for component 'report_stats', language 'de', branch 'MOODLE_38_STABLE'
 *
...
$string['eventreportviewed'] = 'Statistik gesehen';
$string['eventuserreportviewed'] = 'Nutzerstatistik gesehen';
$string['nocapability'] = 'Kein Zugriff auf die Nutzerstatistik';
$string['page-report-stats-index'] = 'Kursstatistik-Bericht';
$string['page-report-stats-user'] = 'Nutzer Kursstatistik-Bericht';
$string['page-report-stats-x'] = 'Jeder Statistikbericht';
$string['pluginname'] = 'Kursstatistiken';
$string['privacy:dailypath'] = 'Tägliche Statistiken';
$string['privacy:metadata'] = 'Das Statistik-Plugin speichert keine personenbezogenen Daten.';
