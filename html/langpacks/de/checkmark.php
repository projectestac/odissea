...
$string['privacy:metadata:attendance'] = 'Anwesenheitsstatus des Benutzers.';
$string['privacy:metadata:checks'] = 'Tabelle mit den geprüften Beispielen des Benutzers (gebunden an einen Eintrag in der Abgabetabelle).';
...
$string['privacy:metadata:feedbacks'] = 'Tabelle mit den Feedbackdaten des Benutzers.';
$string['privacy:metadata:format'] = 'Format für das textuelle Feedback an den Benutzer.';
$string['privacy:metadata:grade'] = 'Bewertung des Benutzers.';
...
$string['privacy:metadata:override:timecreated'] = 'Die Uhrzeit und das Datum, an dem die Daten für diesen Benutzer überschrieben wurden.';
$string['privacy:metadata:override:timemodified'] = 'Der letzte Zeitpunkt und das Datum, an dem die Daten für diesen Benutzer überschrieben wurden.';
...
$string['privacy:metadata:pref:printheader'] = 'Sollen die Header standardmäßig für diesen Benutzer exportiert werden?';
$string['privacy:metadata:pref:quickgrade'] = 'Soll das Schnellbewertung für diesen Benutzer standardmäßig aktiviert sein?';
$string['privacy:metadata:pref:sumabs'] = 'Sollten für diesen Benutzer standardmäßig absolute Summen angezeigt werden?';
$string['privacy:metadata:pref:sumrel'] = 'Sollten für diesen Benutzer standardmäßig relative Summen angezeigt werden?';
$string['privacy:metadata:pref:textsize'] = 'Standard-Textgröße, die für die Exporte dieses Benutzers verwendet wird.';
...
$string['privacy:metadata:presentationgrade'] = 'Bewertung für die Präsentation des Benutzers.';
...
$string['privacy:metadata:submissions'] = 'Tabelle mit Daten zu den Abgaben des Benutzers.';
