...
/**
 * Strings for component 'confman', language 'de', version '3.11'.
 *
 * @package     confman
 * @category    string
...
$string['actions:approve'] = 'Genehmigen';
$string['actions:export'] = 'Exportieren';
$string['actions:export_html'] = 'HTML exportieren';
...
$string['comment:missing'] = 'Erforderlicher Kommentar';
...
$string['confman:addinstance'] = 'ConfMan hinzufügen';
$string['confman:manage'] = 'Beiträge verwalten';
$string['confman:rate'] = 'Beiträge bewerten';
$string['confman:view'] = 'ConfMan öffnen';
...
$string['item:title_post'] = 'Akad. Titel (nachgestellt)';
$string['item:title_pre'] = 'Akad. Titel (vorangestellt)';
$string['item:type'] = 'Art des Beitrags';
$string['item:you_can_modify'] = 'Sie können die Daten mit folgendem Link verwalten';
$string['mail:contributor'] = 'Bereitsteller/in benachrichtigen';
$string['mail:contributor:creation'] = 'Beitrag wurde erstellt';
$string['mail:contributor:files'] = 'Dateien geändert';
$string['mail:contributor:notice'] = '<b>Achtung:</b> Wenn der/die Einreicher/in nicht über die Erstellung der Einreichung informiert wird, erhält er/sie auch nicht den Link, um den Beitrag bearbeiten zu können. In den meisten Fällen sollten Sie diese Einstellung auf "ein" belassen!';
$string['mail:contributor:update'] = 'Beitrag wurde geändert';
$string['mail:organizer'] = 'Organisator/in benachrichtigen';
$string['mail:organizer:creation'] = 'Beitrag wurde erstellt';
$string['mail:organizer:files'] = 'Dateien geändert';
$string['mail:organizer:update'] = 'Beitrag wurde geändert';
