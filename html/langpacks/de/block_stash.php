...
<p>Fundorte kommen mit einigen Einstellungen, unter anderem wie oft eine einzelne Person dort ein Objekt aufsammeln kann, und wie oft ein Objekt dort wieder erscheint, nachdem es aufgesammelt wurde.</p>
<p>Wenn die Teilnehmer/innen z.B. einen <em>Schlüssel</em> benötigen, um Zugang zu einer Aktivität zu erhalten, werden Sie es in der Regel so einstellen, dass er pro Person nur einmal am Fundort aufgesammelt werden kann.</p>
<p>Wenn jede Person aber <em>5 Münzen</em> für den Zugang zu einer anderen Aktivität braucht, lassen Sie diese Münze vielleicht täglich wieder erscheinen, um zu einem täglichen Besuch des Kurs zu motivieren.</p>
<p>Beachten Sie, dass Objekte nicht von Zauberhand in Ihrem Kurs erscheinen. Sie müssen einen speziellen Code in Ihrem Kursinhalt einfügen, damit die Objekte angezeigt werden.</p>';
...
$string['filterstashnotinstalled'] = 'Wir empfehlen, das <a href="{$a->installurl}" target="_blank">Filter-Plugin für Stash</a> zu installieren und zu aktivieren. Es macht die Verwendung von Code-Schnipseln einfacher und zuverlässiger. Außerdem ermöglicht es das Tauschen.';
$string['filterstashwrongversion'] = 'Das Filter-Plugin, das Sie installiert haben, ist eine frühere Version und beherrscht noch keinen Tausch. Bitte besuchen Sie <a href="{$a}" target="_blank">diese Seite</a>, um die neueste Version zu bekommen.';
$string['from'] = 'Von';
$string['gain'] = 'Gewinn';
$string['gainloss'] = 'Gewinn oder Verlust';
$string['gaintitle'] = 'Titel "Gewinn"';
$string['gaintitle_help'] = 'Titel für die Spalte mit Objekten, die der Nutzer bei diesem Tausch erhält.';
$string['grouponly'] = 'Erlauben Sie nur Tauschgeschäfte zwischen Personen in deren jeweiligen Gruppen.';
$string['image'] = 'Bild';
$string['imageandbutton'] = 'Bild und Button';
$string['item'] = 'Objekt';
$string['itemamountlimit'] = 'Höchstmenge';
$string['itemamountlimit_help'] = 'Gibt die Menge an, in der es das Objekt im Kurs geben soll.';
...
$string['itemname_help'] = 'Der Name des Objekts. Dieser wird den Teilnehmern angezeigt.';
$string['items'] = 'Objekte';
$string['itemslist'] = 'Liste der Objekte';
$string['locations'] = 'Fundorte';
$string['loss'] = 'Verlust';
$string['losstitle'] = 'Titel "Verlust"';
$string['losstitle_help'] = 'Titel für die Spalte mit Objekten, die der Nutzer bei diesem Tausch abgeben muss.';
...
$string['nomorescarceitems'] = 'Die maximale Anzahl für diesen Gegenstand wurde erreicht. Erwägen Sie die maximale Anzahl zu erhöhen.';
$string['none'] = 'Nichts';
...
$string['pickupa'] = 'Nimm es \'{$a}\'';
$string['pickupinterval'] = 'Sammlungsintervall';
$string['pickupinterval_help'] = 'Das Intervall definiert den Zeitraum, nach dem das Objekt für Personen, die es bereits aufgesammelt haben, wieder sichtbar wird. Wenn Sie zum Beispiel ein Objekt "Kuchen" erstellt haben, können Sie das Erfassungsintervall auf 24 Stunden einstellen, um die Zeit zu simulieren, die der Bäcker benötigt, um einen weiteren Kuchen zu backen. Wichtig zu beachten ist, dass die Personen nicht von den Aktionen anderer betroffen sind. Diese Einstellung hat keine Auswirkungen, wenn \'Vorrat\' auf \'1\' gesetzt ist.';
$string['pluginname'] = 'Stash';
$string['privacy:metadata:pickup'] = 'Ein Übersicht, der an einem bestimmten Ort aufgesammelten Objekte.';
...
$string['privacy:metadata:useritem'] = 'Eine Übersicht der Objekte, die ein Nutzer besitzt.';
...
$string['privacy:metadata:useritem:userid'] = 'Die ID des Nutzers, der das Objekt besietzt.';
$string['quantity'] = 'Anzahl';
$string['reallydeletedrop'] = 'Sind sie sicher, dass Sie diesen Fundort löschen wollen?';
$string['reallydeleteitem'] = 'Sind Sie sicher, dass Sie dieses Objekt löschen wollen?';
$string['reallyresetstashof'] = 'Sind Sie sicher, das Sie das Inventar von  {$a} zurücksetzen wollen?';
$string['received'] = 'Empfangen';
...
$string['requestdetail'] = 'Diese/r Teilnehmer/in hat den folgenden Handel angefragt.';
...
$string['setup'] = 'Setup';
$string['shortcode:stashdrop'] = 'Zeigt ein Objekt zum Aufsammeln';
$string['shortcode:stashtrade'] = 'Zeigt das Tauschangebot';
...
$string['tradecenterdetail:zero'] = 'Wenn Sie ein Objekt suchen, erhalten Sie eine Liste der Nutzer/innen mit diesen Objekten, um einen Tauschhandel beginnen können. Wenn Sie eine Person auswählen, wird eine Liste mit den Objekten angezeigt, die Sie tauschen können.';
...
$string['tradewidget_help'] = '<p>Bei diesem Tauschangebot erhält man die Objekte in der linken Spalte im Tausch gegen die Objekte der rechten Spalte.</p><p>Klicken Sie auf das + Symbol unter dem Kasten um Objekte zur jeweiligen Spalte hinzuzufügen.</p><p>Die Anzahl der Objekte muss eine positive Zahl sein.</p>';
