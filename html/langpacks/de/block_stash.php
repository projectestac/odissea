...
$string['leaderboard_groups'] = 'Nur Teilnehmende meiner Gruppen anzeigen';
...
$string['new'] = 'Neu';
$string['next'] = 'Weiter';
$string['nofilterandnotiny'] = '📢 Wussten Sie, dass es ein neues Plugin für den TinyMCE Editor gibt, das die Erstellung von Objekten und deren Handel erleichtert. Laden Sie das <a href="https://moodle.org/plugins/filter_shortcodes">Shortcodes Filter Plugin</a> und das <a href="https://moodle.org/plugins/tiny_stash">Tiny Stash Plugin für den TinyMCE Editor</a> herunter, um die Erstellung von Stash-Objekten zu erleichter. Ein Vorschau-Video ist über den Tiny Stash Link verfügbar.';
...
$string['removalconfigurations'] = 'Entfernen-Konfiguration';
$string['removalexplanation'] = 'Entfernen ist derzeit auf einen Versuch in der Aktivität Test beschränkt. Zum Entfernen gelistete Objekte werden jedes Mal entfernt, wenn ein/e Teilnehmer/in einen neuen Versuch startet. Der Zugriff zum Test wird verhindert, wenn der/die Teilnehmer/in nicht genügend gelistete Objekte besitzt.';
...
$string['selectquizcheck'] = 'Bitte wählen Sie einen Test';
