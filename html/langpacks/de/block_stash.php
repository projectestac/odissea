...
/**
 * Strings for component 'block_stash', language 'de', version '4.5'.
 *
 * @package     block_stash
 * @category    string
...
$string['cost'] = 'Kosten';
$string['createquizzes'] = 'Erstellen Sie einen Test in diesem Kurs, um die Entfernung eines Stash-Objekts dafür zu konfigurieren.';
...
$string['drops_help'] = '<p>Fundorte sind Stellen, an denen Ihre Objekte in der <em>virtuellen Welt</em> liegen. Ohne einen <em>Fundort</em> kann ein Objekt nicht von Teilnehmer/innen aufgesammelt werden.</p>
<p>Fundorte verfügen über verschiedene Einstellungen, unter anderem wie oft eine einzelne Person dort ein Objekt aufsammeln kann, und wie oft ein Objekt dort wieder erscheint, nachdem es aufgesammelt wurde.</p>
...
<p>Wenn jede Person aber <em>5 Münzen</em> für den Zugang zu einer anderen Aktivität braucht, lassen Sie diese Münze möglicherweise täglich wieder erscheinen, um zu einem täglichen Besuch des Kurses zu motivieren.</p>
...
$string['filtershortcodesnotinstalled'] = 'Wir empfehlen Ihnen, den <a href="{$a->installurl}" target="_blank">Filter Shortcodes</a> zu installieren und zu aktivieren. Das macht die Verwendung der Code-Schnipsel einfacher und zuverlässiger. Dies ermöglicht außerdem das Tauschen.';
$string['filterstashdeprecated'] = 'Sie verwenden den veralteten Filter Stash, der nicht mehr unterstützt wird. Wir empfehlen Ihnen, stattdessen den <a href="{$a->installurl}" target="_blank">Filter Shortcodes</a> zu installieren und zu aktivieren.  Dies ermöglicht außerdem das Tauschen.';
$string['filterstashnotactive'] = 'Der Filter ist installiert, aber noch nicht für diesen Kurs aktiviert. Gehen Sie zu <a href="{$a->activeurl}" target="_blank">dieser Seite</a>, um den Filter für diesen Kurs zu aktivieren.';
$string['filterstashnotenabled'] = 'Der Filter ist installiert, aber noch nicht <a href="{$a->enableurl}" target="_blank">aktiviert</a>.';
$string['filterstashnotinstalled'] = 'Wir empfehlen Ihnen, den <a href="{$a->installurl}" target="_blank">Filter Stash</a> zu installieren und zu aktivieren. Es macht die Verwendung von Code-Schnipseln einfacher und zuverlässiger. Dies ermöglicht außerdem das Tauschen.';
$string['filterstashwrongversion'] = 'Der Filter, der bei Ihnen installiert wurde, ist veraltet und beherrscht noch nicht das Tauschen. Besuchen Sie bitte <a href="{$a}" target="_blank">diese Seite</a>, um die aktuelle Version zu bekommen.';
$string['from'] = 'Von';
$string['gain'] = 'Gewinn';
...
$string['grouponly'] = 'Erlauben Sie nur Tauschgeschäfte zwischen Teilnehmer/innen in deren jeweiligen Gruppen.';
$string['image'] = 'Bild';
$string['imageandbutton'] = 'Bild und Button';
$string['item'] = 'Objekt';
$string['itemamountlimit'] = 'Höchstmenge';
$string['itemamountlimit_help'] = 'Dies ist die maximale Menge dieses knappen Gegenstandes, die für alle Teilnehmer/innen im Kurs verfügbar ist.';
...
$string['maxpickup_help'] = 'Die Häufigkeit, mit der das Objekt von jeder Person an diesem Fundort abgeholt werden kann. Wenn Sie "1" festlegen, ist das Objekt nur einmal pro Person verfügbar. Wenn Sie es auf "5" setzen, kann jede Person das Objekt fünf Mal an diesem Fundort aufsammeln. Ein Wert ungleich "1" sollte in Kombination mit dem Sammlungsintervall verwendet werden.';
...
$string['new'] = 'Neu';
$string['next'] = 'Weiter';
$string['nofilterandnotiny'] = '📢 Wussten Sie, dass es ein neues Plugin für den TinyMCE Editor gibt, das die Erstellung von Objekten und deren Handel erleichtert. Laden Sie den <a href="https://moodle.org/plugins/filter_shortcodes"> Filter Shortcodes </a> und das <a href="https://moodle.org/plugins/tiny_stash"> Plugin Tiny Stash </a> herunter, um die Erstellung von Stash-Objekten zu erleichtern. Ein Vorschau-Video ist über den Tiny Stash Link verfügbar.';
...
$string['removalexplanation'] = 'Das Entfernen ist derzeit auf einen Versuch in der Aktivität Test beschränkt. Zum Entfernen gelistete Objekte werden jedes Mal entfernt, wenn eine Person einen neuen Versuch startet. Der Zugriff zum Test wird verhindert, wenn die Person nicht genügend gelistete Objekte besitzt.';
...
$string['savequantity'] = 'Speichern Sie die Menge für das Objekt {$a}';
$string['scarceitem'] = 'Mengenbegrenzung';
$string['scarceitem_help'] = 'Das Objekt steht nur begrenzt zur Verfügung. Wenn Sie hier 5 eingeben, kann es fünfmal eingesammelt werden.';
$string['searchitems'] = 'Objekte suchen';
$string['selectanitem'] = 'Objekt wählen';
...
$string['tradename_help'] = 'Der Name des Tauschangebotes, der Teilnehmer/innen angezeigt wird.';
