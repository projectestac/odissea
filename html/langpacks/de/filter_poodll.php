...
/**
 * Strings for component 'filter_poodll', language 'de', version '3.11'.
 *
...
$string['awsregion_desc'] = 'Wählen Sie die nächstgelegene Region zu Ihrem Moodle-Server für die beste Performance und um für Sie geltende Datenschutzbestimmungen zu erfüllen.';
...
$string['bundle'] = 'Paket';
$string['burntrose_recorder'] = 'Burnt Rose (alt)';
...
$string['filter_poodll_camera_heading'] = 'Einstellungen Webkamera';
...
$string['filter_poodll_mic_heading'] = 'Einstellungen Mikrofon';
$string['filter_poodll_mp3recorder_heading'] = 'Einstellungen MP3 Rekorder';
$string['filter_poodll_network_heading'] = 'Einstellungen PoodLL Netzwerk';
...
$string['serverhttpport'] = 'HTTP-Port des PoodLL-Servers';
