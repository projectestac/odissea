...
/**
 * Strings for component 'blog', language 'de', version '4.5'.
 *
 * @package     blog
 * @category    string
...
$string['blogattachment'] = 'Blog-Anhang';
...
$string['cannoteditentryorblog'] = 'Sie können diesen Eintrag oder Blog nicht bearbeiten.';
$string['cannotviewcourseblog'] = 'Sie dürfen In diesem Kurs keine Blogs sehen.';
$string['cannotviewcourseorgroupblog'] = 'Sie dürfen in diesem Kurs oder in dieser Gruppe keine Blogs sehen';
...
$string['deleteblogassociations'] = 'Blogverbindungen';
...
$string['entrytitlewithlink'] = 'Beitragstitel mit Link';
...
$string['linktooriginalentry'] = 'Ursprünglicher Blogeintrag';
