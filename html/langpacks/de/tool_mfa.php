...
$string['confirmationreplace'] = 'Sie werden sofort aufgefordert, ein anderes \'{$a}\' einzurichten. Stellen Sie bitte sicher, dass Sie den Einrichtungsvorgang abzuschließen können.';
...
$string['factorreport'] = 'Multi-Faktor-Bericht';
...
$string['mfa:intro'] = 'Erhöhen Sie die Sicherheit Ihres Nutzerkontos, indem Sie beim Einloggen eine zusätzliche Verifizierungsmethode vorschreiben.';
...
$string['settings:combinations'] = 'Zusammenfassung von Bedingungen für die Anmeldung';
...
$string['settings:guidancefiles_help'] = 'Fügen Sie hier Dateien hinzu, die in der Anleitungsseite verwendet werden sollen, und betten Sie diese mit {{filename}} (aufgelöster Pfad) oder {{filename}}} (HTML-Link) im Editor ein.';
$string['settings:guidancepage'] = 'Inhalt der Anleitungsseite';
$string['settings:guidancepage_help'] = 'Der hier angezeigte HTML-Code wird auf der Hilfeseite dargestellt. Geben Sie Dateinamen aus dem Dateibereich ein, um die Datei mit dem aufgelösten Pfad {{filename}} oder als HTML-Link mit {{{filename}}} einzubetten.';
...
$string['verification_desc'] = 'Um Ihr Nutzerkonto abzusichern, muss geprüft werden, ob Sie es wirklich sind.';
