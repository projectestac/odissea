...
$string['assignnotpermitted'] = 'Sie haben kein Recht, in diesem Kurs Rollen zuzuweisen.';
...
$string['deleteinstanceconfirmself'] = 'Möchten Sie wirklich die Instanz \'{$a->name}\' löschen, mit der Sie Zugriff auf diesen Kurs haben? Es könnte sein, dass Sie danach keinen Zugriff mehr haben.';
$string['deleteinstancenousersconfirm'] = 'Möchten Sie wirklich die Einschreibemethode \'{$a->name}\' löschen?';
$string['disableinstanceconfirmself'] = 'Möchten Sie wirklich die Instanz \'{$a->name}\' deaktivieren, mit der Sie Zugriff auf diesen Kurs haben? Es könnte sein, dass Sie danach keinen Zugriff mehr haben.';
...
$string['eventenrolinstanceupdated'] = 'Instanz für Einschreibeverfahren wurde bearbeitet';
