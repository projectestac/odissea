...
$string['emailothers_help'] = 'Die hier eingetragenen E-Mail-Empfänger (durch Komma getrennt bei mehreren Adressen) erhalten eine Kopie des Zertifikats.';
...
$string['emailstudents_help'] = 'Wenn diese Einstellung aktiviert ist, erhalten Teilnehmer/innen eine Kopie des Zertifikats, sobald dieses verfügbar ist.';
$string['emailstudentsubject'] = '{$a->coursefullname}: {$a->certificatename}';
$string['emailteachers'] = 'Trainer/innen benachrichtigen';
$string['emailteachers_help'] = 'Wenn diese Einstellung aktiviert ist, erhalten Trainer/innen eine Kopie des Zertifikats, sobald dieses verfügbar ist.';
...
$string['receiveddate'] = 'Empfangsdatum';
