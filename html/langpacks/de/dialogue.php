...
/**
 * Strings for component 'dialogue', language 'de', version '4.5'.
 *
 * @package     dialogue
 * @category    string
...
$string['incompleteconversation'] = 'Sie müssen eine/n Empfänger/in für diese Konversation auswählen, bitte versuchen Sie es erneut.';
...
$string['privacy:metadata:authorid'] = 'Nutzer-ID des Autors dieser Konversation';
$string['privacy:metadata:body'] = 'Inhalt der Konversation';
$string['privacy:metadata:conversationid'] = 'ID der Konversation';
$string['privacy:metadata:conversationindex'] = 'Index der Konversation';
$string['privacy:metadata:dialogue_messages'] = 'Dialog Nachrichten';
$string['privacy:metadata:dialogue_participants'] = 'Dialog Teilnehmer/innen';
$string['privacy:metadata:dialogueflags'] = 'Dialog Markierungen';
$string['privacy:metadata:dialogueid'] = 'ID des Dialogs';
$string['privacy:metadata:flag'] = 'Markierung';
$string['privacy:metadata:messageid'] = 'ID der Nachricht';
$string['privacy:metadata:state'] = 'Stauts';
...
$string['search:activity'] = 'Dialog - Aktivitätsinformation';
$string['search:conversations'] = 'Dialog - Informationen zu Konversationen und Nachrichten';
