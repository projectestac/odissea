...
$string['hardestquesdes'] = '* Gesamtzahl der Versuche = Gesamtzahl der Quizversuche.
    * Nicht erfolgreiche Versuche = Insgesamt falsche Versuche + Anzahl der nicht beantworteten Fälle.
In diesem Diagramm wird die Zähigkeit von Fragen unterdrückt, je nachdem, wie oft der Test versucht wurde und wann diese bestimmte Frage nicht versucht oder falsch versucht wurde. Wenn du auf die Balken klickst, die jeder Frage zugeordnet sind, wird die Frage selbst zusammen mit der Erklärung und der richtigen Antwort angezeigt.';
