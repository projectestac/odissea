...
/**
 * Strings for component 'groupselect', language 'de', version '4.5'.
 *
 * @package     groupselect
 * @category    string
...
$string['maxmembers_help'] = 'Maximale Mitgliederzahl pro Gruppe. Verwenden Sie 0 für unbegrenzt.';
...
$string['membershidden'] = 'Liste der Gruppenmitglieder nicht abrufbar';
...
$string['minmembers_help'] = 'Minimale Anzahl von Mitgliedern pro Gruppe. Eine Benachrichtigung für Gruppenmitglieder wird angezeigt, wenn die Anzahl nicht erreicht wurde. Standard ist 0 (deaktiviert).';
$string['minmembers_icon'] = 'Gruppe hat weniger Mitglieder als erforderlich';
$string['minmembers_notification'] = 'Ihre Gruppe hat weniger Mitglieder als benötigt werden. Minimum ist {$a}.';
