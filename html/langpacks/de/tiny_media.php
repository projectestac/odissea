...
$string['alignment_middle'] = 'Mittig';
$string['alignment_right'] = 'Rechts';
$string['alignment_top'] = 'Oben';
$string['audio'] = 'Audio';
$string['audiosourcelabel'] = 'Audio-Quell-URL';
...
$string['captionssourcelabel'] = 'Titel-Track-URL';
$string['chapters'] = 'Kapitel';
$string['chapters_help'] = 'Kapitelüberschriften können zur Navigation der Medienressource bereitgestellt werden.';
$string['chapterssourcelabel'] = 'Kapitel-Track-URL';
$string['constrain'] = 'Proportional';
...
$string['descriptionssourcelabel'] = 'Beschreibungs-Track-URL';
...
$string['mediamanagerbuttontitle'] = 'Medien verwalten';
$string['mediamanagerproperties'] = 'Medien verwalten';
$string['metadata'] = 'Metadaten';
$string['metadata_help'] = 'Metadaten-Tracks für die Verwendung in einem Skript können nur verwendet werden, wenn der Abspieler Metadaten unterstützt.';
$string['metadatasourcelabel'] = 'Metadaten-Track-URL';
...
$string['presentationoraltrequired'] = 'Bilder müssen eine Beschreibung haben, wenn nicht \'Bild als Deekoratiion\' markiert sind.';
...
$string['tracks'] = 'Untertitel und Titel';
$string['tracks_help'] = 'Untertitel, Titel, Kapitel und Beschreibungen können über eine WebVTT-Formatdatei (Web Video Text Tracks) hinzugefügt werden. Tracklabel werden im Dropdown-Menü angezeigt. Für jeden Tracktyp wird jeder als Standard festgelegte Track-Set zu Beginn des Videos vorgewählt.';
$string['unusedfilesdesc'] = 'Die folgenden eingebetteten Dateien werden im Textbereich nicht verwendet:';
...
$string['videosourcelabel'] = 'Video-Quell-URL';
