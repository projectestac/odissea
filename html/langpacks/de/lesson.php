...
$string['displaymode'] = 'Modus anzeigen';
...
$string['firstwrong'] = 'Ihre Antwort ist falsch. Möchten Sie es nochmal (ohne Bewertung) versuchen?';
...
$string['loginfail'] = 'Die Anmeldung ist fehlgeschlagen. Versuchen Sie es bitte nochmal.';
$string['lowscore'] = 'Schlechteste Bewertung';
$string['lowtime'] = 'Niedrigste Zeit';
$string['manageoverrides'] = 'Überschreibungen verwalten';
...
$string['namereject'] = 'Der eingegebene Name wurde zurückgewiesen.<br />Versuchen Sie es bitte mit einem anderem Namen nochmal.';
$string['new'] = 'Neu';
...
$string['pleaseenteryouranswerinthebox'] = 'Schreiben Sie Ihre Antwort ins Eingabefeld';
...
$string['secondpluswrong'] = 'Nicht ganz. Möchten Sie es nochmal versuchen?';
$string['selectallattempts'] = 'Alle Versuche auswählen';
$string['selectaqtype'] = 'Fragetyp auswählen';
$string['selectreport'] = 'Bericht auswählen';
