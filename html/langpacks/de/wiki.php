...
$string['adminmenu'] = 'Administrationsmenü';
...
$string['cannotcomparenewerversion'] = 'Die Seitenversion kann nur mit einer älteren Seitenversion verglichen werden.';
$string['cannoteditpage'] = 'Sie dürfen diese Seite nicht bearbeiten.';
$string['cannotmanagefiles'] = 'Sie dürfen keine Dateien im Wiki verwalten.';
$string['cannotviewfiles'] = 'Sie dürfen keine Dateien im Wiki anzeigen .';
$string['cannotviewpage'] = 'Sie können diese Seite nicht anzeigen.';
$string['changerate'] = 'Möchten Sie Änderungen vornehmen?';
...
$string['diff_help'] = 'Ausgewählte Versionen der Seite können verglichen werden, um Unterschiede zu finden.';
...
$string['firstpagetitle_help'] = 'Name der Startseite im Wiki. Sobald das Wiki angelegt ist, kann der Name nicht mehr geändert werden.';
$string['forceformat'] = 'Format festlegen';
$string['forceformat_help'] = 'Wenn das Format festgelegt ist, kann bei der Erstellung einer neuen Wikiseite kein anderes Format eingestellt werden.';
...
$string['formathtml_help'] = 'Der HTML-Editor kann benutzt werden, um Inhalte im Wiki zu formatieren.
...
$string['formatnwiki_help'] = 'NWiki ist eine dem MediaWiki ähnliche Markup-Sprache, um Inhalte im Wiki zu formatieren.

Um eine neue Seite zu anzulegen, geben Sie den Namen der neuen Seite in doppelte eckige Klammern ein, z.B. [[Neue Seite]].';
$string['formatnwiki_link'] = 'mod/wiki/nwiki';
$string['history'] = 'Verlauf';
$string['history_help'] = 'Der Link \'Verlauf\' führt zu einer Liste mit älteren Versionen der Seite.';
$string['html'] = 'HTML';
$string['incorrectdeleteversions'] = 'Die zu löschenden Seitenversionen sind falsch.';
$string['incorrectpageid'] = 'Die Seiten-ID ist falsch.';
$string['incorrectsubwikiid'] = 'Die Unterwiki-ID ist falsch.';
...
$string['individualpagedoesnotexist'] = 'Diese Wikiseite existiert nicht';
...
$string['invalidlock'] = 'Diese Seite ist bereits von einer anderen Person gesperrt.';
$string['invalidparameters'] = 'Ungültige Parameter';
$string['invalidsection'] = 'Ungültiger Abschnitt';
$string['invalidsesskey'] = 'Scheinbar ist Ihre Session abgelaufen. Notieren Sie bitte Ihren Bearbeitungsstand und melden Sie sich erneut an.';
$string['javascriptdisabledlocks'] = 'In Ihrem Browser ist JavaScript deaktiviert, so dass die Bearbeitungssperre nicht funktioniert. Ihre Änderungen werden eventuell nicht richtig gespeichert und könnten verloren gehen.';
$string['links'] = 'Links';
...
$string['navigationfrom'] = 'Diese Wikiseite kommt von';
$string['navigationfrom_help'] = 'Wikiseite, die zu dieser Seite verlinkten';
$string['navigationto'] = 'Diese Wikiseite führt zu';
...
$string['nocreatepermission'] = 'Keine Rechte zum Anlegen neuer Seiten';
$string['noeditcommentpermission'] = 'Keine Rechte zum Bearbeiten von Kommentaren';
$string['noeditpermission'] = 'Keine Rechte zum Bearbeiten von Seiten';
$string['nofrompages'] = 'Keine Links, die zu dieser Seite führen';
$string['nohistory'] = 'Kein Verlauf für diese Seite';
$string['nomanagecommentpermission'] = 'Keine Rechte zum Verwalten von Kommentaren';
$string['nomanagewikipermission'] = 'Keine Rechte zum Verwalten des Wikis';
$string['noorphanedpages'] = 'Keine verwaisten Seiten';
$string['nooverridelockpermission'] = 'Keine Rechte zum Ändern der Sperre';
$string['norated'] = 'Diese Seite wurde bisher noch nicht bewertet. Geben Sie die erste Bewertung ab!';
...
$string['notmigrated'] = 'Dieses Wiki wurde bisher nicht migriert. Bitte melden Sie sich bei den Administrator/innen.';
$string['notopages'] = 'Diese Wikiseite hat keine Links zu anderen Seiten.';
$string['noupdatedpages'] = 'Keine aktualisierten WIkiseiten';
$string['noviewcommentpermission'] = 'Keine Rechte zum Anzeigen von Kommentaren';
$string['noviewpagepermission'] = 'Keine Rechte zum Anzeigen von Seiten';
$string['nwiki'] = 'NWiki';
$string['oldversion'] = 'Alte Version';
$string['orphaned'] = 'Verwaiste Seiten';
$string['orphaned_help'] = 'Liste von Wikiseiten ohne Verlinkung von anderen Seiten';
...
$string['pageislocked'] = 'Jemand anderes bearbeitet gerade diese Wikiseite. Versuchen Sie es in ein paar Minuten nochmal.';
...
$string['previewwarning'] = 'Dies ist eine Seitenvorschau. Ihre Änderungen wurden noch nicht gespeichert!';
$string['print'] = 'Drucken';
$string['privacy:metadata:core_comment'] = 'Kommentare auf Wikiseiten';
$string['privacy:metadata:core_files'] = 'Angehängte Dateien in Unterwikis';
$string['privacy:metadata:core_tag'] = 'Tags, die mit Wikiseiten verknüpft sind';
$string['privacy:metadata:wiki_locks'] = 'Temporäre Sperrung von Wikiseiten';
$string['privacy:metadata:wiki_locks:lockedat'] = 'Zeitpunkt der Sperrung';
$string['privacy:metadata:wiki_locks:sectionname'] = 'Name des gesperrten Seitenabschnitts';
$string['privacy:metadata:wiki_locks:userid'] = 'Person, die die Seite gesperrt hat';
$string['privacy:metadata:wiki_pages'] = 'Infos zu Wikiseiten';
$string['privacy:metadata:wiki_pages:cachedcontent'] = 'Gecachter Inhalt im HTML-Format';
$string['privacy:metadata:wiki_pages:pageviews'] = 'Anzahl der Seitenaufrufe';
$string['privacy:metadata:wiki_pages:readonly'] = 'Ist die Seite schreibgeschützt?';
$string['privacy:metadata:wiki_pages:timecreated'] = 'Zeitpunkt der Erstellung der Seite';
$string['privacy:metadata:wiki_pages:timemodified'] = 'Zeitpunkt, zu dem die Seite zuletzt geändert wurde';
$string['privacy:metadata:wiki_pages:timerendered'] = 'Zeitpunkt, zu dem die Seite zuletzt gerendert wurde';
$string['privacy:metadata:wiki_pages:title'] = 'Name der Seite';
$string['privacy:metadata:wiki_pages:userid'] = 'Letzte Person, die die Seite bearbeitet hat';
$string['privacy:metadata:wiki_subwikis'] = 'Infos über Unterwikis (im Gruppen- oder Einzelmodus)';
$string['privacy:metadata:wiki_subwikis:groupid'] = 'Gruppe, die ein eigenes Unterwiki hat';
$string['privacy:metadata:wiki_subwikis:userid'] = 'Person, die ein eigenes Unterwiki hat (für persönliche Wikis)';
$string['privacy:metadata:wiki_versions'] = 'Infos zum Verlauf der Wikiseiten';
$string['privacy:metadata:wiki_versions:content'] = 'Inhaltsbearbeitung';
$string['privacy:metadata:wiki_versions:contentformat'] = 'Format der Inhaltsbearbeitung';
$string['privacy:metadata:wiki_versions:timecreated'] = 'Zeitpunkt der Bearbeitung';
$string['privacy:metadata:wiki_versions:userid'] = 'Person, die die Bearbeitung vorgenommen hat';
$string['privacy:metadata:wiki_versions:version'] = 'Versionsnummer';
$string['rated'] = 'Sie haben die Seite bewertet mit: {$a}';
...
$string['repeatedsection'] = 'Wikifehler. Der Abschnittsname \'{$a}\' kann nicht doppelt verwendet werden.';
$string['restore'] = 'Wiederherstellen';
$string['restoreconfirm'] = 'Möchten Sie die Version #{$a} wirklich wiederherstellen?';
...
$string['teacherrating'] = 'Bewertung von Trainer/innen';
...
$string['versionerror'] = 'Version-ID existiert nicht';
...
<li>gemeinsames Wiki - alle Personen benutzen und bearbeiten das Wiki kollaborativ</li>
...
$string['wrongversionsave'] = 'Eine andere Person hat eine neue Version der Seite gespeichert, während Sie daran gearbeitet haben. Sie haben diese neuen Inhalte überschrieben. Prüfen Sie bitte den Seitenverlauf.';
