...
$string['badges:viewawarded'] = 'Personen mit bestimmtem Badge anzeigen, ohne selber den Badge erwerben zu können';
$string['badges:viewbadges'] = 'Verfügbare Badges anzeigen, ohne sie selber erworben zu haben';
...
$string['block:view'] = 'Block anzeigen';
...
$string['blog:view'] = 'Blogeinträge anzeigen';
$string['blog:viewdrafts'] = 'Blogeinträge als Entwürfe anzeigen';
...
$string['category:viewcourselist'] = 'Kursbereich und enthaltene Kurse anzeigen';
$string['category:viewhiddencategories'] = 'Verborgene Kursbereiche anzeigen';
...
$string['cohort:configurecustomfields'] = 'Profilfelder für globale Gruppen konfigurieren';
...
$string['confirmaddadmin'] = 'Möchten Sie wirklich <strong>{$a}</strong> zu den Administrator/innen hinzufügen?';
$string['confirmaddadmins'] = 'Möchten Sie die folgenden Person wirklich zur Liste der Administrator/innen hinzufügen?';
$string['confirmdeladmin'] = 'Möchten Sie \'{$a}\' wirklich aus der Liste der Administrator/innen  löschen?';
$string['confirmremoveadmins'] = 'Möchten Sie die folgenden Personen wirklich aus der Liste der Administrator/innen entfernen?';
...
$string['contentbank:deleteowncontent'] = 'Inhalt des eigenen Inhaltsspeichers löschen';
$string['contentbank:downloadcontent'] = 'Inhalt aus dem Inhaltsspeicher herunterladen';
$string['contentbank:manageanycontent'] = 'Alle Inhalte des Inhaltsspeichers verwalten';
$string['contentbank:manageowncontent'] = 'Alle Inhalte des eigenen Inhaltsspeichers verwalten';
$string['contentbank:upload'] = 'Neuen Inhalt in den Inhaltsspeicher hochladen';
$string['contentbank:useeditor'] = 'Inhalte mit dem Inhaltstyp-Editor anlegen oder bearbeiten';
$string['contentbank:viewunlistedcontent'] = 'Nicht gelistete Inhalte im Inhaltsspeicher anzeigen';
$string['context'] = 'Kontext';
$string['contextrolenotallowed'] = 'Die Rolle {$a} ist in diesem Kontext nicht zulässig.';
...
$string['course:changelockedcustomfields'] = 'Gesperrte nutzerdefinierte Felder ändern';
$string['course:changeshortname'] = 'Kurzen Kursnamen ändern';
$string['course:changesummary'] = 'Kursbeschreibung ändern';
$string['course:configurecoursecommunication'] = 'Kommunikationeinstellungen des Kurses konfigurieren';
$string['course:configurecustomfields'] = 'Nutzerdefinierte Kursfelder konfigurieren';
...
$string['course:recommendactivity'] = 'Aktivitäten in der Aktivitätsauswahl empfehlen';
...
$string['course:view'] = 'Kurse ohne Beteiligung anzeigen';
$string['course:viewcoursegrades'] = 'Bewertungen anzeigen';
$string['course:viewhiddenactivities'] = 'Verborgene Aktivitäten anzeigen';
$string['course:viewhiddencourses'] = 'Verborgene Kurse anzeigen';
$string['course:viewhiddengroups'] = 'Verborgene Gruppen anzeigen';
$string['course:viewhiddensections'] = 'Verborgene Kursabschnitte anzeigen';
$string['course:viewhiddenuserfields'] = 'Verborgene Nutzerfelder anzeigen';
$string['course:viewparticipants'] = 'Kursteilnehmer/innen anzeigen';
$string['course:viewscales'] = 'Bewertungskalen anzeigen';
...
$string['eventrolecreated'] = 'Rolle angelegt';
...
$string['extusers'] = 'Derzeit zugewiesene Nutzeraccounts';
...
$string['grade:view'] = 'Eigene Bewertungen anzeigen';
$string['grade:viewall'] = 'Fremde Bewertungen anzeigen';
$string['grade:viewhidden'] = 'Verborgene Bewertungen anzeigen';
$string['group:configurecustomfields'] = 'Nutzerdefinierte Felder für Gruppen und Gruppierungen konfigurieren';
...
$string['moodlenet:shareactivity'] = 'Aktivitäten für MoodleNet freigeben';
$string['moodlenet:sharecourse'] = 'Kurs über MoodleNet teilen';
$string['morethan'] = 'Mehr als {$a}';
$string['multipleroles'] = 'Mehrfachrollen';
...
$string['notabletooverrideroleshere'] = 'Sie dürfen keine Rechte für irgendeine Rolle ändern.';
$string['notes:manage'] = 'Anmerkungen verwalten';
$string['notes:view'] = 'Anmerkungen anzeigen';
...
$string['payment:manageaccounts'] = 'Konten verwalten';
$string['payment:viewpayments'] = 'Zahlungen anzeigen';
...
$string['question:viewmine'] = 'Eigene Fragen anzeigen';
...
$string['reportbuilder:viewall'] = 'Alle nutzerdefinierten Berichte anzeigen';
...
$string['roleassignment'] = 'Rollenzuweisung';
...
$string['roleoriginalname'] = 'Originalname';
...
$string['roleshortname_help'] = 'Der Kurzname ist ein direktes Identifizierungsmerkmal der Rolle, bei dem ausschließlich alphanumerische Zeichen erlaubt sind. Ändern Sie niemals den Kurznamen einer Standardrolle!';
...
$string['site:deleteownmessage'] = 'Eigene gesendete und empfangene Mitteilungen löschen';
...
$string['site:messageanyuser'] = 'Datenschutzeinstellungen umgehen, um Mitteilungen an alle Nutzer/innen zu schreiben';
$string['site:mnetloginfromremote'] = 'Anmeldung aus anderem Moodle über MNet';
$string['site:mnetlogintoremote'] = 'Verbinden zu anderem Moodle über MNet';
$string['site:readallmessages'] = 'Alle Mitteilungen lesen';
$string['site:restore'] = 'Kurse wiederherstellen';
$string['site:senderrormessage'] = 'Mitteilung aus der Fehlerseite an den Support senden';
$string['site:sendmessage'] = 'Mitteilungen an jede Person senden';
$string['site:trustcontent'] = 'Übermittelten Inhalten vertrauen';
$string['site:uploadusers'] = 'Neue Nutzer/innen aus Datei importieren';
$string['site:viewanonymousevents'] = 'Ereignisse in Berichten anonym anzeigen';
$string['site:viewfullnames'] = 'Vollständige Nutzernamen anzeigen';
$string['site:viewparticipants'] = 'Alle Nutzer/innen anzeigen';
$string['site:viewreports'] = 'Berichte anzeigen';
$string['site:viewuseridentity'] = 'Alle Nutzerinformationen als Liste anzeigen';
$string['siteadministrators'] = 'Administrator/innen';
$string['siteadministratorsconfigphp'] = 'Die Liste der Administrator/innen für die Wesite kann nicht geändert werden, da sie in config.php definiert ist.';
...
$string['user:loginas'] = 'Anmeldung als andere Person';
...
$string['user:viewalldetails'] = 'Alle Nutzerinformationen anzeigen';
