...
$string['availability_hide'] = 'Auf der Kursseite verbergen';
$string['availability_hide_help'] = 'Für Teilnehmer/innen nicht sichtbar';
$string['availability_show'] = 'Auf Kursseite anzeigen';
$string['availability_show_help'] = 'Für Teilnehmer/innen verfügbar (vorbehaltlich von anderen Zugangsbeschränkungen).';
$string['availability_stealth'] = 'Verfügbar, aber auf Kursseite nicht anzeigen';
$string['availability_stealth_help'] = 'Für Teilnehmer/innen verfügbar, wenn ein Link bereitgestellt wird. Aktivitäten werden weiterhin in den Bewertungen und in Berichten angezeigt.';
$string['bulkcancel'] = 'Sammelaktionen schließen';
$string['bulkedit'] = 'Sammelaktionen';
...
$string['cm_duplicate_feedback_batch'] = 'Ausgewählte {$a->count} Aktivitäten dupliziert';
$string['cm_hide_feedback'] = '{$a->name} ist nun verborgen.';
$string['cm_hide_feedback_batch'] = 'Die ausgewählten {$a->count} Aktivitäten sind nun verborgen.';
$string['cm_moveleft_feedback'] = '{$a->name} nach links geschoben';
$string['cm_moveright_feedback'] = '{$a->name} nach rechts geschoben';
$string['cm_nogroups_feedback'] = 'Gruppenmodus {$a->name} wurde auf "Keine Gruppen" geändert.';
$string['cm_separategroups_feedback'] = 'Gruppenmodus {$a->name} wurde auf "Getrennte Gruppen" geändert.';
$string['cm_show_feedback'] = '{$a->name} wird nun angezeigt.';
...
$string['cmsdelete_title'] = 'Ausgewählte Aktivitäten löschen?';
$string['cmsduplicate'] = 'Aktivitäten duplizieren';
$string['cmsmove'] = 'Aktivitäten verschieben';
$string['cmsmove_info'] = '{$a} Aktivitäten verschieben hinter';
...
$string['sectionmove_info'] = '{$a} verschieben hinter';
$string['sectionmove_title'] = 'Abschnitt verschieben';
$string['sectionsavailability'] = 'Abschnittsverfügbarkeit';
$string['sectionsavailability_title'] = 'Abschnittsverfügbarkeit';
$string['sectionsdelete'] = 'Abschnitte löschen';
$string['sectionsdelete_info'] = 'Hiermit werden {$a->count} Abschnitte und alle darin enthaltenen Aktivitäten gelöscht.';
$string['sectionsdelete_title'] = 'Ausgewählte Abschnitte löschen?';
$string['sectionsmove'] = 'Abschnitte verschieben';
$string['sectionsmove_info'] = '{$a} Abschnitte verschieben hinter';
$string['sectionsmove_title'] = 'Ausgewählte Abschnitte verschieben';
$string['selectcm'] = 'Aktivität {$a} auswählen';
$string['selectsection'] = 'Abschnitt {$a} auswählen';
