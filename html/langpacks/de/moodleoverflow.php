...
/**
 * Strings for component 'moodleoverflow', language 'de', version '4.5'.
 *
...
$string['action_remove_upvote'] = 'Klicken, um positive Bewertung zu entfernen';
...
$string['cannotdeletereplies'] = 'Sie können diesen Beitrag nicht löschen, da bereits Antworten vorhanden sind.';
$string['cannoteditposts'] = 'Sie können diesen Beitrag nicht bearbeiten.';
...
$string['desc:review_everything'] = 'Alle Fragen und Antworten werden von einer/m Trainer/in geprüft, bevor sie veröffentlicht werden.';
$string['desc:review_questions'] = 'Alle Fragen werden von einer/m Trainer/in geprüft, bevor sie veröffentlicht werden.';
...
$string['errorunexpectedinteraction'] = 'Die Interaktion stimmt nicht mit den Angaben im Formular überein.';
$string['errorunknown'] = 'Es ist ein unbekannter Fehler aufgetreten. Bitte versuchen Sie es später erneut.';
...
$string['gradepasserror'] = 'Bestehensbewertung muss eine positive Zahl sein';
$string['gradepassvalidationerror'] = 'Bestehensbewertung darf nicht höher als die maximale Bewertung sein';
$string['gradesreport'] = 'Bewertungsbericht';
$string['gradesupdated'] = 'Bewertung aktualisiert';
$string['helpamountofactivity'] = 'Hilfesymbol für Aktivität';
$string['helpamountofactivity_help'] = 'Jede Aktivität wie das Stellen oder das Beantworten einer Frage oder das Bewerten eines Beitrags gibt 1 Punkt.';
...
$string['la_endtime'] = 'Zeitpunkt, an dem die Teilnehmer/innen nicht mehr antworten können';
$string['la_endtime_help'] = 'Teilnehmer/innen können nach dem festgelegten Datum keine Fragen mehr beantworten.';
$string['la_endtime_ruleerror'] = 'Die Endzeit muss in der Zukunft liegen';
$string['la_heading'] = 'Eingeschränkter Antwortmodus';
$string['la_helpicon_teacher'] = 'Dies kann in den Einstellungen von Moodleoverflow geändert werden.';
$string['la_info_endtime'] = 'Beiträge können nach dem {$a->limitedanswerdate} nicht mehr beantwortet werden.';
$string['la_info_start'] = 'Dieses Moodleoverflow befindet sich im eingeschränktem Antwortmodus.';
$string['la_info_starttime'] = 'Beiträge können erst ab dem {$a->limitedanswerdate} beantwortet werden.';
$string['la_sequence_error'] = 'Die Endzeit muss nach der Anfangszeit liegen';
$string['la_starttime'] = 'Zeitpunkt, zu dem die Teilnehmer/innen mit der Beantwortung beginnen können';
$string['la_starttime_help'] = 'Teilnehmer/innen können nach dem festgelegten Datum Beiträge beantworten.';
$string['la_starttime_ruleerror'] = 'Anfangszeit muss in der Zukunft liegen';
$string['la_student_helpicon'] = 'Hilfesymbol für eingeschränktem Antwortmodus';
$string['la_student_helpicon_help'] = 'Dieses Moodleoverflow befindet sich derzeit im eingeschränkten Modus. Sie können antworten, sobald die Trainer/innen es erlauben.';
$string['la_teacher_helpicon'] = 'Hilfesymbol für den eingeschränkten Antwortmodus';
$string['la_teacher_helpicon_help'] = 'Dieses Moodleoverflow befindet sich derzeit im eingeschränkten Modus. Dies kann in den Einstellungen dieser Aktivität geändert werden.';
$string['la_warning_answers'] = 'In diesem Moodleoverflow gibt es bereits beantwortete Beiträge.';
$string['la_warning_conclusion'] = 'Es kann nur noch die Zeit festgelegt werden, bis zu der Studierende antworten dürfen.';
...
$string['markallread'] = 'Alle Beiträge in dieser Diskussion als gelesen markieren';
...
$string['maxtimehaspassed'] = 'Die Bearbeitungszeit für diesen Beitrag ist abgelaufen. Eine Änderung ist nicht mehr möglich.';
...
$string['nootherforums'] = 'Es gibt leider kein anderes Moodleoverflow zum Verschieben.';
...
$string['original_post_reply'] = 'Sie beantworten den Beitrag von {$a}:';
$string['parent'] = 'Ursprungsbeitrag';
$string['pending_review'] = 'Muss noch geprüft werden';
$string['pending_review_but_cannot_now'] = 'Wartet auf Überprüfung, kann jedoch erst {$a} nach der Erstellung dieses Beitrags freigegeben werden, um der Autorin/dem Autor Zeit zur Bearbeitung zu geben.';
...
$string['postmailinfolink'] = 'Dies ist eine Kopie einer Nachricht, die in {$a->coursename} veröffentlicht wurde. Um zu antworten, klicken Sie auf diesen Link: {$a->replylink}';
...
$string['ratedbyteacher'] = 'Dieser Post wurde von der Trainerin/vom Trainer als Lösung markiert.';
...
* Hilfreich - Der vom Fragesteller als hilfreich markierte Beitrag  wird ganz oben angezeigt
* Lösung - Der von der Trainerin/vom Trainer als Lösung markiertee Beitrag  wird ganz oben angezeigt';
...
$string['reviewpossibleaftertime_desc'] = 'Trainer/innen können Beiträge frühestens nach dieser Zeit (in Sekunden) nach der Erstellung des Beitrags akzeptieren oder ablehnen. Nachdem ein Beitrag von der Trainerin/vom Trainer akzeptiert wurde, kann er nicht mehr von seiner/m Autor/in bearbeitet werden, auch nicht falls der Bearbeitungszeitraum eigentlich noch nicht vorbei ist.';
...
$string['showpost_collapse'] = 'Einklappen';
$string['showpost_expand'] = 'Aufklappen';
...
$string['tasksenddailymails'] = 'Moodleoverflow-Task zum Versenden einer täglichen Zusammenfassung ungelesener Beiträge';
$string['tasksendmails'] = 'Moodleoverflow-Task zum Versenden von E-Mails über ungelesene Beiträge';
$string['tasksendreviewmails'] = 'Moodleoverflow-Task zum Versenden einer E-Mail über notwendige Überprüfungen von Beiträgen.';
...
$string['userstatscourse'] = 'Nutzerstatistiken des Kurses: {$a}';
...
$string['wheremovetopic'] = 'Wohin soll das Thema "{$a}" verschoben werden?';
$string['wronginteraction'] = 'Beim Ausführen der Interaktion ist ein Fehler aufgetreten.';
$string['wrongparametercount'] = 'In der URL sollte genau ein Parameter angegeben werden. Bitte geben Sie die gewünschte Aktion an.';
