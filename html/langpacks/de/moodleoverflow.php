...
$string['allownegativereputation_help'] = 'Wenn ja, kann die Reputation der Benutzer innerhalb eines Kurses oder Moduls negativ sein. Wenn nein, kann die Reputation nicht unter Null sinken.';
...
$string['bestanswer'] = 'Der Fragesteller und der Kursverantworliche haben dies als die beste Antwort ausgewählt.';
...
$string['configmaxeditingtime'] = 'Die Voreinstellung für den Zeitraum, während welchem ein Beitrag editiert werden darf, beträgt 3600 Sekunden (=30 Minuten)';
$string['configmaxmailingtime'] = 'Anzahl der Stunden, nach deinen eine neue Nachricht nicht mehr per Mail an die Nutzer versendet wird. Dies verhindert Probleme, wenn der Cron Job für eine längere Zeit nicht gelaufen ist.';
...
$string['configreputationnotnegative'] = 'Verhindert, dass die Reputation von Nutzern negativ sein kann.';
...
$string['coursewidereputation_help'] = 'Wenn ja, wird die Reputation der Nutzer von allen Moodleoverflow Modulen in diesem Kurs summiert.';
...
$string['modulename_help'] = 'Das Moodleoverflow Modul ermöglicht es Teilnehmern eine Frage-Antwort Forum Struktur zu nutzen. Die Beiträge im Forum werden nicht chronologisch angezeigt, sondern nach ihrer Bewertung geordnet.';
...
$string['nopostmoodleoverflow'] = 'Sie dürfen in diesem Forum eigenen keine Beiträge schreiben.';
...
$string['nownotsubscribed'] = '{$a->name} wird künftig KEINE Kopien von \'{$a->moodleoverflow}\' per E-Mail erhalten.';
$string['nownottracking'] = '{$a->name} will \'{$a->moodleoverflow}\' nicht weiter verfolgen.';
$string['nowsubscribed'] = '{$a->name} wird künftig Kopien von \'{$a->moodleoverflow}\'  per E-Mail erhalten.';
...
$string['privacy:metadata:moodleoverflow_discuss_subs'] = 'Informationen über individuell abonnierte Themen (ein Nutzer hat ein Thema abonniert, oder ein Thema, das andernfalls abonniert wäre, deabonniert).';
...
$string['privacy:metadata:moodleoverflow_discuss_subs:userid'] = 'Die ID des Nutzers, der die Abonnement-Einstellungen geändert hat.';
...
$string['privacy:metadata:moodleoverflow_discussions:userid'] = 'Die ID des Nutzers, der das Thema gestartet hat';
$string['privacy:metadata:moodleoverflow_discussions:usermodified'] = 'Die ID des Nutzers, der das Thema bearbeitet hat.';
...
$string['privacy:metadata:moodleoverflow_posts:userid'] = 'Die ID des Nutzers, der diesen Beitrag erstellt hat.';
...
$string['privacy:metadata:moodleoverflow_ratings:userid'] = 'Die ID des Nutzers, der die Bewertung abgegeben hat.';
...
$string['privacy:metadata:moodleoverflow_read:firstread'] = 'Der Zeitpunkt, wann der Beitrag das erste Mal vom Nutzer gelesen wurde.';
$string['privacy:metadata:moodleoverflow_read:lastread'] = 'Der Zeitpunkt, wann der Beitrag das letzte Mal vom Nutzer gelesen wurde.';
$string['privacy:metadata:moodleoverflow_read:postid'] = 'Die ID des Beitrags, der gelesen wurde.';
$string['privacy:metadata:moodleoverflow_read:userid'] = 'Die ID des Nutzers, der den Beitrag gelesen hat.';
...
$string['privacy:metadata:moodleoverflow_subscriptions:moodleoverflow'] = 'Die ID des Moodleoverflow-Forum, das der Nutzer abonniert hat.';
$string['privacy:metadata:moodleoverflow_subscriptions:userid'] = 'Die ID vom Nutzer, der das Forum abonniert hat.';
