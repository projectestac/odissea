...
/**
 * Strings for component 'questionnaire', language 'de', version '4.1'.
 *
...
$string['submitpreviewcorrect'] = 'Die Antwort würde als korrekt ausgefüllt akzeptiert werden.';
...
$string['viewallresponses_help'] = 'Wenn die Befragung im **Gruppenmodus** auf *Sichtbare Gruppen* oder *Getrennte Gruppen* gesetzt ist und der/die aktuelle Nutzer/in das Recht *moodle/site:accessallgroups* hat (im aktuellen Kontext) und im aktuellen Kurs Gruppen definiert wurden, dann hat der/die Nutzer/in Zugriff auf eine Dropdown-Liste der Gruppen. Diese Dropdown-Liste ermöglicht es dem/der Nutzer/in die Antworten der Befragung nach Gruppen zu filtern. Bei der Einstellung **Gruppenmodus**: *Getrennte Gruppen* haben Nutzer/innen, die nicht das Recht *moodle/site:accessallgroups* haben (meist \'Teilnehmer/in\' oder \'Trainer/in ohne Bearbeitungsrecht\', etc.) nur Zugriff auf die Antworten der Gruppe in die sie selbst eingetragen sind.';
