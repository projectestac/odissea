...
$string['allresponses'] = 'Alle Antworten';
...
$string['attemptsallowed'] = 'Versuche erlaubt: {$a}';
$string['attemptstillinprogress'] = 'In Bearbeitung. Gespeichert unter:';
$string['autodeletereponse'] = 'Antworten automatisch löschen nach [?]';
$string['autodeletereponse_desc'] = 'Aktivieren Sie diese Einstellung, um alte Antworten automatisch nach der in "Alte Antworten löschen nach" festgelegten Zeit zu löschen. Deaktivieren Sie diese Option, um alle Antworten zu behalten.';
...
$string['configremoveoldresponses'] = 'Einstellung, die für alle neuen Befragungen als Standard verwendet wird.';
...
$string['confirmdelpermanentlyq'] = 'Möchten Sie diese Frage wirklich dauerhaft löschen?';
...
$string['couldnotdelrespby'] = 'Die Antwort {$a->rid} von {$a->user} konnte nicht gelöscht werden.';
...
$string['deletepermanentlybutton'] = 'Frage dauerhaft löschen';
$string['deletequestionsolderthan'] = 'Fragen löschen, die älter sind als';
$string['deleteresp'] = 'Diese Antwort löschen';
$string['deletesection'] = 'Diesen Abschnitt löschen';
$string['deletesettingdescription'] = 'Der geplante Task löscht alle Fragen im Löschbereich, die älter als diese Anzahl an Tagen sind.';
$string['deletingresp'] = 'Antwort wird gelöscht';
$string['deletionquetions'] = 'Löschbereich für Fragen';
$string['deletionquetions_help'] = 'Gelöschte oder verwaiste Fragen werden zunächst hierher verschoben, anstatt endgültig gelöscht zu werden. Die Fragen können entweder manuell durch Klicken auf das „X“-Symbol gelöscht werden oder das System entfernt sie automatisch nach einer Woche. Verwenden Sie den Pfeil nach oben, um die Frage wiederherzustellen.';
...
$string['duedate'] = 'Fälligkeitstermin';
...
$string['enterpossibleanswers'] = 'Mögliche Antworten eingeben';
...
$string['file'] = 'Datei';
$string['file_help'] = 'Erlauben Sie Nutzer/innen, eine Datei einzureichen (nur einfache, virenfreie Formate sind zulässig).';
...
$string['fullsubmissions'] = 'Vollständige Einreichungen';
...
$string['printbutton'] = 'Drucken';
$string['printstrictdateformatting'] = 'Datum eingeben';
...
$string['recylebindisabled'] = '<span class="timedeletednext7days">Automatische Löschung ist deaktiviert</span>';
...
$string['removeoldresponses'] = 'Alte Antworten löschen';
$string['removeoldresponses_help'] = 'Das System kann Antworten nach einer gewissen Zeit automatisch löschen.';
$string['removeoldresponsesafter'] = 'Alte Antworten löschen nach';
$string['removeoldresponsesdefault'] = 'Niemals löschen';
...
$string['responses_breakdown'] = '(Einreichungen: {$a->responses} | in Bearbeitung: {$a->incomplete})';
$string['responsesnotsubmitted'] = 'Antworten wurden nicht übermittelt';
...
$string['restorebutton'] = 'Diese Frage wiederherstellen';
...
$string['save_and_exit'] = 'Speichern und verlassen';
...
$string['studentwhoresponded'] = 'Teilnehmer/innen mit einer Antwort';
...
$string['timedeletednext7days'] = '<span class="timedeletednext7days">Zeitpunkt der endgültigen Löschung: Nacht des {$a}</strong>';
$string['title'] = 'Titel';
...
$string['viewallxresponses'] = 'Alle {$a} Antworten anzeigen';
