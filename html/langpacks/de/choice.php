...
/**
 * Strings for component 'choice', language 'de', version '4.5'.
 *
 * @package     choice
 * @category    string
...
$string['cannotsubmit'] = 'Ihre Auswahl wurde nicht gespeichert. Versuchen Sie es nochmal.';
$string['choice'] = 'Abstimmung';
$string['choice:addinstance'] = 'Neue Abstimmung hinzufügen';
$string['choice:choose'] = 'Abstimmung vornehmen';
$string['choice:deleteresponses'] = 'Antworten ändern oder löschen';
...
$string['choicefull'] = 'Eine oder mehrere von Ihnen gewählte Optionen sind bereits voll belegt. Ihre Auswahl wurde nicht gespeichert. Wählen Sie etwas anderes.';
...
Sie können jedes der vorhandenen Felder ausfüllen. Wenn Sie Felder leer lassen, werden diese in der Abstimmung nicht angezeigt. Um mehr Felder zu erhalten, klicken Sie auf die Taste "Felder zum Formular hinzufügen".';
...
$string['full'] = '(Voll belegt)';
$string['havetologin'] = 'Sie müssen angemeldet sein, um sich an der Abstimmung beteiligen zu können.';
$string['includeinactive'] = 'Mit Ergebnissen von inaktiven / gesperrten Nutzer/innen';
...
$string['limitanswers_help'] = 'Diese Option legt die maximale Anzahl möglicher Antworten für die betreffende Abstimmoption fest. Sobald diese Obergrenze erreicht ist, kann sich niemand mehr für diese Abstimmoption entscheiden.
...
$string['previewing'] = 'Dies ist nur eine Vorschau der verfügbaren Optionen für die Aktivität. Sie können Ihre Auswahl einreichen, sobald die Aktivität öffnet.';
$string['previewonly'] = 'Dies ist nur eine Vorschau der verfügbaren Optionen für die Aktivität. Sie können Ihre Auswahl erst ab {$a} einreichen.';
...
$string['privacy:metadata:choice_answers:optionid'] = 'Options-ID, die die Person ausgewählt hat';
$string['privacy:metadata:choice_answers:timemodified'] = 'Zeitpunkt, zu dem die Abstimmung aktualisiert wurde';
$string['privacy:metadata:choice_answers:userid'] = 'ID der Person, die die Abstimmung durchgeführt hat';
...
$string['publishinfoanonclose'] = 'Ergebnisse werden nach Abschluss der Aktivität ohne Namensnennung veröffentlicht.';
...
$string['removeresponses'] = 'Alle Stimmabgaben';
...
$string['showavailable_help'] = 'Den Teilnehmer/innen wird für jede Option die bisherige Anzahl der Auswahlen und die Obergrenze angezeigt.';
$string['showpreview'] = 'Vorschau anzeigen';
$string['showpreview_help'] = 'Diese Option legt fest, ob die verfügbaren Auswahlmöglichkeiten bereits vor dem Abstimmungsbeginn angezeigt werden.';
...
$string['withselected'] = 'Mit gewählter Antwort';
