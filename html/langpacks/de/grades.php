...
$string['aggregatesonly'] = 'Nur Gesamtwerte anzeigen';
...
$string['aria-toggledropdown'] = 'Folgende Dropdown-Menü umschalten';
$string['aria:dropdowngrades'] = 'Bewertungselemente gefunden';
...
$string['calculationwarning'] = 'Diese Kategorie verwendet eine Notenberechnung für die Kategoriesumme anstelle einer Aggregation.';
...
$string['errorcalculationbroken'] = 'Fehler bei der Berechnung der Bewertung {$a}';
...
$string['erroroverweight'] = 'Das Gesamtgewicht übersteigt 100 %.';
...
$string['errorunderweight'] = 'Das Gesamtgewicht ist weniger als 100 %.';
...
$string['feedbackprovided'] = 'Rückmeldung gegeben';
$string['feedbacks'] = 'Feedbacks';
$string['feedbacksaved'] = 'Feedback gespeichert';
$string['feedbackview'] = 'Feedback ansehen';
$string['filterbothactive'] = 'Vorname ({$a->first}) Nachname ({$a->last})';
$string['filterbyname'] = 'Filter nach Name';
$string['filterfirstactive'] = 'Vorname ({$a->first})';
$string['filterlastactive'] = 'Nachname ({$a->last})';
...
$string['fullmode'] = 'Bewertungen und Gesamtwerte anzeigen';
...
$string['gradebookcalculationsuptodate'] = 'Die Berechnungen der Bewertungen sind aktuell. Um die Änderungen zu sehen, muss die Seite neu geladen werden.';
...
$string['gradepass_help'] = 'Diese Option legt die erforderliche Mindestbewertung (in Punkten, nicht in Prozent!) für das Bestehen fest. Der Wert wird beim Aktivitäts- und beim Kursabschluss verwendet, außerdem wird bei der Bewertung ein Bestehen in grün und ein Scheitern in rot markiert.';
...
$string['gradesonly'] = 'Nur Bewertungen werden angezeigt';
...
$string['importfilemissing'] = 'Es konnte keine Datei importiert werden. Gehen Sie zu dem Formular zurück und prüfen Sie, ob die richtige Datei ausgewählt wurde.';
$string['importfrom'] = 'Import von';
$string['importoutcomenofile'] = 'Die hochgeladene Datei ist leer oder fehlerhaft. Prüfen Sie die Datei. Das Problem trat in Zeile {$a} auf. Die Meldung erscheint, wenn in den Datenzeilen nicht genau so viele Einträge vorhanden sind wie in der Kopfzeile angelegt wurden, oder ein Fehler in der Kopfzeile vorliegt. Wenn Sie einen Export vornehmen, können Sie darin die richtige Struktur der Kopfzeile erkennen.';
...
$string['intersectioninfo'] = 'Info zu Teilnehmer/in und Bewertung';
...
$string['linktoactivity'] = 'Aktivität {$a->name} \'{$a->title}\'';
$string['lock'] = 'Sperren';
...
$string['manageoutcomes'] = 'Lernziele verwalten';
...
$string['minmaxupgradedgrades'] = 'Hinweis: Eine Bewertung oder mehrere Bewertungen wurden geändert, um Inkonsistenzen in den Bewertungen zu korrigieren. Diese sind aufgetreten durch Änderungen der Einstellung zu den niedrigsten und höchsten Bewertungen, die für die angezeigte Bewertung berücksichtigt werden sollen.';
$string['minmaxupgradefixbutton'] = 'Widersprüche beheben';
$string['minmaxupgradewarning'] = 'Hinweis: Bei einer Bewertung oder mehreren Bewertungen wurde eine Inkonsistenz festgestellt, die auf eine Änderung der niedrigsten und höchsten Bewertung in den Bewertungen zurückzuführen ist. Es wird empfohlen, die Unstimmigkeit durch Klicken auf die Schaltfläche unten zu beheben, auch wenn dadurch einige Bewertungen geändert werden.';
$string['missingitemtypeoreid'] = 'Array-Schlüssel (itemtype oder eid) fehlt';
...
$string['moveselectedto'] = 'Ausgewählte Elemente verschieben nach:';
$string['movesitems'] = 'Elemente verschieben';
...
$string['nonunhideableverbose'] = 'Um diese Bewertung sichtbar zu machen, müssen Sie {$a->itemname} einblenden.';
...
$string['norolesdefined'] = 'Es wurden keine Rollen definiert unter "Website Administration > Bewertungen > Allgemeine Einstellungen > Bewertete Rollen"';
...
$string['outcomesdisabled'] = 'Ergebnisse sind nicht aktiviert';
...
$string['searchcollapsedcolumns'] = 'Zugeklappte Spalten suchen';
...
$string['showingfullmode'] = 'Bewertungen und Gesamtwerte anzeigen';
...
$string['studentsperpagereduced'] = 'Verringert die maximale Anzahl von Teilnehmer/innen pro Seite von {$a->originalstudentsperpage} auf {$a->studentsperpage}. Die PHP Einstellung max_input_vars sollte auf  {$a->maxinputvars} gesetzt werden.';
...
$string['viewfeedback'] = 'Rückmeldung anzeigen';
