...
/**
 * Strings for component 'repository', language 'de', version '4.5'.
 *
 * @package     repository
 * @category    string
...
$string['aliaseschange'] = 'Diese Datei wird von Aliases ({$a}) als Quelle verwendet. Wenn Sie weitermachen, werden diese Aliases in Dateikopien umgewandelt.';
...
$string['chooselicense_help'] = 'Folgen Sie diesen Links, um weitere Infos zu den verfügbaren Lizenzoptionen zu erhalten:';
...
$string['configsyncfiletimeout'] = 'Timeout (in Sekunden) für die Synchronisation einer externen Datei';
$string['configsyncimagetimeout'] = 'Timeout (in Sekunden) für den Download einer Bilddatei während der Synchronisation mit dem Repository';
...
$string['confirmdeletefilewithhref'] = 'Möchten Sie diese Datei wirklich löschen? Zu dieser Datei gibt es {$a} Aliase/Verknüpfungen. Wenn Sie den Vorgang fortsetzen, werden die Aliase in Kopien umgewandelt.';
...
$string['confirmdeleteselectedfile'] = 'Möchten Sie wirklich die ausgewählten Dateien ({$a}) löschen?';
...
$string['confirmrenamefile'] = 'Möchten Sie wirklich diese Datei umbenennen bzw. verschieben?';
$string['confirmrenamefolder'] = 'Möchten Sie dieses Verzeichnis wirklich umbenennen oder verschieben? Alle Aliase/Verknüpfungen werden in Kopien umgewandelt.';
...
$string['errordoublereference'] = 'Das Überschreiben des Dateinamens durch einen Link ist nicht möglich, weil bereits Links zu dieser Datei existieren.';
$string['errornotyourfile'] = 'Sie dürfen nur Dateien auswählen, die von Ihnen hinzugefügt wurden.';
...
$string['errorwhiledownload'] = 'Beim Herunterladen der Datei {$a} trat ein Fehler auf';
...
$string['logintoaccount'] = 'Anmelden zum Nutzerkonto {$a}';
...
$string['makefilelink'] = 'Link zur externen Datei';
$string['makefilereference'] = 'Link zur Datei anlegen';
...
$string['nofilesselected'] = 'Keine Dateien ausgewählt';
$string['nolicenses'] = 'Es sind keine Lizenzen verfügbar';
...
$string['norepositoriesexternalavailable'] = 'Keine Ihrer aktuellen Dateiverwaltungen kann externe Dateien liefern';
...
$string['originalextensionchange'] = 'Die ursprüngliche Dateiendung wurde bei der Umbenennung der Datei ebenfalls geändert. Das Ändern der Dateiendung von \'.{$a->originalextension}\' nach \'.{$a->newextension}\' könnte bewirken, dass die Datei nicht mehr geöffnet werden kann.';
$string['originalextensionremove'] = 'Die ursprüngliche Dateiendung wurde bei der Umbenennung der Datei entfernt. Das Löschen der Dateiendung \'.{$a}\' könnte seltsame Effekte hervorrufen.';
...
$string['popup'] = 'Klicken Sie auf die Taste "Anmelden", um sich anzumelden';
$string['popupblockeddownload'] = 'Das Download-Fenster ist blockiert. Erlauben Sie Popup-Fenster in Ihrem Browser und versuchen Sie es nochmal.';
$string['preview'] = 'Vorschau';
$string['privacy:metadata:repository'] = 'Die Repository-Komponente speichert die Repository-Typen im Core-System.';
$string['privacy:metadata:repository_instances'] = 'Das Repository-Plugin speichert Daten zu nutzereigenen Repository-Instanzen im Core-System.';
...
$string['setupdefaultplugins'] = 'Einrichten der  Repository-Plugins';
...
$string['uploaderror'] = 'Fehler beim Hochladen einer Datei';
