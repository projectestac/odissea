...
/**
 * Strings for component 'atto_media', language 'de', version '3.11'.
 *
 * @package     atto_media
 * @category    string
...
$string['audio'] = 'Audio';
$string['audiosourcelabel'] = 'URL für Audio';
...
$string['captionssourcelabel'] = 'URL für Bildunterschriften-Track';
...
$string['tracks_help'] = 'Untertitel, Beschriftungen, Kapitel und Beschreibungen können über eine WebVTT-Formatdatei (Web Video Text Tracks) eingefügt werden. Track-Labels werden im Auswahlmenü angezeigt. Für jeden Spurtyp wird die vorab eingestellte Spur zu Beginn des Videos vorgewählt.';
$string['video'] = 'Video';
