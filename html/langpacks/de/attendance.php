...
/**
 * Strings for component 'attendance', language 'de', version '3.11'.
 *
 * @package     attendance
 * @category    string
...
$string['error:usernotfound'] = 'Ein/e Nutzer/in mit {$a->userfield}, das für {$a->extuser} gesetzt wurde konnte nicht gefunden werden';
...
$string['mobilesessionfrom'] = 'Zeige Termin, die vor dem letzten liegen';
...
$string['sessionduplicate'] = 'Es existiert bereits ein duplizierter Termin für den Kurs {$a->course} in der Anwesenheit: {$a->activity}';
...
$string['studentavailability_help'] = 'Wenn Teilnehmer/innen ihre eigene Anwesenheit erfassen, dann erscheint der jeweilige Status zeitversetzt in den hier angegebenen Minuten nach Beginn des Termins.
