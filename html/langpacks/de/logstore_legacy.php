...
/**
 * Strings for component 'logstore_legacy', language 'de', branch 'MOODLE_38_STABLE'
 *
...
$string['privacy:metadata:log:info'] = 'Zusätzliche Informationen';
$string['privacy:metadata:log:ip'] = 'IP-Adresse, die zum Zeitpunkt der Aktion verwandt wurde';
$string['privacy:metadata:log:time'] = 'Zeitpunkt an dem Aktion erfolgte';
$string['privacy:metadata:log:url'] = 'URL für Ereignis';
$string['privacy:metadata:log:userid'] = 'ID des Nutzers, der Aktion auslöste';
