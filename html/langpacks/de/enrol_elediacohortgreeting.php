...
/**
 * Strings for component 'enrol_elediacohortgreeting', language 'de', version '3.11'.
 *
...
$string['creategroup'] = 'Neue Gruppe erstellen';
...
$string['greeting_checkbox'] = 'Kursbegrüßung versenden?';
$string['greeting_text'] = 'Kursbegrüßungstext';
$string['idnumber'] = 'Globale Gruppen-ID';
$string['instanceexists'] = 'Globale Gruppe wurde bereits mit der ausgewählten Rolle synchronisiert';
