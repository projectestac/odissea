...
/**
 * Strings for component 'filters', language 'de', version '3.11'.
 *
 * @package     filters
 * @category    string
...
$string['isnotequalto'] = 'ist nicht gleich mit';
$string['limiterfor'] = 'Feldbegrenzung: {$a}';
$string['neveraccessed'] = 'Nicht benutzt';
$string['nevermodified'] = 'Nicht geändert';
$string['newfilter'] = 'Neue Suche';
$string['nofiltersenabled'] = 'Für diese Website sind keine Filter-Plugins aktiviert.';
$string['off'] = 'Aus';
$string['offbutavailable'] = 'Aus (verfügbar)';
$string['on'] = 'An';
$string['privacy:reason'] = 'Das Filter-Subsystem speichert keine personenbezogenen Daten.';
$string['profilefilterfield'] = 'Name des Profilfelds';
$string['profilefilterlimiter'] = 'Operator für Profilfeld';
...
$string['replacefilters'] = 'Filter ersetzen';
