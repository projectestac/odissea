...
$string['completionpass_help'] = 'Wenn diese Option aktiviert ist, gilt diese Aktivität als abgeschlossen, wenn Teilnehmer/innen eine Note zum Bestehen (wie im Abschnitt "Bewertungen" der H5P-Aktivitätseinstellungen angegeben) oder höher erhälten.';
...
$string['contactpersondescription'] = 'H5P wird sich an die Kontaktperson wenden, falls es Probleme mit den vom Herausgeber geteilten Inhalten gibt. Der Name des Ansprechpartners sowie sonstige Angaben werden nicht veröffentlicht oder an Dritte weitergegeben.';
...
$string['copyrightwarning'] = 'Urheberrechtlich geschütztes Material kann nicht im H5P-Hub geteilt werden. Wenn der Inhalt mit einer OER-freundlichen Lizenz wie Creative Commons lizenziert ist, wählen Sie bitte die entsprechende Lizenz aus. Andernfalls kann dieser Inhalt nicht geteilt werden.';
...
$string['emailaddressdescription'] = 'Die E-Mail-Adresse wird von H5P verwendet, um die Herausgeber/innen zu kontaktieren, falls Probleme mit dem Inhalt auftreten oder Herausgeber/innen ihr Konto wiederherstellen müssen. Eine Veröffentlichung oder Weitergabe an Dritte erfolgt nicht.';
...
$string['gradetopassmustbeset'] = 'Die zum Bestehen erforderliche Note darf nicht Null sein. Die Abschlussmethode dieser H5P-Aktivität ist so festgelegt, dass eine Bestehensnote erforderlich ist. Legen Sie bitte einen Wert ungleich Null fest.';
$string['gradetopassnotset'] = 'Für diese H5P-Aktivität ist noch keine Note zum Bestehen festgelegt. Sie kann im Abschnitt "Bewertung" der H5P-Aktivitätseinstellungen festgelegt werden.';
...
$string['hvp:share'] = 'Inhalte auf dem H5P-Hub teilen';
...
$string['publisherdescriptiontext'] = 'Dies wird als "Herausgeberinfo" für die geteilten Inhalte angezeigt.';
$string['publisherfielddescription'] = 'Dies wird als "Herausgebername" für die geteilten Inhalte angezeigt.';
...
$string['reviewandshare'] = 'Prüfen & Teilen';
$string['reviewinfo'] = 'Infos prüfen';
$string['reviewmessage'] = 'Prüfen Sie bitte die Infos, bevor Sie teilen.';
...
$string['sharetryagain'] = 'Etwas ist schief gegangen. Versuchen Sie das Teilen bitte noch einmal.';
...
$string['subcontentwarning'] = 'Sub-Inhalte (Bilder, Fragen, usw.) werden unter :licence geteilt, wenn nichts anderes im Autorentool festgelegt wurde.';
