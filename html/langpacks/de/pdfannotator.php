...
$string['add_private_comment'] = 'Kommentar zu privater Notiz hinzufügen';
$string['add_protected_comment'] = 'Kommentar zu privater Frage hinzufügen';
$string['ago'] = 'vor {$a}';
$string['all'] = 'alle';
$string['all_answers'] = 'Alle Antworten';
$string['all_questions'] = 'Alle Fragen';
...
$string['clicktoopen2'] = 'Klicken Sie auf {$a} um die Datei zu sehen.';
$string['closedquestions'] = 'geschlossene';
$string['colorPicker'] = 'Farbauswahl';
$string['comment'] = 'Kommentar';
$string['commentDeleted'] = 'Kommentar wurde gelöscht';
$string['comments'] = 'Kommentare';
$string['comments_icon_private'] = 'Dieser Kommentar ist privat';
$string['comments_icon_public'] = 'Dieser Kommentar ist öffentlich';
$string['comments_text_all'] = 'Alle Kommentare anzeigen';
$string['comments_text_private'] = 'Nur private Kommentare anzeigen (orange)';
$string['comments_text_public'] = 'Nur öffentliche Kommentare anzeigen (blau)';
...
$string['dnduploadpdfannotator'] = 'Erstelle Datei für PDF-Annotation';
...
$string['editedComment'] = 'zuletzt bearbeitet';
...
$string['export_comments_csv'] = 'Export als CSV';
$string['export_comments_csv_tooltip'] = 'Kommentare als CSV Datei herunterladen';
$string['export_comments_pdf'] = 'Export als PDF';
$string['export_comments_pdf_tooltip'] = 'Kommentare als PDF Datei herunterladen';
$string['filenotfound'] = 'Leider wurde keine Datei gefunden.';
$string['forward'] = 'Weiterleiten';
$string['forwardedquestionhtml'] = '{$a->sender} leitete folgende Frage an Sie weiter: <br /> <br />
...
$string['global_setting_latexapisetting_desc'] = 'API zur Umwandling von LaTeX in PNG beim Herunterladen von PDFs.<br>
        ...
        Wenn Sie die Moodle API nutzen, müssen Sie latex, dvips und convert als ausführbare Dateien auf Ihrem Server haben.
        (Siehe <a href="https://docs.moodle.org/en/TeX_notation_filter">Moodle Dokumentation</a>)';
$string['global_setting_latexusegoogle'] = 'Google Chart API';
$string['global_setting_latexusemoodle'] = 'Interne Moodle API';
$string['global_setting_use_private_comments'] = 'Persönliche Notizen erlauben?';
$string['global_setting_use_private_comments_desc'] = 'Teilnehmer/innen erlauben, persönliche Annotationen und Notizen zu erstellen. Diese sind nur für die jeweiligen Autor/innen sichtbar.';
$string['global_setting_use_protected_comments'] = 'Private Kommentare erlauben?';
$string['global_setting_use_protected_comments_desc'] = 'Teilnehmer/innen erlauben, private Annotationen und Kommentare zu erstellen. Diese sind nur für die jeweiligen Autor/innen und Manager/innen sichtbar.';
...
$string['myprotectedquestions'] = 'Meine privaten Fragen';
...
$string['pdfannotator:forwardquestions'] = 'Weitergeleitete Fragen';
...
$string['pdfannotator:viewprotectedcomments'] = 'Private Kommentare sehen';
...
$string['pdfannotator:writeprivatecomments'] = 'Persönliche Notizen machen';
$string['pdfannotator:writeprotectedcomments'] = 'Private Kommentare verfassen';
...
$string['private_comments'] = 'Persönliche Notizen';
$string['private_comments_help'] = 'Nur für dich sichtbar.';
$string['protected_answers'] = 'Private Antworten';
$string['protected_comments'] = 'Private Kommentare';
$string['protected_comments_help'] = 'Nur für Sie und Manager/innen sichtbar.';
$string['protected_questions'] = 'Private Fragen';
$string['public_comments'] = 'Öffentliche Kommentare';
$string['publicanswers'] = 'Öffentliche Antworten';
$string['publicquestions'] = 'Öffentliche Fragen';
...
$string['questionstabicon'] = 'Fragen';
...
$string['recipient'] = 'Empfänger/innen';
$string['recipient_help'] = 'Um mehrere Personen auszuwählen, halten Sie "Strg" gedrückt';
$string['recipientforwardform'] = 'Weiterleiten an';
$string['recipientrequired'] = 'Empfänger/innen auswählen';
...
$string['setting_use_private_comments'] = 'Persönliche Notizen erlauben';
$string['setting_use_private_comments_help'] = 'Teilnehmer/innen erlauben, persönliche Notizen zu verfassen. Diese sind nur für die jeweiligen Autor/innen sichtbar.';
$string['setting_use_protected_comments'] = 'Private Kommentare erlauben';
$string['setting_use_protected_comments_help'] = 'Teilnehmer/innen erlauben, private Kommentare zu verfassen. Diese sind nur für die jeweiligen Autor/innen und Manager/innen sichtbar.';
...
$string['use_private_comments'] = 'Teilnehmer/innen erlauben, persönliche Notizen zu verfassen.';
$string['use_protected_comments'] = 'Teilnehmer/innen erlauben, private Kommentare zu verfassen.';
