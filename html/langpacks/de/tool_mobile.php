...
/**
 * Strings for component 'tool_mobile', language 'de', version '4.5'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['autologout_desc'] = 'Aus Sicherheitsgründen können Sie das automatische Abmelden für alle Nutzer/innen erzwingen, wenn diese die App verlassen, schließen oder in den Hintergrund bringen. Nutzer/innen müssen sich dann neu anmelden, wenn sie zur App zurückkehren.';
...
$string['logoutconfirmation'] = 'Möchten Sie sich wirklich von der mobilen App auf allen mobilen Geräten abmelden? Sie müssen anschließend Ihren Anmeldenamen und das Kennwort auf allen Geräten neu eingeben, um die App zu verwenden.';
