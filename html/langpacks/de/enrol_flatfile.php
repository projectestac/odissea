...
/**
 * Strings for component 'enrol_flatfile', language 'de', version '4.4'.
 *
...
$string['location_desc'] = 'Geben Sie bitte den vollständigen Pfad der Einschreibedatei an. Die Datei wird nach der Verarbeitung automatisch gelöscht.';
