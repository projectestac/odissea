...
/**
 * Strings for component 'enrol_lti', language 'de', version '4.5'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['incorrecttoken'] = 'Das Token war falsch. Überprüfen Sie die URL und versuchen Sie es nochmal oder kontaktieren Sie die Administrator/innen dieses Tools.';
$string['invalidexpiredregistrationurl'] = 'Ungültige oder abgelaufene Registrierungs-URL. Prüfen Sie bitte die URL und versuchen Sie es nochmal.';
...
$string['ltiadvdynregerror:invalidopenidconfigjson'] = 'Beim Abrufen der OpenID-Konfiguration ist ein Problem aufgetreten. Das Ergebnis war kein gültiges JSON. Dies kann auch durch die Konfiguration blockierter Hosts verursacht werden. Stellen Sie bitte sicher, dass Ihre Website für die Verbindung mit der Plattform konfiguriert ist, und versuchen Sie es nochmal mit einer neuen Registrierungs-URL.';
