...
$string['browsemodewithname'] = 'Vorschaumodus: {$a}';
...
$string['completionstatus_completed'] = 'Vollständig bearbeitet';
...
$string['hidebrowse_help'] = 'Der Vorschaumodus erlaubt es, eine Aktivität von dem Abgeben nochmal anzusehen. Wenn die Vorschau deaktiviert ist, wird die Taste \'Vorschau\' nicht angezeigt.';
...
$string['popupsblocked'] = 'Es scheint so als ob Popup-Fenster blockiert sind. Das Lernpaket kann nicht angezeigt werden. Prüfen Sie bitte Ihre Browsereinstellungen, bevor Sie es nochmal probieren.';
...
$string['toggletableofcontents'] = 'Inhaltsverzeichnis ein-/ausblenden';
...
$string['tracklatency_help'] = 'Die verstrichene Zeit zwischen dem Zeitpunkt, an dem die Frage der Person angezeigt wurde, und dem Zeitpunkt der ersten Antwort.';
...
$string['trackresult_help'] = 'Dies zeigt an, ob die Person eine richtige Antwort eingegeben hat.';
...
$string['tracksuspenddata_help'] = 'Dies bietet Platz zum Speichern und Abrufen von Daten zwischen den Lernsitzungen';
