...
/**
 * Strings for component 'assignment', language 'de', version '3.11'.
 *
 * @package     assignment
 * @category    string
...
$string['messageprovider:assignment_updates'] = 'Systemnachricht zu Aufgaben (2.2)';
...
$string['privacy:metadata:assignment_submissions:teacher'] = 'ID des/der Trainers/in, der die Lösung bewertet';
