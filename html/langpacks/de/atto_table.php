...
/**
 * Strings for component 'atto_table', language 'de', version '3.11'.
 *
 * @package     atto_table
 * @category    string
...
$string['allowborder_desc'] = 'Die Option legt fest, ob die Rahmen von Tabellen und Tabellenzellen angepasst werden können. Voreingestellt ist der Rahmen  mit schwarzer Linie (solid 1px black).';
...
$string['captionposition'] = 'Position des Titels';
...
$string['privacy:metadata'] = 'Das Plugin atto_table speichert keine personenbezogenen Daten.';
$string['rows'] = 'Zeilen';
$string['settings'] = 'Tabellen';
$string['solid'] = 'Solid';
