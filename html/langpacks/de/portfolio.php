...
/**
 * Strings for component 'portfolio', language 'de', version '4.1'.
 *
 * @package     portfolio
 * @category    string
...
$string['format_leap2a'] = 'Leap2A Portfolio';
...
$string['intro'] = 'Inhalte, die Sie z.B. bei Aufgaben, Foren oder Blogs eingegeben haben, können in ein Portfolio exportiert oder heruntergeladen werden. Sie können ein von Ihnen nicht genutztes Portfolio verbergen, so dass es nicht als Option für den Export angezeigt wird.';
...
$string['logsummary'] = 'Vorherige erfolgreiche Transfers';
...
$string['moderatefilesizethreshold'] = 'Mittlerer Wert für Dateigrößen';
...
$string['showhide'] = 'Anzeigen/Verbergen';
...
$string['sure'] = 'Möchten Sie \'{$a}\' wirklich löschen? Sie können das nicht rückgängig machen!';
...
$string['unknownplugin'] = 'Unbekannt (u.U. von Admins inzwischen entfernt)';
$string['wait'] = 'Warten';
