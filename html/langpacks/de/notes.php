...
/**
 * Strings for component 'notes', language 'de', version '4.1'.
 *
 * @package     notes
 * @category    string
...
$string['addnewnote'] = 'Neue Notiz hinzufügen';
...
$string['nonotes'] = 'Es gibt bisher keine Notizen dieser Art.';
...
$string['page-notes-index'] = 'Jede Notizenhauptseite';
$string['page-notes-x'] = 'Jede Notizenseite';
$string['personal'] = 'Persönlich';
$string['personalnotes'] = 'Persönliche Notizen';
