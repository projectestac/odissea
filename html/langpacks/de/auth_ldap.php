...
/**
 * Strings for component 'auth_ldap', language 'de', version '4.5'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_bind_dn'] = 'Wenn Sie für die Nutzerabfrage einen \'Bind-User\' verwenden müssen, tragen Sie hier dessen Anmeldenamen ein. Der Eintrag hat üblicherweise die Form: \'cn=ldapuser,ou=public,o=org\'.';
$string['auth_ldap_bind_dn_key'] = 'Distinguished Name';
$string['auth_ldap_bind_pw'] = 'Kennwort für den Bind-User';
...
$string['auth_ldap_create_context'] = 'Wenn Sie die Nutzererstellung mit E-Mail-Bestätigung aktivieren, geben Sie den Kontext an, in dem das passieren soll. Dieser Kontext sollte sich vom Kontext anderer Nutzer/innen unterscheiden, um Sicherheitsrisiken zu vermeiden. Der Kontext muss nicht zur Variablen ldap_contexts hinzugefügt werden und Moodle sucht dort automatisch nach Nutzer/innen.
...
$string['auth_ldap_expiration_desc'] = 'Wählen Sie \'{$a->no}\', um den Ablauf von Kennwörtern nicht zu prüfen. Wenn Sie \'{$a->ldapserver}\' wählen, wird das Ablaufdatum direkt vom LDAP-Server gelesen.';
...
$string['auth_ldap_ldap_encoding'] = 'Codierung des LDAP-Servers, meistens utf-8. Wenn LDAP v2 ausgewählt ist, verwendet das Microsoft Active Directory seine Codierungen, z.B. cp1252 oder cp1250.';
$string['auth_ldap_ldap_encoding_key'] = 'LDAP-Codierung';
$string['auth_ldap_login_settings'] = 'Anmeldeeinstellungen';
...
$string['auth_ldap_memberattribute_isdn'] = 'Überschreibt die Verwendung der Werte von Mitgliedsattributen';
...
$string['auth_ldap_preventpassindb'] = 'Wählen Sie \'ja\', um Kennwörter <b>nicht</b> in der Moodle-Datenbank zu speichern';
...
$string['auth_ldap_user_attribute'] = 'Optional: Merkmal zur Nutzerbenennung und Nutzersuche ändern. Normalerweise \'cn\'.';
$string['auth_ldap_user_attribute_key'] = 'Nutzermerkmal';
$string['auth_ldap_user_exists'] = 'LDAP-Nutzername existiert bereits!';
$string['auth_ldap_user_settings'] = 'Nutzersuche (user lookup)';
$string['auth_ldap_user_type'] = 'Wählen Sie, wie  Nutzerkonten in LDAP gespeichert werden. Die Einstellung legt auch fest, wie das Ablaufdatum für Kennwörter, die GraceLogins und das Anlegen neuer Nutzerkonten in LDAP funktionieren.';
...
$string['auth_ldap_version'] = 'Tragen Sie die LDAP-Version Ihres Servers ein.';
...
$string['auth_ntlmsso_ie_fastpath_yesform'] = 'Ja, alle anderen Browser nutzen die normale Anmeldung';
...
$string['ntlmsso_failed'] = 'Die automatische Anmeldung ist fehlgeschlagen. Versuchen Sie die normale Anmeldeseite ...';
...
$string['start_tls'] = 'LDAP-Service mit TLS (Port 389) verwenden';
$string['start_tls_key'] = 'TLS benutzen';
$string['sync_updateuserchunk'] = 'Anzahl der Nutzer/innen, die pro Transaktion aktualisiert werden sollen. Setzen Sie den Wert auf 0, um alle Nutzer/innen mit einer Transaktion zu aktualisieren.';
$string['sync_updateuserchunk_key'] = 'Blockgröße der Nutzersynchronisierung';
