...
/**
 * Strings for component 'block_panopto', language 'de', version '4.1'.
 *
...
$string['attempt_provision_course'] = 'Versuch, ein Panopto-Verzeichnis mit der externen ID {$a} anzulegen';
...
$string['attempt_unprovision_course'] = 'Versuch, die Provisionierung eines Panopto-Verzeichnisses mit einer externen ID von {$a} aufzuheben.';
...
$string['attempted_provisioning_personal_folder'] = 'MDer Versuch, ein persönliches Verzeichnis bereitzustellen, wird derzeit nicht von Panopto unterstützt. Bitte ordnen Sie den Kurs über die Blockinstanz-Konfiguration einem anderen Verzeichnis zu und versuchen Sie die Provisionierung erneut.';
...
$string['attribute_new_name'] = 'Neuer Verzeichnisname';
$string['attribute_original_name'] = 'Ursprünglicher Verzeichnisname';
...
$string['block_global_add_courses'] = 'Fügen Sie Moodlekurse zu Panopto hinzu';
...
$string['block_global_build_category_structure'] = 'Alle Moodle-Kategorien mit Panopto synchronisieren';
...
$string['block_global_panopto_folder_and_category_options'] = 'Optionen für Verzeichnisse und Kategorien';
...
$string['block_global_reinitialize_all_imports'] = 'Alle Panopto-Verzeichnisse neu initialisieren';
$string['block_global_rename_all_folders'] = 'Alle Verzeichnisnamen aktualisieren';
$string['block_global_unprovision_courses'] = 'Die Bereitstellung der Panopto-Verzeichnisse in Moodlekursen aufheben';
$string['block_global_upgrade_all_folders'] = 'Alle vorhandenen Ordner und Importe aktualisieren';
$string['block_panopto_any_creator_can_view_folder_settings'] = 'Allen Nutzer/innen mit Erstellerzugang einen Link zu den Panopto-Verzeichniseinstellungen im Block anzeigen';
...
$string['block_panopto_automatic_operation_target_server_desc'] = 'Dies ist der Panopto-Server, der für die Aufgaben \'Neue Kurse automatisch provisionieren\', \'Nutzer/innen bei der Anmeldung synchronisieren\' und \'Kategoriestruktur durchsetzen\' vorgesehen ist.';
...
$string['sso_type_nosync'] = 'Bei Panopto-Anmeldung synchronisieren';
$string['sso_type_sync'] = 'Bei Panopto-Anmeldung nicht synchronisieren';
