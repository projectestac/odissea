...
$string['cachesessionhelp'] = 'Nutzerspezifischer Cache, der die Session beschleunigt und mit dem Abmelden gelöscht wird';
...
$string['configcookiehttponly'] = 'Um Angriffe über Cross-Website-Scripting (XSS) zu erschweren, werden Cookies nur über echte HTTP-Anfragen gesendet. Cookies sollten nicht für Skripte zugänglich sein. Diese Funktion wird nicht von allen Browsern unterstützt und ist möglicherweise nicht vollständig kompatibel mit dem aktuellen Code.';
...
$string['iscustomadminwarnings'] = 'Es wurde festgestellt, dass Ihre Site ein benutzerdefiniertes Administrator/innenverzeichnis verwendet. Diese Funktion wird nicht mehr unterstützt und wird nach Moodle 4.2 entfernt.';
...
$string['userfeedbackencouragement'] = '<p>Moodle verfügt über eine Funktion, mit der Nutzer/innen ein Feedback zur Moodle-Software abgeben können. Diese Umfrage wird über einen externen Server bereitgestellt. Für die Umfrage werden keine personenbezogenen Daten erfasst oder an den externen Server übertragen.</p>
