...
/**
 * Strings for component 'admin', language 'de', version '4.5'.
 *
 * @package     admin
 * @category    string
...
$string['autologinguests'] = 'Gäste automatisch anmelden';
...
$string['configcustomusermenuitems'] = 'Sie können die Menüpunkte des Nutzermenüs konfigurieren (mit Ausnahme von Abmelden, das automatisch hinzugefügt wird).
...
$string['configintroadmin'] = 'Sie müssen ein Nutzerkonto zur Hauptadministration einrichten, das die vollständige Kontrolle über die Website hat. Achten Sie darauf, unbedingt einen sicheren Anmeldenamen, ein sicheres Kennwort sowie eine gültige E-Mail-Adresse anzugeben. Weitere Administrator/innen können Sie später festlegen.';
...
$string['configlangmenu'] = 'Diese Option legt fest, ob Sie das Sprachmenü auf der Startseite und auf der Anmeldeseiten anzeigen möchten. Dies schränkt nicht die Möglichkeit ein, dass alle Nutzer/innen ihre bevorzugte Sprache im Nutzerprofil einstellen können.';
...
$string['configmaxeditingtime'] = 'Hiermit bestimmen Sie die Zeitdauer, in der Beiträge in Foren, Glossaren usw. bearbeitet werden dürfen. Normalerweise sind 30 Minuten ein guter Wert.';
...
$string['confignotifyloginfailures'] = 'Systemnachrichten zu Anmeldefehlern können an ausgewählte Nutzer/innen gesendet werden. Dazu muss eine interner Protokollierung (z.B. Standard-Logstore) aktiviert sein.';
...
$string['configstatsmaxruntime3'] = 'Die Berechnung der Statistiken kann auf dem Server sehr viel Rechenleistung erfordern. Daher können Sie festlegen, wie viel Zeit dafür höchstens eingesetzt werden soll. Weiter unten legen Sie fest für wie viel Tage innerhalb eines Cron-Job-Durchlaufs die Berechnung der Statistiken erfolgen soll.';
...
$string['creatornewroleid'] = 'Rolle für Kursersteller/innen in neuen Kursen';
...
$string['enroladminnewcourse_help'] = 'Wenn Administrator/innen neue Kurse anlegen, sollen sie automatisch eingeschrieben werden und die Rolle für Kursersteller/innen in neuen Kursen bekommen?';
...
$string['loginpageautofocus_help'] = 'Das Aktivieren dieser Option verbessert die Nutzbarkeit der Anmeldeseite, aber ein Autofokus auf bestimmte Felder könnte auch Probleme hinsichtlich der Barrierefreiheit verursachen.';
...
$string['marketplaceavailablenotice'] = 'Suchen Sie Plugins auf dem <a href="{$a}" target="_blank" rel="noopener noreferrer">Moodle Marktplatz <i class="fa fa-external-link" role="img" aria-label="öffnet in neuem Fenster" title="öffnet in neuem Fenster"></i></a> und laden Sie diese herunter.';
...
$string['moodlenetremovalwarning'] = 'Der MoodleNet-Dienst wird am 20. April 2026 eingestellt. Wenn Sie MoodleNet weiterhin auf Ihrer Website nutzen möchten, installieren Sie das MoodleNet-Plugin aus dem <a href="https://github.com/moodlehq/moodle-tool_moodlenet" target="_blank">Moodle HQ GitHub-Repository <i class="fa fa-external-link" role="img" aria-label="öffnet in neuem Fenster" title="öffnet in neuem Fenster"></i></a> und verbinden Sie es mit einer selbstgehosteten MoodleNet-Instanz. Anschließend wird das Feld für die MoodleNet-Profil-ID entfernt. Migrieren Sie bitte diese Daten, falls Sie sie für andere Zwecke verwenden.';
...
$string['oracledatabaseinuse'] = 'Die Oracle-DB-Unterstützung wird entfernt. Moodle 4.5 wird die letzte Version mit einer Oracle-DB-Unterstützung sein. Weitere Details finden Sie auf moodle.org, u.z. <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank"> Oracle database support in LMS deprecation </a>.';
...
$string['overridetossl'] = 'HTTP für Anmeldungen ist veraltet. Diese Instanz erfordert nun SSL. Um die Warnung zu entfernen, muss der Eintrag für den wwwroot in der Datei config.php auf https:// umgestellt werden.';
...
$string['passwordpolicycheckonlogin'] = 'Kennwort beim Anmelden überprüfen';
...
$string['profilefieldmaxlength_help'] = 'Um dieses Feld in der Einstellung "Nutzeridentität anzeigen" zu verwenden, muss die Zeichenzahl 255 oder kleiner sein.';
...
$string['purgecachesconfirm'] = 'Moodle kann Designs, JavaScript, Sprachstrings, gefilterten Text, RSS-Feeds und andere berechnete Daten zwischenspeichern. Durch das Leeren des Caches werden temporäre Daten vom Server gelöscht und alle Browser zum erneuten Abrufen gezwungen. So können Sie sicher sein, dass Ihnen nur die Werte des aktuellen Codes angezeigt werden. Das Leeren des Caches ist ungefährlich, jedoch kann Ihre Website vorübergehend langsamer erscheinen, bis Server und Clients neue Informationen berechnet und zwischengespeichert haben.';
$string['purgecachesfinished'] = 'Alle Caches wurden gelöscht.';
...
$string['purgethemecache'] = 'Designs';
...
$string['upgradingversion'] = 'Aktualisierung auf eine neue Version';
