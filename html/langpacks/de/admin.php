...
$string['userfiltersdefault_desc'] = 'Wählen Sie die Filter aus, die auf der Seite "Nutzerliste anzeigen" und auf der Seite "Nutzerverwaltung (Bulk)" angezeigt werden sollen. Eine Mehrfachauswahl ist möglich (<strg> bzw. <cmd>). Die nicht ausgewählten Filter sind verfügbar, wenn Sie auf den Link "Mehr anzeigen" klicken.';
