...
/**
 * Strings for component 'folder', language 'de', version '4.1'.
 *
 * @package     folder
 * @category    string
...
$string['downloadfolder'] = 'Verzeichnis herunterladen';
...
$string['showexpanded_help'] = 'Wenn diese Option aktiviert ist, werden Unterverzeichnisse geöffnet dargestellt.';
