...
/**
 * Strings for component 'repository_boxnet', language 'de', branch 'MOODLE_38_STABLE'
 *
...
$string['boxnet:view'] = 'Box-Repository anzeigen';
...
$string['nullfilelist'] = 'Keine Dateien in diesem Repository';
$string['password'] = 'Passwort';
$string['pluginname'] = 'Box';
$string['pluginname_help'] = 'Repository bei Box';
$string['privacy:metadata:repository_boxnet'] = 'Das Box-Repository-Plugin speichert keine personenbezogenen Daten. Es überträgt aber Nutzerdaten von Moodle an das entfernte System.';
