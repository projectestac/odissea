...
/**
 * Strings for component 'registration', language 'de', version '3.11'.
 *
...
$string['confighideidnumber'] = 'ID-Nummer beim Drucken verbergen.';
$string['configmaxstudents'] = 'Maximale Anzahl von Teilnehmer/innen je Terminvergabe.';
...
$string['download_results'] = 'Ergebnisse herunterladen';
...
$string['feedbackupdated'] = 'Bewertungen aktualisiert für {\\$a} Personen';
...
$string['legend'] = 'Achtung! Von verschiedenen Terminen innerhalb eines Abschnitts kann jeweils nur ein Termin pro Person ausgewählt werden.';
$string['lookfor'] = 'Suche';
$string['maximumpoints'] = 'Maximale Punktzahl';
$string['maximumsize'] = 'Maximale Teilnehmerzahl';
$string['maxstudents'] = 'Maximale Teilnehmerzahl';
$string['message'] = 'Änderung bei den Terminvergaben im Kurs {$a->coursename}!
...
$string['noregistrations'] = 'Es gibt bisher noch keine Terminvergaben';
$string['nostudentsyet'] = 'Es haben sich bisher keine Teilnehmer eingetragen.';
$string['note'] = 'Kommentar';
$string['notefull'] = 'Auch wenn der Termin ausgebucht ist, können Sie sich noch anmelden. Sie kommen in die Warteschlange. Falls sich jemand abmeldet, rückt die erste Person aus der Warteschlange nach und wird per E-Mail informiert.';
...
$string['registeredon'] = 'Eingetragen am';
...
$string['subject'] = 'Änderung bei den Terminvergaben im Kurs {$a->coursename} ({$a->duedate})';
$string['submissions'] = 'Ergebnisse';
$string['submitted'] = 'Angemeldet';
$string['userdeleted'] = 'Nutzer/in im System gelöscht.';
