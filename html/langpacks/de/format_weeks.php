...
/**
 * Strings for component 'format_weeks', language 'de', branch 'MOODLE_38_STABLE'
 *
...
$string['deletesection'] = 'Woche löschen';
...
$string['privacy:metadata'] = 'Das Wochen-Kursformat speichert keine personenbezogenen Daten.';
$string['section0name'] = 'Allgemeines';
$string['sectionname'] = 'Woche';
$string['showfromothers'] = 'Woche anzeigen';
