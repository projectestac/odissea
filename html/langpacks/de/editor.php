...
/**
 * Strings for component 'editor', language 'de', version '4.1'.
 *
 * @package     editor
 * @category    string
...
$string['absbottom'] = 'absolut unten';
$string['acteditorshhdr'] = 'Verfügbare Texteditoren';
$string['address'] = 'Adresse';
$string['alertnoselectedtext'] = 'Markieren Sie zuerst den Text';
$string['alignment'] = 'Anordnung';
$string['alternatetext'] = 'Alternativer Text';
$string['anchorhelp'] = 'Der Anker wird hier nur erzeugt. Sie müssen ihn an anderer Stelle manuell verlinken.';
...
$string['cellpadding'] = 'Zelleninnenabstand';
$string['cellspacing'] = 'Zellenabstand';
$string['choosechar'] = 'Zeichen auswählen';
$string['chooseicon'] = 'Icon auswählen';
$string['close'] = 'Schließen';
$string['closeafterreplace'] = 'Nach dem Ersetzen schließen';
$string['cols'] = 'Spalten';
$string['configeditorplugins'] = 'Wählen Sie die Editor-Plugins, die benutzt werden sollen. Sie können eine Reihenfolge festlegen.';
...
$string['cutpastemozilla'] = 'Leider können Sie mit diesem Editor die gewohnten Tastaturkürzel zum Einfügen von Text nicht verwenden. Ursache ist eine Sicherheitsfunktion in einigen Versionen von Mozilla Firefox.<br /><br />Sie können mehrere Möglichkeiten ausprobieren: <br /> (1) An Stelle von Strg-V verwenden Sie Shift-Einfg <br /> (2) Sie nutzen das Menü Bearbeiten > Einfügen <br /> (3) Sie ändern die Browsereinstellungen in der Datei user.js. <br /><br />Mit der Taste "OK" bekommen Sie weitere Infos, mit der Taste "Abbrechen" gehen Sie zurück zum Editor.';
...
$string['htmlmode'] = 'HTML-Code umschalten';
$string['imageurl'] = 'Bild-URL';
$string['indent'] = 'Einrücken vergrößern';
...
$string['linkurl'] = 'URL';
$string['matchcase'] = 'Groß-/Kleinschreibung';
...
$string['nolink'] = 'Autoverlinkung verhindern';
$string['normal'] = 'Normal';
$string['notimage'] = 'Die Datei ist kein Bild. Wählen Sie bitte ein Bild aus.';
$string['notset'] = 'Nicht festgelegt';
$string['ok'] = 'OK';
$string['options'] = 'Optionen';
$string['orderedlist'] = 'Nummerierte Liste';
$string['outdent'] = 'Einrücken verringern';
$string['paste'] = 'Einfügen aus Zwischenablage';
$string['path'] = 'Pfad';
$string['percent'] = 'Prozent';
$string['pixels'] = 'Pixel';
$string['pleaseenteralt'] = 'Bildbescheibung für jemanden, der dieses Bild nicht sehen kann.';
...
$string['right'] = 'Rechts';
$string['righttoleft'] = 'Schrift von rechts nach links';
$string['rows'] = 'Zeilen';
...
$string['textindicator'] = 'Aktueller Stil';
$string['textmode'] = 'Sie arbeiten im HTML-Code. Mit dem [<>]-Icon wechseln Sie zurück zur formatierten Textansicht.';
$string['texttop'] = 'Einleitungstext';
$string['top'] = 'Anfang';
$string['type'] = 'Typ';
$string['underline'] = 'Unterstrichen';
$string['undo'] = 'Rückgängig';
$string['unorderedlist'] = 'Aufzählungsliste';
$string['upload'] = 'Hochladen';
$string['vertical'] = 'Vertikal';
$string['width'] = 'Breite';
$string['wordclean'] = 'Word-HTML bereinigen';
$string['zip'] = 'ZIP';
