...
/**
 * Strings for component 'debug', language 'de', version '4.4'.
 *
 * @package     debug
 * @category    string
...
$string['sqlrelyonobsoletetable'] = 'Dieses SQL beinhaltet fehlerhafte Tabellen: {$a}! Die Entwickler/innen müssen den Code korrigieren.';
