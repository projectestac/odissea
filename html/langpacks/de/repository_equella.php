...
/**
 * Strings for component 'repository_equella', language 'de', version '4.5'.
 *
...
$string['equellauserfield'] = 'EQUELLA Nutzerfeld';
$string['equellauserfield_help'] = 'Wählen Sie das Nutzerfeld, das zum Zuordnen von Equella-Nutzer/innen verwendet werden soll. Es werden nur die Nutzerfelder vom Typ Kurztext aufgelistet.';
$string['equellausername'] = 'Nutzername';
$string['group'] = '{$a} Rolleneinstellungen';
$string['groupdefault'] = 'Grundeinstellung';
$string['pluginname'] = 'Equella';
$string['privacy:metadata'] = 'Das Equella-Repository-Plugin speichert keine personenbezogenen Daten. Es überträgt aber Nutzerdaten von Moodle an das entfernte System';
...
$string['search'] = 'Equella durchsuchen';
$string['selectrestriction'] = 'Beschränkung auswählen';
...
$string['sharedid'] = 'Gemeinsame Secret ID';
$string['sharedidtitle'] = 'Gemeinsame Secret ID';
$string['sharedsecrets'] = 'Gemeinsames Secret';
$string['sharedsecretsheading'] = 'Gemeinsame Secret-Einstellungen';
...
$string['sharedsecrettitle'] = 'Gemeinsames Secret';
