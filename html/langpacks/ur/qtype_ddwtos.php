...
/**
 * Strings for component 'qtype_ddwtos', language 'ur', version '4.4'.
 *
...
$string['privacy:metadata'] = 'متن سوال قسم کے پلگ ان میں گھسیٹیں اور چھوڑیں سوال کے مصنفین کو صارف کی ترجیحات کے بطور ڈیفالٹ اختیارات سیٹ کرنے کی اجازت دیتی ہیں۔';
