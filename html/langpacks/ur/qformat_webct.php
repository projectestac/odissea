...
/**
 * Strings for component 'qformat_webct', language 'ur', version '4.4'.
 *
...
$string['errorsdetected'] = '{$a} غلطیوں کا پتہ چلا';
$string['missinganswer'] = 'بہت کم :ANSWER, :Lx, :Rx سوالات کی سطر {$a} کے لیے بیانات۔ آپ کو کم از کم 2 ممکنہ جوابات کی وضاحت کرنی چاہیے۔';
...
$string['warningsdetected'] = '{$a} وارننگ کا پتہ چلا';
$string['wronggrade'] = 'غلط درجہ (لائن {$a} کے بعد):';
