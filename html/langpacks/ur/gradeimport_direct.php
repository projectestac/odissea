...
/**
 * Strings for component 'gradeimport_direct', language 'ur', version '4.4'.
 *
...
$string['direct:view'] = 'اسپریڈشیٹ سے درجات درآمد کریں';
$string['pluginname'] = 'اسپریڈشیٹ سے پیسٹ کریں';
