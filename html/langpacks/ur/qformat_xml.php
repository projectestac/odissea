...
/**
 * Strings for component 'qformat_xml', language 'ur', version '4.5'.
 *
 * @package     qformat_xml
 * @category    string
...
$string['xmlimportnoname'] = 'XML فائل میں سوال کا نام غائب ہے';
$string['xmlimportnoquestion'] = 'XML فائل میں سوال کا متن غائب ہے';
$string['xmltypeunsupported'] = 'سوال کی قسم {$a} XML درآمد کے ذریعے تعاون یافتہ نہیں ہے';
