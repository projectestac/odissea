...
/**
 * Strings for component 'label', language 'ur', version '4.5'.
 *
 * @package     label
 * @category    string
...
$string['configdndmedia'] = 'میڈیا فائلوں کو گھسیٹ کر کورس پر چھوڑے جانے پر ایک لیبل بنانے کی پیشکش کریں';
$string['configdndresizeheight'] = 'جب ایک لیبل کھینچی گئی اور گرائی گئی تصویر سے بنتا ہے، تو اس کا سائز تبدیل کریں اگر یہ اس سے زیادہ پکسلز سے زیادہ ہے (بغیر سائز کے 0)';
$string['configdndresizewidth'] = 'جب ایک لیبل کھینچی گئی اور گرائی گئی تصویر سے بنتا ہے، تو اس کا سائز تبدیل کریں اگر یہ اس سے زیادہ پکسلز سے زیادہ چوڑا ہو (0 بغیر سائز کے)';
$string['dndmedia'] = 'میڈیا ڈریگ اینڈ ڈراپ';
$string['dndresizeheight'] = 'ڈریگ اور ڈراپ اونچائی کا سائز تبدیل کریں';
$string['dndresizewidth'] = 'ڈریگ اور ڈراپ چوڑائی کا سائز تبدیل کریں';
$string['dnduploadlabel'] = 'کورس کے صفحے پر میڈیا شامل کریں';
$string['dnduploadlabeltext'] = 'کورس کے صفحے پر ایک لیبل شامل کریں';
$string['indicator:cognitivedepth'] = 'لیبل علمی';
...
$string['privacy:metadata'] = 'لیبل ریسورس پلگ ان کوئی ذاتی ڈیٹا محفوظ نہیں کرتا ہے۔';
$string['search:activity'] = 'لیبل';
