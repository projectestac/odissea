...
/**
 * Strings for component 'page', language 'ur', version '4.5'.
 *
 * @package     page
 * @category    string
...
$string['content'] = 'صفحہ کا مواد';
$string['contentheader'] = 'مواد';
$string['createpage'] = 'صفحہ کا نیا وسیلہ بنائیں';
$string['displayoptions'] = 'دستیاب ڈسپلے کے اختیارات';
$string['displayselect'] = 'Display';
$string['displayselectexplain'] = 'ڈسپلے کی قسم منتخب کریں۔';
$string['indicator:cognitivedepth'] = 'صفحہ علمی';
...
$string['page:addinstance'] = 'صفحہ کا نیا وسیلہ شامل کریں';
$string['page:view'] = 'صفحہ کا مواد دیکھیں';
$string['pluginadministration'] = 'صفحہ ماڈیول انتظامیہ';
$string['pluginname'] = 'صفحہ';
...
$string['printlastmodifiedexplain'] = 'مواد کے نیچے آخری ترمیم شدہ تاریخ دکھائیں؟';
$string['privacy:metadata'] = 'پیج ریسورس پلگ ان کوئی ذاتی ڈیٹا محفوظ نہیں کرتا ہے۔';
$string['search:activity'] = 'صفحہ';
