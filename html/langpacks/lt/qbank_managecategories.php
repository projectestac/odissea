...
/**
 * Strings for component 'qbank_managecategories', language 'lt', version '4.5'.
 *
...
$string['after'] = 'Po {$a}';
$string['before'] = 'Prieš {$a}';
$string['categoryincategory'] = 'Negalima perkelti kategorijos į tą pačią kategoriją.';
$string['categorymoved'] = 'Kategorija sėkmingai perkelta.';
...
$string['newchild'] = 'Kaip nauja kategorijos „{$a}“ pakategorė';
$string['pluginname'] = 'Tvarkyti kategorijas';
$string['privacy:preference:showdescriptions'] = 'Žyma, rodanti, ar rodomi kategorijų aprašymai, ar ne.';
$string['showcategorydescription'] = 'Rodyti aprašymus';
