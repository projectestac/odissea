...
/**
 * Strings for component 'qtype_ordering', language 'nl', branch 'MOODLE_38_STABLE'
 *
...
$string['editingordering'] = 'Een vraag van het type Rangschikken bewerken';
...
$string['relativeallpreviousandnext'] = 'Relatief aan ALLE vorige en volgende items';
$string['relativenextexcludelast'] = 'Relatief aan het volgende item (exclusief laatste)';
$string['relativenextincludelast'] = 'Relatief aan het volgende item (inclusief laatste)';
$string['relativeonepreviousandnext'] = 'Relatief aan zowel vorige als volgende items';
$string['relativetocorrect'] = 'Relatief aan correcte positie';
...
$string['selectcontiguous'] = 'Selecteer een';
$string['selectcount'] = 'Omvang subset';
