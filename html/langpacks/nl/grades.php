...
$string['aggregatesonly'] = 'Toon enkel totalen';
...
$string['aria-toggledropdown'] = 'Wissel volgend rolmenu';
$string['aria:dropdowngrades'] = 'Beoordelingsitems gevonden';
...
$string['averagesdecimalpoints_help'] = 'Deze instelling specificeert het aantal decimalen dat getoond wordt voor elk bereik en of de algemene decimaal-instellingen voor de  categorie of het beoordelingsitem gebruikt worden (overerven)';
...
$string['calculationwarning'] = 'Deze categorie gebruikt een cijferberekening voor de categorie in plaats van een aggregatie.';
...
$string['collapsecriterion'] = 'Criterium samenvouwen';
...
$string['deletescale'] = 'Schaal verwijderen';
...
$string['enableoutcomes_help'] = 'Indien ingeschakeld kunnen beoordelingsitems beoordeeld worden door gebruik te maken van één of meer schalen die aan competenties gekoppeld zijn.';
...
$string['errorcalculationbroken'] = 'Fout in de berekening van het beoordelingsitem {$a}.';
...
$string['erroroverweight'] = 'Het totaalgewicht overschrijdt 100%.';
...
$string['errorunderweight'] = 'Het totaalgewicht is minder dan 100%.';
...
$string['feedbackprovided'] = 'Feedback gegeven';
$string['feedbacks'] = 'Feedback';
$string['feedbacksaved'] = 'Feedback bewaard';
$string['feedbackview'] = 'Bekijk feedback';
$string['filterbothactive'] = 'Eerste ({$a->first}) Laatste ({$a->last})';
$string['filterbyname'] = 'Filteren op naam';
$string['filterfirstactive'] = 'Eerste ({$a->first})';
$string['filterlastactive'] = 'Laatste ({$a->last})';
...
$string['fullmode'] = 'Toon cijfers en totalen';
$string['generalsettings'] = 'Algemene instellingen';
$string['grade'] = 'Beoordeling';
$string['grade_help'] = 'Het cijfer dat aan de leerling toegekend wordt voor zijn werk.';
...
$string['gradebookcalculationsuptodate'] = 'De berekeningen in het cijferlijst zijn up-to-date. Vernieuw de pagina om de wijzigingen te zien.';
$string['gradebookcalculationswarning'] = 'Opmerking: er zijn fouten ontdekt in de berekeningen van de cijfers die in het cijferlijst getoond worden. Aangeraden wordt om de fouten te herstellen door op onderstaande knop de drukken, maar dat zal er toe leiden dat sommige cijfers wijzigen.  Als je cursus al beëindigd is en je cijfers zijn al ingestuurd, dan wil je dit misschien niet doen.

De nieuwe versie is  {$a->currentversion}; Jij gebruikt cijferlijst versie {$a->gradebookversion}. Je kunt de wijzigingen zien op <a href="{$a->url}"> Cijferlijst berekeningswijzigingen</a>.';
...
$string['gradebooknavigationmenu'] = 'Cijferlijst navigatiemenu';
$string['gradebooksetup'] = 'Cijferlijst instellen';
...
$string['gradeexportdecimalpoints'] = 'Aantal decimalen voor het exporteren van cijfers';
...
$string['gradeexportuserprofilefields_desc'] = 'Geef deze profielvelden mee in de cijferexport, gescheiden door komma\'s';
...
$string['gradeletter_help'] = '<p>Een letter of ander symbool dat gebruikt wordt om een cijferbereik voor te stellen.</p>';
...
$string['gradenotificationmessage'] = 'Je hebt nieuwe feedback over je werk voor "{$a}"';
$string['gradenotificationsubject'] = 'Je bent beoordeeld';
...
$string['gradesonly'] = 'Toon enkel cijfers';
...
$string['gradingmodulename'] = 'Beoordelen {$a})';
...
$string['hideranges'] = 'Verberg cijferbereik';
...
$string['importsettings'] = 'Importeerinstellingen';
...
$string['linktoactivity'] = '{$a->name} activiteit {$a->title}';
...
$string['manageoutcomes'] = 'Beheer resultaten';
...
$string['modgradecategoryrescalegrades_help'] = 'Wanneer je de maximumcijfers van een item in het cijferlijst wijzigt, moet je specificeren of dit al dan niet bestaande percentages moet wijzigen.
...
$string['modgraderescalegrades_help'] = 'Wanneer je de maximumcijfers van een item in het cijferlijst wijzigt, moet je specificeren of dit al dan niet bestaande percentages moet wijzigen.
...
$string['movesitems'] = 'Verplaats items';
...
$string['mygrades_desc'] = 'Deze instelling geeft de mogelijkheid om een extern cijferlijst aan het gebruikersmenu te koppelen';
...
$string['noexistingoutcomes'] = 'Er zijn geen bestaande resultaten';
$string['noexistingscales'] = 'Er zijn geen bestaande schalen';
...
$string['nonunhideableverbose'] = 'Dit cijfer kan zichtbaar worden gemaakt door {$a->itemname} zichtbaar te maken.';
$string['nonunlockableverbose'] = 'Dit cijfer kan gedeblokkeerd worden door {$a->itemname} te deblokkeren.';
...
$string['nouserstograde'] = 'Geen gebruikers om te beoordelen';
...
$string['privacy:metadata:filepurpose'] = 'Feedback-bestanden die zijn opgeslagen in het cijferlijst voor een gebruiker.';
...
$string['privacy:metadata:grade_import_newitem:itemname'] = 'Naam van nieuw cijferitem';
$string['privacy:metadata:grade_import_values'] = 'Tijdelijke tabel voor het importeren van cijfers';
$string['privacy:metadata:grade_import_values:feedback'] = 'Cijferfeedback';
$string['privacy:metadata:grade_import_values:finalgrade'] = 'Ruw beoordelingscijfer';
$string['privacy:metadata:grade_import_values:importcode'] = 'Een unieke code voor de identificatie van een lading imports';
$string['privacy:metadata:grade_import_values:importer'] = 'Gebruiker die de gegevens importeert';
$string['privacy:metadata:grade_import_values:importonlyfeedback'] = 'Markeer als enkel feedback werd geïmporteerd';
$string['privacy:metadata:grade_import_values:userid'] = 'Gebruiker van wie het cijfer werd geïmporteerd';
$string['privacy:metadata:grades'] = 'Een record met cijfers';
$string['privacy:metadata:grades:aggregationstatus'] = 'De aggregatiestatus';
$string['privacy:metadata:grades:aggregationweight'] = 'De weging in de aggregatie';
...
$string['privacy:metadata:outcomes:timemodified'] = 'Tijdstip waarop het record gewijzigd werd';
$string['privacy:metadata:outcomes:usermodified'] = 'De gebruiker die de record het laatst gewijzgd heeft';
$string['privacy:metadata:outcomeshistory'] = 'Een record met vorige versies van competenties';
$string['privacy:metadata:scale'] = 'Een record met schalen';
$string['privacy:metadata:scale:timemodified'] = 'Tijdstip wanneer de record laatst werd gewijzigd';
$string['privacy:metadata:scale:userid'] = 'De gebruiker die de record het laatst gewijzigd heeft';
$string['privacy:metadata:scalehistory'] = 'Een record met vorige versies van schalen';
$string['privacy:path:relatedtome'] = 'Houdt verband met mij';
$string['privacy:request:historyactiondelete'] = 'Verwijder';
$string['privacy:request:historyactioninsert'] = 'Voeg in';
$string['privacy:request:historyactionupdate'] = 'Pas aan';
$string['privacy:request:unknowndeletedgradeitem'] = 'Onbekend (het cijfer was verwijderd)';
...
$string['rangedecimals_help'] = 'Het aantal te tonen decimale cijfers voor het bereik.';
$string['rangesdecimalpoints'] = 'Aantal decimalen binnen cijferbereik';
...
$string['rangesdisplaytype'] = 'Hoe bereik tonen';
$string['rangesdisplaytype_help'] = 'Deze instelling bepaalt of het bereik getoond wordt als reële cijfers, percentages of letters en of de manier waarop categorie en hoe marges getoond moeten worden (overerven).';
...
$string['searchcollapsedcolumns'] = 'Zoek samengevouwen kolommen';
...
$string['selectgrouplink'] = 'Selecteer een groep';
$string['selectuserlink'] = 'Selecteer een gebruiker';
...
$string['showallgrades'] = 'Toon alle cijfers';
...
$string['showfeedback_help'] = 'Toon een kolom voor feedback?';
...
$string['showingaggregatesonly'] = 'Enkel totalen tonen';
$string['showingfullmode'] = 'Cijfers en totalen tonen';
...
$string['showranges'] = 'Toon cijferbereik';
$string['showranges_help'] = 'Toon een rij met het bereik voor iedere categorie en ieder beoordelingsitem in het rapport.';
...
$string['unlimitedgrades_help'] = 'Standaard worden cijfers beperkt door de minimum- en de maximumwaarden van het beoordelingsitem. Door deze instelling in te schakelen verwijder je deze limiet en laat je toe om cijfers boven de 100% in het cijferlijst te zetten.';
...
$string['viewas'] = 'Rapport weergeven als';
