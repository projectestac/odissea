...
/**
 * Strings for component 'report_performance', language 'nl', version '4.5'.
 *
...
$string['check_cachejs_comment_enable'] = 'Indien uitgeschakeld zou de pagina traag kunnen laden.';
$string['check_cachejs_details'] = 'Javascript caching en compressie verbeteren de performantie voor het laden van een pagina. Het wordt aangeraden om dit in te schakelen op productieservers.';
$string['check_dbschema_errors'] = 'Databaseschema is niet in orde.';
$string['check_dbschema_name'] = 'Databaseschema controle';
$string['check_dbschema_ok'] = 'Databaseschema is juist.';
...
$string['check_enablestats_comment_disable'] = 'Performantie kan beïnvloed worden door het berekenen van statistieken. Indien ingeschakeld moeten statistiekinstellingen met voorzichtigheid gekozen worden.';
...
$string['privacy:metadata'] = 'De performantieoverzicht-plugin bewaart geen persoonlijke gegevens.';
$string['value'] = 'Waarde';
