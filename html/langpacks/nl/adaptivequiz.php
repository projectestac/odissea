...
/**
 * Strings for component 'adaptivequiz', language 'nl', version '4.5'.
 *
...
$string['attemptquestion_rightwrong'] = 'Antwoord juist/fout';
...
$string['na'] = 'n.v.t.';
$string['name'] = 'Naam';
$string['percent_correct_display_name'] = '% Juist';
$string['question_report'] = 'Vraaganalyse';
...
$string['times_used_display_name'] = 'Keren gebruikt';
$string['user'] = 'Gebruiker';
$string['value'] = 'Waarde';
$string['wrongpassword'] = 'Wachtwoord is fout';
