...
$string['asyncemailenabledetail'] = 'Indien ingeschakeld, ontvangen gebruikers een melding wanneer een asynchrone back-up of herstel is voltooid.';
$string['asyncgeneralsettings'] = 'Asynchrone backup / restore';
$string['asyncmessagebody'] = 'Melding';
$string['asyncmessagebodydefault'] = 'Je {operation} ID: {backupid} is met succes voltooid. <br/>Toegang via: <a href="{link}">{link}</a>.';
$string['asyncmessagebodydetail'] = 'Melding die moet worden verzonden wanneer een asynchrone back-up of herstel is voltooid.';
$string['asyncmessagesubject'] = 'Onderwerp';
$string['asyncmessagesubjectdefault'] = 'Moodle {operation}  is succesvol voltooid';
$string['asyncmessagesubjectdetail'] = 'Meldingsonderwerp';
...
$string['backupfile'] = 'Back-upbestand';
...
$string['backupthenrestore'] = 'Backup klaar. Start het terugzetten.';
...
$string['choosefilefromactivitybackup_help'] = 'Back-upbestanden voor deze activiteit.';
$string['choosefilefromautomatedbackup'] = 'Automatische back-ups';
$string['choosefilefromautomatedbackup_help'] = 'Back-upbestanden automatisch gegenereerd.';
$string['choosefilefromcoursebackup'] = 'Cursus back-upzone';
$string['choosefilefromcoursebackup_help'] = 'Back-upbestanden voor deze cursus.';
$string['choosefilefromuserbackup'] = 'Private back-upzone';
$string['choosefilefromuserbackup_help'] = 'Private back-upbestanden voor alle cursussen met geanonimiseerde gebruikersinformatie.';
...
$string['configgeneralcontentbankcontent'] = 'Stelt de standaard in voor het opnemen van inhoud van de  inhoudsbank in een back-up';
$string['configgeneralcustomfield'] = 'Configureert de standaardinstelling voor het insluiten van aangepaste velden in een backup.';
...
$string['configgeneralpermissions'] = 'Indien ingeschakeld zullen de rechten van de rollen geïmporteerd worden. Dit kan bestaande rechten voor aangemelde gebruikers wijzigen.';
...
$string['configgeneralxapistate'] = 'Stelt de standaard in voor het opnemen van de status van de gebruiker in inhoud zoals H5P-activiteiten in een back-up.';
$string['configlegacyfiles'] = 'Standaardinstelling voor het opnemen van verouderde cursusbestanden in een backup. Verouderde cursusbestanden zijn bestanden van Moodle-versies ouder dan 2.0.';
...
$string['configrestorecontentbankcontent'] = 'Stelt de standaard in voor het terugzetten van inhoud van de inhoudsbank';
$string['configrestorecustomfield'] = 'Configureert de standaardinstelling voor het terugzetten van aangepaste velden.';
...
$string['configrestorepermissions'] = 'Indien ingeschakeld zullen de rechten van de rollen teruggezet worden. Dit kan bestaande rechten voor aangemelde gebruikers wijzigen.';
...
$string['configrestorexapistate'] = 'Stelt de standaard in voor het herstellen van de status van de gebruiker in inhoud zoals H5P-activiteiten.';
...
$string['copiesinprogress'] = 'Deze cursus is bezig met kopiëren: <a href="{$a}">Bekijk voortgang kopiëren.</a>';
$string['copycoursedesc'] = 'Maak een kopie van deze cursus in gelijk welke categorie.';
...
$string['copyop'] = 'Huidige operatie';
$string['copyprogressheading'] = 'Cursus kopiëren bezig';
$string['copyprogressheading_help'] = 'Deze tabel toont de status van al je lopende cursus-kopieën.';
$string['copyprogresstitle'] = 'Voortgang cursus kopiëren';
$string['copyreturn'] = 'Kopieer en ga terug';
$string['copysource'] = 'Bron';
$string['copyview'] = 'Kopieer en bekijk';
...
$string['enableasyncbackup_help'] = 'Indien ingeschakeld, worden alle back-up- en herstelbewerkingen asynchroon uitgevoerd. Dit geeft een betere gebruikerservaring, waarbij gebruikers andere bewerkingen kunnen uitvoeren terwijl een back-up of herstel bezig is. Dit heeft geen invloed op imports of exports.';
...
$string['generalcontentbankcontent'] = 'Inhoud van inhoudsbank mee opnemen';
$string['generalcustomfield'] = 'Aangepaste velden mee opnemen';
...
$string['generallegacyfiles'] = 'Verouderde cursusbestanden mee opnemen';
$string['generallogs'] = 'Logs mee opnemen';
$string['generalpermissions'] = 'Overschreven rechten meenemen';
...
$string['generalxapistate'] = 'Neem de status van de gebruiker op in inhoud zoals H5P-activiteiten';
...
$string['importfile'] = 'Upload een back-upbestand';
$string['importfromccmidtocourse'] = 'Importeer van cmid: {$a->srccmid} in cursus: {$a->dstcourseid}';
$string['importfromcoursetocourse'] = 'Importeer van cursus: {$a->srccourseid} in cursus: {$a->dstcourseid}';
...
$string['importrootsettings'] = 'Importeerinstellingen';
...
$string['keptroles'] = 'Aanmeldingen van rol mee opnemen';
$string['keptroles_help'] = 'Gebruikers met de geselecteerde rollen zullen aangemeld worden in de nieuwe cursus. Er worden geen gebruikersgegevens gekopieerd, tenzij "Gebruikersgegevens mee opnemen" is ingeschakeld.';
...
$string['managefiles_activity'] = 'Beheer activiteitenback-ups';
$string['managefiles_automated'] = 'Beheer geautomatiseerde back-ups';
$string['managefiles_backup'] = 'Beheer privéback-ups';
$string['managefiles_course'] = 'Beheer cursusback-ups';
...
$string['questioncannotberestored'] = 'De vragen "{$a->name}" kunnen niet gemaakt worden tijdens het terugzetten.';
...
$string['restorenofilesbackuparea'] = 'Er zijn nog geen back-upbestanden.';
$string['restorenofilesbackuparea_activity'] = 'Er zijn nog geen back-upbestanden voor deze activiteit.';
$string['restorenofilesbackuparea_automated'] = 'Er zijn nog geen geautomatiseerde back-upbestanden.';
$string['restorenofilesbackuparea_backup'] = 'U heeft nog geen privéback-upbestanden.';
$string['restorenofilesbackuparea_course'] = 'Er zijn nog geen back-upbestanden voor deze cursus.';
...
$string['restoretocurrentcourseadding'] = 'Voeg de back-up toe aan deze cursus';
...
$string['rootsettingcontentbankcontent'] = 'Inhoud inhoudsbank mee opnemen';
...
$string['rootsettinglegacyfiles'] = 'Verouderde cursusbestanden mee opnemen';
$string['rootsettinglogs'] = 'Cursuslogs invoegen';
$string['rootsettingpermissions'] = 'Overschreven rechten meenemen';
...
$string['userdata'] = 'Gebruikersgegevens mee opnemen';
$string['userdata_help'] = 'Wanneer ingeschakeld zullen gegevens zoals forumberichten, ingestuurde opdrachten enz. gekopieerd worden naar de nieuwe cursus voor alle gebruikers met een rol, geselecteerd in \'Aanmeldingen van rol mee opnemen\'.';
