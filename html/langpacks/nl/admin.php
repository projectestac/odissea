...
$string['accountlocked'] = 'Je account is geblokkeerd. Er is een ontgrendelingslink verzonden via e-mail.';
$string['accounts'] = 'Gebruikers';
$string['accountunlocked'] = 'Je account is succesvol ontgrendeld. Je kunt nu inloggen.';
...
$string['allowframembedding_help'] = 'Indien ingeschakeld mag deze site ingebed worden in frames op een andere site. Dit wordt aangeraden wanneer je de "Publiceer als LTI"-aanmeldings-plugin gebruikt. In alle andere gevallen wordt het inschakelen van deze functie afgeraden om beveiligingsredenen. Merk op dat voor de mobiele app deze instelling altijd genegeerd wordt en inbedden in frame altijd toegestaan is.';
...
$string['asyncbackupdisabled'] = 'Je site is momenteel geconfigureerd om synchrone back-ups te gebruiken. Asynchrone back-ups zorgen voor een betere gebruikerservaring omdat gebruikers dan kunnen blijven verder werken terwijl de backup loopt.
Asynchrone back-ups worden ingeschakeld voor alle sites vanaf Moodle LMS 4.5 LTS.
Synchrone back-ups worden verwijderd uit Moodle LMS de versie na 4.5 LTS';
...
$string['autolangusercreation'] = 'Gebruik de taalinstelling van de browser tijdens het aanmaken van een gebruiker.';
$string['autologinguests'] = 'Gasten automatisch inloggen';
$string['availableto'] = 'Beschikbaar voor';
$string['availabletoanyone'] = 'Beschikbaar voor iedereen de site bezoekt';
$string['availabletoauthenticated'] = 'Alleen beschikbaar voor inlogde gebruikers';
...
$string['blockprotectblock'] = 'Beveilig instanties van {$a}';
$string['blockprotected'] = '{$a} blokken zijn nu beveiligd.';
$string['blocksettings'] = 'Beheer blokken';
$string['blockunprotect'] = 'Onbeschermd';
$string['blockunprotectblock'] = 'Verwijder beveiliging {$a}';
$string['blockunprotected'] = '{$a} -blok is niet langer beveiligd';
...
$string['cliexitgraceful'] = 'Even afsluiten, wacht alstublieft ...';
$string['cliexitnow'] = 'Sluit NU af';
...
{$a}
gebruik --help optie.';
$string['cliupgradecompletenomaintenanceupgrade'] = 'Resterende caches leeg maken na omschakeling naar nieuwe code:
...
Het wordt aanbevolen om deze caches afzonderlijk één voor één leeg te maken met wat tijd tussen de opdrachten om belastingspieken op de webserver te verminderen.';
...
$string['cliupgrademaintenancenotrequired'] = 'Deze upgrade zal de site NIET in onderhoudsmodus zetten voor gebruikers.';
$string['cliupgrademaintenancerequired'] = 'Deze upgrade zal de site IN ONDERHOUDSMODUS zetten voor gebruikers.';
...
$string['cliupgradesetlock'] = 'Upgrade is vergrendeld voor uitsluitend CLI-uitvoering.';
$string['cliupgradeunsetlock'] = 'Bestaande CLI-uitvoeringsupgradevergrendeling is verwijderd.';
$string['cliyesnoprompt'] = 'typ j (ja) of n (nee)';
$string['close'] = 'Sluiten';
$string['cohort_customfield'] = 'Aangepaste site-groep-velden';
...
$string['configallowcoursethemes'] = 'Als je dit inschakelt, dan kan elke cursus zijn eigen thema instellen. De thema\'s van de cursussen zullen alle andere thema\'s overschrijven (site, gebruiker, site-groep  of URL-gedefinieerde thema\'s)';
...
$string['configallowobjectembed'] = 'Als standaard beveiligingsmaatregel kunnen gebruikers met de leerling-rol geen multimedia  in teksten insluiten door gebruik te maken van EMBED en OBJECT tags in hun HTML, hoewel het veilig ingesloten kan worden met de mediaplugins filter. Als je deze tags toch wil laten gebruiken, dan kun je deze optie inschakelen.';
...
$string['configautolangusercreation'] = 'Indien ingeschakeld zal de taalinstelling van de browser gebruikt worden als voorkeurtaal bij een eerste aanmelding (vb bij gebruik van LDAP of OAuth-authenticatie). Anders zal de standaardtaal van de site als voorkeurtaal van de gebruiker ingesteld worden.';
...
$string['configdefaulthomepage'] = 'Naar welke pagina moeten gebruikers geleid worden nadat ze aangemeld zijn? Deze instelling bepaalt ook de eerste link in de navigatie voor gebruikers van Classic-gebaseerde thema\'s.';
...
$string['configdocroot'] = 'Bepaalt het pad naar Moodle Docs voor contextgevoelige hulp via de link \'Documentatie voor deze pagina\' onderaan elke pagina. Als dit veld leeg gelaten wordt, dan wordt er geen link getoond.';
$string['configdoctonewwindow'] = 'Als je dit aanzet zullen links naar Moodle Docs geopend worden in een nieuw venster.';
$string['configduration_high'] = 'Deze waarde is te hoog. De maximale waarde is {$a}.';
$string['configduration_low'] = 'Deze waarde is te laag. De minimale waarde is {$a}.';
...
$string['configemaildkimselector'] = 'De DKIM selector is willekeurig en je DNS-record (s) moeten hiermee overeenkomen.';
...
$string['configemailheaders'] = 'RAW e-mailkopteksten die aan alle uitgaande e-mail moeten worden toegevoegd.';
...
$string['configenablewebservices'] = 'Webservices maken het mogelijk dat andere systemen, zoals de Mobile app, aanmelden in deze Moodle-installatie en acties uitvoeren. Voor extra veiligheid moet dit uitgeschakeld worden tenzij je de Moodle app gebruikt of een externe tool/service die integratie via webservices vereist.';
...
$string['configextendedusernamechars'] = 'Indien ingeschakeld mogen gebruikersnamen ieder teken bevatten behalve hoofdletters. Anders zijn enkel alfanumerieke tekens met kleine letters, underscore (_), koppelteken (-), punt (.) en apenstaartje (@) toegestaan.';
...
$string['configfilternavigationwithsystemcontext'] = 'Het normaal gebruik van filteren is gebonden aan de context waar dit wordt gebruikt (vb. cursus context), maar voor de site-navigatie kan het expliciet laten filteren van alles met site context, kan performantie verbeteren door "inhoud en koppen"-filteren te gebruiken.';
...
$string['configfrontpagecourselimithelp'] = 'Het maximaal aantal te tonen cursussen op de site startpagina in de cursuslijst.';
...
$string['configgradeexportdefault'] = 'Kies welk exportformaat voor de cijferlijst je standaardmethode is voor het exporteren van cijfers.';
...
$string['configpasswordpolicycheckonlogin'] = 'Indien ingeschakeld, worden gebruikerswachtwoorden gecontroleerd aan de hand van het wachtwoordbeleid telkens wanneer gebruikers inloggen. Als de controle mislukt, moet de gebruiker zijn wachtwoord wijzigen voordat hij doorgaat.
Het is handig om deze instelling in te schakelen na het bijwerken van het wachtwoordbeleid.';
...
$string['configproxybypass'] = 'Kommagescheiden lijst met  (gedeeltelijke) hostnamen of IP-adressen die de proxyserver zouden moeten negeren. Scheiden met komma\'s, zonder spaties. Bijvoorbeeld: 192.168., .mijndomein.com';
$string['configproxyfixunsafe_help'] = 'Dit probeert interne oproepen die niet via de proxy gaan, op te lossen door de MoodleBot User Agent toe te voegen en de proxy te gebruiken.';
...
$string['configproxylogunsafe_help'] = 'Hiermee wordt geprobeerd interne oproepen vast te leggen die niet via de proxy gaan en dat wel zouden moeten.';
...
$string['configrecaptchapublickey'] = 'Tekenreeks (site sleutel), nodig om het reCAPTCHA-element te tonen op het registratieformulier en het site ondersteuningsformulier. ReCAPTCHA-sleutels kun je verkrijgen via  <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configservicespage'] = 'Geef de URL naar een  "Diensten en ondersteuning"-pagina of laat leeg om te linken naar Moodle-services op Moodle.com. De link wordt enkel aan site-beheerders getoond.';
...
$string['configsessiontimeoutwarning'] = 'Als ingelogde gebruikers op deze site lange tijd inactief zijn (zonder pagina\'s te laden), worden ze gewaarschuwd dat hun sessie op het punt staat te eindigen. Deze variabele geeft aan hoe lang deze tijd moet zijn.';
$string['configsessiontimeoutwarningcheck'] = 'De waarschuwing voor de time-out van de sessie moet korter zijn dan de time-out van de sessie';
...
$string['configsmtpoauthservice'] = 'Selecteer de OAuth 2-service die is geconfigureerd om met de SMTP-server te praten. Als de service nog niet bestaat, moet je deze maken. Merk op dat je het SMTP Auth type instelt op XOAUTH2.';
...
$string['confirmationpending'] = 'In afwachting van bevestiging';
...
$string['confirmdeletecomments'] = 'Weet je zeker dat je de geselecteerde notities wil verwijderen?';
...
$string['coursecreationguide'] = 'URL naar een gids over het maken van een Moodle-cursus';
$string['coursecreationguide_help'] = 'Definieert het pad naar een snelstartgids met korte video\'s en algemene tips om cursussen te maken. Er wordt een koppeling naar de handleiding weergegeven op de pagina Mijn cursussen als er geen cursussen zijn om weer te geven. Alleen gebruikers met de mogelijkheid om cursussen te maken, zien de link.';
...
$string['cron'] = 'Cron';
$string['cron_enabled'] = 'Cron inschakelen';
$string['cron_enabled_desc'] = 'Cron moet in normale omstandigheden ingeschakeld zijn, maar met deze instelling kun je het tijdelijk uitschakelen, bijvoorbeeld voor het herstarten van een server. Indien uitgeschakeld zal het systeem geen achtergrondtaken meer starten. Merk op dat cron uitgeschakeld laten gedurende lange tijd er voor zal zorgen dat belangrijke functionaliteit niet werkt.';
...
$string['cron_keepalive'] = 'In leven houden';
$string['cron_keepalive_desc'] = 'De tijdsduur die nodig is om te blijven pollen voor aanvullende taken. Deze instelling is om ervoor te zorgen dat cron altijd actief is. Als je aparte taakrunners gebruikt, moet je deze waarde instellen op 0, anders raden we je aan deze in te stellen op een waarde die vergelijkbaar is met je adhoc-taak concurrency-limiet . Langere waarden moeten worden vermeden en de maximale waarde is 15 minuten.';
...
$string['croninfrequent'] = 'De tijd tussen de laatste twee runs van het cron-onderhoudsscript bedroeg {$a->actual} en het zou dat elke {$a->expected} moeten doen. We raden aan de configuratie aan te passen om vaker te worden uitgevoerd.';
$string['cronremotepassword'] = 'Cron wachtwoord voor toegang op afstand';
$string['cronwarning'] = 'Het <code>admin/cron.php</code> script heeft de laatste {$a->actual} niet gelopen en zou elke {$a->expected} moeten lopen.';
$string['cronwarningcli'] = 'Het <code>admin/cli/cron.php</code> script heeft de laatste {$a->actual} niet gelopen en zou elke {$a->expected} moeten lopen.';
$string['cronwarningnever'] = 'Het <code>admin/cli/cron.php</code> script heeft nog nooit gelopen en zou elke {$a->expected} moeten lopen.';
$string['cronwarningneverweb'] = 'Het script <a href="{$a->url}">admin/cron.php</a> heeft nog nooit gelopen en zou iedere {$a->expected} moeten lopen.';
...
$string['dbprefixtoolong'] = 'Het databasevoorvoegsel van jouw site ($CFG->voorvoegsel) is te lang ({$a->current} tekens). Het maximaal toegestane aantal tekens is {$a->maximum}.';
...
$string['debugsqltrace'] = 'Toon de oorsprong van SQL-aanroepen';
$string['debugsqltrace1'] = 'Toon slechts één oproepende lijn';
$string['debugsqltrace100'] = 'Toon volledige stacktracering';
$string['debugsqltrace2'] = 'Toon 2 regels stacktracering';
$string['debugsqltrace_desc'] = 'Indien ingeschakeld, wordt een gedeeltelijke of volledige PHP-stacktrace als commentaar toegevoegd aan de SQL als opmerking.';
...
$string['debugtemplateinfo'] = 'Toon sjablooninformatie';
$string['debugtemplateinfo_desc'] = 'Indien ingeschakeld, worden sjablonen die voor weergave worden gebruikt, weergegeven als opmerkingen in de pagina-HTML. Alleen gebruiken voor tijdelijke debugging, omdat het HTML-validatiefouten veroorzaakt en sommige paginascripts kan breken.';
...
$string['deleteduserx'] = 'Gebruiker {$a} verwijderd';
...
$string['disabled'] = 'Uitgezet';
$string['disableplugin'] = '{$a} uitschakelen';
...
$string['divertallemails'] = 'E-mail omleiden';
$string['divertallemailsdetail'] = 'Gebruikt als beveiliging in ontwikkelomgevingen bij het testen van e-mails. Niet gebruiken in productie-omgeving.';
$string['divertallemailsexcept'] = 'Uitzonderingen op e-mail omleidingen';
$string['divertallemailsexcept_desc'] = 'Een lijst van e-mail uitzonderingsregels, komma of nieuwe-regel gescheiden. Elke regel wordt geïnterpreteerd als reguliere expressie. vb <pre>simone@acme.com
.*@acme.com
fred(\\+.*)?@acme.com
</pre>';
$string['divertallemailsto'] = 'Alle e-mails omleiden';
$string['divertallemailsto_desc'] = 'Indien ingeschakeld zullen alle e-mails omgeleid worden naar dit adres.';
...
$string['downloadcoursecontentallowed'] = 'Cursusinhoud downloaden is mogelijk';
$string['downloadcoursecontentallowed_desc'] = 'Of de download cursus-mogelijkheid beschikbaar is voor cursussen. Wanneer beschikbaar dan kan het downloaden van cursusinhoud ingeschakeld en uitgeschakeld worden met de "Cursusinhoud downloaden inschakelen"  -instelling in het Bewerk instellingen-menu van de cursus. (de standaard hiervoor kan in <a href={$a} target="_blank">Cursus standaardinstellingen</a> ingesteld worden).';
...
$string['emaildkim'] = 'DomainKeys Identified Mail (DKIM)  E-mail ondertekening';
$string['emaildkiminfo'] = 'Als zowel de DKIM selector is ingesteld als een privécertificaatbestand wordt gevonden dat overeenkomt met het e-mailadressen "Van" adresdomein in $CFG->dataroot/dkim/[domein]/[selector].private, dan wordt de e-mail ondertekend. In de meeste gevallen (bijv. Als toegestane e-maildomeinen leeg zijn) is slechts één certificaat nodig in: <code>{$a->pad}</code>. Lees de documentatie over <a href="{$a->docs}">e-mailconfiguratie</a> voor meer details.';
$string['emaildkimselector'] = 'DKIM Selector';
$string['emailfromvia'] = 'E-mail via-informatie';
$string['emailheaders'] = 'E-mailkopteksten';
...
$string['enablecommunicationsubsystem'] = 'Communicatie inschakelen';
$string['enablecommunicationsubsystem_desc'] = 'Integratie met communicatiesystemen, zoals Matrix inschakelen zodat leerlingen en leraars eenvoudiger kunnen communiceren. Je kunt deze integraties beheren via  <a href="settings.php?section=managecommunicationproviders">Plugins</a>.';
...
$string['enabledashboard'] = 'Mijn startpagina inschakelen';
$string['enabledashboard_help'] = 'Mijn startpagina toont standaard de tijdlijn, kalender en recent geopende items. Je kunt voor iedereen een andere standaard Mijn startpagina instellen en gebruikers toestaan hun eigen startpagina aan te passen. Indien uitgeschakeld moet je bij de instelling \'Startpagina voor gebruikers\' iets anders kiezen dan \'Mijn startpagina\'.';
...
$string['enablepdfexportfont'] = 'Schakel PDF-lettertypen in';
$string['enablepdfexportfont_desc'] = 'Als je site cursussen in verschillende talen heeft die andere lettertypen nodig hebben in gegenereerde PDF-bestanden, kun je de optie bieden om het lettertype in te stellen in de cursusinstellingen. Je moet beschikbare lettertypen specificeren in $CFG->pdfexportfont in config.php.';
$string['enableplugin'] = '{$a} inschakelen';
...
$string['enablesharingtomoodlenet'] = 'Delen op MoodleNet inschakelen (versturen)';
$string['enablesharingtomoodlenet_desc'] = 'Sta toe dat gebruikers cursusinhoud delen op een geconfigureerde MoodleNet-instantie als ze dat recht hebben.';
$string['enablestats'] = 'Statistieken inschakelen';
$string['enabletrusttext'] = 'Vertrouwde Inhoud inschakelen';
$string['enableuserfeedback'] = 'Feedback over deze software inschakelen.';
$string['enableuserfeedback_desc'] = 'Wanneer ingeschakeld, zal de "Geef feedback over deze software"-link aan gebruikers in voettekst getoond worden om feedback te geven over de Moodle software aan HQ. Als de \'Volgende feedback-herinnering\'-optie is ingeschakeld, dan zal de gebruiker op het opgegeven interval een herinnering getoond worden. Het instellen van de "Volgende feedback-herinnering" op "nooit" schakelt de herinnering op Mijn startpagina uit, maar laat de "Geef feedback over deze software"-link in de voettekst staan.';
$string['enablewebservices'] = 'Webservices inschakelen';
$string['enablewsdocumentation'] = 'Documentatie Webservices';
$string['encryptedpassword_edit'] = 'Voer een nieuwe waarde in';
$string['encryptedpassword_set'] = '(Ingesteld en versleuteld)';
$string['enroladminnewcourse'] = 'Beheerder automatisch aanmelden in nieuwe cursussen';
$string['enroladminnewcourse_help'] = 'Wanneer een beheerder een nieuwe cursus maakt, moet die dan automatisch aangemeld worden en de rol van cursusaanmaker toegewezen krijgen in nieuwe cursussen?';
...
Zie https://docs.moodle.org/dev/Events_API#Event_dispatching_and_observers.';
...
$string['favicon_desc'] = 'Favicon-bestand dat moet worden weergegeven naast de titel in de tab van de browser. Er wordt een Moodle-favicon getoond als er geen aangepast favicon gegeven wordt.';
...
$string['filternavigationwithsystemcontext'] = 'Filter navigatie met systeem context';
...
$string['frontpage'] = 'Site startpagina';
$string['frontpagebackup'] = 'Back-up site startpagina';
$string['frontpagedefaultrole'] = 'Standaardrol voor site startpagina';
$string['frontpagefilters'] = 'Site startpagina filters';
$string['frontpageloggedin'] = 'Site startpagina-items als aangemeld';
$string['frontpageoverrides'] = 'Site startpagina rechten overschrijven';
$string['frontpagequestions'] = 'Vragen site startpagina';
$string['frontpagerestore'] = 'Site startpagina terugzetten';
$string['frontpageroles'] = 'Rollen site startpagina';
...
$string['grouping_customfield'] = 'Aangepaste velden voor groeperingen';
...
$string['hookcallbacknotcallable'] = 'Deze callback is niet oproepbaar. Dit kan zijn omdat de klasse of methode niet bestaat, of omdat de methode niet openbaar is.';
$string['hookcallbacks'] = 'Callbacks';
$string['hookcallbacks_help'] = 'De lijst met callbacks die zullen worden aangeroepen wanneer de hook wordt verzonden.

De getoonde volgorde is de volgorde waarin callbacks worden aangeroepen.

Een callback met een hogere prioriteit wordt eerder gebeld dan een callback met een lagere prioriteit.';
$string['hookclassmissing'] = 'Hook-klasse niet gevonden';
$string['hookclassmissing_desc'] = 'De hook discovery-agent heeft een klasse geretourneerd die niet bestaat.';
$string['hookconfigoverride'] = 'Overridden';
$string['hookconfigoverride_help'] = 'De definitie van deze callback is overschreven in het configuratiebestand van de site, config.php';
$string['hookdeprecates'] = 'Verouderde callbacks';
$string['hookdescription'] = 'Beschrijving';
$string['hookdescriptionmissing'] = 'Hoek heeft geen beschrijvende methode';
$string['hookname'] = 'Hook';
$string['hooksoverview'] = 'Hakenoverzicht';
$string['hookunknown'] = 'Haak niet gevonden';
$string['hookunknown_desc'] = 'Het object waarnaar deze callback luistert, is niet beschikbaar. Het is mogelijk verwijderd of hernoemd, of het is mogelijk niet beschikbaar in deze versie van Moodle.';
...
$string['langmenuinsecurelayout'] = 'Toon taalmenu in veilige lay-out';
$string['langmenuinsecurelayout_desc'] = 'Indien ingeschakeld zal een gebruiker de taal kunnen wijzigen tijdens een test of andere activiteit tijdens het gebruiken van veilige lay-out.';
...
$string['logininfoinsecurelayout'] = 'Toon aangemelde gebruiker in veilige lay-out';
$string['logininfoinsecurelayout_desc'] = 'Indien ingeschakeld zal de volledige naam van de gebruiker getoond worden in de navigatiebalk wanneer een test of een andere activiteit met veilige layout gebruikt wordt.';
...
$string['maxcharacter'] = '{$a} tekens maximaal';
...
$string['maxsizeperdownloadcoursefile'] = 'Maximum grootte per bestand';
$string['maxsizeperdownloadcoursefile_desc'] = 'De maximale bestandsgrootte van elk bestand wanneer cursus-inhoud gedownload wordt. Grotere bestanden zullen niet gedownload worden.';
...
$string['modassignmentinuse'] = 'Je site gebruikt nog steeds de Opdracht 2.2. Vóór de upgrade moet je 1) een back-up te maken van de Opdracht 2.2-activiteiten die je nog wil houden en deze te herstellen als nieuwe Opdracht-activiteiten, en 2) Het verwijderen van de gegevens uit de tabel "assignment" in de database.';
$string['modassignmentsubpluginsexist'] = 'Er kunnen Opdracht 2.2 subplugins geïnstalleerd zijn. De mod/assignment map en alle subplugins moeten verwijderd zijn voor de upgrade.';
...
$string['navadduserpostslinks_help'] = 'Indien ingeschakeld zullen er twee links toegevoegd worden bij elke gebruiker in de navigatie om discussies te zien die zij gestart hebben en berichten die de gebruiker geplaatst heeft in forums over heel de site of in bepaalde cursussen.';
...
$string['navshowfrontpagemods'] = 'Toon site startpagina-activiteiten in de navigatie';
$string['navshowfrontpagemods_help'] = 'Indien ingeschakeld worden activiteiten op de site startpagina getoond in de navigatie onder site pagina\'s';
...
$string['navshowmycoursecategories_help'] = 'Indien ingeschakeld worden cursus in de Mijn cursussen vertakking in categorieën getoond in het navigatieblok (Enkel voor thema\'s gebaseerd op Classic).';
...
$string['navsortmycoursessort'] = 'Volgorde van cursussen in navigatieblok';
$string['navsortmycoursessort_help'] = 'Moeten cursussen opgelijst worden in de volgorde zoals ingesteld in Sitebeheer > Cursussen > Beheer cursussen en categorieën of alfabetisch volgens cursusinstelling? Deze instelling is enkel van toepassing voor thema\'s gebaseerd op Klassiek.';
$string['never'] = 'Nooit';
...
$string['noemaileverwarning'] = '<strong>Opmerking:</strong> alle uitgaande e-mails zijn uitgeschakeld';
...
$string['noteunneededblocks'] = 'Opmerking: Blokken die zijn ingesteld om weer te geven, worden niet weergegeven in het menu \'Een blok toevoegen\' in een cursus als ze zijn opgegeven in de thema-instelling \'Onnodige blokken\'.';
...
$string['oracledatabaseinuse'] = 'Ondersteuning voor Oracle DB wordt verwijderd. Moodle 4.5 zal de laatste versie zijn met Oracle DB-ondersteuning. Zie voor meer informatie de aankondiging op moodle.org <a href="https://moodle.org/mod/forum/discuss.php?d=456122">Oracle database support in LMS deprecation</a>.';
...
$string['passwordpolicycheckonlogin'] = 'Controleer wachtwoord bij inloggen';
...
$string['pathtopdftoppm'] = 'Pad naar pdftoppm';
$string['pathtopdftoppm_help'] = '<a href="https://poppler.freedesktop.org/">Poppler</a> is een bibliotheek met de tool pdftoppm die PDF-pagina\'s converteert naar PNG. De performantie is over het algemeen beter dan Ghostscript, zeker voor grote bestanden. Indien aanwezig, wordt \'pdftoppm\' gebruikt in plaats van Ghostscript voor deze taak. Bij de meeste Linux-installaties kan dit worden gelaten als \'/usr/bin/pdftoppm\'. Indien niet aanwezig, installeer dan het poppler-utils of poppler-pakket, afhankelijk van de Linux-distributie. Op Windows wordt het geleverd door Cygwin-installaties.';
...
$string['perfdebugdeferred'] = 'Wachten tot het script eindigt om de foutopsporing in de prestaties weer te geven...';
...
$string['pluginscheckfailed'] = 'Afhankelijkheidscontrole mislukt voor {$a->pluginslist}';
...
$string['profilefieldmaxlength'] = 'Tekenlimiet';
$string['profilefieldmaxlength_help'] = 'Als je dit veld wilt gebruiken in de instelling \'Gebruikersidentiteit weergeven\', moet de limiet 255 tekens of minder zijn.';
...
$string['profilevisible_help'] = '* Niet zichtbaar - voor privé-gegevens, enkel zichtbaar voor beheerders en managers
* Zichtbaar voor gebruiker - voor privé-gegevens, enkel zichtbaar voor de gebruiker en beheerders
* Zichtbaar voor gebruiker, leraren en beheerders - voor privé-gegevens, enkel zichtbaar voor de gebruiker, leraren en beheerders (op cursusprofielpagina)
...
$string['profilevisibleteachers'] = 'Zichtbaar voor de gebruiker, leraren en beheerders';
...
$string['proxyfixunsafe'] = 'Niet-proxy-oproepen herstellen';
$string['proxyhost'] = 'Proxyserver';
$string['proxylogunsafe'] = 'Ongeproxyde oproepen loggen';
...
$string['referrernone'] = 'Standaardbrowser';
$string['referrerpolicy'] = 'Verwijzingsbeleid';
$string['referrerpolicydesc'] = 'Stel de verwijzende beleidskop in zodat deze wordt opgenomen in de reacties van je site.';
...
$string['replacefrontsearch'] = 'Gebruikt voor het zoeken naar cursussen op de site startpagina';
...
$string['resetindentation'] = 'Inspringen resetten voor de hele site';
$string['resetindentation_help'] = 'Hiermee wordt alle inspringing verwijderd die eerder was ingesteld voor cursussen op de site in {$a->format}.';
$string['resetindentation_title'] = 'Inspringen op de site resetten?';
$string['resetindentationsuccess'] = 'Inspringing gereset.';
...
$string['searchalternatesettings'] = 'Alternatieve instellingen enkel voor query\'s';
$string['searchalternatesettings_desc'] = 'Als je deze instellingen voltooit, kun je \'alternatieve instellingen\' voor deze zoekmachine selecteren in de optie voor alleen zoekopdrachten op de pagina \'Algemene zoekopdracht beheren\'. Dit is alleen handig wanneer je tussen twee zoekmachines van hetzelfde type wisselt.';
...
$string['searchbanner'] = 'Zoek informatie';
$string['searchbannerenable'] = 'Zoekinformatie weergeven';
$string['searchbannerenable_desc'] = 'Indien ingeschakeld, wordt de onderstaande tekst boven aan het zoekscherm getoond aan alle gebruikers. Dit kan worden gebruikt om gebruikers op de hoogte te houden tijdens het uitvoeren van onderhoud aan het zoeksysteem.';
...
$string['searchenginealternatesettings'] = '{$a} (alternatieve instellingen)';
$string['searchenginequeryonly'] = 'Zoekmachine enkel voor zoekopdrachten';
$string['searchenginequeryonly_desc'] = 'Deze zoekmachine wordt alleen gebruikt voor het maken van zoekopdrachten, niet voor indexering. Door deze functie te gebruiken, kun je opnieuw indexeren in een andere zoekmachine, terwijl zoekopdrachten van gebruikers vanuit deze blijven werken.';
$string['searchenginequeryonly_none'] = 'Geen (gebruik de hoofdzoekmachine voor zoekopdrachten)';
$string['searchenginequeryonlysame'] = 'De zoekmachine voor alleen zoekopdrachten en de hoofdzoekmachine kunnen niet op dezelfde waarde worden ingesteld.';
...
$string['searchmanagement'] = 'Zoekbeheer';
$string['searchmanagement_desc'] = 'Deze opties zijn handig bij het aanbrengen van wijzigingen op sites met zeer grote zoekindexen die veel tijd nodig hebben om opnieuw te worden opgebouwd.';
$string['searchmaxtopresults'] = 'Maximale topresultaten';
$string['searchmaxtopresults_desc'] = 'Geef het maximale aantal hoogst gerangschikte resultaten op om te tonen boven het zoekresultaat voor cursusinhoud, cursussen en gebruikers';
...
$string['searchteacherroles'] = 'Lerarenrollen';
$string['searchteacherroles_desc'] = 'Selecteer alle rollen die gebruikers hoger laten rangschikken in je zoekresultaten.';
$string['searchtopresults'] = 'Topresultaten';
...
$string['servicespage'] = 'Diensten en ondersteuningslink';
...
$string['sessiontimeoutwarning'] = 'Time-out waarschuwing';
...
$string['settingmaxinputvars'] = 'De PHP instelling max_input_vars wordt aangeraden om minstens op 5000 in te stellen.';
$string['settingmaxinputvarsrequired'] = 'De PHP instelling max_input_vars zou minstens 5000 moeten zijn.';
...
$string['settingzendexceptionignoreargs'] = 'Het wordt sterk aangeraden om de PHP-instelling zend.exception_ignore_args  in te schakel als veiligheidsmaatregel.';
...
$string['showuseridentity_desc'] = 'Bij het selecteren of het zoeken naar gebruikers, en bij het tonen van lijsten van gebruikers, kunnen deze velden getoond worden in aanvulling op hun naam. De velden worden alleen getoond aan gebruikers die beschikken over de moodle/site:viewuseridentity capability; standaard zijn dat leraren en managers. (Deze optie is het meest zinvol als je één of twee velden kiest die verplicht zijn in uw instelling.)';
...
$string['sitemaintenancetitle'] = '{$a} in onderhoud';
...
$string['sitenameintitle'] = 'Plaats de naam van de site in de paginatitel';
$string['sitenameintitle_help'] = 'Met deze instelling wordt de sitenaam aan het einde van de paginatitel toegevoegd. Het wordt aangemoedigd om de sitenaam in de paginatitel op te nemen, omdat dit de toegankelijkheid van de site zal verbeteren doordat gebruikers snel kunnen identificeren op welke pagina ze zich momenteel bevinden.';
...
$string['sitesectionhelp'] = 'Toon een sectie bovenaan de pagina waar je aangepaste inhoud in kan plaatsen.';
$string['sixtyfourbitsrequired'] = 'Jouw site gebruikt geen 64-bits PHP-versie. Je moet je systeem upgraden (besturingssysteem, PHP...) voordat je deze Moodle-versie installeert.';
...
$string['smallscreensonly'] = 'Alleen kleine schermen';
$string['smtp'] = 'SMTP';
...
$string['supportavailability'] = 'Beschikbaarheid ondersteuning';
$string['supportcontact'] = 'Helpdesk';
$string['supportemail'] = 'E-mail helpdesk';
$string['supportemailsubject'] = 'Verzoek om site-ondersteuning - {$a}';
...
$string['task_adhoc_failed_retention'] = 'Ad hoc taak behoudperiode mislukt';
$string['task_adhoc_failed_retention_desc'] = 'De maximale periode dat mislukte ad hoc-taken in de wachtrij moeten blijven als ze als ze hun opnieuw proberen-limiet bereikt hebben.';
...
$string['task_dbreads'] = 'Database leesbewerkingen';
$string['task_dbstats'] = 'Databank';
$string['task_dbwrites'] = 'Database schrijfbewerkingen';
$string['task_duration'] = 'Tijdsduur';
$string['task_endtime'] = 'Eindtijdstip';
...
$string['task_logoutput'] = 'Taak output';
...
$string['task_status'] = 'Taakstatus';
$string['task_status_desc'] = 'De taak {$a->name} is {$a->status}. Zie {$a->class}{$a->extradescription} in <a href="{$a->gotourl}">Geplande taken</a> voor details.';
...
$string['taskautomatedbackup_report'] = 'Geautomatiseerd back-uprapport';
$string['taskbackupcleanup'] = 'Backuptabellen, logs en bestanden leeg maken';
$string['taskbadgesadhoc'] = 'Award-badge';
$string['taskbadgescron'] = 'Badges toekennen adhoc taak';
...
$string['taskh5pcleanup'] = 'Opschonen van ongebruikte H5P-bestanden';
$string['tasklegacycron'] = 'Verouderde cronverwerking voor plugins';
$string['tasklockcleanuptask'] = 'Ad hoc taak-metadata opschonen';
...
$string['testoutgoingmailconf_fromemail'] = 'Van gebruikersnaam of e-mailadres';
$string['testoutgoingmailconf_fromemail_help'] = 'Dit veld simuleert het versturen van een bericht vanaf die gebruiker, maar de From-header die gebruikt wordt in de echte verstuurde e-mail zal afhangen van andere instellingen, zoals "allowedemaildomains"';
$string['testoutgoingmailconf_fromemail_invalid'] = 'Ongeldige From gebruikersnaam of e-mail. Moet een geldig e-mailopmaak of een gebruikersnaam zijn die bestaat in Moodle.';
$string['testoutgoingmailconf_message'] = 'Dit is een testbericht om te bevestigen dat je de uitgaande e-mailinstellingen van je Moodle-site succesvol hebt geconfigureerd.
Verstuurd: {$a}';
...
$string['testoutgoingmailconf_subject'] = '{$a->site}: testbericht. {$a->additional} Verstuurd: {$a->time}';
$string['testoutgoingmailconf_subjectadditional'] = 'Bijkomende onderwerpregel';
...
$string['themedefinedinconfigphp'] = 'Het thema kan niet worden gewijzigd omdat het is ingesteld op {$a} in config.php.';
...
$string['themeeditsettingsname'] = 'Thema-instellingen bewerken \'{$a}\'';
...
$string['themeselector'] = 'Thema\'s';
$string['themesettings'] = 'Thema instellingen';
$string['themesettingsadvanced'] = 'Geavanceerde thema-instellingen';
$string['themesettingscustom'] = 'Aangepaste thema-instellingen';
$string['themesettingsname'] = 'Thema-instellingen \'{$a}\'';
$string['themeusagereportname'] = 'Themagebruiksrapport \'{$a}\'';
...
$string['unicoderequired'] = 'Alle data moet als Unicode (UTF-8) bewaard worden. Nieuwe installaties moeten geïnstalleerd worden met Unicode als standaard tekenset voor de databank. Als je upgrade, moet je het UTF-8 migratieproces laten lopen.';
...
$string['unsupportedphpversion7'] = 'PHP versie 7 en hoger worden ondersteund.';
$string['unsupportedphpversion71'] = 'PHP-versie 7.1 en hoger worden niet ondersteund.';
$string['unsupportedphpversion72'] = 'PHP-versie 7.2 en hoger worden niet ondersteund.';
$string['unsupportedphpversion73'] = 'PHP-versie 7.3 en hoger worden niet ondersteund.';
...
$string['unsupportedphpversion84'] = 'PHP versies 8.4 en hoger worden niet ondersteund.';
...
$string['userfeedbackafterupgrade'] = 'Na elke grote upgrade';
$string['userfeedbackencouragement'] = '<p> Moodle bevat een functie waarmee gebruikers feedback kunnen geven over de Moodle-software aan Moodle HQ via een externe enquête-site die wordt gehost door Moodle HQ. Er wordt geen door de gebruiker identificeerbare informatie doorgestuurd naar de enquête-site. </p>
<p> Moodle HQ streeft ernaar open en transparant te zijn over de manier waarop gegevens worden verzameld. Daarom willen we ervoor zorgen dat je op de hoogte bent van en controle heeft over deze functionaliteit. </p>
<p> Feedback van gebruikers zal Moodle HQ enorm helpen bij het verbeteren van de Moodle-software. Ga naar <a href="{$a}"> Feedback-instellingen </a> om deze functie in te schakelen. </p>';
$string['userfeedbacknextreminder'] = 'Volgende feedback-herinnering';
$string['userfeedbacknextreminder_desc'] = 'Wanneer vragen de gebruiker weer feedback?';
$string['userfeedbackperiodically'] = 'Periodiek';
$string['userfeedbackremindafter'] = 'Toon herinnering na';
$string['userfeedbackremindafter_desc'] = 'Herinner gebruikers om feedback te geven na het opgegeven aantal dagen.';
$string['userfiltersdefault'] = 'Standaard gebruikersfilters';
$string['userfiltersdefault_desc'] = 'Selecteer de filters die moeten worden weergegeven op de pagina \'Bulk gebruikers acties\'_pagina.  Houd de Ctrl-toets ingedrukt om meerdere items te selecteren. Alle niet-geselecteerde filters zijn beschikbaar door op de link \'Meer weergeven\' te klikken.';
