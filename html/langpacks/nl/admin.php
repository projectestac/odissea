...
/**
 * Strings for component 'admin', language 'nl', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['configuseexternalyui'] = 'In de plaats van gebruik te maken van lokale bestanden, gebruik de bestanden van  de Yahoo servers. WAARSCHUWING: hiervoor moet je server een verbinding met het internet hebben of AJAX zal niet werken. Deze instelling is niet compatibel met sites die https gebruiken.';
...
$string['coursepage'] = 'Cursuspagina';
...
$string['resetindentation'] = 'Inspringen resetten';
$string['resetindentation_help'] = 'Hiermee wordt alle inspringing verwijderd die eerder was ingesteld voor cursussen in {$a->format}.';
$string['resetindentation_title'] = 'Inspringen op cursuspagina resetten?';
$string['resetindentationsuccess'] = 'Inspringing resetten';
...
$string['sitesectionhelp'] = 'Indien gekozen wordt er een onderwerpsectie getoond op de site startpagina.';
...
$string['userfeedbackencouragement'] = '<p> Moodle 3.9 bevat een nieuwe functie waarmee gebruikers feedback kunnen geven over de Moodle-software aan Moodle HQ via een externe enquête-site die wordt gehost door Moodle HQ. Er wordt geen door de gebruiker identificeerbare informatie doorgestuurd naar de enquête-site. </p>
