...
/**
 * Strings for component 'report_log', language 'nl', version '4.5'.
 *
 * @package     report_log
 * @category    string
...
$string['allsources'] = 'Alle bronnen';
$string['cli'] = 'CLI';
...
$string['missingcontext'] = '{$a->name} (id \'{$a->instanceid}\' verwijderd';
$string['missingcourse'] = 'Cursus (id \'{$a->instanceid}\') ontbreekt';
...
$string['privacy:metadata'] = 'De logs-plugin bewaart geen persoonlijke gegevens.';
