...
/**
 * Strings for component 'scorm', language 'nl', version '4.5'.
 *
 * @package     scorm
 * @category    string
...
$string['allattempts'] = 'Alle SCORM-pogingen';
...
$string['browsemodewithname'] = 'Voorbeeldmodus: {$a}';
...
$string['toggletableofcontents'] = 'Schakel inhoudsopgave';
