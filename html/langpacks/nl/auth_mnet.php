...
/**
 * Strings for component 'auth_mnet', language 'nl', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_mnet
...
$string['crontask'] = 'Achtergrondverwerking voor MNET-authenticatie';
...
$string['privacy:metadata:mnet_log:course'] = 'Cursus-ID van extern systeem waar de actie gebeurde.';
$string['privacy:metadata:mnet_log:coursename'] = 'Cursus volledige naam van extern systeem waar de actie gebeurde.';
$string['privacy:metadata:mnet_log:hostid'] = 'MNet-ID van het extern systeem.';
$string['privacy:metadata:mnet_log:info'] = 'Bijkomende informatie over de actie.';
$string['privacy:metadata:mnet_log:ip'] = 'Het IP-adres dat gebruikt werd toen de actie gebeurde.';
$string['privacy:metadata:mnet_log:module'] = 'Module van het extern systeem waar de actie gebeurde.';
$string['privacy:metadata:mnet_log:remoteid'] = 'Externe ID van de gebruiker die de actie deed in het extern systeem.';
...
$string['unknownhost'] = 'Onbekende host';
