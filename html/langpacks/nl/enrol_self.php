...
/**
 * Strings for component 'enrol_self', language 'nl', version '4.5'.
 *
 * @package     enrol_self
 * @category    string
...
$string['newenrols'] = 'Nieuwe zelfaanmeldingen toestaan';
...
$string['status'] = 'Bestaande zelfaanmeldingen actief houden';
$string['status_desc'] = 'Zelf aanmelden inschakelen in nieuwe cursussen.';
$string['status_help'] = 'Indien nee gekozen wordt, zullen bestaande gebruikers die zichzelf aangemeld hebben geen toegang meer hebben.';
