...
$string['completionexpected_help'] = 'Deze instelling geeft de datum op wanneer de activiteit voltooid hoort te zijn. Wanneer de datum nadert, wordt de activiteit getoond in het tijdslijn-blok op de startpagina.';
