...
/**
 * Strings for component 'completion', language 'nl', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['activitycompletion'] = 'Voltooiingsvoorwaarden';
...
$string['addconditions'] = 'Voorwaarden toevoegen';
...
$string['all'] = 'Alle';
$string['allconditions'] = 'De activiteit is voltooid als de leerlingen al het volgende doen:';
...
$string['badautocompletion'] = 'Je moet ten minste één voorwaarde selecteren.';
...
$string['completion_automatic'] = 'Voeg vereisten toe';
...
$string['completion_manual'] = 'Leerlingen moeten de activiteit handmatig als voltooid markeren';
$string['completion_none'] = 'Geen';
$string['completionactivitydefault'] = 'Gebruik activiteitsstandaard';
$string['completionanygrade_desc'] = 'Elk cijfer';
...
$string['completionexpected'] = 'Zet herinnering op tijdlijn';
$string['completionexpected_help'] = 'Hiermee stel je een herinnering in voor leerlingen om aan deze activiteit te werken. Deze zal verschijnen in het tijdslijn-blok op hun startpagina als "{$a} vereist actie".';
...
$string['completionpassgrade_desc'] = 'Voldoende';
...
$string['completionusegrade_desc'] = 'Een cijfer behalen';
$string['completionusegrade_help'] = 'Indien ingeschakeld, wordt de activiteit als voltooid beschouwd zodra de leerling een cijfer gekregen heeft. Als er een slaagcijfer voor de activiteit is ingesteld, dan zullen geslaagd en mislukt-icoontjes getoond worden in het activiteit voltooien-rapport.';
$string['completionview'] = 'Bekijken vereist';
$string['completionview_desc'] = 'De activiteit bekijken';
...
$string['coursecompletionsettings'] = 'Instellingen voor voltooiing van cursussen';
...
$string['daysuntilcompletion'] = 'Tijd tot voltooiing';
$string['defaultactivitycompletioncourse'] = 'Dit zijn de standaard voltooiingsvoorwaarden voor activiteiten in deze cursus.';
$string['defaultactivitycompletionsite'] = 'Dit zijn de standaard voltooiingsvoorwaarden voor activiteiten in alle cursussen.';
...
$string['deletecompletiondata'] = 'Voltooiingsgegevens';
...
$string['done'] = 'Klaar';
$string['editconditions'] = 'Voorwaarden bewerken';
$string['editcoursecompletionsettings'] = 'Bewerk instelling voor cursusvoltooiing';
$string['emptyconditionsinfo'] = 'Er zijn geen voltooiingsvoorwaarden ingesteld voor deze activiteit.';
$string['emptyconditionswarning'] = 'Je moet minimaal één voltooiingsvoorwaarde toevoegen.';
...
$string['err_settingslocked'] = 'Eén of meer leerlingen hebben al een criterium bereikt en daarom zijn de instellingen geblokkeerd. Het deblokkeren van de voltooiingscriteria zal alle voltooiingsgegevens van je gebruikers verwijderen en kan verwarring veroorzaken.';
...
$string['incompatibleplugin'] = 'Deze activiteit ondersteunt geen standaard voltooiingsinstellingen. Voor elk gebruik moeten de voltooiingsvoorwaarden handmatig worden ingesteld.';
...
$string['studentsmust'] = 'Leerlingen moeten';
...
$string['viewingactivity'] = '{$a} bekijken';
