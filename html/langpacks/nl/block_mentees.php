...
/**
 * Strings for component 'block_mentees', language 'nl', branch 'MOODLE_38_STABLE'
 *
...
$string['configtitle'] = 'Mentees bloktitel';
$string['configtitleblankhides'] = 'Mentees bloktitel (geen titel als leeg)';
