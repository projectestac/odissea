...
/**
 * Strings for component 'portfolio_mahara', language 'nl', branch 'MOODLE_38_STABLE'
 *
...
$string['err_nomnethosts_help'] = 'Deze plugin steunt op Moodle Netwerk peers met SSO IDP gepubliceerd, SSO SP ingeschreven, portfolio services gepubliceerd  <b>en</b> ingeschreven en ook op de MNet authenticatieplugin. Alle exemplaren van deze plugin zijn op niet zichtbaar gezet tot aan deze voorwaarden voldaan is. Ze moeten dan manueel terug op zichtbaar gezet worden.';
