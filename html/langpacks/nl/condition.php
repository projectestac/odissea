...
/**
 * Strings for component 'condition', language 'nl', version '3.11'.
 *
 * @package     condition
 * @category    string
...
$string['completion_incomplete'] = 'mag niet als voltooid gemarkeerd worden';
...
$string['requires_grouping'] = 'Enkel beschikbaar voor groepering <strong>{$a}</strong>.';
...
$string['showavailability_hide'] = 'Verberg de activiteit volledig in de cursus en in het cijferlijst';
