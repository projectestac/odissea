...
/**
 * Strings for component 'studentquiz', language 'nl', version '4.5'.
 *
 * @package     studentquiz
 * @category    string
...
$string['addprivatecomment'] = 'Voeg een privé opmerking toe (deze zijn alleen door leerling en leraar te lezen)';
$string['addprivatecomment_help'] = 'Deze opmerkingen zijn uitsluitend tussen de vraagauteur en degene die de activiteit beheert. Deze draad is meer voor de beheerder om feedback te geven wanneer zij de vraagstatus wijzigen.';
$string['addpubliccomment'] = 'Plaats een publieke opmerking';
...
$string['api_state_change_error_content'] = 'Deze vraag kan niet worden verwijderd omdat hij is goedgekeurd.';
$string['api_state_change_error_title'] = 'Fout bij verwijderen vraag';
...
$string['back_to_course_button'] = 'Terug naar de cursus';
...
$string['changecurrentstate'] = 'Wijzig status van <b><{$s}/b> naar:';
$string['changestateto'] = 'Status(sen) wijzigen naar:';
...
$string['comment_help_help'] = 'Plaats een opmerking bij de vraag.';
$string['comment_veryshort'] = 'Opm.';
$string['commenthistory'] = 'Opmerkingengeschiedenis';
$string['commentplural'] = 'Opmerkingen';
...
$string['current_state'] = 'Huidige status';
...
$string['descriptioncofstate'] = 'Vraag ingesteld op \'{$a->state}\'';
...
$string['includingunread'] = '(inclusief ongelezen)';
...
$string['privatecomments'] = 'Privé opmerkingen';
$string['progress_bar_caption'] = 'Jouw voortgang in deze StudentQuiz activiteit';
$string['public'] = 'Publiek';
$string['publiccomments'] = 'Publieke opmerkingen';
$string['questionchangedlowercase'] = 'gewijzigd';
...
$string['state_approvedlowercase'] = 'goedgekeurd';
$string['state_approvedplural'] = 'Goedgekeurd';
...
$string['state_changedlowercase'] = 'gewijzigd';
$string['state_changedplural'] = 'Gewijzigd';
$string['state_column_name'] = 'Status';
$string['state_column_name_veryshort'] = 'S';
$string['state_deleted'] = 'Verwijderd';
$string['state_deletedlowercase'] = 'verwijderd';
$string['state_deletedplural'] = 'Verwijderd';
$string['state_disapproved'] = 'Afgekeurd';
$string['state_disapprovedlowercase'] = 'afgekeurd';
$string['state_disapprovedplural'] = 'Afgekeurd';
$string['state_hidden'] = 'Verborgen';
$string['state_hiddenlowercase'] = 'verborgen';
$string['state_hiddenplural'] = 'Verborgen';
$string['state_new'] = 'Nieuw';
$string['state_newplural'] = 'Nieuw';
$string['state_pinned'] = 'Vastgezet';
$string['state_pinnedplural'] = 'Vastgezet';
$string['state_shown'] = 'Getoond';
$string['state_shownlowercase'] = 'getoond';
