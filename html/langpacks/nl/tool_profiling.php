...
/**
 * Strings for component 'tool_profiling', language 'nl', version '4.4'.
 *
...
$string['calls'] = 'Functie calls';
$string['cannotfindanyrunforrunid'] = 'Sorry, kan de \'{$a}\' profiling run niet vinden';
...
$string['lastrun'] = 'Samenvatting van de laatste run';
...
$string['referencerun'] = 'Referentierun/opmerking';
$string['runid'] = 'Run ID';
