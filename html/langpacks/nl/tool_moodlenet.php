...
/**
 * Strings for component 'tool_moodlenet', language 'nl', version '4.5'.
 *
...
$string['removalwarning_feature'] = 'Als je MoodleNet wilt blijven gebruiken, neem dan contact op met je sitebeheerder om een zelfgehoste MoodleNet-instantie in te stellen.';
$string['removalwarning_service'] = 'Na die datum kunt u geen inhoud meer bekijken of toevoegen via MoodleNet Central.';
$string['removalwarning_title'] = 'De MoodleNet-dienst wordt op 20 april 2026 stopgezet.';
