...
/**
 * Strings for component 'book', language 'nl', version '4.5'.
 *
 * @package     book
 * @category    string
...
$string['addafterchapter'] = 'Nieuw hoofdstuk toevoegen na "{$a->title}"';
...
Een boek kan gebruikt worden voor:
...
$string['numbering'] = 'Hoofdstukopmaak';
