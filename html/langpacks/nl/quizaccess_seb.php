...
$string['seb:manage_seb_allowcapturecamera'] = 'Wijzig de SEB testinstelling: Geef de browser toegang tot de camera';
$string['seb:manage_seb_allowcapturemicrophone'] = 'Wijzig de SEB testinstelling: Geef de browser toegang tot de microfoon';
...
$string['seb_allowcapturecamera'] = 'Geef de browser toegang tot de camera';
$string['seb_allowcapturecamera_help'] = 'Als deze optie is ingeschakeld, wordt gebruikers gevraagd om SEB toegang tot de camera te verlenen voordat de examensessie van start gaat. In macOS 12/iOS 15 of hoger zorgt het uitschakelen van deze instelling ervoor dat webapplicaties geen toegang meer hebben tot de camera; videoregistratie via WebRTC is dan dus niet mogelijk.';
$string['seb_allowcapturemicrophone'] = 'Geef de browser toegang tot de microfoon';
$string['seb_allowcapturemicrophone_help'] = 'Als deze optie is ingeschakeld, wordt gebruikers gevraagd om SEB toegang tot de microfoon te verlenen voordat de examensessie van start gaat. In macOS 12/iOS 15 of hoger zorgt het uitschakelen van deze instelling ervoor dat webapplicaties geen toegang meer hebben tot de microfoon; audio-opnames via WebRTC zijn dan dus niet mogelijk.';
