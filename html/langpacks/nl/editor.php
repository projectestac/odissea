...
/**
 * Strings for component 'editor', language 'nl', branch 'MOODLE_38_STABLE'
 *
 * @package   editor
...
$string['acteditorshhdr'] = 'Beschikbare teksteditors';
...
$string['configeditorplugins'] = 'Kies de teksteditors die je wil gebruiken en zet ze in de aanbevolen volgorde';
...
$string['pleaseenteralt'] = 'Zet hier een vervangende tekst';
$string['popupeditor'] = 'Vergroot editor';
$string['preformatted'] = 'Vaste opmaak (pre)';
$string['preview'] = 'Voorbeeld';
$string['privacy:metadata:preference:htmleditor'] = 'Voorkeur teksteditor.';
$string['privacy:preference:htmleditor'] = 'De voorkeursteksteditor voor het schrijven van HTML is {$a}';
