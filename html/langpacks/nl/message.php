...
/**
 * Strings for component 'message', language 'nl', version '4.5'.
 *
 * @package     message
 * @category    string
...
$string['enablenotificationplugin'] = 'Notificatie-plugin inschakelen: {$a}';
...
$string['notificationsmarkedasread'] = 'Alle berichten markeren als gelezen.';
...
$string['usercantbemessaged'] = 'Je kunt deze gebruiker geen berichten sturen vanwege hun berichtvoorkeuren. Probeer ze als contact toe te voegen.';
