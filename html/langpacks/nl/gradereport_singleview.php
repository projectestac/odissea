...
/**
 * Strings for component 'gradereport_singleview', language 'nl', version '4.5'.
 *
...
$string['gradeitem'] = 'Cijfers bekijken voor {$a}';
$string['gradeitemcannotbeoverridden'] = 'Dit cijfer kan niet overschreven worden.';
$string['gradeitemedit'] = 'Cijfers bewerken voor {$a}';
$string['gradeuser'] = 'Bekijk cijfers van {$a}';
$string['gradeuseredit'] = 'Bewerk cijfers van {$a}';
