...
/**
 * Strings for component 'tool_brickfield', language 'nl', version '4.5'.
 *
...
$string['checkdesc:imgaltistoolong'] = 'Zorg ervoor dat de alt-tekst (alternatieve tekst) bij de afbeelding voldoende bondig is om de afbeelding te beschrijven.';
