...
/**
 * Strings for component 'enrol_ldap', language 'nl', version '4.1'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['autoupdate_settings_desc'] = '<p>Selecteer de aan te passen velden wanneer "Synchroniseer LDAP-aanmeldingen\' loopt.</p><p>Wanneer er minstens één veld geselecteerd is zal een aanpassing gebeuren.</p>';
...
$string['emptyenrolment'] = 'Lege aanmelding voor rol \'{$a->user_username}\' in cursus \'{$a->course_shortname}\' (id {$a->course_id})';
