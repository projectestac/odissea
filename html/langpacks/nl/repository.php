...
/**
 * Strings for component 'repository', language 'nl', version '4.5'.
 *
 * @package     repository
 * @category    string
...
$string['aliaseschange'] = 'Er zijn {$a} links naar dit bestand. Als je doorgaat, worden die huidige links aangepast naar het gebruik van een kopie van het bestand.';
...
$string['confirmdeletefilewithhref'] = 'Weet je zeker dat je dit bestand wil verwijderen? Er zijn {$a} links naar dit bestand. Als je verder gaat, dan zullen al die locaties die nu naar het bestand liinken automatisch aangepast worden om een kopie van het bestand te gebruiken.';
...
$string['confirmdeleteselectedfile'] = 'Weet je zeker dat je de geselecteerde {$a} bestanden wilt verwijderen?';
...
$string['confirmrenamefile'] = 'Weet je zeker dat je dit bestand wil hernoemen/verplaatsen?';
$string['confirmrenamefolder'] = 'Weet je zeker dat je deze map wil verplaatsen/hernoemen? Alle locaties die nu linken naar bestanden in deze map, zullen aangepast worden om kopieën van het bestand te gebruiken.';
...
$string['errordoublereference'] = 'Kan bestand niet overschrijven met een link omdat er al een link naar dit bestand bestaat.';
...
$string['makefilelink'] = 'Link naar het externe bestand';
$string['makefilereference'] = 'Link naar het bestand';
...
$string['nofilesselected'] = 'Geen bestanden geselecteerd';
$string['nolicenses'] = 'Er zijn geen licenties beschikbaar';
...
$string['originalextensionchange'] = 'De oorspronkelijke bestandsextensie is gewijzigd door het wijzigen van de bestandsnaam. Het wijzigen van de extensie van ".{$a->originalextension}" naar ".{$a->newextension}" kan er voor zorgen dat het bestand niet meer geopend kan worden.';
$string['originalextensionremove'] = 'De oorspronkelijke bestandsextensie is verwijderd door het wijzigen van de bestandsnaam. Het verwijderen van de extensie ". {$a}" kan er voor zorgen dat het bestand niet meer geopend kan worden.';
...
$string['referencesexist'] = 'Er zijn {$a} links naar dit bestand';
