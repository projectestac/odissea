...
/**
 * Strings for component 'tiny_autosave', language 'nl', version '4.5'.
 *
...
$string['privacy:metadata:database:tiny_autosave:userid'] = 'Het gebruikers-ID van de gebruiker die de sessie voor automatisch opslaan aanmaakte';
