...
/**
 * Strings for component 'block_rss_client', language 'nl', version '4.5'.
 *
...
$string['choosefeedlabel'] = 'Kies de te tonen RSS-feeds';
$string['clientchannellink'] = 'Bron site...';
$string['clientnumentries'] = 'Aantal te tonen RSS-links per blok.';
$string['clientshowchannellinklabel'] = 'Toon bronlink indien beschikbaar';
$string['clientshowimagelabel'] = 'Toon een kanaalafbeelding als die beschikbaar is';
$string['configblock'] = 'Configureer dit blok';
$string['configmethodexisting'] = 'Selecteer bestaande RSS-feed';
$string['configmethodnew'] = 'Voeg een nieuwe RSS-feed toe';
...
$string['displaysettings'] = 'Toon instellingen voor RSS-feed';
...
$string['nofeeds'] = 'Er zijn geen RSS-feeds gedefinieerd. Kies \'Voeg nieuwe RSS-feed toe\'.';
...
$string['shownumentrieslabel'] = 'Aantal te tonen items';
$string['submitters'] = 'Wie kan nieuwe RSS-fees definiëren? De feeds staan ter beschikking voor elk lid van je site, zodat zij die kunnen toevoegen aan hun eigen pagina\'s';
$string['submitters2'] = 'Inzenders';
