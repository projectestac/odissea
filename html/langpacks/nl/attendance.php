...
$string['add'] = 'Voeg toe';
$string['addmultiplesessions'] = 'Voeg meerdere sessies toe';
...
$string['attendance_already_submitted'] = 'Je mag niet zelf de aanwezigheid registreren die al geregistreerd is.';
...
$string['commonsession'] = 'Algemeen';
$string['commonsessions'] = 'Algemeen';
...
$string['nogroups'] = 'U kunt geen sessies voor groepen toevoegen omdat er (nog) geen groepen zijn aangemaakt.';
...
$string['sessionsgenerated'] = 'Sessies succesvol gegenereerd';
...
$string['setallstatuses'] = 'Zet de status voor alle gebruikers';
$string['setallstatusesto'] = 'Stel de status «{$a}» in voor alle gebruikers';
