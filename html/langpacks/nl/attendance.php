...
/**
 * Strings for component 'attendance', language 'nl', version '4.4'.
 *
 * @package     attendance
 * @category    string
...
$string['allowupdatestatus'] = 'Leerlingen toestaan hun eigen aanwezigheid bij te werken';
$string['allowupdatestatus_desc'] = 'Indien ingeschakeld kunnen leerlingen hun eigen aanwezigheid bijwerken voor een sessie wanneer ze daar al zelf hebben geregistreerd.';
$string['allowupdatestatus_help'] = 'Indien ingeschakeld kunnen leerlingen hun eigen aanwezigheid bijwerken voor een sessie wanneer ze daar al zelf hebben geregistreerd.';
...
$string['attendance:manualautomark'] = 'Proces manueel automatisch markeren toestaan';
...
$string['attendancereport'] = 'Aanwezigheidsrapportage';
...
$string['attendanceuserreport'] = 'Gebruikersrapport aanwezigheid';
...
$string['automarkingcomplete'] = 'Automatisch markeren voltooid';
$string['automarkingnotavailableyet'] = 'In deze sessie wordt automatisch markeren gebruikt aan het einde van de sessie. Deze sessie is nog niet afgelopen.';
$string['automarkingnotenabled'] = 'Automatisch markeren is niet ingeschakeld in deze sessie';
...
$string['availability'] = 'Beschikbaarheid zelf registreren';
$string['availabilityalways'] = 'Altijd';
$string['availabilitylimitedtime'] = 'Beperkte tijd';
$string['availabilityno'] = 'Nee';
$string['availablebeforesession'] = 'Beschikbaar voor start van sessie';
...
$string['canthidestatus'] = 'Je kunt deze status niet verbergen omdat die al gebruikt wordt binnen deze activiteit Aanwezigheid';
...
$string['customfields'] = 'Aangepaste velden voor sessies';
$string['date'] = 'Datum';
$string['days'] = 'Dagen';
...
$string['lasttaken'] = 'Laatste keer opnemen Aanwezigheid';
$string['manualtriggerauto'] = 'Handmatig triggeren automatisch markeren';
...
$string['numsessionstaken'] = 'Aantal bijgewoonde sessies';
...
$string['passwordheader'] = 'Gebruik onderstaand wachtwoord om je aanwezigheid op te nemen';
...
$string['qrcodevalidbefore'] = 'QR code geldig voor:';
...
$string['reportsessiondate'] = 'Sessiedatum';
$string['reportsessionduration'] = 'Sessieduur';
...
$string['sessiondescription'] = 'Sessiebeschrijving';
...
$string['statusunselected'] = 'niet geselecteerd';
...
$string['studentmarked'] = 'Je aanwezigheid in deze sessie is opgenomen.';
$string['studentmarking'] = 'Opnemen door leerlingen';
$string['studentpassword'] = 'Wachtwoord voor leerlingen';
$string['studentrecordingexpanded'] = 'Opnemen door leerlingen uitgeklapt';
$string['studentrecordingexpanded_desc'] = 'De instellingen "Opnemen door leerlingen" worden standaard uitgeklapt weergegeven wanneer er nieuwe sessies worden aangemaakt.';
$string['studentscanmark'] = 'Sta studenten toe om zelf de aanwezigheid te registeren';
$string['studentscanmark_desc'] = 'Indien aangevinkt kunnen leraren toelaten dat leerlingen hun eigen aanwezigheid opnemen.';
$string['studentscanmark_help'] = 'Leerlingen kunnen hun eigen aanwezigheidsstatus wijzigen als aangevinkt';
$string['studentscanmarksessiontime'] = 'Leerlingen nemen aanwezigheid op tijdens de sessie';
$string['studentscanmarksessiontime_desc'] = 'Indien aangevinkt kunnen leerlingen alleen tijdens de sessie hun aanwezigheid opnemen.';
$string['studentscanmarksessiontimeend'] = 'Eindtijd sessie (minuten)';
$string['studentscanmarksessiontimeend_desc'] = 'Aks de sessie geen eindtijd heeft, hoe lang zal de sessie dan duren wanneer leerlingen er hun aanwezigheid in kunnen opnemen.';
$string['studentsearlyopentime'] = 'Sessie eerder openen voor opnemen';
$string['studentsearlyopentime_help'] = 'Hiermee kunnen leraren de sessie eerder openen, om aanwezigheid op te nemen voor de werkelijke starttijd.';
$string['submit'] = 'Insturen';
$string['submitattendance'] = 'Stuur aanwezigheid in';
$string['submitattendancefuture'] = 'Toekomstige afwezigheid opnemen';
$string['submitpassword'] = 'Wachtwoord insturen';
$string['subnet'] = 'Subnet';
$string['subnetactivitylevel'] = 'Configuratie van subnet op activiteitsniveau toestaan';
$string['subnetactivitylevel_desc'] = 'Indien';
$string['subnetwrong'] = 'Aanwezigheid kan alleen worden opgenomen op bepaalde locaties en deze computer staat niet op de lijst van toegestane apparaten.';
...
$string['thirdpartyemails_help'] = 'Lijst van andere gebruikers die een melding ontvangen. (vereist de permissie mod/attendance:viewreports)';
$string['thirdpartyemailsubject'] = 'Aanwezigheidswaarschuwing';
$string['thirdpartyemailtext'] = '{$a->firstname} {$a->lastname} aanwezigheid in {$a->coursename} {$a->aname} is lager dan {$a->warningpercent} ({$a->percent})';
$string['thirdpartyemailtextfooter'] = 'Je ontvangt dit omdat de leraar van deze cursus je e-mailadres heeft toegevoegd aan de lijst met ontvangers.';
$string['thiscourse'] = 'Deze cursus';
$string['time'] = 'Tijd';
$string['timeahead'] = 'Meerdere sessies over langer dan een jaar kunnen niet worden aangemaakt. Pas de start- en einddata aan.';
$string['timemodified'] = 'Tijdstip aangepast';
$string['timetaken'] = 'Tijdstip opnemen aanwezigheid';
$string['to'] = 'tot:';
$string['todate'] = 'tot heden';
$string['totalnumsessions'] = 'Totaal aantal sessies';
$string['triggered'] = 'Eerst gemeld';
$string['tuseremail'] = 'E-mail';
$string['tusername'] = 'Volledige naam';
$string['ungraded'] = 'Niet beoordeelde sessies';
$string['unknowngroup'] = 'Onbekende groep';
$string['unknownstatus'] = 'Onbekende status id: {$a}';
$string['update'] = 'Wijzigen';
$string['updateattendance'] = 'Aanwezigheid bijwerken';
$string['uploadattendance'] = 'Aanwezigheid uploaden met CSV';
$string['usedefaultsubnet'] = 'Gebruik standaard';
$string['usemessageform'] = 'of gebruik het formulier hieronder om een bericht te sturen aan de geselecteerde leerlingen';
$string['userexistingstatus'] = 'Je aanwzigheid is al gemarkeerd als: <strong>{$a}</strong>, gebruik het formulier hieronder om aan te passen indien noodzakelijk.';
$string['userexists'] = 'Er is al een normale gebruiker met dit e-mailadres.';
$string['userid'] = 'Gebruiker ID';
$string['userimportfield'] = 'Extern gebruikersveld';
$string['userimportfield_help'] = 'Veld in geüpload CSV-bestand dat de gebruikersidentifier bevat';
$string['userimportto'] = 'Moodle gebruikersveld';
$string['userimportto_help'] = 'Veld in Moodle dat overeenkomt met de gegevens uit het geëxporteerde CSV-bestand';
$string['users'] = 'Kies te exporteren gebruikers';
$string['usersessiongrade'] = 'Beoordeling van gebruiker in sessie';
$string['usersessionremarks'] = 'Opmerkingen bij gebruiker in sessie';
$string['usestatusset'] = 'Statusset';
...
$string['weekcommencing'] = 'Beginweek';
$string['weeks'] = 'Weken';
