...
/**
 * Strings for component 'questionnaire', language 'nl', version '4.5'.
 *
...
$string['addnewsection'] = 'Voeg nieuwe sectie toe';
...
$string['centerlabel'] = 'Label centreren';
...
$string['invalidincrement'] = 'Merk op dat de verhogingswaarde lager moet zijn dan de maximumwaarde. Bij een schaal van 1-10 zou de verhogingswaarde waarschijnlijk 1 zijn.';
$string['invalidminmaxrange'] = 'Dit vraagtype ondersteunt een absolute maximumbereik van -100 tot +100. We verwachten dat verreweg de meeste ontwerpen van enquêtes een bereik van 1-10 of -10 tot +10 gebruiken.';
$string['invalidrange'] = 'De maximumwaarde moet groter zijn dan de minimumwaarde van de schuifbalk.';
...
$string['invalidstartingvalue'] = 'De beginwaarde moet gelijk zijn aan of vallen tussen de minimum- en maximumwaardes. Wanneer je bijvoorbeeld een schaal 1 - 10 gebruikt, zou de beginwaarde 5 kunnen zijn.';
...
$string['maxrange'] = 'Maximumwaarde schuifbalk (rechts)';
$string['maxrange_help'] = 'Stel de maximumwaarde in voor de rechterkant van het bereik. Dit is standaard 100, maar kan iedere waarde tussen 1 - 100 zijn. Als de minimumwaarde aan de linkerkant negatief is, wordt het maximum van het bereik met een plusteken (+) weergegeven.';
...
Stel **Min.** en **Max.** op dezelfde waarde in om een exact aantal vakjes aan te laten vinken. Als er alleen een min of max waarde gewenst is, laat dan de andere waarde op standaard **0**. Als je de **Min.** of **Max.** op een andere waarde instelt dan de standaard **0**, wordt er een waarschuwing getoond als de respondent niet voldoet aan de vereisten. Het is vanzelfsprekend dat je de vereisten duidelijk maakt aan de respondenten, ofwel in de algemene instructies van je Enquête ofwel in de tekst van relevante vragen.';
$string['minrange'] = 'Minimumwaarde schuifbalk (links)';
$string['minrange_help'] = 'Stel de minimumwaarde in voor de linkerkant van het bereik. Dit is standaard 1, maar kan tot -100 worden ingesteld. Als je een negatieve waarde (-100 tot -1) instelt, wordt de maximumwaarde aan de rechterkant met een plusteken (+) weergegeven.';
...
$string['return'] = 'Terug';
$string['rightlabel'] = 'Label rechts';
$string['save'] = 'Bewaar';
...
$string['slider'] = 'Schuifbalk';
$string['slider_help'] = 'Het vraagtype Schuifbalk geeft respondenten de mogelijkheid een waarde te selecteren binnen een ingesteld bereik door een knop te verschuiven tussen twee uitersten. Een gecentreerde waarde kan eveneens worden ingesteld.';
$string['started'] = 'Begonnen';
$string['startingvalue'] = 'Beginwaarde Schuifbalk';
$string['startingvalue_help'] = 'De beginwaarde van de schuifknop geeft aan waar de knop eerst verschijnt voor respondenten. Dit is standaard ingesteld op 1 omdat het bereik onbekend is. Je kunt ervoor kiezen in het midden van het bereik te beginnen door een middenwaarde aan te geven (een bereik van 1-100 heeft een middenwaarde van 50).';
$string['stepvalue'] = 'Verhogingswaarde schuifbalk';
$string['stepvalue_help'] = 'De verhogingswaarde voor de schuifbalk bepaalt hoe groot de stappen zijn waarmee respondenten hun antwoord binnen het bereik kunnen instellen. Standaard is dit 1 bij een bereik van 1-100, zodat respondenten een waarde van 70, 71, 72, 73, 74, enz. kunnen geven. Je kunt echter ook kiezen voor een verhogingswaarde van 5 zodat respondenten een waarde van 60, 65, 70, 75, 80, enz. kunnen geven. Of je stelt een bereik in van 1-10 met verhogingen van 1.';
...
$string['viewyourresponses'] = 'Bekijk jouw antwoord(en)';
...
$string['yourresponse'] = 'Bekijk jouw antwoord(en)';
$string['yourresponses'] = 'Bekijk jouw antwoord(en)';
