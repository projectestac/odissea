...
/**
 * Strings for component 'assignfeedback_editpdf', language 'nl', version '4.5'.
 *
...
$string['privacy:metadata:userid'] = 'De ID van de gebruiker.';
$string['privacy:path'] = 'PDF Feedback';
$string['rectangle'] = 'Rechthoek';
$string['red'] = 'Rood';
$string['result'] = 'Resultaat:';
$string['rotateleft'] = 'Draai 90 graden naar links';
$string['rotateright'] = 'Draai 90 graden naar rechts';
