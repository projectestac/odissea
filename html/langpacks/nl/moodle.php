...
$string['addfilesdrop'] = 'Je kunt hier bestanden slepen en neerzetten om te uploaden of klikken om te selecteren.';
$string['addinganew'] = 'Nieuw {$a}';
...
$string['backupinfo'] = 'Maak een kopie van deze cursus, inclusief alle inhoud en activiteiten. Je kunt het back-upbestand gebruiken om deze cursus te herstellen.';
...
$string['blocks_main'] = 'Belangrijkste inhoudsblokken';
$string['blocks_supplementary'] = 'Aanvullende blokken';
...
$string['bulkcancel'] = 'Bulkbewerking sluiten';
...
$string['checkerror'] = 'Fout bij verkrijgen van resultaat van controle \'{$a}\'. Controleer de browserconsole voor meer informatie.';
...
$string['checkloading'] = 'Het resultaat verkrijgen van controle \'{$a}\'';
...
$string['confirmaccount'] = 'Account bevestigen';
...
$string['contextlevel'] = 'Contextniveau';
$string['contextname'] = 'Contextnaam';
$string['contextparent'] = 'Ouder';
...
$string['coursereusenavigationmenu'] = 'Navigatiemenu voor hergebruik van cursussen';
...
$string['coursesectiontitlebulkediting'] = 'Bulkbewerking van {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'Cursus bulksgewijs bewerken: {$a->course}';
...
$string['currenttheme'] = 'Huidig thema';
...
$string['editgroupprofile'] = 'Wijzig groepsbeschrijving';
...
$string['editsection'] = 'Bewerk instellingen';
$string['editsectionname'] = 'Bewerk sectienaam';
$string['editsectionsettings'] = 'Sectie-instellingen bewerken';
$string['editsectiontitle'] = 'Sectie bewerken: {$a}';
...
$string['emailonlyallowed'] = 'Dit e-mailadres kan niet gebruikt worden. Toegestane e-maildomeinen zijn: ({$a})';
...
$string['enddatewithtaskenabled'] = 'Einddatum cursus';
$string['enddatewithtaskenabled_help'] = 'De datum waarop de cursus verborgen wordt voor leerlngingen en ze er geen toegang meer toe hebben.';
...
$string['eventcourseended'] = 'Cursus beëindigd';
...
$string['eventcoursestarted'] = 'Cursus gestart';
...
$string['eventsectionviewed'] = 'Sectie bekeken';
$string['eventunknownlogged'] = 'Onbekende gebeurtenis';
$string['eventurlblocked'] = 'De URL is geblokkeerd';
...
$string['failedtasksubject'] = 'Taak mislukt: {$a}';
...
$string['format_help'] = 'De cursus-format bepaalt de lay-out van de cursus pagina.

* Enkele activiteit  - Voor het weergeven van één enkele activiteit of bron.
* Sociaal - Er wordt een forum weergegeven op de cursus pagina. Bijkomende activiteiten kunnen toegevoegd worden in het sociale activiteitenblok.
* Secties - De cursuspagina is opgedeeld in aanpasbare secties
* Weken - De cursuspagina is georganiseerd in secties per week, met de eerste week beginnend op de cursus startdatum';
...
$string['importinfo'] = 'Importeer items uit andere cursussen, zoals activiteiten, blokken of agenda-evenementen. Er worden geen gebruikersgegevens geïmporteerd.';
...
$string['includesubcategories'] = 'Ook subcategorieën';
...
$string['insertcontentsection'] = 'Inhoud invoegen in sectie \'{$a->sectionname}\'';
...
$string['invalidtaskclassname'] = 'Ongeldige taakklasse {$a}';
...
$string['makeavailablecmtitle'] = 'Maak activiteit beschikbaar';
...
$string['markedthistopic'] = 'Deze sectie is gemarkeerd als de huidige sectie';
$string['markthistopic'] = 'Markeer deze sectie als de huidige sectie';
...
$string['maxlengthreached'] = 'Het maximale tekenlimiet van {$a} is bereikt.';
...
$string['messageprovider:enrolcoursewelcomemessage'] = 'Welkomstbericht voor nieuwe cursusinschrijvingen';
...
$string['messageprovider:failedtaskmaxdelay'] = 'De taak bereikt de maximale foutvertraging';
...
$string['modshow'] = 'Toon';
$string['modshowcmtitle'] = 'Toon activiteit';
...
$string['moodledocslink'] = 'Documentatie voor deze pagina';
$string['moodlelogo'] = 'Moodle logo';
$string['moodlenet:cannotconnecttoserver'] = 'Kan geen verbinding maken met de MoodleNet-server';
$string['moodlenet:columnname'] = 'Naam';
$string['moodlenet:columnsenddate'] = 'Verstuur datum';
$string['moodlenet:columnsendstatus'] = 'Status verzenden';
$string['moodlenet:columntype'] = 'Type';
$string['moodlenet:configoauthservice'] = 'Selecteer een MoodleNet OAuth 2-service om het delen naar een MoodleNet-site in te schakelen. Als de service niet bestaat, dam moet je die <a href="{$a}">cmaken</a>.';
$string['moodlenet:deletedactivity'] = 'Activiteit verwijderd';
$string['moodlenet:deletedcourse'] = 'Cursus verwijderd';
$string['moodlenet:eventresourceexported'] = 'Bron geëxporteerd';
$string['moodlenet:gotomoodlenet'] = 'Ga naar MoodleNet concepten';
$string['moodlenet:issuerisnotauthorized'] = 'MoodleNet-uitgever is niet geauthoriseerd';
$string['moodlenet:issuerisnotenabled'] = 'MoodleNet-uitgever is niet ingeschakeled';
$string['moodlenet:issuerisnotset'] = 'MoodleNet-uitgever is net ingesteld bij site-beheer';
$string['moodlenet:nosharedresources'] = 'Er zijn momenteel geen gedeelde bronnen om weer te geven.';
$string['moodlenet:outboundsettings'] = 'MoodleNet instellingen (versturen)';
$string['moodlenet:packagingandsending'] = 'Bestand verpakken en sturen naar MoodleNet...';
$string['moodlenet:sharefailtext'] = 'Er is een fout opgetreden bijn het delen van je inhoud op MoodleNet.<br>Probeer later opnieuw.';
$string['moodlenet:sharefailtextwithsitesupport'] = 'Er is een fout opgetreden bijn het delen van je inhoud op MoodleNet.<br>Probeer later opnieuw of <a href="{$a}">contacteer site-ondersteuning</a>.';
$string['moodlenet:sharefailtitle'] = 'Er ging wat fout';
$string['moodlenet:sharefilesizelimitexceeded'] = 'De grootte van de gedeelde bron ({$a->filesize}  is groter dan de limiet van {$a->filesizelimit} bytes.';
$string['moodlenet:sharenoticeactivity'] = 'Deze activiteit wordt gedeeld met MoodleNet als een bron.';
$string['moodlenet:sharenoticecourse'] = 'Deze cursus wordt gedeeld met MoodleNet als een bron.';
$string['moodlenet:sharenoticepartial'] = 'De geselecteerde activiteiten worden gedeeld met MoodleNet als een een bron.';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} activiteiten zullen in de cursus gezet worden.';
$string['moodlenet:shareprogress'] = 'MoodleNet deelt de voortgang';
$string['moodlenet:shareprogressinfo'] = 'De lijst toont cursussen en activiteiten die je hebt gedeeld met MoodleNet.<br>Klik op de naam van de bron om deze in MoodleNet te bekijken.';
$string['moodlenet:sharesuccesstext'] = 'Bijna klaar! Bezoek nu je concepten in MoodleNet om het delen van je inhoud te voltooien.';
$string['moodlenet:sharesuccesstitle'] = 'Bewaard als MoodleNet concept';
$string['moodlenet:sharetomoodlenet'] = 'Deel op MoodleNet';
$string['moodlenet:sharetyperesource'] = 'bron';
$string['moodlenet:sharinglargefile'] = 'Grote bestanden kan even duren.';
$string['moodlenet:sharingstatus'] = 'Delen op MoodleNet';
$string['moodlenet:sharingto'] = 'Delen op:';
...
$string['multipleitemsfound'] = 'Er zijn {$a} items gevonden.';
...
$string['noitemsfound'] = 'Geen items gevonden.';
...
$string['oneitemfound'] = 'Er is 1 item gevonden.';
...
$string['pluginmissingfromdisk'] = '{$a->name} (Ontbreekt op schijf)';
...
$string['policyagreementclick'] = 'Gebruiksovereenkomst voor deze site';
$string['popup'] = 'pop-up';
...
$string['previewthemename'] = 'Voorbeeld thema \'{$a}\'';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'MoodleNet deelt voortgangsgegevens';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'De bijbehorende cursusmodule-ID';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'De bijbehorende cursus-ID';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = 'De geretourneerde URL van MoodleNet na succesvol delen';
$string['privacy:metadata:moodlenet_share_progress:status'] = 'De resulterende status van het delen';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = 'Het tijdstip waarop het delen is uitgevoerd';
$string['privacy:metadata:moodlenet_share_progress:type'] = 'Het type gedeelde dat is uitgevoerd';
$string['privacy:metadata:moodlenet_share_progress:userid'] = 'De gebruiker die het  heeft gedeeld';
...
$string['resendemail'] = 'Bevestigings-e-mail opnieuw versturen';
...
$string['restoreinfo'] = 'Gebruik een back-upbestand om een eerdere versie van een cursus te herstellen of een nieuwe cursus te maken.';
...
$string['rolerenaming_help'] = 'Wijzig de getoonde namen of rollen in deze cursus.';
$string['rolerenaming_success'] = 'Namen van cursusrollen bijgewerkt.';
$string['roles'] = 'Rollen';
$string['rss'] = 'RSS';
...
$string['sectionoutline'] = 'Sectieoverzicht';
...
$string['selecttheme'] = 'Selecteer thema';
$string['selectthemename'] = 'Selecteer thema \'{$a}\'';
...
$string['signoutofotherservices'] = 'Van alle webapps uitloggen';
$string['signoutofotherservices_help'] = 'Het account zal op alle apparaten en uit alle systemen die web services gebruiken, zoals de mobiele app, worden uitgelogd.';
$string['since'] = 'Sinds';
...
$string['sites'] = 'Sites';
$string['sitesection'] = 'Voeg inhoud toe';
...
$string['startdatewithtaskenabled'] = 'Startdatum cursus';
$string['startdatewithtaskenabled_help'] = 'De datum waarop de cursus zichtbaar wordt voor leerlingen. Vóór deze datum hebben ze geen toegang tot de cursus.

Deze datum bepaalt ook de start van de eerste week voor een cursus in weekformaat en is de startdatum voor logs van cursusactiviteiten. Als je de cursus terug op standaardinstellingen zet en deze datum wijzigt, worden alle data in de cursus aangepast ten opzichte van de nieuwe startdatum.';
...
$string['theme'] = 'Thema';
$string['themepreviewdescription'] = 'Themabeschrijving {$a}';
$string['themepreviewimage'] = 'Voorbeeldafbeelding {$a}';
...
$string['usermatchedon'] = 'Deze gebruiker komt overeen met de zoekopdracht via het volgende veld';
...
$string['userselectorsearchanywhere'] = 'overal';
$string['userselectorsearchexactmatchonly'] = 'Alleen exacte overeenkomsten';
$string['userselectorsearchfromstart'] = 'vanaf het begin';
$string['userselectorsearchmatching'] = 'Bij elkaar passen:';
...
$string['viewallresults'] = 'Bekijk alle resultaten ({$a})';
...
$string['viewresults'] = 'Bekijk resultaten voor {$a}';
...
Als je je profielpagina nog niet hebt aangevuld, doe dat dan even zodat we je wat beter kunnen leren kennen:
...
$string['wontrunfuturescheduledtask'] = 'Taak die niet is mislukt en gepland is om in de toekomst te worden uitgevoerd, wordt niet uitgevoerd';
