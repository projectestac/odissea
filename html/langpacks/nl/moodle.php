...
$string['accept'] = 'Aanvaarden';
$string['action'] = 'Actie';
$string['actionchoice'] = 'Wat wil je doen met het bestand \'{$a}\'?';
$string['actions'] = 'Acties';
$string['actionsfor'] = 'Acties voor {$a}';
$string['actionsmenu'] = 'Menu Acties';
...
$string['addsections'] = 'Voeg secties toe';
...
$string['agelocationverification'] = 'Leeftijd- en locatieverificatie';
$string['aimid'] = 'AIM ID';
...
$string['allowstealthmodules'] = 'Verborgen activiteiten toestaan';
$string['allowstealthmodules_help'] = 'Indien ingeschakeld kunnen activiteiten beschikbaar gemaakt worden zonder getoond te worden op de cursuspagina. Als je dat doet, dan moeten er ergens anders links gegeven worden naar deze verborgen activiteiten, zoals op een pagina-bron. Verborgen activiteiten worden wel getoond in het cijferlijst en op andere rapporten.';
$string['allparticipants'] = 'Alle deelnemers';
$string['allteachers'] = 'Alle leraren';
$string['alphanumerical'] = 'Mag alleen maar alfanumerieke tekens, liggend streepje (-) of punt (.) bevatten';
...
$string['autosubscribeno'] = 'Nee: schrijf me niet automatisch in op forumdiscussies';
$string['autosubscribeyes'] = 'Ja: schrijf me automatisch in op discussies wanneer ik er een bericht in post';
...
$string['backtohome'] = 'Terug naar de startpagina van de site';
...
$string['backupadhocpending'] = 'Niet geplande cursus back-up-taak in behandeling';
...
$string['backupsavetohelp'] = 'Volledig pad naar de map waar je de back-upbestanden wil bewaren';
...
$string['cachecontrols'] = 'Cache controle';
$string['calltofeedback'] = 'De makers van deze software willen graag jouw feedback';
$string['calltofeedback_give'] = 'Geef feedback';
$string['calltofeedback_remind'] = 'Herinner me later';
$string['cancel'] = 'Annuleer';
$string['cancelled'] = 'Geannuleerd';
$string['categories'] = 'Cursuscategorieën';
$string['categoriesandcourses'] = 'Cursuscategorieën en cursussen';
...
$string['checkactual'] = 'Werkelijk';
$string['checkall'] = 'Selecteer alles';
$string['checkexpected'] = 'Verwacht';
...
$string['checksok'] = 'Alle \'{$a} \' controles OK';
...
$string['confirmdeletesection'] = 'Weet je zeker dat je "{$a}" en alle activiteiten die het bevat volledig wil verwijderen?';
$string['confirmed'] = 'Je registratie is bevestigd';
$string['confirmednot'] = 'Je registratie is nog niet bevestigd. Controleer je mailbox voor een bevestigingse-mail.';
$string['considereddigitalminor'] = 'Je bent te jong om een account te maken op deze site.';
...
$string['courseduration_desc'] = 'De cursusduur wordt gebruikt om de standaard cursus einddatum te berekenen. De cursus einddatum wordt gebruikt om te bepalen of een cursus in de cursuslijst van een gebruiker wordt opgenomen en kan gebruikt worden voor rapportages. Gebruikers kunnen nog steeds in de cursus na de einddatum.';
$string['courseenddateenabled'] = 'Cursus einddatum is standaard ingeschakeld';
$string['courseenddateenabled_desc'] = 'Deze instelling bepaalt of de cursus einddatum standaard ingeschakeld wordt voor nieuwe cursussen en ingesteld wordt op de datum, berekend uit de cursusduur.';
...
$string['coursehelpnewsitemsnumber'] = 'Aantal recente mededelingen die verschijnen in het mededelingenblok op de cursuspagina. Als je dit op nul zet, verschijnt het mededelingenblok niet.';
...
$string['coursepreferences'] = 'Cursusvoorkeuren';
...
$string['databasechecking'] = 'De Moodledatabase van versie {$a->oldversion} naar versie {$a->newversion} aan het upgraden...';
...
$string['defaultcoursesummary'] = 'Schrijf hier een korte en interessante alinea waarin wordt uitgelegd waarover deze cursus gaat';
...
$string['defaulthomepageuser'] = 'Startpagina';
$string['defaulthomepageuser_help'] = 'Naar welke pagina moet je gestuurd worden na het inloggen op de site?';
...
$string['deprecatedeventname'] = '{$a} (niet langer in gebruik)';
$string['desc'] = 'Aflopend';
$string['description'] = 'Beschrijving';
$string['descriptiona'] = 'Beschrijving: {$a}';
$string['deselectall'] = 'Niets selecteren';
$string['deselectnos'] = 'Deselecteer alles \'Nee\'';
...
$string['digitalminor_desc'] = 'Vraag je ouders / voogd om contact op te nemen met:';
$string['directory'] = 'Map';
$string['disable'] = 'Schakel uit';
$string['disabledcomments'] = 'Notities zijn uitgeschakeld';
$string['dismissnotification'] = 'Verwerp deze opmerking';
...
$string['dndnotsupported_help'] = 'Je browser ondersteunt het uploaden met slepen en neerzetten niet. Deze functie is beschikbaar op alle recente versies van Chrome, Firefox en Safari en ook op Internet Explorer 10 en hoger.';
...
$string['editorpreferences'] = 'Voorkeuren editor';
...
Jammer genoeg is je account uitgeschakeld op deze site, waardoor je wachtwoord niet kan gereset worden. Neem contact op met de sitebeheerder, {$a->admin}';
...
$string['emailstop'] = 'Meldingen uitschakelen';
$string['emailtoprivatefiles'] = 'Je kunt via e-mail bestanden naar je privébestanden sturen. Zet ze in bijlage en stuur ze naar {$a}';
$string['emailtoprivatefilesdenied'] = 'De beheerder heeft de mogelijkheid om je eigen private bestanden te uploaden uitgeschakeld.';
$string['emailvia'] = '{$a->name} (via {$a->siteshortname})';
$string['emojicategoryactivities'] = 'Activiteiten';
$string['emojicategoryanimalsnature'] = 'Dieren en natuur';
$string['emojicategoryflags'] = 'Vlaggen';
$string['emojicategoryfooddrink'] = 'Eten en drinken';
$string['emojicategoryobjects'] = 'Objecten';
$string['emojicategorypeoplebody'] = 'Mensen en lichaam';
...
$string['eventcommentcreated'] = 'Opmerking gemaakt';
$string['eventcommentdeleted'] = 'Opmerking verwijderd';
$string['eventcommentsviewed'] = 'Opmerkingen bekeken';
$string['eventconfiglogcreated'] = 'Configuratielog aangemaakt';
$string['eventcontentviewed'] = 'Inhoud bekeken';
$string['eventcoursebackupcreated'] = 'Cursusback-up gemaakt';
$string['eventcoursecategorycreated'] = 'Categorie gemaakt';
$string['eventcoursecategorydeleted'] = 'Categorie verwijderd';
$string['eventcoursecategoryupdated'] = 'Categorie aangepast';
$string['eventcoursecategoryviewed'] = 'Categorie bekeken';
...
$string['eventcourseinformationviewed'] = 'Cursussamenvatting bekeken';
$string['eventcoursemodulecreated'] = 'Cursusmodule gemaakt';
$string['eventcoursemoduledeleted'] = 'Cursusmodule verwijderd';
$string['eventcoursemoduleinstancelistviewed'] = 'Lijst met cursusmodules bekeken';
...
$string['eventsearchresultsviewed'] = 'Zoekresultaten bekeken';
...
$string['eventuserfeedbackgiven'] = 'Geklikt op feedback link';
$string['eventuserfeedbackremind'] = 'Herinner me later feedback link geklikt';
$string['eventuserinfocategorycreated'] = 'Gebruikersveldcategorie gemaakt';
$string['eventuserinfocategorydeleted'] = 'Gebruikersveldcategorie verwijderd';
$string['eventuserinfocategoryupdated'] = 'Gebruikersveldcategorie aangepast';
$string['eventuserinfofieldcreated'] = 'Gebruikersveld gemaakt';
$string['eventuserinfofielddeleted'] = 'Gebruikersveld verwijderd';
$string['eventuserinfofieldupdated'] = 'Gebruikersveld aangepast';
$string['eventuserlistviewed'] = 'Gebruikerslijst bekeken';
$string['eventuserloggedout'] = 'Gebruiker afgemeld';
$string['eventuserpasswordpolicyfailed'] = 'Wachtwoord gebruiker mislukt wachtwoordbeleid';
$string['eventuserpasswordupdated'] = 'Wachtwoord gewijzigd';
...
$string['explanationdigitalminor'] = 'Deze informatie is vereist om te bepalen of je leeftijd hoger is dan de digitale leeftijd die vereist is. Dit is de leeftijd waarop een persoon kan instemmen met de algemene voorwaarden en dat zijn gegevens legaal worden opgeslagen en verwerkt.';
...
$string['favourites'] = 'Met ster';
$string['feedback'] = 'Feedback';
$string['file'] = 'Bestand';
$string['fileexists'] = 'Er is al een bestand met de naam {$a}';
$string['filemissing'] = '{$a} ontbreekt';
$string['filereaderror'] = 'Kon het bestand \'{$a}\' niet lezen. Controleer of het echt een bestand is en geen map.';
...
$string['forumpreferences'] = 'Voorkeuren Forum';
...
$string['hiddensections_help'] = 'Of verborgen aan leerlingen getoond worden als niet beschikbaar (misschien voor een cursus in weekformaat om de vakanties aan te duiden) of volledig verborgen worden.';
...
$string['idnumbermod_help'] = 'Een ID-nummer instellen geeft een manier om de activiteit of bron te identificeren voor de berekening van cijfers of aangepaste rapportering. Als de activiteit niet in een cijferberekening opgenomen wordt, dan mag dit veld leeg gelaten worden.

Voor beoordeelbare activiteiten kan het ID-nummer kan ook ingesteld worden in het cijferlijst - het kan echter alleen bewerkt worden op de instellingspagina van de activiteit.';
...
$string['indicator:accessesafterend'] = 'Cursustoegang na einddatum';
$string['indicator:accessesafterend_help'] = 'Deze indicator geeft aan dat een leerling toegang tot de cursus gehad heeft na de einddatum.';
$string['indicator:accessesbeforestart'] = 'Cursustoegang voor startdatum';
$string['indicator:accessesbeforestart_help'] = 'Deze indicator geeft aan dat een leerling toegang tot de cursus gehad heeft voor de startdatum';
$string['indicator:activitiesdue'] = 'Uit te voeren activiteiten';
$string['indicator:activitiesdue_help'] = 'De gebruiker heeft activiteiten te doen.';
$string['indicator:anycourseaccess'] = 'Elke cursustoegang';
$string['indicator:anycourseaccess_help'] = 'Deze indicator toont  toegangen tot elke cursus waarin de gebruiker aangemeld is.';
$string['indicator:anywrite'] = 'Een schrijfactie';
$string['indicator:anywrite_help'] = 'Deze indicator geeft aan dat er schrijfactie (insturen) gebeurd is door de leerling.';
$string['indicator:anywriteincourse'] = 'Een schrijfactie in de cursus';
$string['indicator:anywriteincourse_help'] = 'Deze indicator geeft aan dat er schrijfactie (insturen) gebeurd is door de leerling in een cursusactiviteit.';
$string['indicator:completeduserprofile'] = 'Gebruikersprofiel aangevuld';
$string['indicator:completeduserprofile_help'] = 'Deze indicator geeft aan dat een leerling zijn gebruikersprofiel heeft aangevuld';
$string['indicator:completeduserprofiledef'] = 'Gebruikersprofiel is voltooid';
$string['indicator:completeduserprofiledef_help'] = 'Het sitebeleid is overeengekomen en de gebruiker heeft de volgende velden ingevuld: Instelling, Afdeling, Adres, Plaats, Land, URL.';
$string['indicator:completionenabled'] = 'Voltooien bijhouden ingeschakeld';
$string['indicator:completionenabled_help'] = 'Deze indicator geeft aan dat het bijhouden van het voltooien van activiteiten is ingeschakeld voor deze cursus.';
$string['indicator:nostudent'] = 'Aanmeldingen van leerlingen';
$string['indicator:nostudent_help'] = 'Deze indicator geeft aan of er leerlingen in deze cursus zijn.';
$string['indicator:noteacher'] = 'Leraren';
$string['indicator:noteacher_help'] = 'Deze indicator geeft aan of er leraren in deze cursus zijn.';
$string['indicator:potentialcognitive'] = 'Potentiële cognitieve diepte van de cursus';
...
$string['invalidusername'] = 'De gebruikersnaam mag alleen kleine alfanumerieke tekens (letters en cijfers), liggend streepje (-), underscore (_), punt(.) of het at-symbool (@) bevatten.';
...
$string['lastip'] = 'Laatste IP-adres';
...
$string['locktimeout'] = 'De time out van de bewerking is verlopen terwijl er op een lock gewacht werd.';
...
$string['loginactivity'] = 'Login-activiteit';
$string['loginagain'] = 'Log opnieuw in';
...
$string['makeavailable'] = 'Maak beschikbaar';
...
$string['maxsectionslimit'] = 'Kan geen nieuwe sectie maken omdat deze het maximumaantal secties dat is toegestaan voor deze cursus ({$a}) overschrijdt.';
...
$string['messageprovider:asyncbackupnotification'] = 'Asynchrone back-up / herstelmeldingen';
...
$string['messageprovider:gradenotifications'] = 'Cijfermeldingen';
$string['messageprovider:infected'] = 'Meldingen antivirus mislukt';
$string['messageprovider:insights'] = 'Inzichten, gegenereerd door voorspellende modellen';
...
$string['missingrecaptchachallengefield'] = 'Ontbrekend reCAPTCHA challenge. Probeer opnieuw.';
...
$string['moveright'] = 'Inspringen naar rechts';
...
$string['mustconfirm'] = 'Je moet je account bevestigen';
...
$string['needed'] = 'Nodig';
$string['networkdropped'] = 'We hebben gemerkt dat je internetverbinding onbetrouwbaar is of onderbroken werd.<br />Let op dat wijzigingen misschien niet goed bewaard worden tot je verbinding verbetert.';
$string['never'] = 'Nooit';
...
$string['newpictureusernotsetup'] = 'Een profielfoto kan alleen worden toegevoegd wanneer alle gewenste profielinformatie is opgeslagen.';
...
$string['nocoursestarttime'] = 'De cursus heeft geen startdatum';
...
$string['nofiltersapplied'] = 'Geen toegepaste filters';
...
$string['nostudentsyet'] = 'Er zijn nog geen leerlingen aangemeld in deze cursus.';
$string['nosuchemail'] = 'Dit e-mailadres is hier niet bekend';
$string['notavailable'] = 'Niet beschikbaar';
$string['notavailablecourse'] = '{$a} is niet beschikbaar';
$string['noteachersyet'] = 'Er zijn nog geen leraren voor deze cursus';
$string['noteachingupcomingcourses'] = 'Aankomende cursussen hebben geen leraren of leerlingen';
...
$string['nothingnew'] = 'Geen recente activiteit';
...
$string['notifyloginfailuresmessage'] = '{$a->time}, IP adres: {$a->ip}, Gebruiker: {$a->info}, Volledige gebruikersnaam: {$a->name}';
$string['notifyloginfailuresmessageend'] = 'Je kunt deze logs bekijken op {$a}';
...
$string['notingroup'] = 'Om deze pagina te kunnen zien moet je lid zijn van een groep.';
...
$string['pagedcontentnavigation'] = 'Paginering navigatie';
$string['pagedcontentnavigationactiveitem'] = 'Huidige pagina, pagina {$a}';
$string['pagedcontentnavigationitem'] = 'Ga naar pagina {$a}';
$string['pagedcontentpagingbaritemsperpage'] = 'Toon {$a} items per pagina';
...
$string['passwordpolicynomatch'] = 'Je huidige wachtwoord komt niet langer overeen met het ingestelde wachtwoordbeleid.
    {$a}';
...
$string['privacy:metadata:config_log'] = 'Het logboek van configuratiewijzigingen.';
$string['privacy:metadata:config_log:name'] = 'De naam van de instelling verandert.';
$string['privacy:metadata:config_log:oldvalue'] = 'De vorige waarde voor deze instelling.';
$string['privacy:metadata:config_log:plugin'] = 'De plug-in is aangepast.';
$string['privacy:metadata:config_log:timemodified'] = 'De tijd dat de wijziging is aangebracht.';
$string['privacy:metadata:config_log:userid'] = 'De gebruiker die de wijziging heeft aangebracht.';
$string['privacy:metadata:config_log:value'] = 'De nieuwe waarde voor deze instelling.';
$string['privacy:metadata:events_queue'] = 'De wachtrij van gebruikersgebeurtenissen die wachten om te worden verwerkt.';
$string['privacy:metadata:events_queue:eventdata'] = 'De gegevens die zijn opgeslagen in de gebeurtenis.';
$string['privacy:metadata:events_queue:stackdump'] = 'Elke stacktrace geassocieerd met deze gebeurtenis.';
$string['privacy:metadata:events_queue:timecreated'] = 'De tijd dat deze gebeurtenis is gemaakt.';
$string['privacy:metadata:events_queue:userid'] = 'De gebruikers-ID geassocieerd met deze gebeurtenis';
$string['privacy:metadata:log'] = 'Een verzameling van vorige gebeurtenissen';
$string['privacy:metadata:log:action'] = 'Een beschrijving van de actie';
$string['privacy:metadata:log:cmid'] = 'cmid';
$string['privacy:metadata:log:course'] = 'cursus';
$string['privacy:metadata:log:info'] = 'Extra informatie';
$string['privacy:metadata:log:ip'] = 'Het IP-adres dat werd gebruikt op het moment van de gebeurtenis';
$string['privacy:metadata:log:module'] = 'module';
$string['privacy:metadata:log:time'] = 'Het tijdstip waarop de actie plaatsvond';
$string['privacy:metadata:log:url'] = 'De URL met betrekking tot de geberutenis';
$string['privacy:metadata:log:userid'] = 'De ID van de gebruiker die de actie heeft uitgevoerd';
$string['privacy:metadata:oauth2_refresh_token'] = 'Ververs token, gebruikt in OAuth 2.0-communicatie';
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'De ID van de uitgever waarmee het token overeenkomt';
$string['privacy:metadata:oauth2_refresh_token:scopehash'] = 'De ID van de gebruiker waarmee het token overeenkomt';
$string['privacy:metadata:oauth2_refresh_token:timecreated'] = 'Het tijdstip waarop het token gemaakt werd';
$string['privacy:metadata:oauth2_refresh_token:timemodified'] = 'Het tijdstip waarop het token laatst aangepast werd';
$string['privacy:metadata:oauth2_refresh_token:token'] = 'Het token verversen voor de opgegeven scope en gebruiker';
$string['privacy:metadata:oauth2_refresh_token:userid'] = 'De ID van de gebruiker waarmee het token overeenkomt';
$string['privacy:metadata:task_adhoc'] = 'De status van niet geplande taken.';
$string['privacy:metadata:task_adhoc:component'] = 'De component die eigenaar is van de taak.';
$string['privacy:metadata:task_adhoc:nextruntime'] = 'De vroegste tijd om deze taak uit te voeren.';
$string['privacy:metadata:task_adhoc:userid'] = 'De gebruiker die deze taak uitvoert.';
$string['privacy:metadata:task_log'] = 'Log output voor een logbestand';
$string['privacy:metadata:task_log:component'] = 'De component die eigenaar is van de taak.';
$string['privacy:metadata:task_log:userid'] = 'De gebruiker aan wie de taak toebehoorde.';
$string['privacy:metadata:upgrade_log'] = 'Het upgradelogboek.';
$string['privacy:metadata:upgrade_log:backtrace'] = 'Alle backtrace geassocieerd met deze upgrade-stap.';
$string['privacy:metadata:upgrade_log:details'] = 'Extra informatie met betrekking tot de upgrade.';
$string['privacy:metadata:upgrade_log:info'] = 'De belangrijkste informatie voor deze upgrade-stap.';
$string['privacy:metadata:upgrade_log:plugin'] = 'De plug-in die is geüpgraded.';
$string['privacy:metadata:upgrade_log:targetversion'] = 'De nieuwe versie om naar te upgraden.';
$string['privacy:metadata:upgrade_log:timemodified'] = 'Het tijdstip waarop de upgrade plaatsvond.';
$string['privacy:metadata:upgrade_log:type'] = 'Het type logboekinvoer.';
$string['privacy:metadata:upgrade_log:userid'] = 'De gebruiker die de upgrade uitvoerde.';
$string['privacy:metadata:upgrade_log:version'] = 'De oude versie van de plug-in.';
$string['private_files_handler'] = 'Bewaar bijlages van een e-mail bij de privébestanden van de gebruiker';
$string['private_files_handler_name'] = 'E-mail naar privébestanden';
$string['privatefiles'] = 'Privébestanden';
$string['privatefilesmanage'] = 'Beheer privébestanden';
$string['proceed'] = 'Doorgaan';
...
$string['questionsinthequestionbank'] = 'Vragen in de vragenpool';
$string['queued'] = 'In de wachtrij';
$string['quotausage'] = 'Je hebt {$a->used} gebruikt van je totale limiet van {$a->total}.';
...
$string['registrationcontactno'] = 'Nee, ik wil niet gecontacteerd worden door anderen';
...
$string['registrationyes'] = 'Ja, laat me iets weten wanneer er nieuwe Moodle releases zijn, beveiligingsupdates of ander belangrijk nieuws.';
$string['reject'] = 'Verwerp';
$string['rejectdots'] = 'Verwerp...';
$string['relativedatesmode'] = 'Relatieve datums modus';
$string['relativedatesmode_help'] = 'Geef cursus- of activiteitsdatums weer met betrekking tot de startdatum van de gebruiker in de cursus.

De startdatum van de cursus van de gebruiker is de startdatum van zijn inschrijving, tenzij ze zijn ingeschreven voordat de cursus begint, in welk geval hun startdatum de start van de cursus is datum.

WAARSCHUWING: dit is een experimentele functie die mogelijk niet door alle activiteiten wordt ondersteund. Nadat de cursus is gemaakt, kan deze cursusinstelling niet meer worden gewijzigd.';
$string['relativedatesmode_warning'] = '<strong> Waarschuwing: </strong> de modus Relatieve datums kan niet worden gewijzigd nadat de cursus is gemaakt.';
...
$string['resortsubcategoriesbyreverse'] = 'Sorteer subcategorieën aflopend op {$a}';
$string['resource'] = 'Bron';
$string['resourcedisplayauto'] = 'Automatisch';
$string['resourcedisplaydownload'] = 'Download verplicht';
$string['resourcedisplayembed'] = 'Ingebed In browser';
...
$string['restoredaccountinfo'] = 'Dit account is geïmporteerd uit een andere server en het wachtwoord ervan is verloren gegaan. Om een nieuw wachtwoord via e-mail in te stellen, klik op "Ga verder"';
...
$string['resultsfound'] = '{$a} resultaten gevonden';
$string['retry'] = 'Opnieuw proberen';
...
$string['savechangesandreturn'] = 'Bewaar en keer terug';
...
$string['searchactivities'] = 'Zoek naar activiteiten op naam of beschrijving';
...
$string['sectionactionnotsupported'] = 'Sectie-actie "{$a}" is hier niet ondersteund';
...
$string['showchartdata'] = 'Toon gegevens van grafiek';
...
$string['showgrades_help'] = 'Voor veel activiteiten in de cursus is het mogelijk om cijfers te geven. Deze instelling bepaalt of een leerling een lijst met al zijn cijfers voor deze cursus kan zien.';
...
$string['showoncoursepage'] = 'Toon op cursuspagina';
...
$string['sitedefaultspecified'] = 'Site standaard ({$a})';
...
$string['sitenews'] = 'Site-mededelingen';
...
$string['statsreport14'] = 'Cursus met hoogste deelname (pagina\'s/berichten)';
...
$string['switchdevicerecommended'] = 'Schakel over naar het aangewezen thema voor jouw toestel';
$string['switchrolereturn'] = 'Terug naar mijn rol';
$string['switchroleto'] = 'Wijzig rol naar ...';
$string['switchroleto_help'] = 'Kies een rol om een beeld te krijgen van wat iemand met deze rol in deze cursus ziet.

Let op: dit beeld kan afwijken. (<a href="https://docs.moodle.org/en/Switch_roles">Zie details en alternatieven</a>).';
$string['tag'] = 'Tag';
...
Als \'platte tekst zone\' wordt geselecteerd, dan kan je opmaak zoals HTML of Markdown kiezen.

De lijst met beschikbare tekstverwerkers wordt door de sitebeheerder bepaald.';
...
$string['timesplitting:decilesaccum'] = 'Alle vorige tienden';
$string['timesplitting:decilesaccum_help'] = 'Dit analyse-interval verdeelt de cursus in tienden (10 gelijke delen); met elk een voorspelling, gebaseerd op de gegevens in alle vorige tienden.';
$string['timesplitting:nosplitting'] = 'Geen tijdslimieten';
$string['timesplitting:nosplitting_help'] = 'Er is geen analyse-interval gedefinieerd voor dit model.';
$string['timesplitting:onemonthafterstart'] = 'Een maand na start';
$string['timesplitting:onemonthafterstart_help'] = 'Dit analyse-interval genereert een voorspelling 1 maand na de analyseerbare start.';
$string['timesplitting:oneweekafterstart'] = 'Een week na start';
$string['timesplitting:oneweekafterstart_help'] = 'Dit analyse-interval genereert een voorspelling 1 week na de analyseerbare start.';
$string['timesplitting:past3days'] = 'Afgelopen 3 dagen';
$string['timesplitting:past3days_help'] = 'Dit analyse-interval genereert om de 3 dagen voorspellingen. De indicatorenberekeningen zijn gebaseerd op de afgelopen 3 dagen.';
$string['timesplitting:pastmonth'] = 'Afgelopen maand';
$string['timesplitting:pastmonth_help'] = 'Dit analyse-interval genereert elke maand voorspellingen. De indicatorenberekeningen zijn gebaseerd op de afgelopen maand.';
$string['timesplitting:pastweek'] = 'Vorige week';
$string['timesplitting:pastweek_help'] = 'Dit analyse-interval genereert elke week voorspellingen. De indicatorenberekeningen zijn gebaseerd op de afgelopen week.';
$string['timesplitting:quarters'] = 'Vorig kwartaal';
$string['timesplitting:quarters_help'] = 'Dit analyse-interval verdeelt de koers in kwartalen (4 gelijke delen), waarbij elke voorspelling is gebaseerd op de gegevens van alleen het meest recente voorgaande kwartaal.';
$string['timesplitting:quartersaccum'] = 'Alle voorgaande kwartalen';
$string['timesplitting:quartersaccum_help'] = 'Dit analyse-interval verdeelt de koers in kwartalen (4 gelijke delen), waarbij elke voorspelling gebaseerd is op de verzamelde gegevens van alle voorgaande kwartalen.';
$string['timesplitting:singlerange'] = 'Van begin tot einde';
$string['timesplitting:singlerange_help'] = 'Dit analyse-interval beschouwt de hele cursus als één enkele reeks.';
$string['timesplitting:tenpercentafterstart'] = '10% na start';
$string['timesplitting:tenpercentafterstart_help'] = 'Dit analyse-interval genereert een voorspelling nadat de 10% van de cursus is voltooid.';
$string['timesplitting:upcoming3days'] = 'Komende 3 dagen';
$string['timesplitting:upcoming3days_help'] = 'Dit analyse-interval genereert voorspellingen om de 3 dagen. De indicatorenberekeningen zullen gebaseerd zijn op de komende 3 dagen.';
$string['timesplitting:upcomingfortnight'] = 'Komende veertien dagen';
$string['timesplitting:upcomingfortnight_help'] = 'Dit analyse-interval genereert voorspellingen om de veertien dagen. De indicatorenberekeningen zullen gebaseerd zijn op de komende veertien dagen.';
$string['timesplitting:upcomingweek'] = 'Aankomende  week';
$string['timesplitting:upcomingweek_help'] = 'Dit analyse-interval genereert elke week voorspellingen. De indicatorenberekeningen zullen gebaseerd zijn op de komende week.';
$string['timezone'] = 'Tijdzone';
$string['to'] = 'Tot';
$string['tocontent'] = 'Voor "{$a}"';
...
$string['toggleemojipicker'] = 'Schakel emoji-kiezer in';
$string['togglesearch'] = 'Schakel zoek invoer';
$string['toomanybounces'] = 'Dat e-mailadres heeft te veel e-mails teruggestuurd. Je <b>moet</b> het wijzigen voor je verder kunt.';
$string['toomanytags'] = 'Deze zoekopdracht bevatte teveel tags; sommige ervan zijn genegeerd.';
...
$string['userpreferences'] = 'Gebruikervoorkeuren';
...
$string['validatehtml'] = 'HTML valideren';
...
$string['wcagcheck'] = 'Controle op toegankelijkheidsrichtlijnen voor webinhoud (WCAG)';
...
$string['wheredoyoulive'] = 'In welk land woon jij?';
$string['whyisthisrequired'] = 'Waarom is dit vereist?';
...
$string['wordforstudenteg'] = 'bijv. leerling, deelnemer, cursist, etc.';
$string['wordforstudents'] = 'Jouw woord voor leerlingen';
$string['wordforstudentseg'] = 'bijv. leerlingen, deelnemers, cursisten, etc.';
...
$string['youhaveupcomingactivitiesdue'] = 'Je hebt activiteiten die ingediend moeten worden';
$string['youhaveupcomingactivitiesdueinfo'] = 'Hallo {$a},

<br/><br/> Je hebt nog taken die voltooid moet worden:';
