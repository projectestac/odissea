...
/**
 * Strings for component 'qtype_truefalse', language 'nl', branch 'MOODLE_38_STABLE'
 *
...
$string['correctanswerfalse'] = 'Het juiste antwoord is "Niet waar".';
$string['correctanswertrue'] = 'Het juiste antwoord is "Waar".';
$string['false'] = 'Niet waar';
$string['feedbackfalse'] = 'Feedback voor het antwoord "Niet waar"';
$string['feedbacktrue'] = 'Feedback voor het antwoord "Waar"';
