...
$string['activitynavigation'] = 'Activiteitsnavigatie';
$string['activitynavigation:jumptoactivity'] = 'Ga naar activiteit';
$string['activitynavigation:nexta'] = 'Volgende activiteit: {$a}';
$string['activitynavigation:preva'] = 'Vorige activiteit: {$a}';
