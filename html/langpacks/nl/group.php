...
$string['addedby'] = 'Toegevoegd door {$a}';
$string['addgroup'] = 'Gebruiker toevoegen aan groep';
$string['addgroupstogrouping'] = 'Voeg groep aan groepering toe.';
...
$string['errorremovenotpermitted'] = 'Je hebt het recht niet om het automatisch toegevoegde groepslid {$a} te verwijderen';
...
$string['groupingsection'] = 'Grouping toegang';
$string['groupingsection_help'] = 'Een groepering is een verzameling groepen binnen een cursus. Als hier een groepering gekozen wordt, dan zullen enkel leerlingen die deel uitmaken van groepen in die groepering toegang hebben tot de sectie.';
