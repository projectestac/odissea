...
/**
 * Strings for component 'filters', language 'nl', version '3.11'.
 *
 * @package     filters
 * @category    string
...
$string['nofiltersenabled'] = 'Er zijn geen filters ingeschakeld voor deze site';
$string['off'] = 'Uit';
$string['offbutavailable'] = 'Uit, maar beschikbaar';
$string['on'] = 'Aan';
$string['privacy:reason'] = 'Het filter subsysteem bewaart geen persoonlijke gegevens.';
...
$string['replacefilters'] = 'Vervang filters';
