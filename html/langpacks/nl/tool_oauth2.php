...
$string['issuersmtpsystememail_help'] = 'Indien opgegeven, wordt dit e-mailadres gebruikt om een systeemaccount te koppelen voor het verzenden van e-mail via SMTP. Dit is vereist voor sommige OAuth 2-diensten (bijvoorbeeld Microsoft). Raadpleeg de documentatie van uw OAuth 2-dienst om te controleren of dit vereist is.';
...
$string['issueruseinsmtpwithoauth'] = 'SMTP enkel met XOAUTH2';
