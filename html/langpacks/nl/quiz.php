...
$string['gradeitemmarkscheme'] = 'Wijs cijferitems toe';
$string['gradeitemnewname'] = 'Nieuwe naam voor cijferitem {$a}';
$string['gradeitemnoneselected'] = '[geen]';
$string['gradeitemnoslots'] = 'Deze test heeft nog geen vragen. Voeg eerst vragen toe, kom dan hier terug om cijferitems in te stellen.';
$string['gradeitems'] = 'Beoordelingsitems';
$string['gradeitemsautosetup'] = 'Cijfer geven voor elke sectie';
$string['gradeitemsetup'] = 'Cijferitems instellen';
$string['gradeitemsnoneyet'] = 'Maak cijferitems in je test. Wijs vragen of testsecties toe aan cijferitems om het resultaat op te splitsen in verschillende zones.';
$string['gradeitemsremoveall'] = 'Instellingen opnieuw instellen';
$string['gradeitemsremoveallconfirm'] = 'Instellingen cijferitems opnieuw instellen?';
$string['gradeitemsremoveallmessage'] = 'Dit zal alle cijferitems verwijderen en de toewijzing van vragen en secties verwijderen.<br><br>Deze actie heeft geen invloed op de vragen en de secties en ook niet op bestaande pogingen in de test.';
$string['gradeitemsremovealltitle'] = 'Instellingen cijferitems opnieuw instellen';
