...
$string['ariaeventlistpaginationnavcourses'] = 'Tijdlijn activiteiten voor de paginering van {$a}';
$string['ariaeventlistpaginationnavdates'] = 'Tijdlijn activiteiten paginering';
...
$string['next7days'] = 'Volgende 7 dagen';
$string['nocoursesinprogress'] = 'Geen lopende cursussen';
$string['noevents'] = 'Er zijn geen verwachte activiteiten';
$string['overdue'] = 'Achterstallig';
$string['pluginname'] = 'Tijdlijn';
...
$string['timeline:myaddinstance'] = 'Voeg een nieuw tijdlijn blok toe aan "Mijn "startpagina"';
