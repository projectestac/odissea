...
/**
 * Strings for component 'choice', language 'nl', version '4.5'.
 *
 * @package     choice
 * @category    string
...
$string['privacy:metadata:choice_answers:choiceid'] = 'De ID van de keuzeactiviteit';
...
$string['removeresponses'] = 'Alle antwoorden';
