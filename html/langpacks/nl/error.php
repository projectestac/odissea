...
$string['cannotdisableformat'] = 'Je kunt het standaardformaat niet uitschakelen';
...
$string['cannotopenzip'] = 'kan zip-bestand niet openen - waarschijnlijk zipextentie-bug op 64-bit OS';
...
$string['cannotservefile'] = 'Kan bestand niet tonen door een server configuratieprobleem.';
...
$string['cannotviewcategory'] = 'Je bent niet gemachtigd om cursussen hier te bekijken';
...
$string['contenttypenotfound'] = 'Het inhoudsbank type \'{$a}\' bestaat niet of wordt niet herkend.';
$string['contentvisibilitynotfound'] = 'De zichtbaarheid van de inhoud met waarde \'{$a}\' bestaat niet of wordt niet herkend.';
...
$string['csvfileerror'] = 'Er is iets mis met de indeling van het CSV-bestand. Controleer of het aantal koppen en kolommen overeenkomt en of het scheidingsteken en de bestandscodering correct zijn. {$a}';
...
$string['csvnodata'] = 'Ongeldig CSV-bestand - Het CSV-bestand heeft kopteksten maar bevat geen gegevens.';
...
$string['detectedbrokenplugin'] = 'Plugin {$a} werkt niet of is verouderd. Je kunt niet verder gaan.';
$string['dmlexceptiononinstall'] = '<p>Databankfout [{$a->errorcode}].<br />{$a->debuginfo}</p>';
$string['dmlparseexception'] = 'Fout bij het verwerken van de SQL-query';
...
$string['downgradedcore'] = 'Fout: de code die je gebruikt is ouder dan de versie van deze databank!';
...
$string['encryption_keyalreadyexists'] = 'Sleutel bestaat al';
$string['encryption_nokey'] = 'Sleutel niet gevonden';
$string['encryption_wrongmethod'] = 'De gegevens komen niet overeen met een ondersteunde versleutelingsmethode';
...
$string['invalidcommentid'] = 'Ongeldige commentaar-ID';
$string['invalidcommentitemid'] = 'Ongeldig commentaar item-ID';
...
$string['invalidgroupid'] = 'Foute groe- ID opgegeven.';
...
$string['invalidnumkey'] = 'De $conditions array mag geen numerieke sleutels bevatten. Verbeter de code!';
...
$string['invaliduserid'] = 'Ongeldig gebruikers-ID';
...
$string['listcantmoveup'] = 'Kon het item niet naar boven verplaatsen want het is het eerste item van dit niveau.';
...
$string['oauth2refreshtokenerror'] = 'Kon OAuth 2 token niet vernieuwen. HTTP-status voor extern eindpunt: {$a}';
$string['oauth2refreshtokentaskerror'] = 'Kon OAuth 2 token niet vernieuwen voor één of meerdere gebruikers. Bekijk de output van de taak voor meer details.';
$string['oauth2upgradetokenerror'] = 'Kon OAuth 2 token niet upgraden. HTTP-status voor extern eindpunt: {$a}';
...
$string['reverseproxyabused'] = 'Reverse proxy ingeschakeld. Er is geen rechtstreekse toegang tot de server mogelijlk. <br />Contacteer de systeembeheerder.';
...
$string['sessionexpired'] = 'Sessie verlopen';
...
$string['unknownjsinrequirejs'] = 'Kan JavaScript-bibliotheek niet vinden: {$a}.';
...
$string['userisfilteredout'] = 'Deze gebruiker komt niet overeen met de filters en tabelvoorkeuren!';
