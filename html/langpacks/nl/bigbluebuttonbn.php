...
$string['completionattendance_desc'] = 'Ga de ruimte binnen en blijf ten minste {$a} minuut(en).';
...
$string['completionengagement_desc'] = 'Doe mee tijdens de sessie';
$string['completionengagementchats'] = 'Chats';
$string['completionengagementchats_desc'] = 'Neem deel aan {$a} chat(s).';
