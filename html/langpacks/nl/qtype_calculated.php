...
/**
 * Strings for component 'qtype_calculated', language 'nl', version '4.4'.
 *
...
$string['datasetrole'] = 'De jokerwaarden <strong>{x...}</strong> zullen vervangen worden door een numerieke waarde van hun dataset';
