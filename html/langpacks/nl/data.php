...
$string['missingfieldtypes'] = 'Voor de volgende velden zijn de bijbehorende veldtypen niet geïnstalleerd en worden ze niet opgenomen in de formulieren bij het toevoegen of bewerken van items.
 Hun labels kunnen nog steeds op het formulier worden weergegeven, dus werk de "Invoersjabloon toevoegen" dienovereenkomstig bij:';
