...
/**
 * Strings for component 'tiny_media', language 'nl', version '4.5'.
 *
 * @package     tiny_media
 * @category    string
...
$string['mediamanagerbuttontitle'] = 'Mediabeheer';
$string['mediamanagerproperties'] = 'Mediabeheer';
$string['metadata'] = 'Metadata';
$string['metadata_help'] = 'Metadatatracks, voor gebruik vanuit een script, mogen alleen worden gebruikt als de speler metadata ondersteunt.';
...
$string['subtitlessourcelabel'] = 'Ondertiteltrack-URL';
$string['tracks'] = 'Ondertiteling en onderschriften';
$string['tracks_help'] = 'Ondertitels, bijschriften, hoofdstukken en beschrijvingen kunnen worden toegevoegd via een bestand in WebVTT-indeling (Web Video Text Tracks). Tracklabels worden weergegeven in het keuzemenu. Voor elk type track wordt elke track die als standaard is ingesteld, vooraf geselecteerd aan het begin van de video.';
$string['unusedfilesdesc'] = 'De volgende ingesloten bestanden worden niet gebruikt in het tekstgebied:';
