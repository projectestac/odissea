...
/**
 * Strings for component 'availability_group', language 'nl', branch 'MOODLE_38_STABLE'
 *
...
$string['anygroup'] = '(Gelijk welke groep)';
$string['description'] = 'Laat enkel leerlingen toe die tot een bepaalde groep behoren of alle groepen';
...
$string['requires_notgroup'] = 'Je behoort niet tot  <strong>{$a}</strong>';
$string['title'] = 'Groep';
