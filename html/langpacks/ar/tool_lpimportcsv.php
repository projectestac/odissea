...
/**
 * Strings for component 'tool_lpimportcsv', language 'ar', version '4.5'.
 *
...
$string['ruleoutcome'] = 'عوائد القاعدة (اختياري)';
$string['ruletype'] = 'نوع القاعدة (اختياري)';
$string['scaleconfiguration'] = 'تكوين النطاق';
$string['scalevalues'] = 'مقياس القيم';
$string['shortname'] = 'اسم قصير';
$string['taxonomy'] = 'التصنيف';
