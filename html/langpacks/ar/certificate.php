...
/**
 * Strings for component 'certificate', language 'ar', version '4.1'.
 *
 * @package     certificate
 * @category    string
...
$string['printgrade_help'] = 'يمكنك اختيار أي مفردة تقييم متاحة في المساق من سجل التقديرات لطباعة درجة المستخدم التي تلقاها من تلك المفردة في الشهادة. يتم عرض مفردات التقييم بالترتيب الذي تظهر به في سجل التقديرات. إختر تنسيق الدرجة أدناه.';
