...
/**
 * Strings for component 'certificate', language 'ar', version '4.5'.
 *
 * @package     certificate
 * @category    string
...
إرسال الشهادة عبر البريد الالكتروني: يؤدي تحديد هذا الخيار إلى إرسال الشهادة إلى الطالب كمرفق بريد الكتروني.
...
$string['printsignature_help'] = 'هذا الخيار يسمح لك بطباعة صورة توقيع من مجلد certificate/pix/signatures. بإمكانك طباعة تمثيل صوري للتوقيع، أو طباعة خط لوضع التوقيع الفعلي عليه. إفتراضيًا، هذه الصورة توضع في الزاوية اليسرى السفلى من الشهادة.';
...
$string['reportcert_help'] = 'إذا اخترت نعم هنا، فسيتم إظهار تاريخ التلقي، الرمز، واسم المقرر الخاصين بهذه الشهادة في تقارير شهادة المستخدم. إذا اخترت طباعة العلامة في هذه الشهادة، فستظهر تلك الدرجة أيضًا في تقريرها.';
