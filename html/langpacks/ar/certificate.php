...
$string['printdate_help'] = 'هذا هو التاريخ الذي ستتم طباعته، لو تم تحديد تاريخ الطباعة. إذا تم اختيار تاريخ إكمال المساق لكن الطالب لم يكمله بعد، ستتم طباعة تاريخ تلقي الشهادة. يمكنك أيضًا اختيار طباعة التاريخ بناءً على موعد منح العلامة للنشاط. إذا تم منح الشهادة قبل تقييم النشاط، ستتم طباعة تاريخ تلقيها.';
$string['printgrade_help'] = 'يمكنك اختيار أي مفردة تقييم متاحة في المساق من سجل التقديرات لطباعة علامة المستخدم التي تلقاها من تلك المفردة في الشهادة. يتم عرض مفردات التقييم بالترتيب الذي تظهر به في سجل التقديرات. إختر تنسيق العلامة أدناه.';
