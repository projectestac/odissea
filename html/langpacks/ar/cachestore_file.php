...
/**
 * Strings for component 'cachestore_file', language 'ar', version '4.5'.
 *
...
$string['autocreate_help'] = 'عند تمكينه، فالمجلد المحدد في المسار يتم إنشاؤه تلقائيًا إن لم يكن موجودًا بالفعل.';
...
$string['prescan_help'] = 'عند تمكينه، يتم تفحص المجلد عند استعمال الخبء لأول مرة ويتم فحص طلبات الحصول على الملفات لأول مرة إزاء البيانات المفحوصة. هذا يمكن أن يساعد إذا كان لديك نظام ملفات بطيء وعندما تكتشف بأن عمليات الملفات هي سبب الاختناق في الأداء.';
