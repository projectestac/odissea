...
$string['configrtmp'] = 'عند تمكينه، فإن الروابط التي تبدأ بـ rtmp:// ستتم معاملتها من قبل الملحق بغض النظر عما إذا كان الامتداد مُمَكَّناً في إعداد امتدادات ملفات الفيديو (videoextensions). الرجوع إلى الفلاش ينبغي تمكينه ليعمل RTMP.';
