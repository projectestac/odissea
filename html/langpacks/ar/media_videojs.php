...
/**
 * Strings for component 'media_videojs', language 'ar', version '4.1'.
 *
...
$string['configaudioextensions'] = 'قائمة مفصولة بفوارز لامتدادات ملفات الصوت المدعومة. سيحاول VideoJS استعمال مشغل الفيديو المحلي في المستعرض عند توافره أو الوظيفة العادية لـ VideoJS.';
...
$string['configvideoextensions'] = 'قائمة مفصولة بفوارز لامتدادات ملفات الفيديو المدعومة. سيحاول VideoJS استعمال مشغل الفيديو المحلي في المستعرض عند توافره أو الوظيفة العادية لـ VideoJS.';
...
$string['pluginname_help'] = 'غلاف JavaScript لملفات الفيديو المشغلة من قبل مشغل الفيديو المحلي في المستعرض. (دعم الصيغ يعتمد على المستعرض).';
