...
/**
 * Strings for component 'auth_pam', language 'ar', version '4.4'.
 *
 * @package     auth_pam
 * @category    string
...
$string['privacy:metadata'] = 'إن إضافة PAM (Pluggable Authentication Modules وحدات المصادقة القابلة للتوصيل) لا تخزن أي بيانات شخصية.';
