...
$string['cannotcreatepagebreak'] = 'فواصل الصفحات لا يمكن إضافتها عند البداية، ويمكن إضافة فاصل صفحات واحد فقط عند النهاية.';
...
$string['completionsubmit'] = 'تسليم الإفادة';
...
$string['label'] = 'النص ومنطقة الوسائط';
...
$string['multiplesubmit_help'] = 'إذا تم ضبطه على نعم:

* بالنسبة للاستطلاعات غير المشخصنة: يمكن للمستخدمين تقديم عدد غير محدود من الإجابات، وسيتم تسجيل كل الإجابات.
* بالنسبة للاستطلاعات المشخصنة: يمكن للمستخدمين تقديم عدد غير محدود من الإجابات، ولكن إجاباتهم الأخيرة فقط سيتم تسجيلها.';
$string['name'] = 'اسم';
...
$string['url_for_continue_help'] = 'بعد تقديم الإفادة، سيتم عرض زر الاستمرار، والذي يذهب إلى صفحة المقرر. كبديل عن ذلك، قد يرتبط بالنشاط الآتي إذا تم وضع رابطه هنا.';
