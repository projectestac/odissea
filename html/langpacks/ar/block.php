...
$string['createdat_help'] = 'الموقع الأصلي الذي تم إنشاء الكتل فيه. إعدادات الكتل قد يجعلها تظهر في مواضع أخرى (سياقات) ضمن الموضع الأصلي. كمثال، الكتلة المنشأة في صفحة المقرر الدراسي يمكن عرضها في الأنشطة ضمن ذلك المقرر. الكتلة المنشأة في الصفحة الأمامية يمكن عرضها في كل أنحاء الموقع.';
