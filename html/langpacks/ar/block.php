...
/**
 * Strings for component 'block', language 'ar', version '3.11'.
 *
 * @package     block
 * @category    string
...
$string['contexts_help'] = 'السياقات هي صفحات من نوع أكثر تحديداً حيث يمكن عرض هذه الكتلة ضمن موقعها الأصلي. سيكون لديك عدة خيارات هنا اعتماداً على موقع الكتلة الأصلي وموقعك الحالي. كمثال على ذلك، يمكنك تقييد ظهور الكتلة ليقتصر على المنتدى فقط في المقرر الدراسي عبر إضافة الكتلة للمقرر (مما يسمح لها بالظهور في كل الصفحات الفرعية)، ثم الذهاب إلى المنتدى وتحرر إعدادات الكتلة مرة أخرى لتقييد عرضها مع صفحات المنتدى.';
$string['createdat'] = 'الموضع الأصلي للكتلة';
$string['createdat_help'] = 'الموضع الأصلي الذي تم إنشاء الكتل فيه. إعدادات الكتل قد يجعلها تظهر في مواضع أخرى (سياقات) ضمن الموضع الأصلي. كمثال، الكتلة المنشأة في صفحة المقرر الدراسي يمكن عرضها في الأنشطة ضمن ذلك المقرر. الكتلة المنشأة في صفحة الواجهة يمكن عرضها في كل أنحاء الموقع.';
...
$string['showonfrontpageandsubs'] = 'العرض في صفحة الواجهة وأي صفحات مضافة إليها';
$string['showonfrontpageonly'] = 'العرض في صفحة الواجهة فقط';
