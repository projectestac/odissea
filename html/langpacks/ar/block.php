...
/**
 * Strings for component 'block', language 'ar', version '4.1'.
 *
 * @package     block
 * @category    string
...
$string['createdat_help'] = 'الموضع الأصلي الذي تم إنشاء الكتل فيه. إعدادات الكتل قد يجعلها تظهر في مواضع أخرى (سياقات) ضمن الموضع الأصلي. كمثال، الكتلة المنشأة في صفحة المساق يمكن عرضها في الأنشطة ضمن ذلك المساق. الكتلة المنشأة في صفحة الواجهة يمكن عرضها في كل أنحاء الموقع.';
