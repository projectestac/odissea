...
/**
 * Strings for component 'search_solr', language 'ar', version '3.11'.
 *
 * @package     search_solr
 * @category    string
...
$string['privacy:metadata'] = 'إن هذا الملحق يرسل البيانات إلى محرك بحث Solr مرتبط. هو لا يخزن البيانات محلياً';
