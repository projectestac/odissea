...
$string['installfromzip_help'] = 'رفع ملف ZIP من الملحق بديلاً عن تنصيبه مباشرةً من مجلد ملاحق مودل. ينبغي أن يكون لحزمة ZIP نفس بنية الحزمة التي تم تنزيلها من مجلد ملاحق مودل.';
...
$string['remoterequestinvalid'] = 'هناك طلب لتنصيب ملحق في هذا الموقع من دليل ملاحق مودل. للأسف، الطلب غير صالح وبالتالي لا يمكن تنصيب الملحق.';
$string['remoterequestnoninstallable'] = 'هناك طلب لتنصيب الملحق {$a->name} ({$a->component}) ذي الإصدار {$a->version} من دليل ملاحق مودل في هذا الموقع. ومع ذلك، فشل الاختبار الأولي لتنصيب الملحق (رمز السبب: {$a->reason}).';
$string['remoterequestpermcheck'] = 'هناك طلب لتنصيب الملحق {$a->name} ({$a->component}) ذي الإصدار {$a->version} من دليل ملاحق مودل في هذا الموقع. ومع ذلك، فإن الموضع <strong>{$a->typepath}</strong> هو <strong>غير قابل للكتابة</strong>. تحتاج إلى منح حق الكتابة لمستخدم مخدم الويب إلى ذلك الموضع، ثم الضغط على زر "استمر" لإعادة التحقق.';
