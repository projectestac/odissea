...
$string['installfromrepo_help'] = 'ستتم إعادة توجيهك إلى مجلد إضافات مودل للبحث عن وتنصيب الملحق. لاحظ أنه سيتم إرسال الاسم الكامل لموقعك ورابطه  وإصدار مودل، لتسهيل عملية التنصيب بالنسبة لك.';
$string['installfromzip'] = 'تنصيب الملحق من ملف مضغوط';
$string['installfromzip_help'] = 'يعد تثبيت حزمة ZIP للملحق بديلاً عن تنصيبه مباشرةً من مجلد إضافات مودل. ينبغي أن يكون لحزمة ZIP نفس بنية الحزمة التي تم تنزيلها من مجلد إضافات مودل.';
...
$string['remoterequestinvalid'] = 'هناك طلب لتنصيب ملحق في هذا الموقع من دليل إضافات مودل. للأسف، الطلب غير صالح وبالتالي لا يمكن تثبيت الإضافة.';
$string['remoterequestnoninstallable'] = 'هناك طلب لتثبيت الإضافة {$a->name} ({$a->component}) ذي الإصدار {$a->version} من دليل إضافات مودل في هذا الموقع. ومع ذلك، فشل الاختبار الأولي لتنصيب الإضافة (رمز السبب: {$a->reason}).';
$string['remoterequestpermcheck'] = 'هناك طلب لتثبيت الإضافة {$a->name} ({$a->component}) ذي الإصدار {$a->version} من دليل إضافات مودل في هذا الموقع. ومع ذلك، فإن الموضع <strong>{$a->typepath}</strong> هو <strong>غير قابل للكتابة</strong>. تحتاج إلى منح حق الكتابة لمستخدم مخدم الويب إلى ذلك الموضع، ثم الضغط على زر "استمر" لإعادة التحقق.';
