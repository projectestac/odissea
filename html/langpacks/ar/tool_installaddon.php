...
$string['installfromzipfile_help'] = 'يجب أن تحتوي الحزمة المضغوطة للملحق على مجلد واحد فقط، مسمى بما يطابق اسم الملحق. سيتم استخراج الملف المضغوط  في الموضع المناسب لنوع الملحق. إذا ما تم تنزيل الحزمة من مجلد ملاحق مودل، فستتوفر فيها هذه البنية.';
...
$string['remoterequestnoninstallable'] = 'هناك طلب لتثبيت الملحق {$a->name} ({$a->component}) ذي الإصدار {$a->version} من دليل ملاحق مودل في هذا الموقع. ومع ذلك، فشل الاختبار الأولي لتنصيب الملحق (رمز السبب: {$a->reason}).';
