...
/**
 * Strings for component 'block_advnotifications', language 'ar', version '3.11'.
 *
...
$string['setting/html_desc'] = 'يقوم بالتبديل فيما إذا كان يسمح بنصوص HTML الأولية في عناوين الإشعارات ورسائلها';
$string['setting/multilang'] = 'دعم منقحات تعدد اللغات:';
$string['setting/multilang_desc'] = 'يقوم بالتبديل فيما إذا كان يتم دعم منقح متعدد اللغات (وغيره) في عناوين الإشعارات ورسائلها.
<br>ملاحظة - هذا للمستخدمين الأكثر تقدمًا وينبغي معه تمكين HTML (أعلاه).<hr>';
