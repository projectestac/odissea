...
/**
 * Strings for component 'qformat_webct', language 'ar', version '4.5'.
 *
...
$string['errorsdetected'] = 'تم الكشف عن {$a} خطأ/أخطاء';
$string['missinganswer'] = 'عدد قليل من عبارات :ANSWER، :Lx، :Rx لسطر السؤال {$a}. عليك تعريف إجابتين اثنتين على الأقل.';
...
$string['warningsdetected'] = 'تم الكشف عن {$a} تحذير/تحذيرات';
$string['wronggrade'] = 'درجة خاطئة (بعد السطر {$a}):';
