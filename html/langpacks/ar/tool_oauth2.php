...
$string['acceptrisk_help'] = 'تعطيل التحقق من البريد الالكتروني يمكن أن يكون له مخاطر أمنية نظرًا لأنه ينطوي على احتمالية قيام بعض المستخدمين بانتحال شخصيات الآخرين عندما تؤتى لهم الفرصة.';
