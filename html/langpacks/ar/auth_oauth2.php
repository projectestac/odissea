...
لقد طُلب إنشاء حساب جديد في \'{$a->sitename}\' باستعمال بريدك الالكتروني.

لتأكيد حسابك الجديد، لطفاً، أنقر على الرابط الآتي:

<a href="{$a->link}">تأكيد حسابك</a>
...
لتأكيد هذا الطلب وربط هذين الحسابين، لطفاً، أنقر الرابط أدناه:

<a href="{$a->link}">ربط الحسابين</a>
