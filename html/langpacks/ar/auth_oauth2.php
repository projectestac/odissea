...
/**
 * Strings for component 'auth_oauth2', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_oauth2
...
$string['notenabled'] = 'عذراً، إن ملحق مصادقة OAuth 2 غير مُمَكَّن';
...
$string['plugindescription'] = 'يعرض ملحق المصادقة هذا قائمة بمزودي الهوية المتاحين في صفحة الدخول. عند اختيار أحد مزودي الهوية هؤلاء سيكون بإمكان المستخدمين تسجيل الدخول مستعملين معطيات حساباتهم من مزود OAuth 2.';
