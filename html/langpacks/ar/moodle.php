...
/**
 * Strings for component 'moodle', language 'ar', version '4.1'.
 *
 * @package     moodle
 * @category    string
...
$string['activityheader'] = 'قائمة النشاط';
$string['activityicon'] = 'أيقونة {$a}';
...
$string['activitynotready'] = 'النشاط غير جاهز بعد';
...
$string['additionalcustomnav'] = 'التنقل الإضافي المخصص';
...
$string['addnewcourse'] = 'إضافة مقرر جديد';
...
$string['adminhelpassigncreators'] = 'يمكن لمنشئي المقررات إنشاء مقررات أكاديمية جديدة';
$string['adminhelpassignsiteroles'] = 'أعط أدوار الموقع المُعرّفة لمستخدمين مخصصين';
$string['adminhelpassignstudents'] = 'اذهب إلى مقرر واضف الطلاب من خلال قائمة المشرف';
...
$string['adminhelpcourses'] = 'عرِّف المقررات والفئات وخصص الأشخاص لها ، ودقق المقررات اللتي هي قيد الانتظار';
...
$string['adminhelpenvironment'] = 'تحقق من كيفية ملائمة مخدمك لمتطلبات التنصيب الحالية والمستقبلية';
...
$string['adminhelpsitesettings'] = 'تعريف مظهر واجهة الموقع';
...
$string['administratordescription'] = 'عادة يتسطيع المدارئ القيام بتنفيذ أي إجراء على الموقع في جميع المقررات';
$string['administrators'] = 'المشرفون';
$string['administratorsall'] = 'كل المشرفين';
$string['administratorsandteachers'] = 'المشرفون والمعلمون';
...
$string['allowstealthmodules_help'] = 'عند تمكينها، سيكون بالإمكان جعل النشاطات موجودة ولكن غير ظاهرة ضمن مقاطع مرئية في صفحات المقررات. في هذه الحالة، ينبغي وضع روابط للنشاطات المخفية في مكان آخر، مثلاً من مورد الصفحة. النشاطات المخفية ستظل مدرجة في سجل التقديرات وفي التقارير الأخرى.';
...
$string['areyousuretorestorethisinfo'] = 'لاحقاً في هذا الإجراء ستخير لإضافة هذه النسخة الاحتياطية إلى مقرر موجود أو إنشاء مقرر جديد';
$string['asc'] = 'تصاعدي';
...
$string['authenticationplugins'] = 'إضافات المصادقة';
...
$string['availablecourses'] = 'المقررات المتاحة';
$string['back'] = 'العودة';
$string['backto'] = 'عودة إلى {$a}';
$string['backtocourselisting'] = 'عودة إلى قائمة المقررات';
...
$string['backupadhocpending'] = 'مهمة النسخ الإحتياطي للمقرر الأكاديمي معلّقة حالياً';
$string['backupcancelled'] = 'تم إلغاء الحفظ الاحتياطي';
$string['backupcoursefileshelp'] = 'تمكين هذه الخاصية سيسمح بإضافة ملفات المقرر إلى الحفظ الاحتياطي التلقائي';
...
$string['backupfailed'] = 'بعض مقرراتك لم يتم حفظها';
...
$string['backupincludemoduleshelp'] = 'حدد رغبتك بشأن إضافة وحدات المقرر مع أو بدون معلومات المستخدمين في الحفظ الاحتياطي التلقائي';
...
$string['backupsitefileshelp'] = 'عند التفعيل سيتم تضمين ملفات الموقع المستعملة في المقررات في الحفظ الاحتياطي التلقائي';
...
$string['bulkmovecoursessuccess'] = 'تم نقل {$a->courses} من المقررات بنجاح إلى {$a->category}';
$string['bycourseorder'] = 'حسب ترتيب المقرر';
...
$string['categories'] = 'تصنيفات المقررات';
...
$string['categorycontents'] = 'الفئات الفرعية والمقررات';
...
$string['categoryheader'] = 'قائمة التصنيف';
...
$string['categorypath'] = 'مسار التصنيف';
...
$string['changesmade'] = 'حدثت تغييرات';
...
$string['check'] = 'تحقق';
$string['checkactual'] = 'الفعلي';
$string['checkall'] = 'إختر الكل';
$string['checkexpected'] = 'المتوقع';
$string['checkingbackup'] = 'التحقق من النسخة الإحتياطية';
$string['checkingcourse'] = 'التحقق من مقرر';
...
$string['childcoursenotfound'] = 'لم يتم العثور على مقرر فرعي';
$string['childcourses'] = 'مقررات فرعية';
$string['choose'] = 'إختر';
$string['choosecourse'] = 'اختر مقرر';
...
$string['choosetheme'] = 'إختر القالب';
...
$string['closeblockdrawer'] = 'إغلاق دُرج الكتلة';
$string['closebuttontitle'] = 'اغلاق';
$string['closecourseindex'] = 'إغلاق فهرس المقرر';
$string['closedrawer'] = 'إغلاق الدُرج';
$string['closewindow'] = 'أغلق هذه النافذة';
$string['collapse'] = 'طي';
$string['collapseall'] = 'طي الكل';
$string['collapsecategory'] = 'طي {$a}';
$string['comebacklater'] = 'يرجى العودة لاحقاً.';
...
$string['contentexport_aboutthiscourse'] = 'ملخص المقرر';
...
$string['cookiesenabled_help_html'] = 'يتم استعمال ملفي تعريف ارتباط في هذا الموقع: <br/><br/>

الأساسي منهما هو ملف تعريف ارتباط الجلسة، والذي يُطلق عليه عادةً MoodleSession. ينبغي أن تسمح لملف تعريف الارتباط هذا في متصفحك لتوفير استمرارية تسجيل الدخول عند تصفح الموقع. عند تسجيل الخروج أو إغلاق المتصفح، يتم إتلاف ملف تعريف الارتباط هذا (في متصفحك وفي المخدم).<br/><br/>

ملف تعريف الارتباط الآخر مخصص للراحة فقط، وعادة ما يسمى MOODLEID أو ما شابه. إنه يتذكر فقط اسم المستخدم الخاص بك في المتصفح. هذا يعني أنه عند العودة إلى هذا الموقع، يتم ملء حقل اسم المستخدم في صفحة تسجيل الدخول ذاتيًا. من الآمن رفض ملف تعريف الارتباط هذا - سيكون عليك فقط إعادة كتابة اسم المستخدم الخاص بك في كل مرة تقوم فيها بتسجيل الدخول.';
...
$string['cookiesnotice'] = 'ملاحظة ملفات تعريف الارتباط';
$string['copy'] = 'نسخ';
$string['copyasnoun'] = 'نسخ';
$string['copycourse'] = 'نسخ المقرر';
$string['copyingcoursefiles'] = 'نسخ ملفات مقرر';
$string['copyingsitefiles'] = 'يتم نسخ ملفات الموقع المستخدمة في مقرر';
...
$string['courseadministration'] = 'إدارة المقرر الأكاديمي';
$string['courseapprovedemail'] = 'لقد تمت الموافقة على المقرر،{$a->name} ،الذي قمت بطلبه، وقد تم تعيينك،{$a->teacher} . للوصول لمقررك الدراسي الجديد أذهب إلى {$a->url}';
$string['courseapprovedemail2'] = 'تمت الموافقة على المقرر {$a->name}، الذي طلبته. للوصول إليه، إذهب إلى {$a->url}';
$string['courseapprovedfailed'] = 'فشل حفظ المقرر كمقرر دراسي تمت الموافقة عليه!';
$string['courseapprovedsubject'] = 'تمت الموافقة على مقررك الدراسي!';
$string['courseavailable'] = 'هذاالمقرر متوفر للطلاب';
$string['courseavailablenot'] = 'هذاالمقرر غير متوفر للطلاب';
$string['coursebackup'] = 'الحفظ الاحتياطي للمقرر';
$string['coursebulkaction'] = 'الا جراءات الجماعية لمقررات معينة';
$string['coursecategories'] = 'أصناف مقرر';
$string['coursecategory'] = 'تصنف المقرر';
$string['coursecategory_help'] = 'هذا الإعداد يحدد التصنيف الذي سيظهر فيه المقرر في قائمة المقررات الدراسية.';
$string['coursecategorydeleted'] = 'تم حذف تصنيف المقرر {$a}';
$string['coursecatmanagement'] = 'إدارة المقررات والتصنيفات';
$string['coursecompletion'] = 'إكمال المقرر';
$string['coursecompletions'] = 'إكمال المقررات';
$string['coursecreators'] = 'منشئ المقرر';
$string['coursecreatorsdescription'] = 'منشئو المقررات يمكنهم إنشاء مقررات دراسية جديدة.';
$string['coursedeleted'] = 'تم حذف المقرر {$a}';
$string['coursedetails'] = 'تفاصيل المقرر';
$string['coursedisplay'] = 'مخطط المقرر';
$string['coursedisplay_help'] = 'يمكن عرض كل محتويات المقرر في صفحة واحدة أو تقسيمها على عدة صفحات.';
...
$string['courseenddateenabled'] = 'تاريخ انتهاء المقرر مُمَكَّن تلقائياً';
...
$string['coursefiles'] = 'ملفات مقرر قديم';
$string['coursefilesedit'] = 'تحرير ملفات المقرر القديمة';
$string['coursefileswarning'] = 'ملفات المقرر متقادمة';
$string['coursefileswarning_help'] = 'ملفات المقرر تم التخلي عنها منذ مودل 2.0، الرجاء استعمال مستودعات خارجية بدلاً منها قدر المستطاع.';
$string['courseformatdata'] = 'بيانات تنسيق المقرر';
$string['courseformatoptions'] = 'خيارات التنسيق لـ {$a}';
$string['courseformats'] = 'تنسيقات المقررات';
$string['courseformatudpate'] = 'تحديث التنسيق';
$string['coursegrades'] = 'درجات  المقرر';
$string['courseheader'] = 'قائمة المقرر';
$string['coursehelpcategory'] = 'يضع المقرر في قائمة المقررات ويصبح من الأسهل على الطلاب إيجادها.';
$string['coursehelpforce'] = 'فرض نمط المجموعات على كل النشاطات.';
$string['coursehelpformat'] = 'ستظهر صفحة المقرر الرئيسية بهذا التنسيق';
$string['coursehelphiddensections'] = 'كيف سيتم عرض المقاطع المخفية من القرر على الطلاب.';
$string['coursehelpmaximumupload'] = 'حدد الحجم الأقصى للملف الذي يمكن رفعه في هذا المقرر، محدداً بإعدادات الحد الأقصى لرفع الملفات في الموقع.';
$string['coursehelpnewsitemsnumber'] = 'عدد الإعلانات التي تظهر في كتلة الإعلانات الأخيرة في صفحة المقرر. عند جعله صفراً، لن يتم إنشاء منتدى الإعلانات.';
$string['coursehelpnumberweeks'] = 'عدد الأقسام في المقرر (ينطبق على بعض تنسيقات المقررات فقط).';
$string['coursehelpshowgrades'] = 'تمكين عرض سجل التقديرات. هذا لا يمنع عرض التقديرات ضمن النشاطات المنفردة.';
$string['coursehidden'] = 'هذا المقرر غير متاح للطلاب حالياً';
$string['courseinfo'] = 'معلومات المقرر';
$string['courselegacyfiles'] = 'ملفات مقرر سالف';
$string['courselegacyfiles_help'] = 'توفر مساحة ملفات المقرر بعض التوافق الرجعي مع مودل 1.9 وما قبله. جميع الملفات في هذه المساحة متاحة دائماً لجميع المشاركين في المساق (سواءً وضعت روابط إليها أم لا) كما أنه لا مجال لمعرفة أين يستعمل أيٌ من هذه الملفات في مودل.

إذا كنت ستستعمل هذه المساحة لتخزين ملفات المقرر، فقد تعرض نفسك لمجموعة من مسائل الأمان والخصوصية، وكذلك تواجه فقدان الملفات عند الحفظ الاحتياطي، مستوردات المساق، وفي أي وقت يتم فيه مشاركة المحتوى أو إعادة استعماله. لهذا فإنه يوصى بعدم استعمال هذه المساحة إلا إذا كنت حقاً تعرف ماذا تفعل.';
$string['courselegacyfiles_link'] = 'coursefiles2';
$string['courselegacyfilesofcourse'] = 'ملفات المقرر القديمة: {$a}';
$string['coursenotaccessible'] = 'لا يسمح بدخول العموم لهذا المقرر';
$string['courseoverview'] = 'استعراض المقرر';
$string['courseoverviewfiles'] = 'صورة المقرر';
$string['courseoverviewfiles_help'] = 'يتم عرض صورة المقرر في قائمة مقرراتي وفي قائمة المقررات المتاحة في الصفحة الرئيسية. يمكن لمشرفي الموقع تمكين أنواع إضافية من الملفات وكذلك تمكين استعمال ملفات متعددة. إذا تم تمكين تعدد الملفات، سيتم عرضها جميعًا في قائمة المقررات المتاحة في الصفحة الرئيسية.';
$string['courseoverviewfilesext'] = 'إمتدادات ملفات صور المقرر';
$string['courseoverviewfileslimit'] = 'محدد عدد ملفات صور المقررات';
$string['courseoverviewgraph'] = 'الرسم البياني لاستعراض المقرر';
$string['coursepreferences'] = 'تفضيلات المساق';
$string['courseprofiles'] = 'الملفات الشخصية في المقررات';
...
$string['coursereject'] = 'أرفض طلب مقرر';
$string['courserejected'] = 'تم رفض المقرر الدارسي، وتم إشعار صاحب الطلب';
$string['courserejectemail'] = 'عذراً، لقد تم رفض المقرر الذي قمت بطلبه، وذلك للأسباب التالية:

{$a}';
$string['courserejectreason'] = 'لخّصْ أسبابَكَ لرَفْض هذا المقرر';
$string['courserejectsubject'] = 'لقد تم رفض طلبلك للحصول على مقرر';
$string['coursereport'] = 'تقرير المقرر';
$string['coursereports'] = 'تقارير مقرر';
$string['courserequest'] = 'طلب المقرر';
$string['courserequestdetails'] = 'تفاصيل المقرر الذي تطلبه';
$string['courserequestfailed'] = 'لسبب ما، لم يتم حفظ طلبك للمساق الدراسي';
$string['courserequestintro'] = 'أستخدم هذا النموذج لطلب إنشاء مقرر لك. <br /> الرجاء تعبئة جميع الحقول ليتسنى لمدير الموقع فهم الاسباب الداعية لحاجتك لهذا المقرر';
$string['courserequestreason'] = 'اسباب طلب هذا المقرر';
$string['courserequestroleerror'] = 'تعريف دور منشئي المساقات الجديدة غير صالح. يرجى معاينة <a href="{$a}">سياسات المستخدم</a>.';
$string['courserequestsuccess'] = 'تم تسليم طلب المساق.';
$string['courserequestsupport'] = 'معلومات داعمة تساعد المشرف في تقييم هذا الطلب';
$string['courserequestwarning'] = 'المستخدم الذي يطلب هذا المقرر سيتم تسجيله  تلقائياً وتعيينه بدور {$a}.';
$string['courserestore'] = 'إسترجاع  مساق';
$string['coursereuse'] = 'إعادة استعمال المقرر';
$string['courses'] = 'المقررات الدراسية';
$string['coursesearch'] = 'ابحث المقررات الدراسية';
...
$string['coursesectionsummaries'] = 'ملخصات مقاطع المقرر';
$string['coursesectiontitle'] = 'المساق: {$a->course}، {$a->sectionname}: {$a->sectiontitle}';
$string['coursesectiontitleediting'] = 'تحرير {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
$string['coursesettings'] = 'الإعدادات الافتراضية للمقررات الدراسية';
$string['coursesmovedout'] = 'تم نقل المقرر من {$a}';
$string['coursespending'] = 'مقررات بانتظار الموافقة';
$string['coursestart'] = 'بدء مساق';
$string['coursesummary'] = 'ملخص المقرر';
$string['coursesummary_help'] = 'وصف موجز لمساقك. المحتوى الذي تضيفه هنا قابل للبحث.';
$string['coursetitle'] = 'المقرر: {$a->course}';
$string['coursetitleediting'] = 'تحرير المساق: {$a->course}';
$string['courseupdates'] = 'تحديثات المقررات';
$string['coursevisibility'] = 'إظهار المقرر';
$string['coursevisibility_help'] = 'هذا الإعداد يحدد ما إذا كان المقرر سيظهر في قائمة المقررات وما إذا كان الطلاب يمكنهم الوصول إليها. إذا تم اختيار إخفاء المقرر، فسيقتصر الوصول إليه على المستخدمين الذين لديهم إمكانية معاينة المقررات الدراسية المخفية (مثل المعلمين).';
$string['create'] = 'إنشاء';
...
$string['creatingcoursemodules'] = 'إنشاء وحدة مساق';
...
$string['creatingnewcourse'] = 'إنشاء مساق  دراسي جديد';
...
$string['currentcourseadding'] = 'إضافة معلومات للمساق الدراسي الحالي';
$string['currentcoursedeleting'] = 'حذف المقرر الحالي أولاً';
...
$string['defaultcategoryname'] = 'الصنف 1';
...
$string['defaultcoursesummary'] = 'اكتب فقرة مختصرة تشرح فيها موضوع المقرر';
$string['defaultcourseteacher'] = 'معلم';
$string['defaultcourseteacherdescription'] = 'يمكن للمعلم القيام بأي شيء في المقرر، يشمل ذلك تعديل النشاطات وإعطاء تقديرات للطلاب.';
$string['defaultcourseteachers'] = 'معلمون';
$string['defaulteditor'] = 'المحرر الافتراضي';
$string['defaulthomepageuser'] = 'صفحة البدء';
$string['defaulthomepageuser_help'] = 'إلى أي صفحة ينبغي إعادة توجيه المستخدم بعد تسجيل دخوله إلى الموقع؟';
$string['delete'] = 'حذف';
...
$string['deletecategorycheck'] = 'هل انت متأكد للقيام بحذف هذا التصنيف تماما<b>\'{$a}\'</b>?<br /> كل المقررات ستنقل ألى التصنيف الرئيس لو وجد تصنيف رئيس، أو إلى منوعات.';
...
$string['deletecourse'] = 'حذف مساق';
$string['deletecoursecheck'] = 'هل أنت متأكدأنك تريد حذف هذا المقرر بكل ما يحتويه من بيانات؟';
...
$string['deletingexistingcoursedata'] = 'حذف معلومات المقرر الموجودة';
...
$string['dndworkingfile'] = 'قم بسحب وإفلات الملفات الى مقاطع المقرر ليتم رفعها';
$string['dndworkingfilelink'] = 'قم بسحب وإفلات الملفات أو الروابط الى مقاطع المقرر ليتم رفعها';
$string['dndworkingfiletext'] = 'قم بسحب وإفلات الملفات أو النصوص الى مقاطع المقرر ليتم رفعها';
$string['dndworkingfiletextlink'] = 'قم بسحب وإفلات الملفات، الروابط أو النصوص الى مقاطع المقرر ليتم رفعها';
$string['dndworkinglink'] = 'قم بسحب وإفلات الروابط الى مقاطع المقرر ليتم رفعها';
$string['dndworkingtext'] = 'قم بسحب وإفلات النصوص الى مقاطع المقرر ليتم رفعها';
$string['dndworkingtextlink'] = 'قم بسحب وإفلات الروابط أو النصوص الى مقاطع المقرر ليتم رفعها';
...
$string['editcoursesettings'] = 'تحرير إعدادات المقرر';
...
$string['editsectionname'] = 'تعديل اسم القسم';
...
$string['emaildisplay'] = 'رؤية البريد الالكتروني';
$string['emaildisplay_help'] = '* مخفي - سيتمكن المستخدمون ذوو الصلاحيات المناسبة حصرًا مثل المعلمين من رؤية عنوان بريدك الالكتروني.
* مرئي للكل - كل المستخدمين في الموقع يمكنهم معاينة عنوان بريدك الالكتروني.
* مرئي للمشاركين في المقررات - فقط المستخدمون في المقررات التي انضممت إليها يمكنهم معاينة عنوان بريدك الالكتروني.';
$string['emaildisplaycourse'] = 'مرئي للمشاركين في المقررات';
$string['emaildisplaycoursemembersonly'] = '(مرئي بالنسبة إلى المشاركين الآخرين في المقرر)';
$string['emaildisplayeveryone'] = '(مرئي للجميع)';
$string['emaildisplayhide'] = '(مخفي عن الكل باستثناء المستخدمين ذوي الصلاحيات المناسبة)';
$string['emaildisplayno'] = 'مخفي';
$string['emaildisplayyes'] = 'مرئي للكل';
...
تم طلب إعادة تعيين كلمة المرور الخاصة بحسابك \'{$a->username}\' في {$a->sitename}.

لتأكيد هذا الطلب، وتعيين كلمة مرور جديدة لحسابك، يرجى الذهاب إلى عنوان الويب:
{$a->link}
...
إذا كنت بحاجة إلى مساعدة، يرجى الاتصال بمشرف الموقع، {$a->admin}';
...
$string['emojicategorypeoplebody'] = 'الأشخاص والهيئات';
$string['emojicategoryrecent'] = 'حديث';
$string['emojicategorysmileysemotion'] = 'الابتسامات والرموز التعبيرية';
$string['emojicategorysymbols'] = 'الرموز';
$string['emojicategorytravelplaces'] = 'السفر والأماكن';
$string['emptycmids'] = 'مُعرَّفات وحدات المقررات الخالية';
$string['emptydragdropregion'] = 'منطقة فارغة';
$string['emptysectionids'] = 'مُعرَّفات القسم الخالي';
$string['enable'] = 'تمكين';
$string['encryptedcode'] = 'رمز مشفر';
$string['enddate'] = 'تاريخ إنتهاء المقرر';
$string['enddate_help'] = 'تاريخ الانتهاء لا يقيد إمكانية الطلاب للوصول إلى المقرر. إنه يحدد موعد وضع المساق ضمن تبويب المقررات الماضية ضمن قائمة مقرراتي.';
$string['english'] = 'الإنجليزية';
$string['enrolmentmethods'] = 'طرق الانضمام';
$string['entercourse'] = 'أنقر للدخول إلى هذا المقرر';
...
$string['eventcoursebackupcreated'] = 'نسخة احتياطية لمساق تم إنشاؤها';
...
$string['eventcoursecontentdeleted'] = 'محتوى مساق تم حذفه';
$string['eventcoursecreated'] = 'مساق تم إنشاؤه';
$string['eventcoursedeleted'] = 'مساق تم حذفه';
$string['eventcourseinformationviewed'] = 'ملخص مساق تمت معاينته';
$string['eventcoursemodulecreated'] = 'وحدة مساق تم إنشاؤها';
$string['eventcoursemoduledeleted'] = 'وحدة مساق تم حذفها';
$string['eventcoursemoduleinstancelistviewed'] = 'قائمة عيِّنات وحدات المقررات الدراسية تمت معاينتها';
$string['eventcoursemoduleupdated'] = 'وحدة مساق تم تحديثها';
$string['eventcoursemoduleviewed'] = 'وحدة مساق تمت معاينتها';
$string['eventcourseresetended'] = 'عملية إعادة تعيين مساق انتهت';
$string['eventcourseresetstarted'] = 'عملية إعادة تعيين مساق تم بدؤها';
$string['eventcourserestored'] = 'مساق تم استرجاعه';
$string['eventcoursesectioncreated'] = 'قسم مقرر تم إنشاؤه';
$string['eventcoursesectiondeleted'] = 'قسم مقرر تم حذفه';
$string['eventcoursesectionupdated'] = 'قسم مقرر تم تحديثه';
$string['eventcoursessearched'] = 'مساقات تم البحث فيها';
$string['eventcourseupdated'] = 'مساق تم تحديثه';
$string['eventcourseuserreportviewed'] = 'تقرير مُستخدم في مساق تمت معاينته';
$string['eventcourseviewed'] = 'مساق تمت معاينته';
...
$string['eventmycoursesviewed'] = 'مقرراتي تمت معاينتها';
...
$string['existingcourseadding'] = 'إضافة معلومات لمساق موجود';
$string['existingcoursedeleting'] = 'حذف معلومات من مساق موجود';
$string['existingcreators'] = 'منشئو المقرر الموجودين';
...
$string['findmorecourses'] = 'ابحث عن مساقات إضافية...';
$string['first'] = 'أولاً';
...
$string['format_help'] = 'تنسيق المقرر يحدد تخطيط صفحته.

* تنسيق النشاط الواحد - لعرض نشاط أو مورد واحد (مثل الاختبار أو حزمة سكورم) في صفحة المقرر
* التنسيق الاجتماعي - يتم عرض منتدى في صفحة المقرر
* التنسيق حسب المواضيع - تنظّم صفحة المقرر في مقاطع حسب المواضيع.
* التنسيق الأسبوعي - تنظّم صفحة المقرر في مقاطع أسبوعية، بحيث يبدأ الأسبوع الأول في تاريخ بدء المقرر';
...
$string['frontpagedescription'] = 'ملخص واجهة الموقع';
$string['frontpagedescriptionhelp'] = 'يمكن عرض هذا الوصف في صفحة واجهة الموقع باستعمال كتلة ملخص المقرر/الموقع.';
$string['frontpageenrolledcourselist'] = 'المقررات الدراسية المُسجلة';
$string['frontpageformat'] = 'تنسيق واجهة الموقع';
$string['frontpageformatloggedin'] = 'تنسيق واجهة الموقع عند تسجيل الدخول';
...
$string['fullnamecourse'] = 'الاسم الكامل للمقرر الدراسي الدراسي';
$string['fullnamecourse_help'] = 'الاسم المعروض في قائمة مقرراتي وفي قائمة المقررات المتاحة في الصفحة الرئيبسية.';
...
لمعاينة التفاصيل الكاملة، راجع صفحة رخصة مودل: https://moodledev.io/general/license';
...
$string['gradenoun'] = 'العلامة';
$string['grades'] = 'التقديرات';
$string['gradeverb'] = 'العلامة';
...
$string['hiddenoncoursepage'] = 'متاح لكن غير ظاهر في صفحة المقرر';
$string['hiddensections'] = 'المقاطع المخفية';
$string['hiddensections_help'] = 'المقاطع المخفية يمكن عرضها للطلاب على أنها غير متاحة في صفحة المقرر، أو إبقاؤها مخفية تمامًا.';
$string['hiddensectionscollapsed'] = 'المقاطع المخفية تظهر وكأنها غير متاحة';
...
$string['hidefromstudents'] = 'مخفي في صفحة المقرر';
$string['hideoncoursepage'] = 'إجعله متاحًا لكن لا تظهره في صفحة المقرر';
...
$string['homeheader'] = 'القائمة الرئيسية';
$string['hour'] = 'ساعة';
$string['hours'] = 'ساعات';
...
$string['idnumbercourse'] = 'مُعرَّف المقرر';
...
بالنسبة إلى النشاطات القابلة لمنح التقديرات، يمكن أيضاً وضع أرقام المُعرَّف في سجل التقديرات مع أنها تكون قابلة للتعديل حصراً من صفحة الإعدادات الخاصة بتلك النشاطات.';
$string['idnumbertaken'] = 'هذا المعرف تم تسجيله من قبل';
$string['imagealt'] = 'وصف الصورة';
$string['import'] = 'استيراد';
$string['importdata'] = 'استيراد بيانات مساق';
$string['importdataexported'] = 'تم تصدير بيانات من المقرر \'from\' بنجاح.<br /> أستمر في الأستيراد إلى مقررك الدراسي \'to\'';
$string['importdatafinished'] = 'إكتمل الإستيراد! الذهاب إلى مساقك الدراسي';
$string['importdatafrom'] = 'جِد مساق لاستيراد البيانات منه:';
...
$string['includecourseusers'] = 'تضمين مستخدمي المقرر';
...
$string['indicator:accessesafterend_help'] = 'هذ المؤشر يعكس ما إذا قام الطالب بالوصول إلى المقرر بعد تاريخ انتهائه.';
$string['indicator:accessesbeforestart'] = 'الوصول إلى المقرر قبل تاريخ بدئه';
$string['indicator:accessesbeforestart_help'] = 'هذ المؤشر يعكس ما إذا قام الطالب بالوصول إلى المقرر قبل تاريخ بدئه';
...
$string['indicator:anycourseaccess_help'] = 'يعكس هذا المؤشر وصول المستخدم إلى أيّ مساق التحق به.';
...
$string['indicator:anywriteincourse'] = 'أي إجراء كتابي في المقرر';
...
$string['indicator:potentialcognitive_help'] = 'هذا المؤشر مبني على العمق المعرفي المتوقع الذي يمكن الوصول إليه من قبل طالب يشارك في نشاطات المقرر';
$string['indicator:potentialcognitivedef'] = 'العمق المعرفي المتوقع للمساق';
$string['indicator:potentialcognitivedef_help'] = 'الدرجة التي يقدم بها المقرر المشاركة المعرفية "العميقة"، على سبيل المثال تقديم العمل للتعليقات، فرصة مراجعة أعمال الآخرين، وفرصة تنقيح العمل وإعادة إرساله.';
...
$string['indicator:potentialsocial_help'] = 'هذا المؤشر مبني على التوسع الاجتماعي المتوقع والذي يمكن الوصول إليه من قبل طالب يشارك في نشاطات المقرر.';
$string['indicator:potentialsocialdef'] = 'التوسع الاجتماعي المتوقع للمساق';
$string['indicator:potentialsocialdef_help'] = 'الدرجة التي يبلغها المقرر من المشاركة الاجتماعية "الواسعة"، التفاعل مع المشاركين الآخرين، ومع مجتمع المشاركين خارج الصف.';
...
$string['inprogress'] = 'لا زال جاريًا';
...
$string['languageselector'] = 'منتقي اللغة';
$string['last'] = 'الأخير';
$string['lastaccess'] = 'آخردخول';
$string['lastcourseaccess'] = 'آخر دخول إلى المقرر';
...
$string['lastnamephonetic'] = 'الاسم الأخير - لفظيًا';
...
$string['local'] = 'محلّي';
$string['localplugins'] = 'الإضافات المحليّة';
$string['localpluginsmanage'] = 'إدارة الإضافات المحليّة';
...
$string['loginagain'] = 'الدخول مجدداً';
...
$string['managecategories'] = 'إدارة تصنيفات المقررات الدراسية';
$string['managecategorythis'] = 'إدارة هذا التصنيف';
$string['managecombined'] = 'إدارة المقررات الدراسية وتصنيفاتها';
...
$string['maximumupload_help'] = 'الحجم الأقصى للملف المسموح برفعه من قبل الطالب إلى المقرر. فضلاً عن ذلك، يمكنك إخضاع حجم الملف الأقصى لمزيد من التقييد على مستوى كل نشاط.';
...
$string['maxnumcoursesincombo'] = 'تصفح <a href="{$a->link}">{$a->numberofcourses}المقررات</a>.';
$string['maxsectionslimit'] = 'لا يمكن إنشاء قسم جديد لأن ذلك سيتجاوز الحد الأقصى لعدد الأقسام المسموح بها لهذ المقرر ({$a}).';
...
$string['memberincourse'] = 'أعضاء المقرر';
$string['menu'] = 'القائمة';
...
$string['messageprovider:coursecompleted'] = 'تم إكمال المقرر';
$string['messageprovider:coursecontentupdated'] = 'تغييرات محتوى المقرر';
$string['messageprovider:courserequestapproved'] = 'إشعار الموافقة على طلب إنشاء المقرر';
$string['messageprovider:courserequested'] = 'إشعار طلب إنشاء المقرر';
$string['messageprovider:courserequestrejected'] = 'إشعار رفض طلب إنشاء المقرر';
...
$string['messageprovider:gradenotifications'] = 'إشعارات التقديرات';
...
$string['messageprovider:instantmessage_help'] = 'هذا القسم مسؤول عن تهيئة ما يحدث للرسائل التي يتم إرسالها إليك مباشرة من مستخدمين آخرين في هذا الموقع.';
$string['messageprovider:messagecontactrequests'] = 'إشعار إلتماسات المراسلة';
$string['messageprovider:newlogin'] = 'إشعارات تسجيلات الدخول الجديدة';
...
$string['messageprovider:reportbuilderschedule'] = 'جدولة منشئ التقارير المخصصة';
...
$string['migratinggrades'] = 'ترحيل التقديرات';
$string['min'] = 'دقيقة';
$string['mins'] = 'دقائق';
$string['minute'] = 'دقيقة';
...
$string['modvisible_help'] = '* الإظهار في صفحة المقرر: متاحاً للطلاب (عُرضة لأي تقييدات وصول قد تكون مستعملة).
* مخفي في صفحة المقرر: غير متاح للطلاب.';
$string['modvisiblehiddensection'] = 'متاح';
$string['modvisiblehiddensection_help'] = '* مخفي في صفحة المقرر: غير متاح للطلاب.
* إجعله متاحًا لكن لا تظهره في صفحة المقرر: متاح للطلاب إذا أعطيتهم رابطًا له. ستظل تلك النشاطات مدرجة في سجل التقديرات والتقارير الأخرى.';
$string['modvisiblewithstealth'] = 'متاح';
$string['modvisiblewithstealth_help'] = '* الإظهار في صفحة المقرر: متاحاً للطلاب (عُرضة لأي تقييدات وصول قد تكون مستعملة).
* مخفي في صفحة المساق: غير متاح للطلاب.
* إجعله متاحًا لكن لا تظهره في صفحة المقرر: متاح للطلاب إذا أعطيتهم رابطًا له. ستظل تلك النشاطات مدرجة في سجل التقديرات والتقارير الأخرى.';
$string['month'] = 'شهر';
$string['months'] = 'شهور';
...
$string['moodleservicesandsupport'] = 'الخدمات والدعم';
$string['moodleversion'] = 'إصدار مودل';
$string['more'] = 'المزيد';
$string['moreactions'] = 'مزيد من الإجراءات';
...
$string['movecoursemodule'] = 'نقل النشاط';
$string['movecoursesection'] = 'أنقل القسم';
$string['movecourseto'] = 'نقل المقرر إلى:';
...
$string['movesection'] = 'أنقل القسم {$a}';
$string['moveselectedcategoriesto'] = 'انقل التصنيفات المُختارة إلى';
$string['moveselectedcoursesto'] = 'أنقل المقررات المختارة إلى...';
...
$string['newcourse'] = 'مقرر جديد';
$string['newloginnotificationbodyfull'] = '<p>مرحبًا {$a->userfullname}،</p>
<p>حسابك في {$a->sitename} قد تم تسجيل الدخول به توًا من جهاز جديد.</p>
<ul>
<li>حسابك: {$a->username} {$a->useremail}</li>
<li>{$a->logintime}</li>
<li>الجهاز: {$a->logindevice}</li>
<li>عنوان IP: {$a->loginip}</li>
</ul>
<p>إذا كنت أنت، فلا حاجة للقيام بشيء.</p>
<p>إذا لم تكن لديك فكرة عن هذا الأمر، يرجى <a href="{$a->changepasswordlink}">تغيير كلمة مرورك</a>.</p>';
$string['newloginnotificationbodysmall'] = 'حسابك في {$a} قد تم تسجيل الدخول عبره توًا من جهاز جديد.';
$string['newloginnotificationtitle'] = 'تسجيل دخول جديد لحسابك في {$a}';
...
$string['newsectionname'] = 'اسم جديد للقسم {$a}';
$string['newsitem'] = 'بند إخباري';
$string['newsitems'] = 'الإعلانات';
$string['newsitemsnumber'] = 'عدد الإعلانات';
$string['newsitemsnumber_help'] = 'منتدى الإعلانات فيه الاشتراك مفروض بشكل إفتراضي. فقط المعلمون وغيرهم من المستخدمين الذين لديهم الصلاحيات المناسبة يمكنهم النشر فيه.

في حال عدم الحاجة إلى منتدى الإعلانات، ضع هذا الإعداد على الصفر.

هذا الإعداد يحدد أيضًا عدد ما يظهر في كتلة آخر الإعلانات من فقرات للطلاب.
...
$string['nocourses'] = 'لا توجد مقررات';
$string['nocoursesfound'] = 'لا يوجد مساق يحتوي على هذه الكلمات  \'{$a}\'';
$string['nocoursestarttime'] = 'المقرر ليس له تاريخ بداية.';
$string['nocoursesyet'] = 'لا توجد مقررات لهذه الفئة';
...
$string['noimagesyet'] = 'لم يتم تحميل أي صورة للمساق الدراسي الخاص بك';
$string['nologsfound'] = 'لم يتم العثور على سجلات';
$string['nomatchingusers'] = 'لا يوجد مستخدمون يطابقون \'{$a}\'';
$string['nomorecourses'] = 'لا يوجد المزيد من المقررات المماثلة';
$string['nomoreidnumber'] = 'لتفادي التعارض لا تستخدم رقم تعريف';
$string['none'] = 'بلا';
$string['noneditingteacher'] = 'معلم بلا صلاحية التحرير';
$string['noneditingteacherdescription'] = 'المعلمون غير المحررين يمكنهم التدريس في المقررات الدراسية وإعطاء التقديرات للطلاب، لكن لا يمكنهم تعديل الأنشطة';
...
$string['nopotentialcreators'] = 'لا يوجد منشئوا مساق محتملون';
...
$string['noteuserschangednonetocourse'] = 'ملاحظة: يتطلب إستراجاع مستخدمي المقرر عند أعدت بيانت المستخدم (في الأنشطة، الملفات أو الرسائل). تم تغير هذا الاعداد لك';
...
$string['numberofcourses'] = 'عدد المقررات الدراسية';
...
$string['opendrawerblocks'] = 'فتح دُرج الكتلة';
$string['opendrawerindex'] = 'فتح فهرس المقرر';
$string['opensinnewwindow'] = 'يُفتح بنافذة جديدة';
$string['operator_and'] = 'و';
$string['operator_andnot'] = 'و';
$string['operator_or'] = 'أو';
...
$string['parentcoursenotfound'] = 'لم يتم العثور على مساق أساسي';
...
$string['paymentrequired'] = 'هذا المقرر غير مجاني ، لذا يجب دفع القيمة للدخول.';
$string['payments'] = 'أقساط مالية';
$string['paymentsorry'] = 'شكراً لقيامك بدفع المبلغ المطلوب! ولكن لسوء الحظ لم يتم حتى الآن إنهاء إجراءات الخاصة بتسجيلك، لذا لن تتمكن من الدخول إلى المقرر "{$a->fullname}". الرجاءً حاولْ الدخول بعد بضعة ثواني، في حالة عدم تمكن من الدخول بعد عدة محاولات الرجاءً إحاطة{$a->teacher} معلّم أَو مدير الموقعَ.';
$string['paymentthanks'] = 'شكراً لقيامك بدفع المبلغ المالي! لقد تم تسجيلك في المقرر: :<br /> "{$a}"';
...
$string['personalprofile'] = 'الملف الشخصي';
$string['phone'] = 'الهاتف';
...
$string['pluginarea'] = 'مساحة';
$string['plugincheck'] = 'فحص الإضافات';
$string['plugindeletefiles'] = 'كُلّ البيانات المرتبطة بالإضافة \'{a$->name}\' تم حذفها مِنْ قاعدةِ البيانات. لمَنع الإضافة من إعادة تنصيب نفسها تلقائياً، يَجِبُ أَنْ تَحْذفَ هذا المجلد الآن مِنْ مخدمِكَ: {$a->directory}';
$string['pluginitemid'] = 'رقم العنصر';
...
$string['potentialcreators'] = 'منشئون مساق محتملون';
$string['potentialstudents'] = 'طلاب محتملون';
$string['potentialteachers'] = 'معلمون محتملون';
$string['poweredbymoodle'] = 'مشغل بواسطة <a href="https://moodle.com">مودل</a>';
$string['preferences'] = 'التفضيلات';
$string['preferredlanguage'] = 'اللغة المفضلة';
$string['preferredtheme'] = 'القالب المفضل';
...
$string['privacy:metadata:config_log:plugin'] = 'الإضافة معدلة';
...
$string['privacy:metadata:log:cmid'] = 'المفتاح الأساسي لوحدة المقرر';
$string['privacy:metadata:log:course'] = 'المقرر';
...
$string['privacy:metadata:upgrade_log:plugin'] = 'الإضافة الذي تمت ترقيته';
...
$string['privacy:metadata:upgrade_log:version'] = 'النسخة القديمة للإضافة';
...
$string['relativedatesmode_warning'] = '<strong>تحذير:</strong> نمط التواريخ النسبية لا يمكن تغييره بمجرد إنشاء المقرر.';
$string['reload'] = 'إعادة التحميل';
$string['remoteappuser'] = 'بعيد {$a} مستخدم';
$string['remove'] = 'إزالة';
$string['removeadmin'] = 'استبعاد مدير';
$string['removecreator'] = 'إزالة منشئ المقرر';
...
$string['requestcourse'] = 'أطلب مساقاً دراسياً';
$string['requestedby'] = 'تم الطلب بواسطة';
$string['requestedcourses'] = 'المقررات الدراسية المطلوبة';
$string['requestreason'] = 'سبب طلب المقرر';
$string['requests'] = 'الإلتماسات';
$string['required'] = 'مفروض';
$string['requirespayment'] = 'هذا المقرر يتطلب الدفع المالي قبل الاشتراك فيه';
$string['resendemail'] = 'إعادة إرسال البريد الالكتروني';
$string['reset'] = 'إعادة التعيين';
$string['resetcomponent'] = 'مكوّن';
$string['resetcourse'] = 'إعادة تعيين المقرر';
$string['resetinfo'] = 'هذه الصفحةِ تَسْمحُ لك بإفراغ المقرر من بيانات المستخدمين، في حين تَحتفظُ بالنشاطاتِ والإعدادات الأخرى. رجاءً كُنْ حَذراً، فبمجرد إخْتياَرك للعناصر أدناه والقيام بتسليم هذه الصفحة سيتم حْذفُ بيانات المستخدمين التي حددتها نهائياً!';
...
$string['resources_help'] = 'أنواع الموارد تُمكنك من إدراج أي نوع من محتوى الويب تقريبًا في المقرر.';
...
$string['restorecoursenow'] = 'استرجع هذا المقرر الآن!';
...
$string['restoretositeadding'] = 'تحذير: أنتَ على وشك الاستعادة إلى واجهة الموقع، مضيفاً البيانات إليها!';
$string['restoretositedeleting'] = 'تحذير: أنتَ على وشك الاستعادة إلى واجهة الموقع، حاذفاً البيانات منها أولاً!';
...
$string['rolerenaming_help'] = 'هذا الإعداد يَسْمحُ بتغيير أسماء الأدوارِ المعدلة والمستعملة في المقرر. سيتغير اسم الدور فقط - صلاحية الدورِ لن تتأثر. أسماء الدورِ الجديدةِ ستظهر على صفحةِ مشاركي المقرر وفي أماكن أخرى ضمن المساق. اسم الدورِ الجديدِ سيُعرض أيضاً كجزء مِنْ قائمة المقررات الدراسية، إذا كان هذا الدور المعدل هو أحد الأدوار التي اختارها مشرف الموقع لإدارة المقرر.';
...
$string['scalestip'] = 'لإنشاء مقاييس مخصصة، استخدم رابط ’مقاييس’من قائمة إدارة المساق';
$string['scalestip2'] = 'لإنشاء مقاييس مخصصة، إختر رابط التقديرات في قائمةِ إدارةِ المساق، ثمّ اختر تحرير المقاييس.';
...
$string['secs'] = 'ثواني';
$string['section'] = 'قسم';
$string['sectionactionnotsupported'] = 'إجراء القسم "{$a}" غير مدعوم هنا';
...
$string['selectgroupsseparate'] = 'حدد المجموعات المنفصلة';
$string['selectgroupsvisible'] = 'حدد المجموعات المرئية';
...
$string['shortnamecourse'] = 'الاسم المختصر للمقرر الدراسي';
$string['shortnamecourse_help'] = 'الاسم المختصر الذي يُعرض في المواضع المحدودة المساحة. ينبغي أن يكون فريدًا.';
...
$string['showactivitydates'] = 'إظهار تواريخ النشاط';
$string['showactivitydates_help'] = 'إظهار تواريخ النشاط في صفحة المقرر.';
...
$string['showdescription'] = 'إعرض الوصف في صفحة المقرر';
...
$string['showgrades_help'] = 'السماح للطلاب بمعاينة قائمة تضم كل تقديراتهم في المساق.';
...
$string['showoncoursepage'] = 'الإظهار في صفحة المقرر';
...
$string['showreports_help'] = 'السماح للطلاب بمعاينة تقارير النشاطِات الخاصة بهم من صفحةِ ملفهم الشخصي.';
...
$string['sitefilesused'] = 'ملفات الموقع المستخدمة في هذا المساق';
...
$string['skiptocourselisting'] = 'انتقل إلى قوائم المساق';
...
$string['starpending'] = '([*]= مساق ينتظر الموافقة)';
$string['startdate'] = 'تاريخ بدء المقرر';
$string['startdate_help'] = 'هذا الإعداد يحدد بداية أول أسبوع للمساق ذي التنسيق الأسبوعي، ويحدد أيضاً تاريخ بدء سجلات وقوعات النشاطات في المساق.

إذا أعدت تعيين المساق وغيَّرت هذا التاريخ، فكل التواريخ التي في المساق سيتم تغييرها نسبة إلى تاريخ بدايته الجديد.';
...
$string['statsnodata'] = 'لا يوجد بيانات حول هذا المساق في تلك الفترة الزمنية';
$string['statsnodatauser'] = 'لا يوجد بيانات للمزيج المساق، المستخدم، والفترة الزمنية';
...
$string['statusunknown'] = 'مجهول';
$string['statuswarning'] = 'تحذير';
$string['stringsnotset'] = 'لم يتم تعريف الإعدادات التالية في {$a}';
$string['studentnotallowed'] = 'عذرا! لا يمكنك الدخول على هذه المساق بصفة \'{$a}\'';
...
$string['summary_help'] = 'إنّ فكرةَ الملخص هي توفير نَص قصير لتَهْيِئة الطلابِ للأنشطة ضمن الموضوعِ أَو الأسبوعِ. سيظهر نص الملخص في صفحةِ المساق تحت اسمِ القسم.';
$string['summaryof'] = 'ملخص لـ  {$a}';
$string['supplyinfo'] = 'المزيد من التفاصيل';
$string['suspended'] = 'موقوف';
$string['suspendedusers'] = 'المُستخدمون الموقوفون';
$string['switchdevicedefault'] = 'التبديل إلى القالب القياسي';
...
$string['textcopiedtoclipboard'] = 'تم نسخ النص إلى الحافظة';
...
$string['toomanytags'] = 'هذا البحث تضمَّن وسوم أكثر من اللازم؛ سيتم تجاهل بعضها.';
...
$string['total'] = 'مجموع';
$string['totopofsection'] = 'إلى الأعلى من القسم "{$a}"';
...
$string['unabletocopytoclipboard'] = 'تعذر نسخ النص إلى الحافظة';
$string['unauthorisedlogin'] = 'الحساب المُرتبط بااسم المُستخدم "{$a}" لايتوفر على هذا الموقع';
$string['undecided'] = 'غير مُحدَّد';
$string['unexistingcmid'] = 'مُعرَّف وحدة المساق غير موجود';
$string['unexistingsectionid'] = 'مُعرَّف قسم المقرر غير موجود';
...
$string['updatethis'] = 'تحديث {$a} هذا';
$string['updatethiscourse'] = 'تحديث هذا المساق';
...
$string['usermenugoback'] = 'عودة إلى قائمة المستخدمين';
$string['username'] = 'اسم المستخدم';
$string['usernameemail'] = 'اسم المُستخدم أو البريد الإلكتروني';
...
$string['usetheme'] = 'استعمل القالب';
$string['usingexistingcourse'] = 'استخدام المساق الموجود';
$string['validatehtml'] = 'تحقق من HTML';
...
$string['wcagcheck'] = 'فحص دليل إرشادات الوصول إلى محتوى الويب (WCAG)';
...
$string['welcomeback'] = 'مرحبًا، {$a->firstname}! 👋';
...
من الأشياء التي يجب أن تفعلها بداية، هي أن تقوم بتعديل صفحة حسابك حتى نعرف المزيد عنك:
 ...
 {$a->profileurl}';
$string['welcometosite'] = 'مرحبًا، {$a->firstname}! 👋';
...
$string['writingcoursedata'] = 'القيام بكتابة معلومات المساق';
...
$string['youneedtoenrol'] = 'للقيام بهذا العمل يجب أن تكون مسجلاً في المساق';
