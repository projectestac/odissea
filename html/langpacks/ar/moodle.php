...
$string['courseoverviewfiles_help'] = 'يتم عرض صورة المساق في قائمة مساقاتي وفي قائمة المقررات المتاحة في الصفحة الرئيسية. يمكن لمشرفي الموقع تمكين أنواع إضافية من الملفات وكذلك تمكين استعمال ملفات متعددة. إذا تم تمكين تعدد الملفات، سيتم عرضها جميعًا في قائمة المقررات المتاحة في الصفحة الرئيسية.';
...
$string['showactivitydates_help'] = 'إظهار تواريخ النشاط في صفحة المساق.';
