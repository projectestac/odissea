...
/**
 * Strings for component 'moodle', language 'ar', version '4.4'.
 *
 * @package     moodle
 * @category    string
...
$string['resetinfo'] = 'حذف كل بيانات المستخدمين وإعادة تعيين هذا المساق إلى حالته الأصلية، مع الإبقاء على الإعدادات والنشاطات كما هي.';
