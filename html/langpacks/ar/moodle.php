...
/**
 * Strings for component 'moodle', language 'ar', version '4.5'.
 *
 * @package     moodle
 * @category    string
...
$string['activityorresource'] = 'النشاط أو المورد';
...
$string['addfilesdrop'] = 'بإمكانك سحب الملفات وإفلاتها هنا لرفعها أو النقر لتحديدها.';
$string['addinganew'] = '{$a} جديد(ة)';
...
$string['adminhelpusers'] = 'عرّف مستخدمي موقعك وأعد طريقة المصادقة';
...
$string['administrator'] = 'المشرف';
$string['administratordescription'] = 'عادة يستطيع المشرفون القيام بتنفيذ أي إجراء في الموقع في كل المساقات.';
...
$string['backupfailed'] = 'بعض مساقاتك لم يتم حفظها.';
...
$string['backupinfo'] = 'إنشاء نسخة من هذا المساق، تتضمن كل محتوياته ونشاطاته حتى الآن. يمكنك استعمال الملف الاحتياطي لاستعادة هذا المساق.';
...
$string['checkerror'] = 'وقع خطأ عند تلقي نتائج الفحص \'{$a}\'. تحقق من منصة المطور في مستعرض الويب لمزيد من المعلومات.';
...
$string['checkloading'] = 'يجري تلقي نتائج الفحص \'{$a}';
...
$string['confirmaccount'] = 'تأكيد الحساب';
...
$string['contextname'] = 'اسم السياق';
$string['contextparent'] = 'الأعلى رتبة';
...
$string['copytoclipboard'] = 'نسخ إلى الحافظة';
...
$string['courseapprovedemail'] = 'لقد تمت الموافقة على المساق الذي قمت بطلبه، <a href="{$a->url}">{$a->name}</a> والآن أنت فيه بدور {$a->teacher}.';
$string['courseapprovedemail2'] = 'تمت الموافقة على المساق الذي طلبته: <a href="{$a->url}">{$a->name}</a>.';
$string['courseapprovedfailed'] = 'فشل حفظ المقرر كمقرر دراسي تمت الموافقة عليه!';
$string['courseapprovedsubject'] = 'تمت الموافقة على مساقك.';
...
$string['courserejectemail'] = 'عذراً، لقد تم رفض المساق الذي طلبته، وذلك للأسباب الآتية:
...
$string['courserequestintro'] = 'استعمل هذا النموذج لطلب إنشاء مساق لك. <br />حاول تعبئة أكبر قدر من المعلومات لتسمح<br />لمشرفي الموقع بفهم الأسباب الداعية لطلبك لهذا المساق.';
...
$string['coursereusenavigationmenu'] = 'قائمة تنقل إعادة استعمال المساق';
...
$string['coursesectiontitlebulkediting'] = 'تحرير بالجملة {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'تحرير المساق بالجملة: {$a->course}';
...
$string['defaultcourseteacher'] = 'المعلم';
...
$string['defaultcourseteachers'] = 'المعلمون';
...
$string['deleteallcomments'] = 'كل التعليقات';
$string['deleteallratings'] = 'كل التقييمات';
...
$string['deletecheckfull'] = 'هل أنت متأكد تماماً من رغبتك في حذف المستخدم {$a}، شاملاً بياناته، مثل تفاصيل ملفه الشخصي، انضماماته إلى المجموعات والزمر، ونشاطاته؟';
...
$string['deletednot'] = 'تعذر حذف {$a}.';
$string['deletepicture'] = 'حذف';
$string['deletesection'] = 'حذف';
...
$string['duplicatedsection'] = '{$a} (منسوخ)';
...
$string['editgroupprofile'] = 'تحرير وصف المجموعة';
...
$string['editsection'] = 'تحرير الإعدادات';
$string['editsectionname'] = 'تعديل اسم القسم';
$string['editsectionsettings'] = 'تحرير إعدادات المقطع';
$string['editsectiontitle'] = 'تحرير القسم: {$a}';
...
تم طلب إنشاء حساب جديد في \'{$a->sitename}\' باستعمال عنوانك البريدي.

لتأكيد حسابك الجديد، يرجى النقر على الرابط أدناه:

<a href="{$a->link}">تأكيد حسابك</a>


إذا كنت بحاجة إلى مساعدة، يرجى الاتصال بمشرف الموقع،
{$a->admin}';
...
$string['emailonlyallowed'] = 'لا يمكن استعمال هذا البريد الإلكتروني. نطاقات عناوين البريد المصرح لها هي: {$a}.';
$string['emailpasswordchangeinfo'] = 'مرحبًا {$a->firstname}،

شخص ما (ربما أنت) طلب كلمة مرور جديدة لحسابك \'{$a->username}\' في \'{$a->sitename}\'.

لتغيير كلمة المرور، يرجى النقر على الرابط الآتي:

<a href="{$a->link}">تغيير كلمة المرور</a>
...
لتأكيد العملية والحصول على كلمة المرور الجديدة مرسلةً لك عن طريق البريد الإلكتروني، يرجى النقر على الرابط الآتي:

<a href="{$a->link}">الحصول على كلمة مرور جديدة</a>
...
لتأكيد هذا الطلب، وتعيين كلمة مرور جديدة لحسابك، يرجى النقر على الرابط أدناه:

<a href="{$a->link}">إعادة تعيين كلمة المرور</a>


(هذا الرابط صالح لـ {$a->resetminutes} دقيقة من وقت تقديم الطلب).

إذا لم يصدر طلب إعادة تعيين كلمة المرور منك، لا حاجة لأي إجراء من جانبك.
...
$string['enddatewithtaskenabled'] = 'تاريخ انتهاء المقرر';
$string['enddatewithtaskenabled_help'] = 'التاريخ الذي يصير فيه المقرر مخفيًا عن الطلاب ولا يمكنهم بعده الوصول إليه.';
...
$string['eventcourseended'] = 'مساق انتهى';
...
$string['eventcoursestarted'] = 'مساق بدأ';
...
$string['eventsectionviewed'] = 'القسم تمت معاينته';
$string['eventunknownlogged'] = 'حدث غير معروف';
$string['eventurlblocked'] = 'عنوان رابط تم حظره';
...
$string['failedtaskbody'] = '<p>مرحبا {$a->firstname},</p>
<p>المهمة <b>{$a->taskname}</b> لقد فشلت المهمة عدة مرات و تتطلب الانتباة</p>
<p><a href="{$a->link}">عرض المهمة </a></p>';
$string['failedtaskcontexturlname'] = 'تقرير الحالة';
$string['failedtasksubject'] = 'فشلت المهمة :{a$}';
...
$string['forcepasswordchange_help'] = 'إذا تم تأشيره، ستتم مطالبة المستخدم بتغيير كلمة مروره عند تسجيل الدخول القادم.';
...
$string['forcepasswordresetfailurenotice'] = 'كلمة مرورك الحالية لم تعد متوافقة مع سياسة وضع كلمات المرور. لطفاً، تواصل مع مشرف مودل لطلب المساعدة.
   {$a}';
$string['forcepasswordresetnotice'] = 'كلمة مرورك الحالية لم تعد متوافقة مع سياسة تعريف كلمات المرور. عليك تعيين كلمة مرور جديدة للمتابعة.
   {$a}';
...
* النشاط الواحد - المساق يضم نشاط أو مورد واحد.
* الاجتماعي - يتمحور المساق حول منتدى رئيسي في صفحته. يمكن إضافة المزيد من النشاطات والموارد باستعمال كتلة النشاطات الاجتماعية.
* المقاطع المخصصة - المساق مقسم إلى مقاطع قابلة للتخصيص.
* المقاطع الأسبوعية - المساق مقسم إلى مقاطع تتعلق بكل أسبوع، وتبدأ من تاريخ بدئه.';
...
$string['go'] = 'إذهب';
$string['gobacktosite'] = 'العودة إلى الموقع';
...
$string['gradenoun'] = 'الدرجة';
$string['grades'] = 'التقديرات';
$string['gradeverb'] = 'الدرجة';
...
$string['highlightoff'] = 'إزالة التمييز';
$string['hits'] = 'نتائج';
...
$string['importinfo'] = 'استيراد العناصر من مساقات أخرى، مثل النشاطات، الكتب أو أحداث التقويم. لن يتم استيراد بيانات المستخدم.';
...
$string['includesubcategories'] = 'تضمين الأصناف الفرعية';
...
$string['insertcontentbefore'] = 'إدراج المحتوى قبل \'{$a->activityname}\'';
$string['insertcontentsection'] = 'إدراج المحتوى في المقطع \'{$a->sectionname}\'';
$string['insertresourceoractivitybefore'] = 'إدراج نشاط أو مورد قبل \'{$a->activityname}\'';
...
$string['invalidtaskclassname'] = 'فئة مهمة غير صالحة {$a}';
$string['invalidtaskid'] = 'مُعرَّف مهمة غير صالح';
...
$string['languagegood'] = 'حزمة اللغة هذه بأحدث حالة.';
...
$string['loginrequired'] = 'تسجيل الدخول مطلوب';
...
$string['makeavailablecmtitle'] = 'إجعل النشاط متاحًا';
...
$string['markedthistopic'] = 'القسم المُميز هو المقطع الحالي';
$string['markthistopic'] = 'ميِّز هذا القسم على أنه المقطع الحالي';
$string['match'] = 'مطابق';
...
$string['maximumgradex'] = 'الدرجة الكبرى: {$a}';
...
$string['maxlengthreached'] = 'تم بلوغ الحد الأقصى من الحروف والبالغ {$a}.';
...
$string['messageprovider:enrolcoursewelcomemessage'] = 'رسالة الترحيب للمنضم الجديد إلى المساق';
...
$string['messageprovider:failedtaskmaxdelay'] = 'وصلت المهمة إلى الحد الأقصى لتأخير الفشل';
...
$string['messageprovider:notices_help'] = 'هذه إشعارات قد يكون من المهم لمشرف الموقع مُشاهدتها.';
...
$string['modshow'] = 'عرض';
$string['modshowcmtitle'] = 'إظهار النشاط';
...
$string['moodledocslink'] = 'توثيقات هذه الصفحة';
$string['moodlelogo'] = 'شعار مودل';
$string['moodlenet:cannotconnecttoserver'] = 'يتعذر الاتصال بمخدم شبكة مودل';
$string['moodlenet:columnname'] = 'الاسم';
$string['moodlenet:columnsenddate'] = 'إرسال التاريخ';
$string['moodlenet:columnsendstatus'] = 'إرسال الحالة';
$string['moodlenet:columntype'] = 'النوع';
$string['moodlenet:configoauthservice'] = 'إختر خدمة مصادقة شبكة مودل OAuth 2 لتمكين المشاركة إلى موقع شبكة مودل ذاك. إذا كانت الخدمة غير موجودة بعد، فستحتاج إلى <a href="{$a}">إنشائها</a>.';
$string['moodlenet:deletedactivity'] = 'نشاط محذوف';
$string['moodlenet:deletedcourse'] = 'مساق محذوف';
$string['moodlenet:eventresourceexported'] = 'المورد تم تصديره';
$string['moodlenet:gotomoodlenet'] = 'الذهاب إلى مسودات شبكة مودل';
$string['moodlenet:issuerisnotauthorized'] = 'مُصدر شبكة مودل غير مصرح له';
$string['moodlenet:issuerisnotenabled'] = 'مُصدر شبكة مودل غير مُمكَّن';
$string['moodlenet:issuerisnotset'] = 'مُصدر شبكة مودل غير مهيأ في إدارة الموقع';
$string['moodlenet:nosharedresources'] = 'ليست هناك موارد مشارَك بها لعرضها حاليًا.';
$string['moodlenet:outboundsettings'] = 'إعدادات صادرات شبكة مودل';
$string['moodlenet:packagingandsending'] = 'يجري رزم ملفك وإرساله إلى شبكة مودل...';
$string['moodlenet:sharefailtext'] = 'وقع خطأ ما عند مشاركة محتواك إلى شبكة مودل.<br>ترجى المحاولة مرة أخرى لاحقًا.';
$string['moodlenet:sharefailtextwithsitesupport'] = 'وقع خطأ ما عند مشاركة محتواك إلى شبكة مودل.<br>ترجى المحاولة مرة أخرى لاحقًا أو <a href="{$a}">تواصل مع الدعم الفني للموقع</a>.';
$string['moodlenet:sharefailtitle'] = 'حدث خطأ ما';
$string['moodlenet:sharefilesizelimitexceeded'] = 'حجم المورد الذي بصدد مشاركته هو ({$a->filesize} بايت) يتجاوز الحد الأقصى البالغ {$a->filesizelimit} بايت.';
$string['moodlenet:sharenoticeactivity'] = 'تجري مشاركة هذا النشاط مع شبكة مودل بمثابة مورد.';
$string['moodlenet:sharenoticecourse'] = 'هذا المساق تجري مشاركته مع شبكة مودل على أنه مورد.';
$string['moodlenet:sharenoticepartial'] = 'النشاطات المحددة تجري مشاركتها مع شبكة مودل كموارد.';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} من النشاطات سيتم تضمينها في المساق.';
$string['moodlenet:shareprogress'] = 'تقدم المشاركة مع شبكة مودل';
$string['moodlenet:shareprogressinfo'] = 'القائمة تُظهر المقررات والنشاطات التي شاركتها مع شبكة مودل.<br>أنقر اسم المورد لمعاينته في شبكة مودل.';
$string['moodlenet:sharesuccesstext'] = 'أوشك على الانتهاء! قم بزيارة مسوداتك في شبكة مودل لإكمال مشاركة محتواك.';
$string['moodlenet:sharesuccesstitle'] = 'تم حفظه في مسودات شبكة مودل';
$string['moodlenet:sharetomoodlenet'] = 'المشاركة إلى شبكة مودل';
$string['moodlenet:sharetyperesource'] = 'المورد';
$string['moodlenet:sharinglargefile'] = 'الملفات الكبيرة قد تستغرق بعض الوقت.';
$string['moodlenet:sharingstatus'] = 'المشاركة إلى شبكة مودل';
$string['moodlenet:sharingto'] = 'المشاركة إلى:';
...
$string['multipleitemsfound'] = 'تم العثور على {$a} من العناصر.';
...
لقد تم إنشاء حساب لك في \'{$a->sitename}\'
...
<a href="{$a->link}">أنقر لتسجيل الدخول</a> لتبدأ باستعمال \'{$a->sitename}\'.
...
$string['nodstpresets'] = 'لم يقم مشرف الموقع بتمكين دعم التوقيت الصيفي';
...
$string['noitemsfound'] = 'لم يُعثر على أي عناصر.';
...
$string['passwordextlink'] = 'الرابط الآتي تم توفيره لمساعدتك في استرجاع كلمة مرورك المفقودة. هذا سيأخذك خارج مودل.';
...
$string['passwordnohelp'] = 'لا توجد مساعدة للحصول على كلمة مرورك. الرجاء الاتصال بمشرف الموقع.';
...
$string['pathslasherror'] = 'لا يمكن إنهاء المسار بعلامة مائلة.';
$string['paymentinstant'] = 'استعمل الزر أدناه لتسديد الرسوم والانضمام خلال دقائق.';
...
$string['paymentsorry'] = 'شكراً لقيامك بتسديد المبلغ. بعد فترة معالجته ستتمكن من الدخول إلى المساق {$a->fullname}. الرجاءً الانتظار ثم المحاولة مجددًا. إذا استمر ظهور المشاكل عندك، تواصل مع {$a->teacher} أَو مشرف الموقع.';
$string['paymentthanks'] = 'شكراً لقيامك بتسديد المبلغ. أنت الآن منضم إلى المساق {$a}.';
...
$string['pluginmissingfromdisk'] = '{$a->name} (مفقود من القرص الصلب)';
...
$string['policyagreementclick'] = 'اتفاقية سياسة الموقع';
$string['popup'] = 'منبثقة';
...
$string['previewthemename'] = 'استعراض القالب \'{$a}\'';
...
$string['primaryadminsetup'] = 'إعداد حساب مشرف الموقع';
$string['privacy:metadata:config_log'] = 'سجل وقوعات تعديلات الإعدادات';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'تفاصيل تقدم مشاركة شبكة مودل';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'مُعرَّف وحدة المساق ذي الصلة';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'مُعرَّف المساق ذي الصلة';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = 'عنوان الرابط المُعاد من شبكة مودل بعد المشاركة الموفقة';
$string['privacy:metadata:moodlenet_share_progress:status'] = 'الحالة الناتجة من المشاركة';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = 'وقت إجراء المشاركة';
$string['privacy:metadata:moodlenet_share_progress:type'] = 'نوع المشاركة المنفذ';
$string['privacy:metadata:moodlenet_share_progress:userid'] = 'المستخدم الذي نفذ المشاركة';
...
$string['privacy:metadata:task_log'] = 'مخرجات التوثيق لسجل الوقوعات';
...
$string['privacy:metadata:upgrade_log'] = 'سجل وقوعات الترقية';
...
$string['privacy:metadata:upgrade_log:type'] = 'نوعية مُدخَل سجل الوقوعات';
...
$string['resendemail'] = 'إعادة إرسال البريد الالكتروني للتأكيد';
$string['reset'] = 'إعادة التعيين';
$string['resetcomponent'] = 'مكوّن';
$string['resetcourse'] = 'إعادة تعيين المقرر';
$string['resetcourseconfirm'] = 'أتريد إعادة تعيين المساق؟';
$string['resetcoursewarning'] = 'هل أنت متأكد من رغبتك في إعادة تعيين المساق \'{$a}\'?
<br/><br/>
هذا من شأنه حذف البيانات المحددة وإعادة تعيين المساق إلى حالته الأصلية. لا يمكنك التراجع عن هذا الإجراء؟';
$string['resetinfo'] = 'هذه الميزة تسمح لك بإزالة كل بيانات المستخدمين وإعادة تعيين المساق إلى حالته الأصلية، مع الإبقاء على الإعدادات والنشاطات كما هي.';
$string['resetinfoselect'] = 'إختر البيانات التي ترغب بحذفها أو إعادة تعيينها من التصنيفات أدناه:';
$string['resetnotimplemented'] = 'إعادة التعيين غير مدعومة';
$string['resetnotimplementedinfo'] = 'هذه النشاطات لا يمكن إعادة تعيينها:';
...
$string['resettask'] = 'إعادة التعيين';
...
$string['restoreinfo'] = 'استعمل ملف الحفظ الاحتياطي لاستعادة نسخة سابقة من المساق، أو لإنشاء مساق جديد.';
...
$string['rolerenaming_help'] = 'تغيير أسماء الأدوارِ المعروضة في هذا المساق.';
$string['rolerenaming_success'] = 'أسماء أدوار المساق تم تحديثها.';
...
$string['rsserrorauth'] = 'لا يحتوي رابط خدمة التغذية على مفتاح مصادقة صالح';
...
$string['searchgroups'] = 'إبحث في المجموعات';
$string['searchitems'] = 'إبحث في العناصر';
$string['searchoptions'] = 'خيارات البحث';
$string['searchresults'] = 'نتائج البحث';
$string['searchusers'] = 'إبحث في المستخدمين';
$string['sec'] = 'ثانية';
...
$string['sectionoutline'] = 'الخطوط العريضة للقسم';
...
$string['selecttheme'] = 'إختر القالب';
$string['selectthemename'] = 'إختر القالب \'{$a}\'';
...
$string['separateandconnected1'] = 'غالباً تعلُّم منفصل';
$string['separateandconnected2'] = 'منفصل ومتصل';
$string['separateandconnected3'] = 'غالباً تعلُّم متصل';
...
$string['signoutofotherservices'] = 'تسجيل خروج من كل تطبيقات الويب';
$string['signoutofotherservices_help'] = 'تسجيل خروج شامل لكافة الاجهزة والنظم التي تستعمل خدمات الويب بما في ذلك تطبيقات الجوالات. جلسات مستعرضات الويب ستبقى فعالة.';
$string['since'] = 'منذ';
...
$string['sitesection'] = 'إضافة محتوى مخصص';
...
$string['startdatewithtaskenabled'] = 'تاريخ بدء المقرر';
$string['startdatewithtaskenabled_help'] = 'التاريخ الذي يصير فيه المساق مرئيًا للطلاب. قبل هذا التاريخ لن يكون بإمكانهم الوصول إلى المساق.

هذا التاريخ يحدد أيضًا بداية الأسبوع الأول بالنسبة إلى المساق الذي بالتنسيق الأسبوعي، وهو تاريخ سجل وقوعات نشاطات المساق. إذا أعدت تعيين المساق وغيرت هذا التاريخ، فكل التواريخ التي في المساق سيتم تزحيفها بالنسبة إلى موعد البدء الجديد.';
...
$string['statuschecks'] = 'فحوصات الحالة';
$string['statuscritical'] = 'حرِج';
$string['statusdone'] = 'تم';
...
$string['submit'] = 'تسليم';
$string['subsectionmoveerror'] = 'لا يمكن نقل المقطع الفرعي هذا إلى مقطع فرعي آخر.';
...
$string['tag'] = 'علامة';
$string['tagalready'] = 'هذة الدرجة موجودة مسبقاً';
...
$string['thanks'] = 'ًشكرا';
$string['theme'] = 'القالب';
$string['themepreviewdescription'] = 'وصف القالب {$a}';
$string['themepreviewimage'] = 'صورة استعراض {$a}';
$string['themes'] = 'القوالب';
$string['themesaved'] = 'تم حفظ القالب الجديد';
...
$string['trackforumsyes'] = 'نعم: أبرز المنشورات الجديدة لي';
...
$string['usermatchedon'] = 'هذا المستخدم يطابق البحث عبر الحقل الآتي';
...
$string['userselectorsearchanywhere'] = 'أي مكان';
$string['userselectorsearchexactmatchonly'] = 'التطابق التام فقط';
$string['userselectorsearchfromstart'] = 'من البدء';
$string['userselectorsearchmatching'] = 'يطابق:';
...
$string['viewallresults'] = 'معاينة كل النتائج ({$a})';
...
$string['viewresults'] = 'معاينة نتائج {$a}';
...
$string['welcometocoursetext'] = 'مرحبًا في {$a->coursename}!

إن لم يسبق لك القيام بذلك، فعليك تعديل صفحة حسابك الشخصي حتى نتعرف عليك أكثر:
...
$string['wontrunfuturescheduledtask'] = 'لن يقوم بتشغيل المهمة التي لم تفشل والتي تمت جدولتها للتشغيل مستقبلاً';
