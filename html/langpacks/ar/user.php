...
/**
 * Strings for component 'user', language 'ar', version '4.5'.
 *
 * @package     user
 * @category    string
...
$string['privacy:metadata:appid'] = 'مُعرَّف التطبيق، عادة شيء مماثل لـ com.moodle.moodlemobile';
$string['privacy:metadata:auth'] = 'ملحق المصادقة المستعمل لسجل المستخدم هذا';
$string['privacy:metadata:autosubscribe'] = 'تفضيل، لتحديد فيما إذا كان ينبغي اعتبار المستخدم مشتركاً بشكل تلقائي في المنتديات التي ينشر فيها';
$string['privacy:metadata:calendartype'] = 'تفضيل المستخدم بالنسبة إلى نوع التقويم الذي يستعمله';
$string['privacy:metadata:category'] = 'مُعرَّف التصنيف';
...
$string['privacy:metadata:fieldid'] = 'المُعرَّف المرتبط بالحقل المخصص للمستخدم';
$string['privacy:metadata:filelink'] = 'هناك ملفات متعددة ومختلفة للمستخدم مخزونة في جدول الملفات';
$string['privacy:metadata:firstaccess'] = 'وقت أول دخول لهذا المستخدم إلى الموقع';
...
$string['privacy:metadata:idnumber'] = 'رقم تعريفي معطى من قبل المؤسسة';
$string['privacy:metadata:imagealt'] = 'النص البديل لصورة المستخدم';
$string['privacy:metadata:infotablesummary'] = 'يخزن معلومات المستخدم المخصصة';
...
$string['privacy:metadata:lastname'] = 'الاسم الأخير للمستخدم';
$string['privacy:metadata:lastnamephonetic'] = 'التفاصيل الصوتية عن الاسم الأخير للمستخدم';
$string['privacy:metadata:maildigest'] = 'إعداد عن تلخيص الرسائل لهذا المستخدم';
...
$string['privacy:metadata:passwordtablesummary'] = 'سجل دوار لخلطات مشفرة من كلمات المرور السابقة للمستخدم';
$string['privacy:metadata:phone'] = 'رقم هاتف المستخدم';
$string['privacy:metadata:picture'] = 'تفاصيل الصورة المتعلقة بهذا المستخدم';
...
$string['privacy:metadata:shortname'] = 'اسم مختصر للمساق الدراسي';
...
$string['privacy:metadata:theme'] = 'تفضيل المستخدم لقالب العرض';
...
$string['privacy:metadata:timererequested'] = 'الوقت الذي أعاد فيه المستخدم المطالبة بإعادة تعيين كلمة المرور';
$string['privacy:metadata:timezone'] = 'المنطقة الزمنية للمستخدم';
$string['privacy:metadata:token'] = 'عبارة السر المجهزة والمرسلة إلى المستخدم';
...
$string['privacy:metadata:user_preference:core_user_welcome'] = 'يتم توثيق الطابع الزمني في لحظة إظهار رسالة الترحيب للمستخدم للمرة الأولى.';
...
$string['privacy:metadata:yahoo'] = 'مُعرَّف Yahoo للمستخدم';
$string['privacy:passwordhistorypath'] = 'ماضي كلمات المرور';
$string['privacy:passwordresetpath'] = 'إعادة تعيينات كلمة المرور';
...
$string['supportmessagesentforloggedoutuser'] = 'كن حذرًا مع هذه الرسالة. لم يكن المرسِل مسجلاً لدخوله، لذلك لم تتأكد هويته.';
