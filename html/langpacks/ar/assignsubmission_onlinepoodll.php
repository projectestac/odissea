...
/**
 * Strings for component 'assignsubmission_onlinepoodll', language 'ar', version '3.11'.
 *
...
$string['onlinepoodll'] = 'Poodll عبر الإنترنت';
$string['onlinepoodll:reviewsubmissions'] = 'مراجعة تسليمات Poodll عبر الإنترنت (التسجيلات)';
$string['onlinepoodll:use'] = 'السماح باستعمال تسليمات Poodll عبر الإنترنت';
...
$string['setting_video_heading_details'] = 'الإعدادات التي تتحكم بظهور المشغل في صفحات مراجعة التسليم وقوائمها';
$string['setting_whiteboard_heading'] = 'إعدادات صورة السبورة';
$string['setting_whiteboard_heading_details'] = 'الإعدادات التي تتحكم بظهور الصور في صفحات مراجعة التسليم وقوائمها';
