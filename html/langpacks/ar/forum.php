...
/**
 * Strings for component 'forum', language 'ar', version '4.5'.
 *
 * @package     forum
 * @category    string
...
$string['allowsallsubscribe'] = 'يسمح هذا المنتدى للجميع بالاختيار ما بين الاشتراك وعدمه.';
...
$string['cannotaddteacherforumto'] = 'تعذرت إضافة عينة منتدى المُعلِّم المحولة إلى القسم 0 في المقرر الدراسي';
$string['cannotcreatediscussion'] = 'تعذر إنشاء مناقشة جديدة';
$string['cannotcreateinstanceforteacher'] = 'تعذر إنشاء عينة مقرر جديد لمنتدى المعلم';
...
$string['cannotuseseperategroupsandsingletopic'] = 'لا يمكن استعمال المجموعات المنفصلة مع موضوع المناقشة الواحد.';
$string['cannotusesingletopicandseperategroups'] = 'لا يمكن استعمال موضوع المناقشة الواحد مع المجموعات المنفصلة.';
$string['cannotviewpostyet'] = 'لا تستطيع قراءة منشورات الطلاب الآخرين في هذه المناقشة لأنك لم تطرح أي مشاركة بعد.';
...
$string['configenablerssfeeds'] = 'هذا سيمكن خدمة تغذية المعلومات لكل المنتديات. ستحتاج القيام بتفعيل خدمة تغذية المعلومات يدوياً من خلال إعدادات كل منتدى.';
$string['configenabletimedposts'] = 'أضبطه على \'نعم\' إذا أردت السماح بتحديد فترات العرض عند نشر مناقشة جديدة في المنتدى.';
$string['configlongpost'] = 'أي منشور يزيد عن هذا الحد (مقاساً بالحروف غير المتضمنة لرموز HTML) يعتبر طويلاً. المنشورات المعروضة في صفحة واجهة الموقع، صفحات المساقات ذات النمط الاجتماعي، أو الملفات الشخصية للمستخدمين يتم تقصيرها إلى فاصل طبيعي في موضع ما بين قيمتي forum_shortpost و forum_longpost.';
...
$string['configshortpost'] = 'أي منشور أقل من هذا الحد (مقاساً  بالحروف بدون إحتساب رموز HTML) يعتبر قصير (أنظر أدناه).';
...
$string['configusermarksread'] = 'إن كانت \'نعم\'، فعلى المستخدم يدويًا تأشير المنشور على أنه مقروء. إن كانت \'لا\'، سيعتبر المنشور مقروءًا بمجرد معاينته.';
...
$string['discussionsstartedincourse'] = 'المناقشات التي بدأت في {$a}';
...
$string['edit'] = 'تحرير';
$string['editdiscussion'] = 'تحرير المناقشة';
$string['editdiscussiontopic'] = 'تحرير موضوع المناقشة';
...
$string['errordiscussionnotfound'] = 'تعذر العثور على المناقشة';
...
$string['errorforumnotfound'] = 'تعذر العثور على المنتدى الذي تعود له هذه المناقشة';
...
$string['forcesubscribed'] = 'هذا المنتدى يجبر الكل على الاشتراك.';
...
* منتدى سؤال وجواب - ينبغي على الطلاب نشر ردودهم أولاً على سؤال يطرحه المعلم قبل أن يتمكنوا من رؤية منشورات باقي الطلاب
...
$string['grade_forum_title'] = 'الدرجة';
...
* وضع إعلانات المساق (باستعمال منتدى الأخبار ذي الاشتراك المفروض)
...
$string['namenews_help'] = 'منتدى الإعلانات في المقرر الدراسي هو منتدى خاص لأغراض الإعلان ويتم إنشاؤه تلقائياً عند إنشاء المقرر الدراسي. يمكن للمساق أن يحتوي على منتدى إعلانات واحد فقط. المعلمون والمشرفون فقط يمكنهم نشر الإعلانات. كتلة "آخر الإعلانات" ستعرض آخر منشورات هذا المنتدى.';
...
$string['nopostforum'] = 'ليس مسموحاً لك بالنشر في هذا المنتدى.';
...
$string['notingroup'] = 'ينبغي أن تكون ضمن مجموعة لمعاينة هذا المنتدى.';
...
$string['nowsubscribed'] = 'سيتم إبلاغك بشأن المنشورات الجديدة في المنتدى \'{$a->forum}\'.';
...
$string['postsmadeincourse'] = 'المنشورات التي كُتبت في {$a}';
...
$string['privatereply_help'] = 'عندما ترد بشكل خاص، سيكون منشورك مرئيًا أيضاً للمستخدمين الذين لديكم إمكانية معاينة الردود الخاصة، مثل المعلمين.';
$string['processingdigest'] = 'معالجة الموجز البريدي للمستخدم {$a}';
$string['processingpost'] = 'معالجة الرسالة {$a}';
$string['prune'] = 'إقسم';
$string['prunediscussion'] = 'تجزئة المناقشة';
...
$string['qandanotify'] = 'هذا منتدى سؤال وجواب. لمعاينة ردود الآخرين، ينبغي عليك تقديم إجابتك أولاً.';
$string['re'] = 'رد:';
$string['readtherest'] = 'قراءة باقي الموضوع';
$string['removeallforumtags'] = 'كل وسوم المنتدى';
...
$string['replypostdiscussion'] = 'الرد على المناقشة';
...
$string['resetdigests'] = 'كل تفضيلات إيجاز المنتدى على مستوى المستخدمين';
$string['resetforums'] = 'حذف المنشورات من';
$string['resetforumsall'] = 'كل المنشورات';
$string['resetsubscriptions'] = 'كل اشتراكات المنتدى';
$string['resettrackprefs'] = 'كل تفضيلات تعقب المنتدى';
...
$string['subplugintype_forumreport'] = 'تقرير المنتدى';
$string['subplugintype_forumreport_plural'] = 'تقارير المنتدى';
$string['subscribe'] = 'اشترك في المنتدى';
...
$string['subscriptionmodeconfirm'] = 'هل أنت متأكد من رغبتك في تغيير نمط الاشتراك إلى {$a}؟';
...
إذا تم جعله إختيارياً، يمكن للمشاركين التخيَُر ما بين تفعيل تعقب القراءة أو تعطيله في المنتدى. (على المستخدمين أيضاً تمكين تعقب القراءة في تفضيلاتهم الشخصية).

إذا تم تمكين \'إسمح بفرض تعقب القراءة\' من قبل مشرف الموقع، فعندها سيظهر خيار إضافي، وهو الفرض. هذا معناه أن التعقب مفعل دائماً بغض النظر عن التفضيل الشخصي للمستخدم.';
...
$string['unsubscribe'] = 'إلغاء الاشتراك في المنتدى';
