...
$string['cannotaddteacherforumto'] = 'تعذرت إضافة عينة منتدى المُعلِّم المحولة إلى المقطع 0 في المساق';
$string['cannotcreatediscussion'] = 'تعذر إنشاء مناقشة جديدة';
$string['cannotcreateinstanceforteacher'] = 'تعذر إنشاء عينة مساق جديد لمنتدى المعلم';
...
$string['cannotmovetonotfound'] = 'تعذر العثور على المنتدى المقصود في هذا المساق.';
...
$string['configlongpost'] = 'أي منشور يزيد عن هذا الحد (مقاساً بالحروف غير المتضمنة لرموز HTML) يعتبر طويلاً. المنشورات المعروضة في الصفحة الأمامية للموقع، صفحات المساقات ذات النمط الاجتماعي، أو الملفات الشخصية للمستخدمين يتم تقصيرها إلى فاصل طبيعي في موضع ما بين قيمتي forum_shortpost و forum_longpost.';
...
$string['errorenrolmentrequired'] = 'ينبغي أن تكون منضماً إلى هذا المساق للوصول إلى هذا المحتوى';
$string['errorwhiledelete'] = 'وقع خطأ عند حذف السجل.';
$string['eventassessableuploaded'] = 'تم نشر بعض المحتوى.';
$string['eventcoursesearched'] = 'تم البحث في المساق';
...
$string['eventdiscussionviewed'] = 'تمت معاينة المناقشة';
...
$string['eventsubscribersviewed'] = 'تمت معاينة المشتركين';
$string['eventsubscriptioncreated'] = 'تم إنشاء الاشتراك';
$string['eventsubscriptiondeleted'] = 'تم حذف الاشتراك';
$string['eventuserreportviewed'] = 'تمت معاينة تقرير المستخدم';
...
$string['forcedreadtracking_desc'] = 'إسمح للمنتديات بأن تفرض تعقب القراءة. هذا سيقلل مستوى الأداء لدى بعض المستخدمين، وبخاصة في المساقات ذات العدد الكبير من المنتديات والمنشورات. عند إيقافه، كل المنتديات التي تم فيها فرض التعقب سابقاً ستعامل على أنه أمر إختياري.';
...
$string['introblog'] = 'المنشورات في هذا المنتدى تم نسخها تلقائياً من مدونات المستخدمين في هذا المساق لأن تلك المدخلات لم تعد متوافرة';
...
يمكن تقييم منشورات المنتدى من قبل المعلمين أو الطلاب (تقييم النظراء). يمكن تجميع التقييمات للخروج منها بالعلامة النهائية التي يتم تسجيلها في سجل العلامات.

للمنتديات  العديد من الاستعمالات، مثل:

* فضاء اجتماعي للطلاب للتعرف على بعضهم البعض
* وضع إعلانات المساق (باستعما منتدى الأخبار ذي الاشتراك المفروض)
* مناقشة محتوى المساق أو مواد القراءة
...
$string['namenews_help'] = 'منتدى الإعلانات في المساق هو منتدى خاص لأغراض الإعلان ويتم إنشاؤه تلقائياً عند إنشاء المساق. يمكن للمساق أن يحتوي على منتدى إعلانات واحد فقط. المعلمون والمشرفون فقط يمكنهم نشر الإعلانات. كتلة "آخر الإعلانات" ستعرض آخر منشورات هذا المنتدى.';
