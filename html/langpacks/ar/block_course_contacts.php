...
/**
 * Strings for component 'block_course_contacts', language 'ar', version '4.4'.
 *
...
$string['course_contacts:addinstance'] = 'إضافة كتلة جديدة من جهات اتصال المقرر';
$string['course_contacts:myaddinstance'] = 'إضافة كتلة جديدة من جهات اتصال المقرر إلى لوحة التحكم';
$string['hideblockforguest'] = 'إخفاء الكتلة بأكملها عن المستخدمين ذوي دور الضيوف.';
$string['online'] = 'متصل بالإنترنت';
$string['pluginname'] = 'جهات اتصال المقرر';
