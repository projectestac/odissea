...
/**
 * Strings for component 'atto_image', language 'ar', version '4.4'.
 *
 * @package     atto_image
 * @category    string
...
$string['imageurlrequired'] = 'ينبغي أن يكون للصورة عنوان رابط';
...
$string['privacy:metadata'] = 'إن إضافة atto_image لا تخزن أي بيانات شخصية.';
