...
$string['aggregationcoefextra_help'] = 'إن كان الإجمال بطريقة \'بسيط\' أو \'متوسط موزون بسيط\' وكانت خانة الرصيد الإضافي مؤشرة، فإن الدرجة القصوى للمفردة لن تتم إضافتها إلى الدرجة القصوى للتصنيف. هذا سيؤدي إلى احتمالية الوصول إلى الدرجة القصوى في التصنيف بدون تحقيق الدرجة القصوى في كل المفردات. إذا قام المشرف على الموقع بتمكين خيار السماح بتجاوز الدرجة القصوى، فقد تظهر درجات أعلى من الدرجة القصوى.
...
$string['aggregationcoefweight_help'] = 'وزن المفردة يُستعمل في احتساب إجمالي التصنيف للتأثير على أهمية المفردة مقارنة مع باقي المفردات ضمن نفس التصنيف.';
...
$string['aggregationposition_help'] = 'يحدد هذا الخيار ما إذا كانت أعمدة مجموع التصنيف أو المقرر الدراسي ستظهر أولاً أم آخراً في تقارير سجلات التقديرات.';
...
$string['calculation_help'] = 'معادلة الدرجات هي معادلة تستعمل لاحساب الدرجة الإجمالية. ينبغي بدء المعادلة بعلامة المساواة (=) ويمكنها أن تتضمن العوامل الرياضية المتداولة، مثل: max، min و sum. عند الرغبة، يمكن تضمين المفردات الأخرى في الحساب عبر إدخال مُعرَّفاتها محصورة بين أقواس مربعة مزدوجة.';
...
$string['coursegradesettings'] = 'إعدادات تقديرت المقرر الدراسي';
...
$string['errorupdatinggradeitemaggregationcoef'] = 'وقع خطأ عند تحديث معامل الإجمالي (الوزن أو الرصيد الإضافي) للمفردة ذات المُعرَّف {$a->id}';
...
$string['gradebookcalculationswarning'] = 'ملاحظة: تم اكتشاف بعض الأخطاء في حساب التقديرات المعروضة في سجل التقديرات. إن كان المقرر الدراسي لم يبدأ بعد أو لا زال مستمراً، من الموصى به إصلاح الأخطاء عبر النقر على الزر أدناه، رغم أن ذلك قد يؤدي إلى تغيير في بعض التقديرات. إن كان المقرر قد انتهى والتقديرات قد تم إعلانها، قد لا يناسبك إصلاح هذه المشكلة.
...
$string['grademax_help'] = 'هذا الإعداد يحدد الدرجة العظمى عند استعمال التقييم المبني على القيم الرقمية. الدرجة العظمى بالنسبة إلى مفردة التقييم العائدة إلى نشاط يتم ضبطها في صفحة إعدادات النشاط.';
...
$string['gradepass_help'] = 'هذا الإعداد يحدد الدرجة الصغرى المطلوبة للنجاح. هذه القيمة تستعمل في إكمال النشاط والمقرر الدراسي، وفي سجل التقديرات، حيث يتم إظهار الدرجات الناجحة باللون الأخضر والراسبة باللون الأحمر.';
...
$string['gradesonly'] = 'التغيير في التقديرات فقط';
...
يمكن تجميع التقديرات من نوعي القيمة والمقياس فقط. نوع التقييم للمفردة المبنية على نشاط يمكن ضبطها في صفحة إعدادات النشاط.';
...
* الأعمدة الأخرى ينبغي أن تكون لها عناوين تشير إلى النشاطات الموجودة أو مفردات التقييم.
...
$string['lessthanmin'] = 'الدرجة المعطاة للمفردة {$a->itemname} والممنوحة لـ {$a->username} أصغر من القيمة الصغرى المسموح بها';
$string['letter'] = 'حرف';
...
$string['mappings_help'] = 'لكل عمود من التقديرات في الجدول، إختر مفردة التقييم المقابلة لها، لاستيراد التقديرات إليها.';
...
$string['meanselection_help'] = 'هذا الإعداد يحدد فيما إذا كانت الخلايا الخالية من تقديرات ينبغي تضمينها عند احتساب المعدل (المتوسط) لكل تصنيف أو مفردة تقييم.';
$string['median'] = 'متوسط';
$string['min'] = 'الأدنى';
...
$string['modgradecantchangegradetype'] = 'لا يمكنك تغيير النوع نظراً لوجود تقديرات مسبقاً لهذه المفردة.';
...
$string['modgradecantchangegradetyporscalemsg'] = 'لقد سبق منح بعض التقديرات بالفعل، ولذلك يتعذر تغيير نوع المفردة ومقياسها.';
$string['modgradecantchangeratingmaxgrade'] = 'لا يمكنك تغيير الدرجة العليا عندما تكون الدرجات ممنوحة مسبقاً لنشاط فيه تقييمات.';
$string['modgradecantchangescale'] = 'لا يمكنك تغيير المقياس نظراً لوجود التقديرات مسبقاً في هذه المفردة.';
...
$string['modgradecategorycantchangegradetyporscalemsg'] = 'هذا التصنيف فيه مفردات تقييم مرتبطة بنشاطات قد تم تجاوزها، لهذا فإن بعض الدرجات قد تم منحها سلفاً وصار متعذراً تغيير نوع الدرجة.';
...
على سبيل المثال، إذا تم وضع هذا الخيار على \'نعم\'، فتغيير الدرجة العليا لمفردة ما من 10 إلى 20 سيؤدي إلى إعادة مقايسة الدرجة 6 من 10 (60%) لتصير 12 من 20 (60%). أما عند ضبط هذا الخيار على \'لا\'، ستبقى الدرجة كما هي، مما يستدعي التعديل اليدوي عليها لضمان صحة النتائج.';
...
$string['multfactor_help'] = 'معامل الضرب هو المعامل الذي تُضرب به كل الدرجات العائدة لمفردة التقييم هذه مع القيمة العظمى، مع مراعاة عدم تجاوزها. على سبيل المثال؛ إذا كان المعامل 2 والدرجة العظمى 100، فإذن كل الدرجات التي تقل عن 50 سيتم ضربها في 2، وكل الدرجات من 50 فما أعلى ستتغير إلى 100.';
...
$string['overridesitedefaultgradedisplaytype_help'] = 'عند تأشيره، يمكن تحديد حروف التقديرات ومدياتها للمقرر بدلاً من استعمال إفتراضيات الموقع.';
...
$string['recovergradesdefault_help'] = 'إفتراضياً، قم باستعادة التقديرات الماضية للمستخدم عند إعادة ضمه إلى المقرر الدراسي.';
...
$string['removeallcoursegrades_help'] = 'عند تأشيرها، فإن كل مفردات التقييم والتقديرات التي تمت إضافتها يدوياً إلى سجل التقديرات ستُحذف، مع بيانات التقديرات في التجاوز، الاستبعاد، الإخفاء والتأمين. ستبقى فقط التقديرات المرتبطة بالنشاطات.';
...
$string['seeallcoursegrades'] = 'مشاهدة كل تقديرات المقرر الدراسي';
...
$string['showaverage_help'] = 'فيما إذا كان ينبغي إظهار عمود المعدل. لاحظ أن بإمكان المشاركين تقدير درجات الآخرين إن كان المعدل محسوباً من عدد قليل من الدرجات. لأسباب تتعلق بالأداء، المعدل سيكون تقريبياً إن كان معتمداً على أي مفردات مخفية.';
...
* إظهاره مخفياً - أسماء المفردات المخفية ستظهر لكن تقديراتها سيتم إخفاؤها
...
$string['unenrolledusersinimport'] = 'عملية الاستيراد هذه تضمنت التقديرات الآتية لمستخدمين ليسوا منضمين حالياً إلى هذا المقرر الدراسي: {$a}';
...
$string['weightcourse'] = 'استعمل التقديراتالموزونة في المقرر الدراسي';
