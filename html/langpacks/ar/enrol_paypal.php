...
/**
 * Strings for component 'enrol_paypal', language 'ar', version '4.5'.
 *
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:business'] = 'عنوان البريد الالكتروني أو مُعرَّف حساب PayPal لمستلم التسديد المالي (أي التاجر)';
