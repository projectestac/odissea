...
$string['errdisabled'] = 'ملحق انضمام PayPal معطل ولا يتعامل مع إشعارات الانضمام.';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:courseid'] = 'مُعرَّف المقرر الدراسي المباع';
$string['privacy:metadata:enrol_paypal:enrol_paypal:instanceid'] = 'مُعرَّف عينة الانضمام في المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:enrol_paypal:item_name'] = 'الاسم الكامل للمقرر الدراسي الذي تم بيع الانضمام إليه';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:userid'] = 'مُعرَّف المستخدم الذي اشترى الانضمام إلى المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:paypal_com'] = 'إن ملحق انضمام PayPal ينقل بيانات المستخدم من مودل إلى موقع PayPal';
$string['privacy:metadata:enrol_paypal:paypal_com:address'] = 'عنوان سكن المستخدم الذي يشتري المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:paypal_com:city'] = 'مدينة المستخدم الذي يشتري المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:paypal_com:country'] = 'بلد المستخدم الذي يشتري المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:paypal_com:custom'] = 'نص مفصول بواصلات يتضمن مُعرَّف المستخدم (المشتري)، مُعرَّف المقرر الدراسي، مُعرَّف عينة الانضمام';
$string['privacy:metadata:enrol_paypal:paypal_com:email'] = 'عنوان البريد الالكتروني للمستخدم الذي يشتري المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:paypal_com:first_name'] = 'الاسم الأول للمستخدم الذي يشتري المقرر الدراسي';
$string['privacy:metadata:enrol_paypal:paypal_com:last_name'] = 'الاسم الأخير للمستخدم الذي يشتري المقرر الدراسي';
...
$string['status_desc'] = 'إسمح للمستخدمين باستعمال PayPal للانضمام إلى المقرر الدراسي إفتراضياً.';
