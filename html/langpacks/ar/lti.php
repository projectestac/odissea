...
/**
 * Strings for component 'lti', language 'ar', version '3.8'.
 *
 * @package     lti
 * @category    string
...
$string['basiclti_in_new_window_open'] = 'افتح في نافذة جديدة';
...
$string['contentitem_help'] = 'إذا تم وضع علامة ، فسيكون خيار "اختيار المحتوى" متاحًا عند إضافة أداة خارجية.';
...
$string['courseinformation'] = 'معلومات المادة';
...
$string['editdescription'] = 'انقر هنا لإعطاء هذه الأداة وصفًا';
$string['edittype'] = 'تحرير أداة مسبقة التكوين';
$string['embed'] = 'ضمّن';
$string['embed_no_blocks'] = 'ضمّن ، دون كتل';
...
$string['external_tool_type'] = 'أداة مسبقة التكوين';
$string['external_tool_type_help'] = 'الغرض الرئيسي من تكوين الأداة هو إقامة قناة اتصال آمن بين مودل و موفر الأداة. فإنه يوفر أيضا فرصة لتكوين افتراضات و إنشاء الخدمات الإضافية التي تقدمها الأداة .
* ** تلقائي ، بناءً على رابط الأداة ** - يتم تحديد أفضل تكوين للأداة تلقائيًا. إذا لم يتم التعرف على رابط الأداة ، فقد يلزم إدخال تفاصيل تكوين الأداة يدويًا.
* ** أداة محددة مسبقًا ** - سيتم استخدام تكوين الأداة للأداة المحددة عند الاتصال بموفر الأداة الخارجية. إذا لم يكن رابط الأداة ينتمي إلى موفر الأداة ، فسيظهر تحذير. ليس من الضروري دائمًا إدخال رابط للأداة.
* ** التكوين المخصص ** - قد يلزم إدخال مفتاح المستفيد و السر المشترك يدويًا. يمكن الحصول على مفتاح المستفيد و السر المشترك من مزود الأداة. و مع ذلك ، لا تتطلب جميع الأدوات مفتاح عميل و سر مشترك ، وفي هذه الحالة قد تترك الحقول فارغة.
 ### تحرير الأداة المُعدة مسبقًا تتوفر ثلاثة أيقونات بعد القائمة المنسدلة للأداة المُعدة مسبقًا:
 * ** أضف** - إنشاء تكوين أداة على مستوى المادة. قد تستخدم جميع مثيلات الأداة الخارجية في هذه المادة لتكوين الأداة.
* ** تحرير ** - حدد أداة مستوى المادة من القائمة المنسدلة ، ثم انقر فوق هذا الرمز. قد يتم تحرير تفاصيل تكوين الأداة.
* ** حذف ** - إزالة أداة مستوى المادة المحددة.';
$string['external_tool_types'] = 'أدوات سابقة التكوين';
...
$string['indicator:cognitivedepth'] = 'أدوات التعلم المشتركة المعرفية';
...
$string['indicator:socialbreadth'] = 'أدوات التعلم المشتركة الاجتماعية';
$string['indicator:socialbreadth_help'] = 'يستند هذا المؤشر إلى الاتساع الاجتماعي الذي تم التوصل إليه بواسطة الطالب في نشاط أدوات التعلم المشتركة.';
...
$string['launch_url_help'] = 'يشير إطلاق العنوان إلى عنوان ويب لأداة خارجية ، و ربما تحتوي على معلومات إضافية ، مثل إظهار الموارد .
إذا كنت غير متأكد من الدخول لإطلاق العنوان ، يرجى التحقق من ذلك من مزود الأداة لمزيد من المعلومات . إذا قمت بتحديد نوع الأداة المحددة ، فقد لا تحتاج إلى إدخال إطلاق العنوان . إذا تم استخدام رابط الأداة للإطلاق فقط في نظام موفر الأداة ، و عدم الذهاب إلى مورد معين فإن هذا يحتمل أن يكون هذا هو الحال .';
...
$string['leaveblank'] = 'اتركه فارغا إذا كنت لا تحتاج إليه';
$string['lti'] = 'أدوات التعلم المشتركة';
$string['lti:addcoursetool'] = 'أضف  تكوينات أداة خاصة بالمادة';
$string['lti:addinstance'] = 'أضف أداة خارجية جديدة';
$string['lti:admin'] = 'كن مسؤولاً عند إطلاق الأداة';
...
$string['lti_administration'] = 'تحرير أداة مسبقة التكوين';
...
$string['manuallyaddtype'] = 'بدلاً من ذلك ، يمكنك تكوين أداة يدويًا .';
...
$string['privacy:metadata:coursefullname'] = 'الاسم الكامل للمادة التي يقوم المستخدم بالوصول إليها كعميل أداة التعلم المشترك';
$string['privacy:metadata:courseid'] = 'معرف المادة الذي يقوم المستخدم بالوصول إليه من عميل أداة التعلم المشترك';
$string['privacy:metadata:courseidnumber'] = 'رقم معرف المادة الذي يقوم المستخدم بالوصول إليه كعميل أداة التعلم المشترك';
$string['privacy:metadata:courseshortname'] = 'الاسم المختصر للمادة التدريبية و الذي يقوم المستخدم بالوصول إليه كعميل مواد تعلم مشترك';
...
$string['privacy:metadata:externalpurpose'] = 'يوفر المستفيد من أداة التعلم المشترك معلومات المستخدم و السياق إلى موفر أداة التعلم المشترك.';
...
$string['privacy:metadata:lti_submission:originalgrade'] = 'الدرجات الأصلية للمستخدم';
...
$string['privacy:metadata:role'] = 'الدور في المادة للمستخدم الذي يصل كمستفيد أداة التعلم المشترك';
...
$string['saveallfeedback'] = 'حفظ كل ردودي';
$string['search:activity'] = 'أداة خارجية - معلومات النشاط';
...
$string['selectcontent'] = 'اختر المحتوى';
$string['send'] = 'أرسل';
...
$string['share_roster_admin_help'] = 'تحديد ما إذا كانت الأداة يمكن لها الوصول إلى قائمة المستخدمين المسجلين في المقررات التعليمية التي أطلقت هذا النوع من الأدوات.';
...
$string['show_in_course_lti1_help'] = 'قد تظهر هذه الأداة في منتقي النشاط لاختيار المعلم إضافتها إلى المادة. بدلاً من ذلك ، قد يظهر في القائمة المنسدلة للأداة المُعدة مسبقًا عند إضافة أداة خارجية إلى الدورة التدريبية. هناك خيار آخر يتمثل في استخدام تكوين الأداة فقط إذا تم إدخال رابط للأداة عند إضافة أداة خارجية إلى المادة.';
...
$string['show_in_course_preconfigured'] = 'إظهار كأداة مُعدة مسبقًا عند إضافة أداة خارجية';
...
$string['toolproxy_help'] = 'تسمح التسجيلات للأدوات الخارجية لمسؤولي موقع Moodle بتكوين أدوات خارجية من وكيل للأدوات تم الحصول عليها من موفر أداة يدعم LTI 2.0. عنوان URL للتسجيل الذي يوفره موفر الأداة هو كل ما هو مطلوب لبدء العملية. يتم تحديد القدرات والخدمات المقدمة لمزود الأداة عند تكوين تسجيل جديد. يتم تقسيم تسجيلات الأدوات المدرجة في هذه الصفحة إلى أربع فئات: * ** تم التهيئة ** - تم إعداد تسجيلات الأداة هذه ولكن لم تبدأ عملية التسجيل بعد. * ** في انتظار ** - بدأت عملية التسجيل الخاصة بهذه التسجيلات للأداة ولكنها لم تكتمل. افتح وحفظ الإعدادات لنقلها مرة أخرى إلى فئة "مكون". * ** مقبول ** - تمت الموافقة على تسجيلات الأدوات هذه ؛ ستظهر الموارد المحددة في بروكسي الأداة على صفحة الأدوات المعدة مسبقًا بالحالة الأولية لـ "معلق". * ** مرفوض ** - هذه التسجيلات للأداة هي تلك التي تم رفضها أثناء عملية التسجيل. افتح وحفظ الإعدادات لإعادتها مرة أخرى إلى فئة "مكون" حتى يمكن إعادة تشغيل عملية التسجيل.';
...
$string['typename_help'] = 'يتم استخدام اسم الأداة لتحديد موفر الأداة داخل مودل. الاسم المدخل سوف يكون ظاهر للمعلمين عند إضافة أدوات خارجية ضمن المقررات.';
$string['types'] = 'أنواع';
