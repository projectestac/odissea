...
/**
 * Strings for component 'lti', language 'ar', version '4.5'.
 *
 * @package     lti
 * @category    string
...
$string['accept_grades'] = 'قبول التقديرات من الأداة';
$string['accept_grades_admin'] = 'قبول التقديرات من الأداة';
...
$string['accept_grades_from_tool'] = 'السماح لـ {$a} بإضافة التقديرات إلى سجل التقديرات';
...
$string['addnewapp'] = 'تمكين التطبيق الخارجي';
$string['addserver'] = 'إضافة مخدم موثوق به جديد';
$string['addtool'] = 'إضافة الأداة';
...
$string['configtypes'] = 'تمكين تطبيقات أدوات التعلم المشتركة';
...
$string['contentitem_multiple_description'] = 'العناصر الآتية ستتم إضافتها إلى مساقك:';
$string['contentitem_multiple_graded'] = 'نشاط سبق منحه تقديرات (الدرجة العليا: {$a})';
$string['contentselected'] = 'المحتوى تم تحديده';
$string['course_tool_types'] = 'أدوات المساق';
$string['courseactivitiesorresources'] = 'أنشطة المساق أو موارده';
$string['courseexternaltooladd'] = 'إضافة أداة تعلم توافقي خارجية جديدة';
$string['courseexternaltooladdsuccess'] = 'أضيفت {$a}.';
$string['courseexternaltooledit'] = 'تحرير {$a}';
$string['courseexternaltooleditsuccess'] = 'تم حفظ التغييرات';
$string['courseexternaltooliconalt'] = 'أيقونة {$a}';
$string['courseexternaltools'] = 'أدوات التعلم التوافقي الخارجية';
$string['courseexternaltoolsinfo'] = 'إن أدوات التعلم التوافقي الخارجية هي تطبيقات مضافة يمكنك دمجها ضمن مساقك، مثل المحتوى التفاعلي أو التقييمات. يمكن لطلابك الوصول إليها واستعمالها دون أن يغادروا مساقك.';
$string['courseexternaltoolsnoeditpermissions'] = 'ليست لديك صلاحية تعديل هذه الأداة';
$string['courseexternaltoolsnoviewpermissions'] = 'معاينة أدوات المساق الخارجية';
$string['courseid'] = 'رقم مُعرَّف المساق';
$string['courseinformation'] = 'معلومات المساق';
$string['courselink'] = 'إذهب إلى المساق';
$string['coursemisconf'] = 'تهيئة خاطئة للمساق';
$string['coursetooldeleted'] = '{$a} تم حذفها';
...
$string['default_launch_container_help'] = 'حاوية الإطلاق تؤثر على عرض الأداة عندما تطلق من المساق. بعض حاويات الإطلاق توفر مساحة شاشة أكبر لهذه الأداة، وغيرها توفر شعورًا أكثر تكاملاً مع بيئة مودل.
...
$string['deletecoursetool'] = 'حذف {$a}';
$string['deletecoursetoolconfirm'] = 'هذا سيحذف {$a} من أدوات التعلم التوافقي المتاحة في مساقك.';
$string['deletecoursetoolwithusageconfirm'] = '{$a} يجري استعماله حاليًا في نشاط واحد على الأقل في مساقك. إذا حذفت هذه الأداة، لن تكون النشاطات التي تستعمله صالحة للعمل.<br><br>هل أنت متأكد من رغبتك في حذف {$a}؟';
$string['deletetype'] = 'هل تريد بالتأكيد حذف هذه الأداة المُعدة مسبقًا؟';
$string['display_description'] = 'عرض وصف النشاط عند وصول الطلاب إلى الأداة';
$string['display_description_help'] = 'يُعرض من هذه الأداة محتوً مضمنًا في صفحة ما في المساق. هذا الإعداد يحدد ما إذا كان وصف النشاط ظاهرًا في تلك الصفحة.';
$string['display_name'] = 'عرض اسم النشاط عند وصول الطلاب إلى الأداة';
$string['display_name_help'] = 'يُعرض من هذه الأداة محتوً مضمنًا في صفحة ما في المساق. هذا الإعداد يحدد ما إذا كان اسم النشاط ظاهرًا في تلك الصفحة.';
...
$string['dontshowinactivitychooser'] = 'لا تُظهره في منتقي النشاطات';
...
$string['editmanualinstancedeprecationwarning'] = 'لم تعد نشاطات الأدواة الخارجية المهيئة يدويًا مدعومة. لا تقلق، فهذا النشاط سيبقى صالحًا للعمل كما هو، ولكن لا يمكنك إجراء تعديلات على تهيئة الأداة بعد الآن.
<br><br>
لإجراء تعديلات على الأداة، أو لإنشاء نشاطات جديدة بها، ينبغي إضافة الأداة إلى مساقك من خلال المساق > المزيد > أدوات التعلم التوافقي الخارجية. عندها ستتمكن من إنشاء النشاطات الجديدة، اختيار الأداة مباشرة عبر منتقي النشاطات.
<br><br>
يمكنك معرفة المزيد عن إضافة أدوات التعلم التوافقي الخارجية في التوثيقات <a href="{$a}" target="_blank">الأداة الخارجية</a>.';
...
$string['entitycourseexternaltools'] = 'أدوات التعلم التوافقي الخارجية';
...
* **تحرير** - حدد أداةً على مستوى المساق من القائمة المنسدلة، ثم انقر على هذه الأيقونة. يمكن تحرير تفاصيل تهيئة الأداة.
...
$string['forced_help'] = 'هذا الإعداد إجباري في المساق أو  تكوين الأداة على مستوى الموقع . لا تستطيع تغييره من هذه الواجهة.';
$string['generaltool'] = 'أداة عامة';
$string['global_tool_types'] = 'الأدوات مسبقة التهيئة';
$string['grading'] = 'توجيه التقديرات';
$string['icon_url'] = 'أيقونة الرابط';
$string['icon_url_help'] = 'رابط الأيقونة يسمح للرمز الذي يظهر في قائمة المساق لهذا النشاط بالتعديل. بدلا من  استخدام أيقونة أدوات التعلم المشترك، الأيقونة الافتراضية هي الأيقونة التي تحمل التعبير عن نوع  النشاط الذي يمكن تحديده.';
...
$string['launchinpopup_help'] = 'حاوية الإطلاق تؤثر على عرض الأداة عندما تطلق من المساق. بعض حاويات الإطلاق توفر مساحة شاشة أكبر لهذه الأداة، وغيرها توفر شعورًا أكثر تكاملاً مع بيئة مودل.
...
$string['lti:addmanualinstanceprohibitederror'] = 'لم يعد الإنشاء اليدوي للأدوات بدون تعريف أداة المساق مدعومًا. يرجى إنشاء أداة المساق أولاً ومن ثم استعملها لإنشاء عيِّنات النشاطات.';
$string['lti:addpreconfiguredinstance'] = 'إضافة أداة مسبقة التهيئة';
$string['lti:admin'] = 'أن يكون مشرفاً عند إطلاق الأداة';
$string['lti:grade'] = 'معاينة التقديرات المسترجعة من الأدارة الخارجية';
...
<br /> بدلاً من ذلك، يمكنك إنشاء تكوين على مستوى المساق لمزود الأداة <a href="{$a->course_tool_editor}">here</a>. </p>';
...
* الأدوات الخارجية مدركة للسياق، أي لديها وصول إلى معلومات عن المستخدم الذي أطلق الأداة، كالمؤسسة، المساق والاسم.
...
$string['modulenamepluralformatted'] = 'الأدوات الخارجية';
$string['name'] = 'الاسم';
$string['never'] = 'أبدأ';
...
$string['nocourseexternaltoolsnotice'] = 'ليست هناك أدوات تعلم توافقي خارجية بعد.';
...
إذا كان مزود الأداة سيستعمل أكثر من مرة في هذا المساق، فتهيئة الأداة على مستوى المساق فكرة جيدة.
...
$string['privacy:metadata:courseshortname'] = 'الاسم المختصر للمقرر الدراسي والذي يقوم المستخدم بالوصول إليه كعميل مواد تعلم مشترك';
...
$string['privacy:metadata:lti_submission:originalgrade'] = 'التقديرات الأصلية للمستخدم';
...
$string['restricttocategory'] = 'التقييد للتصنيف';
$string['restricttocategory_help'] = 'لتقييد استعمال هذه الأداة مع المقررات ضمن تصنيف معين، إختر التصنيف أو التصنيفات من القائمة.';
...
$string['selectcontentvalidationerror'] = 'أنت بحاجة إلى تحديد محتوً لهذا النشاط.';
$string['send'] = 'أرسل';
...
لاحظ أن هذا الإعداد يمكن تجاوزه في تهيئة الأداة.';
$string['share_roster'] = 'السماح للأداة بالوصول إلى قائمة هذا المساق';
...
لاحظ أن هذا الإعداد يمكن تجاوزه في تهيئة الأداة.';
$string['show_in_course_activity_chooser'] = 'الإظهار في منتقي النشاطة وكأداة مُعدة مسبقًا';
...
$string['showinactivitychooser'] = 'الإظهار في منتقي النشاطات';
...
$string['tooltypenotfounderror'] = 'إن أداة التعلم التوافقي المستعملة في هذا النشاط قد تم حذفها. إذا احتجت للمساعدة، تواصل مع معلمك أو مشرف موقعك.';
...
$string['viewsubmissions'] = 'عرض شاشة التسليمات والتقديرات';
