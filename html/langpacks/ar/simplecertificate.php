...
$string['certificatetext_help'] = 'هذا هو النص الذي سيتم استعماله في خلف الشهادة. سيتم استبدال بعض الكلمات الخاصة بمتغيرات، مثل اسم المقرر الدراسي، اسم الطالب، العلامة...
وهذه هي:
<ul>
<li>{USERNAME} -> الاسم الكامل للمستخدم</li>
<li>{COURSENAME} -> الاسم الكامل للمقرر (أو تسمية مُعرفة بديلة للمقرر)</li>
<li>{GRADE} -> العلامة المنسقة</li>
...
<li>{USERRESULTS} -> نتائج المستخدم (العلامات) في نشاطات المقرر الأخرى</li>
