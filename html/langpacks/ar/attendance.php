...
/**
 * Strings for component 'attendance', language 'ar', version '3.11'.
 *
 * @package     attendance
 * @category    string
...
$string['attendanceforthecourse'] = 'الحضور للمقرر';
...
إن كان "نعم"، سيتم تأشير حالة الطلبة تلقائياً إعتماداً على أول وصول لهم إلى المقرر.
...
$string['categoryreport'] = 'تقرير تصنيف المقرر الدراسي';
...
$string['confirmdeletehiddensessions'] = 'هل أنت متأكد من رغبتك في حذف {$a->count} جلسات مجدولة قبل تاريخ بدء المقرر في ({$a->date})؟';
...
$string['coursemessage'] = 'مراسلة مستخدمي المقرر الدراسي';
$string['courseshortname'] = 'الاسم المختصر للمقرر الدراسي';
$string['coursesummary'] = 'تقرير ملخص المقرر الدراسي';
...
$string['createonesession'] = 'أنشئ جلسة واحدة للمقرر الدراسي';
...
لتحصل على أقصى ما هو ممكن من هذا المقرر، ينبغي عليك تحسين حالة حضورك فيه، لطفاً، كن على اتصال إذا كنت بحاجة إلى أي مساعدة إضافية.';
...
$string['error:coursehasnoattendance'] = 'المقرر الذي بالاسم المختصر {$a} ليس فيه أي نشاطات من الحضور.';
...
$string['error:sessioncourseinvalid'] = 'مقرر الجلسة غير صحيح! يجري التخطي.';
...
$string['hiddensessions_help'] = 'تكون الجلسات مخفية إذا تمت جدولتها قبل تاريخ بدء المقرر.
...
$string['priorto'] = 'تاريخ الجلسة سابق لتاريخ بدء المقرر الدراسي ({$a}) لذلك ستكون الجلسات الجديدة المجدولة قبل هذا التاريخ مخفية (غير قابلة للوصول إليها). يمكنك تغيير تاريخ بدء المقرر في أي وقت (أنظر إعدادات المقرر الدراسي) من أجل إتاحة الوصول إلى الجلسات الأسبق.<br><br>لطفاً، قم بتغيير تاريخ الجلسة أو فقط أنقر زر "إضافة جلسة" مرة أخرى للتأكيد!';
...
$string['studentavailability'] = 'متاح للطلاب (بالدقائق)';
$string['studentavailability_help'] = 'عندما يقوم الطلبة بتأشير حضورهم بأنفسهم، عدد الدقائق بعد بدء الجلسة تكون فيها هذه الحالة متاحة.
 <br/>إذا كانت فارغة، ستكون هذه الحالة متاحة دائماً، أما عندما جعلها 0، فستكون دائماً مخفية عن الطلاب.';
...
$string['thirdpartyemailtextfooter'] = 'أنت تتلقى هذ الرسالة لأن معلم هذا المقرر الدراسي قد أضاف عنوان بريدك الالكتروني إلى قائمة المستلمين';
