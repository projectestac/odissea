...
$string['attendance:viewsummaryreports'] = 'معاينة تقارير ملخص المساق';
...
$string['attendancenotstarted'] = 'لم يبدأ الحضور بعد لهذا المساق';
...
إن كان "نعم"، سيتم تأشير حالة الطلبة تلقائياً إعتماداً على أول وصول لهم إلى المساق.
...
$string['categoryreport'] = 'تقرير تصنيف المساق';
...
$string['confirmdeletehiddensessions'] = 'هل أنت متأكد من رغبتك في حذف {$a->count} جلسات مجدولة قبل تاريخ بدء المساق في ({$a->date})؟';
...
$string['coursemessage'] = 'مراسلة مستخدمي المساق';
$string['courseshortname'] = 'الاسم المختصر للمساق الدراسي';
$string['coursesummary'] = 'تقرير ملخص المساق';
...
$string['deletingsession'] = 'يجري حذف جلسة الحضور من المساق';
$string['deletingstatus'] = 'يجري حذف الحالة من المساق';
...
$string['error:coursehasnoattendance'] = 'المساق الذي بالاسم المختصر {$a} ليس فيه أي نشاطات من الحضور.';
$string['error:coursenotfound'] = 'تعذر العثور على المساق ذي الاسم المختصر {$a}.';
...
$string['hiddensessions_help'] = 'تكون الجلسات مخفية إذا تمت جدولتها قبل تاريخ بدء المساق.
...
$string['noattendanceusers'] = 'من المستحيل تصدير أي بيانات نظراً لعدم وجود طلبة منضمين إلى المساق.';
...
$string['nogroups'] = 'لا يمكنك إضافة جلسات للمجموعات. لا توجد مجموعات في المساق.';
...
$string['nosessionexists'] = 'لا توجد جلسات حضور في هذا المساق';
$string['nosessionsselected'] = 'لم يتم اختيار أي جلسات';
$string['notfound'] = 'لم يتم العثور على نشاط الحضور في هذا المساق!';
...
$string['priorto'] = 'تاريخ الجلسة سابق لتاريخ بدء المساق ({$a}) لذلك ستكون الجلسات الجديدة المجدولة قبل هذا التاريخ مخفية (غير قابلة للوصول إليها). يمكنك تغيير تاريخ بدء المساق في أي وقت (أنظر إعدادات المساق) من أجل إتاحة الوصول إلى الجلسات الأسبق.<br><br>لطفاً، قم بتغيير تاريخ الجلسة أو فقط أنقر زر "إضافة جلسة" مرة أخرى للتأكيد!';
...
$string['resetdescription'] = 'تذكر بأن حذف بيانات الحضور سيؤدي إلى حذف المعلومات من قاعدة البيانات. يمكنك فقط إخفاء الجلسات القديمة تحسباً لقيامك بتغيير تاريخ بدء المساق!';
...
$string['sessionduplicate'] = 'توجد جلسة مكررة في المساق: {$a->course} في نشاط الحضور: {$a->activity}';
...
$string['thirdpartyemailtextfooter'] = 'أنت تتلقى هذ الرسالة لأن معلم هذا المساق قد أضاف عنوان بريدك الالكتروني إلى قائمة المستلمين';
