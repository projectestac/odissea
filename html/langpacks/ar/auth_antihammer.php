...
$string['plugin:notenabled'] = 'ملحق مضاد الاقتحام منصب ولكنه غير مُمَكَّن بعد.<br/>
هذا يعني عدم فعالية أي من وظائف هذا الملحق حاليًا.<br/>
إذا أردت الاستفادة من إمكانيات الحظر لهذا الملحق، يرجى تمكينه ضمن قائمة ملاحق المصادقة في إدارة الموقع.';
