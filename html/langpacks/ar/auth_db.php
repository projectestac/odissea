...
/**
 * Strings for component 'auth_db', language 'ar', version '4.5'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbinsertuserduplicate'] = 'وقع خطأ عند إدراج المستخدم {$a->username} - تم سلفاً إنشاء مستخدم باسم الدخول هذا عبر الإضافة \'{$a->auth}\'.';
...
$string['privacy:metadata'] = 'إن إضافة مصادقة قاعدة البيانات الخارجية لا تخزن أي بيانات شخصية.';
