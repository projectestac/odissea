...
$string['courseshorttitlehelp'] = 'هذا يحتوي على المظهر المعد لإنشاء الاسم المختصر للمساق. أنظر أعلاه لمعرفة الوسوم المتاحة.';
$string['coursetitle'] = 'الاسم الكامل للمساق';
$string['coursetitlehelp'] = 'هذا يضم مظهر إنشاء الاسم الكامل للمساق.
...
$string['xlsshorttitlehelp'] = 'هذا يحتوي على المظهر المعد لإنشاء الاسم المختصر للمساق بالنسبة للمساقات المدرجة في القائمة. أنظر وصف العنوان الكامل للقائمة المدرجة لمعرفة التفاصيل.';
