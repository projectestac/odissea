...
/**
 * Strings for component 'enrol_lmb', language 'ar', version '4.4'.
 *
 * @package     enrol_lmb
 * @category    string
...
$string['courseshorttitlehelp'] = 'هذا يحتوي على القالب المعد لإنشاء الاسم المختصر للمقرر الدراسي. أنظر أعلاه لمعرفة الوسوم المتاحة.';
$string['coursetitle'] = 'الاسم الكامل للمقرر الدراسي';
$string['coursetitlehelp'] = 'هذا يضم مظهر إنشاء الاسم الكامل للمقرر الدراسي.
<p>يمكنك أن تقرر كيفية صياغة الاسم الكامل والاسم المختصر للمقرر باستعمال الرموز الآتية. أي ذكر لتلك الرموز في الإعداد سيتم استبداله بما يقابله من معلومات المقرر. أي نص ليس من بين هذه الرموز سيترك كما هو.</p>
<p><ul>
<li>[SOURCEDID] - مثل [CRN].[TERM]<br />
<li>[CRN] - رقم المقرر/القسم<br />
<li>[TERM] - رمز الفصل الدراسي<br />
<li>[TERMNAME] - الاسم الكامل للفصل الدراسي<br />
<li>[LONG] - مثل [DEPT]-[NUM]-[SECTION]<br />
<li>[FULL] - العنوان الكامل للمقرر الدراسي<br />
<li>[RUBRIC] - مثل [DEPT]-[NUM]<br />
<li>[DEPT] - رمز الشعبة المختصر<br />
<li>[NUM] - رمز القسم العائد للمقرر الدراسي<br />
<li>[SECTION] - رقم القسم العائد للمقرر الدراسي<br />
</ul></p>
<p>مثال: الإعداد \'[RUBRIC]-[CRN]-[FULL]\' سيبدو بشكل \'ENG-341-12345-English History\' بالنسبة إلى مقرر بتلك المعلومات.</p>';
...
$string['cronunhidedays'] = 'إرفع الإخفاء عند هذا العدد من الأيام قبل بدء المساق';
$string['cronunhidedayshelp'] = 'هذا هو عدد الأيام التي يُرفع فيها إخفاء المساق قبل بدئه. ضعه على 0 ليتم رفع إخفاء المساق في يوم بدئه.';
$string['forcetitle'] = 'فرض اسم المقرر عند التحديث';
...
$string['xlsshorttitlehelp'] = 'هذا يحتوي على القالب المعد لإنشاء الاسم المختصر للمقرر الأكاديمي بالنسبة للمقررات المدرجة في القائمة. أنظر وصف العنوان الكامل للقائمة المدرجة لمعرفة التفاصيل.';
$string['xlstitle'] = 'الاسم الكامل للمقرر الدراسي المدرج في القائمة';
...
<p>مثال: لنقل بأن لديك مساقين، 12345.200710 و 54321.200710، وهما مدرجان بالتقاطع بالرمز المتقاطع XLSAA200710. إذا جعلت \'الاسم الكامل للمقرر الدراسي المدرج بالتقاطع\' بالشكل \'[XLSID] - [REPEAT]\'، \'مكرر الاسم الكامل\' بالشكل \'[CRN]\'، و \'فاصل الاسم الكامل\' بالشكل \' / \'، فسيكون العنوان الكامل للمقرر الدراسي المدرج بالتقاطع \'XLSAA200710 - 12345 / 54321\'.</p>';
