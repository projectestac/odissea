...
/**
 * Strings for component 'block_cmanager', language 'ar', version '3.11'.
 *
...
$string['cannotrequestcourse'] = 'عذرًا، حسابك لا يمتلك الصلاحيات الكافية للمطالبة بإنشاء مقرر. ينبغي منحك أحد أدوار النظام ذي الصلاحيات الكافية.';
...
$string['cmanagerEnrolmentInstruction'] = 'مدير طلبات المقررات يمكنه توليد مفتاح انضمام تلقائي أو يمكنك أن تختار مطالبة المستخدم بمفتاح الانضمام حسبما يختاره.';
$string['cmanagerStats'] = 'إحصائيات CManager';
$string['comments_date'] = 'التاريخ / الوقت';
$string['configure_EnrolmentKey'] = 'مفتاح الانضمام';
$string['configure_EnrolmentKeyInstruction'] = 'مدير طلبات المقررات يمكنه توليد مفتاح انضمام تلقائي أو يمكنك أن تختار مطالبة المستخدم بمفتاح الانضمام حسبما يختاره. إذا اخترت مطالبة المستخدم، ستتم إضافة حقل لإدخال مفتاح الانضمام إلى الصفحة الأولى من نموذج الطلب.';
$string['configure_instruction1'] = 'إعدادات مدير طلبات المقررات تسمح لك بوضع عناوين البريد الالكتروني للمشرفين لأغراض التواصل، تحديد عناوين البريد الافتراضية، وضع تقاليد تسمية المقرر الدراسي وإعداداته الافتراضية مثل تاريخ البدء وسياسة مفتاح الانضمام.';
...
$string['email_courseName'] = 'اسم المقرر الدراسي';
...
$string['entryFields_DropdownDescription'] = 'قد ترغب في إضافة قائمة منسدلة اختيارية مع بعض القيم التي ستساعدك في تصنيف المساق الجديد. على سبيل المثال، قد تقدم مؤسستك مساقات في وضعية الدوام الكامل، وضعية الدوام الجزئي، وضعية التعليم عن بعد، والوضعية عبر الإنترنت فقط وما إلى ذلك. يمكنك إضافة هذه الخيارات إلى القائمة المنسدلة الاختيارية والسماح للمستخدمين بتحديد واحدة منها عند تقديم طلب مساق جديد.';
$string['entryFields_Name'] = 'الاسم';
$string['entryFields_instruction1'] = 'قم بتكوين الصفحة الأولى من نموذج طلب المساق. تُستعمل الصفحة الأولى من نموذج الطلب لقبول القيم من المستخدم للاسم المختصر للمساق والاسم الكامل له كما هو مطلوب من قبل مودل. قد يتم وصف هذه بشكل مختلف من قبل مؤسستك. على سبيل المثال، يمكنك استعمال رمز المساق (الاسم المختصر) واسم المساق (الاسم الكامل) لوصف مساقاتك.';
...
$string['modname'] = 'اسم المقرر الدراسي';
...
$string['privacy:metadata:db:block_cmanager_records:modname'] = 'الاسم الكامل للمقرر المطلوب';
$string['requestReview_courseName'] = 'اسم المقرر الدراسي';
$string['requestReview_moduleName'] = 'اسم المقرر الدراسي';
