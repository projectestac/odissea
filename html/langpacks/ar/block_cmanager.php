...
$string['cmanagerEnrolmentInstruction'] = 'مدير طلبات المساقات يمكنه توليد مفتاح انضمام تلقائي أو يمكنك أن تختار مطالبة المستخدم بمفتاح الانضمام حسبما يختاره.';
$string['cmanagerStats'] = 'إحصائيات CManager';
$string['comments_date'] = 'التاريخ / الوقت';
$string['configure_EnrolmentKey'] = 'مفتاح الانضمام';
$string['configure_EnrolmentKeyInstruction'] = 'مدير طلبات المساقات يمكنه توليد مفتاح انضمام تلقائي أو يمكنك أن تختار مطالبة المستخدم بمفتاح الانضمام حسبما يختاره. إذا اخترت مطالبة المستخدم، ستتم إضافة حقل لإدخال مفتاح الانضمام إلى الصفحة الأولى من نموذج الطلب.';
$string['configure_instruction1'] = 'إعدادات مدير طلبات المساقات تسمح لك بوضع عناوين البريد الالكتروني للمشرفين لأغراض التواصل، تحديد عناوين البريد الافتراضية، وضع تقاليد تسمية المساقات وإعداداته الافتراضية مثل تاريخ البدء وسياسة مفتاح الانضمام.';
...
$string['email_courseName'] = 'اسم المساق';
...
$string['requestReview_courseName'] = 'اسم المساق';
$string['requestReview_moduleName'] = 'اسم المساق';
