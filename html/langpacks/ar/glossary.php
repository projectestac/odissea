...
$string['entryusedynalink_help'] = 'إذا تم تمكين الربط التلقائي للمسارد على مستوى عموم الموقع من قبل المشرف وتم تأشير هذه الخانة، سيتم ربط المصطلح تلقائياً أينما ظهرت كلمات المفهوم وعباراته في باقي أرجاء المساق.';
...
$string['evententryviewed'] = 'تمت معاينة المصطلح';
...
يمكنك استيراده في أي وقت تشاء إلى هذا المساق أو لغيره.<p>لطفاً، لاحظ أن المرفقات (أي الصور) والكتاب لم يتم استيرادها.</p>';
...
$string['exporttomainglossary'] = 'تصدير إلى المسرد الرئيسي';
...
$string['linkcategory_help'] = 'إذا تم تمكين الربط التلقائي مع تمكين هذا الإعداد، سيتم ربط اسم التصنيف تلقائياً حيثما يظهر في أرجاء المساق. عندما ينقر المشارك على رابط اسم التصنيف، سينتقل إلى صفحة "الاستعراض حسب التصنيف" في المسرد.';
...
إذا تم تمكين الربط التلقائي للمسرد، سيتم ربط المصطلحات تلقائياً حيثما ظهرت كلمات و/أو عبارات المفاهيم ضمن المساق.

يمكن للمعلم السماح بالتعليقات على المصطلحات. كذلك يمكنه إتاحة المصطلحات للتقييم من قبله أو من قبل الطلاب (التقييم المناظر). يمكن تجميع التقييمات للخروج بعلامة نهائية يتم توثيقها في سجل العلامات.
...
$string['usedynalink_help'] = 'إذا تم تمكين الربط التلقائي للمسرد على مستوى عموم الموقع من قبل المشرف مع تمكين هذا الإعداد، سيتضمن نموذج "أضف مصطلحاً جديداً" خيار ربطه تلقائياً حيثما ظهرت كلمات أو عبارات المصطلح في باقي أرجاء المساق.';
