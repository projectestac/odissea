...
$string['aliases_help'] = 'يمكن أن يكون لكل مصطلح في المسرد قائمة مرتبطة من الكلمات المفتاحية (أو الأسماء المستعارة). إذا تم ربط المصطلح تلقائياً، فسيتم ربط الكلمات المفتاحية أيضاً بشكل تلقائي.
...
$string['allowcomments_help'] = 'عند تمكينه، سيتمكن كل المشاركين ممن لديهم صلاحية إنشاء التعليقات من إضافة تعليقات إلى مصطلحات المسرد.';
...
$string['allowprintview_help'] = 'عند تمكينه، سيتوفر لدى الطلاب رابط لنسخة ملائمة للطباعة من المسرد. هذا الرابط متوافر للمعلمين دائماً.';
...
$string['approvaldisplayformat_help'] = 'عند المصادقة على فقرات المسرد قد ترغب بعرضه بتنسيق مختلف';
...
$string['attachment_help'] = 'يمكنك اختيارياً إرفاق ملف واحد أو أكثر بمصطلح المسرد.';
...
$string['cnfallowcomments'] = 'حدد ما إذا كان يُسمح إفتراضياً بالتعليقات على مصطلحات المسرد';
$string['cnfallowdupentries'] = 'حدد ما إذا كان يُسمح إفتراضياً بتكرار مصطلحات المسرد';
...
$string['cnfdefaulthook'] = 'إختر المجموعة الافتراضية التي ستظهر عند عرض المسرد لأول مرة';
$string['cnfdefaultmode'] = 'إختر الإطار الافتراضي الذي سيظهر عند عرض المسرد لأول مرة';
$string['cnffullmatch'] = 'حدد ما إذا كان يجب مطابقة حالة الأحرف للمصطلح إفتراضياً عند ربطه بالنص المقصود';
$string['cnflinkentry'] = 'حدد ما إذا كان ينبغي إفتراضياً ربط المصطلح بشكل تلقائي';
$string['cnflinkglossaries'] = 'حدد ما إذا كان ينبغي إفتراضياً ربط المسرد بشكل تلقائي';
...
$string['cnftabs'] = 'إختر التبويبات المرئية لهذا التنسيق من المسرد';
...
$string['entryusedynalink_help'] = 'إذا تم تمكين الربط التلقائي للمسارد على مستوى عموم الموقع من قبل المشرف وتم تأشير هذه الخانة، سيتم ربط المصطلح تلقائياً أينما ظهرت كلمات المفهوم وعباراته في باقي أرجاء المقرر الدراسي.';
...
$string['explainalphabet'] = 'استعراض المسرد باستعمال الفهرس';
$string['explainexport'] = 'أنقر على الزر أدناه لتصدير مصطلحات المسرد.
يمكنك استيراده في أي وقت تشاء إلى هذا المقرر الدراسي أو لغيره.<p>لطفاً، لاحظ أن المرفقات (أي الصور) والكتاب لم يتم استيرادها.</p>';
...
$string['exporttomainglossary'] = 'التصدير إلى المسرد الرئيسي';
...
$string['fullmatch_help'] = 'هذا الإعداد يحدد فيما إذا كان ينبغي ربط الكلمات الكاملة فقط، على سبيل المثال، مصطلح المسرد المسمى "construct" لن ينشئ رابطاً داخل الكلمة "constructivism".';
$string['glossary:addinstance'] = 'إضافة مسرد جديد';
...
$string['glossarytype_help'] = 'المسرد الرئيسي هو المسرد الذي يمكن استيراد المصطلحات إليه من المسارد الثانوية. يمكن أن يكون هناك مسرد رئيسي واحد في المقرر الدراسي. إذا لم تكن هناك حاجة لاستيراد المصطلحات، يمكن جعل كل المسارد في المقرر ثانوية.';
...
$string['isglobal_help'] = 'المسرد العمومي فيه مصطلحات يُرتبط بها من أرجاء الموقع بدلاً من مجرد المقرر الدراسي الذي يتواجد فيه المسرد. المشرفون وحدهم يمكنهم جعل المسرد عمومياً.';
$string['letter'] = 'حرف';
$string['linkcategory'] = 'أربط هذا التصنيف تلقائياً';
$string['linkcategory_help'] = 'إذا تم تمكين الربط التلقائي مع تمكين هذا الإعداد، سيتم ربط اسم التصنيف تلقائياً حيثما يظهر في أرجاء المقرر الدراسي. عندما ينقر المشارك على رابط اسم التصنيف، سينتقل إلى صفحة "الاستعراض حسب التصنيف" في المسرد.';
$string['linking'] = 'ربط تلقائي';
$string['mainglossary'] = 'مسرد رئيسي';
$string['maxtimehaspassed'] = 'عذراَ، انتهى الوقت الاقصى لتحرير ({$a}) هذا التعليق';
$string['modulename'] = 'مسرد';
$string['modulename_help'] = 'إن وحدة نشاط المسرد تُمَكن المشاركين من إنشاء وإدامة قائمة من التعاريف كما في القاموس أو جمع وتنظيم الموارد أو المعلومات.

يمكن للمعلم السماح بإرفاق الملفات بمصطلحات المسرد. الصور المرفقة يتم عرضها مع المصطلح. يمكن البحث في المصطلحات أو استعراضها هجائياً أو حسب التصنيف، التاريخ أو الكاتب. يمكن جعل المصطلحات خاضعة لمصادقة المعلم لكي يتم عرضها للجميع أو متاحة تلقائياً دون الحاجة إلى مصادقة.

إذا تم تمكين الربط التلقائي للمسرد، سيتم ربط المصطلحات تلقائياً حيثما ظهرت كلمات و/أو عبارات المفاهيم ضمن المقرر الدراسي.
...
$string['newentries'] = 'مصطلحات المسرد الجديدة';
$string['newglossary'] = 'مسرد جديد';
$string['newglossarycreated'] = 'تم إنشاء مسرد جديد.';
...
$string['noentries'] = 'لم يتم العثور على مصطلحات في هذ المقطع';
$string['noentry'] = 'لم تم العثور على أى مصطلح';
$string['nopermissiontodelcomment'] = 'لا يمكنك حذف تعليقات الآخرين!';
$string['nopermissiontodelinglossary'] = 'لا يمكنك إضافة تعليقات في هذا المسرد!';
...
$string['page-mod-glossary-edit'] = 'صفحة إضافة/تحرير مصطلح المسرد';
$string['page-mod-glossary-view'] = 'معاينة صفحة تحرير المسرد';
$string['page-mod-glossary-x'] = 'أي صفحة لوحدة المسرد';
$string['pluginadministration'] = 'إدارة المسرد';
$string['pluginname'] = 'المسرد';
...
$string['privacy:metadata:core_comments'] = 'التعليقات المسجلة على تعاريف المسرد يتم خزنها باستعمال نظام التعليقات المركزي';
$string['privacy:metadata:core_files'] = 'الملفات المرتبطة بتعاريف المسرد يتم خزنها باستعمال نظام الملفات المركزي';
$string['privacy:metadata:core_rating'] = 'التقييمات المضافة إلى تعاريف المسرد يتم خزنها باستعمال نظام التقييم المركزي';
$string['privacy:metadata:core_tag'] = 'الوسوم المضافة إلى تعاريف المسرد يتم خزنها باستعمال نظام الوسوم المركزي';
$string['privacy:metadata:glossary_entries'] = 'معلومات عن مصطلحات المستخدم في نشاط مسرد معين';
...
$string['privacy:metadata:glossary_entries:glossaryid'] = 'مُعرَّف نشاط المسرد';
...
$string['removeallglossarytags'] = 'إزالة كل وسوم المسرد';
...
$string['rssarticles_help'] = 'هذا الإعداد يحدد عدد مفاهيم مصطلحات المسرد التي ينبغي تضمينها في خدمة مغذي الأخبار. العدد المقبول عادة يتراوح ما بين 5 و 20.';
...
$string['search:activity'] = 'المسرد - معلومات النشاط';
$string['search:entry'] = 'المسرد - المصطلحات';
...
$string['tagarea_glossary_entries'] = 'مصطلحات المسرد';
$string['tagsdeleted'] = 'تم حذف وسوم المسرد';
$string['totalentries'] = 'إجمالي المصطلحات';
$string['usedynalink'] = 'ربط مصطلحات المسرد تلقائياً';
$string['usedynalink_help'] = 'إذا تم تمكين الربط التلقائي للمسرد على مستوى عموم الموقع من قبل المشرف مع تمكين هذا الإعداد، سيتضمن نموذج "أضف مصطلحاً جديداً" خيار ربطه تلقائياً حيثما ظهرت كلمات أو عبارات المصطلح في باقي أرجاء المقرر الدراسي.';
$string['visibletabs'] = 'التبويبات المرئية';
$string['waitingapproval'] = 'تنتظر الموافقة';
$string['warningstudentcapost'] = '(ينطبق فقط إذا لم يكن المسرد هو المسرد الرئيسي)';
