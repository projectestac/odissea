...
/**
 * Strings for component 'completion', language 'ar', version '4.1'.
 *
 * @package     completion
 * @category    string
...
عند اقتراب الموعد، سيتم إدراج النشاط في كتلة الخط الزمني في دفة القيادة.';
...
$string['completionpassgrade_desc'] = 'على الطالب أن يحرز درجة النجاح ليُكمل هذا النشاط';
...
$string['showcompletionconditions_help'] = 'شروط إكمال النشاط ظاهرة دائمًا في صفحة النشاط. هذا الإعداد يحدد ما إذا كانت تلك الشروط ظاهرة أيضًا تحت كل نشاط في صفحة المساق.';
