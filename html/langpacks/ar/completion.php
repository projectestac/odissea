...
$string['badcompletiongradeitemnumber'] = 'يتعذر تمكين خيار العلامة مطلوبة لـ <b>{$a}</b> لأن التقييم بواسطة {$a} لم يتم تفعيله.';
...
تشير العلامة الموضوعة بجانب اسم النشاط في صفحة المقرر الدراسي إلى حالة إكتماله.';
