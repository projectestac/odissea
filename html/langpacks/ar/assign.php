...
/**
 * Strings for component 'assign', language 'ar', version '3.8'.
 *
 * @package     assign
 * @category    string
...
$string['batchoperationconfirmunlock'] = 'أتريد إزالة القفل من كل التسليمات المحددة؟';
...
$string['blindmarking_help'] = 'التصحيح الأعمى يخفي هوية الطلاب عن المُصحِّحين. سيتم تأمين الإعدادات للتصحيح الأعمى وقفلها عند إرسال تسليم من الطالب أو وضع درجة لهذا الواجب.';
...
$string['collapsegradepanel'] = 'طي لوحة العلامات';
...
$string['currentassigngrade'] = 'العلامة الحالية في الواجب';
...
$string['gradechangessaveddetail'] = 'التغييرات في العلامة والإفادة تم حفظها';
...
$string['gradersubmissionupdatedhtml'] = '{$a->username} قام بتحديث تسليمه للواجب <i>\'{$a->assignment}\' بتاريخ {$a->timeupdated}</i><br /><br /> وهي <a href="{$a->url}">متاحة في الموقع</a>.';
...
$string['locksubmissions'] = 'أقفل التسليمات';
...
$string['privacy:blindmarkingidentifier'] = 'المُعرَّف المستعمل للتصحيح الأعمى';
...
$string['privacy:metadata:assignusermapping'] = 'التعيين بشأن التصحيح الأعمى';
$string['privacy:metadata:assignworkflowfilter'] = 'الترشيح حسب مراحل سير العمل المختلفة';
$string['privacy:metadata:grade'] = 'العلامة الرقمية لتسليم الواجب هذا. يمكن تحديده وفقاً للمقاييس/نماذج التقييم المتقدم وما شابه، ولكنه دائماً يجري تحويله إلى رقم ذي كسر عشري';
...
$string['submitassignment'] = 'تسليم المهمة';
...
$string['unlocksubmissions'] = 'إرفع قفل التسليمات';
$string['unsavedchanges'] = 'تغييرات غير محفوظة';
$string['unsavedchangesquestion'] = 'هناك تغييرات غير محفوظة في العلامات أو الإفادات. هل ترغب في حفظ التغييرات والاستمرار؟';
