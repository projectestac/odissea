...
$string['couldnotcreatecoursemodule'] = 'لا يمكن إنشاء وحدة المساق.';
...
$string['fixrescalednullgrades'] = 'يحتوي هذا الواجب على بعض الدرجات الخاطئة. يمكنك <a href="{$a->link}">إصلاح هذه الدرجات تلقائياً</a>. هذا قد يؤثر على إجماليات المساق.';
$string['fixrescalednullgradesconfirm'] = 'هل أنت متأكد من رغبتك في إصلاح الدرجات الخاطئة؟ ستتم إزالة كل الدرجات المتأثرة. هذا قد يؤثر على إجماليات المساق.';
