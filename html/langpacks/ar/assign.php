...
$string['assign:grade'] = 'وضع العلامة للواجب';
...
$string['assignmentplugins'] = 'ملاحق الواجب';
...
$string['attemptreopenmethod_help'] = 'هذا الإعداد يُحدِّد ما إذا كان بإمكان الطالب القيام بمحاولات أخرى في الواجب. يتم حفظ العلامة والإفادة لكل محاولة، ويمكن معاينتها من قبل المعلم والطالب. الخيارات المتاحة هي:
