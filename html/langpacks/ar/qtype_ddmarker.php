...
/**
 * Strings for component 'qtype_ddmarker', language 'ar', version '4.5'.
 *
...
$string['followingarewrong'] = 'العلامات الموضوعة في المنطقة الخطأ: {$a}.';
$string['followingarewrongandhighlighted'] = 'العلامات الموضوعة بشكل خاطئ: {$a}. العلامات المميزة ظاهرة الآن مع مواضعها الصحيحة. أنقر على العلامة لتمييز المنطقة المسموح بها.';
