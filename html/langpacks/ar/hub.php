...
$string['creatornotes_help'] = 'ملاحظات المؤلف هي بمثابة دليل للمعلمين حول كيفية استعمال المقرر الدراسي.';
$string['deletescreenshots'] = 'حذف هذه الصور';
$string['deletescreenshots_help'] = 'حذف جميع الصور التي تم رفعها حالياً.';
...
$string['removefromhub'] = 'أزله من Moodle.net';
...
$string['status'] = 'حالة الإدراج في القائمة';
...
$string['unregisterfrom'] = 'إلغاء التسجيل في {$a}';
$string['unregistrationerror'] = 'وقع خطأ عند محاولة إلغاء تسجيل الموقع: {$a}';
$string['update'] = 'تحديث';
$string['updatesite'] = 'قم بتحديث التسجيل في {$a}';
$string['updatesiteregistration'] = 'تحديث التسجيل';
$string['updatestatus'] = 'تحقق منه الآن.';
