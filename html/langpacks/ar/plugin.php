...
/**
 * Strings for component 'plugin', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   plugin
...
$string['type_cachelock'] = 'معالج قفل الخبء';
$string['type_cachelock_plural'] = 'معالجات قفل الخبء';
...
$string['type_gradereport'] = 'تقرير سجل العلامات';
$string['type_gradereport_plural'] = 'تقارير سجل العلامات';
