...
$string['filtershortcodesnotinstalled'] = 'نوصي بتنصيب وتمكين <a href="{$a->installurl}" target="_blank">رموز مختصرات ملحق التنقيح</a>. إنها تسهل استعمال النُتف وتجعلها أكثر فاعلية. إنها تسمح أيضاً بالمبادلة.';
