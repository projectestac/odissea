...
/**
 * Strings for component 'quiz', language 'ar', version '3.8'.
 *
 * @package     quiz
 * @category    string
...
الاسئلة مخزنة في أصناف وذلك لمساعدتك في تنظيمها، ويمكن استعمالها مع أي اختبار في مساقك أو حتى المساقات الأخرى إذا اخترت نشرهما.</p>
...
$string['cannotsetsumgrades'] = 'فشل تعيين مجموع العلامات';
...
$string['downloadextra'] = '(الملف يُخزن أيضاً في ملفات المقرر الدراسي في المجلد /backupdata/quiz)';
...
شكراً على تسليمك لإجاباتك عن \'{$a->quizname}\' في المقرر الدراسي \'{$a->coursename}\' عند {$a->submissiontime}.
...
{$a->studentname} قد أكمل \'{$a->quizname}\' ({$a->quizurl}) في المقرر الدراسي \'{$a->coursename}\'.
...
لقد بدأت بمحاولة \'{$a->quizname}\' في المقرر الدراسي \'{$a->coursename}\'، ولكنك لم تسلمها. وينبغي تسليمها في {$a->attemptduedate}.
...
$string['importfilearea'] = 'الاستيراد من ملف موجود سلفاً ضمن ملفات المقرر الدراسي...';
...
$string['publish'] = 'نشر';
$string['publishedit'] = 'ينبغي أن تكون لديك صلاحية في المقرر الدراسي المنشور لإضافة الأسئلة أو تحريرها في هذا الصنف';
$string['qbrief'] = 'س. {$a}';
$string['qname'] = 'الاسم';
...
$string['savedfromdeletedcourse'] = 'محفوظ من مقرر دراسي محذوف "{$a}"';
...
$string['url'] = 'رابط';
$string['usedcategorymoved'] = 'تم الحفاظ على هذا التصيف ونقله إلى مستوى الموقع لأنه تصنيف منشور لا زال قيد الاستعمال من قبل مقررات دراسية أخرى.';
