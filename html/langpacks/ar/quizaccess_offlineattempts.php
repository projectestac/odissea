...
ملاحظة: لا يمكن محاولة اختبار دون اتصال إذا كان محدداً بوقت، أو يتطلب عنوان شبكة، أو يستعمل أي سلوك للأسئلة بخلاف الإفادة المؤجلة (مع أو بدون منح التقديرات المبني على اليقين).';
$string['confirmdatasaved'] = 'أؤكد أنني لا أملك أيّ عمل غير محفوظ على الجهاز المحمول.';
$string['mobileapp'] = 'تطبيق الجوال';
$string['offlineattemptserror'] = 'لا يمكن محاولة اختبار دون اتصال إذا كان له حد زمني، أو يتطلب عنوان شبكة، أو يستعمل أي سلوك للسؤال بخلاف الإفادة المؤجلة (مع أو بدون منح التقديرات المبني على اليقين).';
