...
/**
 * Strings for component 'choicegroup', language 'ar', version '4.5'.
 *
 * @package     choicegroup
 * @category    string
...
$string['choicegroupopen'] = 'متاح من';
$string['choicegroupoptions'] = 'خيارات اختيار مجموعة';
$string['choicegroupsaved'] = 'تم حفظ اختيارك';
$string['choicetext'] = 'نص الاختيار';
$string['chooseaction'] = 'اختر إجراء';
$string['choosegroup'] = 'قم باختيار مجموعة';
$string['collapse_all_groupings'] = 'طي كل التجميعات';
$string['completionsubmit'] = 'اعرض على أنه منته عندما يحدد المستخدم خياراً';
...
$string['expand_all_groupings'] = 'توسيع كل التجميعات';
...
$string['privacy:metadata'] = 'إن ملحق خيار المجموعة لا يخزن أي بيانات شخصية. كل بيانات المستخدمين تُخزن من قبل مُكون المجموعة لنواة مودل (نواة المجموعة).';
...
$string['removemychoicegroup'] = 'أزل خياري';
