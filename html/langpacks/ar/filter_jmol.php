...
/**
 * Strings for component 'filter_jmol', language 'ar', version '4.4'.
 *
 * @package     filter_jmol
 * @category    string
...
$string['surface'] = 'السطح';
$string['surfacesdotted'] = 'السطوح منقطة';
$string['use_desc'] = 'وصف لتقنية العرض';
$string['whitebackground'] = 'خلفية بيضاء';
