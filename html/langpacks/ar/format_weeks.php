...
/**
 * Strings for component 'format_weeks', language 'ar', version '4.1'.
 *
...
$string['addsections'] = 'إضافة أسبوع';
...
$string['indentation'] = 'السماح بالتداخل في صفحة المساق';
$string['indentation_help'] = 'السماح للمعلمين وغيرهم من المستخدمين ذوي إمكانية إدارة النشاطات بمداخلة العناصر في صفحة المساق.';
$string['newsectionname'] = 'الاسم الجديد للأسبوع {$a}';
$string['page-course-view-weeks'] = 'أي صفحة رئيسية لمساق بالتنسيق الأسبوعي';
$string['page-course-view-weeks-x'] = 'أي صفحة مساق في تنسيق الأسابيع';
