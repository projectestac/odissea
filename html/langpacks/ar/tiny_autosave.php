...
/**
 * Strings for component 'tiny_autosave', language 'ar', version '4.5'.
 *
...
$string['privacy:metadata:database:tiny_autosave:userid'] = 'مُعرَّف المستخدم الذي أنشأ جلسة الحفظ التلقائي';
