...
$string['addnewhost'] = 'أضف مضيفاً جديداً';
...
$string['eventaccesscontrolcreated'] = 'تم إنشاء سيطرة الوصول';
$string['eventaccesscontrolupdated'] = 'تم تحديث سيطرة الوصول';
...
$string['host'] = 'مستضيف';
$string['hostcoursenotfound'] = 'تعذر العثور على المضيف أو المساق';
...
$string['nosite'] = 'تعذر العثور على المساق الذي على مستوى الموقع';
$string['nosuchfile'] = 'الملف/الدالة {$a} غير موجودة.';
$string['nosuchfunction'] = 'تعذر تعيين موضع الدالة، أو إن الدالة ممنوعة في RPC.';
...
$string['remotecourses'] = 'المساقات البعيدة';
