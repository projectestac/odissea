...
/**
 * Strings for component 'question', language 'ar', version '4.1'.
 *
 * @package     question
 * @category    string
...
$string['questionsinuse'] = '* يؤشر الأسئلة المتعذر حذفها لكونها قيد الاستعمال. بدلاً من ذلك، سيتم إخفاؤها في بنك الأسئلة ما لم تضع إشارة على \'إظهار الأسئلة القديمة\'.';
