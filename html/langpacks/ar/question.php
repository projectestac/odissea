...
/**
 * Strings for component 'question', language 'ar', version '3.11'.
 *
 * @package     question
 * @category    string
...
$string['changepublishstatuscat'] = '<a href="{$a->caturl}">الصنف "{$a->name}"</a> في المقرر الدراسي "{$a->coursename}" ستتغير حالة مشاركته من {$a->changefrom} إلى {$a->changeto}.';
$string['check'] = 'تحقَّق';
...
$string['deletecoursecategorywithquestions'] = 'هناك في بنك الأسئلة ما يتعلق بتصنيف المقرر الدراسي هذا. إذا تابعت، سيتم حذفها. قد ترغب بنقل تلك الأسئلة أولاً مستعملاً واجهة بنك الأسئلة.';
...
* سياق تصنيف المقرر - تكون الأسئلة متاحة في جميع وحدات النشاط والمقررات الدراسية التابعة لتصنيف المقرر الدراسي
...
$string['importfromcoursefiles'] = '... أو اختر ملف المقرر الدراسي ليتم استيراده.';
...
$string['missingcourseorcmid'] = 'ينبغي تزويد المعامل print_question بمُعرَّف المقرر الدراسي أو مفتاحه الأساسي.';
$string['missingcourseorcmidtolink'] = 'ينبغي تزويد المعامل get_question_edit_link بمُعرَّف المقرر الدراسي أو مفتاحه الأساسي.';
...
$string['privacy:metadata:link:qformat'] = 'نظام الأسئلة الفرعي يستعمل ملحق استيراد وتصدير تنسيقات الأسئلة لأغراض استيرادها وتصديرها بتنسيقات مختلفة';
...
$string['questionaffected'] = '<a href="{$a->qurl}">السؤال "{$a->name}" ({$a->qtype})</a> موجود ضمن صنف الأسئلة هذا ولكنه قيد الاستعمال أيضاً في <a href="{$a->qurl}">الاختبار "{$a->quizname}"</a> في مقرر دراسي آخر "{$a->coursename}".';
...
$string['unusedcategorydeleted'] = 'لقد تم حذف هذا الصنف، لأنه بعد حذف المقرر الدراسي، لم تستعمل أسئلة الصنف في أي مكان آخر.';
