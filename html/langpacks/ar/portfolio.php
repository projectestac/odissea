...
/**
 * Strings for component 'portfolio', language 'ar', version '4.5'.
 *
 * @package     portfolio
 * @category    string
...
$string['cannotsetvisible'] = 'لا يمكن تغيير هذا الخيار إلى مرئي - الإضافة تم تعطيله تماماً بسبب الإعدادت الخاطئة.';
...
قائمة عينات إضافات المحافظ التي تم تعطيلها هي:
...
$string['singleinstancenomultiallowed'] = 'عينة واحدة فقط لإضافة محفظة متاحة حالياً وهي لا تدعم تصديرات متعددة في نفس الجلسة، وهناك سلفاً عملية تصدير نشطة في الجلسة تستعمل هذه الإضافة!';
