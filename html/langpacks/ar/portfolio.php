...
بعض عينات ملاحق المحافظ قد تم تعطيلها تلقائياً بسبب أخطاء في إعدادات التهيئة. هذا معناه أن المستخدمين لا يستطيعون حالياً تصدير المحتوى إلى هذه المحافظ.
...
<p>بعض عينات ملاحق المحافظ قد تم تعطيلها تلقائياً بسبب أخطاء في إعدادات التهيئة. هذا معناه أن المستخدمين لا يستطيعون حالياً تصدير المحتوى إلى هذه المحافظ.</p>
<p>قائمة عينات ملاحق المحافظ التي تم تعطيلها هي:</p>
{$a->textlist}
<p>هذا ينبغي تصحيحه في أقرب وقت ممكن عبر زيارة <a href="{$a->fixurl}">صفحات تهيئة المحفظة</a>.</p>';
$string['insanebodysmall'] = 'مرحباً! أنت تتلقى هذا الرسالة باعتبارك المشرف على {$a->sitename}.بعض عينات ملاحق المحافظ قد تم تعطيلها تلقائياً بسبب أخطاء في إعدادات التهيئة. هذا معناه أن المستخدمين لا يستطيعون حالياً تصدير المحتوى إلى هذه المحافظ.
هذا ينبغي تصحيحه في أقرب وقت ممكن عبر زيارة {$a->fixurl}.';
$string['insanesubject'] = 'بعض عينات ملاحق المحافظ قد تم تعطيلها تلقائياً';
...
$string['nocommonformats'] = 'لا توجد تنسيقات مشتركة ما بين أي من ملاحق المحافظ المتاحة وموضع الاستدعاء {$a->location} (المستدعي المدعوم {$a->formats})';
...
$string['somepluginsdisabled'] = 'بعض ملاحق المحافظ تم تعطيلها بالكامل، إما لأنها غير صحيحة التهيئة أو تعتمد على مكونات أخرى، وهي:';
