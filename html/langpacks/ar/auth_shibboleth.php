...
/**
 * Strings for component 'auth_shibboleth', language 'ar', version '4.5'.
 *
...
$string['auth_shib_contact_administrator'] = 'في حالة عدم ارتباطك بتلك المنظمات ولكنك بحاجة إلى الوصول إلى مقرر ما في هذا المخدم، لطفاً، تواصل مع <a href="mailto:{$a}">مشرف مودل</a>.';
...
$string['auth_shib_instructions_help'] = 'هناك عليك وضع تعليمات مخصصة لمستخدميك تشرح لهم Shibboleth. سيتم إظهارها في صفحة الدخول في قسم التعليمات. التعليمات ينبغي أن تتضمن رابطاً إلى "<b>{$a}</b>" لينقر عليه المستخدمون عندما يرغبون بتسجيل الدخول.';
...
$string['auth_shibboleth_login_long'] = 'الدخول عن طريق شيبولث';
