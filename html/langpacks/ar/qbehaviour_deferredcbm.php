...
/**
 * Strings for component 'qbehaviour_deferredcbm', language 'ar', version '4.5'.
 *
...
$string['averagecbmmark'] = 'متوسط الدرجة المبنية على اليقين';
$string['basemark'] = 'علامة الأساس {$a}';
$string['breakdownbycertainty'] = 'التقسيم حسب اليقين';
$string['cbmbonus'] = 'علاوة الدرجة المبنية على اليقين';
...
$string['cbmmark'] = 'الدرجة المبنية على اليقين {$a}';
...
-------------------- | ----------------- | ------------- | ----------------
الدرجة إن أصبت     |   1                 |    2            |      3
الدرجة إن أخطأت    |   0                 |   -2            |     -6
...
$string['pluginname'] = 'الإفادة المؤجلة مع الدرجة المبنية على اليقين';
$string['privacy:metadata'] = 'إن ملحق سلوك السؤال، الإفادة المؤجلة مع الدرجة المبنية على اليقين لا يخزن أي بيانات شخصية.';
