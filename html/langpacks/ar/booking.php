...
/**
 * Strings for component 'booking', language 'ar', version '4.5'.
 *
 * @package     booking
 * @category    string
...
$string['beforecompletedtext_help'] = 'إتركه فارغاً لاستعمال النص الافتراضي للموقع. يمكنك استعمال ما تشاء من العناصر النائبة الآتية في النص:
<ul>
<li>{status}</li>
<li>{participant}</li>
<li>{email} - البريد الالكتروني للمستخدم</li>
...
$string['lblbooktootherbooking'] = 'تسمية الزر: حجز المستخدمين بخيار آخر';
$string['lblinstitution'] = 'تسمية الملصق: المؤسسة';
$string['lbllocation'] = 'تسمية الملصق: الموقع';
$string['lblname'] = 'تسمية الملصق: الاسم';
$string['lblnumofusers'] = 'تسمية الملصق: عدد المستخدمين';
$string['lblsputtname'] = 'تسمية الملصق: إرسال رابط الاستطلاع إلى المعلمين';
$string['lblsurname'] = 'تسمية الملصق: اسم العائلة';
$string['lblteachname'] = 'تسمية الملصق: المعلمون';
