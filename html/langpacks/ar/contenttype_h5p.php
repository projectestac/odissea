...
/**
 * Strings for component 'contenttype_h5p', language 'ar', version '3.11'.
 *
...
$string['description'] = 'المحتوى التفاعلي H5P';
$string['h5p:access'] = 'الوصول إلى المحتوى التفاعلي H5P في بنك المحتوى';
$string['h5p:upload'] = 'رفع محتوى H5P جديد';
