...
$string['check_crawlers_details'] = '<p>يُمَكِّن إعداد "مفتوح لمحركات البحث" محركات البحث من الدخول إلى المساقات المتاحة لوصول الضيوف. ليست هناك فائدة من تمكين هذا الإعداد إن كان وصول الضيوف غير مسموح به.</p>';
...
<p>يمكن أيضاً قفل حقل البريد الالكتروني من ملاحق المصادقة، هذه الإحتمالية غير مأخوذ بها هنا.</p>';
...
$string['check_frontpagerole_details'] = '<p>دور الصفحة الأمامية الافتراضي يُعطى لكل المستخدمين المسجلين من أجل نشاطات الصفحة الأمامية. لطفاً، تأكد من عدم السماح بإمكانيات خطيرة في هذا الدور.</p>
<p>من الموصى به إنشاء دور خاص لهذا الغرض وتجنب استعمال دور من نوع موروث.</p>';
$string['check_frontpagerole_error'] = 'تم الكشف عن تعريف خاطئ لدور الصفحة الأمامية "{$a}"!';
$string['check_frontpagerole_name'] = 'دور الصفحة الأمامية';
$string['check_frontpagerole_notset'] = 'دور الصفحة الأمامية غير مُعد.';
$string['check_frontpagerole_ok'] = 'تعريف دور الصفحة الأمامية جيد.';
$string['check_guestrole_details'] = '<p>دور الضيف يستعمل للمستخدمين غير مسجلي الدخول في الموقع ومن أجل الوصول المؤقت للضيوف في المساقات. لطفاً، تأكد من عدم السماح بإمكانيات خطيرة في هذا الدور.</p>
