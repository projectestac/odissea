...
$string['check_antivirus_details'] = 'هذه الحالة تتحرى عما وقع من أخطاء مؤخرًا تم الكشف عنها بناءً على العتبة المحددة في الإعدادات الرئيسية لمضادات الفيروسات.';
$string['check_antivirus_error'] = 'تم اكتشاف {$a->errors} من الأخطاء خلال {$a->lookback} الأخيرة';
$string['check_antivirus_info'] = 'لم يتم تمكين أي من مضادات الفيروسات حاليًا';
$string['check_antivirus_logstore_not_supported'] = 'يتعذر التحقق من حالة مضادات الفيروسات بسبب نوع مخزن الوقوعات المستعمل';
$string['check_antivirus_name'] = 'مضاد الفيروسات';
$string['check_antivirus_ok'] = 'تم تمكين مضاد/ات الفيروسات {$a->scanners}، لم يتم الكشف عن أي مشاكل خلال {$a->lookback} الأخيرة';
...
<p>النوع الموروث المدعوم الوحيد لدور المستخدم الافتراضي هو <em>المستخدم الموثوق</em>. لا ينبغي تمكين إمكانية معاينة المساق.</p>
<p>يرجى التحقق من تمكين الخيار (tool_dataprivacy | automaticdatadeletionapproval) الخاص بالموافقة على التماس حذف البيانات التلقائي قد تم تمكينه. يمكن للمستخدمين أن يطلبوا حذفًا قد يؤدي إلى حذف قدرٍ كبيرٍ من البيانات.</p>';
...
<p>يمكن أيضاً تأمين حقل البريد الالكتروني من إضافات المصادقة، هذه الإحتمالية غير مأخوذ بها هنا.</p>';
...
$string['check_frontpagerole_details'] = '<p>الدور الافتراضي لواجهة الموقع يُعطى لكل المستخدمين المصرح لهم من أجل نشاطات واجهة الموقع. لطفاً، تأكد من عدم السماح بإمكانيات خطيرة في هذا الدور.</p>
<p>من الموصى به إنشاء دور خاص لهذا الغرض وتجنب استعمال دور من نوع موروث.</p>';
$string['check_frontpagerole_error'] = 'تم الكشف عن تعريف خاطئ لدور واجهة الموقع "{$a}"!';
$string['check_frontpagerole_name'] = 'دور واجهة الموقع';
$string['check_frontpagerole_notset'] = 'دور واجهة الموقع غير مُعَد.';
$string['check_frontpagerole_ok'] = 'تعريف دور واجهة الموقع بحالة جيدة.';
...
$string['check_publicpaths_ok'] = 'كل المسارات الداخلية غير مفتوحة للعامة';
$string['check_publicpaths_warning'] = 'بعض المسارات الداخلية مفتوحة للعامة';
