...
$string['check_frontpagerole_details'] = '<p>دور صفحة الواجهة الافتراضي يُعطى لكل المستخدمين المسجلين من أجل نشاطات صفحة الواجهة. لطفاً، تأكد من عدم السماح بإمكانيات خطيرة في هذا الدور.</p>
<p>من الموصى به إنشاء دور خاص لهذا الغرض وتجنب استعمال دور من نوع موروث.</p>';
$string['check_frontpagerole_error'] = 'تم الكشف عن تعريف خاطئ لدور صفحة الواجهة "{$a}"!';
$string['check_frontpagerole_name'] = 'دور صفحة الواجهة';
$string['check_frontpagerole_notset'] = 'دور صفحة الواجهة غير مُعَد.';
$string['check_frontpagerole_ok'] = 'تعريف دور صفحة الواجهة جيد.';
