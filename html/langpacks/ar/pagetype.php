...
/**
 * Strings for component 'pagetype', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   pagetype
...
$string['page-admin-current'] = 'صفحة إدارة الموقع الحالية';
$string['page-admin-x'] = 'أي صفحة إدارة للموقع';
...
$string['page-course-search'] = 'صفحة البحث في المساقات';
...
$string['page-user-x'] = 'كافة صفحات المستخدمين';
$string['page-x'] = 'أي صفحة';
