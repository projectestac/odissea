...
/**
 * Strings for component 'course', language 'ar', version '3.11'.
 *
 * @package     course
 * @category    string
...
$string['activitychoosertabmode_desc'] = 'منتقي النشاطات يتيح للمعلم بسهولة إختيار النشاطات والموارد لإضافتها إلى المقرر الدراسي. هذا الإعداد يحدد التبويبات التي ينبغي لها أن تظهر فيه. لاحظ أن التبويب المعلَّم بنجمة يظهر فقط للمستخدم الذي وضع نجمة لنشاط أو أكثر، أما التبويب الموصى به فيظهر فقط إذا قام المشرف على الموقع بتأشير بعض النشاطات على أنها موصى بها.';
...
$string['aria:courseshortname'] = 'الاسم المختصر للمقرر';
...
$string['customfield_islocked_help'] = 'إذا تم تأمين الحقل، فسيتمكن المستخدمون الذين لديهم إمكانية تغيير الحقول المخصصة المؤمنة فقط (بشكل افتراضي المستخدمون ذوو الدور الافتراضي للمدير فقط) من تغييره في إعدادات المقرر الدراسي.';
...
$string['downloadcourseconfirmation'] = 'أنت على وشك تنزيل ملف مضغوط لمحتوى المقرر الدراسي (باستثناء العناصر غير القابلة للتنزيل وأي ملفات يزيد حجمها عن {$a}).';
$string['downloadcoursecontent'] = 'تنزيل محتوى المقرر الدراسي';
$string['downloadcoursecontent_help'] = 'هذا الإعداد يحدد ما إذا كان بالإمكان تنزيل محتوى المقرر الدراسي من قبل المستخدمين ذوي الإمكانية التي تسمح لهم بتنزيله (إفتراضياً، هم المستخدمون بدور الطلاب والمعلمين).';
$string['enabledownloadcoursecontent'] = 'تمكين تنزيل محتوى المقرر الدراسي';
...
<p>عدد من الطلبة في {$a->coursename} لم يدخلوا إلى المقرر الدراسي على الإطلاق.</p>';
...
<p>عدد من الطلبة في {$a->coursename} لم يدخلوا إلى المقرر الدراسي مؤخراً.</p>';
$string['noteachinginfomessage'] = 'مرحباً {$a->userfirstname}،
<p>هناك مقررات دراسية موعد بدئها سيحل في الأسبوع القادم، قد تم تشخيصها بأنها تفتقر إلى انضمام المعلمين أو الطلبة إليها.</p>';
...
$string['privacy:metadata:completionsummary'] = 'يحتوي المقرر الدراسي على معلومات الإكمال عن المستخدم';
$string['privacy:metadata:favouritessummary'] = 'يحتوي المقرر الدراسي على معلومات تتعلق بتمييزه بنجمة من قبل المستخدم';
...
<p>الطلبة في المقرر الدراسي {$a->coursename} تم تشخيصهم بأنهم معرضون إلى خطر.</p>';
