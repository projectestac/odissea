...
$string['activitynavigation'] = 'التنقل في النشاطات';
$string['activitynavigation:jumptoactivity'] = 'القفز إلى النشاط';
$string['activitynavigation:nexta'] = 'النشاط التالي: {$a}';
$string['activitynavigation:preva'] = 'النشاط السابق: {$a}';
$string['aria:coursecategory'] = 'تصنيف المساق';
$string['aria:courseimage'] = 'صورة المساق';
$string['aria:coursename'] = 'اسم المقرر';
$string['aria:courseshortname'] = 'الاسم المختصر للمقرر الدراسي';
...
$string['downloadcoursecontent_help'] = 'هذا الإعداد يحدد ما إذا كان بالإمكان تنزيل محتوى المقرر من قبل المستخدمين ذوي الإمكانية التي تسمح لهم بتنزيله (إفتراضياً، هم المستخدمون بدور الطلاب والمعلمين).';
...
$string['target:norecentaccesses_help'] = 'هذا المقصد يحدد الطلاب الذين لم يدخلوا إلى المساق رغم انضمامهم إليه خلال فترة التحليل المقررة (الشهر الماضي إفتراضياً).';
$string['target:norecentaccessesinfo'] = 'الطلاب الآتية أسماؤهم لم يدخلوا إلى مساقاتهم رغم انضمامهم إليها خلال فترة التحليل المقررة (الشهر الماضي إفتراضياً).';
