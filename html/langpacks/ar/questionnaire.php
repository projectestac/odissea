...
/**
 * Strings for component 'questionnaire', language 'ar', version '3.11'.
 *
...
$string['missingname'] = 'لا يمكن استعمال السؤال {$a} في مقطع الإفادة هذا لأنه بلا اسم.';
$string['missingnameandrequired'] = 'لا يمكن استعمال السؤال {$a} في مقطع الإفادة هذا لأنه بلا اسم وليس مطلوبًا.';
$string['missingquestion'] = 'الرجاء الإجابة عن السؤال المطلوب';
$string['missingquestions'] = 'الرجاء الإجابة على الأسئلة جميع المطلوبة:';
$string['missingrequired'] = 'لا يمكن استعمال السؤال {$a} في مقطع الإفادة هذا لأنه ليس مطلوبًا.';
...
$string['questionnaire:copysurveys'] = 'نسخ القالب والاستبيانات الخاصة';
