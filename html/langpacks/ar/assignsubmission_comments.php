...
/**
 * Strings for component 'assignsubmission_comments', language 'ar', version '3.11'.
 *
...
$string['blindmarkingname'] = 'المشارك {$a}';
$string['blindmarkingviewfullname'] = 'المشارك {$a->participantnumber} ({$a->participantfullname})';
