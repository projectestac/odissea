...
/**
 * Strings for component 'tool_mobile', language 'ar', version '3.11'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['downloadcourse'] = 'تنزيل المقرر الدراسي';
...
$string['filetypeexclusionlist_desc'] = 'إختر كل أنواع الملفات التي ليست للاستعمال في الجوالات. سيتم سرد هكذا ملفات في المقرر الدراسي، وعندها، إذا حاول المستخدم فتحها، سيتم إظهار تنبيه يوضح بأن ذلك النوع من الملفات غير مهيأ لاستعماله في أجهزة الجوال. يمكن بعدها للمستخدم إلغاء التنبيه أو تجاهله ومحاولة فتح الملف مع ذلك.';
...
$string['qrcodeformobileapploginabout'] = 'إمسح ترميز QR بتطبيق الجوال الخاص بك وسيتم تسجيل دخولك تلقائياً. ستنتهي صلاحية ترميز QR خلال {$a} دقيقة/دقائق.';
