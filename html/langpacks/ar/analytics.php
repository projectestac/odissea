...
$string['timesplittingmethod_help'] = 'فترات التحليل تُعرِّف للنظام متى عليه إحتساب التنبؤات وتدله على أجزاء سجلات التوثيق العائدة لأي نشاط والتي عليه أخذها بعين الاعتبار عند الشروع بتلك الحسابات. على سبيل المثال، يمكن تقسيم فترة المساق إلى أجزاء، بحيث تحصل على التنبؤات عند انتهاء كل جزء منها.';
