...
/**
 * Strings for component 'socialwiki', language 'ar', version '4.5'.
 *
 * @package     socialwiki
 * @category    string
...
$string['allpages'] = 'كل إصدارات الصفحة';
$string['backcomments'] = 'عودة إلى التعليقات';
$string['backoldversion'] = 'عودة إلى الإصدار القديم';
$string['backpage'] = 'عودة إلى الصفحة';
$string['backtomapmenu'] = 'عودة إلى قائمة الخريطة';
$string['backversions'] = 'عودة إلى الإصدارات';
$string['cannoteditpage'] = 'لا يمكنك تحرير هذه الصفحة.';
$string['cannotmanagefiles'] = 'ليس لديك صلاحيات إدارة ملفات الويكي';
$string['cannotviewfiles'] = 'ليست لديك صلاحية معاينة ملفات الويكي.';
$string['cannotviewpage'] = 'لا يمكنك معاينة هذه الصفحة.';
$string['contributors_help'] = 'المستخدمون الذين ساهموا في هذه الصفحة.';
...
الزر الذي تحت الجدول سيقوم بتبديل المعاينة ما بين إظهار الصفحات ذات الصلة (النُسخ الأخرى) وإدراج كل صفحات الويكي.</br>
</br>
للوصول إلى هذه المعاينة، إذهب إلى تبويب المشرف لأي صفحة.';
$string['help_search'] = 'معاينة البحث ستقوم بالبحث في كل من عناوين الصفحات ومحتوياتها ثم تُظهر النتائج.</br>
ترك مربع البحث خاليًا أو طباعة * فيه سيؤدي إلى إظهار كل الصفحات المتاحة.</br>
لمزيد من المعلومات، أنظر <a href="#versions">مساعدة الإصدار</a> نظرًا لأن تلك المعاينات تتصرف بشكل مماثل تمامًا.</br>
</br>
للوصول إلى هذه المعاينة، استعمل مربع البحث عند أعلى يسار أي صفحة للبحث في الويكي الحالي.';
$string['home'] = 'الصفحة الرئيسية';
$string['homemenu'] = 'قائمة الصفحة الرئيسية';
$string['hometitle'] = 'الصفحة الرئيسية للويكي الاجتماعي';
$string['incorrectdeleteversions'] = 'إصدارات الصفحة المقدمة لغرض الحذف غير صحيحة.';
...
$string['navigationfrom'] = 'هذه الصفحة تأتي من';
$string['navigationfrom_help'] = 'صفحات الويكي التي ترتبط بهذه الصفحة';
$string['navigationto'] = 'هذه الصفحة تذهب إلى';
...
$string['nofrompages'] = 'ليست هناك روابط إلى هذه الصفحة';
...
$string['norated'] = 'هذه الصفحة';
$string['noteditblocks'] = 'تعطيل تحرير الكتل';
$string['notopages'] = 'هذه الصفحة لا تربط إلى صفحات أخرى';
...
$string['page-mod-socialwiki-x'] = 'أي صفحة لوحدة الويكي الاجتماعي';
...
$string['socialwiki:addinstance'] = 'إضافة ويكي اجتماعي جديد';
$string['tagsdeleted'] = 'تم حذف وسوم الويكي';
$string['title'] = 'عنوان';
$string['title_help'] = 'عنوان إصدار الصفحة.';
...
$string['userpages_empty'] = 'لم يقم هذا المستخدم بإنشاء أي صفحات.';
...
$string['viewuserpages'] = 'معاينة صفحات المستخدم';
