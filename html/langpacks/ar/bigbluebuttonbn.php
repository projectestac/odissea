...
$string['config_importrecordings_enabled_description'] = 'عند تمكينه مع تمكين ميزة التسجيل، سيكون ممكنًا استيراد التسجيلات من مساقات مختلفة إلى النشاط.';
$string['config_importrecordings_from_deleted_enabled'] = 'استيراد التسجيلات من نشاطات محذوفة مُمَكَّن';
$string['config_importrecordings_from_deleted_enabled_description'] = 'عند تمكينه مع تمكين ميزة التسجيل، سيكون ممكنًا استيراد التسجيلات من نشاطات لم تعد موجودة في المساق.';
...
$string['config_preuploadpresentation_enabled'] = 'تمكين الرفع المسبق للعرض التقديمي';
$string['config_preuploadpresentation_enabled_description'] = 'تمكين ميزة الرفع المسبق للعرض التقديمي في واجهة المستخدم عند إضافة أو تحديث الغرفة أو المؤتمر.';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'يستفيد BBB من config.php مع متغير عام تم إهماله. يرجى تحويل الملف لأنه لن يتم دعمه في الإصدارات المستقبلية';
...
$string['indicator:cognitivedepth'] = 'BBB المعرفي';
$string['indicator:cognitivedepth_help'] = 'يعتمد هذا المؤشر على العمق المعرفي الذي وصل إليه الطالب في نشاط BBB.';
$string['indicator:socialbreadth'] = 'BBB الاجتماعية';
$string['indicator:socialbreadth_help'] = 'يعتمد هذا المؤشر على النطاق الاجتماعي الذي وصل إليه الطالب في نشاط BBB.';
...
$string['modulename_help'] = 'يتيح لك BigBlueButton إنشاء روابط من داخل Moodle للفصول الدراسية عبر الإنترنت في الوقت الفعلي باستخدام BigBlueButton ، وهو نظام مؤتمرات ويب مفتوح المصدر للتعليم عن بعد.

باستخدام BigBlueButton ، يمكنك تحديد العنوان والوصف وإدخال التقويم (الذي يعطي نطاقًا زمنيًا للانضمام إلى الجلسة) والمجموعات والتفاصيل حول تسجيل الجلسة عبر الإنترنت.';
...
$string['search:tags'] = 'BBB - معلومات العلامات';
...
$string['view_groups_nogroups_warning'] = 'لقد تمت تهيئة الغرفة لاستعمال المجموعات ولكن لم يتم تعريف أي منها في المساق.';
...
$string['view_message_recordings_disabled'] = 'تم تعطيل التسجيلات على هذا الخادم. لا يمكن استخدام مثيلات BBB للتسجيلات فقط.';
...
$string['view_recording_course'] = 'المساق';
$string['view_recording_date'] = 'التاريخ';
$string['view_recording_delete_confirmation'] = 'هل أنت متأكد من رغبتك في حذف {$a}؟';
$string['view_recording_delete_confirmation_warning_p'] = 'يرتبط هذا التسجيل مع {$a} من الروابط التي تم استيرادها إلى مساقات أو نشاطات مختلفة. إذا تم حذف التسجيل، ستتم إزالة تلك الروابط أيضًا';
$string['view_recording_delete_confirmation_warning_s'] = 'يرتبط هذا التسجيل مع {$a} من الروابط التي تم استيرادها إلى مساق أو نشاط مختلف. إذا تم حذف التسجيل، ستتم إزالة ذلك الرابط أيضًا';
...
$string['view_recording_unpublish_confirmation_warning_p'] = 'يرتبط هذا التسجيل مع {$a} من الروابط التي تم استيرادها إلى مساقات أو نشاطات مختلفة. إذا تم إلغاء نشر التسجيل، سيتم إلغاء نشر تلك الروابط أيضًا';
$string['view_recording_unpublish_confirmation_warning_s'] = 'يرتبط هذا التسجيل مع {$a} من الروابط التي تم استيرادها إلى مساق أو نشاط مختلف. إذا تم إلغاء نشر التسجيل، سيتم إلغاء نشر ذلك الرابط أيضًا';
