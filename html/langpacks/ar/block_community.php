...
/**
 * Strings for component 'block_community', language 'ar', version '4.5'.
 *
...
$string['addedtoblock'] = 'تم أضافة رابط لهذا المقرر في كتلة مجتمعك';
$string['addtocommunityblock'] = 'احفط الربط لهذا المقرر';
...
$string['coverage'] = 'وسوم: {$a}';
$string['donotrestore'] = 'لا';
$string['dorestore'] = 'نعم';
$string['download'] = 'تنزيل';
$string['downloadable'] = 'المقررات الدراسية  التي استطيع تنزيلها';
...
$string['language'] = 'لغة';
$string['licence'] = 'رخصة';
$string['moredetails'] = 'تفاصيل اضافية';
$string['mycommunities'] = 'مجتمعاتي';
$string['next'] = 'التالي >>>';
...
$string['privacy:metadata:block_community:coursename'] = 'اسم المقرر المجتمعي المرتبط';
$string['removecommunitycourse'] = 'استبعد مساق لمجتمع';
$string['restorecourse'] = 'استرجع مساق';
$string['restorecourseinfo'] = 'استرجع المقرر';
...
$string['visitsite'] = 'قم بزيارة موقع';
