...
/**
 * Strings for component 'gradingform_erubric', language 'ar', version '3.11'.
 *
...
$string['err_missinglogstores'] = '<p><font color="red"><b>خطأ في نظام الوقوعات!</b></font></p>
    ...
    لمزيد من المعلومات، راجع <a target="_blank" href="https://docs.moodle.org/35/en/Learning_Analytics_Enriched_Rubric">توثيقات الملحق</a>.';
...
$string['lockzeropoints_help'] = 'هذا الإعداد يطبق فقط إذا كان مجموع العدد الأدنى من النقاط لكل معيار هو أكبر من الصفر.
    ...
    لمزيد من المعلومات راجع توثيقات الملحق بشأن <a target="_blank" href="https://docs.moodle.org/35/en/Learning_Analytics_Enriched_Rubric#Grade_calculation">إحتساب التقدير</a>.';
$string['name'] = 'الاسم';
