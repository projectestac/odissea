...
/**
 * Strings for component 'chat', language 'ar', version '3.11'.
 *
 * @package     chat
 * @category    string
...
* الاجتماعات المنتظمة للطلاب المشاركين في المقررات الدراسية على الانترنت لتمكينهم من تبادل الخبرات مع الآخرين في نفس المقرر الدراسي ولكن في مكان مختلف
