...
/**
 * Strings for component 'availability_date', language 'ar', version '4.1'.
 *
...
$string['privacy:metadata'] = 'إن إضافة التقييد حسب التاريخ لا تخزن أيّ بيانات شخصية.';
$string['short_from'] = 'متاح من {$a}';
$string['short_from_date'] = 'متاح من {$a}';
$string['short_until'] = 'متاح حتى {$a}';
$string['short_until_date'] = 'متاح حتى نهاية {$a}';
$string['title'] = 'التاريخ';
