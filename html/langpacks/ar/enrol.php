...
$string['actenrolshhdr'] = 'الملاحق المتاحة للانضمام إلى المساق';
...
$string['disableinstanceconfirmself'] = 'هل أنت متأكد حقاً من رغبتك في تعطيل العينة "{$a->name}" التي تتيح لك الوصول إلى هذا المساق؟ من المحتمل أن لا تتمكن من الوصول إلى المساق بعد المتابعة.';
...
$string['errorenrolcohortusers'] = 'خطأ ما عند ضم أعضاء الفوج إلى هذا المساق.';
...
$string['eventuserenrolmentcreated'] = 'المستخدم منضم إلى المساق';
...
$string['proceedtocourse'] = 'استمر إلى محتوى المساق';
