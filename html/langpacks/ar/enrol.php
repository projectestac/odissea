...
$string['deleteinstanceconfirmself'] = 'هل أنت متأكد من رغبتك في حذف العينة "{$a->name}" التي تتيح لك الوصول إلى هذا المقر؟ من المحتمل أن لا تتمكن من الوصول إلى المقرر الدراسي بعد المتابعة.';
$string['deleteinstancenousersconfirm'] = 'أنت على وشك حذف طريقة الانضمام "{$a->name}". هل أنت متأكد من رغبتك في المتابعة؟';
$string['disableinstanceconfirmself'] = 'هل أنت متأكد حقاً من رغبتك في تعطيل نسخة "{$a->name}" التي تتيح لك الوصول إلى هذا المقرر؟ من المحتمل أن لا تتمكن من الوصول إلى المقرر الدراسي بعد المتابعة.';
...
$string['errorenrolcohort'] = 'وقع خطأ عند محاولة إنشاء عيِّنة من ملحق مزامنة الدفعات في هذا المساق.';
...
$string['extremovedaction_help'] = 'إختر الإجراء الذي تريد تنفيذه عند اختفاء انضمام المستخدم من مصدره الخارجي. لطفاً، لاحظ أن بعض بيانات المستخدم وإعداداته ستتم إزالتها من المقرر الدراسي عند إلغاء انضمامه إليه.';
...
$string['instanceeditselfwarningtext'] = 'أنت منضم إلى هذا المقرر بواسطة طريقة الانضمام هذه. التغييرات قد تؤثر على وصولك إليه.';
...
$string['privacy:metadata:user_enrolments:status'] = 'حالة انضمام المستخدم إلى مقرر دراسي';
$string['privacy:metadata:user_enrolments:tableexplanation'] = 'ملحق الانضمام الذي يخزن المستخدمين المنضمين إلى المقرر الدراسي';
...
$string['rolefromthiscourse'] = '{$a->role} (معيَّن في هذا المقرر الدراسي)';
$string['sendfromcoursecontact'] = 'من عنوان اتصال المقرر الدراسي';
...
$string['youenrolledincourse'] = 'أنت منضم إلى المقرر.';
$string['youunenrolledfromcourse'] = 'تم إلغاء انضمامك إلى المقرر الدراسي "{$a}".';
