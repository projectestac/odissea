...
/**
 * Strings for component 'enrol', language 'ar', version '4.1'.
 *
 * @package     enrol
 * @category    string
...
$string['defaultenrol'] = 'إضافة النسخة إلى مساقات جديدة';
$string['defaultenrol_desc'] = 'من الممكن إضافة هذه الإضافة إلى كل المقررات الدراسية الجديدة إفتراضياً.';
