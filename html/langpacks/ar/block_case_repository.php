...
/**
 * Strings for component 'block_case_repository', language 'ar', version '4.5'.
 *
...
$string['config_description_defaults'] = 'إفتراضيًا، كل قيم البيانات الوصفية للنشاط تكون فارغة لكل المقررات/النشاطات.<br/>يمكنك هنا تعريف القيم الافتراضية لكل البيانات الوصفية للنشاطات ولكل وحدة. عند إنشاء نشاط جديد، ستكون قيم البيانات الوصفية هذه بمثالة قوالب لها مع احتفاظ كل عينة منها بقابلية التعديل عليها بشكل مستقل لاحقًا.';
