...
$string['objectclass'] = 'objectClass المستعمل للبحث في المساقات. عادة \'group\' أو \'posixGroup\\';
...
$string['pluginname_desc'] = '<p>يمكنك استعمال مخدم LDAP للسيطرة على الانضمامات عندك. من المفترض أن شجرة LDAP لديك تحتوي على مجموعات تعكس المساقات، وإن كل واحد من تلك المجموعات/المساقات سيكون له مدخلات عضوية تنعكس على الطلاب.</p><p>من المفترض أن المساقات معرفة بمثابة مجموعات في LDAP، ولكل مجموعة عدة حقول انضمام (<em>member</em> أو <em>memberUid</em>) تحتوي على مُعرَّف فريد أو ما يعرف بـ uniqueidentification للمستخدم.</p><p>لاستعمال انضمامات LDAP، على مستخدميك <strong>إجباراً</strong> أن يكون لهم حقل رمز تعريفي idnumber صحيح. مجموعة LDAP عليها أن تمتلك ذلك الرمز التعريفي idnumber في حقل العضو ليكون المستخدم قادراً على الانضمام إلى المساق. هذا عادة ما يسير بشكل جيد إذا سبق لك استعمال مصادقة LDAP.</p><p>سيتم تحديث الانضمامات عندما يقوم المستخدمون بتسجيل دخولهم. يمكنك أيضاً تشغيل نص برمجي لإبقاء الانضمامات متزامنة. أنظر في <em>enrol/ldap/cli/sync.php</em>.</p><p>يمكن ضبط هذا الملحق أيضاً لإنشاء المساقات الجديدة تلقائياً عندما تظهر مجموعات جديدة في LDAP.</p>';
$string['pluginnotenabled'] = 'الملحق غير مُمَكَّن';
$string['privacy:metadata'] = 'إن ملحق انضمام LDAP لا يخزن أي بيانات شخصية.';
$string['role_mapping'] = '<p>لكل دور، عليك تحديد كل سياقات LDAP حيث توجد المجموعات التي تمثل المساقات. إفصل ما بين السياقات المختلفة بفارزة منقوطة (;).</p><p>عليك أيضاً تحديد السمة التي يستعمل مخدم LDAP لتمثيل أعضاء المجموعة. هذا عادة ما تكون \'member\' أو \'memberUid\'.</p>';
