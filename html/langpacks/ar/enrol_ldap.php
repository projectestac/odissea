...
/**
 * Strings for component 'enrol_ldap', language 'ar', version '3.11'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['assignrole'] = 'تعيين دور \'{$a->role_shortname}\' للمستخدم \'{$a->user_username}\' في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
...
$string['autocreation_settings'] = 'الإعدادت التلقائية لإنشاء المقرر الدراسي';
$string['autoupdate_settings'] = 'الإعداد التلقائية لتحديث المقرر الدراسي';
...
$string['cannotcreatecourse'] = 'تعذر إنشاء المقرر الدراسي: البيانات المطلوبة مفقودة من سجل LDAP!';
$string['cannotupdatecourse'] = 'تعذر تحديث المقرر الدراسي: البيانات المطلوبة مفقودة من سجل LDAP!  الرمز التعريفي للمقرر هو: \'{$a->idnumber}\\';
$string['cannotupdatecourse_duplicateshortname'] = 'تعذر تحديث المقرر الدراسي: تكرار في الاسم المختصر. يتم تجاوز المقرر الدراسي ذي  الرمز التعريفي \'{$a->idnumber}\'...';
...
$string['coursenotexistskip'] = 'المقرر الدراسي \'{$a}\' غير موجود والإنشاء التلقائي للمقررات معطل، تم تجاوزه';
$string['courseupdated'] = 'تم تحديث المقرر الدراسي ذي  الرمز التعريفي \'{$a->idnumber}\' بنجاح.';
$string['courseupdateskipped'] = 'المقرر الدراسي ذي  الرمز التعريفي \'{$a->idnumber}\' لا يحتاج التحديث، تم تجاوزه.';
$string['createcourseextid'] = 'إنشاء مستخدم منضم إلى المقرر الدراسي غير الموجود \'{$a->courseextid}\'';
$string['createnotcourseextid'] = 'المستخدم المنضم إلى المقرر الدراسي غير الموجود \'{$a->courseextid}\\';
$string['creatingcourse'] = 'يتم إنشاء المقرر الدراسي \'{$a}\'...';
$string['duplicateshortname'] = 'فشل إنشاء المقرر . تكرار الاسم المختصر. تم تجاوز المقرر الدراسي ذي الرمز التعريفي \'{$a->idnumber}\'...';
$string['editlock'] = 'تأمين القيمة';
$string['emptyenrolment'] = 'أفرغ الانضمام لدور \'{$a->role_shortname}\' في المقرر الدراسي \'{$a->course_shortname}\\';
$string['enrolname'] = 'LDAP';
$string['enroluser'] = 'ضم المستخدم \'{$a->user_username}\' في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
$string['enroluserenable'] = 'تمكين الانضمام للمستخدم \'{$a->user_username}\' في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
$string['explodegroupusertypenotsupported'] = 'الدالة ldap_explode_group() لا تدعم نوع المستخدم المحدد: {$a}';
$string['extcourseidinvalid'] = 'المُعرَّف الخارجي للمقرر غير صحيح!';
$string['extremovedsuspend'] = 'تعطيل الانضمام للمستخدم \'{$a->user_username}\' في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
$string['extremovedsuspendnoroles'] = 'تعطيل الانضمام للمستخدم \'{$a->user_username}\'  وأزل أدواره في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
$string['extremovedunenrol'] = 'ألغ انضمام المستخدم \'{$a->user_username}\'  في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
$string['failed'] = 'فشل!';
...
$string['synccourserole'] = '== مزامنة المقرر الدراسي \'{$a->idnumber}\' لدور \'{$a->role_shortname}\\';
$string['syncenrolmentstask'] = 'مهمة مزامنة انضمامات LDAP';
$string['template'] = 'إختياري: المقررات الدراسية المنشأة تلقائياً يمكنها أن تنسخ إعداداتها من مقرر يعمل بمثابة قالب';
$string['template_key'] = 'القالب';
$string['unassignrole'] = 'إلغاء تعيين دور \'{$a->role_shortname}\' للمستخدم \'{$a->user_username}\' من المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
$string['unassignrolefailed'] = 'فشل إلغاء تعيين دور \'{$a->role_shortname}\' للمستخدم \'{$a->user_username}\' في المقرر الدراسي \'{$a->course_shortname}\' (المُعرَّف {$a->course_id})';
