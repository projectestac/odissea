...
/**
 * Strings for component 'enrol_ldap', language 'ar', version '4.5'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['duplicateshortname'] = 'فشل إنشاء المقرر الدراسي . تكرار الاسم المختصر. تم تجاوز المقرر الدراسي ذي الرمز التعريفي \'{$a->idnumber}\'...';
...
$string['memberattribute_isdn'] = 'إذا كانت عضوية المجموعة تحتوي على أسماء مميزة، فعليك تحديدها هنا. إن كان الأمر كذلك، عليك إكمال باقي الإعدادات في هذا القسم.';
