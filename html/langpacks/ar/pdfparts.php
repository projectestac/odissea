...
/**
 * Strings for component 'pdfparts', language 'ar', version '3.11'.
 *
 * @package     pdfparts
 * @category    string
...
$string['printintroexplain'] = 'أتريد عرض وصف PDF أسفل المحتوى؟ بعض أنواع العرض قد لا تُظهر الوصف حتى عند تمكينه.';
