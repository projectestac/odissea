...
/**
 * Strings for component 'qtype_match', language 'ar', version '4.5'.
 *
 * @package     qtype_match
 * @category    string
...
$string['pluginnamesummary'] = 'الجواب على أي من الأسئلة الفرعية ينبغي تحديده من قائمة إحتمالات.';
...
$string['regradeissuenumchoiceschanged'] = 'عدد الخيارات قد تغير.';
$string['regradeissuenumstemschanged'] = 'عدد الأسئلة الفرعية قد تغير.';
