...
/**
 * Strings for component 'filters', language 'ar', version '4.4'.
 *
 * @package     filters
 * @category    string
...
$string['filterallwarning'] = 'تطبيق المنقحات على العناوين فضلاً عن المحتويات يمكنه زيادة الحمل على مخدمك إلى حد كبير. لطفاً، استعمل إعدادات \'التطبيق على\' بشكل متحفظ. الاستعمال الرئيسي هو مع منقح تعدد اللغات.';
$string['filtersettings'] = 'إعدادات المنقح';
$string['filtersettings_help'] = 'هذه الصفحة تتيح لك تفعيل المنقحات وتعطيلها في أجزاء معينة من الموقع.

بعض المنقحات قد تسمح لك أيضاً بضبط إعدادات محلية، وفي تلك الحالة، سيظهر لك رابط لإجراء الضبط مجاوراً لأسمائها.';
...
$string['globalrolelabel'] = '{$a->label} هو {$a->value}';
...
$string['off'] = 'مغلق';
$string['offbutavailable'] = 'مغلق ولكنه متاح';
$string['on'] = 'فعال';
$string['privacy:reason'] = 'إن نظام المنقحات الفرعي لا يخزن أي بيانات شخصية.';
...
$string['replacefilters'] = 'استبدال المنقحات';
