...
$string['basepalette_desc'] = 'تتم تهيئة لوحة أدوات التعليق الأساسية <a href="{$a}">هنا</a> بالنسبة إلى موقع مودل بأكمله. يمكن للمعلمين عندها تهيئة لوحات الأدوات الخاصة بهم في مساقاتهم عبر قائمة إدارة المساق.';
