...
/**
 * Strings for component 'assignfeedback_editpdfplus', language 'ar', version '4.4'.
 *
...
$string['adminplugin_color'] = 'اللون';
$string['adminplugin_color_desc'] = 'لون التعليق';
$string['adminsubtitle'] = 'تهيئة شريط الأدوات لتعليقات PDF المتقدمة';
$string['admintitle'] = 'تهيئة الإفادة';
$string['admintoolboxannotation'] = 'التعليق';
$string['admintoolboxannotation_color'] = 'اللون';
$string['admintoolboxannotation_reply'] = 'سؤال/جواب';
$string['admintoolboxcartridge_color'] = 'اللون';
$string['annotationcolour'] = 'لون التعليق';
$string['axis_add'] = 'إضافة محور جديد';
$string['axis_label'] = 'الاسم';
$string['basepalette'] = 'أدوات التعليق الأساسية';
$string['basepalette_desc'] = 'تتم تهيئة لوحة أدوات التعليق الأساسية <a href="{$a}">هنا</a> بالنسبة إلى موقع مودل بأكمله. يمكن للمعلمين عندها تهيئة لوحات الأدوات الخاصة بهم في مساقاتهم عبر قائمة إدارة المقرر.';
$string['cannotopenpdf'] = 'تعذر فتح ملف PDF. قد يكون الملف تالفاً، أو هو بصيغة غير مدعومة.';
$string['couldnotsavepage'] = 'تعذر حفظ الصفحة {$a}';
$string['default_help'] = 'إذا تم ضبطه، سيتم تمكين طريقة الإفادة هذه إفتراضياً لكل الواجبات الجديدة.';
$string['delete_model_question'] = 'هل تريد حذف هذا النموذج؟';
$string['deleteannotation'] = 'حذف التعليق';
...
$string['draftchangessaved'] = 'تم حفظ مسودة التعليقات';
$string['erase_student_annotation_desc'] = 'تعديلات الطلاب عند تحديث التعليقات';
$string['erase_student_on_update'] = 'الإبقاء على تعديلات الطلاب عند تحديث التعليقات';
$string['erase_student_on_update_desc'] = 'الإبقاء على تعديلات الطلاب عند تحديث التعليقات، الافتراضي لا';
...
$string['preparesubmissionsforannotation'] = 'تحضير التسليمات لوضع التعليقات عليها';
$string['privacy:metadata:colourpurpose'] = 'لون التعليق';
$string['privacy:metadata:conversionpurpose'] = 'تم تحويل الملفات إلى ملفات PDF للسماح بوضع التعليقات';
...
$string['question_select'] = 'السؤال';
$string['question_select_with'] = 'مع';
$string['question_select_without'] = 'بدون';
