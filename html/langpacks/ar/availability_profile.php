...
/**
 * Strings for component 'availability_profile', language 'ar', version '4.5'.
 *
...
$string['label_value'] = 'القيمة للمقارنة بها';
$string['missing'] = '(حقل مفقود: {$a})';
...
$string['privacy:metadata'] = 'إن إضافة التقييد حسب الملف الشخصي لا تخزن أي بيانات شخصية.';
