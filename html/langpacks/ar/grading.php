...
$string['formnotavailable'] = 'تم اختيار طريقة متقدمة لمنح التقديرات، ولكن نموذجها غير متوافر حتى الآن. ينبغي عليك تعريف النموذج أولاً من خلال الرابط الموجود في قائمة الإجراءات أو كتلة الإشراف.';
...
$string['manageactionshareconfirm'] = 'أنت بصدد حفظ نسخة من نموذج منح التقديرات \'{$a}\' بمثابة قالب عمومي جديد. سيتمكن المستخدمون الآخرون في موقعك من إنشاء نماذج منح تقديرات جديدة لنشاطاتهم مستندين على هذا القالب.';
...
$string['searchtemplate_help'] = 'يمكنك البحث عن نموذج منح التقديرات واستعماله بمثابة قالب لنموذج منح التقديرات الجديد هنا. ببساطة، أدخل الكلمات التي تتوقع وجودها في تسمية النموذج، وصفه، أو متن النموذج نفسه. للبحث عن عبارة كاملة كما هي، ضع كلماتها بين علامتي اقتباس مزدوج.
...
$string['templatepickconfirm'] = 'هل ترغب باستعمال نموذج منح التقديرات \'{$a->formname}\' بمثابة قالب لنموذج منح التقديرات الجديد في \'{$a->component} ({$a->area})\'؟';
