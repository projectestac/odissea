...
/**
 * Strings for component 'organizer', language 'ar', version '3.11'.
 *
 * @package     organizer
 * @category    string
...
$string['configmaximumgrade'] = 'يعين القيمة الافتراضية المحددة في حقل العلامة عند إنشاء منظم جديد. هذه هي أقصى علامة يمكن تعيينها للطالب بشأن موعده.';
...
$string['privacy:metadata:grade'] = 'العلامة التي تلقاها المستخدم أو المجموعة لهذه الفسحة الزمنية';
