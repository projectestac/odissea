...
/**
 * Strings for component 'format_socialwall', language 'ar', version '4.4'.
 *
...
$string['enablestudentupload_help'] = 'سيتمكن الطلاب من إضافة الملفات أو الروابط إلى المنشور';
$string['missingcapdeletecomment'] = 'ليست لديك صلاحية حذف هذا التعليق.';
$string['missingcapdeletepost'] = 'ليست لديك صلاحية حذف المنشور.';
...
$string['timeagodays'] = 'قبل {$a->days} أيام و {$a->hours} ساعات';
$string['timeagomonthdays'] = 'قبل %m months %d أيام';
$string['timeagoyearsdays'] = 'قبل %y years %m أشهر';
