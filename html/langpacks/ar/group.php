...
/**
 * Strings for component 'group', language 'ar', version '4.1'.
 *
 * @package     group
 * @category    string
...
$string['groupingsection_help'] = 'التجميع هي عبارة عن مجموعة من المجموعات ضمن المساق. إذا تم تحديد تجميع هنا، فقط الطلاب المُضافون إلى مجموعات داخل هذا التجميع يمكنهم الوصول إلى المقطع.';
...
نمط المجموعات المعرَّف على مستوى المساق هو النمط الافتراضي لكل الأنشطة ضمنه. كل نشاط يدعم المجموعات يمكن أن يعرِّف نمط المجموعات الخاص به أيضاً، ولكن إن كان نمط المجموعات مفروضاً على مستوى المساق، سيتم تجاهل هذا الإعداد في كل النشاطات.';
$string['groupmodeforce'] = 'فرض نمط المجموعات';
$string['groupmodeforce_help'] = 'إن كان نمط المجموعات مفروضاً، سيتم تطبيق نمط مجموعات المساق على كل الأنشطة، وسيتم تجاهل هذا الإعداد في كل النشاطات.';
