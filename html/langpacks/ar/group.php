...
/**
 * Strings for component 'group', language 'ar', version '3.11'.
 *
 * @package     group
 * @category    string
...
$string['enrolmentkey_help'] = 'يُمكِّن استعمال مفتاح الانضمام جعل الوصول إلى المقرر الدراسي مقتصراً على أولئك الذين يعرفون المفتاح فقط. إذا تم تحديد مفتاح الانضمام للمجموعة أيضاً، فاستعماله لن يسمح للمستخدم بالوصول إلى المقرر فحسب، بل سيقوم بمنحه عضوية تلك المجموعة أيضاً.

ملاحظة: يجب تمكين مفاتيح انضمام المجموعات في إعدادات الانضمام الذاتي، ويجب أيضاً تحديد مفتاح الانضمام إلى المقرر الدراسي.';
...
$string['groupingsection_help'] = 'التجميع هي عبارة عن مجموعة من المجموعات ضمن المقرر الدراسي. إذا تم تحديد تجميع هنا، فقط الطلاب المُضافون إلى مجموعات داخل هذا التجميع يمكنهم الوصول إلى المقطع.';
...
* بلا مجموعات
* مجموعات منفصلة: يمكن لكل عضو في المجموعة مشاهدة أفراد مجموعته فقط، الآخرون مخفيون تماماً
* مجموعات مرئية: كل عضو في المجموعة يعمل ضمن مجموعته، ولكن يستطيع مشاهدة باقي المجموعات

نمط المجموعات المعرَّف على مستوى المقرر الدراسي هو النمط الافتراضي لكل الأنشطة ضمنه. كل نشاط يدعم المجموعات يمكن أن يعرِّف نمط المجموعات الخاص به أيضاً، ولكن إن كان نمط المجموعات مفروضاً على مستوى المقرر الدراسي، سيتم تجاهل هذا الإعداد في كل النشاطات.';
$string['groupmodeforce'] = 'فرض نمط المجموعات';
$string['groupmodeforce_help'] = 'إن كان نمط المجموعات مفروضاً، سيتم تطبيق نمط مجموعات المقرر الدراسي على كل الأنشطة، وسيتم تجاهل هذا الإعداد في كل النشاطات.';
...
$string['nogroups'] = 'لا توجد مجموعات أنشئت في هذا المقرر بعد';
