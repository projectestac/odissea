...
/**
 * Strings for component 'error', language 'ar', version '4.1'.
 *
 * @package     error
 * @category    string
...
$string['cannotaddcoursemodule'] = 'تعذرت إضافة وحدة مساق جديدة';
...
$string['cannotmarktopic'] = 'لا يمكن تصحيح هذا الموضوع لهذا المساق';
...
$string['cannotswitcheditmodeon'] = 'تعذر تشغيل وضع التحرير';
...
$string['invalidcourseformat'] = 'تنسيق المساق غير صحيح';
...
$string['unknowncourse'] = 'اسم المساق غير معروف "{$a}"';
