...
/**
 * Strings for component 'error', language 'ar', version '4.4'.
 *
 * @package     error
 * @category    string
...
$string['cannotmarktopic'] = 'لا يمكن تأشير هذا القسم لهذا المقرر';
...
$string['unknownhelp'] = 'قسم مساعدة غير معروف {$a}';
