...
/**
 * Strings for component 'blog', language 'ar', version '3.8'.
 *
 * @package     blog
 * @category    string
...
$string['autotags_help'] = 'أدخل واحد أو أكثر من الوسوم المحلية (مفصولة بفاصلة) التي تريد إضافتها تلقائيًا إلى كل مشاركة مدونة تم نسخها من المدونة الخارجية إلى مدونتك المحلية.';
$string['backupblogshelp'] = 'في حالة تشغيله سيتم تضمين المدونة في النسخ الاحتياطي للموقع';
...
$string['cannotviewcourseblog'] = 'لا تملك صلاحية عرض مدونات هذا المقرر';
$string['cannotviewcourseorgroupblog'] = 'عرضلا تملك صلاحية استعراض مدونات هذا المقرر/المجموعة';
$string['cannotviewsiteblog'] = 'لا تملك صلاحية عرض جميع مدونات الموقع';
...
$string['configmaxexternalblogsperuser'] = 'عدد المدونات الخارجية المسموح للمستخدم بربطها بمدونة موودل الخاصة به.';
...
$string['courseblog'] = 'مدونة المقرر: {$a}';
...
$string['deleteblogassociations'] = 'احذف ارتباطات المدونة';
$string['deleteblogassociations_help'] = 'إذا تم وضع علامة على أن مشاركات المدونة لم تعد مرتبطة بهذا المقرر أو أي أنشطة أو موارد للمقرر. لن يتم حذف مداخل المدونة نفسها.';
$string['deleteentry'] = 'حذف مشاركة';
$string['deleteexternalblog'] = 'إلغاء تسجيل هذه المدونة الخارجية';
$string['deleteotagswarn'] = 'هل أنت متأكد من رغبتك بإزالة هذه العلامات من جميع مشاركات المدونة وإزالتها من النظام؟';
...
$string['eventblogassociationdeleted'] = 'تم حذف اقتران المدونة';
$string['eventblogentriesviewed'] = 'شوهدت محتويات المدونة';
$string['eventblogexternaladded'] = 'تم تسجيل المدونة الخارجية';
$string['eventblogexternalremoved'] = 'مدونة خارجية تم إلغاء تسجيلها';
$string['eventblogexternalupdated'] = 'مدونة خارجية تم تحديثها';
$string['evententryadded'] = 'تمت إضافة مشاركة';
$string['evententrydeleted'] = 'تم حذف مشاركة';
$string['evententryupdated'] = 'مشاركة مدونة تم تحديثها';
$string['eventexternalblogsviewed'] = 'المدونات الخارجية المسجلة التي تمت معاينتها';
...
$string['readfirst'] = 'اقرأ هذه أولاً';
...
$string['wrongpostid'] = 'رقم مشاركة غير صحيح';
