...
/**
 * Strings for component 'blog', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   blog
...
$string['assocdescription'] = 'إذا كنت تكتب عن دورة تدريبية و / أو وحدات نشاط ، فحددها هنا.';
...
$string['configuseblogassociations'] = 'تمكين ربط مدخلات المدونات بالمساقات ووحدات المساقات';
...
$string['eventblogassociationadded'] = 'تم إنشاء متعلقات المدونة';
$string['eventblogassociationdeleted'] = 'تم حذف متعلقات المدونة';
$string['eventblogentriesviewed'] = 'تمت معاينة مدخلات المدونة';
...
$string['evententryadded'] = 'تمت إضافة المشاركة';
$string['evententrydeleted'] = 'تم حذف المشاركة';
$string['evententryupdated'] = 'تم تحديث المشاركة';
