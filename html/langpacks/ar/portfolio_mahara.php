...
/**
 * Strings for component 'portfolio_mahara', language 'ar', version '4.4'.
 *
...
$string['err_invalidhost_help'] = 'هذه الإضافة معرفة بشكل خاطئ لأنها تشير إلى مضيف شبكة مودل غير صحيح (أو محذوف). هذا الإضافة تعتمد على نظراء شبكة مودل مع كون SSO IDP منشورة، SSO_SP مشترك فيها، والمحفظة مشترك فيها <b>و</b> منشورة.';
$string['err_networkingoff'] = 'شبكة مودل مطفأة';
$string['err_networkingoff_help'] = 'مصادقة شبكة مودل معطل حالياً. لطفاً، قم بتمكينه قبل محاولة تهيئة هذه الإضافة. أي عينات لهذه الإضافة تبقى مخفية حتى تمكين شبكة مودل. ثم ينبغي جعلها مرئية يدوياً مرة أخرى.';
...
$string['err_nomnethosts_help'] = 'هذه الإضافة تعتمد على نظراء شبكة مودل مع كون SSO IDP منشورة، SSO SP مشترك فيها، خدمات المحفظة منشورة <b>و</b> مشترك فيها فضلاً عن إضافة مصادقة شبكة مودل. أي عينات من هذه الإضافة تبقى مخفية حتى تتم تلبية هذه الشروط. ثم ينبغي جعلها مرئية يدوياً مرة أخرى.';
...
$string['privacy:metadata'] = 'هذه الإضافة ترسل البيانات خارجياً إلى تطبيق مهارا مرتبط. هو لا يحفظ البيانات محلياً';
