...
/**
 * Strings for component 'customfield', language 'ar', version '4.5'.
 *
 * @package     customfield
 * @category    string
...
$string['deletecategory'] = 'حذف تصنيف الحقل المخصص: {$a}';
$string['deletefield'] = 'حذف الحقل المخصص: {$a}';
$string['description'] = 'الوصف';
$string['description_help'] = 'يتم عرض الوصف في النموذج أسفل الحقل.';
$string['edit'] = 'تعديل';
$string['editcategoryname'] = 'تعديل اسم الفئة';
$string['editfield'] = 'تحرير الحقل المخصص: {$a}';
...
$string['eventcategorycreated'] = 'فئة حقل مخصص تم إنشاؤها';
$string['eventcategorydeleted'] = 'فئة حقل مخصص تم حذفها';
$string['eventcategoryupdated'] = 'فئة حقل مخصص تم تحديثها';
$string['eventfieldcreated'] = 'لحقل مخصص تم إنشاؤه';
$string['eventfielddeleted'] = 'حقل مخصص تم حذفه';
$string['eventfieldupdated'] = 'حقل مخصص تم تحديثه';
...
$string['modify'] = 'تعديل';
$string['movecategory'] = 'أنقل "{$a}"';
$string['movefield'] = 'أنقل "{$a}"';
$string['no'] = 'لا';
$string['nocategories'] = 'لا توجد حقول وفئات مخصصة.';
...
$string['privacy:metadata:customfield_data:valuetrust'] = 'علم الثقة للقيمة عندما تكون نصًا';
