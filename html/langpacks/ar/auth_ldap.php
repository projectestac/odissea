...
/**
 * Strings for component 'auth_ldap', language 'ar', version '3.8'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['syncroles'] = 'زامن أدوار النظام من LDAP';
...
$string['updateremfail'] = 'خطأ عند تحديث سجل LDAP. رمز الخطأ: {$a->errno}؛ نص الخطأ: {$a->errstring}<br/>Key ({$a->key}) - قيمة مودل القديمة: \'{$a->ouvalue}\' القيمة الجديدة: \'{$a->nuvalue}\\';
