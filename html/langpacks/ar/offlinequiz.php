...
/**
 * Strings for component 'offlinequiz', language 'ar', version '3.11'.
 *
 * @package     offlinequiz
 * @category    string
...
$string['privacy:metadata:offlinequiz_results:usageid'] = 'مُعرَّف قالب الاستعمال لواجهة برمجة التطبيق العائدة للاختبار حيث تم حفظ هذه النتيجة';
