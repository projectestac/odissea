...
$string['addlist'] = 'إضافة قائمة الحضور';
$string['addnewpagesafterselected'] = 'إضافة فاصل صفحات بعد الأسئلة المحددة';
$string['addnewquestion'] = 'سؤال جديد';
$string['addnewquestionsqbank'] = 'إضافة الأسئلة الى الصنف {$a->catname}: {$a->link}';
$string['addnewuseroverride'] = 'إضافة تجاوز لمستخدم';
$string['addpagebreak'] = 'إضافة فاصل صفحات';
$string['addpagehere'] = 'إضافة صفحة هنا';
$string['addparts'] = 'إضافة مشاركين';
$string['addquestionfrombankatend'] = 'إضافة من بنك الأسئلة عند نهاية الصفحة';
$string['addquestionfrombanktopage'] = 'إضافة من من بنك الأسئلة الى الصفحة {$a}';
$string['addrandom'] = 'أضف عشوائياً {$a} من الأسئلة من ذات الخيارات المتعددة';
...
$string['addtoofflinequiz'] = 'إضافة الى الاختبار غير المتصل بالإنترنت';
$string['addtoqueue'] = 'إضافة الى طابور الانتظار';
...
$string['attendanceoverview'] = 'الحاضرون';
$string['attendances'] = 'الحاضرون';
$string['attendancesevaluationheadline'] = '2. التقييم';
$string['attendancesheadline'] = 'الحاضرون';
$string['attendancespreparationheadline'] = '1. التحضير';
$string['attendenceoverviewattwithoutresults'] = 'حاضر بدون نتائج:';
$string['attendenceoverviewattwithresults'] = 'حاضر مع نتائج:';
$string['attendenceoverviewcorrectionnecessary'] = 'التصويب ضروري (صفحات):';
$string['attendenceoverviewnoattwithoutresults'] = 'غائب بدون نتائج:';
$string['attendenceoverviewnoattwithresults'] = 'غائب مع نتائج:';
$string['backtopreview'] = 'إظهار المعاينة';
...
$string['calibratescanner'] = 'تعيير الماسح الضوئي';
...
$string['chooseagroup'] = 'إختر المجموعة...';
...
$string['completiondetail:passgrade'] = 'تلقي درجة النجاح';
$string['completionpass'] = 'النجاح لإكماله';
$string['completionpass_help'] = 'يُكمل الطلاب هذا الاختبار غير المتصل فقط إذا أحرزوا درجة أعلى أو تساوي درجة النجاح الموضوعة ضمن خيارات الدرجة';
...
$string['configuseridentification'] = 'صيغة تصف تعريف المستخدم. تُستعمل هذه الصيغة لتعيين نماذج الإجابات للمستخدمين في النظام. يُعرف الجانب الأيمن من المعادلة عدد المراتب (صحيحة فقط وبحد أقصاه 10 مراتب). الجانب الأيسر من المعادلة ينبغي أن يشير إلى أحد حقول جدول المستخدمين في مودل (مثلاً رقم المُعرَّف، رقم الجوال).
فضلاً عن ذلك، يمكن للمعادلة التعامل مع بادئة ولاحقة تضاف إلى المراتب المؤشرة (مثل "a[7]=username" أو "b[5]cd=username"). تلك الترابطات من السلاسل النصية والرقمية تشير إلى قيمة الحقل المستعمل في جدول المستخدمين، والمستعملة لغرض تمييزهم.';
...
$string['correctheader'] = 'التصويب ضروري:';
$string['correctionerrors'] = 'النماذج ذات التصويبات للأخطاء';
$string['correctionform'] = 'التصويب';
$string['correctionforms'] = 'نماذج التصويب';
$string['correctionheader'] = 'التصويب';
$string['correctionheader_help'] = '<p>نماذج الإجابات المعروضة هنا بحاجة إلى انتباهك، ويجب تصويبها يدويًا. التقييم التلقائي غير ممكن.</p>
<u>قد تحدث الأخطاء التالية...</u>
<ul>
<li><strong>علامات غير دقيقة:</strong> تعذر تقييم بعض العلامات.</li>
<li><strong>رقم المجموعة غير صحيح:</strong> تعذر تقييم رقم المجموعة.</li>
<li><strong>رقم الصفحة غير صحيح:</strong> تعذر تقييم رقم الصفحة.</li>
<li><strong>غير مُعدّل:</strong> تم مسح نموذج الإجابة بشكل غير صحيح، ولا يمكن تقييمه.</li>
<li><strong>توجد نتيجة مختلفة:</strong> توجد نتيجة مُقيّمة برقم مجموعة مختلف.</li>
<li><strong>صفحات غير مكتملة:</strong> تم تقييم ورقة الإجابة الحالية، ولكن هناك ورقة إضافية واحدة على الأقل مفقودة لإكمال تقييم المشارك المُحدد. (يحدث فقط مع نماذج الإجابات متعددة الصفحات.)</li>
<li><strong>النتيجة موجودة:</strong> النتيجة المُقيّمة موجودة بالفعل.</li>
<li><strong>المستخدم غير موجود في المساق:</strong> المشارك المُحدد غير مُسجل حاليًا في المساق.</li>
<li><strong>المستخدم غير موجود:</strong> المشارك المُحدد غير معروف.</li>
</ul>';
$string['correctionoptionsheading'] = 'خيارات التصويب';
$string['correctupdated'] = 'نموذج التصويب المحدث للمجموعة {$a}.';
...
$string['createpdfs'] = 'النماذج';
$string['createpdfsparticipants'] = 'النماذج';
...
$string['defaultparticipantsusage'] = 'تسجيل الحضور';
$string['defaultparticipantsusagedesc'] = 'يحدد ما إذا كان ينبغي تسجيل الحاضرين مع قوائم الحضور إفتراضيًا.';
$string['defaultpdffont'] = 'الخط الافتراضي في النموذج';
$string['defaultpdffont_help'] = 'الخط الافتراضي الذي يستعمله الاختبار غير المتصل في النماذج. قد ترغب بتنزيل الحزمة tcpdf يدويًا واستخراج ما تحتويه من خطوط إلى المجلد $CFG->dataroot/fonts/ للحصول على مزيد من الخطوط. من الموصى به استعمال Freeserif بمثابة الخط الافتراضي نظرًا لكونه يدعم أغلب الحروف. أنظر https://www.gnu.org/software/freefont/coverage.html لقائمة التوافق الكاملة.';
$string['defaultpdffontsize'] = 'الحجم الافتراضي للخط';
...
$string['discriminationindex_info'] = 'بما أن مؤشر التمييز يحسب التنبؤ بالسؤال بين الدرجات الجيدة والدرجات المتدنية، فلا يمكن حسابه إذا:
- لم تكن هناك إجابات مختلفة للطلاب في هذا السؤال.
- لم تكن هناك درجات مختلفة في الاختبار.';
$string['displayoptions'] = 'خيارات العرض';
$string['documentschanged'] = 'تم تغيير سؤال أو أسئلة أخرى في الاختبار غير المتصل بالإنترنت منذ إنشاء المستندات.<br>سيتم إعادة تقييم النتائج المستقبلية تلقائيًا أثناء التقييم إلى الإصدار الحالي من الأسئلة المختارة هنا. سيظل الإصدار الأصلي من الأسئلة معروضًا في المستندات.';
$string['documentschangedwithresults'] = 'تم تغيير سؤال أو أسئلة أخرى في الاختبار غير المتصل بالإنترنت منذ إنشاء المستندات.<br>تمت إعادة تقييم النتائج الحالية تلقائيًا إلى الإصدار الحالي من الأسئلة المختارة هنا. لا يزال الإصدار الأصلي من الأسئلة معروضًا في المستندات.';
$string['done'] = 'أُنجِز';
$string['downloadallzip'] = 'تنزيل كل الملفات بشكل ملف مضغوط';
$string['downloadpartpdf'] = 'تنزيل ملف PDF للقائمة \'{$a}\'';
$string['downloadpdfs'] = 'النماذج';
...
$string['editingofflinequizx'] = 'الأسئلة';
$string['editlist'] = 'تحرير القائمة';
$string['editlists'] = 'قوائم الحضور';
...
$string['errormultiuserinlist'] = 'المستخدم مدرج في قوائم الحضور أكثر من مرة!';
$string['errorreport'] = 'تقرير أخطاء الاستيراد';
$string['evaluated'] = 'مُقيَّم';
$string['evaluation'] = '2. التقييم';
...
$string['fontfamilyfreeserif'] = '(Free-)Serif (موصى به)';
$string['fontfamilyhelvetica'] = 'Helvetica';
$string['fontfamilyhysmyeongjostdmedium'] = 'MyungJo Medium (كوري)';
$string['fontfamilykozgopromedium'] = 'Kozuka Gothic Pro (Sans-Serif ياباني)';
$string['fontfamilykozminproregular'] = 'Kozuka Mincho Pro (Serif ياباني)';
$string['fontfamilymsungstdlight'] = 'MSung Light (صيني تقليدي)';
$string['fontfamilystsongstdlight'] = 'STSong Light (صيني مبسط)';
...
$string['gradingofflinequizx'] = 'التقديرات';
...
$string['importforms'] = 'رفع نماذج الإجابات';
$string['importfromto'] = 'يجري تقييم {$a->from} إلى {$a->to} من أصل {$a->total}.';
$string['importisfinished'] = 'عملية التقييم للاختبار غير المتصل {$a} قد انتهت.';
...
$string['importnew'] = 'تقييم';
$string['importnew_help'] = '<p>
يمكنك استيراد صفحة ممسوحة منفردة أو ملفات لعدة صفحات ممسوحة ضمن أرشيف مضغوط بصيغة ZIP. ستقوم وحدة الاختبار غير المتصل بمعالجة ملفات الصور في الخلفية.
...
$string['legend'] = 'مفاتيح الرموز';
$string['legenddone'] = 'تم تنفيذ الخطوة بنجاح (لا إجراء إضافي مطلوب).';
$string['legendnextitem'] = 'إجراء مطلوب في مخطط سير العمل (قد يعتمد على الخطوات السابقة).';
$string['legendnoaction'] = 'لا يوجد إجراء مطلوب.';
$string['legendwarning'] = 'إجراء مطلوب حالاً';
$string['letter'] = 'الحرف';
...
$string['offlinequizcloseson'] = 'مراجعة الاختبار غير المتصل هذا ستغلق في {$a}';
$string['offlinequizcontent'] = 'محتوى الاختبار غير المتصل';
$string['offlinequizisclosed'] = 'تم إغلاق الاختبار بدون الاتصال';
$string['offlinequizisclosedwillopen'] = 'تم إغلاق الاختبار غير المتصل (يفتح في {$a})';
$string['offlinequizisopen'] = 'الاختبار غير المتصل هذا مفتوح';
$string['offlinequizisopenwillclose'] = 'تم فتح الاختبار غير المتصل (يغلق في {$a})';
$string['offlinequizopenedon'] = 'الاختبار غير المتصل هذا يفتح في {$a}';
$string['offlinequizopens'] = 'الاختبار غير المتصل يفتح';
$string['offlinequizsettings'] = 'إعدادات عدم الاتصال';
$string['offlinequizwillopen'] = 'الاختبار غير المتصل يُفتح في {$a}';
...
$string['overview'] = 'معلومات الاختبار';
...
$string['pagesinprocessing'] = 'قيد المعالجة:';
...
$string['participantsinlists'] = 'المشاركون';
$string['participantslist'] = 'قائمة المشاركين';
$string['participantslists'] = 'المشاركون';
$string['participantsusage'] = 'تسجيل الحضور';
$string['participantsusage_help'] = 'يُحدد هذا الخيار إمكانية تسجيل حضور المشاركين باستعمال قوائم الحضور. صُممت قوائم الحضور للاختبارات القصيرة الكبيرة غير المتصلة بالإنترنت والتي تضم العديد من المشاركين. يُمكن استعمالها للتحقق من الطلاب المشاركين في الاختبار، والتأكد من صحة تقييم كل النتائج.';
...
$string['partuncheckedwithoutresult'] = '{$a} من المشاركين غير المتحقق منهم الذين بلا نتائج';
...
$string['pdffont'] = 'خط النموذج';
$string['pdffont_help'] = 'هنا يمكنك اختيار خط لكل نماذج PDF الخاصة بك: نماذج الإجابات، نماذج التصويب، نماذج الحضور. بالإضافة إلى نماذج الأسئلة، إذا اخترت صيغة PDF. يعتمد الاختيار أيضًا على الأحرف المستعملة في نماذجك. مع صيغتي DOCX وLATEX، لا تتأثر أوراق الأسئلة بهذا.';
...
$string['questionanalysis'] = 'تحليل السؤال';
$string['questionanalysistitle'] = 'جدول تحليل السؤال';
$string['questionandansweranalysis'] = 'تحليل السؤال والإجابة';
...
$string['questionsingroup'] = 'المجموعة';
$string['questionsinthisofflinequiz'] = 'الأسئلة في الاختبار غير المتصل هذا';
...
$string['quizopenclose_help'] = 'يمكن تقييد المراجعة التي عبر الإنترنت بفترة زمنية محددة. انقر على "إظهار" لتغيير إعدادات التاريخ والوقت.

**تنبيه:** في حال عدم تفعيل أي فترة زمنية للمراجعة عبر الإنترنت، تبقى المراجعة غير مقيدة طالما كان الاختبار غير المتصل مرئيًا للمشاركين.

في كل الحالات، سيتم عرض الخيارات المحددة ضمن "تشمل المراجعة" فقط.';
$string['qversioncannotupdate'] = 'إصدار السؤال لا يمكن تحديثه';
$string['qversionnumbersdiffer'] = 'عدد الإجابات يختلف ما بين الإصدار القديم والجديد هذا سيؤدي إلى تناقضات';
$string['qversionupdated'] = 'إصدار السؤال تم تحديثه';
$string['qversionupdatedwarning'] = 'تم إنشاء النماذج مسبقًا.<br>في حال وجود نتائج، فسيتم إعادة تقييمها تلقائيًا إلى الإصدار الحالي من السؤال المُعدَّل الذي تم اختياره هنا. لا يزال الإصدار الأصلي للسؤال معروضًا في المستندات.';
$string['qversionupdateerror'] = 'وقع خطأ عند تحديث إصدار السؤال';
...
$string['recordupdateanddocscreated'] = 'تم تحديث الأسئلة، ولكن بما أن النماذج مُنشأة بالفعل، فإن الإصدار السابق من السؤال لا يزال نشطًا. للانتقال إلى الإصدار الأحدث، يُرجى حذف النماذج وتغيير الإصدار يدويًا.';
$string['recordupdateanddocscreatedversion'] = 'تم تحديث الأسئلة، ولكن النماذج مُنشأة بالفعل. يُرجى التحقق مما إذا كانت التغييرات قد أحدثت أي تغييرات تؤثر على التقييم.';
...
$string['resultimport'] = 'رفع';
$string['results'] = 'النتائج';
$string['resultsavailable'] = 'كمية النتائج المتاحة:';
...
$string['reviewoptions_help'] = 'مع هذه الخيارات يمكنك التحكم بما قد يشاهده الطلاب بعد استيراد النتائج. يمكنك أيضاً تعريف وقت بدء تقرير النتائج وانتهائه.

مربعات التأشير تعني:

**المحاولة** -  سيتم إظهار نصوص الأسئلة وإجاباتها للطلبة. سيشاهدون ما اختاروه من الإجابات، ولكن لن تتم الإشارة إلى الإجابات الصائبة.

**فيما إذا كانت صحيحة** -  هذا الخيار يمكن تفعيله فقط إذا تم تفعيل الخيار "المحاولة". عند التفعيل، سيتمكن الطلاب من مشاهدة أي من الإجابات المختارة هو الصائب (الخلفية الخضراء) أو الخاطئ (الخلفية الحمراء).

**الدرجات** - المجموعة (مثل ب)، الدرجات (الدرجة المحفوظة، إجمالي درجات الأسئلة، الدرجة المحفوظة كنسبة مئوية، مثل 40/80 (50)) والدرجة (مثل 50 من أصل 100) هي ما سيتم عرضه.
فضلاً عن ذلك، إذا تم تأشير "المحاولة"، سيتم إظهار الدرجة المحفوظة والدرجة القصوى لكل سؤال.

**الإفادة الخاصة** - الإفادة التي تعتمد على الاستجابة التي قدمها الطالب.

**الإفادة العامة** - يتم إظهار الإفادة العامة للطالب بعد استيراد النتائج. بخلاف الإفادة الخاصة، التي تعتمد على نوع السؤال والاستجابة التي دمها الطالب، يتم إظهار نفس نص الإفادة العامة لكل الطلاب. يمكنك استعمال الإفادة العامة لإعطاء الطلبة إجابة مفصلة عن السؤال أو ربما، رابطًا لمزيد من المعلومات يمكنهم الاستفادة منها إن لم يكونوا قد فهموا السؤال كما يجب.

**الإجابات الصائبة** - هذا يظهر أي من الإجابات هي الصائبة وأيُّها خاطئة. هذا الخيار متاح فقط عند تأشير "المحاولة".

**النموذج الممسوح** - يتم إظهار نماذج الإجابات الممسوحة. مربعات التأشير معلمة بمربعات خضراء.

**النموذج الممسوح مع التقديرات** - يتم إظهار نماذج الإجابات الممسوحة. مربعات التأشير معلمة بمربعات خضراء.. يتم إبراز التأشيرات الخاطئة وتلك المفقودة. فضلاً عن ذلك، يظهر جدول يتضمن الدرجة القصوى والدرجة المحرزة لكل سؤال.';
...
$string['statisticsviewheader'] = '3. الإحصائيات';
$string['statsoverview'] = 'نظرة عامة على الإحصائيات';
$string['studycode'] = 'رمز الدراسة';
$string['subplugintype_offlinequiz'] = 'تقرير الاختبار غير المتصل';
$string['subplugintype_offlinequiz_plural'] = 'تقارير الاختبار غير المتصل';
$string['tabattendances'] = 'الحاضرون';
$string['tabattendancesoverview'] = 'الحاضرون';
$string['tabdownloadparticipantsforms'] = 'النماذج';
$string['tabdownloadquizforms'] = 'النماذج';
$string['tabeditgrades'] = 'الدرجات';
$string['tabeditgroupquestions'] = 'الأسئلة';
$string['tabeditparticipants'] = 'المشاركون';
$string['tabofflinequizcontent'] = 'المشارك';
$string['tabofflinequizcorrect'] = 'التصويب';
$string['tabofflinequizupload'] = 'رفع';
$string['tabparticipantlists'] = 'قوائم الحضور';
$string['tabparticipantscorrect'] = 'تصويب';
$string['tabparticipantsupload'] = 'رفع';
$string['tabpreview'] = 'النماذج';
$string['tabquestionandanswerstats'] = 'تحليل الأسئلة والإجابات';
$string['tabquestionstats'] = 'تحليل الأسئلة';
$string['tabresults'] = 'النتائج';
$string['tabresultsoverview'] = 'النتائج';
$string['tabstatistics'] = 'الإحصائيات';
$string['tabstatsoverview'] = 'معلومات الاختبار';
...
$string['tutorial:feedback:1:1'] = 'لا توجد أسئلة في نموذج الإجابة. نموذج الإجابة يحتوي فقط على خانات لتؤشر عليها إجاباتك.';
$string['tutorial:feedback:1:2'] = 'تصميم ورقة الإجابة ليس من المفترض به أن يبدو بالضبط كما هو ظاهر في لقطة الشاشة. هو مُعد فقط ليظهر لك الأسئلة ولن يتم مسحه ضوئيًا بعد الاختبار.';
$string['tutorial:feedback:2:1'] = 'هذه التأشيرة باهتة جدًا. من الممكن أن لا يتم مسحها بشكل صحيح.';
$string['tutorial:feedback:2:2'] = 'تأشيرة ذات عرض خط عادي سيتم دائمًا تفسيرها بشكل صحيح.';
$string['tutorial:feedback:2:3'] = 'تأشيرة ذات عرض خط سميك من الممكن تفسيرها على أنها مصوبة (مملوءة بالكامل).';
$string['tutorial:feedback:2:4'] = 'خانة التأشير الفارغة لن يتم تفسيرها على أنها مؤشرة.';
$string['tutorial:feedback:2:5'] = 'خانة التأشير المملوءة بالكامل يتم تفسيرها تمامًا كما هي خانة التأشير الفارغة.';
$string['tutorial:feedback:4:1'] = 'لقد أكملت هذه المحاولة التعليمية بنجاح';
$string['tutorial:feedback:correct'] = 'صحيح!';
$string['tutorial:feedback:wrong'] = 'خطأ!';
$string['tutorial:header:1'] = '1. أوراق الأسئلة ونماذج الإجابات';
$string['tutorial:header:2'] = '2. التأشيرات والتصويبات';
$string['tutorial:header:3'] = '3. نموذج الإجابة';
$string['tutorial:header:5'] = '5. أخيرًا';
$string['tutorial:introduction:1'] = 'في الاختبار، ستحصل على ورقتين: إحداهما للأسئلة والأخرى لخانات التأشير التي تضع فيها إجاباتك. الأسئلة مرقمة، وكذلك الخانات في نموذج الإجابة. كل إجابة مُعلّمة بحرف. بعد الاختبار، يُمسح نموذج الإجابة ضوئيًا ويُفسّر بواسطة الحاسوب.';
$string['tutorial:introduction:2:1'] = 'عرض خانات التأشير المربعة في ورقة الإجابة ٥ ملم. خانات تأشير السؤال نفسه مرتبة في صف واحد. رقم السؤال على اليسار، والحرف المقابل لعنصر الإجابة في أعلى العمود.';
$string['tutorial:introduction:2:2'] = 'استعمل قلمًا أسود أو أزرق لتأشير الحقول. إذا أردت تصحيح علامة، فاملأ المربع كاملًا. ستُفسَّر تلك الخانة على أنها فارغة.';
$string['tutorial:introduction:5'] = 'يرجى العلم أن نماذج الإجابات تُفسّر بواسطة جهاز حاسوب. لا يستطيع هذا الجهاز قراءة أي شيء تكتبه بجوار خانات التأشير. بالنسبة لبرنامج الحاسوب، أي شيء خارج خانات التأشير هو مجرد نقطة تمنع الجهاز من تفسير النموذج بشكل صحيح. ستُعاقب نفسك إذا لم تضع العلامات بشكل صحيح.';
$string['tutorial:option:1:1'] = 'نموذج الإجابة';
$string['tutorial:option:1:2'] = 'ورقة الأسئلة';
$string['tutorial:option:3:1'] = 'يقرأ النظام اسمك باستعمال برنامج ضوئي لتمييز الحروف.';
$string['tutorial:option:3:2'] = 'توقيعك يتم مسحه باستعمال برنامج مستخدم في التعرف الجنائي على بصمات الأصابع.';
$string['tutorial:question:1'] = 'هذه الصورة تُظهر:';
$string['tutorial:question:2'] = 'أي علامة سيتم تفسيرها على أنها × على وجه التأكيد؟';
$string['tutorial:question:3'] = 'كيف يقوم الحاسوب بتعيين نموذج الإجابة إلى الشخص الصحيح؟';
$string['tutorial:question:5'] = 'بالتوفيق!';
$string['tutorial:questionsheet:1'] = '1)&nbsp;&nbsp; كم هو عدد مستندات الاختبار غير المتصل ستُعطى لك خلال الاختبار؟';
...
$string['tutorial:questionsheet:1:marks'] = '(النقاط: 1)';
$string['tutorial:questionsheet:2'] = '2)&nbsp;&nbsp;ما هو المحتوى المتاح في استبيان من الاختبار غير المتصل؟';
$string['tutorial:questionsheet:2:1'] = 'a)&nbsp;&nbsp;الأسئلة';
$string['tutorial:questionsheet:2:2'] = 'b)&nbsp;&nbsp;خيارات الإجابة';
$string['tutorial:questionsheet:2:3'] = 'c)&nbsp;&nbsp;الإجابات الصحيحة';
$string['tutorial:questionsheet:2:4'] = 'd)&nbsp;&nbsp;مزيد من المعلومات';
$string['tutorial:questionsheet:2:5'] = 'e)&nbsp;&nbsp;ولا واحد منها';
$string['tutorial:questionsheet:2:marks'] = '(العلامات: 1)';
$string['tutorial:title'] = 'الدرس التعليمي';
$string['tutorial:title:navigation'] = 'التنقل';
$string['type'] = 'النوع';
