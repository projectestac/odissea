...
/**
 * Strings for component 'assignfeedback_offline', language 'ar', version '4.5'.
 *
...
$string['gradelockedingradebook'] = 'تم تأمين الدرجة في سجل التقديرات لـ {$a}';
$string['graderecentlymodified'] = 'تم تعديل الدرجة في مودل في وقت أقرب من ورقة عمل التقييم لـ {$a}';
$string['gradesfile'] = 'تقييم جدول البيانات (بصيغة CSV)';
...
$string['privacy:nullproviderreason'] = 'لا تحتوي هذا الإضافة على قاعدة بيانات لتخزين معلومات المستخدم. إنها تستعمل واجهات برمجة التطبيقات فقط في mod_assign للمساعدة في عرض واجهة التقدير.';
...
$string['uploadgrades'] = 'رفع جدول بيانات التقييم';
