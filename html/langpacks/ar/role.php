...
$string['backup:backupcourse'] = 'الحفظ الاحتياطي للمساقات';
...
$string['category:viewcourselist'] = 'معاينة قائمة المساقات غير المُنضَمِّ إليها';
...
$string['course:managegrades'] = 'إدارة العلامات';
...
$string['course:setforcedlanguage'] = 'فرض لغة المساق';
...
$string['course:view'] = 'معاينة المساقات بدون الانضمام إليها';
$string['course:viewcoursegrades'] = 'معاينة علامات المساق';
$string['course:viewhiddenactivities'] = 'معاينة الأنشطة المخفية';
$string['course:viewhiddencourses'] = 'معاينة المساقات المخفية';
...
$string['course:visibility'] = 'إخفاء/إظهار المساقات';
...
$string['frontpageuserdescription'] = 'كل المستخدمين مسجلي الدخول عند مساق الصفحة الرئيسية';
$string['globalrole'] = 'دور النظام';
$string['globalroleswarning'] = 'تحذير! أي أدوار تمنحها من هذه الصفحة ستطبق على المستخدمين المعنيين على امتداد النظام بأكمله، بما في ذلك الصفحة الرئيسية وكل المساقات.';
$string['gotoassignroles'] = 'إذهب لتعيين الأدوار لهذا {$a->contextlevel}';
$string['gotoassignsystemroles'] = 'إذهب لتعيين أدوار النظام';
$string['grade:edit'] = 'تحرير العلامات';
...
$string['grade:manageoutcomes'] = 'إدارة مخرجات العلامات';
...
$string['my:configsyspages'] = 'تهيئة قوالب النظام لصفحات دفة القيادة';
...
$string['privacy:metadata:role_cohortroles'] = 'الأدوار إلى الفوج';
$string['prohibit'] = 'حظر';
...
$string['restore:restorecourse'] = 'استعادة المساقات';
