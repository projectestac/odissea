...
/**
 * Strings for component 'enrol_self', language 'ar', version '4.5'.
 *
 * @package     enrol_self
 * @category    string
...
$string['cohortnonmemberinfo'] = 'فقط أعضاء الزمرة \'{$a}\' يمكنهم تسجيل أنفسهم.';
$string['cohortonly'] = 'فقط أعضاء الزمرة';
$string['cohortonly_help'] = 'الانضمام الذاتي قد يكون محصوراً بأعضاء زمرة معينة. لاحظ أن تغيير هذا الإعداد ليس له تأثير على الانضمامات الحالية.';
