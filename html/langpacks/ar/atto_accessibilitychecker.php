...
/**
 * Strings for component 'atto_accessibilitychecker', language 'ar', version '4.5'.
 *
...
$string['privacy:metadata'] = 'إن إضافة atto_accessibilitychecker لا تخزن أي بيانات شخصية.';
...
$string['tablesmissingheaders'] = 'الجدول يجب ان يحتوي على توريسة للصف او العمود';
$string['tableswithmergedcells'] = 'لا ينبغي وجود خلايا مدمجة في الجداول. على الرغم من كون ذلك متاحاً كمَعلَم قياسي في ترميز الجداول منذ سنوات، إلا أنه قد توجد بعض الأنظمة التي لا تدعم بشكل كامل الجداول المعقدة. حيثما كان ممكنا، حاول "تسطيح" الجدول وتجنب دمج الخلايا.';
