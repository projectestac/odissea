...
/**
 * Strings for component 'filter_poodll', language 'ar', version '4.5'.
 *
...
$string['recui_medianotsupportederror'] = 'مستعرضك لا يدعم التسجيل عبر اتصال HTTP.';
...
$string['value'] = 'القيمة';
$string['wboardheight'] = 'الارتفاع الافتراضي للسبورة';
$string['wboardwidth'] = 'العرض الافتراضي للسبورة';
