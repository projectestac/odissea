...
$string['anchorhelp'] = 'يقوم هذا بإنشاء مرتكز فقط، لا زال عليك إنشاء الرابط يدويًا.';
$string['anchorname'] = 'اسم المرتكز';
$string['anchors'] = 'المرتكزات';
...
$string['cols'] = 'أعمدة';
$string['configeditorplugins'] = 'الرجاء اختيار إضافات المحررات التي ترغب باستعمالها ورتبهم حسب ما تراه مناسباً.';
$string['copy'] = 'أنسخ المختار';
$string['createanchor'] = 'إنشاء مرتكز';
$string['createfolder'] = 'أنشئ المجلد';
...
$string['linktargetblank'] = 'نافذة جديدة';
