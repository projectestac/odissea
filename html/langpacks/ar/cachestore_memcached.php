...
/**
 * Strings for component 'cachestore_memcached', language 'ar', version '4.4'.
 *
...
$string['privacy:metadata:memcached'] = 'تخزن إضافة مخزن خبء الذاكرة؛ البيانات لفترة وجيزة كجزء من وظائف التخزين المؤقت. يتم تخزين هذه البيانات على خادم Memcache حيث تتم إزالة البيانات بانتظام.';
