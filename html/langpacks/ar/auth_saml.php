...
/**
 * Strings for component 'auth_saml', language 'ar', version '4.5'.
 *
 * @package     auth_saml
 * @category    string
...
$string['auth_saml_coursemapping_head'] = 'يمكن لـ IdP استعمال الاسم المختصر/المُعرَّف الخاص به للمقررات الدراسية. حدد في هذا القسم التقابل ما بين مقررات دراسية IdP ومقررات مودل. يتقبل قيم متعددة مفصولة بفوارز.';
...
$string['auth_saml_rolemapping_head'] = 'يمكن لـ IdP استعمال الاسم المختصر للأدوار الخاص به. حدد في هذا القسم التقابل ما بين أدوار IdP وأدوار مودل. يتقبل قيم متعددة مفصولة بفوارز.';
$string['auth_saml_supportcourses'] = 'مقررات دراسية دعم SAML';
