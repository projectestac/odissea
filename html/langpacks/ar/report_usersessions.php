...
/**
 * Strings for component 'report_usersessions', language 'ar', branch 'MOODLE_38_STABLE'
 *
...
$string['thissession'] = 'الجلسة الحالية';
$string['usersessions:manageownsessions'] = 'إدارة جلسات المستعرض الخاصة به';
