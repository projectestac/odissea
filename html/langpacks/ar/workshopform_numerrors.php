...
/**
 * Strings for component 'workshopform_numerrors', language 'ar', version '4.4'.
 *
...
$string['mapgrade'] = 'الدرجة المخصصة للتسليم';
$string['pluginname'] = 'عدد الأخطاء';
$string['privacy:export:metadata:map'] = 'إذا وصل عدد الأخطاء الموزون إلى {$a->nonegative}، فستكون الدرجة {$a->grade} بالمئة.';
