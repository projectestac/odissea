...
/**
 * Strings for component 'block_rss_client', language 'ar', version '4.5'.
 *
...
$string['addfeed'] = 'إضافة رابط تغذية الأخبار:';
$string['addheadlineblock'] = 'أضف كتلة خدمة تغذية الأخبار';
$string['addnew'] = 'إضافة جديد';
$string['addnewfeed'] = 'إضافة تغذية جديدة';
$string['cannotmakemodification'] = 'ليس مسموحاً لك بإجراء تعديلات على مغذي الأخبار هذا حالياً.';
$string['choosefeedlabel'] = 'إختر التغذيات التي ترغب بعرضها';
$string['clientchannellink'] = 'الموقع المصدر...';
$string['clientnumentries'] = 'عدد المدخلات الافتراضي التي سيُعرض لكل تغذية.';
$string['clientshowchannellinklabel'] = 'إظهار رابط المصدر لو توفر';
$string['clientshowimagelabel'] = 'إظهار صورة القناة لو توفرت';
$string['configblock'] = 'تهيئة هذه الكتلة';
$string['configmethodexisting'] = 'تحديد تغذية إخبارية موجودة';
$string['configmethodnew'] = 'إضافة تغذية إخبارية جديدة';
$string['couldnotfindfeed'] = 'لم يتم العثور على التغذية الإخبارية ذات المُعرَّف.';
...
$string['disabledrssfeeds'] = 'تم تعطيل مغذيات الأخبار';
$string['displaydescriptionlabel'] = 'إظهار أوصاف الإدخالات';
$string['displaysettings'] = 'عرض إعدادات التغذية الإخبارية';
$string['editafeed'] = 'تحرير التغذية';
$string['editfeeds'] = 'التحرير، الاشتراك أو الانسحاب من خدمة تغذية الأخبار';
...
$string['failedfeed'] = 'فشل تنزيل المغذي - سنعاود المحاولة بعد {$a}';
$string['failedfeeds'] = 'واحد أو أكثر من مغذيات الأخبار قد فشل';
$string['feed'] = 'تغذية';
$string['feedadded'] = 'تمت إضافة تغذية الأخبار';
$string['feeddeleted'] = 'تم حذف تغذية الأخبار';
$string['feeds'] = 'تغذية الأخبار';
$string['feedsaddedit'] = 'إضافة/تحرير التغذية.';
$string['feedsconfigurenewinstance'] = 'أنقر هنا لتهيئة هذه الكتلة لعرض خدمة التغذية الاخبارية.';
$string['feedsconfigurenewinstance2'] = 'أنقر أيقونة التحرير أعلاه لتهيئة هذه الكتلة لعرض مغذيات الأخبار.';
$string['feedupdated'] = 'تم تحديث تغذية الأخبار';
$string['feedurl'] = 'رابط التغذية الإخبارية';
$string['findmorefeeds'] = 'البحث عن المزيد من التغذيات الإخبارية';
$string['managefeeds'] = 'إدارة التغذيات الإخبارية';
$string['nofeeds'] = 'لا توجد تغذيات إخبارية لهذا الموقع بعد. إختر \'إضافة تغذية إخبارية جديدة\'.';
$string['numentries'] = 'مدخلات لكل تغذية';
$string['pickfeed'] = 'إنتق مغذى الأخبار';
$string['pluginname'] = 'مغذيات الأخبار';
...
$string['privacy:metadata:block_rss_client:shared'] = 'فيما إذا كان مغذي الأخبار متاح في كل المقررات الدراسية';
...
$string['remotenewsfeed'] = 'مغذي الأخبار';
$string['rss_client:addinstance'] = 'إضافة كتلة جديدة لمغذي الأخبار';
$string['rss_client:createprivatefeeds'] = 'إنشاء مغذيات إخبارية خاصة';
...
$string['rss_client:myaddinstance'] = 'إضافة كتلة جديدة لمغذي الأخبار إلى دفة القيادة';
$string['seeallfeeds'] = 'شاهد كل التغذيات';
$string['sharedfeed'] = 'تغذية مشتركة';
$string['shownumentrieslabel'] = 'عدد المدخلات المراد غرضها';
...
$string['timeoutdesc'] = 'الوقت بالدقائق للفترة التي ستبقى فيها خدمة تغذية الأخبار في الخبأ.';
$string['updatefeed'] = 'تحديث عنوان رابط مغذى الأخبار';
$string['viewfeed'] = 'معاينة تغذية';
