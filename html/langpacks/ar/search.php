...
/**
 * Strings for component 'search', language 'ar', version '4.1'.
 *
 * @package     search
 * @category    string
...
$string['back'] = 'رجوع';
$string['beadmin'] = 'عليك أن تكون مشرفًا لتستعمل هذه الصفحة';
...
$string['content:courserole'] = '{$a->role} في {$a->course}';
...
$string['search:course_teacher'] = 'معلم المساق';
...
$string['search:mycourse'] = 'مقرراتي';
...
$string['topresults'] = 'النتائج العليا';
