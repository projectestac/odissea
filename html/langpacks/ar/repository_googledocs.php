...
/**
 * Strings for component 'repository_googledocs', language 'ar', branch 'MOODLE_38_STABLE'
 *
...
$string['cachedef_folder'] = 'مُعرَّفات ملفات Google للمجدات في حساب النظام';
$string['configplugin'] = 'تهيئة ملحق Google Drive';
$string['defaultreturntype'] = 'نوع الارجاع الافتراضي';
$string['docsformat'] = 'صيغة استيراد الملفات الافتراضية';
$string['drawingformat'] = 'صيغة استيراد الرسومات الافتراضية';
...
$string['googledocs:view'] = 'معاينة مستودع Google Drive';
$string['importformat'] = 'تهيئة صيغ الاستيراد الافتراضية لـ Google';
