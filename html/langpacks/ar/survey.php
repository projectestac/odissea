...
$string['attls17short'] = 'أنا أقدر المنطق أكثر';
...
$string['attls20short'] = 'ما موطن العلة؟';
...
$string['attlsintro'] = 'الغرض من هذا الاستبيان هو مساعدتنا في تقييم مواقفك حيال التفكير والتعلم.

ليست هناك إجابات \'صائبة\' أو \'خاطئة\'؛ فنحن لا يهمنا إلا التعرف على رأيك.
لطفاً، تأكد من أن ردودك سوف تعامل بأقصى درجة من السرية ولن تؤثر على تقييمك.';
$string['attlsm1'] = 'بعض المواقف حيال التفكير والتعلم';
$string['attlsm2'] = 'التعلم المتصل';
$string['attlsm3'] = 'التعلم المنفصل';
$string['attlsmintro'] = 'في المناقشة...';
$string['attlsname'] = 'ATTLS (نسخة ذات عشرين بندا)';
$string['cannotfindanswer'] = 'لا يوجد إجابات على هذا الاستبيان بعد';
$string['cannotfindquestion'] = 'السؤال غير موجود';
$string['cannotfindsurveytmpt'] = 'لم يتم العثور على أي قوالب استبيانية';
$string['ciq1'] = 'في أي لحظة خلال الدرس شعرت اكثر تفاعلا كمتعلم؟';
$string['ciq1short'] = 'مشارك تماماً';
...
$string['ciq4'] = 'ما الذي قام به أي شخص في المنتديات وتجده الأكثر تحييراً وغرابة؟';
$string['ciq4short'] = 'لحظة محيرة';
...
$string['colles18short'] = 'الطلاب يثنون عليَّ';
...
$string['collesaintro'] = 'يكمن الغرض من هذا الاستبيان في المساعدة على فهم مدى تأثير تقديم هذه الوحدة عبر الاتصال بالإنترنت على تمكينك من التعلم.

ويقوم كل من الأربعة وعشرون عبارة الآتية بسؤالك عن تجربتك مع هذه الوحدة.

ليس هناك إجابات \'صحيحة\' أو \'خاطئة\'؛ نحن مهتمون فقط بآرائك. لطفاً، تأكد من أن ردودك ستعامل بدرجة عالية من السرية، ولن تؤثر على تقييمك.

ردودك المتأنية سوف تساعدنا على تحسين تقديم هذه الوحدة عبر الإنترنت مستقبلاً.

مع جزيل الشكر.';
$string['collesaname'] = 'COLLES (فعلي)';
$string['collesapintro'] = 'يكمن الغرض من هذا الاستبيان في المساعدة على فهم مدى تأثير تقديم هذه الوحدة عبر الاتصال بالإنترنت على تمكينك من التعلم.

يطلب كل من الأربعة وعشرون زوجاً من العبارة أدناه منك مقارنة تجربتك عن تجربتك <b>المأمولة</b> (المثالية) مع تجربتك <b>الواقعية</b> في هذه الوحدة.
...
$string['collesm2'] = 'التفكير الانعكاسي';
$string['collesm2short'] = 'التفكير الانعكاسي';
...
كل من الأسئلة التالية والتي عددها 24 سؤالا تسأل عن تجربتك <b>المأمولة</b> (المثالية) في هذه الوحدة.

ليس هناك إجابات \'صائبة\' أو \'خاطئة\'؛ فنحن لا يهمنا إلا التعرف على رأيك.
تأكد من أن ردودك سوف تعامل بأقصى درجة من السرية ولن تؤثر على تقييمك.

ردودك المتأنية سوف تساعدنا على تحسين طريقة عرض هذه الوحدة على الإنترنت مستقبلاً.
...
$string['downloadinfo'] = 'يمكنك تنزيل البيانات الخام لهذا الاستبيان بشكل مناسب لتحليلها في Excel، SPSS، أو غيرهما من البرامج الأخرى.';
$string['downloadresults'] = 'تنزيل النتائج';
...
$string['indicator:cognitivedepth'] = 'الاستبيان معرفياً';
$string['indicator:cognitivedepth_help'] = 'هذا المؤشر مبني على عمق الحالة المعرفية التي وصلها الطالب في نشاط الاستبيان.';
$string['indicator:cognitivedepthdef'] = 'الاستبيان معرفياً';
$string['indicator:cognitivedepthdef_help'] = 'لقد وصل المشارك إلى هذه النسبة المئوية من المشاركة المعرفية التي وفرتها نشاطات الاستبيان خلال فترة التحليل هذه (المستويات = لا معاينة، معاينة، تقديم)';
$string['indicator:socialbreadth'] = 'الاستبيان إجتماعياً';
$string['indicator:socialbreadth_help'] = 'هذا المؤشر مبني على عمق التوسع الاجتماعي الذي وصله الطالب في نشاط الاستبيان.';
$string['indicator:socialbreadthdef'] = 'الاستبيان إجتماعياً';
$string['indicator:socialbreadthdef_help'] = 'لقد وصل المشارك إلى هذه النسبة المئوية من المشاركة الاجتماعية التي وفرتها نشاطات الاستبيان خلال فترة التحليل هذه (المستويات = لا مشاركة، المشاركة منفرداً)';
$string['introtext'] = 'نص المقدمة';
$string['invalidsurveyid'] = 'معرف الاستبانه غير صحيح';
$string['invalidtmptid'] = 'مُعرَّف القالب غير صحيح';
$string['ipreferthat'] = 'أفضل أن';
$string['modulename'] = 'استبيان';
$string['modulename_help'] = 'توفر وحدة نشاط الاستبيان عدداً من أدوات الاستبيان الموثوقة التي وُجدت مفيدة في تقييم التعليم وتحفيزه في بيئة الإنترنت. يمكن للمعلم استعمالها لجمع البيانات من طلبته لتساعده في التعرف على صفه وانعكاساته على وظيفته التعليمية.

لاحظ أن أدوات الاستبيان هذه معبأة مسبقاً بالأسئلة. المعلمون الراغبون بإنشاء استبياناتهم الخاصة، عليهم استعمال وحدة نشاط الإفادة.';
...
$string['responsereports'] = 'تقايرالاجابة';
...
$string['scaletimes5'] = 'أبداً في الغالب,نادراً,أحياناً,غالباً,تقريباً دائماً';
$string['search:activity'] = 'الاستبيان - معلومات النشاط';
$string['seemoredetail'] = 'اضغط هنا لترى تفاصيل أكثر';
$string['selectedquestions'] = 'إختر سؤالا من النطاق، كل الطلاب';
$string['summary'] = 'الملخص';
$string['survey:addinstance'] = 'إضافة استبيان جديد';
...
$string['surveycompletednograph'] = 'لقد أكملتَ هذا الاستبيان.';
...
$string['surveytype_help'] = 'تتوافر 3 أنواع من الاستبيانات:

* استبيان المواقف من التفكير والتعلم (ATTLS) - لقياس مدى كون الشخص \'عارف متصل\' (ميال إلى جعل التعلم أكثر متعة، وهو غالباً أكثر تعاوناً، انسجاماً وأكثر رغبة في البناء على أفكار الآخرين) أو \'عارف منفصل\' (ميال أكثر إلى النزعة النقدية والجدلية في التعلم)
* استبيان الحوادث الخطيرة
* استبيان بيئة التعلم البنائية عبر الإنترنت (COLLES) - لمراقبة المدى الذي يمكن استغلاله من القدرة التفاعلية للشبكة العنكبوتية على زج الطلبة في ممارسات تعلم مرنة';
