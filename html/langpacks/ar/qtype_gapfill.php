...
/**
 * Strings for component 'qtype_gapfill', language 'ar', version '4.5'.
 *
...
$string['addhinttext_text'] = 'تسكين أول تلميحين في قسم المحاولات المتعددة للنموذج';
...
$string['noduplicates_help'] = 'عند تأشيره، كل إجابة لا بد لها أن تكون فريدة، مفيد عندما يكون لكل حقل المعامل | ، ومثال على ذلك: ما هي أنواع الميداليات الأولمبية، وكل حقل فيه [ذهب|فضة|برونز]، إذا أدخل الطالب ذهب في كل حقل، سيحصل على علامة عن الحقل الأول فقط، (الحقول الأخرى ستحصل على تأشيرة مع ذلك). هو في الواقع عملية إهمال للإجابات المتكررة لأغراض منح الدرجات.';
