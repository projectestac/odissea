...
$string['eventanswercreated'] = 'تمت إضافة إجابة الخيار';
$string['eventanswerdeleted'] = 'تم حذف إجابة الخيار';
$string['eventanswersubmitted'] = 'تم الاختيار';
$string['eventanswerupdated'] = 'تم تحديث الخيار';
$string['eventreportdownloaded'] = 'تم تنزيل تقرير الاختيار';
$string['eventreportviewed'] = 'تمت معاينة تقرير الاختيار';
...
عند الوصول للحد، لن يستطيع أحد جديد من اختيار هذا الخيار.

إن كان هذا الخيار غير مفعّل، يمكن عندها لأي عدد من المشاركين أن يختاروا أي من الخيارات.';
$string['limitno'] = 'الحد {no}';
$string['modulename'] = 'إختيار';
$string['modulename_help'] = 'تمكن وحدة النشاط اختيار المدرس  من طرح سؤال واحد وتقديم مجموعة من الردود المحتملة.

يمكن أن تنشر نتائج الاختيار بعد  أن يكونوا الطلاب قد أجابوا عليها، بعد تاريخ معين، أو لا يتم النشر على الاطلاق. كما يجوز نشر النتائج مع أسماء الطلاب أو بدون أسماء.

 يمكن استخدام نشاط الاختيار
  * كاستطلاع سريع لتحفيز التفكير في الموضوع
  * لاختبار فهم الطلاب  بسرعة
  * لتسهيل اتخاذ القرار على الطالب، على سبيل المثال السماح للطلاب بالتصويت على اتجاه المقرر';
...
$string['taken'] = 'استخدم';
$string['userchoosethisoption'] = 'المستخدمين الذين اختاروا هذا الخيار';
