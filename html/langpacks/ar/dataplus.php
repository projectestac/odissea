...
/**
 * Strings for component 'dataplus', language 'ar', version '4.5'.
 *
 * @package     dataplus
 * @category    string
...
$string['samename'] = 'يوجد مسبقًا حقل بنفس الاسم، أو بتسمية قريبة الشبه. يرجى تعديل اسم الحقل ثم المحاولة مجددًا.';
$string['size'] = 'الحجم';
$string['true'] = 'صح';
