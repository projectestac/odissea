...
/**
 * Strings for component 'scorm', language 'ar', version '3.8'.
 *
 * @package     scorm
 * @category    string
...
$string['chooseapacket'] = 'اختر أو حدث الحزمة';
...
$string['datadir'] = 'خطاء في ملف النظام: لا يمكن إنشاء دليل بيانات المقرر';
...
$string['details'] = 'متابعة التفاصيل';
...
$string['element'] = 'عنصر';
$string['enter'] = 'ادخل';
$string['entercourse'] = 'ادخل المقرر';
...
$string['fullscreen'] = 'ملء الشاشة بأكملها';
...
$string['mode'] = 'نمط';
$string['modulename'] = 'حزم  سكورم';
$string['modulename_help'] = 'حزمة سكورم هي عبارة عن مجموعة من الملفات التي يتم تعبئتها وفقا لمعيار متفق عليه لكائنات التعلم. وحدة النشاط سكورم تمكن حزم سكورم أو AICC و سيتم تحميلها كملف مضغوط و إضافتها إلى المقرر. عادة يتم عرض المحتوى عبر عدة صفحات، مع التنقل بين الصفحات. هناك خيارات مختلفة لعرض المحتوى في إطار منبثق، مع جدول محتويات، مع أزرار التنقل و غيرها.
أنشطة سكورم عموما تشمل الأسئلة، مع درجات يتم تسجيلها في دفتر الدرجات.
و يمكن استخدام أنشطة سكورم
* لعرض محتوى الوسائط المتعددة و الرسوم المتحركة
* باعتبارها أداة تقييم';
...
$string['scrollbars'] = 'السماح للنافذة بالتمرير';
$string['search:activity'] = 'حزمة  سكورم - معلومات النشاط';
$string['selectall'] = 'حدد الكل';
...
$string['statusbar'] = 'أظهر شريط الحالة';
