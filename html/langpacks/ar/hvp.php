...
/**
 * Strings for component 'hvp', language 'ar', version '4.4'.
 *
 * @package     hvp
 * @category    string
...
$string['addlibraries'] = 'إضافة مكتبة';
$string['address'] = 'العنوان';
$string['age'] = 'العمر النموذجي';
$string['ajaxfailed'] = 'فشل في تحميل البيانات';
$string['alttext'] = 'النص البديل';
$string['author'] = 'منشئ المحتوى';
$string['authorcomments'] = 'تعليقات منشئ المحتوى';
$string['authorname'] = 'اسم منشئ المحتوى';
$string['authorrole'] = 'دور منشئ المحتوى';
$string['back'] = 'رجوع';
$string['by'] = 'بواسطة';
$string['cancel'] = 'إلغاء';
$string['cancellabel'] = 'إلغاء';
$string['cancelpublishconfirmationdialogdescription'] = 'هل أنت متأكد من رغبتك بإنهاء المشاركة';
...
$string['changedby'] = 'تم تغييره بواسطة';
$string['changedescription'] = 'وصف التغيير';
$string['changelog'] = 'سجل التعديلات';
$string['city'] = 'المدينة';
...
$string['disablefullscreen'] = 'تعطيل الشاشة الكاملة';
...
$string['upgradeerrorcontent'] = 'تعذرت ترقية المحتوى %id:';
$string['upgradeerrornotsupported'] = 'المعاملات التي تحتوي على %used والتي هي غير مدعومة.';
$string['upgradeheading'] = 'ترقية محتوى {$a}';
