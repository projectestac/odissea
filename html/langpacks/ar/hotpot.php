...
/**
 * Strings for component 'hotpot', language 'ar', version '4.5'.
 *
 * @package     hotpot
 * @category    string
...
إضافة إلى ذلك، إذا كانت طريقة تقييم الوحدة هي الدرجة الأعلى، ستُعرض رسالة تخبر المستخدم فيما إذا كانت محاولته الأخيرة أفضل من سابقتها أو مكافئة لها.';
...
**لا**
: لن تظهر للطالب صفحة خروج بعد إكمال الاختبار. بدلاً من ذلك، سيذهب مباشرةً إلى النشاط التالي أو يعود إلى صفحة المقرر في مودل.';
...
**بلا**
: سيتم عرض الاختبار بدون أي مساعدات تنقل، لذلك عند إجابة كل الأسئلة بشكل صحيح، واعتمادًا على الإعداد "أتريد إظهار الاختبار التالي؟"، إما يعود مودل إلى صفحة المقرر أو يعرض الاختبار اللاحق';
...
$string['useglossary'] = 'استخدم قاموس المصطلحات';
$string['useglossary_help'] = 'إذا تم تمكين هذا الإعداد، فسيتم تمرير المحتوى من خلال مرشح الارتباط التلقائي لقاموس موودل قبل إرساله إلى المتصفح.

لاحظ أن هذا الإعداد يتجاوز إعداد إدارة الموقع لتمكين أو تعطيل عامل تصفية الارتباط التلقائي لقاموس المصطلحات.';
