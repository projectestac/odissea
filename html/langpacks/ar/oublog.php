...
/**
 * Strings for component 'oublog', language 'ar', version '4.4'.
 *
 * @package     oublog
 * @category    string
...
$string['message'] = 'إعلان';
$string['newpost'] = 'إعلان جديد في {$a}';
$string['noposts'] = 'لم يتم بعد إدخال إعلانات';
...
$string['participationbyuser'] = 'تقرير المشاركة وفقا لاسم المستخدم';
