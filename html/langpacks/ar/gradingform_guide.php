...
$string['gradingof'] = 'وضع العلامات لـ {$a}';
$string['guide'] = 'دليل وضع العلامات';
$string['guidemappingexplained'] = 'تحذير: دليل وضع العلامات عندك فيه العلامة القصوى <b>{$a->maxscore} درجة</b> ولكن العلامة القصوى الموضوعة في نشاطك هي {$a->modulegrade}. ستتم مقايسة الدرجة القصوى في دليل وضع العلامات عندك إلى الدرجة القصوى في الوحدة (النشاط).<br />
...
$string['name'] = 'الاسم';
$string['needregrademessage'] = 'لقد تغير دليل وضع العلامات بعد منح العلامات لهذا الطالب. لا يمكن للطالب معاينة دليل وضع العلامات هذا حتى تقوم بالتحقق منه وتحديث الدرجة.';
