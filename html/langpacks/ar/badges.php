...
/**
 * Strings for component 'badges', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   badges
...
$string['addcourse_help'] = 'إختر كل المساقات التي تنبغي إضافتها إلى متطلبات الشارة. اضغط المفتاح CTRL باستمرار لتحديد عناصر متعددة.';
...
$string['aggregationmethod'] = 'طريقة التجميع';
$string['alignment'] = 'انحياز';
$string['all'] = 'الجميع';
...
$string['allmethodcourseset'] = 'كل المساقات المحددة مكتملة';
$string['allmethodmanual'] = 'جميع الأدوار المحددة تمنح الشارة';
$string['allmethodprofile'] = 'تم إكمال جميع حقول ملف التعريف المحدد';
$string['allowcoursebadges'] = 'تمكين شارات المساقات';
$string['allowcoursebadges_desc'] = 'السماح بإنشاء الشارات ومنحها على مستوى المساقات.';
...
$string['anymethodcourseset'] = 'أي من المساقات المحددة مكتملة';
...
$string['archiveconfirm'] = 'الحذف و الاحتفاظ بالشارات الصادرة الحالية';
$string['archivehelp'] = 'يعني هذا الخيار أنه سيتم وضع علامة على الشارة على أنها "معزولة" و لن تظهر بعد الآن في قائمة الشارات. لن يتمكن المستخدمون بعد الآن من كسب هذه الشارة ، و لكن لا يزال بإمكان مستلمي الشارة الحاليين عرض هذه الشارة في صفحة ملفهم الشخصي و دفعها إلى حقائب الظهر الخارجية.';
...
$string['backpackbadges'] = 'لديك
{$a-> total badges} badges)
التي يتم عرضها من
{{$a> total collectionions} Collections).
تغيير إعدادات ظهر بظهر.';
...
$string['backpackconnection'] = 'اتصال حقيبة الظهر';
...
$string['backpackconnection_help'] = 'يمكّنك الاتصال بحقيبة الظهر من مشاركة الشارات الخاصة بك من هذا الموقع، وعرض مجموعات الشارات العامة من حقيبة الظهر الخاصة بك في صفحة ملفك الشخصي لهذا الموقع.';
...
$string['backpackconnectionunexpectedresult'] = 'هناك مشكلة عند الاتصال بحقيبة الظهر العائدة لك. يرجى التحقق من بيانات حسابك فيها ثم المحاولة مرة أخرى.';
...
$string['backpackemailverifyemailbody'] = 'مرحباً،

تم طلب اتصال جديد مع حقيبة الشارات الخاصة بك من \'{$a->sitename}\' باستعمال عنوان بريدك الإلكتروني.

لتأكيد وتفعيل الاتصال بحقيبة الظهر تلك، يرجى الانتقال إلى

{$a->link}

في معظم برامج البريد، ينبغي أن يظهر هذا كرابط أزرق اللون يمكنك النقر عليه. إذا لم يكن ذلك متأتِّياً، قم بنسخه إلى شريط العنوان في أعلى نافذة متصفح الويب الخاص بك.

إذا كنت بحاجة إلى مساعدة، يرجى التواصل معمشرف الموقع،
{$a->admin}';
$string['backpackemailverifyemailsubject'] = '{$a}: التحقق من البريد الإلكتروني OpenBadges Backpack';
$string['backpackemailverifypending'] = 'تم إرسال رسالة تحقق إلى <strong>{$a}</strong>. أنقر على رابط التحقق في البريد الإلكتروني لتفعيل اتصالك بحقيبة الظهر.';
$string['backpackemailverifysuccess'] = 'شكراً لتأكيد عنوان البريد الإلكتروني الخاص بك. أنت الآن متصل بحقيبة الظهر.';
...
$string['backpackneedsupdate'] = 'حقيبة الظهر المتصلة بهذا الملف الشخصي لا تتوافق مع حقيبة الظهر الخاصة بالموقع. تحتاج إلى قطع الاتصال ثم إعادته مع حقيبة الظهر المعنية.';
...
$string['badgeimage_help'] = 'هذه هي الصورة التي سيتم استخدامها عند إصدار هذه الشارة. لإضافة صورة جديدة ، استعرض صورة و حددها (بتنسيق JPG أو PNG) ثم انقر فوق "حفظ التغييرات". سيتم اقتصاص الصورة إلى مربع وتغيير حجمها لتتناسب مع متطلبات صورة الشارة.';
...
$string['badgestatus_0'] = 'غير متاح للمستخدمين';
$string['badgestatus_1'] = 'متاح للمستخدمين';
...
$string['badgesview'] = 'شارات المساق';
...
$string['completionnotenabled'] = 'لم يتم تمكين الإكمال لهذا المساق، لذلك لا يمكن تضمينه في معايير الشارة. يمكن تمكين إكمال المساق في إعداداته.';
$string['configenablebadges'] = 'عند التمكين ، تتيح لك هذه الميزة إنشاء شارات ومنحها لمستخدمي الموقع.';
...
$string['creatorbody'] = '{$a->user} أكمل جميع متطلبات الشارة و حصل على الشارة.
عرض الشارة الصادرة في {$a->link}';
...
$string['criteria_2_help'] = 'يسمح بمنح الشارة يدوياً من قبل المستخدمين الذين لديهم دور معين ضمن الموقع أو المساق.';
$string['criteria_3'] = 'المشاركة الاجتماعية';
$string['criteria_3_help'] = 'اجتماعي';
$string['criteria_4'] = 'إكمال المادة';
$string['criteria_4_help'] = 'يسمح بإعطاء شارة للمستخدمين الذين أكملوا المادة. يمكن أن يكون لهذا المعيار معلمات إضافية مثل الحد الأدنى للصف و تاريخ إكمال المادة.';
$string['criteria_5'] = 'إكمال مجموعة من المساقات';
$string['criteria_5_help'] = 'يسمح بمنح شارة للمستخدمين الذين أكملوا مجموعة من المساقات. يمكن أن يشتمل كل مساق على معايير إضافية، مثل الحد الأدنى للعلامة وتاريخ إكمال المساق.';
$string['criteria_6'] = 'اكتمال الملف الشخصي';
$string['criteria_6_help'] = 'يسمح بإعطاء شارة للمستخدمين لإكمال حقول معينة في ملفهم الشخصي. يمكنك تحديد من حقول ملف التعريف الافتراضي و المخصص المتاحة للمستخدمين.';
$string['criteria_7'] = 'الشارات الممنوحة سابقاً';
$string['criteria_7_help'] = 'يسمح بإعطاء شارة للمستخدمين على أساس الشارات الأخرى التي حصلوا عليها.';
$string['criteria_8'] = 'العضوية في الأفواج';
$string['criteria_8_help'] = 'يسمح بإعطاء شارة للمستخدمين على أساس عضويتهم في فوج.';
...
$string['criteria_descr_0'] = 'يمنح المستخدمون هذه الشارة عند إكمال {$a} للمتطلبات المدرجة.';
...
$string['criteria_descr_5'] = '{$a} من الدورات التالية يجب أن تكتمل:';
...
$string['criteria_descr_8'] = 'يتطلوب العضوية في <strong>{$a}</strong> من الأفواج الآتية:';
...
$string['criteria_descr_single_4'] = 'يجب على المستخدمين إكمال الدورة';
$string['criteria_descr_single_5'] = 'يجب إكمال الدورة التالية:';
...
$string['criteria_descr_single_8'] = 'يتطلوب العضوية في الفوج الآتي:';
...
$string['criterror_help'] = 'تعرض مجموعة الحقول هذه جميع المعّلمات التي تمت إضافتها مبدئيًا إلى متطلبات هذه الشارة و لكنها لم تعد متوفرة.
يوصى بإلغاء تحديد هذه المعلمات للتأكد من أن المستخدمين يمكنهم كسب هذه الشارة في المستقبل.';
...
$string['delbadge'] = 'هل ترغب في حذف الشارة \'{$a}\' و إزالة جميع الشارات الصادرة؟';
$string['delconfirm'] = 'حذف و إزالة الشارات الصادرة الحالية';
...
$string['donotaward'] = 'حاليًا ، هذه الشارة غير نشطة ، لذلك لا يمكن منحها للمستخدمين. إذا كنت ترغب في منح هذه الشارة ، فيرجى ضبط حالتها على نشطة.';
$string['editsettings'] = 'تحرير الإعدادات';
...
$string['error:backpacknotavailable'] = 'لا يمكن الوصول إلى موقعك عبر الإنترنت، لذلك لا يمكن التحقق من أي شارات صادرة من هذا الموقع بواسطة خدمات حقائب الظهر الخارجية.';
$string['error:backpackproblem'] = 'هناك مشكلة خلال الاتصال بمزود خدمة حقيبة الظهر العائدة لك. الرجاء معاودة المحاولة في وقت لاحق.';
...
$string['error:invalidbadgeurl'] = 'تنسيق عنوان URL الخاص بالمصدر غير صالح. يجب أن يحتوي عنوان URL على بادئة http: // أو https: //.';
...
$string['error:invalidparamcohort'] = 'الفوج غير موجود.';
$string['error:noactivities'] = 'لا توجد أنشطة مع تمكين معايير الإكمال في هذه الدورة.';
$string['error:nobadges'] = 'حالياً، لا توجد شارات متاحة للحصول عليها لتُضاف كمعايير. شارة الموقع يمكن أن تكون الشارات الأخرى على مستوى الموقع فقط بمثابة معايير لها. شارة المساق يمكن أن تكون الشارات الأخرى على مستوى المساق أو الموقع بمثابة معايير لها.';
$string['error:nocohorts'] = 'لا الأفواج';
$string['error:nocourses'] = 'لم يتم تمكين إكمال المادة لأي من المقررات في هذا الموقع ، لذلك لا يمكن عرض أي منها. قد يتم تمكين إكمال المادة في إعدادات المقرر.';
$string['error:nogroups'] = 'لا توجد مجموعات عامة من الشارات متوفرة في ظهر بظهر.

يتم عرض المجموعات العامة فقط. زيارة ظهر بظهر الخاصة بك لإنشاء بعض المجموعات العامة.';
...
$string['error:nopermissiontoview'] = 'ليس لديك أذونات لعرض مستلمي شارة';
...
$string['eventbadgearchived'] = 'شارة تم أرشفتها';
$string['eventbadgeawarded'] = 'شارة تم منحها';
$string['eventbadgecreated'] = 'شارة تم إنشاؤها';
$string['eventbadgecriteriacreated'] = 'تم إنشاء معايير شارة';
$string['eventbadgecriteriadeleted'] = 'تم حذف معايير الشارة';
$string['eventbadgecriteriaupdated'] = 'تم تحديث معايير الشارة';
$string['eventbadgedeleted'] = 'شارة محذوفة';
$string['eventbadgedisabled'] = 'شارة معطلة';
$string['eventbadgeduplicated'] = 'شارة مكررة';
$string['eventbadgeenabled'] = 'تم تمكين الشارة';
$string['eventbadgelistingviewed'] = 'قائمة شارة تم عرضها';
$string['eventbadgerevoked'] = 'شارة تم إلغاءها';
$string['eventbadgeupdated'] = 'شارة تم تحديثها';
$string['eventbadgeviewed'] = 'شارة تم عرضها';
...
$string['localbadgesh_help'] = 'جميع الشارات المكتسبة في هذا الموقع عن طريق استكمال المساقات وأنشطتها وغيرها من المتطلبات.
...
$string['nobackpackbadges'] = 'لا توجد شارات في المجموعات التي حددتها.
إضافة المزيد من المجموعات.';
$string['nobackpackbadgessummary'] = 'لا توجد شارات في المجموعات التي حددتها.';
$string['nobackpackcollections'] = 'لم يتم اختيار مجموعات شارة.
إضافة مجموعات.';
$string['nobackpackcollectionssummary'] = 'لم يتم اختيار مجموعات شارة.';
$string['nobackpacks'] = 'لا توجد حقائب ظهر متاحة';
$string['nobadges'] = 'لا توجد شارات متاحة هنا.';
...
$string['noteendorsement'] = 'يمكن استخدام موافقة من طرف ثالث لإضافة قيمة إلى الشارة. على سبيل المثال ، قد يتم اعتماد شارة صادرة عن معلم من قبل المدرسة ، أو قد يتم اعتماد شارة صادرة عن جهة مانحة محلية من قبل الهيئة الوطنية المانحة.';
...
$string['recipientvalidationproblem'] = 'لا يمكن التحقق من المستخدم الحالي كمستلم لهذه الشارة.';
...
<p>بمجرد إصدار الشارة، سيتم <strong>قفلها</strong> - بحيث لا يعود بالإمكان تغيير بعض إعداداتها بما في ذلك المعايير وإعدادات انتهاء الصلاحية.</p>
...
$string['sitebackpack'] = 'حقيبة الظهر الخارجية نشطة';
$string['sitebackpack_help'] = 'حقيبة الظهر الخارجية التي يمكن للمستخدمين الاتصال بها من هذا الموقع. لاحظ أن تغيير هذا الإعداد بعد قيام المستخدمين بالاتصال بحقائب الظهر الخاصة بهم سيستدعي من كل مستخدم الانتقال إلى صفحة إعدادات حقيبة الظهر الخاصة به وقطع الاتصال ثم إعادته.';
$string['sitebackpackverify'] = 'اتصال حقيبة الظهر';
...
$string['sitebadges_help'] = 'لا يمكن منح الشارات للمستخدمين إلا عن الأنشطة المتعلقة بالموقع. تشمل هذه إكمال مجموعة من المساقات أو أجزاء من الملفات الشخصية للمستخدمين. يمكن أيضاً منح شارات الموقع يدوياً من قبل مستخدم لآخر.

يجب إنشاء الشارات المتعلقة بأنشطة المساق على مستوى المساق نفسه. يمكن العثور على شارات المساق ضمن إدارة المساق > الشارات.';
...
**مقفلة**. لا يزال بإمكان المستخدمين الحصول على الشارات المقفلة، ولكن ليس بالإمكان تغيير معاييرها. إذا كنت بحاجة إلى تعديل تفاصيل أو معايير شارة مقفلة، يمكنك تكرارها وإجراء جميع التغييرات المطلوبة.

*لماذا نقوم بقفل الشارات؟*
...
$string['statusmessage_2'] = 'هذه الشارة غير متاحة حاليًا للمستخدمين ، وتم قفل معاييرها. تمكين الوصول إذا كنت تريد أن يكسب المستخدمون هذه الشارة.';
$string['statusmessage_3'] = 'هذه الشارة متاحة حاليًا للمستخدمين ، وتم قفل معاييرها.';
...
$string['variablesubstitution_help'] = 'في رسالة الشارة ، يمكن إدراج بعض المتغيرات في موضوع و / أو نص الرسالة بحيث يتم استبدالها بقيم حقيقية عند إرسال الرسالة. يجب إدراج المتغيرات في النص كما هو موضح أدناه. يمكن استخدام المتغيرات التالية:
٪badgename٪: سيتم استبدال ذلك بالاسم الكامل للشارة.
٪username٪: سيتم استبدال ذلك بالاسم الكامل للمستلم.
٪badgelink٪: سيتم استبداله بعنوان URL العام بمعلومات حول الشارة الصادرة.';
