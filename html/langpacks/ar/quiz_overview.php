...
/**
 * Strings for component 'quiz_overview', language 'ar', branch 'MOODLE_38_STABLE'
 *
...
$string['done'] = 'تم';
$string['err_failedtodeleteregrades'] = 'فشل حذف درجات المحاولات التي تم حسابها';
...
$string['optonlyregradedattempts'] = 'التي أعيد تقييمها / سجلت كـ تحتاج إعادة تقييم';
...
$string['regradeall'] = 'إعادة تصحيح الجميع';
$string['regradealldry'] = 'إعادة تقدير الدرجات بالكامل';
$string['regradealldrydo'] = 'إعادة تصحيح المحاولات التي تم تحديدها بأنها تحتاج لإعادة التصحيح ({$a})';
$string['regradealldrydogroup'] = 'إعادة تقييم المحاولات و المؤشر عليها بإعادة تقييم ({$a->countregradeneeded}) في المجموعة \'{$a->groupname}\\';
...
$string['showinggradedandungraded'] = 'إظهار المحاولات المقيّمة و الغير مقيّمة لكل مستخدم.
يتم تمييز محاولة واحدة لكل مستخدم بلون ظاهر.
طريقة الدرجات لهذا الاختبار هي {$a}.';
$string['studentingroup'] = '\'{$a->coursestudent}\' في مجموعة \'{$a->groupname}\'';
