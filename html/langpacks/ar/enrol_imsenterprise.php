...
/**
 * Strings for component 'enrol_imsenterprise', language 'ar', version '3.11'.
 *
...
$string['createnewcategories'] = 'أنشئ تصنيفات جديدة للمقررات (مخفية) إذا تعذر العثور عليها في مودل';
$string['createnewcategories_desc'] = 'إذا كان عنصر <org><orgunit> موجوداً في البيانات القادمة للمقرر ، فسيتم استعمال محتوياته لتحديد التصنيف إن كان المقرر الدراسي سيتم إنشاؤه من الصفر. الملحق لن يقوم بإعادة تصنيف المقررات الدراسية الموجودة حالياً.

إذا لم يتم العثور على تصنيف بالتسمية المطلوبة، فسيتم إنشاء تصنيف مخفي.';
$string['createnewcourses'] = 'أنشئ مقررات دراسية جديدة (مخفية) إذا تعذر العثور عليها في مودل';
$string['createnewcourses_desc'] = 'عند تمكينه، فسيكون بإمكان ملحق انضمام مؤسسات IMS إنشاء مقررات دراسية جديدة لأي مما تجده في بيانات IMS ولكنه غير موجود في قاعدة بيانات مودل. أي مقررات منشأة ستكون مخفية مبدئياً.';
...
يتم البحث عن المستخدمين أولاً باستعمال  الرمز التعريفي "idnumber"، وثانياً بواسطة اسم المستخدم في مودل. كلمات المرور لا يتم استيرادها من قبل إضافة مؤسسة IMS. استعمال ملحق مصادقة موصى به للمصادقة على المستخدمين.';
...
$string['settingfullname'] = 'وسم وصف IMS لاسم المقرر الكامل';
$string['settingfullnamedescription'] = 'الاسم الكامل هو حقل مطلوب للمقرر، ولذلك عليك تعريف وسم الوصف المحدد في ملف مؤسسة IMS';
$string['settingshortname'] = 'وسم وصف IMS للاسم المختصر للمقرر';
$string['settingshortnamedescription'] = 'الاسم المختصر هو حقل مطلوب للمقرر، ولذلك عليك تعريف وسم الوصف المحدد في ملف مؤسسة IMS';
$string['settingsummary'] = 'وسم وصف IMS لملخص المقرر';
$string['settingsummarydescription'] = 'كحقل إختياري، إختر \'أتركه فارغاً\' إذا لم تكن تريد تحديد ملخص للمقرر';
...
$string['truncatecoursecodes'] = 'إقتطع رموز المقرر إلى هذا الطول';
$string['truncatecoursecodes_desc'] = 'في بعض الحالات، قد يكون لديك رموز مقررات دراسية تريد تقنين طولها إلى عدد حروف معين قبل معالجتها. إن كان الحال كذلك، أدخل عدد الحروف في هذا الحقل. بخلافه، أتركه فارغاً ولن يكون هناك أي استقطاع.';
$string['updatecourses'] = 'تحديث المقرر الدراسي';
$string['updatecourses_desc'] = 'عند تمكينه، يمكن لملحق انضمام مؤسسة IMS تحديث أسماء المقررات الدراسية الكاملة والمختصرة (إذا تم وضع قيمة 2 في العلم "recstatus" والذي يعني التحديث).';
