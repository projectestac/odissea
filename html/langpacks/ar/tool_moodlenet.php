...
/**
 * Strings for component 'tool_moodlenet', language 'ar', version '4.5'.
 *
...
$string['aria:enterprofile'] = 'أدخل مُعرَّف ملفك الشخصي في شبكة مودل';
$string['aria:footermessage'] = 'استعرض المحتوى في شبكة مودل';
$string['autoenablenotification'] = '<p>في الإصدار 4.0 من مودل فصاعدًا، سيكون تكامل <a href="https://moodle.net/">شبكة مودل</a> مُمَكَّنًا بشكل افتراضي في المزايا المتقدمة. سيتمكن المستخدمون ذوو إمكانية إنشاء النشاطات وإدارتها من استعراض شبكة مودل عبر منتقي النشاطات واستيراد موارد الشبكة إلى مساقاتهم.</p><p>عند الرغبة، يمكن تحديد عينة بديلة من شبكة مودل في <a href="{$a->settingslink}">إعدادات شبكة مودل الواردة</a>.</p>';
$string['autoenablenotification_subject'] = 'إعداد إفتراضي لشبكة مودل قد تغير';
...
$string['enablemoodlenet'] = 'تمكين التكامل مع شبكة مودل (الواردة)';
...
$string['forminfo'] = 'مُعرَّف ملفك الشخصي في شبكة مودل سيتم حفظه تلقائياً في ملفك الشخصي لهذا الموقع.';
$string['importconfirm'] = 'أنت على وشك استيراد المحتوى "{$a->resourcename} ({$a->resourcetype})" إلى المساق "{$a->coursename}". هل أنت متأكد من رغبتك في المتابعة؟';
...
$string['importformatselectguidingtext'] = 'بأي صيغة ترغب بإضافة المحتوى "{$a->name} ({$a->type})" إلى المساق العائد لك؟';
$string['importformatselectheader'] = 'إختر صيغة عرض المحتوى';
$string['inputhelp'] = 'أو إذا كان لديك مسبقاً حساب شبكة مودل، أدخل مُعرَّف ملفك التعريفي في شبكة مودل هنا:';
...
$string['moodlenetsettings'] = 'إعدادات شبكة مودل الواردة';
$string['notification'] = 'أنت بصدد استيراد المحتوى "{$a->name} ({$a->type})" إلى موقعك. إختر المساق الذي تنبغي إضافته إليه، أو <a href="{$a->cancellink}">ألغِ العملية</a>.';
...
$string['profilevalidationerror'] = 'وقعت مشكلة عند محاولة التحقق من مُعرَّف ملفك الشخصي في شبكة مودل';
$string['profilevalidationfail'] = 'لطفاً، أدخل مُعرَّفًا صحيحًا لملف شخصي في شبكة مودل';
$string['profilevalidationpass'] = 'تبدو جيدة!';
$string['removalwarning_feature'] = 'إذا كنت بحاجة إلى متابعة استعمال شبكة مودل، تواصل مع مشرف موقعك بشأن تنصيب عيِّنة مستضافة محليًا من شبكة مودل.';
$string['removalwarning_service'] = 'بعد ذلك التاريخ، لن يكون بإمكانك تصفح أو إضافة المحتوى من مركز شبكة مودل.';
$string['removalwarning_title'] = 'سيتم إغلاق خدمة شبكة مودل في 20 نيسان 2026.';
$string['removedmnetprofilenotification'] = 'نظرًا لبعض التغييرات الأخيرة في منصة شبكة مودل، على المستخدمين الذين قاموا مسبقًا بحفظ ملف تعريف شبكة مودل الخاص بهم في الموقع إدخال مُعرَّف شبكة مودل بصيغته الجديدة ليحصلوا على المصادقة التي تسمح لهم بدخول منصة شبكة مودل.';
$string['removedmnetprofilenotification_subject'] = 'تغيير تنسيق مُعرَّف الملف التعريفي في شبكة مودل.';
