...
$string['loadtemplatemsg'] = 'هل أنت متأكد من رغبتك في تحميل هذا المظهر؟ هذا سيزيل أي صفحات وعناصر موجودة في هذه الشهادة.';
$string['managetemplatesdesc'] = 'هذا الرابط سيأخذك إلى شاشة جديدة حيث ستتمكن من إدارة المظاهر المستعملة من قبل نشاطات الشهادات المخصصة في المساق.';
