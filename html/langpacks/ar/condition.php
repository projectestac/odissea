...
/**
 * Strings for component 'condition', language 'ar', version '3.11'.
 *
 * @package     condition
 * @category    string
...
$string['badgradelimits'] = 'إذا قمت بتحديد كل من العلامتين العليا والصغرى، فلا بد أن تكون العلامة العليا أكبر قيمة من الصغرى.';
...
$string['completionconditionsection_help'] = 'هذا الإعداد يقرر شروط إكمال النشاط التي لا بد من تلبيتها من أجل إتاحة الوصول إلى المقطع. لاحظ أن ميزة تتبع الإكمال لا بد من تمكينها قبل أن يكون بالإمكان وضع أي من شروط الإكمال للنشاط.

يمكن تحديد شروط إكمال متعددة حسب الحاجة. إذا كانت الحال كذلك، فلا بد عندها من تلبية كل تلك الشروط ليكون المقطع متاحاً للوصول.';
$string['configenableavailability'] = 'عندتمكينه، يتيح لك وضع شروط (بناءً على التاريخ، العلامة، أو الإكمال) لتحديد فيما إذا كان النشاط متاحاً للوصول إليه.';
...
$string['gradeconditionsection'] = 'شرط العلامة';
$string['gradeconditionsection_help'] = 'هذا الإعداد يقرر شرط العلامة الذي لا بد من تلبيته من أجل إتاحة الوصول إلى المقطع.

يمكن تحديد شروط علامة متعددة حسب الحاجة. إذا كانت الحال كذلك، فلا بد عندها من تلبية كل تلك الشروط ليكون المقطع متاحاً للوصول.';
$string['gradeitembutnolimits'] = 'عليك إدخال الحد الأعلى أو الحد الأدنى أو كليهما.';
$string['gradelimitsbutnoitem'] = 'عليك اختيار أحد عناصر العلامة.';
$string['gradesmustbenumeric'] = 'العلامتان العظمى والصغرى لا بد أن تكونا رقمين (أو فارغتين).';
$string['groupingnoaccess'] = 'أنت غير منتمٍ حالياً إلى مجموعة لديها حق الوصول إلى هذا المقطع.';
...
$string['showavailabilitysection_show'] = 'أظهر المقطع باللون الرمادي مع معلومات تقييد الوصول';
