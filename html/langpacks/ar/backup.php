...
$string['asyncrestorecompletedetail'] = 'مهمة الاستعادة قد اكتملت بنجاح. النقر على زر الاستمرار سيأخذك إلى <a href="{$a}">المساق حيث يتوضع العنصر المستعاد.</a>';
...
$string['backupcoursesections'] = 'أقسام المساق';
...
$string['choosefilefromcoursebackup_help'] = 'ملفات الحفظ الاحتياطي للمساق والمنشأة باستعمال الإعدادات الافتراضية ستخزن هنا.';
...
$string['configlegacyfiles'] = 'يحدد الوضع الافتراضي بشأن تضمين ملفات المساق القديمة في الحفظ الاحتياطي. ملفات المساق القديمة هي العائدة إلى إصدارات مودل التي تسبق 2.0.';
...
$string['copycoursedesc'] = 'هذا المساق ستصير له نسخة أخرى متوضعة في التصنيف المحدد.';
$string['copycourseheading'] = 'إنسخ مساقاً دراسياً';
$string['copycoursetitle'] = 'إنسخ المساق: {$a}';
...
$string['coursecategory'] = 'الفئة التي سيتم استرجاع المساق إليها';
...
$string['generallegacyfiles'] = 'تضمين ملفات المساق القديمة';
...
$string['keptroles_help'] = 'المستخدمون الذين يمتلكون الأدوار المختارة سيتم ضمهم إلى المساق الجديد. لن يتم نسخ بيانات المستخدمين أيضاً ما لم يتم تمكين الإعداد "تضمين بيانات المستخدمين".';
$string['locked'] = 'مغلق';
...
$string['pendingasyncedit'] = 'هناك عملية حفظ احتياطي أو نسخ معلقة لهذا المساق. لطفاً، لا تقم بتعديله ريثما تكتمل هذه العملية.';
...
$string['privacy:metadata:backup:detailsofarchive'] = 'يمكن أن يحتوي هذا الأرشيف على العديد من بيانات المستخدم المتعلقة بالمساق، مثل التقديرات إنضمامات المستخدم وبيانات النشاطات.';
...
$string['setting_overwrite_conf'] = 'استبدال اعدادات المساق';
