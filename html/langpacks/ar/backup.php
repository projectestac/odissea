...
/**
 * Strings for component 'backup', language 'ar', version '3.11'.
 *
 * @package     backup
 * @category    string
...
$string['asyncrestorecompletedetail'] = 'مهمة الاستعادة قد اكتملت بنجاح. النقر على زر الاستمرار سيأخذك إلى <a href="{$a}">المقرر الدراسي حيث يتوضع العنصر المستعاد.</a>';
...
$string['asyncreturn'] = 'عودة إلى المقرر الدراسي';
...
$string['backupsection'] = 'الحفظ الاحتياطي لمقطع المقرر الدراسي: {$a}';
...
$string['config_overwrite_course_startdate'] = 'بشكل افتراضي، تاريخ بداية المقرر الدراسي يتم استبداله بالتاريخ المأخوذ من ملف الحفظ الاحتياطي. يتطلب هذا أن يتم التأشير على "استبدال إعدادات المقرر الدراسي" وأن يكون لدى المستخدم الحالي الإمكانية على تغيير تاريخ بدء المقرر الدراسي (moodle/restore:rolldates) عند الاستعادة';
...
$string['configlegacyfiles'] = 'يحدد الوضع الافتراضي بشأن تضمين ملفات المقرر القديمة في الحفظ الاحتياطي. ملفات المقرر الدراسي القديمة هي العائدة إلى إصدارات مودل التي تسبق 2.0.';
...
$string['confirmnewcoursecontinue'] = 'تنبيه المقرر الدراسي الجديد';
$string['confirmnewcoursecontinuequestion'] = 'سيتم إنشاء مقرر مؤقت (مخفي) من قِبل عملية استعادة المقرر الدراسي. لإيقاف الاستعادة، أنقر على الإلغاء. لا تغلق المتصفح في أثناء الاستعادة.';
$string['copiesinprogress'] = 'المقرر الدراسي لديه عمليات نسخ قيد التنفيذ. <a href="{$a}">عرض تلك العمليات.</a>';
$string['copycoursedesc'] = 'هذا المقرر الدراسي ستصير له نسخة أخرى متوضعة في التصنيف المحدد.';
...
$string['copyprogresstitle'] = 'سير عملية نسخ المقرر الدراسي';
...
$string['error_block_for_module_not_found'] = 'تم العثور على عيِّنة كتلة معزولة (المُعرَّف: {$a-> bid}) لوحدة المقرر الدراسي (المُعرَّف: {$a-> mid}). لن يتم نسخها احتياطيًا';
...
$string['errorrestorefrontpagebackup'] = 'يمكنك استعادة الحفظ الاحتياطي لصفحة الواجهة إلى صفحة الواجهة حصراً';
...
$string['generallegacyfiles'] = 'تضمين ملفات المقرر الدراسي القديمة';
...
$string['importsuccess'] = 'إكتمل الاستيراد. أنقر على استمرار للرجوع إلى المقرر الدراسي';
...
$string['keptroles_help'] = 'المستخدمون الذين يمتلكون الأدوار المختارة سيتم ضمهم إلى المقرر الدراسي الجديد. لن يتم نسخ بيانات المستخدمين أيضاً ما لم يتم تمكين الإعداد "تضمين بيانات المستخدمين".';
$string['locked'] = 'مغلق';
...
$string['pendingasyncedit'] = 'هناك عملية حفظ احتياطي أو نسخ معلقة لهذا المقرر الدراسي. لطفاً، لا تقم بتعديله ريثما تكتمل هذه العملية.';
...
$string['privacy:metadata:backup:detailsofarchive'] = 'يمكن أن يحتوي هذا الأرشيف على العديد من بيانات المستخدم المتعلقة بالمقرر الدراسي، مثل التقديرات إنضمامات المستخدم وبيانات النشاطات.';
$string['privacy:metadata:backup:externalpurpose'] = 'الغرض من هذا الأرشيف هو تخزين المعلومات المتعلقة بالمقررات الدراسية، والتي يمكن استعادتها في المستقبل.';
$string['privacy:metadata:backup_controllers'] = 'قائمة عمليات الحفظ الاحتياطي';
$string['privacy:metadata:backup_controllers:itemid'] = 'مُعرَّف المقرر الدراسي';
...
$string['qcategory2coursefallback'] = 'صنف الأسئلة "{$a->name}”، الموجود في الأصل ضمن سياق الصنف النظام/المقرر الدراسي في ملف الحفظ الاحتياطي، سيتم إنشاؤه في سياق المقرر عند الاستعادة';
$string['qcategorycannotberestored'] = 'فئة الأسئلة "{$a->name}" لا يمكن إنشاؤها بواسطة الاستعادة';
$string['question2coursefallback'] = 'صنف الأسئلة "{$a->name}”، الموجود في الأصل ضمن سياق الصنف النظام/المقرر الدراسي في ملف الحفظ الاحتياطي، سيتم إنشاؤه في سياق المقرر عند الاستعادة';
...
$string['restoreexecutionsuccess'] = 'تم استرجاع المقرر الدراسي بنجاح، النقر على زر الاستمرار أدناه سيأخذك لمعاينة المقرر الذي قمت باسترجاعه.';
...
$string['restoretocurrentcourseadding'] = 'دمج المقرر الدراسي الاحتياطي مع هذا المقرر';
$string['restoretocurrentcoursedeleting'] = 'احذف محتويات هذا المقرر ثم قم باسترجاعه';
$string['restoretoexistingcourse'] = 'الاسترجاع إلى مقرر دراسي موجود';
...
$string['restoretonewcourse'] = 'الاسترجاع كمقرر دراسي جديد';
...
$string['rootsettinglegacyfiles'] = 'تضمين ملفات المقرر القديمة';
$string['rootsettinglogs'] = 'تضمن سجلات وقوعات المقرر';
...
$string['setting_course_startdate'] = 'تاريخ بدء المقرر الدراسي';
...
$string['sitecourseformatwarning'] = 'هذه النسخة الاحتياطية لصفحة الواجهة، لاحظ أن هذه النسخة لا يمكن استعادتها إلا إلى صفحة الواجهة';
...
$string['storagecourseandexternal'] = 'منطقة ملفات الحفظ الاحتياطي للمقرر والمجلد المحدد';
$string['storagecourseonly'] = 'منطقة ملفات الحفظ الاحتياطي للمقرر';
...
$string['userdata_help'] = 'إذا تم تمكينه، فالبيانات مثل منشورات المنتديات، تسليم الواجبات... إلخ. سيتم نسخها إلى المقرر الدراسي الجديد لتصير متاحة إلى أي مستخدمين يمتلكون الأدوار المشمولة بالإعداد \'تضمين طرق ضم المستخدمين\'.';
