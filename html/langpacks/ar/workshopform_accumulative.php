...
/**
 * Strings for component 'workshopform_accumulative', language 'ar', version '4.5'.
 *
...
$string['pluginname'] = 'التقدير التراكمي';
$string['poor'] = 'ضعيف';
$string['present'] = 'حاضر';
$string['privacy:metadata'] = 'تخزن إضافة التقدير التراكمي تفاصيل نموذج التقييم فقط. يتم تخزين البيانات الشخصية الفعلية لكيفية ملء النموذج بواسطة وحدة  ورشة العمل نفسها وإرفاقها بالتقييمات التي تم تصديرها.';
