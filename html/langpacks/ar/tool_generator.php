...
/**
 * Strings for component 'tool_generator', language 'ar', version '3.11'.
 *
...
$string['courseexplanation'] = 'تقوم هذه الأداة بإنشاء مقررات دراسية تجريبية قياسية تتضمن العديد من الأقسام والأنشطة والملفات.

يهدف هذا إلى توفير مقياس موحد للتحقق من موثوقية وأداء مكونات النظام المختلفة (مثل النسخ الاحتياطي والاستعادة).

هذا الاختبار مهم لأنه كانت هناك العديد من الحالات في السابق التي يعجز فيها النظام عن العمل عندما يواجه ظروف التشغيل الفعلي (مثل مقرر ذي 1000 نشاط).
...
$string['coursewithoutusers'] = 'المقرر الدراسي المحدد لا يوجد فيه مستخدمون';
$string['createcourse'] = 'أنشئ المقرر الدراسي';
...
$string['error_nocourses'] = 'لا توجد مقررات لتوليد خطة الاختبار';
...
$string['error_nonexistingcourse'] = 'المقرر الدراسي المحدد غير موجود';
$string['error_nopageinstances'] = 'لا يحتوي المقرر الدراسي المحدد على عينات لوحدة الصفحة';
...
$string['fullname'] = 'مقرر دراسي اختباري: {$a->size}';
$string['maketestcourse'] = 'إنشاء مقرر دراسي إختباري';
$string['maketestplan'] = 'بناء خطة اختبار JMeter';
$string['notenoughusers'] = 'لا يحتوي المقرر الدراسي المحدد على عدد كافٍ من المستخدمين';
...
$string['progress_coursecompleted'] = 'اكتمل المقرر الدراسي ({$a})';
...
$string['size'] = 'حجم المقرر الدراسي';
$string['smallfiles'] = 'ملفات صغيرة';
$string['targetcourse'] = 'إختبار المقرر الدراسي المقصود';
...
إنه جزء من tool_generator لذا فهو يعمل جيداً مع المقررات الدراسية التي تم إنشاؤها بواسطة المقررات الدراسية ومولدات الموقع، كما يمكن استعماله مع أي مقرر يحتوي على الأقل:
