...
/**
 * Strings for component 'tool_generator', language 'ar', version '4.5'.
 *
...
$string['execute'] = 'تنفيذ';
$string['execute_cleanup'] = 'تطهير السيناريوهات';
$string['execute_scenarios'] = 'إختبار السيناريوهات';
...
$string['step_example'] = 'مثال الخطوة:';
...
$string['testscenario_filedesc'] = 'ملفات الميزة المرفوعة يمكنها فقط أن تقتصر على سيناريوهات ذات خطوات core_data_generator أو بعض الخطوات الخاصة التي لا تتطلب selenium. سيتم تنفيذ كل السيناريوهات حالاً ما عدا تلك التي تحمل الوسم @cleanup.';
$string['testscenario_filedesc_cleanup'] = 'السيناريوهات التي تحمل العلامة @cleanup سيتم تنفيذها فقط إذا تم ضبط الإعداد "Execute" على قيمة "Cleanup". لتنفيذ عملية التنظيف باستعمال واجهة سطر الوامر، بإمكانك استعمال الخيار --cleanup.';
$string['testscenario_filedesc_list'] = 'هذه قائمة الخطوات التي يمكن استعمالها في ملف ميزة إختبار السيناريو:';
