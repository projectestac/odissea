...
$string['autogenallforms'] = 'قم بتوليد كل المظاهر الافتراضية';
...
الوسوم المتواجدة في قائمة "الوسوم المتاحة" حصراً يمكن استعمالها للمظهر الحالي.';
...
$string['data:managetemplates'] = 'إدارة المظاهر';
$string['data:manageuserpresets'] = 'إدارة جميع المظاهر المعدة مسبقاً';
...
$string['enabletemplateeditorcheck'] = 'هل أنت متأكد من رغبتك في تمكين المحرر؟ هذا قد ينتج عنه تعديل المحتوى عند حفظ المظهر.';
...
$string['exportaszip_help'] = 'التصدير بصيغة الملف المضغوط zip تسمح لك بحفظ المظاهر والحقول بمثابة ملف تحضير مسبق لغرض التنزيل. يمكن عندها استيراد الملف المضغوط إلى مساق آخر.';
...
$string['multipletags'] = 'تم العثور على عدة وسوم! لم يتم حفظ المظهر';
...
$string['presetinfo'] = 'سيتم نشر المظهر إذا تم حفظه كتحضير مسبق. المستخدمون الآخرون سيتمكنون من استعماله في قواعد بياناتهم.';
...
$string['saveaspreset_help'] = 'إن ميزة الحفظ بمثابة تحضير مسبق تنشر المظاهر والحقول بشكل تحضير مسبق يمكن للآخرين في الموقع استعماله. (يمكنك حذفه من قائمة التحضيرات المسبقة في أي وقت).';
...
$string['templatesaved'] = 'تم حفظ المظهر';
