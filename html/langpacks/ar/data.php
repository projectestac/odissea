...
$string['completionentriescount'] = 'إضافة المدخلات';
...
$string['csvfile'] = 'ملف CSV أو ملف مضغوط ZIP يحتوي على ملف CSV';
...
$string['errordatafilenotfound'] = 'تعذر استيراد الملف. أنواع الملفات المقبولة هي CSV أو ZIP يحتوي على ملف بصيغة CSV وبالتنسيق المستعمل في تصدير المُدخلات.';
...
$string['fieldsinformationtags'] = 'معلومات الحقل';
$string['fieldsnavigation'] = 'التنقل في حقول ما بعد المرحلة الإعدادية';
$string['fieldtagdescription'] = 'وصف {$a}';
$string['fieldtagid'] = 'مُعرَّف {$a}';
$string['fieldtagname'] = 'اسم {$a}';
...
$string['includefiles'] = 'تضمين الملفات عند التصدير';
...
$string['other'] = 'أخرى';
$string['otherfields'] = 'كل الحقول الأخرى';
...
$string['resettemplate'] = 'إعادة تعيين القالب الحالي';
...
$string['uploadrecords'] = 'استيراد المُدخلات';
$string['uploadrecords_help'] = 'استيراد المدخلات التي سبق وأن قمت بتصديرها من قاعدة بيانات أخرى، إما عبر ملف نصي CSV أو ملف مضغوط يحتوي على ملف CSV (إذا كانت الملفات متضمَّنة في ملف التصدير.

بشكل آخر، لإنشاء ملف CSV من أجل الاستيراد، أضف مُدخلاً واحدًا إلى قاعدة البيانات ثم صدِّرها. حرر ملف CSV وأضف المزيد من المُدخلات إليه.
