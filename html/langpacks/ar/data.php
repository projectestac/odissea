...
/**
 * Strings for component 'data', language 'ar', version '3.11'.
 *
 * @package     data
 * @category    string
...
$string['asearchtemplate'] = 'قابل البحث المتقدم';
...
$string['autogenallforms'] = 'توليد كل القوالب الافتراضية';
...
$string['eventtemplateupdated'] = 'قالب تم تحديثه';
$string['eventtemplateviewed'] = 'قوالب تمت معاينتها';
...
$string['exportaszip_help'] = 'التصدير بصيغة الملف المضغوط zip تسمح لك بحفظ القوالب والحقول بمثابة ملف تحضير مسبق لغرض التنزيل. يمكن عندها استيراد الملف المضغوط إلى مقرر دراسي آخر.';
...
$string['headercsstemplate'] = 'تعريف أنماط CSS المحلية للقوالب الأخرى';
...
التصميم المرئي للمعلومات عند إدراج مدخلات قاعدة البيانات، معاينتها، وتحريرها يمكن السيطرة عليه بواسطة قوالب قاعدة البيانات. يمكن مشاركة نشاطات قاعدة البيانات ما بين المقررات الدراسية كتحضيرات مسبقة، كما يمكن أيضاً للمعلم استيراد مدخلات قاعدة البيانات وتصديرها.

إذا تم تمكين مرشح الربط التلقائي لقاعدة البيانات، سيتم ربط أي مدخلات في قاعدة البيانات تلقائياً حيثما ظهرت الكلمات أو العبارات الخاصة بها في المقرر الدراسي.
...
$string['resettemplate'] = 'إعادة تعيين القالب';
