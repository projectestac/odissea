...
/**
 * Strings for component 'data', language 'ar', version '3.8'.
 *
 * @package     data
 * @category    string
...
$string['authorfirstname'] = 'الاسم الأول للكاتب';
$string['authorlastname'] = 'الاسم الأخير للكاتب';
...
$string['availabletags_help'] = 'الوسوم هي عناصر نائبة في القالب، والتي سيتم استبدالها ببيانات أو مفردات أخرى، مثل أيقونة التحرير عند تحرير أو معاينة المدخلات.
...
$string['delete'] = 'حذف';
$string['deleteallentries'] = 'إحذف كل المدخلات';
...
$string['emptyadd'] = 'قالب الإضافة فارغ، يجري إنشاء نموذج إفتراضي...';
...
$string['eventfieldcreated'] = 'تم إنشاء الحقل';
$string['eventfielddeleted'] = 'تم حذف الحقل';
$string['eventfieldupdated'] = 'تم تحديث الحقل';
$string['eventrecordcreated'] = 'تم إنشاء السجل';
$string['eventrecorddeleted'] = 'تم حذف السجل';
...
$string['exportaszip_help'] = 'التصدير بصيغة الملف المضغوط zip تسمح لك بحفظ القوالب والحقول بمثابة ملف تحضير مسبق لغرض التنزيل. يمكن عندها استيراد الملف المضغوط إلى مساق آخر.';
...
$string['failedpresetdelete'] = 'خطأ عند حذف التحضير المسبق';
...
$string['foundnorecords'] = 'لا توجد سجلات (<a href="{$a->reseturl}">إعادة تعيين المرشحات</a>)';
$string['foundrecords'] = 'تم العثور على سجلات: {$a->num}/{$a->max} (<a href="{$a->reseturl}">إعادة تعيين المرشحات</a>)';
$string['fromfile'] = 'من ملف مضغوط';
$string['fromfile_help'] = 'إن ميزة الاستيراد من ملف مضغوط zip تسمح لك باستعراض تحضير مسبق ورفعه بمثابة قالب وحقول محضرة مسبقاً.';
$string['generateerror'] = 'لم يتم إنشاء كل الملفات!';
$string['header'] = 'راس الصفحة';
$string['headeraddtemplate'] = 'يعرِّف الواجهة المخصصة لإضافة المدخلات أو تحريرها';
$string['headerasearchtemplate'] = 'يعرِّف واجهة البحث المتقدم';
$string['headercsstemplate'] = 'عريف أنماط CSS المحلية للقوالب الأخرى';
$string['headerjstemplate'] = 'يعرِّف نصوص برمجية مخصصة من Javascript للتحكم بطريقة عرض العناصر في القائمة \'منفردة أو أضف قوالب\'';
$string['headerlisttemplate'] = 'عرف واجة التصفح لمدخلات متعددة';
$string['headerrsstemplate'] = 'تحديد مظهر بنود التغذية الإخابرية';
...
$string['includeapproval'] = 'قم بتضمين حالة الموافقة';
$string['includetags'] = 'قم بتضمين الوسوم';
$string['includetime'] = 'قم بتضمين وقت الإضافة/التعديل';
$string['includeuserdetails'] = 'قم بتضمين تفاصيل المستخدم';
...
$string['jstemplate'] = 'قالب Javascript';
...
التصميم المرئي للمعلومات عند إدراج مدخلات قاعدة البيانات، معاينتها، وتحريرها يمكن السيطرة عليه بواسطة قوالب قاعدة البيانات. يمكن مشاركة نشاطات قاعدة البيانات ما بين المساقات كتحضيرات مسبقة، كما يمكن أيضاً للمعلم استيراد مدخلات قاعدة البيانات وتصديرها.

إذا تم تمكين مرشح الربط التلقائي لقاعدة البيانات، سيتم ربط أي مدخلات في قاعدة البيانات تلقائياً حيثما ظهرت الكلمات أو العبارات الخاصة بها في المساق.

يمكن للمعلم السماح بالتعليقات على المدخلات. يمكن أيضاً تقييم المدخلات من قبل المعلم أو الطلاب (التقييم المناظر). يمكن تجميع التقييمات للخروج بعلامة نهائية قابلة للتسجيل في سجل العلامات.
...
$string['notapproved'] = 'لم يتم الموافقة على المدخل بعد';
$string['notinjectivemap'] = 'ليست خريطة قابلة للحقن';
$string['notopenyet'] = 'عذراً، هذا النشاط لن يتاح حتى {$a}';
$string['number'] = 'رقم';
$string['numberrssarticles'] = 'مقالات خدمة التغذية الإخبارية';
...
$string['picture'] = 'صورة';
$string['pleaseaddsome'] = 'قم بإنشاء البعض في الأسفل أو <a href="{$a}">قم باختيار مجموعة جاهزة</a> للبدء.';
...
$string['privacy:metadata:data_content'] = 'يمثل جواباً واحداً لحقل واحد في وحدة نشاط قاعدة البيانات';
...
$string['privacy:metadata:data_records'] = 'يمثل السجلات في وحدة نشاط قاعدة البيانات';
...
$string['removealldatatags'] = 'أزِل كل وسوم قاعدة البيانات';
$string['requireapproval'] = 'هل يتطلب موافقة؟';
$string['requireapproval_help'] = 'عند تمكينه، تنبغي الموافة على المدخلات من قبل المعلم قبل أن تكون قابلة للمعاينة من قبل الآخرين.';
...
ملاحظة: إن كان وجود المدخلات مطلوباً قبل المعاينة، فينبغي تعطيل مرشح الربط التلقائي لقاعدة البيانات. هذا لأن الأخير غير قادر على تحديد ما إذا كان المستخدم قد قدم العدد المطلوب من المدخلات.';
...
$string['rsstemplate'] = 'قالب خدمة التغذية الإخبارية';
$string['rsstitletemplate'] = 'قالب عنوان خدمة التغذية الإخبارية';
$string['save'] = 'حفظ';
...
* كل سجل هو سلسلة من البيانات مفصولة بفوارز (أي غيرها من المحددات)
