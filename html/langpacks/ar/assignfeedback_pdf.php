...
/**
 * Strings for component 'assignfeedback_pdf', language 'ar', version '3.11'.
 *
...
$string['enabled_help'] = 'هذا يسمح بتأشير الملاحظات عبر الإنترنت على ملفات PDF (المسلمة بطريقة التسليم المعتمدة على PDF) مع إعادة الأعمال المؤشرة إلى الطلبة.';
