...
/**
 * Strings for component 'forumanon', language 'ar', version '3.11'.
 *
 * @package     forumanon
 * @category    string
...
$string['configlongpost'] = 'أي منشور يزيد عن هذا الحد (مقاساً بالحروف غير المتضمنة لرموز HTML) يعتبر طويلاً. المنشورات المعروضة في الصفحة الأمامية للموقع، صفحات المقررات الدراسية ذات النمط الاجتماعي، أو الملفات الشخصية للمستخدمين يتم تقصيرها إلى فاصل طبيعي في موضع ما بين قيمتي forumanon_shortpost و forumanon_longpost.';
