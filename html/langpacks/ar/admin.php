...
/**
 * Strings for component 'admin', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['agedigitalconsentverification_desc'] = 'تُمكِّن التحقق من عمر القبول الرقمي قبل عرض صفحة التسجيل لمستخدمي التسجيل الذاتي. يحمي هذا موقعك من القُصَّر عند الاشتراك بدون موافقة ولي الأمر / الوصي. سيتم تقديم تفاصيل <a target="_blank" href="{$a}">الدعم الفني</a> إلى القاصرين للحصول على مزيد من المساعدة.';
...
$string['allowblockstodock'] = 'إسمح للكتل بالارتساء';
...
$string['alternativefullnameformat_desc'] = 'هذا يحدد كيفية إظهار الأسماء للمستخدمين الذين لديهم الإمكانية viewfullnames (إفتراضياً، هم كل من المدير، المعلم ، والمعلم بلا صلاحية التحرير). العناصر النائبة التي يمكن استعمالها هي كما تم ذكرها في الإعداد "تنسيق الاسم الكامل ".';
...
$string['backup_shortname'] = 'استعمل اسم المساق في تسمية ملف الحفظ الاحتياطي';
$string['backup_shortnamehelp'] = 'استعمل اسم المساق كجزء من تسمية ملف الحفظ الاحتياطي.';
...
$string['configallowoverride2'] = 'حدد الأدوار التي يمكن تجاوزها من قبل كل دور في العمود الأيمن.<br/>لاحظ أن هذه الإعدادات تتحقق فقط للأشخاص الذين يتمتعون بالإمكانية moodle/role:override أو بالإمكانية moodle/role:safeoverride.';
$string['configallowswitch'] = 'إختر الأدوار التي يمكن للمستخدم التبديل إليها، استناداً إلى الأدوار التي لديه بالفعل. بالإضافة إلى مدخلات هذا الجدول، ينبغي أن تكون للمستخدم أيضاً الإمكانية moodle/role:switchroles ليكون قادراً على تبديل الدور.<br />لاحظ أنه من الممكن فقط التبديل إلى الأدوار التي لديها الإمكانية moodle/course:view، والتي ليس لديها الإمكانية moodle/site:doanything، لذلك تجد بعض الإعمدة في هذا الجدول معطلة.';
$string['configallowthemechangeonurl'] = 'عند تمكينه، يمكن تغيير المظهر بإضافة إمّا:<br/>?theme=themename إلى أي رابط في مودل (مثل: mymoodlesite.com/?theme=afterburner) أو <br/>&theme=themename إلى أي رابط موودل (مثل: mymoodlesite.com/course/view.php?id=2&theme=afterburner).';
...
$string['configallowview'] = 'حدد الأدوار التي سيشاهدها المستخدم، ويكون قادراً على ترشيح المستخدمين وفقاً لها ...إلخ. استناداً إلى الأدوار التي لديه بالفعل.';
...
$string['configcoursegraceperiodafter'] = 'قم باعتبار المساقات المنتهية كما لو أنها جارية حالياً لهذا العدد من الأيام بعد تاريخ انتهائها.';
$string['configcoursegraceperiodbefore'] = 'قم باعتبار المساقات المستقبلية كما لو أنها جارية حالياً بدءً من هذا العدد من الأيام السابقة لتاريخ بدئها.';
$string['configcourseoverviewfilesext'] = 'قائمة مفصولة بفوارز لامتدادات ملفات صور المساق المسموح بها.';
...
$string['configcourserequestnotify2'] = 'قائمة المستخدمين الذين سيتم إشعارهم عند طلب المساق. المستخدمون التالية أسماؤهم فقط هم من يستطيع الموافقة على طلبات إنشاء المساقات.';
$string['configcoursesperpage'] = 'أدخل عدد المساقات المعروضة لكل صفحة من صفحات قائمة المساقات';
$string['configcourseswithsummarieslimit'] = 'أقصى عدد من المساقات التي سيتم عرضها في قائمة المساقات ذات الملخصات قبل التراجع إلى قائمة أبسط.';
...
$string['configfiltermatchonepertext'] = 'ستقوم مرشحات الربط التلقائي بتوليد رابط منفرد لأول عيِّنة من التطابق النصي يُعثر عليها في الصفحة لكل عنصر. سيتم تجاهل ما سواها. هذا الإعداد لا تأثير له إذا تم تمكين \'المرشح يطابق مرة واحد لكل صفحة\'.';
...
$string['configfrontpagecourselimithelp'] = 'أقصى عدد من المساقات التي تظهر في الصفحة الرئيسية للموقع ضمن قائمة المساقات';
...
$string['configgradeexport'] = 'إختر أيّ من صيغ تصدير سجل العلامات لتكون هي الطريقة الرئيسية لتصديرها. الملاحق التي تحددها سيتم ضبطها وستستعمل حقل "آخر تصدير" لكل درجة. على سبيل المثال، هذا قد ينتج عنه تعريف السجلات المصدرة بأنها "جديدة" أو "محدّثة". إذا كنت غير متأكد من هذا، فاترك كل شيء دون تأشير.';
...
$string['configmaxusersperpage'] = 'العدد الأقصى من المستخدمين المعروضين في صفحات المساقات، المجموعات، الأفواج، خدمات الويب... إلخ.';
...
$string['confignavcourselimit'] = 'يحدد عدد المساقات المعروضة للمستخدم ضمن أدوات التنقل.';
$string['confignavshowallcourses'] = 'هذا الإعداد يقرر ما إذا كان المستخدمون المنضمون في مساقات قادرين على مشاهدة كل المساقات ضمن أدوات التنقل، فضلاً عن مساقاتهم المنضمين إليها ضمن قائمة \'مساقاتي\'.';
$string['confignavshowcategories'] = 'أظهر تصنيفات المساقات في شريط التنقل وكتل التنقل. هذا لا يحدث مع المساقات المنضم إليها المستخدم حالياً، فهي ستبقى مدرجة ضمن قائمة مساقاتي بدون التصنيفات.';
...
$string['configopentowebcrawlers'] = 'إذا قمت بتمكين هذا الإعداد، سَتتمكن محركات البحث من الدُخُول إلى موقعِكَ كضيف. فضلاً عن ذلك، سيتم اعتبار الزائرين القادمين إلى موقعك عبر محركات البحث ضيوفاً بشكل تلقائي. لاحظْ بِأَنَّ هذا فقط يُسهل العثور على المساقات التي تم السماح فيها بوصول الضيوف.';
...
$string['configprofilesforenrolledusersonly'] = 'لمنع سوء الاستعمال من قبل المزعجين، يتم إخفاء وصف الملف الشخصي للمستخدمين الذين لم ينضموا بعد لأيّ مساق. يجب على المستخدمين الجدد الانضمام إلى مساق واحد على الأقل قبل أن يتمكنوا من إضافة وصف الملف الشخصي.';
...
$string['configrecaptchapublickey'] = 'سلسلة من الأحرف (مفتاح الموقع) تستعمل لعرض عنصر اختبار reCAPTCHA في نموذج التسجيل. مفاتيح ReCAPTCHA يمكن الحصول عليها من خلال زيارة <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configuseblogassociations'] = 'هل ينبغي أن يكون المستخدمون قادرين على تنظيم مدوناتهم من خلال ربط مدخلاتها مع المساقات ووحدات المساقات؟';
...
$string['contextlocking_desc'] = 'يتيح هذا الإعداد إمكانية منح الوصول للقراءة فقط لبعض التصنيفات، المساقات، الأنشطة، أو الكتل وفقاً لما يتم تحديده منها.';
...
$string['coursecolorheading_desc'] = 'يتم عرض المساقات التي لم توضع لها صورة في إعداداتها في دفة القيادة بشكل بطاقة منقوشة. يمكن تحديد الألوان المستعملة في النقشة مما في أدناه.';
$string['coursecolorsettings'] = 'ألوان بطاقة المساق';
...
$string['coursecontactduplicates'] = 'عرض جميع أدوار الاتصال بالمساق';
$string['coursecontactduplicates_desc'] = 'في حالة التمكين، سيتم عرض المستخدمين الذين لديهم أكثر من دور من أدوار جهات اتصال بالمساق في وصف المساق مع كل دور من أدوارهم. و إلا، سيتم عرضهم مع دور واحد فقط (أيها أعلى في \'تحديد الأدوار\' في إدارة الموقع).';
$string['course_customfield'] = 'تخصيص حقول المساقات';
$string['coursegraceperiodafter'] = 'فترة السماح للمساقات المنتهية';
$string['coursegraceperiodbefore'] = 'فترة السماح للمساقات المستقبلية';
$string['courselistshortnames'] = 'عرض أسماء المساق المطولة';
$string['courselistshortnames_desc'] = 'عند التمكين، سيتم عرض الأسماء المختصرة للمساقات بالإضافة إلى أسمائها الكاملة في قوائم المساقات. إذا لزم الأمر، يمكن تخصيص الأسماء الموسعة للمساقات عن طريق تحرير سلسلة اللغة \'courseextendedamedisplay\' باستعمال ميزة تخصيص اللغة.';
...
$string['editorspellinghelp'] = 'تمكين التدقيق الإملائي أو تعطيله. عند التمكين، <strong>aspell</strong> يجب تنصيبه على المخدم.';
...
$string['enablecourserelativedates_desc'] = 'السماح للمساقات بأن يتم ضبطها لعرض التواريخ نسبة إلى تاريخ بدء المستخدم في المساق.';
...
$string['errordeletingconfig'] = 'وقع خطأ عند حذف سجلات تهيئة الملحق \'{$a}\'.';
...
$string['gravatardefaulturl_help'] = 'Gravatar يحتاج إلى الصورة الافتراضية لعرضها إذا كان غير قادر على العثور على صورة للمستخدم المعين. أعطِ الرابط الكامل للصورة. إذا تركت هذا الإعداد فارغاً، مودل سيحاول استعمال الصورة الافتراضية الأنسب للصفحة التي تشاهدها. لاحظ أيضاً أن Gravatar لديه عدد من الرموز والتي يمكن استعمالها <a href="https://en.gravatar.com/site/implement/images/#default-image">لتوليد الصور الافتراضية</a>.';
...
$string['helpadminseesall'] = 'في تقويم الموقع، هل يشاهد المشرفون الأحداث ويقومون بترشحها من كل تقويمات المساقات، أم فقط للمساقات المنضمين إليها؟ بغض النظر عن الخيار الذي يتم تحديده هنا، سيتمكن المشرفون دائماً من إدارة الأحداث لكل تقاويم المساقات من خلال الانتقال إلى المساق أولاً، ثم الوصول إلى تقويمه مباشرةً.';
...
$string['legacyfilesaddallowed'] = 'إسماح بالإضافة إلى ملفات المساق القديمة';
$string['legacyfilesaddallowed_help'] = 'إذا كان المساق محتوياً على ملفات قديمة، إسمح بإضافة الملفات والمجلدات الجديدة إليه.';
$string['legacyfilesinnewcourses'] = 'توريث ملفات المساق في مساقات جديدة';
$string['legacyfilesinnewcourses_help'] = 'إفتراضياً، تتواجد المناطق القديمة لملفات المساقات فقط في المساقات المُرقَّات. يرجى ملاحظة بعض الميزات مثل الحفظ الاحتياطي للنشاط واستعادته غير متوافقة مع هذا الإعداد.';
...
$string['lockoutduration_desc'] = 'يتم إلغاء قفل الحساب المقفول تلقائياً بعد هذه المدة.';
$string['lockoutemailbody'] = 'لقد تم قفل حسابك باسم المستخدم {$a->username} في الموقع \'{$a->sitename}\'
...
$string['logo_desc'] = 'شعار كامل ليتم استعماله كزينة لبعض المظاهر (مثل المظاهر الأساسية). يمكن أن تكون هذه الصورة عالية الدقة لأنه سيتم تصغيرها للاستخدام (وتخبئتها للأداء). الشعارات ذات العرض الأكبر من ارتفاعها تعطي عادةً نتائج أفضل. التنسيقات المقبولة: PNG و JPG.';
...
$string['manageformats'] = 'إدارة تنسيقات المساقات';
...
$string['maturitycorewarning'] = 'إصدار مودل الذي أنت على وشك تثبيته أو ترقيته سيحتوي رمز التطوير "{$a}" غير المستقر والذي لا يتناسب مع استعمالات معظم المواقع الإنتاجية. إذا لم يكن هذا ما تريده، فينبغي عليك التأكد من أنك تقوم بالتحديث من إصدار مستقر لبرنامج مودل.
...
$string['mnetrestore_extusers_noadmin'] = '<strong>ملاحظة:</strong> يبدو أن ملف الحفظ الاحتياطي هذا يأتي من تنصيب مختلف لمودل ويحتوي على حسابات المستخدمين لشبكة مودل عن بعد. لا يسمح لك بتنفيذ هذا النوع من الاستعادة. إتصل بالمسؤول عن الموقع أو، بدلاً من ذلك، قم باستعادة هذا المساق بدون أي معلومات عن المستخدمين (الوحدات، الملفات...).';
...
الإدارة، المساقات، الأنشطة والمشاركون. إذا كنت قد وضعت أيّ صلاحيات خاصة لتلك الكتل، ينبغي عليك مراجعتها للتأكد من أن كل شيء يتصرف كما تريد.';
$string['navshowallcourses'] = 'إظهار كل المساقات';
$string['navshowcategories'] = 'أظهر تصنيفات المساقات';
$string['navshowfrontpagemods'] = 'أظهر نشاطات الصفحة الأمامية في التنقل';
$string['navshowfrontpagemods_help'] = 'إذا مكّن ، سيتم عرض أنشطة الصفحة الأولى على التنقل تحت صفحات الموقع.';
$string['navshowfullcoursenames'] = 'إظهار أسماء المساقات كاملة';
$string['navshowfullcoursenames_help'] = 'في حالة التمكين، سيتم استعمال الأسماء الكاملة للمساقات في التنقل بدلاً من الأسماء المختصرة.';
$string['navshowmycoursecategories'] = 'أظهر تصنيفات مساقاتي';
$string['navshowmycoursecategories_help'] = 'عند تمكينه، فالمساقات التي تظهر للمستخدم ضمن فرع مساقاتي ستكون مبوبة حسب التصنيفات.';
...
$string['pluginschecktodo'] = 'ينبغي عليك حل كل متطلبات الملاحق قبل الشروع بتنصيب هذا الإصدار من مودل!';
$string['pluginsoverview'] = 'استعراض الملاحق';
$string['pluginsoverviewsee'] = 'أنظر صفحة <a href="{$a->url}">استعراض الملاحق</a> لمزيد من التفاصيل.';
$string['policysettings'] = 'إعدادات السياسة';
$string['privacyandpolicies'] = 'الخصوصية والسياسات';
$string['privacy:metadata'] = 'لا يقوم ملحق الإدارة بتخزين أي بيانات شخصية.';
...
$string['purgecachesconfirm'] = 'مودل يمكنه تخزين المظاهر، javascript، جُمل اللغة، النص المرشح، التغذية الإخبارية، والعديد من قطع البيانات الأخرى المحسوبة. بتطهير هذه المخابئ ستحذف تلك البيانات من المخدم وتفرض على المتصفحات إعادة جلبها، بحيث يمكنك التأكد من أنك ترى القيم الأكثر حداثة التي ينتجها البرنامج حالياً. ليس هناك خطر من تطهير المخابئ، ولكن قد يظهر موقعك أبطأ لفترة من الوقت حتى يحسب المخدم والعملاء المعلومات الجديدة ويعيدوا تخبئتها لديهم.';
...
$string['restorecourse'] = 'استعادة المساقات';
$string['restorernewroleid'] = 'استعادة الأدوار في المقررات';
$string['restorernewroleid_help'] = 'إذا كان المستخدم لا يملك مسبقاً صلاحية إدارة المساق المستعاد حديثاً، يتم تعيين هذا الدور له تلقائياً وضمه إليه إن لزم الأمر. إختر "بلا" إذا كنت لا تريد جعل المستعيدين قادرين على إدارة كل مساق مستعاد.';
...
$string['search'] = 'البحث';
$string['searchablecourses'] = 'المساقات القابلة للبحث';
$string['searchallavailablecourses'] = 'المساقات القابلة للبحث';
$string['searchallavailablecoursesdesc'] = 'إذا تم ضبطه للبحث ضمن المساقات المنضم إليها فقط، فسيتم البحث في معلومات المساقات (الاسم والملخص) ومحتوياتها من التي تم الانضمام إليها. و إلا، سيتم البحث في معلومات المساقات ومحتوياتها لكل المساقات التي يمكن للمستخدم الوصول إليها، مثل المساقات التي تسمح بدخول الضيف.';
$string['searchallavailablecourses_desc'] = 'في بعض الحالات، قد لا يعمل محرك البحث عند البحث في عدد كبير من المساقات. أضبطه للبحث في المساقات المنضم إليها فقط إذا كنت بحاجة إلى تقييد عدد المساقات التي يتم البحث فيها.';
$string['searchallavailablecourses_off'] = 'البحث ضمن المساقات المنْضَم إليها فقط';
$string['searchallavailablecourses_on'] = 'البحث ضمن كل المساقات التي يمكن للمستخدم الوصول إليها';
...
$string['searchincludeallcourses'] = 'شمول كل المساقات المرئية';
$string['searchincludeallcourses_desc'] = 'عند تمكينه، ستتضمن نتائج البحث معلومات المساق (الاسم والملخص) للمساقا التي تكون مرئية للمستخدم، حتى لو لم يكن لديهم إمكانية الوصول إلى محتوى المساق.';
...
$string['sectionerror'] = 'خطأ المقطع!';
...
$string['sitesectionhelp'] = 'إذا تم اختياره، سيتم عرض مقطع الموضوع على الصفحة الأمامية للموقع.';
...
$string['soaprecommended'] = 'تثبيت الملحق الاختياري soap مفيد لخدمات الويب وبعض الوحدات الأخرى.';
$string['sort_fullname'] = 'الاسم الكامل للمساق';
$string['sort_idnumber'] = 'رقم معرف الدورة';
$string['sort_shortname'] = 'الاسم المختصر للمساق';
...
$string['stripalltitletags'] = 'أزل وسوم لغة HTML من كافة أسماء النشاطات';
...
$string['task_adhoc_concurrency_limit_desc'] = 'عدد المتسابقين في مهمة adhoc المسموح لهم بالعمل بشكل متزامن. إذا كان الحد مرتفعًا ، فقد لا تعمل المهام المجدولة بانتظام عندما يكون هناك الكثير من المهام المخصصة. سيؤدي إعداد 0 إلى تعطيل معالجة مهام adhoc بالكامل.';
...
$string['taskbackupcleanup'] = 'إخلاء جداول الحفظ الاحتياطي وسجلات الوقوعات';
$string['taskbadgescron'] = 'شارات الجائزة';
$string['taskbadgesmessagecron'] = 'المعالجة في الخلفية لإرسال إشعارات شارات';
...
$string['task_duration'] = 'مدة زمنية';
...
$string['taskgradecron'] = 'المعالجة الخلفية لسجل العلامات';
$string['taskgradehistorycleanup'] = 'المعالجة في الخلفية لتنظيف تاريخ جداول العلامات';
$string['tasklegacycron'] = 'معالجة مشغل الوظائف الدورية القديم للملاحق';
...
$string['task_logmode_desc'] = 'يمكنك اختيار وقت الرغبة في تسجيل المهام. حسب السجلات الافتراضية يتم التقاطها دائما. يمكنك تعطيل التسجيل بالكامل ، أو التغيير فقط لتسجيل المهام التي تفشل.';
$string['task_logmode_failonly'] = 'تخزين سجلات فقط للوظائف التي تفشل';
...
$string['taskportfoliocron'] = 'المعالجة في الخلفية لملاحق المحافظ';
...
$string['themeresetcaches'] = 'تنظيف مخبوءات المظهر';
...
$string['unicoderequired'] = 'من المتطلبات تخزين كل بياناتك بنظام ترميز اليونيكود (UTF-8). التنصيبات الجديدة يجب تنفيذها بقواعد بيانات ترميزها الافتراضي هو اليونيكود. إذا كنت بصدد الترقية، ينبغي عليك تنفيذ عملية التحويل إلى UTF-8، (أنظر صفحة الإدارة).';
...
$string['updateautocheck_desc'] = 'عند تمكينه، سيتحقق موقعك تلقائياً من وجود تحديثات لبرمجة مودل وملاحقه. في حالة وجود تحديثات متاحة، سيتم إشعار مشرف الموقع.';
$string['updateavailable'] = 'تتوفر نسخة مودل أحدث!';
$string['updateavailabledetailslink'] = 'راجع  {$a->url}  لمزيد من التفاصيل';
$string['updateavailableforplugin'] = 'تتوفر إصدارات جديدة من بعض الملاحق!';
$string['updateavailableinstall'] = 'تثبيت هذا التحديث';
$string['updateavailableinstallall'] = 'تثبيت التحديثات ({$a}) المتاحة.';
...
$string['upgradepluginsinfo'] = 'تحديث الملاحق';
