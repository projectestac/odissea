...
$string['allowcohortthemes'] = 'السماح بمظاهر الدفعات';
...
$string['configallowblockstodock'] = 'إذا تم تمكينه، وكان مدعوماً من قبل القالب المحدد، فسيتمكن المستخدمون من نقل الكتل إلى مرسى خاص.';
$string['configallowcategorythemes'] = 'إذا مكّنت هذا، فالقوالب يمكن تعيينها على مستوى التصنيف. سيؤثر هذا على جميع التصنيفات الفرعية والمقررات ما لم تكن قد خُصِّصَت بقالب خاص بها.
تحذير: تمكين قوالب التصنيف قد يؤثر على الأداء.';
$string['configallowcohortthemes'] = 'إذا قمت بتمكين هذا، فيمكن تعيين القالب على مستوى الدفعة. سيؤثر هذا على جميع المستخدمين في دفعة واحدة فقط أو أكثر من واحد ولكن مع نفس القالب.';
$string['configallowcoursethemes'] = 'عند تمكينه، سيُسمح للمقررات الدراسية باختيار القوالب الخاصة بها. قوالب المقررات الدراسية تتجاوز كل خيارات القالب الأخرى (الموقع، المستخدم، التصنيف، الدفعة أو القوالب المعرفة حسب عنوان الرابط).';
...
$string['configallowguestmymoodle'] = 'عند التمكين، سيتمكن الضيوف من الوصول إلى لوحة التحكم، بخلاف ذلك سيتم توجيه الضيوف إلى صفحة واجهة الموقع.';
...
$string['configallowuserthemes'] = 'لو مكّن هذا، سيسمح للمستخدمين بالقيام باختيار القوالب الخاصة بهم، قالب المستخدم يطغى على قالب الموقع، ولكن لن يطغى على قالب المقرر .';
...
$string['configallusersaresitestudents'] = 'للأنشطة التي في صفحة واجهة الموقع، هل كُلّ المستخدمين يَنبغي اعتبارهم طلابًا؟ إذا كانت الإجابة "نعم"، سَيُسْمحُ بالمُشَارَكَة فيها بدور الطالب لأيّ صاحب حساب مؤكد. إن كانت الإجابة "لا"، فقط المستخدمون الذين هم مشاركون في مقرر واحد على الأقل سيكونون قادرين على الاشتِراك في أنشطة صفحة الواجهة.
فقط المشرفون والمعلمون المعينون بشكل خاص يُمْكِنُهم أَنْ يتصرفوا كمعلمين مع أنشطة صفحة الواجهة.';
...
$string['configfrontpage'] = 'سيتم عرض العناصر المحددة أعلاه في صفحة واجهة الموقع.';
...
$string['configfrontpageloggedin'] = 'سيتم عرض العناصر المحددة أعلاه في صفحة واجهة الموقع بعد قيام المستخدم بتسجيل دخوله.';
...
$string['configintrosite'] = 'هذه الصفحة تسمح لك بتهيئة صفحة الواجهة واسم هذا الموقع الجديد. يمكنك الرجوع إلى هنا في وقت لاحق لتغيير هذه الإعدادات متى تشاء باستعمال قوائم الإدارة.';
...
$string['configsmartpix'] = 'مع تشغيل هذا، الأيقونات يتم تقديمها من خلال نصوص PHP والذي يبحث في القالب الحالي، ثم كل القوالب الأعلى رتبة، ثم في المجلد /pix لمودل. هذا يقلل الحاجة لتكرار ملفات الصور ضمن القوالب، ولكن مقابل تكلفة أداء طفيفة.';
...
$string['configthemedesignermode'] = 'عادة كل صور القالب وأوراق الأنماط يتم تخزينها مؤقتا في المتصفحات وفي المخدم فترة طويلة جدًا، لأداء أفضل. إذا كنت تقوم بتصميم قوالب أو تطوير البرمجة فربما ترغب في تمكينه لكي لا تحصل على الإصدارات المخبأة. تحذير: هذا سيجعل موقعك أبطأ لجميع المستخدمين! بدلاً من ذلك، يمكنك أيضًا إعادة تعيين الذاكرة المخبأة للقالب يدويًا من صفحة اختيار القالب.';
...
$string['eventshandlersinuse'] = 'تستعمل الإضافات التالية في نظامك معالجات الأحداث 1 لواجهة برمجة التطبيق المهملة: \'{$a}\'. يرجى تحديثها لتستعمل الأحداث 2 لواجهة برمجة التطبيق. أنظر https://docs.moodle.org/dev/Event_2#Event_dispatching_and_observers.';
...
$string['frontpagebackup'] = 'الحفظ الاحتياطي لصفحة الواجهة';
...
$string['frontpageoverrides'] = 'تجاوزات صلاحية صفحة الواجهة';
$string['frontpagequestions'] = 'أسئلة صفحة الواجهة';
...
$string['guestroleid_help'] = 'يتم تعيين هذا الدور تلقائياً إلى المستخدم الضيف. أيضاً يتم تعيينه مؤقتاً للمستخدمين غير المسجلين الذين يدخلون إلى المقرر الدراسي عن طريق إضافة إنضمام الضيف.';
...
$string['logo'] = 'الشعار';
$string['logo_desc'] = 'شعار كامل ليتم استعماله كزينة لبعض القوالب (مثل القوالب الأساسية). يمكن أن تكون هذه الصورة عالية الدقة لأنه سيتم تصغيرها للاستخدام (وتخبئتها للأداء). الشعارات ذات العرض الأكبر من ارتفاعها تعطي عادةً نتائج أفضل. التنسيقات المقبولة: PNG و JPG.';
...
$string['navshowfrontpagemods'] = 'إظهار نشاطات صفحة الواجهة في التنقل';
$string['navshowfrontpagemods_help'] = 'عند تمكينه، سيتم إظهار أنشطة صفحة الواجهة في التنقل تحت صفحات الموقع.';
...
$string['sitesectionhelp'] = 'إذا تم اختياره، سيتم عرض مقطع الموضوع على صفحة واجهة الموقع.';
...
$string['soaprecommended'] = 'تنصيب الامتداد الاختياري soap مفيد لخدمات الويب وبعض الملاحق الأخرى.';
$string['sort_fullname'] = 'الاسم الكامل للمقرر الدراسي';
$string['sort_idnumber'] = 'رقم مُعرَّف المقرر الدراسي';
...
$string['themeresetcaches'] = 'تنظيف الملفات المؤقتة للقالب';
$string['themeselect'] = 'تغيير القالب';
$string['themeselector'] = 'محدد القوالب';
...
$string['upgradepluginsinfo_help'] = 'توجد تحديثات متاحة لبعض إضافاتك. ينبغي تنصيبها جميعاً قبل ترقية قاعدة بيانات مودل. إذا كان موقعك لا يدعم نشر التحديثات التلقائية، يجب عليك تنزيل وتثبيت الإصدارات الجديدة من الإضافات يدوياً في مخدمك.';
