...
$string['configallowcohortthemes'] = 'إذا قمت بتمكينه، فسيكون بالإمكان تعيين المظهرعلى مستوى الدفعة. سيؤثر هذا على كل المستخدمين في دفعة واحدة فقط أو أكثر من واحدة ولكن مع نفس المظهر.';
...
$string['configdefaulthomepage'] = 'أي صفحة تنبغي إعادة توجيه المستخدمين إليها بعد تسجيل دخولهم إلى الموقع؟ يحدد هذا الإعداد أيضًا الرابط الأول في التنقل لمستخدمي المظاهر المبنية على المظهر الكلاسيكي.';
...
$string['configfilternavigationwithsystemcontext'] = 'الاستعمال العادي للمرشح يختص بالسياق الذي هو فيه (مثلاً سياق المساق)، ولكن على مستوى تنقل الموقع، أن تجعل كل شيء مرشحًا وفقًا لسياق الموقع فهذا سيؤدي إلى تحسين الأداء عند استعمال ترشيح "المحتوى والعناوين".';
...
من المستحسن تنصيب نسخة محلية لقاعدة البيانات المجانية من GeoLite City من MaxMind.<br />
...
$string['purgethemecache'] = 'المظاهر';
