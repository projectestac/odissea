...
/**
 * Strings for component 'admin', language 'ar', version '4.4'.
 *
 * @package     admin
 * @category    string
...
$string['cachetemplates'] = 'تخبئة المظاهر';
...
$string['configallowuserthemes'] = 'إذا تم تمكينه، سيسمح ذلك للمستخدمين باختيار المظاهر الخاصة بهم، مظهر المستخدم يطغى على مظهر الموقع، (ولكنه لن يطغى على مظهر المساق)';
...
$string['configthemedesignermode'] = 'عادة كل صور المظهر وأوراق الأنماط يتم تخزينها مؤقتا في المتصفحات وفي المخدم فترة طويلة جدًا، لأداء أفضل. إذا كنت تصمم المظاهر أو تطور البرمجة فربما ترغب في تمكينه لكي لا تحصل على الإصدارات المخبأة. تحذير: هذا سيجعل موقعك أبطأ لجميع المستخدمين! بدلاً من ذلك، يمكنك أيضًا إعادة تعيين مخبوءات المظهر يدويًا من صفحة اختيار المظهر.';
...
$string['themedefinedinconfigphp'] = 'لا يمكن تغيير المظهر بسبب ضبطه إلى {$a} في ملف التهيئة config.php.';
...
$string['themeeditsettingsname'] = 'تحرير إعدادات المظهر \'{$a}\'';
...
$string['themeselector'] = 'المظاهر';
$string['themesettings'] = 'إعدادات القالب';
$string['themesettingsadvanced'] = 'إعدادات المظهر المتقدمة';
$string['themesettingscustom'] = 'إعدادات المظهر المخصصة';
$string['themesettingsname'] = 'إعدادات المظهر \'{$a}\'';
$string['themeusagereportname'] = 'تقرير استعمال المظهر \'{$a}\'';
