...
/**
 * Strings for component 'admin', language 'ar', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['allowcoursethemes'] = 'السماح بمظاهر المقررات الدراسية';
...
$string['cachetemplates'] = 'مظاهر الخبء';
...
$string['calendartype_desc'] = 'اختر نوع التقويم الافتراضي للموقع بأكمله. هذا الإعداد يمكن تغييره في إعدادات المساق أو من قبل المستخدمين في ملفاتهم الشخصية.';
...
$string['configallowcategorythemes'] = 'إذا مكّنت هذا، فالمظاهر يمكن تعيينها على مستوى التصنيف. سيؤثر هذا على جميع التصنيفات الفرعية والمقررات الدراسية ما لم تكن قد خُصِّصَت بمظهر خاص بها.
...
$string['configallowguestmymoodle'] = 'عند التمكين، سيتمكن الضيوف من الوصول إلىدفة القيادة، بخلاف ذلك سيتم توجيه الضيوف إلى واجهة الموقع.';
...
$string['configcourseoverviewfilesext'] = 'قائمة مفصولة بفواصل لامتدادات ملفات صور المساق المسموح بها.';
$string['configcourseoverviewfileslimit'] = 'أقصى عدد من الملفات التي يمكن عرضها بجوار ملخص المقرر في صفحة قائمة المقررات الدراسية. يتم استعمال ملف الصورة الأول المُضاف كصورة للمقرر في نظرة عامة على المساق؛ عند ددفة القيادة الخاصة بالمستخدمين. يتم عرض أيّ ملفات إضافية في صفحة قائمة المقررات الدراسية فقط.';
...
$string['configdndallowtextandlinks'] = 'تمكين أو تعطيل السحب والإفلات للنص والروابط في صفحة المساق، جنبًا إلى جنب مع سحب وإفلات الملفات. لاحظ أن سحب النص إلى فايرفوكس أو بين مختلف المتصفحات لا يعتمد عليه وربما يؤدي إلى فقد البيانات التي يتم تحميلها، أو عطب النص المحمل.';
...
$string['configgradebookroles'] = 'هذا الإعداد يَسْمحُ لك بالسَيْطَرَة على مَنْ يظْهرُ في سجل التقديرات. ينبغي للمستخدمين أَنْ يَكُونَ عِنْدَهُمْ على الأقل أحد هذه الأدوارِ في المساق ليتم إظهارهم في سجل تقديرات ذلك المساق.';
...
$string['confighiddenuserfields'] = 'إختر حقول معلومات المستخدم التي ترغب بإخفائها عن باقي المستخدمين، عدا معلمي المساق والمشرفين. هذا يزيد من خصوصية الطلاب. استمر بالضغط على المفتاح CTRL لاختيار أكثر من حقل.';
...
$string['configmycoursesperpage'] = 'الحد الأقصى لعدد المقررات الدراسية لعرضها في أيّ قائمة مقررات للمستخدم';
...
$string['configsectionrequestedcourse'] = 'طلبات المساق';
...
$string['coursecolorheading_desc'] = 'يتم عرض المقررات الدراسية التي لم توضع لها صورة في إعداداتها في دفة القيادة بشكل بطاقة منقوشة. يمكن تحديد الألوان المستعملة في النقشة مما في أدناه.';
$string['coursecolorsettings'] = 'ألوان بطاقة المساق';
$string['coursecontact'] = 'عناوين الاتصال للمساق الدراسي';
...
$string['coursecontactduplicates_desc'] = 'في حالة التمكين، سيتم عرض المستخدمين الذين لديهم أكثر من دور من أدوار جهات اتصال بالمساق في وصف المساق مع كل دور من أدوارهم. وإلا، سيتم عرضهم مع دور واحد فقط (أيها أعلى في \'تحديد الأدوار\' في إدارة الموقع).';
...
$string['courserequestspending'] = 'طلبات معلّقة لمساق';
...
$string['creatornewroleid_help'] = 'إذا كان المستخدم لا يملك مسبقًا صلاحية إدارة المساق الجديد، فالمستخدم يتم ضمه تلقائيًا بهذا الدور.';
...
$string['defaultformatnotset'] = 'خطأ في تحديد تنسيق المساق الافتراضي . الرجاء التحقق من إعدادات الموقع.';
...
$string['downloadcoursecontentallowed'] = 'ميزة تنزيل محتوى المساق متاحة';
$string['downloadcoursecontentallowed_desc'] = 'فيما إذا كانت ميزة تنزيل محتويات المقررات الدراسية متاحة لها. عندما تكون متاحة، يمكن تمكين/تعطيل تنزيل محتويات المساق باستعمال الإعداد "تمكين تنزيل محتوى المقرر" ضمن قائمة تحرير المقرر (القيمة الافتراضية لهذا يمكن تحديدها في <a href={$a} target="_blank">الإعدادات الافتراضية للمقرر الدراسي</a>).';
...
$string['enablecourserelativedates'] = 'تمكين التواريخ المرتبطة بالمساق';
...
$string['enabledashboard'] = 'تمكين دفة القيادة';
$string['enabledashboard_help'] = 'دفة القيادة تُظهر المخطط الزمني، التقويم والعناصر التي تم الوصول إليها مؤخرًا بشكل إفتراضي. يمكنك تعيين دفة قيادة إفتراضية مختلفة لكل شخص والسماح للمستخدمين بتخصيص دفات القيادة الخاصة بهم. عند تعطيله، ستحتاج إلى ضبط الإعداد \'صفحة البدء للمستخدمين\' إلى قيمة أخرى غير دفة القيادة.';
...
$string['enroladminnewcourse_help'] = 'عندما يضيف المشرف مساقًا دراسيًا جديدًا، هل ينبغي ضمه تلقائيًا ومنحه دور المنشئ فيه؟';
...
$string['guestroleid_help'] = 'يتم تعيين هذا الدور تلقائياً إلى المستخدم الضيف. أيضاً يتم تعيينه مؤقتاً للمستخدمين غير المسجلين الذين يدخلون إلى المساق عن طريق إضافة إنضمام الضيف.';
...
$string['iplookupinfo'] = 'يتم استعمال مخدم NetGeo المجاني للبحث في مواقع عناوين IP. مع ذلك، قاعدة البيانات هذه لم تعد مُدامة، وربما ترجع بيانات غير صحيحة. من المستحسن تنصيب نسخة محلية لقاعدة البيانات المجانية من GeoLite2 City من MaxMind.<br />
...
$string['legacyfilesaddallowed'] = 'السماح بالإضافة إلى ملفات المساق القديمة';
...
$string['logo'] = 'الشعار';
$string['logo_desc'] = 'شعار كامل ليتم استعماله كزينة لبعض المظاهر (مثل المظاهر الأساسية). يمكن أن تكون هذه الصورة عالية الدقة لأنه سيتم تصغيرها للاستخدام (وتخبئتها لمتطلب الأداء). الشعارات ذات العرض الأكبر من ارتفاعها تعطي عادةً نتائج أفضل.';
...
$string['maxsizeperdownloadcoursefile_desc'] = 'أقصى حجم لكل ملف عند تنزيل محتوى المساق. الملفات التي تتجاوز هذا الحجم سيتم التغافل عنها عند التنزيل.';
...
$string['multilangforceold'] = 'فرض صيغة متعدد اللغات القديمة: &lt;span&gt; بدون الفئة class="multilang" و &lt;lang&gt;';
...
$string['navshowfrontpagemods_help'] = 'عند تمكينه، سيتم إظهار أنشطة واجهة الموقع في التنقل ضمن صفحات الموقع. هذا الإعداد ينطبق فقط على المظاهر المبنية على المظهر الكلاسيكي.';
...
$string['navsortmycoursessort'] = 'ترتيب مقرراتي';
$string['navsortmycoursessort_help'] = 'يحدد هذا ما إذا كانت المقررات الدراسية المدرجة ضمن مقرراتي مفروزة وفقاً لترتيب الفرز (أي الترتيب المعيَّن في إدارة الموقع > المقررات الدراسية > إدارة المقررات الدراسية والتصنيفات) أو هجائياً حسب إعداد المساق.';
$string['never'] = 'أبداً';
...
$string['noteunneededblocks'] = 'ملاحظة: الكتل المهيأة للظهور لن يتم إدراجها في قائمة \'إضافة كتلة\' ضمن مساق معين إذا تم تحديدها في إعداد المظهر \'الكتل اللا ضرورية\'.';
...
* مرئي للمستخدم، للمعلمين وللمشرفين - للبيانات الخاصة المرئية فقط للمستخدم، للمعلمين وللمشرفين (في الملف الشخصي للمساق الدراسي)
* مرئي للجميع';
...
$string['resetindentation'] = 'إعادة تعيين المحاذاة';
$string['resetindentation_help'] = 'هذا من شأنه إزالة أي محاذاة تم ضبطها سابقًا للمساقات من {$a->format}.';
$string['resetindentation_title'] = 'أتريد إعادة تعيين المحاذاة في صفحة المساق؟';
...
$string['sitesectionhelp'] = 'إذا تم اختياره، سيتم عرض مقطع الموضوع في واجهة الموقع.';
...
$string['sort_fullname'] = 'الاسم الكامل للمساق الدراسي';
$string['sort_idnumber'] = 'رقم مُعرَّف المساق';
$string['sort_shortname'] = 'الاسم المختصر للمساق الدراسي';
...
$string['themeresetcaches'] = 'تنظيف الملفات المؤقتة للمظهر';
$string['themeselect'] = 'تغيير المظهر';
$string['themeselector'] = 'محدد المظاهر';
