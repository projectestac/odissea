...
/**
 * Strings for component 'admin', language 'ar', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['backup_shortnamehelp'] = 'استعمل اسم المقرر الدراسي كجزء من تسمية ملف الحفظ الاحتياطي.';
...
$string['cachetemplates_help'] = 'تعمل تخبئة للقالب على تحسين أداء تحميل الصفحة ويوصى به بشدة في مواقع الإنتاج. ربما يريد المطورون تعطيل هذه الميزة.';
...
$string['configallowcoursethemes'] = 'عند تمكينه، سيُسمح للمقررات الدراسية باختيار المظاهر الخاصة بها. مظاهر المقررات الدراسية تتجاوز كل خيارات المظهر الأخرى (الموقع، المستخدم، التصنيف، الفوج أو المظاهر المعرفة حسب عنوان الرابط).';
...
$string['configautologinguests'] = 'هل ينبغي اعتبار الزوار تلقائياً كضيوف عندما يدخلون إلى مقررات دراسية تسمح بدخول الضيوف؟';
...
$string['configcourseoverviewfileslimit'] = 'أقصى عدد من الملفات التي يمكن عرضها بجوار ملخص المقرر الدراسي في صفحة قائمة المقررات الدراسية. يتم استعمال ملف الصورة الأول المُضاف كصورة للمقرر في نظرة عامة على المقرر؛ عند دلوحة التحكم الخاصة بالمستخدمين. يتم عرض أيّ ملفات إضافية في صفحة قائمة المقررات الدراسية فقط.';
$string['configcourserequestnotify'] = 'أكتب اسم المستخدم الخاص بالمستخدم الذي سيتم إشعاره عند طلب مقرر دراسي جديد';
$string['configcourserequestnotify2'] = 'قائمة المستخدمين الذين سيتم إشعارهم عند طلب المقرر الدراسي. المستخدمون التالية أسماؤهم فقط هم من يستطيع الموافقة على طلبات إنشاء المقررات الدراسية.';
...
$string['configdefaulthomepage'] = 'يحدد هذا الرابط الأول في التنقل للمستخدمين الذين تم تسجيل دخولهم.';
$string['configdefaultrequestcategory'] = 'سيتم وضع المقررات الدراسية التي يطلبها المستخدمون مع إمكانية طلب مقررات دراسية جديدة في سياق النظام في هذا التصنيف؛ ما لم يتمكن المستخدمون من تحديد تصنيف مختلف.';
...
$string['configdocroot'] = 'يحدد المسار إلى توثيقات مودل لتوفير ما هو خاص بالسياق عبر روابط \'المساعدة والتوثيقات\' عند تذييل كل صفحة. إذا تُرِك الحقل فارغاً، فلن يتم عرض الروابط.';
...
$string['configenablecourserequests'] = 'في حالة التمكين، سيكون لدى المستخدمين الذين لديهم إمكانية طلب مقررات جديدة (moodle/course:request) خيار طلب إنشاء مقرر دراسي. هذه الإمكانية غير مسموح بها لأي من الأدوار الافتراضية. قد يتم تطبيقها في سياق النظام أو التصنيف.';
...
$string['configforcelogin'] = 'عادة، يمكن قراءة الصفحة الأولى مِن الموقعِ وقائمة المقررات الدراسية فيه (لكن لَيس المقررات نفسها) مِن قِبل الناسِ بدون تسجيل الدخول إلى الموقعِ. إذا كنتَ تريد إجبار الناس على تسجيل الدخول قبل أن يقوموا بأي شيء في الموقع، فعليك تمكين هذا الإعداد.';
...
$string['configgradebookroles'] = 'هذا الإعداد يَسْمحُ لك بالسَيْطَرَة على مَنْ يظْهرُ في سجل التقديرات. ينبغي للمستخدمين أَنْ يَكُونَ عِنْدَهُمْ على الأقل أحد هذه الأدوارِ في المقرر ليتم إظهارهم في سجل تقديرات ذلك المقرر الدراسي.';
$string['configgradeexport'] = 'إختر أيّ من صيغ تصدير سجل التقديرات لتكون هي الطريقة الرئيسية لتصديرها. الملاحق التي تحددها سيتم ضبطها وستستعمل حقل "آخر تصدير" لكل درجة. على سبيل المثال، هذا قد ينتج عنه تعريف السجلات المصدرة بأنها "جديدة" أو "محدّثة". إذا كنت غير متأكد من هذا، فاترك كل شيء دون تأشير.';
...
$string['configlockrequestcategory'] = 'عند تمكينه، لن يتمكن المستخدمون الذين لديهم إمكانية طلب مقررات دراسية جديدة في سياق النظام من تحديد التصنيف في نموذج الطلب. تتمثل إحدى الطرق البديلة لتقييد طلبات المستخدمين لمقررات جديدة ضمن تصنيف واحد فقط؛ بتطبيق إمكانية طلب المقررات الدراسية الجديدة في سياق التصنيف.';
...
$string['configmessagingallusers'] = 'في حالة التمكين، يمكن للمستخدمين معاينة قائمة بكل المستخدمين في الموقع عند اختيار شخص ما لمراسلته، وستتضمن تفضيلات المراسلة خيار قبول الرسائل من أي شخص في الموقع. إذا تم تعطيله، يمكن فقط للمستخدمين معاينة قائمة المستخدمين في مقرراتهم الدراسية، مع خيارين فقط في تفضيلات المراسلة، هما - قبول الرسائل من جهات اتصالهم فقط، أو جهات اتصالهم وأي شخص في مقرراتهم.';
...
$string['confignavshowallcourses'] = 'هذا الإعداد يقرر ما إذا كان المستخدمون المنضمون إلى مقررات قادرين على مشاهدة كل المقررات الدراسية (استعراض كل المقررات) ضمن أدوات التنقل، فضلاً عن \'مقرراتي الدراسية\' (استعراض مقرراتهم المنضمين إليها).';
$string['confignavshowcategories'] = 'أظهر تصنيفات المقررات الدراسية في شريط التنقل وكتل التنقل. هذا لا يحدث مع المقررات الدراسية المنضم إليها المستخدم حالياً، فهي ستبقى مدرجة ضمن قائمة مقرراتي الدراسية بدون التصنيفات.';
...
$string['configperfdebug'] = 'إذا قمتَ بتمكينه، ستتم طباعة معلومات الأداء في تذييل صفحة المظهر القياسي';
...
$string['configstatsuserthreshold'] = 'هذا الإعداد يحدد أقل عدد من المستخدمين المنضمين إلى المقرر الدراسي ليتم شموله في حسابات الإحصائيات.';
...
$string['configuseblogassociations'] = 'هل ينبغي أن يكون المستخدمون قادرين على تنظيم مدوناتهم من خلال ربط مدخلاتها مع المقررات الدراسية ووحدات المقررات؟';
...
$string['coursecontact_desc'] = 'هذا الإعداد يَسْمحُ لك بالسَيْطَرَة على مَنْ يظْهرُ في وصف المقرر الدراسي. ينبغي للمستخدمين أَنْ يَكُونَ عِنْدَهُمْ على الأقل أحد هذه الأدوارِ في المقرر ليتم إظهارهم في وصف ذلك المقرر.';
...
$string['courselistshortnames'] = 'عرض أسماء المقرر الدراسي المطولة';
...
$string['courserequestnotify'] = 'إشعار طلب المقرر الدراسي';
$string['courserequestnotifyemail'] = 'المستخدم {$a->user} قام بطلب مقرر دراسي عند {$a->link}';
...
$string['debugsqltrace'] = 'أظهر منابع استدعاءات SQL';
...
$string['debugsqltrace_desc'] = 'عند تمكينه، تتم إضافة جزء مقططع من متابع مكدس PHP أو كله إلى نصوص SQL بمثابة تعليق.';
...
$string['defaulthomepage'] = 'الصفحة الرئيسية للمستخدمين';
...
$string['downloadcoursecontentallowed'] = 'ميزة تنزيل محتوى المقرر الدراسي متاحة';
$string['downloadcoursecontentallowed_desc'] = 'فيما إذا كانت ميزة تنزيل محتويات المقررات الدراسية متاحة لها. عندما تكون متاحة، يمكن تمكين/تعطيل تنزيل محتويات المقرر باستعمال الإعداد "تمكين تنزيل محتوى المقرر الدراسي" ضمن قائمة تحرير المقرر (القيمة الافتراضية لهذا يمكن تحديدها في <a href={$a} target="_blank">الإعدادات الافتراضية للمقرر</a>).';
...
$string['frontpagedefaultrole'] = 'الدور الافتراضي للواجهة الأمامية';
...
$string['guestroleid_help'] = 'يتم تعيين هذا الدور تلقائياً إلى المستخدم الضيف. أيضاً يتم تعيينه مؤقتاً للمستخدمين غير المسجلين الذين يدخلون إلى المقرر الدراسي عن طريق ملحق إنضمام الضيف.';
...
$string['invalidthemepreset'] = 'الملف المحدد مسبقاً غير متوافق مع هذا المظهر. الخطأ في ترجمة SCSS كان: "{$a}"';
...
$string['iplookupinfo'] = 'إفتراضياً، مودل يستعمل مجاناً مخدم NetGeo (قاعدة البيانات الجغرافية عبر الإنترنت) للبحث في مواقع عناوين IP. للأسف، قاعدة البيانات هذه لم تعد مُدامة، وربما ترجع <em>بيانات غير صحيحة بشكل كبير.</em>.
من المستحسن تثبيت نسخة محلية لقاعدة البيانات المجانية من GeoLite City من MaxMind.<br />
موقع عنوان IP يتم عرضه على خريطة بسيطة أو باستعمال خرائط Google. يرجى ملاحظة أنك تحتاج أن يكون لديك حساب في Google مع طلب مفتاح واجهة برمجة التطبيق المجاني لخرائط Google لتمكين الخرائط التفاعلية.';
...
$string['legacyfilesaddallowed'] = 'السماح بالإضافة إلى ملفات المقرر الدراسي القديمة';
$string['legacyfilesaddallowed_help'] = 'إذا كان المقرر الدراسي محتوياً على ملفات قديمة، إسمح بإضافة الملفات والمجلدات الجديدة إليه.';
$string['legacyfilesinnewcourses'] = 'توريث ملفات المقرر الدراسي في مقررات جديدة';
$string['legacyfilesinnewcourses_help'] = 'إفتراضياً، تتواجد المناطق القديمة لملفات المقررات الدراسية فقط في المقررات الدراسية المُحدثة. يرجى ملاحظة بعض الميزات مثل الحفظ الاحتياطي للنشاط واستعادته غير متوافقة مع هذا الإعداد.';
...
$string['linkcoursesections'] = 'ضع روابط لمقاطع المقرر الدراسي دائماً';
$string['linkcoursesections_help'] = 'حاول دائماً توفير رابط لمقاطع المقرر الدراسي. عادةً ما يتم عرض مقاطع المقرر الدراسي كروابط فقط إذا كان تنسيق المقرر يتضمن عرض مقطع واحد لكل صفحة. عند تمكين هذا الإعداد، سيتم توفير الرابط دائماً.';
...
$string['maxsizeperdownloadcoursefile_desc'] = 'أقصى حجم لكل ملف عند تنزيل محتوى المقرر الدراسي. الملفات التي تتجاوز هذا الحجم سيتم التغافل عنها عند التنزيل.';
...
$string['mnetrestore_extusers_noadmin'] = '<strong>ملاحظة:</strong> يبدو أن ملف الحفظ الاحتياطي هذا يأتي من تنصيب مختلف لمودل ويحتوي على حسابات المستخدمين لشبكة مودل عن بعد. لا يسمح لك بتنفيذ هذا النوع من الاستعادة. إتصل بالمسؤول عن الموقع أو، بدلاً من ذلك، قم باستعادة هذا المقرر الدراسي بدون أي معلومات عن المستخدمين (الوحدات، الملفات...).';
...
$string['moodleapp_help'] = '<p>إن تطبيق مودل المجاني يسمح للمستخدمين بالوصول إلى مقرراتهم الدراسية عبر هواتفهم الذكية. هناك مزايا إضافية ستكون متوافرة عند الاستفادة من عرض خدمة تشغيل مودل مدفوع الثمن.</p>
...
$string['navshowmycoursecategories'] = 'أظهر تصنيفات مقرراتي الدراسية';
$string['navshowmycoursecategories_help'] = 'عند تمكينه، فالمقررات الدراسية التي تظهر للمستخدم ضمن فرع مقرراتي الدراسية ستكون مبوبة حسب التصنيفات في كتلة التنقل (للمظاهر الكلاسيكية فقط).';
$string['navsortmycourseshiddenlast'] = 'ضع المقررات الدراسية المخفية عند نهاية القائمة';
$string['navsortmycourseshiddenlast_help'] = 'في حالة التمكين، سيتم سرد أيّ مقررات دراسية مخفية بعد المرئي منها (للمستخدمين الذين يمكنهم معاينة المقررات الدراسية المخفية). وإلا، سيتم إدراج جميع المقررات الدراسية، بصرف النظر عن حالة إظهارها، وفقاً لإعداد \'ترتيب مقرراتي\'.';
$string['navsortmycoursessort'] = 'ترتيب مقرراتي الدراسية';
$string['navsortmycoursessort_help'] = 'يحدد هذا ما إذا كانت المقررات الدراسية المدرجة ضمن مقرراتي مفروزة وفقاً لترتيب الفرز (أي الترتيب المعيَّن في إدارة الموقع > المقررات الدراسية > إدارة المقررات الدراسية والتصنيفات) أو هجائياً حسب إعداد المقرر.';
$string['never'] = 'أبداً';
...
$string['registermoodlenet'] = '<p>يسعدنا البقاء على اتصال وتزويدك بأشياء مهمة لموقع مودل الخاص بك!</p><p>عن طريق التسجيل:</p><ul><li>يمكنك الاشتراك للحصول على إشعارات بالإصدارات الجديدة من مودل، تنبيهات الأمان وغيرها من الأخبار الهامة.</li><li>يمكنك الوصول إلى الإشعارات الفورية للهواتف الذكية وتفعليها لصالح موقع مودل الخاص بك عبر <a href="https://download.moodle.org/mobile/">تطبيق مودل</a> المجاني.</li><li>أنت ستساهم ضمن <a href="https://stats.moodle.org">إحصائيات مودل</a> الخاصة بمجتمع مودل في كل المعمورة، وهذا من شأنه مساعدتنا في تحسين مودل ومواقعنا المجتمعية.</li><li>إذا كانت لديك الرغبة، يمكن تضمين موقعك ضمن <a href="https://stats.moodle.org/sites/">قائمة مواقع مودل المسجلة </a> في بلدك.</li></ul>';
...
$string['restorernewroleid_help'] = 'إذا كان المستخدم لا يملك مسبقاً صلاحية إدارة المقرر الدراسي المستعاد حديثاً، يتم تعيين هذا الدور له تلقائياً وضمه إليه إن لزم الأمر. إختر "بلا" إذا كنت لا تريد جعل المستعيدين قادرين على إدارة كل مقرر مستعاد.';
...
$string['taskportfoliocron'] = 'المعالجة الخلفية لملاحق المحافظ';
...
$string['unsupportedphpversion80'] = 'الإصدار 8.0 من PHP غيرمدعوم.';
...
$string['updateavailableforplugin'] = 'تتوفر إصدارات جديدة لبعض الملاحق!';
...
$string['userfeedbackencouragement'] = '<p>في الإصدار 3.9 من مودل وما بعده، استحدثت ميزة جديدة تسمح للمستخدمين بالإدلاء بآرائهم عن برنامج مودل بواسطة موقع استبيان خارجي مستضاف لدى مؤسسة مودل. لن يتم تمرير أي بيانات شخصية إلى موقع الاستبيان.</p>
...
$string['userfiltersdefault_desc'] = 'حدد المنقحات التي ينبغي عرضها في صفحة \'تصفح قائمة المستخدمين\' وفي صفحة \'إجراءات بالجملة على المستخدمين\'. إضغط باستمرار على المفتاح Ctrl لتحديد عناصر متعددة. المنقحات غير المحددة ستتاح بمجرد النقر على الرابط \'أظهر المزيد\'.';
