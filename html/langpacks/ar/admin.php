...
$string['configallowcategorythemes'] = 'إذا مكّنت هذا، فالقوالب يمكن تعيينها على مستوى التصنيف. سيؤثر هذا على جميع التصنيفات الفرعية والمقررات الدراسية ما لم تكن قد خُصِّصَت بمظهر خاص بها.
...
$string['configallowuserthemes'] = 'لو مكّن هذا، سيسمح للمستخدمين بالقيام باختيار القوالب الخاصة بهم، مظهر المستخدم يطغى على قالب الموقع، ولكن لن يطغى على قالب المقرر .';
...
$string['configgradebookroles'] = 'هذا الإعداد يَسْمحُ لك بالسَيْطَرَة على مَنْ يظْهرُ في سجل التقديرات. ينبغي للمستخدمين أَنْ يَكُونَ عِنْدَهُمْ على الأقل أحد هذه الأدوارِ في المساق ليتم إظهارهم في سجل تقديرات ذلك المقرر.';
...
$string['configthemedesignermode'] = 'عادة كل صور القالب وأوراق الأنماط يتم تخزينها مؤقتا في المتصفحات وفي المخدم فترة طويلة جدًا، لأداء أفضل. إذا كنت تقوم بتصميم القالب أو تطوير البرمجة فربما ترغب في تمكينه لكي لا تحصل على الإصدارات المخبأة. تحذير: هذا سيجعل موقعك أبطأ لجميع المستخدمين! بدلاً من ذلك، يمكنك أيضًا إعادة تعيين الذاكرة المخبأة للقالب يدويًا من صفحة اختيار القالب.';
...
$string['coursecontact_desc'] = 'هذا الإعداد يَسْمحُ لك بالسَيْطَرَة على مَنْ يظْهرُ في وصف المساق. ينبغي للمستخدمين أَنْ يَكُونَ عِنْدَهُمْ على الأقل أحد هذه الأدوارِ في المساق ليتم إظهارهم في وصف ذلك المقرر.';
...
$string['coursepage'] = 'صفحة المقرر';
$string['courserequestnotify'] = 'إشعار طلب المقرر';
$string['courserequestnotifyemail'] = 'المستخدم {$a->user} قام بطلب مقرر عند {$a->link}';
...
$string['linkcoursesections_help'] = 'حاول دائماً توفير رابط لمقاطع المقرر. عادةً ما يتم عرض مقاطع المقرر كروابط فقط إذا كان تنسيق المقرر يتضمن عرض مقطع واحد لكل صفحة. عند تمكين هذا الإعداد، سيتم توفير الرابط دائماً.';
...
$string['navsortmycoursessort_help'] = 'هل ينبغي عرض المقررات وفقًا لترتيبها الموجود في إدارة الموقع > المقررات > إدارة المقررات والتصنيفات) أو هجائياً حسب إعداد المقرر؟ هذا الإعداد يُطبق فقط مع المظاهر المبنية على المظهر الكلاسيكي.';
$string['never'] = 'أبداً';
