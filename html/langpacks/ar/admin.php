...
$string['allowcohortthemes'] = 'السماح بمظاهر الزُمر';
...
$string['close'] = 'إغلاق';
$string['cohort_customfield'] = 'الحقول المخصصة للزُمر';
...
$string['configallowcohortthemes'] = 'إذا قمت بتمكينه، فسيكون بالإمكان تعيين المظهر على مستوى الزمرة. سيؤثر هذا على كل المستخدمين في زمرة واحدة فقط أو أكثر من واحدة ولكن مع نفس المظهر.';
$string['configallowcoursethemes'] = 'عند تمكينه، سيُسمح للمساقات باختيار المظاهر الخاصة بها. مظاهر المساقات تتجاوز كل خيارات المظاهر الأخرى (الموقع، المستخدم، التصنيف، الزمرة أو المظاهر المعرفة حسب عنوان الرابط).';
...
حسابك الذي باسم المستخدم {$a->username} في الموقع \'{$a->sitename}\'
قد تم تأمينه بعد عدة محاولات خاطئة لتسجيل الدخول.

لإلغاء تأمين الحساب فوراً، يرجى النقر على الرابط الآتي:

<a href="{$a->link}">إلغاء تأمين الحساب</a>
...
$string['marketplaceavailablenotice'] = 'استعرض الملاحق وقم بتنزيلها في <a href="{$a}" target="_blank" rel="noopener noreferrer">سوق مودل <i class="fa fa-external-link" role="img" aria-label="يُفتح بنافذة جديدة" title="يُفتح بنافذة جديدة"></i></a>.';
...
$string['moodlenetremovalwarning'] = 'سيتم إغلاق خدمة شبكة مودل في 20 نيسان 2026. إذا كنت ما تزال راغبًا باستعمال شبكة مودل في موقعك، قم بتنصيب ملحق شبكة مودل من <a href=https://github.com/moodlehq/moodle-tool_moodlenet" target="_blank">مستودع مركز مودل في GitHub<i class="fa fa-external-link" role="img" aria-label="يُفتح في نافذة جديدة" title="يُفتح في نافذة جديدة"></i></a> واربطه مع عيِّنة مستضافة محليًا من شبكة مودل. تبعًا لذلك، ستتم إزالة حقل مُعرَّف الملف الشخصي لشبكة مودل؛ يرجى ترحيل تلك البيانات إذا كنت تستعملها لأغراض أخرى.';
