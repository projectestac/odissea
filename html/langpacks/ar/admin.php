...
$string['navsortmycoursessort_help'] = 'هل ينبغي عرض المقررات وفقًا لترتيبها الموجود في إدارة الموقع > المقررات > إدارة المقررات والتصنيفات) أو هجائياً حسب إعداد المقرر؟ هذا الإعداد يُطبق فقط مع المظاهر المبنية على القالب الكلاسيكي.';
$string['never'] = 'أبداً';
...
$string['oracledatabaseinuse'] = 'نحن بصدد تغيير دعم قاعدة بيانات أوراكل في نظام إدارة التعليم مودل. الإصدار 4.5 من مودل سيكون آخر إصدار يدعم أوراكل كقاعدة بيانات. يمكن معرفة المزيد من <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank">هنا</a>';
$string['order1'] = 'الأول';
...
$string['sitenameintitle_help'] = 'هذا الإعداد سيقوم بإلحاق اسم الموقع عند نهاية عنوان الصفحة. من الموصى به القيام بذلك لأن ذلك من شأنه تحسين إمكانية الوصول عبر السماح للمستخدمين بالتعرف السريع على الصفحة التي هم عندها عليها حاليًا.';
