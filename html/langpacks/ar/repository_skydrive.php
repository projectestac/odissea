...
/**
 * Strings for component 'repository_skydrive', language 'ar', version '3.11'.
 *
...
$string['oauthinfo'] = '<p>لاستعمال هذا الملحق، عليك تسجيل موقعك <a href="https://account.live.com/developers/applications">مع مايكروسوفت</a>.</p><p>كجزء من عملية التسجيل، عليك إدخال الرابط الآتي بمثابة \'Redirect domain\':</p><p>{$a->callbackurl}</p><p>بمجرد التسجيل، سيتم تزويدك بمُعرَّف الزبون وكلمة السر واللذَين يمكن إدخالهما هنا.';
...
$string['secret'] = 'السر';
$string['skydrive:view'] = 'معاينة OneDrive (موروث)';
