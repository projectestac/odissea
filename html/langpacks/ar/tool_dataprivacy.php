...
/**
 * Strings for component 'tool_dataprivacy', language 'ar', version '3.8'.
 *
...
$string['activitiesandresources'] = 'الأنشطة و المصادر';
$string['addcategory'] = 'اضف فئة';
$string['addnewdefaults'] = 'إضافة وحدة افتراضية جديدة';
$string['addpurpose'] = 'اضف غرضاً';
...
$string['contactdataprotectionofficer_desc'] = 'في حالة التمكين ، سيتمكن المستخدمون من الاتصال بمسؤول الخصوصية و تقديم طلب بيانات عبر رابط في صفحة ملفهم الشخصي.';
...
$string['contextlevelname30'] = 'المستخدمين';
$string['contextlevelname40'] = 'فئات المواد';
$string['contextlevelname50'] = 'المقررات';
$string['contextlevelname70'] = 'وحدات النشاط';
$string['contextlevelname80'] = 'الكتل';
...
{$a->unexpired}';
$string['deletecategory'] = 'احذف الفئة';
...
$string['deletepurpose'] = 'احذف الغرض';
...
$string['noblockstoload'] = 'لا يوجد كُتل';
...
$string['notset'] = 'غير معدّ (استخدم القيمة الافتراضية)';
...
$string['requesttype_help'] = 'حدد سبب الاتصال بمسؤول الخصوصية. كن على علم بأن حذف جميع البيانات الشخصية سيؤدي إلى عدم القدرة على تسجيل الدخول إلى الموقع.';
$string['requesttypedelete'] = 'احذف جميع بياناتي الشخصية';
$string['requesttypedeleteshort'] = 'احذف';
...
$string['requesttypeothersshort'] = 'الرسالة';
...
$string['retentionperiodnotdefined'] = 'لم يتم تحديد فترة الاحتفاظ';
