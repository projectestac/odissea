...
$string['categorydefault_help'] = 'الفئة الافتراضية هي فئة البيانات المطبقة على أي عينات جديدة. في حالة تحديد وراثة، يتم تطبيق فئة البيانات من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المساقات > تصنيفات المساقات > المستخدم > الموقع.';
$string['category_help'] = 'تصف الفئة في سجل البيانات نوع البيانات. يمكن إضافة فئة جديدة، أو في حالة تحديد وراثة، يتم تطبيق فئة البيانات من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المساقات > تصنيفات المساقات > الموقع.';
...
$string['contextlevelname40'] = 'تصنيفات المساقات';
$string['contextlevelname50'] = 'المساقات';
...
$string['createcategory'] = 'أنشئ فئة بيانات';
...
$string['deprecatedexplanation'] = 'يستعمل هذا الملحق إصداراً قديماً من أحد واجهات الخصوصية وينبغي تحديثه.';
...
$string['effectiveretentionperiodcourse'] = '{$a} (بعد تاريخ انتهاء المساق)';
...
$string['exceptionnotificationbody'] = 'حدث خطأ في أثناء استدعاء <b>{$a->fullmethodname}</b>.<br>هذا يعني أن الملحق {$a->component}</b> لم يكمل معالجة البيانات. قد يتم نقل معلومات الخطأ الآتية إلى مطور الملحق:</p><pre>{$a->message}<br>

{$a->backtrace}</pre>';
$string['exceptionnotificationsubject'] = 'وقع خطأ في أثناء معالجة بيانات الخصوصية';
$string['expandplugin'] = 'توسيع وطيّ الملحق.';
$string['expandplugintype'] = 'توسيع وطيّ نوع الملحق.';
...
$string['frontpagecourse'] = 'مساق الصفحة الأمامية';
...
$string['gdpr_art_6_1_f_description'] = 'تعتبر المعالجة ضرورية لأغراض المصالح المشروعة التي يتبعها المراقب أو من قبل طرف ثالث، باستثناء الحالات التي يتم فيها تجاوز هذه المصالح بسبب المصالح أو الحقوق والحريات الأساسية لصاحب البيانات والتي تتطلب حماية البيانات الشخصية، و لا سيما عندما يكون صاحب البيانات طفلاً';
...
$string['pluginregistry'] = 'سجل خصوصية الملحق';
...
$string['purposedefault_help'] = 'الغرض الافتراضي هو الغرض الذي يتم تطبيقه على أي عينات جديدة. إذا تم اختيار وراثة، فسيتم تطبيق الغرض من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المساقات > تصنيفات المساقات > المستخدم > الموقع.';
$string['purpose_help'] = 'يصف الغرض سبب معالجة البيانات. يمكن إضافة غرض جديد، أو في حالة اختيار وراثة، يتم تطبيق الغرض من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المساقات > تصنيفات المساقات > المستخدم > الموقع.';
...
$string['requireallenddatesforuserdeletion'] = 'إعتبار المساقات التي ليس لها تاريخ انتهاء بأنها لا تزال نشطة';
...
* ما إذا كان المستخدم منضم فعلياً في أيّ مساق.

عند التحقق من الانضمام النشط في المساق، إذا لم يكن للمساق تاريخ انتهاء، فسيتم استعمال هذا الإعداد لتحديد ما إذا كان ذلك المساق نشطاً أم لا.

إذا لم يكن للمساق تاريخ انتهاء، و تم تمكين هذا الإعداد، فلن يكون بالإمكان حذف المستخدم.';
$string['requiresattention'] = 'يتطلب الاهتمام.';
$string['requiresattentionexplanation'] = 'لا يطبق هذا الملحق واجهة برمجة التطبيق للخصوصية في مودل. إذا كان هذا الملحق خازناً لأيّ بيانات شخصية، فلن يتم تصديره أو حذفه من خلال نظام الخصوصية في مودل.';
...
$string['user'] = 'مستخدم';
$string['userlistexplanation'] = 'يحتوي هذا الملحق على المزود الأساسي، و لكن يجب أيضاً تطبيق مزود قائمة المستخدمين للحصول على الدعم الكامل لوظيفة الخصوصية.';
