...
/**
 * Strings for component 'tool_dataprivacy', language 'ar', version '4.5'.
 *
...
$string['allowfiltering'] = 'السماح لترشيح التصديرات حسب المقررات';
$string['allowfiltering_desc'] = 'عند تمكينه، يمكن لمسؤول الخصوصية أن يختار تصدير بيانات المستخدم من مقررات محددة بدلاً من كل المقررات. عند تمكين هذه الميزة، ستبدأ طلبات التصدير من الوضع \'بالانتظار\' ويمكن الموافقة عليها فقط بعد إكمال المهمة التي في الخلفية.';
$string['approve'] = 'وافق';
$string['approvedrequestsubmitted'] = 'لقد تم تسليم طلبك وستتم معالجته قريباً.';
$string['approverequest'] = 'وافق على الطلب';
$string['approverequestall'] = 'الموافقة على الطلب (كل البيانات)';
$string['approveselectedcourses'] = 'الموافقة على المقررات المحددة';
...
$string['cancelrequestconfirmation'] = 'هل تريد إلغاء طلب البيانات هذا؟
';
...
$string['category_help'] = 'تصف الفئة في سجل البيانات نوع البيانات. يمكن إضافة فئة جديدة، أو في حالة تحديد وراثة، يتم تطبيق فئة البيانات من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المقررات الدراسية > تصنيفات المقررات الدراسية > الموقع.';
$string['categorycreated'] = 'تم إنشاء الفئة';
$string['categorydefault'] = 'الفئة الافتراضية';
$string['categorydefault_help'] = 'الفئة الافتراضية هي فئة البيانات المطبقة على أي عينات جديدة. في حالة تحديد وراثة، يتم تطبيق فئة البيانات من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المقررات الدراسية > تصنيفات المقررات الدراسية > المستخدم > الموقع.';
...
$string['errornoselectedcourse'] = 'ينبغي عليك تحديد مساق واحد على الأقل';
...
$string['filterexportdata'] = 'الموافقة على الطلب (البيانات من المقررات المحددة)';
$string['filteroption'] = '{$a->category}: {$a->name}';
$string['frontpagecourse'] = 'مساق واجهة الموقع';
...
$string['nocoursetofilter'] = 'المستخدم ليس منضمًا إلى أي مساق للتحديد منها';
...
$string['privacy:metadata:purpose'] = 'معلومات من أغراض البيانات المُعدة لهذا الموقع.';
$string['privacy:metadata:purpose:usermodified'] = 'مُعرَّف المستخدم الذي قام بتحديث الغرض';
...
$string['purpose_help'] = 'يصف الغرض سبب معالجة البيانات. يمكن إضافة غرض جديد، أو في حالة اختيار وراثة، يتم تطبيق الغرض من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المقررات الدراسية > تصنيفات المقررات الدراسية > المستخدم > الموقع.';
$string['purposecreated'] = 'تم إنشاء الغرض';
$string['purposedefault'] = 'الغرض الافتراضي';
$string['purposedefault_help'] = 'الغرض الافتراضي هو الغرض الذي يتم تطبيقه على أي عينات جديدة. إذا تم اختيار وراثة، فسيتم تطبيق الغرض من السياق الأعلى. السياقات هي (من الأدنى إلى الأعلى): الكتل > وحدات النشاط > المقررات الدراسية > تصنيفات المقررات الدراسية > المستخدم > الموقع.';
...
$string['requesttypeexportallowfiltering'] = 'تصدير بياناتي الشخصية';
...
إذا لم يكن للمساق تاريخ انتهاء، وتم تمكين هذا الإعداد، فلن يكون بالإمكان حذف المستخدم.';
...
$string['selectcourses'] = 'إختر المقررات المراد تصديرها';
