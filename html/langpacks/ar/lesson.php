...
/**
 * Strings for component 'lesson', language 'ar', version '3.8'.
 *
 * @package     lesson
 * @category    string
...
$string['activitylink'] = 'إرتبط بالنشاط الآتي';
$string['activitylink_help'] = 'لتوفير رابط عند انتهاء الدرس لنشاط آخر في المقرر الدراسي، إختر ذلك النشاط من القائمة المنسدلة';
...
$string['addbranchtable'] = 'أضف صفحة محتوى';
...
$string['additionalattemptsremaining'] = 'مكتمل، يمكنك إعادة محاولة هذا الدرس';
...
$string['cannotfindfirstgrade'] = 'خطأ: تعذر العثور على العلامات';
$string['cannotfindfirstpage'] = 'خطأ: تعذر العثور على الصفحة الأولى';
$string['cannotfindgrade'] = 'خطأ: تعذر العثور على العلامات';
$string['cannotfindnewestgrade'] = 'خطأ: تعذر العثور على العلامة الأحدث';
...
$string['dependencyon_help'] = 'هذا الإعداد يسمح بأن يكون الوصول إلى هذا الدرس معتمداً على أداء الطالب في درس آخر ضمن نفس المقرر الدراسي. يمكن استعمال أي تشكيلة من شروط؛ الوقت المنقضي، الإكمال، و "التقدير أفضل من".';
...
$string['displayofgrade'] = 'أعرض العلامة (للطلاب فقط)';
...
$string['edit'] = 'تحرير';
$string['editbranchtable'] = 'يجري تحرير صفحة محتوى';
...
$string['editpagecontent'] = 'تحرير محتوى الصفحة';
...
$string['emailallgradedessays'] = 'إرسال كل المقالات المصححة بالبريد الالكتروني';
$string['emailgradedessays'] = 'أرسال المقالات المصححة بالبريد الإلكتروني';
$string['emailsuccess'] = 'تم إرسال الرسائل البريدية بنجاح';
...
$string['eventlessonended'] = 'انتهى الدرس';
$string['eventlessonrestarted'] = 'أُعيد بدء الدرس';
$string['eventlessonresumed'] = 'استُؤنف الدرس';
$string['eventlessonstarted'] = 'تم بدء الدرس';
$string['eventoverridecreated'] = 'تم إنشاء تجاوز الدرس';
$string['eventoverridedeleted'] = 'تم حذف تجاوز الدرس';
$string['eventoverrideupdated'] = 'تم تحديث تجاوز الدرس';
$string['eventpagecreated'] = 'تم إنشاء الصفحة';
$string['eventpagedeleted'] = 'تم حذف الصفحة';
...
$string['invalidid'] = 'لم يتم تمرير مُعرَّف وحدة المقرر الدراسي أو مُعرَّف وحدة الدرس';
...
$string['lesson:grade'] = 'منح العلامات لأسئلة مقالة الدرس';
...
$string['lessoncloseson'] = 'الدرس يُغلق في {$a}';
...
$string['manualgrading'] = 'منح العلامات للمقالات';
...
$string['maxgrade_help'] = 'هذا الإعداد يحدد العلامة القصوى للدرس. عند ضبطه على 0، لن يظهر الدرس في صفحات العلامات.';
...
$string['maximumnumberofattempts'] = 'أقصى عدد من المحاولات';
...
$string['mediafilepopup'] = 'انقر هنا لتعاين';
...
يمكن منح علامات في الدرس مع توثيقها في سجل التقديرات.
...
$string['prerequisiteisobsolete'] = 'من المقرر إزالة خيار المتطلبات المسبقة من الدرس. لطفاً، استعمل تقييدات الوصول بدلاً منه.';
...
$string['privacy:metadata:grades'] = 'سجل لعلامات كل درس';
...
$string['xattempts'] = '{$a} محاولة/محاولات';
