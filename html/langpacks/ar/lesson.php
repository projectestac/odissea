...
$string['displayleftif_help'] = 'هذا الإعداد يحدد فيما إذا كان ينبغي على الطالب إحراز علامة معينة قبل إظهار قائمة الدرس له. هذا سيجبر الطالب على خوض الدرس بأكمله في محاولته الأولى، وبعد حصوله على الدرجة المحددة هنا سيتمكن من استعمال القائمة للمراجعة.';
...
$string['minimumnumberofquestions_help'] = 'هذا الإعداد يحدد أدنى عدد من الأسئلة التي سيتم استعمالها لحساب الدرجة لهذا النشاط.';
