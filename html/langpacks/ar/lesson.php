...
/**
 * Strings for component 'lesson', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   lesson
...
$string['dependencyon_help'] = 'هذا الإعداد يسمح بأن يكون الوصول إلى هذا الدرس معتمداً على أداء الطالب في درس آخر ضمن نفس المساق. يمكن استعمال أي تشكيلة من شروط؛ الوقت المنقضي، الإكمال، و "العلامة أفضل من".';
...
$string['editpage'] = 'تحرير محتوى الصفحة';
...
$string['eventcontentpageviewed'] = 'تمت معاينة محتوى الصفحة';
$string['eventessayassessed'] = 'تقييم المقالة';
$string['eventessayattemptviewed'] = 'تمت معاينة محاولة المقالة';
...
يمكن منح علامات في الدرس مع توثيقها في سجل العلامات.
