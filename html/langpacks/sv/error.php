...
$string['authnotexisting'] = 'Auktorisationsplugin-modulen saknas';
...
$string['cannotinsertgrade'] = 'Det går inte att foga in ett betygsobjekt utan kursID!';
...
$string['cannotunassignrolefrom'] = 'Kan inte ta bort rolltilldelningen för denna användare för roll-id: {$}';
...
$string['mssqlrcsmodemissing'] = 'Databasen använder inte det förväntade READ_COMMITTED_SNAPSHOT-läget vilket kan leda till felaktiga resultat, särskilt inte i scenarier med en stor mängd samtidiga databasanroo. Aktivera det för ett korrekt beteende. För mer information, se <a href="https://docs.moodle.org/en/Installing_MSSQL_for_PHP">Installera MSSQL för PHP</a>.';
...
<p>Om du vill fortsätta trycker du på F5 för att uppdatera den här sidan.</p>';
