...
$string['configurable_reports:myaddinstance'] = 'Lägga till ett nytt konfigurerbar rapport-block på MITT MOODLE';
...
$string['value_fields_help'] = 'Fält som ska representeras i grafen. Ctrl+klick (Cmd+klick på Mac) för att välja flera. Om du väljer fältet Etikett eller ett fält med icke-numeriska värden kommer det att ignoreras';
