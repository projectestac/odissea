...
/**
 * Strings for component 'report_security', language 'sv', version '3.8'.
 *
...
$string['check_riskxss_details'] = '<p>RISK_XSS betecknar samtliga farliga funktionsbehörigheter som endast betrodda användare får utnyttja.</p>
<p>Vänligen bekräfta att du har fullständigt förtroende för följande användare:</p><p>{$a}</p>';
