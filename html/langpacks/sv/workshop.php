...
/**
 * Strings for component 'workshop', language 'sv', branch 'MOODLE_38_STABLE'
 *
 * @package   workshop
...
$string['allowedfiletypesforoverallfeedback'] = 'Tillåtna filtyper för bilagor till återkopplingen';
