...
$string['imagickwarning'] = 'Imagemagick saknas: Be systemadministratören att installera Imagemagick-biblioteket och kontrollera sökvägen till den konvertera binära i teX-notationsfilterinställningarna. Du kan inte importera TIF-filer utan Imagemagick!';
...
$string['printstudycodefield_help'] = 'Om markerat kommer studiekoden visas på förstasidan i frågeformuläret.';
