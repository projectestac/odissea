...
/**
 * Strings for component 'checklist', language 'sv', version '4.4'.
 *
 * @package     checklist
 * @category    string
...
$string['autoupdate_help'] = 'Funktionen kommer automatiskt att markera punkten i din checklista när den relaterade aktiviteten i kursen är genomförd. När en aktivitet är "genomförd" kan variera mellan olika aktiviteter. Om "spårning av fullföljande" är aktiverad i en  i Moodle 2.x kurs, kommer detta att användas för att markera relaterade punkt i checklistan. För information om exakt vad som orsakar att ett element markeras som "genomförd", be administratören att titta i filen "mod / checklista / autoupdate.php". OBS: det kan ta upp till 60 sekunder för att en students genomförda markering syns i deras checklista.';
...
$string['autoupdatewarning_both'] = 'Det finns objekt i denna lista som kommer att uppdateras automatiskt (när studenten har slutfört relaterad aktivitet) Men eftersom detta är en  Checklista som både lärare och studenter kan markera, kommer förloppsindikatorer inte att uppdateras förrän en lärare genomför de givna markeringarna.';
$string['autoupdatewarning_student'] = 'Det finns objekt i denna lista som kommer att uppdateras automatiskt (när student har slutfört relaterad aktivitet).';
...
$string['configshowupdateablemymoodle'] = 'Om det här är markerat så visas endast uppdateringsbara Checklistor på "Mitt Moodle"';
...
$string['emailoncomplete'] = 'Skicka e-post när checklistan är komplett:';
...
$string['eventchecklistcomplete'] = 'Checklista avklarad';
...
$string['showupdateablemymoodle'] = 'Visas endast uppdateringsbara Checklistor på "Mitt Moodle"';
...
$string['yesnooverride'] = 'Ja, kan inte åsidosätta';
$string['yesoverride'] = 'Ja, kan åsidosätta';
