...
/**
 * Strings for component 'editor_tinymce', language 'sv', version '3.11'.
 *
...
$string['advanced:code_desc'] = 'Redigera källa';
...
$string['advanced:help_shortcut'] = 'Tryck Alt-F10 för verktygsrad. Tryck Alt-0 för hjälp.';
...
$string['advanced:rich_text_area'] = 'RTF-text';
...
$string['advanced_dlg:about_plugins'] = 'Om pluginmoduler';
...
$string['customtoolbar_desc'] = 'Varje rad innehåller en lista med kommaavgränsade knappnamn. Använd "radbryt" som gruppavgränsare. Tomma rader ignoreras. Se <a href="{$a}" target="_blank">{$a}</a> för listan över standard tinymce-knappar.<br />Den första raden visas alltid, medan synligheten för andra och tredje verktygsfältet kan växlas av/på.';
...
$string['media_dlg:preload'] = 'Ladda i förväg';
$string['media_dlg:preload_auto'] = 'Låt användarens webbläsare styra';
$string['media_dlg:preload_metadata'] = 'Förhandsinläs video-metadata';
...
$string['media_dlg:swstretchstyle'] = 'Utvidgnings-stil';
...
$string['privacy:metadata'] = 'Pluginmodulen TinyMCE HTML lagrar ingen personlig information.';
...
$string['settings'] = 'Generella inställningar';
...
$string['table_dlg:missing_scope'] = 'Är du säker på att du vill fortsätta utan att ange en omfattning, denna underlättar för icke-grafiska webbläsare.';
...
$string['xhtmlxtras_dlg:title_del_element'] = 'Borttagning';
