...
/**
 * Strings for component 'offlinequiz_statistics', language 'sv', version '3.11'.
 *
...
$string['erroritemappearsmorethanoncewithdifferentweight'] = 'Fråga ({$a}) visas mer än en gång med olika vikter på olika platser i kunskapstestet. Detta stöds för närvarande inte av statistikrapporten och kan göra statistiken för denna fråga otillförlitlig.';
