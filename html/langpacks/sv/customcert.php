...
$string['aligncenter'] = 'Centrerad';
$string['alignment'] = 'Anpassning';
...
$string['createtemplate'] = 'Skapa mall';
...
$string['deliveryoptions'] = 'Leveransflaggor';
...
$string['load'] = 'Ladda';
$string['loadtemplate'] = 'Läs in mall';
...
$string['name'] = 'Namn';
$string['noimage'] = 'Ingen bild';
$string['notemplates'] = 'Inga mallar';
$string['notverified'] = 'Inte verifierad';
$string['numbersuffix_nd_as_in_second'] = ':a';
$string['numbersuffix_rd_as_in_third'] = ':e';
$string['numbersuffix_st_as_in_first'] = ':a';
$string['options'] = 'Urval';
$string['posx'] = 'Position X';
$string['posy'] = 'Position Y';
$string['print'] = 'Skriv';
$string['replacetemplate'] = 'Ersatt';
$string['rightmargin'] = 'Höger marginal';
$string['save'] = 'Spara';
$string['saveandcontinue'] = 'Spara och fortsätt';
$string['savetemplate'] = 'Spara mall';
$string['subplugintype_customcertelement'] = 'Element';
$string['subplugintype_customcertelement_plural'] = 'Element';
$string['templatename'] = 'Mallens namn';
$string['topcenter'] = 'Center';
$string['topleft'] = 'Uppe till vänster';
$string['topright'] = 'Uppe till höger';
$string['type'] = 'Typ';
$string['uploadimage'] = 'Ladda upp bild';
$string['verified'] = 'Verifierad';
$string['verify'] = 'Verifiera';
$string['width'] = 'Bredd';
