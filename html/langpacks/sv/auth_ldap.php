...
/**
 * Strings for component 'auth_ldap', language 'sv', version '4.5'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_expiration_warning_desc'] = 'Antal dagar innan det skickas ut en varning om att lösenordet snart förfaller.';
