...
$string['auth_ldap_memberattribute'] = 'Valfritt: Åsidosätter medlems-attributet när användaren tillhör en grupp. Vanligtvis \'member\'';
...
$string['privacy:metadata'] = 'Plugin-modulen för LDAP-server lagrar ingen användarinformation';
