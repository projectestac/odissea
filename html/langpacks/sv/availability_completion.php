...
/**
 * Strings for component 'availability_completion', language 'sv', version '3.11'.
 *
...
$string['cachedef_previous_cache'] = 'Föregående aktivitets beroende';
...
$string['option_incomplete'] = 'får inte vara slutförd';
$string['option_pass'] = 'måste vara slutförd och godkänd';
$string['option_previous'] = 'Föregående aktivitet med slutförande';
$string['pluginname'] = 'Begränsning via aktivitetsslutförande';
$string['privacy:metadata'] = 'Pluginmodulen Begränsning via aktivitetsslutförande lagrar ingen personinformation.';
...
$string['requires_previous_complete'] = '<strong>Föregående aktivitet med slutförande</strong> är slutförd';
$string['requires_previous_complete_fail'] = '<strong>Föregående aktivitet med slutförande</strong> är slutförd men underkänd';
$string['requires_previous_complete_pass'] = '<strong>Föregående aktivitet med slutförande</strong> är slutförd och godkänd';
$string['requires_previous_incomplete'] = '<strong>Föregående aktivitet med slutförande</strong> är ofullständig';
$string['requires_previous_not_complete_fail'] = '<strong>Föregående aktivitet med slutförande</strong> är ej slutförd och underkänd';
$string['requires_previous_not_complete_pass'] = '<strong>Föregående aktivitet med slutförande</strong> är ej slutförd och ej godkänd';
