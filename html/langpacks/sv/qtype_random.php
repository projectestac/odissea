...
/**
 * Strings for component 'qtype_random', language 'sv', version '3.11'.
 *
...
$string['privacy:metadata'] = 'Pluginmodulen Slumpmässig fråga frågetyp lagrar ingen personinformation.';
$string['randomqname'] = 'Slumpmässig ({$a})';
$string['randomqnamefromtop'] = 'Fallerande slumpmässig fråga! Vänligen ta bort den här frågan.';
...
$string['randomqplusnamecourse'] = 'Slumpmässig (Valfri kategori i denna kurs)';
$string['randomqplusnamecoursecat'] = 'Slumpmässig (Valfri kategori i kurskategori {$a})';
...
$string['randomqplusnamemodule'] = 'Slumpmässig (Valfri kategori i detta test)';
$string['randomqplusnamemoduletags'] = 'Slumpmässig (Valfri kategori i detta test, etiketter: {$a->tags})';
$string['randomqplusnamesystem'] = 'Slumpmässig (Valfri kategori på systemnivå)';
