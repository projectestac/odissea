...
$string['remoterequestpluginfoexception'] = 'Oj... Ett fel uppstod när du försökte få fram information om pluginversionen {$a->name} ({$a->component}) {$a->version}. Det går inte att installera pluginmodulen. Aktivera felsökningsläget för att se detaljer om felet.';
