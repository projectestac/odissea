...
/**
 * Strings for component 'auth_shibboleth', language 'sv', version '4.5'.
 *
...
$string['auth_shib_instructions'] = 'Använd <a href="{$a}">Shibboleth-inloggning</a> för att få åtkomst via Shibboleth, förutsatt att din institution stödjer det. Använd annars inloggningsformuläret nedan.';
...
$string['shib_not_set_up_error'] = 'Autentisering via Shibboleth verkar inte att fungera korrekt. konsultera <a href="README.txt">README</a> för vidare instruktioner om hur man sätter upp autentisering via Shibboleth.';
