...
/**
 * Strings for component 'pagetype', language 'sv', version '4.5'.
 *
 * @package     pagetype
 * @category    string
...
$string['page-mod-x-view'] = 'Valfri startsida i aktivitetsmodul';
$string['page-my-index'] = 'Översiktssida';
$string['page-report-x'] = 'Valfri rapportsida';
$string['page-site-index'] = 'Endast startsidan';
