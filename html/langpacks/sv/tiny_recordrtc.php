...
/**
 * Strings for component 'tiny_recordrtc', language 'sv', version '4.5'.
 *
...
$string['audiobuttontitle'] = 'Spela in ljud';
...
$string['audiotitle'] = 'Spela in ljud';
...
$string['maxfilesizehit'] = 'Du har uppnått maxgränsen för uppladdning av filer';
$string['maxfilesizehit_title'] = 'Inspelningen har stoppats';
$string['norecordingfound'] = 'Någor har gått fel, det verkar inte ha spelats in något';
$string['norecordingfound_title'] = 'Ingen inspelning hittad';
$string['nowebrtc'] = 'Din webbläsare har inget eller bara begränsat stöd för WebRTC-teknik och fungerar inte med detta plugin. V.g. byt eller uppgradera din webbläsare.';
$string['nowebrtc_title'] = 'Det finns inget stöd för WebRTC';
$string['onlyaudio'] = 'Enbart ljud';
$string['onlyscreen'] = 'Raster';
$string['onlyvideo'] = 'Enbart video';
$string['pause'] = 'Gör paus';
...
$string['resume'] = 'CV';
$string['screenbuttontitle'] = 'Spela in skärm';
$string['screentitle'] = 'Spela in skärm';
...
$string['videobuttontitle'] = 'Spara video';
