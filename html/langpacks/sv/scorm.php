...
$string['displayattemptstatus_help'] = 'Med den här inställningen kan en sammanfattning av användarnas försök att visa i kursöversiktsblocket i Mitt Moodle och/eller SCORM-startsidan.';
$string['displayattemptstatusdesc'] = 'Om en sammanfattning av användarens försök visas i kursöversiktsblocket på Mitt Moodle och/eller SCORM-startsidan.';
...
$string['eventuserreportviewed'] = 'Användarens rapport visad';
