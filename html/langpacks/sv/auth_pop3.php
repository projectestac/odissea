...
/**
 * Strings for component 'auth_pop3', language 'sv', version '3.11'.
 *
 * @package     auth_pop3
 * @category    string
...
$string['auth_pop3notinstalled'] = 'Det går inte att använda autentisering för POP3. PHP-modulen är inte installerad.';
