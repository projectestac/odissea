...
/**
 * Strings for component 'folder', language 'sv', version '4.4'.
 *
 * @package     folder
 * @category    string
...
$string['page-mod-folder-view'] = 'Huvudsida för mappmodul';
$string['page-mod-folder-x'] = 'Modulsida för alla mappar';
