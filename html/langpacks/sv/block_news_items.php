...
/**
 * Strings for component 'block_news_items', language 'sv', version '4.5'.
 *
...
$string['news_items:myaddinstance'] = 'Lägg till ett nytt block för senaste nyheter till översiktssidan';
