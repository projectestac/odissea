...
$string['incompatibleversion'] = 'Inkompatibel Moodle-version: {$a}';
...
$string['validationmsg_maturity'] = 'Ange mognadsnivå';
$string['validationmsg_maturity_help'] = 'Pluginmodulen kan deklarera sin mognadsnivå. Om utvecklaren anser att pluginmodulen är stabil kommer den deklarerade mognadsnivån att vara MATURITY_STABLE. Alla andra mognadsnivåer (t.ex. alfa eller beta) bör betraktas som instabila och en varning höjas.';
...
$string['validationmsg_pluginversion'] = 'Pluginmodulens version';
