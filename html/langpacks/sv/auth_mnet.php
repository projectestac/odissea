...
/**
 * Strings for component 'auth_mnet', language 'sv', version '3.11'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:emailstop'] = 'En inställning för att stoppa e-post från att skickas till användaren.';
...
$string['privacy:metadata:mnet_external:lang'] = 'En användarinställning för språket som visas.';
...
$string['privacy:metadata:mnet_external:lastnamephonetic'] = 'Den fonetiska informationen om användarens förnamn.';
...
$string['privacy:metadata:mnet_log:course'] = 'Fjärrsystemkurs-ID där åtgärden inträffade.';
$string['privacy:metadata:mnet_log:coursename'] = 'Fullständigt namn på fjärrsystemkursen där åtgärden inträffade.';
$string['privacy:metadata:mnet_log:hostid'] = 'Fjärrsystem MNet ID.';
$string['privacy:metadata:mnet_log:info'] = 'Ytterligare information om åtgärden.';
$string['privacy:metadata:mnet_log:ip'] = 'IP-adressen som användes vid tidpunkten då åtgärden inträffade.';
$string['privacy:metadata:mnet_log:module'] = 'Fjärrsystemmodul där åtgärden inträffade.';
$string['privacy:metadata:mnet_log:remoteid'] = 'Fjärr-ID för den användare som utförde åtgärden i fjärrsystemet.';
$string['privacy:metadata:mnet_log:time'] = 'Tidpunkt då åtgärden inträffade.';
$string['privacy:metadata:mnet_log:url'] = 'URL för fjärrsystem där åtgärden inträffade.';
$string['privacy:metadata:mnet_log:userid'] = 'Lokalt ID för den användare som utförde åtgärden i fjärrsystemet.';
$string['privacy:metadata:mnet_session'] = 'Information om varje MNet-användarsession i ett fjärrsystem. Data lagras tillfälligt.';
$string['privacy:metadata:mnet_session:expires'] = 'Tidpunkt då sessionen förfaller.';
$string['privacy:metadata:mnet_session:mnethostid'] = 'Fjärrsystem MNet ID.';
$string['privacy:metadata:mnet_session:token'] = 'Unik sessionsidentifierare';
$string['privacy:metadata:mnet_session:useragent'] = 'Användaragent som används för att komma åt fjärrsystemet';
$string['privacy:metadata:mnet_session:userid'] = 'ID för användaren som hoppar till fjärrsystemet.';
...
$string['sso_mnet_login_refused'] = 'Användare {$a->user} har inte behörighet att logga in från {$a->host}.';
