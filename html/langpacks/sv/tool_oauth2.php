...
/**
 * Strings for component 'tool_oauth2', language 'sv', version '4.5'.
 *
 * @package     tool_oauth2
 * @category    string
...
$string['acceptrisk_help'] = 'Om du inaktiverar e-postverifiering kan en användare potentiellt autentisera sig som en annan användare.';
