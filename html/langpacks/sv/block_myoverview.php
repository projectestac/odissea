...
/**
 * Strings for component 'block_myoverview', language 'sv', version '4.5'.
 *
...
$string['all'] = 'Alla';
$string['allincludinghidden'] = 'Alla (inkl. borttagna i kursöversikt)';
$string['aria:addtofavourites'] = 'Favoritmärk för';
$string['aria:allcourses'] = 'Visa alla kurser förutom borttagna i kursöversikt';
...
$string['aria:courseactions'] = 'Åtgärder för aktuell kurs';
$string['aria:courseprogress'] = 'Kursförlopp:';
$string['aria:coursesummary'] = 'Text för kurssammanfattning:';
$string['aria:customfield'] = 'Visa {$a} kurser';
$string['aria:displaydropdown'] = 'Visa nedrullningsmeny';
...
$string['aria:hiddencourses'] = 'Visa borttagna kurser i kursöversikt';
...
$string['customfiltergrouping'] = 'Fält att använda';
...
$string['hidden'] = 'Borttagna kurser i kursöversikt';
$string['hiddencourses'] = 'Borttagen i kursöversikt';
$string['hidecourse'] = 'Ta bort i kursöversikt';
...
$string['privacy:metadata:overviewgroupingpreference'] = 'Grupperingsinställningar för blocket kursöversikt.';
$string['privacy:metadata:overviewpagingpreference'] = 'Sidvisningsinställningar för blocket kursöversikt.';
$string['privacy:metadata:overviewsortpreference'] = 'Inställning för hur blocket Kursöversikt ska sorteras';
