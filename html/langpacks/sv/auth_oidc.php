...
$string['erroroidcclientnoauthendpoint'] = 'Ingen auktorisationsslutpunkt inställd. Ställ in med $this->setendpoints';
$string['erroroidcclientnocreds'] = 'Ställ in inloggningsuppgifter för klienten med setcreds';
$string['erroroidcclientnotokenendpoint'] = 'Ingen tokenslutpunkt har ställts in. Ställ in med $this->setendpoints';
