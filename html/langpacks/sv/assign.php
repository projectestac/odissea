...
$string['activityattachments'] = 'Bilagor till Uppgiftsaktivitet';
...
$string['activityeditor'] = 'Instruktioner för aktivitet';
$string['activityeditor_help'] = 'De åtgärder du vill att studenten ska slutföra för denna inlämning. Dessa visas enbart på inlämningssidan där eleven redigerar och skickar in sin uppgift.';
...
$string['assigntimeleft'] = 'Återstående tid';
...
$string['batchoperationaddattempt'] = 'Ytterligare försök';
...
$string['batchoperationdownloadselected'] = 'Ladda ned';
$string['batchoperationgrantextension'] = 'Förlänga';
$string['batchoperationlock'] = 'Lås inlämningar';
$string['batchoperationremovesubmission'] = 'Ta bort';
$string['batchoperationreverttodraft'] = 'Återställ inlämningar till utkast';
$string['batchoperationsdescription'] = 'Med valda...';
$string['batchoperationsetmarkingallocation'] = 'Tilldela rättare';
...
$string['beginassignment'] = 'Påbörja uppgift';
...
$string['caneditsubmission'] = 'Du kan lämna in/ändra inlämningsuppgiften efter att tidsgränsen passerats, men den kommer att markeras som sen.';
...
$string['completionsubmit'] = 'Eleven måste lämna in';
...
$string['confirmstart'] = 'Du har {$a} för att slutföra den här uppgiften. När du börjar startar timern och den kan inte pausas.';
...
$string['deleteallsubmissions'] = 'Alla inlämningar';
...
$string['enabletimelimit'] = 'Aktivera uppgifter med tidtagning';
$string['enabletimelimit_help'] = 'Om aktiverat kan du ange en tidsgräns på inställningssidan för uppgifter';
...
$string['eventsubmissionremoved'] = 'Inlämning borttagen.';
...
$string['extensionduedatecurrent'] = 'Nuvarande förlängda förfallodatum';
...
$string['gradebreakdown'] = 'Betygsdetaljer';
...
$string['introattachments_help'] = 'Ytterligare filer som ska användas i uppgiften, som till exempel svarsmallar, kan läggas till.';
...
$string['nogroupoverrides'] = 'Inga grupper har åsidosatts';
...
$string['nosubmissionyet'] = 'Inga inlämningar har gjorts ännu';
...
$string['nouseroverrides'] = 'Inga användare har åsidosatts';
...
$string['numberofsubmissionsneedgradinglabel'] = 'Behöver betygsättas: {$a}';
$string['numberofsubmittedassignments'] = 'Inlämnad';
$string['numberofteams'] = 'Grupper';
$string['offline'] = 'Inga onlineinlämningar krävs';
$string['open'] = 'Öppen';
$string['opensubmissionexists'] = 'En öppen inlämningsuppgift finns redan.';
...
$string['privacy:metadata:timestarted'] = 'Startade';
...
$string['removesubmissionconfirm'] = 'Är du säker på att du vill ta bort inlämningen?';
$string['removesubmissionconfirmforstudent'] = 'Är du säker på att du vill ta bort inlämningen för {$a}?';
$string['removesubmissionconfirmforstudentwithtimelimit'] = 'Vill du ta bort inlämningen för {$a}? Observera att detta inte återställer studentens tidsgräns. Du kan lägga till mer tid genom att åsidosätta tidsgränsen för användaren.';
$string['removesubmissionconfirmwithtimelimit'] = 'Är du säker på att du vill ta bort din inlämning? OBS! Detta återställer inte tidsbegränsningen.';
...
$string['reverttodraftforgroup'] = 'Återställ inlämning till utkast för {$a}-gruppen.';
...
$string['sendstudentnotifications_help'] = 'Markera den här rutan om du vill skicka ett meddelande om det uppdaterade betyget eller återkopplingen. Om uppgiften använder ett bedömningsflöde, eller om betygen är dolda i bedömarrapporten, skickas inte meddelandet förrän betyget har publicerats.';
...
$string['submissionattachments'] = 'Visa enbart filer under inlämningen';
$string['submissionattachments_help'] = 'Om aktiverat visas filer enbart på inlämningssidan. Om inaktiverat visas de även på visningssidan för inlämningsuppgiften.';
...
$string['submissionnotopen'] = 'Denna inlämningsuppgift är inte öppen för inlämningar.';
...
$string['submittedovertime'] = 'Uppgiften lämnades in {$a} efter att tiden löpte ut';
$string['submittedundertime'] = 'Uppgiften lämnades in {$a} innan tiden löpte ut';
...
$string['timelimit_help'] = 'Om aktiverat visas tidsgränsen på sidan för inlämningsuppgiften. Dessutom visas en nedräkningstimer under genomförandet av uppgiften.';
$string['timelimitnotenabled'] = 'Tidsbegränsning är inte aktiverad för denna inlämningsuppgift.';
$string['timelimitpassed'] = 'Tidsgränsen har passerats';
