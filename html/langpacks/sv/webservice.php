...
/**
 * Strings for component 'webservice', language 'sv', version '3.8'.
 *
 * @package     webservice
 * @category    string
...
$string['erroroptionalparamarray'] = 'Parametern för webbtjänstbeskrivningen med namnet \'{$a}\' är en enkel parameter eller en matrisparameter. Den kan inte ställas in som <code>VALUE_OPTIONAL</code>. Kontrollera beskrivningen av webbtjänsten.';
...
$string['missingcaps_help'] = 'Lista med för tjänsten nödvändiga funktionsbehörigheter som den valda användaren för närvarande inte har. De saknade funktionsbehörigheterna måste läggas till i användarens roll för att tjänsten ska gå att använda.';
...
$string['onesystemcontrolling'] = 'Tillåt ett externt system att styra Moodle.';
...
$string['onlyseecreatedtokens'] = 'Alla token kan tas bort, men du kan bara visa token som du skapat.';
...
$string['requiredcapability_help'] = 'Om aktiverad kan endast användare med den funktionsbehörighet som krävs för att nå tjänsten.';
...
$string['restrictedusers_help'] = 'Den här inställningen avgör om alla användare med behörigheten att skapa token för webbtjänster kan generera ett token för den här tjänsten via sidan för säkerhetsnycklar, eller om endast behöriga användare kan göra det.';
...
$string['userasclientsdescription'] = 'Följande steg hjälper dig att konfigurera Moodle-webbtjänsten för användare i egenskap av klienter. De här stegen hjälper också till att konfigurera den rekommenderade token (säkerhetsnycklar)-autentiseringsmetoden. I det här användningsfallet genererar användaren sitt token från sidan säkerhetsnycklar på sin inställningssida.';
...
$string['wsdocumentationintro'] = 'Innan du skapar en klient är det rekommenderat att du först läser igenom {$a->doclink}.';
$string['wsdocumentationlogin'] = 'eller ange webbtjänst-användarnamn och -lösenord:';
