...
/**
 * Strings for component 'enrol_mnet', language 'sv', version '4.4'.
 *
 * @package     enrol_mnet
 * @category    string
...
$string['privacy:metadata'] = 'Pluginmodulen MNet-fjärregistrering lagrar ingen personinformation.';
