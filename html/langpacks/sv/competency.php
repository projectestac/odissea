...
$string['errorplanstatus'] = 'Studieplansstatus \'{$a}\' är okänd';
...
$string['errorusercomptencystatus'] = 'Kompetenstatus \'{$a}\' för användare är okänd.';
...
$string['evidence_manualoverride'] = 'Kompetensbedömningen sattes manuellt.';
$string['evidence_manualoverrideincourse'] = 'Kompetensbedömningen sattes manuellt i kursen \'{$a}\'.';
$string['evidence_manualoverrideinplan'] = 'Kompetensbedömningen sattes manuellt i studeplanen \'{$a}\'.';
$string['invalidevidencedesc'] = 'Felaktig beskrivning av bevis';
$string['invalidgrade'] = 'Ogiltig bedömning';
...
$string['privacy:metadata:competency'] = 'En notering av kompetenserna';
$string['privacy:metadata:competency_coursecomp'] = 'En notering av kompetenserna länkade till en kurs';
$string['privacy:metadata:competency_coursecompsetting'] = 'En notering av kompetensinställningarna i en kurs';
$string['privacy:metadata:competency_evidence'] = 'En notering av beviset som påverkar ett kompetenstillstånd';
$string['privacy:metadata:competency_framework'] = 'En notering av kompetensramverken';
$string['privacy:metadata:competency_modulecomp'] = 'En notering av kompetenserna som är länkade till en modul';
$string['privacy:metadata:competency_plan'] = 'En notering av studieplanerna';
$string['privacy:metadata:competency_plancomp'] = 'En notering av kompetenserna i en studieplan';
$string['privacy:metadata:competency_relatedcomp'] = 'En notering av relationer mellan kompetenser';
$string['privacy:metadata:competency_template'] = 'En notering av studieplansmallarna';
$string['privacy:metadata:competency_templatecohort'] = 'En notering av kohorter associerade med en studieplansmall';
$string['privacy:metadata:competency_templatecomp'] = 'En notering av kompetenserna i en studieplansmall';
$string['privacy:metadata:competency_usercomp'] = 'En notering av en användares tillstånd beträffande kompetenser';
$string['privacy:metadata:competency_usercompcourse'] = 'En notering av en användares tillstånd beträffande kompetenser i en kurs';
$string['privacy:metadata:competency_usercompplan'] = 'En notering av tillståndet för kompetenser i en studieplan';
$string['privacy:metadata:competency_userevidence'] = 'En notering av bevis för tidigare lärande';
$string['privacy:metadata:competency_userevidencecomp'] = 'En notering av kompetenser associerade med bevis för tidigare lärande';
...
$string['privacy:metadata:evidence:url'] = 'En webbadress associerad med beviset';
...
$string['privacy:metadata:userevidence:url'] = 'Webbadress associerad med beviset';
