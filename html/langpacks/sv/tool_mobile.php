...
$string['notificationsmissingwarning'] = 'Det gick inte att hämta statistik för notifieringar skickade till Moodle-appen. Det beror troligtvis på att mobila aviseringar ännu inte är aktiverade på webbplatsen. Du kan aktivera dem under <em>Hantera webbplats &#10132; Meddelanden &#10132; Mobil</em>.';
...
$string['subscriptionfeaturenotapplied'] = 'Den här funktionen är konfigurerad på din webbplats men den ingår inte i din Moodle-appplan. Inställningen kommer alltså inte att ha någon effekt.';
$string['subscriptionfeatures'] = 'Ingående funktioner i prenumerationen';
$string['subscriptionlimitsurpassed'] = 'Gränsen för prenumerationen har överskridits';
$string['subscriptionregister'] = 'För information om de olika applanerna och för att få tillgång till Moodle-statistik för appanvändning, gå till <a href="{$a}" target="_blank">Moodle Apps Portal</a>.';
