...
/**
 * Strings for component 'auth', language 'sv', version '4.4'.
 *
 * @package     auth
 * @category    string
...
$string['errorminpasswordnonalphanum'] = 'Lösenord måste innehålla minst {$a} specialtecken, som t.ex. *, - eller #.';
...
$string['informminpasswordnonalphanum'] = 'minst {$a} specialtecken, som t.ex. *, - eller #.';
