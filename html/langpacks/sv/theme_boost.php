...
$string['backgroundimage'] = 'Bakgrundsbild';
$string['backgroundimage_desc'] = 'Bilden som ska visas som en bakgrund på webbplatsen. Bakgrundsbilden du laddar upp här åsidosätter bakgrundsbilden i dina temaförinställningsfiler.';
$string['bootswatch'] = 'Bootswatch';
$string['bootswatch_desc'] = 'En bootswatch är en uppsättning Bootstrap variabler och css för att styla Bootstrap';
$string['brandcolor'] = 'Varumärkesfärg';
