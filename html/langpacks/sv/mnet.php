...
/**
 * Strings for component 'mnet', language 'sv', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['couldnotmatchcert'] = 'Det här matchar inte det certifikat som är publicerat av webbservern.';
...
$string['moodle_home_help'] = 'Sökvägen till startsida för MNet-applikationen hos fjärrvärden, t.ex. /moodle/.';
$string['name'] = 'Namn';
...
$string['privacy:metadata'] = 'Pluginmodulen MNet lagrar ingen personinformation.';
