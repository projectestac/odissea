...
/**
 * Strings for component 'filters', language 'sv', version '3.11'.
 *
 * @package     filters
 * @category    string
...
$string['filterallwarning'] = 'Att sätta <em>"Tillämpa på"</em> till värdet <em>"Innehåll och rubriker"</em> för ett filter kan medföra en avsevärd ökning av belastningen på servern. Använd därför denna inställning sparsamt. Det huvudsakliga användningsområdet för denna inställning är tillsammans med filtret <em>"Flerspråkigt innehåll"</em>.';
...
$string['isafter'] = 'är efter';
$string['isanyvalue'] = 'är vilket värde som helst';
$string['isbefore'] = 'är före';
...
$string['off'] = 'Av';
$string['offbutavailable'] = 'Av, men tillgängligt';
$string['on'] = 'På';
$string['privacy:reason'] = 'Filterundersystemet lagrar ingen personinformation.';
...
$string['replacefilters'] = 'Ersätt filter';
