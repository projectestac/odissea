...
/**
 * Strings for component 'label', language 'sv', version '4.5'.
 *
 * @package     label
 * @category    string
...
$string['configdndmedia'] = 'Ge etikettförslag när mediafiler dras och släpps på en kurs';
$string['configdndresizeheight'] = 'När en etikett skapas från en släppt bild; ändra storlek på den om den är högre än så här många pixlar (0 för ingen storleksändring)';
$string['configdndresizewidth'] = 'När en etikett skapas från en släppt bild; ändra storlek på den om den är bredare än så här många pixlar (0 för ingen storleksändring)';
$string['dndmedia'] = 'Drag och släpp media';
$string['dndresizeheight'] = 'Maxhöjd';
$string['dndresizewidth'] = 'Maxbredd';
$string['dnduploadlabel'] = 'Lägg till media till kurssida';
$string['dnduploadlabeltext'] = 'Lägg till etikett till kurssida';
$string['indicator:cognitivedepth'] = 'Etikett kognitiv';
