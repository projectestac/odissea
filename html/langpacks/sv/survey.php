...
/**
 * Strings for component 'survey', language 'sv', version '4.5'.
 *
 * @package     survey
 * @category    string
...
$string['attls10'] = 'Det är viktigt för mig att förhålla mig så objektiv som möjligt när jag analyserar något.';
...
$string['attls5'] = 'Jag känner att det bästa sättet för mig att skaffa mig en egen identitet är att interagera med olika sorters människor.';
$string['attls5short'] = 'interagerar med variation';
$string['attls6'] = 'Jag gillar att höra andra åsikter från personer som har andra bakgrunder än min - det hjälper mig att förstå hur man kan uppfatta samma sak på olika sätt.';
...
$string['attlsname'] = 'Attityder kring tänkande och lärande (ATTLS) (20-punktersversion)';
...
$string['responsereports'] = 'Svarsrapport';
