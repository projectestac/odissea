...
/**
 * Strings for component 'qtype_multichoice', language 'sv', version '4.4'.
 *
...
$string['privacy:preference:answernumbering'] = 'Vilken numreringsstil som ska användas (1., 2., 3., .../a., b., c., ... osv.)';
...
$string['showstandardinstruction_help'] = 'Om instruktionen ”Välj ett av alternativen:” eller ”Välj ett eller flera alternativ:” ska visas före svarsalternativen.';
