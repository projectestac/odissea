...
/**
 * Strings for component 'wiki', language 'sv', version '4.5'.
 *
 * @package     wiki
 * @category    string
...
$string['cannotcomparenewerversion'] = 'En sidversion kan bara jämföras med en äldre version.';
$string['cannoteditpage'] = 'Du kan inte redigera den här sidan.';
...
$string['cannotviewpage'] = 'Du kan inte visa den här sidan.';
...
$string['deleteallpages'] = 'Ta bort alla Wiki-sidor';
...
$string['editsection'] = 'Redigera';
$string['eventdiffviewed'] = 'Wiki-versionsjämförelse visad';
$string['eventhistoryviewed'] = 'Wiki-historik visad';
$string['eventmapviewed'] = 'Wiki-sidkarta visad';
$string['eventpagecreated'] = 'Wiki-sida skapad';
$string['eventpagedeleted'] = 'Wiki-sida borttagen';
$string['eventpagelocksdeleted'] = 'Wiki-sidlåsningar borttagna';
$string['eventpageupdated'] = 'Wiki-sida uppdaterad';
$string['eventpageversiondeleted'] = 'Wiki-sidversion borttagen';
$string['eventpageviewed'] = 'Wiki-sida visad';
$string['eventversionrestored'] = 'Wiki-version återställd';
$string['eventversionviewed'] = 'Wiki-sidversion visad';
$string['filenotuploadederror'] = 'Det gick inte att ladda upp filen  \'{$a}\' på ett korrekt sätt. ';
$string['files'] = 'Filer';
$string['filtername'] = 'Wiki auto-länkning';
$string['firstpagetitle'] = 'Namn på första sidan';
$string['firstpagetitle_help'] = 'Titel på första sidan i wikin. När Wikin skapats går det inte längre byta namn.';
...
$string['incorrectpageid'] = 'Ogiltigt ID för sidan.';
$string['incorrectsubwikiid'] = 'ID för underwiki är felaktigt.';
$string['incorrectwikiid'] = 'ID för Wiki är felaktigt.';
...
$string['invalidsesskey'] = 'Din session har troligtvis förfallit. Anteckna dina ändringar och logga in igen.';
$string['javascriptdisabledlocks'] = 'Javascript är inaktiverat i din webbläsare och lås fungerar inte. Ändringarna du gör kanske inte sparas korrekt.';
$string['links'] = 'Länkar';
$string['listall'] = 'Lista allt';
$string['listorphan'] = 'Lista föräldralös';
$string['lockingajaxtimeout'] = 'Redigera uppdateringsintervall för sidlåsning';
...
Wikis har många användningsområden, till exempel

* För gruppföreläsningsanteckningar eller studieguider
* För deltagare att planera ett arbetsschema eller en mötesagenda tillsammans
...
$string['noteditblocks'] = 'Avsluta redigering';
...
$string['pageexists'] = 'Den här sidan finns redan.';
$string['pageindex'] = 'Sidindex';
...
$string['pagename'] = 'Sidnamn';
$string['peerreview'] = 'Kollegial granskning';
...
$string['privacy:metadata:core_comment'] = 'Kommentarer för wikisida';
$string['privacy:metadata:core_files'] = 'Filbilagor för underwikis';
$string['privacy:metadata:core_tag'] = 'Etiketter associerade med wikisidor';
$string['privacy:metadata:wiki_locks'] = 'Tillfällig lagringsyta för sidlås vid redigering av wikisidor';
$string['privacy:metadata:wiki_locks:lockedat'] = 'Låsningsdatum';
$string['privacy:metadata:wiki_locks:sectionname'] = 'Namn på låst wikiavsnitt';
$string['privacy:metadata:wiki_locks:userid'] = 'Användare som låste en sida';
$string['privacy:metadata:wiki_pages'] = 'Information om wiki-sidor';
$string['privacy:metadata:wiki_pages:cachedcontent'] = 'Cachelagrat innehåll i HTML-format';
$string['privacy:metadata:wiki_pages:pageviews'] = 'Antal sidvisningar';
$string['privacy:metadata:wiki_pages:readonly'] = 'Om en sida endast har läsbehörighet';
$string['privacy:metadata:wiki_pages:timecreated'] = 'Tid då sidan ursprungligen skapades';
$string['privacy:metadata:wiki_pages:timemodified'] = 'Tid då sidan senast redigerades';
$string['privacy:metadata:wiki_pages:timerendered'] = 'Tid då sidan senast genererades';
$string['privacy:metadata:wiki_pages:title'] = 'Sidnamn';
$string['privacy:metadata:wiki_pages:userid'] = 'Användare som senast redigerade sidan';
$string['privacy:metadata:wiki_subwikis'] = 'Information om underwikis (vid grupp- eller individuellt läge)';
$string['privacy:metadata:wiki_subwikis:groupid'] = 'Grupp som äger en underwiki';
$string['privacy:metadata:wiki_subwikis:userid'] = 'Användare som äger en underwiki (för individuella wikis)';
$string['privacy:metadata:wiki_versions'] = 'Information om sidhistoriken för en Wiki';
$string['privacy:metadata:wiki_versions:content'] = 'Reviderat innehåll';
$string['privacy:metadata:wiki_versions:contentformat'] = 'Format på reviderat innehåll';
$string['privacy:metadata:wiki_versions:timecreated'] = 'Tid då revideringen skapades';
$string['privacy:metadata:wiki_versions:userid'] = 'Användare som skapade revideringen';
...
$string['ratingmode'] = 'Bedömningsläge';
$string['removeallwikitags'] = 'Ta bort all wiki-etiketter';
$string['removepages'] = 'Ta bort sidor';
$string['reparsetimeout'] = 'Standard-timeout för omtolkning';
...
$string['search:activity'] = 'Wiki - aktivitetsinformation';
$string['search:collaborative_page'] = 'Wiki - samarbetssidor';
$string['searchcontent'] = 'Sök i innehållet på sidan';
$string['searchresult'] = 'Sökresultat:';
$string['searchterms'] = 'Sökbegrepp';
$string['searchwikis'] = 'Sök wikis';
$string['special'] = 'Special';
$string['tableofcontents'] = 'Innehållstabell';
$string['tagarea_wiki_pages'] = 'Wikisidor';
$string['tagsdeleted'] = 'Wiki-etiketterna har tagits bort';
$string['teacherrating'] = 'Lärarbedömning';
...
$string['wiki:overridelock'] = 'Åsidosätt wiki-lås';
...
$string['wikiintro'] = 'Beskrivning';
$string['wikiitalictext'] = 'Kursiv stil';
$string['wikilockingsettings'] = 'Timeout för låsning och omtolkning';
...
$string['wikinowikitext'] = 'Ingen wikitext';
...
$string['wrongversionlock'] = 'En annan användare har redigerat denna sida samtidigt som du redigerade den och ditt innehåll är inte längre användbart.';
