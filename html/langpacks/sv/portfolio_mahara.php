...
$string['pf_description'] = 'Tillåt användare att skicka Moodle-innehåll till denna värd<br />Prenumerera på <b>och</b> publicera den här tjänsten för att tillåta autentiserade användare på din webbplats att skicka innehåll till {$a}Beroende: Du måste också publicera SSO-tjänsten (Identity Provider) till {$a}.</li><li><em>Beroende</em>: Du måste också <strong>prenumerera på</strong> SSO-tjänsten (Service Provider) på {$a}</li><li><em>Beroende</em>: Du måste också aktivera MNet-autentiseringsmodulen.</li></ul><br />';
