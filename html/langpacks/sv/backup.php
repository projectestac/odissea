...
$string['configgeneralcontentbankcontent'] = 'Anger standardinställningarna för hur innehållet i innehållsbanken ska inkluderas vid en säkerhetskopiering.';
...
$string['configlegacyfiles'] = 'Ställer in standard för att inkludera äldre kursfiler i en säkerhetskopia. Äldre kursfiler är från versioner av Moodle före 2.0.';
...
$string['copydest'] = 'Mål';
$string['copyfieldnotfound'] = 'Kunde inte hitta obligatoriskt fält';
...
$string['errorrestorefrontpagebackup'] = 'Säkerhetskopior av förstasidan kan endast återställas på förstasidan';
...
$string['generalcontentbankcontent'] = 'Inkludera innehållet i innehållsbanken';
...
$string['generallegacyfiles'] = 'Inkludera kursfiler sparade i äldre format';
$string['generallogs'] = 'Inkludera loggar';
$string['generalpermissions'] = 'Inkludera åsidosättande av behörigheter';
...
$string['managefiles'] = 'Hantera säkerhetskopierade filer';
...
$string['recyclebin_desc'] = 'OBS! Dessa inställningar kommer även att användas för papperskorgen.';
...
$string['rootsettingpermissions'] = 'Inkludera åsidosättande av behörigheter';
...
$string['showtypes'] = 'Visa alternativ för typer';
$string['sitecourseformatwarning'] = 'Detta är en säkerhetskopia av en förstasida. OBS! Dessa kan endast återställas på förstasidan.';
...
$string['successfulcopy'] = 'Kopieringen lyckades';
