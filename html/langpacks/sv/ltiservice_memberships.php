...
/**
 * Strings for component 'ltiservice_memberships', language 'sv', version '4.5'.
 *
...
$string['privacy:metadata:fullname'] = 'Fullständigt namn för användaren av LTI-konsumenten.';
$string['privacy:metadata:lastname'] = 'Efternamn för användaren av LTI-konsumenten.';
$string['privacy:metadata:userid'] = 'ID för användaren av LTI-konsumenten.';
$string['privacy:metadata:useridnumber'] = 'ID-nummer för användaren av LTI-konsumenten.';
