...
/**
 * Strings for component 'block_community', language 'sv', version '3.11'.
 *
...
$string['subject'] = 'Ämne';
$string['subject_help'] = 'Om du vill begränsa sökningen till kurser inom ett visst ämnesområde väljer du en från den här listan.';
