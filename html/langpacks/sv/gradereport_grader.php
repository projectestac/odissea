...
/**
 * Strings for component 'gradereport_grader', language 'sv', version '4.4'.
 *
...
$string['ajaxclicktoclose'] = 'Klicka på den här rutan för att ta bort den';
$string['ajaxerror'] = 'Fel';
$string['ajaxfailedupdate'] = 'Kan inte uppdatera [1] för [2]';
$string['ajaxfieldchanged'] = 'Fältet du just nu redigerar har ändrats. Vill du använda det uppdaterade värdet?';
$string['eventgradereportviewed'] = 'Bedömarrapport visad';
$string['grader:manage'] = 'Hantera betygsrapport';
...
$string['privacy:metadata:preference:grade_report_quickgrading'] = 'Om textinmatningsfält ska visas för varje betyg, så att många resultat kan redigeras samtidigt';
