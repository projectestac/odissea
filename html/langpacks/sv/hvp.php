...
/**
 * Strings for component 'hvp', language 'sv', branch 'MOODLE_38_STABLE'
 *
 * @package   hvp
...
$string['contentstatefrequency_help'] = 'I sekunder, hur ofta du vill att användarens framsteg ska sparas automatiskt. Öka detta nummer om du har problem med många ajax-requests.';
$string['contenttypecacheheader'] = 'Cache för innehållstyp';
...
$string['create'] = 'Skapa';
$string['ctcachebuttonlabel'] = 'Uppdatera cache för innehållstyp';
$string['ctcacheconnectionfailed'] = 'Kunde inte kommunicera med H5P-hubben. Försök igen senare.';
$string['ctcachedescription'] = 'Genom att kontrollera att cache för innehållstyp är uppdaterad så säkerställer du att du kan se, ladda ned och använda de senaste biblioteken. Detta är inte samma sak som att uppdatera själva biblioteken.';
...
$string['ctcachesuccess'] = 'Cache för bibliotek uppdaterat!';
$string['ctcachetaskname'] = 'Uppdatera cache för innehållstyp';
...
$string['disablefileextensioncheckwarning'] = 'Varning! Inaktivering av kontrollen av filändelse kan innebära säkerhetsrisker eftersom detta tillåter att ladda upp php-filer. Detta kan i sin tur göra det möjligt att köra illvillig kod vid intrång. Försäkra dig om att du vet exakt vad du laddar upp.';
$string['disablefullscreen'] = 'Inaktivera helskärm';
$string['disablehubconfirmationmsg'] = 'Vill du fortfarande aktivera hubben?';
$string['disablehubdescription'] = 'Det uppmuntras verkligen att ha detta val aktiverat. H5P-hubben innebär att du får ett enkelt gränssnitt för att få nya innehållstyper och hålla befintliga uppdaterade. I framtiden så kommer det också att bli ännu enklare att dela och återanvända innehåll. Om denna inställning är inaktiverad så behöver du installera och uppdatera innehållstyper genom formulär för uppladdning av filer.';
...
$string['enablecopyright'] = 'Knapp för Copyright';
$string['enabledlrscontenttypes'] = 'Aktivera LRS-beroende innehållstyper';
$string['enabledlrscontenttypes_help'] = 'Gör det möjligt att använda innehållstyper som behöver ett LRS (Learning Record Store) för att fungera ordentligt, såsom innehållstypen Questionnaire.';
...
$string['hvp:saveresults'] = 'Spara resultaten från genomförda H5P-aktiviteter';
...
$string['hvp:viewallresults'] = 'Visa alla resultat för genomförda H5P-aktiviteter';
