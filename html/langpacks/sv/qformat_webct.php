...
/**
 * Strings for component 'qformat_webct', language 'sv', version '4.5'.
 *
...
$string['missinganswer'] = 'För få :ANSWER, :Lx, :Rx-satser för frågeraden {$a}. Du måste definiera minst 2 möjliga svar.';
