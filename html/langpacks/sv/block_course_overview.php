...
/**
 * Strings for component 'block_course_overview', language 'sv', version '4.5'.
 *
...
$string['prevpage'] = 'Föregående sida';
$string['privacy:metadata:sortorder'] = 'Sorteringsordning';
$string['shortnameprefix'] = 'Inkluderar {$a}';
$string['shortnamesufixprural'] = '(Och {$a} andra)';
$string['shortnamesufixsingular'] = '(Och {$a} andra)';
$string['sortorder'] = 'Sorteringsordning';
...
$string['youhavenomessages'] = 'Du har inga olästa';
