...
/**
 * Strings for component 'question', language 'sv', version '3.8'.
 *
 * @package     question
 * @category    string
...
$string['cannotinsertquestioncatecontext'] = 'Kunde inte infoga den nya frågekategorin {$a->cat} ogiltigt \'contextid\' {$a->ctx}';
...
$string['cannotread'] = 'Kunde inte läsa importerad fil (filen kan vara tom)';
...
$string['categorymove'] = 'Kategorin  \'{$a->name}\'  innehåller frågor (det kan handla om gamla, dolda frågor som används i existerande tester). Välj en annan kategori att flytta dem till.';
...
$string['defaultmark'] = 'Förvald poäng';
...
$string['errorduringregrade'] = 'Det gick inte att omgradera fråga {$a->qid}, byter till {$a->stateid}.';
...
$string['exportquestions_help'] = '<p>Den här funktionen gör det möjligt för dig att exportera en komplett kategori av frågor till en textfil.  </p>
<p>Lägg dock märke till att i många filformat är det så att viss information
...
i en skarp produktionsmiljö. </p>

<p>De format som f n stödjs är:</p>

<p><b>GIFT-formatet</b></p>
<ul>
<li>GIFT är det mest heltäckande import- och exportformatet som finns när det gäller att
...
<p>Fler format kommer att tillkomma, vad helst annat som Moodle-användare kan komma att bidra med! </p>';
...
$string['markoutofmax'] = 'Poängsatt {$a->mark} av {$a->max}';
$string['marks'] = 'Poäng';
