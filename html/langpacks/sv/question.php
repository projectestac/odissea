...
$string['cannotgetdsfordependent'] = 'Det gick inte att hitta den angivna datamängden för en fråga som är beroende av en datamängd! (question: {$a[0]}, datasetitem: {a[1]})';
...
$string['questionbehavioursdisabledexplained'] = 'Ange en kommaseparerad lista med frågebeteenden du inte vill ska visas i rullgardinsmenyn.';
