...
/**
 * Strings for component 'quiz_grading', language 'sv', version '4.5'.
 *
...
$string['gradeattemptsneedsgrading'] = 'De som behöver bedömning ({$a})';
...
$string['invalidquestionid'] = 'Bedömningsfråga med ID {$a} hittades inte';
