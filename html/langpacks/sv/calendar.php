...
/**
 * Strings for component 'calendar', language 'sv', version '3.11'.
 *
 * @package     calendar
 * @category    string
...
$string['eventsimported'] = 'Importerade händelser: {$a}';
...
$string['eventsskipped'] = 'Överhoppade händelser: {$a}';
...
$string['eventsupdated'] = 'Händelser uppdaterade {$a}';
