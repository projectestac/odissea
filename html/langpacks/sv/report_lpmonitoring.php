...
/**
 * Strings for component 'report_lpmonitoring', language 'sv', version '3.11'.
 *
...
$string['pluginname'] = 'Övervakning av studieplaner';
$string['previoususer'] = 'Föregående användare';
$string['privacy:metadata'] = 'Pluginmodulen Övervakning av studieplaner lagrar ingen personinformation.';
