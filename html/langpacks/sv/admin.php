...
$string['configauthenticationplugins'] = 'Välj de autentiseringsplugin som du vill använda och ordna dem de ska användas att falla tillbaka på.';
...
$string['configfrontpage'] = 'De objekt som väljs ovan kommer att visas på webbplatsens förstasida.';
...
$string['configfrontpageloggedin'] = 'De objekt som väljs ovan kommer att visas på webbplatsens förstasida när en användare är inloggad.';
...
$string['configlangmenu'] = 'Välj om du vill visa den allmänna språkmenyn på hemsidan, inloggningssidan etc.  Detta påverkar inte användarens möjlighet att ange önskat språk i sin egen profil.';
...
$string['configlocale'] = 'Välj ett webbplatsomfattande språk. Detta åsidosätter formatet och språket för datum för alla språkpaket (även om namn på dagar i kalendern inte påverkas). Stöd för den här språkinställningen måste vara konfigurerat för ditt operativsystem (t.ex. är det för Linux en_US. UTF-8 eller es_ES. UTF-8). I de flesta fall bör det här fältet lämnas tomt.';
...
$string['cronwarningnever'] = 'Skriptet <code>admin/cli/cron.php</code> har aldrig körts. Det bör köras {$a->expected}.';
...
$string['frontpage'] = 'Förstasida';
$string['frontpagebackup'] = 'Säkerhetskopia för förstasidan';
$string['frontpagedefaultrole'] = 'Standarroll på förstasidan';
$string['frontpagefilters'] = 'Filter för förstasidan';
$string['frontpageloggedin'] = 'Förstasidesobjekt när man är inloggad';
$string['frontpageoverrides'] = 'Åsidosätt behörigheter för förstasidan';
$string['frontpagequestions'] = 'Frågor på förstasidan';
$string['frontpagerestore'] = 'Återställning av förstasidan';
...
$string['searchenginequeryonly_none'] = 'Ingen (använd huvudsökmotor för förfrågningar)';
...
Fält markerade * är anpassade användarprofilfält. Du kan markera dessa fält, men det finns för närvarande vissa sidor där de inte kommer att visas.';
...
$string['sitesectionhelp'] = 'Om detta är valt kommer en ämnessektion att visas på webbplatsens förstasida.';
...
$string['unsupportedphpversion80'] = 'PHP version 8.0 stöds inte.';
...
$string['updatenotificationfooter'] = 'Din Moodle-webbplats {$a->siteurl} har konfigurerats för att automatiskt söka efter nya uppdateringar. Du får detta meddelande eftersom du är administratör för denna webbplats. Du kan stänga av den automatiska sökningen genom att gå till <em>Hantera webbplats &#10132; Server &#10132; Uppdateringsnotiser</em> eller genom att ändra dina personliga inställningar för aviseringar under <em>Mina inställningar &#10132; Notisinställningar</em>.';
...
$string['upgradepluginsinfo_help'] = 'Det finns tillgängliga uppdateringar för några av dina pluginmoduler. Du bör installera dem alla innan du uppgraderar Moodle-databasen. Om din webbplats inte stöder automatiska uppdateringar måste du ladda ner och installera nya plugin-versioner på servern manuellt.';
...
$string['userfeedbackencouragement'] = '<p>I Moodle 3.9 och framåt finns en ny funktion som ger användarna möjlighet att ge feedback om Moodle-programvaran till Moodle HQ via en extern enkätwebbplats som drivs av Moodle HQ. Ingen användaridentifieringsinformation vidarebefordras till webbplatsen.</p> <p>Moodle HQ strävar efter att vara öppen och transparent om sina datainsamlingsmetoder. Således vill vi se till att du är medveten och har kontroll över denna funktionalitet.</p> <p>Feedback från användare kommer att i hög tid hjälpa Moodle HQ att förbättra Moodle-programvaran. För att aktivera den här funktionen, gå till <a href="{$a}">Feedback-inställningar</a>.</p>';
