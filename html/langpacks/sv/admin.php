...
/**
 * Strings for component 'admin', language 'sv', version '3.8'.
 *
 * @package     admin
 * @category    string
...
$string['allowcohortthemes'] = 'Tillåt teman för kohorter';
$string['allowcoursethemes'] = 'Tillåt teman för kurser';
$string['allowedemaildomains'] = 'Tillåtna e-mail domäner';
...
$string['allowguestmymoodle'] = 'Tillåt gäståtkomst till Mitt Moodle';
...
$string['allowindexingexceptlogin'] = 'Överallt förutom inloggning -och registreringssida';
...
$string['alternativefullnameformat_desc'] = 'Detta definierar hur namn visas för användare med viewfullnames-behörighet (som standard användare med rollen chef, lärare eller icke-redigerande lärare). Platshållare som kan användas är som för inställningen "Fullständigt namnformat".';
...
$string['bookmarkadded'] = 'Bokmärke skapat.';
...
$string['cachejs_help'] = 'Om du cachar och komprimerar Javascript så får du en markant förbättring av hur sidan laddas in. Detta rekommenderas starkt för skarpa webbplatser. Utvecklare föredrar troligen att inaktivera denna funktion.';
...
$string['cfgwwwrootslashwarning'] = 'Du har definierat $CFG->wwwroot på fel sätt i din config.php-fil. Du har tagit med ett \'/\'-tecken på slutet. Vänligen ta bort det om du inte vill råka ut för konstiga buggar som <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
$string['cfgwwwrootwarning'] = 'Du har definierat $CFG->wwwroot på fel sätt i din config.php-fil. Det matchar inte den URL som du använder för att få tillgång till den här sidan. Vänligen ta bort det om du inte vill råka ut för konstiga buggar som <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
$string['change'] = 'ändra';
...
$string['componentinstalled'] = 'Komponent installerad';
...
$string['configallowguestmymoodle'] = 'Om alternativet aktiverats kommer gäster åt Mitt Moodle, annars omdirigeras gäster till webbplatsen förstasida.';
...
$string['configallowswitch'] = 'Välj vilka roller en användare får byta till, baserat på vilka roller de redan har. Förutom en post i den här tabellen måste en användare också ha funktionsbehörigheten moodle/role:switchroles för att kunna byta.<br />Observera att det bara är möjligt att byta till roller som har funktionsbehörigheten moodle/course:view och som inte har funktionsbehörigheten moodle/site:doanything, så vissa kolumner i den här tabellen är inaktiverade.';
...
$string['configautolang'] = 'Identifiera standardspråket med hjälp av inställningen i webbläsaren. Om du inaktiverar detta så kommer standardinställningen för webbplatsen att användas.';
...
$string['configcourseoverviewfileslimit'] = 'Det maximala antalet filer som kan visas bredvid kurssammanfattningen på sidan med kurslistan. Den första bildfilen som lagts till används som kursbild i kursöversikten på användarnas Mitt Moodle; alla ytterligare filer visas enbart på listan över kurser.';
...
$string['configdeleteunconfirmed'] = 'Om du använder autentisering med e-post så är detta den tid inom vilken ett svar från användarna kommer att accepteras. Efter att denna tid har gått ut så kommer alla icke bekräftade konton att tas bort.';
...
$string['configdocroot'] = 'Definierar sökvägen till Moodle Docs som tillhandahåller kontextspecifik dokumentation via <em>\'Moodle Docs för den här sidan\'</em>-länkar i sidfoten på varje sida. Om fältet lämnas tomt visas inga länkar.';
...
$string['configenablerssfeedsdisabled2'] = 'RSS-flöden är inaktiverade på servernivå. Du måste först aktivera dem under \'Hantera webbplats\'.';
...
$string['configfrontpagecourselimithelp'] = 'Maximalt antal kurser som ska visas i kurslistorna på webbplatsens förstasida.';
...
$string['configkeeptagnamecase'] = 'Markera detta om du vill att etiketter ska behålla den ursprungliga skiftlägeskänslighet som de användare som har skapat dem har angivit.';
...
$string['configoverride'] = 'Definierad i <code>config.php</code>';
...
$string['configproxypassword'] = 'Lösenord som behövs för att få tillgång till Internet via proxy om en sådan krävs. Lämna tomt om det inte krävs (PHP cURL-tillägget behöver då vara konfigurerat).';
...
$string['configrequestedteachersname'] = 'Ord för kursansvarig, lärare, handledare, coacher, mentorer i den begärda kursen';
...
$string['configsessioncookiedomain'] = 'Detta tillåter dig att ändra domänen som Moodles kakor (cookies) är tillgänglöiga från. Detta är användbart för anpassningar av Moodle (tex autenserings- eller anmälningsplugins) som behöver dela Moodles sessionsinformation med en webbapplikation på en annan subdomän.  <strong>VARNING: det rekomenderas starkt att lämna denna inställning som förvalt (tomt) - ett felaktigt värde kommer förhindra all inloggning till webbplatsen.<strong>';
...
$string['cron'] = 'Cron';
$string['cron_help'] = 'cron.php-skriptet kör ett antal schemalagda bakgrundsaktiviteter, som till exempel att söka efter uppdateringar, sammanställa statistik m.m. Skriptet bör köras regelbundet - helst varje minut.';
...
$string['cronwarningcli'] = 'Underhållsscriptet cli/cron.php har inte körts på minst 24 timmar.';
...
$string['defaulthomepage'] = 'Hemsida för användare';
...
$string['filescleanupperiod_help'] = 'Hur ofta filer i papperskorgen tas bort. Det är filer som är associerade med ett sammanhang som inte längre finns, till exempel när en kurs tas bort. Observera: Den här inställningen kan resultera i att filer saknas i en kurs som säkerhetskopieras, raderas och sedan återställs om inställningen \'Inkludera filer\' (backup_auto_files) i \'Inställningar för automatisk säkerhetskopiering\' är inaktiverad.';
...
$string['maintenancemodeisscheduledlong'] = 'Den här webbplatsen kommer att växla till underhållsläge om {$a->hour} tim {$a->min} min {$a->sec}s';
...
$string['maxtimelimit_desc'] = 'För att begränsa maximal exekveringstid för PHP som Moodle tillåter utan att utmatning visas, ange här ett värde i sekunder. 0 betyder att Moodle standardbegränsningar används. Om du har en front-end-server med egen tidsgräns, ställ in detta värde lägre för att få PHP fel i loggarna. Gäller ej CLI skript.';
...
$string['messaging'] = 'Aktivera internt meddelandesystem';
$string['messagingallowemailoverride'] = 'Notis per e-post åsidosättande';
...
$string['messagingdeleteallnotificationsdelay'] = 'Radera aviseringar efter';
$string['messagingdeletereadnotificationsdelay'] = 'Ta bort lästa notiser';
...
$string['mobilenotconfiguredwarning'] = 'Moodle-appen är inte aktiverat.';
...
$string['moodlebrandedapp'] = 'Skräddarsydd Moodle-app';
...
$string['moodlebrandedappreference'] = 'Alternativt, hämta en <a href="https://moodle.com/branded-app/">Skräddarsydd Moodle app</a> med dina egna anpassningar.';
...
$string['mypage'] = 'Standardinställningar för Mitt Moodle';
...
$string['outgoingmailconfig'] = 'Konfigurering av utgående e-post';
...
$string['pathtodot_help'] = 'Sökväg till dot. På Linux är det något i stil med \'/usr/bin/dot\'. På Windows är det något i stil med \'C:\\Program Files (x86)\\Graphviz2.38\\bin\\dot.exe\'. På Mac är det något i stil med \'/opt/local/bin/dot\'. För att kunna generera grafik från DOT-filer måste du ha installerat dot programmet och peka på det här.';
...
$string['privacy:metadata'] = 'Pluginmodulen Administration lagrar ingen personlig information.';
...
$string['profilevisible_help'] = '* Ingen - För privata data som endast administratörer får se
* För användaren - För privata data som endast användaren själv och administratörer får se
* Alla - Synligt för alla användare på webbplatsen';
$string['profilevisibleall'] = 'Alla';
$string['profilevisiblenone'] = 'Ingen';
$string['profilevisibleprivate'] = 'För användaren';
...
$string['registermoodlenet'] = '<p>Vi skulle gärna hålla kontakten och förse dig viktig information rörande din Moodle-webbplats!</p> <p> Genom att registrera dig:</p><ul><li>Kan du prenumerera för att få aviseringar om nya Moodle-utgåvor, säkerhetsvarningar och andra viktiga nyheter.</li> <li>Kan du komma åt och aktivera mobila push-meddelanden från din Moodle-webbplats via vår kostnadsfria <a href="https://download.moodle.org/mobile/">Moodle app</a>.</li> <li>Bidrar du till vår <a href="https://stats.moodle.org">Moodle statistik</a> för den globala gemenskapen, som hjälper oss att förbättra Moodle och våra community-webbplatser.</li> <li>Kan du om du vill inkludera din webbplats i <a href="https://stats.moodle.org/sites/">listan över registrerade Moodle-webbplatser</a> i ditt land.</li></ul>';
...
$string['taskanalyticscleanup'] = 'Städa analysdata';
$string['taskautomatedbackup'] = 'Automatisk säkerhetskopiering';
$string['taskbackupcleanup'] = 'Städa upp backuptabeller och loggar';
...
$string['testoutgoingmailconf_message'] = 'Detta är ett testmeddelande för att bekräfta att du framgångsrikt konfigurerat webbplatsens utgående e-post.';
...
$string['unsupportedphpversion7'] = 'PHP version 7 stöds inte';
$string['unsupportedphpversion71'] = 'PHP version 7.1 stöds inte';
$string['unsupportedphpversion72'] = 'PHP version 7.2 stöds inte';
$string['unsupportedphpversion73'] = 'PHP version 7.3 stöds inte';
$string['unsupportedphpversion74'] = 'PHP version 7.4 stöds inte';
...
$string['updateavailabledetailslink'] = 'Gå till {$a->url} för mer information';
...
$string['updateavailableinstallall'] = 'Installera tillgängliga uppdateringar ({$a})';
$string['updateavailableinstallallhead'] = 'Installerar tillgängliga uppdateringar';
$string['updateavailablenot'] = 'Moodle kör senaste versionen!';
$string['updateavailablerecommendation'] = 'Du rekommenderas absolut att uppdatera din webbplats till den senaste versionen för att få de senaste säkerhetsuppdateringarna och buggfixarna.';
$string['updatecomponent'] = 'Uppdatera komponent';
$string['updateminmaturity'] = 'Obligatorisk kodmognad';
$string['updateminmaturity_desc'] = 'Meddela om tillgängliga uppdateringar endast om den tillgängliga koden minst har den valda mognadsnivån. Uppdateringar för plugins som inte deklarerar sin kodmognadsnivå rapporteras alltid oavsett denna inställning.';
$string['updatenotificationfooter'] = 'Din Moodle-sajt {$a->siteurl} har konfigurerats för att automatiskt söka efter nya uppdateringar. Du får detta meddelande eftersom du är administratör för denna webbplats. Du kan stänga av den automatiska sökningen genom att gå till Administration av webbplats / Server / Uppdateringsnotiser eller genom att ändra dina personliga inställningar för aviseringar under Mina inställningar.';
$string['updatenotifications'] = 'Uppdateringsnotiser';
$string['updatenotificationsubject'] = 'Det finns en ny version av Moodle ({$a->siteurl})';
$string['updatenotifybuilds'] = 'Notifiera vid nya kodbyggen';
$string['updatenotifybuilds_desc'] = 'Om aktiverad rapporteras även den tillgängliga uppdateringen för Moodle-kod när ett nytt bygge för den aktuella versionen är tillgänglig. Byggen är kontinuerliga förbättringar av en given Moodle-version. De släpps i allmänhet varje vecka. Om inaktiverad kommer den tillgängliga versionen att rapporteras endast när det finns en högre version av Moodle tillgänglig. Kontroller för plugins påverkas inte av den här inställningen.';
...
$string['upgradepluginsfirst'] = 'Du rekommenderas att först installera tillgängliga uppdateringar';
$string['upgradepluginsinfo'] = 'Uppdaterar plugins';
$string['upgradepluginsinfo_help'] = 'Det finns tillgängliga uppdateringar för några av dina plugins. Du bör installera dem alla innan du uppgraderar Moodle-databasen. Om din webbplats inte stöder automatiska uppdateringar måste du ladda ner och installera nya plugin-versioner på servern manuellt.';
...
$string['userdefaultpreferences'] = 'Använd standardinställningar';
...
$string['webproxyinfo'] = 'Fyll i följande alternativ om din Moodle-server inte har direkt tillgång till Internet. Tillgång till Internet är nödvändigt för att du ska kunna ladda ner miljödata, språkpaket, RSS-flöden, tidszoner etc.<br /><em>PHP cURL extensionen rekommenderas starkt.</em>';
