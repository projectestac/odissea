...
/**
 * Strings for component 'admin', language 'sv', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['commonactivitysettings'] = 'Vanliga inställningar';
...
$string['opentowebcrawlers'] = 'Öppen för Google';
...
$string['task_result:failed'] = 'Misslyckas';
$string['task_starttime'] = 'Starttid/datum';
$string['tasktype'] = 'Typ';
