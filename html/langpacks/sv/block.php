...
$string['createdat_help'] = 'Den ursprungliga platsen där blocket skapades. Blockinställningar kan göra att blocket även kan visas på andra platser (sammanhang) inom ramen för den ursprungliga platsen. Ett block som skapas på en kurssida kan till exempel visas i aktiviteter i den kursen. Ett block som skapats på förstasidan kan visas på hela webbplatsen.';
