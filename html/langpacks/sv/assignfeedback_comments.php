...
/**
 * Strings for component 'assignfeedback_comments', language 'sv', version '3.8'.
 *
...
$string['enabled_help'] = 'Om funktionen är aktiverad kan den som betygsätter lämna kommentarer för varje inskickad uppgift.';
$string['pluginname'] = 'Återkopplingskommentarer';
...
$string['privacy:metadata:gradepurpose'] = 'Betygs-ID associerat med kommentaren.';
$string['privacy:metadata:tablesummary'] = 'Lagrar kommentarer från betygsättarna som återkoppling till eleven på deras inlämning.';
