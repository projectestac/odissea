...
/**
 * Strings for component 'repository_webdav', language 'sv', version '4.5'.
 *
...
$string['webdav_path'] = 'WebDAV-sökväg';
$string['webdav_port'] = 'WebDAV serverport';
$string['webdav_server'] = 'WebDAV-server';
$string['webdav_type'] = 'WebDAV-typ';
$string['webdav_user'] = 'WebDAV-serveranvändare';
