...
/**
 * Strings for component 'game', language 'fr', version '3.11'.
 *
 * @package     game
 * @category    string
...
$string['deleteattemptcheck'] = 'Êtes-vous sûr(e) de vouloir complètement effacer ces tentatives ?';
...
$string['hangman_maximum_number_of_errors'] = 'Nombre maximum d\'erreurs (doivent être des images nommées hangman_0.jpg, hangman_1.jpg, etc.)';
