...
/**
 * Strings for component 'game', language 'fr', version '4.5'.
 *
 * @package     game
 * @category    string
...
$string['game_error'] = 'Erreur de jeu : {$a}';
...
$string['noattemptsonly'] = 'Montrer {$a} sans tentative seulement';
...
$string['privacy:metadata:game_repetitions'] = 'jeux_répétitions';
...
$string['snakes_dice'] = 'Dés, {$a} points.';
