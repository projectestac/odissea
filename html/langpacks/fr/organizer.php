...
$string['appointmentdeleted_notify_student:fullmessage'] = 'Bonjour {$a->receivername} !

Votre rendez-vous du cours {$a->courseshortname} prévu le {$a->date} à {$a->time} dans le lieu {$a->location} a été supprimé.';
$string['appointmentdeleted_notify_student:group:fullmessage'] = 'Bonjour {$a->receivername} !

Votre rendez-vous du cours {$a->courseshortname} prévu le {$a->date} à {$a->time} dans le lieu {$a->location} a été supprimé.';
$string['appointmentdeleted_notify_student:group:smallmessage'] = 'Votre rendez-vous prévu le {$a->date} à {$a->time} dans l’agenda « {$a->organizername} » a été supprimé.';
$string['appointmentdeleted_notify_student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous supprimé';
$string['appointmentdeleted_notify_student:smallmessage'] = 'Votre rendez-vous prévu le {$a->date} à {$a->time} dans l’agenda « {$a->organizername} » a été supprimé.';
$string['appointmentdeleted_notify_student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous supprimé';
...
$string['btn_comment'] = 'Modifier votre commentaire';
$string['btn_delete'] = 'Supprimer les créneaux sélectionnés';
$string['btn_deleteappointment'] = 'Supprimer le rendez-vous';
...
$string['cfg_dontshowidentity'] = 'Cacher l’identité';
$string['cfg_dontshowidentity_desc'] = 'Cacher l’identité du participant dans la liste des créneaux';
$string['cfg_limitedwidth'] = 'Zone de contenu réduite';
$string['cfg_limitedwidth_desc'] = 'Utiliser un style Moodle 4.X réduit pour la zone de contenu. Le style par défaut utilisé peut être redimensionné si le contenu du tableau est important.';
$string['changegradewarning'] = 'Cet agenda a des rendez-vous notés, et le fait de changer la note ne recalculera pas automatiquement les notes existantes. Si vous souhaitez changer la note, vous devez recalculer les notes de tous les rendez-vous existants.';
...
$string['configemailteachers'] = 'Envoyer un courriel pour informer les organisateurs des changements dans les inscriptions.';
$string['configemailteachers_label'] = 'Envoyer un courriel d’information aux organisateurs';
...
$string['deleteappointmentheader'] = 'Supprimer ce rendez-vous';
...
$string['emailteachers'] = 'Envoyer des notifications par courriel aux organisateurs';
$string['emailteachers_help'] = 'Pour éviter le spam, les organisateurs ne reçoivent pas de courriel lors de la première inscription des participants dans un créneau horaire. Cochez cette case pour autoriser l’agenda à envoyer ces notifications aux organisateurs.
...
$string['err_norecipients'] = 'Aucun destinataire sélectionné';
...
$string['eval_link'] = 'nouveau rendez-vous';
...
$string['eventappointmentdeleted'] = 'Le rendez-vous a été supprimé par l’enseignant.';
...
$string['filtertable'] = '« Filtrer cette table »';
...
$string['gradeaggregationmethod'] = 'Tendance centrale';
$string['gradeaggregationmethod_help'] = 'La tendance centrale détermine comment les notes d’une catégorie sont combinées, par exemple :

* Moyenne des notes - Somme de toutes les notes divisées par le nombre total de notes
* Note la plus basse
* Note la plus haute
* Naturelle - Somme de la valeur de toutes les notes';
$string['grading_desc_grade'] = 'Évaluation activée.';
$string['grading_desc_nograde'] = 'Évaluation désactivée.';
...
$string['hour_pl'] = 'h';
$string['id'] = 'ID';
$string['img_title_due'] = 'Le créneau est réservable';
$string['img_title_evaluated'] = 'Le créneau est finalisé';
$string['img_title_full'] = 'Le créneau est plein';
...
$string['infobox_app_inprogress'] = 'Le rendez-vous est en cours.';
$string['infobox_app_occured'] = 'Le rendez-vous a déjà eu lieu.';
$string['infobox_appointmentsstatus_pl'] = '{$a->tooless} réservation(s) est/sont à effectuer. Il reste {$a->places} places libres dans {$a->slots} créneau(x) à venir.';
$string['infobox_appointmentsstatus_sg'] = '{$a->tooless} réservation(s) est/sont à effectuer. Il reste {$a->places} places libres dans {$a->slots} créneau(x) à venir.';
$string['infobox_counter_slotrows'] = 'créneaux affichés.';
...
$string['infobox_deadline_passed_slotphp'] = '{$a->slots} créneaux n’ont pas pu être créés car la date limite d’inscription est dépassée.';
...
$string['infobox_link'] = 'Afficher/Cacher';
$string['infobox_messages_title'] = 'Messages système';
$string['infobox_messaging_title'] = '';
$string['infobox_minmax'] = 'Réservations par utilisateur : Minimum {$a->min} - Maximum {$a->max}.';
...
$string['infobox_myslot_title'] = 'Mes créneaux';
$string['infobox_myslot_userslots_left'] = 'Il vous reste {$a->left} réservations.';
$string['infobox_myslot_userslots_left_group'] = 'Il reste {$a->left} réservations à votre groupe.';
$string['infobox_myslot_userslots_max_reached'] = 'Vous avez réservé votre maximum de {$a->max} créneaux.';
$string['infobox_myslot_userslots_max_reached_group'] = 'Votre groupe a réservé son maximum de {$a->max} créneaux.';
$string['infobox_myslot_userslots_min_not_reached'] = 'Vous n’avez pas réservé le nombre requis de {$a->min} créneaux.';
$string['infobox_myslot_userslots_min_not_reached_group'] = 'Votre groupe n’a pas réservé le nombre requis de {$a->min} créneaux.';
$string['infobox_myslot_userslots_min_reached'] = 'Vous avez réservé le nombre requis de {$a->min} créneaux avec succès.';
$string['infobox_myslot_userslots_min_reached_group'] = 'Votre groupe a réservé le nombre requis de {$a->min} créneaux avec succès.';
$string['infobox_myslot_userslots_status'] = '{$a->booked} sur {$a->max} créneaux réservés.';
...
$string['infobox_organizer_never_expires'] = 'Cet agenda n’a pas d’échéance.';
$string['infobox_registrationstatistic_title'] = 'Résumé';
$string['infobox_showallparticipants'] = 'Montrer tous les participants';
$string['infobox_showfreeslots'] = 'Montrer uniquement les créneaux disponibles';
$string['infobox_showhiddenslots'] = 'Montrer aussi les créneaux cachés';
$string['infobox_showmyslotsonly'] = 'Montrer uniquement mes créneaux';
$string['infobox_showregistrationsonly'] = 'Montrer uniquement les créneaux réservés';
$string['infobox_showslots'] = 'Montrer aussi les créneaux passés<br/>';
...
$string['infobox_statistic_maxreached'] = '{$a->maxreached} participants sur {$a->entries} ont réservé le maximum de {$a->max} créneaux.';
$string['infobox_statistic_maxreached_group'] = '{$a->maxreached} groupes sur {$a->entries} ont réservé le maximum de {$a->max} créneaux.';
$string['infobox_statistic_minreached'] = '{$a->maxreached} participants sur {$a->entries} ont réservé les {$a->max} créneaux requis.';
$string['infobox_statistic_minreached_group'] = '{$a->maxreached} groupes sur {$a->entries} ont réservé les {$a->max} créneaux requis.';
...
$string['message_error_action_notallowed'] = 'Cette action n’est plus possible. Veuillez revenir en arrière et actualiser votre navigateur.';
...
$string['message_info_appointment_deleted'] = 'Le rendez-vous a été supprimé. Le participant a été notifié.';
$string['message_info_appointment_deleted_group'] = 'Le rendez-vous d’un groupe a été supprimé. Les participants ont été notifié.';
$string['message_info_appointment_not_deleted'] = 'Un problème est survenu lors de la suppression des rendez-vous.';
$string['message_info_queued'] = 'Vous avez été ajouté à la liste d’attente d’un créneau.';
$string['message_info_queued_group'] = 'Votre groupe a été ajouté à la liste d’attente d’un créneau.';
$string['message_info_registered'] = 'Vous vous êtes inscrit à un créneau avec succès.';
$string['message_info_registered_group'] = 'Votre groupe s’est inscrit à un créneau avec succès.';
...
$string['message_info_reregistered'] = 'Vous vous êtes réinscrit à un créneau avec succès.';
$string['message_info_reregistered_group'] = 'Votre groupe s’est réinscrit à un créneau avec succès.';
...
$string['message_info_slots_deleted_pl'] = '{$a->deleted} créneaux ont été supprimés. {$a->notified} participants notifiés.';
$string['message_info_slots_deleted_sg'] = 'Un créneau a été supprimé. {$a->notified} participant(s) notifiés.';
$string['message_info_slots_edited_pl'] = '{$a->count} créneaux ont été modifiés.';
$string['message_info_slots_edited_sg'] = '{$a->count} créneau a été modifié.';
$string['message_info_slots_evaluated_pl'] = '{$a->count} participants ont été évalués.';
$string['message_info_slots_evaluated_sg'] = '{$a->count} participant a été évalué.';
$string['message_info_unqueued'] = 'Vous avez été retiré de la liste d’attente d’un créneau.';
$string['message_info_unqueued_group'] = 'Votre groupe a été retiré de la liste d’attente d’un créneau.';
$string['message_info_unregistered'] = 'Vous vous êtes désinscrit d’un créneau avec succès.';
$string['message_info_unregistered_group'] = 'Votre groupe s’est désinscrit d’un créneau avec succès.';
...
$string['messageprovider:appointmentdeleted_notify_student'] = 'Rendez-vous Agenda supprimé';
...
$string['multimember'] = 'Les utilisateurs ne peuvent pas appartenir à plusieurs groupes de cours !';
...
$string['mymoodle_attended_group_short'] = '{$a->attended} groupes sur {$a->total} se sont présentés à au moins un rendez-vous.';
$string['mymoodle_attended_short'] = '{$a->attended} participants sur {$a->total} se sont présentés à au moins un rendez-vous.';
...
$string['mymoodle_no_reg_slot'] = 'Vous avez réservé {$a->booked} créneaux et n’avez pas encore atteint le minimum de {$a->slotsmin} créneaux requis.';
$string['mymoodle_no_reg_slot_group'] = 'Votre groupe {$a->groupname} a réservé {$a->booked} créneaux et n’a pas encore atteint le minimum de {$a->slotsmin} } créneaux requis.';
...
$string['mymoodle_reg_slot'] = 'Vous avez réservé {$a->booked} et avez donc atteint le minimum de {$a->slotsmin} réservations requises.';
$string['mymoodle_reg_slot_group'] = 'Votre groupe {$a->groupname} a réservé {$a->booked} et a donc atteint le minimum de {$a->slotsmin} réservations requises.';
...
$string['mymoodle_registered_group_short'] = '{$a->registered} groupes sur {$a->total} ont réservé le minimum requis de {$a->slotsmin} créneaux';
$string['mymoodle_registered_short'] = '{$a->registered} participants sur {$a->total} ont réservé le minimum requis de {$a->slotsmin} créneaux.';
...
$string['organizer:deleteappointments'] = 'Supprimer des rendez-vous';
...
$string['pasttimeslotstringphp'] = '{$a->slots} créneaux n’ont pu être créés car la création de créneaux dépassés n’est pas autorisée.';
$string['pdf_notactive'] = 'Pas actif';
$string['pdfsettings'] = 'Réglages PDF';
$string['places_inqueue'] = '{$a->inqueue} sur la liste d’attente';
$string['places_inqueue_withposition'] = 'Vous êtes en {$a->queueposition}e position sur la liste d’attente';
...
$string['recipientname'] = '_nom du destinaire';
$string['reg_not_occured'] = 'Ce créneau n’a pas encore eu lieu.';
...
$string['register_promotion_student:group:fullmessage'] = 'L’inscription de votre groupe à un créneau horaire est passée du statut « liste d’attente » au statut « réservé ».';
$string['register_promotion_student:group:smallmessage'] = 'L’inscription de votre groupe à un créneau horaire est passée du statut « liste d’attente » au statut « réservé ».';
$string['register_promotion_student:group:subject'] = 'Moodle Agenda : groupe promu depuis la file d’attente';
...
Le système de messagerie Moodle';
$string['register_reminder_student:group:smallmessage'] = 'Veuillez inscrire votre groupe au nombre de créneaux horaires requis.';
$string['register_reminder_student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel d’inscription';
$string['register_reminder_student:smallmessage'] = 'Veuillez vous inscrire au nombre de créneaux horaires requis.';
...
$string['remindall_desc'] = 'Envoyer un rappel à tous les participants sans rendez-vous';
$string['remindallmultiple_desc'] = 'Envoyer un rappel à tous les participants ayant un nombre de rendez-vous insufissant';
...
$string['searchfilter'] = 'Chercher / Filtrer';
$string['sec'] = 'sec';
$string['sec_pl'] = 'secs';
$string['select'] = 'Sélectionner des créneaux';
$string['select_all_entries'] = 'Sélectionner toutes les entrées';
...
$string['slotoptionstable'] = 'Étendre le tableau';
$string['slotoptionstable_help'] = 'Afficher également les créneaux passés ou cachés.';
...
$string['synchronizegroupmembers'] = 'Synchroniser les membres du groupe';
$string['synchronizegroupmembers_help'] = 'Si les membres du groupe Moodle changent, les modifications seront appliquées aux créneaux réservés.';
...
$string['teachervisible'] = 'Organisateur affiché';
...
$string['th_bookings'] = 'Total des réservations';
...
$string['title_delete_appointment'] = 'Supprimer le rendez-vous attribué';
...
$string['userslots_mingreatermax'] = 'Le nombre minimum de créneaux par utilisateur est supérieur au nombre maximum.';
$string['userslotsdailymax'] = 'Maximum de créneaux par participant ou de groupes par jour';
$string['userslotsdailymax_help'] = 'Nombre de créneaux qu’un participant ou un groupe est autorisé à réserver par jour. « 0 » signifie qu’il n’y a pas de limite quotidienne.';
$string['userslotsmax'] = 'Nombre maximum de créneaux par participant ou groupe';
$string['userslotsmax_help'] = 'Nombre de créneaux qu’un participant ou un groupe est autorisé à réserver.';
$string['userslotsmin'] = 'Nombre minimum de créneaux par participant ou groupe';
$string['userslotsmin_help'] = 'Nombre minimum de créneaux qu’un participant ou un groupe doit réserver.';
...
$string['waitinglists_desc_active'] = 'Les listes d’attente sont activées.';
$string['waitinglists_desc_notactive'] = 'Les listes d’attente sont désactivées.';
