...
/**
 * Strings for component 'hvp', language 'fr', version '4.5'.
 *
 * @package     hvp
 * @category    string
...
$string['invalidlibrarydata'] = 'Données fournies non valides pour {$a->%property} de {$a->%library}';
$string['invalidlibrarydataboolean'] = 'Données fournies non valides pour {$a->%property} de {$a->%library}. Booléen attendu.';
...
$string['upgradeerrorparamsbroken'] = 'Paramètres non valides.';
