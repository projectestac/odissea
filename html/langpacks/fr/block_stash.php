...
$string['advancedreset'] = 'Réinitialisation avancée';
...
$string['configdeleted'] = 'Configuration supprimée';
$string['configupdated'] = 'Configuration mise à jour';
$string['configurationtitle'] = 'Nom du bloc';
$string['configureremoval'] = 'Configurer la suppression';
...
$string['deleteswap'] = 'Supprimer une demande de troc';
$string['deleteuseritem'] = 'Supprimer {$a} pour cet utilisateur';
...
$string['navleaderboadsettings'] = 'Paramètres du classement';
...
$string['offereditems'] = 'Éléments offerts';
$string['offers'] = 'Offres';
$string['offers:zero'] = 'Aucune offre';
$string['offersdetail:zero'] = 'Aller au centre de troc pour commencer un troc, ou attendre une offre de troc.';
$string['participantswithitem'] = 'Participants avec cet objet';
...
$string['privacy:metadata:swap:stashid'] = 'L’instance dont fait partie ce troc';
$string['privacy:metadata:swap:status'] = 'L’état du troc';
$string['privacy:metadata:swap:timecreated'] = 'Le moment où l’offre de troc a été faite';
$string['privacy:metadata:swap:timemodified'] = 'Chaque fois que l’offre de troc est mis à jour';
...
$string['savequantity'] = 'Enregistrer la quantité pour l’objet {$a}';
$string['scarceitem'] = 'Objet rare';
$string['scarceitem_help'] = 'Seule une quantité limitée de cet objet est disponible. Si vous limitez cet objet à 5, alors seulement 5 objets existent dans ce cours.';
$string['searchitems'] = 'Rechercher des objets';
$string['selectanitem'] = 'Sélectionner un objet';
$string['selectauser'] = 'Sélectionner un utilisateur';
$string['selectquiz'] = 'Test';
$string['selectquizcheck'] = 'Sélectionner un test';
$string['sendtraderequest'] = 'Envoyer une demande de troc';
$string['sent'] = 'Envoyé';
$string['settings'] = 'Paramètres';
$string['settingupdated'] = 'Paramètres mis à jour';
...
$string['swapnolongerpossible'] = 'Cette offre n’est plus possible, probablement parce que vous ou le participant ne possédez plus ces objets.';
$string['text'] = 'Texte';
$string['thedrophasbeendeleted'] = 'Le lieu « {$a} » a été supprimé';
$string['theiritems'] = 'Leurs objets';
...
$string['to'] = 'À';
$string['trade'] = 'Troc';
$string['tradecenter'] = 'Centre de troc';
$string['tradecenter:zero'] = 'Sélectionner un objet ou un utilisateur ci-dessus';
$string['tradecenterdetail:zero'] = 'Sélectionner un objet vous donnera une liste d\'utilisateurs possédant ces objets pour démarrer un échange. La sélection d\'un utilisateur affichera une liste de ses objets à échanger.';
$string['tradecreated'] = 'Troc « {$a} » ajouté';
$string['tradedetails'] = 'Détails du troc';
...
$string['tradesnotenabled'] = 'Le troc n’est pas activé';
$string['tradestatusapproved'] = 'Troc approouvé';
$string['tradestatuscompleted'] = 'Troc complété';
$string['tradestatusdeclined'] = 'Troc refusé';
$string['tradestatusviewed'] = 'Troc vu';
...
$string['useritemswap'] = 'Permettre aux étudiants de faire du troc entre eux.';
$string['view'] = 'voir';
