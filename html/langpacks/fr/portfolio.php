...
/**
 * Strings for component 'portfolio', language 'fr', version '4.4'.
 *
 * @package     portfolio
 * @category    string
...
$string['fileoutputnotsupported'] = 'La réécriture du fichier en sortie n’est pas prise en charge pour ce format';
...
$string['mimecheckfail'] = 'Le plugin de portfolio {$a->plugin} ne prend en charge ce type MIME {$a->mimetype}';
...
$string['nocommonformats'] = 'Aucun format en commun entre les plugins de portfolio et le site appelant {$a->location} (formats pris en charge par l’appelant : {$a->formats})';
$string['noinstanceyet'] = 'Pas encore sélectionné';
$string['nologs'] = 'Il n’y a pas de journal à afficher !';
$string['nomultipleexports'] = 'Le portfolio de destination ({$a->plugin}) ne prend pas en charge les exportations multiples simultanées. Veuillez <a href="{$a->link}">terminer l’exportation actuelle</a>, puis réessayer';
...
$string['singleinstancenomultiallowed'] = 'Une seule instance du plugin de portfolio est disponible. Elle ne prend pas en charge les exportations multiples durant une même session et une exportation est actuellement en cours durant cette session.';
