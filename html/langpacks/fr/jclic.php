...
/**
 * Strings for component 'jclic', language 'fr', version '4.4'.
 *
 * @package     jclic
 * @category    string
...
$string['invalidjclicfile'] = 'Fichier JClic non valide. L’extension ".jclic.zip" est requise.';
$string['invalidurl'] = 'URL non valide. Elle doit commencer par "http(s)" et pointer vers une archive ".jclic.zip" valide.';
$string['jclic'] = 'JClic';
