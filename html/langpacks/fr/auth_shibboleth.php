...
/**
 * Strings for component 'auth_shibboleth', language 'fr', version '4.5'.
 *
...
$string['auth_shib_logout_url_description'] = 'Indiquer l’URL du gestionnaire de déconnexion du fournisseur de service Shibboleth. Par exemple, <tt>/Shibboleth.sso/Logout</tt>';
...
$string['auth_shibboleth_login_long'] = 'Connexion via Shibboleth';
