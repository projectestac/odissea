...
$string['displayattemptstatus_help'] = 'Si ce réglage est activé, un résumé des tentatives de l\'utilisateur sera affiché dans le bloc vue d\'ensemble du cours du tableau de bord et/ou sur la page d\'accueil du SCORM.';
