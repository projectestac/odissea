...
$string['privacy:metadata:checklist_check:usertimestamp'] = 'Heure à laquelle utilisateur a coché cet élément pour la dernière fois (0 si cet élément n\'est pas coché pour l\'instant)';
