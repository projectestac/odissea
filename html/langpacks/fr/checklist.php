...
/**
 * Strings for component 'checklist', language 'fr', version '4.5'.
 *
 * @package     checklist
 * @category    string
...
$string['commenton'] = 'Commentaire sur {$a}';
...
$string['missinguser'] = 'L’utilisateur n\'existe pas';
...
$string['privacy:metadata:checklist_comp_notification:iscomplete'] = '1 achevé et 0 non achevé';
...
$string['togglecolumn'] = 'Basculer la colonne';
$string['toggledates'] = 'Basculer les dates';
$string['togglerow'] = 'Basculer la ligne';
