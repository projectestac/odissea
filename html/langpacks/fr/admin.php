...
/**
 * Strings for component 'admin', language 'fr', version '4.1'.
 *
 * @package     admin
 * @category    string
...
$string['environmentshouldfixcustomcheck'] = 'Ce réglage devrait être activé pour de meilleures résultats';
...
$string['oracledatabaseinuse'] = 'La prise en charge des bases de données Oracle change dans Moodle LMS. La version 4.5 de Moodle sera la dernière version à prendre en charge Oracle comme base de données. Plus d\'informations à ce sujet sont disponibles <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank">ici</a> (en anglais)';
...
$string['resetindentation'] = 'Réinitialiser l’indentation';
$string['resetindentation_help'] = 'Cette opération supprimera toutes les indentations faites précédemment pour les cours en {$a->format}.';
$string['resetindentation_title'] = 'Réinitialiser l’indentation sur la page du cours ?';
...
$string['taskbadgescron'] = 'Délivrer des badges';
