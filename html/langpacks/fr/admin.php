...
/**
 * Strings for component 'admin', language 'fr', version '4.5'.
 *
 * @package     admin
 * @category    string
...
$string['asyncbackupdisabled'] = 'Votre site est actuellement configuré pour effectuer des sauvegardes en mode synchrone. Les sauvegardes asynchrones fournissent une meilleure expérience utilisateur. Elles seront activées pour tous les sites à partir de Moodle LMS 4.5 LTS. Les sauvegardes synchrones seront quant à elles supprimées de Moodle LMS dans la version suivant la version 4.5 LTS.';
...
$string['cfgwwwrootslashwarning'] = 'Le paramètre $CFG->wwwroot est défini incorrectement dans votre fichier config.php. Il contient une barre oblique « / » à la fin, qui doit être supprimée.';
...
$string['cliupgrademaintenancenotrequired'] = 'Cette mise à jour N’ACTIVERA PAS le mode de maintenance pour les utilisateurs.';
$string['cliupgrademaintenancerequired'] = 'Cette mise à jour ACTIVERA le mode de maintenance pour les utilisateurs.';
...
$string['cliupgradesetlock'] = 'La mise à jour a été verrouillé de sorte à n’être possible qu’au moyen de la ligne de commande.';
...
$string['configallowuserswitchrolestheycantassign'] = 'Par défaut, la capacité moodle/role:assign est requise pour qu’un utilisateur puisse basculer vers un autre rôle. L’activation de ce réglage supprime cette obligation, ce qui a pour résultat que le basculement vers d’autres rôles n’est déterminé que par le tableau « Autoriser les attributions de rôles ». Il est recommandé que la configuration de ce tableau ne permette pas de basculer vers un rôle comportant plus de permissions que le rôle existant.';
...
$string['configenablemobilewebservice'] = 'Les services web mobiles sont requis pour l’app Moodle. Si votre site est en HTTPS, les services web mobiles sont activés par défaut. Pour plus d’information, lire la {$a}';
...
$string['configgradeexportdefault'] = 'Choisir quel format d’exportation de carnet de notes est votre méthode par défaut pour l’exportation des notes.';
...
$string['configproxybypass'] = 'Liste de noms de domaines ou d’adresses IP (éventuellement partiels) ne devant pas passer par le proxy. Séparer les éléments par des virgules, et non par des espaces. Par exemple : 192.168.0.0/16, *.mondomaine.com.';
...
$string['configproxytype'] = 'Type de proxy web (PHP5 et son extension cURL sont requis pour la prise en charge de SOCKS5).';
...
$string['courserequestnotifyemail'] = 'L’utilisateur {$a->user} a demandé un nouveau cours sur <a href="{$a->link}">{$a->link}</a>';
...
$string['deleteduserx'] = 'Utilisateur {$a} supprimé';
...
$string['emoticons_desc'] = 'Ce formulaire définit les binettes (ou émoticônes) utilisées sur votre site. Pour définir une nouvelle binette, renseignez les champs de la dernière rangée. Pour supprimer une rangée, effacer son contenu et enregistrer le formulaire. Pour réinitialiser tous les champs à leur valeur par défaut, cliquer sur le lien au-dessous de la table
...
$string['ensureauroraversion'] = 'Votre site fonctionne avec le moteur de base de données Amazon Aurora. La version de MySQL de Amazon Aurora doit être compatible avec la version de Moodle que vous installez ou mettez à jour. Vérifiez la compatibilité sur <a href="https://docs.aws.amazon.com/AmazonRDS/latest/AuroraMySQLReleaseNotes/AuroraMySQL.Updates.30Updates.html">Database engine updates for Amazon Aurora MySQL version 3</a>.';
...
$string['environmentshouldfixcustomcheck'] = 'Ce réglage devrait être activé pour de meilleurs résultats';
...
$string['geoipdbedition_desc'] = 'Choisir l’édition de la base de données GeoIP à télécharger. L’utilisation de la base de données GeoIP2-City requiert une licence payante valide.';
$string['geoipfile'] = 'BDD GeoIP City';
$string['geoipmaxmindaccid'] = 'ID de compte MaxMind';
$string['geoipmaxmindaccid_desc'] = 'L’ID du compte crée sur le service MaxMind API service.';
$string['geoipmaxmindlicensekey'] = 'Clef de licence MaxMind';
$string['geoipmaxmindlicensekey_desc'] = 'La clef de licence du compte créé sur le service MaxMind API.';
$string['geopluginapikey'] = 'Clef API GeoPlugin';
$string['geopluginapikey_desc'] = 'La clef API utilisée pour accéder au service GeoPlugin. Obtenez votre clef sur <a href="https://www.geoplugin.com/" target="_blank">geoplugin.com</a>.';
...
$string['hookdeprecates'] = 'Callbacks dépréciés';
...
$string['intlrecommended'] = 'L’installation de l’extension optionnelle Intl de PHP est utilisée pour améliorer la prise en charge de l’internationalisation, par exemple pour les tris alphabétiques.';
$string['intlrequired'] = 'L’extension Intl de PHP est nécessaire afin d’améliorer la prise en charge de l’internationalisation, par exemple le tri en fonction de la langue et les noms de domaines internationaux.';
...
$string['iplookupmaxmindnote'] = 'Ce produit comprend les données GeoIP City créées par MaxMind, disponibles sur <a href="https://www.maxmind.com/">https://www.maxmind.com/</a>.';
$string['iscustomadminwarnings'] = 'Votre site utilise un dossier « admin » personnalisé. Cette fonctionnalité n’est plus prise en charge et sera supprimée après Moodle 4.2.';
...
$string['libcurlwarning'] = 'La bibliothèque libcurl détectée ne prend pas en charge CURLOPT_PROTOCOL. Pour des raisons de sécurité, il est recommandé de mettre à jour libcurl.';
...
$string['lockoutemailbody'] = 'Bonjour {$a->firstname},
...
$string['maxcharacter'] = 'Maximum {$a} caractères';
...
$string['mbstringrecommended'] = 'Bien que la bibliothèque MBSTRING soit facultative, il est vivement recommandé de l’installer sur le serveur pour de meilleures performances, notamment si votre site prend en charge des caractères non latins.';
...
$string['nosupportedlogstore'] = 'Aucun stockage de journaux pris en charge';
...
$string['oauthrefreshtokenexpired'] = 'Le jeton d’actualisation pour un service OAuth {$a->issuer} de votre site {$a->siteurl} est échu. Par conséquent, les fonctionnalités des plugins qui utilisent ce service seront limitées. Pour corriger ceci, visitez la page de configuration des services OAuth 2 et cliquez sur l’icône « Connect system account » dans la rangée correspondant à ce service. Assurez-vous de vous connecter à chaque fois avec le même compte de service de OAuth.';
...
$string['opcacherecommended'] = 'La mise en cache PHP opcode améliore les performances et diminue les besoins en mémoire. L’extension OPcache de PHP est recommandée et totalement prise en charge.';
...
$string['purgecachesconfirm'] = 'Moodle peut placer en cache les thèmes, le code JavaScript, les chaînes de caractères traduites, le texte filtré, les flux RSS et d’autres données calculées. En effaçant ces caches, des données seront supprimées du serveur et forceront les navigateurs à recalculer les données pour être sûr que les données affichées sont bien celles qui sont à jour. L’effacement des caches ne cause aucun problème, mais votre site semblera plus lent durant un certain temps, car le serveur et les clients devront calculer les nouvelles données et les placer en cache.';
...
$string['registrationwarning'] = 'Ne manquez pas les mises à jour importantes et les alertes de sécurité.';
$string['registrationwarningcontactadmin'] = 'Votre site n’est pas enregistré. Veuillez demander à l’administrateur d’enregistrer le site pour qu’il ne manque pas les mises à jour importantes.';
...
$string['sitesectionhelp'] = 'Afficher une section en haut de la page, dans laquelle ajouter du contenu personnalisé.';
...
$string['storedprogressbarcleanuptask'] = 'Tâche de nettoyage de la barre de progression enregistrée';
$string['strictformsrequired'] = 'Validation stricte des champs requis';
$string['stripalltitletags'] = 'Supprimer les balises HTML du nom des activités';
...
$string['swaggerui'] = 'Interface Moodle REST API (SwaggerUI)';
...
$string['task_adhoc_failed_retention'] = 'Période de rétention des tâches ad hoc en échec';
$string['task_adhoc_failed_retention_desc'] = 'La durée maximale pendant laquelle les tâches ad hoc en échec doivent rester en file d’attente une fois qu’elles ont atteint la limite de leur répétition.';
...
$string['themeeditsettingsname'] = 'Modifier les réglages du thème « {$a} »';
...
$string['themesettingsadvanced'] = 'Réglages avancés du thème';
$string['themesettingscustom'] = 'Réglages personnalisé du thème';
$string['themesettingsname'] = 'Réglage du thème {$a}';
...
$string['tlswarning'] = 'L’extension cURL de PHP avec prise en charge de TLSv1.2 n’a pas été détectée. Certains services ne fonctionneront peut-être pas. Il est vivement recommandé de mettre à jour vos bibliothèques TLS.';
...
$string['unicoderequired'] = 'Toutes les données doivent être enregistrées au format Unicode (UTF-8). Pour les nouvelles installations, la base de données doit avoir par défaut un jeu de caractères Unicode (UTF-8). Si vous effectuez une mise à jour, vous devez procéder à la migration de votre base de données en UTF-8.';
$string['uninstallplugin'] = 'Désinstaller';
$string['unlockaccount'] = 'Débloquer ce compte';
$string['unoconvwarning'] = 'La version installée de <em>unoconv</em> n’est pas prise en charge.';
$string['unsettheme'] = 'Ne pas définir de thème';
$string['unsupported'] = 'Non pris en charge';
$string['unsupporteddbfileformat'] = 'Votre base de données utilise le format de fichier Antelope. La prise en charge complète de l’encodage UTF-8 dans MySQL et MariaDB requiert le format Barracuda. Veuillez passer au format de fichier Barracuda. Consultez la documentation <a href="https://docs.moodle.org/fr/Support_unicode_complet_pour_MySQL">Support unicode complet pour MySQL</a> pour des informations supplémentaires.';
$string['unsupporteddbfilepertable'] = 'Pour une prise en charge complète de l’encodage UTF-8, tant MySQL que MariaDB nécessitent d’activer le paramètre « innodb_file_per_table ». Veuillez consulter la documentation pour plus d’informations.';
$string['unsupporteddblargeprefix'] = 'Pour une prise en charge complète de l’encodage UTF-8, tant MySQL que MariaDB nécessitent d’activer le paramètre « innodb_large_prefix ». Veuillez consulter la documentation pour plus d’informations.';
$string['unsupporteddbstorageengine'] = 'Le moteur de base de données utilisé n’est plus pris en charge.';
...
$string['unsupportedphpversion84'] = 'Les versions de PHP 8.4 et ultérieures ne sont pas prises en charge.';
...
$string['userfiltersdefault_desc'] = 'Sélectionner les filtres à afficher sur la page « Actions par lots sur les utilisateurs ». Maintenir la touche Ctrl ou Cmd enfoncée pour sélectionner plusieurs filtres. Les filtres non sélectionnés seront disponibles au moyen du lien « Afficher plus…».';
...
$string['warningiconvbuggy'] = 'Votre version de la bibliothèque iconv ne prend pas en charge le mot-clef //IGNORE. Veuillez installer l’extension mbstring qui peut être utilisée pour nettoyer les chaînes de caractères contenant des caractères UTF-8 non valides.';
