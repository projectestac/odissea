...
/**
 * Strings for component 'admin', language 'fr', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['coursecolorheading_desc'] = 'Les cours qui n\'ont pas d\'image de cours définie dans les paramètres du cours sont affichés dans le tableau de bord avec dans une carte à motifs colorés. Les couleurs utilisées peuvent être indiquées ci-dessous.';
$string['coursecolorsettings'] = 'Couleurs de la carte de cours';
...
$string['croninfrequent'] = 'La durée entre les deux derniers lancements du script de maintenance a dépassé {$a} secondes. Il est recommandé de configurer des lancements plus fréquents.';
