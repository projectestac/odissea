...
$string['acceptrisk'] = 'Je comprends que la désactivation de la vérification par courriel constitue une risque de sécurité';
$string['acceptrisk_help'] = 'La désactivation de la vérification par courriel constitue une risque de sécurité, car elle peut permettre à des utilisateurs de se connecter sous le nom d\'autres utilisateurs dans des circonstances particulières.';
