...
/**
 * Strings for component 'completion', language 'fr', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['daysuntilcompletion'] = 'Durée jusqu’à l’achèvement';
...
$string['hiddenrules'] = 'Certains réglages spécifiques à <b>{$a}</b> ont été cachés. Pour les afficher, désélectionner d’autres activités';
$string['incompatibleplugin'] = 'Cette activité ne prend pas en charge les conditions d’achèvement par défaut. Les conditions d’achèvement doivent être définies manuellement pour chaque utilisation.';
