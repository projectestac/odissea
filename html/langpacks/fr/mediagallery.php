...
/**
 * Strings for component 'mediagallery', language 'fr', version '3.11'.
 *
...
$string['choosecontent'] = 'Sélectionner un fichier à téléverser ou une URL dans les options ci-dessous.';
$string['close'] = 'Fermer';
...
$string['contentbulkheader'] = 'Vous pouvez téléverser une archive au format ZIP contenant des fichiers multimédias.
...
Le contenu téléversé est présenté sous forme de vignettes dans un carrousel ou dans une grille. Cliquer sur une vignette place l\'image en focus et permet de naviguer à l\'intérieur de la galerie. Les utilisateurs peuvent aussi «Aimer» et commenter le contenu des galeries.';
