...
/**
 * Strings for component 'cache', language 'fr', version '4.5'.
 *
 * @package     cache
 * @category    string
...
$string['cachedef_ai_policy'] = 'Acceptation de la politique IA utilisateur.';
$string['cachedef_ai_ratelimit'] = 'Limitation du taux d’appel du fournisseur IA';
...
$string['cachedef_contentbank_context_extensions'] = 'Extensions autorisées et plugins les prenant en charge dans le contexte de la banque de contenus';
$string['cachedef_contentbank_enabled_extensions'] = 'Extensions autorisées et plugins les prenant en charge dans la banque de contenus';
...
$string['cachedef_routes'] = 'Données de route';
...
$string['supports'] = 'Prend en charge';
