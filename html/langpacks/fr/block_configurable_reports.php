...
/**
 * Strings for component 'block_configurable_reports', language 'fr', version '4.5'.
 *
...
$string['allowedsqlusers'] = 'Utilisateurs de rapports SQL';
$string['allowedsqlusersinfo'] = 'Si vous souhaitez n’autoriser que certains utilisateurs de l’administration à gérer les rapports SQL, ajoutez une liste de noms d’utilisateurs séparés par des virgules. Ils doivent également avoir la capacité block/configurable_reports:managesqlreports.';
$string['anyone'] = 'Tous';
...
$string['csvdelimiterinfo'] = 'Délimiteur CSV : "colon" pour ":", "comma" pour ",", semicolon pour ";",  "tab" pour "\\t" et "cfg" pour le caractère configuré dans "CFG->CSV_DELIMITER" du fichier config.php.';
...
$string['displayprintbutton'] = 'Bouton Imprimer';
$string['displayprintbuttondescription'] = 'Affiche le bouton Imprimer en bas du rapport';
$string['displayreportslist'] = 'Afficher la liste des rapports au sein du bloc';
$string['displaytotalrecords'] = 'Total d’enregistrements';
$string['displaytotalrecordsdescription'] = 'Affiche le nombre total de résultats du rapport';
...
$string['embedlink'] = 'Lien d’intégration';
$string['embedlinkdescription'] = 'Vous pouvez copier ce lien pour intégrer ce rapport dans un bloc HTML';
$string['embedoptions'] = 'Options d’intégration';
...
$string['export_json'] = 'Exporter au format JSON';
$string['export_ods'] = 'Exporter au format ODS';
$string['export_slk'] = 'Exporter au format SYLK';
$string['export_xls'] = 'Exporter au format XLS';
