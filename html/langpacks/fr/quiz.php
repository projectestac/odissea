...
/**
 * Strings for component 'quiz', language 'fr', version '4.5'.
 *
 * @package     quiz
 * @category    string
...
$string['cannotremoveallsectionslots'] = 'Vous avez sélectionné toutes les questions sous l’en-tête de section « {$a} ». Il n’est pas permis de retirer toutes les questions sous un en-tête de section.';
$string['cannotremoveslots'] = 'Impossible de retirer des questions';
...
$string['closebeforeopen'] = 'La date de fermeture doit être postérieure à la date d’ouverture.';
$string['closed'] = 'Fermé';
...
$string['confirmremovequestion'] = 'Voulez-vous vraiment retirer cette question {$a} ?';
$string['confirmremovesectionheading'] = 'Voulez-vous vraiment retirer le titre de section « {$a} » ?';
$string['confirmserverdelete'] = 'Voulez-vous vraiment retirer de la liste le serveur <b>{$a}</b> ?';
...
$string['eventquizgradeitemcreated'] = 'Élément d’évaluation de test créé';
$string['eventquizgradeitemdeleted'] = 'Élément d’évaluation de test supprimé';
$string['eventquizgradeitemorderchanged'] = 'Ordre d’élément d’évaluation de test modifié';
$string['eventquizgradeitemupdated'] = 'Élément d’évaluation de test modifié';
...
$string['eventslotgradeitemupdated'] = 'Créneau d’élément d’évaluation modifié';
...
$string['eventslotversionupdated'] = 'Version mise à jour';
...
$string['gradeitemdefaultname'] = 'Nouvel élément d’évaluation de test {$a}';
$string['gradeitemdelete'] = 'Supprimer l’élément d’évaluation {$a}';
$string['gradeitemedit'] = 'Modifier le nom de l’élément d’évaluation {$a}';
$string['gradeitemmarkscheme'] = 'Attribuer des éléments d’évaluation';
$string['gradeitemnewname'] = 'Nouveau nom pour l’élément d’évaluation {$a}';
$string['gradeitemnoneselected'] = '[aucun]';
$string['gradeitemnoslots'] = 'Ce test n’a pas encore de question. Ajoutez d’abord des questions, puis revenez ici pour configurer des éléments d’évaluation.';
$string['gradeitems'] = 'Éléments d’évaluation';
$string['gradeitemsautosetup'] = 'Configurer un note pour chaque section';
$string['gradeitemsetup'] = 'Configuration des éléments d’évaluation';
$string['gradeitemsnoneyet'] = 'Créer des éléments d’évaluation pour le test. Attribuer des questions ou des sections du test à ces éléments d’évaluation pour répartir les résultats de l’évaluation dans différents domaines.';
$string['gradeitemsremoveall'] = 'Réinitialiser la configuration';
$string['gradeitemsremoveallconfirm'] = 'Réinitialiser la configuration des éléments d’évaluation ?';
$string['gradeitemsremoveallmessage'] = 'Ceci supprimera tous les éléments d’évaluation et en retirera l’attribution des questions et sections.<br><br>Cette action ne modifiera pas les questions et sections, ni les tentatives existantes du test.';
$string['gradeitemsremovealltitle'] = 'Réinitialiser la configuration des éléments d’évaluation';
...
$string['lastautosave'] = 'Dernier enregistrement : {$a}';
...
$string['messageprovider:quiz_open_soon'] = 'Le test s’ouvre bientôt';
$string['messageprovider:submission'] = 'Notifications des tentatives de tests remises par vos étudiants';
$string['min'] = 'Min';
$string['minutes'] = 'minutes';
$string['missingcategory'] = 'Catégorie de questions manquante';
...
$string['openclosedatesupdated'] = 'Dates d’ouverture et de fermeture';
...
$string['overridecannotchange'] = 'L’utilisateur ou le groupe ne peut pas être changé après la création d’une dérogation.';
$string['overridecannotsetbothgroupanduser'] = 'L’utilisateur et le groupe ne peuvent pas être indiqués en même temps.';
...
$string['overrideinvalidattempts'] = 'La valeur des tentatives doit être plus grande que zéro.';
$string['overrideinvalidexistingid'] = 'La dérogation indiquée n’existe pas.';
$string['overrideinvalidgroup'] = 'Le groupe indiqué n’existe pas.';
$string['overrideinvalidquiz'] = 'L’ID du test indiqué n’existe pas.';
$string['overrideinvalidtimelimit'] = 'La durée limite doit être plus grande que zéro.';
$string['overrideinvaliduser'] = 'L’utilisateur indiqué n’existe pas.';
$string['overridemissingdelete'] = 'Les dérogations d’IDs {$a} n’ont pas pu être supprimées : soit elles n’existent pas, soit elles ne font pas partie du test indiqué';
$string['overridemultiplerecordsexist'] = 'Plusieurs dérogations ne peuvent pas être faites pour le même utilisateur ou groupe.';
$string['overridemustsetuserorgroup'] = 'Un utilisateur ou un groupe doit être indiqué.';
...
$string['quizopen'] = 'Ouvrir le test';
...
$string['quizopendatesoonhtml'] = '<p>Bonjour {$a->firstname},</p>
<p>Le test <strong>{$a->quizname}</strong> va bientôt s’ouvrir, dans le cours {$a->coursename}.
<p><strong>Ouverture : {$a->timeopen}</strong></p>
<p><strong>Fermeture : {$a->timeclose}</strong></p>
<p><a href="{$a->url}">Aller au test</a></p>';
$string['quizopendatesoonsubject'] = 'Ouverture le {$a->timeopen} : {$a->quizname}';
...
$string['quizsetupnavigation'] = 'Navigation de la configuration du test';
$string['quiztimer'] = 'Minuterie';
$string['quizwillopen'] = 'Ce test sera ouvert le {$a}';
$string['random'] = 'Question aléatoire';
$string['randomcatwithsubcat'] = '{$a} et les sous-catégories';
$string['randomcoursecatwithsubcat'] = 'Toute catégorie dans la catégorie de cours {$a}';
$string['randomcoursewithsubcat'] = 'Toute catégorie dans ce cours';
$string['randomcreate'] = 'Créer des questions aléatoires';
$string['randomediting'] = 'Modification d’une question aléatoire';
$string['randomfaultynosubcat'] = 'Question erronée';
...
$string['randommodulewithsubcat'] = 'Toute catégorie de ce test';
...
$string['randomqnamecat'] = 'Aléatoire ({$a->category}) basée sur condition de filtre';
$string['randomqnamecattags'] = 'Aléatoire ({$a->category}) basée sur condition de filtre avec balises : {$a->tags}';
...
$string['randomsystemwithsubcat'] = 'Toute catégorie de niveau système';
...
$string['removeallquizattempts'] = 'Toutes les tentatives des tests';
...
$string['savemanualgradingfailed'] = 'Modification non enregistrée. Veuillez examiner le message ci-dessous et ré-essayer.';
...
$string['sendnotificationopendatesoon'] = 'Notifier l’utilisateur de l’ouverture prochaine d’un test';
...
$string['startedon'] = 'Commencé';
$string['startnewpreview'] = 'Prévisualiser à nouveau';
$string['stateabandoned'] = 'Jamais envoyée';
$string['statefinished'] = 'Terminée';
...
$string['summaryofattempts'] = 'Vos tentatives';
$string['summaryofattemptscaption'] = 'Résumé de la tentative {$a}';
...
$string['totalmarks'] = 'Total des points';
