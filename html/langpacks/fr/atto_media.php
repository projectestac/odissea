...
/**
 * Strings for component 'atto_media', language 'fr', version '4.4'.
 *
 * @package     atto_media
 * @category    string
...
$string['addsource_help'] = 'Il est recommandé d’indiquer une source alternative du média, car tous les navigateurs ne prennent pas en charge les mêmes formats.';
...
$string['metadata_help'] = 'Pistes de métadonnées, pour utilisation à partir d’un script ; ne peut être utilisée que si le lecteur prend en charge les métadonnées.';
