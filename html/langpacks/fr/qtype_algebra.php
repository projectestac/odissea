...
/**
 * Strings for component 'qtype_algebra', language 'fr', version '4.4'.
 *
...
$string['badclosebracket'] = 'Parenthèse fermante non valide trouvée';
$string['badequivtype'] = 'Type incorrect: on ne peut comparer des termes de l’analyseur qu’avec d’autres termes de l’analyseur';
$string['badfuncargs'] = 'Arguments non valides pour la fonction « {$a} »';
$string['braces'] = '\\(...\\)';
$string['brackets'] = '[…]';
$string['cdot'] = '\\cdot';
...
$string['illegalplusminus'] = 'Un + ou un - a été trouvé à un emplacement non valide';
...
$string['notanumber'] = 'Valeur non valide : un nombre est requis';
