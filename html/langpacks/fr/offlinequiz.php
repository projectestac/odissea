...
$string['addrandomquestiontoofflinequiz'] = 'Ajouter des questions au QCM papier {$a->name} (groupe {$a->group})';
$string['addrandomquestiontopage'] = 'Ajouter une question aléatoire à la page {$a}';
$string['addtoofflinequiz'] = 'Ajouter au QCM papier';
...
$string['closebeforeopen'] = 'Impossible de modifier le QCM papier : vous avez indiqué une date de fermeture antérieure à la date d’ouverture.';
$string['closestudentview'] = 'Fermer la vue étudiante';
$string['closewindow'] = 'Fermer la fenêtre';
$string['cmmissing'] = 'Le module de cours pour le QCM papier avec l’identifiant {$a} est manquant';
$string['completiondetail:passgrade'] = 'Recevoir une note minimale de réussite';
$string['completionpass'] = 'Passer pour terminer';
$string['completionpass_help'] = 'Les étudiants ne terminent ce QCM papier que s’ils obtiennent une note supérieure ou égale à la note minimale de réussite fixée dans les options de note.';
...
$string['configdecimalplaces'] = 'Le nombre de chiffres à afficher après la virgule lors de l’affichage des notes du QCM papier.';
...
$string['configexperimentalevaluationdesc'] = 'NE PAS UTILISER EN PRODUCTION ! Cette option est utilisée pour les tests alpha du nouvel algorithme d’évaluation. Si cette option est activée, vous pouvez l’activer dans les options de l’instance QCM papier. Nous déconseillons fortement d’utiliser cette option. Aucune assistance n’est fournie pour des données perdues suite à l’activation de cette option.';
$string['configintro'] = 'Les valeurs indiquées ici définissent les valeurs utilisées par défaut lors de la création d’un QCM papier.';
$string['configkeepfilesfordays'] = 'Combien de jours les fichiers téléchargés sont conservés dans l’espace temporaire de stockage. Durant ce temps les images scannées sont disponibles lors de la relecture du QCM papier.';
...
$string['createquestionandadd'] = 'Créer une nouvelle question et l’ajouter au QCM papier.';
...
$string['editgroups'] = 'Modifier les groupes QCM papier';
$string['editingofflinequiz'] = 'Modification des questions des groupes';
$string['editingofflinequiz_help'] = 'Lorsque vous créez un QCM papier, les concepts principaux sont :
<ul><li> Le QCM papier, qui contient les questions réparties sur une ou plusieurs pages</li>
...
$string['editofflinequiz'] = 'Modifier le QCM papier';
$string['editofflinesettings'] = 'Modifier les réglages du QCM papier';
...
$string['emptygroups'] = 'Certains groupes du QCM papier sont vides. Veuillez ajouter des questions.';
...
$string['eventattemptdeleted'] = 'Suppression d’une tentative de QCM papier';
$string['eventattemptpreviewstarted'] = 'Début de prévisualisation d’une tentative de QCM papier';
$string['eventattemptreviewed'] = 'Vérification d’une tentative de QCM papier';
$string['eventattemptsummaryviewed'] = 'Visualisation du résumé d’une tentative de QCM papier';
$string['eventattemptviewed'] = 'Visualisation d’une tentative de QCM papier';
$string['eventdocscreated'] = 'Création des formulaires de question et réponse de QCM papier';
$string['eventdocsdeleted'] = 'Suppression des formulaires de question et réponse de QCM papier';
$string['eventeditpageviewed'] = 'Visualisation de la page d’édition de QCM papier';
$string['eventofflinequizattemptsubmitted'] = 'Soumission d’une tentative de QCM papier';
$string['eventoverridecreated'] = 'Création d’une dérogation de QCM papier';
$string['eventoverridedeleted'] = 'Suppression d’une dérogation de QCM papier';
$string['eventoverrideupdated'] = 'Modification d’une dérogation de QCM papier';
$string['eventparticipantmarked'] = 'Marquage manuel d’un participant de QCM papier';
$string['eventquestionmanuallygraded'] = 'Question notée manuellement';
$string['eventreportviewed'] = 'Visualisation du rapport de QCM papier';
$string['eventresultsregraded'] = 'Re-notation des résultats de QCM papier';
...
$string['gradeiszero'] = 'Note : le nombre maximum de points pour ce QCM papier est 0 !';
...
$string['importisfinished'] = 'L’évaluation pour le QCM papier {$a} est terminé.';
$string['importlinkresults'] = 'Lien vers les résultats : {$a}';
$string['importlinkverify'] = 'Lien vers la vérification : {$a}';
$string['importmailsubject'] = 'Notification d’importation de QCM papier';
$string['importnew'] = 'Évaluer';
$string['importnew_help'] = '<p>
Vous pouvez déposer un fichier image scanné ou un ensemble de fichiers images scannés groupés au sein d’une archive ZIP. Le module QCM papier traitera les fichiers images en tâche de fond.
...
$string['invaliduserfield'] = 'Champ de la table utilisateur non valide.';
...
$string['modulename_help'] = 'Ce module permet à l’enseignant de concevoir les QCMs papiers constitués de questions à choix multiples.
...
Les QCMs papiers peuvent être téléchargés au format PDF, DOCX ou LaTeX. Les étudiants cochent leurs réponses sur une grille. Les grilles sont scannées, déposées dans le système et les réponses sont évaluées.';
$string['modulenameplural'] = 'QCMs papiers';
...
$string['nocourse'] = 'Le cours avec l’identifiant {$a->course} auquel le QCM papier avec l’identifiant {$a->offlinequiz} appartient est manquant.';
$string['nogradesseelater'] = 'Ce QCM papier n’a pas encore été évalué pour {$a}. Les résultats seront publiés ici.';
...
$string['noofflinequiz'] = 'Il n’y a pas de QCM papier avec l’identifiant {$a} !';
...
$string['noquestions'] = 'Certains groupes de QCM papier sont vides. Veuillez ajouter des questions.';
...
$string['offlinequiz:addinstance'] = 'Ajouter un QCM papier';
...
$string['offlinequiz:createofflinequiz'] = 'Créer les formulaires du QCM papier';
$string['offlinequiz:deleteattempts'] = 'Supprimer les résultats du QCM papier';
$string['offlinequiz:grade'] = 'Noter le QCM papier manuellement';
$string['offlinequiz:manage'] = 'Gérer les QCMs papiers';
$string['offlinequiz:preview'] = 'Aperçu des QCMs papiers';
...
$string['offlinequizisopen'] = 'Ce QCM papier est ouvert';
$string['offlinequizisopenwillclose'] = 'QCM papier ouvert (fermera le {$a})';
$string['offlinequizopenedon'] = 'Ce test est ouvert depuis {$a}';
$string['offlinequizopens'] = 'Le test est disponible';
$string['offlinequizsettings'] = 'Réglages QCM papier';
$string['offlinequizwillopen'] = 'Le QCM papier ouvre le {$a}';
...
$string['page-mod-offlinequiz-edit'] = 'Modifier la page du QCM papier';
$string['page-mod-offlinequiz-x'] = 'Ajouter une page au QCM papier';
$string['pagecorrected'] = 'Feuille corrigée de la liste des participants importée';
$string['pageevaluationtask'] = 'Évaluation de la grille de réponse pour le plugin QCM papier';
...
$string['participants_help'] = '<p>Les listes de participants sont destinées aux QCMs papiers avec un nombre important de participants. Elles aident l’enseignant à vérifier quels étudiants ont effectivement participé au QCM papier et si tous les résultats ont été importés correctement.
...
Des listes de participants peuvent être téléchargées sous forme de documents PDF, imprimées et cochées exactement comme les grilles de réponse des QCMs papiers. Plus tard elles peuvent être importées et les étudiants marqués seront considérés comme présents au QCM papier.
...
Sur cet onglet vous pouvez déposer les listes de présences remplies. Vous pouvez déposer un fichier image scanné ou un ensemble de fichiers images scannés groupés au sein d’une archive ZIP. Le module QCM papier traitera les fichiers images en tâche de fond.
Les noms de fichiers ne sont pas importants mais ne doivent pas contenir de caractères spéciaux. Les images doivent être au format GIF, PNG ou TIF.
Une résolution entre 200 et 300 dpi est recommandée.</p>';
...
$string['pluginadministration'] = 'Administration QCM papier';
...
$string['privacy:data_folder_name'] = 'Données QCM papier';
...
$string['privacy:metadata:core_question'] = 'QCM papier utilise l’API de question pour enregistrer les questions des tests.';
$string['privacy:metadata:mod_quiz'] = 'QCM papier utilise l’API de l’activité Test pour enregistrer les résultats des tests.';
...
$string['privacy:metadata:offlinequiz:course'] = 'La colonne « course » de la table offlinequiz enregistre le cours dans lequel ce QCM papier est stocké.';
...
$string['privacy:metadata:offlinequiz:grade'] = 'La note indique le nombre maximal de points à obtenir pour ce QCM papier.';
...
$string['privacy:metadata:offlinequiz:name'] = 'La colonne « name » enregistre le nom du QCM papier.';
$string['privacy:metadata:offlinequiz:numgroups'] = 'Le nombre de groupes distincts de ce QCM papier.';
...
$string['privacy:metadata:offlinequiz:showtutorial'] = 'Enregistre s’il faut proposer aux participants de suivre un didacticiel sur les QCMs papiers.';
...
$string['privacy:metadata:offlinequiz:time'] = 'La colonne temps enregistre la date du QCM papier.';
$string['privacy:metadata:offlinequiz:timeclose'] = 'La colonne « timeclose » enregistre la date à laquelle le QCM papier a été/sera fermé.';
$string['privacy:metadata:offlinequiz:timecreated'] = 'La colonne « timecreated » enregistre la date à laquelle le QCM papier a été créé.';
$string['privacy:metadata:offlinequiz:timemodified'] = 'La colonne « timemodified » enregistre la dernière date à laquelle le QCM papier a été modifié.';
$string['privacy:metadata:offlinequiz:timeopen'] = 'La colonne « timeopen » enregistre la date à laquelle le QCM papier a été/sera ouvert.';
...
$string['privacy:metadata:offlinequiz_group_questions'] = 'Cette table enregistre toutes les questions pour chaque groupe du QCM papier.';
...
$string['privacy:metadata:offlinequiz_group_questions:offlinegroupid'] = 'Le groupe QCM papier auquel cette question de groupe se rapporte.';
$string['privacy:metadata:offlinequiz_group_questions:offlinequizid'] = 'L’identifiant du QCM papier auquel cette question de groupe se rapporte.';
...
$string['privacy:metadata:offlinequiz_group_questions:position'] = 'La position dans ce QCM papier.';
...
$string['privacy:metadata:offlinequiz_groups'] = 'Tableau des groupes dans lesquels les QCMs papiers se déroulent.';
...
$string['privacy:metadata:offlinequiz_groups:number'] = 'Le numéro du groupe pour ce QCM papier : 1 pour le groupe A, 2 pour le groupe B, etc.';
...
$string['privacy:metadata:offlinequiz_groups:offlinequizid'] = 'L’identifiant du QCM papier auquel appartient ce QCM papier.';
...
$string['privacy:metadata:offlinequiz_p_lists:number'] = 'Le nombre de liste dans ce QCM papier.';
$string['privacy:metadata:offlinequiz_p_lists:offlinequizid'] = 'Le QCM papier auquel cette liste appartient.';
...
$string['privacy:metadata:offlinequiz_participants'] = 'La table des participants enregistre si l’utilisateur a participé ou non au QCM papier.';
...
$string['privacy:metadata:offlinequiz_queue:offlinequizid'] = 'L’identifiant de la file d’attente du QCM papier.';
$string['privacy:metadata:offlinequiz_queue:status'] = 'Le statut de la file d’attente qui est nécessaire.';
$string['privacy:metadata:offlinequiz_queue:timecreated'] = 'L’heure à laquelle les feuilles de ce QCM papier ont été importées.';
...
$string['privacy:metadata:offlinequiz_results:offlinegroupid'] = 'Le groupe du QCM papier auquel ce résultat appartient.';
$string['privacy:metadata:offlinequiz_results:offlinequizid'] = 'Le QCM papier auquel ce résultat appartient.';
...
$string['privacy:metadata:offlinequiz_scanned_p_pages:offlinequizid'] = 'Le QCM papier auquel les participants de cette page appartiennent.';
...
$string['privacy:metadata:offlinequiz_scanned_pages'] = 'Le tableau enregistre des informations sur une page scannée d’un QCM papier.';
...
$string['privacy:metadata:offlinequiz_scanned_pages:groupnumber'] = 'Le numéro du groupe auquel appartient ce QCM papier.';
$string['privacy:metadata:offlinequiz_scanned_pages:offlinequizid'] = 'Le QCM papier de la page numérisée.';
...
$string['privacy:metadata:offlinequiz_scanned_pages:warningfilename'] = 'Le nom du fichier qui est créé lorsqu’un QCM papier mal rempli est corrigé et que l’utilisateur reçoit un avertissement à ce sujet.';
...
$string['questionsinthisofflinequiz'] = 'Questions dans ce QCM papier';
$string['questiontextisempty'] = '[Texte de question vide]';
$string['quizdate'] = 'Date du QCM papier';
...
**Attention :** Si aucune période n’est activée pour la révision en ligne, la révision est illimitée tant que le QCM papier est visible pour les participants.
...
$string['regradinginfo'] = 'Si vous modifiez le score d’une question, vous devez ré-évaluer le QCM papier pour mettre à jour les résultats des participants.';
...
$string['resetofflinequizzes'] = 'Réinitialiser les données du QCM papier';
...
$string['reviewbefore'] = 'Permettre la relecture pendant que le QCM papier est ouvert';
$string['reviewclosed'] = 'Après la fermeture du QCM papier';
...
$string['score'] = 'Score';
$string['search:activity'] = 'QCM papier - information de l’activité';
...
$string['showgrades_help'] = 'Cette option détermine si la note maximale de chaque question du QCM papier doit être imprimée sur la feuille des questions.';
...
$string['showtutorial'] = 'Afficher un tutoriel sur les QCMs papiers aux étudiants';
$string['showtutorial_help'] = 'Cette option détermine si les étudiants peuvent visualiser un tutoriel sur les bases des QCMs papiers.
Ce tutoriel fournit des informations sur comment utiliser les différents documents constituant un QCM papier. Une partie interactive leur enseigne comment marquer correctement leur numéro d’identification.<br />
<b>Veuillez noter :</b><br />
Si vous réglez cette option sur Oui, mais que le QCM papier est masqué, le lien ne sera pas visible. Dans ce cas, vous pouvez ajouter un lien vers le tutoriel sur la page de cours.';
...
$string['subplugintype_offlinequiz'] = 'Rapport QCM papier';
$string['subplugintype_offlinequiz_plural'] = 'Rapports QCM papier';
...
$string['tutorial:questionsheet:2'] = '2)&nbsp;&nbsp; Quel contenu est disponible sur un questionnaire du QCM papier ?';
...
$string['upgradingfilenames'] = 'Mise à jour des noms de fichiers des documents : QCM papier {$a->done}/{$a->outof} (QCM papier ID {$a->info})';
$string['upgradingilogs'] = 'Mise à jour des pages scannées : page scannée {$a->done}/{$a->outof} <br/>(identifiant de QCM papier {$a->info})';
$string['upgradingofflinequizattempts'] = 'Mise à jour des tentatives du QCM papier : QCM papier {$a->done}/{$a->outof} <br/>(identifiant de QCM papier {$a->info})';
...
$string['zerogradewarning'] = 'Attention : la note du QCM papier est 0.0 !';
