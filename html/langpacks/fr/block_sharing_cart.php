...
/**
 * Strings for component 'block_sharing_cart', language 'fr', version '4.4'.
 *
...
$string['backup_without_user_data'] = 'Copier sans les données utilisateur.';
...
$string['copy_quiz_warning'] = 'Attention ! - Vous êtes sur le point de copier un test dans le panier de partage. Cela peut prendre un certain temps si le cours comporte beaucoup de questions.';
$string['copy_section'] = 'Copier la section';
$string['copy_this_course'] = 'Copier ce cours';
$string['copy_user_data'] = 'Souhaitez-vous inclure les données utilisateur  (par exemple entrées de glossaire, wiki, base de données) ?';
...
$string['maybe_the_queue_is_stuck'] = 'Si vous souhaitez exécuter la copie maintenant, cliquez sur le bouton ci-dessus.';
...
$string['nopermissions'] = 'Vous n\'êtes pas autorisé à sauvegarder ou restaurer des éléments dans ce cours. Veuillez contacter votre administrateur si vous pensez qu\'il s\'agit d\'une erreur.';
$string['old_version_module_info'] = 'Cet élément a été sauvegardé à partir d\'une version précédente.';
$string['old_version_section_info'] = 'Cette section a été sauvegardée à partir d\'une version précédente.';
...
$string['restores'] = 'Copies en cours';
...
$string['sharing_cart:manual_run_task'] = 'Exécutez manuellement la tâche de sauvegarde/restauration.';
$string['you_do_not_have_permission_to_configure_restores'] = 'Vous n\'êtes pas autorisé à configurer les restaurations. Veuillez contacter votre administrateur si vous pensez qu\'il s\'agit d\'une erreur.';
