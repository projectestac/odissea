...
/**
 * Strings for component 'pdfannotator', language 'fr', version '4.5'.
 *
...
$string['comments_icon_private'] = 'Ce commentaire est privé';
$string['comments_icon_public'] = 'Ce commentaire est publique';
$string['comments_text_all'] = 'Afficher tous les commentaires';
$string['comments_text_private'] = 'Afficher uniquement les commentaires privés (orange)';
$string['comments_text_public'] = 'Afficher uniquement les commentaires publiques (bleu)';
...
$string['export_comments_csv'] = 'Exporter en CSV';
$string['export_comments_csv_tooltip'] = 'Télécharger les commentaires en fichier CSV';
$string['export_comments_pdf'] = 'Exporter en PDF';
$string['export_comments_pdf_tooltip'] = 'Télécharger les commentaires en fichier PDF';
...
$string['successfullySubscribed'] = 'Abonné à la question.';
$string['successfullySubscribednotify'] = 'Votre abonnement à la question a été enregistré.';
