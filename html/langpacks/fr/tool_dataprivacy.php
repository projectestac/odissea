...
/**
 * Strings for component 'tool_dataprivacy', language 'fr', version '4.5'.
 *
...
$string['userlistexplanation'] = 'Ce plugin possède le <em>provider</em> de base, mais devrait également implémenter le <em>provider</em> user list pour offrir la prise en charge complète de la fonctionnalité de protection des données.';
