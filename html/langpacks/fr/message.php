...
/**
 * Strings for component 'message', language 'fr', version '4.5'.
 *
 * @package     message
 * @category    string
...
$string['enablenotificationplugin'] = 'Activer le plugin de notification : {$a}';
...
$string['eventmessagecontactremoved'] = 'Contact de messagerie personnelle retiré';
...
$string['notificationsmarkedasread'] = 'Toutes les notifications sont marquées comme lues.';
...
$string['removecontact'] = 'Retirer ce contact';
$string['removecontactconfirm'] = 'Voulez-vous vraiment retirer {$a} de vos contacts ?';
$string['removecoursefilter'] = 'Retirer le filtre pour le cours {$a}';
...
$string['waitingforcontactaccept'] = 'En attente d’être ajouté comme contact';
