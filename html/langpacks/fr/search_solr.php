...
/**
 * Strings for component 'search_solr', language 'fr', version '4.5'.
 *
 * @package     search_solr
 * @category    string
...
$string['solrsslcainfo'] = 'Nom des certificats CA SSL';
$string['solrsslcainfo_desc'] = 'Nom du fichier avec un ou plusieurs certificats CA SSL pour vérification';
$string['solrsslcapath'] = 'Chemin d’accès aux certificats CA SSL';
$string['solrsslcapath_desc'] = 'Chemin d’accès au dossier contenant plusieurs certificats CA pour vérification';
