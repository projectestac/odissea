...
/**
 * Strings for component 'attendanceregister', language 'fr', version '4.5'.
 *
...
$string['privacy:metadata:attendanceregister_aggregate'] = 'Suivi des sessions cumulées par utilisateur';
$string['privacy:metadata:attendanceregister_aggregate:duration'] = 'Durée de la session';
$string['privacy:metadata:attendanceregister_aggregate:grandtotal'] = 'Temps total global';
$string['privacy:metadata:attendanceregister_aggregate:lastsessionlogout'] = 'Déconnexion de la session en ligne du dernier utilisateur, (extrait de attendanceregister_session logout).';
$string['privacy:metadata:attendanceregister_aggregate:onlinesess'] = 'Si la session est en ligne ou hors ligne';
$string['privacy:metadata:attendanceregister_aggregate:refcourse'] = 'Cours auquel se réfère une session hors ligne';
