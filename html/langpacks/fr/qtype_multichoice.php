...
/**
 * Strings for component 'qtype_multichoice', language 'fr', version '4.5'.
 *
...
$string['showstandardinstruction_desc'] = 'Afficher les instructions « Veuillez choisir une réponse. » ou « Veuillez choisir au moins une réponse. ») seront affichées avant les réponses aux questions à choix multiple.';
$string['showstandardinstruction_help'] = 'Lorsque ce réglage est activé, les instructions « Veuillez choisir une réponse. » ou « Veuillez choisir au moins une réponse. ») seront affichées avant les réponses aux questions à choix multiple. Dans le cas contraire, on peut inclure des instructions dans le texte de la question.';
