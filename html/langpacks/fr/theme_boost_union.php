...
$string['extscssgithubrepo_example'] = 'Exemple : si vous pouvez voir le fichier dans votre compte Github sur https://github.com/moodle-an-hochschulen/moodle-theme_boost_union-extscsstest/blob/main/extscss.scss, le référentiel sera <em>moodle- theme_boost_union-extscsstest</em>.';
...
$string['flavoursbrandcolor'] = 'Couleur de la marque';
