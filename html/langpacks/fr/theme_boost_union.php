...
$string['blockregionsstickyonly'] = 'Remarque : cette mise en page est limitée par le noyau de Moodle, ce qui empêche l’ajout direct de blocs. Toutefois, dès que vous activez une zone de blocs ici, les <a href="{$a}" target="_blank">blocs fixes du site</a> s’afficheront toujours sur cette mise en page.';
...
$string['brandcolor'] = 'Couleur principale de la marque';
$string['brandcolor_desc'] = 'La couleur principale de la marque. Elle est utilisée pour mettre en valeur certains éléments du site et sert également de base au calcul des dégradés de couleurs. De plus, elle est utilisée pour les liens et les boutons, sauf si vous définissez des couleurs différentes pour ces éléments dans les paramètres ci-dessous.';
$string['brandcolorsheading'] = 'Couleur principale';
$string['brandedgraytones'] = 'Utiliser des nuances de gris caractéristiques de la marque';
$string['brandedgraytones_desc'] = 'Avec ce paramètre, les nuances de gris Bootstrap utilisées dans l\'ensemble du thème sont dérivées de la couleur principale de la marque plutôt que de gris neutres. Cela crée une harmonie chromatique subtile entre tous les éléments gris de la page. Remarque : ce paramètre ne s\'applique que si une couleur principale de la marque a été configurée précédemment.';
$string['breadcrumbsheading'] = 'Fil d’Ariane';
$string['buttonbrandcolorsetting'] = 'Couleur de marque pour les boutons';
$string['buttonbrandcolorsetting_desc'] = 'Ce paramètre permet de définir une couleur de marque spécifique pour les boutons principaux. S\'il est laissé vide, la couleur de marque principale de Boost Union sera utilisée.';
$string['bycapability'] = 'Contrôlé par capacité';
...
Remarque : l’option « Ne rien changer » ne change rien au fil d’Ariane de la catégorie de cours tel qu’il est présenté par le cœur de Moodle. Alors que l’option « Non » veille à ce que les fils d’Ariane des catégories de cours ne soient jamais affichés du tout. Cela pourrait être une différence car Boost dans le cœur de Moodle pourrait en effet montrer des fils d’Ariane de catégorie de cours commençant sur des niveaux de catégorie de cours imbriqués plus profonds (ce que les développeurs de Boost Union considèrent comme un problème).';
...
$string['categorylistingpresentation_desc'] = 'Avec ce paramètre, vous pouvez modifier l\'apparence de la liste des catégories sur les pages d\'index des catégories et sur la page d\'accueil du site. Au lieu de la présentation proposée par le cœur de Moodle, vous pouvez présenter la liste des catégories sous forme d\'une liste actualisée de cases.';
$string['categorylistingpresentation_nochange'] = 'Le cauchemar du concepteur (inchangé tel que présenté par le cœur de Moodle)';
...
$string['courselistingpresentation_nochange'] = 'Le cauchemar du concepteur (inchangé tel que présenté par le cœur de Moodle)';
...
$string['courseoverviewimagefallback'] = 'Image de repli de l\'aperçu du cours';
$string['courseoverviewimagefallback_desc'] = 'L\'image que vous téléchargez ici servira d\'image de secours pour la page d\'aperçu du cours dès que le paramètre « Source de l\'image d\'aperçu du cours » aura été configuré en conséquence.<br />Remarque : si vous configurez le « Source de l\'image d\'aperçu du cours » pour utiliser l\'image de secours de la page d\'aperçu du cours, mais que vous ne téléchargez aucune image ici, le motif géométrique sera tout de même utilisé comme image de secours.';
$string['courseoverviewimageheading'] = 'Images de présentation du cours';
...
$string['emailbrandinginstructionli2li3'] = '<code>templateemailtextprefix</code> : cet extrait sera ajouté <em>au début / avant le corps</em> de tous les <em>courriels texte</em> que Moodle envoie.';
...
$string['emailbrandingpitfallsli1'] = 'Il est obligatoire de modifier les chaînes du pack de langue de la <em>langue par défaut actuelle</em> de ce site. Même si plusieurs paquetages de langue sont installés, seules les modifications apportées à la langue par défaut seront impactées.';
...
$string['emailbrandingpitfallsli3'] = 'Si vous modifiez la langue par défaut du site dans le futur, il faudra migrer les chaînes du paquetage de langue modifié vers le nouveau paquetage de langue par défaut.';
...
$string['emailbrandingtextintro'] = 'Aperçu d’un courriel en texte brut basé sur les préfixes et suffixes visuels actuellement définis dans le paquetage de langue.';
$string['emailbrandingtextnopreview'] = 'Jusqu’à présent, les courriels en texte brut n’ont pas été personnalisés dans cette fonctionnalité. Ils seront composés et envoyés normalement.';
...
$string['flavoursbootstrapcolorsuccess_help'] = 'Avec ce paramètre, la couleur choisie remplacera la couleur « success » de Bootstrap définie dans les paramètres d\'apparence de Boost Union.';
...
$string['imageposition_center_bottom'] = 'Centrer horizontalement, en bas verticalement';
...
$string['imageposition_left_center'] = 'À gauche horizontalement, centrer verticalement';
$string['imageposition_left_top'] = 'À gauche horizontalement, en haut verticalement';
$string['imageposition_right_bottom'] = 'À droite horizontalement, en bas verticalement';
$string['imageposition_right_center'] = 'À droite horizontalement, centrer verticalement';
$string['imageposition_right_top'] = 'À droite horizontalement, en haut verticalement';
...
$string['modiconsfilestech'] = 'Note technique : après avoir enregistré le paramètre, la structure du dossier téléchargé et les fichiers d’icônes seront copiés dans le dossier pix_plugins/mod de votre répertoire Moodledata. C’est là que le cœur de Moodle recherche des icônes d’activité personnalisées. Tous les fichiers d’icônes qui peuvent déjà exister à cet endroit seront écrasés lorsque ce paramètre sera enregistré.';
...
$string['navbarcolorsetting_light'] = 'Barre de navigation claire avec une couleur de police sombre (inchangée telle que présentée par le cœur de Moodle)';
...
$string['showhintcourseguestenrolsetting'] = 'Afficher un indice pour l\'accès anonyme';
$string['showhintcourseguestenrolsetting_always'] = 'Oui, même si un mot de passe d\'accès invité est défini.';
$string['showhintcourseguestenrolsetting_desc'] = 'Avec ce paramètre, une indication apparaîtra dans l\'en-tête du cours si celui-ci est visible et si l\'accès anonyme est actuellement possible.';
...
$string['smartmenusmenuitemicon_help'] = 'L\'icône à afficher à côté du titre de l\'élément de menu. Vous pouvez soit sélectionner une icône dans la bibliothèque d\'icônes de Moodle, soit utiliser une icône FontAwesome. Il existe une différence importante entre les deux : Les icônes Moodle : Moodle définit ses icônes comme des « icônes pix » et associe les icônes FontAwesome à ces icônes pix. L\'icône FontAwesome particulière qui est mappée n\'est pas garantie d\'être stable pour toujours et pourrait changer dans les futures versions du cœur de Moodle. De plus, il existe des icônes pix du cœur de Moodle auxquelles une couleur Bootstrap supplémentaire est ajoutée. </li><li>Icônes FontAwesome :<br />Les icônes FontAwesome sont utilisées telles quelles et leur présentation restera stable dans les futures versions de Moodle. Il se peut toutefois que le glyphe FontAwesome change si le cœur de Moodle passe à une future version de FontAwesome. Si vous avez des doutes et que vous n\'avez pas besoin de vous en tenir à une icône pix particulière du cœur de Moodle, il est préférable d\'utiliser ici une icône FontAwesome.';
...
$string['smartmenusmenuitemicon_sourcecore'] = 'Cœur de Moodle';
...
$string['upgradenotice_2025100623'] = 'Les options de couleur de la barre de navigation « Barre de navigation en couleur principale avec police foncée » et « Barre de navigation en couleur principale avec police claire » ont été renommées « Barre de navigation colorée avec police foncée » et « Barre de navigation colorée avec police claire ». Votre configuration existante a été mise à jour automatiquement. De plus, la couleur principale de votre marque a été transférée vers le nouveau paramètre « Teinte de la barre de navigation » afin de conserver l\'aspect visuel précédent.';
