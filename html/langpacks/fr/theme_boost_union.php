...
$string['faviconheading_desc'] = 'Remarque : Boost Union a son propre téléchargement de favicon et n’utilise pas le favicon du <a href="{$a}">paramètre de favicon du cœur de Moodle</a>.<br />Boost Union permet en particulier de remplacer le téléchargement de favicon par des variantes.';
...
$string['logosheading_desc'] = 'Remarque : Boost Union a son propre téléchargement de logo et n’utilise pas le logo du <a href="{$a}">paramètre de logo du cœur de Moodle</a>.<br />Boost Union permet en particulier de télécharger plus de formats d’images que le cœur de Moodle autorise et permet de remplacer les logos téléchargés dans ses variantes.';
