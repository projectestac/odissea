...
/**
 * Strings for component 'block_massaction', language 'fr', version '4.5'.
 *
...
$string['bulkeditingdisabled'] = 'Pour utiliser ce bloc, il faut activer le mode d’édition par lots.';
...
$string['duplicatefailed'] = 'Impossible de dupliquer le module de cours depuis l’identifiant « {$a} »';
...
$string['enablebulkediting'] = 'Activer l’édition par lots';
$string['event:course_modules_duplicated'] = 'Modules de cours dupliqués';
$string['event:course_modules_duplicated_failed'] = 'Échec de la duplication de modules de cours';
$string['event:duplicated_completed_list'] = 'Terminé : {$a->list}.';
$string['event:duplicated_description'] = 'cmid de « {$a->src} » vers « {$a->dst} »';
$string['event:duplicated_failed_description'] = 'Échec de la duplication du module de cours. cmid : « {$a->cmid} » erreur : « {$a->error} »';
$string['event:duplicated_failed_list'] = 'Échec : {$a->list}.';
$string['event:duplicated_summary'] = 'La duplication des modules de cours est terminée. Résumé : {$a->countcomplete} terminés, {$a->countfailed} en échec.';
$string['invalidaction'] = 'Action inconnue : {$a}';
$string['invalidcourseid'] = 'Id de cours non valide';
$string['invalidcoursemodule'] = 'Module de cours non valide';
$string['invalidmoduleid'] = 'Id du module non valide : {$a}';
$string['jsonerror'] = 'Erreur de codage : format JSON non valide';
...
$string['massaction:activityshowhide'] = 'Action par lots : afficher/cacher des modules';
$string['massaction:addinstance'] = 'Ajouter un bloc « Actions par lots »';
$string['massaction:delete'] = 'Action par lots : supprimer des modules';
$string['massaction:descriptionshowhide'] = 'Action par lots : afficher/cacher les descriptions';
$string['massaction:duplicate'] = 'Action par lots : dupliquer des modules';
$string['massaction:duplicatetocourse'] = 'Action par lots : dupliquer vers un cours';
$string['massaction:indent'] = 'Action par lots : indenter des modules';
$string['massaction:movetosection'] = 'Action par lots : déplacer vers une section';
...
$string['sectionrestricted'] = 'La section source est restreinte&nbsp;: vous n’êtes pas autorisé à appliquer une action aux activités de la section « {$a} ».';
