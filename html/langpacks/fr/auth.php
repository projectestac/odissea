...
$string['user_activatenotsupportusertype'] = 'auth: ldap user_activate() ne prend pas en charge le type d’utilisateur sélectionné {$a}';
$string['user_disablenotsupportusertype'] = 'auth: ldap user_disable() ne prend pas (encore) en charge le type d’utilisateur sélectionné';
