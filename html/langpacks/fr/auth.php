...
$string['auth_remove_user'] = 'Indiquer la procédure à effectuer durant une synchronisation avec un compte utilisateur interne lorsque le compte a été retiré de la source d’authentification externe. Seuls les utilisateurs suspendus sont automatiquement restaurés quand ils réapparaissent dans la source externe.';
