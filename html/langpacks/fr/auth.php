...
$string['auth_remove_user'] = 'Indiquer la procédure à effectuer durant une synchronisation avec un compte utilisateur interne lorsque le compte a été supprimé de la source d’authentification externe. Seuls les utilisateurs suspendus sont automatiquement restaurés quand ils réapparaissent dans la source externe.';
...
$string['auth_sync_suspended_key'] = 'Synchronisation de l’état de suspension local de l’utilisateur';
...
$string['user_disablenotsupportusertype'] = 'La fonction auth: ldap user_disable() ne prend pas (encore) en charge le type d’utilisateur sélectionné';
