...
/**
 * Strings for component 'gradereport_grader', language 'fr', version '4.5'.
 *
...
$string['collapsedcolumns'] = 'Colonnes repliées <span class="badge rounded-pill bg-primary text-white ms-1" data-collapse="count">{$a}</span>';
