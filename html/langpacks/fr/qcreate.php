...
/**
 * Strings for component 'qcreate', language 'fr', version '3.11'.
 *
 * @package     qcreate
 * @category    string
...
$string['noofquestionstotal_help'] = 'Ceci est le nombre total de questions que les élèves doivent créer. Ce nombre doit être égal ou supérieur au nombre minimum de questions requis';
