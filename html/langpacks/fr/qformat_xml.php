...
/**
 * Strings for component 'qformat_xml', language 'fr', version '4.4'.
 *
 * @package     qformat_xml
 * @category    string
...
$string['unsupportedexport'] = 'Le type de question {$a} n’est pas pris en charge par l’exportation XML';
...
$string['xmltypeunsupported'] = 'Le type de question {$a} n’est pas pris en charge par l’importation XML';
