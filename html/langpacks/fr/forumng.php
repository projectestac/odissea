...
/**
 * Strings for component 'forumng', language 'fr', version '4.5'.
 *
 * @package     forumng
 * @category    string
...
$string['alert_emailappendix'] = 'Vous recevez cette notification suite à une utilisation de votre adresse de courriel sur le forumNG pour signaler un courriel inadapté.';
...
$string['configreportunacceptable'] = 'Adresse de courriel pour le rapport des messages signalés comme offensants. Si aucune adresse de courriel n’est renseignée, la fonction "Signaler" sera désactivée, à moins qu’elle ne le soit au niveau d’un forum.';
...
$string['grading_max'] = 'Évaluation maximale';
$string['grading_min'] = 'Évaluation minimale';
...
$string['invalidemail'] = 'Cette adresse de courriel n’est pas valide. Veuillez entrer une adresse de courriel unique.';
$string['invalidemails'] = 'Cette adresse de courriel n’est pas valide. Veuillez entrez une ou plusieurs adresses, séparées par des espaces ou des points-virgules.';
...
$string['perforumoption'] = 'À configurer séparément pour chaque forum';
...
$string['reportingemail_help'] = 'Si cette adresse de courriel est fournie, alors un lien "Signaler" apparaît à côté de chaque message. Les utilisateurs peuvent cliquer sur le lien pour rapporter des messages offensifs. Les informations seront envoyées à cette adresse.<br>Si cette adresse de courriel n’est pas renseignée, la fonction de rapport ne sera pas disponible (à moins qu’une adresse spécifique au niveau du site ait été fournie).';
...
$string['selectordiscall'] = 'Voulez-vous inclure toutes les discussions affichées sur cette page, ou en sélectionner certaines ?';
