...
/**
 * Strings for component 'editor', language 'fr', version '4.5'.
 *
 * @package     editor
 * @category    string
...
$string['textmode'] = 'Vous êtes en MODE TEXTE. Cliquez sur le bouton [<>] pour retourner en MODE HTML.';
