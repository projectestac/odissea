...
/**
 * Strings for component 'block_dedication', language 'fr', version '3.11'.
 *
...
$string['show_dedication_help'] = 'Par défaut, le temps dédié n\'est visible que par les enseignants. Ce paramétrage permet aux étudiants de voir dans le bloc le temps qu\'ils ont consacré au cours.';
$string['sincerow'] = 'Du';
