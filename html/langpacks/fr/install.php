...
/**
 * Strings for component 'install', language 'fr', version '4.5'.
 *
 * @package     install
 * @category    string
...
$string['doyouagree'] = 'Le voulez-vous vraiment ? (yes/no) :';
...
$string['sessionautostarthelp'] = '<p>Moodle a besoin de la prise en charge des sessions. il ne fonctionnera pas sans cela.</p><p>Les sessions peuvent être activées dans le fichier « php.ini » de votre serveur, en changeant la valeur du paramètre <b>session.auto_start</b>.</p>';
