...
/**
 * Strings for component 'analytics', language 'fr', version '4.4'.
 *
 * @package     analytics
 * @category    string
...
$string['errornocontextrestrictions'] = 'La cible sélectionnée ne prend pas en charge les restrictions de contexte';
