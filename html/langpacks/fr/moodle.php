...
$string['defaulthomepageuser'] = 'Page d\'accueil';
$string['defaulthomepageuser_help'] = 'Votre page d\'accueil est le premier lien de la navigation.';
...
$string['emojicategorysmileyspeople'] = 'Émoticônes & personnes';
...
$string['eventdatabasetextfieldcontentreplaced'] = 'Recherche et remplacement global de la base de donnée';
...
$string['noteachingupcomingcourses'] = 'Des cours à venir n\'ont ni enseignant, ni élève';
...
$string['sessiontimeoutsoon'] = 'Votre session est sur le point d\'échoir. Voulez-vous étendre la durée de la session actuelle ?';
