...
/**
 * Strings for component 'gradingform_rubric', language 'fr', version '4.5'.
 *
...
$string['criterionduplicate'] = 'Dupliquer le critère';
...
$string['privacy:metadata:criterionid'] = 'Un identifiant pour un critère spécifique évalué.';
