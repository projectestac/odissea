...
/**
 * Strings for component 'qtype_formulas', language 'fr', version '4.4'.
 *
...
$string['error_fact_toolarge'] = 'Impossible de calculer {$a} ! sur cette plateforme, le résultat est plus grand que PHP_MAX_INT.';
...
$string['error_import_missing_field'] = 'Erreur d\'importation. Champ manquant : {$a}';
