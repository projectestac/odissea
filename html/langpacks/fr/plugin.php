...
/**
 * Strings for component 'plugin', language 'fr', version '4.1'.
 *
 * @package     plugin
 * @category    string
...
$string['validationmsg_versionphpsyntax'] = 'Syntaxe non prise en charge détectée dans le fichier version.php.';
