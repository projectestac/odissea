...
$string['aspectratiotootallorwide'] = 'L\'image importée a été enregistrée, mais veuillez vérifier, car elle peut être <strong> {$a->tallorwide} </strong>. Si cela ne semble pas correct, veuillez la recadrer aux dimensions standard du paysage et la téléverser à nouveau. Par exemple 300 de large x 200 de haut conviendraient.';
