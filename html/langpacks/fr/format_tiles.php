...
$string['allowsubtilesview_desc'] = 'Permet l’utilisation d’un réglage de cours qui, s’il est sélectionné, montre dans une tuile les activités (à l’exception des étiquettes) comme sous tuiles, au lieu d’une liste standard.';
...
$string['close'] = 'Fermer';
$string['closetopsection'] = 'Fermer la section supérieure';
...
$string['complete-y-auto'] = 'Élément achevé. Il a été marqué comme étant achevé lorsque vous avez rempli les critères d’achèvement. Vous ne pouvez pas le modifier manuellement.';
...
$string['customcssdesc'] = 'CSS personnalisé à appliquer au contenu de la section de cours lorsque le format de cours est utilisé. Ceci ne sera pas validé, alors prenez soin d’entrer un code valide. Par exemple : <p>.section { color: red; }</p><p>li.activity.subtile.resource.pdf { background-color: orange !important; }</p>';
...
$string['disabledbyadmin'] = 'Désactivé par l’administrateur du site';
...
$string['filteroutcomesrestore'] = 'Le cours d’origine utilisait les résultats dans la barre de filtre, qui ne sont pas encore pris en charge pendant le processus de restauration. Le réglage de la barre de filtre a donc été modifié dans le cours restauré. Si vous souhaitez utiliser les résultats pour filtrer les tuiles dans le cours restauré, veuillez configurer à nouveau les résultats. Le cours initial n’a pas été modifié.';
...
$string['followthemecolour_desc'] = 'Si défini à oui, les enseignants n’auront pas le choix par ce plugin et toutes les couleurs des tuiles ci-dessous seront ignorées. Au lieu de cela, on tentera d’obtenir la couleur principale du thème et d’utiliser cette couleur à la place.';
...
$string['icontitle-binoculars'] = 'Jumelles';
...
$string['nojswarning'] = 'Il semble que votre navigateur ne supporte pas JavaScript, ou celui-ci est désactivé. Une interface améliorée est disponible si vous activez JavaScript';
$string['none'] = 'Aucun';
...
$string['problemcourses'] = 'Cours ayant des problèmes';
...
$string['showseczerocoursewide_desc'] = 'Si coché, la section zéro (la section du haut) sera affichée sur la page d’accueil du cours et en haut de <b>chaque page de section du cours </b> (c’est-à-dire en haut du contenu de chaque tuile). Si la case n’est pas cochée (recommandé), elle ne sera affichée que sur la page d’accueil du cours.';
...
$string['usecourseindex_desc'] = 'Dans une tuile de cours, l’index du cours doit-il s’afficher à gauche ?';
