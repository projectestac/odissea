...
/**
 * Strings for component 'groupselect', language 'fr', version '4.5'.
 *
 * @package     groupselect
 * @category    string
...
$string['globalpassword_help'] = 'Définir un mot de passe global pour rejoindre les groupes, écrase des mots de passe définis par les étudiants.';
...
$string['hidegroupmembers'] = 'Cacher les membres du groupe pour les étudiants';
$string['hidegroupmembers_help'] = 'Si activé, tous les membres du groupe seront cachés pour les étudiants. Si les étudiants ont la capacité de gérer les groupes (moodle/course:managegroups) ou s\'ils peuvent accéder à tous les groupes (moodle/site:accessallgroups), les membres seront toujours affichés.';
$string['hidesuspendedstudents'] = 'Cacher les étudiants suspendus.';
$string['hidesuspendedstudents_help'] = 'Si coché, les étudiants suspendus seront retranchés du nombre d\'utilisateurs et enlevé des listes de groupes.';
...
$string['studentcancreate_help'] = 'Si défini, les étudiants sans groupe (dans le groupement sélectionné) peuvent créer des groupes. Cette permission peut être activée par la suite dans les capacités de rôle.';
