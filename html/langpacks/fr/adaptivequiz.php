...
$string['maximumquestions_help'] = 'Le nombre maximal de questions que l’étudiant peut tenter';
...
$string['minimumquestions_help'] = 'Le nombre minimum de questions que l’étudiant doit tenter';
...
$string['startinglevel_help'] = 'Lorsque l’étudiant commence une tentative, l’activité sélectionnera au hasard une question correspondant au niveau de difficulté';
