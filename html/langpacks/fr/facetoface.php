...
$string['error:couldnotcopysession'] = 'Echec de la copie de session';
$string['error:couldnotdeletesession'] = 'Echec de la suppression de session';
$string['error:couldnotupdatemanageremail'] = 'Echec de la mise à jour de l\'adresse courriel de votre responsable';
$string['error:couldnotupdatesession'] = 'Echec de la mise à jour de la session';
