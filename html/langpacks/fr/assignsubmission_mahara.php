...
/**
 * Strings for component 'assignsubmission_mahara', language 'fr', version '4.4'.
 *
...
$string['errorinvalidhost'] = 'ID d’hôte non valide sélectionné';
$string['errorinvalidstatus'] = 'Erreur développeur : statut de remise non valide envoyé à assign_submission_mahara::set_mahara_submission_status()';
