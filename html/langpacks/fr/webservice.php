...
/**
 * Strings for component 'webservice', language 'fr', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['invalidiptoken'] = 'Jeton non valide. Votre IP n’est pas prise en charge.';
$string['invalidtimedtoken'] = 'Jeton non valide (arrivé à échéance)';
$string['invalidtoken'] = 'Jeton non valide (introuvable)';
