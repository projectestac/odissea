...
/**
 * Strings for component 'h5p', language 'fr', version '3.11'.
 *
 * @package     h5p
 * @category    string
...
$string['filter_displayh5p_description'] = 'Le filtre d\'affichage H5P converti les URLs en contenu H5P intégré.';
...
$string['lockh5pdeploy'] = 'Ce contenu H5P n\'est pas accessible car il est en cours de déploiement. Veuillez essayer plus tard.';
...
$string['missingmbstring'] = 'L\'extension PHP  mbstring n\'est pas chargé. Elle est requise pour une fonctionnement correct de H5P.';
