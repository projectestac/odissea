...
/**
 * Strings for component 'qformat_blackboard_six', language 'fr', version '4.5'.
 *
...
$string['pluginname_help'] = 'Le format Blackboard permet d’importer des questions enregistrées dans tous les formats d’exportation de Blackboard, en fichier DAT ou ZIP. Pour les fichiers ZIP, l’importation des images est pris en charge.';
$string['privacy:metadata'] = 'Le plugin de format de question Blackboard n’enregistre aucune donnée personnelle.';
$string['unhandledpresblock'] = 'Bloc de présentation non pris en charge';
