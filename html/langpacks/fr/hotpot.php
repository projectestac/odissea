...
/**
 * Strings for component 'hotpot', language 'fr', version '4.4'.
 *
 * @package     hotpot
 * @category    string
...
$string['privacy:metadata:hotpot_attempts:attempt'] = 'La tentative indique le nombre de tentatives de l\'utilisateur.';
$string['privacy:metadata:hotpot_attempts:clickreportid'] = 'Le champ « clickreportid » indiquant l\'identifiant du rapport du clic effectué par l\'utilisateur.';
$string['privacy:metadata:hotpot_attempts:endtime'] = 'L\'heure de fin indiquant quand les tentatives ont été interrompues par l\'utilisateur.';
$string['privacy:metadata:hotpot_attempts:hotpotid'] = 'L\'identifiant des tentatives d\'activités HotPot';
$string['privacy:metadata:hotpot_attempts:penalties'] = 'Les sanctions indiquant les sanctions infligées pour les tentatives de l\'utilisateur';
$string['privacy:metadata:hotpot_attempts:score'] = 'Le score indiquant le score obtenu pour les tentatives de l\'utilisateur.';
$string['privacy:metadata:hotpot_attempts:starttime'] = 'L\'heure de début indiquant quand l\'utilisateur a commencé ses tentatives.';
$string['privacy:metadata:hotpot_attempts:status'] = 'Le statut indiquant l\'état des tentatives effectuées par l\'utilisateur';
$string['privacy:metadata:hotpot_attempts:timefinish'] = 'L\'heure indiquant quand l\'utilisateur a mis fin à ses tentatives.';
...
$string['privacy:metadata:hotpot_attempts:userid'] = 'L\'identifiant de l\'utilisateur tente des activités HotPot.';
