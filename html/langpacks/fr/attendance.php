...
$string['enablewarnings_desc'] = 'Cela permet de définir un ensemble d’avertissement pour une participation et d’envoyer des notifications par courriel aux utilisateurs lorsque la participation tombe en dessous du seuil configuré. <br/><strong> ATTENTION : il s’agit d’une nouvelle fonctionnalité qui n’a pas été testée de manière approfondie. Utilisez-le à vos propres risques et faites des retours dans les forums Moodle si vous estimez que cela fonctionne bien. </strong>';
...
$string['invalidimportfile'] = 'Format de fichier non valide';
...
$string['invalidstatus'] = 'Vous avez sélectionner un statut non valide, merci de réessayer';
...
$string['onactivitycompletion'] = 'À la fin de l’activité';
