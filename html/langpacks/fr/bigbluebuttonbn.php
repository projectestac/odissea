...
$string['config_checksum_algorithm'] = 'Algorithme de somme de contrôle BigBlueButton';
$string['config_checksum_algorithm_description'] = 'L\'algorithme de somme de contrôle de votre serveur BigBlueButton (SHA1 garantit la compatibilité avec d\'anciennes versions du serveur, mais est moins sûr, tandis que SHA512 est conforme à FIPS 140-2).';
...
$string['taskname:check_dismissed_recordings'] = 'Vérifier les enregistrements ignorés';
...
$string['view_message_conference_user_limit_reached'] = 'Le nombre maximal d\'utilisateurs dans une session a été atteint';
