...
/**
 * Strings for component 'questionnaire', language 'fr', version '4.5'.
 *
...
$string['allresponses'] = 'Toutes les réponses';
...
$string['autodeletereponse'] = 'Supprimer automatiquement les réponses après [?]';
$string['autodeletereponse_desc'] = 'Activez ce paramètre pour supprimer automatiquement les anciennes réponses en fonction du délai défini dans « Supprimer les anciennes réponses après ». Désactivez-le pour conserver toutes les réponses.';
...
$string['cleanrecylebin'] = 'Vider la « corbeille » du questionnaire';
...
$string['closed'] = 'Fermé le {$a}.';
$string['closedate'] = 'Autoriser les réponses jusqu’au';
$string['closesat'] = 'Fermeture le {$a}';
...
$string['configremoveoldresponses'] = 'Paramètre qui sera utilisé par défaut pour tous les nouveaux questionnaires.';
...
$string['confirmdelpermanentlyq'] = 'Voulez-vous vraiment supprimer définitivement cette question ?';
...
$string['couldnotdelrespby'] = 'Impossible de supprimer la réponse {$a->rid} de {$a->user}';
...
$string['deletepermanentlybutton'] = 'Supprimer définitivement la question';
$string['deletequestionsolderthan'] = 'Supprimer les questions datant de plus de';
$string['deleteresp'] = 'Supprimer ces réponses';
$string['deletesection'] = 'Supprimer cette section';
$string['deletesettingdescription'] = 'La tâche planifiée supprimera les questions se trouvant dans la zone de suppression qui datent de plus de ce nombre de jours';
$string['deletingresp'] = 'Suppression des réponses';
$string['deletionquetions'] = 'Zone de suppression des questions';
$string['deletionquetions_help'] = 'Les questions supprimées ou devenues orphelines seront d\'abord déplacées ici plutôt que d\'être supprimées définitivement. Ces questions peuvent être supprimées définitivement soit manuellement, en cliquant sur l\'icône « X », soit automatiquement par le système au bout d\'une semaine. Utiliser le bouton « flèche vers le haut » pour restaurer la question.';
...
$string['enterpossibleanswers'] = 'Saisir les réponses possibles';
...
$string['file'] = 'Fichier';
$string['file_help'] = 'Permettre à l\'utilisateur de télécharger un fichier (seuls les formats simples et sans risque de virus sont autorisés)';
...
$string['fullsubmissions'] = 'Soumissions complètes';
...
$string['id'] = 'Identifiant utilisateur';
...
$string['printbutton'] = 'Imprimer';
$string['printstrictdateformatting'] = 'Entrez la date';
...
$string['recylebindisabled'] = '<span class="timedeletednext7days">La suppression automatique est désactivée</span>';
...
$string['removeoldresponses'] = 'Supprimer les anciennes réponses';
$string['removeoldresponses_help'] = 'Le système peut supprimer automatiquement les réponses après un certain laps de temps.';
$string['removeoldresponsesafter'] = 'Supprimer les anciennes réponses après';
$string['removeoldresponsesdefault'] = 'Ne jamais supprimer';
...
$string['responses_breakdown'] = '(Réponses : {$a->responses} | En cours : {$a->incomplete})';
$string['responsesnotsubmitted'] = 'Réponses non envoyées';
...
$string['restorebutton'] = 'Récupérer cette question';
...
$string['studentwhoresponded'] = 'Les étudiants qui ont répondu';
...
$string['timedeletednext7days'] = '<span class="timedeletednext7days">Date de suppression définitive : dans la nuit du {$a}</strong>';
$string['title'] = 'Titre';
...
$string['useridnumber'] = 'Identifiant utilisateur';
...
$string['viewallxresponses'] = 'Afficher toutes les réponses {$a}';
