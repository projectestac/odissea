...
/**
 * Strings for component 'auth_db', language 'fr', version '4.5'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbsuspenduser'] = 'Utilisateur {$a->name} id {$a->id} suspendu';
...
$string['auth_dbsyncuserstask'] = 'Synchronisation des utilisateurs via DB';
