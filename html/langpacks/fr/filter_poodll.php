...
/**
 * Strings for component 'filter_poodll', language 'fr', version '4.5'.
 *
...
$string['cloudpoodllserver_details'] = 'Le serveur à utiliser pour Cloud Poodll. Ne modifiez cette option que si Poodll en a fourni un autre.';
...
$string['displaysubs'] = '{$a->subscriptionname} : se termine le {$a->displayexpiredate}';
...
$string['invalidresponse'] = 'Réponse non valide ou échec de la connexion';
...
$string['nosubtitlesyet'] = 'Les sous-titres ne sont pas (encore) disponibles';
$string['notokenincache'] = 'Actualisez pour voir les informations de licence. Contactez le support Poodll en cas de problème.';
$string['novalidsubscription'] = 'Aucun abonnement valide.';
...
$string['ppn_mod_readaloud'] = 'À voix haute';
...
$string['recui_settings'] = 'Paramètres';
$string['recui_silencelevel'] = 'Niveau de silence';
$string['recui_soundtest'] = 'Test sonore';
