...
/**
 * Strings for component 'tool_moodlenet', language 'fr', version '4.5'.
 *
...
$string['removalwarning_feature'] = 'Si vous avez besoin de continuer à utiliser MoodleNet, contactez l’administrateur de votre site pour mettre en place un instance MoodleNet auto-hébergée.';
$string['removalwarning_service'] = 'Après cette date, il ne sera plus possible de parcourir ni de télécharger de contenus du site web MoodleNet.';
$string['removalwarning_title'] = 'Le service MoodleNet sera fermé le 20 avril 2026.';
