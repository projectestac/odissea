...
/**
 * Strings for component 'form', language 'gl', version '4.5'.
 *
 * @package     form
 * @category    string
...
$string['privacy:metadata:preference:filemanager_recentviewmode'] = 'Modo de vista seleccionado recentemente do elemento del Selector de ficheiros.';
