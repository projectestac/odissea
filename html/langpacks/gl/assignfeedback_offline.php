...
/**
 * Strings for component 'assignfeedback_offline', language 'gl', version '4.5'.
 *
...
$string['gradesfile_help'] = 'Follas de cálculo con cualificacións modificadas. Este ficheiro debe ser un csv descargado dende esta tarefa e debe conter columnas para a cualificación do alumnos e identificador. A codificación do ficheiro debe de ser &quot;UTF-8&quot;';
...
$string['ignoremodified_help'] = 'Cando se descarga de Moodle a folla de cualificacións, esta contén a última data de modificación de cada unha das cualificacións. Se se actualiza algunha das cualificacións en Moodle após que se teña descargado esta folla, de xeito predeterminado Moodle rexeitará sobrescribir esta información actualizada ao importar as cualificacións. Ao seleccionar esta opción, desactivarase en Moodle esta comprobación de seguridade e entón será posíbel que cando hai varios correctores estes poidan sobrescribirse uns a outros as súas cualificacións.';
