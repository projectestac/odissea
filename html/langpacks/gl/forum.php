...
/**
 * Strings for component 'forum', language 'gl', version '3.8'.
 *
 * @package     forum
 * @category    string
...
$string['addtofavourites'] = 'Iniciar a esta discusión';
...
$string['allowsdiscussions'] = 'Este foro permítelle a calquera comezar un tema discusión.';
...
$string['cannotadddiscussiongroup'] = 'Non é quen de crear unha discusión porque non é membro de ningún grupo.';
...
$string['cannotdeletediscussioninsinglediscussion'] = 'Non pode eliminar o primeiro comentario nunha única discusión';
...
$string['cannotfavourite'] = 'Sentímolo, pero non ten permiso para destacar as discusións.';
...
$string['cannotpindiscussions'] = 'Sentímolo, pero non ten permiso para fixar discusións.';
...
$string['clicktofavourite'] = 'Vostede non destacou esta discusión. Prema para destacala.';
$string['clicktolockdiscussion'] = 'Prema para bloquear esta discusión';
$string['clicktosubscribe'] = 'Non está subscrito a esta discusión. Prema para subscribirse.';
$string['clicktounfavourite'] = 'Vostede destacou esta discusión. Prema para retirarlle o destaque.';
$string['clicktounlockdiscussion'] = 'Prema para desbloquear esta discusión';
...
$string['discussionlistsortbycreatedasc'] = 'Ordenar a lista de discusións pola data de creación en orde ascendente';
$string['discussionlistsortbycreateddesc'] = 'Ordenar a lista de discusións pola data de creación en orde descendente';
...
$string['discussionlistsortbylastpostasc'] = 'Ordenar a lista de discusións pola data de creación da última publicación en orde ascendente';
$string['discussionlistsortbylastpostdesc'] = 'Ordenar a lista de discusións pola data de creación da última publicación en orde descendente';
$string['discussionlistsortbyrepliesasc'] = 'Ordenar a lista de discusións polo número de respostas en orde ascendente';
$string['discussionlistsortbyrepliesdesc'] = 'Ordenar a lista de discusións polo número de respostas en orde descendente';
...
$string['discussionsplit'] = 'A discusión foi separada';
...
$string['discussionsubscription_help'] = 'Ao subscribirse a unha discusión, recibirá notificacións de novos comentarios para esa discusión.';
...
$string['duedate_help'] = 'Isto é cando se debe publicar no foro. Aínda que esta data aparece no calendario como data límite do foro, a publicación aínda se permitirá após esta data. Estabeleza unha data de corte do foro para evitar a publicación no foro após de certa data (límite) de entrega.';
...
$string['errorcannotlock'] = 'Non ten permiso para bloquear as discusións.';
...
$string['exportdiscussion'] = 'Exportar a discusión enteira ao portafolios';
...
$string['forum:cantogglefavourite'] = 'Destacar discusións';
...
$string['forumbodyhidden'] = 'Non pode ver este comentario, probabelmente porque aínda non enviou mensaxes sobre o tema, porque aínda non transcorreu o tempo máximo para editar a discusión, a discusión non comezou ou xa caducou.';
...
$string['maxtimehaspassed'] = 'O tempo máximo para editar este comentario ({$a}) xa caducou!';
...
$string['pindiscussion'] = 'Fixar esta discusión';
...
$string['privacy:metadata:preference:forum_discussionlistsortorder'] = 'O método de ordenación preferido da lista de discusións';
...
$string['removefromfavourites'] = 'Retirar o destaque desta discusión';
...
$string['showingcountoftotaldiscussions'] = 'Amosando {$a->count} de {$a->total} discusións';
...
$string['subscriptionmode_help'] = 'Cando un participante está subscrito a un foro significa que recibirá notificacións das novas mensaxes do foro. Hai 4 opcións de modo de subscrición:
...
$string['unlockdiscussion'] = 'Desbloquear esta discusión';
$string['unpindiscussion'] = 'Desprender esta discusión';
