...
/**
 * Strings for component 'scorm', language 'gl', version '4.4'.
 *
 * @package     scorm
 * @category    string
...
$string['autocontinue_help'] = 'Esta preferencia estabelece a continuación automática predeterminada da actividade';
...
$string['cachedef_elements'] = 'Caché de elementos';
...
$string['compatibilitysettings'] = 'De estar activada, os obxectos de aprendizaxe inícianse automaticamente, en caso contrario, debe usarse o botón Continuar.';
$string['completed'] = 'Completado';
$string['completiondetail:allscos'] = 'Facer todas as partes desta actividade';
$string['completiondetail:completionscore'] = 'Recibir unha puntuación de {$a} ou máis';
$string['completiondetail:completionstatuscompleted'] = 'Completar a actividade';
$string['completiondetail:completionstatuscompletedorpassed'] = 'Completar ou aprobar a actividade';
$string['completiondetail:completionstatuspassed'] = 'Aprobar a actividade';
...
$string['completionstatusallscos'] = 'Todos os SCO deben devolver o estado de finalización';
...
$string['displaycoursestructure_help'] = 'Esta preferencia estabelece o valor predeterminado para presentar a estrutura do curso no axuste da páxina de entrada';
...
$string['invalidstatus'] = 'Estado non válido';
...
$string['largetrackupgrade'] = 'Este seguinte paso de actualización pode levar algún tempo para completarse, o seu sitio ten {$a} rexistros de pista SCORM que precisan ser migrados á nova estrutura da táboa, teña paciencia xa que non se pode amosar unha barra de progreso.';
...
$string['lastattemptlock_help'] = 'De estar activado, impídeselle ao alumno iniciar o reprodutor SCORM despois de usar todos os intentos designados para el.';
...
$string['masteryoverride_help'] = 'Se o activa, e se fornece unha puntuación por mestría, cando se chame a LMSFinish e se teña estabelecida unha puntuación en bruto, volverá calcularse o estado usando a a puntuación en bruto e a puntuación por mestría; e anularase calquera estado fornecido polo SCORM (incluíndo «incompleto»).';
...
$string['privacy:metadata:aicc:externalpurpose'] = 'Este complemento envía datos externamente utilizando o AICC HACP.';
...
$string['privacy:metadata:scorm_attempt'] = 'Os intentos de SCORM realizados por un usuario';
...
$string['scormstandarddesc'] = 'Cando está desactivado, Moodle permite que os paquetes de SCORM 1.2 almacenen máis que a especificación que permite e utiliza a configuración do formato de nome completo de Moodle ao pasar o nome do usuario ao paquete SCORM.';
...
$string['trackweight_help'] = 'Ponderación asignada ao elemento';
$string['type'] = 'Tipo';
