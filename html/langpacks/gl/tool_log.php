...
/**
 * Strings for component 'tool_log', language 'gl', version '4.1'.
 *
 * @package     tool_log
 * @category    string
...
$string['exportlogdetail'] = 'Incluír os rexistros relacionados co usuario ao exportar.';
...
$string['privacy:request:origin:restore'] = 'Estase a restaurar a copia de seguridade';
$string['privacy:request:origin:web'] = 'Solicitude web estándar';
$string['privacy:request:origin:ws'] = 'Apli móbil ou servizo web';
