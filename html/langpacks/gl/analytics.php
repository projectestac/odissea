...
/**
 * Strings for component 'analytics', language 'gl', version '3.8'.
 *
 * @package     analytics
 * @category    string
...
$string['errorinvalidtimesplitting'] = 'División de tempo non válida; Asegúrese de engadir o nome de clase completamente cualificado.';
...
$string['insightinfomessagehtml'] = 'O sistema xerou unha idea para vostede.';
$string['insightinfomessageplain'] = 'O sistema xerou algunhas ideas para vostede: {$a}';
$string['insightmessagesubject'] = 'Nova idea para «{$a}»';
$string['invalidanalysablefortimesplitting'] = 'Non é posíbel analizar usando o método {$a} de dividir o tempo.';
$string['invalidtimesplitting'] = 'O modelo co ID {$a} necesita un método de división de tempo antes de que poida ser usado para o adestramento.';
...
$string['predictionsprocessor_help'] = 'Un procesador de predicións é a «infraestrutura» de aprendizaxe automática que procesa os conxuntos de datos xerados por indicadores e obxectivos de cálculo de modelos. Cada modelo pode usar un procesador diferente. O indicado aquí será o predeterminado.';
...
$string['privacy:metadata:analytics:predictions:rangeindex'] = 'O índice do método para dividir o tempo';
...
$string['timesplittingmethod_help'] = 'O método de división de tempo define cando o sistema calculará as predición e a porción dos rexistros de actividade que se considerarán para esas predicións. Por exemplo, a duración do curso pode dividirse en partes, cunha predición xerada ao final de cada parte.';
