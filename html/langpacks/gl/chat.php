...
/**
 * Strings for component 'chat', language 'gl', version '4.5'.
 *
 * @package     chat
 * @category    string
...
$string['chat:view'] = 'Ver a actividade de conversa';
...
$string['configmethod'] = 'O método de conversa AJAX fornece unha interface baseada en AJAX, contacta regularmente co servidor para actualización. O método normal de conversa implica que os clientes contactan regularmente para as actualizacións. Non require configuración e funciona en calquera sitio pero pode producir unha longa carga no servidor con moitos participantes. Usar un servizo de servidor require acceso ao shell en Unix, mais resulta ser un contorno de conversa rapidamente escalábel.';
$string['confignormalupdatemode'] = 'As actualizacións das salas de conversa funcionan eficientemente usando a característica <em>Manter vivo</em> de HTTP 1.1 mais isto resulta pesado no lado do servidor. Un método máis avanzado é usar a estratexia de <em>Fluxo</em> para que aflúan as actualizacións aos usuarios. O uso de <em>Fluxo</em> escala moito mellor (semellante ao método chatd) mais pode ser que o seu servidor non sexa compatíbel.';
...
$string['messagebeepseveryone'] = '{$a} pitos para todos!';
...
$string['privacy:metadata:chat_users'] = 'Mantén o control de que usuarios están en que salas de conversa';
$string['privacy:metadata:chat_users:firstping'] = 'Momento do primeiro acceso á sala de conversa';
$string['privacy:metadata:chat_users:ip'] = 'IP do usuario';
$string['privacy:metadata:chat_users:lang'] = 'Idioma do usuario';
$string['privacy:metadata:chat_users:lastmessageping'] = 'Momento da última mensaxe nesta sala de conversa';
$string['privacy:metadata:chat_users:lastping'] = 'Momento do último acceso á sala de conversa';
$string['privacy:metadata:chat_users:userid'] = 'O ID do usuario';
$string['privacy:metadata:chat_users:version'] = 'Como accedeu o usuario á conversa (sockets/basic/ajax/header_js)';
$string['privacy:metadata:messages'] = 'Un rexistro das mensaxes enviadas durante unha sesión de conversa';
$string['privacy:metadata:messages:issystem'] = 'Se a mensaxe é unha mensaxe xerada polo sistema';
$string['privacy:metadata:messages:message'] = 'A mensaxe';
$string['privacy:metadata:messages:timestamp'] = 'O momento no que se enviou a mensaxe.';
$string['privacy:metadata:messages:userid'] = 'O ID de usuario do autor da mensaxe';
...
$string['usingchat_help'] = 'O módulo de conversa contén algunhas características para conversar de xeito un pouco máis agradábel.

* Sorrisos - Calquera sorriso (emoticonas) que poida escribir noutro lugar tamén en Moodle a poderá escribir, por exemplo :-)
