...
/**
 * Strings for component 'chat', language 'gl', version '3.8'.
 *
 * @package     chat
 * @category    string
...
$string['privacy:metadata:chat_messages_current'] = 'Sesión actual de conversa. Este dato é temporal e elimínase após de que se elimine a sesión de conversa';
