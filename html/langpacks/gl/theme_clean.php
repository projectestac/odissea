...
/**
 * Strings for component 'theme_clean', language 'gl', version '3.8'.
 *
 * @package     theme_clean
 * @category    string
...
<div class="well">
<h3>Sobre</h3>
<p>Clean (limpo) é un tema de arrinque (botstrap) modificado de Moodle que herda e redebuxa os estilos do seu tema precursor.</p>
<h3>Precursores</h3>
<p>Este tema está baseado no Tema Bootstrap, que foi creado para Moodle 2.5, coa axuda de:<br>
Stuart Lamour, Mark Aberdour, Paul Hibbitts, Mary Evans.</p>
<h3>Créditos do tema</h3>
<p>Autores:   Bas Brands, David Scotson, Mary Evans<br>
Contacto:  bas@sonsbeekmedia.nl<br>
Sitio web: <a href="http://www.basbrands.nl">www.basbrands.nl</a>
</p>
<h3>Informes de erros:</h3>
