...
/**
 * Strings for component 'tool_generator', language 'gl', version '3.11'.
 *
...
espazo do sistema de ficheiros (decenas de gigabytes). Terá que eliminar os cursos
...
$string['error_noforumdiscussions'] = 'O curso seleccionado non contén debate no foro';
...
$string['updateuserspassword_help'] = 'JMeter precisa iniciar sesión como usuario do curso, pode configurar o contrasinal dos usuarios usando $CFG->tool_generator_users_password en config.php; este axuste actualiza o contrasinal dos usuarios do curso segundo $CFG->tool_generator_users_password. Pode ser útil se usa un curso non xerado por tool_generator ou $CFG->tool_generator_users_password ou se non foi estabelecido cando creou os cursos de proba.';
