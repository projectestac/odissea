...
/**
 * Strings for component 'auth_ldap', language 'gl', version '4.4'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_bind_dn'] = 'Se quere empregar «bind-user» para buscar usuarios, especifíqueo aquí. Algo como «cn=usuarioldap,ou=publico,o=org»';
...
$string['auth_ldap_passwdexpire_settings'] = 'Axustes da caducidade do contrasinal LDAP.';
...
$string['privacy:metadata'] = 'O engadido de autenticación do servidor LDAP non almacena ningún dato persoal.';
...
$string['syncroles'] = 'Sincronizar os roles do sistema dende LDAP';
$string['synctask'] = 'Traballo de sincronización de usuarios LDAP';
$string['systemrolemapping'] = 'Asignación de roles do sistema';
