...
/**
 * Strings for component 'assign', language 'gl', version '3.8'.
 *
 * @package     assign
 * @category    string
...
$string['attemptreopenmethod_help'] = 'Determina como os intentos de entrega se reabren. As opcións dispoñíbeis son: <ul><li>Nunca - A entrega do alumno non se pode reabrir. </li><li>Manualmente - A entrega do alumno pódea reabrir un profesor. </li><li>Automaticamente ata aprobar - A entrega do alumno reábrese automaticamente ata que o alumno acada o nivel para aprobar respecto do valor estabelecido no libro de cualificacións (categorías e ítems de sección) para esta tarefa. </li></ul>';
...
$string['extensionnotafterfromdate'] = 'A data da ampliación ser posterior a data de inicio das entregas';
...
$string['sendstudentnotifications_help'] = 'Se está activado, os estudantes reciben unha mensaxe sobre a cualificación actualizada ou o comentario. Se o fluxo de traballo de cualificación está activado nesta tarefa, non se enviarán notificacións ata que a cualificación sexa «publicada»".';
...
$string['submissionstatement_help'] = 'Declaración que o alumno debe aceptar para enviar o seu traballo';
