...
/**
 * Strings for component 'folder', language 'gl', version '4.4'.
 *
 * @package     folder
 * @category    string
...
$string['display'] = 'Presentar o contido do cartafol';
...
$string['displayinline'] = 'Na páxina do curso';
...
* Para unha serie de ficheiros sobre un tema único, por exemplo un conxunto de antigos exames en formato PDF ou unha colección de ficheiros de imaxe para proxectos dos alumnos
...
$string['showdownloadfolder_help'] = 'Se o configura como «si», amosarase un botón para permitir descargar o contido do cartafol nun arquivo ZIP.';
