...
/**
 * Strings for component 'enrol', language 'gl', version '4.4'.
 *
 * @package     enrol
 * @category    string
...
$string['enrolment'] = 'Matriculación';
...
$string['eventuserenrolmentupdated'] = 'Matriculación de usuarios actualizada';
...
$string['noguestaccess'] = 'Os convidados non poden acceder a este curso. Inicie sesión neste sitio.';
$string['none'] = 'Ningún';
$string['notenrollable'] = 'Non pode matricularse neste curso.';
...
$string['rolefromsystem'] = '{$a->role} (Asignado a nivel do sitio)';
...
$string['timeended'] = 'Rematou o tempo';
$string['timeenrolled'] = 'Tempo matriculado';
$string['timereaggregated'] = 'Tempo reagrupado';
$string['timestarted'] = 'Tempo iniciado';
...
$string['unenrolme'] = 'Desmatricularme deste curso';
$string['unenrolnotpermitted'] = 'Non ten permiso para dar desmatricular a este usuario do curso.';
