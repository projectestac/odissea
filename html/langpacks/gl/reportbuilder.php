...
/**
 * Strings for component 'reportbuilder', language 'gl', version '4.5'.
 *
...
$string['customreportslimit_desc'] = 'O número de informes personalizados pode estar limitado por razóns de rendemento. Se se establece a cero, entón non hai límite.';
$string['customreportsliveediting'] = 'Informes personalizados edición en directo';
$string['customreportsliveediting_desc'] = 'Se está activado, os usuarios poden ver os datos dos informes mentres editan o informe. Isto pode ser desactivado por razóns de rendemento.';
$string['customreportsliveeditingdisabled'] = 'A vista dos datos dos informes mentres se edita está desactivada pola administración do sitio. Cambie ao modo de vista previa para ver o informe.';
$string['customreportssettings'] = 'Axustes do informe personalizado';
...
$string['filterdatepast'] = 'No pasado';
