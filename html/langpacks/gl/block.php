...
/**
 * Strings for component 'block', language 'gl', version '4.5'.
 *
 * @package     block
 * @category    string
...
$string['moveblockinregion'] = 'Mover o bloque para a área {$a}';
...
$string['privacy:metadata:userpref:hiddenblock'] = 'Rexistra cando o usuario contrae/agocha un bloque';
$string['privacy:request:blockisdocked'] = 'Indica se o bloque estaba ancorado';
$string['privacy:request:blockishidden'] = 'Indica se o bloque estaba agochado/contraído';
$string['region'] = 'Área';
