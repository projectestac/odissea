...
/**
 * Strings for component 'filter_tex', language 'gl', branch 'MOODLE_38_STABLE'
 *
 * @package   filter_tex
...
$string['privacy:metadata'] = 'O engadido de notación en TeX non almacena ningún dato persoal.';
