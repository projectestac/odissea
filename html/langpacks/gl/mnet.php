...
$string['couldnotgetcert'] = 'Non se atopou ningún certificado en <br />{$a}. <br />O servidor pode estar caído ou incorrectamente configurado.';
...
$string['deletedhosts'] = 'Servidores eliminados: {$a}';
...
$string['invalidaccessparam'] = 'Parámetro de acceso incorrecto.';
$string['invalidactionparam'] = 'Parámetro de acción non válido.';
$string['invalidhost'] = 'Forneza un identificador de servidor correcto';
$string['invalidpubkey'] = 'A chave non é unha chave SSL correcta. ({$a})';
$string['invalidurl'] = 'Parámetro URL incorrecto.';
$string['ipaddress'] = 'Enderezo IP';
$string['is_in_range'] = 'O enderezo IP <code>{$a}</code> constitúe un servidor de confianza válido.';
$string['ispublished'] = '{$a} Moodle activou este servizo para Vostede.';
$string['issubscribed'] = '{$a} Moodle estase subscribindo a este servizo do seu servidor.';
$string['keydeleted'] = 'A súa chave eliminouse e substituíuse satisfactoriamente.';
$string['keymismatch'] = 'A chave pública que posúe para este servidor é diferente da publicada neste momento. A chave publicada actual é:';
...
$string['loginlinkmnetuser'] = '<br />Se é un usuario remoto de MNet e pode <a href="{$a}">confirmar o seu enderezo de correo aquí</a>, pode ser redirixido á súa páxina de acceso.<br />';
...
$string['mnetdisabled'] = 'MNet está <strong>desactivada</strong>.';
...
$string['mnetsettings'] = 'Axustes da rede Moodle';
$string['moodle_home_help'] = 'A ruta da páxina principal de MNet no servidor remoto, como por exemplo: /moodle/.';
$string['name'] = 'Nome';
$string['net'] = 'Rede';
...
$string['nonmatchingcert'] = 'O titular do certificado: <br /><em>{$a->subject}<br />non coincide co servidor de que procede:<br /><em>{$a->host}</em>.';
$string['nopubkey'] = 'Produciuse un problema durante o proceso de recuperación da chave pública.<br />Talvez o servidor non acepte a rede de Moodle ou a chave non sexa válida.';
...
$string['nosuchpublickey'] = 'Non é posíbel obter a chave pública para a verificación da sinatura.';
...
$string['notBASE64'] = 'Esta cadea non está en formato codificado Base64. Non pode ser unha chave correcta.';
...
$string['phperror'] = 'Un erro interno de PHP impediu completar a súa solicitude.';
$string['position'] = 'Posición';
$string['postrequired'] = 'A función eliminada require unha soliciyude POST.';
...
$string['selectahost'] = 'Seleccione un servidor remoto.';
