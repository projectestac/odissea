...
/**
 * Strings for component 'questionnaire', language 'gl', version '4.5'.
 *
...
$string['activityoverview'] = 'Ten cuestionarios apunto de rematar';
$string['additionalinfo'] = 'Información adicional';
$string['additionalinfo_help'] = 'Texto que se amosará no alto da primeira páxina de este cuestionario (i.e. instruccións, información de fondo, etc.)';
$string['addnewquestion'] = 'Engadindo {$a} pregunta';
$string['addnewsection'] = 'Engadir unha sección';
$string['addquestion'] = 'Engadir pregunta...';
$string['addquestions'] = 'Engadir preguntas';
$string['addquestiontosection'] = 'Engadir unha pregunta á sección';
...
$string['answergiven'] = 'Resposta dada';
$string['answernotgiven'] = 'Resposta non dada';
$string['answerquestions'] = 'Respostar as preguntas...';
$string['answers'] = 'Respostas';
$string['attempted'] = 'Este cuestionario foi enviado.';
$string['attemptstillinprogress'] = 'En progreso. Gardado en:';
$string['autonumbering'] = 'Auto numerado';
$string['autonumbering_help'] = 'Numerado automático de preguntas e páxinas. É posible que desexe deshabilitar esta opción con cuestionarios con ramificación condicional.';
$string['autonumberno'] = 'Non numerar preguntas ou páxinas';
$string['autonumberpages'] = 'Autonumerar páxinas';
$string['autonumberpagesandquestions'] = 'Autonumerar páxinas e preguntas';
$string['autonumberquestions'] = 'Autonumerar preguntas';
$string['average'] = 'Promedio';
$string['averageposition'] = 'Posición promedio';
$string['averagerank'] = 'Rango promedio';
$string['averagesrow'] = 'Promedios (onde se poida aplicar):';
$string['bodytext'] = 'Corpo de texto';
$string['boxesnbexact'] = 'exactamente {$a} caixa(s).';
$string['boxesnbmax'] = 'un máximo de {$a} caixas.';
$string['boxesnbmin'] = 'un mínimo de {$a} caixas.';
$string['boxesnbreq'] = 'Para esta pregunta debe marcar';
$string['by'] = 'por';
$string['cannotviewpublicresponses'] = 'Non pode ver respostas deste cuestionario público.';
...
$string['chart:type_help'] = 'Seleccione o tipo de gráfico que quere usar para esta retroalimentación';
