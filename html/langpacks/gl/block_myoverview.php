...
$string['aria:courseactions'] = 'Accións para o curso actual';
$string['aria:courseprogress'] = 'Progreso do curso:';
...
$string['aria:inprogress'] = 'Amosar en cursos en progreso';
$string['aria:lastaccessed'] = 'Ordenar cursos pola última data de acceso';
...
$string['aria:sortingdropdown'] = 'Ordenado o menú despregábel';
...
$string['defaulttab_desc'] = 'A lapela que se amosará cando un usuario vexa por primeira vez a súa vista xeral do curso. Ao volver á súa visita xeral do curso, lembrarase a lapela activa do usuario.';
...
$string['nocoursesfuture'] = 'Non hai cursos futuros';
$string['nocoursesinprogress'] = 'Non hai cursos sendo cursados';
$string['nocoursespast'] = 'Non hai cursos pasados';
...
$string['privacy:metadata:overviewlasttab'] = 'Isto almacena a última lapela seleccionada polo usuario no bloque de vista xeral.';
