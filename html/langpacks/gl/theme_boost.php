...
/**
 * Strings for component 'theme_boost', language 'gl', version '3.11'.
 *
 * @package     theme_boost
 * @category    string
...
$string['rawscsspre_desc'] = 'Neste campo pode fornecer a inicialización do código SCSS, será inxectado antes do resto. Na maioría das ocasións usará esta configuración para definir variábeis.';
$string['region-side-pre'] = 'Dereita';
