...
/**
 * Strings for component 'webservice', language 'gl', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['addexternalservice'] = 'Engadir servizo externo';
...
$string['editexternalservice'] = 'Editar servizo externo';
...
$string['erroroptionalparamarray'] = 'O parámetro de descrición do servizo web chamado «{$a}» é unha estrutura única ou múltiple. Non se pode definir como VALUE_OPTIONAL. Consulte a descrición do servizo web.';
...
$string['eventwebservicetokencreated'] = 'Creada o testemuño de servizo web';
...
$string['missingcaps_help'] = 'Lista de permisos declarados polo servizo que o usuario non ten. É posíbel que algunhas funcións do servizo non estean dispoñíbeis sen estes permisos.';
...
$string['onlyseecreatedtokens'] = 'Só pode ver os testemuños que creou';
...
$string['webservicetokens'] = 'Testemuños de servizo web';
