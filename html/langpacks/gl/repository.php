...
/**
 * Strings for component 'repository', language 'gl', version '4.5'.
 *
 * @package     repository
 * @category    string
...
$string['activerepository'] = 'Complementos de repositorio dispoñíbeis';
$string['activitybackup'] = 'Copia de seguridade da actividade';
$string['add'] = 'Engadir';
$string['addfile'] = 'Engadir...';
$string['addfiletext'] = 'Engadir ficheiro';
$string['addplugin'] = 'Engadir un complemento de repositorio';
$string['aliaseschange'] = 'Hai {$a} ligazóns a este ficheiro. Se continúa, as localizacións que ligan actualmente ao ficheiro actualizaranse automaticamente para usar unha copia do ficheiro.';
...
$string['cannotunzipcontentunreadable'] = 'Non foi posíbel descomprimir este ficheiro porque non se pode ler o contido do ficheiro.';
$string['cannotunzipextractfileerror'] = 'Non foi posíbel descomprimir este ficheiro porque un ou máis dos seus ficheiros non se poden ler.';
$string['cannotunzipquotaexceeded'] = 'Non foi posíbel descomprimir este ficheiro porque se superará o tamaño máximo permitido nesta área de borrador.';
...
$string['confirmremove'] = 'Confirma que quere retirar o complemento de repositorio {$a}, as súas opcións e <strong>todas as súas instancias</strong>? Se escolle «Continuar e descargar», os ficheiros referidos a contidos externos descargaranse a Moodle, mais a este proceso levaralle bastante tempo.';
...
$string['createfoldersuccess'] = 'O cartafol foi creado correctamente';
...
$string['downloadsucc'] = 'Este ficheiro foi descargado correctamente';
...
$string['login'] = 'Acceder á súa conta';
...
$string['nofilesselected'] = 'Non hai ningún ficheiro seleccionado';
$string['nolicenses'] = 'Non hai licenzas dispoñíbeis';
...
$string['originalextensionchange'] = 'A extensión orixinal do ficheiro modificouse como parte do cambio de nome de ficheiro. Cambiar a extensión de «.{$a->originalextension}» a «.{$a->newextension}» pode producir un ficheiro que non se pode abrir.';
$string['originalextensionremove'] = 'A extensión orixinal do ficheiro eliminouse como parte do cambio de nome de ficheiro. A eliminación da extensión «.{$a}» pode producir un ficheiro que non se pode abrir.';
$string['overwrite'] = 'Sobrescribir';
$string['overwriteall'] = 'Sobrescribir todo';
$string['path'] = 'Ruta';
$string['plugin'] = 'Engadidos de repositorio';
$string['pluginerror'] = 'Producíronse erros no complemento do repositorio';
$string['pluginname'] = 'Nome do complemento do repositorio';
...
$string['setupdefaultplugins'] = 'Configuración dos complementos predeterminados de repositorio';
...
$string['uploadsucc'] = 'Este ficheiro foi enviado correctamente';
...
$string['ziped'] = 'O cartafol foi comprimido correctamente';
