...
/**
 * Strings for component 'workshop', language 'gl', version '4.1'.
 *
 * @package     workshop
 * @category    string
...
$string['aggregategrades'] = 'Volver a calcular as cualificacións';
...
$string['areaoverallfeedbackcontent'] = 'Textos xerais de comentarios';
...
$string['clearassessmentsconfirm'] = 'Confirma que quere limpar todas as cualificacións de avaliación?. Non poderá volver obter a información por vostede mesmo, os avaliadores terán que avaliar de novo as entregas asignadas.';
...
$string['editassessmentform'] = 'Editar o formulario de avaliación';
$string['editassessmentformstrategy'] = 'Editar o formulario de avaliación ({$a})';
$string['editingassessmentform'] = 'Editando o formulario de avaliación';
...
$string['latesubmissions_desc'] = 'Permitir entregas fóra de prazo';
...
$string['noexamplesformready'] = 'Debe definir o formulario de avaliación antes de fornecer entregas de exemplo';
...
$string['overallfeedbackfiles'] = 'Número máximo de anexos xerais de comentarios';
$string['overallfeedbackmaxbytes'] = 'Tamaño máximo de anexos xerais de comentarios';
$string['overallfeedbackmode'] = 'Modo de comentario xeral';
...
$string['privacy:metadata:feedbackauthorformat'] = 'Formulario de texto dos comentarios para o autor';
$string['privacy:metadata:feedbackreviewer'] = 'Comentarios para o usuario que fornece a avaliación';
$string['privacy:metadata:feedbackreviewerformat'] = 'Formulario de texto dos comentarios para o usuario que fornece a avaliación';
...
$string['privacy:metadata:peercommentformat'] = 'Formulario de texto do comentario na cualificación dada';
...
$string['privacy:metadata:submissioncontentformat'] = 'Formulario de texto do contido da entrega';
...
$string['privacy:metadata:subsystem:coreplagiarism'] = 'O módulo de taller ten compatibilidade integrada para os sistemas de prevención de plaxio';
...
$string['strategy_help'] = 'A estratexia de cualificación determina o formulario de avaliación utilizado e o método de cualificación das entregas. Hai 4 opcións:
...
$string['strategyhaschanged'] = 'A estratexia de cualificación do obradoiro cambiou dende que foi aberto o formulario para editalo.';
...
$string['submissionsallocation'] = 'Asignación de entregas';
...
$string['userplanaccessibilityskip'] = 'Saltar ata ás tarefas actuais';
$string['userplanaccessibilitytitle'] = 'Cronograma do obradoiro con {$a} fases';
...
$string['workshop:editdimensions'] = 'Editar o formulario de avaliación';
...
$string['yourgrades'] = 'As súas cualificacións';
