...
/**
 * Strings for component 'privacy', language 'gl', version '4.4'.
 *
 * @package     privacy
 * @category    string
...
$string['trace:deletingapprovedusers'] = 'Realizando a remoción de usuarios en {$a->total} compoñentes aprobados para o contexto {$a->contextid} ({$a->datetime}).';
