...
/**
 * Strings for component 'error', language 'gl', version '3.11'.
 *
 * @package     error
 * @category    string
...
$string['confirmsesskeybad'] = 'Vaites, pero a súa clave de sesión non puido confirmarse para realizar esta acción. Esta característica de seguridade evita a execución accidental ou maliciosa de funcións importantes no seu nome. Asegúrese de que quere executar esta función.';
...
$string['detectedbrokenplugin'] = 'Vaites, o engadido «{$a}» está defectuoso ou desactualizado, non é posíbel continuar.';
...
$string['encryption_invalidkey'] = 'Clave non válida';
...
$string['sessionipnomatch'] = 'Vaites, semella que o seu número IP foi modificado dende a primeira vez que entrou no sistema. Esta característica de seguridade prevén que os «crackers» lle rouben a súa identidade mentres estea neste sitio. Os usuarios normais poderían non estar vendo esta mensaxe. Pida axuda ao administrador do sitio.';
...
$string['wwwrootmismatch'] = 'Detectouse un acceso incorrecto. A este servidor só se pode acceder a través do enderezo «{$a}»;<br />Notifíquello ao administrador do servidor.';
$string['wwwrootslash'] = 'Detectouse un $CFG->wwwroot incorrecto no ficheiro config.php, xa que non pode conter barras invertidas.<br />Notifíquello ao administrador do servidor.';
