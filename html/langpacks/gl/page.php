...
$string['printlastmodifiedexplain'] = 'Amosar a última data modificada baixo o contido?';
$string['privacy:metadata'] = 'O engadido de recurso páxina non almacena ningún dato persoal.';
$string['search:activity'] = 'Páxina';
