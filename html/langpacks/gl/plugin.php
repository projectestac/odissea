...
/**
 * Strings for component 'plugin', language 'gl', version '4.4'.
 *
 * @package     plugin
 * @category    string
...
$string['cancelinstallhead'] = 'Cancelando a instalación de complementos';
...
$string['cancelupgradehead'] = 'Restaurando versións anteriores de complementos';
...
$string['detectedmisplacedplugin'] = 'O complemento «{$a->component}» está instalado nunha localización incorrecta «{$a->current}», a localización agardada é «{$a->expected}»';
$string['displayname'] = 'Nome do complemento';
...
$string['filtercontribonly'] = 'Amosar só os complementos adicionais';
$string['filterupdatesonly'] = 'Amosar só os actualizábeis';
$string['incompatibleversion'] = 'Versión de Moodle incompatíbel: {$a}';
$string['isenabled'] = 'Activado?';
$string['misdepinfoplugin'] = 'Información do complemento';
...
$string['misdepsunavaillist'] = 'Non se atopou a versión que cumpra cos requisitos de dependencias: {$a}.';
$string['misdepsunknownlist'] = 'Non dispoñíbel no directorio de complementos: <strong>{$a}</strong>.';
$string['moodlebranch'] = 'Moodle {$a->min} - {$a->max}';
$string['moodleversion'] = 'Moodle {$a}';
$string['noneinstalled'] = 'Ningún complemento deste tipo está instalado';
...
$string['notes'] = 'Notas';
$string['notsupported'] = 'É posible que o complemento non sexa compatíbel coa versión de Moodle {$a}';
$string['notwritable'] = 'Os ficheiros de complementos non son escribíbeis';
...
$string['overviewall'] = 'Todos os complementos';
$string['overviewext'] = 'Complementos adicionais';
...
$string['plugincheckall'] = 'Todos os complementos';
$string['plugincheckattention'] = 'Complementos que requiren atención';
$string['pluginchecknone'] = 'Ningún complemento require da súa atención agora';
$string['pluginchecknotice'] = 'Esta páxina presenta os complementos que poden requirir a súa atención durante a actualización. Os elementos resaltados inclúen novos complementos que están a pique de seren instalados, os que van ser actualizados e os complementos anteriores que agora faltan. Os complementos adicionais tamén se destacan se existe unha actualización para eles. Recomendase que comprobe se existen versións máis recentes dos complementos e que lles actualice o seu código fonte antes de continuar con esta actualización de Moodle.';
...
$string['supportedconversions'] = 'Conversións de documentos compatíbeis';
$string['supportedmoodleversions'] = 'Versións de Moodle compatíbeis';
$string['systemname'] = 'Identificador';
$string['type_antivirus'] = 'Complemento antivirus';
...
$string['type_communication'] = 'Provedor de comunicación';
$string['type_communication_plural'] = 'Provedores de comunicación';
$string['type_contentbank'] = 'Banco de contidos';
$string['type_contentbank_plural'] = 'Complementos do banco de contidos';
$string['type_contenttype'] = 'Banco de contidos';
$string['type_contenttype_plural'] = 'Complementos do banco de contidos';
...
$string['type_fileconverter'] = 'Convertedor de documentos';
$string['type_fileconverter_plural'] = 'Convertedores de documentos';
$string['type_fileconvertermanage'] = 'Xestionar os convertedores de documentos';
...
$string['type_h5plib'] = 'Entorno de traballo H5P';
$string['type_h5plib_plural'] = 'Entornos de traballo H5P';
$string['type_local'] = 'Complemento local';
...
$string['type_paygw'] = 'Pasarela de pagamento';
$string['type_paygw_plural'] = 'Pasarelas de pagamento';
$string['type_paygwmanage'] = 'Xestionar as pasarelas de pagamento';
$string['type_plagiarism'] = 'Complemento de plaxio';
$string['type_plagiarism_plural'] = 'Complementos de plaxio';
...
$string['type_qbank'] = 'Complemento do banco de preguntas';
$string['type_qbank_plural'] = 'Complementos do banco de preguntas';
...
$string['updatepluginconfirm'] = 'Confirmación de actualización do complemento';
...
$string['validationmsg_componentmismatchname'] = 'Non coincide o nome do complemento';
...
$string['validationmsg_componentmismatchtype'] = 'Non coincide o tipo de complemento';
...
$string['validationmsg_missingcomponent'] = 'O complemento non declara o nome do seu compoñente';
$string['validationmsg_missingcomponent_help'] = 'Todos os complementos deben fornecer o seu nome completo mediante a declaración de  «$plugin->component» no ficheiro version.php.';
...
$string['validationmsg_missingexpectedlangenfile_info'] = 'Ao tipo de complemento dado fáltalle o ficheiro de idioma inglés agardado  {$a}.';
...
$string['validationmsg_missingversion'] = 'O complemento non declara a súa versión';
...
$string['validationmsg_pluginversion'] = 'Versión do complemento';
$string['validationmsg_pluginversiontoolow'] = 'Xa está instalada unha versión superior deste complemento';
$string['validationmsg_release'] = 'Publicación do complemento';
$string['validationmsg_requiresmoodle'] = 'Versión de Moodle requirida';
$string['validationmsg_rootdir'] = 'Nome do complemento que será instalado';
...
$string['validationmsg_rootdirinvalid'] = 'Nome de complemento incorrecto';
...
$string['validationmsg_targetexists_help'] = 'O directorio onde se instalará o complemento xa existía previamente e será substituído polos contidos do paquete do complemento.';
$string['validationmsg_targetnotdir'] = 'A localización destino está ocupada por un ficheiro';
$string['validationmsg_unknowntype'] = 'Tipo de complemento descoñecido';
