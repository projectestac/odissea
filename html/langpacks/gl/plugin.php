...
$string['type_mlbackend'] = 'Backend de aprendizaxe automática';
$string['type_mlbackend_plural'] = 'Backends de aprendizaxe automática';
...
$string['validationmsg_pluginversiontoolow'] = 'Xa está instalada unha versión superior deste engadido';
