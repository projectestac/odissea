...
/**
 * Strings for component 'backup', language 'gl', version '3.11'.
 *
 * @package     backup
 * @category    string
...
$string['automatedsettings'] = 'Axustes da copia de seguridade automatizada';
...
$string['config_overwrite_course_fullname'] = 'De forma predeterminada, sobrescribe o nome completo do curso co do ficheiro de copia de seguridade. Isto necesita que estea activado «Sobrescribir a configuración do curso» e que o usuario actual teña a funcionalidade para cambiarlle o nome completo ao curso (moodle/course:changefullname)';
$string['config_overwrite_course_shortname'] = 'De forma predeterminada, sobrescribe o nome abreviado do curso co do ficheiro de copia de seguridade. Isto necesita que estea activado «Sobrescribir a configuración do curso» e que o usuario actual teña a funcionalidade para cambiarlle o nome abreviado ao curso (moodle/course:changeshortname)';
$string['config_overwrite_course_startdate'] = 'De forma predeterminada, sobrescribe a data de inicio do curso coa data do ficheiro de copia de seguridade. Isto necesita que estea activado «Sobrescribir a configuración do curso» e que o usuario actual teña a funcionalidade para cambiar as datas do curso ao restaurar (moodle/restore:rolldates)';
...
$string['configgeneralgroups'] = 'Define o comportamento predeterminado para incluír grupos e agrupamentos nunha copia de seguridade.';
...
$string['configrestorelogs'] = 'Se está activado, restauraranse de forma predeterminada os rexistros se foron incluídos na copia de seguridade.';
...
$string['configrestoreroleassignments'] = 'Se está activado, restauraranse de forma predeterminada as asignacións de roles se foron incluídas na copia de seguridade.';
...
$string['configrestoreuserscompletion'] = 'Se está activado, restaurarase a información de grado de avance do usuario se foi incluída na copia de seguridade.';
...
$string['errorrestorefrontpagebackup'] = 'Só se poden restaurar copias de seguridade da páxina principal na páxina principal';
$string['executionsuccess'] = 'Creouse satisfactoriamente o ficheiro de copia de seguridade.';
...
$string['generalbackdefaults'] = 'Valores predeterminados da copia de seguridade';
...
$string['generalsettings'] = 'Axustes xerais da copia de seguridade';
...
$string['pendingasyncedit'] = 'Hai unha copia de seguridade asíncrona pendente para este curso. Non edite este curso ata que a copia de seguridade estea completa.';
...
$string['sitecourseformatwarning'] = 'Isto é unha copia de seguridade da páxina principal, teña en conta que só se pode restaurar na páxina principal';
