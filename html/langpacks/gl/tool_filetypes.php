...
/**
 * Strings for component 'tool_filetypes', language 'gl', version '3.11'.
 *
...
$string['descriptiontype_default'] = 'Predeterminado (tipo MIME ou cadea de idioma correspondente se está dispoñíbel)';
