...
/**
 * Strings for component 'course', language 'gl', branch 'MOODLE_38_STABLE'
 *
 * @package   course
...
$string['customfield_visibility_help'] = 'Este axuste determina quen pode ver o nome e valor do campo personalizado na lista de cursos.';
...
$string['target:coursecompetencies_help'] = 'Este obxectivo describe se un alumno corre o risco de non acadar as competencias asignadas a un curso. Este obxectivo considera que todas as competencias asignadas ao curso deben ser acadadas ata o final do curso.';
$string['target:coursecompletion'] = 'Alumnos en risco de non cumprir as condicións de completado do curso';
$string['target:coursecompletion_help'] = 'Este obxectivo describe se se considera que o alumno está en risco de non cumprir as condicións de completado do curso.';
...
$string['target:coursegradetopass_help'] = 'Este obxectivo describe se o alumno corre o risco de non acadar a cualificación mínima para aprobar o curso.';
