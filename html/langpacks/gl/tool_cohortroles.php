...
/**
 * Strings for component 'tool_cohortroles', language 'gl', branch 'MOODLE_38_STABLE'
 *
...
$string['acohortroleassignmentssaved'] = 'Gardáronse {$a} asignacións de roles de círculo.';
$string['assign'] = 'Asignar';
$string['assignroletocohort'] = 'Asigna roles de contexto de usuario a todos os membros de círculos';
$string['backgroundsync'] = 'Nota: as novas asignacións de roles de círculo non entrarán en vigor inmediatamente. Os cambios na asignación de roles serán realizados por unha tarefa programada.';
$string['cohortroleassignmentnotremoved'] = 'Non se eliminou a asignación de rol de círculo.';
$string['cohortroleassignmentremoved'] = 'Retirouse a asignación de rol de círculo.';
$string['cohortroles'] = 'Roles de círculo';
$string['existingcohortroles'] = 'Asignacións de roles de círculo existentes';
$string['managecohortroles'] = 'Asigna roles de usuario para círculo';
$string['noassignableroles'] = 'Actualmente non hai roles que se poidan asignar no contexto do usuario. <a href="../../roles/manage.php">Xestionar roles</a>';
...
$string['selectusers'] = 'Seleccione os usuarios para asignarlle roles';
$string['taskname'] = 'Sincronizar as asignacións de roles de círculo existentes';
$string['thisuserroles'] = 'Roles asignados en relación a este usuario';
