...
/**
 * Strings for component 'hub', language 'gl', version '3.11'.
 *
 * @package     hub
 * @category    string
...
$string['analyticsactions'] = 'Número de accións realizadas con predicións xeradas ({$a})';
$string['analyticsactionsnotuseful'] = 'Número de accións que marcan unha previsión non útil ({$a})';
...
$string['completeregistration'] = 'Rexistro completo con Moodle.net';
...
$string['errorotherhubsnotsupported'] = 'Esta páxina xa non se pode usar para o rexistro con sitios personalizados';
$string['errorregistration'] = 'Produciuse un erro durante o rexistro, ténteo de novo máis tarde. ({$a})';
$string['errorregistrationupdate'] = 'Produciuse un erro durante a actualización do rexistro ({$a})';
$string['errorunpublishcourses'] = 'Por mor dun erro non agardado, non é posíbel eliminar os cursos no centro. Ténteo outra vez máis tarde (recomendado) ou contacte co administrador do centro.';
$string['errorws'] = '{$a}';
$string['errorwstokenreset'] = 'Restabeleceuse o testemuño de rexistro neste sitio. Agora pode rexistrar o seu sitio de novo.';
$string['existingscreenshotnumber'] = 'hai {$a} capturas de pantalla. Poderá ver estas capturas de pantalla nesta páxina, só após que o administrador do centro active o seu curso.';
...
$string['imageurl_help'] = 'Esta imaxe presentarase en pantalla do centro. Debe estar dispoñíbel dende o centro en calquera momento. A imaxe debería ter un tamaño máximo de {$a->width} X {$a->height}';
...
$string['mobilenotificationsenabled'] = 'Notificacións móbiles activadas ({$a})';
$string['mobileservicesenabled'] = 'Servizos móbiles activados ({$a})';
...
$string['policyagreed'] = 'Aviso de privacidade e acordo de procesamento de datos';
$string['policyagreeddesc'] = 'Acepto o <a href="{$a}" target="_blank">aviso de privacidade e un acordo de procesamento de datos</a>';
...
$string['registereduserdevices'] = 'Número de usuarios con dispositivos móbiles rexistrados ({$a})';
$string['registersite'] = 'Rexistrarse en {$a}';
$string['registerwithmoodleorg'] = 'Rexístrese en Moodle.org';
$string['registerwithmoodleorgcomplete'] = 'Complete o seu rexistro do sitio';
...
$string['registerwithmoodleorgremove'] = 'Vai dar de baixa o seu sitio. Se continúa, deixará de ter acceso a notificacións e alertas de seguridade importantes. Os seus usuarios non poderán recibir notificacións «push» do seu sitio na súa aplicación móbil Moodle. Confirma que quere dar de baixa o seu sitio?';
...
$string['sitecommnews_help'] = 'Ten a posibilidade de subscribirte ao noso boletín de Moodle. Pódese dar de baixa en calquera momento.';
$string['sitecommnewsno'] = 'Non, non quero recibir ningún correo electrónico';
$string['sitecommnewsyes'] = 'Si, gustaríame recibir o boletín de Moodle';
...
$string['siteregistrationemail'] = 'Notificacións de novas versións do Moodle, alertas de seguridade e outras novas importantes';
$string['siteregistrationemail_help'] = 'Ten a posibilidade de subscribirte á nosa lista de correo de baixo volume para recibir notificacións de novas versións do Moodle, alertas de seguridade e outras novas importantes. Pódese dar de baixa en calquera momento.';
...
$string['unregisterexplained'] = 'Se o sitio web co URL {$a} está rexistrado, eliminarase o seu rexistro.';
$string['unregisterfrom'] = 'Darse de baixa de {$a}';
$string['unregistrationerror'] = 'Produciuse un erro ao tentar dar de baixa o sitio: {$a}';
$string['update'] = 'Actualizar';
$string['updatesite'] = 'Actualizar o rexistro en {$a}';
$string['updatesiteregistration'] = 'Actualizar o rexistro';
$string['updatestatus'] = 'Comprobalo agora.';
$string['urlalreadyregistered'] = 'O seu sitio parece que xa está rexistrado, o que significa que algo foi mal. Contacte co administrador do directorio de sitios para restabelecer o seu rexistro e así poder tentalo de novo.';
$string['usedifferentemail'] = 'Usar un correo diferente';
