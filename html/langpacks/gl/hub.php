...
$string['errorotherhubsnotsupported'] = 'Esta páxina xa non se pode usar para o rexistro con sitios distintos de Moodle.net';
...
$string['errorws'] = '{$a}';
$string['errorwstokenreset'] = '{a}. Restabeleceuse a marca de rexistro neste sitio. Agora pode rexistrar o seu sitio de novo.';
...
$string['policyagreeddesc'] = 'Acepto o <a href="{$a}" target="_blank">aviso de privacidade e un acordo de procesamento de datos</a> para Moodle.net';
...
$string['sitecommnews'] = 'Actualizacións sobre novas e funcións de Moodle';
$string['sitecommnews_help'] = 'Ten a opción de subscribirse na nosa lista de correos electrónicos de baixo volume, incluíndo un boletín sobre acontecementos na comunidade Moodle.';
$string['sitecommnewsno'] = 'Non, non quero recibir ningún correo electrónico de Moodle HQ';
$string['sitecommnewsyes'] = 'Si, inclúanme nas actualizacións regulares do boletín informativo de Moodle';
...
$string['unregisterexplained'] = 'Se o sitio web co URL {$a} está rexistrado en Moodle.net, o seu rexistro eliminarase.';
