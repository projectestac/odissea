...
/**
 * Strings for component 'completion', language 'gl', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['addconditions'] = 'Engadir condicións';
...
$string['completedunlockedtext'] = 'Ao gardar este formulario, os datos de completado serán eliminados e após recalculados cando sexa posíbel. Para evitar isto, pode saír da navegación sen gardar.';
$string['completedwarning'] = 'Opcións de completado bloqueadas';
$string['completedwarningtext'] = 'Esta actividade está marcada como realizada para un ou varios alumnos. Se desbloquea os axustes para facer un cambio, e após garda o formulario, os datos de completado serán eliminados, e volverán ser recalculados cando sexa posíbel. O completado manual non pode ser recalculado, polo que neste caso o alumno deberá marcala como feita de novo.';
...
$string['completionexpected'] = 'Definir o lembrete na cronoloxía';
$string['completionexpected_help'] = 'Isto permite estabelecer un lembrete para que o alumnado traballe nesta actividade. Aparecerá no bloque de Cronoloxía no seu Taboleiro como «{$a} precisa dunha acción"';
...
$string['coursecompletionsettings'] = 'Axustes de completado de curso';
...
$string['daysuntilcompletion'] = 'Días ata que se complete';
$string['defaultactivitycompletioncourse'] = 'Estas son as condicións predeterminadas de completado das actividades deste curso.';
$string['defaultactivitycompletionsite'] = 'Estas son as condicións predeterminadas de completado das actividades de todos os cursos.';
...
$string['done'] = 'Feito';
$string['editconditions'] = 'Editar condicións';
$string['editcoursecompletionsettings'] = 'Editar os axustes de completado do curso';
$string['emptyconditionsinfo'] = 'Estas son as condicións de non completado configuradas para esta actividade.';
$string['emptyconditionswarning'] = 'Hai que engadir ao menos unha condición de completado.';
$string['enablecompletion'] = 'Activar o seguimento do progreso (para o completado)';
$string['enablecompletion_help'] = 'Se está activado, pode definir condicións para a realización da actividade ou a realización do curso.';
...
$string['err_settingslocked'] = 'Un ou máis alumnos xa completaron un criterio, polo que os axustes foron bloqueados. Ao desbloquear os axustes eliminarase calquera dato de completado do usuario o que podería causar confusión.';
...
$string['privacy:metadata:timecreated'] = 'O momento no que se creou o completado da actividade';
...
$string['showcompletionconditions_help'] = 'Amosar as condicións de completado da actividade na páxina do curso.';
$string['showinguser'] = 'Amosando o usuario';
$string['studentsmust'] = 'Os alumnos deberán';
$string['timecompleted'] = 'Tempo rematado';
$string['todo'] = 'Para facer';
$string['unenrolingfromcourse'] = 'Dando de baixa do curso';
$string['unenrolment'] = 'Dar de baixa';
$string['unit'] = 'Unidade';
$string['unlockcompletion'] = 'Desbloquear os axustes de completado';
$string['unlockcompletiondelete'] = 'Desbloquear os axustes de completado e eliminar os datos de completado do usuario';
