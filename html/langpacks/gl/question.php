...
$string['addanotherhint'] = 'Engadir outro consello';
...
$string['cannotdeletetopcat'] = 'Non é posíbel eliminar as principais categorías.';
$string['cannotedittopcat'] = 'Non é posíbel editar as principais categorías.';
$string['cannotenable'] = 'Non é posíbel crear directamente o tipo de pregunta {$a}.';
$string['cannotenablebehaviour'] = 'Non se pode usar directamente o tipo de comportamento {$a}. Soamente para uso interno.';
$string['cannotfindcate'] = 'Non foi posíbel atopar o rexistro da categoría';
$string['cannotfindquestionfile'] = 'Non foi posíbel atopar o ficheiro de datos da pregunta en zip';
...
$string['changepublishstatuscat'] = '<a href="{$a->caturl}">A categoría «{$a->name}»</a> no curso «{$a->coursename}» cambiará o seu estado de compartición dende <strong>{$a->changefrom} a {$a->changeto}</strong>.';
$string['check'] = 'Comprobar';
$string['chooseqtypetoadd'] = 'Escolla o tipo de pregunta que engadir';
$string['clearwrongparts'] = 'Limpar respostas incorrectas';
...
As categorías úsanse tamén para preguntas ao chou, as preguntas selecciónanse dunha categoría particular.';
...
$string['filecantmovefrom'] = 'Non pode mover os ficheiros das preguntas porque non ten permiso para retirar ficheiros do lugar dende onde está tentando mover preguntas.';
$string['filecantmoveto'] = 'Non pode mover nin copiar os ficheiros de preguntas porque non ten permiso para engadir ficheiros ao lugar a onde está tentando mover as preguntas.';
...
$string['hintn'] = 'Consello {no}';
$string['hintnoptions'] = 'Consello {no} opcións';
$string['hinttext'] = 'Consello de texto';
...
$string['movingcategoryandfiles'] = 'Confirma que quere mover a categoría {$a->name} e todas as categorías fillas ao contexto de «{$a->contextto}»?<br />Detectáronse {$a->urlcount} ficheiros ligados dende preguntas en {$a->fromareaname}, quere copialos ou movelos a {$a->toareaname}?';
...
$string['notyourpreview'] = 'Esta vista previa non lle corresponde';
...
$string['previewquestion'] = 'Vista previa da pregunta: {$a}';
...
$string['specificfeedback_help'] = 'Comentario que depende de que contestación dese o alumno.';
...
$string['submissionoutofsequencefriendlymessage'] = 'Introduciu datos nunha secuencia contraria á normal. Isto pode ocorrer se usa o botón de Volver atrás ou adiante do seu navegador; non os use durante o proba. Tamén pode suceder se preme en algo mentres se carga a páxina. Prema <strong>Continuar</strong> para continuar.';
...
$string['wrongprefix'] = 'Nome de prefixo {$a} formatado erradamente';
