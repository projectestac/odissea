...
$string['deletequestioncheck'] = 'Isto eliminará a seguinte pregunta e todas as súas versións:<br /><br />{$a}';
$string['deletequestionscheck'] = 'Isto eliminará as seguintes preguntas e todas as súas versións:<br /><br />{$a}';
...
$string['eventqbankdisabled'] = 'Desactivouse o complemento de banco de preguntas';
$string['eventqbankenabled'] = 'Activouse o complemento de banco de preguntas';
...
$string['privacy:metadata:link:qbehaviour'] = 'O subsistema de preguntas usa o tipo de complemento Question Behaviour (Comportamento de pregunta).';
$string['privacy:metadata:link:qformat'] = 'O subsistema de preguntas fai uso do tipo de complemento Question Format (Formato de pregunta) para o propósito de importar e exportar preguntas en diferentes formatos.';
$string['privacy:metadata:link:qtype'] = 'O subsistema de preguntas interactúa co tipo de complemento Question Type (Tipo de pregunta) que contén os diferentes tipos de preguntas.';
$string['published'] = 'compartido';
$string['qbanknotfound'] = 'O complemento de banco de preguntas «{$a}» non existe ou non é recoñecido.';
...
$string['questionsinuse'] = '* Indica preguntas que non se poden eliminar porque están en uso. Pola contra, agocharanse no banco de preguntas a non ser que seleccione «Amosar preguntas antigas».';
...
$string['questionsrescuedfrominfo'] = 'Estas preguntas (algunha das cales poden estar agochadas) gardáronse cando se eliminou o contexto {$a} porque aínda se usan nalgúns cuestionarios ou outras actividades.';
...
$string['restartwiththeseoptions'] = 'Gardar as opcións de vista previa e comezar de novo';
...
$string['showhidden'] = 'Amosar as preguntas agochadas';
