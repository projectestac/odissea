...
/**
 * Strings for component 'admin', language 'es', version '4.5'.
 *
 * @package     admin
 * @category    string
...
$string['asyncbackupdisabled'] = 'Su sitio está configurado actualmente para usar copias de seguridad síncronas. Las copias de seguridad asíncronas dan una mejor experiencia de usuario, permitiendo a los usuarios seguir trabajando mientras dura el proceso de copia o de restauración. Las copias de seguridad asíncronas se habilitarán para todos los sitios en Moodle 4.5 LTS. Las copias de seguridad síncronas desaparecerán en Moodle LMS tras la versión 4.5 LTS.';
...
$string['configallowobjectembed'] = 'Como medida de seguridad, los usuarios con rol de estudiante no pueden incrustar multimedia dentro de textos usando las etiquetas EMBED y OBJECT en HTML, aunque sí se puede mostrar multimedia usando el filtro multimedia plugins. Active esta opción si desea permitir dichas marcas.';
...
$string['configdocroot'] = 'Define la ruta a Moodle Docs para proporcionar documentación específica según el contexto mediante enlaces hacia \'"Documentación para esta página" en el pie de cada página. Si deja vacío este campo no se mostrarán los enlaces.';
...
$string['configenablemobilewebservice'] = 'Habilitar el servicio para móviles para la aplicación Moodle. Si su sitio usa HTTPS, los servicios móviles están habilitados por defecto. Para más información lea la {$a}.';
...
$string['configgeoipfile'] = 'Ubicación del archivo binario GeoIP City. Este archivo no forma parte de la distribución de Moodle y debe obtenerse de forma independiente en <a href="https://www.maxmind.com/">MaxMind</a>. Puede adquirir una versión comercial u optar por la versión gratuita.  Necesitará registrarse para descargar el archivo de base de datos City, lo que puede hacer en <a href="https://dev.maxmind.com/geoip/geoip2/geolite2/" >https://dev.maxmind.com/geoip/geoip2/geolite2/</a>. Una vez hecho el registro, descargue el archivo y extráigalo en el directorio "{$a}" de su servidor.';
...
$string['configgradeexportdefault'] = 'Elija qué formato de exportación es su método de exportación de calificaciones por defecto.';
...
$string['configintrosite'] = 'Esta página le permite configurar la página principal del sitio y dar un nombre a su nuevo sitio. Puede volver aquí más adelante y cambiar estos ajustes en cualquier momento usando los menús de Administración.';
...
$string['configproxybypass'] = 'Lista de los nombres de host (parciales) o direcciones IP que deberían saltar el proxy. Separe cada elemento por comas, sin espacios. Por ejemplo 192.168.0.0/16,*.mydomain.com.';
...
$string['confirmationpending'] = 'Confirmación pendiente';
...
$string['coursecolorheading_desc'] = 'Cualquier curso sin imagen preestablecida en los ajustes del curso se mostrará en la pantalla principal con una tarjeta estandarizada del curso. Los colores usados en el modelo pueden estar especificados a continuación.';
...
$string['courserequestnotifyemail'] = 'El usuario {$a->user} ha solicitado un nuevo curso en <a href="{$a->link}">{$a->link}</a>.';
...
$string['curlsecurityblockedhosts'] = 'Lista de direcciones cURL bloqueadas';
...
$string['debugtemplateinfo_desc'] = 'Si se habilita, las plantillas usadas para renderizar se muestran como comentarios en el HTML de la página. Una vez cambiado el ajuste, debe purgar cachés. Úsese sólo para debug temporal, ya que produce errores de validación de HTML y podría romper algunos scripts de página. ¡También puede romper funcionalidad del core!';
...
$string['deleteduserx'] = 'Borrado usuario {$a}';
...
$string['ensureauroraversion'] = 'Su sitio se está ejecutando mediante un motor de base de datos Amazon Aurora. La versión de MySQL de Amazon Aurora debe ser compatible con la versión de Moodle que está instalando o a la que está subiendo. Puede comprobar la compatibilidad en <a href="https://docs.aws.amazon.com/AmazonRDS/latest/AuroraMySQLReleaseNotes/AuroraMySQL.Updates.30Updates.html" target="_blank">Actualizaciones de motor de base de datos de Amazon Aurora versión 3 de MySQL</a>.';
...
$string['frontpagebackup'] = 'Copia de seguridad de la página principal del sitio';
$string['frontpagedefaultrole'] = 'Rol por defecto en la página principal del sitio';
$string['frontpagefilters'] = 'Filtros de la página principal del sitio';
$string['frontpageloggedin'] = 'Elementos de la página principal del sitio al iniciar sesión';
$string['frontpageoverrides'] = 'Anulaciones de permisos en la página principal del sitio';
$string['frontpagequestions'] = 'Preguntas de la página principal del sitio';
$string['frontpagerestore'] = 'Restauración de la página principal del sitio';
$string['frontpageroles'] = 'Roles de la página principal del sitio';
...
$string['geoipdbedition_desc'] = 'Seleccione la edición de base de datos GeoIP a descargar. Por favor, tenga en cuenta que usar la base de datos GeoIP2-City requiere el pago de una licencia válida.';
$string['geoipfile'] = 'GeoIP City DB';
$string['geoipmaxmindaccid'] = 'ID de cuenta MaxMind';
...
$string['gradeexportdefault'] = 'Método de exportación de calificaciones por defecto.';
$string['gravatardefaulturl'] = 'URL para imagen por defecto de Gravatar';
$string['gravatardefaulturl_help'] = 'Gravatar necesita una imagen por defecto para utilizar en caso de que no se pueda localizar la imagen de un determinado usuario. Hay códigos para generar imágenes por defecto en  <a href="https://docs.gravatar.com/api/avatars/images/">Gravatar para Desarrolladores - Solicitudes de Avatar</a>.';
$string['group_customfield'] = 'Campos personalizados del grupo';
...
$string['grouping_customfield'] = 'Campos personalizados del agrupamiento';
...
$string['hookdeprecates'] = 'Retrollamadas obsoletas';
...
$string['importantupdates_content'] = '<p>En Moodle 5.0, las actividades de Chat y Encuestas Predefinidas dejarán de estar en el core de Moodle. Estarán disponibles en el <a href="https://moodle.org/plugins/">directorio de plugins de Moodle</a>.</p>
<p>Si usted deseara seguir usando la actividad Chat o Encuestas Predefinidas en su sitio, usted deberá instalarlas como plugins antes de subir a la versión Moodle 5.0.</p>';
$string['importantupdates_title'] = 'Actualización importante sobre las actividades Chat y Encuestas Predefinidas';
...
$string['iplookupinfo'] = 'Se usa el servidor gratuito en línea NetGeo para buscar la ubicación de las direcciones IP. Esta base de datos ya no se mantiene, y puede devolver información errónea.
Se recomienda instalar una copia local de la base de datos GeoIP, desde MaxMind.<br />
...
$string['iplookupmaxmindnote'] = 'Este producto incluye datos de GeoIP City creado por MaxMind, disponible en <a href="https://www.maxmind.com">https://www.maxmind.com</a>.';
...
Su cuenta de usuario {$a->username} en el sitio "{$a->sitename}" ha sido bloqueada tras múltiples intentos de acceso no válidos.
...
$string['maxcharacter'] = '{$a} caracteres máximo';
...
$string['navshowfrontpagemods'] = 'Mostrar actividades de la página principal del sitio en la navegación';
$string['navshowfrontpagemods_help'] = 'Si se habilita, las actividades de la página principal del sitio se mostrarán en la navegación debajo de las páginas del sitio. Este ajuste sólo es aplicable a los temas basados en el Clásico (Classic).';
...
$string['oauthrefreshtokenexpired'] = 'El token de refresco para un servicio OAuth 2 {$a->issuer} en su sitio {$a->siteurl} ha expirado. Esto limitará la funcionalidad de cualquiera de los plugins que usan este servicio. Para solucionarlo, visite la página de configuración Servicios OAuth 2 y haga click en el icono "Conectar cuenta del sistema" en la fila de la tabla de este servicio. Asegúrese de iniciar sesión usando la misma cuenta de servicio para el sistema OAuth cada vez.';
...
$string['oracledatabaseinuse'] = 'Se va a eliminar el soporte de Oracle DB. La versión 4.5 será la última que soporte Oracle DB. Se pueden encontrar más detalles en moodle.orge <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank">fin de soporte de base de datos Oracle en LMS</a>';
...
$string['profilefieldlink_help'] = 'Para transformar el texto en un enlace, introduzca una URL que contenga $$, donde $$ se reemplazará con el texto. Por ejemplo, para transformar una ID de Twitter en un enlace, introduzca https://twitter.com/$$.';
...
$string['purgecachesconfirm'] = 'Moodle puede guardar en caché los temas, JavaScript, cadenas de idioma, texto filtrado, RSS feeds y muchos otros datos calculados. Purgar cachés borrará datos del servidor y forzará a los navegadores de los clientes a actualizar la información, y así se asegurará de que los usuarios estén viendo la información con el código actualizado. No se corre ningún riesgo al purgar cachés, aunque su sitio podría parecer algo más lento durante un rato hasta que el servidor y los clientes calculen nueva información y la guarden en caché.';
...
$string['registrationwarning'] = 'No se pierda actualizaciones y alertas de seguridad importantes.';
$string['registrationwarningcontactadmin'] = 'Este sitio no está registrado. Por favor, consulte con su administrador para registrar su sitio para que no se pierdan actualizaciones importantes.';
...
$string['replacefrontsearch'] = 'Utilizada para la busqueda de la página principal del sitio';
...
$string['requiremodintro_desc'] = 'Si se activa, los usuarios serán forzados a introducir una descripción para cada actividad.';
...
$string['sessioncookie'] = 'Sufijo de \'cookies\'';
...
$string['settingzendexceptionignoreargs'] = 'Se recomienda encarecidamente que se habilite la configuración zend.exception_ignore_args como medida de precaución';
...
$string['sitesectionhelp'] = 'Mostrar una sección en la parte superior de la página donde puede añadir contenido personalizado.';
...
$string['smallscreensonly'] = 'Sólo pantallas pequeñas';
$string['smtp'] = 'SMTP';
...
$string['storedprogressbarcleanuptask'] = 'Tarea de limpieza de de barra de progreso guardada';
...
$string['supportandservices'] = 'Soporte y servicios';
...
$string['task_adhoc_failed_retention'] = 'Periodo de retención de tareas ad hoc fallidas';
$string['task_adhoc_failed_retention_desc'] = 'El periodo máximo que deberían permanecer en cola las tareas ad hoc fallidas una vez que han alcanzado su límite de intentos.';
...
$string['taskautomatedbackup_report'] = 'Informe de copias de seguridad automatizadas';
$string['taskbackupcleanup'] = 'Limpiar tablas, logs y archivos de respaldo';
$string['taskbadgesadhoc'] = 'Insignia de premio';
$string['taskbadgescron'] = 'Añadir tareas adhoc de insignias de premio';
...
$string['taskupdategeoip2file'] = 'Actualizar archivo GeoIP';
...
$string['themedefinedinconfigphp'] = 'El tema no se puede cambiar porque está definido en {$a} en config.php.';
...
$string['themeeditsettingsname'] = 'Editar ajustes de tema "{$a}"';
...
$string['themesettingsadvanced'] = 'Ajustes avanzados de tema';
$string['themesettingscustom'] = 'Ajustes de personalización de tema';
$string['themesettingsname'] = 'Configuración del tema "{$a}"';
$string['themeusagereportname'] = 'Informe de uso del tema "{$a}"';
...
$string['unicoderequired'] = 'Se deben almacenar todos los datos en formato Unicode (UTF-8). Las instalaciones nuevas deberían ejecutarse en bases de datos con juego de caracteres por defecto UTF-8. Si está realizando una actualización, debe seguir el proceso de migración UTF-8.';
...
$string['unsupportedphpversion84'] = 'No están soportadas ni la versión PHP 8.4 ni superiores.';
...
$string['userfiltersdefault_desc'] = 'Seleccione los filtros que quiera mostrar en la página "Acciones de usuario masivas". Mantenga presionada la tecla Ctrl para seleccionar varios elementos. Cualquier filtro no seleccionado estará disponible haciendo clic en el enlace "Mostrar más".';
