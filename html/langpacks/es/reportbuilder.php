...
$string['columnsortdisable'] = 'Deshabilitar la ordenación por la columna \'{$a}\'';
$string['columnsortenable'] = 'Habilitar la ordenación por la columna \'{$a}\'';
...
$string['enablecustomreports_desc'] = 'Permitir a los usuarios crear y visualizar informes personalizados del Creador de informes';
...
$string['sorting_help'] = 'La clasificación define el orden inicial de las columnas en el informe. El orden se puede invertir utilizando el icono Arriba/Abajo. Después, los usuarios pueden definir su propio orden de clasificación haciendo clic en el nombre de una columna.';
