...
/**
 * Strings for component 'report_log', language 'es', version '4.5'.
 *
 * @package     report_log
 * @category    string
...
$string['missingcontext'] = '{$a->name} (id \'{$a->instanceid}\') borrado';
$string['missingcourse'] = 'Curso (id \'{$a->instanceid}\') no encontrado';
