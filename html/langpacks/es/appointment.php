...
/**
 * Strings for component 'appointment', language 'es', version '4.5'.
 *
 * @package     appointment
 * @category    string
...
$string['placeholdersdesc'] = 'Marcadores de posición';
$string['placeholdersdesc_help'] = 'Los marcadores de posición te permiten agregar un contenido dinámico, por ejemplo, el marcador de posición [nombre] se reemplazará con el nombre de usuario en la notificación enviada al usuario.';
...
$string['venue'] = 'Lugar';
$string['waitlistedat'] = '<strong>Lista de espera:</strong> {$a}';
