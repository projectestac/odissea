...
$string['completionattendance_desc'] = 'El estudiante debe entrar a la sala y permanecer en la sesión durante al menos {$a} minuto(s)';
...
$string['completionengagement_desc'] = 'El estudiante debe participar en actividades durante la reunión.';
$string['completionengagementchats'] = 'Eventos del chat';
$string['completionengagementchats_desc'] = 'El estudiante debe participar en {$a} chat(s) para completarlo.';
$string['completionengagementchats_event_desc'] = 'Ha generado {$a} de chat(s)';
$string['completionengagementemojis'] = 'Emojis';
$string['completionengagementemojis_desc'] = 'El estudiante debe enviar {$a} emoji(s) a las encuestas para completarlo.';
$string['completionengagementemojis_event_desc'] = 'Ha generado {$a} emoji(s)';
...
$string['completionengagementpollvotes_desc'] = 'El estudiante debe votar en las encuestas {$a} veces para completarlo.';
$string['completionengagementpollvotes_event_desc'] = 'Ha generado {$a} voto(s) de encuesta';
$string['completionengagementraisehand'] = 'Requerir levantar la mano';
$string['completionengagementraisehand_desc'] = 'El estudiante debe levantar la mano {$a} vez(veces) para completarlo.';
...
$string['completionengagementtalks_desc'] = 'La estudiante debe hablar {$a} vez(veces) para completarlo';
...
$string['completionview_desc'] = 'El estudiante debe unirse a una sala o reproducir una grabación para completarlo.';
$string['completionview_event_desc'] = 'Se ha unido a la sala o ha reproducido la grabación {$a} vez(veces).';
