...
/**
 * Strings for component 'block', language 'es', version '4.4'.
 *
 * @package     block
 * @category    string
...
$string['showonfrontpageandsubs'] = 'Mostrar en la página principal del sitio y en cualquier página añadida a ésta.';
$string['showonfrontpageonly'] = 'Mostrar sólo en la página principal del sitio';
