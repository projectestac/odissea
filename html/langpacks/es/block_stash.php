...
/**
 * Strings for component 'block_stash', language 'es', version '4.5'.
 *
 * @package     block_stash
 * @category    string
...
$string['cost'] = 'Coste';
$string['createquizzes'] = 'Crear un cuestionario en este curso para configurar la eliminación de un artículo de inventario desde aquí.';
...
$string['itemremoval'] = 'Eliminación de artículo.';
$string['items'] = 'Artículos';
$string['itemslist'] = 'Lista de artículos';
$string['itemsremoved'] = 'Artículos eliminados';
$string['leaderboard'] = 'Mostrar tablero de ranking';
$string['leaderboard_groups'] = 'Mostrar en los tableros de ranking solamente usuarios de mis grupos.';
$string['leaderboards'] = 'Tableros de ranking';
...
$string['mostitems'] = 'Mostrar artículos';
$string['mostsingularitem'] = 'Mayoría de un único artículo concreto';
$string['mostsingularitemname'] = 'Mayoría de "{$a}"';
$string['mostuniqueitems'] = 'Mostrar artículos únicos';
...
$string['navleaderboadsettings'] = 'Ajustes de tablero de ranking';
$string['navreport'] = 'Informe';
$string['navtrade'] = 'Comercio';
$string['new'] = 'Nuevo';
$string['next'] = 'Siguiente';
$string['nofilterandnotiny'] = '📢 ¿Sabía que hay un nuevo plugin para el editor TinyMCE que hace que crear artículos e intercambios sea mucho más fácil? Descárguelo e instale tanto <a href="https://moodle.org/plugins/filter_shortcodes">filter plugin shortcodes</a> como <a href="https://moodle.org/plugins/tiny_stash">TinyMCE editor plugin tiny stash</a> para mejorar enormemente su experiencia de creación de inventario. Hay un vídeo de vista previa disponible en el enlace de tiny stash anterior.';
...
$string['none'] = 'Ninguno';
$string['noquizzes'] = 'Usted o tiene cuestionarios';
$string['nosingularitem'] = 'Por favor, añada al menos un elemento para usar este tablero de ranking';
$string['notiny'] = '📢 ¿Sabía que hay un nuevo plugin para el editor TinyMCE que hace que crear artículos e intercambios sea mucho más fácil? Descárguelo e instale <a href="https://moodle.org/plugins/tiny_stash">TinyMCE plugin tiny stash</a> para mejorar enormemente su experiencia de creación de inventario. Hay un vídeo de vista previa disponible en el enlace anterior.';
...
$string['quizitemsremoved'] = 'Se han eliminado los siguientes artículos:';
$string['quizname'] = 'Nombre del cuestionario';
$string['quiznotenoughitems'] = 'Usted no tiene suficientes artículos para hacer este cuestionario. Necesita los siguientes artículos:';
$string['quizremovalconfigured'] = 'Este cuestionario está <a href="{$a}">configurado</a> para eliminar artículos de inventario.';
...
$string['removalconfigurations'] = 'Configuraciones de eliminación';
$string['removalexplanation'] = 'Actualmente las eliminaciones se limitan a intentos de actividad de cuestionario. Los artículos listados para eliminación se borrarán cada vez que un estudiante inicie un intento. Se negará el acceso si el estudiante no tiene suficiente cantidad de artículos listados.';
$string['removals'] = 'Eliminaciones';
...
$string['selectquiz'] = 'Cuestionario';
$string['selectquizcheck'] = 'Por favor, seleccione un cuestionario';
$string['sendtraderequest'] = 'Enviar solicitud de intercambio';
$string['sent'] = 'Enviar';
$string['settings'] = 'Configuraciones';
$string['settingupdated'] = 'Ajuste actualizado';
