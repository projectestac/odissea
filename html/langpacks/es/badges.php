...
$string['badgesnavigation'] = 'Navegación de insignias';
...
$string['canvascredentialsprovider'] = 'Credenciales Canvas';
$string['canvasregions'] = 'Regiones de credenciales Canvas';
$string['canvasregions_desc'] = 'Puede configurar los contenidos de las regiones de credenciales Canvas. Cada línea se separa por barras verticales y consiste en 1) el nombre de la región, 2) la URL de la mochila, y 3) la URL de la API de la mochila.';
...
$string['includeauthdetails'] = 'Conectar a la cuenta del proveedor de la mochila';
$string['includeauthdetails_desc'] = 'Introduzca sus credenciales de emisor de insignia para conectarse a su proveedor de mochila.';
$string['includeauthdetails_help'] = 'Envía sus credenciales de emisor con cada insignia exportada a esta mochila.';
$string['includeauthdetailscanvas'] = 'Conectar a la cuenta de emisor de credenciales Canvas';
$string['includeauthdetailscanvas_desc'] = 'Introduzca sus detalles de credenciales Canvas para conectarse a su cuenta de emisor.';
$string['includeauthdetailscanvas_help'] = 'Las insignias exportadas a credenciales Canvas mostrarán su organización como emisor. Esto también le permite seguir quién recibió insignias, y gestionar actualizaciones.';
$string['includeauthdetailscanvas_subtitle'] = '(Requiere un plan de pago de Canvas Credentials)';
...
$string['wrongrole'] = 'El ro que desea usar no le está asignado.';
$string['year'] = 'Año(s)';
