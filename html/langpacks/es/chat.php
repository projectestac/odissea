...
/**
 * Strings for component 'chat', language 'es', version '4.5'.
 *
 * @package     chat
 * @category    string
...
$string['enterchat'] = 'Entrar al chat';
...
$string['pastsessions'] = 'Sesiones pasadas';
...
$string['removemessages'] = 'Todos los mensajes';
