...
/**
 * Strings for component 'repository_boxnet', language 'es', branch 'MOODLE_38_STABLE'
 *
...
$string['saved'] = 'Datos guardados en Box.net';
$string['shareurl'] = 'URL compartida';
$string['username'] = 'Nombre de usuario para Box.net';
