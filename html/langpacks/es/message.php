...
/**
 * Strings for component 'message', language 'es', version '4.5'.
 *
 * @package     message
 * @category    string
...
$string['backupmessageshelp'] = 'Si se activa, los mensajes instantáneos serán incluidos en las copias automatizadas del SITIO';
...
$string['enablenotificationplugin'] = 'Habililtar plugin de notificación: {$a}';
...
$string['notificationsmarkedasread'] = 'Se han marcado como leídas todas las notificaciones';
...
$string['privacy_desc'] = 'Puede restringir quién puede enviarle mensajes';
...
$string['unabletomessage'] = 'No puede enviar mensajes a este usuario';
...
$string['usercantbemessaged'] = 'No puedes enviar un mensaje a este usuario debido a sus preferencias de mensajería. Intenta añadirlo como un contacto.';
...
$string['waitingforcontactaccept'] = 'Esperando para ser añadido como contacto';
