...
$string['cm_delete_feedback_batch'] = 'Las {$a->count} actividades seleccionadas se han borrado.';
$string['cm_duplicate_feedback'] = '{$a->name} se ha duplicado.';
$string['cm_duplicate_feedback_batch'] = 'Las {$a->count} actividades se han duplicado.';
$string['cm_hide_feedback'] = '{$a->name} ahora está oculto.';
$string['cm_hide_feedback_batch'] = 'Las {$a->count} actividades seleccionadas ahora están ocultas.';
$string['cm_moveleft_feedback'] = '{$a->name} se ha movido a la izquierda.';
$string['cm_moveright_feedback'] = '{$a->name} se ha movido a la derecha.';
$string['cm_nogroups_feedback'] = 'El modo de grupo de {$a->name} se ha cambiado a "Sin grupos".';
$string['cm_separategroups_feedback'] = 'El modo de grupo de {$a->name} se ha cambiado a "Grupos separados".';
$string['cm_show_feedback'] = 'Ahora {$a->name} está visible.';
$string['cm_show_feedback_batch'] = 'Las {$a->count} actividades seleccionadas ahora están visibles.';
$string['cm_stealth_feedback'] = '{$a->name} ahora está disponible pero no se muestra en la página principal del curso.';
$string['cm_stealth_feedback_batch'] = 'Las actividades seleccionadas {$a->count} ahora están disponibles pero no son visibles en la página del curso.';
$string['cm_uncomplete_feedback'] = '{$a->name} marcado como no completado.';
$string['cm_uncomplete_feedback_batch'] = '{$a->count} actividades seleccionadas marcadas como no completadas.';
