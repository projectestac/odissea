...
$string['asyncemailenable'] = 'Habilitar notificaciones';
$string['asyncemailenabledetail'] = 'Cuando se habilita, los usuarios recibirán una notificación cuando se complete una restauración o copia de seguridad asincrónicos.';
$string['asyncgeneralsettings'] = 'Copia de seguridad/restauración asincrónicos';
$string['asyncmessagebody'] = 'Notificación';
...
$string['asyncmessagebodydetail'] = 'Notificación a enviar cuando se complete una restauración o copia de seguridad asincrónicos.';
$string['asyncmessagesubject'] = 'Asunto';
$string['asyncmessagesubjectdefault'] = '{operation} de Moodle se completó exitosamente';
$string['asyncmessagesubjectdetail'] = 'Asunto de la notificación';
...
$string['backupfile'] = 'Fichero de copia de seguridad';
...
$string['backupthenrestore'] = 'Copia de seguridad terminada. Empezar a restaurar.';
...
$string['choosefilefromactivitybackup_help'] = 'Archivos de copia de seguridad de esta actividad.';
$string['choosefilefromautomatedbackup'] = 'Copias de seguridad automáticas';
$string['choosefilefromautomatedbackup_help'] = 'Archivos de copia de seguridad generados automáticamente.';
$string['choosefilefromcoursebackup'] = 'Zona de copia de seguridad de curso';
$string['choosefilefromcoursebackup_help'] = 'Archivos de copia de seguridad de este curso.';
$string['choosefilefromuserbackup'] = 'Zona de copia de seguridad privada de usuario';
$string['choosefilefromuserbackup_help'] = 'Archivos de copia de seguridad privada de todos los cursos, con información de usuario anonimizada.';
...
$string['configgeneralcustomfield'] = 'Fija los valores por defecto para incluir campos personalizados en una copia de seguridad.';
...
$string['configrestorecustomfield'] = 'Fija los valores por defecto para restaurar campos personalizados.';
...
$string['copycoursedesc'] = 'Crear una copia de este curso en cualquier categoría de curso.';
...
$string['enableasyncbackup_help'] = 'Si se habilita, todas las operaciones de copia de seguridad y restauración se harán asincrónicamente. Esto da una mejor experiencia de usuario al permitir hacer otras operaciones mientras hay una copia de seguridad o restauración en progreso. No tiene efecto en importaciones y exportaciones.';
...
$string['errorrestorefrontpagebackup'] = 'Sólo puede restaurar copias de seguridad de la página principal en la página principal del sitio.';
...
$string['generalcustomfield'] = 'Incluir campos por defecto';
...
$string['importfromccmidtocourse'] = 'Importar desde cmid:{$a->srccmid} a curso:{$a->dstcourseid}';
$string['importfromcoursetocourse'] = 'Importar de curso:{$a->srccourseid} a curso:{$a->dstcourseid}';
...
$string['managefiles_activity'] = 'Gestionar copias de seguridad de actividades';
$string['managefiles_automated'] = 'Gestionar copias de seguridad automatizadas';
$string['managefiles_backup'] = 'Gestionar copias de seguridad privadas';
$string['managefiles_course'] = 'Gestionar copias de seguridad de curso';
...
$string['questioncannotberestored'] = 'Las preguntas "{$a->name}" no pueden crearse por restauración';
...
$string['restorenofilesbackuparea'] = 'No hay archivos de copias de seguridad aún.';
$string['restorenofilesbackuparea_activity'] = 'No hay archivos de copia de seguridad de esta actividad aún.';
$string['restorenofilesbackuparea_automated'] = 'No hay archivos de copia de seguridad automatizada aún.';
$string['restorenofilesbackuparea_backup'] = 'Usted no tiene archivos de copia de seguridad privada aún.';
$string['restorenofilesbackuparea_course'] = 'No hay archivos de copia de seguridad de este curso aún.';
...
$string['sitecourseformatwarning'] = 'Esto es una copia de segudad de una página principal de sitio. Sólo puede restaurarse en la página principal del sitio.';
