...
/**
 * Strings for component 'tool_dataprivacy', language 'es', version '4.5'.
 *
...
$string['allowfiltering'] = 'Permitir filtrado de exportaciones por curso';
$string['allowfiltering_desc'] = 'Si se activa, el encargado de privacidad puede elegir exportar datos de usuario de cursos seleccionados en vez de todos los cursos. Cuando esta característica está activada, las solicitudes de exportación comenzarán desde "Pendiente" y sólo se aprobarán cuando se haya completado una tarea en segundo plano.';
...
$string['approverequestall'] = 'Autorizar solicitud (todos los datos)';
$string['approveselectedcourses'] = 'Autorizar los cursos seleccionados';
...
$string['cancelrequestconfirmation'] = '¿Desea cancelar esta solicitud de datos?';
...
$string['errornoselectedcourse'] = 'Debe seleccionar al menos un curso';
...
$string['filterexportdata'] = 'Autorizar solicitud (datos de los cursos seleccionados)';
$string['filteroption'] = '{$a->category}: {$a->name}';
$string['frontpagecourse'] = 'Curso de página principal del sitio';
...
$string['nocoursetofilter'] = 'El usuario no está matriculado en ninguno de los cursos para seleccionar';
...
$string['requesttypeexportallowfiltering'] = 'Exportar mis datos personales';
...
$string['selectcourses'] = 'Seleccionar cursos a exportar';
