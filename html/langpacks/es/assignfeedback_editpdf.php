...
/**
 * Strings for component 'assignfeedback_editpdf', language 'es', version '4.5'.
 *
...
$string['pathtogserror'] = 'La ruta configurada al ghostscript no está configurada correctamente: {$a}';
