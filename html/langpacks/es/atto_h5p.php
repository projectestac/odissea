...
/**
 * Strings for component 'atto_h5p', language 'es', version '4.1'.
 *
 * @package     atto_h5p
 * @category    string
...
$string['instructions'] = 'Puede insertar contenido H5P <strong>o bien</strong> introduciendo una URL <strong>o bien</strong> subiendo un archivo H5P.';
