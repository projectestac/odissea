...
/**
 * Strings for component 'tool_brickfield', language 'es', version '4.5'.
 *
...
$string['checkdesc:imgaltistoolong'] = 'Asegúrses de que "alt" (texto de descripción alternativa de la imagen) sea sufiicentemente conciso.';
