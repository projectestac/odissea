...
/**
 * Strings for component 'choicegroup', language 'es', version '4.5'.
 *
 * @package     choicegroup
 * @category    string
...
$string['choicebegins'] = 'La selección empieza en';
$string['choiceends'] = 'La selección termina en';
...
$string['option'] = 'Grupo';
$string['page-mod-choicegroup-x'] = 'Cualquier página del módulo de elección de grupo';
...
$string['studentswhochose'] = 'Estudiantes que eligieron';
