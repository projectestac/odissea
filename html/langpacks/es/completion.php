...
/**
 * Strings for component 'completion', language 'es', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['activitycompletion'] = 'Condiciones de finalización de actividad';
...
$string['addconditions'] = 'Añadir condición';
...
$string['all'] = 'Todos';
$string['allconditions'] = 'La actividad se completa cuando los estudiantes hacen lo siguiente:';
...
$string['badautocompletion'] = 'Debe seleccionar al menos una condición.';
...
$string['completionexpected'] = 'Añadir recordatorio en la Línea del Tiempo';
$string['completionexpected_help'] = 'Esto le permite establecer un recordatorio para que los estudiantes trabajen en esta actividad. Aparecerá en el bloque "Línea del Tiempo" en su Área Personal como "{$a} requiere acción".';
...
$string['completionpassgrade_desc'] = 'Calificación de aprobado';
...
$string['coursecompletionsettings'] = 'Ajustes de finalización del curso';
...
$string['deletecompletiondata'] = 'Datos de finalización';
...
$string['emptyconditionsinfo'] = 'No se han establecido condiciones de finalización de actividad para esta actividad.';
$string['emptyconditionswarning'] = 'Usted tiene que añadir al menos una condición de finalización de actividad';
...
$string['incompatibleplugin'] = 'Esta actividad ya no permite configuración de finalización de actividad por defecto. Las condiciones de finalización de actividad deben configurarse manualmente en cada nuevo uso.';
