...
/**
 * Strings for component 'questionnaire', language 'es', version '4.5'.
 *
...
$string['autodeletereponse'] = 'Auto borrar respuestas después [?]';
$string['autodeletereponse_desc'] = 'Active esta configuración para borrar automáticamente respuestas antiguas basadas en el tiempo configurado en "Borrar respuestas antiguas después". Deshabilite para mantener todas las respuestas.';
...
$string['configremoveoldresponses'] = 'Configuración a usar por defecto en todas las nuevas encuestas';
...
$string['fullsubmissions'] = 'Entregas completas';
...
$string['printstrictdateformatting'] = 'Introducir la fecha';
...
$string['removeoldresponses'] = 'Borrar respuestas antiguas';
$string['removeoldresponses_help'] = 'El sistema puede borrar automáticamente respuestas antiguas tras un determinado periodo de tiempo.';
$string['removeoldresponsesafter'] = 'Borrar respuestas antiguas después';
$string['removeoldresponsesdefault'] = 'Nunca eliminar';
...
$string['responses_breakdown'] = '(Entregas: {$a->responses} | En progreso: {$a->incomplete})';
$string['responsesnotsubmitted'] = 'Respuestas no entregadas';
...
$string['useridnumber'] = 'Número de id del usuario';
