...
$string['privacy:metadata:preference:quiz_overview_slotmarks'] = 'Si mostrar marcas para cada espacio de preguntas.';
$string['privacy:preference:slotmarks:no'] = 'Las marcas no se muestran junto al espacio de la pregunta.';
$string['privacy:preference:slotmarks:yes'] = 'Las marcas se muestran junto al espacio de la pregunta.';
...
$string['showdetailedmarks'] = 'Marcas para cada pregunta';
