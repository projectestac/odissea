...
/**
 * Strings for component 'tool_uploaduser', language 'es', version '4.4'.
 *
...
$string['invaliduserdatavalues'] = 'Datos incorrectos ({$a->values}) detectados para el usuario "{$a->username}". Estos datos se han corregido o borrado.';
