...
$string['accountcreatedsuccess'] = 'Tu cuenta ha sido creada y está lista para usar.';
$string['accountlinkedsuccess'] = 'Tu cuenta existente ha sido vinculada exitosamente.';
...
$string['cannotcreateaccounts'] = 'La creación de cuenta esta prohibida actualmente en este sitio.';
...
$string['firstlaunchnoauthnotice'] = 'Para vincular su cuenta existente, debe iniciar sesión en el sitio. Inicie sesión en el sitio en una nueva pestaña/ventana y luego reinicie la herramienta aquí. Para obtener más información, consulte la documentación <a href="{$a}" target="_blank">Publicado como herramienta LTI</a>.';
...
$string['privacy:metadata:auth_lti:authsubsystem'] = 'Este plugin está conectado al subsistema de autenticación.';
