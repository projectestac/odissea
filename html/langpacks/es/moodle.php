...
/**
 * Strings for component 'moodle', language 'es', version '3.11'.
 *
 * @package     moodle
 * @category    string
...
$string['adminhelplanguage'] = 'Para comprobar y editar el paquete de idioma actual';
...
$string['adminhelpmymoodle'] = 'Configurar los bloques de "My Moodle" para usuarios';
