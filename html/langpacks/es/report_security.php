...
/**
 * Strings for component 'report_security', language 'es', version '4.5'.
 *
...
$string['check_upgradefile_info'] = 'Los archivos de notas de actualización no deberían ser públicos';
