...
$string['addpagebreakafter'] = 'Añadir salto de página tras pregunta {$a}';
...
$string['attemptduration'] = 'Duración';
...
$string['closebeforeopen'] = 'La fecha de cierre debe ser posterior a la de apertura.';
...
$string['eventquizgradeitemcreated'] = 'Elemento de calificación de cuestionario creado';
$string['eventquizgradeitemdeleted'] = 'Elemento de calificación de cuestionario eliminado';
$string['eventquizgradeitemorderchanged'] = 'Orden de elemento de calificación modificado';
$string['eventquizgradeitemupdated'] = 'Elemento de calificación de cuestionario actualizado';
...
$string['eventslotgradeitemupdated'] = 'Ranura de elemento de calificación actualizada';
...
$string['gradeitemdefaultname'] = 'Nuevo elemento de calificación {$a}';
$string['gradeitemdelete'] = 'Borrar elemento de calificación {$a}';
$string['gradeitemedit'] = 'Editar nombre de elemento de calificación {$a}';
$string['gradeitemmarkscheme'] = 'Asignar elementos de calificación';
$string['gradeitemnewname'] = 'Nuevo nombre de elemento de calificación {$a}';
$string['gradeitemnoneselected'] = '[ninguno]';
$string['gradeitemnoslots'] = 'Este cuestionario no tiene preguntas aún. Por favor, primero añada preguntas. Después vuelva aquí para configurar elementos de calificación.';
$string['gradeitems'] = 'Ítems de calificación';
$string['gradeitemsautosetup'] = 'Configurar una calificación para cada sección';
$string['gradeitemsetup'] = 'Configuración de elementos de calificación';
$string['gradeitemsnoneyet'] = 'Cree elementos de calificación en su cuestionario. Asigne preguntas o secciones del cuestionario para repartir la calificación en distintas áreas.';
$string['gradeitemsremoveall'] = 'Resetear configuración';
$string['gradeitemsremoveallconfirm'] = '¿Resetear configuración de elementos de calificación?';
$string['gradeitemsremoveallmessage'] = 'Esto borrará todos los elementos de calificación y desasignará preguntas y secciones. <br><br>Esta acción no afectará ni a las preguntas ni a las secciones. Tampoco afectará a los intentos anteriores del cuestionario.';
$string['gradeitemsremovealltitle'] = 'Resetear configuración de elementos de calificación';
...
$string['lastautosave'] = 'Último guardado: {$a}';
...
$string['movequestionnumber'] = 'Mover pregunta: {$a}';
...
$string['noreviewshort'] = 'Revisión no permitida';
...
$string['overridecannotchange'] = 'El usuario o grupo no puede cambiarse una vez se ha creado una anulación.';
$string['overridecannotsetbothgroupanduser'] = 'Grupo y usuario no pueden configurarse a la vez.';
...
$string['overrideinvalidattempts'] = 'El valor de intentos debe ser mayor que cero.';
$string['overrideinvalidexistingid'] = 'No existe esta anulación.';
$string['overrideinvalidgroup'] = 'El grupo dado no existe.';
$string['overrideinvalidquiz'] = 'El ID del cuestonario no existe.';
$string['overrideinvalidtimelimit'] = 'El tiempo límite debe ser superior a cero.';
$string['overrideinvaliduser'] = 'El usuario dado no existe.';
$string['overridemissingdelete'] = 'La(s) ID(s) de anulación {$a} no se pudieron borrar porque no existen o no son parte del cuestionario dado.';
$string['overridemultiplerecordsexist'] = 'No se pueden establecer múltiples anulaciones para el mismo usuario/grupo.';
$string['overridemustsetuserorgroup'] = 'Se debe seleccionar un usuario o grupo.';
...
$string['questionsinclhidden'] = 'Preguntas (incluidas las ocultas)';
...
$string['quizsetupnavigation'] = 'Configuración de navegación del cuestionario';
...
$string['randomcatwithsubcat'] = '{$a} y subcategorías';
$string['randomcoursecatwithsubcat'] = 'Cualquier categoría dentro de la categoría de curso {$a}';
$string['randomcoursewithsubcat'] = 'Cualquier categoría en este curso';
$string['randomcreate'] = 'Crear preguntas aleatorias';
$string['randomediting'] = 'Editando pregunta aleatoria';
$string['randomfaultynosubcat'] = 'Pregunta fallida';
...
$string['randommodulewithsubcat'] = 'Cualquier categoría de este cuestionario';
...
$string['randomqnamecat'] = '({$a->category}) aleatoria basada en condición de filtro';
$string['randomqnamecattags'] = '({$a->category}) aleatoria basada en condición de filtro con etiquetas: {$a->tags}';
...
$string['randomsystemwithsubcat'] = 'Cualquier categoría a nivel de sistema';
...
$string['removepagebreakafter'] = 'Eliminar salto de página tras la pregunta {$a}';
