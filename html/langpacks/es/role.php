...
$string['course:viewsuspendedusers'] = 'Ver los usuarios expulsados';
...
$string['reportbuilder:viewall'] = 'Ver todos los informes personalizados';
...
$string['roleassignment'] = 'Asignación de rol';
...
$string['roleoriginalname'] = 'Nombre original';
...
$string['siteadministratorsconfigphp'] = 'No se puede cambiar la lista de administradores porque está definida en config.php.';
