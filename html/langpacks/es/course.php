...
/**
 * Strings for component 'course', language 'es', version '4.5'.
 *
 * @package     course
 * @category    string
...
$string['activitynavigation:jumptoactivity'] = 'Saltar a actividad';
$string['activitynavigation:nexta'] = 'Siguiente actividad: {$a}';
$string['activitynavigation:preva'] = 'Actividad anterior: {$a}';
