...
/**
 * Strings for component 'grading', language 'es', version '4.4'.
 *
 * @package     grading
 * @category    string
...
$string['manageactionshareconfirm'] = 'Está a punto de guardar una copia del formulario de calificación \'{$a}\' como una plantilla pública. Otros usuarios de su sitio podrán crear nuevos formularios de calificación para sus actividades a partir de esta plantilla.';
