...
$string['coursesize_2'] = 'M (~100MB; creazione in ~2 minuti)';
$string['coursesize_3'] = 'L (~1GB; creazione in ~30 minuti)';
$string['coursesize_4'] = 'XL (~10GB; creazione in ~2 ore)';
$string['coursesize_5'] = 'XXL (~20GB; creazione in ~4 ore)';
...
$string['progress_createassignments'] = 'Creazione compiti in corso ({$a})';
...
$string['progress_createusers'] = 'Creazione account utente in corso ({$a})';
...
$string['testscenario'] = 'Crea scenario di test';
$string['testscenario_description'] = 'La creazione di scenari di test utilizza una sintassi limitata del \'feature file\' per creare tutti gli elementi necessari allo svolgimento di un test manuale.';
...
$string['testscenario_filedesc'] = 'I \'feature file\' caricati possono contenere solo scenari con passi core_data_generator o alcuni passi specifici che non richiedono selenium. Tutti gli scenari verranno eseguiti contemporaneamente, ad eccezione di quelli con il tag @cleanup.';
...
$string['testscenario_notready'] = 'Le librerie Composer e Behat non sono ancora installate.<br><br>Eseguire il seguente comando per abilitare questo strumento: <strong>php admin/tool/generator/cli/runtestscenario.php</strong>';
$string['testscenario_outline'] = 'Gli schemi degli scenari non sono supportati.';
$string['testscenario_scenarionosteps'] = 'Lo scenario non ha passi.';
$string['testscenario_steps'] = 'Passi dello scenario di test:';
