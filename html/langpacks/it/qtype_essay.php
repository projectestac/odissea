...
/**
 * Strings for component 'qtype_essay', language 'it', version '4.5'.
 *
 * @package     qtype_essay
 * @category    string
...
$string['maxwordlimit_help'] = 'Se la risposta richiede che gli studenti inseriscano del testo, questo è il numero massimo di parole che ogni studente potrà inviare.';
$string['maxwordlimitboundary'] = 'Il limite di parole per questa domanda è di {$a->limit} parole e stai tentando di inviare {$a->count} parole. Accorcia la risposta e riprova.';
$string['minwordlimit'] = 'Limite minimo parole';
$string['minwordlimit_help'] = 'Se la risposta richiede che gli studenti inseriscano del testo, questo è il numero minimo di parole che ogni studente dovrà inviare.';
$string['minwordlimitboundary'] = 'Questa domanda richiede una risposta di almeno {$a->limit} parole e stai tentando di inviare {$a->count} parole. Per favore espandi la tua risposta e riprova.';
