...
/**
 * Strings for component 'tool_installaddon', language 'it', branch 'MOODLE_38_STABLE'
 *
...
$string['remoterequestnoninstallable'] = 'E\' stato richiesto di installare il plugin {$a->name} ({$a->component}) versione {$a->version} dal Moodle plugins directory. Sfortunatamente il controllo preliminare non è andato a buon fine (codice della motivazione: {$a->reason}).';
...
$string['typedetectionmismatch'] = 'E\' stato selezionato un tipo di plugin che non corrisponde al tipo dichiarato dal plugin stesso: {$a}';
