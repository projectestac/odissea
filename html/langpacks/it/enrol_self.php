...
/**
 * Strings for component 'enrol_self', language 'it', version '4.5'.
 *
 * @package     enrol_self
 * @category    string
...
$string['newenrols'] = 'Consenti nuove iscrizioni spontanee';
...
$string['status'] = 'Mantieni attive le attuali iscrizioni spontanee';
$string['status_desc'] = 'Abilita il metodo di iscrizione spontanea ai corsi.';
$string['status_help'] = 'Se impostato su No, tutti i partecipanti esistenti che si sono iscritti al corso non avranno più accesso.';
