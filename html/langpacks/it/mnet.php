...
/**
 * Strings for component 'mnet', language 'it', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['error7020'] = 'Questo errore di norma si verifica se il sito remoto ha creato un record per questo sito  usando una wwwroot errata, ad esempio, http://iltuosito.com invece di http://www.iltuosito.com. È necessario contattare l\'amministratore del sito remoto e comunicargli la wwwroot corretta (è definita nella config.php) in modo che possa correggere il record di questo host.';
$string['error7022'] = 'Il messaggio che hai inviato all\'host remoto è stato crittografato ma non è stato firmato. Ciò è davvero insolito:  se il problema si dovesse verificare nuovamente, forse dovresti inserire un bug nel Tracker fornendo il maggior numero di informazioni possibile sulla  versione di Moodle in uso.';
...
$string['eventaccesscontrolcreated'] = 'Creazione controllo d\'accesso';
$string['eventaccesscontrolupdated'] = 'Aggiornamento controllo d\'acecsso';
...
$string['installreflectionclasserror'] = 'Errore nel codice! È fallita l\'intropsezione MNet per il metodo \'{$a->method}\' nella classe \'{$a->class}\'. Per comodità ecco il messaggio di errore originale:  \'{$a->error}\'';
$string['installreflectionfunctionerror'] = 'Errore nel codice! È fallita l\'intropsezione MNet per la funazione \'{$a->method}\' nel file \'{$a->class}\'. Per comodità ecco il messaggio di errore originale:  \'{$a->error}\'';
...
$string['peerprofilefielddesc'] = 'È possibile alterare le impostazioni globali che regolano i campi del profilo utente da inviare e ricevere durante la creazione di nuovi utenti';
...
$string['profilefielddesc'] = 'È possibile configurare l\'elenco dei campi del profilo utente da inviare e ricevere via MNet durante la creazione o l\'aggiornamento di utenti. È anche possibile alterare questa impostazione per ciascun nodo MNet. I seguenti campi saranno sempre inviati indipendentemente dalla configurazione: {$a}';
...
$string['validated_by'] = 'È convalidato dal network:  <code>{$a}</code>';
