...
/**
 * Strings for component 'workshopform_numerrors', language 'it', version '3.11'.
 *
...
$string['grade0'] = 'Parola per valutazione negativa';
$string['grade0default'] = 'No';
$string['grade1'] = 'Parola per valutazione positiva';
...
$string['privacy:export:metadata:map'] = 'Se il numero pesato di errori raggiunge {$a->nonegative}, allora il punteggio sarà {$a->grade} percento.';
