...
$string['addnewdefaults'] = 'Aggiungi un default del modulo';
...
$string['bulkdenyrequests'] = 'Respingi richieste';
$string['cachedef_contextlevel'] = 'Categorie e finalità a livello di contesto';
...
$string['cannotreset'] = 'Non è stato possibile resettare la richiesta di dati. E\' possibile resettare solo richieste respinte.';
...
$string['confirmbulkapproval'] = 'Sei sicuro di approvare tutte le richieste selezionate?';
$string['confirmbulkdenial'] = 'Sei sicuro di respingere tutte le richieste selezionate?';
$string['confirmcompletion'] = 'Sei sicuro di contrassegnare come completata la richiesta selezionata?';
...
$string['contactdataprotectionofficer'] = 'Contatta il responsabile del trattamento dei dati';
$string['contactdataprotectionofficer_desc'] = 'L\'impostazione rende disponibile un collegamento per contattare il responsabile del trattamento dei dati. Il collegamento porterà ad una maschera dove l\'utente potrà inviare richieste di dati.';
$string['contactdpoviaprivacypolicy'] = 'Per favore contatta il responsabile del trattamento dei dati come indicato nelle Politiche di privacy.';
...
$string['datarequestcreatedfromscheduledtask'] = 'Creata automaticamente da elaborazione pianificata (Utente eliminato preesistente)';
$string['datarequestcreatedupondelete'] = 'Creata automaticamente per eliminazione dell\'utente';
...
$string['defaultunexpired'] = 'Solo i dati degli utenti che hanno almeno uno dei seguenti ruoli: <br>
{$a->expired}';
$string['defaultunexpiredwithexceptions'] = 'Solo i dati degli utenti che hanno almeno uno dei seguenti ruoli: <br>
{$a->expired}
a meno che abbiamo almeno uno dei seguenti ruoli:<br>
{$a->unexpired}';
...
$string['deleteexpireddatarequeststask'] = 'Eliminazione file delle richieste scadute di dati';
...
$string['deprecatedexplanation'] = 'Il plugin utilizza una versione obsoleta delle interfacce privacy, deve essere aggiornato.';
...
$string['dporolemapping'] = 'Mappatura ruolo del responsabile del trattamento dei dati';
$string['dporolemapping_desc'] = 'Il responsabile del trattamento dei dati gestisce le richieste di dati. Affinché un ruolo possa comparire nella mappatura del responsabile del trattamento dei dati, il ruolo deve possedere Il privilegio tool/dataprivacy:managedatarequests';
$string['duplicaterole'] = 'Il ruolo è già stato impstatao';
$string['editcategories'] = 'Modifica categorie';
$string['editcategory'] = 'Modifica categoria';
$string['editdefaults'] = 'Modifica default: {$a}';
$string['editmoduledefaults'] = 'Modifica default del modulo';
...
{$a->backtrace}</pre>';
$string['exceptionnotificationsubject'] = 'Si è veriifcata un\'eccezione durante l\'elaborazione dei dati di privacy';
$string['expandplugin'] = 'Espandi e contrai plugin.';
$string['expandplugintype'] = 'Espandi e contrai tipi di plugin.';
$string['expiredretentionperiodtask'] = 'Verifica scadenza tempi di conservazione';
...
$string['roleoverrideoverview'] = 'E\' possibile impostare un tempo di conservazione diverso per ruoli specifici. I dati di un utente scadranno solo quando tutti i ruoli a lui assegnati saranno scaduti.';
