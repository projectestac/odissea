...
/**
 * Strings for component 'assignfeedback_editpdf', language 'it', version '4.4'.
 *
...
$string['pathtogserror'] = 'Il percorso configurato per ghostscript non è impostato correttamente: {$a}';
