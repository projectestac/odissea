...
/**
 * Strings for component 'moodle', language 'it', version '3.11'.
 *
 * @package     moodle
 * @category    string
...
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'ID dell\'emittente a cui corrisponde il token';
