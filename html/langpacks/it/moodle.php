...
/**
 * Strings for component 'moodle', language 'it', version '4.5'.
 *
 * @package     moodle
 * @category    string
...
$string['creatingmodroles'] = 'Creazione attribuzioni di ruolo a livello di modulo e relative modifiche';
...
$string['creatinguserroles'] = 'Creazione attribuzioni di ruolo a livello di utente e relative modifiche';
...
$string['deletecheckfull'] = 'Vuoi davvero eliminare l\'utente {$a}, inclusi dati come i dettagli del profilo, iscrizioni, appartenenza a gruppi e gruppi globali nonché alcuni dati sulle attività dell\'utente?';
...
$string['forcepasswordchange_help'] = 'Obbliga l\'utente a cambiare la propria password al suo prossimo login.';
...
{$a}';
$string['forcepasswordresetnotice'] = 'La password attuale non è più conforme ai requisiti. Devi reimpostarla per poter accedere.
    {$a}';
...
* Attività singola - sarà visualizzata una singola risorsa o attività
* Relazionale - Il corso è incentrato su un forum principale nella pagina del corso. È possibile aggiungere ulteriori attività e risorse utilizzando il blocco Attività sociali.
* Sezioni personalizzabili-  il corpo centrale della pagina home del corso sarà suddiviso in un numero di sezione personalizzabili
* Sezioni settimanali - il copro centrale della pagina home del corso sarà suddiviso in una sezione per ciascuna settimana. La data di inizio della prima settimana coinciderà con la data di inizio del corso.';
...
$string['insertcontentsection'] = 'Inserisci contenuto nella sezione \'{$a->sectionname}\'';
...
$string['makeavailablecmtitle'] = 'Rendi disponibile l\'attività';
...
$string['markedthistopic'] = 'Questa sezione è evidenziata come sezione corrente';
$string['markthistopic'] = 'Contrassegna questa sezione come sezione corrente';
$string['match'] = 'Filtra';
...
$string['maxlengthreached'] = 'È stato raggiunto il limite massimo di caratteri {$a}.';
...
$string['modshowcmtitle'] = 'Visualizza attività';
...
$string['moodlenet:sharetyperesource'] = 'risorsa';
...
$string['multipleitemsfound'] = 'Sono stati trovati {$a} elementi';
...
$string['noitemsfound'] = 'Non sono stati trovati elementi.';
...
$string['oneitemfound'] = 'È stato trovato 1 elemento.';
...
$string['viewresults'] = 'Visualizza i risultati per {$a}';
