...
/**
 * Strings for component 'gradereport_singleview', language 'it', version '4.5'.
 *
...
$string['gradeitem'] = 'Visualizzazione valutazioni di {$a}';
$string['gradeitemcannotbeoverridden'] = 'Non è possibile modificare questo elemento di valutazione.';
$string['gradeitemedit'] = 'Modifica valutazioni di {$a}';
$string['gradeuser'] = 'Visualizzazione valutazioni di {$a}';
$string['gradeuseredit'] = 'Modifica valutazioni di {$a}';
...
$string['overrideall'] = 'Modifica tutti i voti';
$string['overrideallgrades'] = 'Sovrascrivi tutto';
$string['overridefor'] = 'Modifiche per {$a}';
$string['overridenone'] = 'Non modificare nessun voto';
