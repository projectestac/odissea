...
/**
 * Strings for component 'repository_local', language 'it', version '3.11'.
 *
...
$string['configplugin'] = 'Configurazione per il repository File del server';
$string['currentusefiles'] = 'File attualmente in uso';
$string['emptyfilelist'] = 'Non ci sono file da visualizzare';
$string['local:view'] = 'Visualizzare repository File del server';
