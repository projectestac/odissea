...
/**
 * Strings for component 'block_course_overview', language 'it', branch 'MOODLE_37_STABLE'
 *
...
$string['configotherexpanded'] = 'Gli altri corsi saranno espansi di default a meno che l\'utente non cambi le proprie preferenze.';
...
$string['privacy:metadata:courseorder'] = 'Elenco ordinato dei corsi visualizzati';
$string['privacy:metadata:coursesortorder'] = 'Ordinamento dei corsi (versione obsoleta)';
$string['privacy:metadata:favourites'] = 'Elenco ordinato dei corsi preferiti';
...
$string['setmaxcoursesmax'] = 'Numero massimo di corsi';
$string['setmaxcoursesmaxdesc'] = 'Il numero massimo di corsi che un utente può selezionare nel blocco Panoramica corsi.';
