...
$string['addcertpage'] = 'Aggiungi una pagina al certificato';
...
$string['elementname_help'] = 'Il nome utilizzato per identificare l\'lemento in fase di modifica. Per esempio, puoi avere più immagini su una pagina e volerle distinguere tra di loro velocemente quando modifichi il certificato. Nota: questo nome non verrà visualizzato nel PDF';
...
$string['emailothers_help'] = 'Consente di inviare agli indirizzi inseriti (separati da una virgola) una copia del certificato, una volta che sarà stato rilasciato.';
...
$string['emailstudents_help'] = 'Consente di inviare agli studenti una copia del certificato, una volta che sarà stato rilasciato.';
$string['emailstudentsubject'] = '{$a->coursefullname}: {$a->certificatename}';
$string['emailteachers'] = 'Notifica i docenti';
$string['emailteachers_help'] = 'Consente di inviare ai docenti una copia del certificato, una volta che sarà stato rilasciato.';
...
$string['getcustomcert'] = 'Scarica il certificato';
...
$string['listofissues'] = 'Destinatari';
$string['load'] = 'Carica';
...
$string['nocustomcerts'] = 'Non ci sono certificati personalizzati per questo corso';
...
$string['uploadimagedesc'] = 'Il link porta a una nuova pagina dove potrai caricare le immagini. Le immagini caricate con questa modalità saranno disponibili a tutti gli utenti del sito che possono creare un certificato personalizzato.';
