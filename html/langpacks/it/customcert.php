...
/**
 * Strings for component 'customcert', language 'it', version '4.4'.
 *
 * @package     customcert
 * @category    string
...
$string['aligncenter'] = 'Centrato';
$string['alignleft'] = 'Allineato a sinistra';
$string['alignment'] = 'Allineamento';
$string['alignment_help'] = 'Questa proprietà imposta l\'allineamento orizzontale dell\'elemento. Alcuni elementi potrebbero non supportarlo, mentre il comportamento di altri potrebbe essere diverso.';
$string['alignright'] = 'Allineamento a destra';
...
$string['certificateexecutionperiod'] = 'Periodo di esecuzione del certificato';
$string['certificateexecutionperiod_desc'] = 'Se il valore non è 0, l\'attività non elaborerà i certificati il cui corso è stato inattivo o l\'ultima emissione è precedente al tempo configurato. Questo può contribuire a migliorare le prestazioni dell\'attività pianificata.';
$string['certificatesperrun'] = 'Certificati per sessione';
$string['certificatesperrun_desc'] = 'Immettere il numero di certificati da elaborare per ogni esecuzione programmata, dove 0 significa che verranno elaborati tutti i certificati.';
$string['code'] = 'Codice';
$string['copy'] = 'Copia';
...
$string['customcert:managelanguages'] = 'Gestione della lingua nel modulo di modifica';
...
$string['downloadallissuedcertificates'] = 'Scaricare tutti i certificati emessi';
$string['downloadallsitecertificates'] = 'Scaricare tutti i certificati del sito';
$string['downloadallsitecertificatesdesc'] = 'Permette di scaricare tutti i certificati del sito in un file zip.';
...
$string['elementheight'] = 'Altezza';
$string['elementheight_help'] = 'Specificare l\'altezza dell\'elemento. Se è consentito \'0\', viene calcolata automaticamente.';
...
$string['eventelementcreated'] = 'Elemento di certificato personalizzato creato';
$string['eventelementdeleted'] = 'Elemento di certificato personalizzato eliminato';
$string['eventelementupdated'] = 'Elemento di certificato personalizzato aggiornato';
$string['eventpagecreated'] = 'Pagina del certificato personalizzato creata';
$string['eventpagedeleted'] = 'Pagina del certificato personalizzato eliminata';
$string['eventpageupdated'] = 'Pagina del certificato personalizzato aggiornata';
$string['eventtemplatecreated'] = 'Modello di certificato personalizzato creato';
$string['eventtemplatedeleted'] = 'Modello di certificato personalizzato eliminato';
$string['eventtemplateupdated'] = 'Modello di certificato personalizzato aggiornato';
...
$string['includeinnotvisiblecourses'] = 'Includere i certificati nei corsi nascosti';
$string['includeinnotvisiblecourses_desc'] = 'I certificati dei corsi nascosti non vengono processati per impostazione predefinita. Se si desidera includerli, attivare questa impostazione.';
...
$string['invalidelementwidthorheightnotnumber'] = 'Inserire un numero valido.';
$string['invalidelementwidthorheightzeroallowed'] = 'Immettere un numero maggiore o uguale a 0.';
$string['invalidelementwidthorheightzeronotallowed'] = 'Inserire un numero maggiore di 0.';
...
$string['scheduledtaskconfigdesc'] = 'Configurare le impostazioni dell\'attività pianificata che elabora i certificati.';
$string['scheduledtaskconfigheading'] = 'Configurazione delle attività pianificate';
...
$string['subplugintype_customcertelement_plural'] = 'Elementi';
$string['taskemailcertificate'] = 'Gestisce l\'invio dei certificati via email';
$string['taskissuecertificate'] = 'Emissione di certificati';
...
$string['useadhoc'] = 'Usa l\'invio di certificati e-mail come attività ad hoc';
