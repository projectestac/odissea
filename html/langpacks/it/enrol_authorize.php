...
/**
 * Strings for component 'enrol_authorize', language 'it', version '3.11'.
 *
...
$string['anrefererdesc'] = 'Pui definire l\'URL referer se ltale URL è stata impostata nel tuo account Authorize.net. In questo modo nella request web sarà inclusa una linea "Referer: URL"';
