...
/**
 * Strings for component 'my', language 'it', version '4.5'.
 *
 * @package     my
 * @category    string
...
$string['coursemanagementoptions'] = 'Opzioni gestione corsi';
...
$string['error:dashboardisdisabled'] = 'La dashboard è stata disabilitata dall’amministratore.';
...
$string['privacy:metadata:core_my:preference:user_home_page_preference'] = 'Preferenza pagina Home dell\'utente';
