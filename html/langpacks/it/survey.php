...
/**
 * Strings for component 'survey', language 'it', version '4.5'.
 *
 * @package     survey
 * @category    string
...
$string['actualstudent'] = '{$a} reale';
$string['allquestionrequireanswer'] = 'Tutte le domande sono a risposta obbligatoria.';
$string['allscales'] = 'Tutte le valutazioni, tutti gli studenti';
$string['alreadysubmitted'] = 'Hai già compilato questo sondaggio';
$string['analysisof'] = 'Analisi di {$a}';
$string['answers'] = 'Risposte';
$string['attls1'] = 'Valutando ciò che le persone dicono, pongo attenzione alla qualità dei suoi argomenti, non alla persona che li presenta.';
...
$string['attls11'] = 'Provo a pensare con le persone anziché contro di loro.';
$string['attls11short'] = 'pensare CON le persone';
$string['attls12'] = 'Ho determinati criteri che uso per valutare gli argomenti di discussione.';
$string['attls12short'] = 'usare criteri per valutare';
...
$string['attls17'] = 'uso la logica e la ragione al di là di ogni mia preoccupazione quando risolvo dei problemi.';
$string['attls17short'] = 'do maggiore importanza alla logica';
$string['attls18'] = 'Posso arrivare alla comprensione di opinioni diverse dalle mie grazie all\'empatia (immedesimarsi nell\'altra persona).';
$string['attls18short'] = 'comprensione per empatia';
$string['attls19'] = 'Quando incontro persone che sembrano avere opinioni diverse dalle mie, faccio uno sforzo per \'immedesimarmi\' in loro, per cercare di capire come hanno maturato quelle opinioni.';
$string['attls19short'] = 'sforzo di immedesimazione';
$string['attls1short'] = 'attenzione alla qualità  degli argomenti';
...
$string['attls3'] = 'Mi piace capire \'da dove vengono\' le altre persone, quali esperienze le hanno portate ad essere quello che sono.';
$string['attls3short'] = 'da dove vengono gli altri';
$string['attls4'] = 'La parte più importante della mia formazione sta nell\'aver imparato a capire le persone molto diverse da me.';
$string['attls4short'] = 'capire le persone diverse';
...
$string['attls7'] = 'Trovo che posso rafforzare la mia posizione discutendo con qualcuno che non è d\'accordo con me.';
$string['attls7short'] = 'rafforzarsi discutendo';
$string['attls8'] = 'Sono sempre interessato a sapere perché le persone dicono e credono nelle cose che fanno.';
...
$string['ciq1'] = 'In classe in quale momento sei più partecipe come studente?';
$string['ciq1short'] = 'Più partecipe';
$string['ciq2'] = 'In classe in quale momento sei meno partecipe come studente?';
$string['ciq2short'] = 'Meno partecipe';
$string['ciq3'] = 'Quale azione nei forum da parte degli altri partecipanti trovi più utile?';
$string['ciq3short'] = 'Momento utile';
$string['ciq4'] = 'Quale azione nei forum da parte degli altri partecipanti trovi disorientante e confusionaria?';
$string['ciq4short'] = 'Momento confusionario';
$string['ciq5'] = 'Quale evento ti ha sorpreso di più?';
$string['ciq5short'] = 'Momento sorprendente';
$string['ciqintro'] = 'Rispondi alle seguenti domande pensando alle attività svolte recentemente in classe.';
...
$string['colles11'] = 'gli altri studenti mi chiedono di spiegare loro le mie idee.';
$string['colles11short'] = 'mi chiedono di spiegare';
$string['colles12'] = 'gli altri studenti rispondono alle mie idee.';
$string['colles12short'] = 'gli studenti mi rispondono';
$string['colles13'] = 'il docente mi stimola a pensare.';
$string['colles13short'] = 'il docente stimola a pensare';
$string['colles14'] = 'il docente mi incoraggia a partecipare.';
$string['colles14short'] = 'il docente mi incoraggia';
$string['colles15'] = 'il docente costruisce una buona discussione.';
$string['colles15short'] = 'il docente costruisce la discussione';
$string['colles16'] = 'il docente costruisce auto-riflessioni critiche.';
$string['colles16short'] = 'il docente costruisce auto-riflessioni';
...
$string['colles19'] = 'gli altri studenti danno valore al mio contributo';
$string['colles19short'] = 'gli studenti mi danno valore';
$string['colles1short'] = 'concentrato sulle cose interessanti';
$string['colles2'] = 'quello che imparo è importante per la mia pratica professionale.';
$string['colles20'] = 'gli altri studenti comprendono l\'impegno che dedico all\'apprendimento';
$string['colles20short'] = 'gli studenti comprendono';
$string['colles21'] = 'accolgo positivamente i commenti degli altri studenti.';
$string['colles21short'] = 'capisco gli altri studenti';
$string['colles22'] = 'gli altri studenti accolgono positivamente i miei commenti.';
$string['colles22short'] = 'gli studenti mi capiscono';
$string['colles23'] = 'accolgo positivamente i commenti del docente.';
$string['colles23short'] = 'capisco il docente';
$string['colles24'] = 'il docente capisce i miei commenti.';
$string['colles24short'] = 'il docente mi capisce';
...
$string['colles4short'] = 'si collega con la mia professione';
...
$string['colles8short'] = 'sono critico sulle letture';
$string['colles9'] = 'spiego le mie idee agli altri studenti.';
$string['colles9short'] = 'spiego le mie idee';
$string['collesaintro'] = 'L\'obiettivo di questo sondaggio è di aiutarci a capire come lo svolgimento online di questa unità ti sia stato utile nell\'apprendimento.
...
Grazie.';
$string['collesapname'] = 'COLLES (Ideale e Reale)';
...
$string['collespintro'] = 'L\'obiettivo di questo sondaggio è di aiutarci a capire come lo svolgimento online di questa unità ti sia stato utile nell\'apprendimento.
...
$string['completionsubmit'] = 'Rispondere al sondaggio';
$string['customintro'] = 'Descrizione';
$string['deleteallanswers'] = 'Tutte le risposte al sondaggio';
$string['deleteanalysis'] = 'Analisi delle risposte';
$string['done'] = 'Fatto';
...
$string['eventreportdownloaded'] = 'Scaricamento report sondaggio';
$string['eventreportviewed'] = 'Visualizzazione report sondaggio';
$string['eventresponsesubmitted'] = 'Invio risposte al sondaggio';
...
$string['nobodyyet'] = 'Nessuno ha ancora compilato questo sondaggio';
$string['notdone'] = 'Non ancora svolto';
$string['notes'] = 'Le tue note e analisi';
$string['notyetanswered'] = 'Senza risposta';
$string['othercomments'] = 'Hai altri commenti?';
$string['page-mod-survey-x'] = 'Qualsiasi pagina con modulo sondaggio';
$string['peoplecompleted'] = '{$a} persone hanno completato il sondaggio';
$string['pluginadministration'] = 'Gestione Sondaggio';
$string['pluginname'] = 'Sondaggio';
...
$string['report'] = 'Report del sondaggio';
...
$string['scaleagree5'] = 'Fortemente in disaccordo,Un po\' in disaccordo,Né d\'accordo né in disaccordo,Abbastanza d\'accordo,Completamente d\'accordo';
$string['scales'] = 'Valutazioni';
$string['scaletimes5'] = 'Quasi Mai,Raramente,A volte,Spesso,Quasi Sempre';
$string['search:activity'] = 'Sondaggio - Informazioni sull\'attività';
$string['seemoredetail'] = 'Clicca qui per ulteriori dettagli';
