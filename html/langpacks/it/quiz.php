...
/**
 * Strings for component 'quiz', language 'it', version '4.5'.
 *
 * @package     quiz
 * @category    string
...
$string['addarandomquestion_success'] = 'Le domande casuali sono state aggiunte';
...
$string['closebeforeopen'] = 'La data di chiusura deve essere successiva alla data di apertura.';
...
$string['completionattemptsexhausted'] = 'Valutazione sufficiente oppure all\'esaurimento dei tentativi consentiti';
...
$string['eventquizgradeitemcreated'] = 'Creazione elemento di valutazione quiz';
$string['eventquizgradeitemdeleted'] = 'Eliminazione elemento di valutazione quiz';
$string['eventquizgradeitemorderchanged'] = 'Modifica ordinamento elemento di valutazione quiz';
$string['eventquizgradeitemupdated'] = 'Aggiornamento elemento di valutazione quiz';
...
$string['eventslotdisplayedquestionnumberupdated'] = 'Aggiornamento slot visualizzazione numero domanda';
$string['eventslotgradeitemupdated'] = 'Aggiornamento slot elemento di valutazione';
$string['eventslotmarkupdated'] = 'Aggiornamento slot';
$string['eventslotmoved'] = 'Spostamento slot';
$string['eventslotrequirepreviousupdated'] = 'Aggiornamento slot richiesta precedente';
$string['eventslotversionupdated'] = 'Aggiornamento versione slot';
...
$string['gradeitemdefaultname'] = 'Nuovo elemento di valutazione {$a}';
$string['gradeitemdelete'] = 'Elimina elemento di valutazione {$a}';
$string['gradeitemedit'] = 'Modifica elemento di valutazione {$a}';
$string['gradeitemmarkscheme'] = 'Assegna elementi di valutazione';
$string['gradeitemnewname'] = 'Nuovo nome per l\'elemento di valutazione {$a}';
$string['gradeitemnoneselected'] = '[nessuno]';
$string['gradeitemnoslots'] = 'Il quiz non ha domande. Aggiungere prima le domande, poi tornare qui per impostare gli elementi di valutazione.';
$string['gradeitems'] = 'Elementi valutazione';
$string['gradeitemsautosetup'] = 'Imposta una valutazione per ogni sezione';
$string['gradeitemsetup'] = 'Impostazione degli elementi di valutazione';
$string['gradeitemsnoneyet'] = 'Crea elementi di valutazione all\'interno del quiz. Assegnare domande o sezioni di quiz a questi elementi di valutazione per suddividere i risultati dei voti in aree diverse.';
$string['gradeitemsremoveall'] = 'Ripristina la configurazione';
$string['gradeitemsremoveallconfirm'] = 'Reimpostare l\'impostazione degli elementi di valutazione?';
$string['gradeitemsremoveallmessage'] = 'Questa operazione eliminerà tutti gli elementi di valutazione e annullerà l\'assegnazione di domande e sezioni.<br><br>Questa azione non influirà sulle domande e sulle sezioni stesse, né sui tentativi esistenti all\'interno del quiz.';
$string['gradeitemsremovealltitle'] = 'Reimposta la configurazione degli elementi di valutazione';
...
$string['lastautosave'] = 'Ultimo salvataggio: {$a}';
...
$string['marks_help'] = 'Il punteggio ottenuto per ciascuna domanda e il punteggio complessivo del tentativo. È possibile selezionare Punteggi solo se è selezionato Punteggi massimi.';
...
$string['maxmarks'] = 'Punteggio massimo';
$string['maxmarks_help'] = 'Il punteggio massimo di ciascuna domanda.';
...
$string['messageprovider:quiz_open_soon'] = 'Apertura quiz imminente';
$string['messageprovider:submission'] = 'Notifiche di consegne quiz';
$string['min'] = 'Minimo';
$string['minutes'] = 'Minuti';
$string['missingcategory'] = 'La categoria delle domande è mancante';
...
$string['noreviewshort'] = 'Revisione non consentita';
...
$string['openclosedatesupdated'] = 'Date di apertura e chiusura';
...
$string['overridecannotchange'] = 'L\'utente o il gruppo non può essere modificato dopo la creazione di una personalizzazione.';
$string['overridecannotsetbothgroupanduser'] = 'Non è possibile impostare contemporaneamente gruppo e utente.';
...
$string['overrideinvalidattempts'] = 'Il valore dei tentativi deve essere maggiore di zero.';
$string['overrideinvalidexistingid'] = 'La personalizzazione corrente non esiste.';
$string['overrideinvalidgroup'] = 'Il gruppo specificato non esiste.';
$string['overrideinvalidquiz'] = 'L\'ID impostato del quiz non esiste.';
$string['overrideinvalidtimelimit'] = 'Il limite di tempo deve essere maggiore di zero.';
$string['overrideinvaliduser'] = 'L\'utente specificato non esiste.';
$string['overridemissingdelete'] = 'Le ID delle personalizzazioni  {$a} non può essere eliminato perché non esiste o non fa parte del quiz specificato.';
$string['overridemultiplerecordsexist'] = 'Non è possibile effettuare più personalizzazioni per lo stesso utente o gruppo.';
$string['overridemustsetuserorgroup'] = 'È necessario impostare un utente o un gruppo.';
...
$string['quizopendatesoonhtml'] = '<p>Gentile {$a->firstname},</p>
<p>l’apertura del quiz <strong>{$a->quizname}</strong> nel corso {$a->coursename} è imminente.
<p><strong>Apertura: {$a->timeopen}</strong></p>
<p><strong>Chiusura: {$a->timeclose}</strong></p>
<p><a href="{$a->url}">Vai al quiz</a></p>';
$string['quizopendatesoonsubject'] = 'Apre il {$a->timeopen}: {$a->quizname}';
...
$string['quizsetupnavigation'] = 'Configurazione della navigazione del quiz';
$string['quiztimer'] = 'Quiz Timer';
$string['quizwillopen'] = 'Questo quiz sarà aperto il {$a}';
$string['random'] = 'Domanda casuale';
$string['randomcatwithsubcat'] = '{$a} e sotto categorie';
$string['randomcoursecatwithsubcat'] = 'Qualsiasi categoria all\'interno della categoria di corso {$a}';
$string['randomcoursewithsubcat'] = 'Qualsiasi categoria del corso';
$string['randomcreate'] = 'Crea Domande casuali';
$string['randomediting'] = 'Modifica domanda casuale';
$string['randomfaultynosubcat'] = 'Domanda errata';
...
$string['randommodulewithsubcat'] = 'Qualsiasi categoria di questo quiz';
...
$string['randomqname'] = 'Domanda casuale basata sulla condizione del filtro';
$string['randomqnamecat'] = '({$a->category}) casuale in base alla condizione del filtro';
$string['randomqnamecattags'] = '({$a->category}) casuale in base alla condizione del filtro con i seguenti tag: {$a->tags}';
$string['randomqnametags'] = 'Domanda casuale basata sulla condizione del filtro con tag: {$a}';
...
$string['randomsystemwithsubcat'] = 'Qualsiasi categoria a livello di sistema';
...
$string['removeallquizattempts'] = 'Tutti i tentativi del quiz';
...
$string['savemanualgradingfailed'] = 'Modifica non salvata. Controllare il messaggio qui sotto e riprovare.';
...
$string['sendnotificationopendatesoon'] = 'Avvisare l\'utente dell\'imminente data di apertura del quiz';
...
$string['summaryofattempts'] = 'I tuoi tentativi';
$string['summaryofattemptscaption'] = 'Riepilogo del tentativo {$a}';
...
$string['top'] = 'Top';
$string['totalmarks'] = 'Totale dei punteggi';
...
$string['updatefilterconditon'] = 'Aggiorna le condizioni del filtro';
$string['updatefilterconditon_success'] = 'Condizioni del filtro aggiornate correttamente';
