...
/**
 * Strings for component 'block_myoverview', language 'it', version '4.5'.
 *
...
$string['aria:courseactions'] = 'Azioni per il corso';
$string['aria:courseprogress'] = 'Stato avanzamento corso:';
$string['aria:coursesummary'] = 'Testo introduttivo corso:';
$string['aria:customfield'] = 'Visualizza {$a} corsi';
$string['aria:displaydropdown'] = 'Visualizza menu a discesa';
...
$string['zero_nocourses_intro'] = 'Hai bisogno di aiuto per iniziare? Consulta la <a href="{$a->dochref}" title="{$a->doctitle}" target="{$a->doctarget}">documentazione di Moodle</a>.';
