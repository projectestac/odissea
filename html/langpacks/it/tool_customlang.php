...
/**
 * Strings for component 'tool_customlang', language 'it', version '4.5'.
 *
...
$string['cliexportfileexists'] = 'Il file per {$a->lang} esiste già e verrà saltato. Se si desidera sovrascrivere, aggiungere l\'opzione --override=true.';
$string['cliexportfilenotfoundforcomponent'] = 'File {$a->filepath} non è stato trovato per la lingua {$a->lang}. Il file verrà ignorato.';
$string['cliexportheading'] = 'Avvio della esportazione dei file della lingua.';
$string['cliexportnofilefoundforlang'] = 'Non è stato trovato nessun file esportare. L\'esportazione di questa lingua viene ignorata.';
