...
/**
 * Strings for component 'repository_googledocs', language 'it', version '4.5'.
 *
...
$string['drawingformat'] = 'Formato di importazione di default dei disegni';
$string['external'] = 'Esterno (solo link memorizzati in Moodle)';
