...
/**
 * Strings for component 'form', language 'it', version '4.5'.
 *
 * @package     form
 * @category    string
...
$string['err_lettersonly'] = 'Devi inserire solo lettere.';
$string['err_maxfiles'] = 'Non puoi allegare più di {$a} file.';
$string['err_maxlength'] = 'Devi inserire non più di {$a->format} caratteri.';
$string['err_minlength'] = 'Devi inserire almeno {$a->format} caratteri.';
...
$string['err_positiveduration'] = 'Questa durata non può essere negativa';
$string['err_positiveint'] = 'Devi inserire un numero intero maggiore di 0.';
...
$string['formactions'] = 'Azione del modulo';
...
$string['togglesensitive'] = 'Attiva/disattiva sensibili';
$string['unmaskpassword'] = 'Visualizza';
$string['year'] = 'Anno';
