...
/**
 * Strings for component 'forum', language 'it', version '4.5'.
 *
 * @package     forum
 * @category    string
...
$string['messageinboundthresholdhit'] = 'Non è stato possibile inserire la tua risposta poiché hai superato la soglia massima interventi impostata nel forum.';
...
$string['nopostforum'] = 'Non sei autorizzato ad intervenire in questo forum.';
...
$string['noquestions'] = 'Al momento non ci sono domande in questo forum.';
...
$string['notingroup'] = 'Devi appartenere ad un gruppo per poter visualizzare questo forum.';
...
$string['removeallforumtags'] = 'Tutti i tag del forum';
...
$string['resetdigests'] = 'Tutte le preferenze utente per l\'email di raccolta';
$string['resetforums'] = 'Rimuovi tutti gli interventi da questi tipi di forum';
$string['resetforumsall'] = 'Tutti gli interventi';
$string['resetsubscriptions'] = 'Tutte le sottoscrizioni al forum';
$string['resettrackprefs'] = 'Tutte le impostazioni di tracciamento del forum';
