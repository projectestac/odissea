...
$string['clienablemodel'] = 'E\' possibile abilitare il modello selezionando un intervallo di analisi tramite la corrispondente ID. E\' anche possibile abilitarlo in seguito tramite l\'interfaccia web (\'nessuno\' per uscire).';
...
$string['invalidindicatorsremoved'] = 'E\' stato aggiunto un nuovo modello. Gli indicatori che non funzionano con l\'obiettivo selezionato sono stati rimossi automaticamente.';
...
$string['restoredefaultinfo'] = 'Questi modelli di default risultano mancanti oppure sono stati modificati dopo l\'installazione. E\' possibile ripristinare i modelli di default selezionati.';
