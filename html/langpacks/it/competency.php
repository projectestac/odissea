...
/**
 * Strings for component 'competency', language 'it', version '4.5'.
 *
 * @package     competency
 * @category    string
...
$string['deletecompetencyratings'] = 'Valutazioni delle competenze';
...
$string['eventcompetencycreated'] = 'Creazione competenza';
$string['eventcompetencydeleted'] = 'Eliminazione competenza';
$string['eventcompetencyframeworkcreated'] = 'Creazione quadro di competenze';
$string['eventcompetencyframeworkdeleted'] = 'Eliminazione quadro di competenze';
$string['eventcompetencyframeworkupdated'] = 'Aggiornamento quadro di competenze';
$string['eventcompetencyframeworkviewed'] = 'Visualizzazione quadro di competenze.';
$string['eventcompetencyupdated'] = 'Aggiornamento competenza';
$string['eventcompetencyviewed'] = 'Visualizzazione competenza';
$string['eventevidencecreated'] = 'Creazione attestazione';
$string['eventplanapproved'] = 'Approvazione piano di formazione';
$string['eventplancompleted'] = 'Completamento piano di formazione';
$string['eventplancreated'] = 'Creazione piano di formazione';
$string['eventplandeleted'] = 'Eliminazione piano di formazione';
$string['eventplanreopened'] = 'Riapertura piano di formazione';
$string['eventplanreviewrequestcancelled'] = 'Annullamento richiesta revisione piano di formazione';
$string['eventplanreviewrequested'] = 'Richiesta di revisione piano di formazione';
$string['eventplanreviewstarted'] = 'Inizio revisione piano di formazione';
$string['eventplanreviewstopped'] = 'Fine revisione piano di formazione';
$string['eventplanunapproved'] = 'Disapprovazione piano di formazione';
$string['eventplanunlinked'] = 'Scollegamento piano di formazione';
$string['eventplanupdated'] = 'Aggiornamento piano di formazione';
$string['eventplanviewed'] = 'Visualizzazione piano di formazione';
$string['eventtemplatecreated'] = 'Creazione modello di piano di formazione';
$string['eventtemplatedeleted'] = 'Eliminazione modello di piano di formazione';
$string['eventtemplateupdated'] = 'Aggiornamento modello di piano di formazione';
$string['eventtemplateviewed'] = 'Visualizzazione modello di piano di formazione';
$string['eventusercompetencyplanviewed'] = 'Visualizzazione piano delle competenze dell\'utente';
$string['eventusercompetencyrated'] = 'Valutazione competenza utente';
$string['eventusercompetencyratedincourse'] = 'Valutazione competenza utente in un corso';
$string['eventusercompetencyratedinplan'] = 'Valutazione competenza utente in un piano di formazione';
$string['eventusercompetencyreviewrequestcancelled'] = 'Annullamento richiesta di revisione competenza dell\'utente';
$string['eventusercompetencyreviewrequested'] = 'Richiesta di revisione competenza utente';
$string['eventusercompetencyreviewstarted'] = 'Inizio revisione competenza dell\'utente';
$string['eventusercompetencyreviewstopped'] = 'Fine revisione competenza dell\'utente';
$string['eventusercompetencyviewed'] = 'Visualizzazione competenza utente';
$string['eventusercompetencyviewedincourse'] = 'Visualizzazione competenza utente in un corso';
$string['eventusercompetencyviewedinplan'] = 'Visualizzazione competenza utente in un piano di formazione';
$string['eventuserevidencecreated'] = 'Creazione attestazione della formazione pregressa';
$string['eventuserevidencedeleted'] = 'Eliminazione attestazione della formazione pregressa';
$string['eventuserevidenceupdated'] = 'Aggiornamento attestazione della formazione pregressa';
...
$string['evidence_coursemodulecompleted'] = 'L\'attività \'{$a}\' è stata completata.';
...
$string['usercompetency'] = 'Competenza utente';
