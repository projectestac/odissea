...
$string['advancedsearchoptions'] = 'Opzioni di ricerca';
...
$string['cannotdeletetopcat'] = 'Le categorie di primo livello non possono essere eliminate.';
$string['cannotedittopcat'] = 'Le categorie di primo livello non possono essere modificate.';
...
$string['changepublishstatuscat'] = '<a href="{$a->caturl}">La categoria "{$a->name}"</a> nel corso "{$a->coursename}" avrà il suo stato di condivisione cambiato da {$a->changefrom} a {$a->changeto}.';
...
$string['correctfeedback'] = 'Per risposte esatte';
...
$string['deletequestioncheck'] = 'Questa operazione eliminerà la seguente domanda e tutte le sue versioni:<br/><br/>{$a}';
$string['deletequestionscheck'] = 'Questa operazione eliminerà le seguenti domande e tutte le rispettive versioni:<br/><br/>{$a}';
$string['deletequestiontitle'] = 'Eliminare la domanda?';
$string['deletequestiontitle_plural'] = 'Eliminare le domande?';
$string['deleteselectedquestioncheck'] = 'Questa operazione eliminerà le versioni selezionate della seguente domanda:<br /><br />{$a}';
$string['deleteversiontitle'] = 'Eliminare la versione selezionata?';
$string['deleteversiontitle_plural'] = 'Eliminare le versioni selezionate?';
...
$string['eventquestioncategoryupdated'] = 'Aggiornamento categoria di domande';
$string['eventquestioncategoryviewed'] = 'Visualizzazione categoria di domande';
$string['eventquestioncreated'] = 'Creazione domanda';
$string['eventquestiondeleted'] = 'Eliminazione domanda';
$string['eventquestionmoved'] = 'Spostamento domanda';
$string['eventquestionsexported'] = 'Esportazione domanda';
$string['eventquestionsimported'] = 'Importazione domanda';
$string['eventquestionupdated'] = 'Aggiornamento domanda';
...
$string['partiallycorrectfeedback'] = 'Per risposte parzialmente esatte';
$string['partiallycorrectfeedbackdefault'] = 'Risposta parzialmente esatta.';
...
$string['privacy:metadata:database:question_attempt_steps'] = 'Ciascun tentativo di risposta comprende un certo numero di passi che rappresentano le diverse fasi, inizio, completamento, valutazione. La tabella contiene le informazioni di ogni passo.';
$string['privacy:metadata:database:question_attempt_steps:fraction'] = 'Valutazione ottenuta nel tentativo della domanda in una scala in cui il massimo è 1.';
...
$string['privacy:metadata:database:question_bank_entries'] = 'Dettagli di una voce specifica del deposito domande.';
$string['privacy:metadata:database:question_bank_entries:ownerid'] = 'Persona prorietaria della voce del deposito domande.';
...
$string['rightanswer_help'] = 'Un sommario delle risposte esatte generato automaticamente. Questo  sommario è limitato,  potrebbe essere preferibile fornire la risposta corretta nel feedback generale della domanda, disabilitando questa impostazione.';
$string['save'] = 'Salva';
