...
/**
 * Strings for component 'assignfeedback_offline', language 'it', branch 'MOODLE_38_STABLE'
 *
...
$string['default_help'] = 'Consente di abilitare di default il foglio di valutazione offline per i compiti di nuova creazione.';
