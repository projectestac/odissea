...
/**
 * Strings for component 'analytics', language 'it', branch 'MOODLE_38_STABLE'
 *
 * @package   analytics
...
$string['analyticsdisabled'] = 'L\'analitica è disabilitata. E\' possibile abilitarla da "Amministrazione del sito" > "Funzionalità avanzate".';
...
$string['defaulttimesplittingmethods_help'] = 'L\'intervallo di analisi imposta quando il motore dei pronostici elaborerà i dati e la porzione di log da tenere in considerazione. Il processo di valutazione itererà in tutti i metodi abilitati di suddivisione del tempo, pertanto tanti più metodi saranno abilitati tanto più lenta sarà l\'elaborazione.';
...
$string['errorimportversionmismatches'] = 'La versione dei seguenti componenti non corrisponde da quella installata nel sito: {$a}. E\' possibile utilizzare l\'opzione \'Ignora mancate corrispondenze di versione\' per ignorare le differenze.';
...
$string['errornoexportconfigrequirements'] = 'E\' possibile esportare solamente i modelli con intervallo di analisi.';
...
$string['washelpful'] = 'E\' stata utile?';
