...
/**
 * Strings for component 'tool_uploaduser', language 'it', version '4.5'.
 *
...
$string['invaliduserdatavalues'] = 'Dati errati ({$a->values}) trovati per l\'utente {$a->username}. Questi dati sono stati corretti o eliminati.';
