...
$string['asyncemailenabledetail'] = 'Gli utenti saranno avvisati tramite notifica quando il backup/ripristino asincrono sarà stato completato.';
$string['asyncgeneralsettings'] = 'Backup/ripristino asincrono';
$string['asyncmessagebody'] = 'Notifica';
$string['asyncmessagebodydefault'] = '{operation} (ID: {backupid}) è stato completato correttamente. Per accedere: <a href="{link}">{link}</a>.';
$string['asyncmessagebodydetail'] = 'Notifica da inviare quando il backup/ripristino asincrono sarà stato completato:';
$string['asyncmessagesubject'] = 'Oggetto';
$string['asyncmessagesubjectdefault'] = '{operation} Moodle è stata completata correttamente';
$string['asyncmessagesubjectdetail'] = 'Oggetto della notifica';
...
$string['backupfile'] = 'File di backup';
...
$string['backupthenrestore'] = 'Backup completato. Click su Start per ripristinare';
...
$string['choosefilefromactivitybackup_help'] = 'File di backup di questa attività.';
$string['choosefilefromautomatedbackup'] = 'Backup automatici';
$string['choosefilefromautomatedbackup_help'] = 'File di backup generati automaticamente.';
$string['choosefilefromcoursebackup'] = 'Area backup corso';
$string['choosefilefromcoursebackup_help'] = 'File di backup di questo corso.';
$string['choosefilefromuserbackup'] = 'Area backup personali';
$string['choosefilefromuserbackup_help'] = 'File di backup privati per tutti i corsi, con informazioni utente anonimizzate.';
...
$string['configgeneralcustomfield'] = 'Imposta il default per l\'inclusione di campi personalizzati in un backup.';
...
$string['configgeneralxapistate'] = 'L\'mpostazione di default per includere lo stato dell\'utente nel contenuto come le attività H5P in un backup.';
...
$string['configrestorecustomfield'] = 'Imposta il default per il ripristino dei campi personalizzati.';
...
$string['configrestorexapistate'] = 'l\'impostazione di default per il ripristino dello stato dell\'utente in contenuti come le attività H5P.';
...
$string['copycoursedesc'] = 'Crea una copia di questo corso in qualsiasi categoria di corso.';
...
$string['enableasyncbackup_help'] = 'Le operazioni di backup e ripristino saranno asincrone. Fornisce un\'esperienza migliore, consentendo all\'utente di svolgere altre attività durante i backup o i ripristini. L\'impostazione non ha influenza su importazioni ed esportazioni.';
...
$string['generalcustomfield'] = 'Includi campi personalizzati';
...
$string['generalxapistate'] = 'Includi lo stato dell\'utente nei contenuti, come le attività H5P.';
...
$string['importfile'] = 'Carica un file di backup';
$string['importfromccmidtocourse'] = 'Importa da cmid:{$a->srccmid} nel corso:{$a->dstcourseid}';
$string['importfromcoursetocourse'] = 'Importa dal corso:{$a->srccourseid} nel corso:{$a->dstcourseid}';
...
$string['managefiles_activity'] = 'Gestione backup attività';
$string['managefiles_automated'] = 'Gestione backup automatici';
$string['managefiles_backup'] = 'Gestione backup privati';
$string['managefiles_course'] = 'Gestione backup dei corsi';
...
$string['restorenofilesbackuparea'] = 'Non sono presenti file di backup.';
$string['restorenofilesbackuparea_activity'] = 'Non sono presenti file di backup di questa attiivtà.';
$string['restorenofilesbackuparea_automated'] = 'Non sono presenti file di backup automatici.';
$string['restorenofilesbackuparea_backup'] = 'Non sono presenti file di backup privati.';
$string['restorenofilesbackuparea_course'] = 'Non sono presenti file di backup di questo corso.';
