...
/**
 * Strings for component 'block_activity_results', language 'it', version '4.4'.
 *
...
$string['config_decimalplaces'] = 'Cifre decimali da visualizzare';
...
$string['config_grade_format'] = 'Visualizza valutazioni come';
$string['config_name_format'] = 'Privacy dei risultati';
$string['config_names_anon'] = 'Risultati anonimi';
$string['config_names_full'] = 'Visualizza nome e cognome';
$string['config_names_id'] = 'Visualizza solo codici identificativi';
$string['config_no_activities_in_course'] = 'In questo corso al momento non sono presenti attività';
...
$string['defaulthighestgrades'] = 'Numero di valutazioni più alte visualizzate di default';
$string['defaulthighestgrades_desc'] = 'Imposta il numero di valutazioni più alte visualizzate di default';
...
$string['privacy:metadata'] = 'Il blocco Risultati attività visualizza solamente dati memorizzati da altri componenti.';
