...
/**
 * Strings for component 'availability_group', language 'it', branch 'MOODLE_38_STABLE'
 *
...
$string['anygroup'] = '(Qualsiasi gruppo)';
$string['description'] = 'Criterio di accesso basato sull\'appartenenza a gruppi.';
...
$string['requires_notgroup'] = 'Non appartenere a <strong>{$a}</strong>';
$string['title'] = 'Gruppo';
