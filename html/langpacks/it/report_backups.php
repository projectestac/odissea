...
/**
 * Strings for component 'report_backups', language 'it', branch 'MOODLE_38_STABLE'
 *
...
$string['backupofcourselogs'] = 'Log del backup di {$a}';
$string['logsofbackupexecutedon'] = 'Log del backup effettuato il {$a}';
