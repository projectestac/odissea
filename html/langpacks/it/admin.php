...
/**
 * Strings for component 'admin', language 'it', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['configautolangusercreation'] = 'Utilizza la lingua rilevata dal browser quando si creano utenti';
...
$string['configlanglist'] = 'Lascia vuoto se vuoi consentire agli utenti di scegliere tra tutte le lingue installate. In alternativa è possibile abbreviare il menu delle lingue inserendo un elenco dei codici lingua separati da virgole, adPer esempio: en, es_es, it, fr. E\' anche possibile visualizzare un nome diverso del language pack utilizzando il seguente formato:  language code|language name, come ad esempio en_kids|English,de_kids|Deutsch.';
...
$string['configsupportemail'] = 'Indirizzo email al quale  gli utenti del sito possono rivolgersi per richieste di assistenza (ad esempio, quando nuovi utenti creano il proprio account). Se il campo è lasciato vuoto, non verrà fornita nessuna email di supporto.';
...
$string['environmentmariadbwrongdbtype'] = '<code>$CFG->dbtype</code> errato: deve essere cambiato nel file <code>config.php</code>, modificando \'<code>mysql</code>\' in \'<code>mariadb</code> \'.';
...
$string['frontpagebackup'] = 'Backup pagina home';
...
$string['frontpagequestions'] = 'Domande pagina home';
$string['frontpagerestore'] = 'Ripristino pagina home';
$string['frontpageroles'] = 'Ruoli pagina hme';
...
$string['iscustomadminwarnings'] = 'E\' stato rilevato che questo sito utilizza una cartella admin personalizzata. Questa funzionalità non è iù supportata e sarà rimossa a partere da Moodle 4.2.';
...
$string['moodlebrandedappreference'] = 'E\' anche possibile avere la <a href="https://moodle.com/branded-app/">Branded Moodle app</a> con il proprio logo e colori.';
...
$string['registermoodleorg'] = 'Registrando il tuo sito';
...
$string['searchallavailablecourses_desc'] = 'In alcuni casi il motore di ricerca può non funzionare correttamente lavorando su troppi corsi. E\' possibile limitare la ricerca ai corsi dove si è iscritti.';
...
$string['unsupportedphpversion80'] = 'Il PHP versione 8.0 non è supportato.';
...
$string['xmlrpcmaharaenabled'] = 'E\' stato rilevato che su questo sito è attivo l\'ePortfolio Mahara. Questa funzionalità si basa sull\'estensione PHP XML-RPC che non più mantenuta da PHP.';
$string['xmlrpcmnetenabled'] = 'E\' stato rilevato che su questo sito è attivo Moodle Networking. Quseta funzionalità si basa sull\'estensione PHP XML-RPC che non più mantenuta da PHP.';
$string['xmlrpcrecommended'] = 'L\'estensione XMLRPC è utile per i web service e il Moodle Networking.';
$string['xmlrpcwebserviceenabled'] = 'E\' stato rilevato che su questo sito è attivo il protocollo web service XML-RPC. Questa funzionalità si basa sull\'estensione PHP XML-RPC che non più mantenuta da PHP.';
