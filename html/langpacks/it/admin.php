...
$string['configenablewebservices'] = 'I Web service consentono ad altri sistemi di collegarsi a Moodle e di effettuare varie operazioni, come ad esempio ola App Mobile Moodle. Per maggiore sicurezza, abilitare i Web service solo se si ha realmente bisogno di usarli.';
...
$string['divertallemailsexcept_desc'] = 'Elenco di eccezioni in forma di regole separate da virgola o da a capo. Ciascuna regola verrà interpretata come espressione regolare, ad esempio:
<pre>simone@acme.com
.*@acme.com
fred(\\+.*)?@acme.com
</pre>';
