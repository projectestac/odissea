...
$string['configgradeexportdefault'] = 'Selezionare il formato di default di esportazione del registro delle valutazioni.';
...
$string['configproxybypass'] = 'Elenco di nomi host (parziali) o indirizzi IP che dovrebbero bypassare il proxy. Separare ogni elemento con virgole, senza spazi. Ad esempio: 192.168.0.0/16,*.mydomain.com.';
...
$string['confirmationpending'] = 'Conferma in attesa';
...
$string['deleteduserx'] = 'Utente {$a} eliminato';
...
$string['hookdeprecates'] = 'Callback deprecate';
...
$string['maxcharacter'] = 'Massimo {$a} caratteri';
...
$string['purgecachesconfirm'] = 'Moodle può tenere in cache temi, javascript, stringhe di lingua, testo filtrato, feed RSS ed altri tipi di dati elaborati. Svuotando le cache i dati saranno eliminati dal server e il browser verrà costretto a ricaricarli, in questo modo si potrà essere certi di visualizzare i dati più aggiornati. Svuotare le cache non presenta rischi, tuttavia il sito potrà subire un rallentamento fino a quando le cache non saranno ripristinate.';
...
$string['settingzendexceptionignoreargs'] = 'Si consiglia vivamente di abilitare l\'impostazione PHP zend.exception_ignore_args come precauzione di sicurezza.';
...
$string['sitesectionhelp'] = 'Visualizza una sezione nella parte superiore della pagina dove aggiungere contenuti personalizzati.';
...
$string['smallscreensonly'] = 'Solo schermi piccoli';
$string['smtp'] = 'SMTP';
...
$string['task_adhoc_failed_retention'] = 'Periodo di conservazione delle elaborazioni ad hoc non riuscite';
$string['task_adhoc_failed_retention_desc'] = 'Il periodo massimo in cui le elaborazioni ad hoc non riuscite devono rimanere in coda una volta raggiunto il limite di tentativi.';
...
$string['themeeditsettingsname'] = 'Modifica impostazione \'{$a}\' del tema';
...
$string['themeselector'] = 'Temi';
$string['themesettings'] = 'Impostazioni tema';
$string['themesettingsadvanced'] = 'Impostazioni avanzate tema';
$string['themesettingscustom'] = 'Impostazioni tema personalizzato';
$string['themesettingsname'] = 'Impostazioni tema \'{$a}\'';
$string['themeusagereportname'] = 'Report utilizzo tema \'{$a}\'';
...
$string['unicoderequired'] = 'Tutti i dati devono essere archiviati in formato Unicode (UTF-8). Per le nuove installazioni, il database deve avere UTF-8 come set di caratteri predefinito. Se si sta eseguendo l\'aggiornamento, si deve seguire il processo di migrazione a UTF-8.';
...
$string['unsupportedphpversion84'] = 'La versione PHP 8.4 e successive non sono supportate.';
...
$string['userfiltersdefault_desc'] = 'Selezionare i filtri che devono essere visualizzati nella pagina \'Azioni in massa\'. Tenere premuto il tasto Ctrl per selezionare più elementi. Eventuali filtri non selezionati saranno disponibili facendo clic sul collegamento \'Visualizza altro\'.';
