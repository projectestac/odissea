...
/**
 * Strings for component 'payment', language 'it', version '4.4'.
 *
 * @package     payment
 * @category    string
...
$string['gotopaymentaccounts'] = 'È possibile creare più account di pagamento utilizzando i gateway disponibili nella pagina {$a}';
