...
$string['passwordrequired'] = 'Devi inserire la password della sessioen prima di poter registrare la tua presenza.';
...
$string['sessionupdated'] = 'Sessioen aggiornata correttamente';
...
$string['studentmarked'] = 'La tua presenta a questa sessioen è stata registrata.';
...
$string['studentscanmarksessiontimeend_desc'] = 'Se la sessione non ha un orario di fine, consente di impostare per quanti minuti lasciare disponibile la registrazione della presenza alla sessioen.';
