...
$string['addmultiplesessions'] = 'Ripeti lezione';
$string['addsession'] = 'Aggiungi lezione';
$string['adduser'] = 'Aggiungi utente';
$string['addwarning'] = 'Aggiungi avvertimento';
$string['all'] = 'Tutte';
...
$string['attendance:import'] = 'Importa lezioni da file (csv)';
...
$string['automarkuseempty_desc'] = 'Quando selezionato, gli stati che hanno il campo "Disponibilità agli" impostato a vuoto o non impostato saranno disponibili durante la registrazione automatica';
...
$string['invalidsessionenddate'] = 'Questa data non può essere antecedente alla data della lezione';
...
$string['maxwarn'] = 'Massimo numero di email di avvertimento';
$string['maxwarn_help'] = 'Il numero massimo di volte che un avvertimento deve essere inviato (è inviato solo un avvertimento per lezione).';
...
$string['modulename_help'] = 'Il modulo Presenza consente al docente di registrare le presenze durante la lezione agli studenti di visualizzare lo stato delle loro presenze.
...
$string['multisessionexpanded_desc'] = 'Visualizza la sezione "Ripeti lezione" già espansa nella creazione di nuove lezioni.';
...
$string['pluginadministration'] = 'Amministrazione presenza';
...
$string['privacy:metadata:attendancelog'] = 'I log delle registrazioni della presenza dell\'utente.';
$string['privacy:metadata:attendancesessions'] = 'Le lezioni per cui la presenza è stata registrata.';
$string['privacy:metadata:attendancewarningdone'] = 'I log degli avvertimenti che sono stati inviati agli utenti in base alle informazioni di presenza.';
$string['privacy:metadata:duration'] = 'La durata della lezione in secondi.';
$string['privacy:metadata:groupid'] = 'L\'ID del gruppo associato alla lezione.';
$string['privacy:metadata:ipaddress'] = 'L\'indirizzo IP da cui è stata registrata la presenza.';
$string['privacy:metadata:lasttaken'] = 'L\'orario di quando è stata registrata la presenza.';
$string['privacy:metadata:lasttakenby'] = 'L\'ID dell\'ultimo utente che ha registrato la propria presenza';
$string['privacy:metadata:notifyid'] = 'ID della lezione a cui l\'avvertimento è associato.';
$string['privacy:metadata:remarks'] = 'I commenti sulla presenza di un utente.';
$string['privacy:metadata:sessdate'] = 'Orario di inizio di una lezione.';
$string['privacy:metadata:sessionid'] = 'ID della lezione.';
...
$string['privacy:metadata:studentid'] = 'L\'ID dello studente a cui è stata registrata la presenza.';
$string['privacy:metadata:takenby'] = 'L\'ID dell\'utente che ha registrato la presenza dello studente.';
$string['privacy:metadata:timemodified'] = 'Orario di quando la lezione è stata modificata per l\'ultima volta';
$string['privacy:metadata:timesent'] = 'Orario di quando è stato inviata l\'avvertenza.';
$string['privacy:metadata:timetaken'] = 'Orario di quando la presenza è stata registrata per lo studente';
$string['privacy:metadata:userid'] = 'ID dell\'utente a cui mandare l\'avvertimento.';
...
$string['sessionduplicate'] = 'Esiste una lezione duplicata nel corso {$a->course} per l\'attività {$a->activity}, {$a->date}';
...
$string['sessionscompleted'] = 'Lezioni svolte';
$string['sessionscurrentcourses'] = 'Corsi attuali';
$string['sessionsgenerated'] = '{$a} lezioni sono state create correttamente';
...
$string['unknownstatus'] = 'ID dello stato sconosciuto: {$a}';
...
$string['warningdesc_course'] = 'Queste soglie di avvertimento agiscono nel report delle assenze e permetteno agli studenti o altri utenti di essere avvertiti. Se più di un avvertimento è attivato nello stesso momento, soltanto l\'avvertimento con soglia più bassa sarà inviato.';
