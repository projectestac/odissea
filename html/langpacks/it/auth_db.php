...
/**
 * Strings for component 'auth_db', language 'it', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbpasstype'] = '<p>Il formato utilizzato dal campo password.</p> <p>Utiilzzare \'Interno9 se sio desidera lasciare al database esterno la gestione di username ed email ma delegare a Moodle la gestione delle password. Se si utilizza \'Interno\', è <i>obbligatorio</i> configurare un campo email che nel database esterno contenga dei dati. Inoltre è necessario eseguire con regolarità gli script  admin/cron.php e auth/db/auth_db_sync_users.php per consentire a Moodle di inviare tramite email una password provvisoria a ciascun nuovo utente.</p>';
