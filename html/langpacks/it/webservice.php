...
/**
 * Strings for component 'webservice', language 'it', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['createuserdescription'] = 'È necessario creare un utente web service per il sistema che controllerà Moodle.';
...
$string['enabledocumentationdescription'] = 'È disponile la documentazione dettagliata dei web service relativa ai protocolli abilitati.';
...
$string['erroroptionalparamarray'] = 'Il parametro di descrizione web service di nome \'{$a}\' è una struttura singola o multipla. Non è possibile impostarlo a VALUE_OPTIONAL. Controllare la descrizione del web service.';
$string['eventwebservicefunctioncalled'] = 'Richiamo di funzione web service';
$string['eventwebserviceloginfailed'] = 'Autenticazione web service fallita';
$string['eventwebserviceservicecreated'] = 'Creazione servizio web service';
$string['eventwebserviceservicedeleted'] = 'Eliminazione servizio web service';
$string['eventwebserviceserviceupdated'] = 'Aggiornamento servizio web service';
$string['eventwebserviceserviceuseradded'] = 'Aggiunta utente servizio web service';
$string['eventwebserviceserviceuserremoved'] = 'Eliminazione utente servizio web service';
$string['eventwebservicetokencreated'] = 'Creazione token web service';
$string['eventwebservicetokensent'] = 'Invio token web service';
...
$string['missingcaps_help'] = 'Elenco dei privilegi richiesti per usare la funzione che non sono posseduti dall\'utente selezionato. Per fruire del servizio è necessario assegnare all\'utente i privilegi mancanti.';
$string['missingpassword'] = 'Password mancante';
$string['missingrequiredcapability'] = 'È necessario il privilegio {$a}.';
...
$string['privacy:metadata'] = 'Le API webservice non memorizzano dati personali';
...
$string['testwithtestclientdescription'] = 'Simula l\'accesso al web service dall\'esterno  tramite il client di test. È possibile utilizzare un protocollo abilitato con l\'autenticazione via token.<strong>Attenzione: la funzione SARA\' REALMENTE ESEGUITA, fare molta attenzione su cosa si sceglie di provare.</strong>';
$string['token'] = 'Token';
$string['tokenauthlog'] = 'Autenticazione token';
$string['tokencopied'] = 'Testo copiato nella clipboard.';
...
$string['tokennamehint'] = 'Se non si inserisce un nome, sarà utilizzato un nome generato casualmente.';
$string['tokennameprefix'] = 'Webservice-{$a}';
$string['tokennewmessage'] = 'Copiare il token adesso. Non sarà più visualizzato una volta cambiata la pagina.';
...
$string['validuntil_empty'] = 'Il token non ha data di scadenza';
