...
$string['aggregatesonly'] = 'Visualizza solo i totali';
...
$string['calculationwarning'] = 'Questa categoria utilizza un calcolo per il totale della categoria di valutazione anziché un\'aggregazione.';
...
$string['errorcalculationbroken'] = 'Si è verificato un errore durante il calcolo della valutazione {$a}.';
...
$string['erroroverweight'] = 'Il peso totale supera il 100%.';
...
$string['errorunderweight'] = 'Il peso totale è inferiore al 100%.';
...
$string['feedbackprovided'] = 'Feedback fornito';
$string['feedbacks'] = 'Feedback';
$string['feedbacksaved'] = 'Feedback salvato';
$string['feedbackview'] = 'Vedi feedback';
$string['filterbothactive'] = 'Primi ({$a->first}) Ultimi ({$a->last})';
$string['filterbyname'] = 'Filtra per nome';
$string['filterfirstactive'] = 'Primi ({$a->first})';
$string['filterlastactive'] = 'Ultimi ({$a->last})';
...
$string['fullmode'] = 'Visualizza valutazioni e totali';
...
$string['gradesonly'] = 'Visualizza solo le valutazioni';
...
$string['linktoactivity'] = '{$a->name} attività {$a->title}';
$string['lock'] = 'Blocca';
...
$string['missingitemtypeoreid'] = 'La chiave dell\'array (itemtype oppure eid) è mancante manca';
...
$string['movesitems'] = 'Sposta elementi';
...
$string['nonunhideableverbose'] = 'Per rendere visibile questa valutazione si deve prima rendere visibile {$a->itemname}.';
...
$string['searchcollapsedcolumns'] = 'Ricerca nelle colonne chiuse';
...
$string['showingaggregatesonly'] = 'Visualizzazione solo dei totali';
$string['showingfullmode'] = 'Visualizzazione delle valutazioni e dei totali';
...
$string['viewfeedback'] = 'Vsualizza feedback';
