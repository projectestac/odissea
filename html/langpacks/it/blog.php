...
/**
 * Strings for component 'blog', language 'it', version '4.5'.
 *
 * @package     blog
 * @category    string
...
$string['deleteblogassociations'] = 'Associazioni blog';
...
$string['eventblogexternaladded'] = 'Registrazione blog esterno';
$string['eventblogexternalremoved'] = 'Rimozione registrazione blog esterno';
$string['eventblogexternalupdated'] = 'Aggiornamento blog esterno';
$string['evententryadded'] = 'Inserimento intervento blog';
$string['evententrydeleted'] = 'Eliminazione intervento blog';
$string['evententryupdated'] = 'Aggiornamento intervento blog';
$string['eventexternalblogsviewed'] = 'Visualizzazione blog esterno registrato';
...
$string['incorrectblogfilter'] = 'È stato specificato un tipo di filtro blog errato';
...
$string['privacy:metadata:core_comments'] = 'Commenti associati agli interventi sul blog.';
$string['privacy:metadata:core_files'] = 'File allegati agli interventi sul blog.';
$string['privacy:metadata:core_tag'] = 'Tag associati agli interventi sul blog.';
$string['privacy:metadata:external'] = 'Collegamento al feed RSS esterno';
$string['privacy:metadata:external:description'] = 'Descrizione del feed';
$string['privacy:metadata:external:filtertags'] = 'Elenco dei tag con cui filtrare gli interventi.';
$string['privacy:metadata:external:name'] = 'Nome del feed';
$string['privacy:metadata:external:timefetched'] = 'Data e ora dell\'ultimo caricamento del feed.';
$string['privacy:metadata:external:timemodified'] = 'Data e ora dell\'ultima modifica dell\'associazione.';
$string['privacy:metadata:external:url'] = 'URL del feed';
$string['privacy:metadata:external:userid'] = 'ID dell\'utente che ha aggiunto un intervento esterno sul blog.';
$string['privacy:metadata:post'] = 'Informazioni relative agli interventi sul blog.';
$string['privacy:metadata:post:content'] = 'Contenuto di un intervento esterno su un blog.';
$string['privacy:metadata:post:created'] = 'Data di creazione dell\'intervento blog';
$string['privacy:metadata:post:lastmodified'] = 'Data di modifica più recente dell\'intervento blog';
$string['privacy:metadata:post:publishstate'] = 'Visibilità dell\'intervento ad altri';
$string['privacy:metadata:post:subject'] = 'Titolo dell\'intervento blog';
$string['privacy:metadata:post:summary'] = 'Testo dell\'intervento blog';
$string['privacy:metadata:post:uniquehash'] = 'Identificativo unico per un intervento esterno, generalmente un URL.';
$string['privacy:metadata:post:userid'] = 'ID dell\'utente che ha inserito l\'intervento blog';
