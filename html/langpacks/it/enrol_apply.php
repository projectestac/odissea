...
/**
 * Strings for component 'enrol_apply', language 'it', version '4.5'.
 *
 * @package     enrol_apply
 * @category    string
...
$string['btncancel'] = 'Rifiuta richieste';
$string['btnconfirm'] = 'Conferma richieste';
...
$string['expirymessageenrolledsubject'] = 'Notifica di scadenza della richiesta di iscrizione';
$string['expirymessageenrollersubject'] = 'Notifica di scadenza della richiesta di iscrizione';
$string['expirynotifyall'] = 'Docenti e utenti iscritti';
$string['expirynotifyenroller'] = 'Solo ai docenti';
$string['group'] = 'Assegnazione a gruppo';
$string['group_help'] = 'Puoi assegnare in automatico gli iscritti con questo metodo a uno o più gruppi';
...
$string['messageprovider:expiry_notification'] = 'Notifiche di scadenza della richiesta di iscrizione al corso';
...
$string['opt_commentaryzone'] = 'Campo di commento';
$string['opt_commentaryzone_help'] = 'Abilita un campo di commento nella pagina di iscrizione';
...
$string['sendexpirynotificationstask'] = 'Invio delle notifica di scadenza delle richieste di iscrizione';
