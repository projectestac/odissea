...
$string['aria-toggledropdown'] = 'Commuta la llista desplegable següent';
...
$string['calculationwarning'] = 'Aquesta categoria utilitza un càlcul de qualificacions per al total de la categoria en lloc d\'una agregació.';
...
$string['deletescale'] = 'Suprimeix l\'escala';
...
$string['duplicatedgradeitem'] = '{$a} (còpia)';
...
$string['editoutcome'] = 'Edita el resultat';
...
$string['enableoutcomes'] = 'Habilita els resultats';
...
$string['eventgradeexported'] = 'S\'ha exportat la qualificació';
$string['eventgradeitemcreated'] = 'S\'ha creat l\'element de qualificació';
$string['eventgradeitemdeleted'] = 'S\'ha esborrat l\'element de qualificació';
...
$string['exportalloutcomes'] = 'Exporta tots els resultats';
$string['exportas'] = 'Exporta com a';
...
$string['gradebooknavigationmenu'] = 'Menú de navegació del llibre de qualificacions';
...
$string['gradeletter_help'] = '<p>Es poden utilitzar lletres (A, B, C, ...) o paraules (Matrícula d\'honor, Excel·lent, Aprovat, ... ) per representar un interval de qualificacions.</p>';
...
$string['gradeoutcomeitem'] = 'Qualifica l\'element de resultat';
$string['gradeoutcomes'] = 'Resultats';
$string['gradeoutcomescourses'] = 'Resultats del curs';
...
$string['hidenooutcomes'] = 'Mostra els resultats';
...
$string['importdata_help'] = 'Les qualificacions es poden enganxar directament des d\'un full de càlcul OpenDocument o Excel amb el format següent:

* Almenys una columna hauria de contenir dades d\'identitat de l\'usuari - nom d\'usuari, adreça de correu electrònic o número ID.
* Altres columnes haurien de tenir encapçalaments per a les activitats existents o elements de qualificació.

Es pot obtenir un full de càlcul amb el format correcte exportant primer algunes qualificacions. Després, el full de càlcul es pot editar per afegir més qualificacions i desar-lo.

Seleccioneu i copieu les columnes que voleu importar des del full de càlcul i després enganxeu-les en aquest camp.';
...
$string['importskippednomanagescale'] = 'No teniu permís per a afegir una nova escala, de manera que el resultat «{$a}» s\'ha omès, ja que requeria crear una escala nova.';
$string['importskippedoutcome'] = 'Ja existeix un resultat amb el nom curt «{$a}» en aquest context. El que contenia el fitxer importat s\'ha omès.';
$string['importstandard'] = 'Importa com a resultats estàndard';
...
$string['itemsedit'] = 'Edita l\'element de qualificació';
...
$string['manageoutcomes'] = 'Gestiona les competències';
...
$string['newitem'] = 'Element de qualificació nou';
$string['newoutcomeitem'] = 'Nou element de resultat';
$string['no'] = 'No';
...
$string['noexistingoutcomes'] = 'No hi ha resultats existents.';
$string['noexistingscales'] = 'No hi ha escales existents.';
...
$string['noscales'] = 'Els resultats han d\'estar vinculats a una escala del curs o a una escala global, però no n\'hi ha cap. Voleu crear-ne una?';
...
$string['outcomecategory'] = 'Crea resultats en la categoria';
$string['outcomecategorynew'] = 'Categoria nova';
$string['outcomeconfirmdelete'] = 'Segur que voleu esborrar el resultat «{$a}»?';
$string['outcomecreate'] = 'Afegeix un resultat nou';
$string['outcomedelete'] = 'Esborra el resultat';
$string['outcomefullname'] = 'Nom complet';
$string['outcomeitem'] = 'Element de resultat';
$string['outcomeitemsedit'] = 'Edita l\'element de resultat';
$string['outcomereport'] = 'Informe de resultats';
$string['outcomes'] = 'Resultats';
$string['outcomescourse'] = 'Resultats emprats al curs';
$string['outcomescoursecustom'] = 'Resultats personalitzats emprats (no els suprimiu)';
$string['outcomescoursenotused'] = 'Resultats estàndard no emprats';
$string['outcomescourseused'] = 'Resultats estàndard  emprats (no els suprimiu)';
$string['outcomescustom'] = 'Resultats personalitzats';
$string['outcomesdisabled'] = 'Els resultats no estan habilitats';
$string['outcomeshortname'] = 'Nom curt';
$string['outcomesstandard'] = 'Resultats estàndard';
$string['outcomesstandardavailable'] = 'Resultats estàndard disponibles';
$string['outcomestandard'] = 'Resultat estàndard';
$string['outcomestandard_help'] = 'Un resultat estàndard està disponible per a tots els cursos del lloc.';
...
$string['privacy:metadata:grade_import_newitem:itemname'] = 'Nom de l\'element de qualificació nou';
...
$string['privacy:metadata:outcomes'] = 'Un registre de resultats';
...
$string['privacy:metadata:outcomeshistory'] = 'Un registre de les versions prèvies de resultats';
...
$string['selectgrouplink'] = 'Seleccioneu un grup';
$string['selectuserlink'] = 'Seleccioneu un usuari';
...
$string['showallgrades'] = 'Mostra totes les qualificacions';
...
$string['shownooutcomes'] = 'Oculta els resultats';
...
$string['usenooutcome'] = 'No utilitzis resultats';
...
$string['usermappingerrormultipleusersfound'] = 'Error de mapatge d\'usuari: S\'han trobat múltiples usuaris amb el valor «{$a->value}» al camp «{$a->field}». Utilitzeu un camp de mapatge més individualitzat.';
...
$string['viewfeedback'] = 'Visualitza els comentaris';
...
$string['weightorextracredit'] = 'Ponderació o crèdit extra';
