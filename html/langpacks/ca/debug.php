...
/**
 * Strings for component 'debug', language 'ca', version '4.5'.
 *
 * @package     debug
 * @category    string
...
$string['invalideventdata'] = 'Dades d\'esdeveniment incorrectes enviades: {$a}';
...
$string['line'] = 'Línia';
$string['missingconfigversion'] = 'La taula de configuració no conté la versió. No podeu continuar.';
...
$string['reactive_highlightoff'] = 'Ressalta desactivat';
$string['reactive_highlighton'] = 'Ressalta activat';
$string['reactive_instances'] = 'Instàncies reactives:';
$string['reactive_noinstances'] = 'Aquesta pàgina no té cap instància reactiva.';
$string['reactive_pin'] = 'Fixa';
$string['reactive_readmodeoff'] = 'Mode de lectura desactivat';
$string['reactive_readmodeon'] = 'Mode de lectura activat';
$string['reactive_resetpanel'] = 'Reinicia el tauler';
$string['reactive_saveingwarning'] = 'Atenció: Editar l\'estat pot causar resultats inesperats.';
$string['reactive_statedata'] = 'Dades de l\'estat';
$string['reactive_unpin'] = 'Deixa de fixar';
...
$string['stacktrace'] = 'Traça de la pila';
