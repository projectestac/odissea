...
$string['cannoteditentryorblog'] = 'No podeu editar aquesta entrada o bloc';
...
$string['deleteblogassociations'] = 'Associacions de blogs';
...
$string['entrytitlewithlink'] = 'Títol de l\'entrada amb enllaç';
...
$string['linktooriginalentry'] = 'Entrada original del blog';
...
$string['privacy:metadata:core_files'] = 'Fitxers adjuntats a les entrades del blog';
$string['privacy:metadata:core_tag'] = 'Etiquetes associades amb entrades de blog';
$string['privacy:metadata:external'] = 'Un enllaç a un canal RSS extern';
$string['privacy:metadata:external:description'] = 'La descripció del canal';
$string['privacy:metadata:external:filtertags'] = 'La llista d\'etiquetes amb les quals filtrar les entrades';
$string['privacy:metadata:external:name'] = 'El nom del canal';
$string['privacy:metadata:external:timefetched'] = 'L\'hora de la darrera actualització del canal';
$string['privacy:metadata:external:timemodified'] = 'L\'hora de la darrera modificació de l\'associació';
$string['privacy:metadata:external:url'] = 'L\'URL del canal';
$string['privacy:metadata:external:userid'] = 'L\'ID de l\'usuari que ha afegit l\'entrada del blog extern';
$string['privacy:metadata:post'] = 'La informació relacionada amb les entrades del blog';
$string['privacy:metadata:post:content'] = 'El contingut d\'una entrada de blog externa';
$string['privacy:metadata:post:created'] = 'La data de creació de l\'entrada del blog';
$string['privacy:metadata:post:lastmodified'] = 'La data de la darrera modificació de l\'entrada del blog';
$string['privacy:metadata:post:publishstate'] = 'Si l\'entrada és visible per als altres o no';
$string['privacy:metadata:post:subject'] = 'El títol de l\'entrada del blog';
$string['privacy:metadata:post:summary'] = 'El text de l\'entrada del blog';
$string['privacy:metadata:post:uniquehash'] = 'Un identificador únic per a una entrada externa, típicament un URL';
$string['privacy:metadata:post:userid'] = 'L\'ID de l\'usuari que ha afegit l\'entrada del blog';
$string['privacy:metadata:post:usermodified'] = 'L\'usuari que va modificar l\'última entrada';
$string['privacy:path:blogassociations'] = 'Publicacions associades al blog';
$string['privacy:unknown'] = 'Desconegut';
...
$string['publishtodraft'] = 'Esborrany';
