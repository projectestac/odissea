...
/**
 * Strings for component 'report_eventlist', language 'ca', branch 'MOODLE_38_STABLE'
 *
...
$string['abstractclass'] = 'Classe abstracta';
$string['action'] = 'Acció';
$string['affectedtable'] = 'Taula afectada';
$string['all'] = 'Tots';
$string['clear'] = 'Neteja';
...
$string['errorinvaliddirectory'] = 'El directori de l\'esdeveniment no existeix o és no vàlid.';
$string['errorinvalidevent'] = 'L\'esdeveniment proporcionat no és un esdeveniment vàlid.';
