...
/**
 * Strings for component 'block_html', language 'ca', version '4.5'.
 *
 * @package     block_html
 * @category    string
...
$string['configclasses_help'] = 'El propòsit d\'aquesta configuració és prestar assistència amb la tematització ajudant a distingir uns blocs HTML dels altres. Qualssevol classes de CSS que introduïu aquí (delimitades per espais) s\'afegiran a les classes per defecte.';
$string['configcontent'] = 'Contingut';
$string['configtitle'] = 'Títol del bloc';
$string['html:addinstance'] = 'Afegeix un bloc HTML nou';
