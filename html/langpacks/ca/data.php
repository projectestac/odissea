...
$string['choosepreset'] = 'Fitxer de la preconfiguració';
...
$string['entrieslefttoadd'] = 'Heu d\'afegir {$a->entriesleft} entrada/es més per completar aquesta activitat.';
$string['entrieslefttoaddtoview'] = 'Heu d\'afegir {$a->entrieslefttoview} entrada/es més abans que pugueu veure les entrades d\'altres participants.';
...
$string['exportpreset'] = 'Exporta la preconfiguració';
...
$string['fieldsinformationtags'] = 'Informació del camp';
...
$string['headeraddtemplate'] = 'Defineix la interfície per a afegir entrades noves o editar-les.';
...
$string['importandapply'] = 'Importa la preconfiguració i aplica-la';
$string['importapreset'] = 'Importa una preconfiguració';
$string['importentries'] = 'Importa les entrades';
$string['importpreset'] = 'Importa la preconfiguració';
$string['importpreset_desc'] = 'La preconfiguració s’aplicarà a aquesta activitat, i crearà camps i plantilles. No apareixerà a la llista de preconfiguracions.';
...
$string['listview'] = 'Visualització de llista';
$string['longitude'] = 'Longitud';
$string['manageapproved'] = 'Permet l\'edició d\'entrades aprovades';
$string['manageapproved_help'] = 'Permet que els alumnes editin o suprimeixin les seves entrades després que aquestes hagin estat aprovades. Caldrà tornar a aprovar aquestes entrades editades.';
$string['managefields'] = 'Gestiona els camps';
...
$string['otherfields'] = 'Tots els altres camps';
...
$string['previewaction'] = 'Previsualitza';
...
$string['resetalltemplates'] = 'Reinicialitza totes les plantilles';
$string['resetalltemplatesconfirmtitle'] = 'Confirmeu que voleu reinicialitzar totes les plantilles?';
...
$string['usepreset'] = 'Empra aquesta preconfiguració';
