...
/**
 * Strings for component 'editor', language 'ca', version '3.11'.
 *
 * @package     editor
 * @category    string
...
$string['privacy:metadata:preference:htmleditor'] = 'Editor de text preferit.';
$string['privacy:preference:htmleditor'] = 'El vostre editor de text preferit per escriure HTML és {$a}';
