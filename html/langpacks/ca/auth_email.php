...
/**
 * Strings for component 'auth_email', language 'ca', version '4.5'.
 *
 * @package     auth_email
 * @category    string
...
$string['privacy:metadata'] = 'El complement d\'autenticació d\'autoregistre basat en correu electrònic no emmagatzema cap dada personal.';
