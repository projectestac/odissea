...
/**
 * Strings for component 'tool_task', language 'ca', version '4.5'.
 *
 * @package     tool_task
 * @category    string
...
$string['clearfaildelay_confirm'] = 'Confirmeu que voleu netejar el retard de fallada per a la tasca «{$a}»? Després de netejar el retard, la tasca s\'executarà d\'acord amb el seu calendari normal.';
