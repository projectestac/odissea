...
$string['addmoreimages'] = 'Blancs per a {no} elements arrossegables més';
...
$string['formerror_noimageselected'] = 'Heu de seleccionar un element d\'arrossegar com a elecció correcta per a aquesta zona de destí.';
