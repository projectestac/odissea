...
/**
 * Strings for component 'logstore_database', language 'ca', version '4.5'.
 *
...
$string['privacy:metadata:log:eventname'] = 'El nom de l\'esdeveniment';
$string['privacy:metadata:log:origin'] = 'L\'origen de l\'esdeveniment';
$string['privacy:metadata:log:other'] = 'Informació adicional sobre l\'esdeveniment';
$string['read'] = 'Lectura';
