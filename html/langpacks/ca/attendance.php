...
/**
 * Strings for component 'attendance', language 'ca', version '4.4'.
 *
 * @package     attendance
 * @category    string
...
$string['allowupdatestatus_help'] = 'Si es marca, els estudiants podran actualitzar la seva assistència a una sessió després d\'haver-ne informat ells mateixos.';
...
$string['availability'] = 'Disponibilitat de l\'autocontrol';
$string['availability_help'] = 'Restringeix la disponibilitat d’aquest estat. <br> Si se selecciona l’opció de temps limitat, aleshores cal proporcionar el nombre de minuts durant els quals estarà disponible aquest estat després que hagi començat la sessió. Això s’aplica quan cada estudiant fa el marcatge de la seva pròpia assistència.';
$string['availabilityalways'] = 'Sempre';
$string['availabilitylimitedtime'] = 'Temps limitat';
$string['availablebeforesession'] = 'Disponible abans del començament de la sessió';
$string['availablebeforesession_help'] = 'Quan cada estudiant fa el marcatge de la seva pròpia assistència, permet que es pugui triar aquest estat abans que comenci la sessió.';
...
$string['deletecheckfull'] = 'Esteu segur que voleu suprimir completament {$a}, incloses totes les dades d\'usuari?';
...
$string['newstatusset'] = 'Nou conjunt d\'estats';
...
$string['saveandshownext'] = 'Desa i mostra la pàgina següent';
