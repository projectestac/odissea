...
$string['captureyes'] = 'La targeta de crèdit serà registrada i l\'estudiant s\'inscriurà al curs. Hi esteu d\'acord?';
...
$string['subvoidyes'] = 'La transacció reemborsada ({$a->transid}) està essent cancel·lada i retornarà la quantitat {$a->amount} al vostre compte. Hi esteu d\'acord?';
