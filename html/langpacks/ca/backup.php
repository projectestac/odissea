...
/**
 * Strings for component 'backup', language 'ca', version '4.5'.
 *
 * @package     backup
 * @category    string
...
$string['asyncemailenable'] = 'Activa les notificacions';
$string['asyncemailenabledetail'] = 'Si està habilitat, els usuaris rebran una notificació quan es completi una còpia de seguretat o restauració asíncrona.';
$string['asyncgeneralsettings'] = 'Còpia de seguretat/restauració asíncrona';
$string['asyncmessagebody'] = 'Notificació';
$string['asyncmessagebodydefault'] = 'La vostra {operation} (ID: {backupid}) s\'ha completat correctament. Hi podeu accedir aquí: <a href="{link}">{link}</a>.';
$string['asyncmessagebodydetail'] = 'Notificació per enviar quan es completi una còpia de seguretat o una restauració asíncrona.';
$string['asyncmessagesubject'] = 'Assumpte';
$string['asyncmessagesubjectdefault'] = '{operation} de Moodle completada amb èxit.';
$string['asyncmessagesubjectdetail'] = 'Assumpte de la notificació';
...
$string['choosefilefromactivitybackup_help'] = 'Fitxers de còpia de seguretat per a aquesta activitat.';
$string['choosefilefromautomatedbackup'] = 'Còpies de seguretat automàtiques';
$string['choosefilefromautomatedbackup_help'] = 'Fitxers de còpia de seguretat generats automàticament.';
$string['choosefilefromcoursebackup'] = 'Àrea de còpies de seguretat de cursos';
$string['choosefilefromcoursebackup_help'] = 'Fitxers de còpia de seguretat per a aquest curs.';
$string['choosefilefromuserbackup'] = 'Àrea privada de còpies de seguretat de l\'usuari';
$string['choosefilefromuserbackup_help'] = 'Fitxers de còpia de seguretat privats per a tots els cursos, amb informació d\'usuari anonimitzada.';
...
$string['configgeneralcustomfield'] = 'Defineix els valors per defecte per incloure camps personalitzats en una còpia de seguretat.';
$string['configgeneralfiles'] = 'Estableix els valors per defecte per incloure els fitxers en una còpia de seguretat. Avís: El fet d\'inhabilitar aquest paràmetre farà que només es creen enllaços als fitxers. No és un problema si la còpia de seguretat es restaura en el mateix servidor i els fitxers no s\'han eliminat segons el paràmetre \'Neteja els fitxers de la paperera\' (filescleanupperiod).';
...
$string['configrestorecustomfield'] = 'Defineix els valors per defecte per restaurar camps personalitzats.';
...
$string['copycoursedesc'] = 'Crea una còpia d\'aquest curs a qualsevol categoria de curs.';
$string['copycourseheading'] = 'Còpia un curs';
$string['copycoursetitle'] = 'Còpia el curs: {$a}';
$string['copydest'] = 'Destinació';
$string['copyfieldnotfound'] = 'No s\'han trobat dades de camp obligatòries per al(s) camp(s): {$a}';
...
$string['enableasyncbackup_help'] = 'Si s\'habilita, les operacions de còpia de seguretat i restauració es faran de manera asíncrona. Això proporciona una millor experiència d\'usuari que permet als usuaris realitzar altres operacions mentre hi ha una còpia de seguretat o restauració en curs. Això no afecta les importacions ni les exportacions.';
...
$string['error_delegate_section_not_found'] = 'Falta la secció de delegats del formulari del mòdul del curs (ID {$a}). No es farà una còpia de seguretat de la secció.';
...
$string['errorrestorefrontpagebackup'] = 'Només podeu restaurar les còpies de seguretat de la pàgina d\'inici a la pàgina d\'inici.';
...
$string['generalcustomfield'] = 'Inclou els camps personalitzats';
...
$string['importfile'] = 'Puja un fitxer de còpia de seguretat';
...
$string['includeuserinfo_instance'] = 'Inclou les dades d\'usuari de {$a}';
...
$string['managefiles_activity'] = 'Gestiona les còpies de seguretat de l\'activitat';
$string['managefiles_automated'] = 'Gestiona les còpies de seguretat automatitzades';
...
$string['pendingasyncedit'] = 'Hi ha una còpia de seguretat o una còpia pendents d\'aquest curs. No editeu el curs fins que no s\'hagi completat.';
...
$string['recyclebin_desc'] = 'Heu de tenir en compte que aquests paràmetres també s\'utilitzen a la paperera de reciclatge.';
...
$string['restoreexecutionsuccess'] = 'El curs s\'ha restaurat amb èxit.';
...
$string['restorenofilesbackuparea'] = 'Encara no hi ha fitxers de còpia de seguretat.';
$string['restorenofilesbackuparea_activity'] = 'Encara no hi ha fitxers de còpies de seguretat d\'aquesta activitat.';
$string['restorenofilesbackuparea_automated'] = 'Encara no hi ha fitxers de còpies de seguretat automàtiques.';
$string['restorenofilesbackuparea_backup'] = 'Encara no hi ha fitxers de còpies de seguretat privades.';
$string['restorenofilesbackuparea_course'] = 'Encara no hi ha fitxers de còpies de seguretat d\'aquest curs.';
...
$string['section_prefix'] = 'Secció {$a}:';
...
$string['sitecourseformatwarning'] = 'Això és una còpia de seguretat de la pàgina principal. Només es pot restaurar a la pàgina principal.';
...
$string['subsectioncontent'] = 'Context de la subsecció';
