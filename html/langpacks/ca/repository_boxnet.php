...
/**
 * Strings for component 'repository_boxnet', language 'ca', version '3.11'.
 *
...
$string['cannotcreatereference'] = 'No es pot crear una referència, no teniu prou permisos per compartir el fitxer a Box.';
