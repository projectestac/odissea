...
/**
 * Strings for component 'role', language 'ca', version '4.5'.
 *
 * @package     role
 * @category    string
...
$string['confirmaddadmins'] = 'Confirmeu que voleu afegir els usuaris següents a la llista d\'administradors del lloc?';
$string['confirmdeladmin'] = 'Realment voleu eliminar l\'usuari <strong>{$a}</strong> de la llista d\'administradors del lloc?';
$string['confirmremoveadmins'] = 'Confirmeu que voleu eliminar els usuaris següents de la llista d\'administradors del lloc?';
...
$string['confirmunassign'] = 'Confirmeu que voleu eliminar aquest rol d\'aquest usuari?';
