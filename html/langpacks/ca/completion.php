...
$string['achievingpassinggrade'] = 'Assoliment de la qualificació per aprovar';
...
$string['activitycompletion'] = 'Condicions de la compleció';
...
$string['addconditions'] = 'Afegeix condicions';
...
$string['all'] = 'Totes';
$string['allconditions'] = 'L\'activitat està completada quan els alumnes fan tot el següent:';
$string['any'] = 'Qualsevol';
$string['approval'] = 'Aprovació';
$string['areyousureoverridecompletion'] = 'Segur que voleu rectificar l\'estat de compleció actual d\'aquesta activitat d\'aquest usuari i marcar-la com a «{$a}»?';
$string['badautocompletion'] = 'Heu de seleccionar almenys una condició.';
$string['badcompletiongradeitemnumber'] = 'No es pot habilitar el requeriment de qualificació per <b>{$a}</b> perquè la puntuació per {$a} està inhabilitada.';
...
$string['completedunlockedtext'] = 'En desar aquest formulari, les dades de compleció s\'esborraran i es tornaran a calcular sempre que sigui possible. Per evitar-ho, podeu navegar sense desar.';
$string['completedwarning'] = 'Opcions de compleció bloquejades';
$string['completedwarningtext'] = 'Aquesta activitat està marcada com a completada per a un o més estudiants. Si desbloquegeu els paràmetres per fer un canvi i després deseu el formulari, les dades de finalització s\'eliminaran i es tornaran a calcular sempre que sigui possible. La finalització manual no es pot tornar a calcular, per la qual cosa, en aquest cas, l\'estudiant l\'haurà de marcar com a completada de nou.';
...
$string['completion_automatic'] = 'Afegeix requisits';
$string['completion_help'] = 'Si s\'habilita, es fa un seguiment de la compleció de l\'activitat, ja sigui de forma manual o de forma automàtica, sobre la base de certes condicions. Es poden configurar múltiples condicions. Si es fa així, l\'activitat només es considerarà completada quan es compleixin TOTES les condicions.';
$string['completion_link'] = 'activitat/compleció';
$string['completion_manual'] = 'Els estudiants han de marcar de forma manual l\'activitat com a completada';
$string['completion_none'] = 'Cap';
$string['completionactivitydefault'] = 'Utilitza el valor per defecte de l\'activitat';
$string['completionanygrade_desc'] = 'Qualsevol qualificació';
$string['completiondefault'] = 'Valor per defecte del seguiment de la compleció';
...
$string['completionpassgrade_desc'] = 'Qualificació per aprovar';
...
$string['completionusegrade_desc'] = 'Rebre una qualificació';
$string['completionusegrade_help'] = 'Si s\'habilita, l\'activitat es considera completada quan un estudiant rep una qualificació. Les icones d\'aprovat o suspès es mostraran si s\'ha configurat la qualificació per aprovar l\'activitat.';
$string['completionview'] = 'Visualització requerida';
$string['completionview_desc'] = 'Mostra l\'activitat';
...
$string['detail_desc:view'] = 'Mostra';
$string['done'] = 'Fet';
$string['editconditions'] = 'Edita les condicions';
$string['editcoursecompletionsettings'] = 'Edita els paràmetres de compleció del curs';
$string['emptyconditionsinfo'] = 'No s\'ha establert cap condició de compleció per a aquesta activitat.';
$string['emptyconditionswarning'] = 'Heu d\'afegir almenys una condició de compleció.';
$string['enablecompletion'] = 'Habilita el seguiment de la compleció';
$string['enablecompletion_help'] = 'Si està activat, podeu establir condicions per a la compleció de l\'activitat o del curs.';
...
$string['err_settingslocked'] = 'Un o més estudiants han completat algun criteri i, per això, la configuració està bloquejada. Desbloquejar els paràmetres esborrarà qualsevol dada de compleció dels usuaris i pot causar confusió.';
...
$string['incompatibleplugin'] = 'Aquesta activitat no admet la configuració predeterminada de compleció. Les condicions de compleció s\'han d\'establir manualment per a cada ús.';
...
$string['manualselfcompletionnote'] = 'Nota: El bloc d\'autocompleció s\'hauria d\'afegir al curs si l\'autocompleció manual està activa.';
...
$string['showcompletionconditions_help'] = 'Mostra les condicions de compleció de l\'activitat a la pàgina del curs.';
...
$string['unit'] = 'Unitat';
$string['unlockcompletion'] = 'Desbloqueja els paràmetres de compleció';
$string['unlockcompletiondelete'] = 'Desbloqueja els paràmetres de compleció i esborra les dades de compleció dels usuaris';
