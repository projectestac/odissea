...
$string['showcompletionconditions_help'] = 'Les condicions de compleció de l\'activitat es mostren sempre a la pàgina de l\'activitat. Aquest paràmetre determina si les condicions de compleció es mostren també (o no) al dessota de cada activitat a la pàgina del curs.';
