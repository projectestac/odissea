...
$string['completionexpected_help'] = 'Aquest paràmetre especifica la data en què s\'espera que es completi l\'activitat. Quan la data és propera, l\'activitat els llista al bloc «Cronologia» del Tauler.';
