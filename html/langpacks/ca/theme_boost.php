...
/**
 * Strings for component 'theme_boost', language 'ca', version '3.11'.
 *
 * @package     theme_boost
 * @category    string
...
$string['bootswatch_desc'] = 'Un «bootswatch» és un conjunt de variables i CCS de Bootstrap per configurar el Bootstrap';
...
$string['preset'] = 'Configuració predeterminada del tema';
...
$string['rawscss_desc'] = 'Utilitzeu aquest camp per proporcionar codi SCSS o CSS que serà injectat al final del full d\'estils.';
