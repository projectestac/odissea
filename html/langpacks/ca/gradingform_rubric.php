...
$string['additionalfeedback'] = 'Retroacció addicional';
...
$string['criterionmovedown'] = 'Mou cap avall';
$string['criterionmoveup'] = 'Mou cap amunt';
$string['criterionremark'] = 'Nota per al criteri {$a->description}: {$a->remark}';
$string['definerubric'] = 'Defineix rúbrica';
$string['description'] = 'Descripció';
$string['enableremarks'] = 'Permet que l\'avaluador afegeixi observacions en format de text al final de cada criteri';
...
$string['lockzeropoints'] = 'Calcula la qualificació establint com a puntuació mínima la qualificació mínima assolible en la rúbrica';
...
$string['rubricmappingexplained'] = 'La puntuació mínima per a aquesta rúbrica és de <b>{$a->minscore} punts</b>. Es convertirà en la qualificació mínima disponible per a aquesta activitat (la qual és zero, llevat que s\'utilitzi una escala). La puntuació màxima de <b>{$a->maxscore} punts</b> es convertirà en la qualificació màxima. Les puntuacions intermèdies es convertiran i s\'arrodoniran a la qualificació més pròxima.

Si una escala s\'usa com a qualificació, la puntuació es convertirà en elements de l\'escala com si fossin números enters consecutius.

Aquest càlcul de la qualificació es pot modificar editant el formulari i marcant la casella «Calcula la qualificació establint com a puntuació mínima la qualificació mínima assolible en la rúbrica».';
