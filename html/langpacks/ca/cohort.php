...
$string['cohortmember'] = 'Membre de la cohort';
$string['cohorts'] = 'Cohorts';
$string['cohortsin'] = 'Cohorts disponibles: {$a}';
$string['component'] = 'Font';
$string['contextcohortnotallowed'] = 'La cohort <b>{$a}</b> no està permesa en aquest context.';
...
$string['invalidtheme'] = 'El tema de la cohort no existeix';
...
$string['privacy:metadata:cohort_members'] = 'Informació sobre la cohort de l\'usuari.';
$string['privacy:metadata:cohort_members:cohortid'] = 'L\'ID de la cohort';
$string['privacy:metadata:cohort_members:timeadded'] = 'La marca horària que indica quan es va afegir l\'usuari a la cohort';
$string['privacy:metadata:cohort_members:userid'] = 'L\'ID de l\'usuari que està associat a la cohort';
