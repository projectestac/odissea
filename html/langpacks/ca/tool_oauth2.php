...
$string['deleteconfirm'] = 'Confirmeu que que voleu esborrar l\'emissor d\'identitat «{$a}»? Qualsevol connector que depengui d\'aquest emissor deixarà de funcionar.';
$string['deleteendpointconfirm'] = 'Confirmeu que voleu esborrar l\'<em>endpoint</em> «{$a->endpoint}» de l\'emissor «{$a->issuer}»? Qualsevol connector que depengui d\'aquest <em>endpoint</em> deixarà de funcionar.';
$string['deleteuserfieldmappingconfirm'] = 'Confirmeu que voleu esborrar el mapatge de camps d\'usuari per a l\'emissor «{$a}»?';
