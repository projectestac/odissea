...
/**
 * Strings for component 'editor_tinymce', language 'ca', version '4.5'.
 *
...
$string['advanced_dlg:link_is_email'] = 'L\'URL que heu introduït sembla una adreça de correu. Voleu afegir-hi el prefix necessari mailto://?';
$string['advanced_dlg:link_is_external'] = 'L\'URL que heu introduït sembla un enllaç extern. Voleu afegir-hi el prefix necessari http://?';
...
$string['advimage_dlg:missing_alt'] = 'Confirmeu que voleu continuar sense incloure-hi una descripció de la imatge? Sense aquesta, la imatge no serà accessible per a les persones usuàries amb discapacitat, o per a aquelles que utilitzin un navegador de text, o les que naveguin amb les imatges desactivades.';
...
$string['advlink_dlg:is_email'] = 'L\'URL que heu introduït sembla una adreça de correu. Voleu afegir-hi el prefix necessari mailto://?';
$string['advlink_dlg:is_external'] = 'L\'URL que heu introduït sembla un enllaç extern. Voleu afegir-hi el prefix necessari http://?';
...
$string['common:invalid_data'] = 'Error: Heu introduït valors no vàlids; estan marcats en vermell.';
...
$string['common:popup_blocked'] = 'Ens hem adonat que el vostre bloquejador de finestres emergents ha desactivat una finestra que proporciona funcionalitat a l\'aplicació. Haureu de desactivar el blocatge de finestres emergents en aquest lloc per tal d\'utilitzar plenament aquesta eina.';
...
$string['customtoolbar_desc'] = 'Cada línia conté un llista de botons separats per comes, utilitzeu "|"  com a separador de grup, les línies buides s\'ignoren. Mireu <a href="{$a}" target="_blank">{$a}</a> per veure una llista de botons per defecte de TinyMCE. <br /> La primera fila sempre es mostrarà, mentre que la segona i la tercera barra d\'eines es pot ocultar/mostrar.';
...
$string['fullpage_dlg:movedown'] = 'Desplaça cap avall l\'element seleccionat';
$string['fullpage_dlg:moveup'] = 'Desplaça cap amunt l\'element seleccionat';
...
$string['media_dlg:invokeurls'] = 'Invoca URL';
...
$string['paste:paste_text_desc'] = 'Enganxa com a text net';
$string['paste:paste_word_desc'] = 'Enganxa des de Word';
$string['paste:plaintext_mode'] = 'Enganxa està actualment en mode de text net. Feu clic de nou per canviar Enganxa al mode normal.';
...
$string['spellchecker:no_sug'] = 'Cap suggeriment';
