...
/**
 * Strings for component 'qformat_webct', language 'ca', version '4.4'.
 *
...
$string['unknowntype'] = 'Tipus desconegut de pregunta després de la línia {$a}';
$string['warningsdetected'] = '{$a} avis(os) detectat(s)';
$string['wronggrade'] = 'Puntuació errònia  (després de la línia {$a}) :';
