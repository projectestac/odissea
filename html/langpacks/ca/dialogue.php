...
/**
 * Strings for component 'dialogue', language 'ca', version '4.5'.
 *
 * @package     dialogue
 * @category    string
...
$string['configmaxattachments'] = 'Nombre màxim d\'adjuncions per defecte permeses per missatge.';
...
$string['conversationcloseconfirm'] = 'Confirmeu que voleu tancar la conversa {$a}?';
$string['conversationclosed'] = 'La conversa {$a} s\'ha tancat';
$string['conversationdeleteconfirm'] = 'Confirmeu que voleu suprimir la conversa {$a}? (Aquesta acció no es pot desfer.)';
...
$string['dialoguecron'] = 'Cron del diàleg';
...
$string['eventconversationclosed'] = 'Conversa tancada';
$string['eventconversationcreated'] = 'Conversa creada';
$string['eventconversationdeleted'] = 'Conversa esborrada';
$string['eventconversationviewed'] = 'Conversa vista';
$string['eventreplycreated'] = 'Resposta creada';
...
$string['maxattachments'] = 'Nombre màxim d\'adjuncions';
...
$string['messageapibasicmessage'] = '<p> {$a->userfrom} ha publicat un missatge nou en una conversa on esteu participant amb l\'assumpte: <i>{$a->subject}</i> <br/><br/>
<a href="{$a->url}">Vegeu-ho a Moodle</a> </p>';
$string['messageapismallmessage'] = '{$a} ha publicat un missatge nou en una conversa on esteu participant';
$string['messageprovider:post'] = 'Notificacions del diàleg';
$string['messages'] = 'missatges';
$string['mine'] = 'Meus';
$string['modulename'] = 'Diàleg';
$string['modulename_help'] = 'Els diàlegs permeten als estudiants o als professors iniciar diàlegs de doble sentit amb una altra persona. Són activitats del curs que poden resultar útils quan el professor vol un lloc per donar retroacció privada a un estudiant sobre la seva activitat en línia. Per exemple, si un estudiant participa en un fòrum de llengua i comet un error gramatical que el professor vol puntualitzar sense avergonyir-lo, un diàleg és el lloc perfecte per fer-ho. Una activitat de diàleg també seria una excel·lent via perquè els consellers d\'una institució puguin interactuar amb els estudiants: totes les activitats es registren i el correu electrònic no es requereix necessàriament.';
...
$string['replydeleteconfirm'] = 'Confirmeu que voleu suprimir aquesta resposta?';
