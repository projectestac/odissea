...
/**
 * Strings for component 'survey', language 'ca', version '4.5'.
 *
 * @package     survey
 * @category    string
...
$string['cannotfindsurveytmpt'] = 'Manca la plantilla de l\'enquesta!';
...
$string['completiondetail:submit'] = 'Tramet les respostes';
...
$string['responsereports'] = 'Informes de respostes';
...
* Examen d\'actituds per pensar i aprendre (ATTLS)- Per mesurar el grau en el qual una persona és un \'alumne grupal\' (tendeix a ser més amigable, i és sovint més cooperatiu, congenia amb els altres i construeix idees amb altres) o és un \'alumne separat\' (tendeix a ser més crític i controvertit en l\'aprenentatge).
