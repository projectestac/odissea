...
$string['confirm_delete'] = 'Confirmeu que voleu suprimir l\'índex de {$a}? Fins que no s\'indexi l\'àrea de cerca, els usuaris no obtindran resultats de cerca d\'aquesta àrea.';
$string['confirm_deleteall'] = 'Confirmeu que voleu suprimir tots els continguts indexats ara? Fins que el lloc no torni a ser indexat, els usuaris no obtindran resultats de cerca.';
$string['confirm_indexall'] = 'Confirmeu que voleu actualitzar el contingut indexat ara? Si una gran quantitat de contingut necessita indexar-se, això pot trigar molt de temps. Per als servidors autònoms, normalment hauríeu de deixar la indexació a la tasca programada «Cerca global d\'indexació».';
$string['confirm_reindexall'] = 'Confirmeu que voleu reindexar tot el contingut del lloc ara? Si el vostre lloc conté una gran quantitat de contingut, això tardaria molt de temps, i els usuaris podrien no obtenir resultats de cerca complets fins que es completi.';
...
$string['gradualreindex_confirm'] = 'Confirmeu que voleu reindexar {$a}? Això podria tardar una estona, tot i que les dades existents romandrien disponibles durant la reindexació.';
...
$string['performsearch'] = 'Realitza una cerca';
...
$string['sitewidesearch'] = 'Cerca a tot el lloc web';
