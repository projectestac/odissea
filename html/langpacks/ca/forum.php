...
/**
 * Strings for component 'forum', language 'ca', branch 'MOODLE_38_STABLE'
 *
 * @package   forum
...
$string['attachmentname'] = 'Adjunt {$a}';
...
$string['cannotfavourite'] = 'Malauradament no teniu permisos per destacar els debats.';
...
$string['cannotpindiscussions'] = 'Malauradament no teniu permisos per fixar els debats.';
...
$string['clicktofavourite'] = 'No heu destacat aquest debat. Cliqueu per a destacar-lo.';
$string['clicktolockdiscussion'] = 'Cliqueu per blocar aquest debat.';
$string['clicktosubscribe'] = 'No us heu subscrit a aquest debat. Cliqueu per a subscriure-us-hi.';
$string['clicktounfavourite'] = 'Heu destacat aquest debat. Cliqueu per a treure el destacat.';
$string['clicktounlockdiscussion'] = 'Cliqueu per desblocar aquest debat.';
...
$string['completiondiscussionsdesc'] = 'L\'estudiant ha de crear un mínim de {$a} debat(s).';
...
$string['discussionlistsortbystarterasc'] = 'Ordena pel nom de l\'iniciador del debat en ordre ascendent';
$string['discussionlistsortbystarterdesc'] = 'Ordena pel nom de l\'iniciador del debat en ordre descendent';
...
$string['discusstopicname'] = 'Debat el tema: {$a}';
...
$string['duedatetodisplayincalendar'] = 'Data de venciment a mostrar al calendari';
...
$string['errorcannotlock'] = 'No teniu permisos per blocar debats';
...
$string['exporthumandates_help'] = 'Si cal exportar les dates en un format intel·ligible pels humans o bé com a una marca horària (seqúència de nombres).';
$string['exportoptions'] = 'Exporta les opcions';
$string['exportstriphtml'] = 'Elimina l\'HTML';
$string['exportstriphtml_help'] = 'Si cal o no llevar les marques HTML com ara <p> del missatge enviat al fòrum.';
...
$string['forumbodydeleted'] = 'El contingut d\'aquest missatge del fòrum s\'ha esborrat i no és possible d\'accedir-hi.';
...
$string['forum:canposttomygroups'] = 'Envia missatges a tots els grups als quals tinc accés';
...
$string['forum:readprivatereplies'] = 'Mostra les respostes privades';
...
$string['forumsubjectdeleted'] = 'Aquest missatge del fòrum s\'ha eliminat';
...
$string['gradeforwholeforum'] = 'Qualificació pel fòrum: {$a->str_long_grade}';
$string['gradeforwholeforumhidden'] = 'Qualificació pel fòrum oculta';
...
$string['indicator:cognitivedepth'] = 'Fòrum cognitiu';
$string['indicator:cognitivedepthdef'] = 'Fòrum cognitiu';
$string['indicator:cognitivedepthdef_help'] = 'El participant ha assolit aquest percentatge de la implicació cognitiva oferta per les activitats del fòrum en el decurs d\'aquest interval d\'anàlisi (Nivells = No visualització, Visualització, Enviament, Visualització de retroalimentacions, Comenaris a les retroalimentacions, Reenviament després de veure les retroalimentacions)';
...
$string['indicator:socialbreadthdef_help'] = 'El participant ha assolit aquest percentatge de la implicació social oferta per les activitats del fòrum en el decurs d\'aquest interval d\'anàlisi (Nivells = No participació, Participant solitari, Participant amb altres)';
$string['indicator:socialbreadth_help'] = 'Aquest indicador es basa en l\'abast social que ha assolit l\'estudiant en una activitat de fòrum.';
$string['inforum'] = 'en {$a}';
...
$string['modenestedv2'] = 'Mostra les respostes en forma experimental jerarquitzada';
...
$string['privacy:digesttypenone'] = 'No disposem de cap dada relativa al tipus de resum preferit per a aquest fòrum';
$string['privacy:digesttypepreference'] = 'Heu escollit de rebre el següent tipus de resum de fòrum: «{$a->type}».';
$string['privacy:discussionsubscriptionpreference'] = 'Heu escollit de rebre la següent preferència de subscripció als debats d\'aquest fòrum: «{$a->preference}».';
$string['privacy:metadata:core_rating'] = 'El fòrum empra el subsistema de valoracions per poder valorar les publicacions.';
$string['privacy:metadata:core_tag'] = 'El fòrum empra el subsistema d\'etiquetatge per poder etiquetar les publicacions.';
$string['privacy:metadata:forum_digests'] = 'Informació sobre les preferències de resum per cada fòrum';
$string['privacy:metadata:forum_digests:forum'] = 'El fòrum al qual s\'ha subscrit.';
$string['privacy:metadata:forum_digests:maildigest'] = 'La preferència de resum.';
$string['privacy:metadata:forum_digests:userid'] = 'L\'ID de l\'usuari amb la preferència de resum.';
$string['privacy:metadata:forum_discussions'] = 'Informació sobre els debats individuals que ha creat un usuari';
$string['privacy:metadata:forum_discussions:name'] = 'El nom del debat, tal com l\'ha escollit l\'autor.';
$string['privacy:metadata:forum_discussions:timemodified'] = 'L\'instant de la darrera modificació al debat.';
$string['privacy:metadata:forum_discussion_subs'] = 'Informació sobre les subscripcions als debats individuals del fòrum';
$string['privacy:metadata:forum_discussion_subs:discussionid'] = 'L\'ID del debat al qual s\'ha subscrit.';
$string['privacy:metadata:forum_discussion_subs:preference'] = 'L\'instant inicial de la subscripció.';
$string['privacy:metadata:forum_discussion_subs:userid'] = 'L\'ID de l\'usuari amb la subscripció al debat.';
$string['privacy:metadata:forum_discussions:userid'] = 'L\'ID de l\'usuari que inicià el debat.';
$string['privacy:metadata:forum_discussions:usermodified'] = 'L\'ID de l\'usuari que modificà d\'alguna manera el debat per darrera vegada.';
...
$string['privacy:metadata:forum_posts:created'] = 'L\'instant de creació de la publicació.';
$string['privacy:metadata:forum_posts:discussion'] = 'El debat en què s\'ubica aquesta publicació.';
$string['privacy:metadata:forum_posts:message'] = 'El missatge de la publicació al fòrum.';
$string['privacy:metadata:forum_posts:modified'] = 'L\'instant de darrera modificació de la publicació.';
$string['privacy:metadata:forum_posts:parent'] = 'La publicació pare a la qual es responia.';
$string['privacy:metadata:forum_posts:privatereplyto'] = 'l\'ID de l\'usuari a qui s\'envià aquesta resposta.';
...
$string['privacy:metadata:forum_posts:userid'] = 'L\'ID de l\'usuari que creà la publicació al fòrum.';
$string['privacy:metadata:forum_queue'] = 'Registre temporal de publicacions que s\'enviaran per correu en forma de resum';
$string['privacy:metadata:forum_queue:discussionid'] = 'ID del debat del fòrum';
$string['privacy:metadata:forum_queue:postid'] = 'ID de la publicació del fòrum';
$string['privacy:metadata:forum_queue:timemodified'] = 'L\'instant de modificació de la publicació original';
$string['privacy:metadata:forum_queue:userid'] = 'L\'usuari que ha de ser notificat de la publicació';
...
$string['privacy:metadata:forum_read:userid'] = 'L\'ID de l\'usuari relacionat amb aquest registre.';
$string['privacy:metadata:forum_subscriptions'] = 'Informació sobre a quins fòrums s\'ha subscrit l\'usuari.';
$string['privacy:metadata:forum_subscriptions:forum'] = 'El fòrum a què s\'ha subscrit.';
$string['privacy:metadata:forum_subscriptions:userid'] = 'L\'ID de l\'usuari relacionat amb aquesta subscripció al fòrum.';
$string['privacy:metadata:forum_track_prefs'] = 'Informació sobre a quins fòrums l\'usuari ha escollit de fer un seguiment de les lectures a les publicacions.';
$string['privacy:metadata:forum_track_prefs:forumid'] = 'El fòrum que té habilitat el seguiment de lectures.';
$string['privacy:metadata:forum_track_prefs:userid'] = 'L\'ID de l\'usuari relacionat amb aquesta preferència de seguiment del fòrum.';
$string['privacy:metadata:preference:autosubscribe'] = 'Si s\'ha de subscriure als debats quan es respongui a alguna publicació d\'aquests.';
$string['privacy:metadata:preference:forum_discussionlistsortorder'] = 'L\'ordenació preferida de la llista de debats';
$string['privacy:metadata:preference:maildigest'] = 'La preferència de resum de correu per a tot el lloc';
$string['privacy:metadata:preference:markasreadonnotification'] = 'Si s\'han de marcar com a llegides les publicacions al fòrum quan es reben com a missatges.';
$string['privacy:metadata:preference:trackforums'] = 'Si s\'ha d\'habilitar el seguiment de lectura.';
$string['privacy:postwasread'] = 'Aquesta publicació es llegí per primer cop el {$a->firstread} i la lectura més recent fou el {$a->lastread}';
...
$string['privatereply_help'] = 'Una resposta privada només és visible per l\'autor de la publicació a què es respon i a qualsevol usuari amb permisos per veure respostes privades.';
...
$string['showingcountoftotaldiscussions'] = 'llista de debats. Es mostren {$a->count} debats de {$a->total}';
...
$string['starredonly'] = 'Mostra només els debats destacats';
...
$string['useexperimentalui'] = 'Utilitza la visualització experimental jerarquitzada dels debats';
