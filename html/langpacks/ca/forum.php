...
$string['discussionpinned_help'] = 'Els debats fixats apareixeran al capdamunt del fòrum.';
...
$string['eventdiscussionpinned'] = 'S\'ha fixat el debat';
$string['eventdiscussionsubscriptioncreated'] = 'S\'ha creat la subscripció al debat';
$string['eventdiscussionsubscriptiondeleted'] = 'S\'ha esborrat la subscripció al debat';
$string['eventdiscussionunpinned'] = 'S\'ha desfixat el debat';
...
$string['forum:pindiscussions'] = 'Fixa els debats';
...
$string['modethreaded'] = 'Visualitza les respostes abreujades, seguint el fil del debat';
...
$string['newforumposts'] = 'Missatges nous dels fòrums';
...
$string['sendstudentnotificationsdefault'] = 'Paràmetre per defecte per a «Notifica-ho als estudiants»';
$string['sendstudentnotificationsdefault_help'] = 'Defineix el valor per defecte de la casella de verificació «Notifica-ho als estudiants» al formulari de qualificació.';
