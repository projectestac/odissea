...
$string['changetagcoll'] = 'Canvia la col·lecció d\'etiquetes de l\'àrea de {$a}';
$string['changetype'] = 'Canvia el tipus d\'etiqueta';
$string['collnameexplained'] = 'Deixeu el camp buit per fer servir el valor per defecte: {$a}';
...
$string['deleted'] = 'S\'han esborrat les etiquetes';
$string['deletedcoursetags'] = 'Esborrades - Etiquetes del curs';
$string['deleteselected'] = 'Esborra les seleccionades';
$string['description'] = 'Descripció';
$string['editcollname'] = 'Edita el nom de la col·lecció d\'etiquetes';
$string['editisstandard'] = 'Canvia l\'ús de l\'etiqueta estàndard';
$string['editname'] = 'Edita el nom de l\'etiqueta';
$string['editsearchable'] = 'Canvia si és cercable';
...
$string['eventtagremoved'] = 'S\'ha esborrat l\'etiqueta d\'un element';
...
$string['namewithlink'] = 'Nom de l\'etiqueta amb l\'enllaç';
$string['newcollnamefor'] = 'Nom nou per a la col·lecció d\'etiquetes {$a}';
...
$string['privacy:metadata:tag'] = 'Els detalls de cada etiqueta única s\'emmagatzemen al costat de la seva descripció i altra informació relacionada';
$string['privacy:metadata:tag:description'] = 'La descripció de l\'etiqueta.';
$string['privacy:metadata:tag:flag'] = 'Si una etiqueta s\'ha marcat com a inadequada.';
$string['privacy:metadata:tag:name'] = 'El nom de l\'etiqueta - aquesta és la versió normalitzada del nom.';
$string['privacy:metadata:tag:rawname'] = 'El nom de l\'etiqueta - aquest és el nom a mostrar.';
$string['privacy:metadata:tag:timemodified'] = 'L\'hora de l\'última modificació de l\'etiqueta.';
$string['privacy:metadata:tag:userid'] = 'L\'ID de l\'usuari que ha creat l\'etiqueta.';
$string['privacy:metadata:taginstance'] = 'L\'enllaç entre cada etiqueta i on s\'utilitza.';
$string['privacy:metadata:taginstance:ordering'] = 'L\'ordre relatiu d\'aquesta etiqueta.';
$string['privacy:metadata:taginstance:tagid'] = 'L\'enllaç a l\'etiqueta.';
$string['privacy:metadata:taginstance:timecreated'] = 'L\'hora en què aquesta etiqueta s\'ha enllaçat al destí.';
$string['privacy:metadata:taginstance:timemodified'] = 'L\'hora en què es va modificar aquesta etiqueta per al destí.';
$string['privacy:metadata:taginstance:tiuserid'] = 'Quan el contingut compartit pot ser etiquetat individualment pels usuaris, el propietari de la instància de l\'etiqueta s\'emmagatzema.';
...
$string['showstandard_help'] = 'Mentre introduïu etiquetes, es poden suggerir o forçar etiquetes estàndard, això vol dir que no es poden introduir etiquetes noves. Alternativament, es poden introduir etiquetes noves si no se suggereix cap etiqueta habitual.';
$string['standardforce'] = 'Força';
$string['standardhide'] = 'No suggereixis';
$string['standardsuggest'] = 'Suggereix';
$string['standardtag'] = 'Estàndard';
$string['suredeletecoll'] = 'Segur que voleu eliminar la col·lecció d\'etiquetes «{$a}»?';
$string['tag'] = 'Etiqueta';
$string['tagarea'] = 'Àrea de l\'etiqueta';
...
$string['tagarea_tag'] = 'Etiquetes relacionades';
...
$string['tagauthor'] = 'Autor de l\'etiqueta';
...
$string['taginstance'] = 'Instància de l\'etiqueta';
