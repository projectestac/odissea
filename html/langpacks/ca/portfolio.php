...
/**
 * Strings for component 'portfolio', language 'ca', version '4.5'.
 *
 * @package     portfolio
 * @category    string
...
$string['confirmcancel'] = 'Confirmeu que voleu cancel·lar aquesta exportació?';
...
$string['privacy:metadata'] = 'El subsistema de portafolis actua com un canal, passant sol·licituds dels connectors als diversos connectors de portafolis.';
$string['privacy:metadata:instance'] = 'Identificador de portafolis';
$string['privacy:metadata:instancesummary'] = 'Emmagatzema dades sobre instàncies i preferències de portafolis.';
$string['privacy:metadata:name'] = 'Nom de la preferència';
$string['privacy:metadata:portfolio_log'] = 'Registre de transferències de portafolis (utilitzat per comprovar posteriorment si hi ha duplicats)';
$string['privacy:metadata:portfolio_log:caller_class'] = 'Nom de la classe utilitzada per crear la transferència';
$string['privacy:metadata:portfolio_log:caller_component'] = 'Nom del component responsable de l\'exportació';
$string['privacy:metadata:portfolio_log:time'] = 'Hora de la transferència (en el cas d\'una transferència en cua, aquest és el moment en què s\'ha executat la transferència real, no quan l\'usuari la va iniciar)';
$string['privacy:metadata:portfolio_log:userid'] = 'ID de l\'usuari que ha exportat contingut';
$string['privacy:metadata:portfolio_tempdata'] = 'Emmagatzema dades temporals per a exportacions de portafolis.';
$string['privacy:metadata:portfolio_tempdata:data'] = 'Exporta dades';
$string['privacy:metadata:portfolio_tempdata:expirytime'] = 'Hora de caducitat d\'aquest registre';
$string['privacy:metadata:portfolio_tempdata:instance'] = 'Instància del connector de portafolis que s\'està utilitzant';
$string['privacy:metadata:portfolio_tempdata:userid'] = 'Usuari que realitza l\'exportació';
$string['privacy:metadata:userid'] = 'ID de l\'usuari';
$string['privacy:metadata:value'] = 'Valor per la preferència';
$string['privacy:path'] = 'Instàncies de portafolis';
...
$string['sure'] = 'Confirmeu que voleu suprimir «{$a}»? Aquesta acció no es pot desfer.';
