...
/**
 * Strings for component 'atto_image', language 'ca', version '4.5'.
 *
 * @package     atto_image
 * @category    string
...
$string['imageurlrequired'] = 'Cada imatge ha de tenir un URL.';
$string['pluginname'] = 'Insereix o edita una imatge';
