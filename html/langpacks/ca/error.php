...
$string['agedigitalconsentmapinvalidage'] = '«{$a}» no és un valor vàlid per a l\'edat.';
$string['agedigitalconsentmapinvalidcomma'] = '«{$a}» només ha de tenir un separador de comes.';
$string['agedigitalconsentmapinvalidcountry'] = '«{$a}» no és un valor vàlid per al país.';
$string['agedigitalconsentmapinvaliddefault'] = 'Falta el valor predeterminat (*).';
$string['agelocationverificationdisabled'] = 'Verificació d\'edat i ubicació desactivada';
...
$string['blockcannotadd'] = 'No es pot afegir el bloc';
$string['blockcannotconfig'] = 'Aquest bloc no admet la configuració global.';
...
$string['cannotgeoplugin'] = 'No s\'ha pogut connectar al servidor geoPlugin a https://www.geoplugin.com. Comproveu els paràmetres del servidor intermediari o instal·leu els fitxers de dades MaxMind GeoIP City.';
...
$string['cannotopenzip'] = 'No s\'ha pogut obrir el fitxer comprimit, probablement per un problema amb l\'extensió zip en el S.O. de 64 bits';
...
$string['cannotreprocessgrades'] = 'No s\'han pogut reprocessar les qualificacions d\'aquesta activitat {$a}';
...
$string['cannotusepage'] = 'Només els professors o administradors poden utilitzar aquesta pàgina';
$string['cannotusepage2'] = 'No podeu utilitzar aquesta pàgina';
$string['cannotviewcategory'] = 'No teniu permís per veure aquesta llista de cursos.';
...
$string['contentvisibilitynotfound'] = 'La visibilitat del contingut amb el valor «{$a}» no existeix o no es reconeix.';
...
$string['couldnotverifyagedigitalconsent'] = 'S\'ha produït un error en intentar verificar l\'edat del consentiment digital.<br />Contacteu amb l\'administrador.';
...
$string['courseformatnotfound'] = 'El format de curs «{$a}» no existeix o no és reconegut.';
...
$string['csvfileerror'] = 'Hi ha algun problema amb el format del fitxer CSV. Comproveu que el nombre d\'encapçalaments i columnes coincideixi, i que el separador i la codificació del fitxer siguin correctes. {$a}';
...
$string['csvnodata'] = 'Fitxer CSV no vàlid: el fitxer CSV té capçaleres que no contenen cap dada.';
...
$string['dbsessionmysqlpacketsize'] = 'S\'ha detectat un problema seriós en la sessió. Notifiqueu-ho a l\'administrador. Aquest problema molt probablement està causat per un valor massa petit en el paràmetre max_allowed_packet de MySQL.';
...
$string['detectedbrokenplugin'] = 'El connector {$a} és defectuós o ha quedat obsolet. No podeu continuar.';
$string['dmlexceptiononinstall'] = '<p>S\'ha produït un error de la base de dades [{$a->errorcode}].<br />{$a->debuginfo}</p>';
$string['dmlparseexception'] = 'Error de sintaxi a la consulta SQL';
...
$string['downgradedcore'] = 'S\'ha produït un error perquè el codi que esteu utilitzant és més antic que la versió enregistrada a la base de dades.';
...
$string['encryption_invalidkey'] = 'Clau no vàlida';
$string['encryption_keyalreadyexists'] = 'La clau ja existeix';
$string['encryption_nokey'] = 'No s\'ha trobat la clau';
...
$string['forumblockingtoomanyposts'] = 'Heu superat el llindar de publicació establert per a aquest fòrum';
$string['functionalityremoved'] = 'Esteu intentant accedir a una funcionalitat que ha estat eliminada.';
$string['gdfeaturenotsupported'] = 'L\'extensió GD no està compilada amb mètodes per a {$a}';
$string['gdmimetypenotsupported'] = 'El tipus MIME no està suportat';
...
$string['gradesneedregrading'] = 'Cal recalcular les qualificacions del curs';
...
$string['guestcantaccessprofiles'] = 'Els visitants no poden accedir als perfils d\'usuari. Inicieu la sessió per a continuar.';
...
$string['idnumbertaken'] = 'Aquest número d\'ID ja s\'està utilitzant';
...
$string['inplaceeditableerror'] = 'S\'ha produït un error en cridar el processador d\'actualitzacions';
...
$string['invalidcommentitemid'] = 'L\'ID d\'ítem del comentari no és vàlid';
...
$string['invalidcontentid'] = 'L\'ID del contingut no és vàlid';
$string['invalidcontext'] = 'El context no és vàlid';
$string['invalidcountrycode'] = 'Codi de país no vàlid: {$a}';
$string['invalidcourse'] = 'El curs no és vàlid';
$string['invalidcourseformat'] = 'El format del curs no és vàlid';
...
$string['invalidcoursemoduleid'] = 'L\'identificador del mòdul del curs no és vàlid: {$a}';
$string['invalidcoursenameshort'] = 'El nom curt del curs no és vàlid.';
$string['invaliddata'] = 'Les dades enviades són incorrectes.';
$string['invaliddatarootpermissions'] = 'S\'han detectat permisos no vàlids en provar de crear un directori. Activeu la depuració per veure\'n més detalls.';
$string['invaliddevicetype'] = 'El tipus de dispositiu no és vàlid.';
$string['invalidelementid'] = 'L\'ID de l\'element no és vàlid.';
...
$string['invalidfile'] = 'No s\'ha trobat el fitxer';
...
$string['invalidlanguagecode'] = 'Codi d\'idioma no vàlid: {$a}';
...
$string['invalidnumkey'] = 'La matriu $conditions no pot contenir claus numèriques. Heu de corregir el codi.';
$string['invalidoutcome'] = 'L\'identificador del resultat no és correcte';
...
$string['invalidsesskey'] = 'Sembla que la sessió ha esgotat el temps d\'inactivitat. Comproveu que la sessió estigui iniciada o torneu a la pantalla anterior i torneu a carregar la pàgina.';
...
$string['invaliduserdata'] = 'Les dades de l\'usuari no són vàlides: {$a}';
$string['invaliduserfield'] = 'Camp d\'usuari no vàlid: {$a}';
...
$string['invalidusernameblank'] = 'El nom d\'usuari no pot estar en blanc';
...
$string['itemnotfound'] = 'No s\'ha trobat cap element {$a->itemtype} amb l\'identificador «{$a->identifier}»';
$string['listcantmovedown'] = 'No s\'ha pogut moure aquest element més avall perquè és el darrer dels seus iguals.';
$string['listcantmoveleft'] = 'No es pot moure aquest element a l\'esquerra: no és fill de cap altre element';
$string['listcantmoveright'] = 'No es pot moure aquest element a la dreta, atès que no hi ha un element igual del qual fer-lo fill. Moveu-lo sota un altre element igual i tot seguit podreu moure\'l a la dreta.';
$string['listcantmoveup'] = 'No s\'ha pogut moure aquest element més amunt perquè és el primer dels seus iguals.';
...
$string['loginasnoenrol'] = 'No us podeu inscriure en un curs ni cancel·lar la inscripció si heu entrat amb «Inicia sessió com a».';
$string['loginasonecourse'] = 'No podeu entrar en aquest curs. Heu d\'acabar la sessió «Inicia sessió com a» abans d\'entrar a cap altre curs.';
...
$string['maxdraftitemids'] = 'Les càrregues dels fitxers estan limitades temporalment perquè heu pujat un volum elevat de fitxers. Espereu i torneu-ho a provar.';
$string['messageundeliveredbynotificationsettings'] = 'El missatge no s\'ha pogut enviar perquè l\'administrador del lloc ha desactivat els missatges personals entre usuaris (a la configuració de notificacions).';
...
$string['missingcategoryrole'] = 'No s\'ha pogut assignar el rol a l\'usuari: falta el rol per a la categoria.';
...
$string['mnetlocal'] = 'Els usuaris remots de MNET no poden autenticar-se localment';
...
$string['moodlenet:invalidshareformat'] = 'El format de la compartició a MoodleNet no és vàlid';
$string['moodlenet:invalidsharestatus'] = 'L\'estat de la compartició a MoodleNet no és vàlid';
$string['moodlenet:invalidsharetype'] = 'El tipus de compartició a MoodleNet no és vàlid';
...
$string['nologinas'] = 'No esteu autoritzat a iniciar la sessió com a aquest usuari';
...
$string['nopermissiontodelentry'] = 'No podeu esborrar aquest comentari';
...
$string['nopermissiontoviewcalendar'] = 'No teniu permís per veure l\'esdeveniment del calendari.';
...
$string['oauth1accesstoken'] = 'Error d\'OAuth 1.0: No s\'ha obtingut el testimoni d\'accés.';
$string['oauth1requesttoken'] = 'Error d\'OAuth 1.0: No s\'ha obtingut el testimoni de sol·licitud - el proveïdor de serveis pot estar temporalment inactiu.';
$string['oauth2refreshtokenerror'] = 'No s\'ha pogut actualitzar el testimoni OAuth 2. L\'estat HTTP per a l\'extrem remot és: {$a}';
$string['oauth2refreshtokentaskerror'] = 'No s\'ha pogut actualitzar el testimoni OAuth 2 per a un o més emissors. Mireu la sortida de la tasca per als detalls.';
$string['oauth2upgradetokenerror'] = 'No s\'ha pogut actualitzar el testimoni OAuth 2. L\'estat HTTP per a l\'extrem remot és: {$a}';
$string['onlyadmins'] = 'Això només poden fer-ho els administradors';
$string['onlyeditingteachers'] = 'Això només poden fer-ho els professors que tinguin permisos d\'edició';
$string['onlyeditown'] = 'Només podeu editar la vostra pròpia informació';
$string['opensslsealerror'] = 'OpenSSL no pot segellar les dades';
$string['opensslsignerror'] = 'OpenSSL no pot signar dades';
$string['orderidnotfound'] = 'No s\'ha trobat l\'ID d\'ordre {$a}';
$string['pagenotexist'] = '<p>S\'ha produït un error inusual en intentar visualitzar una pàgina que no existeix:</p>{$a}';
$string['pagenotexisttitle'] = 'Error 404: No s\'ha trobat el fitxer';
$string['passwordexceeded'] = 'La contrasenya no pot tenir més de {$a} caràcters.';
...
$string['pluginnotexist'] = 'El connector {$a} no existeix';
...
$string['pluginunsupported'] = 'El connector  «{$a->pluginname}» {$a->pluginversion} no és compatible amb aquesta versió del Moodle {$a->moodleversion}. Cerqueu informació del connector per trobar les versions admeses.';
...
$string['privatefilesupload'] = 'Ja no s\'accepta la pujada directa a l\'àrea de fitxers privats d\'usuari. Heu de fer la pujada a una àrea d\'esborrany i després moure els fitxers amb core_user::add_user_private_files';
...
$string['redissessionhandlerproblem'] = 'La configuració de la sessió Redis ha fallat. Notifiqueu-ho a l\'administrador del servidor.';
...
$string['reverseproxyabused'] = 'El servidor intermediari invers està habilitat per la qual cosa no es pot accedir directament al servidor.<br />Poseu-vos en contacte amb l\'administrador del servidor.';
...
$string['sectioncantbefound'] = '<p><strong>No es pot trobar aquest contingut.</strong></p><p>Potser ha estat esborrat o l\'URL és incorrecte.</p>';
$string['sectionnotexist'] = 'Aquesta secció no existeix';
$string['sendmessage'] = 'Envia un missatge';
$string['sendmessagesent'] = 'Gràcies pels vostres comentaris sobre:<br>{$a}';
$string['serverconnection'] = 'S\'ha produït un error de connexió amb el servidor';
$string['servicedonotexist'] = 'El servei no existeix';
$string['sessioncannotobtainlock'] = '<p>No s\'ha pogut obtenir el bloqueig per a l\'identificador de sessió {$a->id} en {$a->acquiretimeout}.</p>
<p>És probable que una altra pàgina ({$a->whohaslock}) encara s\'estigui executant en una altra pestanya del navegador, o que no hagi alliberat el bloqueig a causa d\'un error.</p>
<p>Podeu esperar fins al temps d\'espera del bloqueig de la sessió ({$a->lockexpire}) o podeu reiniciar la sessió del navegador. Si aquest error persisteix, notifiqueu a l\'administrador del servidor.</p>';
$string['sessioncookiesdisable'] = 'L\'ús de require_key_login() és incorrecte. S\'han de desactivar les galetes de sessió.';
$string['sessiondiskfull'] = 'La partició de la sessió és plena. Ara mateix no és possible iniciar la sessió. Notifiqueu-ho a l\'administrador del servidor.';
$string['sessionerroruser'] = 'Heu excedit el termini de la vostra sessió. Torneu a iniciar-la.';
...
$string['sessionexpired'] = 'La sessió ha caducat';
...
$string['sessionstarterror'] = 'No s\'ha pogut iniciar la sessió. Torneu-ho a provar més tard.';
$string['sessionwaiterr'] = 'S\'ha excedit el temps mentre s\'esperava a tancar la sessió.<br />Espereu que acabi la sol·licitud en curs i torneu a provar-ho més tard.';
...
$string['statscatchupmode'] = 'S\'estan recollint les estadístiques. Fins ara s\'han processat {$a->daysdone} dies i n\'estan pendents {$a->dayspending}. Torneu a provar-ho d\'aquí a una estona.';
...
$string['storedfilecannotcreatefile'] = 'No s\'ha pogut crear un fitxer de grup de fitxers local. Verifiqueu els permisos a dataroot i l\'espai de disc disponible.';
$string['storedfilecannotcreatefiledirs'] = 'No s\'han pogut crear els directoris de grup de fitxers locals. Verifiqueu els permisos a dataroot.';
$string['storedfilecannotread'] = 'No s\'ha pogut llegir el fitxer. Potser que no existeixi o que hi hagi un problema de permisos.';
...
$string['unknowncategory'] = 'Categoria desconeguda amb número ID de categoria «{$a}»';
...
$string['unknownjsinrequirejs'] = 'No s\'ha pogut trobar la biblioteca JavaScript {$a}.';
...
$string['userautherror'] = 'El connector d\'autenticació és desconegut';
$string['userauthunsupported'] = 'El connector d\'autenticació no funciona aquí';
$string['useremailduplicate'] = 'Adreça duplicada';
$string['userisfilteredout'] = 'Aquest usuari no coincideix amb els filtres i les preferències de la taula!';
$string['usermustbemnet'] = 'Els usuaris de la llista de control d\'accés MNET han de ser usuaris remots';
$string['usernamelowercase'] = 'El nom d\'usuari ha de ser en minúscules';
...
$string['usernotaddedusernameexists'] = 'No s\'ha afegit l\'usuari. El nom d\'usuari ja existeix amb una altra adreça de correu electrònic';
$string['usernotavailable'] = 'No podeu disposar dels detalls d\'aquest usuari.';
$string['usernotdeletedadmin'] = 'No s\'ha eliminat l\'usuari perquè no es poden eliminar els comptes dels administradors';
...
$string['usernotrenamedmissing'] = 'No s\'ha canviat el nom de l\'usuari - no s\'ha pogut trobar el nom antic';
$string['usernotrenamedoff'] = 'No s\'ha canviat el nom d\'usuari - no és permès de canviar els noms';
$string['usernotupdatedadmin'] = 'No es poden actualitzar els comptes d\'administració';
$string['usernotupdatederror'] = 'L\'usuari no s\'ha actualitzat - s\'ha produït un error';
$string['usernotupdatednotexists'] = 'L\'usuari no s\'ha actualitzat - no existeix';
...
$string['verifyagedigitalconsentnotpossible'] = 'En aquest moment no és possible verificar el consentiment digital per edat.';
