...
$string['csvfileerror'] = 'El format del fitxer CSV és no vàlid. Comproveu que hi ha el mateix nombre de capçaleres i de columnes, i que el delimitador i la codificació del fitxer són correctes. {$a}';
...
$string['detectedbrokenplugin'] = 'No es pot continuar perquè el connector «{$a}» és defectuós o ha quedat obsolet.';
...
$string['listcantmoveright'] = 'No es pot moure aquest element a la dreta, atès que no hi ha un element igual del qual fer-lo fill. Mogueu-lo sota un altre element igual i tot seguit podreu moure\'l a la dreta.';
