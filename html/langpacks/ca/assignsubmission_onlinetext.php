...
/**
 * Strings for component 'assignsubmission_onlinetext', language 'ca', version '3.11'.
 *
...
$string['allowonlinetextsubmissions'] = 'Habilitat';
...
$string['enabled_help'] = 'Si està habilitat, els estudiants poden teclejar text enriquit directament en un camp d\'edició per trametre\'l.';
$string['eventassessableuploaded'] = 'S\'ha pujat un text en línia.';
...
$string['onlinetext'] = 'Text en línia';
...
$string['privacy:metadata:filepurpose'] = 'Fitxers incrustats al text de la tramesa.';
$string['privacy:metadata:submissionpurpose'] = 'L\'ID de la tramesa que enllaça a les trameses de l\'usuari.';
$string['privacy:metadata:tablepurpose'] = 'Emmagatzema el text de la tramesa per a cada intent.';
$string['privacy:metadata:textpurpose'] = 'El text real tramès en aquest intent per a la tasca.';
$string['privacy:path'] = 'Text de la tramesa';
