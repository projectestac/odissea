...
$string['privacy:metadata:submissionpurpose'] = 'L\'ID de la tramesa que s\'enllaça a les trameses de l\'usuari.';
$string['privacy:metadata:tablepurpose'] = 'Emmagatzema la tramesa de text per a cada intent.';
