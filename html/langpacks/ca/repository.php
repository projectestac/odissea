...
$string['confirmdelete'] = 'Confirmeu que voleu suprimir aquest repositori: {$a}? Si trieu «Continua i descarrega», les referències del fitxer a continguts externs es descarregaran a Moodle. Això podria ser molt llarg de processar.';
$string['confirmdeletefile'] = 'Confirmeu que voleu suprimir el fitxer?';
$string['confirmdeletefilewithhref'] = 'Confirmeu que voleu suprimir el fitxer? Hi ha {$a} enllaços a aquest fitxer. Si procediu a fer-ho, les ubicacions que actualment s\'enllacen amb el fitxer s\'actualitzaran de manera automàtica per utilitzar una còpia del fitxer.';
$string['confirmdeletefolder'] = 'Confirmeu que voleu suprimir la carpeta? Se suprimiran tots els fitxers i totes les subcarpetes.';
$string['confirmdeleteselectedfile'] = 'Segur que voleu esborrar el(s) {$a} fitxer(s) seleccionat(s)?';
$string['confirmremove'] = 'Confirmeu que voleu suprimir aquest connector de repositori, les seves opcions i <strong>totes les seves instàncies</strong>: {$a}? Si trieu «Continua i descarrega», les referències del fitxer a continguts externs es descarregaran a Moodle. Això podria ser molt llarg de processar.';
$string['confirmrenamefile'] = 'Confirmeu que voleu moure el fitxer o canviar-li el nom?';
$string['confirmrenamefolder'] = 'Confirmeu que voleu moure la carpeta o canviar-li el nom? Qualsevol ubicació que actualment s\'enllaci amb els fitxers s\'actualitzarà de manera automàtica per utilitzar una còpia del fitxer.';
