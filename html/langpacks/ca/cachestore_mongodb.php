...
/**
 * Strings for component 'cachestore_mongodb', language 'ca', version '4.5'.
 *
...
$string['replicaset_help'] = 'El nom de la rèplica per connectar-s\'hi. Si això es dona, el mestre es determinarà mitjançant ordres a la base de dades en l\'alimentació, de manera que el controlador pot tancar la connexió a un servidor que ni tan sols és a la llista.';
