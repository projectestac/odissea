...
$string['colpoll'] = 'Interval d\'actualització';
$string['commontasks'] = 'Opcions';
$string['confirmeventdelete'] = 'Confirmeu que voleu suprimir l\'esdeveniment «{$a}»?';
...
$string['coursecalendarlink'] = 'Calendari del curs';
...
$string['datepicker'] = 'Selector de dates';
$string['day'] = 'Dia';
...
$string['errorinvalidbymonth'] = 'Els valors vàlids per la regla BYMONTH (PER_MES) són d\'1 a 12';
$string['errorinvalidbymonthday'] = 'Els valors vàlids per la regla BYMONTHDAY (PER_DIAMES) són d\'1 a 31 o de -31 a -1';
...
$string['eventsdeleted'] = 'S\'han suprimit {$a} esdeveniments';
$string['eventsfor'] = 'Esdeveniments {$a}';
$string['eventsimported'] = 'S\'han importat {$a} esdeveniments';
...
$string['eventsskipped'] = 'S\'han omès {$a} esdeveniments';
...
$string['eventsupdated'] = 'S\'han actualitzat {$a} esdeveniments';
...
$string['eventtypeother'] = 'del tipus «altres»';
$string['eventtypesite'] = 'de lloc';
...
$string['exporthelp'] = '<p>L\'URL del calendari proporciona un enllaç dinàmic per importar esdeveniments a altres calendaris. Qualsevol esdeveniment nou, modificat o suprimit en el calendari d\'origen <strong>es reflectirà</strong> en els altres calendaris.</p>
<p>L\'exportació del calendari vos permet crear una còpia de seguretat dels esdeveniments, que es pot importar a altres calendaris. Les actualitzacions realitzades en el calendari d\'origen <strong>no es reflectiran</strong> en els altres calendaris.</p>';
...
$string['newmonthannouncement'] = 'El calendari ara està definit com a {$a}.';
$string['nocalendarsubscriptions'] = 'Encara no us heu subscrit a cap calendari. {$a}';
$string['nocalendarsubscriptionsimportexternal'] = 'Encara no us heu subscrit a cap calendari. <a href="{$a}">Importeu un calendari extern</a>';
...
$string['pref_persistflt_help'] = 'Si està activat, la configuració del filtre d\'esdeveniments més recent es desarà per a la propera vegada que inicieu la sessió.';
