...
/**
 * Strings for component 'tool_mobile', language 'ca', version '3.11'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['qrcodedisabled'] = 'L\'accés mitjançant codi QR està deshabilitat';
$string['qrcodeformobileappaccess'] = 'Codi QR per accedir amb l\'aplicació mòbil';
$string['qrcodeformobileapploginabout'] = 'Escanegeu el codi QR amb la vostra aplicació mòbil i hi accedireu automàticament. El codi QR caducarà d\'aquí a {$a} minuts.';
