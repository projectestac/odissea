...
/**
 * Strings for component 'studentquiz', language 'ca', version '4.5'.
 *
 * @package     studentquiz
 * @category    string
...
$string['abort_button'] = 'Interromp';
$string['add_comment'] = 'Afegeix un comentari';
$string['addpubliccomment'] = 'Afegeix un comentari públic';
$string['anonymous_user'] = 'Usuari anònim';
$string['anonymous_user_name'] = 'Usuari anònim #{$a}';
$string['approve'] = 'Aprova';
$string['approve_toggle'] = 'Aprova/desaprova';
$string['approved'] = '✓';
$string['approved_column_name'] = 'Aprovat';
$string['approveselectedscheck'] = 'Confirmeu que voleu acceptar/rebutjar les preguntes següents? <br /><br />{$a}';
$string['average_column_name'] = 'Mitjana';
$string['changecurrentstate'] = 'Canvia l\'estat <b>{$a}</b> a:';
$string['changestateto'] = 'Canvia els estats a:';
...
$string['completionpoint'] = 'Quantitat mínima de punts requerida:';
$string['completionpointgroup'] = 'Requereix punts';
$string['completionquestionapproved'] = 'Nombre mínim de preguntes úniques aprovades que es requereix:';
$string['completionquestionapprovedgroup'] = 'Requereix preguntes creades aprovades';
$string['completionquestionpublished'] = 'Nombre mínim de preguntes úniques creades que es requereix:';
$string['completionquestionpublishedgroup'] = 'Requereix preguntes publicades';
$string['createnewquestion'] = 'Crea una pregunta nova';
$string['createnewquestionfirst'] = 'Crea la primera pregunta';
$string['creator_anonym_fullname'] = 'Estudiant anònim';
$string['current_state'] = 'Estat actual';
$string['deleted'] = 'Suprimida';
...
$string['filter'] = 'Filtre ràpid';
$string['filter_ishigher'] = 'és més alt';
$string['filter_islower'] = 'és més baix';
$string['filter_label_answered'] = 'S\'han respost';
...
$string['filter_label_notmine'] = 'No són meves';
...
$string['filter_label_owner'] = 'Propietari o propietària';
...
$string['manager_anonym_fullname'] = 'Gestor anònim';
...
$string['modulename_help'] = 'L\'activitat StudentQuiz permet que els estudiants afegeixin preguntes per a tothom. A la visió general de StudentQuiz els estudiants poden filtrar les preguntes. També poden fitrar les preguntes creades per tothom per practicar. El professor té l\'opció de convertir en anònimes les preguntes creades per columna. <br><br>L\'activitat StudentQuiz premia els estudiants amb punts per motivar-los a afegir preguntes i practicar-hi. Els punts són a una llista en una taula de classificació.';
...
$string['ranking_block_title_anonymised'] = 'Classificació (anonimitzada)';
...
$string['reportquiz_stats_all_questions_approved_help'] = 'El professorat pot aprovar preguntes per verificar-ne la correcció. Aquest és el nombre de totes les preguntes aprovades dins aquest StudentQuiz.';
$string['reportquiz_stats_all_questions_created'] = 'Nombre de preguntes dins aquest StudentQuiz';
...
$string['settings_approvedquantifier'] = 'Factor de pregunta aprovada';
...
$string['settings_availability_close_answering_from'] = 'Tancat per respondre a partir del dia';
$string['settings_availability_close_submission_from'] = 'Tancat per a la tramesa de preguntes a partir del dia';
$string['settings_availability_open_answering_from'] = 'Obert per respondre a partir del dia';
$string['settings_availability_open_submission_from'] = 'Obert per a la tramesa de preguntes a partir del dia';
...
$string['settings_excluderoles'] = 'Exclou aquests rols per defecte de les classificacions';
$string['settings_excluderoles_help'] = 'El docent pot controlar quins rols queden exclosos de les classificacions a cada StudentQuiz. La llista de rols que s’estableix aquí és la llista per defecte que s’empra a cada StudentQuiz nou que es creï.';
...
$string['settings_privatecommenting_help'] = 'El fil de debat privat, accessible quan es previsualitza una pregunta i fins que és aprovada, permet que hi hagi un debat entre l\'autor o autora de la pregunta i les persones administradores de l\'activitat. Si el mode de StudentQuiz s\'ha establert a «Publica les preguntes noves de manera automàtica», aleshores l\'autor o autora potser no arribarà a veure mai aquest fil concret. No obstant això, aquest continua estant disponible per a les persones administradores de l\'activitat, les quals podrien utilitzar-lo per explicar la raó per la qual han ocultat una pregunta o l\'han suprimit. L\'opció predeterminada dels  comentaris privats es troba configurada als paràmetres del connector a nivell del servidor.';
...
$string['state_approvedplural'] = 'Aprovades';
$string['state_changed'] = 'Modificada';
$string['state_changedplural'] = 'Modificades';
$string['state_column_name'] = 'Estat';
$string['state_deleted'] = 'Suprimida';
$string['state_deletedlowercase'] = 'suprimida';
$string['state_deletedplural'] = 'Suprimides';
$string['state_disapproved'] = 'Rebutjada';
$string['state_disapprovedplural'] = 'Rebutjades';
$string['state_hidden'] = 'Amagada';
$string['state_hiddenplural'] = 'Amagades';
$string['state_new'] = 'Nova';
$string['state_newplural'] = 'Noves';
$string['state_reviewable'] = 'Revisable';
$string['state_reviewablelowercase'] = 'revisable';
$string['state_reviewableplural'] = 'Revisables';
$string['state_toggle'] = 'Modifica l\'estat';
$string['state_unpinnedlowercase'] = 's\'ha desfixat';
$string['statistic_block_approvals'] = 'Preguntes aprovades';
$string['statistic_block_created'] = 'Preguntes creades';
$string['statistic_block_disapprovals'] = 'Preguntes rebutjades';
$string['statistic_block_new_changed'] = 'Preguntes noves/modificades';
...
$string['studentquiz:pinquestion'] = 'Fixa les preguntes a StudenQuiz';
$string['studentquiz:preview'] = 'Previsualitza les preguntes';
...
$string['unpin'] = 'Desfixa la pregunta';
