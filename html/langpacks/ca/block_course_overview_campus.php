...
/**
 * Strings for component 'block_course_overview_campus', language 'ca', version '4.5'.
 *
...
$string['prioritizemyteachedcourses'] = 'Dona prioritat als cursos en què jo ensenyo';
...
$string['submitfilter'] = 'Filtra els meus cursos!';
