...
/**
 * Strings for component 'quiz_statistics', language 'ca', version '4.4'.
 *
...
$string['getstatslockprogress'] = 'Esperant una tasca en progrés. Si us plau, espereu o torneu-ho a intentar després.';
$string['getstatslocktimeout'] = 'Temps d\'espera del bloqueig del càlcul de les estadístiques';
$string['getstatslocktimeoutdesc'] = 'Quants segons cal esperar perquè s\'alliberi un bloqueig quan s\'intenta realitzar un càlcul estadístic d\'un qüestionari. Aquest paràmetre existeix inicialment per fer comprovacions, no el modifiqueu excepte si sabeu què esteu fent.';
...
$string['nostats'] = 'No s\'ha pogut completar el càlcul d\'estadístiques. Potser hi ha un càlcul molt llarg en progrés. Si us plau, intenteu-ho més tard.';
...
$string['privacy:metadata'] = 'Encara que el connector d\'estadístiques del qüestionari té taules a la base de dades, les dades són dades agregades i no descriuen a un únic individu.';
...
$string['rangeofvalues'] = 'Rang d\'estadístiques per aquestes preguntes';
$string['recalculatenow'] = 'Recalcula ara';
$string['recalculatetask'] = 'Recalcula les estadístiques de la pregunta';
...
$string['viewanalysis'] = 'Mostra els detalls';
