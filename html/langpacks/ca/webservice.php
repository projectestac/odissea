...
/**
 * Strings for component 'webservice', language 'ca', version '4.5'.
 *
 * @package     webservice
 * @category    string
...
$string['criteriaerror'] = 'Falten permisos per cercar segons un criteri.';
...
$string['erroroptionalparamarray'] = 'El paràmetre de descripció del servei web anomenat «{$a}» és una estructura única o múltiple. No es pot definir com a VALUE_OPTIONAL. Comproveu la descripció del servei web.';
...
$string['eventwebserviceservicecreated'] = 'S\'ha creat un servei web';
$string['eventwebserviceservicedeleted'] = 'S\'ha eliminat un servei web';
$string['eventwebserviceserviceupdated'] = 'S\'ha actualitzat un servei web';
$string['eventwebserviceserviceuseradded'] = 'S\'ha afegit un usuari al servei web';
$string['eventwebserviceserviceuserremoved'] = 'S\'ha eliminat l\'usuari del servei web';
...
$string['installserviceshortnameerror'] = 'Error de codificació: el nom curt del servei «{$a}» només pot contenir caràcters alfanumèrics (lletres i números), subratllat (_), guió (-) i punt final (.)';
...
$string['missingcaps_help'] = 'Llista de capacitats declarades pel servei que l\'usuari no té. És possible que algunes funcionalitats del servei no estiguin disponibles sense aquestes capacitats.';
...
$string['onlyseecreatedtokens'] = 'Només podeu veure els testimonis que heu creat.';
...
$string['servicenotavailable'] = 'El servei web no està disponible. (No existeix o està desactivat)';
