...
/**
 * Strings for component 'availability', language 'ca', version '4.5'.
 *
...
$string['disabled_verb'] = 'No es pot canviar perquè el conjunt de regles inclou una regla que conté dades privades.';
$string['editsettings'] = 'Edita les restriccions';
$string['enableavailability'] = 'Habilita l\'accés restringit';
$string['enableavailability_desc'] = 'Si està activat, es poden establir condicions (basades en la data, la nota, la finalització, etc.) per controlar si es pot accedir a una activitat o recurs.';
$string['error_list_nochildren'] = 'Els conjunts de restriccions haurien de contenir almenys una condició.';
$string['hidden_all'] = 'Completament ocult si l\'estudiant no compleix les condicions';
$string['hidden_individual'] = 'Completament ocult si l\'estudiant no compleix aquesta condició';
...
$string['listheader_multi_or'] = 'qualsevol de';
$string['listheader_sign_before'] = 'Estudiant';
...
$string['or'] = 'o';
$string['privacy:metadata'] = 'El subsistema de restricció d\'accés no emmagatzema cap dada personal.';
...
$string['shown_all'] = 'Es mostra si l\'estudiant no compleix les condicions';
$string['shown_individual'] = 'Es mostra si l\'estudiant no compleix aquesta condició';
