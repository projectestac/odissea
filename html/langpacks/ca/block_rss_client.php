...
/**
 * Strings for component 'block_rss_client', language 'ca', version '4.5'.
 *
...
$string['pluginname'] = 'Canals RSS';
$string['remotenewsfeed'] = 'Canals d\'informació remots de notícies';
$string['rss_client:addinstance'] = 'Afegeix un bloc nou de canals RSS remots';
