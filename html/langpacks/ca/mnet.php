...
/**
 * Strings for component 'mnet', language 'ca', version '4.5'.
 *
 * @package     mnet
 * @category    string
...
$string['error7022'] = 'El missatge que heu enviat al lloc remot s\'ha xifrat però no s\'ha signat. Això és molt inesperat; probablement hauríeu d\'enviar un informe d\'error (donant tanta informació com sigui possible sobre les versions de l\'aplicació en qüestió, etc.)';
...
$string['keydeletedcancelled'] = 'No s\'ha fet cap canvi a la clau.';
...
$string['privacy:metadata'] = 'El connector MNet no emmagatzema cap dada personal.';
...
$string['reallydeleteserver'] = 'Confirmeu que voleu suprimir el servidor?';
