...
/**
 * Strings for component 'qtype_algebra', language 'ca', version '4.4'.
 *
...
$string['answerprefix_help'] = 'El text introduït aquí es mostrarà al davant de la caixa d\'entrada on els estudiants introdueixen les seves respostes. Per exemple, si en una pregunta es demana l\'expressió d\'una certa funció f(x), aleshores podríeu posar "f(x) = " en aquest camp.';
...
$string['dynamic'] = 'S\'utilitza una petició AJAX dinàmica';
...
$string['filloutoneanswer'] = 'Heu de proporcionar com a mínim una possible resposta. Les respostes en blanc no s\'utilitzaran. La primera resposta que concordi serà la que s\'utiltizarà per determinar la puntuació i la retroalimentació. Només estan permeses les variables que s\'han definit més amunt.';
$string['filloutonevariable'] = 'Heu de proporcionar una variable com a mínim.';
$string['formuladisplay'] = 'Mètode per mostrar la fórmula de resposta';
$string['host'] = 'URL del servidor que hostatja el SAGE';
$string['iframe'] = 'S\'utilitza un element «iframe»';
...
$string['invalidanswer'] = 'Resposta no vàlida o no reconeguda';
...
$string['multiplyoperator'] = 'Operador de multiplicació del TeX';
...
$string['privacy:metadata'] = 'El connector del tipus de pregunta «Àlgebra» no emmagatzema cap dada personal.';
