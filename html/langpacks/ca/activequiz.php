...
$string['countdatasetlabel'] = 'Nombre de respostes';
...
$string['enabledquestiontypes'] = 'Habilita els tipus de pregunta';
$string['endquestion'] = 'Pregunta final';
$string['eventattemptstarted'] = 'Intent començat';
$string['eventattemptviewed'] = 'S\'ha mostrat l\'intent';
$string['eventquestionanswered'] = 'Preguntes respostes per intent';
...
$string['indvquestiontime'] = 'Temps de la pregunta';
$string['indvquestiontime_help'] = 'Temps de la pregunta en segons.';
...
$string['no_questions'] = 'No hi ha preguntes afegides a aquest qüestionari.';
...
$string['percentagedatasetlabel'] = 'Percentatge del total de respostes';
$string['pluginname'] = 'Qüestionari actiu';
$string['points'] = 'Punts de la pregunta';
...
$string['response_attempt_controls'] = 'Edita/Mostra l\'intent';
