...
$string['submissiondeleteconfirmassess'] = 'Confirmeu que voleu suprimir la tramesa següent? Tingueu en compte que això també suprimirà les {$a->count} avaluacions associades amb aquesta tramesa, que poden afectar les qualificacions dels revisors.';
