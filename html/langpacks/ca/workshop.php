...
$string['allowedfiletypesforoverallfeedback_help'] = 'Es poden restringir els tipus de fitxer permesos a les adjuncions de la retroacció proporcionant una llista de tipus de fitxer permesos. Si el camp es deixa buit, aleshores s\'hi permeten tots els tipus de fitxer.';
...
$string['allowedfiletypesforsubmission_help'] = 'Es poden restringir els tipus de fitxer permesos a les adjuncions de la tramesa proporcionant una llista de tipus de fitxer permesos. Si el camp es deixa buit, aleshores s\'hi permeten tots els tipus de fitxer.';
...
$string['areaoverallfeedbackattachment'] = 'Fitxers adjunts de la retroacció global';
$string['areaoverallfeedbackcontent'] = 'Textos de la retroacció global';
$string['areasubmissionattachment'] = 'Adjuncions a la tramesa';
$string['areasubmissioncontent'] = 'Textos de la tramesa';
...
$string['assessmentendevent'] = '{$a} data límit per a l\'avaluació';
...
$string['assessmentstartevent'] = '{$a} obre per a l\'avaluació';
...
$string['clearaggregatedgradesconfirm'] = 'Confirmeu que voleu esborrar les qualificacions calculades per a les trameses i les avaluacions?';
...
$string['clearassessmentsconfirm'] = 'Confirmeu que voleu esborrar totes les qualificacions de les avaluacions? No podreu reconstruir aquesta informació vós mateix, sinó que els revisors hauran de tornar a avaluar les trameses assignades.';
...
$string['examplesbeforeassessment'] = 'Els exemples estan disponibles després de la pròpia tramesa i cal que s\'avaluïn abans d\'avaluar les trameses dels companys';
...
$string['privacy:metadata:feedbackauthor'] = 'Comentaris per a l\'autor';
$string['privacy:metadata:feedbackauthorformat'] = 'Format de text dels comentaris per a l\'autor';
$string['privacy:metadata:feedbackreviewer'] = 'Comentaris per a l\'usuari que fa l\'avaluació';
$string['privacy:metadata:feedbackreviewerformat'] = 'Format de text dels comentaris per a l\'usuari que fa l\'avaluació';
$string['privacy:metadata:late'] = 'Si l\'enviament s\'ha tramès després de la data límit';
$string['privacy:metadata:strategy'] = 'Nom del subcomplement de l\'estratègia de qualificació que interpreta els valors del registre';
$string['privacy:metadata:submissioncontent'] = 'Contingut de la tramesa';
$string['privacy:metadata:submissioncontentformat'] = 'Format de text del contingut de la tramesa';
$string['privacy:metadata:submissiongrade'] = 'Qualificació agregada de la tramesa escrita com a nombre decimal de l\'interval 0..100';
$string['privacy:request:delete:title'] = '[Suprimit]';
...
$string['submissiondeleteconfirmassess'] = 'Esteu segur que voleu suprimir la tramesa següent? Tingueu en compte que això també suprimirà les {$a->count} avaluacions associades amb aquesta tramesa, que poden afectar les qualificacions dels revisors.';
...
$string['taskdone'] = 'Tasca feta';
$string['taskfail'] = 'Tasca fallida';
$string['taskinfo'] = 'Informació de la tasca';
...
$string['yoursubmissionwithassessments'] = 'La vostra tramesa amb avaluacions';
