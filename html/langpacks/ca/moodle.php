...
$string['addfilesdrop'] = 'Podeu arrossegar i deixar anar fitxers aquí per carregar-los o fer clic per seleccionar-los.';
$string['addinganew'] = 'Nou {$a}';
$string['addinganewto'] = 'S\'està afegint l\'activitat o el recurs següent: {$a->what} a {$a->to}';
$string['addingdatatoexisting'] = 'S\'estan afegint dades a les ja existents';
...
$string['admin'] = 'Admin';
$string['adminhelpaddnewuser'] = 'Crea manualment un compte d\'usuari nou';
$string['adminhelpassignadmins'] = 'Els administradors poden fer-ho tot i anar a tot arreu en aquest lloc web';
$string['adminhelpassigncreators'] = 'Els creadors poden crear nous cursos';
$string['adminhelpassignsiteroles'] = 'Aplica els rols definits al lloc a usuaris específics';
...
$string['autosubscribeno'] = 'No: no em subscriguis automàticament als debats dels fòrums';
$string['autosubscribeyes'] = 'Sí: quan escrigui en un fòrum, subscriu-me a aquell fil de debat del fòrum';
...
$string['backupfailed'] = 'Alguns dels cursos no s\'han desat.';
...
$string['backupinfo'] = 'Fa una còpia d\'aquest curs, incloent-hi tot el contingut i l\'activitat fins ara. Podeu utilitzar el fitxer de còpia de seguretat per restaurar el curs.';
...
$string['blocks'] = 'Blocs';
$string['blocks_main'] = 'Blocs de contingut principal';
$string['blocks_supplementary'] = 'Blocs suplementaris';
...
$string['bulkcancel'] = 'Tanca l\'edició massiva';
...
$string['checkerror'] = 'S\'ha produït un error en obtenir el resultat de la comprovació "{$a}". Consulteu la consola del navegador per obtenir més informació.';
...
$string['checkloading'] = 'Obtenint el resultat de la comprovació \'{$a}\'';
...
$string['confirmaccount'] = 'Confirma el compte';
...
$string['contextlevel'] = 'Nivell del context';
$string['contextname'] = 'Nom del context';
$string['contextparent'] = 'Pare';
$string['contexturl'] = 'URL del context';
...
$string['copytoclipboard'] = 'Copia al porta-retalls';
...
$string['courseapprovedemail'] = 'El curs que heu sol·licitat està aprovat, <a href="{$a->url}">{$a->name}</a>, i en sou un {$a->professor}.';
$string['courseapprovedemail2'] = 'El curs que heu sol·licitat està aprovat: <a href="{$a->url}">{$a->name}</a>.';
...
$string['coursedisplay_help'] = 'Les seccions del curs es poden mostrar totes en una pàgina o dividides en diverses pàgines.';
...
$string['courseoverviewfiles_help'] = 'La imatge del curs es mostra a Els meus cursos i a la llista de cursos disponibles a la pàgina d\'inici. Els administradors del lloc poden habilitar tipus de fitxers addicionals i l\'ús de diversos fitxers. Si feu servir diversos fitxers, tots es mostraran a la llista de cursos disponibles a la pàgina d\'inici.';
...
$string['courseoverviewgraph'] = 'Gràfic de resum de cursos';
...
$string['courserequestsuccess'] = 'S\'ha tramès la vostra sol·licitud d\'un curs nou.';
...
$string['coursereusenavigationmenu'] = 'Menú de navegació de reutilització del curs';
...
$string['coursesectiontitlebulkediting'] = 'Edició massiva {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursesummary_help'] = 'Una breu descripció del vostre curs. El contingut que afegiu aquí es pot cercar.';
$string['coursetitle'] = 'Curs: {$a->course}';
$string['coursetitlebulkediting'] = 'Edició massiva del curs: {$a->course}';
...
$string['coursevisibility_help'] = '* Mostra: El curs apareix a la llista de cursos i els estudiants hi poden accedir.
* Amaga: L\'accés està restringit als professors i altres usuaris amb la capacitat de veure els cursos ocults.';
$string['create'] = 'Crea';
...
$string['downloadtext'] = 'Baixa en format de text';
...
$string['duplicatedsection'] = '{$a} (còpia)';
...
$string['editcategorysettings'] = 'Edita els paràmetres de la categoria';
...
$string['editgroupprofile'] = 'Edita la descripció del grup';
...
$string['editsection'] = 'Edita els paràmetres';
$string['editsectionname'] = 'Edita el nom de la secció';
$string['editsectionsettings'] = 'Edita els paràmetres de la secció';
$string['editsectiontitle'] = 'Edita la secció: {$a}';
...
$string['emaildisplay'] = 'Visibilitat de l\'adreça de correu electrònic';
$string['emaildisplay_help'] = '* Oculta: només els usuaris amb els permisos adequats, com ara els professors, poden veure la vostra adreça electrònica.
* Visible per a tothom: tots els usuaris del lloc web poden veure la vostra adreça electrònica.
* Visible per als participants del curs: només els participants dels cursos en què esteu inscrit poden veure la vostra adreça electrònica.';
$string['emaildisplaycourse'] = 'Visible per als participants del curs';
...
$string['emaildisplayhide'] = '(Oculta a tothom excepte als usuaris amb els permisos adequats)';
$string['emaildisplayno'] = 'Oculta';
$string['emaildisplayyes'] = 'Visible per a tothom';
...
$string['enddate_help'] = 'La data de finalització no restringeix l\'accés dels estudiants al curs. Determina si un curs apareix a «Passats» a Els meus cursos.';
$string['enddatewithtaskenabled'] = 'Data de finalització del curs';
$string['enddatewithtaskenabled_help'] = 'La data en la qual el curs esdevé ocult per als estudiants i ja no poden accedir-hi.';
...
$string['eventcourseended'] = 'El curs ha finalitzat';
...
$string['eventcoursestarted'] = 'El curs ha començat';
...
$string['eventsectionviewed'] = 'Secció visualitzada';
$string['eventunknownlogged'] = 'Esdeveniment desconegut';
$string['eventurlblocked'] = 'L\'URL estava bloquejada';
...
<p>La tasca <b>{$a->taskname}</b> ha fallat diverses vegades i requereix atenció.</p>
<p><a href="{$a->link}">Mostra la tasca</a></p>';
$string['failedtaskcontexturlname'] = 'Informe de l\'estat';
$string['failedtasksubject'] = 'Tasca que ha fallat: {$a}';
...
Aquest programa es distribueix amb l\'esperança que sigui útil, però SENSE CAP GARANTIA; sense ni tan sols la garantia implícita de COMERCIABILITAT o IDONEÏTAT PER A UN PROPÒSIT PARTICULAR.

Vegeu la pàgina d\'informació de la Llicència Moodle per obtenir més informació: https://moodledev.io/general/license';
$string['gpl3'] = 'Drets d\'autor (C) 1999 en endavant Martin Dougiamas (https://moodle.com)

Aquest programa és programari lliure: podeu redistribuir-lo i/o modificar-lo segons els termes de la Llicència Pública General GNU tal com la publica la Free Software Foundation, ja sigui la versió 3 de la Llicència o (a la vostra elecció) qualsevol versió posterior.
...
$string['hiddensections_help'] = 'Les seccions ocultes es poden mostrar als estudiants com a «no disponibles» a la pàgina del curs o mantenir-les completament ocultes.';
...
$string['hidefromstudents'] = 'Oculta-ho a la pàgina del curs';
...
$string['idnumbercourse_help'] = 'Només s\'utilitza per connectar el curs amb sistemes externs. Deixeu-ho en blanc si no teniu un ID oficial del curs.';
...
$string['importinfo'] = 'Importa elements d\'altres cursos, com ara activitats, blocs o esdeveniments del calendari. No s\'importaran dades d\'usuari.';
...
$string['includesubcategories'] = 'Inclou subcategories';
...
$string['invalidtaskclassname'] = 'Classe de tasca no vàlida {$a}';
$string['invalidtaskid'] = 'ID de tasca no vàlid';
...
$string['lastnamephonetic'] = 'Cognoms - fonètic';
...
$string['loginrequired'] = 'Cal iniciar sessió';
...
$string['makeavailablecmtitle'] = 'Posa disponible l\'activitat';
...
$string['modshowcmtitle'] = 'Mostra l\'activitat';
...
* Posa-ho disponible, però no ho mostris a la pàgina del curs: Disponible per als estudiants si els proporcioneu un enllaç. Les activitats apareixeran al llibre de qualificacions i altres informes.';
...
$string['moodledocslink'] = 'Documentació per a aquesta pàgina';
$string['moodlelogo'] = 'Logotip de Moodle';
$string['moodlenet:cannotconnecttoserver'] = 'No es pot establir la connexió amb el servidor MoodleNet';
$string['moodlenet:columnname'] = 'Nom';
$string['moodlenet:columnsenddate'] = 'Data d\'enviament';
$string['moodlenet:columnsendstatus'] = 'Estat de l\'enviament';
$string['moodlenet:columntype'] = 'Tipus';
$string['moodlenet:configoauthservice'] = 'Seleccioneu un servei MoodleNet OAuth 2 per a habilitar la compartició en aquest lloc MoodleNet. Si el servei encara no existeix, l\'haureu de <a href="{$a}">crear</a>.';
$string['moodlenet:deletedactivity'] = 'Activitat esborrada';
$string['moodlenet:deletedcourse'] = 'Curs esborrat';
$string['moodlenet:eventresourceexported'] = 'El recurs s\'ha exportat';
$string['moodlenet:gotomoodlenet'] = 'Ves als esborranys de MoodleNet';
$string['moodlenet:issuerisnotauthorized'] = 'L\'emissor de MoodleNet no està autoritzat.';
$string['moodlenet:issuerisnotenabled'] = 'L\'emissor de MoodleNet no està habilitat';
$string['moodlenet:issuerisnotset'] = 'L\'editor de MoodleNet no està actiu en l\'administració del lloc web';
$string['moodlenet:nosharedresources'] = 'No hi ha recursos compartits per mostrar en aquest moment';
$string['moodlenet:outboundsettings'] = 'Paràmetres de sortida de MoodleNet';
$string['moodlenet:packagingandsending'] = 'S\'està empaquetant el vostre fitxer i s\'està enviant a MoodleNet...';
$string['moodlenet:sharefailtext'] = 'Hi ha hagut un error en la compartició del vostre contingut a MoodleNet.<br> Si us plau proveu-ho més tard.';
$string['moodlenet:sharefailtextwithsitesupport'] = 'S\'ha produït un error en compartir el vostre contingut a MoodleNet.<br>Torneu-ho a provar més tard o <a href="{$a}">contacteu amb el suport del lloc</a>.';
$string['moodlenet:sharefailtitle'] = 'Alguna cosa ha anat malament';
$string['moodlenet:sharefilesizelimitexceeded'] = 'La mida del recurs que es comparteix ({$a->filesize} bytes) excedeix el límit de {$a->filesizelimit} bytes.';
$string['moodlenet:sharenoticeactivity'] = 'Aquesta activitat s\'està compartint amb MoodleNet com a recurs.';
$string['moodlenet:sharenoticecourse'] = 'Aquest curs s\'està compartint amb MoodleNet com a recurs.';
$string['moodlenet:sharenoticepartial'] = 'Les activitats seleccionades s\'estan compartint amb MoodleNet com a recurs.';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} activitats s\'inclouran en el curs';
$string['moodlenet:shareprogress'] = 'Progrés de la compartició a MoodleNet';
$string['moodlenet:shareprogressinfo'] = 'La llista mostra cursos i activitats que heu compartit a MoodleNet.<br>Feu clic al nom del recurs per veure\'l a MoodleNet.';
$string['moodlenet:sharesuccesstext'] = 'Gairebé està fet! Visiteu els vostres esborranys a MoodleNet per acabar de compartir el vostre contingut.';
$string['moodlenet:sharesuccesstitle'] = 'S\'ha desat als esborranys de MoodleNet';
$string['moodlenet:sharetomoodlenet'] = 'Comparteix a MoodleNet';
$string['moodlenet:sharetyperesource'] = 'recurs';
$string['moodlenet:sharinglargefile'] = 'Els fitxers grans poden trigar una estona.';
$string['moodlenet:sharingstatus'] = 'S\'està compartint a MoodleNet';
$string['moodlenet:sharingto'] = 'S\'està compartint a:';
$string['moodlerelease'] = 'Versió de Moodle';
...
$string['movecategoryto'] = 'Mou la categoria a:';
...
$string['movecourseto'] = 'Mou el curs a:';
...
$string['newsitemsnumber_help'] = 'El fòrum d\'anuncis té la subscripció forçada configurada per defecte. Només els professors i altres usuaris amb els permisos adequats hi poden publicar.

Si no necessiteu un fòrum d\'anuncis, configureu-ho a zero.

Aquest paràmetre també determina quants anuncis recents apareixen al bloc d\'anuncis més recents.';
...
$string['noresultsfor'] = 'No hi ha resultats per "{$a}"';
...
$string['opensinnewwindowbracketed'] = '(S\'obre en una finestra nova)';
...
$string['paymentinstant'] = 'Feu servir el botó de sota per pagar i registrar-vos en qüestió de minuts.';
...
$string['paymentsorry'] = 'Gràcies pel vostre pagament. Quan s\'hagi processat, podreu entrar al curs «{$a->fullname}». Espereu i torneu-ho a intentar. Si continueu tenint problemes, poseu-vos en contacte amb el {$a->teacher} o amb l\'administrador del lloc web.';
$string['paymentthanks'] = 'Gràcies pel vostre pagament. Ara esteu inscrit al curs {$a}.';
...
$string['pluginmissingfromdisk'] = '{$a->name} (Manca al disc)';
...
$string['policyagreementclick'] = 'Acceptació de la normativa d\'ús del lloc';
...
$string['previewthemename'] = 'Previsualitza el tema \'{$a}\'';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'Detalls del progrés de compartició a MoodleNet';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'L\'ID del mòdul associat';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'L\'ID del curs associat';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = 'L\'URL retornat de MoodleNet després d\'una compartició correcta';
$string['privacy:metadata:moodlenet_share_progress:status'] = 'L\'estat resultant de la compartició';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = 'El moment en què es va realitzar la compartició';
$string['privacy:metadata:moodlenet_share_progress:type'] = 'El tipus de compartició que s\'ha realitzat';
$string['privacy:metadata:moodlenet_share_progress:userid'] = 'L\'usuari que ha realitzat la compartició';
...
$string['resendemail'] = 'Reenvia el correu de confirmació';
...
$string['restoreinfo'] = 'Utilitzeu un fitxer de còpia de seguretat per restaurar una versió anterior d\'un curs o per crear un curs nou.';
...
$string['rolerenaming_help'] = 'Canvieu els noms de visualització dels rols d\'aquest curs.';
$string['rolerenaming_success'] = 'S\'han actualitzat els noms de rols del curs.';
$string['roles'] = 'Rols';
$string['rss'] = 'RSS';
...
$string['searchgroups'] = 'Cerca grups';
$string['searchitems'] = 'Cerca elements';
...
$string['selectgroupsseparate'] = 'Selecciona els grups separats';
$string['selectgroupsvisible'] = 'Selecciona grups visibles';
...
$string['selecttheme'] = 'Selecciona el tema';
$string['selectthemename'] = 'Selecciona el tema \'{$a}\'';
...
$string['showgrades_help'] = 'Permet que els estudiants visualitzin una llista de totes les notes obtingudes en el curs.';
...
Aquesta data també determina l\'inici de la primera setmana per a un curs en format setmanal, i és la data d\'inici per als registres d\'activitats del curs. Si reinicieu el curs i canvieu aquesta data, totes les dates del curs es mouran amb relació a la data d\'inici nova.';
...
$string['textformat'] = 'Format de text net';
$string['thanks'] = 'Gràcies';
$string['theme'] = 'Tema';
$string['themepreviewdescription'] = 'Descripció del tema {$a}';
$string['themepreviewimage'] = 'Imatge de previsualització de {$a}';
$string['themes'] = 'Temes';
...
$string['usermatchedon'] = 'L\'usuari coincideix amb la cerca mitjançant el camp següent:';
...
$string['viewallresults'] = 'Mostra tots els resultats ({$a})';
...
$string['viewresults'] = 'Mostra resultats per {$a}';
...
$string['wontrunfuturescheduledtask'] = 'No s\'executarà la tasca que no ha fallat i està programada per executar-se en el futur';
