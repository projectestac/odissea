...
/**
 * Strings for component 'moodle', language 'ca', version '4.1'.
 *
 * @package     moodle
 * @category    string
...
$string['actionsfor'] = 'Accions per a {$a}';
...
$string['addfilehere'] = 'Deixa anar els fitxers aquí per afegir-los al final d\'aquesta secció';
$string['addinganew'] = 'S\'està afegint una activitat nova o un recurs nou: {$a}';
$string['addinganewto'] = 'S\'està afegint l\'activitat o el recurs següent: {$a->what} a {$a->to}';
$string['addingdatatoexisting'] = 'S\'estan afegint dades a les existents';
$string['additionalcustomnav'] = 'Navegació personalitzada addicional';
$string['additionalnames'] = 'Noms addicionals';
$string['addlinkhere'] = 'Afegeix un enllaç aquí';
$string['addnew'] = 'Afegeix un nou {$a}';
$string['addnewcategory'] = 'Afegeix una categoria nova';
$string['addnewcourse'] = 'Afegeix un curs nou';
...
$string['adminhelpfailurelogs'] = 'Explora els registres d\'inici de sessió fallits';
...
$string['agelocationverification'] = 'Verificació de l\'edat i procedència';
$string['aimid'] = 'AIM ID';
...
$string['allowstealthmodules'] = 'Permet activitats secretes';
$string['allowstealthmodules_help'] = 'Si s\'habilita, les activitats es poden fer disponibles, però sense mostrar-se a les seccions visibles de la pàgina principal del curs. Si és així, els enllaços a les activitats secretes s\'han de proporcionar d\'alguna altra manera, com ara des d\'un recurs del tipus pàgina. Les activitats secretes s\'enumeren al butlletí de qualificacions i en altres informes.';
...
$string['backtohome'] = 'Torna a la pàgina principal';
...
$string['backupadhocpending'] = 'Tasca ad hoc de la còpia de seguretat del curs pendent';
...
$string['backuperrorinvaliddestination'] = 'La carpeta de destinació de la còpia de seguretat no existeix o no es pot escriure.';
...
$string['backupnonisowarning'] = 'Avís: aquesta còpia de seguretat és d\'una versió de Moodle no Unicode (anterior a la 1.6). Si la còpia conté textos que no estiguin codificats amb ISO-8859-1 es poden corrompre si proveu de restaurar-los en aquesta versió Unicode del Moodle. Vegeu les <a href="https://docs.moodle.org/en/Backup_FAQ">PMF de còpies de seguretat</a> per a més informació sobre la manera de restaurar correctament aquesta còpia.';
...
$string['backupsavetohelp'] = 'Ruta completa al directori on voleu desar els fitxers de còpies de seguretat';
...
$string['backuptakealook'] = 'Doneu una ullada als registres de la còpia de seguretat:
{$a}';
...
$string['blocksediton'] = 'Activa l\'edició de blocs';
...
$string['calltofeedback'] = 'Als creadors d\'aquest programari els agradaria saber la vostra opinió.';
$string['calltofeedback_give'] = 'Proporcioneu retroalimentació sobre aquest programari';
$string['calltofeedback_remind'] = 'Recorda-m\'ho més tard';
...
$string['categoryheader'] = 'Menú de categoria';
$string['categoryhidden'] = '(amagada)';
...
$string['categorypath'] = 'Camí de la categoria';
...
$string['changesmade'] = 'S\'han fet els canvis';
...
$string['checksok'] = 'Totes les comprovacions \'{$a}\' són correctes';
...
$string['closeblockdrawer'] = 'Tanca el calaix dels blocs';
$string['closebuttontitle'] = 'Tanca';
$string['closecourseindex'] = 'Tanca l\'índex del curs';
$string['closedrawer'] = 'Tanca el calaix';
...
$string['commentsrequirelogin'] = 'Us cal autenticar-vos per veure els comentaris.';
$string['comparelanguage'] = 'Compara i edita l\'idioma actual';
$string['complete'] = 'Complet';
$string['completed'] = 'S\'ha completat';
...
$string['confirmednot'] = 'El vostre registre encara no està confirmat. Comproveu si a la vostra bústia de correu teniu un missatge de confirmació.';
...
$string['contentexport_aboutthiscourse'] = 'Resum del curs';
$string['contentexport_coursesummary'] = 'Aquest fitxer és part del contingut descarregat des de <a href="{$a->courselink}">{$a->coursename}</a>.';
$string['contentexport_footersummary'] = 'Aquest fitxer és part del contingut descarregat des de <a href="{$a->courselink}">{$a->coursename}</a> per {$a->userfullname} el dia {$a->date}.';
$string['contentexport_modulesummary'] = 'Aquest fitxer és part del contingut descarregat des de <a href="{$a->courselink}">{$a->coursename}</a> el dia {$a->date}. Tingueu en compte que alguns continguts i els fitxers més grans de {$a->maxfilesize} no es descarreguen.';
$string['contentexport_viewfilename'] = 'Mostra el fitxer {$a}';
...
$string['cookiesenabled_help'] = 'Aquest lloc utilitza dues galetes:
...
$string['cookiesnotice'] = 'Avís de galetes';
$string['copy'] = 'copia';
$string['copyasnoun'] = 'còpia';
$string['copycourse'] = 'Copia el curs';
...
$string['coursecategory_help'] = 'Aquest paràmetre determina en quina categoria, dins la llista de cursos, apareixerà el curs.';
...
$string['coursedetails'] = 'Detalls del curs';
...
$string['courseduration'] = 'Durada del curs';
$string['courseduration_desc'] = 'La durada del curs s\'utilitza per calcular la data de finalització del curs que hi ha per defecte. La data de finalització del curs s\'utilitza per determinar si un curs s\'ha d\'incloure a la llista de cursos d\'un usuari. També es pot utilitzar per als informes personalitzats. Els usuaris poden continuar entrant al curs després de la data de finalització.';
$string['courseenddateenabled'] = 'Data de finalització del curs habilitada per defecte';
$string['courseenddateenabled_desc'] = 'Aquesta configuració determina si la data de finalització del curs s\'habilita per defecte per als cursos nous i s\'estableix una data calculada a partir de la durada del curs.';
...
$string['courseheader'] = 'Menú del curs';
...
$string['coursehelpnewsitemsnumber'] = 'Nombre d\'anuncis recents que apareixen al bloc de darrers anuncis de la pàgina principal del curs. Si s\'estableix a zero, el fòrum d\'anuncis no es crearà.';
...
$string['courseoverviewfiles'] = 'Imatge del curs';
...
$string['courseoverviewfilesext'] = 'Extensions del fitxer de la imatge del curs';
$string['courseoverviewfileslimit'] = 'Límit del fitxer de la imatge del curs';
...
$string['coursereuse'] = 'Reutilització del curs';
$string['courses'] = 'Cursos';
$string['coursesearch'] = 'Cerca cursos';
$string['coursesearch_help'] = 'Podeu cercar diverses paraules de cop i refinar la vostra cerca de la manera següent:

* paraula - troba qualsevol coincidència d\'aquesta paraula al text
* +paraula - només troba coincidències exactes
...
$string['createnewcategory'] = 'Crea una categoria nova';
$string['createnewcourse'] = 'Crea un curs nou';
...
$string['dataformats'] = 'Formats de dades';
$string['date'] = 'Data';
...
$string['defaultcompetencescale'] = 'Escala de competència per defecte';
$string['defaultcompetencescaledesc'] = 'Una escala de qualificació binària que no ofereix informació més enllà de algú ha demostrat assoliment o no.';
$string['defaultcompetencescalenotproficient'] = 'No és competent encara';
$string['defaultcompetencescaleproficient'] = 'Competent';
$string['defaultcoursestudent'] = 'Estudiant';
$string['defaultcoursestudentdescription'] = 'Els estudiants generalment tenen menys privilegis dins un curs.';
...
$string['defaultcourseteacherdescription'] = 'Els professors poden fer qualsevol cosa dins d\'un curs, i això inclou fer canvis a les activitats i qualificar els estudiants.';
$string['defaultcourseteachers'] = 'Professors';
$string['defaulteditor'] = 'Editor per defecte';
$string['defaulthomepageuser'] = 'Pàgina inicial';
$string['defaulthomepageuser_help'] = 'A quina pàgina caldria redirigir-vos després d\'iniciar la sessió al lloc?';
...
$string['deletepicture'] = 'Suprimeix';
$string['deletesection'] = 'Esborra la secció';
...
$string['deprecatedeventname'] = '{$a} (en desús)';
$string['desc'] = 'Descendent';
$string['description'] = 'Descripció';
$string['descriptiona'] = 'Descripció: {$a}';
$string['deselectall'] = 'Desselecciona-ho tot';
$string['deselectnos'] = 'Desselecciona tots els \'No\'';
...
$string['dismissnotification'] = 'Descarta aquesta notificació';
...
$string['dndenabled_inbox'] = 'Podeu arrossegar i deixar anar fitxers aquí per afegir-los';
$string['dndnotsupported'] = 'La pujada via «retalla i enganxa» no està suportada';
$string['dndnotsupported_help'] = 'El vostre navegador no suporta la pujada via «arrossega i deixa anar». Aquesta funcionalitat està disponible a les versions recents de Chrome, Firefox i Safari, així com a l\'Internet Explorer v10 i posteriors.';
...
$string['documentation'] = 'Documentació del Moodle';
...
$string['edhelpfontfamily'] = 'La propietat font-family és una llista de noms de tipus de lletra i/o noms genèrics de tipus de lletra. Els noms dels tipus de lletra s\'han de separar amb comes.';
...
$string['editorpreferences'] = 'Preferències de l\'editor';
...
$string['editsection'] = 'Edita la secció';
...
$string['edulevel'] = 'Tots els esdeveniments';
$string['edulevel_help'] = '* Ensenyant - accions que fa el professor, com ara actualitzar un recurs
* Participant - accions que fa l\'estudiant, com ara escriure en un fòrum
* Altres - accions que fa un usuari amb un rol diferent del de professor o estudiant';
...
* Resum, només capçaleres: rebreu un correu diari amb les capçaleres de cada missatge enviat a fòrums.

També podeu triar una configuració diferent per a cada fòrum, si voleu.';
$string['emaildigestcomplete'] = 'Complet (missatge de correu electrònic diari amb els missatges complets dels fòrums)';
$string['emaildigestoff'] = 'Sense resum (un missatge de correu electrònic per cada missatge dels fòrums)';
$string['emaildigestsubjects'] = 'Assumptes (missatge de correu electrònic diari només amb els assumptes)';
...
$string['emaildisplaycoursemembersonly'] = '(Visible per a altres participants del curs)';
$string['emaildisplayeveryone'] = '(Visible per a tothom)';
$string['emaildisplayhide'] = '(Ocult per a tots els usuaris sense privilegis)';
...
$string['emailexistshintlink'] = 'Recupera el nom d\'usuari o la contrasenya oblidades';
$string['emailexistssignuphint'] = 'Tal vegada heu creat un compte amb anterioritat? {$a}';
$string['emailformat'] = 'Format del missatge de correu electrònic';
...
<p> Verifiqueu la informació introduïda i torneu a provar-ho. Si continueu tenint problemes, poseu-vos en contacte amb l\'administrador del lloc. </p>';
...
$string['emailstop'] = 'Desactiva les notificacions';
$string['emailtoprivatefiles'] = 'També podeu enviar fitxers per correu electrònic com a fitxers adjunts directament al vostre espai de fitxers privats. Adjunteu els vostres fitxers a un missatge de correu electrònic i envieu-ho a {$a}';
$string['emailtoprivatefilesdenied'] = 'El vostre administrador ha inhabilitat l\'opció de pujar els vostres fitxers personals.';
$string['emailvia'] = '{$a->name} (via {$a->siteshortname})';
$string['emojicategoryactivities'] = 'Activitats';
$string['emojicategoryanimalsnature'] = 'Animals i natura';
$string['emojicategoryflags'] = 'Banderes';
$string['emojicategoryfooddrink'] = 'Menjar i beure';
$string['emojicategoryobjects'] = 'Objectes';
$string['emojicategorypeoplebody'] = 'Persones i cos';
$string['emojicategoryrecent'] = 'Recent';
$string['emojicategorysmileysemotion'] = 'Emoticones i emocions';
$string['emojicategorysymbols'] = 'Símbols';
$string['emojicategorytravelplaces'] = 'Viatges i indrets';
$string['emptycmids'] = 'Identificadors del mòdul de curs buit';
$string['emptydragdropregion'] = 'regió buida';
$string['emptysectionids'] = 'Identificadors de secció buida';
...
$string['eventcommentcreated'] = 'Comentari creat';
$string['eventcommentdeleted'] = 'Comentari suprimit';
$string['eventcommentsviewed'] = 'Comentaris vists';
$string['eventconfiglogcreated'] = 'S\'ha creat el registre de configuració';
$string['eventcontentviewed'] = 'Contingut mostrat';
$string['eventcoursebackupcreated'] = 'S\'ha creat la còpia de seguretat del curs';
$string['eventcoursecategorycreated'] = 'Categoria creada';
$string['eventcoursecategorydeleted'] = 'Categoria suprimida';
$string['eventcoursecategoryupdated'] = 'Categoria actualitzada';
$string['eventcoursecategoryviewed'] = 'Categoria mostrada';
...
$string['eventcourseinformationviewed'] = 'Resum del curs mostrat';
$string['eventcoursemodulecreated'] = 'Mòdul de curs creat';
$string['eventcoursemoduledeleted'] = 'Mòdul de curs suprimit';
$string['eventcoursemoduleinstancelistviewed'] = 'Llista d\'instàncies de mòduls de curs vistos';
$string['eventcoursemoduleupdated'] = 'Mòdul de curs actualitzat';
$string['eventcoursemoduleviewed'] = 'Mòdul de curs vist';
...
$string['eventcoursesectioncreated'] = 'Secció de curs creada';
$string['eventcoursesectiondeleted'] = 'S\'ha esborrat una secció del curs';
$string['eventcoursesectionupdated'] = 'Secció de curs actualitzada';
$string['eventcoursessearched'] = 'Cursos cercats';
$string['eventcourseupdated'] = 'Curs actualitzat';
$string['eventcourseuserreportviewed'] = 'Informe d\'usuari del curs vist';
$string['eventcourseviewed'] = 'Curs vist';
$string['eventdashboardreset'] = 'Reinicia el tauler';
$string['eventdashboardsreset'] = 'Reinicia els taulers';
$string['eventdashboardviewed'] = 'S\'ha mostrat el tauler';
$string['eventdatabasetextfieldcontentreplaced'] = 'Cerca i reemplaçament globals a la base de dades';
$string['eventemailfailed'] = 'Error en enviar el correu electrònic';
$string['eventmycoursesviewed'] = 'S\'ha visualitzat «Els meus cursos»';
$string['eventname'] = 'Nom de l\'esdeveniment';
$string['eventrecentactivityviewed'] = 'Activitat recent vista';
$string['eventsearchindexed'] = 'S\'han indexat les dades de cerca';
$string['eventsearchresultsviewed'] = 'Resultats de la cerca mostrats';
$string['eventunknownlogged'] = 'Esdeveniment desconegut';
$string['eventusercreated'] = 'Usuari creat';
$string['eventuserdeleted'] = 'Usuari suprimit';
$string['eventuserfeedbackgiven'] = 'S\'ha fet clic a l\'enllaç de retroalimentació';
$string['eventuserfeedbackremind'] = 'S\'ha fet clic a l\'enllaç de recordar més tard de la retroalimentació';
$string['eventuserinfocategorycreated'] = 'S\'ha creat una categoria de camps de perfil d\'usuari nova';
$string['eventuserinfocategorydeleted'] = 'S\'ha esborrat la categoria de camps de perfil d\'usuari';
$string['eventuserinfocategoryupdated'] = 'S\'ha actualitzat la categoria de camps de perfil d\'usuari';
$string['eventuserinfofieldcreated'] = 'S\'ha creat un nou camp de perfil d\'usuari';
$string['eventuserinfofielddeleted'] = 'S\'ha esborrat el camp de perfil d\'usuari';
$string['eventuserinfofieldupdated'] = 'S\'ha actualitzat el camp de perfil d\'usuari';
$string['eventuserlistviewed'] = 'Llista d\'usuaris mostrada';
$string['eventuserloggedout'] = 'Usuari desconnectat';
$string['eventuserpasswordpolicyfailed'] = 'La contrasenya de l\'usuari no ha superat la política de contrasenyes';
$string['eventuserpasswordupdated'] = 'Actualitzada la contrasenya de l\'usuari';
...
$string['expandall'] = 'Expandeix-ho tot';
$string['expandcategory'] = 'Amplia {$a}';
$string['explanation'] = 'Explicació';
$string['explanationdigitalminor'] = 'Aquesta informació es demana per determinar si la vostra edat està per sobre de l\'edat mínima de consentiment digital. Només amb aquesta edat una persona pot acceptar els termes i condicions de privadesa per a que les seves dades siguin legalment desades i processades pel sistema.';
$string['extendperiod'] = 'Període ampliat';
$string['extendsession'] = 'Estén la sessió';
...
$string['forumpreferences'] = 'Preferències del fòrum';
...
$string['frontpagedescription'] = 'Resum per a la pàgina inicial del lloc';
$string['frontpagedescriptionhelp'] = 'Aquest resum es pot mostrar a la pàgina inicial del lloc fent servir el bloc de resum del curs/lloc.';
$string['frontpageenrolledcourselist'] = 'Cursos inscrits';
$string['frontpageformat'] = 'Format de la pàgina inicial del lloc';
$string['frontpageformatloggedin'] = 'Format de la pàgina inicial del lloc per a usuaris que han iniciat la sessió';
$string['frontpagenews'] = 'Anuncis';
$string['frontpagesettings'] = 'Paràmetres de la pàgina inicial del lloc';
...
$string['functiondisabled'] = 'Aquesta funcionalitat està inhabilitada';
...
Vegeu la pàgina d\'informació sobre la llicència de Moodle per a més detalls:
...
$string['hiddenfromstudents'] = 'Ocult per als estudiants';
$string['hiddenoncoursepage'] = 'Disponible, però no es mostra a la pàgina principal del curs';
$string['hiddensections'] = 'Temes ocults';
$string['hiddensections_help'] = 'Aquest paràmetre determina si les seccions ocultes es mostren als estudiants en format reduït (potser per a un curs en format setmanal per indicar-hi les vacances) o si es troben completament ocultes.';
$string['hiddensectionscollapsed'] = 'Les seccions ocultes es mostren com a no disponibles';
$string['hiddensectionsinvisible'] = 'Els temes ocults són completament invisibles';
$string['hiddenwithbrackets'] = '(ocult)';
$string['hide'] = 'Oculta';
$string['hideadvancedsettings'] = 'Oculta paràmetres avançats';
$string['hidechartdata'] = 'Oculta dades del gràfic';
$string['hidefromstudents'] = 'Oculta-ho als estudiants';
...
$string['highlight'] = 'Realça';
$string['highlighted'] = 'Realçat';
$string['highlightoff'] = 'Suprimeix el realçament';
...
$string['home'] = 'Inici';
$string['homeheader'] = 'Menú de la pàgina inicial';
$string['hour'] = 'hora';
$string['hours'] = 'hores';
...
$string['htmleditordisabledadmin'] = 'L\'administrador ha inhabilitat l\'editor HTML en aquest lloc';
...
$string['idnumbercourse_help'] = '<p>Moodle no mostra mai el número ID del curs. Només s\'utilitza per identificar el curs contra sistemes externs. Si teniu un codi oficial del curs, podeu usar-lo aquí. Si no, podeu deixar aquest camp en blanc.</p>';
...
$string['idnumbergrouping_help'] = 'El número ID de l\'agrupament només es fa servir quan es compara l\'agrupament amb sistemes externs i no es veurà en cap lloc del lloc web. Si l\'agrupament té un nom de codi oficial, es pot introduir; en cas contrari, el camp es pot deixar en blanc.';
$string['idnumbermod'] = 'Número ID';
$string['idnumbermod_help'] = 'Definir un número ID és una manera de poder identificar l\'activitat i els recursos amb diverses finalitats, com fer càlculs per a les qualificacions o crear informes personalitzats.
Si no és el cas, podeu deixar el camp en blanc.

En les activitats avaluables, el número ID també es pot definir des del llibre de qualificacions, encara que sols es podrà editar des de la pàgina de configuració de l\'activitat.';
...
$string['indicator:accessesafterend'] = 'Accessos al curs després de la data de finalització';
$string['indicator:accessesafterend_help'] = 'Aquest indicador mostra si l\'estudiant ha accedit al curs després de la data de finalització.';
$string['indicator:accessesbeforestart'] = 'Accessos al curs abans de la data d\'inici';
$string['indicator:accessesbeforestart_help'] = 'Aquest indicador mostra si l\'estudiant ha accedit al curs abans de la data d\'inici.';
$string['indicator:activitiesdue'] = 'Activitats pendents';
$string['indicator:activitiesdue_help'] = 'L\'usuari té activitats pendents.';
$string['indicator:anycourseaccess'] = 'Accés a qualsevol curs';
$string['indicator:anycourseaccess_help'] = 'Aquest indicador mostra l\'accés a qualsevol curs on l\'usuari estigui inscrit.';
$string['indicator:anywrite'] = 'Qualsevol acció d\'escriptura';
$string['indicator:anywrite_help'] = 'Aquest indicador mostra qualsevol acció d\'escriptura (enviament) feta per l\'estudiant.';
$string['indicator:anywriteincourse'] = 'Qualsevol acció d\'escriptura en el curs';
$string['indicator:anywriteincourse_help'] = 'Aquest indicador mostra qualsevol acció d\'escriptura (enviament) feta per l\'estudiant en qualsevol activitat del curs.';
$string['indicator:completeduserprofile'] = 'Perfil d\'usuari complet';
$string['indicator:completeduserprofile_help'] = 'Aquest indicador mostra si l\'estudiant té completa la informació del perfil d\'usuari.';
$string['indicator:completeduserprofiledef'] = 'El perfil d\'usuari està completat';
$string['indicator:completeduserprofiledef_help'] = 'S\'han acceptat les polítiques del lloc i l\'usuari ha emplenat els camps següents: institució, departament, adreça, ciutat, país, URL.';
$string['indicator:completionenabled'] = 'S\'ha habilitat el seguiment de la compleció';
$string['indicator:completionenabled_help'] = 'Aquest indicador mostra si el seguiment de la compleció està habilitat en aquest curs.';
$string['indicator:nostudent'] = 'Inscripcions d\'estudiants';
$string['indicator:nostudent_help'] = 'Aquest indicador reflecteix la disponibilitat d\'estudiants en el curs.';
$string['indicator:noteacher'] = 'Disponibilitat de professors';
$string['indicator:noteacher_help'] = 'Aquest indicador mostra la disponibilitat de professors en el curs.';
$string['indicator:potentialcognitive'] = 'Profunditat cognitiva potencial del curs';
$string['indicator:potentialcognitive_help'] = 'Aquest indicador reflecteix la profunditat cognitiva que podria assolir un estudiant que participi en les activitats d\'aquest curs.';
$string['indicator:potentialcognitivedef'] = 'Profunditat cognitiva potencial del curs';
$string['indicator:potentialcognitivedef_help'] = 'El grau en què el curs ofereix un compromís cognitiu «profund», per exemple: tramesa de treballs per rebre\'n retroacció, l’oportunitat de revisar el treball d’altres persones, i l’oportunitat de revisar un treball i tornar-lo a trametre.';
$string['indicator:potentialcognitivedef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:potentialsocial'] = 'Abast social potencial del curs';
$string['indicator:potentialsocial_help'] = 'Aquest indicador mostra l\'abast social que pot assolir un estudiant que participi en les activitats d\'aquest curs.';
$string['indicator:potentialsocialdef'] = 'Potencial abast social del curs';
$string['indicator:potentialsocialdef_help'] = 'El grau en què el curs ofereix un compromís social «ampli», interactuant amb altres participants i amb la comunitat de pràctiques més enllà de la classe.';
$string['indicator:potentialsocialdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['indicator:readactions'] = 'Nivell d\'accions de lectura';
$string['indicator:readactions_help'] = 'Aquest indicador mostra el nombre d\'accions de lectura (visualitzacions) fetes per l\'estudiant.';
$string['indicator:userforumstracking'] = 'L\'usuari segueix els fòrums';
...
$string['interestslist_help'] = 'Escriviu els vostres interessos, un per un, els quals es mostraran a la pàgina del vostre perfil com a etiquetes.';
$string['invalidemail'] = 'L\'adreça de correu no és vàlida';
$string['invalidlogin'] = 'Inici de sessió incorrecte, torneu a intentar-ho';
$string['invalidusername'] = 'El nom d\'usuari solament pot contenir caràcters alfanumèrics en minúscules, guió baix (_), guionet (-), punt (.) o el símbol arrova (@)';
...
$string['legacylogginginuse'] = 'Aquest lloc té habilitada actualment l\'escriptura al registre heretat. L\'escriptura en aquest registre està desaconsellada. Escriviu a un registre admès, com l\'«estàndard» o l\'«extern».';
...
$string['loginactivity'] = 'Activitat d\'entrada';
$string['loginagain'] = 'Torneu a iniciar la sessió';
...
<p>Només cal triar un nom d\'usuari i una contrasenya, i emprar-los al formulari d\'aquesta pàgina.</p>
<p>Si algú ja ha triat abans el vostre nom d\'usuari, n\'haureu de provar un altre diferent.</p>';
...
$string['mailstudents'] = 'Informa\'n els estudiants';
...
$string['makeavailable'] = 'Posa-ho disponible';
...
$string['makethismyhome'] = 'Fes que aquesta sigui la meva pàgina inicial';
$string['makeunavailable'] = 'Fes que no estigui disponible';
$string['manageblocks'] = 'Blocs';
$string['managecategories'] = 'Gestiona les categories de curs';
$string['managecategorythis'] = 'Gestiona aquesta categoria';
$string['managecombined'] = 'Gestiona les categories de curs i els cursos';
$string['managecontentbanktypes'] = 'Gestiona els tipus de contingut';
$string['managecourses'] = 'Gestiona cursos';
$string['managedatabase'] = 'Base de dades';
$string['managedataformats'] = 'Gestiona els formats de dades';
...
$string['markallread'] = 'Marca-ho tot com a llegit';
...
$string['maxsectionslimit'] = 'No es pot crear una secció nova, ja que excediria el nombre màxim de seccions permeses per a aquest curs ({$a}).';
...
$string['maxsizeandattachmentsandareasize'] = 'Mida màxima de fitxer: {$a->size}, nombre màxim de fitxers adjunts: {$a->attachments}, límit global: {$a->areasize}';
...
$string['messageprovider:asyncbackupnotification'] = 'Notificacions de les còpies de seguretat / restauracions asíncrones';
$string['messageprovider:availableupdate'] = 'Notificacions d\'actualització disponible';
$string['messageprovider:backup'] = 'Notificacions de les còpies de seguretat';
$string['messageprovider:badgecreatornotice'] = 'Notificacions de creador d\'insígnies';
$string['messageprovider:badgerecipientnotice'] = 'Notificacions als destinataris de les insígnies';
$string['messageprovider:competencyplancomment'] = 'S\'ha escrit un comentari a un pla d\'aprenentatge';
$string['messageprovider:competencyusercompcomment'] = 'S\'ha escrit un comentari a una competència';
$string['messageprovider:coursecompleted'] = 'S\'ha completat el curs';
$string['messageprovider:coursecontentupdated'] = 'Canvis en el contingut del curs';
...
$string['messageprovider:messagecontactrequests'] = 'El contacte del missatge sol·licita una notificació';
$string['messageprovider:newlogin'] = 'Notificacions d\'inicis de sessió nous';
...
$string['messageprovider:reportbuilderschedule'] = 'Programacions del generador d\'informes personalitzats';
...
$string['missingrecaptchachallengefield'] = 'Camp reCAPTCHA erroni. Torneu a provar-ho.';
...
$string['moodledocslink'] = 'Ajuda i documentació';
$string['moodlelogo'] = 'Logotip de Moodle';
$string['moodlerelease'] = 'Alliberament de Moodle';
$string['moodleservicesandsupport'] = 'Serveis i suport';
$string['moodleversion'] = 'Versió del Moodle';
$string['more'] = 'més';
$string['moreactions'] = 'Més accions';
$string['morehelp'] = 'Més ajuda';
$string['morehelpaboutmodule'] = 'Més ajuda sobre l\'activitat {$a}';
$string['moreinfo'] = 'Més informació';
$string['moreinformation'] = 'Més informació d\'aquest error';
$string['moremenu'] = 'Més';
$string['morenavigationlinks'] = 'Més...';
...
$string['myhome'] = 'Tauler';
$string['mymoodledashboard'] = 'El meu tauler de Moodle';
$string['myprofile'] = 'El meu perfil';
$string['name'] = 'Nom';
$string['namedfiletoolarge'] = 'El fitxer «{$a->filename}» és massa llarg i no es pot pujar';
...
$string['networkdropped'] = 'Hem detectat que la vostra connexió a Internet no és segura i ha estat interrompuda. <br />
Teniu en compte que els canvis no es desaran fins que la vostra connexió millori.';
$string['never'] = 'Mai';
...
<ul>
<li>El vostre compte: {$a->username} {$a->useremail}</li>
<li>{$a->logintime}</li>
<li>Dispositiu: {$a->logindevice}</li>
<li>IP: {$a->loginip}</li>
</ul>
<p>Si heu estat vós, no cal que feu res.</p>
<p>Si no reconeixeu aquesta activitat, si us plau <a href="{$a->changepasswordlink}">canvieu la vostra contrasenya</a>.</p>';
$string['newloginnotificationbodysmall'] = 'El vostre compte {$a} acaba d\'iniciar la sessió des d\'un altre dispositiu ara mateix.';
$string['newloginnotificationtitle'] = 'Inici de sessió nou del vostre compte {$a}';
...
$string['newpasswordfromlost'] = '<strong>AVÍS:</strong> La vostra <strong>contrasenya actual</strong> s\'haurà enviat en el <strong>segon</strong> dels dos missatges de correu electrònic que rebreu com a part del procés de recuperació de la contrasenya. Assegureu-vos que heu rebut la contrasenya nova abans de continuar.';
...
$string['newpicture_help'] = 'Per afegir una imatge nova, exploreu i seleccioneu una imatge (en format JPG o PNG); després, cliqueu a «Actualitza perfil». La imatge es retallarà com un quadre i es redimensionarà a 100x100 píxels.';
$string['newpictureusernotsetup'] = 'La imatge del perfil només pot afegir-se quan tota la informació requerida del perfil s\'ha desat.';
$string['newsectionname'] = 'Nom nou per a la secció {$a}';
$string['newsitem'] = 'Notícia';
$string['newsitems'] = 'anuncis';
$string['newsitemsnumber'] = 'Nombre d\'anuncis';
$string['newsitemsnumber_help'] = 'El fòrum d\'anuncis és un tipus de fòrum especial que es crea automàticament en crear un curs. Té la subscripció forçada per defecte, i només els usuaris amb permís adequat (per defecte, els professors) hi poden publicar missatges.
...
$string['nofiltersapplied'] = 'No s\'ha aplicat cap filtre';
...
$string['none'] = 'Cap';
$string['noneditingteacher'] = 'Professor no editor';
$string['noneditingteacherdescription'] = 'Els professors no editors poden ensenyar dins dels cursos i qualificar els estudiants, però no poden modificar les activitats.';
...
$string['noreplybouncemessage'] = 'Heu contestat a una adreça de correu inadequada. Si volíeu contestar un missatge del fòrum, feu-ho utilitzant els fòrums: {$a}.
...
$string['nostudentsyet'] = 'No hi ha cap estudiant inscrit en aquest curs';
$string['nosuchemail'] = 'Adreça de correu desconeguda';
$string['notavailable'] = 'No disponible';
$string['notavailablecourse'] = '{$a} no és disponible';
$string['noteachersyet'] = 'Encara no hi ha cap professor en aquest curs';
$string['noteachingupcomingcourses'] = 'Els propers cursos no tenen professors ni estudiants';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Nota:</strong> La capacitat de canviar les dates quan es restaura una còpia de seguretat ha estat desactivada, ja que no teniu els permisos que calen.';
...
$string['nothingnew'] = 'Sense activitat recent';
...
$string['notifyloginfailuresmessage'] = '{$a->time}, IP: {$a->ip}, Usuari: {$a->info}, Nom complet d\'usuari: {$a->name}';
...
$string['notingroup'] = 'Heu de ser part d\'un grup per veure aquesta pàgina.';
...
$string['pagedcontentnavigationitem'] = 'Ves a la pàgina {$a}';
...
$string['passwordpolicynomatch'] = 'La vostra contrasenya actual ja no coincideix amb la política de contrasenyes establerta.
   {$a}';
...
<p><b>Busqueu la contrasenya nova al correu</b></p>
...
$string['poweredbymoodle'] = 'Funciona amb <a href="https://moodle.com">Moodle</a>';
...
$string['privacy:metadata:config_log'] = 'Registre de canvis a la configuració.';
$string['privacy:metadata:config_log:name'] = 'El nom dels canvis de configuració.';
$string['privacy:metadata:config_log:oldvalue'] = 'El valor anterior d\'aquest camp.';
$string['privacy:metadata:config_log:plugin'] = 'El connector modificat.';
$string['privacy:metadata:config_log:timemodified'] = 'L\'hora quan es va fer el canvi.';
$string['privacy:metadata:config_log:userid'] = 'L\'usuari que va fer el canvi.';
$string['privacy:metadata:config_log:value'] = 'El valor nou d\'aquest camp.';
$string['privacy:metadata:events_queue'] = 'La cua d\'esdeveniments de l\'usuari que espera ser processada.';
$string['privacy:metadata:events_queue:eventdata'] = 'La informació desada en aquest esdeveniment.';
$string['privacy:metadata:events_queue:stackdump'] = 'Qualsevol traça associada a aquest esdeveniment.';
$string['privacy:metadata:events_queue:timecreated'] = 'L\'hora de creació de l\'esdeveniment.';
$string['privacy:metadata:events_queue:userid'] = 'L\'ID d\'usuari associat amb aquest esdeveniment';
$string['privacy:metadata:log'] = 'Una col·lecció d\'esdeveniments passats';
$string['privacy:metadata:log:action'] = 'Una descripció de l\'acció';
$string['privacy:metadata:log:cmid'] = 'cmid';
$string['privacy:metadata:log:course'] = 'curs';
$string['privacy:metadata:log:info'] = 'Informació addicional';
$string['privacy:metadata:log:ip'] = 'L\'adreça IP utilitzada en el moment de l\'esdeveniment';
$string['privacy:metadata:log:module'] = 'mòdul';
$string['privacy:metadata:log:time'] = 'La data en què va tenir lloc l\'acció';
$string['privacy:metadata:log:url'] = 'L\'URL relacionat amb l\'esdeveniment';
$string['privacy:metadata:log:userid'] = 'L\'ID de l\'usuari que va realitzar l\'acció';
$string['privacy:metadata:oauth2_refresh_token'] = 'Refresca el testimoni utilitzat a la comunicació de l\'OAuth 2.0';
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'L\'ID de l\'emissor al qual correspon el testimoni';
$string['privacy:metadata:oauth2_refresh_token:scopehash'] = 'L\'ID de l\'usuari al qual correspon el testimoni';
$string['privacy:metadata:oauth2_refresh_token:timecreated'] = 'L\'hora en què es va crear el testimoni';
$string['privacy:metadata:oauth2_refresh_token:timemodified'] = 'L\'hora en què es va actualitzar el testimoni per darrera vegada';
$string['privacy:metadata:oauth2_refresh_token:token'] = 'El testimoni de refresc pels respectius àmbits i usuari';
$string['privacy:metadata:oauth2_refresh_token:userid'] = 'L\'ID de l\'usuari al qual correspon el testimoni';
$string['privacy:metadata:task_adhoc'] = 'L\'estat de les tasques ad hoc.';
$string['privacy:metadata:task_adhoc:component'] = 'El component propietari de la tasca.';
$string['privacy:metadata:task_adhoc:nextruntime'] = 'La propera data d\'execució de la tasca.';
$string['privacy:metadata:task_adhoc:userid'] = 'L\'usuari en el nom del qual la tasca s\'executarà.';
$string['privacy:metadata:task_log'] = 'Sortida de registre per a un registre';
$string['privacy:metadata:task_log:component'] = 'El component propietari de la tasca.';
$string['privacy:metadata:task_log:userid'] = 'L\'usuari al qual pertanyia la tasca.';
$string['privacy:metadata:upgrade_log'] = 'El registre d\'actualitzacions.';
$string['privacy:metadata:upgrade_log:backtrace'] = 'Qualsevol traça relacionada amb aquest pas de l\'actualització.';
$string['privacy:metadata:upgrade_log:details'] = 'Informació extra relacionada amb l\'actualització.';
$string['privacy:metadata:upgrade_log:info'] = 'La informació principal per a aquest pas de l\'actualització.';
$string['privacy:metadata:upgrade_log:plugin'] = 'El connector que s\'ha actualitzat.';
$string['privacy:metadata:upgrade_log:targetversion'] = 'La nova versió a la que s\'ha d\'actualitzar.';
$string['privacy:metadata:upgrade_log:timemodified'] = 'La data de l\'actualització.';
$string['privacy:metadata:upgrade_log:type'] = 'El tipus d\'entrada de registre.';
$string['privacy:metadata:upgrade_log:userid'] = 'L\'usuari que va executar l\'actualització.';
$string['privacy:metadata:upgrade_log:version'] = 'La versió anterior del connector.';
...
$string['queued'] = 'A la cua';
$string['quotausage'] = 'Actualment heu utilitzat {$a->used} del vostre total de {$a->total}';
...
$string['registration'] = 'Registre del Moodle';
$string['registrationcontact'] = 'Contacte públic';
$string['registrationcontactno'] = 'No, no vull ser contactat per altres';
$string['registrationcontactyes'] = 'Sí, mostra un formulari perquè altres usuaris de Moodle puguin contactar amb mi';
...
<p>Per defecte, la vostra informació es mantindrà  en privat, i mai no es vendrà ni es cedirà a ningú més. Es recull aquesta informació únicament per tal de donar suport i per ajudar a construir una imatge estadística de la comunitat Moodle com un tot.
<p>Si ho trieu així, el nom del vostre lloc, el país i l\'adreça web s\'afegiran a la llista pública de llocs Moodle.</p>
<p>Tots el registres nous són verificats manualment abans d\'afegir-se a la llista; un cop afegits, podeu modificar el vostre registre (i les dades de la llista pública) en qualsevol moment, tot reenviant aquest formulari.</p>';
...
$string['registrationyes'] = 'Sí, vull rebre notificacions de la publicació de noves versions del Moodle, d\'alertes de seguretat i d\'altres coses importants';
$string['reject'] = 'Denega';
$string['rejectdots'] = 'Denega...';
$string['relativedatesmode'] = 'Mode de dates relatives';
$string['relativedatesmode_help'] = 'Mostra les dates del curs o de l’activitat relatives a la data d’inici del curs per a l’usuari.

La data d\'inici del curs per a l\'usuari serà la seva data d\'inscripció, tret que hi estigui inscrit abans que comenci el curs; en aquest darrer cas, la seva data d\'inici serà la data d\'inici del curs.

ADVERTIMENT: Es tracta d’una característica experimental, i és possible que no totes les activitats hi siguin compatibles. Un cop creat el curs, aquest paràmetre ja no es pot canviar.';
$string['relativedatesmode_warning'] = '<strong>Avís:</strong> Les dates relatives no es poden modificar després de crear el curs.';
...
$string['reporttype'] = 'Tipus d\'informe';
...
$string['resortsubcategoriesbyreverse'] = 'Ordena les subcategories per {$a} descendent';
...
$string['resourcedisplaynew'] = 'Finestra nova';
...
$string['restoredaccountinfo'] = 'Aquest compte ha estat importat des d\'un altre servidor i la contrasenya s\'ha perdut. Per establir una altra contrasenya per correu electrònic, feu clic a «Continua»';
$string['restorefinished'] = 'La restauració s\'ha completat amb èxit';
$string['restoremnethostidmismatch'] = 'l\'id del servidor MNet de l\'usuari «{$a}» no concorda amb l\'id del servidor MNet local.';
$string['restoreto'] = 'Restaura en';
$string['restoretositeadding'] = 'Atenció: Ara restaurareu damunt la primera plana del lloc afegint-hi dades!';
$string['restoretositedeleting'] = 'Atenció: Ara restaurareu la pàgina inicial del lloc, esborrant-ne les dades primer!';
...
$string['resultsfound'] = 'S\'han trobat {$a} resultats';
$string['retry'] = 'Torna-ho a provar';
...
$string['savechangesandreturn'] = 'Desa i retorna';
...
$string['scale'] = 'Escala';
$string['scale_help'] = 'Una escala proporciona una manera d\'avaluar o qualificar l\'execució d\'una activitat. L\'escala es defineix com una llista ordenada de valors, que van des dels negatius als positius, separats per comes. Per exemple: «Decebedor, No prou bo, Correcte, Bo, Molt bo, Excel·lent!»';
...
$string['searchactivities'] = 'Cerca activitats pel nom o per la descripció';
...
$string['searchcoursecategories'] = 'Cerca a les categories';
...
$string['selectitem'] = 'Tria \'{$a}\'';
$string['selectmoduletoviewhelp'] = 'Seleccioneu una activitat o un recurs per veure\'n l\'ajuda.
Feu doble clic al nom de l\'activitat o el recurs per afegir-lo de manera ràpida.';
...
$string['sessionforceclean'] = 'Com a precaució de seguretat, els scripts generats pels usuaris s\'han inhabilitat dins d\'aquesta sessió.';
$string['sessiontimeoutsoon'] = 'La vostra sessió està a punt de superar el temps màxim d\'inactivitat. La voleu estendre?';
$string['setcategorytheme'] = 'Estableix el tema de la categoria';
$string['setmode'] = 'Mode de configuració';
$string['setpassword'] = 'Definició de la contrasenya';
$string['setpasswordinstructions'] = 'Introduïu la contrasenya nova a continuació; després, deseu els canvis.';
...
$string['showchartdata'] = 'Mostra les dades del gràfic';
...
$string['showdescription_help'] = 'Si s\'habilita, la descripció de dalt es mostrarà a la pàgina del curs, a sota de l\'enllaç a l\'activitat o el recurs.';
$string['showgrades'] = 'Mostra el llibre de qualificacions als estudiants';
$string['showgrades_help'] = 'Moltes activitats del curs poden ser qualificades. Aquest paràmetre determina si un estudiant pot veure o no la llista de totes les notes obtingudes en el curs.';
$string['showingacourses'] = 'S\'estan mostrant tots els cursos: {$a}';
$string['showingxofycourses'] = 'S\'està mostrant del curs {$a->start} al curs {$a->end} d\'un total de {$a->total} cursos';
...
$string['sitedefaultspecified'] = 'Valor per defecte del lloc ({$a})';
...
$string['sitelegacyfiles'] = 'Fitxers del lloc heretats';
...
$string['statslogins'] = 'Inicis de sessió';
...
$string['statsreport1'] = 'Inicis de sessió';
...
$string['statsreport14'] = 'Cursos més participatius (enviaments/vistes)';
...
$string['statsreport9'] = 'Inicis de sessió (curs del lloc)';
...
$string['statsreportlogins'] = 'Inicis de sessió';
...
$string['statsstudentactivity'] = 'Activitat de l\'estudiant';
$string['statsstudentreads'] = 'Visualitzacions de l\'estudiant';
$string['statsstudentwrites'] = 'Trameses de l\'estudiant';
...
$string['statsuniquelogins'] = 'Inicis de sessió únics';
$string['statsuseractivity'] = 'Tota l\'activitat';
$string['statsuserlogins'] = 'Inicis de sessió';
...
$string['statusna'] = 'N/D';
$string['statusok'] = 'Correcte';
$string['statusunknown'] = 'Desconegut';
...
$string['switchroleto_help'] = 'Trieu un rol per fer-vos una idea de com veurà el curs un usuari que tingui aquest rol.

Tingueu en compte que aquesta visualització pot no ser perfecta. (<a href="https://docs.moodle.org/ca/Switch_roles">Vegeu-ne els detalls i les alternatives</a>.)';
$string['tag'] = 'Etiqueta';
...
$string['textcopiedtoclipboard'] = 'S\'ha copiat el text al porta-retalls';
$string['textediting'] = 'Editor de text';
$string['textediting_help'] = 'Si escolliu un editor HTML com l\'Atto o el TinyMCE, les àrees d\'entrada de text tindran una barra d\'eines amb botons per tal d\'afegir contingut de manera senzilla.

Si se selecciona «àrea de text simple», es podrà escollir un format com ara HTML o Markdown per les àrees de text.

La llista d\'editors de text disponibles la determina l\'administrador del lloc.';
$string['texteditor'] = 'Utilitza formularis web normals';
$string['textellipsis'] = '{$a}...';
$string['textformat'] = 'Text net';
...
$string['timecreatedcourse'] = 'Hora de creació del curs';
$string['timesplitting:deciles'] = 'Darrera desena';
$string['timesplitting:deciles_help'] = 'Aquest interval d\'anàlisi divideix el curs en desenes (10 parts iguals), on cada predicció està basada, únicament, en les dades de la desena prèvia més recent.';
$string['timesplitting:decilesaccum'] = 'Totes les desenes prèvies';
$string['timesplitting:decilesaccum_help'] = 'Aquest interval d\'anàlisi divideix el curs en desenes (10 parts iguals), on cada predicció està basada en les dades acumulades de totes les desenes prèvies.';
$string['timesplitting:nosplitting'] = 'Sense límit de temps';
$string['timesplitting:nosplitting_help'] = 'No s\'ha definit cap interval d\'anàlisi per aquest model';
$string['timesplitting:onemonthafterstart'] = 'Un mes després de començar';
$string['timesplitting:onemonthafterstart_help'] = 'Aquest interval d\'anàlisi genera una predicció un mes després de començar l\'analitzable.';
$string['timesplitting:oneweekafterstart'] = 'Una setmana després de començar';
$string['timesplitting:oneweekafterstart_help'] = 'Aquest interval d\'anàlisi genera una predicció una setmana després de començar l\'analitzable.';
$string['timesplitting:past3days'] = 'Els darrers 3 dies.';
$string['timesplitting:past3days_help'] = 'Aquest interval d\'anàlisi genera prediccions cada tres dies. El càlcul dels indicadors estarà basat en els darrers tres dies.';
$string['timesplitting:pastmonth'] = 'El mes passat';
$string['timesplitting:pastmonth_help'] = 'Aquest interval d\'anàlisi genera prediccions cada mes. El càlcul dels indicadors estarà basat en el mes passat.';
$string['timesplitting:pastweek'] = 'La setmana passada';
$string['timesplitting:pastweek_help'] = 'Aquest interval d\'anàlisi genera prediccions cada setmana. El càlcul dels indicadors estarà basat en la darrera setmana.';
$string['timesplitting:quarters'] = 'El darrer trimestre';
$string['timesplitting:quarters_help'] = 'Aquest interval d\'anàlisi divideix el curs en trimestres (4 parts iguals), on cada predicció està basada, únicament, en les dades del trimestre previ més recent.';
$string['timesplitting:quartersaccum'] = 'Tots els trimestres previs';
$string['timesplitting:quartersaccum_help'] = 'Aquest interval d\'anàlisi divideix el curs en trimestres (4 parts iguals), on cada predicció està basada en les dades acumulades de tots els trimestres previs.';
$string['timesplitting:singlerange'] = 'De principi a final';
$string['timesplitting:singlerange_help'] = 'Aquest interval d\'anàlisi considera el curs com un lapse de temps únic';
$string['timesplitting:tenpercentafterstart'] = '10% després de començar';
$string['timesplitting:tenpercentafterstart_help'] = 'completatAquest interval d\'anàlisi genera una predicció una vegada s\'ha completat un 10% del curs.';
$string['timesplitting:upcoming3days'] = 'Els propers 3 dies';
$string['timesplitting:upcoming3days_help'] = 'Aquest interval d\'anàlisi genera prediccions cada 3 dies. Els indicadors es calcularan en base als propers 3 dies.';
$string['timesplitting:upcomingfortnight'] = 'La propera quinzena';
$string['timesplitting:upcomingfortnight_help'] = 'Aquest interval d\'anàlisi genera prediccions cada quinzena. Els indicadors es calcularan en base a la propera quinzena.';
$string['timesplitting:upcomingweek'] = 'La setmana vinent';
$string['timesplitting:upcomingweek_help'] = 'Aquest interval d\'anàlisi genera prediccions cada setmana. Els indicadors es calcularan en base a la setmana vinent.';
...
$string['toggleemojipicker'] = 'Commuta el capturador d\'emojis';
$string['togglesearch'] = 'Commuta l\'entrada de la cerca';
...
$string['toomanytags'] = 'Aquesta cerca inclou massa etiquetes, algunes s\'ignoraran.';
...
$string['turneditingon'] = 'Activa l\'edició';
$string['unabletocopytoclipboard'] = 'No s\'ha pogut copiar el text al porta-retalls';
$string['unauthorisedlogin'] = 'El compte d\'usuari «{$a}» no està disponible en aquest lloc';
$string['undecided'] = 'No decidit';
$string['unexistingcmid'] = 'No s\'ha trobat l\'identificador del mòdul de curs';
$string['unexistingsectionid'] = 'No s\'ha trobat l\'identificador de la secció de curs';
...
$string['userdescription_help'] = 'Podeu escriure un text que us descrigui en aquest quadre. Serà el que llegiran els altres usuaris si consulten el vostre perfil.';
$string['userdetails'] = 'Més dades de l\'usuari';
$string['userfiles'] = 'Fitxers d\'usuari';
$string['userlist'] = 'Llista d\'usuaris';
$string['usermenu'] = 'Menú d\'usuari';
$string['usermenugoback'] = 'Torna al menú d\'usuari';
$string['username'] = 'Nom d\'usuari';
$string['usernameemail'] = 'Nom d\'usuari o correu electrònic';
...
$string['validatehtml'] = 'Valida l\'HTML';
...
$string['wcagcheck'] = 'Verificació de les guies d\'accessibilitat de contingut web (WCAG)';
...
$string['whatisyourage'] = 'Quants anys teniu?';
$string['whattocallzip'] = 'Quin nom voleu donar al fitxer zip?';
$string['whattodo'] = 'Què cal fer';
$string['wheredoyoulive'] = 'A quin país viviu?';
$string['whyisthisrequired'] = 'Per què això és necessari?';
...
$string['youhaveupcomingactivitiesdue'] = 'Teniu activitats properes previstes';
$string['youhaveupcomingactivitiesdueinfo'] = '{$a},

<br/><br/>Teniu activitats properes previstes:';
$string['youneedtoenrol'] = 'Per a realitzar aquesta acció us heu d\'inscriure al curs';
$string['yourlastlogin'] = 'El vostre darrer inici de sessió va ser';
$string['yourself'] = 'vós mateix';
$string['yourteacher'] = 'el vostre {$a}';
$string['yourwordforx'] = 'El vostre nom per a «{$a}»';
