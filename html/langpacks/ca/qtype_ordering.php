...
/**
 * Strings for component 'qtype_ordering', language 'ca', version '4.5'.
 *
...
$string['answer'] = 'Element de text';
$string['correctitemsnumber'] = 'Elements correctes: {$a}';
$string['correctorder'] = 'L\'ordre correcte d\'aquests elements és el següent:';
$string['defaultanswerformat'] = 'Format de resposta per defecte';
$string['defaultquestionname'] = 'Arrossega els següents elements en l\'ordre correcte.';
$string['draggableitemno'] = 'Element arrossegable {no}';
$string['draggableitems'] = 'Elements arrossegables';
$string['duplicatesnotallowed'] = 'No es permet duplicar els elements arrossegables. La cadena «{$a->text}» ja està en ús a {$a->item}.';
...
$string['highlightresponse'] = 'Ressalta la resposta com a correcta o incorrecta';
...
$string['noresponsedetails'] = 'No s\'han trobat detalls de la resposta per a aquesta pregunta.';
$string['noscore'] = 'Sense puntuació';
$string['notenoughanswers'] = 'La preguntes d\'ordenació han de tenir més de {$a} respostes.';
$string['notenoughsubsetitems'] = 'Un subconjunt ha de tenir almenys {$a} elements.';
...
$string['numberingstyle_desc'] = 'L\'estil de numeració per defecte.';
...
$string['privacy:preference:numberingstyle'] = 'L\'estil de numeració de les opcions.';
...
$string['regradeissuenumitemschanged'] = 'El nombre d\'elements arrossegables ha canviat.';
...
$string['removeeditor'] = 'Suprimeix l\'editor HTML';
$string['removeitem'] = 'Suprimeix l\'element arrossegable';
...
$string['selectcount'] = 'Mida del subconjunt';
$string['selectcount_help'] = 'El nombre d\'elements que es mostraran quan la pregunta aparegui al qüestionari.';
