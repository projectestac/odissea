...
$string['incompatibleversion'] = 'Versió incompatible de Moodle: {$a}';
...
$string['notsupported'] = 'El connector pot no ser compatible amb la versió de Moodle {$a}';
...
$string['type_communication'] = 'Proveïdor de comunicacions';
$string['type_communication_plural'] = 'Proveïdors de comunicacions';
...
$string['type_customfield'] = 'Camp personalitzat';
$string['type_customfield_plural'] = 'Camps personalitzats';
...
$string['type_h5plib'] = 'Entorn de treball H5P';
$string['type_h5plib_plural'] = 'Entorns de treball H5P';
...
$string['type_mlbackend'] = 'Rerefons d\'aprenentatge automàtic';
$string['type_mlbackend_plural'] = 'Rerefons d\'aprenentatge automàtic';
...
$string['type_paygw'] = 'Passarel·la de pagament';
$string['type_paygw_plural'] = 'Passarel·les de pagament';
$string['type_paygwmanage'] = 'Gestiona les passarel·les de pagament';
...
$string['type_qbank'] = 'Connector del banc de preguntes';
$string['type_qbank_plural'] = 'Connectors del banc de preguntes';
...
$string['validationmsg_pluginversiontoolow'] = 'Ja hi ha instal·lada una versió superior d\'aquest connector';
