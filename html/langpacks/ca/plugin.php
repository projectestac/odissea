...
$string['filtermissingonly'] = 'Mostra només els que falten al disc';
$string['filternewpluginsonly'] = 'Mostra només els connectors que s\'ha d\'instal·lar';
...
$string['notdownloadable_help'] = 'El paquet ZIP amb l\'actualització no es pot baixar de forma automàtica.';
...
$string['notwritable_help'] = 'El servidor web no pot escriure els fitxers dels complements. El procés del servidor web ha de tenir accés d\'escriptura a la carpeta del complement i a tot el seu contingut. També pot ser necessari accés d\'escriptura a la carpeta arrel del tipus de complement.';
...
$string['pluginchecknotice'] = 'Aquesta pàgina mostra els complements que poden requerir la vostra atenció durant l\'actualització, com ara complements nous que s\'instal·laran, complements que s\'actualitzaran, complements que falten, etc. Es mostren complements addicionals si hi ha una actualització disponible per a ells. Es recomana que comproveu si hi ha versions més recents dels complements disponibles i que actualitzeu el codi font abans de continuar amb aquesta actualització del Moodle.';
...
$string['type_aiprovider'] = 'Connector de proveïdor d\'IA';
$string['type_aiprovider_plural'] = 'Connectors de proveïdors d\'IA';
...
$string['type_message'] = 'Connector de notificacions';
$string['type_message_plural'] = 'Connectors de notificacions';
...
$string['type_plagiarism'] = 'Connector de plagi';
$string['type_plagiarism_plural'] = 'Connectors plagi';
...
$string['type_smsgateway'] = 'Passarel·la SMS';
$string['type_smsgateway_plural'] = 'Passarel·les SMS';
...
$string['uninstalldeleteconfirmexternal'] = 'Sembla que la versió actual del connector s\'ha obtingut mitjançant la comprovació del sistema de gestió de codi font ({$a}). Si elimineu la carpeta del connector, podeu perdre modificacions locals importants del codi. Assegureu-vos de que voleu eliminar la carpeta del connector abans de continuar.';
...
$string['validationmsg_targetexists'] = 'La ubicació de destinació ja existeix i s\'esborrarà';
$string['validationmsg_targetexists_help'] = 'El directori del connector ja existeix i serà substituït pel contingut del paquet del connector.';
