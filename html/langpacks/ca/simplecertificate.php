...
/**
 * Strings for component 'simplecertificate', language 'ca', version '3.11'.
 *
...
$string['enablesecondpage_help'] = 'Habilita l\'edició del dors del certificat. Si s\'inhabilita, al dors només s\'imprimirà el codi QR (si aquest s\'ha de mostrar)';
...
$string['openemail'] = 'Feu clic al botó de sota per enviar el certificat al vostre correu electrònic com a adjunció.';
