...
/**
 * Strings for component 'auth_mnet', language 'ca', version '4.4'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:suspended'] = 'Indicador per mostrar si l\'usuari ha estat suspès en aquest sistema.';
$string['privacy:metadata:mnet_external:timezone'] = 'La zona horària de l\'usuari';
$string['privacy:metadata:mnet_external:trackforums'] = 'Preferència pels fòrums i el seguiment dels mateixos.';
$string['privacy:metadata:mnet_external:trustbitmask'] = 'La màscara de bits de confiança';
$string['privacy:metadata:mnet_external:username'] = 'Nom d\'usuari per a aquest usuari.';
$string['privacy:metadata:mnet_log'] = 'Detalls de les accions remotes dutes a terme per un usuari local connectat a un sistema remot.';
$string['privacy:metadata:mnet_log:action'] = 'Acció que duu a terme l\'usuari.';
$string['privacy:metadata:mnet_log:cmid'] = 'Identificador del mòdul del curs.';
$string['privacy:metadata:mnet_log:course'] = 'Identificador del curs del sistema remot on s\'ha produït l\'acció.';
$string['privacy:metadata:mnet_log:coursename'] = 'Nom complet del curs del sistema remot on s\'ha produït l\'acció.';
$string['privacy:metadata:mnet_log:info'] = 'Informació addicional sobre l\'acció.';
$string['privacy:metadata:mnet_log:ip'] = 'L\'adreça IP utilitzada en el moment que s\'ha produït l\'acció.';
$string['privacy:metadata:mnet_log:module'] = 'Mòdul del sistema remot on s\'ha produït l\'acció.';
$string['privacy:metadata:mnet_log:remoteid'] = 'Identificador remot de l\'usuari que ha realitzat l\'acció al sistema remot.';
$string['privacy:metadata:mnet_log:time'] = 'Moment en què es va produir l\'acció.';
$string['privacy:metadata:mnet_log:url'] = 'URL del sistema remot on s\'ha produït l\'acció.';
$string['privacy:metadata:mnet_log:userid'] = 'Identificador local de l\'usuari que ha realitzat l\'acció al sistema remot.';
$string['privacy:metadata:mnet_session'] = 'Els detalls de cada sessió d\'usuari MNet en un sistema remot. Les dades s\'emmagatzemen temporalment.';
$string['privacy:metadata:mnet_session:expires'] = 'Hora en què expira la sessió.';
$string['privacy:metadata:mnet_session:mnethostid'] = 'Identificador MNet del sistema remot.';
$string['privacy:metadata:mnet_session:token'] = 'Identificador únic de sessió';
$string['privacy:metadata:mnet_session:useragent'] = 'Agent d\'usuari utilitzat per accedir al sistema remot';
$string['privacy:metadata:mnet_session:userid'] = 'Identificador de l\'usuari que salta al sistema remot.';
$string['privacy:metadata:mnet_session:username'] = 'Nom d\'usuari de l\'usuari que passa al sistema remot.';
...
$string['unknownhost'] = 'Amfitrió desconegut';
