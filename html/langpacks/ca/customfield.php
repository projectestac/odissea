...
$string['deletecategory'] = 'Esborra la categoria de camps personalitzats: {$a}';
$string['deletefield'] = 'Esborra el camp personalitzat: {$a}';
...
$string['editfield'] = 'Edita el camp personalitzat: {$a}';
...
$string['privacy:metadata:customfield_data:valuetrust'] = 'L\'indicador de confiança del valor, quan és text';
