...
/**
 * Strings for component 'tool_migratehvp2h5p', language 'ca', version '4.1'.
 *
...
$string['error_modh5pactivity_disabled'] = 'L\'activitat H5P està inhabilitada. Cal habilitar-la per migrar activitats des del mod_hvp';
