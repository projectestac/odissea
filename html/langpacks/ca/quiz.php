...
$string['addarandomquestion'] = 'Afegeix una pregunta aleatòria...';
$string['addarandomquestion_help'] = 'Quan s\'afegeix una pregunta aleatòria, això dona com a resultat una pregunta escollida a l\'atzar de la categoria que s\'insereix al qüestionari. Això vol dir que és probable que diferents estudiants rebin una selecció diferent de preguntes. A més, quan un qüestionari permet intents múltiples, aleshores és probable que cada intent incorpori una selecció nova de preguntes.';
$string['addarandomquestion_success'] = 'S\'han afegit preguntes aleatòries';
...
$string['addquestionfrombankatend'] = 'Afegeix des del banc de preguntes al final';
$string['addquestionfrombanktopage'] = 'Afegeix del banc de preguntes a la pàgina {$a}';
...
$string['addrandomquestionatend'] = 'Afegeix una pregunta aleatòria al final';
...
$string['addselectedquestionstoquiz'] = 'Afegeix les preguntes seleccionades al qüestionari';
...
$string['alwayslatest'] = 'Sempre la més recent';
...
$string['attemptgradeddelay'] = 'Retard abans d\'enviar les notificacions d\'«intent qualificat»';
$string['attemptgradeddelay_desc'] = 'S\'aplica un retard abans d\'enviar les notificacions de qualificació de l\'intent per permetre que el professorat pugui editar la qualificació.';
...
$string['attemptquiz'] = 'Contesta el qüestionari';
...
$string['cachedef_overrides'] = 'Informació de les excepcions d\'usuari i grup';
...
$string['canredoquestions_desc'] = 'Si s\'habilita, quan el alumnes hagin acabat l\'intent d\'una pregunta particular, veuran un botó «Tornar a respondre». Això els permetrà intentar una altra versió de la mateixa pregunta, sense haver d\'enviar l\'intent del qüestionari sencer i començar-ne un altre. Aquesta opció és útil principalment per qüestionaris de pràctica.
...
$string['completionattemptsexhausted'] = 'Cal arribar a la qualificació per a aprovar o que tots els intents disponibles s\'hagin completat';
...
$string['configdecimalplacesquestion'] = 'Nombre de dígits que s\'han de mostrar després de la coma decimal en visualitzar les puntuacions de cada pregunta.';
...
$string['configoutcomesadvanced'] = 'Si aquesta opció està activada, els resultats en el formulari d\'edició del qüestionari esdevindran paràmetres avançats.';
...
$string['confirmremovesectionheading'] = 'Segur que voleu suprimir la capçalera de la secció «{$a}»?';
$string['confirmserverdelete'] = 'Confirmeu que voleu suprimir el servidor <b>{$a}</b> de la llista?';
...
$string['decimaldigits'] = 'Xifres decimals a les qualificacions';
...
$string['decimalplacesquestion'] = 'Nombre de decimals a les puntuacions de les preguntes';
$string['decimalplacesquestion_help'] = 'Nombre de dígits que es mostren després de la coma decimal quan es visualitzen les puntuacions de cada pregunta.';
$string['decimalpoints'] = 'Nombre de decimals';
...
$string['edit_slotdisplaynumber_hint'] = 'Edita el nombre de la pregunta (màxim 16 caràcters)';
$string['edit_slotdisplaynumber_label'] = 'Valor nou per a {$a}';
...
$string['emailconfirmautosubmitsmall'] = 'Gràcies per trametre les vostres respostes a \'{$a->quizname}\'';
...
El temps per a realitzar el qüestionari \'{$a->quizname}\' del curs \'{$a->coursename}\' ha expirat. Les vostres respostes s\'han tramès automàticament a les {$a->submissiontime}.
...
$string['emailmanualgradedbody'] = 'Hola, {$a->username}

Les vostres respostes a \'{$a->quizname}\' del curs \'{$a->coursename}\' a les {$a->attempttimefinish} s\'han qualificat ara.

Podreu veure la vostra puntuació i retroacció si visiteu \'{$a->quizurl}\' i reviseu el vostre intent.';
$string['emailmanualgradedsubject'] = 'S\'ha qualificat el vostre intent {$a->quizname}';
...
$string['eventattemptautosaved'] = 'S\'ha desat automàticament l\'intent del qüestionari';
$string['eventattemptdeleted'] = 'S\'ha suprimit l\'intent del qüestionari';
$string['eventattemptmanualgradingcomplete'] = 'S\'ha completat la qualificació manual de l\'intent del qüestionari';
$string['eventattemptpreviewstarted'] = 'S\'ha iniciat la previsualització de l\'intent del qüestionari';
$string['eventattemptquestionrestarted'] = 'S\'ha reiniciat la pregunta de l\'intent del qüestionari';
...
$string['eventattemptupdated'] = 'S\'ha actualitzat l\'intent del qüestionari';
$string['eventattemptviewed'] = 'S\'ha mostrat l\'intent del qüestionari';
...
$string['eventpagebreakcreated'] = 'S\'ha creat un salt de pàgina';
$string['eventpagebreakdeleted'] = 'S\'ha suprimit un salt de pàgina';
...
$string['eventquizattemptreopened'] = 'S\'ha tornat a obrir l\'intent del qüestionari';
...
$string['eventquizgradeitemcreated'] = 'S\'ha creat l\'element de qualificació del qüestionari';
$string['eventquizgradeitemdeleted'] = 'S\'ha suprimit l\'element de qualificació del qüestionari';
$string['eventquizgradeitemorderchanged'] = 'Ha canviat l\'ordre de l\'element de qualificació del qüestionari';
$string['eventquizgradeitemupdated'] = 'S\'ha actualitzat l\'element de qualificació del qüestionari';
$string['eventquizgradeupdated'] = 'S\'ha actualitzat la qualificació del qüestionari';
$string['eventquizrepaginated'] = 'S\'ha repaginat el qüestionari';
$string['eventreportviewed'] = 'S\'ha visualitzat l\'informe del qüestionari';
$string['eventsectionbreakcreated'] = 'S\'ha creat un salt de secció';
$string['eventsectionbreakdeleted'] = 'S\'ha suprimit un salt de secció';
$string['eventsectiontitleupdated'] = 'S\'ha actualitzat el títol de la secció';
...
$string['gobacktoquiz'] = 'Torna enrere';
...
$string['gradeitemdefaultname'] = 'Element de qualificació nou {$a}';
$string['gradeitemdelete'] = 'Suprimeix l\'element de qualificació {$a}';
$string['gradeitemedit'] = 'Edita el nom de l\'element de qualificació {$a}';
$string['gradeitemmarkscheme'] = 'Assigna els elements de qualificació';
$string['gradeitemnewname'] = 'Nom nou per a l\'element de qualificació {$a}';
$string['gradeitemnoneselected'] = '[cap]';
$string['gradeitemnoslots'] = 'Aquest qüestionari encara no té cap pregunta. Primer de tot afegiu les preguntes, després torneu aquí per configurar els elements de qualificació.';
...
$string['gradingdetailsadjustment'] = 'Amb les penalitzacions prèvies això dona <strong>{$a->cur}/{$a->max}</strong>.';
...
$string['manualgradequestion'] = 'Qualifica la pregunta {$a->question} de forma manual a {$a->quiz} per {$a->user}';
...
$string['maxmarks_help'] = 'La qualificació màxima disponible per a cada pregunta.';
...
$string['newsectionheading'] = 'Encapçalament nou';
...
$string['overridessummaryyourgroups'] = 'S\'han establert excepcions ({$a}) pels vostres grups';
...
$string['previewquizstart'] = 'Previsualitza el qüestionari';
$string['previous'] = 'Estat anterior';
$string['privacy:metadata:quiz_overrides'] = 'Detalls de les excepcions d\'aquest qüestionari';
$string['privacy:metadata:quiz_overrides:quiz'] = 'El qüestionari amb informació d\'excepcions';
$string['privacy:metadata:quiz_overrides:timeclose'] = 'El nou instant de tancament del qüestionari.';
$string['privacy:metadata:quiz_overrides:timelimit'] = 'La nova durada màxima del qüestionari.';
$string['privacy:metadata:quiz_overrides:timeopen'] = 'El nou instant d\'obertura del qüestionari.';
$string['privacy:metadata:quiz_overrides:userid'] = 'L\'usuari afectat per l\'excepció';
...
$string['questionbank'] = 'Afegeix una pregunta del banc de preguntes';
...
$string['questionversionlatest'] = 'v{$a} (la més recent)';
...
$string['quizisclosedwillopen'] = 'Qüestionari tancat (s\'obre el dia {$a})';
...
$string['readytosend'] = 'Ara enviareu el qüestionari complet perquè sigui qualificat. Confirmeu que voleu continuar?';
...
$string['reviewofquestion'] = 'Revisió de la pregunta {$a->question} en {$a->quiz} per {$a->user}';
...
$string['submission_confirmation'] = 'Voleu trametre les vostres respostes i finalitzar el qüestionari?';
...
$string['totalmarks'] = 'Total de les notes';
