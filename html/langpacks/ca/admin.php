...
$string['debugtemplateinfo_desc'] = 'Si s\'habilita, les plantilles utilitzades per a la representació es mostraran com a comentaris a la pàgina HTML. Utilitza només per a la depuració temporal, ja que produeix errors de validació HTML i pot trencar alguns scripts de pàgina.';
...
$string['hookdeprecates'] = 'Crides de retorn de la lib.php obsoletes';
