...
$string['accountlocked'] = 'El vostre compte està bloquejat. S\'ha enviat un enllaç de desbloqueig per correu electrònic.';
$string['accounts'] = 'Comptes';
$string['accountunlocked'] = 'El vostre compte està desbloquejat. Podeu iniciar sessió.';
...
$string['agedigitalconsentverification_desc'] = 'Activa la verificació de l\'edat del consentiment digital abans de mostrar la pàgina de registre per als usuaris que s\'autoregistren. Això protegeix el vostre lloc web contra menors que es registrin sense el consentiment dels pares o tutors. Es proporcionen els detalls del <a target="_blank" href="{$a}">contacte de suport</a> per obtenir més ajuda.';
...
$string['asyncbackupdisabled'] = 'El vostre lloc web està configurat actualment per utilitzar còpies de seguretat síncrones. Les còpies de seguretat asíncrones proporcionen una millor experiència d\'usuari, permetent als usuaris fer altres operacions mentre una còpia de seguretat o restauració està en curs. Les còpies de seguretat asíncrones estan habilitades per a tots els llocs web a partir del Moodle 4.5 LTS. Les còpies de seguretat síncrones s\'eliminaran del Moodle LMS a la versió posterior a la 4.5 LTS.';
...
$string['blockprotectblock'] = 'Protegeix instàncies de {$a}';
$string['blockprotected'] = '{$a} instàncies de bloc estan protegides.';
$string['blocksettings'] = 'Gestió de blocs';
$string['blockunprotect'] = 'Desprotegeix';
$string['blockunprotectblock'] = 'Desprotegeix instàncies de {$a}';
$string['blockunprotected'] = '{$a} instàncies de bloc no estan protegides.';
...
$string['cliupgradecompletenomaintenanceupgrade'] = 'Per a purgar la memòria cau restant després de retallar el trànsit d\'usuaris al codi nou:
...
$string['cliupgradesetlock'] = 'L\'actualització només s\'ha bloquejat a l\'execució de la CLI.';
$string['cliupgradeunsetlock'] = 'S\'ha eliminat el bloqueig d\'actualització de la CLI existent.';
$string['cliyesnoprompt'] = 'Escriu y (significa Sí) o n (significa No)';
$string['close'] = 'Tancar';
$string['cohort_customfield'] = 'Camps personalitzats de la cohort';
...
$string['configallowobjectembed'] = 'Per seguretat, els usuaris amb el rol d\'estudiant no poden incrustar contingut multimèdia dins de textos mitjançant les etiquetes HTML EMBED i OBJECT, tot i que el contingut multimèdia encara es pot mostrar mitjançant el filtre de complements multimèdia. Si voleu permetre aquestes etiquetes, activeu aquesta opció.';
...
$string['configcustomusermenuitems'] = 'Podeu configurar el contingut del menú d\'usuari (amb l\'excepció de l\'enllaç de tancament de sessió, que s\'afegeix automàticament). Cada línia està separada per caràcters de barra vertical i consta de 1) una cadena amb el format «langstringname, componentname» o amb text sense format, i 2) un URL. Es poden utilitzar divisors afegint una línia d\'un o més caràcters # on es vulgui.';
...
$string['configdefaulthomepage'] = 'A quina pàgina s\'haurien de redirigir els usuaris després d\'iniciar la sessió al lloc web? La configuració també determina el primer enllaç de la navegació per als usuaris de temes basats en la versió clàssica.';
...
$string['configdocroot'] = 'Defineix la ruta a «Moodle Docs» per proporcionar documentació específica del context mitjançant els enllaços «Documentació per a aquesta pàgina» al peu de pàgina de cada pàgina. Si el camp es deixa en blanc, els enllaços no es mostraran.';
...
$string['configduration_high'] = 'Aquest valor és massa alt. El valor màxim és {$a}.';
$string['configduration_low'] = 'Aquest valor és massa baix. El valor mínim és {$a}.';
...
$string['configforcelogin'] = 'Normalment, la pàgina d\'inici del lloc web i la llista de cursos (però no els cursos) poden ser llegits per persones sense haver d\'iniciar sessió al lloc web. Si voleu obligar la gent a iniciar sessió abans de fer res al lloc web, hauríeu d\'activar aquest paràmetre.';
...
$string['configfrontpage'] = 'Els elements seleccionats anteriorment es mostraran a la pàgina d\'inici del lloc web.';
$string['configfrontpagecourselimit'] = 'Nombre màxim de cursos';
$string['configfrontpagecourselimithelp'] = 'Nombre màxim de cursos que es mostraran a la pàgina d\'inici del lloc web a les llistes de cursos.';
$string['configfrontpageloggedin'] = 'Els elements seleccionats anteriorment es mostraran a la pàgina d\'inici del lloc quan un usuari iniciï la sessió.';
...
$string['configgradeexportdefault'] = 'Trieu quin format d\'exportació del llibre de qualificacions és el vostre mètode predeterminat per exportar les qualificacions.';
...
$string['configintrosite'] = 'Aquesta pàgina us permet configurar la pàgina d\'inici i el nom d\'aquest lloc nou. Podeu tornar aquí més tard per canviar aquests paràmetres en qualsevol moment mitjançant els menús d\'administració.';
...
$string['confignavshowcategories'] = 'Mostra les categories dels cursos a la barra de navegació i als blocs de navegació. Això no passa amb els cursos en què l\'usuari està inscrit actualment; continuaran apareixent a «Els meus cursos» sense categories.';
...
$string['configprofileroles'] = 'Rols que apareixen als perfils d\'usuari i a la pàgina de participants.';
...
$string['configproxybypass'] = 'Llista de noms d\'amfitrió (parcials) o adreces IP que haurien d\'ometre el servidor intermediari. Separeu els elements amb una coma i sense espais, per exemple 192.168.0.0/16, *.elmeudomini.com.';
...
$string['configrecaptchapublickey'] = 'Cadena de caràcters (clau del lloc) que s\'utilitza per mostrar l\'element reCAPTCHA al formulari de registre i al formulari de suport del lloc. Les claus ReCAPTCHA es poden obtenir de <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configservicespage'] = 'Introduïu l\'URL d\'una pàgina de serveis i suport o deixeu-ho en blanc per enllaçar amb els serveis de Moodle a moodle.com. L\'enllaç només es mostra als administradors del lloc.';
...
$string['configsmtpauthtype'] = 'Això estableix el tipus d\'autenticació que s\'utilitzarà al servidor SMTP.';
...
$string['configsupportemail'] = 'Si l\'SMTP està configurat en aquest lloc i no hi ha una pàgina de suport definida, aquesta adreça electrònica rebrà els missatges enviats a través del formulari de suport. Si l\'enviament falla, l\'adreça electrònica es mostrarà als usuaris que hagin iniciat la sessió.';
$string['configsupportname'] = 'El nom de la persona o altra entitat que proporciona suport a través del formulari de suport o la pàgina de suport.';
$string['configsupportpage'] = 'Introduïu l\'URL d\'una pàgina d\'assistència o deixeu-ho en blanc per enllaçar a un formulari de contacte. L\'enllaç es mostra al peu de pàgina del lloc web.';
...
$string['configusesitenameforsitepages'] = 'Si està habilitat, s\'utilitzarà el nom curt del lloc per al node de pàgines del lloc a la navegació en lloc de la cadena «Pàgines del lloc».';
...
$string['coursecolorheading_desc'] = 'Els cursos que no tinguin una imatge definida als paràmetres del curs es mostren a la pàgina «Els meus cursos» amb una targeta de curs amb un patró. Els colors utilitzats al patró es poden especificar a continuació.';
...
$string['coursecreationguide'] = 'URL de guia de creació de cursos de Moodle';
$string['coursecreationguide_help'] = 'Defineix el camí a una guia Quickstart amb vídeos curts i consells generals per a crear cursos. A la pàgina Els meus cursos es mostra un enllaç a la guia quan no hi ha cursos per mostrar. Només els usuaris amb capacitat per crear cursos veuran l\'enllaç.';
...
$string['cron_keepalive'] = 'Mantén viu';
$string['cron_keepalive_desc'] = 'El temps per a continuar la votació de tasques addicionals. Aquesta opció de configuració és per assegurar que el cron sempre s\'està executant. Si utilitzeu corredors de tasques dedicats, establiu-lo a 0. En cas contrari, establiu-lo a un valor similar al límit de concurrència de la tasca adhoc. Eviteu temps més llargs. El temps màxim és de 15 minuts.';
...
$string['debugtemplateinfo'] = 'Mostra la informació de la plantilla';
$string['debugtemplateinfo_desc'] = 'Si està activat, les plantilles utilitzades per al renderitzat es mostren com a comentaris a l\'HTML de la pàgina. Després de canviar el paràmetre, cal purgar les memòries cau. Utilitzeu-ho només per a la depuració temporal, perquè produeix errors de validació HTML i pot trencar els scripts de la pàgina. També pot trencar la funcionalitat bàsica!';
...
$string['deleteduserx'] = 'S\'ha eliminat l\'usuari {$a}';
...
$string['disableplugin'] = 'Desactiva {$a}';
...
$string['enablecommunicationsubsystem'] = 'Habilita els proveïdors de comunicació';
$string['enablecommunicationsubsystem_desc'] = 'Permet la integració amb proveïdors de comunicació com Matrix perquè professors i estudiants puguin comunicar-se més fàcilment. Podeu gestionar aquestes integracions a <a href="settings.php?section=managecommunicationproviders">Connectors</a>.';
...
$string['enablepdfexportfont'] = 'Activa els tipus de lletra PDF';
$string['enablepdfexportfont_desc'] = 'Si el vostre lloc té cursos en diferents idiomes que necessiten altres tipus de lletra en els fitxers PDF generats, podeu proporcionar l\'opció d\'establir el tipus de lletra a la configuració del curs. Heu d\'especificar els tipus de lletra disponibles a $CFG->pdfexportfont a config.php.';
$string['enableplugin'] = 'Activa {$a}';
...
$string['enablesharingtomoodlenet'] = 'Activa la compartició a MoodleNet (outbound)';
$string['enablesharingtomoodlenet_desc'] = 'Permet als usuaris compartir el contingut del curs a una instància configurada de MoodleNet si tenen la capacitat pertinent.';
...
$string['eventshandlersinuse'] = 'Els següents complements del vostre sistema utilitzen controladors obsolets de l\'API Events 1: «{$a}». Si us plau, actualitzeu-los per utilitzar l\'API Events 2. Vegeu https://docs.moodle.org/dev/Events_API#Event_dispatching_and_observers.';
...
$string['frontpage'] = 'Pàgina d\'inici del lloc';
$string['frontpagebackup'] = 'Còpia de seguretat de la pàgina d\'inici del lloc';
$string['frontpagedefaultrole'] = 'Rol per defecte de la pàgina d\'inici del lloc';
$string['frontpagefilters'] = 'Filtres de la pàgina d\'inici';
$string['frontpageloggedin'] = 'Elements de la pàgina d\'inici si l\'usuari ha iniciat la sessió';
$string['frontpageoverrides'] = 'Sobreescriptura de permisos de la pàgina d\'inici del lloc';
$string['frontpagequestions'] = 'Preguntes de la pàgina d\'inici';
$string['frontpagerestore'] = 'Restauració de la pàgina d\'inici';
$string['frontpageroles'] = 'Rols de la pàgina d\'inici';
$string['frontpagesettings'] = 'Paràmetres de la pàgina d\'inici';
...
$string['grouping_customfield'] = 'Camps personalitzats d\'agrupaments';
...
$string['hookcallbacknotcallable'] = 'Aquesta crida de retorn no és cridable. Això podria ser perquè la classe o el mètode no existeix, o perquè el mètode no és públic.';
$string['hookcallbacks'] = 'Crides de retorn';
$string['hookcallbacks_help'] = 'La llista de trucades que es cridaran quan s\'enviï el ganxo.

L\'ordre mostrat és l\'ordre en què es criden les trucades de retorn.

Es cridarà una crida de retorn amb una prioritat més alta abans d\'una amb prioritat més baixa.';
$string['hookclassmissing'] = 'No s\'ha trobat la classe Hook';
$string['hookclassmissing_desc'] = 'L\'agent de descobriment de ganxos ha retornat una classe que no existeix.';
$string['hookconfigoverride'] = 'Sobreescrit';
$string['hookconfigoverride_help'] = 'La definició d\'aquesta crida de retorn s\'ha anul·lat al fitxer de configuració del lloc, config.php';
$string['hookdeprecates'] = 'Crides de retorn obsoletes';
$string['hookdescription'] = 'Descripció';
$string['hookdescriptionmissing'] = 'El Hook no té un mètode de descripció';
$string['hookname'] = 'Hook';
$string['hooksoverview'] = 'Resum dels Hooks';
$string['hookunknown'] = 'Hook no trobat';
$string['hookunknown_desc'] = 'L\'objecte que escolta aquesta crida de retorn no està disponible. Pot ser que s\'hagi eliminat o reanomenat, o pot ser que no estigui disponible en aquesta versió de Moodle.';
...
$string['installsessionerror'] = 'No es pot inicialitzar la sessió PHP. Si us plau, verifiqueu que el vostre navegador accepti galetes.';
...
$string['logo'] = 'Logotip';
$string['logo_desc'] = 'Un logotip complet per utilitzar com a decoració per alguns temes (com ara els temes del nucli). Aquesta imatge pot tenir una resolució força alta perquè es reduirà per al seu ús (i es desarà a la memòria cau per al rendiment). Els logotips que són més amples que alts solen donar millors resultats.';
$string['logocompact'] = 'Logotip compacte';
$string['logocompact_desc'] = 'Una versió compacta del mateix logotip que abans, com ara un emblema, un escut o una icona. La imatge ha de ser nítida fins i tot en mides petites.';
...
$string['maxcharacter'] = '{$a} caràcters com a màxim';
...
$string['navshowfrontpagemods'] = 'Mostra les activitats de la pàgina d\'inici a la navegació';
$string['navshowfrontpagemods_help'] = 'Si està habilitat, les activitats de la pàgina d\'inici es mostraran a la navegació a les pàgines del lloc. Aquest paràmetre només s\'aplica als temes basats en el Classic.';
...
$string['navshowmycoursecategories_help'] = 'Si està habilitat, els cursos de la branca «Els meus cursos» de l\'usuari es mostraran en categories al bloc de navegació (només temes basats en el Classic).';
...
$string['navsortmycoursessort'] = 'Ordre dels cursos al bloc de navegació';
$string['navsortmycoursessort_help'] = 'Els cursos s\'han de llistar segons l\'ordre de classificació establert a Administració del lloc > Cursos > Gestiona cursos i categories o alfabèticament per configuració del curs? Aquest paràmetre només s\'aplica als temes basats en el Classic.';
$string['never'] = 'Mai';
...
$string['noemaileverwarning'] = '<strong>Nota:</strong> s\'han desactivat tots els correus electrònics de sortida';
...
$string['oracledatabaseinuse'] = 'El suport per a Oracle s\'acaba. El Moodle 4.5 serà l\'última versió amb suport Oracle DB. Per obtenir més informació, consulteu l\'anunci a moodle.org <a href="https://moodle.org/mod/forum/discuss.php?d=456122">Suport per a bases de dades Oracle declarat obsolet</a>.';
...
$string['perfdebugdeferred'] = 'S\'està esperant fins que acabi l\'script per mostrar la depuració del rendiment...';
$string['performance'] = 'Execució';
$string['pgcluster'] = 'Grup PostgreSQL';
$string['pgclusterdescription'] = 'Paràmetre de grup/versió PostgreSQL per a operacions de línia de comandament. Si només teniu un postgresql en el vostre sistema o no esteu segur de què significa això, deixeu el paràmetre en blanc.';
...
$string['plugin_disabled'] = '{$a} desactivat.';
...
$string['profilecreatefield'] = 'Crea un camp de perfil nou';
...
$string['profilefieldlink_help'] = 'Per transformar el text en un enllaç, introduïu un URL que contingui $$, on $$ se substituirà pel text. Per exemple, per transformar un ID de Twitter en un enllaç, introduïu https://twitter.com/$$.';
$string['profilefieldlinktarget'] = 'Objectiu de l\'enllaç';
$string['profilefieldmaxlength'] = 'Límit de caràcters';
...
$string['profilevisible_help'] = '* No visible: per a dades privades només visibles per administradors i gestors.
* Visible per a l\'usuari: per a dades privades només visibles per l\'usuari i els administradors.
* Visible per a l\'usuari, els professors i els administradors: per a dades privades només visibles per l\'usuari, els administradors i els professors (al perfil del curs).
...
$string['profilingexcluded_help'] = 'Llista d\'URL (separats per comes, excloent wwwroot, accessibles) que seran exclosos de l\'anàlisi de rendiment definit pel paràmetre «Anàlisi de rendiment de».';
...
$string['profilingincluded_help'] = 'Llista d\'URL (separats per comes, excloent wwwroot, accessibles) que seran inclosos de forma automàtica en l\'anàlisi de rendiment. Exemples: /index.php, /course/view.php. També accepta el caràcter asterisc en qualsevol posició. Exemples: /mod/forum/*, /mod/*/view.php.';
...
$string['purgecachesconfirm'] = 'El Moodle pot emmagatzemar a la memòria cau temes, JavaScript, cadenes d\'idioma, text filtrat, canals RSS i altres dades calculades. Purgar les memòries cau eliminarà les dades del servidor i obligarà els navegadors a tornar a obtenir les dades, de manera que podeu estar segur que esteu veient els valors més actualitzats produïts pel codi actual. No hi ha cap perill en purgar les memòries cau, però el vostre lloc pot carregar més lent durant un temps fins que el servidor i els clients calculin la nova informació i l\'emmagatzemin a la memòria cau.';
...
$string['questioncwqpfscheck'] = 'Una o més preguntes «aleatòries» d\'algun qüestionari s\'han definit per seleccionar preguntes d\'una barreja de categories compartides i no compartides. Vegeu <a href="{$a->reporturl}">l\'informe de preguntes aleatòries</a> i la <a href="{$a->docsurl}">documentació</a>.';
...
$string['registration_help'] = 'En estar registrat:
...
$string['requiredentrieschanged'] = 'Nota: Després de l\'actualització, el paràmetre «Entrades requerides abans de veure els paràmetres» ara s\'aplica a les activitats de la base de dades següents:<br/>{$a->text}<br/>';
...
$string['resetindentation'] = 'Reinicia el sagnat a tot el lloc';
$string['resetindentation_help'] = 'Això eliminarà qualsevol sagnat prèviament establert per a tots els cursos del lloc en {$a->theformat}.';
$string['resetindentation_title'] = 'Voleu restablir el sagnat a tot el lloc?';
$string['resetindentationsuccess'] = 'S\'ha reiniciat el sagnat.';
...
$string['servicespage'] = 'Enllaç de serveis i suport';
...
$string['sessioncookie'] = 'Sufix de la galeta';
...
$string['settingzendexceptionignoreargs'] = 'Es recomana fermament habilitar la configuració del PHP zend.exception_ignore_args com a mesura de seguretat.';
...
$string['showuseridentity_desc'] = 'Quan seleccioneu o cerqueu usuaris i quan mostreu llistes d\'usuaris, aquests camps es poden mostrar a més del seu nom complet. Els camps només es mostren als usuaris que tenen la capacitat moodle/site:viewuseridentity; per defecte, professors i gestors. (Aquesta opció té més sentit si trieu un o dos camps que són obligatoris a la vostra institució).

Els camps marcats amb un * són camps de perfil d\'usuari personalitzats. Podeu seleccionar aquests camps, però actualment hi ha algunes pantalles en què no apareixeran.';
...
$string['sitesectionhelp'] = 'Mostra una secció a la part superior de la pàgina on afegir contingut personalitzat.';
...
$string['smallscreensonly'] = 'Només pantalles petites';
$string['smtp'] = 'SMTP';
...
$string['task_adhoc_failed_retention'] = 'El període de retenció de tasques ad hoc ha fallat';
$string['task_adhoc_failed_retention_desc'] = 'El període màxim que les tasques ad hoc fallides haurien de romandre a la cua un cop hagin arribat al seu límit de reintents.';
...
$string['taskautomatedbackup_report'] = 'Informe de còpies de seguretat automatitzades';
$string['taskbackupcleanup'] = 'Neteja les taules, els registres i els fitxers de còpia de seguretat';
$string['taskbadgesadhoc'] = 'Insígnia de premi';
$string['taskbadgescron'] = 'Afegeix tasques adhoc de concessió d\'insígnies';
...
$string['themedefinedinconfigphp'] = 'El tema no es pot canviar perquè està configurat en {$a} a config.php.';
...
$string['themeeditsettingsname'] = 'Edita la configuració del tema "{$a}"';
...
$string['themeselector'] = 'Temes';
$string['themesettings'] = 'Paràmetres de tema';
$string['themesettingsadvanced'] = 'Configuració avançada del tema';
$string['themesettingscustom'] = 'Configuració del tema personalitzat';
$string['themesettingsname'] = 'Configuració del tema \'{$a}\'';
$string['themeusagereportname'] = 'Informe d\'ús del tema \'{$a}\'';
...
$string['unsupportedphpversion84'] = 'La versió 8.4 i superiors del PHP no són compatibles.';
...
$string['updatenotificationfooter'] = 'El vostre lloc Moodle {$a->siteurl} està configurat per comprovar automàticament si hi ha actualitzacions disponibles. Esteu rebent aquest missatge com a administrador del lloc. Podeu desactivar les comprovacions automàtiques de les actualitzacions disponibles a Administració del lloc / Servidor / Notificacions d\'actualització o personalitzar el lliurament d\'aquest missatge a través de la vostra pàgina de preferències.';
...
$string['upgradeerror'] = 'S\'ha produït un error desconegut en actualitzar {$a->plugin} a la versió {$a->version}. No es pot continuar.';
...
$string['upgradesettingsintro'] = 'Els paràmetres que es mostren a continuació es van afegir durant la vostra darrera actualització del Moodle. Feu els canvis necessaris als valors predeterminats i feu clic al botó «Desa els canvis» a la part inferior d\'aquesta pàgina.';
...
$string['userfeedbackencouragement'] = '<p>El Moodle inclou una funció que ofereix als usuaris l\'opció de proporcionar comentaris sobre el programari Moodle a través d\'un lloc web d\'enquestes extern allotjat per Moodle HQ. No s\'envia cap informació que identifiqui l\'usuari al lloc web d\'enquestes.</p>
<p>Moodle HQ s\'esforça per ser obert i transparent sobre les seves pràctiques de recopilació de dades. Per tant, volem assegurar-nos que coneixeu i controleu aquesta funcionalitat.</p>
<p>Els comentaris dels usuaris ajuden Moodle HQ a millorar el programari Moodle. Per habilitar aquesta funció, aneu a <a href="{$a}">Configuració de comentaris</a>.</p>';
...
$string['userfiltersdefault_desc'] = 'Seleccioneu els filtres que s\'han de mostrar a la pàgina «Accions de l\'usuari en bloc». Per seleccionar diversos elements, manteniu premuda la tecla CTRL. Els filtres no seleccionats seguiran disponibles fent clic a l\'enllaç «Mostra\'n més».';
