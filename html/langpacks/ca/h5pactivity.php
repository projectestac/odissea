...
/**
 * Strings for component 'h5pactivity', language 'ca', version '4.5'.
 *
 * @package     h5pactivity
 * @category    string
...
$string['attempts_none'] = 'Aquest usuari no té cap intent per mostrar.';
$string['attempts_report'] = 'Informe d\'intents';
...
$string['previewmode'] = 'Esteu en mode de previsualització.';
...
$string['review_user_attempts'] = 'Mostra ({$a})';
