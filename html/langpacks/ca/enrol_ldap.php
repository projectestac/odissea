...
/**
 * Strings for component 'enrol_ldap', language 'ca', version '4.4'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['enroluserenable'] = 'S\'ha habilitat la inscripció per a l\'usuari «{$a->user_username}» al curs «{$a->course_shortname}» (id {$a->course_id})';
...
$string['ok'] = 'D\'acord!';
$string['opt_deref'] = 'Si els membres del grup contenen noms distintius, especifiqueu com s’utilitzen els àlies durant una cerca. Seleccioneu un dels valors següents: «No» (LDAP_DEREF_NEVER) o «Sí» (LDAP_DEREF_ALWAYS).';
