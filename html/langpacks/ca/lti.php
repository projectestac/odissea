...
$string['automatic'] = 'Automàtic, basat en el llançament d\'URL';
...
$string['basiclti_in_new_window_open'] = 'Obre en una nova finestra';
...
$string['clientidadmin'] = 'ID de client';
...
$string['contentselected'] = 'Contingut seleccionat';
$string['course_tool_types'] = 'Eines del curs';
$string['courseactivitiesorresources'] = 'Activitats del curs o recursos';
$string['courseexternaltooladdsuccess'] = 'S\'ha afegit {$a}.';
$string['courseexternaltooledit'] = 'Edita {$a}';
$string['courseexternaltooleditsuccess'] = 'Canvis desats.';
$string['courseexternaltooliconalt'] = 'Icona per a {$a}';
...
$string['coursetooldeleted'] = 'S\'ha esborrat {$a}';
...
$string['deletecoursetool'] = 'Esborra {$a}';
...
$string['lti:addpreconfiguredinstance'] = 'Afegeix una eina preconfigurada';
...
* **Rebutjada** —Aquests proveïdors d\'eines han estat marcats com aquells que un administrador no té intenció de posar a la disposició de tota la instància de Moodle.
Amb tot, els professors poden emprar eines d\'aquests proveïdors si tenen una clau de consumidor i una contrasenya secreta compartida, o si no en cal cap.';
...
$string['organizationid_default'] = 'ID per defecte de l\'organització';
$string['organizationidguid'] = 'ID de l\'organització';
...
Per exemple, un URL base de *tool.com* hauria de concordar amb els següents:
...
Un URL base de *www.tool.com/quizzes* hauria de concordar amb els següents:

* www.tool.com/quizzes
* tool.com/quizzes
* tool.com/quizzes/take.php?id=10

Un URL base de *quiz.tool.com* hauria de concordar amb els següents:
...
També podeu inserir un URL de cartutx (<em>cartridge</em>), si en teniu un, i els detalls per a l\'eina s\'emplenaran de manera automàtica.';
