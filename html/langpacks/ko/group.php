...
/**
 * Strings for component 'group', language 'ko', version '4.5'.
 *
 * @package     group
 * @category    string
...
$string['eventgroupinggroupassigned'] = '그룹이 그룹 만들기에 할당됨';
$string['eventgroupinggroupunassigned'] = '그룹이 그룹 만들기에 할당되지 않음';
...
$string['notingroup'] = '그룹에 있는 사용자 제외하기';
$string['notingrouping'] = '[모둠무리속에 없음]';
$string['notingrouplist'] = '그룹에 없음';
...
$string['privacy:metadata:core_message'] = '그룹 대화';
$string['privacy:metadata:groups'] = '그룹 멤버십 레코드';
$string['privacy:metadata:groups:userid'] = '사용자 아이디는 그룹과 연관이 있습니다.';
$string['random'] = '무작위로';
