...
/**
 * Strings for component 'completion', language 'ko', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['activitiescompleted'] = '활동 완료';
...
$string['coursesavailableexplaination'] = '노트: 강좌가 위 목록에 나타나려면 강좌 완료 조건이 설정되어야 합니다.';
$string['criteria'] = '기준';
