...
/**
 * Strings for component 'editor_tinymce', language 'ko', version '3.11'.
 *
...
$string['advanced:blockquote'] = '블록 인용';
$string['advanced:blockquote_desc'] = '블록 인용';
$string['advanced:bold_desc'] = '굵은 글씨(Ctrl+B)';
$string['advanced:bullist_desc'] = '기호 목록 삽입 / 제거';
$string['advanced:charmap_desc'] = '특수 문자 삽입';
$string['advanced:cleanup_desc'] = '지저분한 코드 삭제';
$string['advanced:clipboard_msg'] = '복사/잘라내기/붙이기는 Mozilla 및Firefox 에서 사용되지 않습니다. 이 문제에 대한 추가 정보를 원하십니까?';
$string['advanced:code'] = '코드';
$string['advanced:code_desc'] = 'HTML 소스 편집';
...
$string['advanced:hr_desc'] = '수평선 삽입';
...
$string['advanced:toolbar_focus'] = '도구 버튼으로 가기 - Alt+Q, 에디터로 가기 - Alt-Z, 요소 경로로 가기 - Alt-X';
$string['advanced:underline_desc'] = '밑줄(Ctrl+U)';
$string['advanced:undo_desc'] = '실행취소(Ctrl+Z)';
$string['advanced:unlink_desc'] = '링크 삭제';
$string['advanced:visualaid_desc'] = '가이드라인 및 보이지 않는 요소 표시/숨기기';
...
$string['advanced_dlg:charmap_title'] = '특수 문자 선택';
$string['advanced_dlg:charmap_usage'] = '찾아가기 위해 왼쪽 및 오른쪽 화살표를 사용하세요.';
$string['advanced_dlg:code_title'] = 'HTML 소스 편집기';
...
$string['advanced_dlg:link_is_email'] = '입력한 URL이 메일주소인 것 같습니다. 앞에 mailto: 를 추가할까요?';
$string['advanced_dlg:link_is_external'] = '입력한 URL이 외부링크인 것 같습니다. 앞에 http://를 추가할까요?';
...
$string['advhr:advhr_desc'] = '수평선 삽입';
...
$string['advimage_dlg:tab_appearance'] = '모습';
...
$string['advlink_dlg:is_email'] = '입력한 URL이 메일주소인 것 같습니다. 앞에 mailto: 를 추가할까요?';
$string['advlink_dlg:is_external'] = '입력한 URL이 외부링크인 것 같습니다. 앞에 http://를 추가할까요?';
...
$string['advlink_dlg:target_parent'] = '부모창/프레임에서 열기';
$string['advlink_dlg:target_same'] = '이 창/프레임에서 열기';
...
$string['autosave:restore_content'] = '자동 저장된 내용 복원';
...
$string['common:more_colors'] = '더 많은 색...';
...
$string['fullpage_dlg:appearance_tab'] = '모습';
...
$string['fullscreen:desc'] = '전체화면 전환';
...
$string['media:desc'] = '임베디드 미디어 삽입/편집';
...
$string['media_dlg:autohref'] = '자동 HREF';
...
$string['media_dlg:captioningid'] = '캡션 ID';
...
$string['media_dlg:fullscreen'] = '전체 화면';
...
$string['media_dlg:nojava'] = '자바가 설치되어 있지 않습니다';
...
$string['media_dlg:rmp_options'] = '리얼미디어 플레이어 옵션';
...
$string['media_dlg:swstretchstyle'] = '스트레치 스타일';
$string['media_dlg:swstretchvalign'] = 'Stretch V-Align';
$string['media_dlg:target'] = 'Target';
$string['media_dlg:targetcache'] = '타겟 캐시';
$string['media_dlg:title'] = '엠베디드 미디어 삽입/편집';
$string['media_dlg:type'] = '타입';
$string['media_dlg:uimode'] = 'UI 모드';
...
$string['media_dlg:wmp_options'] = '윈도우 미디어 플레이어 옵션';
$string['nonbreaking:nonbreaking_desc'] = '빈칸 삽입';
$string['pagebreak:desc'] = '인쇄를 위해 페이지 나누기 삽입';
$string['paste:paste_text_desc'] = '텍스트로 붙여넣기';
...
$string['paste_dlg:text_title'] = '윈도우에 텍스트를 붙여 넣으려면 키보드로 Ctrl+V를 입력해 주세요.';
$string['paste_dlg:word_title'] = '윈도우에 텍스트를 붙여 넣으려면 키보드로Ctrl+V를 입력해 주세요.';
...
$string['searchreplace:replace_desc'] = '찾기/바꾸기';
...
$string['searchreplace_dlg:replace_title'] = '찾기/바꾸기';
...
$string['simple:bullist_desc'] = '글 머리 기호 목록 삽입/제거';
$string['simple:cleanup_desc'] = '지저분한 코드 삭제';
$string['simple:italic_desc'] = '이탤릭(Ctrl+I)';
$string['simple:numlist_desc'] = '번호있는 목록 삽입/ 제거';
...
$string['spellchecker:desc'] = '맞춤법 검사 전환';
...
$string['style_dlg:text_blink'] = '깜박이기';
...
$string['style_dlg:title'] = 'CSS 스타일 편집';
...
$string['table:delete_col_desc'] = '열 삭제';
$string['table:delete_row_desc'] = '행 삭제';
$string['table:desc'] = '테이블 삽입/편집';
...
$string['table_dlg:cellpadding'] = '셀 패딩';
$string['table_dlg:cellspacing'] = '셀 간격';
$string['table_dlg:col_limit'] = '렬수의 상한{$cols}를 넘었습니다.';
$string['table_dlg:colgroup'] = '열 그룹';
$string['table_dlg:cols'] = '열';
...
$string['table_dlg:rowgroup'] = '행 그룹';
$string['table_dlg:rows'] = '행';
$string['table_dlg:rowtype'] = '행 유형';
...
$string['table_dlg:tfoot'] = '푸터';
$string['table_dlg:th'] = 'Header';
$string['table_dlg:thead'] = '헤더';
$string['table_dlg:title'] = '테이블 삽입/편집';
...
$string['visualchars:desc'] = '볼 수 있는 제어 문자의 표시/감추기';
...
$string['xhtmlxtras_dlg:attribs_title'] = '속성 삽입/편집';
...
$string['xhtmlxtras_dlg:attribute_label_langdir'] = '텍스트 방향';
...
$string['xhtmlxtras_dlg:fieldset_attrib_tab'] = '요소 속성';
$string['xhtmlxtras_dlg:fieldset_events_tab'] = '요소 이벤트';
...
$string['xhtmlxtras_dlg:title_abbr_element'] = '약어 요소';
$string['xhtmlxtras_dlg:title_acronym_element'] = '약어 요소';
$string['xhtmlxtras_dlg:title_cite_element'] = '인용 요소';
$string['xhtmlxtras_dlg:title_del_element'] = '요소 삭제';
$string['xhtmlxtras_dlg:title_ins_element'] = '요소 삽입';
