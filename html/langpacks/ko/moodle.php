...
$string['actions'] = '동작들';
$string['actionsfor'] = '{$a} 활동';
$string['actionsmenu'] = '활동 차림표';
$string['active'] = '활성';
...
$string['additionalcustomnav'] = '추가 맞춤 탐색';
$string['additionalnames'] = '추가 이름';
$string['addlinkhere'] = '여기에 링크 추가';
$string['addnew'] = '새로운 {$a} 추가하기';
...
$string['courseoverviewfiles_help'] = '강의 현황에는 강의 이미지로 나타납니다.
이미지 파일 이외의 파일, 파일 개수는 관리자에 의해 설정이 가능합니다. 등록된 파일들은 강의 페이지의 강의 요약에 나타납니다.';
...
$string['courserequestsuccess'] = '강좌 개설 요청이 성공적으로 저장되었습니다. 며칠 안에 결과가 이메일로 통지될 것입니다.';
...
$string['coursevisibility_help'] = '이 설정은 강좌의 목록 표시 여부와 학생들의 접근 가능 여부를 결정합니다. 숨김 설정을 할 경우 숨겨진 강좌에 접근할 수 있는 사용자(교사 등)에게만 접근이 허용됩니다.';
...
$string['defaulthomepageuser'] = '홈 페이지';
$string['defaulthomepageuser_help'] = '네비게이션의 첫 번째 링크가 당신의 홈 페이지 입니다.';
$string['delete'] = '삭제';
...
$string['enddate_help'] = '강의 종료 날짜는 사용자의 강의 리스트에 해당 강의 포함 여부를 판단하는 데 사용됩니다. 종료 날짜가 과거라면 강의는 더이상 네비게이션이 아닌 강의 개요에 지난 강의로 올라갑니다. 강의 종료 날짜는 맞춤 보고서에 사용될 수 있습니다. 사용자는 종료 날짜 이후에도 강의에 입장할 수 있습니다. 다시 말해서 날짜로 접근을 제한하지 않습니다.';
$string['english'] = '영어';
...
$string['eventcoursemoduleviewed'] = '감좌 모듈 봄';
...
$string['eventcoursesectiondeleted'] = '강의 부문이 삭제됨';
...
$string['frontpagedescription'] = '시작 페이지 요약';
$string['frontpagedescriptionhelp'] = '시작 페이지의 강좌/사이트 요약 블록에 이 요약이 표시됩니다.';
...
$string['usernameemail'] = '사용자이름/이메일';
