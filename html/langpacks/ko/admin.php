...
$string['accountlocked'] = '계정이 잠겨 있습니다. 잠금 해제 링크를 이메일로 전송하였습니다.';
$string['accounts'] = '계정';
...
$string['additionalhtmltopofbody_desc'] = '여기에 있는 내용은 모든 페이지의 시작 body 태그 뒷 부분 에 즉시 포함될 것입니다.';
...
$string['allowedemaildomains'] = '이메일 도메인 허용';
...
$string['cachetemplates'] = '템플릿 캐싱';
$string['cachetemplates_help'] = '템플릿 캐싱은 페이지 로딩 속도를 향상시킵니다. 서비스 중인 사이트에는 적극 추천합니다. 개발자들의 경우 이 옵션을 끄는 것이 나을 겁니다.';
$string['caching'] = '캐싱';
$string['calendar_weekend'] = '주말';
$string['calendarexportsalt'] = '달력 내보내기 암호화';
$string['calendarsettings'] = '달력 및 일정';
$string['calendartype'] = '달력 유형';
$string['calendartype_desc'] = '전체 사이트에 대한 기본 달력을 선택합니다. 강의 설정이나 사용자 프로필에서 자유롭게 설정할 수 있습니다.';
...
$string['cliexitgraceful'] = '안전하게 종료하기, 잠시만 기다려 주세요...';
$string['cliexitnow'] = '즉시 종료하기';
...
$string['configtempdatafoldercleanup'] = '선택된 시간보다 오래된 데이터 폴더의 데이터 파일을 삭제합니다.';
...
$string['coursecolorheading_desc'] = '강의 이미지가 설정 되어 있지 않은 강의는 패턴 이미지로 나타납니다. 이미지에 사용되는 패턴은 아래와 같이 지정할 수 있습니다.';
...
$string['curlsecurityallowedport'] = 'cURL 허용 포트 목록';
$string['curlsecurityblockedhosts'] = 'cURL 차단 된 호스트 목록';
$string['curlsecurityurlblocked'] = 'URL이 차단되었습니다.';
...
$string['customusermenuitems'] = '사용자 메뉴 아이템';
...
$string['enablecalendarexport'] = '달력 및 일정 내보내기 활성화';
...
$string['enableuserfeedback_desc'] = '활성화 되면, \'이 소프트웨어에 대한 피드백 제출\' 링크가 아래에 나타납니다. \'피드백 제출을 다음으로 미룸\' 옵션이 설정되면, 일정 기간 후 사용자에게 다시 나타납니다. \'피드백 제출을 하지 않음\' 을 \'원하지 않음\' 으로 설정하면 피드백 제출이 강의 현황에 나타나지 않고, \'이 소프트웨어에 대한 피드백 제출\' 링크가 아래에만 나타납니다.';
...
$string['fileconversioncleanuptask'] = '파일 변환 임시 기록 전체 삭제';
$string['filecreated'] = '새 파일 생성됨';
$string['filescleanupperiod'] = '트래쉬풀 파일 전체 삭제';
...
$string['ishttpswarning'] = '사이트가 HTTPS로 보호되지 않는 것을 감지했습니다. 보안을 강화하고 다른 시스템과의 통합을 위해 사이트를 HTTPS로 마이그레이션하는 것을 강력하게 권합니다.';
...
$string['langmenuinsecurelayout'] = '보안 레이아웃에서 언어 메뉴 표시하기';
...
$string['logo'] = '로고';
$string['logstorenotrequired'] = '로그 저장소가 필요하지 않습니다.';
$string['logstoressupported'] = '이 보고서를 지원하는 로그 저장소';
...
$string['messagingallusers'] = '사이트 전체 메세지 허용';
$string['messagingcategory'] = '메세지 발송';
$string['messagingdeleteallnotificationsdelay'] = '모든 알림 삭제';
...
$string['opentowebcrawlers'] = 'Google에 개방';
$string['optionalmaintenancemessage'] = '선택적인 유지 보수 메세지';
$string['order1'] = '첫번째';
$string['order2'] = '두번째';
$string['order3'] = '세번째';
$string['order4'] = '네번째';
$string['passwordchangelogout'] = '비밀번호 변경 후 로그아웃';
$string['passwordchangetokendeletion'] = '비밀번호 변경 후 웹 서비스 접속 토큰 제거';
...
$string['pathtopython'] = '파이썬 경로';
$string['pathtosassc'] = 'SassC 경로';
...
$string['search'] = '검색';
$string['searchablecourses'] = '검색 가능한 강좌';
$string['searchallavailablecourses'] = '검색 가능한 강좌';
$string['searchallavailablecourses_off'] = '수강신청한 강의만 검색하기';
$string['searchallavailablecourses_on'] = '사용자가 접근할 수 있는 모든 강좌 검색';
$string['searchalldeleted'] = '모든 색인된 내용들이 삭제되었습니다.';
$string['searchdeleteindex'] = '모든 색인된 내용들을 삭제';
$string['searchindexupdated'] = '검색 엔진의 내용이 갱신되었습니다';
$string['searchinsettings'] = '설정 검색';
$string['searchoptions'] = '검색 옵션';
$string['searchreindexed'] = '모든 사이트의 색인이 재생성 되었습니다';
$string['searchreindexindex'] = '모든 사이트의 색인 재생성';
$string['searchresults'] = '검색 결과';
$string['searchupdateindex'] = '색인된 내용을 갱신';
$string['sectionerror'] = '섹션 오류!';
$string['secureforms'] = '추가적인 보안 형식 사용';
$string['security'] = '보안';
$string['selectdevice'] = '기기 선택';
$string['selectsearchengine'] = '검색 엔진 선택';
...
$string['task_dbstats'] = '데이타 베이스';
$string['task_duration'] = '기간';
$string['task_result'] = '결과';
$string['task_result:failed'] = '실패';
$string['task_starttime'] = '시작 시간';
$string['task_stats:dbreads'] = '{$a} 읽기';
$string['task_stats:dbwrites'] = '{$a} 쓰기';
$string['taskcalendarcron'] = '일정 전송';
$string['testoutgoingmailconf_sendtest'] = '테스트 메세지 전송하기';
$string['testoutgoingmailconf_subject'] = '{$a}: 테스트 메세지';
$string['testoutgoingmailconf_toemail'] = '이메일 주소로 전송하기';
...
$string['thirdpartylibrary'] = '라이브러리';
$string['thirdpartylibrarylocation'] = '장소';
...
$string['unsupportedphpversion7'] = 'PHP 7 버전은 지원되지 않습니다.';
$string['unsupportedphpversion71'] = 'PHP 7.1 버전은 지원되지 않습니다.';
$string['unsupportedphpversion72'] = 'PHP 7.2 버전은 지원되지 않습니다.';
$string['unsupportedphpversion73'] = 'PHP 7.3 버전은 지원되지 않습니다.';
$string['unsupportedphpversion74'] = 'PHP 7.4 버전은 지원되지 않습니다.';
$string['unsupportedphpversion80'] = 'PHP 8.0 버전은 지원되지 않습니다.';
...
<br /><br />판올림 과정을 시작할까요?';
$string['upgradekeyreq'] = '업그레이드 키가 필요합니다';
