...
/**
 * Strings for component 'assign', language 'ko', version '4.5'.
 *
 * @package     assign
 * @category    string
...
$string['enabled'] = '활성화됨';
$string['enabletimelimit'] = '제출 기한이 있는 과제 활성화';
$string['enabletimelimit_help'] = '활성화하면 과제 설정 페이지에서 제출 기한을 설정할 수 있습니다.';
...
$string['errorrecordmodified'] = '지금 보고 있는 페이지가 열린 이후에 다른 사용자에 의해 변경된 요소가 있어 성적이 저장되지 않습니다.';
$string['eventallsubmissionsdownloaded'] = '모든 제출물을 다운로드 했습니다.';
$string['eventassessablesubmitted'] = '제출된 제출물이 있습니다.';
$string['expandreviewpanel'] = '리뷰패널 펼치기';
...
$string['multipleteamsgrader'] = '여러 그룹에 등록되어 있어 제출물을 만들 수 없습니다.';
$string['newsubmissions'] = '제출된 과제들';
$string['nextuser'] = '다음 사용자';
...
$string['nosubmissionyet'] = '아직 제출물이 만들어지지 않았습니다.';
...
$string['noteamgrader'] = '어떤 그룹에도 등록되지 않아 제출물을 만들 수 없습니다.';
...
$string['open'] = '열기';
$string['opensubmissionexists'] = '이미 진행 중인 과제가 있습니다.';
...
$string['previoususer'] = '이전 사용자';
$string['privacy:blindmarkingidentifier'] = '익명 제출물을 위한 고유 식별자';
$string['privacy:gradepath'] = '성적';
$string['privacy:metadata:assignfeedbackpluginsummary'] = '과제 피드백 데이터';
$string['privacy:metadata:assignmentid'] = '과제 ID';
$string['privacy:metadata:assignmessageexplanation'] = '메시지 시스템을 통해 학생들에게 메시지가 전달됩니다.';
$string['privacy:submissionpath'] = '제출물';
$string['quickgrading'] = '빠른 채점';
$string['quickgradingchangessaved'] = '채점 변경이 저장되었습니다.';
$string['quickgradingresult'] = '빠른 채점';
$string['recordid'] = '식별자';
$string['removesubmissionconfirmwithtimelimit'] = '정말로 제출물을 삭제하시겠습니까? 과제 제출 시간은 재설정 되지 않습니다.';
...
$string['savingchanges'] = '변경 사항 저장 중...';
$string['scale'] = '척도';
