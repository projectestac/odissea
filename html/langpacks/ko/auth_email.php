...
/**
 * Strings for component 'auth_email', language 'ko', version '3.11'.
 *
 * @package     auth_email
 * @category    string
...
$string['auth_emailrecaptcha'] = '이메일을 이용해 스스로 등록하려는 사용자들을 위해 등록 페이지에 시청각 확인 기능을 추가하십시요. 이렇게 하면 스패머로부터 사이트를 지킬 수 있을 뿐만 아니라 의미있는 주의에 기여합니다. 좀 더 알고 싶으면 http://www.google.com/recaptcha/learnmore의 내용을 참조하십시요. <br /><em>PHP cURL 익스텐션이 필요합니다.</em>';
