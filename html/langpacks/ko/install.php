...
/**
 * Strings for component 'install', language 'ko', version '4.4'.
 *
 * @package     install
 * @category    string
...
$string['cliadminemail'] = '새 관리자 이메일 주소';
...
$string['cliskipdatabase'] = '데이터베이스 설치 생략';
...
<p>Safe mode는 일부 웹호스트에서 이를 켜 놓을 수 있는데, 무들 사이트를 원활히 운용하기 위해서는 새로운 웹호스트를 찾아보시는 편이 나을 겁니다.</p>
