...
/**
 * Strings for component 'tool_xmldb', language 'ko', version '4.1'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['actual'] = '실제';
$string['aftertable'] = '이 테이블 다음 :';
$string['back'] = '뒤로';
$string['backtomainview'] = '메인 페이지로 돌아가기';
$string['cannotuseidfield'] = '"id"필드에 입력할 수 없음. 자동 숫자 컬럼임';
$string['change'] = '변경';
$string['charincorrectlength'] = '문자 필드 길이 틀림';
$string['check_bigints'] = '잘못된 DB 정수 찾기';
$string['check_defaults'] = '일관성이 결여된 디폴트 값 찾기';
$string['check_foreign_keys'] = '외래키 위반사항 찾기';
$string['check_indexes'] = '누락된 DB 인덱스 찾기';
$string['check_oracle_semantics'] = '잘못된 길이의 시만틱 찾기';
$string['checkbigints'] = '정수 확인';
$string['checkdefaults'] = '디폴트 확인';
$string['checkforeignkeys'] = '외래키 확인';
$string['checkindexes'] = '인덱스 점검';
$string['checkoraclesemantics'] = '시만틱 점검';
$string['completelogbelow'] = '(아래에서 검색에 대한 전체 로그 참조)';
...
$string['confirmdeletefield'] = '정말로 필드를 삭제하기를 원하십니까?';
$string['confirmdeleteindex'] = '정말로 인덱스를 삭제하기를 원하십니까?';
$string['confirmdeletekey'] = '정말로 키를 삭제하기를 원하십니까?';
$string['confirmdeletetable'] = '정말로 테이블을 삭제하기를 원하십니까?';
$string['confirmdeletexmlfile'] = '정말로 파일을 삭제하기를 원하십니까?';
...
$string['documentationintro'] = '이 문서는 XMLDB 데이터베이스 정의에 의해 자동적으로 생성됩니다. 단, 영문으로만 이용할 수 있습니다.';
$string['down'] = '아래';
$string['duplicate'] = '복제';
$string['duplicatefieldname'] = '동일한 이름을 가진 다른 필드가 존재함';
$string['duplicatefieldsused'] = '중복된 필드가 사용되었습니다.';
$string['duplicateindexname'] = '인덱스 이름 중복';
...
$string['expected'] = '예상된';
$string['extensionrequired'] = '죄송합니다만 이 작업은 PHP의 \'{$a}\' 익스텐션이 필요합니다. 이 기능을 사용하려면 필요한 익스텐션을 설치하기 바랍니다.';
$string['field'] = '필드';
$string['fieldnameempty'] = '이름 필드가 비어 있습니다';
$string['fields'] = '필드들';
$string['fieldsnotintable'] = '테이블에 필드가 존재하지 않음';
$string['fieldsusedinindex'] = '이 필드는 인덱스로 사용됨';
$string['fieldsusedinkey'] = '이 필드는 키로 사용됨';
$string['filenotwriteable'] = '쓸 수 없는 파일';
$string['fkviolationdetails'] = '{$a->tablename} 테이블에 있는 외래키 {$a->keyname} 는 {$a->numrows} 열에서 {$a->numviolations} 위반입니다.';
$string['float2numbernote'] = '알림: XMLDB에 의해 "float" 필드가 100% 지원된다 하더라도, "number" 필드로 마이그레이션 할 것을 권장합니다.';
...
$string['gotolastused'] = '마지막 사용했던 파일로 감';
$string['incorrectfieldname'] = '틀린 이름';
$string['incorrectindexname'] = '틀린 인덱스 이름';
$string['incorrectkeyname'] = '잘못된 키 이름';
$string['incorrecttablename'] = '잘못된 테이블 이름';
$string['index'] = '인덱스';
$string['indexes'] = '인덱스';
$string['indexnameempty'] = '인덱스 이름이 공백입니다';
$string['integerincorrectlength'] = '정수필드에 맞지 않는 길이';
$string['key'] = '키';
$string['keynameempty'] = '키 이름은 공백일 수 없습니다.';
$string['keys'] = '키';
$string['listreservedwords'] = '예약어 목록<br/>(<a href="http://docs.moodle.org/en/XMLDB_reserved_words" target="_blank">XMLDB_reserved_words</a>를 이용하여 항상 최신 상태로 유지)';
$string['load'] = '로드';
...
$string['mustselectonefield'] = '필드와 관련된 동작을 보기 위해서는 하나의 필드를 선택해야만 합니다.';
$string['mustselectoneindex'] = '인덱스와 관련된 동작을 보기 위해서는 하나의 인덱스를 선택해야만 합니다.';
$string['mustselectonekey'] = '키와 관련된 동작을 보기 위해서는 하나의 키를 선택해야만 합니다.';
$string['new_table_from_mysql'] = 'MySQL에서 새 테이블';
...
$string['nowrongdefaultsfound'] = '잘못된 기본값이 발견되지 않았으므로, DB는 추가 조치가 필요하지 않습니다.';
$string['nowrongintsfound'] = '잘못된 정수가 발견되지 않았으므로, DB는 추가 조치가 필요하지 않습니다.';
$string['numberincorrectdecimals'] = '숫자 필드에 적합하지 않은 소수점 자리수';
$string['numberincorrectlength'] = '숫자 필드에 맞지 않는 길이';
$string['pendingchanges'] = '주의: 파일이 변경되었습니다. 언제든 파일을 저장할 수 있습니다.';
$string['pendingchangescannotbesaved'] = '파일이 변경되었지만, 저장할 수 없습니다! 디렉토리와 "install.xml"  에 대해서 웹 서버의 쓰기 권한이 주어졌는지 확인해 보시기 바랍니다.';
$string['pendingchangescannotbesavedreload'] = '파일이 변경되었지만, 저장할 수 없습니다! 디렉토리와 그 디렉토리 안의 "install.xml" 파일에 대해 웹 서버가 쓰기 권한이 있는지 확인해 보십시요. 그런 다음 이 페이지를 새로고침하면 변경사항을 저장할 수 있을 것입니다.';
