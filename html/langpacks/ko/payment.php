...
/**
 * Strings for component 'payment', language 'ko', version '4.5'.
 *
 * @package     payment
 * @category    string
...
$string['privacy:metadata:database:payments:timecreated'] = '결제된 시간';
$string['privacy:metadata:database:payments:timemodified'] = '결제 기록이 마지막으로 업데이트된 시간';
$string['selectpaymenttype'] = '결제 유형을 선택하세요.';
