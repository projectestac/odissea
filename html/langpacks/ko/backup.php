...
/**
 * Strings for component 'backup', language 'ko', version '4.4'.
 *
 * @package     backup
 * @category    string
...
$string['questioncannotberestored'] = '질문 "{$a->name}"은 복구에 의해 생성될 수 없습니다.';
...
$string['rootsettingquestionbank'] = '질문은행 포함';
...
$string['skipmodifdays'] = '다음 이후에 수정되지 않은 강좌 건너뛰기:';
$string['skipmodifdayshelp'] = '수일 이후 수정되지 않은 강좌를 건너뛰기 위해서는 선택하세요.';
$string['skipmodifprev'] = '이전 백업 이후에 수정되지 않은 강좌 건너뛰기:';
$string['skipmodifprevhelp'] = '이전 백업 이후에 수정되지 않은 강좌를 건너뛸 것인지를 선택하세요.';
