...
/**
 * Strings for component 'hub', language 'ko', version '4.5'.
 *
 * @package     hub
 * @category    string
...
$string['sitecommnews'] = '무들 뉴스레터';
$string['sitecommnews_help'] = '무들 뉴스레터를 구독해 보세요. 언제든 해지하실 수 있습니다.';
$string['sitecommnewsno'] = '아니오, 이메일 수신을 원하지 않습니다';
$string['sitecommnewsyes'] = '네, 무들 뉴스레터 수신을 희망합니다';
