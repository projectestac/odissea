...
/**
 * Strings for component 'qtype_numerical', language 'ko', version '4.4'.
 *
...
$string['addmoreanswerblanks'] = '추가  {no}  답란을 위한 공백';
$string['addmoreunitblanks'] = '추가 {no} 단위를 위한 공백';
...
$string['decfractionofquestiongrade'] = '질문 성적의 부분 (0-1)으로';
$string['decfractionofresponsegrade'] = '응답 성적의 부분 (0-1)으로';
...
$string['unitmandatory_help'] = '* 쓰여진 단위를 사용하여 응답이 채점될 것입니다.
* 단위 필드가 비어 있으면 단위 감점이 적용됩니다.';
