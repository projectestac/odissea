...
$string['advancedsearchoptions'] = '옵션 검색';
$string['alltries'] = '모든 시도';
$string['answer'] = '답';
$string['answers'] = '답';
...
$string['cannotdeletetopcat'] = '최상위 카테고리는 삭제할 수 없습니다.';
$string['cannotedittopcat'] = '최상위 카테고리는 수정할 수 없습니다.';
...
$string['cannotregradedifferentqtype'] = '다른 유형의 문제로는 다시 평가할 수 없습니다.';
...
$string['correctfeedbackdefault'] = '답이 맞습니다.';
$string['created'] = '생성됨';
...
$string['defaultmarkmustbepositive'] = '기본 점수는 양수이어야 합니다.';
...
$string['deletequestiontitle'] = '문제를 삭제하시겠습니까?';
$string['deletequestiontitle_plural'] = '문제를 삭제하시겠습니까?';
$string['deleteversiontitle'] = '선택된 버전을 삭제하겠습니까?';
$string['deleteversiontitle_plural'] = '선택된 버전을 삭제하겠습니까?';
$string['deletingbehaviour'] = '질문 진행방식 \'{$a}\' 삭제';
$string['deletingqtype'] = '\'{$a}\' 질문 유형 삭제';
$string['didnotmatchanyanswer'] = '[어떤 대답과도 일치하지 않습니다]';
$string['disabled'] = '불가능';
$string['displayoptions'] = '표시 옵션';
...
$string['eventquestioncategorycreated'] = '문제 카테고리가 생성되었습니다.';
$string['eventquestioncategorydeleted'] = '문제 카테고리가 삭제되었습니다.';
$string['eventquestioncategorymoved'] = '문제 카테고리가 이동되었습니다.';
$string['eventquestioncategoryupdated'] = '문제 카테고리가 업데이트 되었습니다.';
$string['eventquestioncategoryviewed'] = '문제 카테고리가 표시되었습니다.';
$string['eventquestioncreated'] = '문제를 생성했습니다.';
$string['eventquestiondeleted'] = '문제를 삭제했습니다.';
$string['eventquestionmoved'] = '문제를 이동했습니다.';
$string['eventquestionsexported'] = '문제를 내보내기했습니다.';
$string['eventquestionsimported'] = '문제를 가져왔습니다.';
$string['eventquestionupdated'] = '문제를 업데이트했습니다.';
$string['eventquestionviewed'] = '문제를 표시했습니다.';
$string['export'] = '내보내기';
$string['exportasxml'] = 'Moodle XML 양식으로 내보내기';
...
$string['exportonequestion'] = '이 문제를 Moodle XML 양식으로 다운로드하기';
...
$string['filterbytags'] = '다음 태그 포함...';
$string['firsttry'] = '첫 시도';
$string['flagged'] = '기표됨';
...
$string['generalfeedback_help'] = '공통 피드백은 학생들이 문제를 완료한 후에 표시됩니다. 문제 유형과 학생의 응답에 따라 달라지는 구체적인 피드백과 달리, 공통 피드백은 모든 학생에게 동일하게 표시됩니다.

공통 피드백을 학생들에게 정답과 해설을 알려주거나, 문제를 이해하지 못한 학생들을 위해 추가 정보를 알려주는 용도로 사용할 수도 있습니다.';
...
$string['importwrongfileencoding'] = '선택한 파일이 UTF-8 인코딩을 사용하지 않습니다. {$a} 파일은 반드시 UTF-8 인코딩을 사용해야 합니다.';
...
$string['incorrectfeedbackdefault'] = '답이 틀립니다.';
...
$string['manualgradeinvalidformat'] = '유효한 숫자가 아닙니다.';
...
$string['notagfiltersapplied'] = '적용된 태그 없음';
$string['notanswered'] = '답하지 않음';
$string['notchanged'] = '마지막 시도 이후 변경사항 없음';
...
$string['partiallycorrectfeedbackdefault'] = '답이 부분적으로 옳습니다.';
...
$string['penaltyforeachincorrecttry_help'] = '\'여러 번의 시도로 상호 작용(Interactive with multiple tries)\' 또는 \'적응형 모드(Adaptive mode)\' 에서 여러 번 시도할 때, 틀린 시도마다 받는 패널티를 조정합니다.

페널티는 문제의 전체점수에 대한 비율이므로, 질문이 3점의 가치가 있고 페널티가 0.3333333인 경우, 첫번째 시도에서 맞은 경우 3점, 두 번째 시도에서 맞으면 2점, 세 번째 시도에서 맞으면 1점을 받게 됩니다.

일부 다단계 질문의 경우 이 채점 논리는 질문의 각 부분에 별도로 적용됩니다. 세부 사항은 질문 유형에 따라 다르며 복잡할 수 있지만, 원칙은 학생들에게 가능한 한 공정하게 점수를 부여하는 것입니다.';
...
$string['privacy:metadata:database:question'] = '문제에 대한 세부 사항';
$string['privacy:metadata:database:question:createdby'] = '출제자';
$string['privacy:metadata:database:question:generalfeedback'] = '이 문제에 대한 공통 피드백';
$string['privacy:metadata:database:question:modifiedby'] = '마지막으로 수정한 사람';
$string['privacy:metadata:database:question:name'] = '문제명';
$string['privacy:metadata:database:question:questiontext'] = '문제 본문';
$string['privacy:metadata:database:question:timecreated'] = '문제 생성일';
$string['privacy:metadata:database:question:timemodified'] = '문제 수정일';
$string['privacy:metadata:database:question_attempt_step_data'] = '문제 시도 단계에는 그 단계와 관련된 추가 데이터가 있을 수 있습니다. 데이터는 step_data 테이블에 저장됩니다.';
$string['privacy:metadata:database:question_attempt_step_data:name'] = '데이터 항목 이름';
$string['privacy:metadata:database:question_attempt_step_data:value'] = '데이터 항목 값';
...
$string['settingsformultipletries'] = '여러번 시도';
...
$string['showquestiontext_off'] = '아니요.';
