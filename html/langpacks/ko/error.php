...
$string['TODO'] = '실행목록';
$string['activityisscheduledfordeletion'] = '활동을 삭제하는 중...';
$string['agedigitalconsentmapinvalidage'] = '"{$a}"은/는 유효한 연령 값이 아닙니다.';
$string['agedigitalconsentmapinvalidcountry'] = '"{$a}"은/는 유효한 국가 값이 아닙니다.';
$string['agedigitalconsentmapinvaliddefault'] = '기본 (*) 값이 누락되었습니다.';
$string['agelocationverificationdisabled'] = '연령 및 위치 검증이 비활성화되었습니다.';
...
$string['cannotedituserpreferences'] = '유저의 환경설정을 수정할 수 없음';
...
$string['cannotmovecourses'] = '강의를 대상이 있는 카테고리에서 다른 카테고리로 이동할 수 없습니다.';
...
$string['cannotviewcategory'] = '이 강의 목록에 대한 열람 권한이 없습니다.';
...
$string['dndmaxbytes'] = '파일이 너무 큽니다. 지원되는 크기는 최대 {$a->size}입니다.';
$string['dndread'] = '파일을 읽는 중에 오류가 발생했습니다.';
$string['dndunkownfile'] = '해당 파일 유형은 지원되지 않습니다.';
$string['dndupload'] = '파일을 업로드하는 중에 알 수 없는 오류가 발생했습니다.';
...
$string['duplicatenosupport'] = '\'{$a->modname}\'활동은 복제될 수 없습니다. {$a->modtype}모듈에서 백업 및 복구를 지원하지 않기 때문입니다.';
...
$string['encryption_decryptfailed'] = '복호화 실패';
$string['encryption_encryptfailed'] = '암호화 실패';
$string['encryption_invalidkey'] = '유효하지 않은 키';
$string['enddatebeforestartdate'] = '강의 종료일은 강의 시작일보다 늦어야 합니다.';
$string['error'] = '오류 발생';
...
$string['gradesneedregrading'] = '강의 등급이 재측정되어야 함';
...
$string['guestcantaccessprofiles'] = '게스트는 사용자 프로필에 접근할 수 없습니다. 계속하시려면 로그인하십시오.';
...
$string['invalidcontentid'] = '유효하지 않은 내용의 ID';
$string['invalidcontext'] = '잘못된 문맥';
$string['invalidcountrycode'] = '유효하지 않은 국가 코드: {$a}';
$string['invalidcourse'] = '잘못된 강좌';
$string['invalidcourseformat'] = '유효하지 않은 강의 형식';
...
$string['nopermissiontoaccesspage'] = '이 페이지에 접근할 권한이 없습니다.';
...
$string['nopermissiontoviewcalendar'] = '죄송합니다. 달력 이벤트를 볼 수 있는 권한이 없습니다.';
...
$string['nostartdatenoenddate'] = '강의 시작일은 강의 종료일이 설정된 경우에만 설정할 수 있습니다.';
...
$string['pagenotexisttitle'] = '404 오류: 파일을 찾지 못함';
...
$string['registrationdisabled'] = '이 사이트에서 등록이 비활성화되어 있습니다.';
...
$string['sessionexpired'] = '세션이 만료되었습니다.';
...
$string['usernamelowercase'] = '사용자 이름은 소문자로 구성되어야 합니다.';
