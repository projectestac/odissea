...
/**
 * Strings for component 'auth_cas', language 'ko', version '4.4'.
 *
 * @package     auth_cas
 * @category    string
...
$string['auth_cas_casversion'] = 'CAS 프로토콜 버전';
$string['auth_cas_certificate_check'] = '서버 인증서의 유효성을 검사하려는 경우 \'예\'를 선택하십시오';
...
$string['auth_cas_version'] = '사용할 CAS 프로토콜 버전';
