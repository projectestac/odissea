...
$string['cannoteditentryorblog'] = '해당 항목 또는 블로그를 수정할 수 없습니다.';
...
$string['eventblogexternalupdated'] = '외부 블로그 업데이트됨';
...
$string['myprofileuserblogs'] = '모든 블로그 게시글 보기';
$string['name'] = '이름';
...
$string['privacy:metadata:core_files'] = '블로그 게시글에 파일 첨부';
$string['privacy:metadata:post:subject'] = '블로그 게시물 제목';
$string['publishto'] = '게시';
...
$string['wrongexternalid'] = '잘못된 외부 블로그 ID';
