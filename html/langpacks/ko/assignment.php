...
/**
 * Strings for component 'assignment', language 'ko', version '3.11'.
 *
 * @package     assignment
 * @category    string
...
$string['modulename'] = '과제 2.2 (비활성화됨)';
...
$string['modulenameplural'] = '과제제출 2.2 (비활성화됨)';
...
$string['pluginadministration'] = '과제 2.2 (비활성화됨) 관리';
$string['pluginname'] = '과제 2.2 (비활성화됨)';
$string['privacy:submissionpath'] = '제출';
