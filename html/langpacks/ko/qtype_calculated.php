...
/**
 * Strings for component 'qtype_calculated', language 'ko', version '4.4'.
 *
...
$string['atleastonewildcard'] = '질문지나 답안 공식에 적어도 하나 이상의 와일드카드 파라메터가 있어야만 함';
...
$string['datasetrole'] = '와일드카드 파라메터<strong>{x..}</strong>는 숫자집합에서 수치로 치환될 것입니다.';
$string['decimals'] = '{$a}로';
...
$string['hexanotallowed'] = '데이터셋 <strong>{$a->name}</strong>에 16진법 값 $a->value 은 허용되지 않습니다.';
...
$string['mandatoryhdr'] = '필수 와일드카드 파라메터가 답에 존재합니다.';
$string['max'] = '최대';
$string['min'] = '최소';
$string['minmax'] = '값의 범위';
...
$string['newsetwildcardvalues'] = '와일드카드 파라메터 값의 새 집합';
$string['nextitemtoadd'] = '다음 \'추가할 항목\'';
$string['nextpage'] = '다음 페이지';
$string['nocoherencequestionsdatyasetcategory'] = '범주 id {$a->qcat} 의 질문 id {$a->qid} 에 대해 범주 id {$a->sharedcat}의 공유 와일드카드 파라메터 {$a->name} 와 일치하지 않습니다.  질문을 편집하십시요.';
$string['nocommaallowed'] = '0.013 혹은 1.3e-2처럼 ,(쉽표)대신 .(마침표)를 사용하세요. ';
$string['nodataset'] = '없음 - 와일드카드 파라메터가 아님';
$string['nosharedwildcard'] = '범주내에 공유된 와일드카드 파라메터가 없음';
$string['notvalidnumber'] = '와일드카드 파라메터 값이 유용한 숫자가 아님';
...
$string['possiblehdr'] = '질문의 문장에만  와일드카드 파라메터가 있을 수 있습니다';
$string['questiondatasets'] = '질문 숫자집합';
$string['questiondatasets_help'] = '개별 질문에서 쓰일 와일드카드 파라메터의 질문 숫자집합';
$string['questionstoredname'] = '질문 이름';
$string['replacewithrandom'] = '무작위 값으로 대치';
$string['reuseifpossible'] = '이전값 재 사용';
$string['setno'] = '집합 {$a}';
$string['setwildcardvalues'] = '와일드카드 파라메터 값의 집합';
$string['sharedwildcard'] = '공유 와일드카드 파라메터<strong>{$a}</strong>';
$string['sharedwildcardname'] = '공유 와일드카드 파라메터';
$string['sharedwildcards'] = '공유 와일드카드 파라메터';
$string['showitems'] = '표시';
...
$string['updatewildcardvalues'] = '와일드카드 파라메터값 업데이트';
$string['useadvance'] = '오류를 보기위한 고급 버튼 사용';
$string['usedinquestion'] = '질문에서 사용됨';
$string['wildcard'] = '와일드카드 파라메터 {<strong>{$a}</strong>}';
$string['wildcardparam'] = '와일드카드 파라메터는 값을 생성하는데 사용됨';
$string['wildcardrole'] = '와일드카드 파라메터<strong>{x..}</strong> 는 생성된 값을 수치값으로 치환할 것임';
$string['wildcards'] = '와일드카드 파라메터 {a}...{z}';
$string['wildcardvalues'] = '와일드카드 파라메터 값';
$string['wildcardvaluesgenerated'] = '와일드카드 파라메터 값이 만들어졌습니다.';
$string['youmustaddatleastoneitem'] = '이 질문을 저장하기전에 최소 한개 데이터집합 항목을 추가하여야 합니다.';
$string['youmustaddatleastonevalue'] = '이 질문을 저장하기전에 최소 한개의 와일드카드 파라메터 값 집합을 추가해야 합니다.';
