...
/**
 * Strings for component 'auth_oauth2', language 'zh_cn', version '4.5'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['confirmaccountemail'] = '嗨{$a->firstname}，

已在“{$a->sitename}”处请求新帐户
使用您的电子邮件地址。
...
在大多数邮件程序中，这应该显示为蓝色链接，您可以单击它。 如果这不起作用，然后将地址剪切并粘贴到地址中Web 浏览器窗口顶部的行。

如果您需要帮助，请联系网站管理员，
{$a->admin}

如果您不这样做，其他人可能会试图破坏您的帐户。
请立即与网站管理员联系。';
...
$string['confirmlinkedloginemail'] = '{$a->firstname} 您好，
...
$string['noconfiguredidps'] = '没有配置的 OAuth2 提供程序';
$string['noissuersavailable'] = '配置的 OAuth 2 服务均不允许您链接登录帐户';
...
$string['testidplogin'] = '测试登录';
$string['userinfo'] = '来自提供方的用户数据：';
$string['value'] = '值';
