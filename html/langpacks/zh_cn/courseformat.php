...
$string['addsection'] = '添加节';
$string['availability_hide'] = '在课程页面上隐藏';
$string['availability_hide_help'] = '不适用于学生';
$string['availability_show'] = '在课程页面上显示';
$string['availability_show_help'] = '可供学生使用（受设置的任何访问限制的限制）';
$string['availability_stealth'] = '提供，但不显示在课程页面上';
$string['availability_stealth_help'] = '如果您提供链接，则对学生可用。活动仍将显示在成绩簿和其他报告中。';
$string['bulkcancel'] = '关闭批量操作';
$string['bulkedit'] = '批量操作';
...
$string['cm_duplicate_feedback_batch'] = '选定的 {$a->count} 活动已重复';
$string['cm_hide_feedback'] = '{$a->name} 现已隐藏';
$string['cm_hide_feedback_batch'] = '选定的 {$a->count} 活动现在处于隐藏状态';
$string['cm_moveleft_feedback'] = '{$a->name}已移到左边';
$string['cm_moveright_feedback'] = '{$a->name}已移到右边';
$string['cm_nogroups_feedback'] = '{$a->name} 组模式更改为无组';
$string['cm_separategroups_feedback'] = '{$a->name} 组模式更改为独立分组';
$string['cm_show_feedback'] = '{$a->name} 现在显示';
...
$string['cmsdelete_title'] = '删除选定的活动？';
$string['cmsduplicate'] = '重复活动';
$string['cmsmove'] = '移动活动';
$string['cmsmove_info'] = '将活动{$a}移到后面';
...
$string['sectionmove_info'] = '移动 {$a}到后';
$string['sectionmove_title'] = '移动节';
$string['sectionsavailability'] = '节可用性';
$string['sectionsavailability_title'] = '节可用性';
$string['sectionsdelete'] = '删除节';
$string['sectionsdelete_info'] = '这将删除 {$a->count} 节及其包含的所有活动';
$string['sectionsdelete_title'] = '删除选定的节？';
$string['sectionsmove'] = '移动节';
$string['sectionsmove_info'] = '移动 {$a}到后';
$string['sectionsmove_title'] = '移动选定的节';
$string['selectcm'] = '选择活动{$a}';
$string['selectsection'] = '选择节{$a}';
