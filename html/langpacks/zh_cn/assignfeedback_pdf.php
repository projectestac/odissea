...
/**
 * Strings for component 'assignfeedback_pdf', language 'zh_cn', version '4.5'.
 *
...
$string['comment'] = '评论';
$string['commentcolour'] = '[,] - 注释背景色';
$string['commenticon'] = 'c-add 注释\\n按住Ctrl键绘制直线';
...
$string['gspath2'] = '在大多数Linux安装中，这可以保留为“/usr/bin/gs”。在Windows上，它将类似于“c:\\gs\\bin\\gswin32c.exe“（确保路径中没有空格-如有必要，将文件“gswin32c.exe”和“gsdll32.dll”复制到路径中没有空格的新文件夹中）';
$string['highlighticon'] = 'h - 高亮文本';
$string['imagefor'] = '{$a}的图像文件';
$string['jsrequired'] = '必须在浏览器中启用Javascript才能运行PDF批注';
$string['keyboardnext'] = 'n - 下一页';
$string['keyboardprev'] = 'p - 上一页';
$string['linecolour'] = '{,} - line colour';
$string['lineicon'] = 'l-直线';
$string['missingannotationdata'] = '缺少批注数据';
$string['missingcommentdata'] = '缺少评论列表数据';
$string['missingquicklistdata'] = '缺少快速列表数据';
$string['next'] = '下一步';
$string['nocomments'] = '没有评论';
$string['nogroup'] = '不在组里的';
$string['okagain'] = '单击“确定”重试';
$string['openlinknewwindow'] = '在新窗口打开链接';
$string['opennewwindow'] = '在新窗口中打开页面';
$string['ovalicon'] = 'o-椭圆形';
$string['pagenumber'] = '页码';
$string['pagenumbertoobig'] = '要求的页码大于总页数 ({$a->pageno} > {$a->pagecount})';
$string['pagenumbertoosmall'] = '要求的页码数太小(<1)';
$string['pdf'] = 'PDF反馈';
$string['pluginname'] = 'PDF反馈';
$string['previous'] = '向前';
$string['previousnone'] = '没有';
$string['quicklist'] = '评论快速列表';
$string['rectangleicon'] = 'r-矩形';
$string['resend'] = '重新发送';
$string['responsefor'] = '{$a}的响应文件';
$string['responseok'] = '已生成响应文件';
$string['responseproblem'] = '生成响应文件时出现问题';
$string['savedraft'] = '保存草稿批注';
$string['servercommfailed'] = '与服务器通信失败――你是否要重新发送此信息？';
$string['showpreviousassignment'] = '显示以前的作业';
$string['stamp'] = '选择印章';
$string['stampicon'] = 's-印章';
...
$string['test_notexecutable'] = 'ghostscript指向一个不可执行的文件';
$string['test_ok'] = '这个 ghostscript 目录似乎没有问题――请检查你是否能看到图像下方的信息';
$string['testgs'] = '测试ghostscript 路径';
