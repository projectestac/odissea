...
$string['auth_cas_auth_logo'] = '认证方法标识LOGO';
$string['auth_cas_auth_logo_description'] = '为用户熟悉的CAS身份验证方法提供一个LOGO。';
$string['auth_cas_auth_name'] = '认证方法名称';
$string['auth_cas_auth_name_description'] = '为用户熟悉的CAS身份验证方法提供一个名称。';
