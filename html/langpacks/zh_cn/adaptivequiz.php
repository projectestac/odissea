...
$string['attemptfeedbackhdr'] = '尝试反馈';
...
$string['placeholdercopied'] = '已复制至剪切板';
...
$string['reportattemptadmchartadmdifflabel'] = '已实施难度';
$string['reportattemptadmcharttargetdifflabel'] = '目标难度';
...
$string['reportattemptsfilterincludeinactiveenrolments'] = '包括非活跃注册用户';
$string['reportattemptsfilterincludeinactiveenrolments_help'] = '是否包括已暂停注册的用户';
$string['reportattemptsfilterusers'] = '显示';
...
$string['score'] = '分数';
$string['showabilitymeasurefeedback_help'] = '当此设置被启用后，学生可以在答题完成页面上看到能力预测值，该预测值会作为标准小组件显示。请注意，如果已使用占位符在自定义反馈文本中配置显示预测值，此设置不会影响该预测值的显示。';
