...
/**
 * Strings for component 'adaptivequiz', language 'zh_cn', version '3.11'.
 *
...
$string['answer'] = '答案';
$string['answerdistgraph_numrightwrong'] = '数字错误 (-)  /  数字正确 (+)';
$string['answerdistgraph_questiondifficulty'] = '问题级别';
$string['answerdistgraph_right'] = '正确';
$string['answerdistgraph_title'] = '答案分配给 {$a->firstname} {$a->lastname}';
$string['answerdistgraph_wrong'] = '错误';
...
$string['attemptquestion_error'] = '标准误差(&plusmn;&nbsp;x%)';
$string['attemptquestion_level'] = '问题级别';
$string['attemptquestion_rightwrong'] = '正确/错误';
...
$string['errorclosingattempt'] = '未找到尝试记录';
$string['errorclosingattempt_alreadycomplete'] = '此尝试已完成，无法手动关闭。';
$string['errordeletingattempt'] = '未找到尝试记录';
$string['errorfetchingquest'] = '无法获取级别{$a->level}的问题';
...
$string['graphlegend_target'] = '目标水平';
...
$string['name'] = '名称';
$string['noattemptrecords'] = '该学生没有尝试记录';
...
$string['reportattemptanswerdistributiontabletitle'] = '答案分布表视图';
...
$string['score'] = '分数';
$string['showabilitymeasure'] = '向学生展示能力测量';
$string['showabilitymeasure_help'] = '有时，在进行自适应测试后，向学生展示能力评估可能很有用。启用此设置后，学生可以在尝试摘要中以及完成尝试后立即看到能力评估。';
