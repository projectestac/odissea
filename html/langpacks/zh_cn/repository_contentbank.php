...
/**
 * Strings for component 'repository_contentbank', language 'zh_cn', version '3.11'.
 *
...
$string['configplugin'] = '内容库存储库的配置';
$string['contentbank:accesscoursecategorycontent'] = '访问课程类别内容库文件';
