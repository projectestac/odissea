...
/**
 * Strings for component 'book', language 'zh_cn', branch 'MOODLE_38_STABLE'
 *
 * @package   book
...
$string['customtitles_help'] = '章标题通常显示目录中，并做为正文上方的标题。

如果自定义标题复选框被勾选，就不会在正文上方显示章标题。可以在正文中输入一个不同的标题（可以比章标题长）。';
$string['deletechapter'] = '删除章节“{$a}”';
$string['editchapter'] = '编辑章节“{$a}”';
$string['editingchapter'] = '编辑章节';
$string['errorchapter'] = '读取图书章节出错。';
