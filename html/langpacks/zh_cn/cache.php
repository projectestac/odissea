...
$string['cachedef_portfolio_add_button_portfolio_instances'] = 'portfolio_add_button类的组合实例';
...
$string['storeready'] = '就绪';
$string['storerequiresattention'] = '需要注意。';
$string['storerequiresattention_help'] = '此存储的实例不是直接可以使用的但有映射。解决这个问题将提高你的系统的性能。请检查存储后端是随时可以使用，并且满足任何PHP的要求。';
$string['storeresults_application'] = '作为一个应用程序缓存使用时的存储请求。';
$string['storeresults_request'] = '作为请求缓存使用时的存储请求。';
$string['storeresults_session'] = '作为会话缓存使用时的存储请求。';
$string['stores'] = '存储';
$string['storesummaries'] = '配置存储实例';
$string['supports'] = '支持';
$string['supports_dataguarantee'] = '数据保证';
$string['supports_keyawareness'] = '获取密钥';
$string['supports_multipleidentifiers'] = '多个标识符';
$string['supports_nativelocking'] = '锁定中';
$string['supports_nativettl'] = 'TTL';
$string['supports_searchable'] = '通过密钥搜索';
$string['tested'] = '已测试';
