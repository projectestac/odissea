...
/**
 * Strings for component 'workshopallocation_random', language 'zh_cn', version '4.5'.
 *
...
$string['nogroupusers'] = '<p>警告：如果互动评价处在“公开小组”模式或者“独立小组”模式，那么用户必须至少属于一个组，才能用此工具向他们分配评价任务。不属于任何组的用户仍然可以做自我评价或者删除已有的评价。</p> <p>这些用户目前还未被加入任何组：{$a}</p>';
