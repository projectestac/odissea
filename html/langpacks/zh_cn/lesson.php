...
$string['completiondetail:reachend'] = '将活动进行到底';
$string['completiondetail:timespent'] = '在这项活动上至少花费{$a}';
...
$string['eventhighscoreadded'] = '第一课增加高分';
$string['eventhighscoresviewed'] = '查看课程高分';
