...
/**
 * Strings for component 'qtype_ordering', language 'zh_cn', version '4.4'.
 *
...
$string['addmultipleanswers'] = '添加更多{$a}项';
$string['addsingleanswer'] = '再添加一项';
$string['allornothing'] = '全有或全无';
$string['answer'] = '项目文本';
$string['correctitemsnumber'] = '正确条目：{$a}';
$string['correctorder'] = '这些项目的正确顺序如下:';
$string['defaultanswerformat'] = '默认的答案格式';
$string['defaultquestionname'] = '将下列项目拖到正确的顺序。';
$string['draggableitemno'] = '可拖动项{no}';
$string['draggableitems'] = '可拖动项';
$string['duplicatesnotallowed'] = '不允许重复拖动项。字符串“{$a->text}”已经在{$a->item}中使用。';
...
$string['highlightresponse'] = '突出显示正确或不正确的响应';
$string['horizontal'] = '水平';
$string['incorrectitemsnumber'] = '错误项：{$a}';
...
$string['moved'] = '{$a->item} 移动到新位置: {$a->total}中的{$a->position} 。';
...
$string['notenoughsubsetitems'] = '子集必须至少有{$a}项。';
$string['numberingstyle'] = '给选项编号？';
$string['numberingstyle123'] = '1., 2., 3., ...';
$string['numberingstyleABCD'] = 'A., B., C., ...';
$string['numberingstyleIIII'] = 'I., II., III., ...';
$string['numberingstyle_desc'] = '默认的编号样式。';
$string['numberingstyle_help'] = '在此问题中选择可拖动项的编号样式。';
$string['numberingstyleabc'] = 'a., b., c., ...';
$string['numberingstyleiii'] = 'i., ii., iii., ...';
$string['numberingstylenone'] = '不编号';
$string['partialitemsnumber'] = '部分正确项：{$a}';
...
$string['positionx'] = '位置 {$a}';
$string['privacy:preference:gradingtype'] = '分级类型。';
$string['privacy:preference:layouttype'] = '布局';
$string['privacy:preference:numberingstyle'] = '选项的编号样式';
$string['privacy:preference:selectcount'] = '选择计数';
$string['privacy:preference:selecttype'] = '选择类型';
$string['privacy:preference:showgrading'] = '是否显示评分详细信息';
