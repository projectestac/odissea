...
/**
 * Strings for component 'assignsubmission_file', language 'zh_cn', branch 'MOODLE_38_STABLE'
 *
...
$string['default'] = '默认开启';
$string['defaultacceptedfiletypes'] = '默认可接受文件类型';
...
$string['privacy:metadata:filepurpose'] = '为此作业提交加载的文件';
$string['siteuploadlimit'] = '网站上传限制';
$string['submissionfilearea'] = '上传作业文件';
