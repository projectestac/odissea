...
/**
 * Strings for component 'qtype_numerical', language 'zh_cn', version '4.4'.
 *
...
$string['privacy:metadata'] = '数字题类型插件允许问题作者将默认选项设置为用户首选项。';
$string['privacy:preference:defaultmark'] = '为给定问题设置的默认分数。';
$string['privacy:preference:multichoicedisplay'] = '单位显示为文本输入元素、多选选项还是下拉菜单。';
$string['privacy:preference:penalty'] = '当使用“多次尝试交互”或“自适应模式”行为运行问题时，每次错误尝试的罚分。';
$string['privacy:preference:unitgradingtypes'] = '是否将单位罚分应用到回答问题或提出问题的得分中（0-1）。';
$string['privacy:preference:unitpenalty'] = '回答问题或提出问题的得分（0-1）应该是多少？';
$string['privacy:preference:unitrole'] = '单位是必要的、可选的还是不必要的。';
$string['privacy:preference:unitsleft'] = '单位是显示在左边（如$, £）还是右边（如kg, km, cm）。';
$string['relative'] = '相对';
