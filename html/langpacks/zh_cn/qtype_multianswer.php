...
/**
 * Strings for component 'qtype_multianswer', language 'zh_cn', version '4.5'.
 *
...
$string['layoutmultiple_horizontal'] = '复选框水平行';
$string['layoutmultiple_vertical'] = '复选框垂直列';
...
$string['privacy:metadata'] = '完形填空问题类型插件不存储任何个人数据。';
