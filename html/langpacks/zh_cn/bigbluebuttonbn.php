...
$string['completionengagementchats_desc'] = '参与 {$a} 聊天';
$string['completionengagementchats_event_desc'] = '已提出 {$a} 个聊天';
$string['completionengagementemojis'] = '标签图标';
$string['completionengagementemojis_desc'] = '更改他们的表情符号{$a}次。';
$string['completionengagementemojis_event_desc'] = '已更改 {$a} 次表情符号';
...
$string['config_dpa_note'] = '注意：为了履行您的数据保护义务，在使用此插件的服务提供商之前，您可能需要确保您已阅读并接受服务提供商的数据处理协议。 对于免费 BigBlueButton 服务，请阅读并接受以下<a href="{$a}" target="_blank">数据处理协议</a>.<br/> 请咨询您自己的隐私专家以获取建议。';
...
$string['config_poll_interval'] = '以秒为单位刷新房间的状态';
...
$string['config_recordings_asc_sort'] = '按时间顺序列出录音';
$string['config_recordings_asc_sort_description'] = '录音按时间排序，可以按时间顺序或倒序排列（最新的录音在前）。';
...
$string['config_recordings_deleted_editable'] = '可以编辑包含已删除活动的录音';
$string['config_recordings_deleted_editable_description'] = '默认情况下，在添加或更新实例时，可以编辑已删除活动中的包含录制内容。';
...
$string['general_error_not_found'] = '找不到 ID 为 {$a} 的 BigBlueButton 活动';
$string['general_error_unable_connect'] = '无法连接。请检查BigBlueButton服务器的网址，并检查BigBlueButton服务器是否正在运行。';
$string['guest_invitation_full_message'] = '你好
<p>我们邀请您参加课程 {$a->course_fullname} 中的 BigBlueButton 会话 <strong>{$a->name}</strong>。</p>
<p>链接： {$a->guestjoinurl}<br/>
<p>密码：{$a->guestpassword}</p>
<p>如果您需要帮助，请联系 {$a->sender}。</p>';
$string['guest_invitation_small_message'] = '你好

您将被邀请参加课程 {$a->course_fullname} 中的 BigBlueButton 会话 {$a->name}。

链接： {$a->guestjoinurl}
密码：{$a->guestpassword}

如果您需要帮助，请联系 {$a->sender}。';
$string['guest_invitation_subject'] = '邀请：{$a->course_fullname} 中的 {$a->name} 会话';
$string['guestaccess_activitynotfound'] = '未找到活动';
$string['guestaccess_add'] = '添加访客';
$string['guestaccess_add_no_id'] = '未提供 BigBlueButton 实例 ID';
$string['guestaccess_copy_link'] = '复制链接';
$string['guestaccess_copy_password'] = '复制密码';
$string['guestaccess_emails'] = '访客电子邮件';
$string['guestaccess_emails_help'] = '电子邮件地址列表，用逗号分隔';
$string['guestaccess_emails_invalidemail'] = '无效邮箱：{$a}';
$string['guestaccess_feature_disabled'] = '访客访问已禁用';
$string['guestaccess_invite_failure'] = '邀请 {$a->emails} 时出错 {$a->errors}';
$string['guestaccess_invite_success'] = '邀请将发送至 {$a->emails}';
$string['guestaccess_join_meeting'] = '加入会议';
$string['guestaccess_meeting_invalid_password'] = '密码错误';
$string['guestaccess_meeting_link'] = '会议链接';
$string['guestaccess_meeting_not_started'] = '会议尚未开始。请稍后再来。';
$string['guestaccess_meeting_password'] = '会议密码';
$string['guestaccess_password'] = '密码';
$string['guestaccess_title'] = '添加访客';
$string['guestaccess_username'] = '访客用户名';
...
$string['mod_form_block_guestaccess'] = '访客访问';
...
$string['mod_form_field_guestallowed'] = '允许访客访问';
...
$string['mod_form_field_mustapproveuser'] = '参加的访客必须得到主持人的许可';
...
$string['report_join_info'] = '{$a} 次会议';
$string['report_play_recording_info'] = '已播放录音内容{$a}次';
$string['report_room_view'] = '已查看';
...
$string['view_message_conference_user_limit_reached'] = '已达到会话中允许的用户数';
$string['view_message_conference_wait_for_moderator'] = '等待主持人加入。';
$string['view_message_cron_disabled'] = '列表可能不是最新的。请与网站管理员联系并提供以下信息：{$a}';
...
$string['view_message_session_started_at'] = '会话开始于';
...
$string['view_recording_link'] = '导入链接';
