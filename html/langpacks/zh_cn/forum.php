...
$string['cannotfavourite'] = '抱歉，您没有收藏此讨论的权限。';
...
$string['clicktofavourite'] = '您尚未收藏此讨论。单击以收藏。';
$string['clicktolockdiscussion'] = '点击锁定此话题。';
$string['clicktosubscribe'] = '您没有订阅此话题。点击订阅。';
$string['clicktounfavourite'] = '您已收藏此讨论。单击以取消收藏。';
...
$string['favouriteupdated'] = '您的收藏选项已更新。';
...
$string['forum:cantogglefavourite'] = '收藏讨论';
