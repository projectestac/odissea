...
$string['activationinfo'] = '<p>要使用此插件，您必须在此表单中提供此网站的有效密钥。</p><p>如果您还没有这些密钥，请<a href=“{$a}”data action=“send_info”target=“_blank”>在Brickfield门户（在新窗口中打开）注册</p> <p>插件一旦激活，您的密钥将通过预定的cron任务进行验证</p>';
...
$string['bannercontentone'] = '企业可访问性工具包具有一整套功能，可帮助您的组织提高课程的可访问性。<a href=“{$a}”>请联系Brickfield教育实验室</a>预订高级功能的免费演示。';
...
$string['error:nocoursespecified'] = '此摘要报告需要有效的课程id。请从课程中通过“操作”菜单访问可访问性工具包，该菜单将提供此必需的课程id。';
