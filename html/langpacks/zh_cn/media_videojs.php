...
/**
 * Strings for component 'media_videojs', language 'zh_cn', version '3.11'.
 *
...
$string['configvideoextensions'] = '使用逗号分隔的可以支持的音频文件扩展名列表。VideoJS将在可用时尝试使用浏览器自带的视频播放器，如果浏览器支持Flash，并且下面启用了Flash回调功能，则对于其他格式，VideoJS将使用Flash播放器。';
$string['configyoutube'] = '使用VideoJS播放YouTube视频。请注意，VideoJS目前还不支持YouTube播放列表。';
$string['limitsize'] = '限制尺寸';
$string['pluginname'] = 'VideoJS播放器';
$string['pluginname_help'] = '浏览器的自带的视频播放器播放的视频文件的JavaScript包装，带有Flash播放器回调功能。（格式支持取决于浏览器。）';
