...
/**
 * Strings for component 'assignsubmission_cloudpoodll', language 'zh_cn', version '3.11'.
 *
...
$string['cloudpoodllsubmission'] = '允许Cloud Poodll提交';
...
$string['setting_snapshot_heading_details'] = '控制提交审阅和列表页面中图像外观的设置';
...
$string['setting_whiteboard_heading_details'] = '控制提交审阅和列表页面中图像外观的设置';
$string['showaudiolightbox'] = '显示文件名(轻量盒外观)';
$string['showcurrentsubmission'] = '显示当前提交';
$string['showcurrentsubmissiondetails'] = '在提交表单上显示以前记录的提交。';
$string['shownoaudio'] = '显示文件名';
$string['shownoimage'] = '不显示图片';
