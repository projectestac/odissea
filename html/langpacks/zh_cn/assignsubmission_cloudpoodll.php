...
/**
 * Strings for component 'assignsubmission_cloudpoodll', language 'zh_cn', version '4.5'.
 *
...
$string['novalidcredentials'] = 'API用户和密钥被拒绝，无法访问。请在<a href="{$a}">设置页面</a>上检查它们</a> 您可以从<a href="https://poodll.com/member">Poodll.com</a>找到此页面。';
$string['numwords'] = '({$a} 词)';
