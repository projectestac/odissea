...
/**
 * Strings for component 'tool_lpimportcsv', language 'zh_cn', branch 'MOODLE_38_STABLE'
 *
...
$string['descriptionformat'] = '描述格式';
$string['encoding'] = '编码';
$string['export'] = '导出';
$string['exportid'] = '导出 ID (可选)';
$string['exportnavlink'] = '导出能力框架';
...
$string['ruleoutcome'] = '规则成果（可选）';
$string['ruletype'] = '规则类型 (可选)';
$string['scaleconfiguration'] = '量尺配置';
$string['scalevalues'] = '量尺值';
$string['shortname'] = '简称';
$string['taxonomy'] = '分类';
