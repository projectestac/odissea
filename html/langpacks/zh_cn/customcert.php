...
/**
 * Strings for component 'customcert', language 'zh_cn', version '4.5'.
 *
 * @package     customcert
 * @category    string
...
$string['code'] = '代码';
$string['emailnonstudentcertificatelinktext'] = '';
...
$string['receiveddate'] = '获奖';
$string['verified'] = '已验证';
$string['verify'] = '验证';
$string['verifycertificate'] = '证书验证';
