...
/**
 * Strings for component 'availability', language 'zh_cn', version '4.5'.
 *
...
$string['hidden_all'] = '如果学生不满足条件就完全隐藏';
$string['hidden_individual'] = '如果学生不满足这个条件就完全隐藏';
...
$string['shown_all'] = '如果学生不满足条件则显示';
$string['shown_individual'] = '如果学生不满足条件则显示';
