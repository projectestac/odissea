...
$string['asyncbackupcompletedetail'] = '备份过程已成功完成。<br/>您可在<a href="{$a}">恢复页面</a>访问备份。';
...
$string['asynccheckprogress'] = '您可以随时在<a href="{$a}">恢复页面</a>上查看进度。';
$string['asyncemailenable'] = '启用通知';
$string['asyncemailenabledetail'] = '如果启用，用户在异步备份或还原完成时将收到一条消息。';
$string['asyncgeneralsettings'] = '异步备份/恢复';
$string['asyncmessagebody'] = '通知';
$string['asyncmessagebodydefault'] = '您的 {operation} （ID： {backupid}） 已成功完成，您可以在此处访问它：<a href="{link}">{link}</a>。';
$string['asyncmessagebodydetail'] = '异步备份或还原完成时发送的通知';
$string['asyncmessagesubject'] = '主题';
$string['asyncmessagesubjectdefault'] = 'Moodle{operation}成功完成';
$string['asyncmessagesubjectdetail'] = '通知主题';
...
$string['asyncrestorecompletedetail'] = '恢复过程已成功完成。单击“继续”将带您进入还原项目的<a href="{$a}">课程</a>';
...
$string['backupautoactivitiesdescription'] = '设置在备份中包含活动的默认值。要使回收站正常工作，必须启用此设置。';
...
$string['backupthenrestore'] = '备份完成，开始恢复。';
...
$string['choosefilefromactivitybackup_help'] = '此活动的备份文件';
$string['choosefilefromautomatedbackup'] = '自动备份';
$string['choosefilefromautomatedbackup_help'] = '自动生成的备份';
$string['choosefilefromcoursebackup'] = '课程备份区';
$string['choosefilefromcoursebackup_help'] = '此课程的备份';
$string['choosefilefromuserbackup'] = '用户私人备份区';
$string['choosefilefromuserbackup_help'] = '所有课程的私人备份文件，含有匿名用户信息';
...
$string['configgeneralcustomfield'] = '设置在备份中包括自定义字段的默认值。';
...
$string['configgeneralxapistate'] = '设置在备份中的内容（如 H5P 活动）中包含用户状态的默认值。';
...
$string['configrestorecustomfield'] = '设置默认恢复自定义字段。';
...
$string['configrestorexapistate'] = '设置在内容（如 H5P 活动）中恢复用户状态的默认值。';
...
$string['copycoursedesc'] = '在任何课程类别中创建此课程的副本';
$string['copycourseheading'] = '复制课程';
$string['copycoursetitle'] = '复制课程：{$a}';
$string['copydest'] = '目的地';
$string['copyfieldnotfound'] = '未找到字段：{$a}所需的字段数据。';
...
$string['enableasyncbackup_help'] = '如果启用，备份和还原操作将异步完成。这提供了更好的用户体验，允许用户在备份或还原过程中执行其他操作。这不会影响进出口。';
...
$string['generalcustomfield'] = '包含自定义字段';
...
$string['generalxapistate'] = '在H5P活动等内容中包含用户的状态';
...
$string['importfile'] = '导入备份文件';
$string['importfromccmidtocourse'] = '从 cmid：{$a->srccmid} 导入到 course：{$a->dstcourseid}';
$string['importfromcoursetocourse'] = '从 course：{$a->srccourseid} 导入到 course：{$a->dstcourseid}';
...
$string['managefiles_activity'] = '管理活动备份';
$string['managefiles_automated'] = '管理自动备份';
$string['managefiles_backup'] = '管理私人备份';
$string['managefiles_course'] = '管理课程备份';
...
$string['pendingasyncedit'] = '本课程有待处理的备份或副本请求。在完成之前，请不要编辑课程。';
...
$string['questioncannotberestored'] = '这些题目“{$a->name}”不能用还原来创建';
$string['recyclebin_desc'] = '请注意这些设置也用于回收站。';
...
$string['restoreexecutionsuccess'] = '课程已成功恢复';
...
$string['restorenofilesbackuparea'] = '没有备份文件';
$string['restorenofilesbackuparea_activity'] = '没有此活动的备份文件';
$string['restorenofilesbackuparea_automated'] = '没有自动备份文件';
$string['restorenofilesbackuparea_backup'] = '没有私人备份文件';
$string['restorenofilesbackuparea_course'] = '没有此课程的备份文件';
