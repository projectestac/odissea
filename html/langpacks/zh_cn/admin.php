...
$string['oracledatabaseinuse'] = '将删除 Oracle DB 支持。Moodle 4.5 将是支持 Oracle DB 的最后一个版本。详见关于 moodle.org <a href=“https://moodle.org/mod/forum/discuss.php?d=456122”>LMS中Oracle 数据库支持停用的公告</a>。';
$string['order1'] = '第一';
$string['order2'] = '第二';
$string['order3'] = '第三';
$string['order4'] = '第四';
