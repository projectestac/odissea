...
$string['xmlrpcmaharaenabled'] = '已检测到您的网站已启用Mahara ePortfolio。此功能依赖于PHP不再维护的PHP XML-RPC扩展。';
$string['xmlrpcmnetenabled'] = '检测到您的站点上已启用Moodle网络。此功能依赖于PHP不再维护的PHP XML-RPC扩展。';
