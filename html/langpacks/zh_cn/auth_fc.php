...
/**
 * Strings for component 'auth_fc', language 'zh_cn', branch 'MOODLE_32_STABLE'
 *
 * @package   auth_fc
...
$string['auth_fcconnfail'] = '连接失败。错误号：{$a->no}，错误字符串：{$a->str}';
...
$string['pluginname'] = '使用 FirstClass 服务器';
