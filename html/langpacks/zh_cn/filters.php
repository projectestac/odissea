...
/**
 * Strings for component 'filters', language 'zh_cn', version '3.11'.
 *
 * @package     filters
 * @category    string
...
$string['actfilterhdr'] = '活动过滤器';
$string['addfilter'] = '添加过滤器';
$string['anycategory'] = '任何类别';
$string['anycourse'] = '任何课程';
$string['anycourses'] = '注册任何课程';
$string['anyfield'] = '任何字段';
$string['anyrole'] = '任何角色';
$string['anyvalue'] = '任意值';
$string['applyto'] = '应用到';
...
$string['nofiltersenabled'] = '本站没有打开任何过滤器插件。';
$string['off'] = '关闭';
