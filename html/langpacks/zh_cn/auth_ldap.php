...
$string['diag_contextnotfound'] = '上下文{$a}不存在或无法被绑定的DN读取。';
$string['diag_emptycontext'] = '找到空的上下文';
$string['diag_genericerror'] = 'LDAP错误 {$a->code} 读取 {$a->subject}: {$a->message}.';
$string['diag_rolegroupnotfound'] = '角色{$a->localname}的组{$a->Group}不存在或无法被绑定DN读取。';
$string['diag_toooldversion'] = '现代的LDAP服务器不太可能使用LDAPv2协议。错误的设置可能会损坏用户字段中的值。请与LDAP管理员联系。';
