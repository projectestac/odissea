...
/**
 * Strings for component 'editor_atto', language 'zh_cn', version '4.5'.
 *
 * @package     editor_atto
 * @category    string
...
$string['privacy:metadata:database:atto_autosave'] = '自动保存的文本编辑器草稿。';
$string['privacy:metadata:database:atto_autosave:drafttext'] = '保存的文本。';
...
$string['taskautosavecleanup'] = '删除过期的自动保存草稿';
