...
/**
 * Strings for component 'qtype_truefalse', language 'zh_cn', version '4.1'.
 *
...
$string['pleaseselectananswer'] = '请选择答案。';
$string['pluginname'] = '判断题';
$string['pluginname_help'] = '在回答一个问题（可能包括图像）时，答题者从正确或错误进行选择。';
...
$string['showstandardinstruction_help'] = '是否在正确/错误答案之前显示说明“选择一项：”';
$string['true'] = '对';
