...
/**
 * Strings for component 'imscp', language 'zh_cn', version '4.4'.
 *
 * @package     imscp
 * @category    string
...
$string['page-mod-imscp-x'] = '任意 IMS 内容包模块页';
$string['pluginadministration'] = 'IMSCP 管理';
$string['pluginname'] = 'IMS 内容包';
$string['privacy:metadata'] = 'IMS内容包插件不存储任何个人数据。';
$string['search:activity'] = 'IMS内容包-资源信息';
$string['toc'] = '目录';
