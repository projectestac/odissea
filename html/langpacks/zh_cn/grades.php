...
$string['aria-toggledropdown'] = '切换下拉列表';
$string['aria:dropdowngrades'] = '对找到的项目评分';
...
$string['calculationwarning'] = '此类别对类别总计使用成绩计算，而不是加和。';
...
$string['coursesettingsexplanation'] = '课程成绩设置决定了成绩簿对课程中所有参与者的显示方式';
...
$string['errorcalculationbroken'] = '等级项目{$a}计算错误';
...
$string['erroroverweight'] = '总重量超过100%。';
...
$string['errorunderweight'] = '总权重小于100%。';
...
$string['eventgradeexported'] = '成绩已导出';
...
$string['linktoactivity'] = '{$a->name} 活动 {$a->title}';
$string['lock'] = '锁定';
$string['locked'] = '锁定';
...
$string['missingitemtypeoreid'] = '缺少数组键（itemtype 或 eid）';
...
$string['moveselectedto'] = '将所选项目移动到：';
$string['movesitems'] = '移动项目';
...
$string['nonunhideableverbose'] = '要取消隐藏这个等级，需要取消隐藏{$a->itemname}。';
...
$string['scaledpct'] = '调整%';
$string['searchcollapsedcolumns'] = '搜索折叠栏';
...
$string['showingaggregatesonly'] = '只显示总分';
$string['showingfullmode'] = '显示成绩和总分';
