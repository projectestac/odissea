...
/**
 * Strings for component 'assignment', language 'zh_cn', version '4.5'.
 *
 * @package     assignment
 * @category    string
...
$string['privacy:metadata:assignment_submissions:grade'] = '为作业提交给出的分数。';
$string['privacy:metadata:assignment_submissions:mailed'] = '已发送作业提交通知的状态。';
$string['privacy:metadata:assignment_submissions:numfiles'] = '作业提交所允许的最大文件数。';
$string['privacy:metadata:assignment_submissions:submissioncomment'] = '作业提交附带的提交评论。';
$string['privacy:metadata:assignment_submissions:teacher'] = '作业提交进行评分的教师用户标识。';
$string['privacy:metadata:assignment_submissions:timecreated'] = '作业提交创建的日期/时间。';
