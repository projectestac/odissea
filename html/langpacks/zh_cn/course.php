...
$string['activitynavigation'] = '活动导航';
$string['activitynavigation:jumptoactivity'] = '跳转到活动';
$string['activitynavigation:nexta'] = '下个活动：{$a}';
$string['activitynavigation:preva'] = '上个活动：{$a}';
...
$string['aria:favourite'] = '课程已收藏';
$string['aria:favouritestab'] = '收藏的活动';
...
$string['privacy:favouritespath'] = '课程收藏信息';
$string['privacy:metadata:activityfavouritessummary'] = '课程系统包含用户在活动选择器中收藏项目的信息。';
$string['privacy:metadata:completionsummary'] = '此课程包含用户的课程进度信息。';
$string['privacy:metadata:favouritessummary'] = '课程包含用户收藏课程的相关信息。';
