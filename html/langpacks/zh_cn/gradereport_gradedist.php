...
/**
 * Strings for component 'gradereport_gradedist', language 'zh_cn', version '4.1'.
 *
...
$string['changeletters'] = '修改分数段';
$string['confirm'] = '修改分数段';
$string['gradeboundary_help'] = '使用本设置规定达到某一分数段的最低百分比成绩。';
$string['gradeletter'] = '分数段';
$string['newcolumns'] = '新建分数段';
$string['newletterssubmitted'] = '新分数段已提交';
$string['newletterssubmitted_description'] = 'ID为{$a->userid}的用户提交了新分数段。';
$string['notification'] = '注意:分数段定义适用于课程的所有成绩项。';
