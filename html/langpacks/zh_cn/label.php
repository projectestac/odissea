...
$string['configdndmedia'] = '在将媒体文件拖放到课程上时提供创建标签';
$string['configdndresizeheight'] = '从拖放的图像创建标签时，如果标签的大小高于这么多像素，请调整标签的大小（0表示不调整大小）';
$string['configdndresizewidth'] = '从拖放的图像创建标签时，如果标签宽度超过这么多像素，请调整标签大小（0表示不调整大小）';
$string['dndmedia'] = '媒体拖放';
$string['dndresizeheight'] = '调整拖放高度';
$string['dndresizewidth'] = '调整拖放宽度';
$string['dnduploadlabel'] = '将媒体添加到课程页面';
$string['dnduploadlabeltext'] = '将标签添加到课程页面';
...
$string['privacy:metadata'] = '标签资源插件不存储任何个人数据。';
