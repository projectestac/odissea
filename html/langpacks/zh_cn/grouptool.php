...
$string['agroups'] = '激活组';
$string['ajax_edit_size_help'] = '保存新的大小，使用 &lt;Enter&gt;, 使用 &lt;ESC&gt; 如果要放弃，保持为空来删除个数';
...
$string['allow_reg_help'] = '允许学生自行注册以便学生能自己在下面选择并注册到想加入的组。';
...
$string['calendaravailable'] = '已开放了{$a} 个注册';
...
$string['cfg_instance_head'] = '默认分组实例设置';
$string['cfg_instance_head_info'] = '新建分组实例时的默认设置';
...
$string['cfg_moodlesync_head_info'] = '决定在moodle组成员变化或单个组被删除后，分组工具应该怎么处理成员或组';
...
$string['choose'] = '选择...';
$string['choose_group'] = '必须选择一个要加入的组！';
...
$string['completiondetail:register'] = '注册组： {$a}';
...
$string['eventregistrationcreated'] = '新注册已完成';
...
$string['forceregistration'] = '在 分组工具 中强制注册';
...
$string['group_assign_error'] = '无法分配到组！';
$string['group_assign_error_prev'] = '不能分配到组！';
...
$string['myoverview_registrations_missing'] = '未有注册信息';
...
$string['registration_missing'] = '1个未注册';
...
$string['registrations_missing'] = '{$a} 未注册';
...
$string['showownafterreg'] = '本人 - 组成员注册后';
$string['size'] = '组容量';
