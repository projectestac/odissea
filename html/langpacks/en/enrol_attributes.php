...
/**
 * Strings for component 'enrol_attributes', language 'en', version '3.11'.
 *
...
$string['profilefields_desc'] = 'Which user profile fields can be used when configuring an enrolment instance?<br><br><b>If you don\'t select any attribute here, this makes the plugin moot and hence disables its use in courses.</b><br>The feature below may however still be used in this case.';
