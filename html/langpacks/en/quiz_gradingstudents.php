...
/**
 * Strings for component 'quiz_gradingstudents', language 'en', version '3.11'.
 *
...
$string['confirmationcode'] = '<strong>confirmation code</strong> {$a}';
...
$string['personalidentifier'] = '<strong>Personal identifier</strong> {$a}';
