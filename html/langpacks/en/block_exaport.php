...
$string['cancel_edit_comment'] = 'cancel comment editing';
$string['capability_required'] = 'You do not have permission to manage preset structure';
$string['categories'] = 'Categories';
$string['categories_created'] = 'Categories created: {$a}';
$string['categories_skipped'] = 'Categories skipped (already exist): {$a}';
...
$string['category_moved'] = 'Category moved successfully';
...
$string['configureblock_badge'] = 'Choose Badges';
$string['configureblock_cv_information'] = 'Choose cv info';
$string['configureblock_cvinfo_group_by_category'] = 'Display CV elements in categories';
$string['configureblock_headline'] = 'Choose headline';
$string['configureblock_item'] = 'Choose artefact';
$string['configureblock_media'] = 'Choose media';
$string['configureblock_personal_information'] = 'Choose personal info';
$string['configureblock_text'] = 'Choose text';
...
$string['distribution_summary'] = 'Distribution Summary';
...
$string['savecommentchanges'] = 'Save changes';
...
$string['settings_enable_category_distribution_body'] = 'Show or hide the "Preset structure" navigation area.';
$string['settings_enable_category_distribution_head'] = 'Show "Preset structure" area';
$string['settings_enable_importexport_body'] = 'Show or hide the "Import/Export" navigation area.';
$string['settings_enable_importexport_head'] = 'Show "Import/Export" area';
$string['settings_enable_myportfolio_body'] = 'Show or hide the "My Portfolio Artefacts" navigation area.';
$string['settings_enable_myportfolio_head'] = 'Show "My Portfolio Artefacts" area';
$string['settings_enable_resume_body'] = 'Show or hide the "My CV" navigation area.';
$string['settings_enable_resume_head'] = 'Show "My CV" area';
$string['settings_enable_shared_categories_body'] = 'Show or hide the "Shared Categories" navigation area.';
$string['settings_enable_shared_categories_head'] = 'Show "Shared Categories" area';
$string['settings_enable_shared_views_body'] = 'Show or hide the "Shared Portfolios" navigation area.';
$string['settings_enable_shared_views_head'] = 'Show "Shared Portfolios" area';
$string['settings_enable_views_body'] = 'Show or hide the "My Portfolios" navigation area.';
$string['settings_enable_views_head'] = 'Show "My Portfolios" area';
$string['settings_enable_whyeportfolio_body'] = 'Show or hide the "Why ePortfolio" navigation area.';
$string['settings_enable_whyeportfolio_head'] = 'Show "Why ePortfolio" area';
...
$string['settings_show_course_navbar_body'] = 'When enabled, the Moodle course navigation bar (Course, Participants, Grades, etc.) is shown on ePortfolio pages. Disable to show a cleaner interface without course tabs.';
$string['settings_show_course_navbar_head'] = 'Show course navigation bar';
...
$string['starter_template_loaded'] = 'Starter template loaded successfully';
...
$string['students_processed'] = 'Students processed: {$a}';
