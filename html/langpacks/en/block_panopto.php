...
/**
 * Strings for component 'block_panopto', language 'en', version '3.11'.
 *
...
$string['block_panopto_panopto_connection_timeout_desc'] = 'Timeout in seconds for connecting Panopto. Change the value only when Panopto support advises.';
$string['block_panopto_panopto_socket_timeout'] = 'Panopto Socket Timeout';
$string['block_panopto_panopto_socket_timeout_desc'] = 'How long in seconds the Plugin will wait for Panopto to complete a task after connecting. Change the value only when Panopto support advises.';
...
$string['block_panopto_sso_sync_type_desc'] = 'Select the behavior for user syncing when accessing Panopto content. Users can be sync\'d at the same time as they are logged into Panopto, or in the background using an asynchronous task after they have successfully logged in.';
...
$string['block_panopto_sync_on_enrolment_desc'] = 'Synchronizes the permission when a student is enroled into a course with a valid Panopto folder. When disabled, users will be sync\'d with Panopto when the user views the Panopto block. This feature can be enabled if you do not intend to use the block in a course, or if a course has embedded Panopto content directly into the course homepage (content will load before the block syncs in this case). Note that enabling this feature may cause a performance slowdown when enroling users.';
