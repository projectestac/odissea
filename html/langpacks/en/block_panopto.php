...
/**
 * Strings for component 'block_panopto', language 'en', version '4.5'.
 *
...
$string['block_panopto_api_throttling_heading'] = 'API Throttling Settings';
...
$string['block_panopto_enable_api_throttling'] = 'Enable SOAP API Throttling';
$string['block_panopto_enable_api_throttling_desc'] = 'Enable intelligent throttling for Panopto API operations. Uses adaptive throttling with automatic retry logic to prevent 500 errors during bulk operations. Recommended to keep enabled.';
...
$string['block_panopto_lti_category_provisioning'] = 'Enable LTI Tools Category Provisioning';
$string['block_panopto_lti_category_provisioning_desc'] = 'When enabled, courses provisioned through LTI tools (Student Submission, Course Embed, Atto LTI, TinyMCE LTI) will respect the Moodle category structure settings and be created in the appropriate category folders instead of at the top level. This setting works in conjunction with the "Create Category Folders on Course (Re)provision" option to ensure LTI-provisioned courses follow the same category hierarchy as block-provisioned courses.';
...
$string['block_panopto_print_verbose_logs_desc'] = 'When selected, more logs will be added to the Panopto PHP error_log and detailed WSDL trace logging will be enabled. This creates extensive logs and should only be selected on an as-needed basis for debugging purposes.';
...
$string['block_panopto_wsdl_caching_enabled_desc'] = 'When enabled (default), WSDL files will be cached to improve performance and reduce server load. When disabled, WSDL files are downloaded on every request. Disable this setting only if experiencing WSDL-related issues or if advised by Panopto Support.';
...
$string['bulk_task_access_error'] = 'TASK BLOCKED: The user {$a} does not have access to a provisioned Panopto course folder. Working user must have at least viewer access to all Panopto course folders for bulk operations. It is highly reccommended that the working user is an Administrator on Panopto.';
$string['bulk_task_config_error'] = 'TASK BLOCKED: Configuration validation failed. {$a}';
$string['bulk_task_config_validation'] = 'Validating Panopto configuration against server';
...
$string['config_error_auth_failed'] = 'Authentication failed with Panopto server. Check application key and instance name.';
$string['config_error_instance_mismatch'] = 'Instance name "{$a->moodle_instance}" does not match Panopto server expectation. This may indicate production configuration in a test environment.';
$string['config_error_invalid_server_config'] = 'Invalid server configuration. Server name or application key is missing/incorrect.';
$string['config_error_server_unreachable'] = 'Cannot connect to Panopto server "{$a}". Check server URL and network connectivity.';
$string['config_validation_success'] = 'Configuration validation successful - proceeding with bulk operation';
...
$string['loading_content'] = 'Loading Panopto content...';
