...
/**
 * Strings for component 'tiny_cloze', language 'en', version '4.4'.
 *
 * @package     tiny_cloze
 * @category    string
...
$string['err_invalid_brackets'] = 'Opening and closing brackets do not match in regular expression.';
$string['err_invalid_chars'] = 'Special chars like . ^ $ * + { } \\ / must be escaped in correct regular expression.';
