...
/**
 * Strings for component 'facetoface', language 'en', version '4.5'.
 *
 * @package     facetoface
 * @category    string
...
$string['facetoface:uploadbookingsfiledesc'] = 'Fields expected:
...
$string['facetofaceattendee'] = 'Face-to-Face attendee';
...
$string['facetofacesessiondates'] = 'Face-to-Face session dates';
...
$string['icalendarclass:confidential'] = 'Confidential';
$string['icalendarclass:private'] = 'Private';
$string['icalendarclass:public'] = 'Public';
...
$string['setting:icalendarclass_caption'] = 'Default iCalendar event privacy level';
$string['setting:icalendarclass_desc'] = 'Select the default privacy level (CLASS) for events when exporting to iCalendar.';
...
$string['setting:visiblefield'] = 'Show the field as an additional column on the session list view.';
$string['setting:visiblefield_caption'] = 'Visible field on course page';
