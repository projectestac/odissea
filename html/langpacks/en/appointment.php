...
/**
 * Strings for component 'appointment', language 'en', version '3.11'.
 *
 * @package     appointment
 * @category    string
...
$string['appointmentbooking'] = 'Appointment booking';
...
$string['edit'] = 'Edit';
$string['editappointment'] = 'Edit appointment';
...
$string['entitiyappointment'] = 'Appointment';
$string['entitiysession'] = 'Session';
$string['error:addalreadysignedupattendee'] = '{$a} is already signed-up for this Appointment activity.';
$string['error:addattendee'] = 'Could not add {$a} to the session.';
$string['error:appointmentfailedupdatestatus'] = 'Appointment failed to update the user\'s status';
...
$string['error:cannotconfigurecustomfields'] = 'You are not allowed to configure custom fields.';
...
$string['error:couldnotaddtrainer'] = 'Could not save new Appointment session trainer';
...
$string['error:couldnotdeletetrainer'] = 'Could not delete a Appointment session trainer';
...
$string['error:couldnotupdateappointmentrecord'] = 'Could not update Appointment signup record in database';
...
$string['error:cronprefix'] = 'Error: Appointment cron:';
...
$string['error:incorrectappointmentid'] = 'Appointment ID was incorrect';
...
$string['error:incorrectcoursemodulesession'] = 'Course Module Appointment Session was incorrect';
...
$string['mods_help'] = 'Appointment activities are used to keep track of in-person trainings which require advance booking.
...
$string['noappointments'] = 'There are no Appointment activities';
...
$string['privacy:metadata:appointment_session_roles'] = 'Lists users with a trainer role in a appointment session';
$string['privacy:metadata:appointment_signups'] = 'User signups to Appointment sessions';
$string['privacy:metadata:appointment_signups:discountcode'] = 'The discount code entered by the user';
...
$string['privacy:metadata:appointment_signups:notificationtype'] = 'How the user would like to be notified.';
...
$string['really'] = 'Do you really want to delete all results for this Appointment?';
$string['registeredon'] = 'Registered On';
$string['registrations'] = 'Registrations';
$string['reminder'] = 'Reminder';
$string['reminderinstrmngr'] = '# Notice for Manager';
$string['reminderinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for Manager** field is sent to a learner\'s manager advising that they have signed up for a Appointment session.';
...
$string['reportbuildersessionslist'] = 'Viewing the list of sessions is impossible without plugin tool_reportbuilder';
...
* The staff member and the staff member\'s manager will be sent a confirmation email (i.e., the one formatted per the "Confirmation message" section of the Appointment instance\'s settings).
* The staff member will be sent a reminder email message (i.e., the one formatted per the "Reminder message" section of the Appointment instance\'s settings). The reminder will be sent a number of days before the session, according to the "Days before message is sent" setting also found in the "Reminder message" section of the Appointment instance\'s settings.
...
* The staff member will be sent a confirmation email (i.e. the one formatted per the "Wait-listed message" section of the Appointment instance\'s settings).
...
$string['sessionsoncoursepage_help'] = 'This is the number of sessions for each Appointment activity that will be shown on the main course page.';
