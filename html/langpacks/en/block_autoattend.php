...
/**
 * Strings for component 'block_autoattend', language 'en', version '3.11'.
 *
...
This function can only be executed by an administrator.';
$string['deletedb_info'] = 'There are <strong>{$a->delnum}</strong> sessions data to be deleted before <strong>{$a->delstr}</strong>.';
...
$string['email_teacher_key_html'] = 'The keyword of {$a->fullname} [{$a->date} {$a->starttm}-{$a->endtm}] is <strong>{$a->key}</strong>';
...
$string['installpairmod'] = '<strong>Please Install Module (mod_autoattendmod)</strong>';
$string['instancepairmod'] = '<strong>Please Create Instance of Module (mod_autoattendmod) in this Course</strong>';
$string['ip'] = 'IP';
...
$string['settingpairmod'] = '<strong>Setting of Module (mod_autoattedmod)</strong>';
