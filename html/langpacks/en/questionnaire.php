...
/**
 * Strings for component 'questionnaire', language 'en', version '4.5'.
 *
...
$string['timedeletednext7days'] = '<span class="timedeletednext7days">Time of permanent deletion: night of {$a}</strong>';
$string['title'] = 'Title';
