...
/**
 * Strings for component 'geogebra', language 'en', version '4.5'.
 *
 * @package     geogebra
 * @category    string
...
$string['height_help'] = 'Value in pixels. Must be greater than zero.';
...
$string['width'] = 'Width';
$string['width_help'] = 'Value in pixels. Must be greater than zero.';
