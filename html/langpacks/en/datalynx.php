...
/**
 * Strings for component 'datalynx', language 'en', version '4.5'.
 *
 * @package     datalynx
 * @category    string
...
$string['admissibleroleserror'] = 'Please select at least one role!';
...
$string['andor'] = 'and/or ...';
$string['anyof'] = 'any of';
$string['approvalnone'] = 'Not required';
$string['approvalrequirednew'] = 'Required only for new entries';
$string['approvalrequiredupdate'] = 'Required for new entries and edited entries';
...
$string['autocompletiontextfield'] = 'Textfield';
$string['autocompletiontextfield_help'] = 'Choose datalynx module and textfield to retrieve the autocompletion data of.';
...
$string['cachedefpatterns'] = 'Patterns (Cache)';
$string['checkenable'] = 'You must mark \'enable\' checkbox to confirm the validity of the selected value.';
...
$string['datalynxcommentadded'] = 'Comment added';
$string['datalynxentryadded'] = 'Entry added';
$string['datalynxentryapproved'] = 'Entry approved';
$string['datalynxentrydeleted'] = 'Entry deleted';
$string['datalynxentrydisapproved'] = 'Entry disapproved';
$string['datalynxentryupdated'] = 'Entry updated';
$string['datalynxmemberadded'] = 'Team member added';
$string['datalynxmemberremoved'] = 'Team member removed';
$string['datalynxratingadded'] = 'Rating added';
$string['datalynxratingdeleted'] = 'Rating deleted';
$string['datalynxratingupdated'] = 'Rating updated';
...
$string['equal'] = 'equal';
$string['errnumeric'] = 'You must enter a number here. Example: 0.00 or 0.3 or 387';
...
$string['fieldhasduplicateentries'] = 'There are duplicate entries, therefore it\'s not possible to set this field to Unique:"Yes" at the moment!';
...
$string['fromaftertodayerror'] = '\'From\' date cannot be set after today\'s date!';
$string['fromdate'] = 'From date';
$string['fromfile'] = 'Import from zip file';
$string['fromtoerror'] = '\'From\' date cannot be set after \'To\' date!';
...
$string['limitchoiceerror'] = 'You have already selected option \'{$a}\' the maximum allowed number of times!';
$string['line'] = 'Line';
$string['linksettings'] = 'Message link settings';
$string['linktoentry'] = 'Link to entry';
$string['listformat'] = 'List format';
$string['listformatcomma'] = 'Comma separated';
$string['listformatcommaspace'] = 'Comma separated with space';
$string['listformatnewline'] = 'Newline separated';
$string['listformatspace'] = 'Space separated';
$string['listformatul'] = 'Unordered list';
$string['lock'] = 'Lock';
...
$string['maxteamsizeerrorform'] = 'You can select only a maximum of {$a} team members!';
...
$string['targetviewdefault'] = '(Default)';
$string['targetviewedit'] = '(Edit)';
$string['targetviewforroles'] = 'Link target views for roles';
$string['targetviewmore'] = '(More)';
$string['targetviewthis'] = '(This view)';
$string['targetviewthisnew'] = 'This view (New)';
...
$string['teamsizeerrorrequired'] = 'This field is required!';
$string['teamsizeerrorvalue'] = 'The value must be a positive integer!';
...
$string['timefieldrequired'] = '{$a} field is required!';
...
$string['uniquerequired'] = 'Unique text required! This text was already used!';
