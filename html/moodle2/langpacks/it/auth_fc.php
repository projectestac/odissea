...
/**
 * Strings for component 'auth_fc', language 'it', branch 'MOODLE_31_STABLE'
 *
 * @package   auth_fc
...
$string['auth_fcconnfail'] = 'Connessione fallita con errore numero {$a->no} e stringa di errore {$a->str}';
