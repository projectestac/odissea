...
/**
 * Strings for component 'repository_filesystem', language 'it', branch 'MOODLE_31_STABLE'
 *
...
$string['nosubdir'] = 'Per poter scegliere una cartella, devi crearne almeno una all\'interno della cartella <b>{$a}</b>.';
