...
/**
 * Strings for component 'qtype_calculatedmulti', language 'it', branch 'MOODLE_34_STABLE'
 *
...
$string['answeroptions'] = 'Opzioni scelta';
$string['answeroptions_help'] = 'La formula consigliata è ...<strong>{={x}+..}</strong>...';
...
$string['privacy:metadata'] = 'Il plugin Tipo di domande \'Scelta multipla calcolata\' non memorizza dati personali.';
