...
/**
 * Strings for component 'enrol_ldap', language 'it', branch 'MOODLE_36_STABLE'
 *
 * @package   enrol_ldap
...
$string['syncenrolmentstask'] = 'Sincronizzazione iscrizioni LDAP';
...
$string['user_attribute'] = 'Se l\'appartenenza al gruppo contiene <i>distinguished names</i>, specificare l\'attributo utilizzato per nominare/cercare l\'utente. Se è configurata anche l\'autenticazione LDAP, questo valore deve corrispondere all\'attributo \'Codice identificativo\' configurato nella mappatura dati del plugin di autenticazione LDAP';
$string['user_attribute_key'] = 'Attributo Codice identificativo';
$string['user_contexts'] = 'Se l\'appartenenza al gruppo contiene <i>distinguished names</i>, specificare l\'elenco dei contesti dove si trovano gli utenti. Separare contesti diversi con \';\'. Ad esempio: \'ou=users,o=org; ou=others,o=org\'';
$string['user_contexts_key'] = 'Contesti';
$string['user_search_sub'] = 'Se l\'appartenenza al gruppo contiene <i>distinguished names</i>, specificare se ricercare gli utenti anche nei sotto contesti.';
