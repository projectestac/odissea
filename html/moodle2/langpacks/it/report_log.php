...
/**
 * Strings for component 'report_log', language 'it', branch 'MOODLE_36_STABLE'
 *
 * @package   report_log
...
$string['eventreportviewed'] = 'Visualizzato report log';
$string['eventuserreportviewed'] = 'Visualizzato report log utente';
