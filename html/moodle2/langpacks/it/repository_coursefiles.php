...
/**
 * Strings for component 'repository_coursefiles', language 'it', branch 'MOODLE_31_STABLE'
 *
...
$string['configplugin'] = 'Configurazione repository File legacy del corso';
$string['coursefiles:view'] = 'Utilizzare plugin File del corso';
