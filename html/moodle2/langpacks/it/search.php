...
/**
 * Strings for component 'search', language 'it', branch 'MOODLE_31_STABLE'
 *
 * @package   search
...
$string['beadmin'] = 'Bisogna essere Amministratori per usare questa pagina.';
$string['checkdb'] = 'Controllo database';
$string['checkdbadvice'] = 'Controllare Database per possibili problemi';
...
$string['filterheader'] = 'Filltro';
$string['fromtime'] = 'Modificato dopo';
...
$string['totime'] = 'Modificato prima';
$string['type'] = 'Tipo';
