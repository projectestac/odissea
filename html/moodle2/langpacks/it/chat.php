...
/**
 * Strings for component 'chat', language 'it', branch 'MOODLE_31_STABLE'
 *
 * @package   chat
...
$string['search:activity'] = 'Chat - Informazioni sull\'attività';
...
$string['sessionstart'] = 'La prossima sessione di chat inizierà il {$a}, ({$a->fromnow} da adesso)';
