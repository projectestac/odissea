...
/**
 * Strings for component 'calendar', language 'it', branch 'MOODLE_32_STABLE'
 *
 * @package   calendar
...
$string['addevent'] = 'Aggiungi evento';
...
$string['errorinvalidbydayprefix'] = 'I valori interi che precedono la regola BYDAY possono essere presenti solo per RRULE MONTHLY o YEARLY.';
...
$string['errorrrule'] = 'Il rrule sembra non corretto';
$string['errorrruleday'] = 'Il parametro giorno del rrule non è valido';
$string['errorrrulefreq'] = 'Il parametro frequenza del rrule non è valido';
$string['eventcalendareventcreated'] = 'Creato evento di calendario';
$string['eventcalendareventdeleted'] = 'Eliminato evento di calendario';
$string['eventcalendareventupdated'] = 'Aggiornato evento di calendario';
...
$string['eventsubscriptioncreated'] = 'Creata sottoscrizione al calendario';
$string['eventsubscriptiondeleted'] = 'Eliminata sottoscrizione al calendario';
$string['eventsubscriptionupdated'] = 'Aggiornata sottoscrizione al calendario';
$string['eventsupdated'] = 'Eventi aggiornati: {$a}';
$string['eventtime'] = 'Ora';
$string['eventview'] = 'Dettagli evento';
$string['expired'] = 'Terminato';
$string['explain_site_timeformat'] = 'E\' possibile visualizzare l\'orario nel formato a 12 o 24 ore. Scegliendo "default" il formato sarà scelto automaticamente dalle impostazioni della lingua usata nel sito. L\'impostazione può essere modificata dalle preferenze dell\'utente.';
...
$string['hideuserevents'] = 'Nascondi eventi dell\'utente';
...
$string['showcourseevents'] = 'Visualizza eventi dei corsi';
$string['showglobalevents'] = 'Visualizza eventi globali';
$string['showgroupsevents'] = 'Visualizza eventi di gruppo';
$string['shown'] = 'visibili';
$string['showuserevents'] = 'Visualizza eventi dell\'utente';
...
$string['subsource'] = 'Origine dell\'evento: {$a->name}';
$string['sun'] = 'Dom';
...
$string['tt_hidecourse'] = 'Eventi corso visualizzati (clicca per nascondere)';
$string['tt_hideglobal'] = 'Eventi generali visualizzati (clicca per nascondere)';
$string['tt_hidegroups'] = 'Eventi gruppo visualizzati (clicca per nascondere)';
$string['tt_hideuser'] = 'Eventi utente visualizzati (clicca per nascondere)';
$string['tt_showcourse'] = 'Eventi corso nascosti (clicca per visualizzare)';
$string['tt_showglobal'] = 'Eventi generali nascosti (clicca per visualizzare)';
$string['tt_showgroups'] = 'Eventi gruppo nascosti (clicca per visualizzare)';
$string['tt_showuser'] = 'Eventi utente nascosti (clicca per visualizzare)';
$string['tue'] = 'Mar';
