...
/**
 * Strings for component 'block_completion_progress', language 'it', branch 'MOODLE_34_STABLE'
 *
...
$string['how_activitiesincluded_works_help'] = '<p>Per default, tutte le attività con l\'impostazione di completamento sono presenti nella barra.</p><p>Si possono selezionare manualmente le attività da includere.</p>';
