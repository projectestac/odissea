...
/**
 * Strings for component 'grades', language 'it', branch 'MOODLE_28_STABLE'
 *
 * @package   grades
...
$string['categoriesedit'] = 'Modifica impostazioni';
...
$string['eventgradeviewed'] = 'Visualizzate valutazioni nel registro del valutatore';
...
$string['gradealreadyupdated'] = '{$a} valutazioni non sono state importate poiché le valutazioni contenuti nel file di importazione sono più vecchie di quelle presenti nel registro del valutatore. Per importare comunque le valutazioni, usare l\'impostazione "Forza importazione".';
...
$string['modgradeerrorbadpoint'] = 'E\' stato inserito un voto non valido. Deve essere un intero compreso tra 0 e {$a}';
...
$string['removeallcoursegrades_help'] = 'Selezionando la casella, saranno eliminati tutti gli elementi di valutazione manualmente aggiunti al registro del valutatore e tutte le valutazioni modificate, escluse, nascoste o bloccate. Saranno mantenute solo le valutazioni associate alle attività.';
$string['removeallcourseitems'] = 'Elimina tutti gli elementi e le categorie';
$string['removeallcourseitems_help'] = 'Selezionando la casella, saranno eliminati tutti gli elementi di valutazione e le categorie manualmente aggiunti al registro del valutatore e tutte le valutazioni modificate, escluse, nascoste o bloccate. Saranno mantenute solo le valutazioni associate alle attività.';
...
$string['sumofgradesupgradedgrades'] = 'Nota: per effetto dell\'aggiornamento del sito, il metodo di aggregazione "Somma dei voti" è stata cambiata in "Naturale". Poiché questo corso utilizzava il metodo "Somma dei voti", si raccomanda di verificare le variazioni nel registro del valutatore.';
...
$string['userfields_show_help'] = 'Nel registro del valutatore  saranno visualizzati campi utente ulteriori come ad esempio l\'indirizzo email. E\' possibile impostare i campi che saranno visualizzati tramite l\'impostazione "showuseridentity" disponibile a livello di sito.';
