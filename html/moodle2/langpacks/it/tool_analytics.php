...
$string['invalidanalysablesinfo'] = 'La pagina elenca gli elementi del sito che sono analizzabili ma che non possono essere utilizzati per il modello del pronostico. Gli elementi presenti nell\'elenco non possono essere utilizzati per addestrare il modello del pronostico ed il modello non può utilizzarli per ricavare pronostici.';
$string['invalidanalysablestable'] = 'Tabella degli elementi analizzabili non validi del sito';
