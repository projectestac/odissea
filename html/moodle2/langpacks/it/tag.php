...
$string['eventtagcollcreated'] = 'Creata raccolta di tag';
$string['eventtagcolldeleted'] = 'Eliminata raccolta di tag';
$string['eventtagcollupdated'] = 'Aggiornata raccolta di tag';
...
$string['privacy:metadata:tag:timemodified'] = 'L\'orario della modifica più recente effettuata sul tag.';
$string['privacy:metadata:tag:userid'] = 'L\'utente che ha creato il tag.';
...
$string['showstandard_help'] = 'Durante l\'inserimento di tag è possibile utilizzare nuovi tag oppure imporre l\'utilizzo dei tag standard suggeriti. E\' anche possibile inserire nuovi tag senza che i tag standard vengano suggeriti.';
