...
$string['formerror_disallowedtags'] = 'Hai utilizzato tag HTML che non sono consentiti in elementi trascinabili di tipo testo.';
...
$string['formerror_nobgimage'] = 'Devi selezionare un\'immagine da utilizzare come background per l\'area di trascinamento e rilascio.';
$string['formerror_nofile'] = 'Devi caricare o scegliere il file da utilizzare.';
$string['formerror_nofile3'] = 'Devi selezionare un file immagine oppure eliminare l\'etichetta associata e deselezionare la casella di spunta Illimitato.';
...
$string['formerror_noxleft'] = 'Devi impostare la coordinata x per l\'angolo superiore sinistro di quest\'area di rilascio. Puoi trascinare e rilasciare l\'area di rilascio soprastante oppure impostare la coordinata manualmente.';
$string['formerror_noytop'] = 'Devi impostare la coordinata y per l\'angolo superiore sinistro di quest\'area di rilascio. Puoi trascinare e rilasciare l\'area di rilascio soprastante oppure impostare la coordinata manualmente.';
...
$string['pluginnamesummary'] = 'Immagini e le etichette di testo vengono trascinate e rilasciate su aree definite su un0immagine di sfondo.';
