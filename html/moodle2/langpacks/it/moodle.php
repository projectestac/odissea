...
$string['activityclipboard'] = 'Spostamento dell\'attività :<b>{$a}</b>';
...
$string['addfilehere'] = 'Aggiungi file qui';
...
$string['again'] = 'ancora';
$string['agelocationverification'] = 'Verifica dell\'età e della della nazione';
$string['aimid'] = 'AIM ID';
...
$string['clicktochangeinbrackets'] = '{$a} (Click per cambiare)';
...
$string['coursealreadyfinished'] = 'Corso già terminato';
...
$string['coursedisplay_help'] = 'Consente di impostare il modo con cui saranno visualizzate le sezioni del corso, tutte sulla stessa pagina oppure distribuite su più pagine. L\'impostazione non ha effetto su alcuni tipi di formato, come il formato SCORM.';
...
$string['courseduration_desc'] = 'La durata del corso viene utilizzata per calcolare di default della data di fine del corso. La data di fine del corso viene utilizzata per stabilire se il corso deve apparire o meno nell\'elenco dei corsi di ciascun utente.  Gli utenti potranno comunque accedere al corso anche dopo la data di fine.';
...
$string['courseformatoptions'] = 'Opzioni di formattazione per {$a}';
...
$string['coursehelpshowgrades'] = 'Gli studenti possono essere autorizzati a vedere il proprio registro valutatore. Indipendentemente da questa impostazione, gli studenti potranno comunque visualizzare le valutazioni ricevute nelle singole attività.';
...
$string['coursevisibility_help'] = 'Consente di definire la visibilità di un corso nell\'elenco dei corsi e se uno studente può accedervi. Se il corso è nascosto, potranno accedervi solo i ruoli con il privilegio di visualizzare corsi nascosti.';
$string['create'] = 'Crea';
...
$string['dndnotsupported_help'] = 'Il tuo browser non supporta il caricamento tramite trascina e rilascia.<br />Questa funzione è disponibile in tutte le versioni più recenti di Chrome, Firefox e Safari ed anche da Internet Explorer a partire dalla versione 10.';
...
$string['emailuserhasnone'] = 'L\'utente non ha indirizzo email';
...
$string['enddate_help'] = 'La data di fine del corso viene utilizzata per stabilire se includere o meno un corso nell\'elenco dei corsi dell\'utente. Se la data di fine è trascorsa, il corso non apparirà più nella navigazione e verrà elencato come trascorso nella panoramica corsi. La data di fine corso può anche essere utilizzata da report personalizzati. Gli utenti potranno continuare ad accedere al corso dopo la data di fine, data che non rappresenta impedimento all\'accesso.';
...
$string['format_help'] = 'Il formato imposta la visualizzazione del corpo centrale della pagina home del corso.
...
* Formato Per argomenti -  il corpo centrale della pagina home del corso sarà suddiviso in una sezione per ciascun argomento
* Formato Settimanale - il copro centrale della pagina home del corso sarà suddiviso in una sezione per ciascuna settimana. La data di inizio della prima settimana coinciderà con la data di inizio del corso.';
...
$string['fullnamecourse_help'] = 'Il titolo del corso viene visualizzato nella parte superiore delle pagine del corso e nell\'elenco dei corsi.';
...
$string['hiddensectionscollapsed'] = 'Le sezioni nascoste visualizzano solo l\'intestazione';
...
$string['hideoncoursepage'] = 'Rendi disponibile ma non visibile sulla pagina del corso';
...
$string['highlightoff'] = 'Rimuovi evidenziamento';
$string['hits'] = 'Accessi';
...
$string['idnumbercourse_help'] = 'Il codice identificativo del corso viene utilizzato solamente per identificare il corso rispetto ad un sistema esterno e non viene mai visualizzato nel sito. Può essere utilizzato se il corso ha una codifica ufficiale, altrimenti il campo può essere lasciato vuoto.';
...
$string['indicator:userforumstracking'] = 'Evidenziamento dei messaggi dei forum';
$string['indicator:userforumstracking_help'] = 'L\'indicatore rappresenta l\'attivazione o mancata attivazione dell\'evidenziamento dei messaggi dei forum da parte dello studente.';
...
$string['messagedselecteduserfailed'] = 'Il messaggio non è stato inviato all\'utente {$a->fullname}.';
...
$string['messageprovider:competencyplancomment'] = 'Inserito commento su un piano di formazione';
$string['messageprovider:competencyusercompcomment'] = 'Inserito commento su una competenza';
...
$string['modvisible_help'] = 'Impostando la disponibilità su "Visualizza sulla pagina del corso", l\'attività o risorsa sarà disponibile agli studenti (ma soggetta a restrizioni a seconda delle eventuali condizioni di accesso).<br>
<br>
Impostando la disponibilità su "Nascondi agli studenti", l\'attività o risorsa sarà disponibile solamente agli utenti con il privilegio di visualizzare attività nascoste (di default, gli utenti con il ruolo di docente o docente non editor).';
$string['modvisiblehiddensection'] = 'Disponibilità';
$string['modvisiblehiddensection_help'] = 'Impostando la disponibilità su "Nascondi agli studenti", l\'attività o risorsa sarà disponibile solamente agli utenti con il privilegio di visualizzare attività nascoste (di default, gli utenti con il ruolo di docente o docente non editor).<br><br>
Se il corso contiene numerose attività o risorse, la pagina del corso può essere semplificata con l\'impostazione "Rendi disponibile ma non visibile sulla pagina del corso". In questo caso, occorre inserire un link a questa attività o risorsa da qualche parte, ad esempio, in una risorsa "Pagina". L\'attività disponibile ma non visibile sarà elencata nel registro valutatore e in altri report.';
$string['modvisiblewithstealth'] = 'Disponibilità';
$string['modvisiblewithstealth_help'] = 'Impostando la disponibilità su "Visualizza sulla pagina del corso", l\'attività o risorsa sarà disponibile agli studenti (ma soggetta a restrizioni a seconda delle eventuali condizioni di accesso).<br>
<br>
Impostando la disponibilità su "Visualizza sulla pagina del corso", l\'attività o risorsa sarà disponibile agli studenti (ma soggetta a restrizioni a seconda delle eventuali condizioni di accesso).<br><br>
Se il corso contiene numerose attività o risorse, la pagina del corso può essere semplificata con l\'impostazione "Rendi disponibile ma non visibile sulla pagina del corso". In questo caso, occorre inserire un link a questa attività o risorsa da qualche parte, ad esempio, in una risorsa "Pagina". L\'attività disponibile ma non visibile sarà elencata nel registro valutatore e in altri report.';
$string['month'] = 'Mese';
$string['months'] = 'Mesi';
...
Se il link non dovesse essere attivo, copia e incolla l\'indirizzo nella barra dell\'indirizzo del tuo browser.
...
$string['nocoursestudents'] = 'Non sono presenti studenti';
...
$string['participantscount'] = 'Numero di partecipanti: {$a}';
...
$string['passwordforgotteninstructions2'] = 'Per recuperare la password, inserisci lo username oppure l\'email nei campi sottostanti. Se il dato inserito è presente nel database, riceverai un\'email con le istruzioni per completare il recupero.';
...
$string['resetinfo'] = 'Questa pagina consente di rimuovere i dati degli utenti dal corso, mantenendo le attività e le altre impostazioni. Fate molta attenzione perché selezionando le opzioni sotto specificate e cliccando su Reset corso, i dati utente selezionati saranno eliminati da questo corso per sempre!';
...
$string['rolerenaming_help'] = 'Consente la personalizzazione dei nomi dei ruoli usati nel corso. I privilegi non vengono modificati, verrà cambiato solo il nome del ruolo. I nomi personalizzati dei ruoli verranno usati nella pagina con l\'elenco dei partecipanti al corso e nelle altre pagine del corso dove compaiono i nomi dei ruoli. Se assegnate un nome personalizzato ad un ruolo che è stato definito dall\'Amministratore del sito come Gestore del corso, il nome personalizzato apparirà anche nella descrizione del corso disponibile all\'interno delle Categorie.';
$string['roles'] = 'Ruoli';
$string['rss'] = 'RSS';
...
$string['showoncoursepage'] = 'Visualizza nella pagina del corso';
...
$string['timesplitting:deciles'] = 'Decimi';
$string['timesplitting:decilesaccum'] = 'Decimi accumulativo';
$string['timesplitting:decilesaccum_help'] = 'Il metodo di suddivisione del tempo divide la durata del corso in decimi (10 parti uguali), con ogni previsione basata sui dati di tutti i decimi precedenti.';
$string['timesplitting:deciles_help'] = 'Il metodo di suddivisione del tempo divide la durata del corso in decimi (10 parti uguali), con ogni previsione basata sui dati di tutti i decimi precedenti.';
$string['timesplitting:nosplitting'] = 'Intervallo unico';
$string['timesplitting:nosplitting_help'] = 'Il modello non ha nessun metodo di suddivisione del tempo.';
$string['timesplitting:quarters'] = 'Trimestri';
$string['timesplitting:quartersaccum'] = 'Trimestri accumulativo';
$string['timesplitting:quartersaccum_help'] = 'Metodo di suddivisione del tempo che divide il corso in trimestri (4 parti uguali); ciascun pronostico è formulato in base ai dati di tutti i trimestri precedenti.';
$string['timesplitting:quarters_help'] = 'Metodo di suddivisione del tempo divide il corso in trimestri (4 parti uguali); ciascun pronostico è formulato in base ai dati del solo trimestre precedente.';
$string['timesplitting:singlerange'] = 'Intervallo unico';
$string['timesplitting:singlerange_help'] = 'Metodo di suddivisione del tempo che non divide la durata del corso';
$string['timesplitting:weekly'] = 'Settimanale';
$string['timesplitting:weeklyaccum'] = 'Settimanale accumulativo';
$string['timesplitting:weeklyaccum_help'] = 'Metodo di suddivisione del tempo che divide il corso in settimane (7 giorni); ciascun pronostico è formulato in base ai dati di tutti le settimane precedenti.';
$string['timesplitting:weekly_help'] = 'Metodo di suddivisione del tempo divide il corso in settimane (7 giorni); ciascun pronostico è formulato in base ai dati della sola settimana precedente.';
...
$string['total'] = 'Totale';
$string['totopofsection'] = 'Sopra la sezione "{$a}"';
...
$string['uploadlimitwithsize'] = 'Limite di caricamento per {$a->contextname}: ({$a->displaysize})';
...
$string['userfilterplaceholder'] = 'Cerca una parola chiave o imposta un filtro';
...
$string['userselectorsearchanywhere'] = 'Cerca corrispondenze dei criteri di ricerca in tutti i i campi visualizzati.';
...
$string['weekshow'] = 'Visualizza questa settimana a {$a}';
