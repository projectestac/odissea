...
/**
 * Strings for component 'tool_messageinbound', language 'it', branch 'MOODLE_28_STABLE'
 *
...
$string['fixedenabled_help'] = 'Non è possibile modificare lo stato di questo gestore. E\' possibile che il gestore sia utilizzato da altri gestori.';
$string['fixedvalidateaddress'] = 'Verifica indirizzo del mittente';
$string['fixedvalidateaddress_help'] = 'Non è possibile modificare la verifica del mittente di questo gestore. E\' possibile che il gestore richieda questa specifica impostazione.';
...
$string['incomingmailconfiguration'] = 'Configurazione email in arrivo';
$string['incomingmailserversettings'] = 'Impostazioni server email in arrivo';
...
$string['invalid_recipient_handler_name'] = 'Gestore destinatario non valido';
...
$string['messageinboundenabled'] = 'Abilita elaborazione email in arrivo';
$string['messageinboundenabled_desc'] = 'Affinché i messaggi vengano inviati con le appropriate informazioni, deve essere abilitata l\'elaborazione email in arrivo.';
...
$string['messageinboundhost'] = 'Server email in arrivo';
...
$string['oldmessagenotfound'] = 'Hai tentato di verificare manualmente un messaggio ma il messaggio non è stato trovato. E\' possibile che sia già stato elaborato o che sia scaduto.';
...
$string['taskcleanup'] = 'Pulizia email in arrivo non verificate';
$string['taskpickup'] = 'Lettura email in arrivo';
