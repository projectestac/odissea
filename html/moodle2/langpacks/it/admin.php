...
/**
 * Strings for component 'admin', language 'it', branch 'MOODLE_34_STABLE'
 *
 * @package   admin
...
$string['configenableactivitychooser'] = 'Il selettore attività è una finestra di dialogo con una breve descrizione di ciascuna attività e risorsa. Disabilitando il selettore attività, saranno visualizzati due menù a discesa, uno per le attività ed uno per le risorse.';
...
$string['defaulthomepage'] = 'Pagina home di default per gli utenti';
...
$string['iplookupmaxmindnote'] = 'Questo prodotto include dati GeoLite2 creati da MaxMind, disponibili su <a href="http://www.maxmind.com/">http://www.maxmind.com/</a>.';
...
$string['mobilenotconfiguredwarning'] = 'Moodle Mobile non è abilitato';
...
$string['pathtopsql'] = 'Percorso per psql';
...
$string['pathtopsqlinvalid'] = 'Percorso non valido per psql - percorso errato o non eseguibile';
...
$string['sitepolicyhandler_desc'] = 'Selezionare il componente per la gestione delle accettazioni delle politiche del sito da parte degli utenti. Il gestore core di default fornisce una semplice funzione controllata da due elementi: `politiche del sito` e `politiche del sito per gli ospiti`. E\' possibile fornire altri gestori tramite plugin aggiuntivi in grado di offrire ulteriori funzionalità.';
...
$string['tokenduration'] = 'Durata del token creati dagli utenti';
