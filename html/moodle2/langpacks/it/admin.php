...
/**
 * Strings for component 'admin', language 'it', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['allowframembedding_help'] = 'Consenti di incorporare questo sito dentro frame di altri siti, come suggerito dal plugin di iscrizione \'Pubblicazione come tool LTI\'. Se non si usa il plugin, per motivi di sicurezza si sconsiglia l\'uso di questa impostazione.';
...
$string['configdebugsmtp'] = 'Consente la visualizzazioni di informazioni di debug utili per individuare problemi relativi all\'invio dei email tramite server SMTP. L\'impostazione \'Messaggi di debug\' deve essere a \'Sviluppatore\'.';
