...
/**
 * Strings for component 'hvp', language 'it', branch 'MOODLE_34_STABLE'
 *
 * @package   hvp
...
$string['authorcommentsdescription'] = 'Commenti per l\'editore del contenuto (Questo testo non sarà pubblicato come parte delle informazioni sul copyright)';
...
$string['close'] = 'Chiudi';
$string['confirmdialogbody'] = 'Per favore conferma che desideri continuare. L\'azione non è reversibile.';
...
$string['contentstatefrequency_help'] = 'Quanto spesso desideri, in secondi, che l\'utente possa effettuare il salvataggio automatico del suo progresso? Aumenta il numero di secondi se hai problemi con molte richieste ajax';
...
$string['ctcachedescription'] = 'Accertarsi che la cache del tipo di contenuto sia aggiornata assicurerà che sarà possibile visualizzare, scaricare e utilizzare le ultime librerie. Questa operazione è diversa dall\'aggiornamento delle librerie stesse.';
...
$string['disablefileextensioncheckwarning'] = 'Attenzione! Disabilitando il controllo dell\'estensione dei file si potrebbero verificare dei problemi dato che viene consentito il caricamento di file php. Questo potrebbe consentire a persone ostili di eseguire codice malevole nel tuo sito. Per favore verifica attentamente ciò che stai caricando.';
$string['disablefullscreen'] = 'Disabilita schermo intero';
$string['disablehubconfirmationmsg'] = 'Desideri ancora abilitare l\'hub?';
$string['disablehubdescription'] = 'Si consiglia fortemente di mantenere questa opzione abilitata. L\'hub H5P offre un\'interfaccia semplice per ottenere nuovi tipi di contenuti e mantenere aggiornati i tipi di contenuto esistenti. In futuro, sarà resa più semplice la condivisione e il riutilizzo dei contenuti. Se questa opzione è disabilitata, dovrai installare e aggiornare i tipi di contenuti tramite i moduli di caricamento dei file.';
...
$string['enabledlrscontenttypes_help'] = 'Rende possibile l\'utilizzo di tipi di contenuto che si basano su un Learning Record Store per funzionare correttamente, come il tipo di contenuto del questionario.';
...
$string['filenotfoundonserver'] = 'Il file non è stato trovato sul server. Verifica le impostazioni del caricamento del file.';
...
$string['hubcommunicationdisabled'] = 'La comunicazione dell\'hub di H5P è stata disabilitata perché uno o più requisiti H5P non sono andati a buon fine.';
$string['hubisdisabled'] = 'L\'Hub è disabilitato. Puoi abilitarlo nuovamente nelle impostazioni di H5P.';
$string['hubisdisableduploadlibraries'] = 'L\'hub H5P è stato disabilitato fino a quando questo problema sarà stato risolto. Il caricamento delle librerie è comunque possibile attraverso la pagina "Librerie H5P".';
...
$string['invalidlanguagefile2'] = 'Il file della lingua {$a->%file} incluso nella libreria {$a->%library} non è valido';
...
$string['invalidlibrarynamed'] = 'La libreria {$a->%library} H5P utilizzata dal contenuto non è valida';
...
$string['invalidmultiselectoption'] = 'L\'opzione selezionata non è valida per la selezione multipla.';
$string['invalidparameters'] = 'Parametro non valido';
$string['invalidselectoption'] = 'L\'opzione selezionata non è valida per la selezione.';
...
$string['invalidxapiresult'] = 'Non è stato  ovato nessun risultato xAPI per la combinazione del contenuto e l\'id utente';
$string['javascriptloading'] = 'Caricamento di JavaScript...';
$string['libraries'] = 'Librerie H5P';
$string['librarydirectoryerror'] = 'Il nome della cartella della libreria deve coincidere col machineName o il machineName-majorVersion.minorVersion (dalla library.json). (Nome Cartella: {$a->%directoryName} , machineName: {$a->%machineName}, majorVersion: {$a->%majorVersion}, minorVersion: {$a->%minorVersion})';
...
$string['maximumgradeerror'] = 'Inserisci un numero intero positivo valido come massimo punteggio disponibile per questa attività';
$string['maxpostsizetoosmall'] = 'La dimensione massima del post PHP è piuttosto ridotta. Con la configurazione attuale, non puoi caricare file più grandi di  {$a->%number} MB. Questo potrebbe essere un problema quando provi a caricare H5P, immagini e video. Valuta di aumentarla oltre 5 MB';
$string['maxscore'] = 'Punteggio massimo';
$string['maxuploadsizetoosmall'] = 'La dimensione massima del post PHP è piuttosto ridotta. Con la configurazione attuale, non puoi caricare file più grandi di  {$a->%number} MB. Questo potrebbe essere un problema quando provi a caricare H5P, immagini e video. Valuta di aumentarla oltre 5 MB';
...
$string['missingmbstring'] = 'L\'estensione mbstring di PHP non è stata caricata. H5P necessita questa libreria per funzionare correttamente';
