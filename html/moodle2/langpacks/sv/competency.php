...
/**
 * Strings for component 'competency', language 'sv', branch 'MOODLE_31_STABLE'
 *
 * @package   competency
...
$string['allchildrenarecomplete'] = 'Alla underliggande är kompletta.';
$string['competencies'] = 'Kompetenser';
$string['competenciesarenotenabled'] = 'Kompetenser är ej aktiverade';
$string['competenciessettings'] = 'Inställningar kompetenser';
$string['completeplanstask'] = 'Kompletta studieplaner som är utgångna';
$string['coursecompetencyoutcome_complete'] = 'Fullfölj kompetensen';
$string['coursecompetencyoutcome_evidence'] = 'Bifoga verifiering';
$string['coursecompetencyoutcome_none'] = 'Gör inget';
$string['coursecompetencyoutcome_recommend'] = 'Skicka in för granskning';
$string['coursemodulecompetencyoutcome_complete'] = 'Komplettera kompetensen';
$string['coursemodulecompetencyoutcome_evidence'] = 'Bifoga verfiering';
...
$string['deletecompetencyratings'] = 'Radera kompetensgraderingen';
...
$string['errorcannotchangeapastduedate'] = 'Sista datum har passerats; det går inte att ändra.';
$string['errorcannotsetduedateinthepast'] = 'Sista datum kan inte sättas tillbaka i tiden.';
$string['errorcannotsetduedatetoosoon'] = 'Sista datum är satt för tidigt.';
$string['errorcompetencyrule'] = 'Regel \'{$a}\' för kurskompetens är okänd';
$string['errorcoursecompetencyrule'] = 'Regel \'{$a}\' för kurskompetens är okänd';
$string['errorinvalidcourse'] = 'Felaktig kurs.';
$string['errornocompetency'] = 'Kompetensen {$a} kan ej hittas';
$string['errorplanstatus'] = 'Studieplanen \'{$a}\' är okänd';
$string['errorscalealreadyused'] = 'Skalan kan ej ändras då den används redan.';
$string['errorscaleconfiguration'] = 'Skalan måste konfigureras genom val av standard- och skicklighetsvärden.';
$string['errorusercomptencystatus'] = 'Användare \'{$a}\' kompetensstatus är okänd.';
$string['eventcompetencycreated'] = 'Kompetens skapad.';
$string['eventcompetencydeleted'] = 'Kompetens raderad.';
$string['eventcompetencyframeworkcreated'] = 'Ramverk för kompetenser skapad.';
$string['eventcompetencyframeworkdeleted'] = 'Ramverk för kompetenser raderad.';
$string['eventcompetencyframeworkupdated'] = 'Ramverk för kompetenser uppdaterad.';
$string['eventcompetencyframeworkviewed'] = 'Ramverk för kompetenser visad.';
$string['eventcompetencyupdated'] = 'Kompetens uppdaterad.';
$string['eventcompetencyviewed'] = 'Kompetens visad.';
$string['eventevidencecreated'] = 'Verifiering skapad.';
$string['eventplanapproved'] = 'Studieplan godkänd.';
$string['eventplancompleted'] = 'Studieplan kompletterad.';
...
$string['eventplanreviewrequestcancelled'] = 'Studieplansgranskning avbruten.';
...
$string['eventplanunlinked'] = 'Studieplan avlänkad.';
...
$string['eventtemplatedeleted'] = 'Studieplansmall raderad.';
...
$string['eventusercompetencyreviewrequestcancelled'] = 'Granskning av användares kompetens avbruten.';
...
$string['evidence_coursecompleted'] = 'Kursen \'{$a}\' genomfördes.';
$string['evidence_coursemodulecompleted'] = 'Aktiviteten \'{$a}\' genomfördes.';
$string['evidence_courserestored'] = 'Bedömningen återställdes jäms med kursen \'{$a}\'.';
...
$string['evidence_manualoverride'] = 'Kompetensgraderingen sattes manuellt.';
$string['evidence_manualoverrideincourse'] = 'Kompetensgraderingen sattes manuellt i kursen \'{$a}\'.';
...
$string['pointsrequiredaremet'] = 'Poängkrav har uppnåtts';
$string['pushcourseratingstouserplans'] = 'För över kursbedömningar till individuella studieplaner.';
$string['pushcourseratingstouserplans_desc'] = 'Grundinställning för kursens inställning att uppdatera individuella studieplaner när kurskompetenser bedöms.';
...
$string['taxonomy_outcome'] = 'Förmåga';
...
$string['usercompetencystatus_idle'] = 'Overksam';
$string['usercompetencystatus_inreview'] = 'Bedömning pågår';
$string['usercompetencystatus_waitingforreview'] = 'Väntar på bedömning';
