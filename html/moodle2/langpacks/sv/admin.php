...
/**
 * Strings for component 'admin', language 'sv', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['allowindexingnowhere'] = 'Ingenstanns';
...
$string['defaulthomepage'] = 'Standardhemsida för användare';
...
$string['mypage'] = 'Standardformat för sidan Mitt Moodle';
