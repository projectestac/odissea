...
/**
 * Strings for component 'message', language 'sv', branch 'MOODLE_36_STABLE'
 *
 * @package   message
...
$string['deleteallconfirm'] = 'Vill du verkligen radera hela denna konversation? Detta kommer inte radera den för andra deltagare i konversationen.';
...
$string['managemessageoutputs'] = 'Hantera meddelandeutmatning';
...
$string['searchnocontactsfound'] = 'Inga kontakter hittades';
$string['searchnomessagesfound'] = 'Inga meddelanden hittades';
$string['searchnononcontactsfound'] = 'Inga icke-kontakter hittades';
