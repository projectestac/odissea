...
$string['optout'] = 'Arkivera inte i Urkund';
...
Om du vill förhindra att ditt dokument används som en källa för analys utanför denna webbplats av andra organisationer kan du använda denna länk för att din text inte arkiveras i Urkund. {$a->optoutlink}';
