...
$string['aggregationhintdropped'] = '';
$string['aggregationhintexcluded'] = '( Undantagen )';
$string['aggregationhintextra'] = '( Extra kreditering )';
...
$string['contributiontocoursetotal'] = 'Bidrag till totalen för kursen';
