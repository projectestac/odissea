...
/**
 * Strings for component 'plugin', language 'sv', branch 'MOODLE_36_STABLE'
 *
 * @package   plugin
...
$string['checkforupdates'] = 'Kontrollera efter tillgängliga uppdateringar';
$string['checkforupdateslast'] = 'Senast kontroll utfört {$a}';
$string['displayname'] = 'Plugin namn';
...
$string['plugindisabled'] = 'Avaktivera';
$string['pluginenable'] = 'Aktivera';
$string['pluginenabled'] = 'Aktivera';
...
$string['status_downgrade'] = 'Högre version installerad redan!';
