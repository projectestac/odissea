...
/**
 * Strings for component 'auth', language 'ar', branch 'MOODLE_34_STABLE'
 *
 * @package   auth
...
$string['actauthhdr'] = 'مكونات المصادقة المتاحة';
...
$string['authenticationoptions'] = 'خيارات المصادقة';
...
$string['auth_notconfigured'] = 'طريقة المصادقة {$a} لم يتم ضبطها.';
...
$string['chooseauthmethod'] = 'اختر طريقة المصادقة:';
...
إن لم تكن متأكداً من الكلمات، يمكنك تجربة كاباتشا CAPTCHA أخرى أو حتى تجربة كاباتشا صوتية.';
...
$string['stdchangepassword'] = 'استخدم الصفحة القياسية لتغيير كلمة المرور';
$string['stdchangepassword_expl'] = 'إذا كان نظام المصادقة الخارجي يسمح بتغيير كلمة المرور من خلال مودل، فغيّر هذا الإعداد إلى (نعم). هذا الإعداد سيتخطى رابط تغيير كلمة المرور.';
$string['stdchangepassword_explldap'] = 'ملاحظة: من المستحسن استخدام LDAP عبر نفق مشفر بواسطة (ldaps://) إذا كان خادم LDAP بعيدًا.';
