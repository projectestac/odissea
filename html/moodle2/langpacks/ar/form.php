...
$string['addfields'] = 'أضف {$a} حقول للنموذج';
$string['advancedelement'] = 'عناصر متقدمة';
$string['close'] = 'مغلق';
$string['day'] = 'يوم';
$string['display'] = 'عرض';
...
$string['modstandardels'] = 'إعدادات وحدة عامة';
$string['month'] = 'شهر';
$string['nomethodforaddinghelpbutton'] = 'لا يوجد منهجية لإضافة زر مساعدة لعناصر هذا النموذج {$a->name} (class {$a->classname})';
$string['nonexistentformelements'] = 'محاولة إضافة زر مساعدة  لعناصر النموذج غير موجود';
