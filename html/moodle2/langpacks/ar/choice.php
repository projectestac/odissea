...
/**
 * Strings for component 'choice', language 'ar', branch 'MOODLE_34_STABLE'
 *
 * @package   choice
...
$string['choice:choose'] = 'سجل اختيار';
$string['choiceclose'] = 'حتى';
$string['choice:deleteresponses'] = 'احذف الاجابات';
$string['choice:downloadresponses'] = 'قم بتنزيل الاجابات';
