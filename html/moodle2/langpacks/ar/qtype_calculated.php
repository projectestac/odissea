...
/**
 * Strings for component 'qtype_calculated', language 'ar', branch 'MOODLE_36_STABLE'
 *
...
$string['choosedatasetproperties_help'] = 'مجموعة البيانات هي مجموعة من القيم يتم إدراجها بدلا من البطاقات البديلة . يمكنك إنشاء مجموعة بيانات خاصة عن سؤال محدد، أو مجموعة بيانات مشتركة .. و التي يمكن استخدامها لغيرها من الأسئلة تحسب ضمن هذه الفئة.';
...
$string['correctfeedback'] = 'عن أيّ إجابة صحيحة';
$string['dataitemdefined'] = 'مع {$a} القيم العددية المحددة متاحة بالفعل';
$string['datasetrole'] = 'البطاقات البديلة <strong>{x..}</strong> سيتم الاستعاضة عن قيمة رقمية من مجموعة البيانات الخاصة بها';
...
$string['hexanotallowed'] = 'المجموعة  <strong>{$a->name}</strong> قيمة تنسيق ست عشرية {$a->value} غير مسموح بها';
$string['illegalformulasyntax'] = 'بناء جملة بصيغة غير صحيحة و التي تبدأ بـ \'{$a}\\';
$string['incorrectfeedback'] = 'لأي إجابة غير صحيحة';
$string['itemno'] = 'العنصر {$a}';
$string['itemscount'] = 'العناصر <br/> عدد';
$string['itemtoadd'] = 'عنصر للإضافة';
...
$string['nextitemtoadd'] = '’التالي’ لإضافة عنصر';
...
$string['nocommaallowed'] = 'لا يمكن استخدامها، و استخدام كما هو الحال في 0.013 أو 1.3E-2';
...
$string['oneanswertrueansweroutsidelimits'] = 'واحد على الأقل الجواب الصحيح خارج حدود القيمة الحقيقية. <br/> تعديل إعدادات التسامح في الإجابات المتوفرة كمعايير متقدمة';
$string['param'] = 'المعلمة {<strong> {$a} </strong>}';
$string['partiallycorrectfeedback'] = 'عند أي إجابة صحيحة جزئيا';
...
$string['pluginnamesummary'] = 'الأسئلة الحسابية مثل الأسئلة العددية و لكن مع أرقام مستخدمة يتم اختيارها عشوائياً من مجموعة محددة، عندما يتم أخذ هذا الاختبار.';
$string['possiblehdr'] = 'البطاقات البديلة وجودها ممكن فقط في نص السؤال';
$string['privacy:metadata'] = 'المكون الإضافيCalculated question type لن يخزن أيّ بيانات شخصية.';
...
$string['youmustaddatleastoneitem'] = 'يجب إضافة بند واحد على الأقل من مجموعة البيانات قبل أن تتمكن من حفظ هذه المسألة.';
$string['youmustaddatleastonevalue'] = 'يجب إضافة مجموعة واحدة على الأقل من قيم البطاقات البديلة قبل أن تتمكن من حفظ هذه المسألة.';
