...
/**
 * Strings for component 'group', language 'ar', branch 'MOODLE_34_STABLE'
 *
 * @package   group
...
$string['enrolmentkeyalreadyinuse'] = 'يتم استخدام مفتاح التسجيل الحالي للالتحاق بمجموعة أخرى.';
$string['enrolmentkey_help'] = 'يُمكِّن استخدام مفتاح التسجيل ليقتصر الوصول إلى المقرر الدراسي على أولئك الذين يعرفون المفتاح فقط. إذا تم تحديد مفتاح التسجيل للمجموعة أيضاً، فاستخدام المقتاح  سوف يسمح للمستخدم أيضاً بعد الدخول للمقرر الدراسي  إدخاله تلقائياً كعضو في هذه المجموعة.

ملاحظة: يجب تمكين مفاتيح التسجيل المجموعة في إعدادات التسجيل الذاتي، ويجب أيضا تحديد مفتاح التسجيل للمقرر الدراسي.';
...
$string['eventgroupcreated'] = 'تم إنشاء المجموعة';
$string['eventgroupdeleted'] = 'تم حذف المجموعة';
$string['eventgroupingcreated'] = 'تم إنشاء التجمُّع';
$string['eventgroupingdeleted'] = 'تم حذف التجمُّع';
$string['eventgroupinggroupassigned'] = 'إضافة المجموعة للتجمُّع';
$string['eventgroupinggroupunassigned'] = 'إزالة المجموعة من التجمُّع';
$string['eventgroupingupdated'] = 'تم تحديث التجمُّع';
$string['eventgroupmemberadded'] = 'تم إضافة عضو للمجموعة';
...
$string['groupingaddedsuccesfully'] = 'تم إضافة التجميع  {$a} بنجاح';
...
$string['groupingnameexists'] = 'التجميع باسم \'{$a}\' موجود مسبقاً في هذا المقرر، يرجى اختيار اسم آخر.';
$string['groupings'] = 'تجميعات';
$string['groupingsection'] = 'صلاحية الوصول للتجميع/التجمُّع';
$string['groupingsection_help'] = 'التجميع أو التجمُّع عبارة عن مجموعة من المجموعات ضمن المقرر الدراسي. إذا تم تحديد تجميع هنا، فقط الطلاب المُضافين لمجموعات داخل هذا التجميع يمكنهم الوصول إلى القسم.';
...
$string['groupnameexists'] = 'المجموعة باسم \'{$a}\' موجودة مسبقاً في هذا المقرر، يرجى اختيار اسم آخر.';
...
$string['importgroups_help'] = 'يمكن استيراد المجموعات عبر ملف نصي. يجب أن يكون شكل الملف كما يلي:

* كل سطر من الملف يحتوي على سجل واحد
* كل سجل هو عبارة عن سلسلة من البيانات مفصولة بفواصل
*  يحتوي السجل الأول على قائمة أسماء الحقول  (fieldnames) لتحديد شكل بقية الملف
 * حقل اسم المجموعة إجباري ويجب إدخاله
* الحقول التالية هي اختيارية :الوصف description , ومفتاح التسجيل enrolmentkey ,و الصورة  picture,و كذلك حقل خيار إخفاء الصورة hidepicture.';
$string['includeonlyactiveenrol'] = 'تشمل التسجيلات النشطة فقط';
...
$string['nogroups'] = 'لا توجد مجموعات أنشئت في هذا المقرر الدراسي بعد';
...
$string['notingrouplist'] = '[ليس في مجموعة]';
...
$string['potentialmembers'] = 'الأعضاء المحتملين: {$a}';
$string['potentialmembs'] = 'الأعضاء المحتملين';
