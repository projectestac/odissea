...
/**
 * Strings for component 'moodle', language 'ar', branch 'MOODLE_28_STABLE'
 *
 * @package   moodle
...
$string['coursecategory_help'] = 'يحدد هذا الإعداد التصنيف الذي سينتمي له المقرر الدراسي في قائمة المقررات الدراسية.';
...
$string['courseoverviewfiles_help'] = 'ملفات ملخص المقرر الدراسي، مثل الصور،يتم عرضها في قائمة المقررات جنبا إلى جنب مع الملخص.';
...
$string['coursesummary_help'] = 'يتم عرض مُلخص المقرر الدراسي في قائمة المقررات.مُحرك البحث للمقررات الدراسية يبحث في نص المُلخص لمقرر الدراسي بالإضافة للبحث في أسماء المقررات';
...
$string['dndnotsupported_help'] = 'متصفحك لا يدعم سحب وإسقاط للتحميل. <br />هذه الميزة  متوفرة في جميع النسخ الأخيرة من متصفح كروم ، فايرفوكس وسفاري، وكذلك انترنت اكسبلورر النسخة العاشرة والأحدث منها';
...
$string['format'] = 'تنسيق';
$string['format_help'] = '.يحدد تنسيق المقرر تخطيط صفحة المقرر الدراسي كما يلي

* تنسيق النشاط واحد - لعرض نشاط أو مصدر واحد (مثل اختبار أو حزمة سكورم) في صفحة المقرر الدراسي
* تنسيق اجتماعي - يتم عرض المنتدى على صفحة المقرر الدراسي
* تنسيق موضوعي - يتم تنظيم صفحة المقرر الدراسي  إلى أقسام يمثل كل قسم موضوع مُعين
* تنسيق أسبوعي - يتم تقسيم صفحة المقرر الدراسي إلى أقسام  يمثل كل قسم أسبوع، يبدأ الأسبوع الأول من تاريخ بداية المقرر الدراسي';
...
$string['fullnamecourse_help'] = '.يتم عرض الاسم الكامل للمقرر الدراسي في أعلى كل صفحة في المقرر وفي قائمة المقررات';
...
$string['idnumbercourse_help'] = 'يتم استخدام الرقم التعريفي للمقرر الدراسي فقط عند مطابقة المقرر مع أنظمة خارجية ولن يتم عرضه في أي مكان على الموقع. فإذا كان للمقرر رمز تعريفي رسمي فيمكن إدخاله، وإلا فإن هذا الحقل يمكن تركه فارغاً';
...
$string['idnumbermod_help'] = 'وضع رقم معرف يوفر وسيلة لتحديد النشاط عند حساب الدرجات . إذا لم يتم تضمين النشاط في أي حساب للدرجات فهذا الحقل للرقم التعريفي يمكن تركه فارغاً.

ويمكن أيضا تعيين الرقم التعريفي في سجل الدرجات،إلّا أنه في هذه الحالة لا يمكن تعديله إلا على .صفحة إعدادات النشاط';
...
$string['interestslist_help'] = 'أدخل مجالات الاهتمام الخاصة بك، مفصولة بفاصلة، سوف يتم عرضها على صفحة ملفك الشخصي كعلامات';
...
$string['messageprovider:errors_help'] = 'هذه أخطاء مهمة يجب إخبار المشرف على الموقع (الأدمن) عنها';
$string['messageprovider:instantmessage'] = 'الرسائل الشخصية بين المستخدمين';
$string['messageprovider:instantmessage_help'] = 'هذا القسم مسؤول عن ضبط  إعدادت الرسائل التي يتم إرسالها إليك مباشرة من مستخدمين آخرين على هذا الموقع';
