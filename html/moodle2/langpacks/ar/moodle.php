...
/**
 * Strings for component 'moodle', language 'ar', branch 'MOODLE_34_STABLE'
 *
 * @package   moodle
...
$string['abouttobeinstalled'] = 'على وشك الانتهاء من التثبيت';
$string['action'] = 'عمل';
...
$string['activityclipboard'] = 'تغيير مكان النشاط {$a}هذا:';
...
$string['addblock'] = 'أضف منصة مجاورةً';
...
$string['addinganew'] = 'أضف {$a} جديداً';
$string['addinganewto'] = 'إأضافة {$a->what} جديدا لِـ {$a->to}';
$string['addingdatatoexisting'] = 'أضافة بيانات للموجود';
$string['additionalnames'] = 'أسماء إضافية';
$string['addlinkhere'] = 'اضف رابطاً هنا';
$string['addnewcategory'] = 'إضف فئة جديدة';
$string['addnewcourse'] = 'اضف مساقا جديداً';
$string['addnewuser'] = 'اضف مستخدماً جديداً';
...
$string['allowstealthmodules'] = 'السماح بالأنشطة السرية';
$string['allowstealthmodules_help'] = 'إذا تم تفعيلها، فإن الأنشطة ستكون متاحة لكن لن تظهر في الأقسام المرئية من صفحة المقرر. ولذلك، روابط الأنشطة السرية يتم وضعها بأماكن أخرى، مثل المصادر, كما أنها ستكون موجودة في سجل الدرجات والتقارير الأخرى.';
...
$string['backtohome'] = 'العودة إلى صفحة الموقع الرئيسية';
...
$string['coursealreadyfinished'] = 'لقد انتهى المقرر';
...
$string['courseenddateenabled'] = 'تاريخ إنتهاء الصف مفعل تلقائيا';
...
$string['coursenotyetfinished'] = 'الصف لم ينتهي بعد';
$string['coursenotyetstarted'] = 'الصف لم يبدأ بعد';
...
$string['coursevisibility'] = 'إشهار الصف';
...
$string['enddate_help'] = 'يتم استخدام تاريخ انتهاء الدورة التدريبية لتحديد ما إذا كان يجب تضمين المساق في قائمة المساقات الخاصة بالمستخدم. عند تجاوز تاريخ الانتهاء، لن يتم إدراج المساق في قائمة التنقل بل يتم إدراجه تحت "انتهى "ضمن مستعرض المساقات. يمكن أيضًا استخدام تاريخ انتهاء لمساق من خلال التقارير المخصصة. لا يزال بإمكان المستخدمين الدخول إلى لمساق بعد تاريخ الانتهاء؛ وبعبارة أخرى فإن التاريخ لا يقيد الوصول.';
...
$string['eventconfiglogcreated'] = 'تم عمل سجل التهيئة';
$string['eventcontentviewed'] = 'تم استعراض المحتوى';
$string['eventcoursebackupcreated'] = 'تم عمل النسخة الاحتياطية للمقرر';
...
$string['eventcoursesectioncreated'] = 'تم إنشاء قسم المقرر';
...
$string['eventuserinfocategorycreated'] = 'تم عمل الملف الشخصي للعضو';
$string['eventuserinfocategorydeleted'] = 'تم حذف الحقل المعني من الملف الشخصي للعضو';
$string['eventuserinfocategoryupdated'] = 'تم تحديث تصنيف حقل الملف الشخصي للعضو';
$string['eventuserinfofieldcreated'] = 'تم إنشاء حقل الملف الشخصي';
$string['eventuserinfofielddeleted'] = 'تم حذف حقل الملف الشخصي';
$string['eventuserinfofieldupdated'] = 'تم تحديث حقل الملف الشخصي للعضو';
...
$string['filter'] = 'تصفية';
$string['filteroption'] = '{$a->معيار}: {$a->قيمة}';
$string['filters'] = 'تصفيات';
...
$string['hiddenoncoursepage'] = 'متاح ولكن لا يظهر في صفحة المقرر';
...
$string['hidefromstudents'] = 'إخفاء من الطلاب';
$string['hideoncoursepage'] = 'أجعلها متاحة ولكن لا تظهر على صفحة المقرر';
...
$string['indicator:accessesafterend'] = 'تم الوصول للقرر بعد تاريخ الانتهاء';
$string['indicator:accessesafterend_help'] = 'هذا يشير إلى أن الطالب وصل للمقرر بعد تاريخ انتهاء المقرر.';
$string['indicator:accessesbeforestart'] = 'تم الوصول للمقرر قبل تاريخ البدء';
$string['indicator:accessesbeforestart_help'] = 'هذا يشير إلى أن الطالب قد وصل للمقرر قبل تاريخ بدء المقرر.';
$string['indicator:anywrite'] = 'إي اجراء ارسال';
$string['indicator:anywrite_help'] = 'هذا يشير إلى أي اجراء (ارسال) تم بواسطة الطالب.';
$string['indicator:anywriteincourse'] = 'أي اجراء ارسال بهذا المقرر';
$string['indicator:anywriteincourse_help'] = 'هذا يشير إلى أي اجراء (ارسال) تمت بواسطة الطالب في أي نشاط بالمقرر.';
$string['indicator:completeduserprofile'] = 'اكتمل الملف الشخصي للعضو';
$string['indicator:completeduserprofile_help'] = 'هذا يشير إلى أن الطالب أكمل ملفه الشخصي.';
$string['indicator:completionenabled'] = 'تم تفعيل تتبع الاكتمال';
$string['indicator:completionenabled_help'] = 'هذا يشير إلى أن تتبع الاكتمال قد تم تفعيله بهذا المقرر';
$string['indicator:nostudent'] = 'لايوجد طلاب';
...
$string['indicator:potentialcognitive'] = 'العمق الإدراكي المتوقع للصف';
$string['indicator:potentialcognitive_help'] = 'هذا المؤشر مبني على العمق الإدراكي المتوقع والذي يمكن الوصول إليه من قبل طالب يشارك في نشاطات الصف';
$string['indicator:potentialsocial'] = 'الاتساع الاجتماعي المتوقع للصف';
$string['indicator:potentialsocial_help'] = 'هذا المؤشر مبني على الاتساع الاجتماعي المتوقع والذي يمكن الوصول إليه من قبل طالب يشارك في نشاطات الصف';
$string['indicator:readactions'] = 'كمية افعال القراءة';
$string['indicator:readactions_help'] = 'هذا المؤشر يبين عدد مرات القراءة (مشاهدة) التي قام بها الطالب';
$string['indicator:userforumstracking'] = 'المستخدم يتتبع المنتديات';
$string['indicator:userforumstracking_help'] = 'هذا المؤشر يبين فيما إذا كان الطالب قد شغل حاصية التتبع في المنتديات';
$string['info'] = 'معلومات';
...
$string['loginsteps'] = 'للوصول الكامل لهذا الموقع, عليك أن تنشئ حسابا.';
...
$string['modvisible_help'] = 'ذا تم اختيار التوافر على "ظاهر على صفحة المساق"، فسيكون النشاط أو المورد متاحًا للطلاب (مع مراعاة القيود التي يتم تحديدها للوصول)<br><br>
اذا تم اختيار التوافر على "مخفى عن الطلاب"، فسيكون النشاط أو المورد متاحًا فقط للمستخدمين الذين لديهم إذن لرؤية الأنشطة المخفية (عادة، المستخدمين الذين لديهم دور المعلم أو المعلم الذي لا يقوم بالتحرير).';
$string['modvisiblehiddensection'] = 'متاح';
$string['modvisiblehiddensection_help'] = 'إذا تم اختيار التوافر على "مخفى عن الطلاب"، فسيكون النشاط أو المورد متاحًا فقط للمستخدمين الذين لديهم إذن لعرض الأنشطة المخفية (عادة، المستخدمين الذين لهم دور المعلم أو المعلم الذي لا يقوم بالتحرير). <br> <br>
إذا كان المساق يحوي العديد من الأنشطة أو الموارد، فقد يتم تبسيط صفحة المساق عن طريق تعيين مدى التوفر على "متاح لكن عير ظاهر على صفحة المساق" وفي هذه الحالة يجب توفير رابط للوصول إلى النشاط أو المورد من مكان آخر، مثلا من مورد صفحة. سيظل النشاط مدرجًا في دفتر التقديرات والتقارير الأخرى.';
$string['modvisiblewithstealth'] = 'متاح';
$string['modvisiblewithstealth_help'] = 'إذا تم اختيار التوافر "ظاهر على صفحة الدورة التدريبية"، فسيكون النشاط أو المورد متاحًا للطلاب (خاضعًا لأية قيود الوصول التي يتم ضبطها). <br> <br>
إذا تم اختيار التوافر "مخفى عن الطلاب"، فسيكون النشاط أو المورد متاحًا فقط للمستخدمين الذين لديهم إذن لعرض الأنشطة المخفية (عادة المستخدمين الذين لهم دور المعلم أو المعلم الذي لا يقوم بالتحرير). <br> <br>
إذا كان المساق يحوي العديد من الأنشطة أو الموارد، فقد يتم تبسيط صفحة المساق عن طريق تعيين مدى التوفر على "متاح لكن عير ظاهر على صفحة المساق" وفي هذه الحالة يجب توفير رابط للوصول إلى النشاط أو المورد من مكان آخر، مثلا من مورد صفحة. سيظل النشاط مدرجًا في دفتر التقديرات والتقارير الأخرى.';
$string['month'] = 'شهر';
$string['months'] = 'شهور';
...
$string['newsitemsnumber_help'] = 'منتدى الإخبار هو منتدى خاص يتم إنشاؤه تلقائيا للصف. الإشتراك الإجباري مفعل لهذا المنتدى. فقط المستخدمون الذين يتمتعون بامتيازات مناسبه (المدرسون بطبيعة الحال) يمكنهم إصدار هذه الأخبار .

هذا الإعداد يحدد عدد بنود اخر الاخبار التي ستظهر في كتلة الاخبار في صفحة المقرر الدراسي
.
في حال عدم الرغبة لاستخدام منتدى الأخبار, ينبغي إختيار صفر كي لايظهر منتدى الأخبار.';
...
$string['nocourseactivity'] = 'لايوجد نشاطات كافيه بين بداية الصف وانتهاؤه';
$string['nocourseendtime'] = 'لايوجد موعد لانتهاء الصف';
$string['nocourses'] = 'لا يوجد مقررات';
$string['nocoursesections'] = 'لايوجد اقسام في الصف';
$string['nocoursesfound'] = 'لا يوجد مقرر دراسي يحتوي على هذه الكلمات  \'{$a}\'';
$string['nocoursestarttime'] = 'لايوجد موعد لابتداء الصف';
$string['nocoursestudents'] = 'لا طلاب';
...
$string['nofiltersapplied'] = 'لايوجد مرشحات مطبّقة';
...
$string['registrationno'] = 'لا: لا أريد استلام بريد إلكتروني من Moodle HQ';
$string['registrationsend'] = 'إرسل معلومات التسجيل إلى moodle.org';
$string['registrationyes'] = 'نعم: فضلاً أعلمني بالأخبار المهمة (مشكلات أمان أو إصدارات مثلا)';
$string['reject'] = 'أرفض';
...
$string['sectionactionnotsupported'] = 'فعل القسم "{$a}" غير متاح';
...
$string['showoncoursepage'] = 'أعرض في صفحة المقرر';
...
$string['tags'] = 'علامات';
$string['target:coursedropout'] = 'طلاب معرضون لخطر ترك الدراسة';
$string['target:coursedropout_help'] = 'هذا الهدف يوضح فيما إذا كان الطالب معرض لخطر ترك الدراسة';
$string['targetlabelstudentdropoutno'] = 'ليس في خطر';
$string['targetlabelstudentdropoutyes'] = 'طالب معرض لخطر ترك الدراسة';
$string['targetlabelteachingno'] = 'لا تدريس';
$string['targetlabelteachingyes'] = 'المستخدمون المسموح لهم بالتدريس يستطيعون الدخول للصف';
$string['target:noteachingactivity'] = 'لا يوجد تدريس';
$string['target:noteachingactivity_help'] = 'هذا الهدف يوضح إذا كانت الصفوف التي ستبدأ الأسبوع القادم ستحوي نشاطا تدريسيا';
...
$string['timesplitting:deciles'] = 'اعشار';
$string['timesplitting:decilesaccum'] = 'الأعشار التراكمية';
$string['timesplitting:decilesaccum_help'] = 'طريقة قسمة الوقت هذه، تقسم المساق إلى أعشار (10 أجزاء متساوية) ، بحيث يكون كل تكهن مستندا على جميع البيانات للأعشار السابقة.';
$string['timesplitting:deciles_help'] = 'طريقة قسمة الوقت هذه، تقسم المساق إلى أعشار (10 أجزاء متساوية)، بحيث يكون كل تكهن مستندا فقط على اخر البيانات  حداثة للأجزاء العشرة السابقة.';
$string['timesplitting:nosplitting'] = 'لا يوجد تقسيم للوقت';
$string['timesplitting:nosplitting_help'] = 'لا توجد آلية تقسيم وقت بهذا النموذج';
$string['timesplitting:quarters'] = 'الأرباع';
$string['timesplitting:quartersaccum'] = 'الأرباع التراكمية';
$string['timesplitting:quartersaccum_help'] = 'طريقة قسمة الوقت هذه، تقسم المساق إلى أرباع (4 أجزاء متساوية)، بحيث يكون كل تكهن مستندا على جميع البيانات للأرباع السابقة.';
$string['timesplitting:quarters_help'] = 'طريقة قسمة الوقت هذه، تقسم المساق إلى أرباع (4 أجزاء متساوية)، بحيث يكون كل تكهن مستندا فقط على اخر البيانات حداثة للأرباع السابقة.';
$string['timesplitting:singlerange'] = 'مدى مفرد';
$string['timesplitting:singlerange_help'] = 'طريقة اقتسام الوقت هذه تعتبر كامل المساق امتدادا واحدا.';
$string['timesplitting:weekly'] = 'اسبوعياً';
$string['timesplitting:weeklyaccum'] = 'تراكم أسبوعي';
$string['timesplitting:weeklyaccum_help'] = 'طريقة قسمة الوقت هذه، تقسم المساق إلى أسابيع (7 أيام)، حيث يكون كل تكهن مستندا على جميع بيانات الأسابيع السابقة.';
$string['timesplitting:weekly_help'] = 'طريقة قسمة الوقت هذه، تقسم المساق إلى أسابيع (7 أيام)، حيث يكون كل تكهن مستندا على اخر بيانات الأسابيع السابقة حداثة.';
...
$string['userfilterplaceholder'] = 'أبحث باستخدام كلمة أو اختر مرشحا';
