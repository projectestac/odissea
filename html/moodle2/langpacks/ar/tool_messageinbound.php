...
/**
 * Strings for component 'tool_messageinbound', language 'ar', branch 'MOODLE_36_STABLE'
 *
...
$string['configmessageinboundhost'] = 'عنوان الخادم الذي يجب أن يتحقق من Moodle البريد. لتحديد منفذ غير افتراضي ، استخدم [server]: [port] ، على سبيل المثال mail.example.com:587. إذا لم يتم تحديد منفذ ، فسيتم استخدام المنفذ الافتراضي لنوع خادم البريد.';
