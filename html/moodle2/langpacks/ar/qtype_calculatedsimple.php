...
/**
 * Strings for component 'qtype_calculatedsimple', language 'ar', branch 'MOODLE_36_STABLE'
 *
...
$string['atleastonewildcard'] = 'يجب أن يكون هناك بطاقة بديلة واحدة على الأقل <strong>{x..}</strong> الموجودة في صيغ الإجابة الصحيحة';
$string['converttocalculated'] = 'احفظ في شكل سؤال حسابي عادي جديد';
