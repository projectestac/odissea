...
/**
 * Strings for component 'message_jabber', language 'ar', branch 'MOODLE_36_STABLE'
 *
...
$string['configjabberhost'] = 'الخادم الذي ستم الاتصال به لإرسال رسائل إشعارات خدمة جابر (Jabber)';
