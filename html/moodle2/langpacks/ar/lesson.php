...
/**
 * Strings for component 'lesson', language 'ar', branch 'MOODLE_36_STABLE'
 *
 * @package   lesson
...
$string['eventcontentpageviewed'] = 'تم استعراض محتوى الصفحة';
$string['eventessayassessed'] = 'تقييم المقالة';
$string['eventpagemoved'] = 'انتقلت الصفحة';
$string['eventpageupdated'] = 'تم تحديث الصفحة';
$string['eventquestionanswered'] = 'تمت الإجابة على السؤال';
$string['eventquestionviewed'] = 'تم استعراض السؤال';
$string['false'] = 'خاطىء';
...
$string['messageprovider:graded_essay'] = 'إعلام بتقييم مقالة';
