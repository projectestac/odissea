...
/**
 * Strings for component 'feedback', language 'ar', branch 'MOODLE_32_STABLE'
 *
 * @package   feedback
...
$string['allowfullanonymous'] = 'اسمح بغير مشخصن كامل';
$string['analysis'] = 'تحليل';
$string['anonymous'] = 'غير مشخصن';
$string['anonymous_edit'] = 'سجل اسم المستخدم';
$string['anonymous_entries'] = 'مدخلات غير مشخصنة';
...
$string['delete_templates'] = 'احذف قالب';
...
$string['export_to_excel'] = 'تصدير إلى إكسل';
$string['feedbackclose'] = 'إغلاق الأفادة';
$string['feedback:complete'] = 'إكمال إفادة';
$string['feedback:createprivatetemplate'] = 'أنشئ قالب خاص';
$string['feedback:createpublictemplate'] = 'أنشئ قالب عام';
$string['feedback:deletesubmissions'] = 'أحذف التسليمات بالكامل';
...
$string['import_questions'] = 'اسنورد الأسئلة';
...
$string['not_selected'] = 'لم يتم الاختيار';
$string['not_started'] = 'لم يتم البدء';
$string['numeric'] = 'اجابة رقمية';
...
$string['save_entries'] = 'سلم إجاباتك';
