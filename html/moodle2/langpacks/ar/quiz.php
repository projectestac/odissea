...
/**
 * Strings for component 'quiz', language 'ar', branch 'MOODLE_36_STABLE'
 *
 * @package   quiz
...
$string['attemptquiznow'] = 'قم بمحاولة أداء الاختبار الآن';
...
$string['backtocourse'] = 'العودة إلى صفحة المقرر الدراسي';
...
$string['browsersecurity_help'] = 'إذا تم اختيار "ملء الشاشة المنبثقة مع بعض الأمن جافا سكريبت "  فإنه

 سيبدأ الاختبار فقط إذا كان الطالب مُفعَّل خيار جافا سكريبت  لمتصفح الإنترنت*
 يظهر الاختبار في نافذة منبثقة كامل الشاشة التي تغطي جميع النوافذ الأخرى وليس لديها عناصر التحكم   في التنقل
سوف يتم منع الطلاب ، بقدر ما هو ممكن، من استخدام الأدوات مثل النسخ واللصق';
...
$string['max'] = 'اقصى';
$string['messageprovider:confirmation'] = 'تأكيدات إرسالات الشخصية للاختبارات';
...
$string['modulename'] = 'اختبار';
$string['modulename_help'] = 'يمكن نشاط الاختبار المدرس من إنشاء اختبارات تضم أسئلة من مختلف الأنواع، بما فيها أسئلة الاختيار من متعدد، المطابقة، أجوبة قصيرة وأسئلة عددية.

  يستطيع المدرس أن يسمح بعدة محاولات للاختبار، مع خلط الأسئلة أو اختيارها عشوائياً من بنك الأسئلة، كما يمكن تعيين مهلة زمنية.

يتم تلقائياً وضع درجة لكل محاولة، مع استثاء الأسئلة المقالية، ويتم حفظ الدرجة في دفتر الدرجات.

يستطيع المدرس أن يختار متى، وفيما إذا كان سيتم إظهار أي تلميحات، إفادات، الأجوبة الصحيحة للطلاب.

يمكن استخدام الاختبارات:

* كامتحانات للمقرر
* كاختبارات قصيرة لواجبات القراءة أو اختبارات نهاية الوحدة.
*كامتحان تدريبي باستخدام أسئلة من الامتحانات السابقة.
* لإيصال إجابة تقييمية فورية حول الأداء.
* للتقييم الذاتي.';
$string['modulenameplural'] = 'اختبارات';
...
$string['newattemptfail'] = 'خطاء  -  لا يمكن البدئ في محاولة جديد لهذا الاختبار';
...
$string['overallfeedback_help'] = 'التغذية الراجعة العامة هي النص الذي يظهر بعد الانتهاء من الاختبار. بتحديد حدود إضافية للدرجة (كنسبة مئوية أو كرقم)، فإن النص الذي يظهر سيعتمد على الدرجة التي حصل عليها الطالب.';
...
$string['reviewclosed'] = 'بعد أن يغلق الاختبار';
...
$string['subplugintype_quiz'] = 'تقرير';
...
$string['viewed'] = 'تم استعراضها';
$string['warningmissingtype'] = '<b> هذا السؤال هو من النوع الذي لم يتم تثبيته على مودل الخاص بك حتى الآن. <br /> الرجاء تنبيه مُشرف موقع المودل. </b>';
