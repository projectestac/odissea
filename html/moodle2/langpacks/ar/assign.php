...
/**
 * Strings for component 'assign', language 'ar', branch 'MOODLE_36_STABLE'
 *
 * @package   assign
...
$string['attemptreopenmethod_help'] = 'هذا الخيار يُحدِّد كيفية إعادة فتح محاولات تسليم الطالب. الخيارات المتاحة هي :<ul><li>أبداً-تسليم  الطالب لا يمكن إعادة فتحه.</li><li>يدوياً- تسليم الطالب يمكن إعادة فتحه من قبل المعلم.</li><li>تلقائياً حتى النجاح-يتم إعادة فتح التسليم للطالب تلقائياً حتى يحقق الطالب درجة النجاح لتجاوز التكليف وهذه القيمة تكون مُحدَّدة في سجل الدرجات (داخل قسم إعدادات سجل الدرجات) لهذا التكليف.</li></ul>';
...
$string['numberofdraftsubmissions'] = 'مسودات';
$string['numberofparticipants'] = 'المشاركين';
$string['numberofsubmissionsneedgrading'] = 'بحاجة لتقييم';
...
$string['submissionstatus_marked'] = 'تم رصد درجة';
$string['submissionstatus_submitted'] = 'مسلمة للتقييم';
$string['submitassignment'] = 'تقديم مهمة';
