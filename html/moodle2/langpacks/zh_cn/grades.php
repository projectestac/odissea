...
$string['gradeexportcustomprofilefields'] = '成绩导出客户配置字段';
$string['gradeexportcustomprofilefields_desc'] = '在成绩导出中包含这些客户配置字段，用逗号分隔。';
...
$string['gradeexportuserprofilefields'] = '成绩导出用户配置字段';
$string['gradeexportuserprofilefields_desc'] = '在成绩导出中包含这些用户配置字段，用逗号分隔。';
...
$string['gradepointmax_help'] = '在一个活动中此设置决定的最大成绩值。';
