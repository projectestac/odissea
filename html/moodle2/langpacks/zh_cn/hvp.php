...
$string['changedby'] = '付费方式';
$string['changedescription'] = '更改说明';
...
$string['copyrighttitle'] = '查看这个内容的版权';
$string['couldnotcopy'] = '不能复制文件';
$string['couldnotsave'] = '不能保存文件';
$string['create'] = '创建';
$string['creativecommons'] = '知识共享';
$string['ctcachebuttonlabel'] = '更新内容类型缓存';
$string['ctcacheconnectionfailed'] = '无法与 H5P Hub通信，请稍后再试。';
$string['ctcachedescription'] = '确保内容类型缓存是最新，以确保您可以查看、下载和使用最新的库。这不同于更新库本身。';
$string['ctcachelastupdatelabel'] = '上次更新';
$string['ctcacheneverupdated'] = '从不';
$string['ctcachenolibraries'] = 'H5P Hub没有接收到任何内容类型。请稍后再试。';
$string['ctcachesuccess'] = '库缓存已成功更新！';
$string['ctcachetaskname'] = '更新内容类型缓存';
$string['dataviewreportlabel'] = '查看回答';
$string['date'] = '日期';
$string['disablefileextensioncheck'] = '禁用文件扩展名检查';
$string['disablefileextensioncheckwarning'] = '警告!禁用文件扩展名检查可能会影响安全性，因为它允许上传php文件。这反过来又可能使攻击者在您的站点上执行恶意代码。请确保您确切地知道您上传的是什么。';
$string['disablefullscreen'] = '禁用全屏';
$string['disablehubconfirmationmsg'] = '你还想启用Hub吗？';
$string['disablehubdescription'] = '强烈建议启用此选项。H5P Hub为获取新的内容类型和保持现有内容类型最新提供了一个简单的接口。在未来，它还将使共享和重用内容变得更加容易。如果禁用此选项，则必须通过文件上载表单安装和更新内容类型。';
...
$string['enabledlrscontenttypes_help'] = '使使用依赖于学习记录存储的内容类型 (如调查表内容类型) 正常运行成为可能。';
