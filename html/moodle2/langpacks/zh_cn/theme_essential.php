...
/**
 * Strings for component 'theme_essential', language 'zh_cn', branch 'MOODLE_26_STABLE'
 *
...
$string['alternativethemehovercolor'] = '替换主题 hover 颜色  {$a}';
...
$string['donate_title'] = 'Essential 捐赠';
...
$string['usecategoryicon'] = '启用分类图标';
$string['usecategoryicondesc'] = '使用自定义的分类图标';
...
$string['website'] = '网站 URL';
$string['websitedesc'] = '输入网站的 URL。 (比如 http://www.uplearning.nl)';
