...
/**
 * Strings for component 'block', language 'zh_cn', branch 'MOODLE_28_STABLE'
 *
 * @package   block
...
$string['createdat_help'] = '最初创建版块时的位置。版块设置可以使它出现在原始位置之下的其它位置（场景）。例如，在课程页面创建的版块可以显示在课程的活动中。创建在首页的版块可以在整个网站都显示。';
