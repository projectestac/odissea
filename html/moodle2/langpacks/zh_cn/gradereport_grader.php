...
/**
 * Strings for component 'gradereport_grader', language 'zh_cn', branch 'MOODLE_32_STABLE'
 *
...
$string['ajaxclicktoclose'] = '点击此框删除它';
$string['ajaxerror'] = '错误';
$string['ajaxfailedupdate'] = '无法为[2]更新[1]';
$string['ajaxfieldchanged'] = '您正在编辑的字段被修改了，您想使用修改后的值吗？';
$string['eventgradereportviewed'] = '成绩报表查看';
