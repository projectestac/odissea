...
$string['congratulations'] = '恭喜—课程结束';
$string['continue'] = '继续';
...
$string['displayofgrade'] = '仅向学生显示成绩';
...
$string['displayscorewithoutessays'] = '您的分数是{$a->score}(出自$a->grade})。';
...
$string['firstwrong'] = '你回答错了。你想再试一次这个问题吗?(如果你现在正确地回答了这个问题，它也不计入你的最终分数。)';
...
$string['full'] = '展开的';
$string['general'] = '一般';
$string['gotoendoflesson'] = '到程序教学末尾';
$string['grade'] = '成绩';
...
$string['modattemptsnoteacher'] = '学生复审只对学生有效。';
...
$string['new'] = '新的';
$string['nextpage'] = '下一页';
$string['noanswer'] = '未回答问题。请返回并提交一个答案。';
...
$string['nolessonattemptsgroup'] = '{$a}组成员在此程序教学没有做任何尝试。';
...
$string['ongoingcustom'] = '到目前为止，您已经从{$a->currenthigh}分中获得了 {$a->score}分。';
$string['ongoing_help'] = '如果启用，每个页面都会显示学生已经获得的分数和目前的总分。';
$string['ongoingnormal'] = '您已经在{$a->viewed} 尝试中正确地回答了{$a->correct}。';
...
$string['teacherjumpwarning'] = '此程序教学使用了一个{$a->cluster}跳转或一个{$a->unseen}跳转。将使用“下一页”跳转模式替代。以学生身份登录来测试这些跳转。';
...
$string['unseenpageinbranch'] = '内容页中未显示的题目';
...
$string['youhaveseen'] = '您已经浏览了本程序教学的多个页面。<br />想从上次结束的页面开始吗？';
$string['youranswer'] = '您的答案';
$string['yourcurrentgradeis'] = '您当前的分数是{$a}';
$string['yourcurrentgradeisoutof'] = '您目前的分数是{$a->grade}（出自{$a->total}）';
