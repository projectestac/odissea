...
/**
 * Strings for component 'enrol_ldap', language 'zh_cn', branch 'MOODLE_32_STABLE'
 *
 * @package   enrol_ldap
...
$string['autoupdate_settings_desc'] = '<p>同步脚本(enrol/ldap/cli/sync.php)运行时，选定更新字段.</p><p>至少需要选定一个字段用来更新</p>';
