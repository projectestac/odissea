...
/**
 * Strings for component 'questionnaire', language 'zh_cn', branch 'MOODLE_34_STABLE'
 *
...
$string['download'] = '下载';
$string['downloadtextformat'] = '以文本格式下载';
$string['dropdown'] = '下拉框';
$string['edit'] = '编辑';
