...
$string['attemptfirst'] = '第一次尝试';
$string['attemptincomplete'] = '{$a} 的答题尚未完成。';
$string['attemptlast'] = '最后一次尝试';
$string['attemptnumber'] = '尝试';
$string['attemptquiznow'] = '现在尝试测验';
$string['attempts'] = '试卷';
...
$string['connectionerror'] = '网络连接丢失。（自动保存失败）。
...
$string['overduehandlingautoabandon'] = '学生必须在考试时间耗尽前点击交卷按钮，否则不计成绩';
$string['overduehandlingautosubmit'] = '考试时间耗尽后，服务器自动帮他交卷';
$string['overduehandling_desc'] = '学生没有在期限终止前提交测验会默认发生什么。';
$string['overduehandlinggraceperiod'] = '考试时间耗尽后，学生可以晚点交卷，但不能再答题了';
...
$string['overduemustbesubmittedby'] = '此次尝试现在已经过期了。它应该已经提交了。如果您想给这个测验评分的话，您必须通过{$a}提交。如果您没有那样提交，这次尝试的得分将不计算在内。';
$string['override'] = '覆盖';
...
$string['reviewofattempt'] = '检查尝试{$a}';
$string['reviewofpreview'] = '检查预览';
...
$string['summaryofattempt'] = '尝试概要';
$string['summaryofattempts'] = '您上次尝试的概要';
