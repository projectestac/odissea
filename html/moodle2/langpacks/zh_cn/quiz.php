...
$string['addquestionfrombankatend'] = '在测验尾部添加题库中的问题';
...
$string['addrandomquestionatend'] = '在测验尾部添加一个随机问题';
$string['addrandomquestiontopage'] = '添加一个随机的问题到页面{$a}';
$string['addrandomquestiontoquiz'] = '向测验{$a}添加一道随机题';
$string['addselectedquestionstoquiz'] = '添加所选的试题到测验里';
...
$string['canredoquestions'] = '允许重做尝试';
$string['canredoquestions_desc'] = '若启用，当学生完成一次作答，他们会看到一个“重做试题”按钮。这会允许他们重做本题，而不需要提交整份测验。
这一选项主要用在“练习性测验”，不要用在“论述题”，以及作答方式是“立即反馈”或“可多次作答”。';
$string['canredoquestions_help'] = '若启用，当学生完成一次作答，他们会看到一个“重做试题”按钮。这会允许他们重做本题，而不需要提交整份测验。
这一选项主要用在“练习性测验”，不要用在“论述题”，以及作答方式是“立即反馈”或“可多次作答”。';
$string['canredoquestionsyes'] = '学生可以重做已经作答的试题';
...
$string['completionattemptsexhausted'] = '或所有可用的尝试已用尽';
$string['completionattemptsexhausted_help'] = '当学生已经耗尽所有的尝试次数时，标记测验完成。';
$string['completionpass'] = '需要通过分数';
$string['completionpass_help'] = '如启用，当学生达到成绩表中的通过分数时标记活动已完成';
...
$string['eventattemptdeleted'] = '尝试删除测验';
$string['eventattemptpreviewstarted'] = '尝试开始预览测验';
$string['eventattemptreviewed'] = '检查了试答的测验';
$string['eventattemptsummaryviewed'] = '查看了试答测验的简报';
$string['eventattemptviewed'] = '查看了试答的测验';
$string['eventeditpageviewed'] = '测验编辑页面浏览';
$string['eventoverridecreated'] = '重定创建测验';
$string['eventoverridedeleted'] = '重写删除测验';
$string['eventoverrideupdated'] = '重写更新测验';
$string['eventquestionmanuallygraded'] = '试题手动分级';
$string['eventquizattemptabandoned'] = '尝试放弃测验';
$string['eventquizattemptstarted'] = '尝试开始测验';
$string['eventquizattemptsubmitted'] = '提交了试答的测验';
$string['eventquizattempttimelimitexceeded'] = '尝试次数超过时间限制';
$string['eventreportviewed'] = '查看测验报告';
...
$string['graceperiod_desc'] = '把“时间超过时要怎么做？“设置为”允许在宽限时间内提交，但不可以更改任何答案“时，所允许的默认额外时间(以秒为单位)。';
$string['graceperiod_help'] = '把“时间超过时要怎么做？“设置为”允许在宽限时间内提交，但不可以更改任何答案“时所允许的默认额外时间。';
$string['graceperiodmin'] = '最后提交宽限时间';
$string['graceperiodmin_desc'] = '测验结束后存在的问题：一方面，希望配合计时器和自动提交功能，让学生作答到最后一秒；另一方面，服务器可能会超载，反应较慢，而产生延时问题。所以我们需要根据作答时服务器的表现，制订一个合理的宽限时间，使得学生不会因为服务器问题而受到惩罚。';
...
$string['groupoverridesdeleted'] = '已删除群组重做';
...
$string['overduehandlingautosubmit'] = '开放的尝试会自动提交';
$string['overduehandling_desc'] = '学生没有在期限终止前提交测验会默认发生什么。';
$string['overduehandlinggraceperiod'] = '开放的尝试可以在宽限的时间内提交，但不能回答更多问题';
...
$string['overduemustbesubmittedby'] = '这个尝试现在已经过期。它应该已经被提交。如果希望重新修改这个测验，你必须通过 {$a}提交。如果没有通过它提交，则不计算在内。';
$string['override'] = '覆盖';
...
$string['page-mod-quiz-attempt'] = '尝试测验页面';
$string['page-mod-quiz-edit'] = '编辑测验页面';
$string['page-mod-quiz-report'] = '任何一个测验报告页面';
$string['page-mod-quiz-review'] = '回顾测验尝试页面';
$string['page-mod-quiz-summary'] = '尝试摘要页面';
$string['page-mod-quiz-view'] = '测验资料页面';
...
$string['questiondependencyadd'] = '试题{$a->thisq} 可以作答，没有限制。点选可以更改';
$string['questiondependencyfree'] = '这道试题没有限制';
$string['questiondependencyremove'] = '除非试题{$a->previousq}已经作答，否则试题{$a->thisq}无法作答。点选可以更改';
$string['questiondependsonprevious'] = '除非前一试题已经作答，否则该试题无法作答';
...
$string['questionposition'] = '为问题{$a}有新位置';
$string['questions'] = '试题';
...
$string['redoesofthisquestion'] = '其他已经作答的试题在：{$a}';
...
$string['reportshowonlyfinished'] = '每个用户最多显示一次已完成的尝试 ({$a})';
...
$string['shufflequestions_help'] = '若你启动它，那每一次作答测验时，将随机排列试题。
这会使学生更难共享答案(作弊)，但也使学生更难与你讨论某道试题。';
...
$string['theattempt_help'] = '学生是否可以检查所有的尝试。';
$string['time'] = '时间';
...
$string['useroverridesdeleted'] = '已删除用户重做';
