...
$string['addquestionfrombanktopage'] = '添加题库到页面{$a}';
...
$string['completionattemptsexhausted'] = '或用所有可用的尝试去完成';
$string['completionattemptsexhausted_help'] = '当学生已经耗尽所有的尝试次数时，标记测验完成。';
$string['completionpass'] = '请求及格';
$string['completionpass_help'] = '如果启用，当一个学生都能获得及格，在成绩簿设置及格分数，此活动被认为是完整的。';
...
$string['overduehandlingautosubmit'] = '打开尝试是自动提交';
$string['overduehandling_desc'] = '学生没有在期限终止前提交测验会默认发生什么。';
$string['overduehandlinggraceperiod'] = '当开放尝试用于提交的时候，有一个开放限期。但没有更多的题目去回答';
...
$string['reportshowonlyfinished'] = '显示每一个用户最多一个已完成的尝试（{$a}）';
