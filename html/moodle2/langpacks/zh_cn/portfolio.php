...
/**
 * Strings for component 'portfolio', language 'zh_cn', branch 'MOODLE_34_STABLE'
 *
 * @package   portfolio
...
$string['enableddesc'] = '如果启用，用户可以将内容（例如论坛帖子和作业提交）导出到外部组合或HTML页面。';
...
$string['nocallbackfile'] = '你正试图从中导出的模块有些问题——找不到请求的组合文件';
