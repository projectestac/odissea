...
$string['activities_help'] = '各种活动，例如讨论区、测验和Wiki，使课程获得各种互动功能';
$string['activity'] = '活动';
...
$string['addactivitytosection'] = '新增一个活动到小节 {$a}';
...
$string['again'] = '再一次';
$string['agelocationverification'] = '年龄和地区认证';
$string['aimid'] = 'AIM号码';
...
$string['considereddigitalminor'] = '您被认为未达到可进行数字承诺的年龄。';
$string['content'] = '内容';
$string['continue'] = '继续';
...
$string['coursealreadyfinished'] = '课程已结束';
...
$string['coursehelpnumberweeks'] = '课程中的章节数量（仅适用于某些课程格式）。';
...
$string['coursenotyetfinished'] = '课程尚未完成';
$string['coursenotyetstarted'] = '课程尚未开始';
$string['courseoverview'] = '课程总览';
$string['courseoverviewfiles'] = '课程摘要文件';
$string['courseoverviewfilesext'] = '课程说明文件类型';
...
$string['default'] = '缺省';
$string['defaultcompetencescale'] = '默认能力等级';
...
$string['digitalminor'] = '未达数字承诺年龄';
$string['digitalminor_desc'] = '如想在本站创建账号，请让您的家长或监护人联系以下人员。';
$string['directory'] = '字典';
$string['disable'] = '禁用';
...
$string['emailpasswordconfirmmaybesent'] = '<p>如果您提供了正确的用户名或email地址，那么一封email已经发送给您。</p>
...
$string['emailuserhasnone'] = '该用户无电子邮件地址。';
...
$string['eventcommentcreated'] = '评论创建了';
$string['eventcommentdeleted'] = '删除了的评论';
$string['eventcommentsviewed'] = '查看过的评论';
$string['eventconfiglogcreated'] = '已创建配置记录';
$string['eventcontentviewed'] = '已浏览的内容';
$string['eventcoursebackupcreated'] = '已创建课程备份';
...
$string['eventcoursemoduleupdated'] = '课程模块已更新';
$string['eventcoursemoduleviewed'] = '查看了课程模块';
$string['eventcourseresetended'] = '课程重置完成';
$string['eventcourseresetstarted'] = '课程重置开始';
$string['eventcourserestored'] = '课程已恢复';
$string['eventcoursesectioncreated'] = '已创建课程章节';
...
$string['eventdashboardreset'] = '仪表盘重置';
$string['eventdashboardsreset'] = '仪表盘重置';
$string['eventdashboardviewed'] = '仪表盘界面';
$string['eventemailfailed'] = '无法发送邮件';
...
$string['eventuserinfocategorycreated'] = '已创建用户档案字段类别';
$string['eventuserinfocategorydeleted'] = '已删除用户档案字段分类';
$string['eventuserinfocategoryupdated'] = '用户档案字段分类已更新';
$string['eventuserinfofieldcreated'] = '已创建用户档案字段';
$string['eventuserinfofielddeleted'] = '已删除用户档案字段';
$string['eventuserinfofieldupdated'] = '已更新用户档案字段';
$string['eventuserlistviewed'] = '查看用户列表';
$string['eventuserloggedout'] = '已退出的用户';
$string['eventuserpasswordupdated'] = '修改了用户密码';
$string['eventuserprofileviewed'] = '浏览用户个人资料';
$string['eventuserupdated'] = '已更新的用户';
...
$string['explanationdigitalminor'] = '此信息用于确认您是否已达到可进行数字承诺的年龄。此年龄是个人可对条款及条件做出承诺，且个人信息合法存储及处理。';
...
$string['frontpagedescriptionhelp'] = '此描述将显示含有课程/站点描述区域的首页。';
...
$string['groupextendenrol'] = '延长选课时间（通用）';
$string['groupfor'] = '为组';
...
$string['hiddenoncoursepage'] = '启用但不在课程页面显示';
...
$string['indicator:accessesafterend'] = '课程结束后被访问';
$string['indicator:accessesafterend_help'] = '此标识反映学生是否在课程结束后访问过课程此标识反映学生是否在课程结束后访问过课程。';
$string['indicator:accessesbeforestart'] = '课程在开始前被访问';
$string['indicator:accessesbeforestart_help'] = '此标识反映学生是否在课程开始前对课程进行了访问。';
$string['indicator:anywrite'] = '任何写操作';
$string['indicator:anywrite_help'] = '此标识代表学生进行的任何写(提交)操作。';
$string['indicator:anywriteincourse'] = '课程中的任何写操作';
$string['indicator:anywriteincourse_help'] = '此标识代表学生在任何课程活动中进行的写(提交)操作。';
$string['indicator:completeduserprofile'] = '用户档案已完善';
$string['indicator:completeduserprofile_help'] = '此标识代表学生已完善了其用户档案。';
$string['indicator:completionenabled'] = '进度跟踪启用了';
...
$string['indicator:potentialcognitive_help'] = '这个指标基于学生参与课程活动所能达到的潜在认知深度。';
$string['indicator:potentialsocial'] = '课程潜在的社会广度';
$string['indicator:potentialsocial_help'] = '这个指标是基于学生参与课程活动所能达到的潜在的社会广度。';
$string['indicator:readactions'] = '读设置数量';
$string['indicator:readactions_help'] = '此标识代表学生进行的读(浏览)操作的数量。';
$string['indicator:userforumstracking'] = '用户正在跟踪论坛';
$string['indicator:userforumstracking_help'] = '此标识代表学生是否在论坛中打开跟踪功能。';
$string['info'] = '信息';
...
$string['loginsteps'] = '为了能完全访问此网站，您首先需要创建一个帐户。';
...
$string['maxnumberweeks'] = '最大节数';
$string['maxnumberweeks_desc'] = '下拉菜单数量的最大值（仅适用于特定课程格式）。';
$string['maxnumcoursesincombo'] = '浏览<a href="{$a->link}">{$a->numberofcourses}门课程</a>。';
$string['maxsize'] = '大小限制: {$a}';
$string['maxsizeandareasize'] = '新文件的最大：{$a->size}，总限制：{$a->areasize}';
$string['maxsizeandattachments'] = '新文件的最大尺寸： {$a->size} ，最多附件：{$a->attachments}';
$string['maxsizeandattachmentsandareasize'] = '新文件的最大：{$a->size}，附件最多：{$a->attachments}，总限制：{$a->areasize}';
$string['memberincourse'] = '课程成员';
$string['messagebody'] = '消息正文';
$string['messagedselectedcountusersfailed'] = '出现问题， {$a}条信息未发送。';
$string['messagedselecteduserfailed'] = '信息未发送到用户 {$a->fullname}。';
$string['messagedselectedusers'] = '消息已经发给选择的用户，接收者列表被重置。';
$string['messagedselectedusersfailed'] = '给选中用户发送信息时出错。一些用户可能收到了邮件。';
$string['messageprovider:availableupdate'] = '可用更新通知';
...
$string['messageprovider:competencyusercompcomment'] = '发表在权限上的评论';
$string['messageprovider:courserequestapproved'] = '课程申请被批准通知';
$string['messageprovider:courserequested'] = '课程创建请求通知';
$string['messageprovider:courserequestrejected'] = '课程申请被拒绝通知';
$string['messageprovider:errors'] = '本站的严重错误';
$string['messageprovider:errors_help'] = '有管理员必须知晓的严重的错误。';
$string['messageprovider:insights'] = '预测模型产生的洞察力';
$string['messageprovider:instantmessage'] = '用户间的私人信息';
$string['messageprovider:instantmessage_help'] = '此小节配置在收到本站其他用户直接发给您的消息后，该如何处理。';
$string['messageprovider:notices'] = '关于某些小问题的通知';
$string['messageprovider:notices_help'] = '有一些管理员可能会感兴趣的通知';
...
$string['missingrecaptchachallengefield'] = 'reCAPTCHA验证失败，请重试。';
...
$string['modvisible'] = '有效性';
$string['modvisible_help'] = '如果可见性设为“在课程页面显示”，学生就可以访问活动或资源（也可以添加其他访问限制）<br><br>
如果可见性设为“对学生隐藏”，只有拥有特定权限的用户才可以查看隐藏的活动或资源（默认情况下指的是教师或无编辑权教师角色的用户）。';
$string['modvisiblehiddensection'] = '有效性';
$string['modvisiblehiddensection_help'] = '如果可见性设为“对学生隐藏”，只有拥有特定权限的用户才可以查看隐藏的活动或资源（默认情况下指的是教师或无编辑权教师角色的用户）。<br><br>
如果课程包含许多活动或资源，可以通过“不在课程页面显示但仍可用”将课程页面简化。这种情况下，必须提供一个指向活动或资源的链接，否则将无法访问。活动仍会被列在成绩册和其他报表中。';
$string['modvisiblewithstealth'] = '有效性';
$string['modvisiblewithstealth_help'] = '如果可见性设为“在课程页面显示”，学生就可以访问活动或资源（也可以添加其他访问限制）<br><br>
如果可见性设为“对学生隐藏”，只有拥有特定权限的用户才可以查看隐藏的活动或资源（默认情况下指的是教师或无编辑权教师角色的用户）。<br><br>
如果课程包含许多活动或资源，可以通过“不在课程页面显示但仍可用”将课程页面简化。这种情况下，必须提供一个指向活动或资源的链接，否则将无法访问。活动仍会被列在成绩册和其他报表中。';
$string['month'] = '月';
$string['months'] = '月';
...
$string['nocourseactivity'] = '课程的开始与结束日期之间无足够课程活动';
$string['nocourseendtime'] = '这门课程没有课程结束日期';
$string['nocourses'] = '没有课程';
$string['nocoursesections'] = '无课程章节';
$string['nocoursesfound'] = '没有含关键词“{$a}”的课程';
$string['nocoursestarttime'] = '该课程无开始时间';
...
$string['noneditingteacherdescription'] = '无编辑权教师可以教课和给学生打分，但是可能不能修改活动。';
...
$string['noreplybouncemessage'] = '您把回复信发到了一个”不可回复“的email地址上。如果您想要回复论坛中的帖子，请使用讨论区{$a}来。
...
$string['notingroup'] = '抱歉，您需要加入群组才可浏览此页。';
...
$string['participants'] = '成员';
$string['participantscount'] = '参与课程人数: {$a}';
...
$string['passwordforgotteninstructions2'] = '想重置密码，请在下面提交您的用户名或email地址。如果数据库中有关于您的记录，我们会向您的email地址发送一封邮件。邮件会讲解如何重新获得访问权。';
...
$string['policyagreementclick'] = '网站政策协议的链接';
$string['popup'] = '弹出';
...
$string['quotausage'] = '您当前已使用总配额 {$a->total} 中的 {$a->used}。';
...
$string['rsserrorauth'] = '您的RSS链接不包含有效的认证标记';
$string['rsserrorguest'] = '这个种子使用访客身份访问数据，但是访客没有阅读数据的权限。请以一个有效的用户访问这个种子的原始地址（URL），并取得一个新的 RSS 链接。';
...
$string['scalestandard_help'] = '标准等级在全站的所有课程中都可用。';
$string['scalestip'] = '使用管理菜单的“等级...”链接创建自定义等级';
$string['scalestip2'] = '要建立自定义等级，请点击课程管理菜单里的“成绩”链接，然后选择编辑、等级。';
$string['schedule'] = '时间表';
...
$string['secs'] = '秒';
$string['section'] = '小节';
$string['sectionactionnotsupported'] = '这里不支持章节活动  "{$a}"';
$string['sectionname'] = '小节名';
$string['sections'] = '小节';
$string['sectionusedefaultname'] = '使用缺省的小节名';
$string['seealsostats'] = '请参阅：统计';
$string['selctauser'] = '选择一个用户';
$string['select'] = '选择';
$string['selectacategory'] = '选用选择一个类别';
...
$string['selectcategorysort'] = '你要对哪一个类别做排序？';
$string['selectcategorysortby'] = '选择你默认的类别排序';
$string['selectcoursesortby'] = '选择你默认的课程排序';
...
$string['separateandconnectedinfo'] = '此评级基于独立型和情景型认知理论。此理论描述了我们了解和评价所闻所见事物的两种不同方法。<ul><li><strong>独立型的人</strong>总是尽量保持客观，避免受感觉和情绪的影响。在与其他人讨论时，他们喜欢维护自己的观点，用逻辑找出对手观点中的漏洞。</li><li><strong>情景型的人</strong>比其他人更敏感。 他们善于换位思考，喜欢倾听和提问，直到他们觉得自己能从别人的角度理解事物。他们通过分享自己的经验，来从他人获得知识。</li></ul>';
$string['servererror'] = '和服务器通讯时发生了一个错误';
...
$string['shortnamecourse_help'] = '课程简称将在导航中显示，并且会被用在课程email的标题中。';
...
$string['showdescription_help'] = '如果启用，上述说明将显示在活动或资源链接下方的课程页面上。';
...
$string['sitehome'] = '网站首页';
$string['sitelegacyfiles'] = '继承的网站文件';
$string['sitelogs'] = '本站日志';
$string['sitemessage'] = '用户留言';
$string['sitenews'] = '本站新闻通告';
...
$string['startdate_help'] = '此设置以每周格式确定课程的第一周的开始时间。 它还确定课程活动的日志可用的最早日期。 如果课程重置，课程开始日期更改，课程中的所有日期将相对于新的开始日期移动。';
...
$string['tags'] = '标签';
$string['target:coursedropout'] = '有辍学风险的学生';
$string['target:coursedropout_help'] = '这个目标描述了这个学生是否被认为有辍学的危险。';
$string['targetlabelstudentdropoutno'] = '不是风险';
$string['targetlabelstudentdropoutyes'] = '有退学风险的学生';
$string['targetlabelteachingno'] = '没有教学活动';
$string['targetlabelteachingyes'] = '有教学能力的用户可访问此课程';
$string['target:noteachingactivity'] = '没有教学活动';
$string['target:noteachingactivity_help'] = '这个目标描述了在下周开始的课程是否会有教学活动。';
...
$string['timesplitting:decilesaccum'] = '十分法累计';
$string['timesplitting:decilesaccum_help'] = '这个时间分割方法将这门课程时间分成了十个十分之一(10个相等的部分)，每个预测都是基于之前所有的十分之一数据。';
$string['timesplitting:deciles_help'] = '这个时间分割方法将这门课程时间分成了十个十分之一(10个相等的部分)，每个预测都是基于最近的十分之一数据。';
$string['timesplitting:nosplitting'] = '没有时间分割';
$string['timesplitting:nosplitting_help'] = '该模型没有定义时间分割的方法。';
$string['timesplitting:quarters'] = '四分法';
$string['timesplitting:quartersaccum'] = '四分法累计';
$string['timesplitting:quartersaccum_help'] = '这种时间分割的方法将课程分为四个四分之一(4个相等的部分)，每个预测都基于所有四分之一的数据。';
$string['timesplitting:quarters_help'] = '这种时间分割方法将课程时间分为四个四分之一(4个相等的部分)，每个预测都基于最近一个四分之一的数据。';
$string['timesplitting:singlerange'] = '单一的范围';
$string['timesplitting:singlerange_help'] = '这种时间分割的方法将整个课程视为一个单一的时间段。';
$string['timesplitting:weekly'] = '每周';
$string['timesplitting:weeklyaccum'] = '周累计';
$string['timesplitting:weeklyaccum_help'] = '这种时间分割的方法将课程划分为几周(7天)，每个预测都基于前几周的数据。';
$string['timesplitting:weekly_help'] = '这种时间分割方法将课程划分为几周(7天)，每个预测都基于最近一周的数据。';
$string['timezone'] = '时区';
$string['to'] = '截止时间';
...
$string['viewallcoursescategories'] = '查看所有课程和分类';
...
$string['welcometocoursetext'] = '欢迎您加入{$a->coursename}！

如果您还没有做，请修改课程中个人资料，这样我们才可以进一步了解您：
...
$string['whyisthisrequired'] = '为什么需要此信息？';
...
$string['withselectedusers_help'] = '* 发送消息 - 向一名或多名成员发送消息
* 添加备注 - 向一名已选择的成员添加备注
* 添加通用备注 - 向多名成员添加相同的备注';
