...
$string['categorybulkaction'] = '对选定类别的批量操作';
...
$string['coursebulkaction'] = '对选定课程的批量操作';
...
$string['coursehelpnewsitemsnumber'] = '课程主页右边新闻版块中显示的最近新闻条数。 如果设置为零，则不会显示最新的新闻板块。';
...
$string['default'] = '缺省';
$string['defaultcompetencescale'] = '默认能力标记';
...
$string['firstname'] = '名';
$string['firstnamephonetic'] = '名 的 拚音';
...
$string['registrationcontactno'] = '不，我不希望在网站列表中显示联系表格';
$string['registrationcontactyes'] = '是，提供一个表格给预期的Moodle用户以方便他联系我';
