...
$string['default'] = '缺省';
$string['defaultcompetencescale'] = '默认权限标记';
$string['defaultcompetencescaledesc'] = '除了某人是否已经表现出熟练程度以外，二进制评分表不提供进一步的信息。';
$string['defaultcompetencescalenotproficient'] = '尚无权限';
$string['defaultcompetencescaleproficient'] = '权限';
