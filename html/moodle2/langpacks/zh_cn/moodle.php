...
$string['again'] = '再一次';
$string['agelocationverification'] = '年龄和位置验证';
$string['aimid'] = 'AIM号码';
...
$string['clicktohideshow'] = '点击展开或折叠';
...
$string['considereddigitalminor'] = '您太小了，不能在这个网站上创建帐户。';
$string['content'] = '内容';
$string['continue'] = '继续';
...
$string['eventcommentcreated'] = '创建了评论';
$string['eventcommentdeleted'] = '删除了评论';
...
$string['explanationdigitalminor'] = '此信息用于确认您是否已达到可进行数字承诺的年龄。此年龄是个人可对条款及条件做出承诺，他们的数据被合法地存储和处理。';
...
$string['messagedselectedcountusersfailed'] = '出现问题， {$a}条消息未发送。';
$string['messagedselecteduserfailed'] = '消息未发送到用户 {$a->fullname}。';
...
$string['notingroup'] = '抱歉，您需要加入小组才可浏览此页。';
...
$string['passwordforgotteninstructions2'] = '要重置您的密码，请在下面提交您的用户名或您的电子邮件地址。如果我们能在数据库中找到您，一封电子邮件将会发送到您的电子邮件地址，并说明如何再次获得访问权限。';
...
$string['showgrades_help'] = '课程中的许多活动允许设定成绩。此设置确定学生是否可以通过导航抽屉或版块中的“成绩”链接查看课程的所有成绩列表。';
...
$string['usernameoremail'] = '输入用户名或者Email地址';
...
$string['whyisthisrequired'] = '为什么需要这个?';
