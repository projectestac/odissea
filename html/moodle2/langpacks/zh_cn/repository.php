...
/**
 * Strings for component 'repository', language 'zh_cn', branch 'MOODLE_36_STABLE'
 *
 * @package   repository
...
$string['configgetfiletimeout'] = '下载一个外部文件到Moodle的超时时间，以秒为单位。';
...
$string['confirmdeletefile'] = '您确定要删除此文件？';
...
$string['xhtmlerror'] = '您似乎正使用严格的XHTML头信息。某些特定的YUI组件不支持这种模式，请关闭它。';
