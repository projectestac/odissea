...
$string['eventcalendareventdeleted'] = '删除了日历事件';
...
$string['invalidtimedurationminutes'] = '您输入的持续分钟数是无效的。请输入大于0的数，或者选择不持续。';
$string['invalidtimedurationuntil'] = '您为“持续到”选择的时间和日期早于此事件的开始时间。请在继续处理前，纠正它。';
...
$string['repeateditall'] = '也应用到此重复系列的其它{$a}事件';
$string['repeateditthis'] = '仅应用到此事件';
