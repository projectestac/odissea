...
$string['cannotfindorcreateforum'] = '无法找到或创建该网站的主新闻通告论坛';
...
$string['couldnotadd'] = '由于未知的错误无法添加您的帖子';
...
$string['discussionsubscription'] = '讨论订阅';
...
$string['eventdiscussionunpinned'] = '话题不再置顶';
...
$string['forum:canoverridediscussionlock'] = '回复已冻结的话题';
...
$string['markasreadonnotification'] = '何时发送新帖提醒';
$string['markasreadonnotification_help'] = '当你收到新帖提醒，你可以选择是否把你的讨论区跟踪标记为已读。';
...
$string['namenews_help'] = '课程新闻通告讨论是一个特殊的公告论坛，在创建课程时自动创建。一门课程只能有一个通告论坛。只有教师和管理员才能发布通告。 “最新通告”栏将显示最近的通告。';
...
$string['smallmessagedigest'] = '讨论区摘要里有{$a} 条消息';
