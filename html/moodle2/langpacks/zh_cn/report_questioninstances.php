...
/**
 * Strings for component 'report_questioninstances', language 'zh_cn', branch 'MOODLE_31_STABLE'
 *
...
$string['reportforqtype'] = '题目类型“{$a}”的报表';
$string['reportsettings'] = '报表设置';
$string['totalquestions'] = '总数';
$string['visiblequestions'] = '可见';
