...
/**
 * Strings for component 'portfolio_picasa', language 'zh_cn', branch 'MOODLE_28_STABLE'
 *
...
$string['oauth2upgrade_message_content'] = '作为升级至 Moodle 2.3 的一部分，Picasa 组合插件已被禁用。若要重新启用，您的 Moodle 站点需要在 Google 重新注册，以获得一个客户端 ID 和密匙，正如在文档 {$a->docsurl} 中描述的那样。客户端 ID 和密匙可以被用来配置所有的 Google 文档和 Picasa 插件。';
$string['oauth2upgrade_message_small'] = '该插件已被禁用，因为它需要文档里所说的 Google OAuth 2.0 设置的配置。';
$string['oauth2upgrade_message_subject'] = '关于 Picasa 组合插件的重要信息';
