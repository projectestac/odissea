...
/**
 * Strings for component 'feedback', language 'zh_cn', branch 'MOODLE_36_STABLE'
 *
 * @package   feedback
...
$string['completed_feedbacks'] = '已提交回答';
...
$string['non_anonymous'] = '用户名将被记录并与回答一起显示';
$string['non_anonymous_entries'] = '非匿名条目 ({$a})';
$string['non_respondents_students'] = '未答复的学生 ({$a})';
$string['not_completed_yet'] = '还未完成';
$string['no_templates_available_yet'] = '还没有模板';
$string['not_selected'] = '未选择的';
$string['not_started'] = '没有开始的';
$string['numberoutofrange'] = '超出范围的数';
$string['numeric'] = '数字题';
...
$string['show_nonrespondents'] = '显示未答复';
