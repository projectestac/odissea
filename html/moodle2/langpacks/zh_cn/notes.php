...
/**
 * Strings for component 'notes', language 'zh_cn', branch 'MOODLE_28_STABLE'
 *
 * @package   notes
...
$string['nonotes'] = '没有这种类型的备注';
$string['nopermissiontodelete'] = '您不能删除此备注';
$string['note'] = '备注';
$string['notes'] = '备注';
$string['notesdisabled'] = '对不起，备注功能已禁用';
$string['notesnotvisible'] = '您无权查看备注！';
$string['nouser'] = '您必须选择一个用户';
