...
/**
 * Strings for component 'admin', language 'zh_cn', branch 'MOODLE_32_STABLE'
 *
 * @package   admin
...
$string['pathtounoconv_help'] = '到 unoconv 文件转换器的路径。这是一个可执行的文件，它可用来转换LibreOffice软件所支持的各种文件格式。这是可自由选用的，但若指定了，Moodle将会用它来自动转换文件格式。这是用来支持以PDF批注作业活动的多种输入文件。';
