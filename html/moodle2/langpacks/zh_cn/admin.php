...
/**
 * Strings for component 'admin', language 'zh_cn', branch 'MOODLE_34_STABLE'
 *
 * @package   admin
...
$string['additionalhtml_desc'] = '这些设置允许你设定你想添加到每个页面的HTML代码。你可以在紧挨着<body>标签之后，或者紧挨着</body>之前，设定那些会被包含在<head></head>之间的HTML代码。<br />这么做让你能在每个页面上添加自定义的页眉和页脚，或者非常方便地添加像Google Analytics之类的服务支持，并与你所选的主题无关。';
...
$string['agedigitalconsentverification'] = '数字时代的同意验证';
$string['ageofdigitalconsentmap'] = '数字时代的同意书';
...
$string['mobile'] = '手机';
$string['mobilenotconfiguredwarning'] = 'Moodle 移动应用没有启用。';
...
$string['unsupporteddbfileformat'] = '你的数据库的数据表现在使用 Antelope 作为文件格式。而在MySQL 和 MariaDB 上要有完整的UTF-8支持需要Barracuda文件格式。请转换数据表到Barracuda格式。
请参考网页 <a href="https://docs.moodle.org/en/cli">同命令行进行管理</a> 以了解转换InnoDB 数据表到Barracuda的工具详细资料。';
