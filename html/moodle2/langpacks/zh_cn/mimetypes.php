...
$string['application/vnd.oasis.opendocument.text'] = 'OpenDocument文本文档';
$string['application/vnd.oasis.opendocument.text-template'] = 'OpenDocument文本模板';
...
$string['image/vnd.microsoft.icon'] = 'Windows图标';
$string['text/css'] = 'CSS层叠样式表';
