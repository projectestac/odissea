...
/**
 * Strings for component 'message', language 'zh_cn', branch 'MOODLE_36_STABLE'
 *
 * @package   message
...
$string['addcontactconfirm'] = '您确定要将{$a}添加到您的联系人吗?';
...
$string['info'] = '用户信息';
$string['isnotinyourcontacts'] = '{$a}不是你的联系人';
...
$string['messagepreferences'] = '信息偏好';
$string['messages'] = '消息';
...
$string['nocontactrequests'] = '没有联系请求';
...
$string['removecontactconfirm'] = '您确定要把{$a}从联系人中删除吗？';
$string['removefromfavourites'] = '取消标星对话';
$string['removefromyourcontacts'] = '从联系人中删除';
$string['requirecontacttomessage'] = '您需要加{$a}为联系人才能发消息';
...
$string['send'] = '发送';
$string['sendcontactrequest'] = '发送联系请求';
...
$string['unabletomessage'] = '您无法向该用户发送消息';
$string['unblock'] = '解除屏蔽';
$string['unblockcontact'] = '对联系人解除屏蔽';
$string['unblockuser'] = '解除屏蔽用户';
$string['unblockuserconfirm'] = '你确定要解除屏蔽{$a}吗？';
...
$string['userwouldliketocontactyou'] = '{a}请求加为联系人';
$string['viewfullnotification'] = '查看完整通知';
$string['wouldliketocontactyou'] = '请求加为联系人';
$string['writeamessage'] = '写一条消息...';
$string['you'] = '您：';
$string['youhaveblockeduser'] = '已经屏蔽了这个用户。';
$string['yourcontactrequestpending'] = '您的联系请求正在等待{$a}接受';
