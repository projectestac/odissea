...
/**
 * Strings for component 'glossary', language 'zh_cn', branch 'MOODLE_28_STABLE'
 *
 * @package   glossary
...
$string['errconceptalreadyexists'] = '词名已存在。此词汇表中不允许使用相同词名。';
...
$string['fillfields'] = '词名和定义都是必须填写的项目。';
...
$string['glossary:approve'] = '审核未接受的词条';
