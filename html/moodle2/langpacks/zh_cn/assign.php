...
$string['assign:editothersubmission'] = '编辑另一个学生的提交';
...
$string['assign:manageoverrides'] = '管理分配覆盖';
...
$string['assign:viewblinddetails'] = '即使掩码启用仍可查看学生身份';
...
$string['batchoperationconfirmdownloadselected'] = '要下载勾选的作业？';
...
$string['blindmarkingenabledwarning'] = '此活动已启用匿名评分方式';
...
$string['clickexpandreviewpanel'] = '点选以扩展检查面板';
$string['collapsegradepanel'] = '折叠计分面板';
...
$string['confirmsubmissionheading'] = '确认提交';
...
$string['defaultlayout'] = '回复默认的版面格式';
...
$string['downloadasfolders'] = '下载作业文件包';
$string['downloadasfolders_help'] = '分配的提交可以在文件夹中下载。随后将每份提交放在一个单独的文件夹中，为任何子文件夹保留文件夹结构，并且不重命名文件。';
$string['downloadselectedsubmissions'] = '下载勾选的作业';
$string['duedate'] = '截止时间';
...
$string['duedatevalidation'] = '到期日期不能早于允许提交的开始日期';
$string['duplicateoverride'] = '重复覆盖';
...
$string['eventassessablesubmitted'] = '一个作业已经提交';
$string['eventbatchsetmarkerallocationviewed'] = '对已阅读的位置批量设置标记';
$string['eventbatchsetworkflowstateviewed'] = '批量设置阅读状态工作流程';
$string['eventextensiongranted'] = '已设定一个宽限时间';
$string['eventfeedbackupdated'] = '反馈已更新';
$string['eventfeedbackviewed'] = '返回已经阅读';
$string['eventgradingformviewed'] = '评分格式已经阅读';
$string['eventgradingtableviewed'] = '评分表格已经阅读';
$string['eventidentitiesrevealed'] = '已经展示身份';
$string['eventmarkerupdated'] = '已经更新评分者';
$string['eventoverridecreated'] = '已创建分配覆盖';
$string['eventoverridedeleted'] = '已删除分配覆盖';
$string['eventoverrideupdated'] = '分配覆盖已更新';
$string['eventrevealidentitiesconfirmationpageviewed'] = '已经阅读过的身份确认页';
$string['eventstatementaccepted'] = '用户已授受作业提交声明';
$string['eventsubmissionconfirmationformviewed'] = '提交确认格式已阅读';
$string['eventsubmissioncreated'] = '提交已创建';
$string['eventsubmissionduplicated'] = '用户已复制提交的作业';
$string['eventsubmissionformviewed'] = '提交格式已阅读';
$string['eventsubmissiongraded'] = '提交的作业已评分';
$string['eventsubmissionlocked'] = '作业已锁定';
$string['eventsubmissionstatusupdated'] = '作业已更新';
$string['eventsubmissionstatusviewed'] = '查看了提交的状态';
$string['eventsubmissionunlocked'] = '作业已开启（解锁）';
$string['eventsubmissionupdated'] = '提交已更新';
$string['eventsubmissionviewed'] = '提交已阅读';
$string['eventworkflowstateupdated'] = '已更新流程状态';
$string['expandreviewpanel'] = '扩展检查面板';
...
$string['filternone'] = '未筛选';
$string['filternotsubmitted'] = '未提交';
$string['filterrequiregrading'] = '待评分';
$string['filtersubmitted'] = '已提交';
$string['fixrescalednullgrades'] = '此作业包含一些错误成绩。您可以<a href="{$a->link}">自动修改这些错误</a>。 会影响到课程总成绩。';
$string['fixrescalednullgradesconfirm'] = '确实要修复错误的成绩吗？所有受影响的成绩将被删除。这可能会影响课程总计。';
$string['fixrescalednullgradesdone'] = '成绩已修复。';
...
$string['groupoverridesdeleted'] = '已删除群组覆盖';
$string['groupsnone'] = '本课程中没有分组';
$string['groupsubmissionsettings'] = '分组提交设置';
$string['hiddenuser'] = '参与者';
$string['hideshow'] = '隐藏 / 显示';
$string['inactiveoverridehelp'] = '* 学生没有正确的分组或角色来尝试作业';
...
$string['marker'] = '评分者';
$string['markerfilter'] = '评分者过滤器';
$string['markerfilternomarker'] = '没有评分者';
...
$string['maxperpage'] = '每页最多显示多少作业';
$string['maxperpage_help'] = '最多可以显示多少作业在一个评分页面上。当课程选课人数很多时，可以防止超时限制。';
...
$string['multipleteams_desc'] = '作业需要以组为单位提交。您是多个组的成员。为了能够提交, 您必须只是一个组的成员。请联系您的教师更改您的组成员。';
...
$string['noclose'] = '无关闭日期';
$string['nofiles'] = '没有文件。';
$string['nofilters'] = '无筛选条件';
$string['nograde'] = '没有成绩。';
...
$string['noopen'] = '无开放日期';
$string['nooverridedata'] = '您必须覆盖至少一项作业设置。';
...
$string['noteam_desc'] = '此作业需要按组提交。您不是任何组的成员, 因此不能创建提交。请联系您的老师把你添加到一个小组中。';
...
$string['override'] = '覆盖';
$string['overridedeletegroupsure'] = '确实要删除对组 {$a} 的覆盖吗？';
$string['overridedeleteusersure'] = '确实要删除对用户 {$a} 的覆盖吗？';
...
$string['privacy:blindmarkingidentifier'] = '用于盲标记的标识符';
$string['privacy:gradepath'] = '成绩';
$string['privacy:metadata:assigndownloadasfolders'] = '用户选项, 设置否应将提交的多个文件下载为文件夹';
$string['privacy:metadata:assignfeedbackpluginsummary'] = '作业反馈数据。';
$string['privacy:metadata:assignfilter'] = '筛选选项, 如 "已提交"、"未提交"、"需要打分" 和 "授予延期"';
$string['privacy:metadata:assigngrades'] = '保存用户作业成绩';
$string['privacy:metadata:assignmarkerfilter'] = '按分配的标记筛选作业摘要。';
...
$string['privacy:metadata:assignquickgrading'] = '是否使用快速打分的选项。';
$string['privacy:metadata:assignsubmissiondetail'] = '存储用户提交信息';
$string['privacy:metadata:assignsubmissionpluginsummary'] = '作业的反馈数据。';
$string['privacy:metadata:assignuserflags'] = '存储用户元数据, 如延期日期';
$string['privacy:metadata:assignusermapping'] = '映射盲标记';
$string['privacy:metadata:assignworkflowfilter'] = '按不同的工作进程筛选';
$string['privacy:metadata:grade'] = '此作业提交的数字化成绩。可以通过等级/高级评分形式等来确定, 但始终会转换回浮点数。';
$string['privacy:metadata:grader'] = '学习成绩的用户 ID。';
$string['privacy:metadata:groupid'] = '用户所属组的组ID。';
$string['privacy:metadata:latest'] = '极大地简化了只想了解最后一次尝试信息的查询。';
$string['privacy:metadata:mailed'] = '已发邮件给此用户了吗？';
$string['privacy:metadata:timecreated'] = '创建时间';
$string['privacy:metadata:userid'] = '用户标识';
$string['privacy:studentpath'] = '学生提交材料';
$string['privacy:submissionpath'] = '提交';
...
$string['saveoverrideandstay'] = '保存并输入另一覆盖';
$string['savingchanges'] = '更改保存中……';
$string['scale'] = '量表';
...
$string['sendstudentnotificationsdefault_help'] = '为计分表上的“通知学生”勾选设定默认值';
...
$string['submissionmodified'] = '你有现存的提交资料。请离开本页再试一次。';
$string['submissionmodifiedgroup'] = '这一提交的作业已被某人修改过，请离开本页再试一次。';
...
$string['submissionreceiptothertext'] = '您已经提交了作业\'{$a->assignment}\'。
您可以查看状态：
