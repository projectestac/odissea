...
/**
 * Strings for component 'qtype_essay', language 'de', branch 'MOODLE_28_STABLE'
 *
 * @package   qtype_essay
...
$string['formatmonospaced'] = 'Unformatierter Text, Schrittyp mit fester Laufweite';
$string['formatnoinline'] = 'Kein Textfeld';
