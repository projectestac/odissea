...
/**
 * Strings for component 'currencies', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   currencies
...
$string['BAM'] = 'Bosnia Herzegovina Convertible Mark';
