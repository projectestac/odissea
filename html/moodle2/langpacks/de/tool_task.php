...
/**
 * Strings for component 'tool_task', language 'de', branch 'MOODLE_28_STABLE'
 *
 * @package   tool_task
...
$string['disabled_help'] = 'Deaktivitierte Termine für Aufgaben werden durch den Cron-Job nicht ausgeführt. Sie können jedoch manuell über das CLI Tool ausgeführt werden.';
...
$string['scheduledtaskchangesdisabled'] = 'Änderungen in der Liste der terminierten Aufgaben wurden unterbunden';
