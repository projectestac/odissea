...
$string['managerules'] = 'Regeln zur Event-Beobachtung';
$string['manageruleslink'] = 'Sie können Events der {$a} Seite verwalten.';
$string['managesubscriptions'] = 'Eventbeobachtung';
$string['managesubscriptionslink'] = 'Sie können sich über Ereignisse der {$a}-Seite benachrichtigen lassen.';
...
$string['pluginname'] = 'Eventbeobachtung';
