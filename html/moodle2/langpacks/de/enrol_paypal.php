...
$string['errdisabled'] = 'Das Plugin PayPal ist deaktiviert und kann keine Zahlungsmitteilungen verarbeiten.';
...
$string['messageprovider:paypal_enrolment'] = 'Mitteilung bei Einschreibung über Paypal';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:txn_id'] = 'Original Transaktionsidentifikationsnummer für den Empfänger zur Zahlung des Käufers mit Hinweis zum Zahlungszweck (Kurs)';
