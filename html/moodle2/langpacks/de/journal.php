...
/**
 * Strings for component 'journal', language 'de', branch 'MOODLE_28_STABLE'
 *
 * @package   journal
...
$string['daysavailable'] = 'Verfügbarkeit';
...
$string['feedbackupdated'] = 'Rückmeldung für {$a} Einträge aktualisiert';
...
$string['mailsubject'] = 'Rückmeldung zu Journaleintrag';
...
$string['noentriesmanagers'] = 'Keine Trainer eingeschrieben';
...
$string['removeentries'] = 'Alle Journaleinträge löschen';
$string['saveallfeedback'] = 'Meine Rückmeldungen speichern';
$string['showoverview'] = 'Journalübersicht auf \'Meine Startseite\' anzeigen';
$string['showrecentactivity'] = 'Aktuelle Aktivitäten anzeigen';
$string['startoredit'] = 'Journaleintrag bearbeiten';
$string['viewallentries'] = 'Zeige {$a} Journaleinträge';
$string['viewentries'] = 'Zeige Journaleinträge';
