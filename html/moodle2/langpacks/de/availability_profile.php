...
/**
 * Strings for component 'availability_profile', language 'de', branch 'MOODLE_36_STABLE'
 *
...
$string['missing'] = '(Fehlendes Kursfeld: {$a})';
...
$string['requires_isempty'] = 'Ihr Profilfeld <strong>{$a->field}</strong> ist leer';
$string['requires_isequalto'] = 'Ihr Profilfeld <strong>{$a->field}</strong> ist <strong>{$a->value}</strong>';
$string['requires_isnotempty'] = 'Ihr Profilfeld <strong>{$a->field}</strong> ist nicht leer';
$string['requires_notendswith'] = 'Ihr Profilfeld <strong>{$a->field}</strong> endet nicht mit <strong>{$a->value}</strong>';
$string['requires_notisequalto'] = 'Ihr Profilfeld <strong>{$a->field}</strong> ist nicht <strong>{$a->value}</strong>';
$string['requires_notstartswith'] = 'Ihr Profilfeld <strong>{$a->field}</strong> beginnt nicht mit <strong>{$a->value}</strong>';
$string['requires_startswith'] = 'Ihr Profilfeld <strong>{$a->field}</strong> beginnt mit <strong>{$a->value}</strong>';
$string['title'] = 'Nutzerprofil';
