...
/**
 * Strings for component 'auth_fc', language 'de', branch 'MOODLE_28_STABLE'
 *
 * @package   auth_fc
...
$string['auth_fchost'] = 'Adresse des FirstClass-Servers. Tragen Sie die IP-Adresse oder den DNS Namen ein.';
