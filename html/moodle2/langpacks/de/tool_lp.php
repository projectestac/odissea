...
/**
 * Strings for component 'tool_lp', language 'de', branch 'MOODLE_31_STABLE'
 *
 * @package   tool_lp
...
$string['cannotcreateuserplanswhentemplateduedateispassed'] = 'Neue Lernpläne können nicht angelegt werden. Der Fälligkeitstermin für diese Vorlage ist abgelaufen oder wird in Kürze ablaufen.';
...
$string['inheritfromframework'] = 'Vom Kompetenzrahmen übernehmen (standardmäßig)';
...
$string['templatecohortnotsyncedwhileduedateispassed'] = 'Globale Gruppen werden nicht synchronisiert, wenn das Abgabedatum der Vorlage abgelaufen ist.';
