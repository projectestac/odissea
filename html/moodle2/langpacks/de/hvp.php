...
/**
 * Strings for component 'hvp', language 'de', branch 'MOODLE_31_STABLE'
 *
 * @package   hvp
...
$string['hvp:getcontent'] = 'Inhalt der H5P-Datei im Kurs anzeigen';
...
$string['hvp:viewresults'] = 'Ergebnis für den H5P-Inhalt anzeigen';
...
$string['invalidlibrary'] = 'Die H5P-Bibliothek \'{$a->%library}\', die für den Inhalt verwendet wird, ist ungültig.';
...
$string['modulename_help'] = 'Die H5P-Aktivität ermöglicht das Erstellen von interaktiven Inhalten wie interaktiven Videos, Fragebögen, Drag-and-Drop-Fragen, Multiple-Choice-Fragen, Präsentationen und vieles mehr.
...
Interaktive H5P-Inhalte können durch das Hochladen einer H5P-Datei hinzugefügt werden. Sie können H5P-Dateien auf der Website h5p.org erstellen und herunterladen.';
...
$string['welcomecommunity'] = 'Wir hoffen, dass Sie H5P mögen und die wachsende Community unterstützen, indem Sie unsere <a href={$a->forums}>Foren</a> und den Chat <a {$a->gitter}>H5P at Gitter</a> besuchen.';
...
$string['welcomegettingstarted'] = 'Um mit H5P und Moodle einfach anzufangen, schauen Sie sich unser <a {$a->moodle_tutorial}>Tutorial</a> an und laden Sie sich <a {$a->example_content}>Beispielinhalte</a> als Anregungen von H5P.org herunter. Die am meisten nachgefragten Inhaltstypen wurden bereits installiert.';
