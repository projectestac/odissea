...
/**
 * Strings for component 'role', language 'de', branch 'MOODLE_34_STABLE'
 *
 * @package   role
...
$string['badges:awardbadge'] = 'Auszeichnung an Nutzer/in vergeben';
$string['badges:configurecriteria'] = 'Kriterien für Auszeichnung aufstellen';
$string['badges:configuredetails'] = 'Details für Auszeichnung aufstellen';
...
$string['frontpageuserdescription'] = 'Alle angemeldeten Nutzer/innen auf der Startseite';
...
$string['privacy:metadata:role_assignments:modifierid'] = 'ID des Nutzers der Rollenzuweisung erstellte oder veränderte';
$string['privacy:metadata:role_assignments:roleid'] = 'ID der Rolle';
...
$string['privacy:metadata:role_assignments:userid'] = 'ID des Nutzers';
...
$string['privacy:metadata:role_capabilities:modifierid'] = 'ID des Nutzers, der die Berechtigung angelegt oder verändert hat.';
$string['privacy:metadata:role_capabilities:permission'] = 'Berechtigungsumfang: vererbt, erlaubt, verhindert, untersagt';
$string['privacy:metadata:role_capabilities:roleid'] = 'ID der Rolle';
...
$string['tag:edit'] = 'Vorhandene Schlagwörter bearbeiten';
$string['tag:editblocks'] = 'Blöcke auf Schlagwortseiten bearbeiten';
$string['tag:flag'] = 'Schlagwörter als unangemessen markieren';
...
$string['user:editmessageprofile'] = 'Mitteilungsprofil bearbeiten';
