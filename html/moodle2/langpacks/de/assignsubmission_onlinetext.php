...
/**
 * Strings for component 'assignsubmission_onlinetext', language 'de', branch 'MOODLE_28_STABLE'
 *
...
$string['eventassessableuploaded'] = 'Onlinetext wurde hochgeladen';
...
$string['wordlimitexceeded'] = 'Die Höchstgrenze der Worte für diese Aufgabenlösung ist {$a->limit}. Ihre Antwort enthält {$a->count} Worte. Überarbeiten Sie bitte Ihre Lösung und speichern Sie sie dann erneut.';
$string['wordlimit_help'] = 'Wenn Online-Texteingabe aktiviert wurde, legen Sie hier die Höchstzahl der Worte fest, die die Lösung eines/r Teilnehmers/in enthalten darf.';
