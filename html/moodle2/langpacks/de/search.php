...
/**
 * Strings for component 'search', language 'de', branch 'MOODLE_28_STABLE'
 *
 * @package   search
...
$string['commenton'] = 'Kommentar ein';
$string['createanindex'] = 'Index erzeugen';
$string['createdon'] = 'Erzeugt ein';
...
$string['emptydatabaseerror'] = 'Eine Datenbank-Tabelle ist nicht vorhanden oder sie enthält keine Index-Datensätze.';
$string['enteryoursearchquery'] = 'Tragen Sie Ihre Suchanfrage ein';
