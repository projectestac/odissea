...
$string['autotags'] = 'Schlagwörter hinzufügen';
$string['autotags_help'] = 'Geben Sie lokale Schlagwörter an (getrennt durch Kommas), mit denen automatisch jeder Beitrag markiert werden soll, der von einem externen Blog in Ihren lokalen Blog übertragen wird.';
...
$string['blocktitle'] = 'Blocktitel für Blogschlagwörter';
$string['blog'] = 'Blog';
...
$string['blogtags'] = 'Blogschlagwörter';
...
$string['filtertags'] = 'Externe Schlagwörter';
$string['filtertags_help'] = 'Mit dieser Option können Sie die Beiträge filtern. Wenn Sie hierbei Schlagwörter angeben (getrennt durch Kommas), werden ausschließlich Beiträge mit diesen Schlagwörtern vom externen Blog kopiert.';
