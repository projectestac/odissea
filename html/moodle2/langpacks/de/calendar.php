...
/**
 * Strings for component 'calendar', language 'de', branch 'MOODLE_31_STABLE'
 *
 * @package   calendar
...
$string['hidecourseevents'] = 'Kurstermine';
$string['hideglobalevents'] = 'Globale Termine';
$string['hidegroupsevents'] = 'Gruppentermine';
$string['hideuserevents'] = 'Persönliche Termine';
...
$string['pollinterval'] = 'Update-Intervall';
...
$string['showcourseevents'] = 'Kurstermine';
$string['showglobalevents'] = 'Globale Termine';
$string['showgroupsevents'] = 'Gruppentermine';
$string['shown'] = 'angezeigt';
$string['showuserevents'] = 'Persönliche Termine';
$string['siteevents'] = 'Globale Termine';
