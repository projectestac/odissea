...
/**
 * Strings for component 'label', language 'de', branch 'MOODLE_34_STABLE'
 *
 * @package   label
...
$string['dnduploadlabel'] = 'Medien zur Kursseite hinzufügen';
$string['dnduploadlabeltext'] = 'Textfeld zur Kursseite hinzufügen';
$string['indicator:cognitivedepth'] = 'Textfeld kognitiv';
$string['indicator:cognitivedepth_help'] = 'Dieser Indikator basiert auf der kognitiven Tiefe, die ein/e Teilnehmer/in bei einem Textfeld erreicht hat.';
$string['indicator:socialbreadth'] = 'Textfeld sozial';
$string['indicator:socialbreadth_help'] = 'Dieser Indikator basiert auf der sozialen Breite, die ein/e Teilnehmer/in bei einem Textfeld erreicht hat.';
