...
/**
 * Strings for component 'forum', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   forum
...
$string['privacy:metadata:forum_digests:userid'] = 'Die Nutzer-ID mit der Übersichtseinstellung';
$string['privacy:metadata:forum_discussions'] = 'Information zu den individuellen Forumsthemen, die eine Person angelegt hat';
...
$string['privacy:metadata:forum_discussion_subs:discussionid'] = 'ID der Diskussion, in der der Nutzer eingeschrieben ist';
...
$string['privacy:metadata:forum_discussions:userid'] = 'ID des Nutzers der Diskussion gestartet hat';
$string['privacy:metadata:forum_discussions:usermodified'] = 'ID des Nutzers, der die Diskussion zuletzt bearbeit hat';
$string['privacy:metadata:forum_posts'] = 'Information über die Tageszusammenfassung  für jedes Forum';
$string['privacy:metadata:forum_posts:created'] = 'Die Zeit, zu der der Beitrag angelegt wurde.';
$string['privacy:metadata:forum_posts:discussion'] = 'Die Diskussion, zu der der Beitrag gehört.';
$string['privacy:metadata:forum_posts:message'] = 'Die Mitteilung des Forumsbeitrags.';
$string['privacy:metadata:forum_posts:modified'] = 'Die Zeit, zu der der Beitrag zuletzt geändert wurde.';
$string['privacy:metadata:forum_posts:parent'] = 'Ursprungsbeitrag, auf den geantwortet wird';
$string['privacy:metadata:forum_posts:subject'] = 'Der Betreff des Forumsbeitrags.';
...
$string['privacy:metadata:forum_read:discussionid'] = 'Die Diskussion, zu der der Beitrag gehört.';
$string['privacy:metadata:forum_read:firstread'] = 'Die Zeit, zu der der Beitrag das erste Mal gelesen wurde.';
$string['privacy:metadata:forum_read:lastread'] = 'Wann Beitrag zuletzt gelesen wurde';
$string['privacy:metadata:forum_read:postid'] = 'Der Beitrag, der gelesen wurde.';
$string['privacy:metadata:forum_read:userid'] = 'Die ID der Person, zu der dieser Datensatz gehört.';
$string['privacy:metadata:forum_subscriptions'] = 'Information, welche Diskussionen der Nutzer abonniert hat';
...
$string['smallmessagedigest'] = 'Die Forenzusammenfassung enthält {$a} Mitteilungen';
...
$string['unsubscribealldone'] = 'Sie haben alle optionalen Abonnements abbestellt. Trotzdem werden Sie Beiträge aus Foren mit verbindlichen Abonnements erhalten. Die E-Mail-Systemnachrichten können Sie in den Einstellungen Ihres Nutzerprofils verwalten.';
