...
/**
 * Strings for component 'message', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   message
...
$string['messagecontactrequestsnotification'] = '{$a} hat eine Kontaktanfrage geschickt';
$string['messagecontactrequestsnotificationsubject'] = '{$a} hat eine Kontaktanfrage geschickt';
...
$string['nogroupmessages'] = 'Keine Gruppengespräche';
...
$string['searchnocontactsfound'] = 'Keine Kontakte gefunden';
$string['searchnomessagesfound'] = 'Keine Mitteilungen gefunden';
$string['searchnononcontactsfound'] = 'Keine weiteren Personen gefunden';
...
$string['viewinganotherusersmessagearea'] = 'Sie betrachten einen fremden Mitteilungsbereich.';
