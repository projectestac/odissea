...
$string['progress:addinstance'] = 'Einen neuen Fortschrittsbalken-Block hinzufügen';
$string['progressbar'] = 'Fortschrittsbalken';
$string['progress:myaddinstance'] = 'Einen neuen Fortschrittsbalken-Block auf meiner Startseite hinzufügen';
$string['progress:overview'] = 'Kursübersicht mit Fortschritsbalken für alle Teilnehmer/innen anzeigen';
$string['progress:showbar'] = 'Den Balken im Fortschrittsbalken-Block anzeigen';
