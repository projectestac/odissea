...
/**
 * Strings for component 'moodle', language 'de', branch 'MOODLE_26_STABLE'
 *
 * @package   moodle
...
$string['frontpagedescriptionhelp'] = 'Diese Informationen zur Website werden auf der Startseite angezeigt, entweder im Block \'Kursbeschreibung\' oder in einen zentralen Themenabschnitt.';
...
$string['increasesections'] = 'Anzahl der Bereiche erhöhen';
...
$string['reducesections'] = 'Anzahl der Bereiche reduzieren';
...
$string['resortbyfullname'] = 'Nach Name';
$string['resortbyidnumber'] = 'Nach ID-Nummer';
$string['resortbyshortname'] = 'Nach Kurzbezeichnung';
$string['resortcourses'] = 'Kurse neu ordnen';
$string['resortsubcategoriesbyidnumber'] = 'Kursunterbereiche nach ID-Nummer ordnen';
$string['resortsubcategoriesbyname'] = 'Kursunterbereiche nach Namen ordnen';
...
$string['rsskeyshelp'] = '<p>Um Datenschutz und Sicherheit zu gewährleisten, werden RSS Feed URLs mit einem Token für jeden Nutzer versehen. So wird dafür gesorgt, dass unberechtigte Personen keinen Zugang zu den RSS Feeds erhalten.</p>
<p>Das persönliche Token wird beim ersten Zugriff erzeugt. Wenn man den Eindruck hat, das eigene Token könnte in fremde Hände gelangt sein, kann das Token aktualisiert werden, was das alte Token automatisch ungültig macht.</p>';
...
$string['setpasswordinstructions'] = 'Das neue Kennwort muss zweimal eingegeben werden. Klicken Sie anschließend auf die Taste "Kennwort setzen".<br />Das neue Kennwort wird gesichert und Sie werden angemeldet.';
...
$string['sortcategoriesbyidnumber'] = 'Kursbereiche nach ID-Nummer ordnen';
$string['sortcategoriesbyname'] = 'Kursbereiche nach Namen ordnen';
$string['sortcoursesbyfullname'] = 'Kurse nach langem Namen ordnen';
$string['sortcoursesbyidnumber'] = 'Kurse nach ID-Nummer ordnen';
$string['sortcoursesbyshortname'] = 'Kurse nach Kurzbezeichnung ordnen';
