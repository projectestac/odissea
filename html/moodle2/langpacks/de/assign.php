...
$string['assign:viewblinddetails'] = 'Teilnehmeridentität anzeigen, obwohl die Identität als anonym markiert ist.';
...
$string['blindmarking_help'] = 'Die anonyme Bewertung verbirgt den Teilnehmeridentität während der Bewertung. Die Einstelloption ist nicht änderbar, sobald die erste Lösung eingereicht oder Bewertung vorgenommen wurde.';
...
$string['cutoffdatefromdatevalidation'] = 'Der letzte Abgabetermin muss nach dem Abgabebeginn liegen.';
...
$string['duedate_help'] = 'Zum Abgabeende wird die Aufgabe fällig. Wenn spätere Abgaben erlaubt sind, wird jede nach diesem Datum eingereichte Abgabe als verspätet markiert. Um eine Abgabe nach einem bestimmten Verspätungsdatum zu verhindern kann ein endgültiges Abgabedatum gesetzt werden.';
...
$string['eventbatchsetworkflowstateviewed'] = 'Bewertungsworkflow angezeigt';
...
$string['eventmarkerupdated'] = 'Die zugewiesene Markierung wurde aktualisiert.';
...
$string['eventworkflowstateupdated'] = 'Der Prozessstatus wurde aktualisiert.';
...
$string['markerfilternomarker'] = 'Keine Markierung';
...
$string['sendstudentnotificationsdefault'] = 'Standardeinstellung für Teilnehmerbenachrichtigung';
