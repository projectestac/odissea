...
$string['recordid'] = 'ID';
$string['reopenuntilpassincompatiblewithblindmarking'] = 'Die Bewertungen können in den Bewertungsbereich nur übertragen werden wenn die Identität der Teilnehmer/innen aufgedeckt wurde. Öffnen Sie die Bestehen-Option (?) erneut wenn die Einstellung mit der verdeckten Bewertung inkompatibel ist.';
