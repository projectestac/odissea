...
/**
 * Strings for component 'block_course_overview', language 'de', branch 'MOODLE_36_STABLE'
 *
...
$string['defaulttab'] = 'Standardmäßiger Tab';
$string['defaulttabdesc'] = 'Welcher Tab soll standardmäßig geöffnet sein, wenn das Dashboard geöffnet wird?';
...
$string['morecoursestext'] = 'Weitere Kurse anzeigen';
...
$string['setmaxcoursesdesc'] = 'Maximale Kursanzahl, die standardmäßig in der Kurszusammenfassung pro Nutzer angezeigt werden soll.';
$string['setmaxcoursesmax'] = 'Maximal mögliche Kursanzahl';
$string['setmaxcoursesmaxdesc'] = 'Maximal mögliche Kursanzahl, die sich Nutzer in der Kurszusammenfassung anzeigen lassen können.';
...
$string['userchoosezero'] = '(Standardeinstellung nutzen)';
$string['usersetmaxcourses'] = 'Angezeigte Kursanzahl:';
