...
$string['filters_help'] = 'Diese Option filtert Aktivitäten aus, die nicht aufgezeichnet werden.';
...
$string['logguests'] = 'Gastaktionen einbeziehen';
$string['other'] = 'Andere';
$string['participating'] = 'Teilnehmend';
$string['pluginname'] = 'Externe Logdatenbank';
