...
/**
 * Strings for component 'block_myoverview', language 'de', branch 'MOODLE_36_STABLE'
 *
...
$string['aria:allcourses'] = 'Alle Kurse';
...
$string['aria:hiddencourses'] = 'Verborgene Kurse anzeigen';
$string['aria:hidecourse'] = '{$a} in der Ansicht verbergen';
...
$string['hiddencourses'] = 'Verborgene';
$string['hidecourse'] = 'In der Ansicht verbergen';
$string['inprogress'] = 'Laufende';
$string['lastaccessed'] = 'Letzter Zugriff';
$string['list'] = 'Liste';
$string['morecourses'] = 'Weitere Kurse';
$string['myoverview:addinstance'] = 'Neuen Neuen Block \'Kursübersicht\' hinzufügen';
...
$string['show'] = 'Diesen Kurs anzeigen';
