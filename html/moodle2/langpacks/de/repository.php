...
$string['confirmremove'] = 'Möchten Sie das Repository-Plugin \'{$a}\' wirklich mit allen Optionen und <strong>allen Instanzen</strong> löschen? Wenn Sie \'Fortsetzen und Download\' wählen, werden alle extern verknüpften Dateien heruntergeladen und in Moodle gespeichert. Dieser Prozesss kann sehr viel Zeit dauern.';
...
$string['createfolderfail'] = 'Fehler beim Erstellen des Verzeichnisses';
$string['createfoldersuccess'] = 'Verzeichnis erfolgreich erstellt';
$string['createinstance'] = 'Repository-Instanz erstellen';
$string['createrepository'] = 'Repository-Instanz erstellen';
$string['createxxinstance'] = 'Instanz \'{$a}\' erstellen';
$string['date'] = 'Datum';
...
$string['enablecourseinstances'] = 'Nutzer/innen erlauben, eine Repository-Instanz zum Kurs hinzuzufügen';
$string['enableuserinstances'] = 'Nutzer/innen erlauben, eine eigene Repository-Instanz anzulegen';
...
$string['off'] = 'Aktiviert, aber verborgen';
$string['on'] = 'Aktiviert und sichtbar';
