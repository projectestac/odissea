...
$string['analyticsdesc'] = 'Diese Option aktiviert Google Analytics für die Website. Sie benötigen dafür ein kostenfreies Konto bei  <a href="http://analytics.google.com" target="_blank">http://analytics.google.com</a>';
...
$string['bootstrapcdn'] = 'Awesome Icons von CDN';
$string['bootstrapcdndesc'] = 'Diese Option legt fest, ob der Zeichensatz Awesome aus der Onlinequelle von Bootstrap CDN nachgeladen wird. Aktivieren Sie die Option, wenn die Awesome Icons auf Ihrer Website nicht richtig angezeigt werden.';
...
$string['categoryicondesc'] = 'Diese Option erlaubt das Festlegen von Icons für jeden Kursbereich';
...
$string['categoryiconinfodesc'] = 'Geben Sie den Namen des Symbols an, das Sie verwenden möchten. Die verfügbaren Symbole finden Sie in dieser <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_new">Liste</a>. Geben Sie als Namen genau das ein, was nach \'fa-\' steht.';
...
<h3>Autoren von Essential</h3>
<p>2013 Julian Ridden
<br />2014 Gareth J. Barnard, David Bezemer
</p>
<h3>Donations</h3>
<p>Dieses Design wird Ihnen kostenlos zur Verfügung gestellt. Falls Sie sich gerne bedanken und uns unterstützen möchten, spenden Sie bitte einen Betrag über <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=themmai%40gmail%2ecom&lc=GB&item_name=Essential%20Theme%20Fund¤cy_code=EUR&bn=PP%2dDonationsBF%3abtn_donate_LG%2egif%3aNonHosted" target="_blank"> Paypal </a><br>Spenden helfen uns, weitere und verbesserte Funktionen zu entwickeln.</p>
</div></div>';
...
$string['defaultcategoryicondesc'] = 'Legen Sie ein standardmäßigen Icon für Kursbereiche fest.';
...
$string['donate_desc'] = 'Bitte {$a->url}, um die Weiterentwicklung von Essential zu unterstützen oder einfach um Ihre Dankbarkeit auszudrücken.';
...
$string['flickrdesc'] = 'Geben Sie die URL zu Ihrer Flickr Seite an, z.B. http://www.flickr.com/mycollege';
...
$string['fontcharactersetdesc'] = 'Wenn ein Google-Zeichensatz gewählt wird, können Sie weitere sprachbezogene Zeichensätze hinzufügen. Um Ihre Webseite nicht zu verlangsamen, sollten Sie nur die Zeichensätze auswählen, die Sie tatsächlich benötigen.';
...
$string['fontselectdesc'] = 'Wählen Sie einen Zeichensatz aus der Liste aus. Sie können auch die Google-Zeichensätze deaktivieren, wenn Sie möchten.';
...
$string['footercolorsdesc'] = 'Wählen Sie die Farbeinstellungen für den Fußbereich der Seiten.';
...
$string['generalheadingdesc'] = 'Konfigurieren Sie hier die globalen Einstellungen für das Design. Sie können sowohl das Layout wie auch visuelle Optionen beeinflussen.';
...
$string['helplinkdesc'] = 'Wenn Sie die Option URL gewählt haben, tragen Sie eine vollständige URL zur Hilfeseite ein (mit http:// bzw. https://). Wenn Sie die Option E-Mail gewählt haben, tragen Sie die E-Mail-Adresse für Ihren Support ein.';
...
$string['ios'] = 'iOS (App Store)';
$string['iosdesc'] = 'Geben Sie die URL zu Ihrer Mobile App im App Store an. Wenn Sie keine eigene App haben, können Sie stattdessen die offizielle Moodle Mobile App verlinken. <br />https://itunes.apple.com/en/app/moodle-mobile/id633359593';
$string['iosicon'] = 'Homescreen Icons';
$string['iosicondesc'] = 'Das Design zeigt ein standardmäßiges Icon für iOS und Android Homescreens an. Wenn Sie möchten, können Sie auch eigene Icons hochladen.';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Laden Sie Ihr eigenes Logo hoch, um es in der Kopfleiste anzuzeigen. Das Logo sollte 65 Pixel hoch sein und darf eine beliebige passende Breite haben. Wenn Sie ein Logo hochgeladen haben, ersetzt es das standardmäßige Icon und den angezeigten Namen.';
...
$string['mobileappsdesc'] = 'Haben Sie eine App im App Store oder bei Google Play? Geben Sie die Links an, um diese Apps verfügbar zu machen.';
...
$string['pagebackgrounddesc'] = 'Laden Sie ein eigenes Hintergrundbild hoch. Dieses Bild wird auf allen Seiten im Hintergrund gekachelt. Wenn Sie kein Bild hochladen, wird ein Standardbild verwendet. Für einen einfarbigen Hintergrund erzeugen Sie ein Bild mit 1 Pixel in der gewünschten Farbe.';
...
$string['pinterestdesc'] = 'Geben Sie die URL zu Ihrer Pinterest Seite an, z.B. http://www.pinterest.com/mycollege';
$string['pluginname'] = 'Essential';
$string['previoussection'] = 'Vorheriger Abschnitt';
$string['profilebarcustomtitle'] = 'Titel des eigenen Profilleiste';
$string['profilebarcustomtitledesc'] = 'Titel des eigenen Profilleiste';
...
$string['slidecaption'] = 'Folienuntertitel';
$string['slidecaptionbelow'] = 'Folientitel unter dem Bild';
$string['slidecaptionbelowdesc'] = 'Diese Option legt fest, ob der Folientitel unter dem Bild gezeigt werden soll.';
...
$string['slidecaptiondesc'] = 'Geben Sie einen Bilduntertitel ein, der für diese Folie benutzt wird.';
$string['slidecolor'] = 'Textfarbe der Folien';
$string['slidecolordesc'] = 'Diese Option legt die Überschriftfarbe auf den Folien fest.';
$string['slideimage'] = 'Folienbild';
$string['slideimagedesc'] = 'Als Bilder verwenden Sie am besten transparente Bilder im Format png.';
...
$string['themehovercolordesc'] = 'Wählen Sie eine Hoverfarbe. Diese Farbe wird beim Berühren von Links und Menüs auf der gesamten Website benutzt.';
