...
/**
 * Strings for component 'error', language 'de', branch 'MOODLE_26_STABLE'
 *
 * @package   error
...
$string['cannotgeoplugin'] = 'Der geoPlugin-Server http://www.geoplugin.com kann nicht erreicht werden. Prüfen Sie die Proxyeinstellungen oder installieren Sie die Datenbank \'<a href="http://www.maxmind.com">MaxMind GeoLiteCity</a>\'.';
...
$string['cannotmovecategory'] = 'Kategorie kann nicht verschoben werden';
...
$string['dbsessionhandlerproblem'] = 'Das Einrichten der Datenbank-Session ist fehlgeschlagen. Bitte benachrichtigen Sie den Administrator des Servers';
$string['dbsessionmysqlpacketsize'] = 'Ein scherwiegender Session-Fehler wurde erkannt. Bitte informieren Sie den Administrator des Servers, dass dieses Problem auftreten kann, wenn der Wert max_allowed_packet in den MySQL-Einstellungen zu klein festgelegt wurde';
...
$string['groupnotaddedtogroupingerror'] = 'Gruppe \'{$a}\' wurde nicht zur Gruppierung \'{$a}\' hinzugefügt';
...
$string['guestcantaccessprofiles'] = 'Gäste können nicht auf Nutzerprofile zugreifen. Loggen Sie sich mit Ihren persönlichen Zugangsdaten ein.';
...
$string['nopermissiontomanagegroup'] = 'Sie haben nicht das Recht, Gruppen zu verwalten.';
...
$string['sessionerroruser'] = 'Nach längerer Inaktivität müssen Sie sich wieder neu einloggen.';
...
$string['sessionipnomatch2'] = '<p>Entschuldigung, aber Ihre IP-Adresse hat sich geändert, seit Sie sich eingeloggt haben. Diese Sicherheitsoption schützt davor, dass Ihre Identität gestohlen werden kann, während Sie eingeloggt sind. Sie könnten diese Fehlermeldung auch erhalten, wenn Sie ein Funknetzwerk benutzen oder zwischen unterschiedlichen Netzwerken pendeln (roaming). Bitte fragen Sie für weitere Hilfe den Administrator Ihrer Website. </p><p>>Falls Sie weitermachen möchten, aktualisieren Sie bitte die Seite (F5-Taste).</p>';
