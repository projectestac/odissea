...
$string['config_keep_groups_and_groupings'] = 'Standardmäßig die aktuellen Gruppen und Gruppierungen beibehalten';
$string['config_keep_roles_and_enrolments'] = 'Standardmäßig die aktuellen Rollen und Einschreibungen beibehalten';
...
$string['config_overwrite_course_fullname'] = 'Standardmäßig wird der aktuelle Kursname mit dem Kursnamen aus der Sicherungsdatei überschrieben. Um das Recht zu haben, den Kursnamen zu ändern (moodle/course:changefullname) muss auch \'Kurseinstellungen überschreiben\' aktiviert sein.';
