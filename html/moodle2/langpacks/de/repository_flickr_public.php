...
/**
 * Strings for component 'repository_flickr_public', language 'de', branch 'MOODLE_34_STABLE'
 *
...
$string['by-nc-nd'] = 'Namensnennung-Nichtkommerziell-Keine Bearbeitung';
$string['by-nc-sa'] = 'Namensnennung-Nichtkommerziell-Weitergabe unter gleichen Bedingungen';
$string['by-nd'] = 'Namensnennung-Keine Bearbeitung';
$string['by-sa'] = 'Namensnennung-Weitergabe unter gleichen Bedingungen';
$string['callbackurl'] = 'Rücksprung-URL';
$string['commercialuse'] = 'Ich möchte die Bilder kommerziell nutzen';
$string['configplugin'] = 'Einstellungen für Flickr Public';
$string['creativecommonscommercial'] = 'Nur Creative Commons Kommerziell';
...
$string['privacy:metadata:repository_flickr_public'] = 'Das Flickr-Repository-Plugin speichert keine persönlichen Daten. Es überträgt aber von Moodle Nutzerdaten an das entfernte System';
...
$string['watermark'] = 'Wasserzeichen zu den Fotos hinzufügen';
