...
$string['deleteserviceconfirm'] = 'Zusammen mit dem Service werden auch alle damit verbundenen Tokens gelöscht. Möchten Sie wirklich den externen Service \'{$a}\' löschen?';
