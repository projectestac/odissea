...
/**
 * Strings for component 'files', language 'de', branch 'MOODLE_34_STABLE'
 *
 * @package   files
...
$string['privacy:metadata:files:license'] = 'Lizenz für Dateiinhalt';
$string['privacy:metadata:files:mimetype'] = 'MIME-Typ der Datei';
$string['privacy:metadata:files:source'] = 'Quelle der Datei';
$string['privacy:metadata:files:timecreated'] = 'Erstellungsdatum der Datei';
$string['privacy:metadata:files:timemodified'] = 'Datum der letzten Bearbeitung der Datei';
$string['privacy:metadata:files:userid'] = 'Nutzer, der die Datei erstellt hat';
