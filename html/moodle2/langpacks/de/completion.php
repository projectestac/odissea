...
/**
 * Strings for component 'completion', language 'de', branch 'MOODLE_34_STABLE'
 *
 * @package   completion
...
$string['defaultcompletion'] = 'Standardmäßiger Abschluss für Aktivität';
...
$string['privacy:metadata:course'] = 'Kurs-Identifier';
...
$string['privacy:metadata:gradefinal'] = 'Endbewertung für Kursabschluss';
$string['privacy:metadata:overrideby'] = 'Nutzer-ID des Nutzers der Modulabschluss überschrieben hat';
...
$string['privacy:metadata:timeenrolled'] = 'Einschreibezeitpunkt in Kurs';
...
$string['privacy:metadata:userid'] = 'Kurs und Aktivitätsabschluss wird für einen Nutzer gespeichert';
