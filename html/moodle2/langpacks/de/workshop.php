...
$string['indicator:cognitivedepth_help'] = 'Dieser Indikator basiert auf der kognitiven Tiefe, die ein/e Teilnehmer/in in einer gegenseitigen Beurteilungsaktivität erreicht hat.';
$string['indicator:socialbreadth'] = 'Gegenseitige Beurteilung sozial';
$string['indicator:socialbreadth_help'] = 'Dieser Indikator basiert auf der sozialen Breite, die ein/e Teilnehmer/in in einer gegenseitigen Beurteilungsaktivität erreicht hat.';
$string['info'] = 'Info';
...
$string['myassessments'] = 'Meine Aufgaben';
...
$string['privacy:metadata:assessmentid'] = 'Identifier der Aufgabe';
$string['privacy:metadata:authorid'] = 'Identifier des Autors der Lösung';
$string['privacy:metadata:dimensiongrade'] = 'Bewertrung in der festgelegten Aufgabendimension';
$string['privacy:metadata:dimensionid'] = 'Identifier der Aufgabendimension';
...
$string['privacy:metadata:reviewerid'] = 'Identifier dessen, der Lösung abgibt';
...
$string['privacy:metadata:submissionid'] = 'Identifier der Lösung';
...
$string['privacy:metadata:workshopid'] = 'Identifier der Workshop-Aktivität';
...
$string['privacy:request:delete:content'] = 'Der Inhalt wurde auf Anfrage des Nutzers gelöscht';
