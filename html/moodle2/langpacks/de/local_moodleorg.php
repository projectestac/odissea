...
/**
 * Strings for component 'local_moodleorg', language 'de', branch 'MOODLE_26_STABLE'
 *
...
$string['aboutstatistics'] = 'Sie können Moodle kostenfrei herunterladen und installieren. Eine Registrierung ist freiwillig. Daher stehen uns keine vollständigen Informationen über die Nutzerzahlen insgesamt zur Verfügung. Aus den zur Verfügung stehenden Daten erstellen wir einige Statistiken und grafische Darstellungen auf unserer Statistik-Seite.';
...
$string['heroslide_link_stories'] = 'Weiter lesen';
...
$string['partnerslogan'] = 'Das Moodle-Projekt wird weltweit von 60 zertifizierten Moodle-Partnern unterstützt.<br /><a href="http://moodle.com/partners/about/">Erfahren Sie mehr</a> über das Moodle-Partner-Programm und <a href="http://moodle.com/partners">finden Sie einen Moodle Partner</a> in Ihrer Nähe.';
...
$string['supportforums'] = 'Unsere Nutzer-Community unterhält sich meistens über Foren innerhalb von "Kursen" auf dieser Moodle-gestützten Website. Sie müssen sich in den Kurs "einschreiben", um einen Forumsbeitrag schreiben zu können. Die Einschreibung ist freiwillig und vollkommen kostenlos.';
