...
$string['validationresult2_help'] = 'No se han detectado problemas serios. La instalación de la extensión puede continuar. Véanse los mensajes de validación para más detalle y posibles avisos.';
