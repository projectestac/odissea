...
/**
 * Strings for component 'moodle', language 'es', branch 'MOODLE_26_STABLE'
 *
 * @package   moodle
...
$string['deletelogs'] = 'Eliminar registros';
...
$string['duplicateconfirm'] = '¿Está seguro que desea duplicar el/la {$a->modtype} \'{$a->modname}\'?';
$string['duplicatecontcourse'] = 'Volver al curso';
$string['duplicatecontedit'] = 'Editar la copia';
$string['duplicatesuccess'] = '\'{$a->modname}\' {$a->modtype} ha sido duplicado/a correctamente';
...
$string['failedloginattemptsall'] = '{$a->attempts} intentos de identificación fallidos para las cuentas {$a->accounts}';
...
$string['frontpagedescriptionhelp'] = 'Este resumen puede mostrarse en la página principal utilizando el bloque Resumen del curso/sitio o incluyendo un elemento de sección en la página principal.';
...
$string['missingcity'] = 'Falta la ciudad/pueblo';
...
$string['modchooserdisable'] = 'Desconectar Selector de actividades';
...
$string['notifyloginfailuresmessageend'] = 'Puede ver estos logs en {$a}/report/log/index.php?id=1&chooselog=id=1&amp;chooselog=1&amp;modid=site_errors..';
...
$string['resortsubcategoriesbyidnumber'] = 'Ordenar subcategorías por número ID';
$string['resortsubcategoriesbyname'] = 'Ordenar subcategorías por nombre';
...
$string['sortcategoriesbyidnumber'] = 'Ordenar categorías por número ID';
$string['sortcategoriesbyname'] = 'Ordenar categorías por nombre';
$string['sortcoursesbyfullname'] = 'Ordenar cursos por nombre';
$string['sortcoursesbyidnumber'] = 'Ordenar cursos por número ID';
$string['sortcoursesbyshortname'] = 'Ordenar cursos por nombre corto';
