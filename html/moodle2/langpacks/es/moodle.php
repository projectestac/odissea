...
/**
 * Strings for component 'moodle', language 'es', branch 'MOODLE_34_STABLE'
 *
 * @package   moodle
...
$string['considereddigitalminor'] = 'Se considera que Usted es un menor digital.';
...
$string['timesplitting:singlerange'] = 'Rango simple';
