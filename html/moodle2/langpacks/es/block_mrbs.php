...
/**
 * Strings for component 'block_mrbs', language 'es', branch 'MOODLE_26_STABLE'
 *
 * @package   block_mrbs
...
$string['bookingmovedmessage'] = 'Su reserva {$a->name} ha sido movida de la sala {$a->oldroom} a la sala {$a->newroom} en {$a->area} para la asignatura {$a->date}, {$a->starttime}. La sala es solicitada por {$a->newbookingname}. ATENCIÓN: Este cambio ha sido realizado por los cálculos del ordenador siguiendo las mejores posibilidades. Por favor compruebe que la sala se ajusta a sus necesidades.';
...
$string['booking_users_help'] = 'Este debería ser una lista de emails de los usuarios que pueden reservar esta sala, separados por una coma. Dejar vacío si se le permite a todos los usuarios.';
$string['both'] = 'Ambas';
...
$string['clashemailbody'] = 'Debido a una importación reciente de reservas, se ha detectado un conflicto en sus reservas:   {$a->time}, {$a->oldbooking} y {$a->newbooking} usan la misma sala en horario {$a->room} Por favor resuelvan el conflicto entre ustedes antes para evitar posibles errores. ESTE SERÁ EL ÚNICO AVISO DE CONFLICTO. SI IGNORA ESTE CORREO TENDRÁ PROBLEMAS EN LA RESERVA DE SALAS. Este mensaje ha sido enviado automáticamente por el sistema de reserva de salas, si cree que lo ha recibido por error contacte con  {$a->admin}';
