...
/**
 * Strings for component 'block_myprofile', language 'es', branch 'MOODLE_28_STABLE'
 *
...
$string['display_phone1'] = 'Mostrar teléfono número 1';
$string['display_phone2'] = 'Mostrar teléfono número 2';
