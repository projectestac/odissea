...
$string['contentCopied'] = 'El contenido se copió al portapapeles';
...
$string['modulename_help'] = 'El módulo de actividad H5P le permite crear contenido interactivo como videos interactivos, conjuntos de preguntas, preguntas de arrastrar y soltar, preguntas de selección múltiple, presentaciones y mucho más.

Además de ser una herramienta de creación de contenido enriquecido, H5P le permite importar y exportar archivos H5P para reutilizar y compartir contenido de manera efectiva.

Las interacciones y puntuaciones de los usuarios se controlan mediante xAPI y están disponibles a través del libro de calificaciones de Moodle. Tenga en cuenta que actualmente es posible que las personas con habilidades de programación hagan trampa en las interacciones H5P y obtengan la puntuación completa sin saber las respuestas correctas. H5Ps no deben ser utilizados para exámenes o similares.

Para agregar contenido H5P interactivo, cree contenido con la herramienta de creación integrada o suba los archivos H5P que se encuentran en otros sitios habilitados para H5P.';
...
$string['noextension'] = 'El archivo que cargó no es un paquete HTML5 válido (no tiene la extensión de archivo .h5p)';
...
$string['nopermissiontogettranslations'] = 'No tienes permisos para recuperar traducciones';
...
$string['olduploadoldcontent'] = 'Estás intentando subir contenido de una versión anterior de H5P. Actualice el contenido en el servidor en el que se originó e intente cargarlo nuevamente o encienda el Hub H5P para que este servidor lo actualice para su llamada automática.';
...
$string['reuseDescription'] = 'Reutiliza este contenido.';
