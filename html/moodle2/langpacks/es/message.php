...
/**
 * Strings for component 'message', language 'es', branch 'MOODLE_36_STABLE'
 *
 * @package   message
...
$string['addtofavourites'] = 'Destacar';
...
$string['defaultmessageoutputs'] = 'Salidas de mensaje por defecto';
...
$string['messagecontactrequestsnotificationsubject'] = '{$a} quiere que le añadas como contacto';
...
$string['messageoutputs'] = 'Salidas de mensaje';
...
$string['nogroupmessages'] = 'No hay mensajes de grupo';
...
$string['removefromfavourites'] = 'Quitar estrella';
...
$string['searchnocontactsfound'] = 'No se encontraron contactos';
$string['searchnomessagesfound'] = 'No se encontraron mensajes';
$string['searchnononcontactsfound'] = 'No se encontraron personas que no fueran contactos';
...
$string['you'] = 'Tú:';
$string['youhaveblockeduser'] = 'Bloqueaste a este usuario en el pasado';
