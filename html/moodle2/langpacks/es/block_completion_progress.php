...
/**
 * Strings for component 'block_completion_progress', language 'es', branch 'MOODLE_31_STABLE'
 *
...
$string['completion_not_enabled'] = 'El seguimiento de completado no está habilitado en este sitio.';
$string['completion_not_enabled_course'] = 'El seguimiento de completado no está habilitado en este curso.';
$string['completion_progress:addinstance'] = 'Añadir un nuevo bloque de Progreso de Completado';
$string['completion_progress:myaddinstance'] = 'Añadir un nuevo bloque de Progreso de Finalización a la página de inicio';
$string['completion_progress:overview'] = 'Ver el resumen del curso del Progreso de Completado para todos los estudiantes';
$string['completion_progress:showbar'] = 'Mostrar la barra en el bloque de Progreso Completado';
$string['config_activitiesincluded'] = 'Actividades incluidas';
$string['config_activitycompletion'] = 'Todas las actividades con completado establecida';
$string['config_default_title'] = 'Progreso de Completado';
...
$string['how_activitiesincluded_works_help'] = '<p>De manera predeterminada, todas las actividades con el conjunto de ajustes de completado de la actividad se incluyen en la barra. </p> <p> También puede seleccionar manualmente las actividades a ser incluidas.</p>';
...
$string['how_ordering_works_help'] = '<p>Hay dos formas de ordenar las actividades en el bloque de Progreso de Completado. </ p> <ul> <li> <em>El tiempo usando "Esperando el completado en" fecha </ em> (predeterminado) <br />Las fechas de completado previstas de actividades/recursos se utilizan para ordenar la barra. En el caso de que las actividades/recursos no tengan una fecha de finalización prevista, en su lugar se utiliza el orden en el curso. Cuando se utiliza esta opción, se muestra el indicador AHORA. </li> <li> <em> Ordenamiento en curso </ em> <br /> Las actividades/recursos se presentan en el mismo orden en que están en la página del curso. Cuando se utiliza esta opción, las fechas de finalización prevista se ignoran. Cuando se utiliza esta opción, no se muestra el indicador AHORA. </li> </ ul>';
$string['how_selectactivities_works'] = 'Como funciona incluyendo actividades';
$string['how_selectactivities_works_help'] = '<P> Para seleccionar manualmente las actividades a incluir en la barra, asegúrese que "Actividades incluidas" esté narcado como "actividades seleccionadas". </ p> <p> Sólo las actividades con el conjunto de ajustes del completado de la actividad pueden ser incluidos. </ p> <p> Mantenga pulsada la tecla CTRL para seleccionar múltiples actividades. </ p>';
...
$string['no_activities_config_message'] = 'No hay actividades o recursos con el completado de actividad establecida o no se han seleccionado actividades o recursos. Configure el completado de las actividades en las actividades y los recursos, y luego configure este bloque.';
...
$string['no_blocks'] = 'No hay bloques de Progreso de Completado establecidos para sus cursos.';
$string['no_courses'] = 'No está inscrito en ningún curso. Sólo se mostrarán las barras de cursos matriculados.';
$string['not_all_expected_set'] = 'No todas las actividades con completado tienen una fecha establecida "{$a}".';
...
$string['pluginname'] = 'Progreso de Completado';
$string['progress'] = 'Progreso';
$string['progressbar'] = 'Progreso de Completado';
...
$string['why_set_the_title_help'] = '<p>Pueden existir múltiples instancias del bloque de progreso de completado. Es posible utilizar diferentes bloques de progreso de completado para seguir diferentes tipos de actividades o recursos. Por ejemplo, podría hacer seguimiento del progreso de las tareas en un bloque y los cuestionarios en otro. Por esta razón puede anular el título predeterminado y establecer un título más adecuado para cada caso. </ p>';
