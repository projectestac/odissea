...
/**
 * Strings for component 'availability', language 'es', branch 'MOODLE_28_STABLE'
 *
...
$string['list_root_and'] = 'No disponible excepto:';
$string['list_root_and_hidden'] = 'No disponible (oculto) excepto:';
$string['list_root_or'] = 'No disponible excepto cualquiera de:';
