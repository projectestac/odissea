...
$string['additionalhtml_desc'] = 'Estos ajustes permiten especificar el código HTML que desea añadir a cada página. Puede editar el HTML que será agregado dentro de la etiqueta HEAD de la página, inmediatamente después de la etiqueta de apertura de BODY, o inmediatamente antes de la etiqueta de cierre. <br /> Hacer esto le permite agregar encabezados o pies de página en cada página, o añadir soporte para servicios como Google Analytics con mucha facilidad e independiente de la plantilla elegida.';
...
$string['availablesearchareas'] = 'Campos de búsqueda disponibles';
...
$string['navexpandmycourses'] = 'Mostrar Mis cursos expandidos en el Área personal';
$string['navexpandmycourses_desc'] = 'Si se habilita, Mis cursos se muestran inicialmente expandidos en el bloque de navegación del Área personal.';
