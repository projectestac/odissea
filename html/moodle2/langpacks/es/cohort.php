...
/**
 * Strings for component 'cohort', language 'es', branch 'MOODLE_34_STABLE'
 *
 * @package   cohort
...
$string['name'] = 'Nombre';
$string['namecolumnmissing'] = 'Existe algún problema con el formato del fichero CSV. Por favor comprueba que incluye el nombre de las columnas.';
