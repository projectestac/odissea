...
/**
 * Strings for component 'filter_mathjaxloader', language 'es', branch 'MOODLE_31_STABLE'
 *
...
$string['httpurl_help'] = 'URL completa a la biblioteca MathJax. Se usa cuando se accede a la página a través de http.';
