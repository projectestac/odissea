...
$string['addtype'] = 'Gehitu kanpoko tresnaren ezarpenak';
...
$string['curllibrarymissing'] = 'PHP Curl libuurtegiak instalatuta egon behar du LTI erabiltzeko';
...
$string['delete_confirmation'] = 'Ziur al zaude kanpoko tresnaren ezarpenak ezabatu nahi dituzula?';
$string['deletetype'] = 'Ezabatu kanpoko tresnaren ezarpenak';
...
$string['edittype'] = 'Editatu kanpoko tresnaren ezarpenak';
...
$string['global_tool_types'] = 'tresna orokor motak';
...
$string['lti'] = 'LTI';
$string['lti:addcoursetool'] = 'Kalifikatu LTI jarduerak';
$string['lti:addinstance'] = 'Gehitu kanpoko beste tresna baten jarduerak';
$string['lti_administration'] = 'LTIren kudeaketa';
...
$string['noltis'] = 'Ez dago LTI instantziarik';
