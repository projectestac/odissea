...
/**
 * Strings for component 'dbtransfer', language 'eu', branch 'MOODLE_32_STABLE'
 *
 * @package   dbtransfer
...
$string['checkingsourcetables'] = 'Jatorrizko taula-egitura aztertzen';
$string['copyingtable'] = '{$a} taula kopiatzen';
$string['copyingtables'] = 'Taularen edukiak kopiatzen';
$string['creatingtargettables'] = 'Taulak datu-base helburuan sortzen';
...
$string['importversionmismatchexception'] = 'Oraingo bertsioa {$a->currentver} ez dator bat esportatutako bertsioarekin {$a->schemaver}.';
$string['malformedxmlexception'] = 'Aurkitutako XML-a ez da egokia, ezin da jarraitu.';
$string['tablex'] = '{$a} taula:';
