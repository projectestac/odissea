...
/**
 * Strings for component 'auth_cas', language 'eu', branch 'MOODLE_32_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_curl_ssl_version'] = 'Erabil beharreko SSL bertsioa (2 edo 3). Berez PHP bera saiatuko da hautematen, batzuetan eskuz zehaztu behar den arren.';
...
$string['auth_cas_logout_return_url'] = 'Eman CAS erabiltzaileak saioa amaitzean bideratzeko erabiliko den URLa.<br /> Hutsik utziz gero, erabiltzaileak Moodle-k bideratzen dituen lekura bideratuko ditu';
