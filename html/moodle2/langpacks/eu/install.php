...
$string['admindirsetting'] = 'Oso web zerbitzari gutxik erabiltzen dute /admin kontrol-panel edo antzekora sartzeko URL berezi gisa. Zoritxarrez, hau ez dator bat Moodle-n lehenetsitako kudeaketa-orrien kokapenarekin. Nahi izanez gero, zure instalazioko admin karpetaren izena alda dezakezu, hemen izen berria idatziz. Adibidez: <br /> <br /><b>moodleadmin</b><br /> <br />
Horrela Moodle-ko admin loturak konponduko dira.';
$string['admindirsettinghead'] = 'Ezarri Admin direktorioa...';
$string['admindirsettingsub'] = 'Oso web zerbitzari gutxik erabiltzen dute /admin kontrol-panel edo antzekora sartzeko URL berezi gisa. Zoritxarrez, hau ez dator bat Moodle-n lehenetsitako kudeaketa-orrien kokapenarekin. Nahi izanez gero, zure instalazioko admin karpetaren izena alda dezakezu, hemen izen berria idatziz. Adibidez: <br /> <br /><b>moodleadmin</b><br /> <br />
Horrela Moodle-ko admin loturak konponduko dira.';
...
$string['datarootpublicerror'] = 'Zehaztutako \'Datuen karpetara\' web bidez ailega daiteke, beste karpeta bat erabili behar duzu.';
...
$string['fileuploadshelp'] = '<p>Zure zerbitzarian fitxategien igoera desgaituta dagoela dirudi.</p>

<p>Moodle oraindik instala daiteke, baina aukera hori izan ezean, ezingo dituzu fitxategirik, ezta erabiltzaileen irudirik ere, ikastaroetara igo.</p>

<p>Fitxategien igoera ahalbidetzeko, zeuk (edo sistemaren administratzaileak) jatorrizko php.ini fitxategia editatu eta <b>file_uploads</b> ezarpena aldatu beharko duzu.</p>';
