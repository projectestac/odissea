...
/**
 * Strings for component 'block_myprofile', language 'eu', branch 'MOODLE_26_STABLE'
 *
...
$string['display_phone1'] = 'Telefono-zenbakia (1) erakutsi';
$string['display_phone2'] = 'Telefono-zenbakia (2) erakutsi';
