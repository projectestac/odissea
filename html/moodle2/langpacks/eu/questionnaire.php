...
/**
 * Strings for component 'questionnaire', language 'eu', branch 'MOODLE_34_STABLE'
 *
...
$string['subject'] = 'Gaia';
$string['submitsurvey'] = 'Bidali galdeketa-inkesta';
$string['summary'] = 'Laburpena';
$string['text'] = 'Galderaren testua';
$string['thank_head'] = 'Eskerrik asko galdeketa-inkesta betetzeagatik';
$string['title'] = 'Izenburua';
$string['today'] = 'gaur';
$string['type'] = 'Galdera-mota';
$string['view'] = 'Ikusi';
$string['viewallresponses_help'] = 'e';
$string['yesno'] = 'Bai/Ez';
