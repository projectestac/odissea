...
$string['filtermodified'] = 'Aldatutakoak bakarrik';
$string['filteronlyhelps'] = 'Laguntza bakarrik';
$string['filtershowstrings'] = 'Erakutsi kateak';
$string['filterstringid'] = 'Kate-identifikatzailea';
$string['filtersubstring'] = 'Ondokoa duten kateak bakarrik';
...
$string['modifiednum'] = '{$a} aldatutako kate daude. Aldaketa hauek zure hizkuntza pakete lokalean behin betiko gorde nahi dituzu?';
