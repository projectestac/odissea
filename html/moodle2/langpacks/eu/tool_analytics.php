...
/**
 * Strings for component 'tool_analytics', language 'eu', branch 'MOODLE_36_STABLE'
 *
...
$string['clienablemodel'] = 'Eredu bat gaitu dezakezu denboraren zatiketa-metodo bat bere IDaren bitartez aukeratuta. Kontuan izan beranduago ere gaitu dezakezuela web interfazetik (aukeratu \'bat ere ez\' irtetzeko).';
$string['clievaluationandpredictions'] = 'Programatutako zeregina gaitutako ereduetan arakatu eta aurreikuspenak lortzen ditu. Web interfaze bidezko ereduen ebaluazioa desgaituta dago. Prozesu hauek web interfazetik eskuz exekutatzea gaitu dezakezu analitiken ezarpenetan <a href="{$a}">\'onlycli\'</a> aukera desgaituta.';
$string['clievaluationandpredictionsnoadmin'] = 'Programatutako zeregina gaitutako ereduetan arakatu eta aurreikuspenak lortzen ditu. Web interfaze bidezko ereduen ebaluazioa desgaituta dago. Guneko kudeatzaileak gaitu dezake aukera hau.';
$string['disabled'] = 'Desgaituta';
$string['editmodel'] = 'Editatu "{$a}" eredua';
$string['edittrainedwarning'] = 'Eredu hau dagoeneko trebatua izan da. Kontuan izan bere adierazleak edo denboraren zatiketa-metodoak aldatuta aurretiko aurreikuspenak ezabatuko direla eta aurreikuspen berriak sortzen hasiko direla.';
$string['enabled'] = 'Gaituta';
$string['errorcantenablenotimesplitting'] = 'Denboraren zatiketa-metodo bat aukeratu behar duzu eredua gaitu aurretik.';
...
$string['errornostaticedit'] = 'Usteetan oinarritutako ereduak ezin dira editatu.';
...
$string['getpredictionsresults'] = '{$a->name} ikastaroaren iraupena banatzearen emaitzak';
$string['getpredictionsresultscli'] = '{$a->name} ikastaroaren (id: {$a->id}) iraupena banatzearen emaitzak';
...
$string['modeltimesplitting'] = 'Denbora-banatzea';
...
$string['timesplittingnotdefined'] = 'Denbora-banatzea oraindik ez da zehaztu';
$string['timesplittingnotdefined_help'] = 'Eredua gaitu baino lehen denboraren zatiketa-metodo bat aukeratu  behar duzu';
