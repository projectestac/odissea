...
$string['completionactivitydefault'] = 'Erabili berezko jarduera';
...
$string['completiondefault'] = 'Berezko osaketaren jarraipena';
...
Lauki zuria agertzen bada, jarduera osatu duzula uste duzunean markatu egin dezakezu. (Berriz ere sakatzen badiozu, kendu egingo diozu osaketa marka iritziz aldatu baduzu).';
...
$string['configcompletiondefault'] = 'Berezko osaketaren jarraipena jarduera berriak sortzean.';
...
$string['csvdownload'] = 'Kalkulu-orria formatuan jaitsi (UTF-8 .csv)';
$string['datepassed'] = 'Data igarota';
$string['days'] = 'Egun';
$string['daysoftotal'] = '{$a->days} egun {$a->total}-(e)tik';
$string['defaultcompletion'] = 'Berezko jarduera-osaketa';
...
$string['eventdefaultcompletionupdated'] = 'Ikastaroko jarduera-osaketaren berezko balioak eguneratu dira';
$string['excelcsvdownload'] = 'Excel-ekin bateragarria den formatuan jaitsi (.cvs)';
