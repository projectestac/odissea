...
$string['filter_theme'] = 'Itxura';
$string['filter_theme_help'] = 'Erakutsi ibilaldia erabiltzailea aukeratutako itxuretako bat erabiltzen ari denean.';
$string['importtour'] = 'Inportatu ibilaldia';
$string['left'] = 'Ezkerrean';
$string['modifyshippedtourwarning'] = 'Hau Moodle-rekin batera datorren ibilaldia da. Hemen egiten duzun edozein aldaketa gunearen hurrengo eguneraketetan gainidatzia izan daiteke.';
