...
/**
 * Strings for component 'editor_tinymce', language 'eu', branch 'MOODLE_28_STABLE'
 *
...
$string['advanced_dlg:invalid_color_value'] = 'Kolorearen balore baliogabea';
...
$string['advimage_dlg:missing_alt'] = 'Ziur al zaude irudiaren deskribapena idatzi gabe jarraitu nahi duzula? Deskribapenik gabe, agian gutxitasuna duten erabiltzaileek ezingo dute irudia eskuratu, ezta nabigatzailea testu eran erabiltzen dutenek edota orriko irudiak desgaituta dituztenek.';
...
$string['advlink_dlg:popup_dependent'] = 'Dependentea (Mozilla/Firefox bakarrik)';
...
$string['advlink_dlg:popup_props'] = 'Popup-aren propietateak';
...
Ziur al zaude edukia berreskuratu nahi duzula?';
...
$string['customtoolbar_desc'] = 'Lerro bakoitzak komaz banatutako botoi izen zerrenda bat dauka, erabili "wrap" taldeak bereizteko, lerro hutsak ez dira kontuan hartuko. Ikusi <a href="{$a}" target="_blank">{$a}</a>  TinyMCE-ren berezko botoi zerrenda ikusteko.<br /> Lehenengo lerroa beti erakutsiko da, eta bigarren eta hirugarren lerroak erakutsi edo ezkutatu daitezke.';
...
$string['media_dlg:currentmarker'] = 'Oraingo markatzailea';
...
$string['table_dlg:cell_limit'] = 'Gehieneko gelaxka-kopurua gainditu duzu: {$cells}.';
...
$string['table_dlg:cell_title'] = 'Gelaxkaren propietateak';
$string['table_dlg:cell_type'] = 'Gelaxka-mota';
$string['table_dlg:colgroup'] = 'Gelaxka-taldea';
$string['table_dlg:col_limit'] = 'Gehieneko gelaxka-kopurua gainditu duzu: {$cols}.';
...
$string['table_dlg:missing_scope'] = 'Ez duzu ezarri esparrurik taularen goiburu gelaxkari. Ziur al zaude jarraitu nahi duzula? Hori ezarri gabe, gutxitasunak dituzten erabiltzaileentzat zaila izan daiteke taularen edukia edo datuak ulertzea.';
...
$string['visualchars:desc'] = 'Ikusi/Ezkutatu ikus-kontrol karaktereak';
