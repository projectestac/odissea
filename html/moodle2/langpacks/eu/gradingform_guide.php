...
$string['err_maxscoreisnegative'] = 'Gehienezko puntuazioa ez da baliagarria, balio negatiboak ez daude baimenduta';
...
$string['guidemappingexplained'] = 'KONTUZ: zure ebaluazio-gidak <b>{$a->maxscore} puntuko</b> gehienezko kalifikazioa du, baina zure jardueraren gehienezko kalifikazioa {$a->modulegrade} da. Kalifikazio-gidaren gehienezko kalifikazioa moduluaren gehienezko kalifikaziora eskalatuko da. <br />
...
$string['regrademessage1'] = 'Kalifikatzeko erabili den ebaluazio-gida batean aldaketak egitera zoaz. Mesedez, adierazi orain arteko kalifikazioak berrikusi behar diren. Ezarpen hau markatzen baduzu, ebaluazio-gida ikasleei ezkutatuko zaie beren kalifikazioa berrikusi arte.';
$string['regrademessage5'] = 'Kalifikatzeko erabilia izan den ebaluazio-gida batean aldaketa nabarmenak egitera zoaz. Kalifikazio liburuaren balioa ez da aldatuko, baina kalifikazio-gida ikasleei ezkutatuko zaie beren kalifikazioa berrikusi arte.';
