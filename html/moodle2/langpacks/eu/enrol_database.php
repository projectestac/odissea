...
/**
 * Strings for component 'enrol_database', language 'eu', branch 'MOODLE_31_STABLE'
 *
...
$string['newcoursefullname'] = 'Ikastaro berriaren izen luzerako eremua';
$string['newcourseidnumber'] = 'Ikastaro berriaren ID zenbakirako eremua';
$string['newcourseshortname'] = 'Ikastaro berriaren izen laburrerako eremua';
