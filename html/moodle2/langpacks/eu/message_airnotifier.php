...
/**
 * Strings for component 'message_airnotifier', language 'eu', branch 'MOODLE_36_STABLE'
 *
...
$string['configairnotifiermobileappname'] = 'Mobile app-aren identifikatzaile bakarra (normalean com.moodle.moodlemobile moduko zerbait)';
...
$string['errorretrievingkey'] = 'Errorea gertatu da sarrera-giltza berreskuratzean. Zure gunea erregistratuta egon behar da zerbitzu hau erabiltzeko. Zure gunea dagoeneko erregistratuta badago mesedez saiatu zure erregistroa eguneratzen.';
$string['keyretrievedsuccessfully'] = 'Giltza ondo berreskuratu da';
$string['nodevices'] = 'Ez dago erregistratutako gailurik. Gailuak automatikoki agertuko dira Moodle app-a instalatu eta gune hau gehitzen duzunean.';
$string['nopermissiontomanagedevices'] = 'Ez duzu baimenik gailuak kudeatzeko.';
$string['notconfigured'] = 'Airnotifier zerbitzaria ez da konfiguratu eta ondorioz Airnotifier mezuak ezin dira bidali';
...
$string['sitemustberegistered'] = 'Airnotifier instantzia publikoa erabili ahal izateko, zure gunea Moodle-en erregistratuta egon behar da.';
