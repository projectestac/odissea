...
/**
 * Strings for component 'workshop', language 'eu', branch 'MOODLE_32_STABLE'
 *
 * @package   workshop
...
$string['byfullnamewithoutlink'] = '{$a}-(r)en arabera';
...
$string['resetphase'] = 'Ezarpenak zehazteko aldira aldatu';
$string['resetphase_help'] = 'Gaituz gero, tailer guztiak ezarpenak zehazteko aldira igaroko dira.';
