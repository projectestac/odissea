...
$string['allowedfiletypesforoverallfeedback_help'] = 'Feedback-eko fitxategietan onartutako fitxategi-motak mugatu daitezke komaz banaturiko fitxategi-luzapenen zerrenda sartuta, ad. \'mp4, mp3, png, jpg\'. Eremu hau hutsik utziz gero, fitxategi-mota guztiak onartuko dira.';
$string['allowedfiletypesforsubmission'] = 'Bidalketetako fitxategietan onartutako fitxategi-motak';
$string['allowedfiletypesforsubmission_help'] = 'Bidalketetako fitxategietan onartutako fitxategi-motak mugatu daitezke komaz banaturiko fitxategi-luzapenen zerrenda sartuta, ad. \'mp4, mp3, png, jpg\'. Eremu hau hutsik utziz gero, fitxategi-mota guztiak onartuko dira.';
...
$string['phaseevaluation'] = 'Kalifikazioa ebaluatzeko fasea';
...
$string['resetphase'] = 'Ezarpenak zehazteko fasera aldatu';
$string['resetphase_help'] = 'Gaituz gero, tailer guztiak ezarpenak zehazteko fasera igaroko dira.';
$string['resetsubmissions'] = 'Bidalketa guztiak ezabatu';
...
$string['submissionendswitch'] = 'Hurrengo fasera igaro bidalketetarako azken eguna igarotzean';
$string['submissionendswitch_help'] = 'Bidalketak egiteko azken eguna zehaztuta badago eta aukera hau markatuta badago, tailerra hurrengo fasera automatikoki igaroko da azken eguna igarotzean.

Aukera hau gaituz gero, esleipen automatikoa konfiguratzea gomendatzen da. Bidalketak ez badira esleitzen ezin da ebaluaziorik egin ebaluazio-fasean egon arren.';
...
$string['switchphase30auto'] = 'Tailerra ebaluazio-fasera automatikoki igaroko da {$a->daydatetime} ({$a->distanceday}) ondoren';
...
$string['switchphase40info'] = 'Tailerra <strong>Kalifikazioa ebaluatzeko fasera</strong> eramango duzu. Fase honetan erabiltzaileek ezin dituzte beren bidalketa edo ebaluazioak aldatu. Irakasleek ebaluazio-tresnak erabil ditzakete azken kalifikazioak kalkulatzeko eta ebaluatzaileei feedbacka emateko.';
