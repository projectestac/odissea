...
/**
 * Strings for component 'hvp', language 'eu', branch 'MOODLE_36_STABLE'
 *
 * @package   hvp
...
$string['ctcacheconnectionfailed'] = 'Ezin izan da H5P Hub-arekin komunikatu. Saiatu berriro beranduago, mesedez.';
...
$string['ctcachenolibraries'] = 'Ez da eduki motarik jaso H5P Hub-etik. Saiatu berriro beranduago, mesedez.';
...
$string['enablehublabel'] = 'Erabili H5P Hub-a';
...
$string['hubcommunicationdisabled'] = 'H5P Hub-arekiko komunikazioa desgaitu da H5P-ren eskakizun batek edo gehiagok huts egin dutelako.';
$string['hubisdisabled'] = 'Hub-a desgaitu da. H5P ezarpenetan berriro gaitu dezakezu.';
$string['hubisdisableduploadlibraries'] = 'H5P Hub-a desgaitu da arazoak konpondu arte. Hala ere, liburutegiak igotzen jarrai dezakezu "H5P Liburutegiak" orriaren bidez.';
...
$string['invalidh5ppost'] = 'Ezin izan da H5P-a argitaratu.';
...
$string['maxpostsizetoosmall'] = 'Zure PHPko post_max_size parametroaren balioa nahiko baxua da. Ezarpen horrekin ezin duzu igo {$a->%number} MBtik gorako tamaina duen fitxategirik. Hori arazo bihur daiteke H5P-ak, irudiak eta bideoak igotzerakoan. Azter ezazu 5 MB baino muga handiagoa ezartzea, mesedez.';
$string['maxscore'] = 'Puntuazio altuena';
$string['maxuploadsizetoosmall'] = 'Zure PHPko max_upload_size parametroaren balioa nahiko baxua da. Ezarpen horrekin ezin duzu igo {$a->%number} MBtik gorako tamaina duen fitxategirik. Hori arazo bihur daiteke H5P-ak, irudiak eta bideoak igotzerakoan. Azter ezazu 5 MB baino muga handiagoa ezartzea, mesedez.';
...
$string['missingmbstring'] = 'Mbstring PHP hedapena ez dago kargatuta. H5P-k funtzio hori behar du';
...
$string['nombstringexteension'] = 'Mbstring PHP hedapena ez dago kargatuta. H5P-k funtzio hori behar du';
...
$string['privacy:metadata:hvp_content_user_data:sub_content_id'] = 'H5P-ren azpiedukia, 0 azpiedukia ez bada.';
...
$string['privacy:metadata:hvp_xapi_results:additionals'] = 'H5P-k bidali dezakeen informazio gehigarria.';
...
$string['sitecouldnotberegistered'] = 'Zure gunea ezin izan da erregistratu. Mesedez jarri harremanetan zure guneko kudeatzailearekin.';
$string['sitekey'] = 'Gunearen gakoa';
$string['sitekeydescription'] = 'Gunearen kodea gune hau Hub-ean identifikatzen duen sekretua da.';
$string['sitekeyregistered'] = 'Gako bakarra eman zaizu eguneraketa berriak jasotzean Hub-ean identifikatzen zaituena. Gakoa "H5P ezarpenak" orrian ikusi dezakezu.';
$string['size'] = 'Tamaina';
$string['source'] = 'Iturria';
$string['sslnotenabled'] = 'Zure zerbitzariak ez du SSL-a gaituta. SSL-a gaitu beharko zenuke H5P hub-arekiko konexioa segurua dela bermatzeko.';
$string['startingover'] = 'Berriro hasiko zara.';
$string['sublevel'] = 'Azpimaila';
$string['successfullyregisteredwithhub'] = 'Zure webgunea H5P Hub-ean ondo erregistratu da.';
