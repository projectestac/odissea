...
$string['expireyourkeyexplain'] = 'Moodle-k zure gakoak 28 egunean behin (berez) automatikoki rotatzen ditu baina edozein unetan gako hau <em>eskuz</em> iraungitu dezakezu. Hau soilik gakoa arriskuan egon bada izan daiteke erabilgarria. Ordezkoa automatikoki sortuko da.<br />Gakoa ezabatuta beste aplikazioek ez dute zurekin komunikatzeko aukera izango, zuk kudeatzaile bakoitzarekin eskuz harremanetan jarri eta zure gako berria helarazi ezean.';
...
$string['hostexists'] = 'Dagoeneko badago ostalari-izen hau duen ostalari baten erregistroa (agian ezabatu daiteke). <a href="{$a}">Klik egin hemen</a> erregistro hori ezabatzeko.';
...
$string['mnetidproviderdesc'] = 'Aukera hau erabil dezakezu saioa hasteko esteka bat eskuratzeko, aurretik saioa hasteko erabili duzun erabiltzailearen e-posta helbidea eman ahal baduzu.';
...
$string['nosuchmodule'] = 'Funtzioa ez da ondo kokatu edo ezin da aurkitu. Mesedez, erabili mod/modulename/lib/functionname formatua.';
