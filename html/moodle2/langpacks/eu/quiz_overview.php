...
$string['attemptsonly'] = 'Saiakerak dituen {$a} baino ez erakutsi';
...
$string['regradealldrygroup'] = '{$a->groupname}\' talderako guztiaren berkalifikazioa proba moduan';
$string['regradeallgroup'] = 'Berriz kalifikatu guztia \'{$a->groupname}\' taldeari';
$string['regradecomplete'] = 'Berriz kalifikatzea ondo egina';
...
$string['showattempts'] = 'Bakarrik erakutsi/jaitsi saiakerak';
$string['showdetailedmarks'] = 'Puntuak galdera bakoitzerako';
$string['showinggraded'] = 'Erabiltzaile bakoitzarentzat kalifikatutako saiakera bakarrik erakusten.';
