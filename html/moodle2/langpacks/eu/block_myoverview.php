...
/**
 * Strings for component 'block_myoverview', language 'eu', branch 'MOODLE_36_STABLE'
 *
...
$string['aria:allcourses'] = 'Ikastaro guztiak';
$string['aria:card'] = 'Aldatu txartel-ikuspegira';
$string['aria:controls'] = 'Ikastaroaren ikuspegi orokorraren kontrolak';
$string['aria:courseactions'] = 'Oraingo ikastarorako ekintzak';
$string['aria:courseprogress'] = 'Ikastaro-aurrerapena:';
$string['aria:coursesummary'] = 'Ikastaro-laburpenaren testua:';
$string['aria:displaydropdown'] = 'Erakutsi zabaltzen den menua';
$string['aria:favourites'] = 'Erakutsi nabarmendutako ikastaroak';
$string['aria:future'] = 'Erakutsi etorkizuneko ikastaroak';
$string['aria:groupingdropdown'] = 'Zabaltzen den menua taldekatzerako';
$string['aria:hiddencourses'] = 'Erakutsi ezkutuko ikastaroak';
$string['aria:hidecourse'] = 'Ezkutatu {$a} ikuspegian';
...
$string['aria:showcourse'] = 'Erakutsi {$a} ikuspegian';
...
$string['favourites'] = 'Nabarmendua';
$string['future'] = 'Etorkizunean';
$string['hidden'] = 'Ezkutuko ikastaroak';
$string['hiddencourses'] = 'Ezkutuan';
$string['hidecourse'] = 'Ezkutatu ikuspegian';
$string['inprogress'] = 'Martxan';
$string['lastaccessed'] = 'Azken sarrera';
$string['list'] = 'Zerrenda';
$string['morecourses'] = 'Ikastaro gehiago';
$string['myoverview:addinstance'] = 'Gehitu ikastaroaren ikuspegi orokorra blokea';
...
$string['privacy:metadata:overviewgroupingpreference'] = 'Ikastaroaren ikuspegi orokorra blokearen taldekatzerako hobespena.';
...
$string['show'] = 'Erakutsi ikastaro hau';
