...
/**
 * Strings for component 'tool_assignmentupgrade', language 'eu', branch 'MOODLE_28_STABLE'
 *
...
$string['upgradeselected'] = 'Eguneratu aukeratutako zereginak';
$string['upgradeselectedcount'] = '{$a} zeregin eguneratu nahi dituzu?';
$string['upgradesingle'] = 'Eguneratu zeregin bakar bat';
$string['viewcourse'] = 'Ikusi ikastaro hau behin zeregina eguneratuta';
