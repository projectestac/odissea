...
$string['cannotunassigncap'] = 'Ezin izan zaio {$a->role} rolari zaharkitutako {$a->cap} baimena kendu.';
...
<p>Guneko kudeatzaileak zerbitzariaren konfigurazioa baieztatu beharko luke</p><p>{$a}</p>';
...
$string['ddldependencyerror'] = '{$a->targettype} "{$a->targetname}" ezin da aldatu. Menpekotasuna aurkitu da honekiko: {$a->offendingtype} "{$a->offendingname}"';
...
$string['gradesneedregrading'] = 'Ikastaroko kalifikazioak birkalkulatu behar dira';
...
$string['groupinghasidnumber'] = '"{$a}" taldekatzeak ID zenbakia dauka eta agian kanpoko sistema batean sortu da. Ez duzu taldekatze hau ezabatzeko baimenik.';
...
$string['invaliddatarootpermissions'] = 'Baimen baliogabeak antzeman dira karpeta sortzen saiatzean. Gaitu arazketa xehetasun gehiago lortzeko.';
...
$string['invalidlegacy'] = 'Zaharkitutako rol definizio baliogabea mota honentzat: {$a}';
...
$string['invalidqueryparam'] = 'ERROREA: kontsultaren parametro kopuru baliogabea. {$a->expected} espero ziren eta {$a->actual} eskuratu dira.';
...
$string['nopermissiontoupdatecalendar'] = 'Sentitzen dugu, baina ez duzu egutegiko ekitaldiak eguneratzeko baimenik';
...
$string['sessioncookiesdisable'] = 'require_key_login() funtzioaren erabilera okerra - saioaren cookie-ak desgaituta egon behar dira!';
...
$string['unicodeupgradeerror'] = 'Sentitzen dugu baina zure datu-basea oraindik ez dago Unicoden eta Moodle-ren bertsio honek ezin du zure datu-basea Unicodera migratu. Mesedez, eguneratu Moodle 1.7.x-era eta egin Unicoderako migrazioa Kudeaketa orritik. Hori eginda, Moodle {$a}-rako migrazioa egin ahal izango duzu.';
...
$string['wwwrootmismatch'] = 'Zuzena ez den sarbidea antzeman da, zerbitzari honetara soilik "{$a}" bidez sartu daiteke, sentitzen dugu.<br />Jakinarazi mesedez zerbitzariko kudeatzaileari.';
$string['wwwrootslash'] = 'config.php fitxategian zuzena ez den $CFG->wwwroot parametroa antzeman da, ezin du bukaeran barrarik izan.<br />Jakinarazi mesedez zerbitzariko kudeatzaileari.';
