...
$string['entryusedynalink_help'] = 'Glosategirako esteka automatikoa kudeatzaileak gaitu badu eta laukitxo hau aukeratuta badago, sarrerak automatikoki estekatuko dira kontzeptuen hitz eta esaldiak ikastaroan zehar agertzen direnean.';
...
$string['explainaddentry'] = 'Gehitu beste sarrera bat glosategi honetara.<br />Kontzeptua eta azalpena derrigorrezko datuak dira.';
...
$string['explainexport'] = 'Egin klik beheko botoian glosategiko sarrerak esportatzeko.<br/>Behera kargatu eta gorde ondo. Beti izango duzu aukera hori inportatzeko, ikastaro honetan edo beste batean.';
...
$string['glossary:addinstance'] = 'Gehitu glosategi berria';
...
$string['glossaryleveldefaultsettings'] = 'Glosategiaren ezarpen lehenetsiak';
...
$string['notapproved'] = 'oraindik onartu gabeko glosategi-sarrera.';
$string['notcategorised'] = 'Kategoriarik gabe';
$string['numberofentries'] = 'Sarrera-kopurua';
$string['onebyline'] = '(lerro bakoitzeko bat)';
$string['page-mod-glossary-edit'] = 'Glosategian sarrerak gehitzeko/editatzeko orria';
$string['page-mod-glossary-view'] = 'Ikusi glosategia editatzeko orria';
$string['page-mod-glossary-x'] = 'Glosategiaren edozein orri';
...
$string['resetglossariesall'] = 'Ezabatu glosategi guztietako sarrerak';
...
$string['sortchronogically'] = 'Kronologikoki ordenatu';
