...
$string['aliases_help'] = 'Glosarioko kontzeptu bakoitza hitz gakoen zerrenda batekin lotuta egon daiteke. Sarrera autoestekatzen bada,  edozein hitz gako ere automatikoki estekatuko da.

Hitz gako horiek lerro banatan sartu (komaz banatu gabe).';
$string['allcategories'] = 'Kategoria guztiak';
$string['allentries'] = 'GUZTIAK';
$string['allowcomments'] = 'Baimendu iruzkinak sarreretan';
$string['allowcomments_help'] = 'Gaituz gero, iruzkinak sortzeko baimena duten partaide guztiak gai izango dira glosarioko sarrerei iruzkinak gehitzeko.';
...
$string['allowprintview_help'] = 'Gaituz gero, ikasleek glosarioa inprimatu ahal izateko esteka bat izango dute eskura. Irakasleek une oro erabil dezakete inprimatzeko esteka.';
...
<p>Adibidez, gaituta badago, foro bateko mezu bateko "html" hitzak ez du estekarik sortuko "HTML" sarrerara.</p>';
$string['cat'] = 'kat';
...
$string['cnfallowcomments'] = 'Erabaki glosarioak sarreretan iruzkinak onartuko dituen ala ez';
$string['cnfallowdupentries'] = 'Erabaki glosarioak sarrera bikoiztuak onartuko dituen ala ez';
$string['cnfapprovalstatus'] = 'Erabaki ikasleek egindako sarreren egoera lehenetsia';
$string['cnfcasesensitive'] = 'Erabaki sarreretan, estekatzen direnean, modu lehenetsian letra larri-txikiak bereiziko diren ala ez';
$string['cnfdefaulthook'] = 'Erabaki nola agertuko den glosarioa lehen ikustaldian';
$string['cnfdefaultmode'] = 'Erabaki zein markotan agertuko den glosarioa lehen ikustaldian';
$string['cnffullmatch'] = 'Erabaki sarrera batek, estekaduna bada, modu lehenetsian letra larri eta xeheetan bat etorri behar duen testuarekin';
$string['cnflinkentry'] = 'Erabaki sarrerak modu lehenetsian automatikoki estekatuko diren edo ez';
$string['cnflinkglossaries'] = 'Erabaki glosarioak automatikoki esteka bihurtu behar duen';
$string['cnfrelatedview'] = 'Aukeratu esteka automatikoa ikusteko formatua';
$string['cnfshowgroup'] = 'Zehaztu taldea erakutsi ala ez';
$string['cnfsortkey'] = 'Aukeratu lehenetsitako antolaketa-gakoa';
$string['cnfsortorder'] = 'Aukeratu lehenetsitako ordena';
$string['cnfstudentcanpost'] = 'Erabaki modu lehenetsian ikasleek sarrerak idatzi ahalko duten ala ez';
$string['cnftabs'] = 'Aukeratu glosario honetan ikusgai dauden fitxak';
...
$string['defaultsortkey'] = 'Lehenetsitako giltza-mota';
$string['defaultsortorder'] = 'Lehenetsitako sailkatze-ordena';
...
$string['entryusedynalink_help'] = 'Glosariorako esteka automatikoa kudeatzaileak gaitu badu eta laukitxo hau aukeratuta badago, sarrerak automatikoki estekatuko dira kontzeptuen hitz eta esaldiak ikastaroan zehar agertzen direnean.';
...
$string['errorparsingxml'] = 'Errorea fitxategia aztertzean. Ziurtatu ezazu XML sintaxia ondo dagoela.';
...
$string['explainaddentry'] = 'Gehitu beste sarrera bat glosario honetara.<br />Kontzeptua eta azalpena derrigorrezko datuak dira.';
$string['explainall'] = 'Erakutsi sarrera guztiak orri bakar batean';
$string['explainalphabet'] = 'Bilatu glosarioan aurkibide hau erabiliz';
$string['explainexport'] = 'Egin klik beheko botoian glosarioko sarrerak esportatzeko.<br/>Behera kargatu eta gorde ondo. Beti izango duzu aukera hori inportatzeko, ikastaro honetan edo beste batean.';
...
$string['filtername'] = 'Autoestekatutako glosarioa';
$string['fullmatch'] = 'Hitz osoak bakarrik bilatu';
$string['fullmatch_help'] = 'Aldagai honek esteka automatikoa hitz osoekin egingo den ala ez definitzen du. Adibidez, gaituta egonez gero, "eta" izeneko glosario-sarrera bat ez da automatikoki "aldaketa" hitzarekin estekatuko.';
...
$string['isglobal_help'] = 'Glosario orokorrak dituen sarrerak guneko edozein tokitatik estekatuak izan daitezke, ez bakarrik glosarioa duen ikastarotik. Kudeatzaileek bakarrik ezar dezakete glosario bat orokor gisa.';
$string['letter'] = 'letra';
...
$string['privacy:metadata:core_tag'] = 'Glosario-sarrerei gehitutako etiketak core_tag sisteman gordetzen dira';
...
$string['warningstudentcapost'] = '(Bakarrik glosario nagusia ez bada)';
