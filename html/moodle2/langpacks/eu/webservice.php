...
$string['addcapabilitytousers'] = 'Erabiltzaileen gaitasunak egiaztatu ';
$string['addfunction'] = 'Funtzioa gehitu';
$string['addfunctionhelp'] = 'Aukera ezazu zein funtzio gehitu zerbitzura.';
$string['addfunctions'] = 'Funtzioak gehitu';
$string['addfunctionsdescription'] = 'Aukera itzazu beharrezko funtzioak zerbitzu berrirako.';
...
$string['checkusercapability'] = 'Erabiltzailearen gaitasunak egiaztatu ';
$string['configwebserviceplugins'] = 'Segurtasun-arrazoiak direla-eta, erabiliko diren protokoloak baino ez dira gaituko.';
...
$string['createtokenforuserdescription'] = 'Web-zerbitzuetako erabiltzaileentzako token-a sortu.';
$string['createuser'] = 'Sor ezazu erabiltzaile jakin bat';
$string['default'] = '"{$a}"rako berezko balorea';
...
$string['enabledocumentation'] = 'Garatzaileen dokumentazioa gaitu';
$string['enableprotocols'] = 'Protokoloak gaitu';
$string['enablews'] = 'Web-zerbitzuak gaitu';
...
$string['invalidtimedtoken'] = 'Token baliogabea - token-a iraungita';
$string['invalidtoken'] = 'Token baliogabea - token-a ez da aurkitu';
$string['iprestriction'] = 'IP muga';
$string['key'] = 'Giltza';
...
$string['removefunctionconfirm'] = 'Ziur al zaude "{$a->function}" funtzioa "{$a->service}" zerbitzutik ezabatu nahi duzula?';
...
$string['requiredcaps'] = 'Gaitasunak behar ditu';
...
$string['securitykey'] = 'Segurtasun-giltzak (token-a)';
$string['securitykeys'] = 'Segurtasun-giltzak';
$string['selectauthorisedusers'] = 'Aukeratu baimendutako erabiltzaileak';
$string['selectedcapability'] = 'Aukeratuta';
$string['selectservice'] = 'Aukera ezazu zerbitzu bat';
$string['selectspecificuser'] = 'Aukera ezazu erabiltzaile jakin bat';
...
$string['wsclientdoc'] = 'Moodle-ren web-zerbitzuen dokumentazioa';
$string['wsdocapi'] = 'API dokumentazioa';
...
$string['wsdocumentationintro'] = 'Bezeroa sortzeko, gomendatu nahi dizugu {$a->doclink} irakurtzeko';
$string['wsdocumentationlogin'] = 'edo erabiltzaile-izena eta web-zerbitzuen pasahitza idatzi:';
