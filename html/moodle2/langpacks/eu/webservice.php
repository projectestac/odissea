...
$string['addfunctionhelp'] = 'Aukera ezazu zein funtzio gehitu zerbitzura.';
...
$string['checkusercapabilitydescription'] = 'Erabiltzaileak erabiiltako protokoloekin lotutakoa baimenak izan beharko lituzke, adibidez webservice/rest:use edo webservice/soap:use. Hau lortzeko, sor ezazu web-zerbitzuetan beharrezko gaitasunak baimenduta dituen rol bat eta eslei iezaiozu web-zerbitzuaren erabiltzaileari sistemako rol moduan';
...
$string['createtokenforuser'] = 'Sortu erabiltzaile batentzako token-a';
$string['createtokenforuserdescription'] = 'Sortu web-zerbitzuko erabiltzaileentzako token-a.';
$string['createuser'] = 'Sortu erabiltzaile jakin bat';
$string['createuserdescription'] = 'Web-zerbitzuko erabiltzaile bat behar da Moodle-k kontrolatzen duen sistema ordezkatzeko.';
$string['criteriaerror'] = 'Baimenak falta dira irizpidean bilatzeko.';
$string['default'] = 'Berezko balorea: "{$a}"';
$string['deleteaservice'] = 'Ezabatu zerbitzua';
$string['deleteservice'] = 'Ezabatu zerbitzua: {$a->name} (id: {$a->id})';
$string['deleteserviceconfirm'] = 'Zerbitzu bat ezabatzeak zerbitzu horrekin lotutako token-ak ere ezabatuko ditu. Ziur zaude "{$a}" kanpoko zerbitzua ezabatu nahi duzula?';
...
$string['errornotemptydefaultparamarray'] = 'Web-zerbitzuaren \'{$a}\' izeneko deskribapen-parametroa egitura bakan edo anitzekoa da. Berezko balioa kate hutsa baino ezin da izan. Egiaztatu web-zerbitzuaren deskribapena.';
$string['erroroptionalparamarray'] = 'Web-zerbitzuaren \'{$a}\' izeneko deskribapen-parametroa egitura bakan edo anitzekoa da. Ezin du VALUE_OPTIONAL bezala ezarri. Egiaztatu web-zerbitzuaren deskribapena.';
...
$string['eventwebserviceservicecreated'] = 'Web-zerbitzuaren zerbitzua sortu da';
$string['eventwebserviceservicedeleted'] = 'Web-zerbitzuaren zerbitzua ezabatu da';
$string['eventwebserviceserviceupdated'] = 'Web-zerbitzuaren zerbitzua eguneratu da';
$string['eventwebserviceserviceuseradded'] = 'Web-zerbitzuaren zerbitzu-erabiltzailea gehitu da';
$string['eventwebserviceserviceuserremoved'] = 'Web-zerbitzuaren zerbitzu-erabiltzaile ezabatu da';
$string['eventwebservicetokencreated'] = 'Web-zerbitzuaren token-a sortu da';
$string['eventwebservicetokensent'] = 'Web-zerbitzuaren token-a bidali da';
...
$string['installserviceshortnameerror'] = 'Kodeaketa-errorea: "{$a}" izeneko zerbitzuak zenbakiak, hizkiak eta  _-.. karaktereak baino ez lituzke izan beharko.';
...
$string['invalidtimedtoken'] = 'Token baliogabea - token-a iraungi da';
$string['invalidtoken'] = 'Token baliogabea - ez da token-a aurkitu';
...
$string['onesystemcontrolling'] = 'Kanpoko sistemari Moodle kontrolatzeko baimena eman';
...
$string['privacy:metadata:tokens:lastaccess'] = 'Tokena azkenengoz erabili zeneko unea';
...
$string['requiredcapability_help'] = 'Ezarriz gero, beharrezko baimenak dituzten erabiltzaileak baino ezin izango dira zerbitzura sartu.';
...
$string['restrictedusers_help'] = 'Ezarpen honek zehazten du web-zerbitzuetako token-ak sortzeko baimena duten erabiltzaile guztiek euren segurtasun-gakoen orriaren bitartez zerbitzu honetarako token-a sortu dezaketen edo hori soilik baimendutako erabiltzaileek egin dezaketen.';
$string['securitykey'] = 'Segurtasun-gakoak (token-a)';
...
$string['userasclientsdescription'] = 'Hurrengo urratsek lagunduko dizute Moodle-ko web-zerbitzua erabiltzaileak bezero gisa konfiguratzen. Honek autentifikazio-metodorako token bat (segurtasun-gakoa) konfiguratzea barne hartzen du. Erabilera-kasu honetan, erabiltzaileek bere token-a sortuko dute euren segurtasun-gakoen orritik hobespenen orriaren bitartez.';
...
$string['wsclientdoc'] = 'Moodle-ko web-zerbitzuen dokumentazioa';
