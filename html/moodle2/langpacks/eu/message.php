...
/**
 * Strings for component 'message', language 'eu', branch 'MOODLE_36_STABLE'
 *
 * @package   message
...
$string['addcontactconfirm'] = 'Ziur al zaude {$a} gehitu nahi duzula zure kontaktuetara?';
$string['addtofavourites'] = 'Esleitu izarra elkarrizketari';
...
$string['blockuserconfirm'] = 'Ziur al zaude {$a} blokeatu nahi duzula?';
$string['blockuserconfirmbutton'] = 'Blokea';
...
$string['contactableprivacy_coursemember'] = 'Nire kontaktuak eta nire ikastaroetako edonor';
$string['contactableprivacy_onlycontacts'] = 'Nire kontaktuak bakarrik';
...
$string['deleteselectedmessagesconfirm'] = 'Ziur al zaude aukeratutako mezuak ezabatu nahi dituzula? Horrek ez ditu ezabatuko elkarrizketako beste partaideentzat.';
...
$string['eventmessageuserunblocked'] = 'Erabiltzailea desblokeatuta';
...
$string['messagedrawerviewgroupinfo'] = '{$a}-ren talde-xehetasunak';
...
$string['nogroupmessages'] = 'Ez dago taldeko elkarrizketarik';
...
$string['notincontacts'] = '{$a} gehitu behar duzu kontaktuetara mezua bidali ahal izateko.';
...
$string['privacy_desc'] = 'Mezuak nork bidaliko dizkizun zehaz dezakezu';
...
$string['removecontactconfirm'] = 'Ziur al zaude {$a} kendu nahi duzula zure kontaktuetatik?';
$string['removecoursefilter'] = 'Ezabatu iragazkia {$a} ikastarotik';
$string['removefromfavourites'] = 'Kendu izarra elkarrizketari';
$string['removefromyourcontacts'] = 'Ezabatu kontaktuetatik';
$string['requirecontacttomessage'] = '{$a}-(r)i  egin behar diozu kontaktu-eskaria mezua bidali ahal izateko.';
...
$string['searchnocontactsfound'] = 'Ez da kontakturik aurkitu';
$string['searchnomessagesfound'] = 'Ez da mezurik aurkitu';
$string['searchnononcontactsfound'] = 'Ez da "ez-kontaktua" aurkitu';
...
$string['unblockuserconfirm'] = 'Ziur al zaude {$a} desblokeatu nahi duzula?';
