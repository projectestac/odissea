...
$string['competenciesarenotenabled'] = 'Gaitasunak ez daude gaituta.';
$string['competenciessettings'] = 'Gaitasunen ezarpenak';
$string['completeplanstask'] = 'Osatu amaiera-datara heldutako ikasketa-planak';
$string['coursecompetencyoutcome_complete'] = 'Osatu gaitasuna';
...
$string['coursemodulecompetencyoutcome_complete'] = 'Osatu gaitasuna';
...
$string['eventcompetencyframeworkcreated'] = 'Gaitasun-markoa sortu da.';
$string['eventcompetencyframeworkdeleted'] = 'Gaitasun-markoa ezabatu da.';
$string['eventcompetencyframeworkupdated'] = 'Gaitasun-markoa eguneratu da.';
$string['eventcompetencyframeworkviewed'] = 'Gaitasun-markoa ikusi da.';
$string['eventcompetencyupdated'] = 'Gaitasuna eguneratu da.';
$string['eventcompetencyviewed'] = 'Gaitasuna ikusi da.';
...
$string['eventusercompetencyplanviewed'] = 'Erabiltzailearen gaitasun-plana ikusi da.';
$string['eventusercompetencyrated'] = 'Erabiltzailearen gaitasuna kalifikatu da.';
$string['eventusercompetencyratedincourse'] = 'Erabiltzailearen gaitasuna kalifikatu da ikastaroan.';
$string['eventusercompetencyratedinplan'] = 'Erabiltzailearen gaitasuna kalifikatu da ikasketa-planean.';
$string['eventusercompetencyreviewrequestcancelled'] = 'Erabiltzailearen gaitasuna berrikusteko eskaera bertan behera utzi da.';
$string['eventusercompetencyreviewrequested'] = 'Erabiltzailearen gaitasuna berrikusteko eskatu da.';
$string['eventusercompetencyreviewstarted'] = 'Erabiltzailearen gaitasunaren berrikusketa hasi da.';
$string['eventusercompetencyreviewstopped'] = 'Erabiltzailearen gaitasunaren berrikusketa gelditu da.';
...
$string['taxonomy_outcome'] = 'Ikas-emaitza';
...
$string['usercommentedonacompetency'] = '{$a->fullname}-(e)k iruzkina egin du "{$a->competency}" gaitasunean:

{$a->comment}

Ikusi: {$a->url}';
$string['usercommentedonacompetencyhtml'] = '<p>{$a->fullname}-(e)k iruzkina egin du "{$a->competency}" gaitasunean:</p>
<div>{$a->comment}</div>
