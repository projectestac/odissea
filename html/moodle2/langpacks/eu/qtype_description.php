...
/**
 * Strings for component 'qtype_description', language 'eu', branch 'MOODLE_36_STABLE'
 *
...
$string['informationtext'] = 'Informazio-testua';
$string['pluginname'] = 'Deskribapena';
$string['pluginnameadding'] = 'Deskribapena gehitzen';
