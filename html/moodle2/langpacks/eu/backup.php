...
$string['config_keep_groups_and_groupings'] = 'Berez mantendu uneko taldeak eta taldekatzeak.';
$string['config_keep_roles_and_enrolments'] = 'Berez mantendu uneko rolak eta matrikulazioak.';
...
$string['config_overwrite_course_fullname'] = 'Berez gainidatzi ikastaroaren izen osoa segurtasun-kopian dagoenarekin. Ezarpen honek "Ikastaroaren ezarpenak gainidatzi" markatuta egotea eta uneko erabiltzaileak ikastaroaren izen osoa aldatzeko baimena (moodle/course:changefullname) izatea behar du.';
$string['config_overwrite_course_shortname'] = 'Berez gainidatzi ikastaroaren izen laburra segurtasun-kopian dagoenarekin. Ezarpen honek "Ikastaroaren ezarpenak gainidatzi" markatuta egotea eta uneko erabiltzaileak ikastaroaren izen laburra aldatzeko baimena (moodle/course:changeshortname) izatea behar du.';
$string['config_overwrite_course_startdate'] = 'Berez gainidatzi ikastaroaren hasiera- eta amaiera-data segurtasun-kopian dagoenarekin. Ezarpen honek "Ikastaroaren ezarpenak gainidatzi" markatuta egotea eta uneko erabiltzaileak berreskuratzean ikastaroaren datak aldatzeko baimena (moodle/restore:rolldates) izatea behar du.';
$string['configrestoreactivities'] = 'Jarduerak berreskuratzeko berezko balioa zehazten du.';
$string['configrestorebadges'] = 'Dominak berreskuratzeko berezko balioa zehazten du.';
$string['configrestoreblocks'] = 'Blokeak berreskuratzeko berezko balioa zehazten du.';
$string['configrestorecalendarevents'] = 'Egutegiko ekitaldiak berreskuratzeko berezko balioa zehazten du.';
$string['configrestorecomments'] = 'Iruzkinak berreskuratzeko berezko balioa zehazten du.';
$string['configrestorecompetencies'] = 'Gaitasunak berreskuratzeko berezko balioa zehazten du.';
$string['configrestoreenrolments'] = 'Matrikulazio-metodoak berreskuratzeko berezko balioa zehazten du.';
$string['configrestorefilters'] = 'Iragazkiak berreskuratzeko berezko balioa zehazten du.';
$string['configrestoregroups'] = 'Taldeak eta taldekatzeak berreskuratzeko berezko balioa zehazten du, segurtasun-kopian egonez gero.';
$string['configrestorehistories'] = 'Erabiltzaileen berezko historia berreskuratzeko berezko balioa zehazten du, segurtasun-kopian egonez gero.';
$string['configrestorelogs'] = 'Gaituz gero berez agerraldiak berreskuratuko dira, segurtasun-kopian egonez gero.';
$string['configrestoreroleassignments'] = 'Gaituz gero berez matrikulazioak berreskuratuko dira, segurtasun-kopian egonez gero.';
$string['configrestoreusers'] = 'Erabiltzaileak berreskuratzeko berezko balioa zehazten du, segurtasun-kopian egonez gero.';
$string['configrestoreuserscompletion'] = 'Gaituz gero berez erabiltzaileen osatze-informazioa berreskuratuko da, segurtasun-kopian egonez gero.';
...
$string['generalenrolments'] = 'Gehitu matrikulazio-metodoak';
...
$string['generalrestoredefaults'] = 'Berreskuratzeko berezko balio orokorrak';
...
$string['mergerestoredefaults'] = 'Berezko berreskuratze-balioak segurtasun-kopia ikastaro batera batzean';
...
$string['replacerestoredefaults'] = 'Berezko berreskuratze-balioak segurtasun-kopia ikastaro bateko edukiak ezabatu eta ondoren berreskuratzean';
...
$string['rootsettingenrolments'] = 'Gehitu matrikulazio-metodoak';
