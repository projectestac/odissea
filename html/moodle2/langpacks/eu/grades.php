...
$string['grademax_help'] = 'Ezarpen honek zehazten du gehienezko kalifikazioa balioa denean kalifikazio-mota. Jarduera batean oinarritutako kalifikazio-elementu baterako gehienezko kalifikazioa jardueraren orriaren ezarpenetan adierazten da.';
$string['grademin'] = 'Gutxieneko kalifikazioa';
$string['grademin_help'] = 'Ezarpen honek zehazten du gutxienezko kalifikazioa balioa denean kalifikazio-mota.';
...
$string['gradepointmax'] = 'Kalifikazioaren gehienezko puntuazioa';
$string['gradepointmax_help'] = 'Ezarpen honek jarduera baterako gehienezko zenbakizko kalifikazio eskuragarria zehazten du.';
...
$string['outcomestandard_help'] = 'Gune osoan, ikastaro guztietan, edozein ikaste-emaitza estandar dago eskuragarri.';
...
$string['quickgrading_help'] = 'Gaituz gero, eta edizioa aktibatuta dagoenean, testua sartzeko eremu bat agertzen da kalifikazio bakoitzarentzat, eta horrela aldi berean kalifikazio bat baino gehiago editatu daitezke. Eguneratu botoian klik egitean aldaketak gorde eta nabarmentzen dira.

Kontuan izan kalifikazio-liburuan kalifikazio bat editatzen denean baliogabetua izan denaren marka jartzen zaiola, eta horrek esan nahi du kalifikazioa ezingo dela lotutako jardueratik aldatu ahalko.';
...
$string['showanalysisicon_desc'] = 'Modu lehenetsian kalifikazio-analisiaren ikonoa erakutsi edo ez. Jarduera-moduluak baimentzen badu, kalifikazio-analisiaren ikonoak kalifikazioaren eta nola lortu duenaren azalpen zehatzagoa erakusten duen orri bat estekatuko du';
...
$string['showaverages_help'] = 'Gaituz gero, kalifikatzailearen txostenean kategoria eta elementu bakoitzerako  batez bestekoa erakusten dituen beste lerro bat erakusten du.';
...
Kontuan izan feedbacka kalifikazio-txostenean editatzen denean baliogabetu marka jartzen zaiola, eta horrek esan nahi du ondoren ezingo dela feedback hori dagokion jardueratik aldatu.';
...
$string['unlimitedgrades_help'] = 'Modu lehenetsian, kalifikazioak kalifikazio-elementuaren gutxieneko eta gehienezko balioek mugatzen dituzte. Ezarpen hau gaituz gero, muga hori kentzen da, eta kalifikazio-liburuan %100etik gorako kalifikazioak sartzea ahalbidetzen du.';
