...
/**
 * Strings for component 'block_tag_youtube', language 'eu', branch 'MOODLE_28_STABLE'
 *
...
$string['includeonlyvideosfromplaylist'] = 'zerrendako bideoak bakarrak sartu ID-arekin';
$string['music'] = 'Musika';
