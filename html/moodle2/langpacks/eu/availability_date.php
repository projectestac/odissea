...
/**
 * Strings for component 'availability_date', language 'eu', branch 'MOODLE_28_STABLE'
 *
...
$string['description'] = 'Saihestu sarbidea data eta ordu zehatz batetik aurrera (edo batera arte).';
