...
/**
 * Strings for component 'qtype_calculated', language 'eu', branch 'MOODLE_31_STABLE'
 *
...
$string['dataitemdefined'] = 'dagoeneko definitutako {$a} balore numeriko daude eskuragarri';
...
$string['distributionoption'] = 'Aukeratu banaketa-aukera';
$string['editdatasets'] = 'Editatu komodinaren datu-multzoak';
$string['editdatasets_help'] = 'Komodineko balioak komodinaren eremuan zenbaki bat sartu eta gehitu botoian sakatuta sor daitezke. Automatikoki 10 edo balio gehiago sortzeko aukeratu nahi dituzun balio kopurua eta ondoren gehitu botoia sakatu. Banaketa uniformeak limiteen barruko edozein balio probabilitate berarekin sortuko dela esan nahi du; banaketa loguniformeak ordea beheko limitetik hurbil dauden balioak sortzeko probabilitatea altuagoa dela esan nahi du.';
$string['existingcategory1'] = 'dagoeneko existitzen den datu-multzo konpartitua erabiliko du';
$string['existingcategory2'] = 'dagoeneko existitzen den eta kategoria honetako beste galderek erabiltzen duten fitxategien multzo bateko fitxategi bat';
$string['existingcategory3'] = 'dagoeneko existitzen den eta kategoria honetako beste galderek erabiltzen duten esteken multzo bateko esteka bat';
$string['forceregeneration'] = 'behartu birsorkuntza';
$string['forceregenerationall'] = 'behartu komodin guztien birsorkuntza';
$string['forceregenerationshared'] = 'behartu soilik elkarbanatu gabeko komodinen birsorkuntza';
$string['functiontakesatleasttwo'] = '{$a} funtzioak gutxienez bi argumentu izan behar ditu';
$string['functiontakesnoargs'] = '{$a} funtzioak ez du argumenturik hartzen';
...
$string['generatevalue'] = 'Sortu beste balore bat ondokoen artean';
$string['getnextnow'] = 'Lortu " Gehitzeko elementua" orain';
$string['hexanotallowed'] = '<strong>{$a->name}</strong> datu-multzoko {$a->value} balioaren formatu hamaseitarra ez dago baimenduta';
$string['illegalformulasyntax'] = 'Legez kanpoko formula-sintaxia \'{$a}\'-(r)ekin hasita';
$string['incorrectfeedback'] = 'Edozein erantzun okerretarako';
$string['itemno'] = '{$a} elementua';
$string['itemscount'] = 'Elementuak<br />Kopurua';
$string['itemtoadd'] = 'Gehitzeko elementua';
$string['keptcategory1'] = 'aurreko datu-multzo elkarbanatu bera erabiliko du';
$string['keptcategory2'] = 'aurreko kategori bereko datu-multzo elkarbanatuko fitxategi-multzoko fitxategia';
$string['keptcategory3'] = 'aurreko kategori bereko datu-multzo elkarbanatuko esteka-multzoko esteka';
$string['keptlocal1'] = 'aurreko datu-multzo pribatu bera erabiliko du';
$string['keptlocal2'] = 'aurreko galderako datu-multzo pribatuko fitxategi-multzoko fitxategia';
$string['keptlocal3'] = 'aurreko galderako datu-multzo pribatuko esteka-multzoko esteka';
$string['lengthoption'] = 'Aukeratu luzera aukerak';
$string['loguniform'] = 'Loguniformea';
$string['loguniformbit'] = 'hamartar, banaketa loguniformea jarraituta';
$string['makecopynextpage'] = 'Hurrengo orria (beste galdera bat)';
$string['mandatoryhdr'] = 'Erantzunetan derrigor agertu beharreko komodinak';
$string['max'] = 'Geh.';
$string['min'] = 'Gutx.';
$string['minmax'] = 'Balore-tartea';
...
$string['newcategory1'] = 'elkarbanatutako datu-multzo berri bat erabiliko du';
$string['newcategory2'] = 'fitxategi-multzo berri bateko fitxategia, kategoria bereko beste galderek ere erabili ahal izango dutena';
$string['newcategory3'] = 'esteka-multzo berri bateko esteka, kategoria bereko beste galderek ere erabili ahal izango dutena';
...
$string['nocoherencequestionsdatyasetcategory'] = '{$a->qid} id-a duen galderaren kasuan, {$a->qcat} id-a duen kategoria ez da elkarbanatutako komodinaren {$a->name} kategoriaren id-arekin bat etortzen {$a->sharedcat}. Editatu ezazu galdera.';
...
$string['nosharedwildcard'] = 'Ez dago partekatutako komodinik kategoria honetan';
$string['notvalidnumber'] = 'Komodinaren balorea ez da zenbaki baliagarria';
$string['oneanswertrueansweroutsidelimits'] = 'Gutxienez erantzun zuzen bat dago benetako balioen mugetatik kanpo.<br/>Aldatu erantzunen tolerantziaren ezarpenak Parametro Aurreratuak atalean';
...
$string['reuseifpossible'] = 'berrerabili lehengo balorea eskuragarri badago';
...
$string['uniformbit'] = 'hamartar, banaketa uniformea jarraituta';
$string['unsupportedformulafunction'] = 'Ez da {$a} funtzioa onartzen';
$string['updatecategory'] = 'Eguneratu kategoria';
$string['updatedatasetparam'] = 'Eguneratu datu-multzoaren parametroak';
$string['updatetolerancesparam'] = 'Eguneratu tolerantzia-parametroak erantzunetan';
$string['updatewildcardvalues'] = 'Eguneratu komodin(ar)en baloreak';
$string['useadvance'] = 'Erabili botoi aurreratua erroreak ikusteko';
$string['usedinquestion'] = 'Galderan erabilia';
$string['wildcard'] = 'Komodina: {<strong>{$a}</strong>}';
$string['wildcardparam'] = 'Baloreak sortzeko erabilitako komodinen parametroak';
$string['wildcardrole'] = 'Komodinak <strong>{x..}</strong>sortutako baloreetako zenbakizko balore batekin ordezkatuko dira.';
$string['wildcards'] = 'Komodinak {a}...{z}';
$string['wildcardvalues'] = 'Komodin(ar)en baloreak';
$string['wildcardvaluesgenerated'] = 'Komodin(ar)en baloreak sortu dira';
$string['youmustaddatleastoneitem'] = 'Gutxienez datu-multzoko elementu bat gehitu behar duzu galdera gorde baino lehen.';
$string['youmustaddatleastonevalue'] = 'Galdera hau gorde baino lehen, komodinetarako hainbat balore gehitu behar dituzu.';
$string['zerosignificantfiguresnotallowed'] = 'Galdera zuzenak ezin du zero datu esanguratsu izan!';
