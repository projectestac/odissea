...
/**
 * Strings for component 'qbehaviour_adaptive', language 'eu', branch 'MOODLE_26_STABLE'
 *
...
$string['gradingdetailsadjustment'] = 'Aurreko penalizazioekin,  hauxe da emaitza: <strong>{$a->cur}/{$a->max}</strong>';
