...
/**
 * Strings for component 'forum', language 'eu', branch 'MOODLE_36_STABLE'
 *
 * @package   forum
...
$string['cannotadddiscussiongroup'] = 'Ezin duzu eztabaida sortu ezein taldetako kiderik ez baitzara.';
...
$string['configdigestmailtime'] = 'Aukera hori hartzen dutenei posta elektroniko bidez elkarrizketen laburpen-mezua bidaliko zaie. Ezarpen honek e-maila eguneko zer ordutan bidaliko den zehazten du (aukeratutako orduaren ondorengo lehenengo cronaren bitartez).';
...
$string['digestmailheader'] = '{$a->sitename} guneko foroetako azken mezuen banaketa da hau. Foroetako zure posta elektronikoko ezarpenak editatzeko joan zaitez hona: {$a->userprefs}';
...
$string['digestsentusers'] = 'Laburpen-mezuak posta elektroniko bidez ondo bidali zaizkie {$a} erabiltzaile(r)entzat.';
...
$string['displayend_help'] = 'Ezarpen honek foroko mezuak data jakin batetik aurrera ezkutatu behar diren ala ez zehazten du. Kontuan hartu  kudeatzaileek ikusiko dituztela.';
$string['displaymode'] = 'Erakusteko modua';
$string['displayperiod'] = 'Erakusteko epea';
$string['displaystart'] = 'Erakusteko hasiera-data';
$string['displaystart_help'] = 'Ezarpen honek foroko mezuak data jakin batetik aurrera erakutsi behar diren ala ez zehazten du. Kontuan hartu  kudeatzaileek ikusiko dituztela.';
...
$string['emaildigesttype'] = 'Posta elektroniko bidezko laburpen-mezuak aukerak';
$string['emaildigesttype_help'] = 'Foro bakoitzetik jasoko duzun jakinarazpen mota.

* Lehenetsitakoa - erabiltzailearen profilean ezarritakoa jarraitzen du. Zure profila eguneratzen baduzu, aldaketa hori hemen ere islatuko da;
...
$string['invaliddigestsetting'] = 'Foroetako mezuak posta elektroniko bidez jasotzeko moduan ezarpen baliogabea jaso da';
...
$string['markasreadonnotification'] = 'Foroko mezuen jakinarazpenak bidaltzean';
$string['markasreadonnotification_help'] = 'Foroko mezu batez jakinarazten zaizunean, foroko jarraipenerako mezu hori irakurritzat markatu nahi duzun aukera dezakezu.';
...
$string['mustprovidediscussionorpost'] = 'Eztabaidaren id-a edo mezuaren id-a eman behar duzu esportatzeko';
...
$string['privacy:metadata:preference:maildigest'] = 'Gune mailako posta elektroniko bidezko banaketa-aukeraren hobespena';
...
$string['resetdigests'] = 'Ezabatu erabiltzailekako foroetako mezuak posta elektroniko bidez jasotzeko hobespenak';
...
$string['subscribeenrolledonly'] = 'Sentitzen dugu, soilik matrikulatutako erabiltzaileek harpidetu daitezke foroko mezuen jakinarazpenak jasotzeko.';
