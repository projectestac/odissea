...
$string['debugnormal'] = 'NORMALA: akatsak, abisuak eta berriak erakutsi';
...
$string['eventshandlersinuse'] = 'Zure sistemako hurrengo gehigarriek baztertutako Events 1 API-aren kudeatzaileak erabiltzen dituzte: \'{$a}\'. Mesedez, eguneratu itzazu Events 2 API-ra. Ikusi https://docs.moodle.org/dev/Event_2#Event_dispatching_and_observers gehiago jakiteko.';
...
$string['passwordreuselimit_desc'] = 'Erabiltzaile batek pasahitza aldatu beharreko aldi-kopurua bere pasahitz bat berriz erabili ahal izateko. Aurretik erabilitako pasahitzen hash-ak datu-basean gordetzen dira. Baliteke funtzio hau kanpoko autentifikazio-gehigarri batzuekin ezin erabiltzea.';
...
$string['pluginscheck'] = 'Egiaztatu gehigarrien menpekotasuna';
$string['pluginscheckfailed'] = 'Menpekotasun egiaztapenak huts egin du hurrengo hauetan: {$a->pluginslist}';
$string['pluginschecktodo'] = 'Gehigarri guztien betebeharrak konpondu behar dituzu Moodle bertsio hau instalatzen jarraitu baino lehen!';
...
$string['profilingallowall_help'] = 'Gehigarri hau gaitzen baduzu, edozein unetan PROFILEALL parametroa edonon (PGC) erabili ahal izango duzu Moodle saio iraun bitartean exekutatutako script guztien profilatzea gaitzeko. Modu berean, PROFILEALLSTOP parametroa erabili ahalko duzu profilatzea geratzeko.';
$string['profilingallowme'] = 'Profilatzen selektiboa';
$string['profilingallowme_help'] = 'Gehigarri hau gaitzen baduzu, modu selektiboan PROFILEME parametroa edonon (PGC) erabili ahalko duzu exekutatuko den script hori profilatzeko. Modu berean, DONTPROFILEME parametroa erabili ahalko duzu profilatzea egin ez dadin.';
...
$string['searchindexdeleted'] = 'Index-a ezabatu da';
...
$string['soaprecommended'] = 'SOAP luzapena instalatzea erabilgarria da web-zerbitzu eta gehigarri batzuentzat.';
...
$string['tasklegacycron'] = 'Gehigarrien zaharkitutako cron-aren prozesatzea';
...
$string['taskplagiarismcron'] = 'Plagio-gehigarrien zaharkitutako cron-aren atzeko planoaren prozesatzea';
$string['taskportfoliocron'] = 'Portfolio gehigarrien atzeko planoko prozesatzea';
