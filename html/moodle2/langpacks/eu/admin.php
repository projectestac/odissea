...
$string['ageofdigitalconsentmap_desc'] = 'Hemen berezko onespen-adin digitala eta berezko balio horrekin bat egiten ez duten herrialdeen adinak zehaztu daitezke. Sartu adin bakoitza errendaka batean hurrengo formatuarekin: herrialde-kodea, adina (komaz banatuta). Berezko adina herrialde-kodean * karakterea jarrita adierazten da. Herrialde-kodeak ISO 3166-2-an zehaztuta daude.';
...
$string['alternativefullnameformat_desc'] = 'Ezarpen honek definitzen du izenak nola erakusten zaizkien izen osoa ikustea gaituta duten erabiltzaileei (kudeatzaile-, irakasle- edo edizio-baimenik gabeko irakasle-rola dutenei, besterik adierazi ezean). Erabil daitezkeen parametroak "Izen osoaren formatua" ezarpenarenak bezalakoak dira.';
$string['always'] = 'Beti';
...
$string['configallowswitch'] = 'Aukera ezazu erabiltzaile bat zein roletara alda daitekeen, jadanik dituen roletan oinarrituz. Taula honetako sarreraz gain, erabiltzaileak moodle/role:switchroles baimena gaituta izan beharko du. <br />Ohar zaitez moodle/course:view baimena duten baina moodle/site:doanything baimena ez duten roletara bakarrik alda daitekeenez, taula honetako zutabe batzuk desgaituta daudela.';
...
$string['configcookiehttponly'] = 'PHP 5.2.0 funtzio berria gaitu - nabigatzaileei adierazten zaie cookie-a benetako http-eskariei bakarrik bidaltzeko. Cookie-ak ez lirateke script hizkuntzetatik eskuragarri egon behar. Nabigatzaile guztiek ez dute funtzio hau onartzen eta agian ez da oraingo kodearekin bateragarri izango. Hainbat XSS erasori aurre egiten laguntzen du.';
...
$string['configemailfromvia'] = 'Gehitu informazioa e-postaren igorlearen atalaren bidez. Horrek jakinarazten du mezua nork bidali zuen eta ustekabean ez-erantzuteko posta-helbidera erantzutea eragozten du.';
...
$string['configenablesafebrowserintegration'] = 'Honek \'Eskatu Azterketarako Nabigatzaile Segurua\' gehitzen du galdetegiaren ezarpen-formularioko \'Nabigatzailearen segurtasuna\' eremuan. Ikusi http://www.safeexambrowser.org/ informazio gehiagorako.';
...
$string['configenabletrusttext'] = 'Berez, erabiltzaileek idatzitako testua sakon garbituko du Moodle-k segurtasunerako arrisku izan daitekeen edozein \'script\', media e.a. ezabatzeko. Konfiantzazko Edukiaren sistemarekin zure konfiantza duten erabiltzaile jakinei edukietan ezaugarri aurreratu horiek sartzeko baimena ematen diezu, interferentziarik gabe. Sistema gaitzeko, ezarpen hau gaitu behar duzu lehenik eta ondoren Konfidantzazko Eduki baimena eman Moodle-ren rol zehatz bati. Erabiltzaile horiek sortu edo igotako testuak konfiantzazko gisa markatuko dira eta ez dira garbiketa prozesutik pasako erakutsi aurretik.';
...
$string['configerrorlevel'] = 'Erakustea nahi duzun PHP abisu-kopurua aukeratu. Aukera onena \'Arrunta\' da.';
...
$string['configsmtphosts'] = 'Moodle-k posta-mezuak bidaltzeko erabiliko duen SMTP zerbitzari lokal bat edo gehiagoren izenak hemen idatzi (ad., \'mail.a.com\' edo \'mail.a.com;mail.b.com\'). Berezkoa ez den portu bat aukeratzeko (adibidez: 25a ez den bat) [zerbitzaria]:[portua] sintaxia erabili dezakezu (adibidez: \'mail.a.com:587\'). Konexio seguruak egiteko, normalean 465 SSL-arekin erabiltzen da eta 587 TLS-arekin. Behar izanez gero segurtasun protokoloa behian adierazi. Zuriz uzten baduzu, Moodle-k posta bidaltzeko lehenetsitako PHP metodoa erabiliko du.';
...
$string['configstatsruntimedays'] = 'Ezarpen honek estatistika-datuen azterketa bakoitzean prozesatutako gehienezko egun kopurua zehazten du. Estatistikak eguneratuta daudenean egun bakarra prozesatuko da eta beraz  balore hau zure zerbitzariaren kargaren arabera doitu beharko duzu eta gutxitu krona sarriago egikaritu behar bada.';
...
$string['configthemelist'] = 'Aukera hau zuriz utzi baliozko edozein itxuraren erabilera baimentzeko. Itxuren menua laburbildu nahi baduzu, kakotxez bereizitako izenbururen zerrenda adieraz dezakezu (Ez utzi tarterik!). Adibidez: standard,orangewhite';
$string['configtimezone'] = 'Hau datak erakusteko lehenetsitako ordutegi-eremua da - erabiltzaileek beren profiletan alda dezakete. Cron zereginak eta bestelako zerbitzariko ezarpenak ordutegi-eremu honetan konfiguratzen dira. Ezarpen hau aldatu beharko zenuke "Ordutegi-eremu baliogabea" erakusten badu.';
...
$string['courselistshortnames_desc'] = 'Gaituta badago, ikastaro-zerrendetan ikastaroen izen laburrak erakutsiko dira izen osoarekin batera. Behar izanez gero, ikastaroen izen luzeak pertsonalizatu daitezke Hizkuntzen pertsonalizazioa aukeran \'courseextendednamedisplay\' hizkuntza-katea editatuz.';
...
$string['debugall'] = 'DENAK: PHP arazketa-mezu guztiak erakutsi';
...
$string['defaultformatnotset'] = 'Errorea berezko ikastaro-formatua zehaztean. Mesedez, egiazta itzazu gunearen ezarpenak';
...
$string['devicedetectregex_desc'] = '<p>Berez, Moodle-k hurrengo gailu-motak antzeman ditzake: arrunta (mahaigaineko PCa, eramangarria,...) sakelekoak (sakeleko telefonoak eta eskurako gailu txikiak), tablet-ak  (iPad-ak, Android tablet-ak) eta zaharkitutakoak (Internet Explorer 6 erabiltzaileak). Itxura-hautatzailea erabil daitezke horietako bakoitzari itxura ezberdinak aplikatzeko. Ezarpen honek gailu-mota gehigarriak antzemateko adierazpen erregularrak erabiltzea ahalbidetzen du (honek berez antzemandako gailu-motekiko lehentasuna izango luke).</p>
...
$string['forceloginforprofileimage_help'] = 'Gaituz gero, erabiltzaileak sartu beharko dira erabiltzaileen irudiak ikusteko eta erabiltzaileen berezko irudia erabiliko da jakinarazpen e-posta guztietan.';
...
$string['formatuninstallwithcourses'] = '{$a->format} formatua erabiltzen duen {$a->count} ikastaro dago. Euren formatua {$a->defaultformat}-(e)ra aldatuko da (gunearen berezko formatua). Formatuaren berezko datu batzuk gal daitezke. Ziur zaude jarraitu nahi duzula?';
$string['frontpage'] = 'Hasiera-orria';
$string['frontpagebackup'] = 'Hasiera-orriaren segurtasun-kopia';
$string['frontpagedefaultrole'] = 'Hasiera-orriko berezko rola';
...
$string['gravatardefaulturl_help'] = 'Gravatar-ek berezko irudi bat behar du erabiltzaile baten irudia eskuratzeko gai ez denerako. Eman irudiaren URL osoa. Ezarpen hau hutsik utiz gero, Moodle ikusten ari zaren orriarentzako berezko irudi egokiena erabiltzen saiatuko da. Kontuan izan Gravatar-ek erabil daitezkeen kode batzuk ere badituela <a href="https://en.gravatar.com/site/implement/images/#default-image">berezko irudiak sortzeko</a>.';
...
$string['ishttpswarning'] = 'Zure gunea HTTPS erabiliz babesturik ez dagoela antzeman dugu. Zure gunea HTTPS erabiltzeko migratzea irmoki gomendatzen dugu segurtasuna eta beste sistemekiko integrazioak hobetzeko.';
...
$string['legacyfilesinnewcourses_help'] = 'Berez, heredatutako ikastaroko fitxategiak eguneratutako ikastaroetan soilik daude eskuragarri. Mesedez kontuan izan jardueren segurtasun-kopia eta berreskuratzea bezalako funtzio batzuk ez direla ezarpen honekin bateragarriak.';
...
$string['linkcoursesections_help'] = 'Beti ikastaroko ataletara esteka bat ematen saiatu. Ikastaro-atalak normalean esteka gisa erakusten dira soilik ikastaro-formatuak orriko atal bakarra erakusten duenean. Ezarpen hau gaituta badago esteka beti emango da.';
...
$string['lockoutemailbody'] = 'Zure \'{$a->sitename}\' zerbitzariko {$a->username} erabiltzaileran kontua blokeatua izan da sartzeko saiakera oker anitz egin direlako.

Kontua berehala desblokeatzeko, sartu hurrengo estekan:

{$a->link}

E-posta programa gehienetan goiko helbidea lotura urdin bat gisa agertu beharko litzateke eta zuk zuzenean klik egiteko aukera izan. Horrela ez bada, helbidea kopiatu eta zure nabigatzailearen goialdean dagoen helbide-barran itsasi.
...
$string['loginpageautofocus'] = 'Foku automatikoa sarrera-orriko formularioan';
$string['loginpageautofocus_help'] = 'Aukera hau gaitzeak sarrera-orriko erabilterraztasuna handitzen du, baina eremuak automatikoki fokatzea irisgarritasun arazo gisa ere ikusi daiteke.';
...
$string['maxtimelimit_desc'] = 'Moodle-k onartuko duen gehienezko PHP exekuzio-denbora mugatzeko inolako irteerarik erakutsi gabe, sartu hemen balio bat segundutan, 0 jarriz gero Moodle-ko berezko mugak aplikatuko dira. Bere muga propioak dituen frontend zerbitzari bat baduzu hemen balio baxuago bat ezarri PHP error mezuak jasotzeko. Muga hau ez zaie CLI script-ei aplikatzen.';
...
$string['mediapluginswfnote'] = 'Berezko segurtasun-neurri gisa, erabiltzaile arruntei ez zaie swf flash fitxategirik sartzen uzten.';
...
$string['multilangforceold'] = 'Behartu zintaxi eleanitz zaharra: <span> ondokorik gabe class="multilang" and <lang>';
...
$string['navsortmycoursessort_help'] = 'Aukera honek Nire ikastaroak atalean ikastaroak ordenaren arabera (Gunearen Kudeaketa > Ikastaroak > Kudeatu ikastaroak eta kategoriak atalean zehaztutakoaren arabera) edo alfabetikoki erakutsiko diren zehazten du.';
...
$string['oauthrefreshtokenexpired'] = 'Zure {$a->siteurl} guneko {$a->issuer} OAuth zerbitzu bateko freskatze-tokena iraungi da. Honek zerbitzu hori erabiltzen duten pluginen funtzionalitatea mugatuko du. Arazoa konpontzeko, sartu Oauth 2 zerbitzuen ezarpenen orrian eta taulako zerbitzu horren errenkadan klik egin “Konektatu sistemaren kontua” ikonoan. Ziurta ezazu OAuth sisteman sartzen zaren bakoitzean zerbitzuko kontu bera erabiltzen ari zarela.';
$string['oauthrefreshtokenexpiredshort'] = 'Zure {$a->siteurl} guneko {$a->issuer} OAth freskatze-tokena iraungitu da.';
...
$string['pcreunicodewarning'] = 'Unicode karaktereekin bateragarria den PHPko PCRE luzapena instalatzea irmoki gomendatzen dugu.';
...
$string['pleaserefreshregistrationnewdata'] = 'Erregistroko informazioa aldatu da. Mesedez, konfirma ezazu ‘Eguneratu erregistroa’ botoian sakatuta.';
...
$string['profilingexcluded_help'] = '\'Hauek profilatu’ ezarpenean zehaztutako profilatzetik kanpo utziko diren URLen zerrenda (komaz bananduta, wwwroot erabat saihestuz, eskuragarri).';
...
$string['profilingincluded_help'] = 'Automatikoki profilatuko diren URLen zerrenda (komaz bananduta, wwwroot erabat saihestuz, eskuragarri). Adibideak: /index.php, /course/view.php. * komodina ere edozein kokapenetan erabili daiteke. Adibideak:  /mod/forum/*, /mod/*/view.php.';
...
$string['sitepolicyguest_help'] = 'Gunea erabili aurretik bisitari guztiek irakurri eta onartu beharreko guneko politika baduzu, idatzi hemen horren URL-a, bestela hutsik utzi. Ezarpen honek edozein URL publiko izan dezake. Oharra: forcelogin ezarpenak identifikatu gabekoen sarrera galerazi dezake.';
$string['sitepolicyhandler'] = 'Guneko politiken kudeatzailea';
$string['sitepolicyhandlercore'] = 'Berezkoa (sistema)';
...
$string['sitepolicy_help'] = 'Zure politikak erabiltzaile guztiek gunean parte hartu baino lehen zure baldintzak irakur ditzaten eskatzen badu, URLa hemen zehaztu; bestela, hutsik utzi. Ezarpen honek edozein URL publiko izan dezake.';
...
$string['tempdatafoldercleanup'] = 'Data hau baino zaharragoak diren behin-behineko datuetako fitxategiak:';
...
$string['updateavailablerecommendation'] = 'Azken segurtasun- eta errore-konponketak eskuratzearren zure gunea azken bertsiora eguneratzea biziki aholkatzen zaizu.';
