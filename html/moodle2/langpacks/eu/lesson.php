...
$string['addedendofcluster'] = 'Multzo-bukaera gehitu da';
$string['addendofbranch'] = 'Gehitu adar-taularen bukaera';
$string['addendofcluster'] = 'Gehitu multzo-bukaera';
$string['addessay'] = 'Sortu ikasgaiaren galdera-orri bat';
...
$string['casesensitive_help'] = 'Laukian klik egin  erantzunen analisian adierazpen erregularrak erabiltzeko.';
...
$string['configintro'] = 'Hemen zehaztutako balioak ikasgai jarduera berri bat sortzean berezko balioak zehazteko erabiltzen dira. Ezarpen aurreratu gisa markatutakoak \'Erakutsi gehiago...\' estekan klik egitean bakarrik erakutsiko dira.';
...
$string['editendofbranch'] = 'Adar-taularen bukaera bat editatzen';
$string['editendofcluster'] = 'Multzo-bukaera bat editatzen';
$string['editessay'] = 'ikasgaiaren galdera-orri bat editatzen';
...
$string['endofcluster'] = 'Multzoaren bukaera';
$string['endofclustertitle'] = 'Multzoaren bukaera';
...
$string['mediafile_help'] = 'Media-fitxategi bat igo daiteke ikasgaian erabiltzeko. \'Klik egin hemen ikusteko\' esteka erakutsiko da \'Estekatutako media\' izeneko blokean ikasgaiaren orri bakoitzean.';
...
$string['privacy:metadata:overrides'] = 'Ikasgai bakoitzeko baliogabetzeen erregistroa';
...
$string['privacy:metadata:overrides:timelimit'] = 'Ikasgaia osatzeko denbora-muga, segunduetan.';
...
$string['reverttodefaults'] = 'Itzuli ikasgaiaren berezko balioetara';
...
$string['score_help'] = 'Puntuazioa soilik puntuazio pertsonalizatua gaituta dagoenean erabiltzen da. Kasu horretan erantzun bakoitzari puntuazio numeriko bat eman dakioke (positiboa edo negatiboa).';
...
$string['timelimit_help'] = 'Gaituz gero, denbora-mugaren gaineko ohar bat erakusten da ikasgaiaren hasieran eta atzera kontu bat erakusten da. Denbora-muga bukatu ondoren emandako erantzunak ez dira kalifikatuko.';
