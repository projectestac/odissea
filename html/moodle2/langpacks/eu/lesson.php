...
/**
 * Strings for component 'lesson', language 'eu', branch 'MOODLE_28_STABLE'
 *
 * @package   lesson
...
$string['casesensitive'] = 'Erabili espresio erregularrak';
...
$string['deleteallattempts'] = 'Ikasgaiaren saiakera guztiak ezabatu';
...
$string['displayleftmenu_help'] = 'Gaituz gero, orrien zerrendan nabigatzeko aukera ematen duen menua erakutsiko da.';
...
$string['emailallgradedessays'] = 'Kalifikatutako entsegu GUZTIAK e-postaz bidali';
$string['emailgradedessays'] = 'Kalifikatutako entseguak e-mailez bidali';
$string['emailsuccess'] = 'E-postak ondo bidali dira';
...
$string['eventhighscoreadded'] = 'Gehieneko puntuazioa gehitu da';
$string['eventhighscoresviewed'] = 'Gehieneko puntuazioa ikusi da';
...
$string['firstwrong'] = 'Erantzun okerra eman duzu. Berriz saiatu nahi al duzu? (oraingoan erantzun zuzena emanez gero ez du azken emaitzan zenbatuko.)';
...
$string['handlingofretakes_help'] = '<p align="center"><b>Errepikapenen erabilera</b></p>

<p>Ikasleei ikasgaia errepikatzeko edo berriz hartzeko aukera ematen zaienean, irakasleak ikaslearen azken kalifikazioa zein den erabaki ahal izango du aukera honekin, kalifikazio-orrian, adibidez.<b> Media</b>, <b>lehenengoa</b> edo ikasgaian egindako saiakera eta errepikapen guztien artean lortutako kalifikazio <b>onena</b> izan daiteke.</p>

<p>Edozein unetan alda dezakezu aukera hau.</p>';
...
$string['messageprovider:graded_essay'] = 'Saiakera kalifikatu izanaren jakinarazpena';
$string['minimumnumberofquestions'] = 'Gutxienezko galdera-kopurua';
$string['minimumnumberofquestions_help'] = 'Ezarpen honek zehazten du jardueraren kalifikazioa kalkulatzeko erabiliko den gutxieneko galdera-kopurua. Ikasgaiak eduki-orri bat edo gehiago baditu, gutxieneko galdera-kopurua zero ezarri beharko da.

Esate baterako 20 ezartzen bada, ikasgaiaren hasiera orrian horrelako testuren bat gehitzea gomendatzen da: " Ikasgai honetan gutxienez 20 galderari erantzungo diozula espero da. Gehiago ere erantzun ditzakezu, nahi baduzu. Bestela, 20 baino gutxiagori erantzuten badiozu, 20 erantzuten saiatu bazina bezala kalkulatuko da zure kalifikazioa."';
...
$string['multianswer_help'] = 'Aukera bat baino gehiago zuzena bada, klik egin laukian.';
...
$string['noanswer'] = 'Galdera batek edo gehiagok ez du erantzunik. Mesedez atzera joan eta erantzun itzazu.';
...
$string['numberofcorrectmatches'] = 'Ondo osatutako bikoteen kopurua: {$a}';
$string['numberofpagestoshow'] = 'Erakutsi beharreko orriak';
$string['numberofpagestoshow_help'] = 'Erakutsi beharreko orri-kopurua (Txartelak) Balore hau Txartel erako ikasgaietan bakarrik (<i>Flash Card</i>)
erabiltzen da. Berez ematen duen balorea zerokoa da eta horrek
adierazten du ikasgaian Orri/Txartel guztiak erakutsiko direla.
...
$string['pleasecheckoneanswer'] = 'Aukera ezazu erantzun bat';
$string['pleasecheckoneormoreanswers'] = 'Aukera ezazu erantzun bat edo gehiago';
...
$string['postprocesserror'] = 'Errorea gertatu da prozesamendu-ostean!';
...
$string['randompageinbranch'] = 'Eduki-orri barruko ausazko galdera';
...
$string['retakesallowed_help'] = 'Gaituz gero,  ikasleek behin baino gehiagotan erantzun ahal dio ikasgaiari. ';
...
$string['studentresponse'] = '{$a}(r)en ebazpena';
...
$string['topscorestitle'] = '{$a} puntuazio altuenak';
$string['true'] = 'Egia';
...
$string['usepassword_help'] = 'Gaituta, ikasgaia eskuratzeko pasahitza eskatuko da.';
...
$string['viewreports2'] = 'Osatutako {$a} saiakera ikusi';
