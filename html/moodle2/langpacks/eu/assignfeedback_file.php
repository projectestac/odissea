...
/**
 * Strings for component 'assignfeedback_file', language 'eu', branch 'MOODLE_31_STABLE'
 *
...
$string['enabled_help'] = 'Ezarriz gero, zereginak kalifikatzeko unean, irakasleak igo ahal izango ditu fitxategiak feedbackekin. Fitxategi hauek izan daitezke, besteak beste, ikasleen dokumentuak oharrekin, dokumentu berriak iruzkinekin edo hitzezko feedbacka duten audioak.';
...
$string['importfeedbackfiles'] = 'Inportatu feedback-fitxategia(k)';
$string['maxbytes'] = 'Fitxategiaren gehienezko tamaina';
$string['maxfiles'] = 'Igotako fitxategien gehienezko kopurua';
$string['maximumsize'] = 'Fitxategiaren gehienezko tamaina';
