...
/**
 * Strings for component 'report_myfeedback', language 'en', branch 'MOODLE_26_STABLE'
 *
...
$string['gradetblheader_assessment'] = 'Assessment Name (part name)';
...
$string['gradetblheader_submission'] = 'Submission';
$string['gradetblheader_submissiondate'] = 'Submission Date';
$string['gradetblheader_type'] = 'Assessment Type';
