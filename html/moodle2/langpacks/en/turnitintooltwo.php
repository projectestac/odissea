...
/**
 * Strings for component 'turnitintooltwo', language 'en', branch 'MOODLE_26_STABLE'
 *
...
$string['deleteconfirm'] = 'Are you sure you want to delete this submission?nnThis action cannot be undone.';
...
$string['partdeletewarning'] = 'The assignment part you are trying to delete contains submissions. You will lose these submissions if you delete this assignment part.nnAre you sure you want to continue?';
...
$string['turnitindeleteconfirm'] = 'Deleting papers removes them from your submissions list and inbox but does not completelynremove them from the Turnitin database.nnAre you sure you want to delete this submission? This action cannot be undone.';
