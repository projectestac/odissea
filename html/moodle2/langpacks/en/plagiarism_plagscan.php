...
$string['plagscanexplain'] = 'PlagScan is a plagiarism checker: documents from your institution as well as text from the Internet is considered for the analysis.<br/><br/>Find out about how to register <a href="https://www.plagscan.com/">here</a> and ask us for a free trial <a href="mailto:pro@plagscan.com">pro@plagscan.com</a><br><br>General information can be found at <a href="http://www.plagscan.com">www.PlagScan.com</a>';
