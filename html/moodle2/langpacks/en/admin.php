...
/**
 * Strings for component 'admin', language 'en', branch 'MOODLE_28_STABLE'
 *
 * @package   admin
...
$string['pathtogs_help'] = 'On most Linux installs, this can be left as \'/usr/bin/gs\'. On Windows it will be something like \'c:gsbingswin32c.exe\' (make sure there are no spaces in the path - if necessary copy the files \'gswin32c.exe\' and \'gsdll32.dll\' to a new folder without a space in the path)';
