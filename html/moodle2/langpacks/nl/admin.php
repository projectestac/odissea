...
$string['allowframembedding_help'] = 'Indien ingeschakeld kan deze site geëmbedded worden in een frame in een extern systeem. Deze instelling is nodig wanneer je de aanmeldingsplugin \'Publiceer als LTI-tool\' gebruikt. Anders kun je om veiligheidsredenen deze functie beter uitgeschakeld laten.';
...
$string['configdoclang'] = 'Deze taal zal gebuikt worden voor links naar documentatiepagina\'s.';
...
$string['configrecaptchaprivatekey'] = 'Variabele, nodig om je Moodle server te laten communiceren met de recaptcha.net server. Je kunt deze voor jouw site bekomen via http://www.google.com/recaptcha';
$string['configrecaptchapublickey'] = 'Variabele, gebruikt om het reCAPTCHA-element te tonen in het inschrijvingsformulier voor e-mail zelfregistratie. Gegenereerd door http://www.google.com/recaptcha';
...
$string['configslasharguments'] = '\'Slash arguments\' (het gebruik van <em>PATH_INFO</em>) is vereist voor het correct tonen van SCORM-pakketten en bronnen die uit meerdere bestanden bestaan. Als jouw webserver dit niet ondersteunt en je dit niet kunt configureren, dan kan deze instelling uitgeschakeld worden, maar het resultaat zal zijn dat sommige zaken niet goed werken. <br />Opmerking: het gebruik van \'slash arguments\' zal vereist zijn in toekomstige Moodle-versies.';
...
$string['enableglobalsearch'] = 'Globaar zoeken inschakelen';
...
$string['navsortmycoursessort_help'] = 'Bepaalt of de cursussen getoond worden op Mijn cursussen volgens de sorteervolgorde. (de volgorde in Instellingen > Site beheer > Cursussen > Cusrussen toevoegen/bewerken) of alfabetisch volgens cursusinstelling.';
...
$string['pathtounoconv_help'] = 'Pad naar unoconv document converter. Dit is een programma dat kan converteren tussen documentformaten, ondersteund door LibreOffice. Dit is optioneel, maar indien je dit opgeeft zal Moodle automatisch tussen documentformaten converteren. Dit wordt gebruikt om een bredere waaier van bestandsformaten te kunnen gebruiken voor het annoteren op PDF in opdrachten.';
...
$string['registration_help'] = 'Het is aan te raden om te registreren bij Moodle.org om veiligheidsmeldingen via e-mail te ontvangen en voor toegang tot Moodle.net, ons deelplatform voor cursussen.';
...
$string['taskplagiarismcron'] = 'Achtergrondprocessen voor oudere functie cron in plagiaatplugins';
$string['taskportfoliocron'] = 'Achtergrondprocessen voor portfolioplugins';
$string['taskquestioncron'] = 'Achtergrondprocessen voor vragenmotor';
...
$string['updatenotificationfooter'] = 'Je Moodlesite {$a->siteurl} is geconfigureerd om automatisch te controleren op beschikbare updates. Je ontvangt dit bericht als site-beheerder. Je kunt het automatisch controleren van updates blokkeren in de sectie Site-beheer van het blok Instellingen. Je kunt de melding van dit bericht aanpassen via je persoonlijke berichten instelling in de sectie Profiel-instellingen.';
