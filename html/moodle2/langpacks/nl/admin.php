...
/**
 * Strings for component 'admin', language 'nl', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['moodleapp_help'] = '<p>Als je een account hebt op een Moodle site, dan kun je toegang krijgen tot al je cursussen op je mobiele toestellen met onze gratis mobiele app voor Moodle.</p>
<a href="https://moodle.com/mobile-app">Moodle app installeren</a>';
