...
$string['closedate_help'] = 'Je kunt hier een datum specificeren waarop de enquête sluit. Vink het vakje aan en selecteer de datum en tijd die je wilt.
...
$string['feedbackmessages'] = 'Feedback bericht voor categorie {$a}';
...
$string['feedbacksectionheading'] = 'Feedback-kop voor sectie {$a}';
...
$string['feedbacksectionquestions'] = '{$a} vragen in sectie';
$string['feedbacksections'] = '{$a} Feedback-secties';
...
$string['invalidsectionid'] = 'Ongeldige feedbacksectie gespecificeerd.';
...
$string['missingquestion'] = 'Beantwoord verplichte vraag a.u.b.';
...
$string['viewyourresponses'] = 'Jouw antwoorden - bekijk {$a}';
...
$string['yourresponses'] = 'Jouw antwoorden';
