...
/**
 * Strings for component 'assignfeedback_comments', language 'nl', branch 'MOODLE_36_STABLE'
 *
...
$string['enabled'] = 'Feedback tekstvak';
$string['enabled_help'] = 'Indien ingeschakeld kan de beoordelaar in een tekstvak feedback achterlaten bij elke ingestuurde opdracht.';
$string['pluginname'] = 'Feedback tekstvak';
$string['privacy:commentpath'] = 'Feedback tekstvak';
$string['privacy:metadata:assignmentid'] = 'Opdracht-ID';
$string['privacy:metadata:commentpurpose'] = 'De feedbacktekst';
$string['privacy:metadata:filepurpose'] = 'Feedbackbestanden van de leraar voor de leerling.';
$string['privacy:metadata:gradepurpose'] = 'Het cijferID dat met de feedbacktekst geassocieerd is.';
$string['privacy:metadata:tablesummary'] = 'Dit bewaart opmerkingen die door de beoordelaars gemaakt zijn als feedback op hun inzending.';
