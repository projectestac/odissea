...
$string['backup:backuptargethub'] = 'Back-up voor hub';
...
$string['comment:view'] = 'Bekijk opmerkingen';
$string['community:add'] = 'Gebruik de community-blok om hubs en cursussen te zoeken';
...
$string['competency:plancomment'] = 'Reageer op een leerplan';
$string['competency:plancommentown'] = 'Reageer op je eigen leerplan';
$string['competency:planmanage'] = 'Beheer leerplannen';
$string['competency:planmanagedraft'] = 'Beheer ontwerp leerplannen';
$string['competency:planmanageown'] = 'Beheer eigen leerplannen';
$string['competency:planmanageowndraft'] = 'Beheer van eigen leerplannen in ontwerp';
$string['competency:planrequestreview'] = 'Vraag een mening over een leerplan';
$string['competency:planrequestreviewown'] = 'Vraag een mening over je eigen leerplan';
$string['competency:planreview'] = 'Geef je mening over een leerplan';
$string['competency:planview'] = 'Bekijk alle leerplannen';
$string['competency:planviewdraft'] = 'Bekijk leerplannen in ontwerp';
$string['competency:planviewown'] = 'Bekijk eigen leerplannen';
$string['competency:planviewowndraft'] = 'Bekijk eigen leerplannen in ontwerp';
$string['competency:templatemanage'] = 'Beheer leerplansjablonen';
$string['competency:templateview'] = 'Bekijk leerplansjablonen';
...
$string['notabletoassignroleshere'] = 'De beheerder heeft het toewijzen van rollen in deze context niet ingeschakeld.';
...
$string['restore:restoretargethub'] = 'Terugzetten van bestanden die een hub als doel hebben';
...
$string['roleshortname_help'] = 'De korte rolnaam is een identificatie van de rol op systeemniveau waarin enkel ASCII alphanumerieke tekens toegestaan zijn. Verander de korte rolnaam van standaardrollen niet.';
