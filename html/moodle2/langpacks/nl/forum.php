...
$string['postbymailsuccess'] = 'Je bericht met als onderwerp  "{$a->subject}" is toegevoegd. Je kunt het bekijken via {$a->discussionurl}.';
...
$string['privacy:digesttypenone'] = 'We hebben geen gegevens over het gekozen digest-type voor dit forum.';
$string['privacy:digesttypepreference'] = 'U hebt ervoor gekozen om het volgende forum-digest type te ontvangen: "{$a->type}".';
...
$string['privacy:metadata:forum_digests'] = 'Informatie over de digest-voorkeuren voor elk forum.';
$string['privacy:metadata:forum_digests:forum'] = 'Het forum waarop geabonneerd is.';
$string['privacy:metadata:forum_digests:maildigest'] = 'De digest-voorkeur.';
$string['privacy:metadata:forum_digests:userid'] = 'De ID van de gebruiker met de digest-voorkeur.';
...
$string['privacy:metadata:forum_posts'] = 'Informatie over de digest-voorkeuren voor elk forum.';
...
$string['privacy:metadata:forum_queue'] = 'Tijdelijk logboek van berichten die in digest-vorm worden gemaild';
...
$string['privacy:metadata:preference:maildigest'] = 'De voorkeur voor e-mail voor de hele site';
