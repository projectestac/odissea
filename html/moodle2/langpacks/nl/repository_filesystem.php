...
/**
 * Strings for component 'repository_filesystem', language 'nl', branch 'MOODLE_28_STABLE'
 *
...
$string['nosubdir'] = 'Je moet minstens één map maken in de <b>{$a}</b> map zodat je die hier kan selecteren.';
