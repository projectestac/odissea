...
/**
 * Strings for component 'cachestore_mongodb', language 'nl', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata:mongodb'] = 'De MongoDB cache-plugin bewaart gegevens kort als deel van zijn cachingsfunctie. Deze gegevens worden bewaard op een MongoDB-server en daar regelmatig gewist.';
$string['privacy:metadata:mongodb:data'] = 'De gegevens die in cache bewaard worden';
