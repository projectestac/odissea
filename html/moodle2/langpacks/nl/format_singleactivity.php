...
/**
 * Strings for component 'format_singleactivity', language 'nl', branch 'MOODLE_28_STABLE'
 *
...
$string['activitytype_help'] = 'Kies het activiteitstype of bron om te gebruiken in deze cursus';
