...
$string['attemptreopenmethod_help'] = 'Bepaalt hoe de inzendingen van leerlingen heropend kunnen worden. De mogelijke opties zijn: <ul><li>Nooit - de inzending van de leerling kan door een leraar niet heropend worden.</li><li>Manueel - de inzending kan heropend worden door een leraar</li><li>Automatisch tot geslaagd - De inzending van de leerling wordt automatisch terug heropend tot de leerling een cijfer heeft dat hoog genoeg is om te slagen (instelling in het puntenboek) voor deze opdracht.</li></ul>';
...
$string['useridlistnotcached'] = 'De wijzigingen zijn NIET bewaard omdat het niet mogelijk was om te bepalen voor welke inzending ze waren.';
