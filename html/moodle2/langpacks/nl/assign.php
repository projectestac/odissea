...
$string['downloadasfolders_help'] = 'Als de inzending van een opdracht meer is dan een enkel bestand, dan kunnen de inzendingen gedownload worden in mappen. Elke inzending wordt in een aparte map gezet, waarbij de mapstructuur behouden blijft voor alle onderliggende mappen en bestanden niet hernoemd worden.';
