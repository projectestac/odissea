...
/**
 * Strings for component 'wiki', language 'nl', branch 'MOODLE_36_STABLE'
 *
 * @package   wiki
...
$string['firstpagetitle_help'] = 'Titel van de eerste pagina van de wiki. Zodra de wiki is aangemaakt, kan de titel niet meer worden gewijzigd.';
...
$string['view'] = 'Bekijk';
$string['viewallhistory'] = 'Bekijk hele geschiedenis';
