...
$string['addedandupdatelibraries'] = '{$a->%new} nieuwe H5P bibliotheken toegevoegd en {$a->%old} bijgewerkt.';
...
$string['hvp:addinstance'] = 'Een nieuwe H5P activiteit toevoegen';
$string['hvp:getcachedassets'] = 'Gecachete H5P-inhoud ophalen';
$string['hvp:getcontent'] = 'Inhoud van H5P bestand in cursus ophalen/bekijken';
$string['hvp:getexport'] = 'Exportbestand van H5P in cursus ophalen';
$string['hvp:installrecommendedh5plibraries'] = 'Aanbevolen H5P-bibliotheken installeren';
$string['hvp:restrictlibraries'] = 'Een H5P bibliotheek beperken';
$string['hvp:savecontentuserdata'] = 'H5P inhoud gebruikersgegevens opslaan';
$string['hvp:saveresults'] = 'Resultaat opslaan voor H5P inhoud';
$string['hvp:updatelibraries'] = 'De versie van een H5P bibliotheek updaten';
$string['hvp:userestrictedlibraries'] = 'Gebruik beperkte H5P bibliotheken';
$string['hvp:viewallresults'] = 'Bekijk resultaat voor alle gebruikers in cursus';
$string['hvp:viewresults'] = 'Resultaat bekijken voor eigen vragen in cursus';
...
$string['invalidlibrary'] = 'De H5P bibliotheek {$a->library} gebruikt in de content is ongeldig';
...
$string['welcomecommunity'] = 'We hopen dat je H5P met plezier gebruikt en betrokken raakt bij onze almaar groeiende community via onze <a {$a->forums}>forums</a> en chatroom <a {$a->gitter}H5P op Gitter</a>';
