...
/**
 * Strings for component 'block_course_overview', language 'nl', branch 'MOODLE_32_STABLE'
 *
...
$string['showwelcomeareadesc'] = 'Toon de welkomzone boven de cursuslijst?';
$string['view_edit_profile'] = '(Bekijke en bewerk je profiel)';
