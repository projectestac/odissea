...
$string['presetfiles_desc'] = 'Instellingsbestanden kunnen worden gebruikt om het uiterlijk van het thema drastisch te veranderen.  Zie <a href=https://docs.moodle.org/dev/Boost_Presets> Boost presets </a> voor informatie over het maken en delen van uw eigen vooraf ingestelde-bestanden, en zie de <a href = http: //moodle.net / boost> presets repository </a> voor instellingen die anderen hebben gedeeld.';
$string['privacy:drawernavclosed'] = 'De huidige voorkeur voor de navigatiebalk is gesloten.';
$string['privacy:drawernavopen'] = 'De huidige voorkeur voor de navigatiebalk is open.';
$string['privacy:metadata'] = 'Het Boost-thema slaat geen persoonlijke gegevens over een gebruiker op.';
$string['privacy:metadata:preference:draweropennav'] = 'De gebruikersvoorkeur voor het tonen of verbergen van de navigatiebalk.';
