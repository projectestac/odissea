...
$string['autoactiveenabled'] = 'Ingegeschakeld';
...
$string['choosefilefromactivitybackup_help'] = 'Activiteitenback-ups met standaard instellingen zullen hier bewaard worden.';
...
$string['choosefilefromcoursebackup_help'] = 'Als je back-ups maakt van cursussen met de standaardinstellingen, dan zullen de back-upbestanden hier bewaard worden.';
$string['choosefilefromuserbackup'] = 'Private back-upzone';
$string['choosefilefromuserbackup_help'] = 'Wanneer je een back-up maakt van cursussen met de "Maak gebruikersinfo anoniem"optie ingeschakeld, dan zullen back-upbestanden  hier bewaard worden';
...
MERK OP: Dit uitschakelen zal het backuppen van activiteiten die de vragenbank gebruiken, zoals testen, uitschakelen.';
...
$string['filereferencesincluded'] = 'Er zitten bestandsreferenties naar externe inhoud in het back-upbestand. Die zullen niet werken als de backup op een andere site teruggezet wordt.';
...
$string['missingfilesinpool'] = 'Sommige bestanden konden niet bewaard worden tijdens deze back-up.  Het zal niet mogelijk zijn om ze terug te zetten.';
...
$string['rootsettingquestionbank'] = 'Vragenbank ook backuppen';
