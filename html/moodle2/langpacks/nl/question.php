...
$string['categorymove'] = 'De categorie \'{$a->name}\' bevat {$a->count} vragen (sommige kunnen verborgen vragen zijn of willekeurige vragen die nog in gebruik zijn in een test). Kies alsjeblieft een andere categorie om deze vragen naartoe te verplaatsen.';
