...
$string['enablecompetencies_desc'] = 'Competenties maken het mogelijk om leerlingen te beoordelen volgens leerplannen';
...
$string['errorplanstatus'] = 'Leerplan \'{$a}\' status onbekend';
...
$string['eventplanapproved'] = 'Leerplan goedgekeurd.';
$string['eventplancompleted'] = 'Leerplan voltooid.';
$string['eventplancreated'] = 'Leerplan gemaakt.';
$string['eventplandeleted'] = 'Leerplan verwijderd.';
$string['eventplanreopened'] = 'Leerplan heropend.';
$string['eventplanreviewrequestcancelled'] = 'Verzoek om leerplan te bekijken geannuleerd.';
$string['eventplanreviewrequested'] = 'Verzoek om leerplan te bekijken.';
$string['eventplanreviewstarted'] = 'Leerplan bekijken gestart.';
$string['eventplanreviewstopped'] = 'Leerplan bekijken beëindigd.';
$string['eventplanunapproved'] = 'Leerplan niet goedgekeurd';
$string['eventplanunlinked'] = 'Leerplan link ongedaan gemaakt.';
$string['eventplanupdated'] = 'Leerplan aangepast.';
$string['eventplanviewed'] = 'Leerplan bekeken.';
$string['eventtemplatecreated'] = 'Leerplan sjabloon gemaakt.';
$string['eventtemplatedeleted'] = 'Leerplan sjabloon verwijderd.';
$string['eventtemplateupdated'] = 'Leerplan sjabloon aangepast.';
$string['eventtemplateviewed'] = 'Leerplan sjabloon bekeken.';
...
$string['eventusercompetencyratedinplan'] = 'Gebruikerscompetentie beoordeeld in leerplan.';
...
$string['eventusercompetencyviewedinplan'] = 'Gebruikerscompetentie bekeken in een leerplan.';
...
$string['privacy:metadata:competency_plan'] = 'Een gegeven van leerplannen';
...
$string['privacy:metadata:competency_template'] = 'Een gegeven over de leerplansjablonen';
$string['privacy:metadata:competency_templatecohort'] = 'Een gegeven van de site-groepen geassocieerd met een leerplansjabloon';
$string['privacy:metadata:competency_templatecomp'] = 'Een gegeven van de competenties in het leerplansjabloon';
...
$string['privacy:metadata:competency_usercompplan'] = 'En gegeven over de status van de competenties in een leerplan';
...
$string['privacy:metadata:core_comments'] = 'Opmerkingen gemaakt over leerplannen en competenties';
...
$string['privacy:metadata:plan:description'] = 'De beschrijving van het leerplan';
$string['privacy:metadata:plan:duedate'] = 'De einddatum van het leerplan';
$string['privacy:metadata:plan:name'] = 'De naam van het leerplan';
$string['privacy:metadata:plan:reviewerid'] = 'De ID van wie het leerplan nagekeken heeft';
$string['privacy:metadata:plan:status'] = 'De status van het leerplan';
$string['privacy:metadata:plan:userid'] = 'De ID van de gebruiker van wie het leerplan is';
...
$string['privacy:path:plans'] = 'Leerplannen';
$string['privacy:path:relatedtome'] = 'Aan mij gerelateerd';
$string['privacy:path:userevidence'] = 'Bewijs van vroeger leren';
$string['pushcourseratingstouserplans'] = 'Stuur cursusbeoordelingen naar individuele leerplannen';
$string['pushcourseratingstouserplans_desc'] = 'Standaardwaarde voor cursusinstellingen om individuele leerplannen  aan te passen wanneer curuscompetenties beoordeeld worden.';
$string['syncplanscohorts'] = 'Synchroniseer plannen van leerplannensjabloon voor site-groepen';
...
$string['usercommentedonaplan'] = '{$a->fullname} heeft een opmerking gemaakt bij leerplan "{$a->plan}":

{$a->comment}

Zie: {$a->url}';
$string['usercommentedonaplanhtml'] = '<p>{$a->fullname} heeft een opmerking gemaakt bij leerplan "{$a->plan}":</p>
<div>{$a->comment}</div>
<p>Zie: <a href="{$a->url}">{$a->urlname}</a>.</p>';
$string['usercommentedonaplansmall'] = '{$a->fullname} heeft een opmerking gemaakt bij leerplan "{$a->plan}".';
$string['usercommentedonaplansubject'] = '{$a} heeft een opmerking gemaakt bij een leerplan.';
