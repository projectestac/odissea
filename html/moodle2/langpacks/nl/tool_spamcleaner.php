...
/**
 * Strings for component 'tool_spamcleaner', language 'nl', branch 'MOODLE_31_STABLE'
 *
...
$string['spamdesc'] = 'Beschrijving';
$string['spameg'] = 'vb: casino,porn,xxx';
$string['spamfromblog'] = 'Van blogbericht:';
$string['spamfromcomments'] = 'Van opmerkingen:';
$string['spamfromforumpost'] = 'Van forumberichten:';
$string['spamfrommessages'] = 'Van berichten:';
$string['spaminvalidresult'] = 'Onbekend maar ongeldig resultaat';
$string['spamkeyword'] = 'Sleutelwoord';
