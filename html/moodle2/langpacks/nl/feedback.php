...
$string['anonymous_entries'] = 'Anoniem ingevuld  ({$a})';
...
$string['non_respondents_students'] = 'Leerlingen die niets insturen  ({$a})';
...
$string['oldvalueswillbedeleted'] = 'De huidige vragen en alle antwoorden zullen verwijderd worden.';
...
$string['relateditemsdeleted'] = 'Alle antwoorden voor deze vraag zullen ook verwijderd worden.';
...
$string['switch_item_to_not_required'] = 'Verander in niet vereist';
$string['switch_item_to_required'] = 'Verander in vereist';
