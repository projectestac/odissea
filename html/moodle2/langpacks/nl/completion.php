...
$string['enablecompletion_help'] = 'Indien ingeschakeld kunnen er instellingen gemaakt worden voor voltooien van een activiteit (bij de instellingen van die activiteit) en/of voor het voltooien van een cursus';
...
$string['eventcoursemodulecompletionupdated'] = 'Cursus module voltooien aangepast';
...
$string['progresstotal'] = 'Vooruitgang: {$a->complete} / {$a->total}';
