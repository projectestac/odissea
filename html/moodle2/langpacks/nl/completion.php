...
$string['err_nousers'] = 'Er zijn geen gebruikers in deze cursus of groep van wie informatie over voltooide activiteiten getoond wordt. (standaard wordt informatie over voltooide activiteiten enkel getoond aan leerlingen, als er geen leerlingen zijn, zie je deze foutmelding. Beheerders kunnen deze optie wijzigen via de beheerdersinterface.)';
...
$string['privacy:metadata:completionstate'] = 'Als de cursusmodule voltooid is.';
...
$string['privacy:metadata:coursemoduleid'] = 'De identificatie van de cursusmodule.';
$string['privacy:metadata:coursemodulesummary'] = 'Bewaart de voltooiingsgegevens voor een gebruiker van de cursusmodule.';
...
$string['privacy:metadata:userid'] = 'Cursus en activiteitsvoltooiing worden voor deze gebruiker bewaard.';
