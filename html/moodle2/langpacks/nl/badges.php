...
/**
 * Strings for component 'badges', language 'nl', branch 'MOODLE_36_STABLE'
 *
 * @package   badges
...
$string['addalignment'] = 'Competentie toevoegen';
...
$string['balignment'] = 'Competenties ({$a})';
...
$string['noalignment'] = 'Deze badge heeft geen opgegeven competenties.';
...
$string['notealignment'] = 'Externe competencies, vaardigheden of standaarden die onder deze badge vallen kunnen hier opgegeven worden. Elke competentie wordt op de badge-pagina getoond.';
...
$string['targetcode_help'] = 'Een unieke tekenreeks-ID als referentie voor een competentie binnen zijn referentiekader.';
$string['targetdescription'] = 'Beschrijving';
$string['targetdescription_help'] = 'Korte beschrijving van het richttarget.';
$string['targetframework'] = 'Kader';
$string['targetframework_help'] = 'De naam van het competentiekader.';
$string['targetname'] = 'Naam competentie';
$string['targetname_help'] = 'De competentie, vaardigheid of norm die de badge dekt.';
$string['targeturl'] = 'URL';
$string['targeturl_help'] = 'Een link naar de pagina die de competentie, vaardigheid of standaard beschrijft. De URL moet een prefix http:// of https:// hebben.';
$string['type'] = 'Type';
