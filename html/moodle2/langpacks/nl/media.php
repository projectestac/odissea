...
/**
 * Strings for component 'media', language 'nl', branch 'MOODLE_36_STABLE'
 *
 * @package   media
...
$string['defaultheightdesc'] = 'Mediaspelerhoogte als er geen hoogte opgegeven is en wanneer de hoogte door de mediaspeler niet uit het mediabestand gehaald kan worden.';
$string['defaultwidth'] = 'Standaard breedte';
$string['defaultwidthdesc'] = 'De breedte van de media-speler als er geen breedte is opgegeven en de breedte niet uit het bestand kan gehaald worden door de speler.';
$string['extensions'] = 'Extenties: {$a}';
