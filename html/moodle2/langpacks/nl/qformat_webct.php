...
/**
 * Strings for component 'qformat_webct', language 'nl', branch 'MOODLE_31_STABLE'
 *
...
$string['missinganswer'] = 'Te weinig :ANSWER, :Lx, Rx, bepalingen voor regel {$a}. Je moet minstens 2 mogelijke antwoorden geven';
