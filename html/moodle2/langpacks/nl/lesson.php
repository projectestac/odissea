...
$string['privacy:metadata:attempts:retry'] = 'Het pogingsnummer';
...
$string['privacy:metadata:overrides:deadline'] = 'Tijdstip waarop leerlingen hun poging moeten beëindigd hebben';
