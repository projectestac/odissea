...
$string['groupoverrides'] = 'Groep overschreven';
...
$string['mediafile_help'] = 'Er kan een mediabestand geüpload worden om te gebruiken in de les. En \'Klik hier om te bekijken\'-link zal dan getoond worden in een blok met als naam \'Gelinkte media\' op elke pagina van de les.';
