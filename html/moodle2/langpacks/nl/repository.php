...
$string['configsyncfiletimeout'] = 'Timeout in seconden voor het syncroniseren van de bestandsgrootte van het externe bestand.';
$string['configsyncimagetimeout'] = 'Timeout in seconden voor het downloaden van een afbeeldingsbestand uit een externe opslagruimte tijdens het syncroniseren.';
