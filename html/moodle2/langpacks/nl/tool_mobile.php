...
/**
 * Strings for component 'tool_mobile', language 'nl', branch 'MOODLE_36_STABLE'
 *
 * @package   tool_mobile
...
$string['forcedurlscheme'] = 'Als je wilt toestaan dat alleen je aan jouw organisatie aangepaste  app geopend wordt via een browser venster, specificeer hier dan het URL schema daarvan; anders kan dit veld leeg blijven.';
...
$string['mobilenotificationsdisabledwarning'] = 'Mobiele meldingen zijn niet ingeschakeld. Ze zouden moeten ingeschakeld zijn in "Beheer berichtenoutput".';
...
$string['setuplink_desc'] = 'URL van de pagina die linkt naar de mobiele app van de App Store en Google Play.';
