...
/**
 * Strings for component 'workshopallocation_random', language 'nl', branch 'MOODLE_36_STABLE'
 *
...
$string['resultnumperauthor'] = 'Aan het proberen {$a} beoordelingen per auteur toe te wijzen';
$string['resultnumperreviewer'] = 'Aan het proberen {$a} beoordelingen per beoordeler toe te wijzen';
