...
/**
 * Strings for component 'portfolio', language 'ca', branch 'MOODLE_34_STABLE'
 *
 * @package   portfolio
...
$string['nomultipleexports'] = 'El destí del dossier ({$a->plugin}) no admet exportacions múltiples simultànies. <a href="{$a->link}">Acabeu-ne primer l\'actual</a> i torneu-ho a intentar.';
