...
/**
 * Strings for component 'auth_mnet', language 'ca', branch 'MOODLE_28_STABLE'
 *
 * @package   auth_mnet
...
$string['sso_sp_description'] = 'Publiqueu aquest servei a fi de permetre que usuaris autenticats del lloc {$a} accedeixin al vostre lloc sense necessitat d\'iniciar-hi una sessió. <ul><li><em>Dependència</em>: també us haureu de <strong>subscriure</strong> al servei SSO (Proveïdor d\'Identitat) del lloc {$a}.</li></ul><br />Subscriviu-vos a aquest servei a fi de permetre que els vostres usuaris passin al lloc Moodle {$a} sense necessitat d\'iniciar-hi una sessió. <ul><li><em> Dependència </em>: també haureu de <strong>publicar</strong> el servei SSO (Proveïdor d\'Identitat) per a {$a}.</li></ul><br />';
