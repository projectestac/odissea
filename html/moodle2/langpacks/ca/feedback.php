...
$string['bold'] = 'Negreta';
$string['calendarend'] = 'La retroacció {$a} es tanca';
$string['calendarstart'] = 'La retroacció {$a} s\'obre';
...
$string['mapcourses_help'] = 'Una vegada heu triat els cursos rellevants de la vostra cerca, podeu associar-los a aquesta retroacció utilitzant els mapes de curs. Podeu seleccionar múltiples cursos prement la tecla Apple o Ctrl mentre feu clic sobre el nom dels cursos. Un curs pot deixar d\'estar associat a una retroacció en qualsevol moment.';
$string['mappedcourses'] = 'Cursos mapejats';
$string['mappingchanged'] = 'El mapatge de curs ha canviat';
