...
/**
 * Strings for component 'auth_shibboleth', language 'ca', branch 'MOODLE_28_STABLE'
 *
...
$string['auth_shib_auth_method_description'] = 'Proporciona una paraula per a la identificació Shibboleth que sigui familiar als vostres usuaris. Aquesta pot ser el nom de la vostra federació Shibboleth, com ara <tt>SWITHCHaai Login</tt> o <tt>InCommon Login</tt> o semblant.';
...
$string['auth_shib_contact_administrator'] = 'En cas que no estigueu associat amb les organitzacions donades i us calgui accés al curs en aquest servidor, si us plau contacteu amb l\'<a href="mailto:{$a}">Administrador de Moodle</a>.';
...
$string['auth_shib_idp_list_description'] = 'Proporciona una llista de proveïdors d\'identitat de noms d\'usuari per deixar a l\'usuari escollir a la pàgina d\'inici. <br>En cada línia cal que hi hagi una tupla separada per comes de l\'ID del proveïdor (mireu el fitxer de metadades de Shibboleth) i del nom del proveïdor així com s\'haurà de mostrar a la llista desplegable de sota. </br>
