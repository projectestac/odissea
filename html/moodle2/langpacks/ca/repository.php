...
$string['confirmdelete'] = 'Esteu segur que voleu suprimir aquest repositori: {$a}? Si trieu «Continua i descarrega», les referències del fitxer a continguts externs es descarregaran a Moodle, però podria ser molt llarg de processar.';
...
$string['confirmremove'] = 'Esteu segur que voleu suprimir el connector de repositori, les seves opcions i <strong>totes les seves instàncies</strong>: {$a}? Si trieu «Continua i descarrega», les referències del fitxer a continguts externs es descarregaran a Moodle, però podria ser molt llarg de processar.';
