...
/**
 * Strings for component 'qtype_missingtype', language 'ca', branch 'MOODLE_28_STABLE'
 *
...
$string['cannotchangeamissingqtype'] = 'No podeu fer canvis en una pregunta de tipus desconegut.';
$string['deletedquestion'] = 'Pregunta desconeguda';
