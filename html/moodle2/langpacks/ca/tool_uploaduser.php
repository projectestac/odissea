...
/**
 * Strings for component 'tool_uploaduser', language 'ca', branch 'MOODLE_36_STABLE'
 *
...
$string['assignedsysrole'] = 'S\'ha assignat el rol del sistema {$a}';
...
$string['invalidupdatetype'] = 'No es pot triar aquesta opció amb el tipus de càrrega seleccionat.';
...
$string['unassignedsysrole'] = 'S\'ha desassignat el rol del sistema {$a}';
