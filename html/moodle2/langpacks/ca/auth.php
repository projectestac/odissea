...
$string['forcechangepasswordfirst_help'] = 'Obliga els usuaris a canviar la contrasenya la primera vegada que iniciïn la sessió al Moodle.';
$string['forcechangepassword_help'] = 'Obliga els usuaris a canviar la contrasenya la propera vegada que iniciïn la sessió al Moodle.';
...
$string['ntlmsso_failed'] = 'L\'entrada automàtica ha fallat. Proveu d\'iniciar la sessió a través de la pàgina normal...';
...
$string['suspended_help'] = 'Els comptes invalidats no poden connectar-se a Moodle ni utilitzar serveis web, i se\'n descarten els missatges de sortida.';
