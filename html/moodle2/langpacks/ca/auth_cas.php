...
/**
 * Strings for component 'auth_cas', language 'ca', branch 'MOODLE_32_STABLE'
 *
 * @package   auth_cas
...
$string['auth_casdescription'] = 'Aquest mètode utilitza un servidor CAS (Central Authentication Service, Servei Central d\'Autenticació) per autenticar els usuaris en un entorn Single Sign On (SSO, inscripció única). També podeu fer servir una autenticació LDAP. Si el nom d\'usuari i la contrasenya són vàlids d\'acord amb el CAS, Moodle crea un usuari nou en la seva base de dades i, si escau, agafa els atributs del LDAP. En els inicis de sessió següents només es verifiquen el nom d\'usuari i la contrasenya.';
