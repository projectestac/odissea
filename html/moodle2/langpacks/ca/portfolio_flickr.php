...
/**
 * Strings for component 'portfolio_flickr', language 'ca', branch 'MOODLE_28_STABLE'
 *
...
$string['noauthtoken'] = 'No s\'ha pogut trobar un testimoni d\'autenticació per utilitzar-lo en aquesta sessió';
...
$string['setupinfodetails'] = 'Per obtenir una clau API i una contrasenya, inicieu sessió a Flickr i sol·liciteu una nova clau <a href="{$a->applyurl}">. Una vegada que hàgiu obtingut la clau i la contrasenya, aneu a l\'enllaç «Edit auth flow for this app» a la mateixa pàgina. A «App Type» seleccioneu «Web Application». Empleneu el camp «Callback URL» amb el valor:<br /><code>{$a->callbackurl}</code><br />Si voleu, també podeu proporcionar la descripció i el logotip del vostre lloc Moodle. Aquests valors es poden definir més endavant a <a href="{$a->keysurl}"> la pàgina</ a> que enumera les vostres aplicacions de Flickr.';
