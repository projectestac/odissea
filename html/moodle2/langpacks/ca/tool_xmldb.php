...
/**
 * Strings for component 'tool_xmldb', language 'ca', branch 'MOODLE_34_STABLE'
 *
 * @package   tool_xmldb
...
$string['extensionrequired'] = 'L\'extensió de PHP «{$a}» és necessària per fer aquesta acció. Instal·leu-la si voleu utilitzar aquesta característica.';
$string['field'] = 'Camp';
