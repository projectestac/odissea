...
/**
 * Strings for component 'hub', language 'ca', branch 'MOODLE_36_STABLE'
 *
 * @package   hub
...
$string['contactphone'] = 'Telèfon';
$string['contactphone_help'] = 'Els números de telèfon sols es mostren a l\'administrador del concentrador, i no es fan públics.';
...
$string['publishername_help'] = 'El que publica és la persona o l\'organització que és el publicador oficial del curs. A menys que ho estigueu publicant en nom d\'altri, en general sereu vós.';
...
$string['registrationupdated'] = 'El registre s\'ha actualitzat.';
...
$string['settingsupdated'] = 'Els paràmetres s\'han actualitzat.';
...
$string['statuspublished'] = 'És a la llista';
$string['statusunpublished'] = 'No és a la llista';
$string['subject'] = 'Tema';
