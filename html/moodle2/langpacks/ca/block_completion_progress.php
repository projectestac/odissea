...
/**
 * Strings for component 'block_completion_progress', language 'ca', branch 'MOODLE_32_STABLE'
 *
...
$string['how_ordering_works_help'] = '<p>Hi ha dues maneres d\'ordenar les activitats en el bloc Progrés de la compleció.</p><ul><li><em>Temporal, usant la data "S\'espera que es completi el"</em> (per defecte)<br />Les dates esperades de compleció de les activitats i els recursos s\'usen per a ordenar la barra. Aquelles activitats i recursos que no tinguin definida una data de compleció, s\'ordenen segons la posició en el curs. Quan s\'usa aquesta opció, es mostra l\'indicador ARA.</li><li><em>Ordre dins el curs</em><br />Les activitats i recursos es presenten en el mateix ordre que a la pàgina del curs. Quan s\'usa aquesta opció, s\'ignoren les dates de compleció i no es mostra l\'indicador ARA.</li></ul>';
...
$string['mouse_over_prompt'] = 'Passeu la busca per sobre o toqueu la barra per a més informació.';
$string['no_activities_config_message'] = 'No hi ha cap activitat o recurs amb criteris de compleció definits, o no s\'ha seleccionat cap activitat o recurs. Cal que definiu el seguiment de la compleció a les activitats i recursos abans de configurar aquest bloc.';
...
$string['pluginname'] = 'Progres de la compleció';
