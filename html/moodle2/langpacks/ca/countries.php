...
/**
 * Strings for component 'countries', language 'ca', branch 'MOODLE_36_STABLE'
 *
 * @package   countries
...
$string['GR'] = 'Grècia';
$string['GS'] = 'Illes Geòrgia del Sud i Sandwich del Sud';
$string['GT'] = 'Guatemala';
$string['GU'] = 'Guam';
...
$string['SX'] = 'Sint Maarten (Part dels Països Baixos)';
$string['SY'] = 'Síria';
