...
/**
 * Strings for component 'local_moodlemobileapp', language 'ca', branch 'MOODLE_26_STABLE'
 *
...
$string['add'] = 'Afegeix';
$string['addcontact'] = 'Afegeix com a contacte';
$string['addedtoqueue'] = 'Esteu desconnectat. L\'operació s\'ha afegit a la cua de tasques.';
$string['addfakenotifications'] = 'Afegeix notificacions de prova';
$string['addnote'] = 'Afegeix una nota';
...
$string['cannotaddnote'] = 'No teniu connexió a la xarxa. La vostra nota s\'ha desat a la cua de tasques. Quan estigueu en línia podreu reenviar-la.';
$string['cannotconnect'] = 'No s\'ha pogut connectar. Comproveu que l\'URL és correcte i que el lloc Moodle utilitza la versió 2.4 o posterior.';
$string['cannotconnectssl'] = 'No s\'ha pogut connectar. Comproveu que l\'URL és correcte, que el lloc Moodle utilitza la versió 2.4 o posterior i que el certificat SSL és vàlid.';
$string['cannotsendmessage'] = 'No teniu connexió a la xarxa. El missatge s\'ha desat a la cua de tasques. Quan estigueu en línia podreu reenviar-lo.';
$string['city'] = 'Ciutat';
$string['close'] = 'Tanca';
$string['completed'] = 'Completat';
$string['confirmcontinuedownload'] = 'Esteu segur que voleu continuar amb la baixada del fitxer?';
...
$string['deletesite'] = 'Voleu suprimir aquest lloc?';
$string['deletesiteb'] = 'Suprimeix lloc';
$string['deletesitefiles'] = 'Esteu segur que voleu esborrar els fitxers baixats d\'aquest lloc?';
...
$string['empty'] = 'buit';
$string['enableautosync'] = 'Habilita sincronització automàtica';
$string['enableautosynccss'] = 'Habilita sincronització de fulls d\'estil CSS addicionals';
$string['enableautosynclang'] = 'Habilita sincronització de fitxers d\'idioma';
...
$string['errorcapturingaudio'] = 'S\'ha produït un error en capturar l\'àudio';
$string['errorcapturingvideo'] = 'S\'ha produït un error en capturar el vídeo';
...
$string['erroruploading'] = 'S\'ha produït un error en penjar el fitxer';
$string['estimatedfreespace'] = 'Espai lliure estimat';
$string['events'] = 'Esdeveniments del calendari';
$string['feedback'] = 'Retroacció';
$string['filedownloaded'] = 'S\'ha baixat el fitxer';
$string['filename'] = 'Nom de fitxer';
$string['filesize'] = 'Mida';
$string['fileuploaded'] = 'S\'ha penjat el fitxer';
...
$string['invalidaccount'] = 'Verifiqueu el vostre nom d\'usuari/ària i contrasenya o demaneu a l\'administració de Moodle que comprovi la configuració del lloc.';
...
$string['noticelargefile'] = 'Teniu en compte que la mida del fitxer que voleu baixar és gran i pot tardar una mica.';
...
$string['passwordnotnull'] = 'Introduïu la vostra contrasenya';
$string['passwordrequired'] = 'Contrasenya obligatòria';
...
$string['reportbuginfo'] = 'Feu clic en el botó \'correu\' per a enviar per correu un informe d\'error<br /><br /><b>No oblideu escriure una descripció detallada del problema en el cos del correu</b><br /><br />Teniu en compte que s\'hi adjuntarà certa informació de depuració (cap informació privada)';
$string['requiredfields'] = 'Cal completar tots els camps requerits.';
...
$string['send'] = 'Envia';
$string['sendall'] = 'Envia-ho tot';
$string['sendmessage'] = 'Envia un missatge';
$string['sendnow'] = 'Envia ara';
...
$string['siteurllabel'] = 'URL del lloc';
$string['siteurlrequired'] = 'L\'URL del lloc és obligatori, p. ex. <i>http://www.elvostremoodle.abc o https://www.elvostremoodle.efg</i>';
$string['spaceusage'] = 'Utilització de l\'espai';
$string['stop'] = 'Atura';
...
$string['therearentnotificationsyet'] = 'No hi ha notificacions';
$string['threemonthsmore'] = 'Mostra tres mesos més';
$string['timecreated'] = 'Data de creació';
$string['timeduration'] = 'Durada';
$string['timemodified'] = 'Última modificació';
$string['timestart'] = 'Hora d\'inici';
$string['total'] = 'Total';
$string['totalusage'] = 'Ús total';
$string['type'] = 'Tipus';
$string['unexpectederror'] = 'S\'ha produït un error inesperat. Tanqueu l\'aplicació i torneu a obrir-la per a reintentar-ho.';
$string['update'] = 'Actualitza';
$string['updatesite'] = 'Actualitza el lloc';
$string['upload'] = 'Penja';
$string['uploading'] = 'S\'està penjant.';
$string['uploadingtoprivatefiles'] = 'S\'està penjant en la vostra àrea de fitxers privats';
$string['uselocalmobileplugin'] = 'Aquesta pàgina funciona millor si el lloc Moodle té instal·lat el connector mòbil opcional.';
$string['userfrom'] = 'De';
$string['username'] = 'Nom d\'usuari/ària';
$string['usernamelabel'] = 'Nom d\'usuari/ària';
$string['usernamerequired'] = 'El nom d\'usuari/ària és necessari';
$string['video'] = 'Vídeo';
