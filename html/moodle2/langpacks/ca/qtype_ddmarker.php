...
$string['formerror_onlyusewholepositivenumbers'] = 'Utilitzeu només nombres enters positius per especificar les coordenades x,y i/o l\'amplada i l\'alçada de les formes. Les vostres coordenades per a  {$a->shape} haurien expressar-se com - {$a->coordsstring}.';
