...
/**
 * Strings for component 'quiz_grading', language 'ca', branch 'MOODLE_34_STABLE'
 *
...
$string['alldoneredirecting'] = 'S\'han qualificat tots els intents seleccionats. Es retornarà a la llista de preguntes.';
$string['alreadygraded'] = 'Ja qualificada';
$string['alsoshowautomaticallygraded'] = 'Mostra també les preguntes que s\'han qualificat automàticament';
...
$string['gradeall'] = 'qualifica\'ls tots';
$string['gradeattemptsall'] = 'Tots ({$a})';
$string['gradeattemptsautograded'] = 'Aquells que s\'han qualificat automàticament ({$a})';
$string['gradeattemptsmanuallygraded'] = 'Aquells que ja s\'han qualificat a mà ({$a}';
$string['gradeattemptsneedsgrading'] = 'Aquells que necessiten qualificació ({$a})';
...
$string['total'] = 'Total';
$string['unknownquestion'] = 'Pregunta desconeguda';
$string['updategrade'] = 'actualitza les qualificacions';
