...
$string['aria:hiddencourses'] = 'Mostra els cursos ocults';
$string['aria:hidecourse'] = 'Oculta {$a} de la vista';
$string['aria:inprogress'] = 'Mostra en cursos actuals';
...
$string['aria:showcourse'] = 'Mostra {$a} en la vista';
