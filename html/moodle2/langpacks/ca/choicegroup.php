...
/**
 * Strings for component 'choicegroup', language 'ca', branch 'MOODLE_28_STABLE'
 *
 * @package   choicegroup
...
$string['notenrolledchoose'] = 'Només els usuaris inscrits poden fer eleccions.';
$string['notopenyet'] = 'Aquesta activitat no estarà disponible fins al {$a}';
...
$string['pleasesetgroups'] = 'Si us plau, creeu almenys dos grups al curs.';
...
$string['publishnames'] = 'Publica els resultat complets, mostra els noms i les seves eleccions';
