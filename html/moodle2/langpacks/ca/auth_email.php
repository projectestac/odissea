...
/**
 * Strings for component 'auth_email', language 'ca', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_email
...
$string['auth_emailrecaptcha'] = 'Afegeix un element de confirmació visual o sonor al formulari de registre, per a usuaris de l\'autoregistre per correu electrònic. Això protegeix el lloc contra la brossa i a més a més contribueix a una bona causa. Vegeu http://www.google.com/recaptcha per més detalls.';
