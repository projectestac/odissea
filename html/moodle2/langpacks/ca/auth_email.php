...
/**
 * Strings for component 'auth_email', language 'ca', branch 'MOODLE_28_STABLE'
 *
 * @package   auth_email
...
$string['auth_emaildescription'] = '<p>L\'autoregistre basat en correu electrònic permet a un usuari crear el seu propi compte a través del botó «Crea un nou compte» de la pàgina d\'inici de sessió. Quan l\'usuari es registra i tria el seu nom d\'usuari i contrasenya, se li envia un missatge per confirmar les dades. Aquest missatge conté un enllaç segur a una pàgina en la qual l\'usuari pot confirmar el seu compte. En els següents inicis de sessió simplement es compara el nom d\'usuari i la contrasenya amb els valors guardats a la base de dades de Moodle.</p><p>Nota: A banda d\'habilitat el connector, també cal seleccionar l\'autoregistre basat en correu electrònic en el menú desplegable d\'autoregistre a la pàgina «Gestió de l\'autenticació - Paràmetres comuns»';
