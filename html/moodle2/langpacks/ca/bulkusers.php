...
/**
 * Strings for component 'bulkusers', language 'ca', branch 'MOODLE_28_STABLE'
 *
 * @package   bulkusers
...
$string['addall'] = 'Afegeix tots a Seleccionats';
$string['addsel'] = 'Afegeix els marcats a Seleccionats';
$string['allfilteredusers'] = 'Tots els filtrats ({$a->count}/{$a->total})';
$string['allselectedusers'] = 'Tots els seleccionats ({$a->count}/{$a->total})';
