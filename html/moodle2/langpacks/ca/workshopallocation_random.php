...
/**
 * Strings for component 'workshopallocation_random', language 'ca', branch 'MOODLE_34_STABLE'
 *
...
$string['confignumofreviews'] = 'Nombre de trameses a assignar aleatòriament per defecte';
