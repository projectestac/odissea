...
$string['generalquestionbank'] = 'Inclou el banc de qüestions';
...
$string['importgeneralmaxresults_desc'] = 'Això controla el nombre de cursos que el llisten durant el primer pas del procés d\'importació';
...
$string['skipmodifprevhelp'] = 'Trieu ometre o no els cursos que no s\'hagin modificat des de la còpia de seguretat anterior.';
