...
$string['automateddeletedays'] = 'Suprimeix les copies de seguretat més antigues de';
$string['automatedmaxkept'] = 'Nombre màxim de còpies de seguretat a emmagatzemar';
$string['automatedmaxkepthelp'] = 'Això especifica el nombre màxim de còpies de seguretat recents que s\'han de mantenir en cada curs. Les còpies de seguretat més antigues s\'esborraran de forma automàtica.';
$string['automatedminkept'] = 'Nombre mínim de còpies de seguretat a emmagatzemar';
$string['automatedminkepthelp'] = 'Si les còpies de seguretat més antigues d\'un nombre específic de dies s\'esborren, pot succeir que un curs inactiu acabi sense cap còpia de seguretat. Per tal d\'evitar-ho, cal que especifiqueu un nombre mínim de còpies de seguretat que s\'han de mantenir.';
...
$string['choosefilefromactivitybackup_help'] = 'Les còpies de seguretat d\'activitats fetes utilitzant els paràmetres per omissió es desaran aquí.';
...
$string['choosefilefromcoursebackup_help'] = 'Les còpies de seguretat de cursos fetes utilitzant els paràmetres per omissió es desaran aquí.';
