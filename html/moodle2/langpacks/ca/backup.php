...
$string['automatedmaxkepthelp'] = 'Això especifica el nombre màxim de copies de copies de seguretats recents a mantindre en cada curs. Les copies de seguretat més antigues s\'esborraran de forma automàtica.';
$string['automatedminkept'] = 'Nombre mínim de còpies de seguretat a emmagatzemar';
$string['automatedminkepthelp'] = 'Si les copies de seguretat més antigues d\'un nombre especific de dies s\'esborren, pot succeir que un curs inactiu acabi sense cap còpia de seguretat. Per tal d\'evitar-ho, cal que especifiqueu un nombre de copies de seguretat mínim a mantindre.';
