...
$string['oauth2upgrade_message_content'] = 'Com a part de l\'actualització a Moodle 2.3, s\'ha inhabilitat el connector portfolio de Google Drive. Per tornar-lo a habilitar, cal que registreu el vostre lloc Moodle amb Google, com es descriu a la documentació {$a->docsurl}, per obtenir un ID de client i una  contrasenya secreta. L\'ID de client i la contrasenya secreta es poden utilitzar per configurar els connectors Google Drive i Picasa.';
