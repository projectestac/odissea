...
$string['maxtimelimit_desc'] = 'Per a restringir el temps màxim d\'execució de PHP que Moodle permetrà sense que es visualitzi cap sortida, introduïu aquí un valor en segons. 0 significa que que s\'utilitzen les restriccions per defecte de Moodle. Si disposeu d\'un servidor amb el seu propi límit de temps, definiu un valor més baix per a rebre els errors de PHP en els registres. No s\'aplica als scripts CLI.';
