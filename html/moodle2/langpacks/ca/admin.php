...
/**
 * Strings for component 'admin', language 'ca', branch 'MOODLE_31_STABLE'
 *
 * @package   admin
...
$string['availablesearchareas'] = 'Àrees disponibles per a la cerca';
...
$string['navexpandmycourses'] = 'Mostra «Els meus cursos» expandit al Tauler';
$string['navexpandmycourses_desc'] = 'Si s\'habilita, «Els meus cursos» es mostrarà inicialment expandit al bloc de navegació al Tauler';
