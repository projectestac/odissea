...
/**
 * Strings for component 'admin', language 'ca', branch 'MOODLE_28_STABLE'
 *
 * @package   admin
...
$string['configtimezone'] = 'Aquesta és la zona horària per defecte per mostrar dates; cada usuari pot redefinir aquest paràmetre al seu perfil. Aquí «Hora del servidor» vol dir que Moodle agafarà la zona horària del sistema operatiu del servidor. En el perfil de l\'usuari, «Hora del servidor» vol dir que l\'usuari agafa la zona horària definida en aquest paràmetre de Moodle. Es recomana que actualitzeu les zones horàries i després seleccioneu una zona horària identificada concreta per a la vostra regió.';
...
$string['navexpandmycourses'] = 'Mostrar «Els meus cursos» expandit a «El meu Moodle»';
$string['navexpandmycourses_desc'] = 'Si s\'habilita,«Els meus cursos» es mostrarà inicialment expandit al bloc de navegació en «El meu Moodle»';
...
$string['taskcompletioncron'] = 'Calcula la data de compleció';
...
$string['taskplagiarismcron'] = 'Processament en segon pla dels connectors de detecció plagi';
