...
$string['autonumberquestions'] = 'Autonumera les preguntes';
$string['average'] = 'Mitjana';
$string['averageposition'] = 'Posició mitja';
...
$string['chart:type_help'] = 'Selecciona el tipus de gràfica per aquesta retroalimentació';
