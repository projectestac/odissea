...
/**
 * Strings for component 'resource', language 'ca', branch 'MOODLE_34_STABLE'
 *
 * @package   resource
...
$string['clicktodownload'] = 'Feu clic en l\'enllaç {$a} per baixar el fitxer.';
$string['clicktoopen2'] = 'Feu clic en l\'enllaç {$a} per veure el fitxer.';
...
$string['filterfiles'] = 'Utilitza filtres en el contingut del fitxer';
$string['filterfilesexplain'] = 'Selecciona el tipus de filtrat de contingut del fitxer, si us plau fixeu-vos que això pot provocar problemes en algunes aplicacions de Java i Flash. Comproveu que tots els fitxers de text estan codificats en UTF-8.';
