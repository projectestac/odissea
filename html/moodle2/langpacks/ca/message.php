...
$string['beepnewmessage'] = 'Emet un so d\'avís quan es visualitzi una notificació emergent';
...
$string['errorwhilesendingmessage'] = 'S\'ha produït un error mentre s\'enviava un missatge; torneu-ho a provar més tard.';
...
$string['messagenavigation'] = 'Navegació dels missatges:';
$string['messageoutputs'] = 'Sortides de missatges';
$string['messages'] = 'Missatges';
$string['messagesent'] = 'S\'ha enviat el missatge';
$string['messagetosend'] = 'Missatge a enviar';
$string['messaging'] = 'Missatgeria';
$string['messagingblockednoncontact'] = '{$a} no us podrà respondre perquè heu blocat els usuaris que no són als vostres contactes';
...
$string['sendingmessage'] = 'S\'està enviant un missatge';
...
$string['thisconversation'] = 'aquesta conversa';
...
$string['unabletomessageuser'] = 'No teniu permís per enviar un missatge a aquest usuari';
...
$string['viewconversation'] = 'Mostra la conversa';
