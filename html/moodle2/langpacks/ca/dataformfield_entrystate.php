...
/**
 * Strings for component 'dataformfield_entrystate', language 'ca', branch 'MOODLE_26_STABLE'
 *
...
$string['states'] = 'Estats';
$string['transition'] = 'Transició';
$string['transitions'] = 'Transicions';
