...
/**
 * Strings for component 'tool_profiling', language 'ca', branch 'MOODLE_34_STABLE'
 *
...
$string['markreferencerun'] = 'Marca com a execució de referència / comentari';
$string['memory'] = 'Memòria utilitzada';
$string['pluginname'] = 'Perfils d\'execució';
$string['profilingfocusscript'] = 'Focus als perfils d\'execució per al guió: {$a}';
$string['profilingruns'] = 'Perfils d\'execucions';
$string['profilingrunsfor'] = 'Perfils d\'execucions per {$a}';
$string['referencerun'] = 'Execució de referència / comentari';
