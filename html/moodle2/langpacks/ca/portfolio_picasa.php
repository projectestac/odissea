...
$string['oauth2upgrade_message_content'] = 'Com a part de l\'actualització a Moodle 2.3, s\'ha inhabilitat el connector de portafolis de Picasa. Per tornar-lo a habilitar, heu de registrar el vostre lloc Moodle amb Google, com es descriu a la documentació {$a->docsurl}, a fi d\'obtenir un ID de client i una contrasenya secreta. L\'ID de client i la contrasenya secreta es poden utilitzar per configurar tots els connectors de Picasa i Google Drive.';
