...
$string['uninstallconfirm'] = 'Ara desinstal·lareu el connector <em>{$a->name}</em>. Això suprimirà completament de la base de dades tot allò relacionat amb aquest connector, inclosos la seva configuració, els registres, els fitxers d\'usuari gestionats pel connector, etc. No hi ha cap manera de desfer els canvis, i Moodle no crearà cap còpia de seguretat de recuperació. Esteu SEGUR que voleu continuar ?';
