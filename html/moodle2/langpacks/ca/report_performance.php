...
/**
 * Strings for component 'report_performance', language 'ca', branch 'MOODLE_31_STABLE'
 *
...
$string['check_themedesignermode_comment_enable'] = 'Si s\'inhabilita, les imatges i els fulls d\'estils s\'emmagatzemaran en memòria cau, la qual cosa comporta un augment significatiu del rendiment.';
$string['check_themedesignermode_details'] = 'Això és sovint el motiu que hi hagi llocs de Moodle lents. <p>De mitjana, es podria consumir com a mínim dues vegades la quantitat de CPU per executar un lloc Moodle amb el mode de disseny de tema habilitat.</p>';
