...
$string['inputstandardtags'] = 'Entreu la llista separada per comes de les etiquetes noves';
...
$string['showstandard_help'] = 'Mentre entreu etiquetes, es poden suggerir o forçar etiquetes estàndard, això vol dir que no es poden entrar etiquetes noves. Alternativament, es poden introduir etiquetes noves si no es suggereix cap etiqueta habitual.';
$string['standardforce'] = 'Força';
$string['standardhide'] = 'No suggereixis';
$string['standardsuggest'] = 'Suggereix';
$string['standardtag'] = 'Estandard';
