...
/**
 * Strings for component 'availability_profile', language 'ca', branch 'MOODLE_36_STABLE'
 *
...
$string['conditiontitle'] = 'Camp de perfil d\'usuari';
$string['description'] = 'Control d\'accés basat en camps del perfil de l\'estudiant.';
$string['error_selectfield'] = 'Cal que seleccioneu un camp del perfil.';
$string['error_setvalue'] = 'Cal que introduïu un valor.';
$string['label_operator'] = 'Mètode de comparació';
$string['label_value'] = 'Valor per comparar contra';
$string['missing'] = '(Falta el camp personalitzat: {$a})';
$string['op_contains'] = 'conté';
$string['op_doesnotcontain'] = 'no conté';
$string['op_endswith'] = 'acaba en';
$string['op_isempty'] = 'està buit';
$string['op_isequalto'] = 'és igual a';
