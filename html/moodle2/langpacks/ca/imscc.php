...
/**
 * Strings for component 'imscc', language 'ca', branch 'MOODLE_31_STABLE'
 *
 * @package   imscc
...
$string['cc2moodle_checking_schema'] = 'Format CC ! S\'està comprovant l\'esquema.';
$string['cc2moodle_invalid_schema'] = 'L\'esquema no és vàlid.';
$string['cc2moodle_manifest_dont_load'] = 'No es pot llegir el manifest XML.';
$string['cc2moodle_req_auth'] = 'ERROR: El paquet Common Cartridge requereix autorització.';
$string['cc2moodle_valid_schema'] = 'Esquema vàlid!';
$string['cc_import_req_dom'] = 'ERROR: La importació Common Cartridge requereix l\'extensió DOM.';
$string['cc_import_req_libxml'] = 'ERROR: La importació Common Cartridge requereix l\'extensió LIBXML.';
