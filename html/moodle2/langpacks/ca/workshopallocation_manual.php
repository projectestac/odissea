...
/**
 * Strings for component 'workshopallocation_manual', language 'ca', branch 'MOODLE_36_STABLE'
 *
...
$string['addreviewee'] = 'Afegeix un revisat';
$string['addreviewer'] = 'Afegeix un revisor';
