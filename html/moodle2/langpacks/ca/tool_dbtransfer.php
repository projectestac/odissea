...
/**
 * Strings for component 'tool_dbtransfer', language 'ca', branch 'MOODLE_36_STABLE'
 *
...
$string['notargetconectexception'] = 'No es pot connectar amb la base de dades de destinació.';
$string['options'] = 'Opcions';
$string['pluginname'] = 'Transferència de base de dades';
