...
/**
 * Strings for component 'block_mentees', language 'ca', branch 'MOODLE_28_STABLE'
 *
...
$string['mentees:myaddinstance'] = 'Afegir un bloc nou de Tutelats a la pàgina del «meu Moodle»';
