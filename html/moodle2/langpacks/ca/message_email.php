...
/**
 * Strings for component 'message_email', language 'ca', branch 'MOODLE_28_STABLE'
 *
...
$string['configsmtphosts'] = 'Doneu el nom d\'un o més servidors SMTP locals que Moodle pugui usar per enviar correu (p. ex. \'mail.a.com\' o \'mail.a.com;mail.b.com\'). Per especificar un port que no sigui el port per defecte (un port diferent al port 25), podeu utilitzar la sintaxi [servidor]:[port] (p. ex. \'mail.a.com:587\' ). Per a connexions segures, el port 465 és l\'utilitzat generalment amb SSL i el port 587 és l\'utilitzat generalment amb TLS. Si el deixeu en blanc, Moodle utilitzarà el mètode per defecte del PHP per enviar correu.';
