...
/**
 * Strings for component 'media', language 'ca', branch 'MOODLE_32_STABLE'
 *
 * @package   media
...
$string['audioextensions'] = 'Àudio: {$a}';
$string['defaultheight'] = 'Alçària per defecte';
$string['defaultheightdesc'] = 'Alçària del reproductor multimèdia si no se n\'ha especificat cap i el reproductor no pot determinar l\'alçària real del fitxer.';
