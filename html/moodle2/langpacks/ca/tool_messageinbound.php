...
/**
 * Strings for component 'tool_messageinbound', language 'ca', branch 'MOODLE_31_STABLE'
 *
...
$string['defaultexpiration_help'] = 'Qua una adreça de correu electrònic ha estat generada per un gestor, es pot configurar que caduqui de forma automàtica després d\'un període de temps, i que no es pugui utilitzar més. És aconsellable establir un període de caducitat.';
