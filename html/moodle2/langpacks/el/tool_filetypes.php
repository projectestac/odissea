...
$string['defaulticon_help'] = 'Αν υπάρχουν πολλαπές επεκτάσεις αρχείου με τον ίδιο τύπο MIME, επιλέξτε αυτή την επιλογή για μια από τις επεκτάσεις, έτσι ώστε το εικονίδιό της να χρησιμοποιηθεί όταν προσδιορίζεται/αναζητείται ένα εικονίδιο από τον τύπο MIME.';
...
$string['description_help'] = 'Απλή περιγραφή τύπου αρχείου, π.χ. \'Kindle ebook\'. Αν ο ιστότοπός σας υποστηρίζει πολλαπλές γλώσσες και χρησιμοποιεί το φίλτρο πολλαπλών γλωσσών, μπορείτε να εισάγετε ετικέτες πολλαπλών γλωσσών σε αυτό το πεδίο για να παρέχετε μια περιγραφή σε διαφορετικές γλώσσες.';
...
$string['icon_help'] = 'Όνομα αρχείου εικονιδίου. Η λίστα με τα εικονίδια λαμβάνεται από τον κατάλογο/φάκελλο /pix/f της εγκατάστασης Moodle σας. Μπορείτε να προσθέσετε προσαρμοσμένα εικονίδια σε αυτόν τον φάκελο αν απαιτείται.';
