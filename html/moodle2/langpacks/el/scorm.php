...
$string['autocommit'] = 'Αυτόματη υποβολή';
...
$string['forcejavascript_desc'] = 'Αν ενεργοποιηθεί (προτείνεται), εμποδίζει την πρόσβαση σε αντικείμενα SCORM όταν η JavaScript δεν υποστηρίζεται ή δεν είναι ενεργοποιημένη στον περιηγητή του χρήστη. Αν απενεργοποιηθεί, ο χρήστης μπορεί να δει το SCORM αλλά η επικοινωνία API θα αποτύχει και δεν θα αποθηκευτούν πληροφορίες βαθμολόγησης.';
...
$string['popupsblocked'] = 'Φαίνεται ότι τα αναδυόμενα παράθυρα αποκλείονται, εμποδίζοντας την αναπαραγωγή του πακέτου SCORM. Παρακαλώ ελέγξτε τις ρυθμίσεις του περιηγητή σας και δοκιμάστε ξανά.';
