...
$string['aicchacptimeout_desc'] = 'Χρονικό διάστημα σε λεπτά όπου μια εξωτερική συνόδος AICC HACP μπορεί να παραμείνει ανοιχτή';
...
$string['forcejavascript_desc'] = 'Εάν ενεργοποιηθεί (προτείνεται), εμποδίζει την πρόσβαση σε αντικείμενα SCORM όταν η JavaScript δεν υποστηρίζεται ή δεν είναι ενεργοποιημένη στον περιηγητή του χρήστη. Αν απενεργοποιηθεί, ο χρήστης μπορεί να δει το SCORM αλλά η επικοινωνία API θα αποτύχει και δεν θα αποθηκευτούν πληροφορίες βαθμολόγησης.';
...
$string['forcenewattemptdesc'] = 'Αυτή η ρύθμιση αποκρύπτει το πλαίσιο ελέγχου «Έναρξη νέας προσπάθειας» και αποτρέπει τη λειτουργία αναθεώρησης. Το SCORM επιτρέπει σε έναν μαθητή να επιστρέψει στην ίδια προσπάθεια σε οποιοδήποτε σημείο και μια νέα προσπάθεια δεν είναι δυνατή εκτός αν η προηγούμενη προσπάθεια έχει οριστεί ως "ολοκληρώθηκε", "πέρασε" ή "απέτυχε". Εάν το πακέτο SCORM δεν το κάνει αυτό, ο μαθητής θα επανέρχεται πάντα στην ίδια προσπάθεια.';
$string['forcenewattempt_help'] = 'Αυτή η ρύθμιση αποκρύπτει το πλαίσιο «Εκκίνηση νέας προσπάθειας» και εμποδίζει την κατάσταση ανασκόπησης.
Το SCORM επιτρέπει σε ένα μαθητή να επιστρέψει στην ίδια προσπάθεια οποιαδήποτε στιγμή και μια νέα προσπάθεια δεν είναι δυνατή, εκτός αν η προηγούμενη προσπάθεια έχει οριστεί ως «ολοκληρώθηκε», «πέρασε» ή «απέτυχε». Αν το πακέτο SCORM δεν το κάνει αυτό, ο μαθητής θα εισέρχεται πάντα στην ίδια προσπάθεια.';
...
$string['hidetoc_help'] = 'Ο τρόπος εμφάνισης του πίνακα περιεχομένων στο πρόγραμμα αναπαραγωγής του SCORM.';
...
$string['invalidhacpsession'] = 'Μη έγκυρη συνόδος HACP';
...
$string['masteryoverride_help'] = 'Εάν ενεργοποιηθεί και παρέχεται σκορ αριστοτεχνίας, όταν καλείται το LMSFinish και έχει οριστεί ανεπεξέργαστο σκορ, η κατάσταση θα υπολογιστεί εκ νέου χρησιμοποιώντας το ανεπεξέργαστο σκορ και το σκορ αριστοτεχνίας και οποιαδήποτε κατάσταση παρέχεται από το SCORM (συμπεριλαμβανομένης της «ανολοκλήρωτη») θα παρακαμφθεί.';
...
$string['navpositionleft'] = 'Θέση πλήκτρων πλοήγησης από αριστερα σε εικονοστοιχεία.';
...
$string['scorm12standarddesc'] = 'Η απενεργοποίηση αυτής της ρύθμισης επιτρέπει στο Moodle να αποθηκεύει περισσότερα δεδομένα από ό,τι επιτρέπει η προδιαγραφή SCORM 1.2.
Αν τα SCORM πακέτα σας, επιτρέπουν στους χρήστες να εισάγουν μεγάλα κείμενα ή αν το πακέτο σας προσπαθεί να αποθηκεύσει μεγάλη ποσότητα δεδομένων στο πεδίο suspend_data απενεργοποιήστε τη.';
...
$string['scorm:viewscores'] = 'Προβολή των σκορ';
...
$string['tracklatency_help'] = 'Το χρονικό διάστημα που μεσολάβησε από τη διάθεση της ερώτησης στο μαθητή για απάντηση μέχρι την πρώτη απάντηση.';
...
$string['tracksuspenddata_help'] = 'Παρέχει χώρο για την αποθήκευση και ανάκτηση δεδομένων μεταξύ των συνόδων του μαθητή';
...
$string['viewalluserreports'] = 'Προβολή αναφορών για {$a} χρήστες';
