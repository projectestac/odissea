...
/**
 * Strings for component 'workshopform_rubric', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'Το πρόσθετο Ρουμπρίκα αποθηκεύει μόνο τα στοιχεία της φόρμας αξιολόγησης. Τα πραγματικά προσωπικά δεδομένα για το πως έχει συμπληρωθεί η φόρμα αποθηκεύονται από το ίδιο το άρθρωμα του Εργαστηρίου και επισυνάπτονται στις εξαγόμενες εκτιμήσεις.';
