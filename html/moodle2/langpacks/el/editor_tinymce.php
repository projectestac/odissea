...
$string['advanced:blockquote'] = 'Μπλοκ παράθεσης (κατά λέξη)';
$string['advanced:blockquote_desc'] = 'Μπλοκ αντί εισαγωγικών για παράθεση κατά λέξη';
