...
$string['advanced_dlg:link_is_email'] = 'Η διαδρομή URL που δώσατε μοιάζει με διεύθυνση ηλ. ταχυδρομείου. Θέλετε να προστεθεί το απαιτούμενο πρόθεμα mailto: ;';
$string['advanced_dlg:link_is_external'] = 'Η διαδρομή URL που δώσατε μοιάζει με εξωτερικός σύνδεσμος. Θέλετε να προστεθεί το απαιτούμενο πρόθεμα http:// ;';
...
$string['advanced:toolbar_focus'] = 'Μετάβαση στα κουμπιά εργαλείων - Alt+Q,<br />
μετάβαση στον επεξεργαστή κειμένου - Alt-Z,<br />
μετάβαση στην διαδρομή του στοιχείου - Alt-X.';
...
$string['advimage_dlg:missing_alt'] = 'Σίγουρα θέλετε να συνεχίσετε χωρίς περιγραφή εικόνας; Χωρίς αυτήν η εικόνα μπορεί να μην είναι προσβάσιμη σε κάποιους χρήστες με προβλήματα, ή σε αυτούς που χρησιμοποιούν περιηγητή κειμένου, ή βλέπουν το Ιντερνετ με τις εικόνες απενεργοποιημένες.';
...
$string['advlink_dlg:is_email'] = 'Η διαδρομή URL που δώσατε μοιάζει με διεύθυνση ηλ. ταχυδρομείου. Θέλετε να προστεθεί το απαιτούμενο πρόθεμα mailto: ;';
$string['advlink_dlg:is_external'] = 'Η διαδρομή URL που δώσατε μοιάζει με εξωτερικός σύνδεσμος. Θέλετε να προστεθεί το απαιτούμενο πρόθεμα http:// ;';
...
$string['colors:993300'] = 'Καμμένο πορτοκαλί';
...
$string['common:popup_blocked'] = 'Ένα πρόγραμμα αποκλεισμού αναδυόμενων παραθύρων (popup-blocker) έχει απενεργοποιήσει ένα παράθυρο απαραίτητο για την εφαρμογή. Πρέπει να το απενεργοποιήσετε για αυτόν τον ιστότοπο για να χρησιμοποιήσετε πλήρως την εφαρμογή.';
...
$string['media_dlg:qt_stream_warn'] = 'Πηγές ροών RTSP θα πρέπει να προστεθούν στο πεδίο «Πηγή αρχείου QuickTime» κάτω από την καρτέλα «Για προχωρημένους». Επίσης καλό θα ήταν να προσθέσετε μια απλή (όχι ροής) έκδοση στο πεδίο αυτό.';
...
$string['style_dlg:background'] = 'Φόντο';
...
$string['xhtmlxtras_dlg:title_acronym_element'] = 'Στοιχείο ακρονυμίου';
