...
/**
 * Strings for component 'editor_tinymce', language 'el', branch 'MOODLE_31_STABLE'
 *
...
$string['advanced:clipboard_msg'] = 'Οι λειτουργίες Αντιγραφή/Αποκοπή/Επικόλληση δεν είναι διαθέσιμες σε Mozilla και Firefox.nΘέλετε περισσότερες πληροφορίες ;';
...
$string['media_dlg:qt_stream_warn'] = 'Πηγές ροών rtsp θα πρέπει να προστεθούν στο πεδίο Πηγή QT κάτω από την καρτέλα Για προχωρημένους.nΕπίσης καλό θα ήταν να προσθέσετε μια απλή (όχι ροής) πηγή..';
...
$string['pluginname'] = 'TinyMCE HTML συντάκτης';
