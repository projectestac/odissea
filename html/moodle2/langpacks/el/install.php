...
/**
 * Strings for component 'install', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   install
...
$string['configfilenotwritten'] = 'Η δέσμη ενεργειών εγκατάστασης δεν μπόρεσε να δημιουργήσει αυτόματα ένα αρχείο config.php το οποίο να περιέχει τις επιλεγμένες ρυθμίσεις, μάλλον γιατί ο φάκελος του Moodle δεν είναι εγγράψιμος. Μπορείτε χειροκίνητα να αντιγράψετε τον παρακάτω κώδικα σε ένα αρχείο με όνομα config.php μέσα στο root φάκελο του Moodle.';
...
$string['datarooterror'] = 'Ο «φάκελος δεδομένων» που καθορίσατε δεν μπόρεσε να βρεθεί ή να δημιουργηθεί. Είτε διορθώστε τη διαδρομή (πλήρες όνομα) είτε δημιουργήστε αυτόν τον φάκελο χειροκίνητα.';
...
$string['nativemssqlhelp'] = 'Τώρα πρέπει να διαμορφώσετε τη βάση δεδομένων όπου θα αποθηκευτούν τα περισσότερα δεδομένα Moodle.
Αυτή η βάση δεδομένων πρέπει να έχει ήδη δημιουργηθεί καθώς και ένα όνομα χρήστη με κωδικό για την πρόσβαση σε αυτήν. Το πρόθεμα πίνακα είναι υποχρεωτικό.';
