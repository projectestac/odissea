...
/**
 * Strings for component 'repository_upload', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['upload_error_ini_size'] = 'Το ανεβασμένο αρχείο υπερβαίνει το υποχρεωτικό μέγιστο upload_max_filesize που ορίστηκε στο php.ini.';
