...
$string['completion_help'] = '<p>Αν είναι ενεργοποιημένη, η ολοκλήρωση δραστηριότητας παρακολουθείται, είτε με το χέρι είτε αυτόματα, με βάση συγκεκριμένες συνθήκες. Μπορούν να ρυθμιστούν πολλαπλές συνθήκες αν είναι επιθυμητό. Αν ναι, η δραστηριότητα θα θεωρείται ολοκληρωμένη μόνο όταν καλύπτονται όλες οι συνθήκες.</p>

<p>Μια επισήμανση δίπλα στο όνομα της δραστηριότητας στη σελίδα του μαθήματος υποδεικνύει πότε έχει ολοκληρωθεί η δραστηριότητα.</p>';
...
$string['nottracked'] = 'Επί του παρόντος δεν παρακολουθείτε η ολοκλήρωση αυτού του μαθήματος';
...
$string['unenrolingfromcourse'] = 'Ακύρωση εγγραφής από μάθημα';
