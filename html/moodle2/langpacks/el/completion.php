...
$string['completionicons_help'] = 'Ένα σημαδάκι ν στο τετραγωνίδιο δίπλα σε ένα όνομα δραστηριότητας μπορεί να χρησιμοποιηθεί για να υποδηλώσει πότε η δραστηριότητα είναι ολοκληρωμένη. Εάν εμφανιστεί ένα τετραγωνίδιο με διάστικτα περιγράμματα, θα εμφανιστεί αυτόματα ένα σημαδάκι ν στο τετραγωνίδιο όταν ολοκληρώσετε τη δραστηριότητα σύμφωνα με τις προϋποθέσεις που ορίζει ο διδάσκων. Εάν εμφανιστεί ένα τετραγωνίδιο με ένα συμπαγές περίγραμμα, μπορείτε να κάνετε κλικ σε αυτό για να επιλέξετε το τετραγωνίδιο όταν νομίζετε ότι έχετε ολοκληρώσει τη δραστηριότητα. (Κάνοντας κλικ σε αυτό ξανά, αφαιρείται πάλι το ν, αν αλλάξετε γνώμη.)';
$string['completion_link'] = 'δραστηριότητα/ολοκήρωση';
