...
/**
 * Strings for component 'completion', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   completion
...
$string['bulkcompletiontracking_help'] = '<strong>Καμία:</strong> Μην υποδεικνύετε την ολοκλήρωση της δραστηριότητας

<strong>Χειροκίνητα:</strong> Οι μαθητές μπορούν να επισημάνουν χειροκίνητα τη δραστηριότητα ως ολοκληρωμένη

<strong>Με προϋποθέσεις:</strong> Εμφάνιση της δραστηριότητας ως πλήρης όταν πληρούνται κάποιες προϋποθέσεις';
...
$string['completionicons_help'] = 'Ένα σημαδάκι ν στο τετραγωνίδιο δίπλα σε ένα όνομα δραστηριότητας μπορεί να χρησιμοποιηθεί για να υποδηλώσει πότε η δραστηριότητα είναι ολοκληρωμένη. Εάν εμφανιστεί ένα τετραγωνίδιο με διάστικτα περιθώρια, θα εμφανιστεί αυτόματα ένα σημαδάκι ν στο τετραγωνίδιο όταν ολοκληρώσετε τη δραστηριότητα σύμφωνα με τις προϋποθέσεις που ορίζει ο διδάσκων. Εάν εμφανιστεί ένα τετραγωνίδιο με ένα συμπαγές περίγραμμα, μπορείτε να κάνετε κλικ σε αυτό για να επιλέξετε το τετραγωνίδιο όταν νομίζετε ότι έχετε ολοκληρώσει τη δραστηριότητα. (Κάνοντας κλικ σε αυτό ξανά, αφαιρείται πάλι το ν, αν αλλάξετε γνώμη.)';
...
$string['completion-n-override'] = 'Δεν ολοκληρώθηκε (τέθηκε από {$a})';
$string['completionondate'] = 'Ημερομηνία';
$string['completionondatevalue'] = 'Ο χρήστης θα πρέπει να παρεμείνει εγγεγραμμένος εώς';
...
$string['completionusegrade_help'] = 'Αν ενεργοποιηθεί, η δραστηριότητα θεωρείται ολοκληρωμένη όταν ένας μαθητής λαμβάνει μια βαθμολογία. Τα εικονίδια επιτυχίας και αποτυχίας μπορούν να εμφανίζονται εάν έχει οριστεί βαθμός επιτυχίας για τη δραστηριότητα. <br />

<br /> <br /> <p> Όταν αυτή η επιλογή είναι ενεργοποιημένη, οι μαθητές υποχρεούνται να λάβουν βαθμό στη δραστηριότητα προκειμένου να την ολοκληρώσουν. Για παράδειγμα, ένα quiz θα σημειωθεί ως ολοκληρωμένο μόλις ο χρήστης το υποβάλει. </p> <p> Δεν έχει σημασία η επίδοση του μαθητή. Η απόδοση οποιουδήποτε βαθμού θα σημειώσει τη δραστηριότητα ως ολοκληρωμένη. </p> <h2>Διαχωρισμός μεταξύ επιτυχίας και αποτυχίας</h2> <p> Είναι δυνατό να γίνει διαχωρισμός μεταξύ βαθμού "επιτυχίας" και "αποτυχίας", έτσι ώστε η δραστηριότητα να γίνεται "ολοκληρωμένη, επιτυχημένη" ή "ολοκληρωμένη, αποτυχημένη" αντί για απλώς "ολοκληρωμένη". Αυτά τα αποτελέσματα εμφανίζουν διαφορετικό εικονίδιο και κείμενο. </p> <p> Για να ρυθμίσετε αυτή την επιλογή, πρέπει να ορίσετε τη βάση για το βαθμό αυτής της δραστηριότητας: </p> <ol> <li>Πηγαίνετε στο βαθμολόγιο του μαθήματος πατώντας στο σύνδεσμο "Βαθμοί" στο μπλοκ διαχείρισης του μαθήματος.</li> <li>Από την αναδυόμενη λίστα "Επιλογή ενέργειας", επιλέξτε "Κατηγορίες και αντικείμενα".</li> <li>Πατήστε το εικονίδιο Επεξεργασία δίπλα στο βαθμολογημένο αντικείμενο αυτής της δραστηριότητας.</li> <li>Ενεργοποιήστε το "Εμφάνιση Προχωρημένων".</li> <li>Εισάγετε ένα βαθμό (π.χ. 5.0) στο κουτί "Βαθμός βάσης".</li> </ol> <p> Μόλις το κάνετε αυτό, οποιοσδήπτοε υποβάλει το quiz θα λάβει είτε το εικονίδιο επιτυχίας είτε το εικονίδιο αποτυχίας. Αν το quiz μπορεί να συμπληρωθεί πολλές φορές από ένα χρήστη, το εικονίδιο ολοκλήρωσης θα ενημερώνεται αυτόματα με κάθε νέο βαθμό. </p> <p> Υπάρχει ένας περιορισμός: αυτό δουλεύει μόνο όταν οι βαθμοί είναι άμεσα εμφανίσιμοι στους μαθητές. Ο βαθμός δεν θα πρέπει να είναι μόνιμα κρυμμένος, ή κρυμμένος μέχρι μία συγκεκριμένη ημερομηνία. Αν ο βαθμός είναι κρυμμένος, τότε μόνο το τυπικό "ολοκληρωμένο" θα εμφανίζεται - ακόμα και όταν η ημερομηνία απόκρυψης έχει περάσει. </p>';
$string['completionview'] = 'Απαιτείται προβολή';
$string['completionview_desc'] = 'Ο μαθήτης πρέπει να δει τη δραστηριότητα για να την ολοκληρώσει';
...
$string['configenablecompletion'] = 'Εάν ενεργοποιηθεί, σας επιτρέπει να ενεργοποιήσετε το σύστημα παρακολούθησης προόδου σε κάθε μάθημα ξεχωριστά.';
...
$string['csvdownload'] = 'Λήψη σε αρχείο CSV (κωδικοποίηση UTF-8)';
...
$string['err_nousers'] = 'Δεν υπάρχουν χρήστες σ\' αυτό το μάθημα ή ομάδα για τους οποίους διατηρούνται πληροφορίες ολοκλήρωσης. (Από προεπιλογή τέτοιες πληροφορίες διατηρούνται μόνο για τους μαθητές, και αν δεν υπάρχουν τέτοιοι θα δείτε αυτό το μήνυμα. Ο διαχειριστής του συστήματος μπορεί να αλλάξει τη ρύθμιση αυτή).';
...
$string['nocriteriaset'] = 'Σεν έχουν οριστεί κριτήρια ολοκλήρωσης για αυτό το μάθημα';
...
$string['roleaggregation_all'] = 'ΟΛΟΙ οι επιλεγμένοι ρόλοι για να επισημανθεί πότε καλύπτεται η συνθήκη';
$string['roleaggregation_any'] = 'ΟΠΟΙΟΣΔΗΠΟΤΕ από τους επιλεγμένους ρόλους για να επισημανθεί πότε καλύπτεται η συνθήκη';
...
$string['viewcoursereport'] = 'Προβολή αναφοράς μαθήματος';
$string['viewingactivity'] = 'Προβολή {$a}';
