...
$string['cannotsavetempl'] = 'Η αποθήκευση πρότυπων δεν επιτρέπεται';
...
$string['depending_help'] = 'Είναι πιθανό να εμφανιστεί ένα στοιχείο ανάλογα με την αξία ενός άλλου στοιχείου.<br /> <strong>Να ένα παράδειγμα.</strong><br />
<ul>
...
$string['email_notification'] = 'Ενεργοποίηση αποστολής ειδοποιήσεων (μέσω ηλεκτρονικού ταχυδρομείου) για υποβολές εργασιών';
...
$string['resetting_data'] = 'Μηδενισμός αποκρίσεων σχόλιου';
...
$string['template_deleted'] = 'Το πρότυπο διαγράφηκε';
