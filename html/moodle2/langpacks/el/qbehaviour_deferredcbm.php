...
$string['cbmgrades_help'] = 'Με την βαθμολόγηση με βάση την βεβαιότητα (CBM) μια σωστή απάντηση σε κάθε ερώτηση με C=1 (χαμηλή βεβαιότητα) δίνει βαθμό 100%. Οι βαθμοί μπορεί να φτάσουν μέχρι 300% αν κάθε ερώτηση απαντηθεί σωστά με C=3 (υψηλή βεβαιότητα). Οι παρανοήσεις (σίγουρες αλλά λανθασμένες απαντήσεις) μειώνουν τους βαθμούς πολύ περισσότερο από τις λάθος απαντήσεις που όμως αναγνωρίζονται ως αβέβαιες. Αυτό μπορεί να οδηγήσει ακόμη και σε αρνητικούς συνολικούς βαθμούς. ** Ακρίβεια ** είναι το ποστοστό % σωστών απαντήσεων με αγνόηση της βεβαιότητας αλλά σταθμισμένο για το μέγιστο βαθμό κάθε ερωτήματος.
Η επιτυχής διάκριση περισσότερο και λιγότερο αξιόπιστων απαντήσεων δίνει καλύτερο βαθμό από την επιλογή της ίδιας βεβαιότητας για κάθε ερώτηση. Αυτό αντανακλάται στο Bonus ** CBM **.
...
$string['judgementsummary'] = 'Απαντήσεις: {$a->responses}. Ακρίβεια: {$a->fraction}. (Βέλτιστο εύρος από {$a->idealrangelow} σε {$a->idealrangehigh}). . Είσαστε {$a->judgement} χρησιμοποιώντας αυτό το επίπεδο βεβαιότητας.';
