...
/**
 * Strings for component 'antivirus_clamav', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['invalidpathtoclam'] = 'Η διαδρομή για το εκτελέσιμο αρχείο Clam AV, {$a}, δεν είναι έγκυρη.';
$string['pathtoclam'] = 'Γραμμή εντολών';
$string['pathtoclamdesc'] = 'Αν η μέθοδος εκτέλεσης είναι ορισμένη σε «Γραμμή εντολών», εισάγετε εδώ τη διαδρομή για το ClamAV. Στο Linux αυτό θα είναι /usr/bin/clamscan ή /usr/bin/clamdscan.';
