...
* Κύκλος: κέντρο_Χ, κέντρο_Ψ; ω ακτίνα <br />για παράδειγμα: <code> 80, 100; 50 </ code>
* Ορθογώνιο: πάνω_αριστερά_Χ, πάνω_αριστερά_Ψ; πλάτος, ύψοςζ <br />για παράδειγμα: <code> 20, 60, 80, 40 </ code>
...
$string['pluginname_help'] = 'Οι δείκτες θέσης για μεταφορά και απόθεση απαιτούν από τον αποκρινόμενο να μεταφέρει ταμπέλες κειμένου και να τις αποθέσει σε καθορισμένες ζώνες απόθεσης σε μια εικόνα υπόβαθρου.';
