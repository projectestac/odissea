...
$string['automatedbackupsinactive'] = 'Η προγραμματισμένη λήψη αντιγράφων ασφαλείας δεν έχει ενεργοποιηθεί από το διαχειριστή του ιστοτόπου';
...
$string['configgeneralbadges'] = 'Ορίζει την προεπιλογή για την συμπερίληψη βραβείων στα αντίγραφα ασφαλείας.';
...
$string['configrestorecompetencies'] = 'Ορίζει την προεπιλογή για την αποκατάσταση προσόντων.';
...
$string['confirmnewcoursecontinuequestion'] = 'Ένα προσωρινό (κρυφό) μάθημα θα δημιουργηθεί από τη διαδικασία επαναφοράς μαθήματος. Για να ματαιώσετε την επαναφορά πατήστε Ακύρωση. Μην κλείσετε τον περιηγητή, κατά την επαναφορά.';
...
$string['filereferencesincluded'] = 'Οι αναφορές του αρχείου σε εξωτερικό περιεχόμενο περιλαμβάνονται στο αρχείο αντιγράφου ασφαλείας. Αυτές δεν θα λειτουργούν αν το αντίγραφο ασφαλείας γίνει επεναφορά σε διαφορετικό ιστότοπο.';
$string['filereferencesnotsamesite'] = 'Το αρχείο αντιγράφου ασφαλείας είναι από διαφορετικό ιστότοπο, και έτσι δεν είναι εφικτή η επαναφορά των αναφορών του αρχείου.';
$string['filereferencessamesite'] = 'Το αρχείο αντιγράφου ασφαλείας είναι από αυτόν τον ιστότοπο, και έτσι είναι εφικτή η επαναφορά των αναφορών του αρχείου.';
...
$string['generalbadges'] = 'Συμπερίληψη βραβείων';
...
$string['rootsettingbadges'] = 'Συμπερίληψη βραβείων';
