...
$string['loginlinkmnetuser'] = '<br />Εάν είστε ένας απομακρυσμένος χρήστης του δίκτυου Moodle «MNet» και μπορείτε να <a href="{$a}">επιβεβαιώσετε την διεύθυνση ηλε.ταχυδρομείου σας εδώ</a>, τότε μπορείτε να ανακατευθυνθείτε στη σελίδα σύνδεσής σας.<br />';
