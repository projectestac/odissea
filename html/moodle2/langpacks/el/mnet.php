...
$string['error7024'] = 'Στείλατε ένα μη κρυπτογραφημένο μήνυμα στον απομακρυσμένο ιστότοπο, αλλά ο απομακρυσμένος ιστότοπος δεν δέχεται μη κρυπτογραφημένη επικοινωνία από τον ιστότοπό σας. Αυτό είναι πολύ αναπάντεχο· θα πρέπει πιθανώς να υποβάλλετε μια αναφορά σφάλματος εάν αυτό ξανασυμβεί (παρέχοντας όσο γίνεται περισσότερες πληροφορίες σχετικά με την έκδοση του Moodle, κλπ).';
