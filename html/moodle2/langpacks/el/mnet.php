...
/**
 * Strings for component 'mnet', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   mnet
...
$string['deletewrongkeyvalue'] = 'Συνέβη ένα σφάλμα. Εάν δεν προσπαθείτε να διαγράψετε το κλειδί SSL του εξυπηρετητή σας, είναι πιθανό ότι έχετε πέσει θύμα μιας κακόβουλης επίθεσης. Δεν πραγματοποιήθηκε καμία ενέργεια.';
$string['deny'] = 'Άρνηση';
...
$string['error7020'] = 'Αυτό το σφάλμα συμβαίνει συνήθως εάν ο απομακρυσμένος ιστότοπος έχει δημιουργήσει μια εγγραφή για εσάς με λάθος wwwroot, για παράδειγμα, http://yoursite.com αντί για http://www.yoursite.com. Θα πρέπει να επικοινωνήσετε με τον διαχειριστή του απομακρυσμένου ιστοτόπου και να του δώσετε το σωστό wwwroot (όπως ορίζεται στο αρχείο config.php) ζητώντας του να ενημερώσει την εγγραφή για τον κεντρικό υπολογιστή σας.';
...
$string['loginlinkmnetuser'] = '<br />Εάν είστε έναν απομακρυσμένος χρήστης του Δίκτυου Moodle "MNet" και μπορείτε να <a href="{$a}">επιβεβαιώσετε την διεύθυνση ηλεκτρονικού ταχυδρομείου σας εδώ</a>, τότε μπορείτε να ανακατευθυνθείτε στη σελίδα σύνδεσής σας.<br />';
...
$string['nosuchmodule'] = 'Η συνάρτηση κλήθηκε λανθασμένα και δεν ήταν δυνατή η εύρεση της. Παρακαλούμε χρησιμοποιήστε τη μορφή mod/modulename/lib/functionname.';
...
$string['usernotfullysetup'] = 'Ο λογαριασμός χρήστη σας είναι ανολοκλήρωτος. Πρέπει να μεταβείτε <a href="{$a}"> πίσω στον παροχέα σας </a> και να διασφαλίσετε ότι το προφίλ σας έχει ολοκληρωθεί εκεί. Μπορεί να χρειαστεί να αποσυνδεθείτε και να συνδεθείτε πάλι για να ισχύσει αυτό.';
