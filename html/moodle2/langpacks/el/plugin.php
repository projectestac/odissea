...
/**
 * Strings for component 'plugin', language 'el', branch 'MOODLE_28_STABLE'
 *
 * @package   plugin
...
$string['type_editor_plural'] = 'Συντάκτες';
...
$string['type_gradereport_plural'] = 'Αναφορές βιβλίου βαθμολογιών';
...
$string['type_qbehaviour_plural'] = 'Συμπεριφορά ερωτήσεων';
