...
/**
 * Strings for component 'format_singleactivity', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['activitytype'] = 'Τύπος δραστηριότητας';
$string['activitytype_help'] = 'Επιλέξτε τον τύπο της δραστηριότητας ή του πόρου που θα χρησιμοποιηθεί σε αυτό το μάθημα';
$string['defactivitytype'] = 'Προεπιλεγμένος τύπος δραστηριότητας';
$string['defactivitytypedesc'] = 'Καθορίστε τον τύπο δραστηριότητας που θα επιλεγεί από προεπιλογή κατά τη δημιουργία ενός νέου μαθήματος';
$string['erroractivitytype'] = 'Ο τύπος δραστηριότητας δεν έχει οριστεί στις ρυθμίσεις του μαθήματος';
