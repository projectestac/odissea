...
$string['errorretrievingkey'] = 'Ένα σφάλμα προέκυψε κατά την ανάκτηση του κλειδιού. Ο ιστοτοπός σας πρέπει να καταχωρηθεί για να χρησιμοποιήσετε αυτή την υπηρεσία. Αν ο ιστότοπός σας είναι ήδη καταχωρημένος, παρακαλούμε προσπαθήστε να ενημερώσετε την καταχώρησή σας.';
$string['keyretrievedsuccessfully'] = 'Το κλειδί ανακτήθηκε επιτυχώς';
$string['nodevices'] = 'Καμία καταχωρημένη συσκευή. Οι συσκευές θα εμφανιστούν αυτόματα μετά την εγκατάσταση της εφαρμογής Moodle για κινητά και γίνει η προσθήκη αυτού του ιστοτόπου.';
...
$string['sitemustberegistered'] = 'Για να χρησιμοποιήσετε το δημόσιο στιγμιότυπο Airnotifier, πρέπει να να καταχωρήσετε τον ιστότοπό σας στο Moodle.';
