...
/**
 * Strings for component 'lti', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   lti
...
$string['allow'] = 'Nα επιτρέπεται';
$string['allowsetting'] = 'Nα επιτρέπεται στο εργαλείο να αποθηκεύει 8Κ για ρυθμίσεις στο Moodle';
$string['always'] = 'Πάντα';
$string['autoaddtype'] = 'Προσθήκη εργαλείου';
$string['automatic'] = 'Αυτόματη, βάσει διεύθυνσης εργαλείου';
$string['baseurl'] = 'Βασική διεύθυνση URL/όνομα εγγραφής εργαλείου';
$string['basiclti'] = 'LTI';
...
$string['coursemisconf'] = 'Το μάθημα είναι κακοδιαμορφωμένο';
...
$string['custom_help'] = 'Οι προσαρμοσμένες παράμετροι είναι οι ρυθμίσεις που χρησιμοποιούνται από τον πάροχο εργαλείων. Για παράδειγμα, μπορεί να χρησιμοποιηθεί μια προσαρμοσμένη παράμετρος για την εμφάνιση ενός συγκεκριμένου πόρου από τον πάροχο. Κάθε παράμετρος πρέπει να εισαχθεί σε ξεχωριστή γραμμή με τον μορφότυπο "name = value". για παράδειγμα, "κεφάλαιο=3".
...
$string['duplicateregurl'] = 'Αυτή η διεύθυνση URL εγγραφής είναι ήδη σε χρήση';
...
$string['enableemailnotification'] = 'Αποστολή ειδοποιήσεων μέσω μηνυμάτων ηλ. ταχυδρομείου';
$string['enableemailnotification_help'] = 'Αν ενεργοποιηθεί, οι μαθητές θα λαμβάνουν ειδοποίηση μέσω ηλεκτρονικού ταχυδρομείου όταν βαθμολογούνται οι υποβολές εργαλείων τους.';
...
$string['errorinvalidresponseformat'] = 'Μη έγκυρη μορφή απάντησης περιεχομένου-στοιχείου.';
...
Τρία εικονίδια είναι διαθέσιμα μετά την αναπτυσσόμενη λίστα προεπιλεγμένων εργαλείων:

* ** Προσθήκη ** - Δημιουργία ρυθμίσεων εργαλείου επιπέδου μαθήματος. Όλα τα εξωτερικά στιγμιότυπα εργαλείων σε αυτό το μάθημα μπορεί να χρησιμοποιούν τις ρυθμίσεις του εργαλείου.
* ** Επεξεργασία ** - Επιλέξτε ένα εργαλείο επιπέδου μαθήματος από το αναπτυσσόμενο μενού και, στη συνέχεια, κάντε κλικ σε αυτό το εικονίδιο. Οι λεπτομέρειες των ρυθμίσεων του εργαλείου μπορούν να τροποποιηθούν.
...
$string['fixexistingconf'] = 'Χρησιμοποιήστε ένα υπάρχων σετ ρυθμίσεων για το κακορυθμισμένο στιγμιότυπο';
$string['fixnew'] = 'Νέο σετ ρυθμίσεων';
$string['fixnewconf'] = 'Ορίστε ένα υπάρχων σετ ρυθμίσεων για το κακορυθμισμένο στιγμιότυπο';
...
$string['force_ssl_help'] = 'Η ενεργοποίηση αυτής της επιλογής υποχρεώνει όλες τις εκκινήσεις σε αυτόν τον παροχέα εργαλείων να χρησιμοποιούν SSL. Επιπλέον, όλα τα αιτήματα υπηρεσίας ιστού από τον παροχέα εργαλείων θα χρησιμοποιούν SSL. Εάν χρησιμοποιείτε αυτήν την επιλογή, επιβεβαιώστε ότι αυτός ο ιστότοπος Moodle και ο πάροχος εργαλείων υποστηρίζουν SSL.';
$string['generaltool'] = 'Γενικό εργαλείο';
$string['global_tool_types'] = 'Γενικά προρυθμισμένα εργαλεία';
...
$string['lti:addinstance'] = 'Προσθήκη νέων δραστηριοτήτων εξωτερικού εργαλείου';
...
$string['lti_launch_error_tool_request'] = '<p> Για να υποβάλετε αίτημα για για να ολοκληρώσει ένας διαχειριστής τις ρυθμίσεις εργαλείου, κάντε κλικ <a href="{$a->admin_request_url}" target="_top">εδώ</a>. </p>';
...
* ** Σε εκκρεμότητα ** - Αυτοί οι προμηθευτές εργαλείων καταχωρήθηκαν κατά την εισαγωγή ενός πακέτου, αλλά δεν έχουν ρυθμιστεί από διαχειριστή. Οι διδάσκοντες μπορούν να εξακολουθούν να χρησιμοποιούν εργαλεία από αυτούς τους παρόχους, εάν διαθέτουν κλειδί καταναλωτή και κοινόχρητο μυστικό ή εάν δεν απαιτούνται.
* ** Απορρίπτεται ** - Αυτοί οι παροχείς εργαλείων επισημαίνονται ως αυτοί που ένας διαχειριστής δεν έχει πρόθεση να θέσει στη διάθεση ολόκληρου του στιγμιότυπου του Moodle. Οι διδάσκοντες μπορούν να εξακολουθούν να χρησιμοποιούν εργαλεία από αυτούς τους παρόχους, εάν διαθέτουν κλειδί καταναλωτή και κοινόχρητο μυστικό ή εάν δεν απαιτούνται.';
...
$string['misconfiguredtools'] = 'Εντοπίστηκαν κακοδιαμορφωμένα στιγμιότυπα εργαλείων';
$string['missingparameterserror'] = 'Η σελίδα είναι κακοδιαμορφωμένη: "{$a}"';
...
$string['organization'] = 'Στοιχεία οργανισμού';
$string['organizationdescr'] = 'Περιγραφή οργανισμού';
$string['organizationid'] = 'Αναγνωριστικό οργανισμού';
$string['organizationid_help'] = 'Ένα μοναδικό αναγνωριστικό για αυτό το στιγμιότυπο Moodle. Τυπικά, χρησιμοποιείται το όνομα DNS του οργανισμού. Αν αυτό το πεδίο αφεθεί κενό, το όνομα κεντρικού Η/Υ αυτού του ιστοτόπου Moodle θα χρησιμοποιηθεί ως η προεπιλεγμένη τιμή.';
...
$string['privacy:metadata:email'] = 'Η διεύθυνση ηλεκτρονικού ταχυδρομείου του χρήστη που έχει πρόσβαση στον καταναλωτή LTI';
...
$string['privacy:metadata:lti_submission:datesubmitted'] = 'Η χρονοσφραγίδα που σηματοδοτεί πότε έγινε η υποβολή';
$string['privacy:metadata:lti_submission:dateupdated'] = 'Η χρονοσφραγίδα που σηματοδοτεί πότε τροποποιήθηκε η υποβολή';
...
$string['quickgrade'] = 'Να επιτρέπεται η γρήγορη ταξινόμηση';
...
Αυτό το πεδίο θα πρέπει να εισαχθεί αν δημιουργήσετε μια σύνδεση με έναν παροχέα εργαλείων ο οποίος δεν έχει ήδη ρυθμιστεί.
...
Το κλειδί του καταναλωτή μπορεί να θεωρηθεί ως όνομα χρήστη που χρησιμοποιείται για την επαλήθευση της πρόσβασης στο εργαλείο. Μπορεί να χρησιμοποιηθεί από τον παροχέα εργαλείων για να προσδιορίσει με μοναδικό τρόπο την τοποθεσία Moodle από την οποία οι χρήστες ξεκινούν το εργαλείο.
...
$string['share_email'] = 'Κοινοποίηση στο εργαλείο της διεύθυνσης ηλεκτρονικού ταχυδρομείου αυτού που έκανε την εκκίνηση';
$string['share_email_admin'] = 'Κοινοποίηση στο εργαλείο της διεύθυνσης ηλεκτρονικού ταχυδρομείου αυτού που έκανε την εκκίνηση';
$string['share_email_admin_help'] = 'Καθορίστε εάν η διεύθυνση ηλεκτρονικού ταχυδρομείου του χρήστη που θα εκκινήσει το εργαλείο θα μοιραστεί με τον πάροχο των εργαλείων. Ο πάροχος εργαλείων μπορεί να χρειαστεί τις διευθύνσεις ηλεκτρονικού ταχυδρομείου του χρήστη που θα εκκινήσει το εργαλείο για να διακρίνει μεταξύ χρηστών με ίδιο όνομα στο περιβάλλον εργασίας ή να στέλνει μηνύματα ηλεκτρονικού ταχυδρομείου στους χρήστες με βάση τις ενέργειες μέσα στο εργαλείο.';
$string['share_email_help'] = 'Καθορίστε εάν η διεύθυνση ηλεκτρονικού ταχυδρομείου του χρήστη που ξεκινά το εργαλείο θα μοιράζεται με τον πάροχο του εργαλείου.

Ο πάροχος του εργαλείου μπορεί να χρειάζεται τις διευθύνσεις ηλεκτρονικού ταχυδρομείου αυτών που ξεκινούν το εργαλείο για να διακρίνει χρήστες με το ίδιο όνομα, ή να στέλνει μηνύματα ηλεκτρονικού ταχυδρομείου σε χρήστες βασισμένος σε ενέργειες εντός του εργαλείου.
...
$string['show_in_course_lti1_help'] = 'Αυτό το εργαλείο μπορεί να εμφανιστεί στον επιλογέα δραστηριότητας για να το επιλέξει ένας διδάσκων, να το προσθέσει σε ένα μάθημα. Εναλλακτικά, μπορεί να εμφανιστεί στο αναπτυσσόμενο μενού των προ-ρυθμισμένων εργαλείων κατά την προσθήκη ενός εξωτερικού εργαλείου σε ένα μάθημα. Μια άλλη επιλογή είναι οι ρυθμίσεις του εργαλείου να χρησιμοποιούνται μόνο αν εισαχθεί η ακριβής διεύθυνση URL του εργαλείου κατά την προσθήκη ενός εξωτερικού εργαλείου σε ένα μάθημα.';
$string['show_in_course_lti2'] = 'Χρήση ρυθμίσεων εργαλείου';
$string['show_in_course_lti2_help'] = 'Αυτό το εργαλείο μπορεί να εμφανιστεί στον επιλογέα δραστηριότητας για να το επιλέξει ένας διδάσκων να το προσθέσει σε ένα μάθημα ή στο αναπτυσσόμενο μενού προδιαμορφωμένου εργαλείου όταν προστίθεται ένα εξωτερικό εργαλείο σε ένα μάθημα.';
...
$string['successfullyfetchedtoolconfigurationfromcontent'] = 'Επιτυχής ανάκτηση ρυθμίσεων εργαλείου από το επιλεγμένο περιεχόμενο.';
...
$string['toolproxy_help'] = 'Οι εξωτερικές καταχωρίσεις εργαλείων επιτρέπουν στους διαχειριστές ιστότοπων Moodle να διαμορφώνουν εξωτερικά εργαλεία μέσω ενός διακομιστή μεσολάβησης εργαλείων που αντλεί ρυθμίσεις από έναν παροχέα (εξυπηρετητή) εργαλείων που υποστηρίζει το LTI 2.0. Μια διεύθυνση URL καταχώρισης που παρέχεται από τον παροχέα εργαλείων είναι το μόνο που απαιτείται για την έναρξη της διαδικασίας. Οι δυνατότητες και οι υπηρεσίες που προσφέρονται στον παροχέα εργαλείων επιλέγονται κατά τη διαμόρφωση μιας νέας εγγραφής. Οι καταχωρήσεις εργαλείων που αναφέρονται στην λίστα αυτής της σελίδας χωρίζονται σε τέσσερις κατηγορίες:

* ** Διαμορφωμένες ** - Αυτές οι καταχωρήσεις εργαλείων έχουν ρυθμιστεί αλλά η διαδικασία εγγραφής δεν έχει ξεκινήσει ακόμα.
* ** Εκκρεμείς ** - Η διαδικασία εγγραφής για αυτές τις καταχωρήσεις εργαλείων έχει ξεκινήσει αλλά δεν έχει ολοκληρωθεί. Ανοίξτε και αποθηκεύστε τις ρυθμίσεις για να μετακινηθείτε πίσω στην κατηγορία «Διαμορφωμένες».
...
* ** Απορρίφθηκαν ** - Αυτές οι καταχωρήσεις εργαλείων είναι αυτές που απορρίπτονται κατά τη διαδικασία εγγραφής. Ανοίξτε και αποθηκεύστε τις ρυθμίσεις για να μετακινηθείτε πίσω στην κατηγορία «Διαμορφωμένες», έτσι ώστε να είναι δυνατή η επανεκκίνηση της διαδικασίας εγγραφής.';
...
$string['typename_help'] = 'Το όνομα του εργαλείου χρησιμοποιείται για να ταυτοποιεί τον πάροχο του εργαλείου μέσα στο Moodle. Το όνομα που καταχωρείται θα είναι ορατό στους διδάσκοντες όταν προσθέτουν εξωτερικά εργαλεία μέσα στα μαθήματ.';
$string['types'] = 'Τύποι';
