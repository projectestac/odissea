...
/**
 * Strings for component 'lti', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   lti
...
$string['main_admin_help'] = 'Τα εξωτερικά εργαλεία επιτρέπουν στους χρήστες του Moodle να αλληλεπιδρούν με μαθησιακούς πόρους που φιλοξενούνται σε άλλο κεντρικό Η/Υ. Μέσω ενός ειδικού πρωτοκόλλου εκκίνησης, το απομακρυσμένο εργαλείο έχει πρόσβαση σε γενικές πληροφορίες σχετικά με τον χρήστη που ζητά την εκκίνηση. Για παράδειγμα, το όνομα του ιδρύματος, το αναγνωριστικό μαθήματος, το αναγνωριστικό χρήστη και άλλες πληροφορίες, όπως το όνομα χρήστη ή η διεύθυνση ηλεκτρονικού ταχυδρομείου.
