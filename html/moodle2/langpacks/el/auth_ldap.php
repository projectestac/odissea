...
/**
 * Strings for component 'auth_ldap', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_ldap
...
$string['auth_ldapdescription'] = 'Αυτή η μέθοδος παρέχει αυθεντικοποίηση μέσω (έναντι) ενός εξωτερικού εξυπηρετητή LDAP. Εάν το δοσμένο όνομα χρήστη και ο κωδικός πρόσβασης ισχύουν, το Moodle δημιουργεί μια νέα καταχώρηση χρήστη στη βάση δεδομένων του. Αυτό το άρθρωμα μπορεί να διαβάσει τα ιδιοχαρακτηριστικά χρηστών από τον LDAP και να συμπληρώσει εκ των προτέρων τα ζητούμενα πεδία στο Moodle. Για τις επόμενες συνδέσεις μόνο το όνομα χρήστη και ο κωδικός πρόσβασης ελέγχονται.';
...
$string['auth_ldap_gracelogins_desc'] = 'Ενεργοποίηση της υποστήριξης grace login (συνδέσεις χάριτος μετά τη λήξη) του LDAP. Αφού λήξει ο κωδικός πρόσβασης ο χρήστης μπορεί να συνδεθεί μέχρι το grace login να φθάσει το 0. Ενεργοποιώντας αυτή τη ρύθμιση θα εμφανίζεται ένα μήνυμα grace login εάν ο κωδικός πρόσβασης έχει λήξει. ((Μόνο για Novell eDirectory.))';
...
$string['auth_ldap_ldap_encoding'] = 'Καθορίστε την κωδικοποίηση που θα χρησιμοποιείται από τον εξυπηρετητή LDAP. Πιθανότατα utf-8. Το MS AD v2 (Active Directory της Microsoft έκδοση 2) χρησιμοποιεί προεπιλεγμένη κωδικοποίηση πλατφόρμας π.χ. cp1252, cp1250, κλπ.';
...
$string['auth_ldap_memberattribute_isdn'] = 'Προαιρετικό: Απαγορεύει τη διαχείριση των τιμών του χαρακτηριστικού member (μέλος). Είτε 0 είτε 1.';
...
$string['morethanoneuser'] = 'Παράξενο!  Περισσότερες από μία εγγραφές χρήστη βρέθηκαν στο LDAP. Χρησιμοποιήστε μόνο την πρώτη.';
...
$string['systemrolemapping'] = 'Αντιστοίχηση ρόλου συστήματος';
...
$string['updatepasserrorexpiregrace'] = 'Σφάλμα στο user_update_password() κατά την τροποποίηση του χρόνου λήξης και/ή των συνδέσεων χάριτος μετά τη λήξη. Κωδικός σφάλματος: {$a->errno}. Μήνυμα σφάλματος: {$a->errstring}';
