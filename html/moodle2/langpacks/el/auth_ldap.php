...
$string['auth_ntlmsso_ie_fastpath'] = 'Ορίστε το σε ναι για να ενεργοποιήσετε τη γρήγορη διαδρομή του NTLM SSO (παρακάμπτει ορισμένα βήματα και δουλεύει μόνο με περιηγητή MS Internet Explorer).';
