...
$string['nosubmissions'] = 'Δεν υπάρχουν υποβολές για αυτό το εργαστήριο';
...
$string['strategy_help'] = 'Η στρατηγική βαθμολόγησης καθορίζει την μορφή αξιολόγησης που χρησιμοποιείται και τη μέθοδο βαθμολόγησης των υποβολών. Υπάρχουν 4 επιλογές: * Αθροιστική βαθμολόγηση - Δίνονται σχόλια και ένα βαθμός σύμφωνα με τις καθορισμένες πτυχές * Σχόλια - Σχόλια δίνονται σύμφωνα με τις καθορισμένες πτυχές αλλά βαθμός δεν μπορεί να δοθεί * Αριθμός λαθών - Δίνονται σχόλια και μια αξιολόγηση τύπου ναι/όχι σύμφωνα με τους  καθορισμένους ισχυρισμούς * Κριτήρια αξιολόγησης - Ένα επίπεδο αξιολόγησης δίνεται σύμφωνα με τα καθορισμένα κριτήρια';
...
$string['subplugintype_workshopallocation_plural'] = 'Μέθοδοι κατανομής υποβολών';
...
$string['useexamples_desc'] = 'Παρέχονται παραδείγματα από υποβολές για εξάσκηση των εκπαιδευομένων στην αξιολόγηση';
$string['useexamples_help'] = 'Αν είναι ενεργοποιημένο, οι χρήστες μπορούν να προσπαθήσουν να αξιολογήσουν ένα ή περισσότερα παραδείγματα που έχουν υποβληθεί και να συγκρίνουν τις αξιολογήσεις τους με την αναφορά αξιολόγησης. Ο βαθμός δεν υπολογίζεται στον βαθμό αξιολόγησης.';
...
$string['usepeerassessment_help'] = 'Αν είναι ενεργοποιημένο, ένας χρήστης μπορεί να επιβλέψει την υποβολή άλλων εκπαιδευομένων για να τις αξιολογήσει και θα λάβει ένα βαθμό για αξιολόγηση που θα κάνει, εκτός του βαθμού για την δική του υποβολή.';
$string['useselfassessment'] = 'Χρήση αυτό-αξιολόγησης';
...
$string['workshop:overridegrades'] = 'Παράκαμψη των calculated βαθμολογιών';
