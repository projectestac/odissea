...
$string['privacy:metadata:database:question_attempt_steps'] = 'Κάθε προσπάθεια ερωτήσεων έχει έναν αριθμό βημάτων που υποδεικνύουν τις διάφορες φάσεις από την αρχή έως την ολοκλήρωση της βαθμολόγησης. Αυτός ο πίνακας αποθηκεύει τις πληροφορίες για κάθε ένα από αυτά τα βήματα.';
