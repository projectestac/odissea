...
/**
 * Strings for component 'userkey', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   userkey
...
$string['createnewkey'] = 'Δημιουργία νέου κλειδιού χρήστη';
$string['createuserkey'] = 'Δημιουργία κλειδιού χρήστη';
$string['deletekeyconfirm'] = 'Θέλετε σίγουρα να διαγράψετε αυτό το κλειδί χρήστη;';
$string['edituserkey'] = 'Επεξεργασία κλειδιού χρήστη';
$string['keyiprestriction'] = 'Περιορισμοί IP διεύθυνσης για το κλειδί';
$string['keyiprestriction_help'] = 'Εισαγάγετε μια συγκεκριμένη διεύθυνση IP ή μια περιοχή διευθύνσεων IP που θα είναι οι μόνες διευθύνσεις IP που έχουν πρόσβαση σε αυτά τα δεδομένα. Αφήστε κενό για να απενεργοποιήσετε τον περιορισμό IP (δεν συνιστάται).';
$string['keymanager'] = 'Διαχείριση κλειδιών';
$string['keyvaliduntil'] = 'Το κλειδί ισχύει μέχρι';
...
$string['privacy:metadata:user_private_key:validuntil'] = 'Η ημερομηνία μέχρι την οποία είναι έγκυρο το ιδιωτικό κλειδί';
