...
$string['allowaccountssameemail'] = 'Επιτρέπονται λογαριασμοί με την ίδια διεύθυνση ηλ. ταχυδρομείου';
$string['allowaccountssameemail_desc'] = 'Αν ενεργοποιηθεί, τότε πολλοί χρήστες θα έχουν την ίδια διεύθυνση ηλ. ταχυδρομείου. Αυτό μπορεί να οδηγήσει σε προβλήματα ασφάλειας ή ιδιωτικότητας, όπως για παράδειγμα, σε περίπτωση αλλαγής του κωδικού πρόσβασης.';
...
$string['auth_data_mapping'] = 'Aντιστοίχιση πεδίων';
...
$string['auth_fieldmapping'] = 'Aντιστοίχιση πεδίων ({$a})';
...
$string['authloginviaemail_desc'] = 'Επιτρέψτε στους χρήστες να χρησιμοποιούν εκτός από το όνομα χρήστη και την διεύθυνση ηλ.ταχυδρομείου (αν είναι μοναδική) για σύνδεση στον ιστότοπο.';
...
$string['auth_remove_user'] = 'Καθορίστε τι πρέπει να γίνει με τον εσωτερικό λογαριασμό χρήστη κατά τη διάρκεια μαζικού συγχρονισμού όταν ο χρήστης έχει αφαιρεθεί από την εξωτερική πηγή. Μόνο οι χρήστες σε αναστολή γίνονται επεναφορά αυτόματα αν επανεμφανιστούν στην εξωτερική πηγή.';
$string['auth_remove_user_key'] = 'Ο εξωτερικός χρήστης διαγράφηκε';
$string['auth_sync_script'] = 'Συγχρονισμός λογαριασμών χρηστών (μέσω μιας δέσμης ενεργειών χρονοπρογραμματισμού cron)';
$string['auth_sync_suspended'] = 'Εάν ενεργοποιηθεί, το ιδιοχαρακτηριστικό αναστολής θα χρησιμοποιηθεί για την ενημέρωση της κατάστασης αναστολής λογαριασμού τοπικού χρήστη.';
...
$string['auth_updateremote_ldap'] = '<p><b>Σημείωση:</b> Η ενημέρωση εξωτερικών LDAP δεδομένων απαιτεί να ορίσετε τα binddn και bindpw σε έναν bind-user με επιπλέον προνόμια σε όλες τις εγγραφές των χρηστών.  Επί του παρόντος δεν διατηρεί ιδιοχαρακτηριστικά με πολλαπλές τιμές και αφαιρεί πλεονάζουσες τιμές κατά την ενημέρωση. </p>';
$string['auth_user_create'] = 'Να επιτρέπεται η δημιουργία χρηστών';
$string['auth_user_creation'] = 'Νέοι (ανώνυμοι) χρήστες μπορούν να δημιουργήσουν λογαριασμούς χρηστών στο εξωτερικό σημείο πιστοποίησης και να τους επιβεβαιώσουν μέσω ηλεκτρονικού ταχυδρομείου. Αν το ενεργοποιήσετε αυτό, θυμηθείτε επίσης να επεξεργαστείτε τις επιλογές κάθε συγκεκριμένου αρθρώματος για δημιουργία χρηστών.';
...
$string['changepasswordhelp'] = 'Διεύθυνση URL σελίδας ανάκτησης κωδικού πρόσβασης, που θα αποστέλλεται στους χρήστες με μήνυμα ηλ. ταχυδρομείου. Σημειώστε ότι αυτή η ρύθμιση δεν θα έχει κανένα αποτέλεσμα αν μια διεύθυνση URL για ξεχασμένους κωδικούς πρόσβασης έχει οριστεί στις κοινές ρυθμίσεις αυθεντικοποίησης.';
...
$string['createpasswordifneeded'] = 'Δημιουργία κωδικού πρόσβασης αν χρειαστεί και αποστολή μέσω μηνύματος ηλεκτρονικού ταχυδρομείου';
$string['emailchangecancel'] = 'Ακύρωση αλλαγής διεύθυνσης ηλ.ταχυδρ.';
...
$string['emailupdatemessage'] = 'Αγαπητέ χρήστη {$a->fullname}, Ζητήσατε μια αλλαγή της διεύθυνσης σας ηλεκτρονικού ταχυδρομείου για το λογαριασμό σας στο {$a->site}. Παρακαλούμε ανοίξτε την παρακάτω διεύθυνση URL στον περιηγητή σας για να επιβεβαιώσετε αυτή την αλλαγή:{$a->url} <br /> Αν έχετε οποιαδήποτε ερώτηση, παρακαλούμε επικοινωνήστε με την υποστήριξη (του ιστοτόπου): {$a->supportemail}';
...
$string['limitconcurrentlogins_desc'] = 'Αν ενεργοποιηθεί, ο αριθμός των σύγχρονων συνδέσεων περιηγητή περιορίζεται. Η παλαιότερη συνόδος τερματίζεται μόλις ξεπεραστεί το όριο. Παρακαλούμε σημειώστε ότι οι χρήστες μπορεί να χάσουν όλη την μη αποθηκευμένη εργασία τους. Αυτή η ρύθμιση είναι ασύμβατη με πρόσθετα αυθεντικοποίησης SSO (single sign-on: μία και μόνον ενιαία αυθεντικοποίηση).';
...
(NTLM =NT LAN Manager: διαχείριστής τοπικού δικτύου των Microsoft NT) (SSO=Single sign-on: μία και μόνον ενιαία αυθεντικοποίηση)';
...
$string['privacy:metadata:userpref:createpassword'] = 'Υποδεικνύει ότι πρέπει να δημιουργηθεί ένας κωδικός πρόσβασης για τον χρήστη';
$string['privacy:metadata:userpref:forcepasswordchange'] = 'Καθορίζει αν ο χρήστης πρέπει να αλλάξει τον κωδικό πρόσβασης κατά τη σύνδεση';
...
$string['privacy:metadata:userpref:loginlockoutignored'] = 'Υποδεικνύει ότι ο λογαριασμός ενός χρήστη δεν πρέπει ποτέ να υπόκειται σε αποκλεισμούς';
...
$string['recaptcha_link'] = 'αυθεντικοποίηση/ηλεκτρονικό ταχυδρομείο';
$string['security_question'] = 'Ερώτηση ασφαλείας';
$string['selfregistration'] = 'Self registration';
$string['selfregistration_help'] = 'Αν επιλεγεί ένα πρόσθετο αυθεντικοποίησης, όπως η αυτο-καταχώρηση με χρήση ηλεκτρονικού ταχυδρομείου, τότε επιτρέπει σε πιθανούς χρήστες να αυτο-καταχωρούνται και να δημιουργούν λογαριασμούς. Αυτό δίνει δυνατότητα σε ανεπιθύμητους να δημιουργούν λογαριασμούς για να στέλνουν ανεπιθύμητα μηνύματα μέσω δημοσιεύσεων σε φόρουμ, αναρτήσεων σε ιστολόγια κλπ. Για να αποφύγετε αυτόν τον κίνδυνο, η αυτο-καταχώρηση πρέπει να απενεργοποιείται ή να περιορίζεται με τη ρύθμιση <em>Επιτρεπόμενοι τομείς διευθύνσεων ηλεκτρονικού ταχυδρομείου</em>.';
$string['settingmigrationmismatch'] = 'Εντοπίστηκε αναντιστοιχία τιμών κατά τη διόρθωση των ονομάτων των ρυθμίσεων του πρόσθετου. Το πρόσθετο αυθεντικοποίησης «{$a->plugin}» είχε τη ρύθμιση «{$a->setting}» διαμορφωμένη σε «{$a->legacy}» με το όνομα παλαιού τύπου και σε «{$a->current}» με το τρέχον όνομα. Η τελευταία τιμή έχει οριστεί ως η έγκυρη αλλά θα πρέπει να ελέγξετε και να επιβεβαιώσετε ότι είναι αποδεκτή.';
...
$string['stdchangepassword_explldap'] = 'Σημείωση: Προτείνεται να χρησιμοποιήσετε LDAP πάνω από ένα SSL κρυπτογραφημένο τούνελ (ldaps://) εάν ο εξυπηρετητής LDAP είναι απομακρυσμένος.';
