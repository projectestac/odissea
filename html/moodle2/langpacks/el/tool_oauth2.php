...
/**
 * Strings for component 'tool_oauth2', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   tool_oauth2
...
$string['authconnected'] = 'Ο λογαριασμός συστήματος είναι πλέον συνδεδεμένος για πρόσβαση χωρίς σύνδεση';
...
$string['createfromtemplate'] = 'Δημιουργία μιας υπηρεσίας OAuth 2 από ένα πρότυπο';
$string['createfromtemplatedesc'] = 'Επιλέξτε ένα από τα πρότυπα υπηρεσιών OAuth 2 παρακάτω για να δημιουργήσετε μια υπηρεσία OAuth με έγκυρες ρυθμίσεις για έναν από τους γνωστούς τύπους υπηρεσιών. Αυτό θα δημιουργήσει την υπηρεσία OAuth 2, με όλα τα σωστά τελικά σημεία και τις παραμέτρους που απαιτούνται για τον έλεγχο ταυτότητας, παρόλο που θα χρειαστεί να εισάγετε το αναγνωριστικό πελάτη και μυστικό για τη νέα υπηρεσία πριν να μπορέσετε να το χρησιμοποιήσετε.';
...
$string['issuerloginparamsoffline'] = 'Επιρόσθετες παράμετροι που περιλαμβάνονται σε ένα αίτημα σύνδεσης για πρόσβαση χωρίς σύνδεση.';
$string['issuerloginparamsoffline_help'] = 'Κάθε σύστημα αυθεντικοποίησης OAuth ορίζει ένα διαφορετικό τρόπο αιτήματος πρόσβασης χωρίς σύνδεση. Π.χ. Η Google απαιτεί τις επιπρόσθετες παραμέτρους: «access_type=offline&prompt=consent». Αυτές οι παράμετροι θα πρέπει να είναι σε μορφότυπο παραμέτρων ερωτημάτων διευθύνσεων ιστού URL.';
...
$string['issuerloginscopesoffline'] = 'Εμβέλειες που περιλαμβάνονται σε ένα αίτημα σύνδεσης για πρόσβαση χωρίς σύνδεση.';
$string['issuerloginscopesoffline_help'] = 'Κάθε σύστημα αυθεντικοποίησης OAuth ορίζει ένα διαφορετικό τρόπο αιτήματος πρόσβασης χωρίς σύνδεση. Π.χ. Η Microsoft απαιτεί μια επιπρόσθετη εμβέλεια με όνομα «offline_access» (πρόσβαση χωρίς σύνδεση).';
$string['issuername'] = 'Όνομα';
$string['issuername_help'] = 'Όνομα του εκδότη ταυτότητας. Μπορεί να εμφανιστεί στη σελίδα σύνδεσης.';
$string['issuerrequireconfirmation'] = 'Απαιτείται εξακρίβωση διεύθυνσης ηλεκτρονικού ταχυδρομείου';
$string['issuerrequireconfirmation_help'] = 'Να απαιτείται να επαληθεύουν όλοι οι χρήστες τη διεύθυνσή τους ηλεκτρονικού ταχυδρομείου πριν μπορέσουν να συνδεθούν με το OAuth. Αυτό ισχύει για νεοδημιουργημένους λογαριασμούς στο πλαίσιο της διαδικασίας σύνδεσης ή όταν ένας υπάρχων λογαριασμός Moodle συνδέεται με μια σύνδεση OAuth μέσω διευθύνσεων ηλεκτρονικού ταχυδρομείου που ταιριάζουν.';
