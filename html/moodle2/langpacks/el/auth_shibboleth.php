...
$string['auth_shibbolethdescription'] = 'Με αυτήν την μέθοδο οι χρήστες δημιουργούνται και πιστοποιούνται χρησιμοποιώντας το <a href="http://shibboleth.internet2.edu/" target="_blank">Shibboleth</a>.<br> Δείτε το <a href="../auth/shibboleth/README.txt">README</a> σχετικά με το πως να ρυθμίσετε το Moodle με το Shibboleth.';
...
$string['auth_shib_username_description'] = 'Όνομα της μεταβλητής περιβάλλοντος του διακομιστή διαδικτύου Shibboleth που θα χρησιμοποιηθεί ως όνομα χρήστη στο Moodle.';
...
$string['shib_no_attributes_error'] = 'Φαίνεται πως έχετε πιστοποιηθεί με το Shibboleth αλλά το Moodle δεν έχει λάβει στοιχεία χρήστη. Παρακαλώ ελέγξτε ότι ο Παροχέας Ταυτότητας αποστέλλει τα απαραίτητα στοιχεία ({$a}) στον Παροχέα Υπηρεσιών που τρέχει το Moodle ή ενημερώστε τον διαχειριστή αυτού του διακομιστή.';
$string['shib_not_all_attributes_error'] = 'Το Moodle χρειάζεται κάποια στοιχεία Shibboleth που δεν υπάρχουν στην περίπτωσή σας. Τα στοιχεία είναι: {$a}<br />Παρακαλώ επικοινωνήστε με τον διαχειριστή αυτού του διακομιστή ή τον Παροχέα Ταυτότητας.';
$string['shib_not_set_up_error'] = 'Η αυθεντικοποίηση Shibboleth δεν έχει εγκατασταθεί σωστά επειδή δεν είναι υπάρχουν οι μεταβλητές περιβάλλοντος του Shibboleth σε αυτή τη σελίδα. Παρακαλώ δείτε το <a href="README.txt">README</a> για περισσότερες οδηγίες σχετικά με το πως να ρυθμίσετε την αυθεντικοποίηση Shibboleth ή επικοινωνήστε με το διαχειριστή του Moodle.';
