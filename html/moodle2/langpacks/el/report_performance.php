...
/**
 * Strings for component 'report_performance', language 'el', branch 'MOODLE_34_STABLE'
 *
...
$string['check_backup_comment_disable'] = 'Η απόδοση ενδέχεται να επηρεαστεί κατά τη διάρκεια της διαδικασίας δημιουργίας αντιγράφων ασφαλείας. Εάν ενεργοποιηθεί, τα αντίγραφα ασφαλείας πρέπει να προγραμματιστούν για ώρες εκτός αιχμής.';
$string['check_backup_comment_enable'] = 'Η απόδοση ενδέχεται να επηρεαστεί κατά τη διάρκεια της διαδικασίας δημιουργίας αντιγράφων ασφαλείας. Τα αντίγραφα ασφαλείας πρέπει να προγραμματιστούν για ώρες εκτός αιχμής.';
...
$string['check_cachejs_details'] = 'Η αποθήκευση σε κρυφή μνήμη και η συμπίεση της Javascript βελτιώνει σημαντικά την ταχύτητα φόρτωσης σελίδας. Συνιστάται ιδιαίτερα στους ιστοτόπους παραγωγής.';
...
$string['check_debugmsg_details'] = 'Σπάνια υπάρχει κάποιο πλεονέκτημα στο να πηγαίνετε στο επίπεδο προγραμματιστή, εκτός αν είστε προγραμματιστής, οπότε συνιστάται έντονα.<p>Μόλις λάβετε το μήνυμα σφάλματος και το αντιγράψετε και το επικολλήσετε κάπου, ΣΥΝΙΣΤΑΤΑΙ έντονα να γυρίσει το Debug πίσω στο NONE. Τα μηνύματα εντοπισμού σφαλμάτων μπορούν να δώσουν ενδείξεις σε έναν χάκερ ως προς τη ρύθμιση του ιστότοπού σας και ενδέχεται να επηρεάσουν την απόδοση.</p>';
...
$string['check_themedesignermode_comment_disable'] = 'Εάν ενεργοποιηθεί, οι εικόνες και τα φύλλα στυλ δεν θα αποθηκεύονται προσωρινά, με αποτέλεσμα σημαντική υποβάθμιση της απόδοσης.';
$string['check_themedesignermode_comment_enable'] = 'Αν απενεργοποιηθεί, οι εικόνες και τα φύλλα στυλ θα αποθηκεύονται προσωρινά, με αποτέλεσμα σημαντικές βελτιώσεις στην απόδοση.';
$string['check_themedesignermode_details'] = 'Αυτή είναι συχνά η αιτία αργών ιστοτόπων Moodle. <p>Κατά μέσο όρο μπορεί να χρειαστεί τουλάχιστον διπλάσιος χρόνος επεξεργαστή (CPU) για την επεξεργασία ενός ιστοτόπου Moodle με ενεργοποιημένη τη λειτουργία σχεδιασμού θέματος.</p>';
...
$string['performance:view'] = 'Προβολή αναφοράς απόδοσης';
