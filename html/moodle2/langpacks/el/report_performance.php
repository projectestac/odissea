...
$string['check_debugmsg_details'] = 'Σπάνια υπάρχει κάποιο πλεονέκτημα στο να πηγαίνετε στο επίπεδο προγραμματιστή, εκτός αν είστε προγραμματιστής, οπότε συνιστάται έντονα.<p>Μόλις λάβετε το μήνυμα σφάλματος και το αντιγράψετε και το επικολλήσετε κάπου, ΣΥΝΙΣΤΑΤΑΙ έντονα να γυρίσετε το Debug πίσω στο NONE. Τα μηνύματα εντοπισμού σφαλμάτων μπορούν να δώσουν ενδείξεις σε έναν χάκερ ως προς τη ρύθμιση του ιστοτόπου σας και ενδέχεται να επηρεάσουν την απόδοση.</p>';
