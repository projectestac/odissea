...
$string['display_help'] = 'Εάν επιλέξετε να εμφανίσετε τα περιεχόμενα του φακέλου σε μια σελίδα μαθήματος, δεν θα υπάρχει σύνδεσμος σε ξεχωριστή σελίδα. Η περιγραφή θα εμφανιστεί μόνο αν έχει επιλεγεί η «Εμφάνιση περιγραφής στη σελίδα του μαθήματος». <br /> Σημειώστε επίσης ότι οι ενέργειες εμφάνισης των συμμετεχόντων δεν μπορούν να καταγραφούν στην περίπτωση αυτή.';
...
$string['noautocompletioninline'] = 'Δεν είναι δυνατή η επιλογή της αυτόματης ολοκλήρωσης κατά την προβολή της δραστηριότητας μαζί με την επιλογή «Ένθετη προβολή»';
