...
/**
 * Strings for component 'repository_url', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'To πρόσθετο «Λήψη (εικόνων) από διεύθυνση URL» δεν αποθηκεύει ούτε μεταβιβάζει κανένα προσωπικό δεδομένο.';
$string['rename'] = 'Όνομα';
