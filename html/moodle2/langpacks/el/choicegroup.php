...
/**
 * Strings for component 'choicegroup', language 'el', branch 'MOODLE_30_STABLE'
 *
 * @package   choicegroup
...
Μπορείτε να εισάγετε οποιοδήποτε πλήθος επιλογών. Αν αφήσετε κάποιες κενές δεν θα εμφανίζονται. Για περισσότερες επιλογές πατήστε το κουμπί "Προσθήκη 3 πεδίων στη φόρμα".';
...
$string['members/'] = 'Πληρότητα';
$string['members/max'] = 'Πληρότητα / Χωρητικότητα';
$string['modulename'] = 'Επιλογή ομάδας';
$string['modulename_help'] = 'Το module επιλογής επιτρέπει στον διδάσκοντα να θέσει μία ερώτηση και να ορίσει μια επιλογή μεταξύ πολλών απαντήσεων.';
