...
$string['configsyncfiletimeout'] = 'Λήξη χρόνου σε δευτερόλεπτα για συγχρονισμό του μεγέθους του εξωτερικού αρχείου.';
$string['configsyncimagetimeout'] = 'Λήξη χρόνου σε δευτερόλεπτα για λήψη ενός αρχείου εικόνας από εξωτερικό αποθετήριο κατά το συγχρονισμό.';
...
$string['confirmremove'] = 'Είστε σίγουροι οτι θέλετε να διαγράψετε αυτό το πρόσθετο αποθετηρίου, τις επιλογές του και <strong>όλα τα στιγμιότυπά του</strong> - {$a}; Αν επιλέξετε «Συνέχεια και λήψη», θα γίνει λήψη στο Moodle των αναφορών αρχείων σε εξωτερικά περιεχόμενα. Αυτό θα μπορούσε να πάρει πολύ χρόνο για επεξεργασία.';
...
$string['detailview'] = 'Προβολή λεπτομερειών';
...
$string['help'] = 'Βοήθεια';
$string['iconview'] = 'Προβολή ως εικονίδια';
...
$string['nopathselected'] = 'Δεν επιλέχθηκε ακόμη διαδρομή προορισμού (κάντε διπλό κλικ σε ένα κόμβο του δέντρου για να επιλέξετε)';
