...
$string['availablefromdate'] = 'Διαθέσιμη από';
$string['availabletags'] = 'Διαθέσιμες ετικέτες';
$string['availabletags_help'] = 'Οι ετικέτες είναι δεσμευτικά θέσης στη φόρμα, που θα αντικατασταθούν από δεδομένα ή άλλα στοιχεία, όπως ένα εικονίδιο επεξεργασίας, όταν γίνεται προβολή ή επεξεργασία της καταχώρησης. Τα πεδία έχουν το μορφότυπο [[fieldname]]. Όλες οι άλλες ετικέτες έχουν το μορφότυπο ##sometag##. Μόνο οι ετικέτες που είναι στην λίστα "Available tags" μπορούν να χρησιμοποιηθούν στην τρέχουσα φόρμα.';
...
$string['cannotdeletepreset'] = 'Σφάλμα κατά τη διαγραφή ενός προτύπου!';
$string['cannotoverwritepreset'] = 'Σφάλμα κατά τη αντικατάσταση προτύπου!';
$string['cannotunziptopreset'] = 'Δεν είναι δυνατή η αποσυμπίεση στον κατάλογο των προτύπων';
$string['checkbox'] = 'Πλαίσιο ελέγχου';
...
$string['chooseorupload'] = 'Επιλέξτε αρχείο';
...
$string['deletewarning'] = 'Σίγουρα θέλετε να διαγράψετε αυτό το πρότυπο;';
...
$string['errorpresetexists'] = 'Υπάρχει ήδη ένα πρότυπο με το επιλεγμένο όνομα';
...
$string['exportaszip_help'] = 'Η λειτουργία εξαγωγής ως συμπιεσμένο αρχείο (zip) σας επιτρέπει να αποθηκεύσετε τις φόρμες και τα πεδία ως ένα πρότυπο zip έτοιμο προς λήψη. Το (ληφθέν) zip μπορεί κατόπιν να εισαχθεί σε κάποιο άλλο μάθημα.';
...
$string['failedpresetdelete'] = 'Σφάλμα κατά τη διαγραφή ενός προτύπου!';
...
$string['fieldmappings_help'] = 'Αυτό το μενού σας επιτρέπει να διατηρείτε τα δεδομένα από την υπάρχουσα βάση δεδομένων. Για να διατηρήσετε τα δεδομένα σε ένα πεδίο, πρέπει να το αντιστοιχίσετε σε ένα νέο πεδίο, όπου θα εμφανιστούν τα δεδομένα. Οποιοδήποτε πεδίο μπορεί επίσης να παραμείνει κενό, χωρίς να αντιγραφούν καθόλου πληροφορίες μέσα σε σε αυτό. Οποιοδήποτε παλιό πεδίο που δεν αντιστοιχίζεται σε νέο, θα χαθεί και όλα τα δεδομένα του θα διαγραφούν.
Μπορείτε να αντιστοιχίσετε μόνο πεδία του ίδιου τύπου, γι\' αυτό κάθε αναπτυσσόμενο μενού περιέχει διαφορετικά πεδία. Επίσης, πρέπει να προσέξετε να μην προσπαθήσετε να αντιστοιχίσετε ένα παλιό πεδίο σε περισσότερα από ένα νέο πεδίο.';
...
$string['headeraddtemplate'] = 'Ορίζει τη διεπαφή κατά την επεξεργασία καταχωρήσεων';
...
$string['headerjstemplate'] = 'Ορίζει προσαρμοσμένο Javascipt για τις άλλες φόρμες';
...
$string['manageapproved_help'] = 'Εάν ενεργοποιηθεί, οι εγκεκριμένες καταχωρήσεις δεν είναι πλέον επεξεργάσιμες ή διαγράψιμες από τον χρήστη που τις πρόσθεσε. Η ρύθμιση αυτή έχει αποτέλεσμα μόνο αν είναι ενεργοποιημένη η ρύθμιση «Απαιτείται έγκριση».';
...
Ένας διδάσκων μπορεί να επιτρέψει σχόλια στις καταχωρήσεις. Οι καταχωρήσεις μπορούν επίσης να βαθμολογούνται από διδάσκοντες ή μαθητές (αξιολόγηση από ομοτίμους). Οι βαθμολογίες μπορούν να συναθροίζονται για να διαμορφώσουν έναν τελικό βαθμό, ο οποίος εγγράφεται στο βαθμολόγιο.

Οι δραστηριότητες βάσεων δεδομένων έχουν πολλές χρήσεις, όπως:

* Μια συνεργατική συλλογή από σύνδεσμους ιστού, βιβλία, κριτικές βιβλίων, αναφορές σε περιοδικά κλπ.
...
$string['namecheckbox'] = 'Πεδίο πλαισίου ελέγχου';
...
$string['namenumber'] = 'Πεδίο αριθμού';
$string['namepicture'] = 'Πεδίο εικόνας';
$string['nameradiobutton'] = 'Πεδίο κουμπιού επιλογής';
...
$string['nodefinedfields'] = 'Το νέο πρότυπο δεν έχει κανένα ορισμένο πεδίο!';
...
$string['ods'] = '<acronym title="OpenDocument Spreadsheet (φύλλο εργασίας)">ODS</acronym> (OpenOffice)';
$string['optionaldescription'] = 'Σύντομη περιγραφή (προαιρετικό)';
$string['optionalfilename'] = 'Όνομα αρχείου (προαιρετικό)';
$string['other'] = 'Άλλο';
$string['overrwritedesc'] = 'Αντικατάσταση του προτύπου αν υπάρχει ήδη';
...
$string['rsstemplate'] = 'Φόρμα (τροφοδοσίας) RSS';
$string['rsstitletemplate'] = 'Φόρμα τίτλου (τροφοδοσίας) RSS';
...
$string['saveaspreset_help'] = 'Η λειτουργία αποθήκευσης ως πρότυπο  δημοσιεύει τη φόρμα και τα πεδία ως ένα πρότυπο, το οποίο οι άλλοι χρήστες του ιστοτόπου μπορούν κατόπιν να χρησιμοποιήσουν. (Μπορείτε να το διαγράψετε από τη λίστα των προτύπων οποτεδήποτε.)';
$string['savesettings'] = 'Αποθήκευση ρυθμίσεων';
$string['savesuccess'] = 'Επιτυχής αποθήκευση. Το πρότυπό σας θα είναι διαθέσιμο σε όλο τον ιστότοπο.';
...
$string['usestandard_help'] = 'Για να χρησιμοποιήσετε ένα πρότυπο διαθέσιμο σε όλο τον ιστότοπο, επιλέξτε το από μια λίστα. (Αν έχετε προσθέσει ένα πρότυπο στη λίστα χρησιμοποιώντας τη λειτουργία αποθήκευσης ως πρότυπο, τότε έχετε την επιλογή της διαγραφής του.)';
