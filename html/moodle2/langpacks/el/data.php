...
/**
 * Strings for component 'data', language 'el', branch 'MOODLE_28_STABLE'
 *
 * @package   data
...
$string['availabletags_help'] = '<p align="center"><strong>Διαθέσιμες ετικέτες</strong></p>
<p>Με την ενεργοποίηση αυτής της επιλογής, τα στοιχειά αντικαθιστούνται από κουμπιά και πεδία όταν οι καταχωρήσεις εμφανίζονται ή τυγχάνουν επεξεργασίας.</p>
<p>Τα πεδία έχουν την εξής μορφή: [[πεδίο]]</p>
<p>Τα κουμπιά έχουν την εξής μορφή: ##κουμπί##</p>
<p>Μόνο τα στοιχειά που είναι στη λίστα διαθέσιμων μπορούν να χρησιμοποιηθούν στο πρότυπο.</p>';
...
$string['csvimport_help'] = '<p align="center"><strong>Εισαγωγή από αρχείο τύπου CSV </strong></p>

<p>CSV σημαίνει Comma-Separated-Values (τιμές χωρισμένες με κόμμα). Αποτελεί συνηθισμένο
τύπο αρχείου που περιέχει δεδομένα σε μορφή κειμένου προς εναλλαγή.</p>

<p>Η δομή του αρχείου συνήθως είναι αρχείο απλού κειμένου (plain text file), όπου η πρώτη γραμμή
αναγράφει τους τίτλους κάθε στήλης στη σειρά τον ένα μετά τον άλλο χωρισμένους με κόμμα. Στις επόμενες
γραμμές αναγράφονται τα δεδομένα με τον ίδιο τρόπο.</p>

<p>Οι στήλες δεδομένων χωρίζονται με κόμμα, ενώ δεν ορίζεται προεπιλεγμένος \'field enclosure\'
(με τον όρο \'field enclosures\' εννοούνται οι χαρακτήρες που περιβάλλουν το περιεχόμενο μιας στήλης σε μια γραμμή).</p>

<p>Οι γραμμές δεδομένων συνήθως χωρίζονται η μια από την άλλη με το πάτημα του πλήκτρου RETURN ή ENTER.
Διάκενα (tabs) ορίζονται με t και νέες γραμμές με n.</p>

<p>Παράδειγμα αρχείου CSV:</p>
...
$string['data:viewallratings'] = 'Εμφάνιση όλων των πρώτων αξιολογήσεων που δόθηκαν ατομικά';
$string['data:viewalluserpresets'] = 'Εμφάνιση προτύπων άλλων χρηστών';
$string['data:viewanyrating'] = 'Εμφάνιση όλων των συνολικών αξιολογήσεων που έλαβε κάποιος';
...
$string['fieldmappings_help'] = '<p align="center"><strong>Αντιστοιχίσεις πεδίων</strong></p>
<p> Για την διατήρηση των δεδομένων σε ένα πεδίο, πρέπει να γίνει αντιστοίχιση στο νέο πεδίο που τα δεδομένα θα εμφανιστούν. Τα πεδία μπορούν να μείνουν κενά. Ένα παλιό πεδίο, το όποιο δεν αντιστοιχεί σε ένα νέο, θα εξαφανιστεί με όλα τα δεδομένα που περιέχει.</p>
<p>
...
$string['fromfile_help'] = '<p align=\'center\'><strong>Εισαγωγή από αρχείο zip</strong></p>
<p>Χρησιμοποιήστε αυτή την επιλογή για να φορτώσετε περιεχόμενα στη βάση δεδομένων με μία κίνηση. Τα περιεχόμενα θα πρέπει να είναι ήδη διαθέσιμα σαν αρχείο zip που προήλθε από τη χρήση της λειτουργίας "Εξαγωγή σε αρχείο zip".</p>';
...
$string['maxentries_help'] = '<title>Μέγιστος αριθμός καταχωρήσεων </title>
<p align="center"><strong>Μέγιστος αριθμός καταχωρήσεων </strong></p>

<p>Ο μέγιστος αριθμός καταχωρήσεων που κάθε μαθητής μπορεί να υποβάλλει σ\' αυτή τη βάση δεδομένων.</p>';
...
$string['newfield_help'] = '<p align="center"><strong>Πεδία</strong></p>

<p>Δημιουργία πεδίων της βάσης δεδομένων. Κάθε πεδίο δέχεται διαφορετικούς τύπους δεδομένων.</p>';
...
$string['requireapproval_help'] = '<p align="center"><strong>Απαίτηση έγκρισης</strong></p>

<p>Αν ενεργοποιήσετε αυτή την επιλογή, όλες οι καταχωρήσεις που γίνονται από μαθητές θα πρέπει να εγκρίνονται από τον καθηγητή πριν εμφανιστούν σε άλλους χρήστες. Αυτό είναι χρήσιμο για τη διαχείριση περιεχομένου που μπορεί να είναι ακατάλληλο ή προσβλητικό.</p>';
...
$string['requiredentriestoview_help'] = '<p align="center"><strong>Απαιτούμενες καταχωρήσεις για προβολή</strong></p>

<p>Ο αριθμός των καταχωρήσεων που ο συμμετέχοντας πρέπει να εισάγει προτού του επιτραπεί να δει άλλες καταχωρήσεις αυτής της δραστηριότητας.</p>';
...
$string['saveaspreset_help'] = '<p align="center"><strong>Αποθήκευση ως πρότυπο</strong></p>
<p>Με τη λειτουργία αυτή, η τρέχουσα δομή της βάσης δεδομένων αποθηκεύεται στο Moodle ως πρότυπο και μπορεί να χρησιμοποιηθεί από οποιονδήποτε για τη δημιουργία μιας νέας βάσης δεδομένων με την ίδια ακριβώς δομή. Μπορείτε να αφαιρέσετε αυτό ή άλλο πρότυπο οποιαδήποτε στιγμή θέλετε.</p>';
...
$string['usestandard_help'] = '<p align="center"><strong>Χρήση προτύπου</strong></p>
<p>Με τη λειτουργία αυτή μπορείτε να επιλέξετε ένα έτοιμο πρότυπο για τη δομή της βάσης δεδομένων, κάτι που σας απαλλάσσει από την ανάγκη να καθορίσετε τη δομή χειροκίνητα.</p>
<p>Επίσης, μπορείτε να διαγράψετε όσα πρότυπα έχετε προσθέσει στη λίστα έτοιμων προτύπων.</p>';
