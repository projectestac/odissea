...
$string['answerdisplay'] = 'Προβολή απάντησης';
...
$string['choosedatasetproperties_help'] = 'Ένα σύνολο δεδομένων είναι ένα σύνολο τιμών που εισάγονται στη θέση ενός μπαλαντέρ. Μπορείτε να δημιουργήσετε ένα ιδιωτικό σύνολο δεδομένων για μια συγκεκριμένη ερώτηση ή ένα κοινόχρηστο σύνολο δεδομένων που μπορεί να χρησιμοποιηθεί για άλλες υπολογιζόμενες ερωτήσεις εντός της κατηγορίας.';
...
$string['illegalformulasyntax'] = 'Σφάλμα σύνταξης τύπου/φόρμουλας που ξεκινάει με «{$a}»';
...
$string['mandatoryhdr'] = 'Υποχρεωτικοί χαρακτήρες μπαλαντέρ πανόντες στις ερωτήσεις';
$string['max'] = 'Μέγιστο';
$string['min'] = 'Ελάχιστο';
...
$string['sharedwildcardname'] = 'Διαμοιραζόμενο μπαλαντέρ';
...
$string['updatewildcardvalues'] = 'Ενημερώστε τις τιμές των μπαλαντέρ';
