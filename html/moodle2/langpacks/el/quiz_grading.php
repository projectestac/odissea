...
/**
 * Strings for component 'quiz_grading', language 'el', branch 'MOODLE_28_STABLE'
 *
...
$string['gradeall'] = 'Βαθμολόγηση και των {$a} προσπαθειών';
...
$string['gradingattempt'] = 'Προσπάθεια υπαριθμόν {$a->attempt} για τον {$a->fullname}';
...
$string['pluginname'] = 'Χειροκίνητη βαθμολόγηση';
