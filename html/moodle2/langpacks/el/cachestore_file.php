...
$string['autocreate_help'] = 'Αν ενεργοποιηθεί, ο φάκελος που καθορίζεται στη διαδρομή θα δημιουργηθεί αυτόματα αν δεν υπάρχει ήδη.';
$string['path'] = 'Διαδρομή/κατάλογος κρυφής μνήμης';
