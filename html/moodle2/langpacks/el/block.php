...
$string['defaultregion_help'] = 'Τα θέματα μπορούν να ορίσουν μία ή περισσότερες ονομασμένες περιοχές μπλοκ όπου εμφανίζονται μπλοκ. Αυτή η ρύθμιση ορίζει σε ποιά από αυτές τις περιοχές θέλετε το μπλοκ σας να εμφανίζεται από προεπιλογή. Η περιοχή μπορεί να παρακαμφθεί σε συγκεκριμένες σελίδες αν απαιτηθεί.';
...
$string['deleteblockwarning'] = '<p> Πρόκειται να διαγράψετε ένα μπλοκ που εμφανίζεται αλλού. </ p> <p> Αρχική θέση μπλοκ:  {$a->location} <br /> Εμφάνιση σε τύπους σελίδων: {$a->pagetype} p> <p> Είστε βέβαιοι ότι θέλετε να συνεχίσετε; </ p>';
