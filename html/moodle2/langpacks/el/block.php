...
$string['addtodock'] = 'Μετακίνηση στην πλατφόρμα';
$string['blocksdrawertoggle'] = 'Απόκρυψη/εμφάνιση εκδότη μπλοκ';
...
$string['createdat_help'] = 'Η αρχική θέση που δημιουργήθηκε το μπλοκ. Οι ρυθμίσεις του μπλοκ μπορεί να προκαλέσουν την εμφάνιση του σε άλλες θέσεις (πλαισία) μέσα στην αρχική θέση. Για παράδειγμα, ένα μπλοκ που δημιουργήθηκε σε μια σελίδα μαθήματος θα μπορούσε να εμφανιστεί σε δραστηριότητες εντός του εν λόγω μαθήματος. Ένα μπλοκ που δημιουργήθηκε στην πρώτη σελίδα μπορεί να εμφανίζεται σε όλο τον ιστότοπο.';
...
$string['dockblock'] = 'Προσθήκη μπλοκ {$a}';
$string['hideblock'] = 'Απόκρυψη μπλοκ {$a}';
$string['hidedockpanel'] = 'Αποκρύψη πίνακα πλατφόρμας';
...
$string['undockall'] = 'Αφαίρεση όλων';
$string['undockblock'] = 'Αφαίρεση μπλοκ {$a}';
$string['undockitem'] = 'Αφαίρεση αυτού του στοιχείου';
