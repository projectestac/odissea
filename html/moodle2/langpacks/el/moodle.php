...
$string['checkinginstances'] = 'Έλεγχος στιγμιότυπων';
...
$string['emaildisplayno'] = 'Απόκρυψη της διεύθυνσης ηλε.ταχυδρομείου από όλους (εκτός διαχειριστών κτλ.)';
...
Κάποιος (μάλλον εσείς ο ίδιος) έχει ζητήσει νέο κωδικό πρόσβασης για το λογαριασμό σας στο «{$a->sitename}».
 ...
 Για να αλλάξετε τον κωδικό πρόσβασης, παρακαλώ μεταβείτε στην παρακάτω διεύθυνση ιστού:
...
$string['forcepasswordchange_help'] = 'Αν αυτό το πλαίσιο ελέγχου είναι επιλεγμένο, ο χρήστης προτρέπεται να αλλάξει τον κωδικό πρόσβασής του κατά την επόμενη σύνδεσή του';
...
$string['forgottenduplicate'] = 'Αυτή η διεύθυνση ηλε.ταχυδρομείου είναι κοινή για πολλούς λογαριασμούς. Παρακαλούμε, αντί της διεύθυνσης αυτής, να εισαγάγετε το όνομα χρήστη.';
...
$string['registrationyes'] = 'Ναι, ειδοποιήστε με για νέες διανομές Moodle, συναγερμικές ειδοποιήσεις ασφαλείας και άλλα σημαντικά νέα';
