...
$string['confirmednot'] = 'Η εγγραφή σας δεν έχει επιβεβαιωθεί ακόμη! Παρακαλούμε, ελέγξτε το γραμματοκιβώτιο του ηλε.ταχυδρομείου σας για ένα μήνυμα επιβεβαίωσης.';
...
$string['dndnotsupported_help'] = 'Ο περιηγητής σας δεν υποστηρίζει ανέβασμα με μεταφορά & απόθεση.<br />Αυτή η λειτουργία είναι διαθέσιμη σε όλες τις πρόσφατες εκδόσεις του Chrome, Firefox και Safari, καθώς και στον Internet Explorer v10 και άνω.';
...
$string['dndworkingfile'] = 'Κάντε μεταφορά & απόθεση αρχείων, σε τμήματα μαθήματος, για να τα ανεβάσετε';
$string['dndworkingfilelink'] = 'Κάντε μεταφορά & απόθεση αρχείων ή συνδέσμων, σε τμήματα μαθήματος, για να τα ανεβάσετε';
$string['dndworkingfiletext'] = 'Κάντε μεταφορά & απόθεση αρχείων ή κειμένου, σε τμήματα μαθήματος, για να τα ανεβάσετε';
$string['dndworkingfiletextlink'] = 'Κάντε μεταφορά & απόθεση αρχείων, κειμένου ή συνδέσμων, σε τμήματα μαθήματος, για να τα ανεβάσετε';
$string['dndworkinglink'] = 'Κάντε μεταφορά & απόθεση συνδέσμων, σε τμήματα μαθήματος, για να τα ανεβάσετε';
$string['dndworkingtext'] = 'Κάντε μεταφορά & απόθεση κειμένου, σε τμήματα μαθήματος, για να το ανεβάσετε';
$string['dndworkingtextlink'] = 'Κάντε μεταφορά & απόθεση κειμένου ή συνδέσμων, σε τμήματα μαθήματος, για να τα ανεβάσετε';
...
<br />Στα περισσότερα προγράμματα ηλε.ταχυδρομείου, εμφανίζεται ως μπλε σύνδεσμος στον οποίο μπορείτε να απλά να κάνετε κλικ. Αν αυτό δεν λειτουργήσει, τότε αποκόψτε και επικολλήστε τη διεύθυνση στη γραμμή διευθύνσεων στο επάνω μέρος του παραθύρου του περιηγητή σας. Αν χρειάζεστε βοήθεια, παρακαλώ επικοινωνήστε με τον διαχειριστή του ιστοτόπου.
...
$string['emaildisplay'] = 'Εμφάνιση διεύθυνσης ηλε.ταχυδρομείου';
$string['emaildisplaycourse'] = 'Η διεύθυνση ηλε.ταχυδρομείου να είναι ορατή μόνο στα άλλα μέλη του μαθήματος';
$string['emaildisplay_help'] = 'Οι προνομιακοί χρήστες (όπως οι διδάσκοντες και οι διαχειριστές) θα μπορούν πάντα να βλέπουν τη διεύθυνση ηλε.ταχυδρομείου σας.';
$string['emaildisplayhidden'] = 'Απόκρυψη διεύθυνσης ηλε.ταχυδρομείου';
$string['emaildisplayno'] = 'Απόκρυψη της διεύθυνσης ηλε.ταχυδρομείου από όλους (εκτός διαχειριστών κ.λ.π.)';
$string['emaildisplayyes'] = 'Η διεύθυνση ηλε.ταχυδρομείου να είναι ορατή σε όλους τους χρήστες';
...
$string['emailexists'] = 'Υπάρχει ήδη κάποιος άλλος εγγεγραμμένος χρήστης με αυτή την διεύθυνση ηλε.ταχυδρομείου.';
...
$string['emailnotallowed'] = 'Δεν επιτρέπονται οι διευθύνσεις ηλε.ταχυσδρομείου από αυτούς τους τομείς ({$a})';
...
$string['emailpasswordconfirmmaybesent'] = '<p>Αν έχετε δώσει σωστό όνομα χρήστη ή διεύθυνση, ένα μήνυμα ηλε.ταχυδρομείου θα έχει σταλεί σε εσάς.</p> <p>Περιέχει εύκολες πληροφορίες για την επιβεβαίωση και την ολοκλήρωση της αλλαγής του κωδικού πρόσβασης. Αν συνεχίσετε να έχετε προβλήματα, παρακαλούμε επικοινωνήστε με το διαχειριστή του ιστοτόπου.</p>';
...
$string['emailresetconfirmsent'] = 'Ένα μήνυμα ηλε.ταχυδρομείου έχει σταλεί στη διεύθυνση σας στο <b>{$a}.</b> <br /> Περιέχει απλές οδηγίες για να επιβεβαιώσετε και να ολοκληρωθεί αυτή η αλλαγή του κωδικού πρόσβασης.
...
$string['emailuserhasnone'] = 'Δεν υπάρχει διεύθυνση ηλε.ταχυδρομείου για αυτόν τον χρήστη.';
...
$string['files'] = 'Αρχεία';
$string['filesanduploads'] = 'Αρχεία και ανεβασμένα';
...
$string['forgottenduplicate'] = 'Αυτή η διεύθυνση ηλε.ταχυδρομείου είναι κοινή για πολλούς λογαριασμούς. Παρακαλούμε εισαγάγετε το όνομα χρήστη αντ\' αυτού.';
...
$string['moodledocslink'] = 'Αρχεία βοήθειας του Moodle για αυτή τη σελίδα';
...
$string['newpasswordfromlost'] = '<strong>ΕΙΔΟΠΟΙΗΣΗ:</strong> Ο <strong> τρέχων κωδικός πρόσβασης</strong> θα σας έχει σταλεί στο <strong> δεύτερο</strong> εκ των δύο μηνυμάτων ηλε.ταχυδρομείου που θα αποσταλλούν στο πλαίσιο της διαδικασίας ανάκτησης κωδικού πρόσβασης. Επιβεβαιώστε ότι έχετε λάβει τον κωδικό πρόσβασης αντικατάστασης πριν συνεχίσετε με αυτή την οθόνη.';
...
$string['shortnamecourse_help'] = 'Το σύντομο όνομα του μαθήματος εμφανίζεται στην πλοήγηση και χρησιμοποιείται στη γραμμή θέματος των μηνυμάτων ηλε.ταχυδρομείου.';
