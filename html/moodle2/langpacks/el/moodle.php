...
$string['courseoverviewfiles_help'] = 'Η εικόνα του μαθήματος εμφανίζεται στην επισκόπηση μαθήματος στο ταμπλό. Πρόσθετοι αποδεκτοί τύποι αρχείων και περισσότερα από ένα αρχεία ενδέχεται να ενεργοποιηθούν από το διαχειριστή του ιστότοπου. Αν συμβεί κάτι τέτοιο, αυτά τα αρχεία θα εμφανίζονται δίπλα στην περίληψη του μαθήματος στη σελίδα των μαθημάτων.';
