...
$string['errorcontexthasunexpiredchildren'] = 'Το πλαίσιο «{$a}» εξακολουθεί να έχει υπο-πλαίσια που δεν έχουν ακόμη λήξει. Δεν έχουν επισημανθεί πλαίσια για διαγραφή.';
...
$string['privacy:metadata:request:timecreated'] = 'Η χρονοσφραγίδα που σημαδοδοτεί πότε έγινε το αίτημα από τον χρήστη.';
...
$string['retentionperiod_help'] = 'Η περίοδος διατήρησης καθορίζει το χρονικό διάστημα που πρέπει να τηρούνται τα δεδομένα. Όταν λήξει η περίοδος διατήρησης, τα δεδομένα επισημαίνονται και μπαίνουν σε λίστα για διαγραφή, αναμένοντας επιβεβαίωση διαχειριστή.';
