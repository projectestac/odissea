...
/**
 * Strings for component 'lesson', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   lesson
...
$string['configslideshowbgcolor'] = 'Το χρώμα φόντου για την παρουσίαση, εάν ενεργοποιηθεί';
...
$string['lessonpagelinkingbroken'] = 'Δεν βρέθηκε η πρώτη σελίδα. Η σύνδεση με τη σελίδα της διδασκαλίας πρέπει να έχει διακοπεί. Παρακαλούμε επικοινωνήστε με έναν διαχειριστή.';
...
$string['wrongresponse'] = 'Λάθος απόκριση';
