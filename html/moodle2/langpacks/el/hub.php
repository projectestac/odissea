...
/**
 * Strings for component 'hub', language 'el', branch 'MOODLE_31_STABLE'
 *
 * @package   hub
...
$string['emailalert'] = 'Ειδοποιήσεις μέσω email';
...
$string['siteregistrationemail'] = 'Ειδοποιήσεις μέσω email';
$string['specifichubregistrationdetail'] = 'Μπορείτε επίσης να καταχωρήσετε τον ιστόχωρο σας με άλλους κόμβους της κοινότητας.';
