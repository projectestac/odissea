...
/**
 * Strings for component 'block_mnet_hosts', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['error_localusersonly'] = 'Οι απομακρυσμένοι χρήστες δεν μπορούν να μεταπηδήσουν σε άλλους εξυπηρετητές δικτύου MNet από αυτόν τον κενρικό Η/Υ.';
