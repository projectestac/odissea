...
$string['eventtagflagged'] = 'Η ετικέτα επισημάνθηκε';
...
$string['flag'] = 'Επισήμανση';
$string['flagasinappropriate'] = 'Επισήμανση ως ακατάλληλης';
$string['flagged'] = 'Η ετικέτα επισημάνθηκε';
...
$string['reset'] = 'Επαναφορά επισήμανσης ετικέτας';
$string['resetfilter'] = 'Επαναφορά φίλτρου';
$string['resetflag'] = 'Επαναφορά επισήμανσης';
