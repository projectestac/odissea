...
$string['formatnoinline'] = 'Χωρίς κείμενο σε σύνδεση';
...
$string['mustattach'] = 'Όταν έχει επιλεγεί «Χωρίς κείμενο σε σύνδεση» ή οι αποκρίσεις είναι προαιρετικές, πρέπει να επιτρέπεται τουλάχιστον ένα συνημμένο.';
$string['mustrequire'] = 'Όταν έχει επιλεγεί «Χωρίς κείμενο σε σύνδεση» ή οι αποκρίσεις είναι προαιρετικές, πρέπει να απαιτείται τουλάχιστον ένα συνημμένο.';
...
$string['pluginname_help'] = 'Σε απάντηση μιας ερώτησης, αυτός που απαντά μπορεί να ανεβάσει ένα ή περισσότερα αρχεία και/ή να εισάγει κείμενο κατά τη διάρκεια της σύνδεσης. Μπορεί να παρέχεται ένα πρότυπο φόρμας απόκρισης. Οι αποκρίσεις πρέπει να βαθμολογηθούν χειροκίνητα.';
$string['pluginname_link'] = 'ερώτηση/τύπος/έκθεση';
$string['pluginnamesummary'] = 'Επιτρέπει ως απόκριση το ανέβασμα ενός αρχείου και/ή κείμενο σε σύνδεση. Η απόκριση θα πρέπει έπειτα να βαθμολογηθεί χειροκίνητα.';
