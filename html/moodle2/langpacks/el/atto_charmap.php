...
/**
 * Strings for component 'atto_charmap', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['centsign'] = 'cent sign (σέντ)';
$string['chi'] = 'χι (chi)';
...
$string['finalsigma'] = 'τελικό σίγμα (final sigma)';
$string['forall'] = 'για κάθε (for all), ανεστραμένο κεφ. Α';
...
$string['gamma'] = 'γάμμα (gamma)';
$string['gamma_caps'] = 'Γάμμα (Gamma)';
...
$string['minussign'] = 'πλήν, μείον (minus sign)';
...
$string['scaron'] = 's - caron (ανεστραμένη περισπωμένη)';
$string['scaron_caps'] = 'S - caron (ανεστραμένη περισπωμένη)';
...
$string['theta_caps'] = 'Θέτα (Theta)';
$string['thetasymbol'] = 'σύμβολο θήτα (theta symbol) ((καλλιγραφικό))';
$string['thinspace'] = 'μικρό κενό (thin space)';
$string['thorn'] = 'σω αρχαίο ελλ., σκανδιναβινό γράμμα αγκάθι (thorn)';
$string['thorn_caps'] = 'Σω αρχαίο ελλ., σκανδιναβινό γράμμα αγκάθι (THORN)';
