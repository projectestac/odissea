...
/**
 * Strings for component 'qtype_description', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['informationtext'] = 'Κείμενο πληροφοριών';
$string['pluginname'] = 'Περιγραφή';
$string['pluginnameadding'] = 'Προσθήκη μιας Περιγραφής';
$string['pluginnameediting'] = 'Τροποποίηση μιας Περιγραφής';
$string['pluginname_help'] = 'Μια περιγραφή δεν είναι πραγματικά τύπος ερωτήματος. Απλώς επιτρέπει την εμφάνιση του κειμένου χωρίς να απαιτείται καμία απάντηση, παρόμοια με μια ταμπέλα στη σελίδα του μαθήματος.
