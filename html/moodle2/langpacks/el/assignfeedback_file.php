...
/**
 * Strings for component 'assignfeedback_file', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['batchoperationconfirmuploadfiles'] = 'Να μεταφορτωθούν ένα ή περισσότερα αρχεία ανατροφοδότησης για όλους τους επιλεγμένους χρήστες;';
