...
$string['batchoperationconfirmuploadfiles'] = 'Να μεταφορτωθούν ένα ή περισσότερα αρχεία ανατροφοδότησης για όλους του επιλεγμένους χρήστες;';
...
$string['enabled_help'] = 'Αν ενεργοποιηθεί, ο διδάσκων θα μπορεί να ανεβάζει αρχεία με ανατροφοδότηση όταν βαθμολογεί εργασίες. Αυτά τα αρχεία μπορεί να είναι, αλλά δεν περιορίζονται σε βαθμολογημένες υποβολές μαθητών, έγγραφα με σχολιασμό ή ανατροφοδότηση με ηχογράφηση ομιλίας.';
...
$string['feedbackzip_help'] = 'Ένα συμπιεσμένο αρχείο που περιέχει μια λίστα αρχείων ανατροφοδότησης για έναν ή περισσότερους μαθητές. Τα αρχεία ανατροφοδότησης θα ανατεθούν στους μαθητές με βάση το αναγνωριστικό συμμετέχοντα, το οποίο θα πρέπει να είναι το δεύτερο μέρος κάθε ονόματος αρχείου αμέσως μετά το πλήρες όνομα του χρήστη. Αυτή η σύμβαση ονοματοδοσίας χρησιμοποιείται κατά τη λήψη των υποβολών, ώστε να μπορείτε να κάνετε λήψη όλων των υποβολών, να προσθέσετε σχόλια σε μερικά αρχεία και στη συνέχεια να επανασυμπιέσετε και να μεταφορτώσετε όλα τα αρχεία. Αρχεία χωρίς αλλαγές θα αγνοηθούν.';
