...
$string['cannotfindthepathtothecli'] = 'Δεν είναι δυνατή η εύρεση της διαδρομής για το εκτελέσιμο από γραμμή εντολών (CLI) αρχείο της PHP, οπότε η εκτέλεση της εργασίας διακόπηκε. Ορίστε τη ρύθμιση «Μονοπάτι προς το εκτελέσιμο αρχείο της PHP» στην σελίδα «Διαχείριση ιστοτόπου / Εξυπηρετητής / Διαδρομές συστήματος».';
