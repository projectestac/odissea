...
$string['addfunctionsdescription'] = 'Επιλογή των απαιτούμενων λειτουργιών για την νεο-δημιουργηθήσα υπηρεσία.';
...
$string['createuserdescription'] = 'Ένας χρήστης υπηρεσιών ιστού απατείται για να αντιπροσωπεύει το σύστημα που ελέγχει το Moodle.';
...
$string['enablewsdescription'] = 'Οι υπηρεσίες ιστού πρέπει να είναι ενεργοποιημένες στις «Προχωρημένες ρυθμίσεις».';
...
$string['missingcaps_help'] = 'Λίστα απαιτούμενων δυνατοτήτων για την υπηρεσία που δεν έχει ο επιλεγμένος χρήστης. Οι δυνατότητες που λείπουν πρέπει να προστεθούν στο ρόλο του χρήστη για να χρησιμοποιήσουν την υπηρεσία.';
...
$string['restparam'] = 'REST (παραμέτροι POST)';
