...
$string['quiz:addinstance'] = 'Προσθέστε ένα νέο κουίζ';
...
$string['subneterror'] = 'Συγγνώμη, αυτό το κουίζ είναι κλειδωμένο έτσι ώστε να είναι προσπελάσιμο μόνο από ορισμένες διευθύνσεις. Αυτή τη στιγμή ο υπολογιστής σας δεν έχει άδεια πρόσβασης στο κουίζ.';
...
$string['timelimitexeeded'] = 'Συγγνώμη! Ο χρόνος του κουίζ έχει λήξει!';
