...
/**
 * Strings for component 'quiz', language 'el', branch 'MOODLE_32_STABLE'
 *
 * @package   quiz
...
$string['autosaveperiod'] = 'Καθυστέρηση αυτό-αποθήκευσης';
...
$string['noclose'] = 'Καμία ημερομηνία κλεισίματος';
...
$string['noreviewattempt'] = 'Δεν επιτρέπεται να επανεξετάσετε αυτήν την προσπάθεια.';
...
$string['notenoughrandomquestions'] = 'Δεν υπάρχουν αρκετά ερωτήματα στην κατηγορία {$a->category} να δημιουργήσετε το ερώτημα {$a->name} ({$a->id}).';
...
$string['outofpercent'] = '{$a->grade} από {$a->maxgrade} ({$a->percent}%)';
...
$string['overridedeleteusersure'] = 'Είστε σίγουροι ότι θέλετε να διαγράψετε την παράκαμψη για χρήστη  {$a};';
...
$string['quiz:emailconfirmsubmission'] = 'Λήψη email επιβεβαίωσης κατά την υποβολή';
$string['quiz:emailnotifysubmission'] = 'Λήψη email  επιβεβαίωσης κατά την υποβολή της προσπάθειας';
...
$string['quiz:preview'] = 'Προεπισκόπηση κουίζ';
...
$string['startnewpreview'] = 'Ξεκίνησε μία νέα επισκόπηση';
...
$string['summaryofattempt'] = 'Σύνοψη προσπάθειας';
$string['summaryofattempts'] = 'Σύνοψη προηγούμενων προσπαθειών';
