...
/**
 * Strings for component 'quiz', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   quiz
...
$string['canredoquestions_desc'] = 'Εάν ενεργοποιηθεί, τότε όταν οι μαθητές έχουν τελειώσει την προσπάθεια συγκεκριμένης ερώτησης, θα δουν ένα κουμπί ερώτησης «Ξανά». Αυτό τους επιτρέπει να προσπαθήσουν μια άλλη έκδοση της ίδιας ερώτησης, χωρίς να χρειάζεται να υποβάλουν ολόκληρη την προσπάθεια κουίζ και να ξεκινήσουν μια άλλη. Αυτή η επιλογή είναι χρήσιμη κυρίως για κουίζ εξάσκησης. Αυτή η ρύθμιση επηρεάζει μόνο τις ερωτήσεις (για παράδειγμα όχι, τις ερωτήσεις Έκθεσης) και τις συμπεριφορές (για παράδειγμα Άμεση ανατροφοδότηση ή Διαδραστική με πολλαπλές δοκιμές) όπου ο μαθητής μπορεί να ολοκληρώσει την ερώτηση πριν από την υποβολή της προσπάθειας.';
$string['canredoquestions_help'] = 'Εάν ενεργοποιηθεί, τότε όταν οι μαθητές έχουν τελειώσει την προσπάθεια συγκεκριμένης ερώτησης, θα δουν ένα κουμπί ερώτησης «Ξανά». Αυτό τους επιτρέπει να προσπαθήσουν μια άλλη έκδοση της ίδιας ερώτησης, χωρίς να χρειάζεται να υποβάλουν ολόκληρη την προσπάθεια κουίζ και να ξεκινήσουν μια άλλη. Αυτή η επιλογή είναι χρήσιμη κυρίως για κουίζ εξάσκησης. Αυτή η ρύθμιση επηρεάζει μόνο τις ερωτήσεις (για παράδειγμα όχι, τις ερωτήσεις Έκθεσης) και τις συμπεριφορές (για παράδειγμα Άμεση ανατροφοδότηση ή Διαδραστική με πολλαπλές δοκιμές) όπου ο μαθητής μπορεί να ολοκληρώσει την ερώτηση πριν από την υποβολή της προσπάθειας.';
...
$string['confirmserverdelete'] = 'Είστε σίγουρος ότι θέλετε να διαγράψετε το εξυπηρετητή <b>{$a}</b> από τη λίστα;';
...
$string['overduehandling_help'] = 'Αυτή η ρύθμιση ελέγχει τι συμβαίνει εάν ο μαθητής δεν υποβάλει την προσπάθεια του κουίζ πριν λήξει η προθεσμία. Εάν ο μαθητής εργάζεται ενεργά στο κουίζ εκείνη τη στιγμή, τότε το χρονόμετρο αντίστροφης μέτρησης θα υποβάλει πάντα αυτόματα την προσπάθεια για αυτόν, αλλά αν έχει αποσυνδεθεί, τότε αυτή η ρύθμιση ελέγχει τι θα συμβεί.';
...
$string['questiondeleted'] = 'Αυτή η ερώτηση έχει διαγραφεί. Παρακαλούμε επικοινωνήστε με τον διδάσκοντα.';
...
$string['showeachpage'] = 'Προβολή μία σελίδα την φορά';
...
$string['showreport'] = 'Προβολή αναφοράς';
...
$string['showuserpicture_help'] = 'Εάν ενεργοποιηθεί, το όνομα και η εικόνα του μαθητή θα εμφανίζονται στην οθόνη κατά τη διάρκεια της προσπάθειας και στην οθόνη της εξέτασης, κάνοντας ευκόλοτερο τον έλεγχο ότι ο εκπαιδευόμενος έχει συνδεθεί ο ίδιος σε μια επιτηρούμενη (εποπτευόμενη) εξέταση.';
...
$string['shufflequestions_help'] = 'Αν το ενεργοποιήσετε, τότε κάθε φορά που επιχειρείται το κουίζ, η σειρά των ερωτήσεων σε αυτό το τμήμα θα ανακατευτεί σε μια διαφορετική τυχαία σειρά.

Αυτό μπορεί να δυσκολέψει τους μαθητές να μοιραστούν απαντήσεις, αλλά δυσκολεύει επίσης τους μαθητές να συζητήσουν μαζί σας μια συγκεκριμένη ερώτηση.';
...
$string['viewallreports'] = 'Προβολή αναφορών για {$a} προσπάθειες';
