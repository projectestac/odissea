...
$string['emailconfirmbody'] = 'Αγαπητέ {$a->username}, Ευχαριστούμε που υποβάλατε τις απαντήσεις σας στο «{$a->quizname}» για το μάθημα «{$a->coursename}» στις {$a->submissiontime}. Αυτό το μήνυμα ηλ. ταχυδρομείου επιβεβαιώνει ότι οι απαντήσεις σας έχουν ληφθεί με ασφάλεια. Μπορείτε να δείτε το κουίζ στο {$a->quizurl}.';
...
$string['privacy:metadata:quiz_attempts:timemodifiedoffline'] = 'Πότε ενημερώθηκε η προσπάθεια μέσω ενημέρωσης χωρίς σύνδεση.';
...
$string['quiz:emailconfirmsubmission'] = 'Λάβετε (με ηλ. ταχυδρομείο) ένα μήνυμα επιβεβαίωσης κατά την υποβολή';
$string['quiz:emailnotifysubmission'] = 'Λάβετε (με ηλ. ταχυδρομείο) ένα μήνυμα ειδοποίησης κατά την υποβολή μιας προσπάθειας';
$string['quiz:emailwarnoverdue'] = 'Λάβετε (με ηλ. ταχυδρομείο) ένα μήνυμα ειδοποίησης όταν μια προσπάθεια γίνεται εκπρόθεσμη και χρειάζεται να υποβληθεί.';
