...
/**
 * Strings for component 'logstore_legacy', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['eventlegacylogged'] = 'Καταγράφηκε γεγονός παλαιού τύπου';
$string['loglegacy'] = 'Καταγραφή δεδομένων παλαιού τύπου';
