...
/**
 * Strings for component 'report_loglive', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['eventreportviewed'] = 'Η αναφορά ζωντανών καταγραφών προβλήθηκε';
$string['livelogs'] = 'Ζωντανές καταγραφές της τελευταίας ώρας';
$string['loglive:view'] = 'Εμφάνιση των ζωντανών καταγραφών';
$string['nologreaderenabled'] = 'Δεν είναι ενεργοποιημένος κανένας αναγνώστης καταγραφών';
$string['pause'] = 'Παύση ζωντανών ενημερώσεων';
$string['pluginname'] = 'Ζωντανές καταγραφές';
$string['privacy:metadata'] = 'Το πρόσθετο «Ζωντανές καταγραφές» δεν αποθηκεύει κανένα προσωπικό δεδομένο.';
$string['resume'] = 'Να αρχίσουν πάλι οι ζωντανές ενημερώσεις';
