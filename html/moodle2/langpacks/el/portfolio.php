...
$string['format_document'] = 'Εγγραφο';
...
$string['highdbsizethreshold'] = '«Μεγάλο» μεγέθος βάσης δεδομένων μεταφοράς';
...
$string['highfilesizethreshold'] = '«Μεγάλο» μεγέθος αρχείου για μεταφορά';
...
$string['invalidfileareaargs'] = 'Μη έγκυρες παράμετροι περιοχής αρχείου δώθηκαν στο set_file_and_format_data - πρέπει να περιέχουν τα contextid, component, filearea και itemid';
...
$string['leap2a_entryalreadyexists'] = 'Προσπαθήσατε να προσθέσετε μια καταχώρηση Leap2A με αναγνωριστικό ({$a}) που υπάρχει ήδη σε αυτήν την τροφοδότηση';
...
$string['multipleinstancesdisallowed'] = 'Προσπάθεια δημιουργίας ενός άλλου στιγμιοτύπου ενός πρόσθετου που έχει απαγορεύσει πολλαπλά στιγμιοτύπα ({$a})';
...
$string['nocallbackfile'] = 'Κάτι στο άρθρωμα από το οποίο προσπαθείτε να εξάγετε είναι κατεστραμένο - δεν ήταν δυνατόν να βρεθεί ένα απαιτούμενο αρχείο χαρτοφυλακίου';
$string['noclassbeforeformats'] = 'Πρέπει να ρυθμίσετε την κλάση επανάκλησης πριν καλεσετε την set_formats στο portfolio_button';
$string['nocommonformats'] = 'Δεν υπάρχουν κοινά μορφότυπα μεταξύ οποιουδήποτε διαθέσιμου πρόσθετου χαρτοφυλακίων και της καλούσας τοποθεσίας {$a->location} (η καλούσα υποστήριζε μορφότυπους {$a->formats})';
