...
/**
 * Strings for component 'enrol_mnet', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   enrol_mnet
...
$string['instancename_help'] = 'Μπορείτε προαιρετικά να μετονομάσετε αυτό το στιγμιότυπο της μεθόδου εγγραφής MNet. Αν αφήσετε αυτό το πεδίο κενό, θα χρησιμοποιηθεί το προεπιλεγμένο όνομα στιγμιοτύπου, το οποίο θα περιέχει το όνομα του απομακρυσμένου Η/Υ και τον ρόλο που έχει ανατεθεί στους χρήστες του.';
$string['mnet:config'] = 'Ρύθμιση στιγμιοτύπων εγγραφής MNet';
