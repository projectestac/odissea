...
$string['notemplatesurveys'] = 'Κανένα σχεδιότυπο ερωτηματολογίου.';
...
$string['questionnaire:view'] = 'Εμφανιση ενός ερωτηματολογίου';
...
$string['templatenotviewable'] = 'Τα σχεδιότυπα ερωτηματολογίων δεν μπορούν να εμφανιστούν.';
...
$string['today'] = 'σήμερα';
$string['total'] = 'Σύνολο';
$string['totalofnumbers'] = 'Σύνολο ημερών που δώθηκαν';
...
$string['usetemplate'] = 'Χρήση σχεδιοτύπου';
