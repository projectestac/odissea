...
$string['myresponses'] = 'Όλες οι απαντήσεις σας';
...
$string['responseview'] = 'Οι μαθητές μπορούν να δουν όλες τις απαντήσεις';
...
$string['title'] = 'Τίτλος';
$string['yourresponse'] = 'Η απάντησή σας';
$string['yourresponses'] = 'Η απάντησή σας';
