...
$string['additionalinfo'] = 'Επιπρόσθετη πληροφορία';
...
$string['answerquestions'] = 'Απάντησε τις ερωτήσεις...';
...
$string['qtype'] = 'Τύπος';
$string['qtypemonthly'] = 'μηνιαία απόκριση';
