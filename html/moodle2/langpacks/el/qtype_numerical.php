...
/**
 * Strings for component 'qtype_numerical', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['decfractionofresponsegrade'] = 'ως κλάσμα (0-1) του βαθμού της απόκρισης';
...
$string['invalidnumbernounit'] = 'Πρέπει να εισάγετε έναν έγκυρο αριθμό. Μην περιλάβετε μονάδα μέτρησης στην απόκρισή σας.';
...
$string['manynumerical'] = 'Οι μονάδες μέτρησης είναι προαιρετικές. Αν εισαχθεί μονάδα μέτρησης, χρησιμοποιείται για να μετατρέψει την απόκριση στην μονάδα μέτρησης 1 πριν βαθμολογηθεί.';
$string['multiplier'] = 'Πολλαπλασιαστής';
$string['nominal'] = 'Ονομαστικός';
$string['noneditableunittext'] = 'ΜΗ τροποποιήσιμο κείμενο της Μονάδας Νο1';
...
$string['numericalmultiplier_help'] = 'Ο πολλαπλασιαστής είναι ο συντελεστής με τον οποίο η σωστή αριθμητική απάντηση θα πολλαπλασιαστεί. Η πρώτη μονάδα (Μονάδα 1) έχει προεπιλεγμένο πολλαπλασιαστή 1. Έτσι αν η σωστή αριθμητική απάντηση είναι 5500 και έχετε ορίσει W ως μονάδα στην Μονάδα 1 που έχει 1 σαν προεπιλεγμένο πολλαπλασιαστή, η σωστή απάντηση είναι 5500 W. Αν προσθέσετε την μονάδα kW με πολλαπλασιαστή 0.001, αυτό θα εμφανίσει ως σωστή απάντηση 5.5 kW. Αυτό σημαίνει ότι οι απαντήσεις 5500W ή 5.5kW θα βαθμολογηθούν ως σωστές. Σημειώστε ότι το αποδεκτό λάθος πολλαπλασιάζεται επίσης, έτσι αν επιτρέπεται λάθος 100W θα επιτρέπεται και λάθος 0.1kW.';
$string['oneunitshown'] = 'Η μονάδα 1 εμφανίζεται αυτόματα δίπλα στο πλαίσιο απάντησης.';
$string['onlynumerical'] = 'Μονάδες που δεν χρησιμοποιούνται καθόλου. Μόνο η αριθμητική τιμή βαθμολογείται.';
...
$string['pluginname_link'] = 'ερώτηση/τύπος/αριθμητική';
...
$string['unit'] = 'Μονάδα';
$string['unitappliedpenalty'] = 'Αυτοί οι βαθμοί περιλαμβάνουν ποινή {$a} για λανθασμένη μονάδα.';
$string['unitchoice'] = 'μια επιλογή σε ερώτηση πολλαπλής επιλογής';
