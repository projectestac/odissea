...
/**
 * Strings for component 'calendar', language 'el', branch 'MOODLE_31_STABLE'
 *
 * @package   calendar
...
$string['calendarpreferences'] = 'Ρυθμίσεις ημερολογίου';
...
$string['for'] = 'για';
$string['forcecalendartype'] = 'Επέβαλε ημερολόγιο';
$string['fri'] = 'Παρ';
...
$string['pref_maxevents_help'] = 'Εδώ ορίζεται ο μέγιστος αριθμός επικείμενων γεγονότων που μπορούν να εμφανιστούν. Αν επιλέξετε μεγάλο αριθμό γεγονότων, τότε υπάρχει περίπτωση να χρησιμοποιηθεί μεγάλο μέρος της οθόνης σας για την εμφάνισή τους.';
...
$string['repeatevent'] = 'Επαναλάβετε αυτό το γεγονός';
...
$string['showcourseevents'] = 'Εμφάνισε τα γεγονότα του μαθήματος';
$string['showglobalevents'] = 'Εμφάνιση καθολικών γεγονότων';
$string['showgroupsevents'] = 'Εμφάνισε τα γεγονότα των ομάδων';
$string['shown'] = 'εμφανίζονται';
$string['showuserevents'] = 'Εμφάνισε τα γεγονότα του χρήστη';
...
$string['upcomingeventsfor'] = 'Επερχόμενα γεγονότα για:';
