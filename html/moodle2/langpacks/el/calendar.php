...
/**
 * Strings for component 'calendar', language 'el', branch 'MOODLE_32_STABLE'
 *
 * @package   calendar
...
$string['addevent'] = 'Προσθέστε γεγονότα';
...
$string['calendarurl'] = 'Ημερολόγιο URL: {$a}';
...
$string['detailedmonthviewfor'] = 'Λεπτομερή μηναία προβολή για:';
$string['detailedmonthviewtitle'] = 'Λεπτομερή μηναία προβολή: {$a}';
...
$string['erroraddingevent'] = 'Αποτυχία να προσθέσετε το γεγονός';
$string['errorbadsubscription'] = 'Δεν βρέθηκε συνδρομή στο ημερολόγιο';
$string['errorbeforecoursestart'] = 'Αδυναμία ορισμού γεγονότος πριν την έναρξη μαθήματος';
$string['errorcannotimport'] = 'Δεν είναι δυνατή ο ορισμός μιας συνδρομής στο ημερολόγιο αυτή τη στιγμή.';
$string['errorinvalidbymonth'] = 'Έγκυρες τιμές για τον κανόνα BYMONTH είναι από 1 μέχρι 12.';
$string['errorinvalidbymonthday'] = 'Έγκυρες τιμές για τον κανόνα BYMONTHDAY είναι από 1 μέχρι 31 ή -31 μέχρι -1.';
...
$string['errorrrule'] = 'Ο κανόνας προβιβασμού είναι λάθος';
$string['errorrruleday'] = 'Ο κανόνας έχει μια μη έγκυρη παράμετρο';
$string['errorrrulefreq'] = 'Ο κανόνας έχει μια μη έγκυρη παράμετρο συχνότητας';
...
$string['eventsimported'] = 'Τα γεγονότα που εισήχθηκαν: {$a}';
...
$string['eventsupdated'] = 'Τα γεγονότα που ενημερώθηκαν: {$a}';
...
$string['for'] = 'για';
$string['forcecalendartype'] = 'Επιβολή ημερολογίου';
$string['fri'] = 'Παρ';
...
$string['hidecourseevents'] = 'Απόκρυψη γεγονότων μαθήματος';
$string['hideglobalevents'] = 'Απόκρυψη καθολικών γεγονότων';
$string['hidegroupsevents'] = 'Απόκρυψη γεγονότων ομάδων';
$string['hideuserevents'] = 'Απόκρυψη γεγονότων χρηστών';
...
$string['importfrominstructions'] = 'Παρακαλώ δώστε μια διεύθυνση URL για ένα απομακρυσμένο ημερολόγιο, ή ανεβάστε ένα αρχείο.';
$string['importfromurl'] = 'Ημερολόγιο URL';
$string['invalidtimedurationminutes'] = 'Η διάρκεια σε λεπτά που έχετε εισάγει δεν είναι έγκυρη. Παρακαλώ εισάγετε την διάρκεια σε λεπτά μεγαλύτερη από 0 ή επιλέξτε Όχι διάρκεια.';
$string['invalidtimedurationuntil'] = 'Η ημερομηνία και η ώρα που επιλέξατε για διάρκεια έως είναι προγενέστερη από την ώρα έναρξης του γεγονότος. Παρακαλώ διορθώστε πριν προχωρήσετε.';
...
$string['pref_persistflt_help'] = 'Αν είναι ενεργοποιημένο, τότε το Moodle θα θυμάται τις τελευταίες ρυθμίσεις φίλτρου για την περίπτωση σας και θα τις επαναφέρει αυτόματα κάθε φορά που θα συνδέεστε.';
...
$string['pref_timeformat_help'] = 'Μπορείτε να επιλέξετε να δείτε την ώρα σε 12 ή 24 ωρη μορφή. Αν επιλέξετε "προεπιλογή", τότε η μορφή θα επιλεγεί αυτόματα ανάλογα με τη γλώσσα που χρησιμοποιείτε στον ιστοχώρο.';
$string['quickdownloadcalendar'] = 'Γρήγορο κατέβασμα / συνδρομή στο ημερολόγιο';
...
$string['showcourseevents'] = 'Εμφάνιση γεγονότων μαθημάτων';
$string['showglobalevents'] = 'Εμφάνιση καθολικών γεγονότων';
$string['showgroupsevents'] = 'Εμφάνιση γεγονότων ομάδων';
$string['shown'] = 'εμφανίζονται';
$string['showuserevents'] = 'Εμφάνιση γεγονότων χρήστη';
$string['siteevents'] = 'Γεγονότα ιστοχώρου';
...
$string['subsource'] = 'Πηγή γεγονότος: {$a->name}';
$string['sun'] = 'Κυρ';
...
$string['tt_hideglobal'] = 'Τα καθολικά γεγονότα συστήματος φαίνονται (κλικ για απόκρυψη)';
...
$string['tt_showglobal'] = 'Τα καθολικά γεγονότα δε φαίνονται (κλικ για εμφάνιση)';
