...
$string['addtoyourcontacts'] = 'Προσθήκη στις επαφές σας';
$string['ago'] = '{$a} πρίν';
...
$string['loggedindescription'] = 'Όταν είμαι συνδεδεμένος';
$string['loggedin_help'] = 'Προσαρμόστε το πώς επιθυμείτε να λαμβάνετε ειδοποιήσεις όταν είστε συνδεδεμένος/η στη πλατφόρμα';
$string['loggedoff'] = 'Μη συνδεδεμένος';
$string['loggedoffdescription'] = 'Όταν δεν είμαι συνδεδεμένος';
$string['loggedoff_help'] = 'Προσαρμόστε το πώς επιθυμείτε να λαμβάνετε ειδοποιήσεις όταν δεν είστε συνδεδεμένος/η στη πλατφόρμα';
...
$string['removefromyourcontacts'] = 'Αφαίρεση από τις επαφές σας';
