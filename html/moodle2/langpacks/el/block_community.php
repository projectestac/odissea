...
/**
 * Strings for component 'block_community', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['blocks'] = 'Μπλοκ';
$string['cannotselecttopsubject'] = 'Δεν είναι δυνατή η επιλογή επιπέδου κορυφαίου θέματος';
$string['comments'] = 'Σχόλια ({$a})';
$string['community:addinstance'] = 'Προσθήκη νέου μπλοκ «Εύρεση κοινότητας»';
$string['community:myaddinstance'] = 'Προσθήκη νέου μπλοκ «Εύρεση κοινότητας» στο Ταμπλό';
...
$string['downloadable'] = 'μαθήματα που μπορώ να κάνω λήψη';
...
$string['errorcourselisting'] = 'Προέκυψε σφάλμα κατά την ανάκτηση της λίστας μαθημάτων από τον επιλεγμένο κεντρικό κόμβο. Παρακαλούμε προσπαθήστε ξανά αργότερα. ({$a})';
