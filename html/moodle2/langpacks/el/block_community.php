...
$string['downloadablecourses'] = 'Μαθήματα που μπορούν να ληφθούν';
...
$string['downloadingsize'] = 'Παρακαλώ περιμένετε... γίνεται λήψη του μαθήματος ({$a->total}Mb)...';
...
$string['enroldownload_help'] = 'Μερικά μαθήματα που περιλαμβάνονται στο επιλεγμένο κόμβο διαφημίζονται, προκειμένου να έλθουν άτομα και να λάβουν μέρος σε αυτά στον αρχικό ιστότοπο.

Άλλα είναι πρότυπα μαθημάτων που παρέχονται για να μπορείτε να τα κατεβάσετε και να χρησιμοποιήσετε στο δικό σας ιστότοπο Moodle.';
...
$string['visitsite'] = 'Δείτε τον ιστότοπο';
