...
/**
 * Strings for component 'grading', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   grading
...
$string['gradingformunavailable'] = 'Παρακαλούμε σημειώστε: η φόρμα προχωρημένης βαθμολόγησης δεν είναι έτοιμη προς το παρόν. Η Απλή μέθοδος βαθμολόγησης θα χρησιμοποιηθεί μέχρι η φόρμα να αποκτήσει έγκυρη κατάστση.';
...
$string['manageactionshare'] = 'Δημοσίευση της φόρμας ως ένα νέο πρότυπο';
$string['manageactionshareconfirm'] = 'Πρόκειται να αποθηκεύσετε ένα αντίγραφο της φόρμας βαθμολόγησης «{$a}» ως ένα νέο δημόσιο πρότυπο. Οι άλλοι χρήστες του ιστοτόπου σας θα μπορούν να δημιουργούν στις δραστηριότητές τους νέες φόρμες βαθμολόγησης από αυτό το πρότυπο.';
...
Από προεπιλογή, μόνο οι φόρμες βαθμολόγησης που έχουν αποθηκευτεί ως κοινόχρηστα πρότυπα περιλαμβάνονται στα αποτελέσματα της αναζήτησης. Μπορείτε επίσης να περιλάβετε όλες τις φόρμες σας στα αποτελέσματα. Έτσι, μπορείτε απλά να επαναχρησιμοποιήσετε τις φόρμες σας χωρίς να τις κάνετε κοινόχρηστες. Μόνο φόρμες επισημασμένες ως «Έτοιμες για χρήση» μπορούν να χρησιμοποιηθούν με αυτόν τον τρόπο.';
$string['statusdraft'] = 'Προσχέδιο';
$string['statusready'] = 'Έτοιμες για χρήση';
$string['templatedelete'] = 'Διαγραφή';
$string['templatedeleteconfirm'] = 'Πρόκειται να διαγράψετε το κοινόχρηστο πρότυπο «{$a}». Διαγραφή ενός προτύπου δεν επηρεάζει τις υπάρχουσες φόρμες που δημιουργήθηκαν από αυτό.';
$string['templateedit'] = 'Επεξεργασία';
$string['templatepick'] = 'Χρήση αυτού του προτύπου';
$string['templatepickconfirm'] = 'Θέλετε να χρησιμοποιήσετε την φόρμα βαθμολόγησης «{$a->formname}» ως πρότυπο για την νέα φόρμα στο «{$a->component} ({$a->area})»;';
$string['templatepickownform'] = 'Χρήση αυτής της φόρμας ως προτύπου';
$string['templatesource'] = 'Τοποθεσία: {$a->component} ({$a->area})';
$string['templatetypeown'] = 'Δική σας φόρμα';
$string['templatetypeshared'] = 'Διαμοιραζόμενο πρότυπο';
