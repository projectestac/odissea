...
$string['formnotavailable'] = 'Επιλέχτηκε η προχωρημένη μέθοδος βαθμολόγησης αλλά η φόρμα βαθμολόγησης δεν είναι έτοιμη ακόμη. Ίσως πρέπει να την ορίσετε πρώτα μέσω ενός συνδέσμου στο μπλοκ Διαχείρισης.';
