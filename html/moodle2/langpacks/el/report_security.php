...
$string['check_emailchangeconfirmation_error'] = 'Οι χρήστες μπορούν να εισάγουν οποιαδήποτε δι/νση ηλε.ταχυδρομείου.';
...
$string['check_emailchangeconfirmation_name'] = 'Επιβεβαίωση αλλαγής δι/νσης ηλε.ταχυδρομείου';
$string['check_emailchangeconfirmation_ok'] = 'Επιβεβαίωση αλλαγής δι/νσης ηλε.ταχυδρομείου στο προφίλ του χρήστη.';
