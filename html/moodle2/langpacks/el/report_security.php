...
$string['check_configrw_details'] = '<p>Συνιστάται να αλλάξετε τα δικαιώματα του αρχείου config.php μετά την εγκατάσταση ώστε το αρχείο να μην μπορεί να τροποποιηθεί από τον εξυπηρετητή ιστού.
Παρακαλούμε σημειώστε ότι αυτό το μέτρο δεν βελτιώνει την ασφάλεια του εξυπηρετητή σημαντικά, αν και μπορεί να καθυστερήσει ή και να περιορίσει τις τυπικές κακόβουλες επιθέσεις.</p>';
...
$string['check_embed_details'] = '<p>Η άνευ ορίου ενσωμάτωση αντικειμένων σε σελίδες είναι πολύ επικίνδυνη - κάθε εγγεγραμμένος χρήστης μπορεί να ξεκινήσει μια επίθεση XSS εναντίον χρηστών άλλου εξυπηρετητή. Αυτή η ρύθμιση θα πρέπει να απενεργοποιείται σε εξυπηρετητές παραγωγής.</p>';
...
$string['check_mediafilterswf_details'] = '<p>Η αυτόματη ενσωμάτωση αρχείων swf σε σελίδες είναι πολύ επικίνδυνη - οποιοσδήποτε εγγεγραμμένος χρήστης μπορεί να ξεκινήσει μια επίθεση XSS εναντίον χρηστών άλλου εξυπηρετητή. Παρακαλούμε απενεργοποιήστε το σε εξυπηρετητές παραγωγής.</p>';
...
$string['check_noauth_ok'] = 'Η υπομονάδα λογισμικού Χωρίς Πιστοποίηση είναι απενεργοποιημένη.';
$string['check_nodemodules_details'] = '<p>Ο φάκελος <em>{$a->path}</em> περιέχει τα αρθρώματα Node.js και τις εξαρτήσεις τους, συνήθως εγκατεστημένες από το βοηθητικό πρόγραμμα NPM. Αυτά τα αρθρώματα ενδέχεται να είναι απαραίτητα για την τοπική ανάπτυξη του Moodle, όπως για παράδειγμα για τη χρήση του πλαισίου grunt. Δεν χρειάζονται για την λειτουργία ενός ιστοτόπου Moodle στην παραγωγή και μπορεί να περιέχουν δυνητικά επικίνδυνο κώδικα που εκθέτει τον ιστότοπό σας σε απομακρυσμένες επιθέσεις.</p><p>Συνιστάται ένθερμα να καταργήσετε τον φάκελο αν ο ιστότοπος είναι διαθέσιμος μέσω δημόσιας διεύθυνσης URL, ή τουλάχιστον να απαγορεύσετε την πρόσβαση ιστού σε αυτόν στις ρυθμίσεις του εξυπηρετητή σας.</p>';
...
$string['check_vendordir_details'] = '<p>Ο φάκελος <em>{$a->path}</em> περιέχει διάφορες βιβλιοθήκες τρίτων κατασκευαστών και τις εξαρτήσεις τους, συνήθως εγκατεστημένες από τον PHP Composer. Αυτές οι βιβλιοθήκες μπορεί να είναι απαραίτητες για την τοπική ανάπτυξη του Moodle, όπως για την εγκατάσταση του πλαισίου PHPUnit. Δεν χρειάζονται για να την λειτουργία ενός ιστοτόπου Moodle στην παραγωγή και μπορεί να περιέχουν δυνητικά επικίνδυνο κώδικα που εκθέτει τον ιστότοπό σας σε απομακρυσμένες επιθέσεις.</p><p>Συνιστάται ένθερμα να καταργήσετε τον φάκελο αν ο ιστότοπος είναι διαθέσιμος μέσω δημόσιας διεύθυνσης URL, ή τουλάχιστον να απαγορεύσετε την πρόσβαση ιστού σε αυτόν στις ρυθμίσεις του διακομιστή σας.</p>';
