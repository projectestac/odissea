...
$string['check_cookiesecure_details'] = '<p>Εάν ενεργοποιήσετε την επικοινωνία https τότε σας συνιστούμε να ενεργοποιήσετε επίσης και τα ασφαλή cookies. Θα πρέπει επίσης να προσθέσετε μόνιμη ανακατεύθυνση από http σε https. Ιδανικά, ενεργοποιήστε και τις κεφαλίδες της πολιτικής HSTS.</p>';
...
$string['check_webcron_name'] = '(Δέσμη ενεργειών PHP χρονο-προγραμματισμού) cron, ιστού';
