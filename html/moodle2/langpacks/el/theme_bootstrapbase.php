...
$string['choosereadme'] = '<div class = "theme_screenshot"> <h2> Βάση Bootstrap</ h2> <img class = img-polaroid src = "bootstrap / pix / screenshot.jpg" /> <h3> </ h3> <p> <h3> Θέμα Bootstrap του Moodle twitter </ h3> <p> Αυτό το θέμα βασίζεται στο πλαίσιο CSS Bootstrap, έκδοση 2.3 </ p> <p> <a href = "http: // getbootstrap .com "> http://getbootstrap.com </a> </ p> <p> Αυτό είναι ένα θέμα GPL που είναι διαθέσιμο στο GitHub: </ p> <p> <a href = https: // github. com / bmbrands / theme_bootstrap "> https://github.com/bmbrands/theme_bootstrap </a> </ p> <p> Μπορείτε να το τροποποιήσετε / βελτιώσετε / μοιραστείτε. </ p> <p> Αυτό το θέμα δημιουργήθηκε με η βοήθεια των: Stuart Lamour, Mark Aberdour, Paul Hibbitts, Mary Evans. <br> Συντάκτες: Bas Brands, David Scotson. <br> Επικοινωνία: bas@sonsbeekmedia.nl <br> Ιστοσελίδα: <a href = "http : //www.basbrands.nl "> www.basbrands.nl </a> <br> </ p>
<br>
