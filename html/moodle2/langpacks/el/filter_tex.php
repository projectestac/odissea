...
/**
 * Strings for component 'filter_tex', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   filter_tex
...
$string['pathconvert'] = 'Μονοπάτι για το <i>convert</i> εκτελέσιμο αρχείο';
$string['pathdvips'] = 'Μονοπάτι για το <i>dvips</i> εκτελέσιμο αρχείο';
$string['pathdvisvgm'] = 'Μονοπάτι για το <i>dvisvgm</i> εκτελέσιμο αρχείο';
$string['pathlatex'] = 'Μονοπάτι για το <i>latex</i> εκτελέσιμο αρχείο';
$string['pathmimetex'] = 'Μονοπάτι για το <i>mimetex</i> εκτελέσιμο αρχείο';
