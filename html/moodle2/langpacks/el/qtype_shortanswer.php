...
$string['answermustbegiven'] = 'Πρέπει να εισάγετε μια απάντηση εάν υπάρχει βαθμός ή ανατροφοδότηση.';
$string['answerno'] = 'Απάντηση {$a}';
$string['caseno'] = 'Όχι, δεν υπάρχει διαφορά μεταξύ μικρών και κεφαλαίων';
$string['casesensitive'] = 'Διάκριση μικρών/κεφαλαίων (Case sensitive)';
...
$string['pluginnamesummary'] = 'Επιτρέπει μια απάντηση η οποία αποτελείται από καμία ή λίγες λέξεις και η οποία βαθμολογείται σε σύγκριση με διάφορες πρότυπες απαντήσεις, οι οποίες μπορούν να περιέχουν μπαλαντέρ.';
