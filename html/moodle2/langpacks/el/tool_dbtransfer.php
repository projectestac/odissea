...
/**
 * Strings for component 'tool_dbtransfer', language 'el', branch 'MOODLE_31_STABLE'
 *
...
$string['transferdbtoserver'] = 'Μεταφορά αυτής της Moodle βάσης σε άλλο διακομιστή';
$string['transferringdbto'] = 'Γίνεται μεταφορά της βάσης σε {$a->dbtype} βάση {$a->dbname} στον {$a->dbhost}';
