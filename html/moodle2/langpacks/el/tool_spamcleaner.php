...
$string['spamcleanerintro'] = '<p>Αυτή η δέσμη ενεργειών σας επιτρέπει να αναζητήσετε σε όλα τα προφίλ των χρηστών, συγκεκριμένες συμβολοσειρές και έπειτα να σβήσετε αυτούς τους λογαριασμούς που έχουν προφανώς δημιουργηθεί από κακόβουλους χρήστες. Μπορείτε να κάνετε αναζήτηση με πολλαπλές λέξεις κλειδιά χρησιμοποιώντας κόμμα (π.χ καζίνο, πορνό).</p> <p>Για περισσότερες πληροφορίες, δείτε την τεκμηρίωση του Moodle σχετικά με την <a href="http://docs.moodle.org/en/Reducing_spam_in_Moodle">Μείωση των ανεπιθύμητων μηνυμάτων στο Moodle (Reducing spam in Moodle)</a>.</p>';
