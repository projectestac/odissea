...
$string['autoupdate_settings_desc'] = '<p> Επιλέξτε πεδία για ενημέρωση όταν εκτελείται το σενάριο συγχρονισμού (enrol/ldap/cli/sync.php).</p><p>Όταν επιλεγεί τουλάχιστον ένα πεδίο, θα γίνει μια ενημέρωση.</p>';
...
$string['bind_dn_key'] = 'Δεσμεύστε το διακεκριμένο όνομα χρήστη';
...
$string['group_memberofattribute'] = 'Όνομα του χαρακτηριστικού που καθορίζει τις ομάδες στις οποίες ανήκει ένας συγκεκριμένος χρήστης ή ομάδα (π.χ. μέλος ομάδας, μέλος ομαδοποίησης, κ.λπ.)';
...
$string['ldap_encoding'] = 'Καθορίστε την κωδικοποίηση που χρησιμοποιείται από το διακομιστή LDAP. Πιθανότατα το utf-8, το MS AD v2 χρησιμοποιεί προεπιλεγμένη κωδικοποίηση πλατφόρμας όπως cp1252, cp1250, κλπ.';
...
$string['ok'] = 'OK!';
$string['opt_deref'] = 'Εάν η ιδιότητα μέλους της ομάδας περιέχει διακριτικά ονόματα, καθορίστε τον τρόπο χειρισμού των ψευδώνυμα κατά τη διάρκεια μιας αναζήτησης. Επιλέξτε μία από τις ακόλουθες τιμές: \'Όχι\' (LDAP_DEREF_NEVER) ή \'Ναι\' (LDAP_DEREF_ALWAYS).';
...
$string['role_mapping'] = '<p>Για κάθε ρόλο που θέλετε να αντιστοιχίσετε από το LDAP, πρέπει να καθορίσετε τη λίστα των πλαισίων όπου βρίσκονται οι ρόλοι των ομάδων μαθημάτων((;)). Διαχωρίστε διαφορετικά πλαίσια με \';\'.</p><p>Πρέπει επίσης να καθορίσετε το ιδιοχαρακτηριστικό που χρησιμοποιεί ο εξυπηρετητής LDAP για να κρατάει τα μέλη μιας ομάδας. Συνήθως \'member\' ή \'memberUid\'</p>';
...
$string['syncenrolmentstask'] = 'Eργασία συγχρονισμού εγγραφών';
