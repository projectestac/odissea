...
$string['cannotaddcoursemodule'] = 'Αδυναμία προσθήκης νέου αρθρώματος μαθήματος';
...
$string['cannotcreateuploaddir'] = 'Αδυναμία δημιουργίας φακέλου μεταφορτώσεων. Ο διαχειριστής του ιστοχώρου πρέπει να ρυθμίσει τα δικαιώματα.';
...
$string['cannotunassignrolefrom'] = 'Αδυναμία κατάργησης αυτού του χρήστη από το id ρόλου: {$a}';
...
$string['cannotupdaterss'] = 'Αδυναμία ενημέρωσης RSS';
...
$string['invalidlegacy'] = 'Λανθασμένος προσδιορισμός ρόλου παλαιότερης έκδοσης για τον τύπο: {$a}';
...
$string['iplookupfailed'] = 'Αδυναμία εύρεσης πληροφοριών geo σχετικά με αυτήν την IP διεύθυνση {$a}';
...
$string['remotedownloadnotallowed'] = 'Η λήψη συστατικών στο διακομιστή δεν επιτρέπεται (το allow_url_fopen είναι απενεργοποιημένο).<br /><br />Πρέπει να κατεβάσετε το αρχείο <a href="{$a->url}">{$a->url}</a> χειροκίνητα, να το αντιγράψετε στο "{$a->dest}" στο διακομιστή σας και αποσυμπιέστε το εκεί.';
...
$string['storedfilecannotcreatefiledirs'] = 'Αδυναμία δημιουργίας τοπικών pool καταλόγων αρχείων, παρακαλώ ελέγξτε τα δικαιώματα στο dataroot.';
