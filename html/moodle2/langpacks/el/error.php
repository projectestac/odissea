...
$string['cannoteditsiteform'] = 'Δεν μπορείτε να επεξεργαστείτε το μάθημα ιστοτόπου χρησιμοποιώντας αυτήν τη φόρμα';
...
<p>Ο διαχειριστής του ιστοτόπου θα πρέπει να ελέγξει τις ρυθμίσεις του διακομιστή</p><p>{$a}</p>';
...
$string['messagingdisable'] = 'Η αποστολή μηνυμάτων είναι απενεργοποιημένη σε αυτόν τον ιστότοπο';
...
$string['remotedownloadnotallowed'] = 'Το κατέβασμα στοιχείων λογισμικού στο διακομιστή δεν επιτρέπεται (το allow_url_fopen είναι απενεργοποιημένο).<br /><br />Πρέπει να κατεβάσετε το <a href="{$a->url}">{$a->url}</a> αρχείο χειροκίνητα, αντιγράψτε το στο "{$a->dest}" στο διακομιστή σας και αποσυμπιέστε το εκεί.';
...
$string['sessionerroruser'] = 'Η σύνδεσή σας έμεινε ανενεργή για πολύ χρόνο. Παρακαλώ συνδεθείτε ξανά.';
...
$string['upgraderunning'] = 'Ο ιστότοπος βρίσκεται υπό αναβάθμιση, παρακαλώ ξαναπροσπαθήστε αργότερα.';
