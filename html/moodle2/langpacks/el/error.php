...
/**
 * Strings for component 'error', language 'el', branch 'MOODLE_31_STABLE'
 *
 * @package   error
...
$string['filenotfound'] = 'Συγγνώμη, το αρχείο που ζητήθηκε δε βρέθηκε';
...
$string['nocontext'] = 'Συγγνώμη, αλλά αυτό το μάθημα δεν αποτελεί έγκυρο πλαίσιο';
...
$string['nopermissions'] = 'Συγγνώμη, αλλά επί του τρεχόντως δεν έχετε το δικαίωμα να το κάνετε αυτό ({$a})';
