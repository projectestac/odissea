...
$string['cannotcreateuploaddir'] = 'Αποτυχία δημιουργίας φακέλου μεταφορτώσεων. Ο διαχειριστής του ιστοτόπου πρέπει να ρυθμίσει τα δικαιώματα αρχείων.';
...
$string['cannotgeoplugin'] = 'Δεν είναι δυνατή η σύνδεση με τον εξυπηρετητή geoPlugin στη διεύθυνση http://www.geoplugin.com, ελέγξτε τις ρυθμίσεις διακομιστή μεσολάβησης ή καλύτερα να εγκαταστήσετε το αρχείο δεδομένων MaxMind GeoLite City';
...
$string['cannotmailconfirm'] = 'Σφάλμα κατά την αποστολή μηνύματος ηλεκτρονικού ταχυδρομείου για επιβεβαίωση αλλαγής κωδικού πρόσβασης';
...
$string['cannotopentemplate'] = 'Αδυναμία ανοίγματος αρχείου-προτύπου ({$a})';
...
$string['cannotresetguestpwd'] = 'Δεν μπορείτε να επαναφέρετε τον κωδικό πρόσβασης επισκέπτη';
$string['cannotresetmail'] = 'Σφάλμα επαναφοράς κωδικού πρόσβασης και αποστολής μηνύματος ηλεκτρονικού ταχυδρομείου';
$string['cannotresetthisrole'] = 'Αδυναμία επαναφοράς αυτού του ρόλου';
$string['cannotrestore'] = 'Προέκυψε σφάλμα και δεν ήταν δυνατή η ολοκλήρωση της επαναφοράς!';
...
$string['cannotusepage2'] = 'Λυπούμαστε, δεν μπορείτε να χρησιμοιήσετε αυτή τη σελίδα';
...
$string['commentmisconf'] = 'Το ID του σχολίου είναι κακοδιαμορφωμένο';
...
$string['csvfewcolumns'] = 'Δεν υπάρχουν αρκετές στήλες. Παρακαλούμε επιβεβαιώστε τη ρύθμιση του διαχωριστικού στηλών.';
...
$string['dbdriverproblem'] = '<p>Σφάλμα: Ο οδηγός της βάσης εμφάνισε πρόβλημα</p> <p>Ο διαχειριστής του ιστοτόπου θα πρέπει να ελέγξει τις ρυθμίσεις του εξυπηρετητή</p><p>{$a}</p>';
...
$string['dbsessionmysqlpacketsize'] = 'Εντοπίστηκε σοβαρό σφάλμα συνόδου. Παρακαλούμε ειδοποιήστε το διαχεριστή του ιστοτόπου. Το πρόβλημα πιθανότατα προκλήθηκε από χαμηλή τιμή της ρύθμισης max_allowed_packet στην MySQL.';
...
$string['emailfail'] = 'Αποτυχία αποστολής μηνύματος ηλεκτρονικού ταχυδρομείου';
...
$string['gradesneedregrading'] = 'Οι βαθμοί μαθημάτων πρέπει να υπολογιστούν ξανά';
...
$string['invalidcommentitemid'] = 'Μη έγκυρο αναγνωριστικό στοιχείου σχολίου (commentid)';
$string['invalidcommentparam'] = 'Μη έγκυρες παραμέτροι σχολίων';
...
$string['invalidfiletype'] = '"{$a}" δεν είναι έγκυρος τύπος αρχείου';
...
$string['invalidgradeitemid'] = 'Λανθασμένο αναγνωριστικό (id) στοιχείου βαθμού';
...
$string['invalidlegacy'] = 'Λανθασμένος ορισμός ρόλου παλαιάς έκδοσης για τον τύπο: {$a}';
...
$string['invalidoutcome'] = 'Μη έγκυρο αναγνωριστικό (id) μαθησιακού αποτελέσματος';
...
$string['mnetlocal'] = 'Οι απομακρυσμένοι χρήστες MNET δεν μπορούν να συνδεθούντοπικά';
...
$string['noformdesc'] = 'Δε βρέθηκε προσδιορισμός φόρμας formslib γι\' αυτή τη δρστηριότητα.';
...
$string['noparticipants'] = 'Δε βρέθηκαν συμμετέχοντες γι\' αυτό το μάθημα';
$string['noparticipatorycms'] = 'Συγγνώμη, αλλά δεν έχετε αρθρώματα συμμετοχικού μαθήματος για να αναφέρετε';
$string['nopermissions'] = 'Συγγνώμη, αλλά αυτή τη στιγμή δεν έχετε τα δικαιώματα για να το κάνετε αυτό ({$a})';
...
$string['nopermissiontoupdatecalendar'] = 'Συγγνώμη, αλλά αυτή τη στιγμή δεν έχετε τα δικαιώματα για να ενημερώσετε γεγονός ημερολογίου';
...
$string['redirecterrordetected'] = 'Ανιχντεύτηκε μη υποστηριζόμενη ανακατεύθυνση. Τερματίστηκε η εκτέλεση δέσμης ενεργειών';
$string['refoundto'] = 'Μπορεί να σας επιστραφεί το ποσό {$a}';
$string['refoundtoorigi'] = 'Έγινε επιστροφή στο αρχικό ποσό: {$a}';
$string['registrationdisabled'] = 'Η εγγραφή είναι απενεργοποιημένη σε αυτόν τον ιστότοπο';
...
$string['reverseproxyabused'] = 'Έχει ενεργοποιηθεί ο Reverse proxy. Ο εξυπηρετητής σας τώρα δεν είναι προσβάσιμος απευθείας. Λυπούμαστε γι\' αυτό.<br />Παρακαλούμε επικοινωνήστε με το διαχειριστή του εξυπηρετητή σας.';
...
$string['sessiondiskfull'] = 'Η διαμέριση συνόδου (session partition) είναι πλήρης. Δεν είναι δυνατή η σύνδεση αυτή τη στιγμή. Παρακαλούμε ειδοποιήστε τον διαχεριστή του εξυπηρετητή';
...
$string['storedfilecannotcreatefile'] = 'Αδυναμία δημιουργίας τοπικού αρχείου στη «δεξαμενή αρχείων». Παρακαλούμε, επιβεβαιώστε τα δικαιώματα στο φάκελο dataroot και το διαθέσιμο χώρο στο δίσκο.';
$string['storedfilecannotcreatefiledirs'] = 'Δεν είναι δυνατή η δημιουργία τοπικών pool καταλόγων αρχείων. Παρακαλούμε ελέγξτε τα δικαιώματα στο dataroot.';
