...
/**
 * Strings for component 'auth_cas', language 'el', branch 'MOODLE_31_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_invalidcaslogin'] = 'Συγγνώμη, η είσοδος απέτυχε, δεν πιστοποιήθηκε η ταυτότητά σας';
