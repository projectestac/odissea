...
$string['auth_cas_certificate_path'] = 'Διαδρομή του CA (Certificate Authority: Αρχή έκδοσης πιστοποιητικών για ασφαλείς συνδέσεις στο Διαδίκτυο) αρχείου αλυσίδας (σε μορφότυπο PEM) για επικύρωση του πιστοποιητικού εξυπηρετητή.';
...
$string['auth_cas_certificate_path_key'] = 'Διαδρομή (πλήρες όνομα αρχείου) πιστοποιητικού';
