...
/**
 * Strings for component 'grades', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   grades
...
Η νεότερη έκδοση είναι {$a->currentversion}· χρησιμοποιείτε την έκδοση βαθμολoγίου {$a->gradebookversion}. Μπορείτε να δείτε μια λίστα αλλαγών στις <a href="{$a->url}">Αλλαγές υπολογισμών βαθμολoγίου</a>.';
...
$string['resetweights'] = 'Αρχικοποίηση των συντελεστών βαρύτητας του «{$a->itemname}»';
$string['resetweightsshort'] = 'Αρχικοποίηση συντελεστών βαρύτητας';
...
$string['weightoverride_help'] = 'Εάν αποεπιλεγεί θα επαναφέρει τον συντελεστή βαρύτητας ενός στοιχείου βαθμού στην αυτόματα υπολογισμένη τιμή του. Εάν επιλεγεί θα αποτραπεί η αυτόματη ρύθμιση/προσαρμογή του συντελεστή βαρύτητας.';
