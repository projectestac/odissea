...
$string['adjustedweight'] = 'Με συντελεστή βαρύτητας';
...
$string['aggregatesubcatsupgradedgrades'] = 'Σημείωση: Η ρύθμιση συνάθροισης «Συνάθροιση με συμπερίληψη υποκατηγοριών» έχει αφαιρεθεί ως μέρος μιας αναβάθμισης του ιστοτόπου. Επειδή το «Συνάθροιση με συμπερίληψη υποκατηγοριών» χρησιμοποιήθηκε προηγουμένως στο παρόν μάθημα, συνιστάται να επαναθεωρήσετε αυτή την αλλαγή στο βαθμολόγιο.';
...
$string['averagesdecimalpoints_help'] = 'Αυτή η ρύθμιση καθορίζει τον αριθμό των δεκαδικών ψηφίων που θα εμφανίζονται για κάθε μέσο όρο ή αν η ρύθμιση του συνόλου δεκαδικών ψηφίων για την κατηγορία ή το στοιχείο βαθμού χρησιμοποιείται (κληρονομεί).';
...
$string['backupwithoutgradebook'] = 'Το αντίγραφο ασφαλείας δεν περιέχει ρυθμίσεις βαθμολόγιου';
...
$string['combo'] = 'Καρτέλες και αναπτυσσόμενο μενού';
...
$string['dropdown'] = 'Αναπτυσσόμενο μενού';
...
$string['errornocourse'] = 'Δεν ήταν δυνατή η ανάκτηση πληροφορίων μαθήματος';
...
$string['gradealreadyupdated'] = 'Δεν έχουν εισαχθεί {$a} βαθμοί επειδή οι βαθμοί στο αρχείο εισαγωγής είναι παλαιότεροι από ό,τι στην αναφορά βαθμολογητή. Για να συνεχίσετε με την εισαγωγή βαθμού ούτως ή άλλως, χρησιμοποιήστε την επιλογή υποχρεωτικής εισαγωγής.';
...
$string['gradebookcalculationswarning'] = 'Σημείωση: Έχουν εντοπιστεί ορισμένα σφάλματα κατά τον υπολογισμό των βαθμών που εμφανίζονται στο βαθμολόγιο. Εάν το μάθημά σας δεν έχει ξεκινήσει ή βρίσκεται σε εξέλιξη, συνιστάται να διορθωθούν τα σφάλματα κάνοντας κλικ στο παρακάτω κουμπί, αν και αυτό θα έχει ως αποτέλεσμα την αλλαγή ορισμένων βαθμών. Εάν το μάθημά σας έχει ήδη λήξει και έχουν υποβληθεί βαθμοί, πιθανώς δεν θέλετε να διορθώσετε αυτό το ζήτημα. Η νεότερη έκδοση είναι {$a->currentversion}· χρησιμοποιείτε την έκδοση βαθμολoγίου {$a->gradebookversion}. Μπορείτε να δείτε μια λίστα αλλαγών στις <a href="{$a->url}">Αλλαγές υπολογισμών βαθμολoγίου</a>.';
...
* Πραγματικοί βαθμοί
* Ποσοστό
* Γράμμα - Γράμματα ή λέξεις χρησιμοποιούνται για να παρουσιάσουν ένα εύρος βαθμών';
...
$string['gradeexportdecimalpoints_desc'] = 'Ο αριθμός των δεκαδικών ψηφίων που θα εμφανίζονται κατά την εξαγωγή. Μπορεί να παρακαμφθεί κατά την εξαγωγή.';
$string['gradeexportdisplaytype'] = 'Τρόπος εμφάνισης εξαγωγής βαθμού';
$string['gradeexportdisplaytype_desc'] = 'Οι βαθμοί μπορούν να εμφανίζονται σαν πραγματικοί βαθμοί, σαν ποσοστά (σε σχέση με τον ελάχιστο και μέγιστο βαθμό) ή σαν γράμματα (A, B, C κλπ..) κατά την εξαγωγή. Αυτό μπορεί να παρακαμθεί κατά την εξαγωγή.';
...
$string['gradepass_help'] = 'Αυτή η ρύθμιση καθορίζει τον ελάχιστο βαθμό που απαιτείται για να περάσει κανείς. Η τιμή χρησιμοποιείται στην ολοκλήρωση δραστηριότητας και μαθήματος, και στο βαθμολόγιο, όπου οι βαθμοί επιτυχίας επισημαίνονται με πράσινο χρώμα και οι βαθμοί αποτυχίας με κόκκινο.';
...
$string['gradepublishing_help'] = 'Ενεργοποίηση δημοσίευσης εξαγωγών και εισαγωγών: Η πρόσβαση στους εξαγόμενους βαθμούς γίνεται γίνεται μέσω μιας τοποθεσίας ιστού, χωρίς την αναγκαιότητα εισόδου σε έναν ιστότοπο Moodle. Η εισαγωγή των βαθμών μπορεί να γίνει με την πρόσβαση σε μια τέτοια τοποθεσία ιστού (που σημαίνει οτι ένας ιστότοπος Moodle μπορεί να εισάγει βαθμούς που έχουν δημοσιευθεί από έναν άλλο ιστότοπο). Εξ\'ορισμού μόνο οι διαχειριστές μπορούν να χρησιμοποιούν αυτό το χαρακτηριστικό, παρακαλούμε εκπαιδεύστε τους χρήστες πριν προσθέσετε τις απαραίτητες ικανότητες σε άλλους ρόλους (κίνδυνοι διαμοιρασμού σελιδοδεικτών και επιταχυντών λήψης, περιορισμοί IP κλπ.).';
...
$string['gradeview'] = 'Προβολή βαθμού';
...
* Απαιτείται ένα όνομα πεδίου που περιέχει δεδομένα ταυτότητας χρήστη - είτε όνομα χρήστη ή αναγνωριστικό αριθμό ή διεύθυνση ηλεκτρονικού ταχυδρομείου.
...
$string['importoutcomenofile'] = 'Το αρχείο που ανέβηκε είναι άδειο ή κατεστραμμένο. Παρακαλούμε επιβεβαιώστε οτι είναι ένα έγκυρο αρχείο. Το πρόβλημα εντοπίστηκε στη γραμμή {$a}· προκλήθηκε από το ότι οι γραμμές δεδομένων δεν έχουν τόσες στήλες όσες η πρώτη γραμμή (η γραμμή κεφαλίδας) ή επειδή από το εισαγόμενο αρχείο λείπουν κάποιες αναμενόμενες κεφαλίδες. Κοιτάξτε ένα εξαγώμενο αρχείο ως ένα παράδειγμα αρχείου με έγκυρες κεφαλίδες.';
...
$string['includescalesinaggregation_help'] = 'Μπορείτε να αλλάξετε το εάν οι κλίμακες θα συμπεριλαμβάνονται σαν αριθμοί σε όλους τους συναθροιζόμενους βαθμούς σε όλα τα βαθμολόγια όλων των μαθημάτων. ΠΡΟΣΟΧΗ: η αλλαγή αυτής της ρύθμισης θα επιβάλει επανυπολογισμό των συναθροιζόμενων βαθμών.';
...
$string['mapfrom_help'] = 'Επιλέξτε τη στήλη στο λογιστικό φύλλο που περιέχει δεδομένα για την αναγνώριση του χρήστη, όπως όνομα χρήστη, αναγνωριστικό χρήστη ή διεύθυνση ηλεκτρονικού ταχυδρομείου.';
...
$string['modgrade_help'] = 'Επιλέξτε τον τύπο βαθμολόγησης που χρησιμοποιείται για αυτή τη δραστηριότητα. Αν επιλεγεί «Κλίμακα», τότε μπορείτε κατόπιν να επιλέξετε την κλίμακα από το αναπτυσσόμενο μενού «Κλίμακα». Εάν χρησιμοποιείτε βαθμολόγηση «Πόντοι», μπορείτε στη συνέχεια να εισαγάγετε τη μέγιστη διαθέσιμη βαθμολογία για αυτή τη δραστηριότητα.';
...
$string['nopermissiontoresetweights'] = 'Δεν υπάρχει το δικαίωμα για επανακαθορισμό των συντελεστών βαρύτητας';
...
$string['outcomeconfirmdelete'] = 'Είστε σίγουροι οτι θέλετε να διαγράψετε το μαθησιακό αποτέλεσμα «{$a}»;';
...
$string['outcomereport'] = 'Αναφορά μαθ. αποτελέσματος';
...
$string['rangesdecimalpoints_help'] = 'Ορίζει τον αριθμό των δεκαδικών που θα εμφανίζονται για κάθε εύρος ή εάν θα χρησιμοποιηθεί (inherit, κληρονομηθεί) η συνολική ρύθμιση δεκαδικών ψηφίων για την κατηγορία ή το στοιχείο βαθμού.';
...
$string['resetweights'] = 'Επαναφορά των συντελεστών βαρύτητας του «{$a->itemname}»';
$string['resetweightsshort'] = 'Επαναφορά συντελεστών βαρύτητας';
...
$string['septab'] = 'Χαρακτήρας tab (στηλοθέτης)';
...
$string['showaverage_help'] = 'Εμφάνιση της στήλης μέσου όρου; Σημειώστε ότι οι συμετέχοντες έχουν την δυνατότητα να μαντέψουν τους βαθμούς άλλων μαθητών αν ο μέσος όρος είναι υπολογισμένος από μικρό αριθμό βαθμών. Για λόγους απόδοσης ο μέσος όρος είναι κατά προσέγγιση, αν εξαρτάται από τυχόν κρυφά στοιχεία.';
...
$string['showcontributiontocoursetotal'] = 'Προβολή συνεισφοράς στον τελικό βαθμό';
...
$string['showquickfeedback_help'] = 'Εάν ενεργοποιηθεί, όταν γίνεται επεξεργασία, εμφανίζεται ένα πλαίσιο εισαγωγής κειμένου ανατροφοδότησης με ένα διάστικτο περίγραμμα για κάθε βαθμό, επιτρέποντας την επεξεργασία των σχολίων ανατροφοδότησης για πολλές βαθμολογήσεις την ίδια στιγμή. Οι αλλαγές αποθηκεύονται και επισημαίνονται όταν κάνετε κλικ στο κουμπί ενημέρωσης.

Σημειώστε πως όταν γίνεται επεξεργασία ανατροφοδότησης στην αναφορά βαθμολογητή, μια επισήμανση παράκαμψης τίθεται, πράγμα που σημαίνει ότι η ανατροφοδότηση δεν μπορεί πλέον να αλλάξει μέσα από τη σχετική δραστηριότητα.';
...
$string['userfields_show_help'] = 'Εμφάνιση επιπρόσθετων πεδίων χρηστών όπως η διεύθυνση ηλεκτρονικού ταχυδρομείου στην αναφορά βαθμολογητή. Τα συγκεκριμένα πεδία που εμφανίζονται ελέγχονται από την ρύθμιση ιστοτόπου showuseridentity (εμφάνιση ταυτότητας χρήστη)';
$string['usergrade'] = 'Χρήστης {$a->fullname} ({$a->useridnumber}) στο στοιχείο {$a->gradeidnumber}';
$string['userid'] = 'ID χρήστη';
...
$string['weightoverride'] = 'προσαρμογή συντελεστή βαρύτητας';
$string['weightoverride_help'] = 'Εάν αποεπιλεγεί θα επαναφέρει τον συντελεστή βαρύτητας ενός στοιχείου βαθμού στην αυτόματα υπολογισμένη τιμή του. Εάν επιλεγεί θα αποτραπεί η αυτόματη προσαρμογή του συντελεστή βαρύτητας.';
$string['weights'] = 'Συντελεστές βαρύτητας';
$string['weightsadjusted'] = 'Οι συντελεστές βαρύτητάς σας προσαρμόστηκαν ώστε να έχουν σύνολο 100';
