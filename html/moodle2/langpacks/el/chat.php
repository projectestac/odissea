...
$string['configmethod'] = 'Η «Κανονική μέθοδος συνομιλίας μέσω ajax» παρέχει μια διεπαφή συνομιλίας (chat) βασισμένη στο ajax. Η κανονική μέθοδος συνομιλίας περιλαμβάνει τη συχνή/τακτική επικοινωνία των προγραμμάτων περιήγησης (πελάτες) με το Moodle (εξυπηρετητή). Δεν απαιτεί ρυθμίσεις και λειτουργεί παντού αλλά μπορεί να επιφέρει μεγάλο φόρτο στον εξυπηρετητή όταν οι συνομιλητές είναι πολλοί. Η χρήση αυτόνομης υπηρεσίας (daemon) απαιτεί πρόσβαση σε γραμμή εντολών (unix shell) αλλά έχει ως αποτέλεσμα ένα κλιμακώσιμο (ακόμα και με πολλούς χρήστες) γρήγορο περιβάλλον συνομιλίας.';
$string['confignormalupdatemode'] = 'Οι ενημερώσεις των δωματίων συνομιλιών κανονικά γίνονται αποδοτικά χρησιμοποιώντας την λειτουργία <em>Keep-Alive</em> του (πρωτοκόλλου) HTTP 1.1 αλλά αυτό είναι ήδη αρκετά επιβαρυντικό για τον εξυπηρετητή. Μια πιο εξελιγμένη μέθοδος είναι η χρήση στρατηγικής <em>Stream</em> για την προώθηση ενημερώσεων προς τους χρήστες. Με τη χρήση της <em>Stream</em> η κλιμάκωση είναι καλύτερη (παρόμοια με την μέθοδο αυτόνομης υπηρεσίας συνομιλίας).';
...
$string['configrefreshroom'] = 'Πόσο συχνά πρέπει να ανανεώνεται το ίδιο το δωμάτιο συνομιλίας (σε δευτερόλεπτα); Ορίζοντάς λίγα δευτερόλεπτα το δωμάτιο συνομιλίας θα φαίνεται γρηγορότερο αλλά μπορεί να επιβαρύνει πολύ τον εξυπηρετητή σας όταν συνομιλούν πολλά άτομα. Αν χρησιμοποιείτε ενημερώσεις <em>Stream</em>, μπορείτε να επιλέξετε υψηλότερες συχνότητες ανανέωσης -- δοκιμάστε 2.';
...
$string['configservermax'] = 'Μέγιστoς αριθμός επιτρεπόμενων πελατών (clients)';
$string['configserverport'] = 'Η θύρα (port) που θα χρησιμοποιεί η αυτόνομη υπηρεσία εξυπηρετητή';
$string['coursetheme'] = 'Θέμα (εμφάνισης) μαθήματος';
...
$string['explainmethoddaemon'] = 'Αυτές οι ρυθμίσεις έχουν σημασία <strong>μόνο</strong> εάν έχετε επιλέξει «Αυτόνομη υπηρεσία συνομιλίας» για μέθοδο συνομιλίας';
...
$string['messageenter'] = 'Ο/Η {$a} μόλις έχει μπει σ\' αυτή τη συνομιλία';
...
* Τακτικές συναντήσεις μαθητών που συμμετέχουν σε online μαθήματα για να τους επιτρέψουν να μοιραστούν εμπειρίες με άλλους στο ίδιο μάθημα αλλά σε διαφορετική τοποθεσία,
...
$string['normalstream'] = 'Συνεχής ροή';
...
$string['seesession'] = 'Προβολή αυτής της συνόδου';
...
* Εικονίδια διάθεσης - Οποιαδήποτε εικονίδια διάθεσης (emoticons, smileys, φατσούλες, χαμογελαστά πρόσωπα) που μπορείτε να πληκτρολογήσετε αλλού στο Moodle μπορείτε επίσης να τα πληκτρολογήσετε κι εδώ. Για παράδειγμα :-)
