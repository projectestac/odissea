...
$string['chat:view'] = 'Προβολή δραστηριότητας συνομιλίας';
$string['composemessage'] = 'Συνθέσετε ένα μήνυμα';
...
$string['entermessage'] = 'Πληκτρολογήστε το μήνυμά σας';
...
$string['nopermissiontoseethechatlog'] = 'Δεν έχετε την άδεια να δείτε τα αρχεία καταγραφής της συνομιλίας.';
...
$string['sessionstart'] = 'Η επόμενη συνεδρία τσάτ θα αρχίσει στις {$a->date}, ({$a->fromnow} από τώρα)';
