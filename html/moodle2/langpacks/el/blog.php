...
/**
 * Strings for component 'blog', language 'el', branch 'MOODLE_28_STABLE'
 *
 * @package   blog
...
$string['description_help'] = 'Εισάγετε μία ή δύο προτάσεις συνοψίζοντας το περιεχόμενο των εξωτερικών σας ιστολογίων. (Αν δεν παρέχεται περιγραφή, θα χρησιμοποιηθεί η περιγραφή που καταγράφεται στο εξετερικό σας ιστολόγιο).';
