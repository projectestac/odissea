...
$string['questioninquiz'] = '<ul> <li>προσθέστε ή διαγράψτε ερωτήσεις,</li><li>αλλάξτε τη σειρά ερωτήσεων στο κείμενο,</li><li>αλλάξτε τον τύπο τους (αριθμητικές, σύντομες, πολλαπλής επιλογής).</li></ul>';
