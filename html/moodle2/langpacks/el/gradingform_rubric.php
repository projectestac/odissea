...
/**
 * Strings for component 'gradingform_rubric', language 'el', branch 'MOODLE_36_STABLE'
 *
...
$string['alwaysshowdefinition'] = 'Επιτρέψτε στους χρήστες την προεπισκόπιση της ρουμπρίκας (Κλίμακα Διαβαθμισμένων Κριτηρίων, rubric) (αλλιώς θα εμφανίζεται μόνο μετά τη βαθμολόγηση)';
...
$string['criterionmovedown'] = 'Ματακίνηση κάτω';
$string['criterionmoveup'] = 'Ματακίνηση πάνω';
$string['criterionremark'] = 'Σχόλιο για το κριτήριο {$a->description}: {$a->remark}';
$string['definerubric'] = 'Ορισμός της ρουμπρίκας (Κλίμακας Διαβαθμισμένων Κριτηρίων, rubric)';
...
$string['lockzeropoints'] = 'Υπολογισμός βαθμολογίας με βάση τη ρουμπρίκα που έχει ελάχιστο σκορ 0';
...
Εάν επιλεγεί, ο ελάχιστος επιτεύξιμος βαθμός για τη ρουμπρίκα (Κλίμακα Διαβαθμισμένων Κριτηρίων, rubric) θα είναι μεγαλύτερος από 0.
...
$string['rubricmappingexplained'] = 'Το ελάχιστο δυνατό σκορ για αυτή τη ρουμπρίκα (Κλίμακα Διαβαθμισμένων Κριτηρίων, rubric) είναι <b>{$a->minscore} πόντοι</b>. Θα μετατραπεί στον ελάχιστο βαθμό που είναι διαθέσιμος για τη δραστηριότητα (που είναι 0 αν δεν χρησιμοποιείται κλίμακα). Το μέγιστο σκορ των <b>{$a->maxscore} πόντων</b> θα μετατραπεί στη μέγιστη βαθμολογία. Τα ενδιάμεσα σκορ θα μετατραπούν αντίστοιχα. Εάν χρησιμοποιείται μια κλίμακα για βαθμολόγηση, το σκορ θα στρογγυλοποιηθεί και θα μετατραπεί στα στοιχεία της κλίμακας σαν να ήταν διαδοχικοί ακέραιοι αριθμοί. Αυτός ο υπολογισμός βαθμού μπορεί να αλλάξει με την επεξεργασία της φόρμας και την επιλογή του πλαισίου ελέγχου «Υπολογισμός βαθμολογίας με βάση τη ρουμπρίκα που έχει ελάχιστο σκορ 0».';
...
$string['sortlevelsasc0'] = 'Φθίνουσα κατά αριθμο πόντων';
$string['sortlevelsasc1'] = 'Αύξουσα κατά αριθμο πόντων';
