...
$string['addnewattemptfromprevious'] = 'Πρόσθεσε μία νέα προσπάθεια βασισμένη σε προηγούμενη υποβολή';
$string['addnewgroupoverride'] = 'Προσθήκη παράκαμψης ομάδας';
$string['addnewuseroverride'] = 'Προσθήκη παράκαμψης χρήστη';
$string['addsubmission'] = 'Υποβολή';
$string['allowsubmissions'] = 'Επέτρεψε στο χρήστη να συνεχίζει να προσθέτει υποβολές σε αυτή την εργασία.';
$string['allowsubmissionsfromdate'] = 'Επέτρεψε υποβολές από';
$string['allowsubmissionsshort'] = 'Επέτρεψε αλλαγές στις υποβολές';
...
$string['collapsereviewpanel'] = 'Σύμπτυξη πίνακα ανασκόπησης';
...
$string['duedatecolon'] = 'Καταληκτική ημερομηνία: {$a}';
...
$string['gradechangessaveddetail'] = 'Οι αλλαγές στο βαθμό και στο πεδίο \'Ανατροφοδότηση\' αποθηκεύτηκαν';
...
$string['gradersubmissionupdatedhtml'] = 'Ο/Η φοιτητής/τρια {$a->username} τροποποίησε την υποβολή που είχε κάνει για την εργασία <i>\'{$a->assignment}\'</i><br /><br />
Για να την δείτε πατήστε <a href="{$a->url}">εδώ</a>.';
$string['gradersubmissionupdatedtext'] = 'Ο/Η φοιτητής/τρια {$a->username} τροποποίησε την υποβολή που είχε κάνει για την εργασία \'{$a->assignment}\'
...
$string['gradingsummary'] = 'Σύνοψη βαθμολογίας';
...
$string['nousersselected'] = 'Κανένας χρήστης δεν επιλέχθηκε';
...
$string['numberofsubmittedassignments'] = 'Υποβλήθηκε';
$string['numberofteams'] = 'Ομάδες';
$string['offline'] = 'Δεν απαιτείται διαδικτυακή υποβολή';
$string['open'] = 'Άνοιγμα';
$string['outlinegrade'] = 'Βαθμός: {$a}';
$string['overdue'] = '<font color="red">Η εργασία είναι εκπρόθεσμη για: {$a}</font>';
...
$string['sendstudentnotifications'] = 'Ειδοποίησε τους μαθητές';
$string['sendstudentnotificationsdefault'] = 'Προεπιλεγμένες ρυθμίσεις για "Ειδοποίηση των φοιτητών"';
...
$string['submissionstatus_draft'] = 'Πρόχειρο (δεν υποβλήθηκε)';
...
$string['viewsummary'] = 'Προβολή σύνοψης';
