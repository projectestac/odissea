...
$string['assign:viewblinddetails'] = 'Εμφάνιση των ταυτοτήτων μαθητών όταν είναι ενεργοποιημένη η τυφλή επισήμανση';
...
$string['markingworkflow'] = 'Χρησιμοποιήστε ροή εργασίας βαθμολόγησης';
