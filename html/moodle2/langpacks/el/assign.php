...
$string['allowsubmissionsfromdate'] = 'Να επιτρέπονται υποβολές από';
...
$string['alwaysshowdescription_help'] = 'Αν απενεργοποιηθεί, η Περιγραφή της Εργασίας παραπάνω θα γίνει ορατή για τους μαθητές μόνο κατά την ημερομηνία «Επέτρεψε υποβολές από» και μετά.';
...
$string['assign:viewblinddetails'] = 'Προβολή των ταυτοτήτων μαθητών όταν είναι ενεργοποιημένη η τυφλή επισήμανση';
...
$string['attemptreopenmethod_help'] = 'Καθορίζει τον τρόπο εκ νέου ανοίγματος των προσπαθειών υποβολής μαθητών. Οι διαθέσιμες επιλογές είναι: <ul><li>Ποτέ - Η υποβολή του μαθητή δεν μπορεί να ξανανοίξει.</li><li>Χειροκίνητα - Η υποβολή του μαθητή μπορεί να ανοίξει εκ νέου από έναν διδάσκοντα. Η υποβολή του μαθητή ανοίγει αυτόματα μέχρι να πετύχει ο μαθητής βαθμολογία που να ξεπερνάει την τιμή που έχει οριστεί στο Βαθμολόγιο (τμήμα ρυθμίσεων Βαθμολογίου) για αυτήν την εργασία.</li></ul>';
...
$string['batchoperationconfirmsetmarkingallocation'] = 'Ορισμός εκχωρήσεων βαθμολογήσεων για όλες τις επιλεγμένες υποβολές;';
...
$string['blindmarkingenabledwarning'] = 'Τυφλή βαθμολόγηση είναι ενεργοποιημένη για αυτήν τη δραστηριότητα.';
$string['blindmarking_help'] = 'Η τυφλή βαθμολόγηση κρύβει την ταυτότητα των μαθητών από τους βαθμολογητές. Οι ρυθμίσεις τυφλής βαθμολόγησης θα κλειδώνονται μόλις γίνει υποβολή ή βαθμολόγηση σε σχέση με αυτή την ανάθεση.';
$string['calendardue'] = '{$a} οφείλεται';
$string['calendargradingdue'] = '{$a} οφείλεται για βαθμολόγηση';
$string['changefilters'] = 'Αλλαγή φίλτρων';
$string['changegradewarning'] = 'Αυτή η ανάθεση έχει βαθμολογημένες υποβολές και η αλλαγή της βαθμολογίας δεν θα επανυπολογίσει αυτόματα τους υφιστάμενους βαθμούς υποβολής. Πρέπει να επαναβαθμολογήσετε όλες τις υπάρχουσες υποβολές, αν θέλετε να αλλάξετε την βαθμολογία.';
...
$string['cutoffdatevalidation'] = 'Η ημερομηνία διακοπής δεν μπορεί να είναι νωρίτερα από την καταληκτική ημερομηνία.';
...
$string['duedate_help'] = 'Αυτό συμβαίνει όταν η ανάθεση έχει λήξει. Οι υποβολές θα εξακολουθούν να επιτρέπονται μετά την ημερομηνία αυτή, αλλά οι εργασίες που υποβάλλονται μετά από αυτή την ημερομηνία σημειώνονται ως καθυστερημένες. Για να αποφύγετε υποβολές μετά από μια συγκεκριμένη ημερομηνία - ορίστε την ημερομηνία τερματισμού υποβολών.';
$string['duedateno'] = 'Χωρίς καταληκτική ημερομηνία';
$string['duedatereached'] = 'Η καταληκτική ημερομηνία για την εργασία αυτή έχει τώρα περάσει';
$string['duedatevalidation'] = 'Η καταληκτική ημερομηνία δεν μπορεί να είναι νωρίτερα από την ημερομηνία έναρξης υποβολών.';
...
$string['editsubmission_help'] = 'Τροποποίηση της υποβολής σας';
...
$string['eventbatchsetmarkerallocationviewed'] = 'Ο μαζικός ορισμός βαθμολογητών που εκχωρούνται προβλήθηκε';
...
$string['eventworkflowstateupdated'] = 'Η κατάσταση της ροής εργασιών ενημερώθηκε.';
$string['expandreviewpanel'] = 'Αναπτύξτε το πλαίσιο εξέτασης';
$string['extensionduedate'] = 'Ημερομηνία λήξης της παράτασης';
$string['extensionnotafterduedate'] = 'Η ημερομηνία λήξης της παράτασης πρέπει να ορίζεται μετά την καταληκτική ημερομηνία';
...
$string['gradingdueduedatevalidation'] = 'Η ημερομηνία «Υπενθύμιση βαθμολόγησης μέχρι» δεν μπορεί να είναι προγενέστερη από την καταληκτική ημερομηνία.';
...
$string['markingallocation_help'] = 'Εάν ενεργοποιηθεί μαζί με τη ροή εργασιών βαθμολόγησης, οι βαθμολογητές μπορούν να εκχωρηθούν σε συγκεκριμένους μαθητές.';
$string['markingworkflow'] = 'Χρησιμοποιήστε ροή εργασιών βαθμολόγησης';
...
$string['markingworkflowstate'] = 'Κατάσταση ροής εργασιών βαθμολόγησης';
...
* Έτοιμη προς ανακοίνωση - ο υπεύθυνος διδάσκων είναι ικανοποιημένος με την βαθμολόγηση αλλά περιμένει πριν δώσει στους μαθητές πρόσβαση στη βαθμολόγηση
...
$string['markingworkflowstatenotmarked'] = 'Δεν έχει βαθμολογηθεί';
$string['markingworkflowstatereadyforrelease'] = 'Όλα έτοιμα για ανακοίνωση βαθμολογιών';
$string['markingworkflowstatereadyforreview'] = 'Η βαθμολόγηση ολοκληρώθηκε';
...
$string['maxperpage_help'] = 'Ο μέγιστος αριθμός αναθέσεων (εργασιών) που μπορεί να εμφανίσει ο βαθμολογητής στη σελίδα βαθμολόγησης. Χρήσιμο για να αποφύγετε τα σφάλματα χρονικού ορίου σε μαθήματα με πάρα πολλές εγγραφές.';
...
$string['privacy:metadata:assignworkflowfilter'] = 'Φιλτράρισμα ανά διαφορετικό στάδιο ροής εργασιών.';
...
$string['reopenuntilpassincompatiblewithblindmarking'] = 'Η επιλογή ξανα-ανοίγματος μέχρι να σημειωθεί επιτυχία δεν είναι συμβατή με την τυφλή σήμανση, επειδή οι βαθμοί δεν κυκλοφορούν στο βαθμολόγιο.μέχρι να αποκαλυφθούν οι ταυτότητες των μαθητών.';
...
$string['saveallquickgradingchanges'] = 'Αποθήκευση όλων των αλλαγών γρήγορης ταξινόμησης';
...
$string['sendsubmissionreceipts_help'] = 'Αυτός ο διακόπτης θα επιτρέψει την αποστολή αποδεικτικών υποβολής για τους μαθητές. Οι μαθητές θα λαμβάνουν ειδοποίηση κάθε φορά που υποβάλουν επιτυχώς μια εργασία';
...
$string['setmarkingworkflowstate'] = 'Ορισμός  κατάστασης ροής εργασιών βαθμολόγησης';
$string['setmarkingworkflowstateforlog'] = 'Ορισμός κατάστασης ροής εργασιών : (αναγνωριστικό={$a->id}, πλήρες όνομα={$a->fullname}, κατάσταση={$a->state}).';
...
$string['studentnotificationworkflowstateerror'] = 'Η κατάσταση ροής εργασιών βαθμολόγησης πρέπει να είναι «Ανακοινώθηκε» για να γίνει ενημέρωση μαθητών.';
...
$string['submissiondrafts_help'] = 'Εάν είναι ήδη ενεργοποιημένο, οι μαθητές θα πρέπει να κάνουν κλικ σε ένα κουμπί «Υποβολή» για να δηλώσουν την υποβολή τους ως τελική. Αυτό επιτρέπει στους μαθητές να διατηρούν έκδοση προσχεδίου της υποβολής τους στο σύστημα.<br />
Εάν αυτή η ρύθμιση αλλάξει από «Όχι» σε «Ναι» αφού οι μαθητές έχουν ήδη κάνει υποβολές, αυτές θα θεωρηθούν ως τελικές.';
...
$string['teamsubmission_help'] = 'Εάν ενεργοποιηθεί, οι μαθητές θα χωριστούν σε ομάδες με βάση το προεπιλεγμένο σύνολο ομάδων ή μια προσαρμοσμένη ομαδοποίηση. Μια υποβολή ομάδας θα διαμοιραστεί μεταξύ των μελών της ομάδας και όλα τα μέλη της ομάδας θα δουν ο ένας τις αλλαγές του άλλου στην υποβολή.';
...
$string['validmarkingworkflowstates'] = 'Έγκυρες καταστάσεις ροής εργασιών βαθμολόγησης';
$string['viewadifferentattempt'] = 'Προβολή μιας διαφορετικής προσπάθειας';
$string['viewbatchmarkingallocation'] = 'Προβολή σελίδας μαζικών ορισμών βαθμολογητών που εκχωρούνται.';
$string['viewbatchsetmarkingworkflowstate'] = 'Προβολή σελίδας μαζικών ορισμών κατάστασης ροής εργασιών βαθμολόγησης.';
...
$string['viewgradingformforstudent'] = 'Προβολή σελίδας βαθμολόγησης για μαθητή: (αναγνωριστικό={$a->id}, πλήρες όνομα={$a->fullname}).';
$string['viewownsubmissionform'] = 'Προβολή της δικής σας σελίδας υποβολής εργασίας.';
$string['viewownsubmissionstatus'] = 'Προβολή της δικής σας σελίδας κατάστασης υποβολής εργασίας.';
$string['viewrevealidentitiesconfirm'] = 'Προβολή σελίδας επιβεβαίωσης αποκάλυψης ταυτότητας μαθητών.';
$string['viewsubmission'] = 'Προβολή υποβολής';
$string['viewsubmissionforuser'] = 'Προβολή υποβολής για χρήστη: {$a}';
$string['viewsubmissiongradingtable'] = 'Προβολή πίνακα βαθμολόγησης υποβολής.';
$string['viewsummary'] = 'Προβολή περίληψης';
$string['workflowfilter'] = 'Φίλτρο ροής εργασιών';
