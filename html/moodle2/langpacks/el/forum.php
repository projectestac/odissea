...
$string['forum:viewhiddentimedposts'] = 'Εμφανίση κρυμμένων χρονομετρημένων αναρτήσεων';
...
Οι αναρτήσεις σε φόρουμ μπορούν να βαθμολογηθούν από διδάσκοντες ή μαθητές (αξιολόγηση από ομοτίμους). Οι βαθμολογίες μπορούν να συναθροιστούν για να σχηματίσουν έναν τελικό βαθμό που καταγράφεται στο βαθμολόγιο.
...
$string['overviewnumpostssince'] = '{$a} αναρτήσεις από την τελευταία σύνδεση';
...
$string['subscribestart'] = 'Να μου αποστέλλονται ειδοποιήσεις (με ηλ.ταχ/μείο) για νέες αναρτήσεις σε αυτό το φόρουμ';
