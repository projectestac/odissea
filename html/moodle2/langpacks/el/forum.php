...
/**
 * Strings for component 'forum', language 'el', branch 'MOODLE_34_STABLE'
 *
 * @package   forum
...
$string['cannotaddteacherforumto'] = 'Δεν ήταν δυνατό να προστεθεί το στιγμιότυπο του αλλαγμένου φόρουμ διδάσκοντος στο τμήμα 0 στο μάθημα';
...
$string['discussionnowsubscribed'] = 'Ο/Η {$a->name} ΔΕΝ θα ειδοποιηθεί για νέες δημοσιεύσεις στην συζήτηση «{$a->discussion}» του φόρουμ «{$a->forum}»';
...
$string['emaildigest_0'] = 'Θα λαμβάνεις με ηλ.ταχυδρομείο, ένα μήνυμα για κάθε ανάρτηση στο φόρουμ.';
$string['emaildigest_1'] = 'Θα λαμβάνεις με ηλ.ταχυδρομείο, μία σύνοψη ανά ημέρα, που θα περιέχει τα πλήρη περιεχόμενα κάθε ανάρτησης στο φόρουμ.';
$string['emaildigest_2'] = 'Θα λαμβάνεις με ηλ.ταχυδρομείο, μία σύνοψη ανά ημέρα, που θα περιέχει το θέμα κάθε ανάρτησης στο φόρουμ.';
...
$string['emaildigestupdated'] = 'Η επιλογή σύνοψης μέσω ηλ.ταχυδρομείου άλλαξε σε \'{$a->maildigesttitle}\' για το φόρουμ \'{$a->forum}\'. {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = 'Η προεπιλεγμένη στο προφίλ σας ρύθμιση  \'{$a->maildigesttitle}\' χρησιμοποιήθηκε για το φόρουμ  \'{$a->forum}\'. {$a->maildigestdescription}.';
...
$string['forum:canposttomygroups'] = 'Μπορεί να αναρτήσει σε όλες τις ομάδες στις οποίες έχετε πρόσβαση';
...
$string['forum:viewrating'] = 'Προβολή της συνολικής βαθμολογίας που λάβατε';
...
$string['nowallsubscribed'] = 'Είστε τώρα εγγεγραμμένος σε όλα τα φόρουμ στο {$a}.';
$string['nowallunsubscribed'] = 'Όλα τα φόρουμ στο «{$a}» είναι χωρίς εγγραφή.';
...
$string['postmailinfo'] = 'Αυτό είναι ένα αντίγραφο ενός μηνύματος που δημοσιεύτηκε στην ιστοσελίδα {$a}.

Για να απαντήσετε, κάντε κλικ σε αυτόν το σύνδεσμο:';
...
$string['qandanotify'] = 'Αυτό είναι ένα φόρουμ ερωτήσεων και απαντήσεων. Για να δείτε τις απαντήσεις σε αυτές τις ερωτήσεις, πρέπει πρώτα να δημοσιεύσετε την απάντησή σας';
$string['re'] = 'Απάντηση:';
...
$string['trackingtype_help'] = 'Η παρακολούθηση ανάγνωσης επιτρέπει στους συμμετέχοντες να ελέγχουν εύκολα ποιές δημοσιεύσεις δεν έχουν ακόμη δει επισημαίνοντας κάθε νέα δημοσίευση. Αν οριστεί σε προαιρετική, οι συμμετέχοντες μπορούν να επιλέξουν εάν θα ενεργοποιήσουν ή θα απενεργοποιήσουν την παρακολούθηση ανάγνωσης μέσω ενός συνδέσμου στο μπλοκ του διαχειριστή. (Οι χρήστες πρέπει επίσης να ενεργοποιήσουν την παρακολούθηση φόρουμ στην προτιμήσεις φόρουμ τους.) Αν η επιλογή «Επιτρέπεται υποχρεωτική παρακολούθηση ανάγνωσης» είναι ενεργοποιημένη στην διαχείριση ιστοτόπου, τότε μια περαιτέρω επιλογή είναι διαθέσιμη - υποχρεωτική. Αυτό σημαίνει ότι η παρακολούθηση είναι πάντοτε ενεργοποιημένη, άσχετα με τις προτιμήσεις φόρουμ του χρήστη.';
...
$string['viewalldiscussions'] = 'Προβολή όλων των συζητήσεων';
$string['viewthediscussion'] = 'Προβολή της συζήτησης';
