...
$string['userdata_help'] = 'Οι βαθμοί μπορούν να αντιγραφούν και να επικολληθούν από ένα λογιστικό φύλλο στο βαθμολόγιο. Το λογιστικό φύλλο θα πρέπει να περιέχει μια στήλη που να περιέχει δεδομένα ταυτότητας χρήστη - είτε όνομα χρήστη, είτε αναγνωριστικό αριθμό, είτε διεύθυνση ηλεκτρονικού ταχυδρομείου. Κάθε στήλη για εισαγωγή θα πρέπει να έχει μια κεφαλίδα στήλης.';
