...
$string['configreverseproxyignore'] = 'Εάν ο εξυπηρετητής σας βρίσκεται πίσω από πολλαπλούς αντίστροφους διακομιστές μεσολάβησης που επισυνάπτονται στην κεφαλίδα X-Forwarded-For, θα πρέπει να καθορίσετε μια λίστα με διαχωρισμένες με κόμμα διευθύνσεις ή υποδίκτυα των αντίστροφων διακομιστών μεσολάβησης που πρέπει να αγνοηθούν, προκειμένου να βρεθούν οι σωστές διευθύνσεις IP των χρηστών.';
...
$string['sitepolicy_help'] = 'Η διεύθυνση URL της πολιτικής ιστοτόπου που όλοι οι εγγεγραμμένοι χρήστες πρέπει να δουν και να συμφωνήσουν πριν από την πρόσβαση στον ιστότοπο. Λάβετε υπόψη ότι αυτή η ρύθμιση θα έχει αποτέλεσμα μόνο εάν ως διαχειριστής πολιτικής ιστοτόπου έχει οριστεί ο προεπιλεγμένος (βασικός).';
