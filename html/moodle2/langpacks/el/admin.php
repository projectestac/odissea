...
$string['agedigitalconsentverification'] = 'Επιβεβαίωση ηλικίας ψηφιακής συναίνεσης';
$string['agedigitalconsentverification_desc'] = 'Επιτρέπει την επαλήθευση της ηλικίας ψηφιακής συναίνεσης πριν εμφανιστεί η σελίδα εγγραφής για τους χρήστες με αυτο-εγγραφή. Αυτό προστατεύει τον ιστότοπό σας από την εγγραφή ανήλικων χωρίς τη συγκατάθεση των γονέων/κηδεμόνων. <a target="_blank" href="{$a}">Τα στοιχεία επικοινωνίας της υποστήριξης</a> παρέχονται στους ανήλικους για περαιτέρω βοήθεια.';
...
$string['allowbeforeblockdesc'] = 'Από προεπιλογή, οι καταχωρίσεις στη λίστα αποκλεισμένων διευθύνσεων IP αντιστοιχίζονται πρώτα. Αν αυτή η επιλογή είναι ενεργοποιημένη, οι καταχωρίσεις στη λίστα επιτρεπόμενων διευθύνσεων IP επεξεργάζονται πριν από τη λίστα των αποκλεισμένων.';
$string['allowblockstodock'] = 'Να επιτρέπεται στα μπλοκ να χρησιμοποιούν πλευρική ελαχιστοποίηση';
$string['allowcategorythemes'] = 'Να επιτρέπονται θέματα κατηγορίας';
$string['allowcoursethemes'] = 'Να επιτρέπονται θέματα μαθήματος';
...
$string['allowuserthemes'] = 'Να επιτρέπονται θέματα χρηστών';
...
$string['authpreventaccountcreation'] = 'Αποτροπή δημιουργίας λογαριασμού κατά την αυθεντικοποίηση';
...
$string['blockprotect_help'] = 'Αν κλειδώσετε ένα συγκεκριμένο τύπο μπλοκ, τότε κανείς δεν θα μπορεί να προσθέσει ή να διαγράψει στιγμιότυπα. (Μπορείτε, βεβαίως, να το ξεκλειδώσετε ξανά αν χρειάζεται να επεξεργαστείτε στιγμιότυπα.) <br /> Σκοπός είναι να προστατεύονται τα μπλοκ όπως η πλοήγηση και οι ρυθμίσεις που είναι πολύ δύσκολο να ανακτηθούν αν διαγραφούν κατά λάθος.';
...
$string['cachejs_help'] = 'Η αποθήκευση σε κρυφή μνήμη και η συμπίεση της Javascript βελτιώνει σημαντικά την ταχύτητα φόρτωσης σελίδας. Συνιστάται ιδιαίτερα στους ιστοτόπους παραγωγής. Οι προγραμματιστές πιθανώς θα θέλουν να απενεργοποιήσουν αυτό το χαρακτηριστικό.';
...
$string['cachesessionhelp'] = 'Ιδιαίτερη κρυφή μνήμη χρήστη που λήγει όταν λήξει η συνόδος του χρήστη. Σχεδιασμένη για να ελαττώσει τον όγκο/ρυθμό δεδομένων κατά τη σύνοδο.';
...
$string['categoryemail'] = 'Ηλεκτρονικό ταχυδρομείο';
...
$string['configallcountrycodes'] = 'Αυτή είναι η λίστα χωρών που μπορούν να επιλεγούν σε διάφορα σημεία, για παράδειγμα στο προφίλ του χρήστη. Αν είναι κενή (η προεπιλογή) χρησιμοποιείται η λίστα του countries.php στο τυπικό πακέτο Αγγλικής γλώσσας. Αυτή είναι η λίστα από το πρότυπο ISO 3166-1. Διαφορετικά, μπορείτε να ορίσετε μια λίστα κωδικών χωρισμένων με κόμμα, για παράδειγμα \'GB,FR,ES\'. Αν προσθέσετε νέους, μη τυποποιημένους κωδικούς εδώ, θα πρέπει να τους προσθέσετε στο countries.php σε \'en\' και στο πακέτο της γλώσσας σας .';
...
$string['configallowattachments'] = 'Αν ενεργοποιηθεί, τα μηνύματα ηλεκτρονικού ταχυδρομείου που αποστέλλονται από τον ιστότοπο μπορούν να έχουν συνημμένα, όπως π.χ. διακριτικά.';
$string['configallowblockstodock'] = 'Εάν ενεργοποιηθεί και υποστηρίζεται από το επιλεγμένο θέμα, οι χρήστες μπορούν να επιλέξουν να μετακινήσουν τα μπλοκ σε μια ειδική θέση πλευρικής ελαχιστοποίησης.';
$string['configallowcategorythemes'] = 'Εάν ενεργοποιήσετε αυτή την επιλογή τότε τα θέματα θα μπορούν να ορίζονται στο επίπεδο κατηγοριών. Αυτό θα επηρεάσει όλες τις υποκατηγορίες και μαθήματα εκτός εάν έχει οριστεί συγκεκριμένο δικό τους θέμα. ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Η ενεργοποίηση θεμάτων κατηγοριών μπορεί να επηρεάσει την απόδοση.';
$string['configallowcoursethemes'] = 'Εάν ενεργοποιηθεί, τότε θα επιτρέπεται στα μαθήματα να ορίσουν τα δικά τους θέματα. Τα θέματα μαθήματος παρακάμπτουν όλες τις άλλες επιλογές θέματος (θέματα ιστοτόπου, χρήστη ή συνόδου)';
$string['configallowedemaildomains'] = 'Λίστα τομέων ηλεκτρονικού ταχυδρομείου που επιτρέπεται να αποκαλύπτονται στο τμήμα (πεδίο) «Από» των εξερχόμενων μηνυμάτων ηλεκτρονικού ταχυδρομείου. Η προεπιλογή «Κενό» θα χρησιμοποιήσει τη διεύθυνση Μη-απάντησης για όλα τα εξερχόμενα μηνύματα ηλεκτρονικού ταχυδρομείου. Η χρήση των μπαλαντέρ επιτρέπεται π.χ. * .example.com θα επιτρέπει την αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου από κάθε υποτομέα του example.com, αλλά όχι το ίδιο το example.com. Αυτό θα απαιτήσει χωριστή καταχώρηση.';
...
$string['configallowthemechangeonurl'] = 'Εάν ενεργοποιηθεί, το θέμα μπορεί να αλλάξει προσθέτοντας απλώς:<br />?theme=themename σε οποιαδήποτε Moodle διεύθυνση URL (π.χ.: mymoodlesite.com/?theme=afterburner) ή <br />&theme=themename σε οποιαδήποτε εσωτερική Moodle διεύθυνση URL (π.χ.: mymoodlesite.com/course/view.php?id=2&theme=afterburner).';
$string['configallowuserblockhiding'] = 'Θέλετε να επιτρέπεται στους χρήστες η σύμπτυξη/ανάπτυξη πλευρικών μπλοκ σε όλοκληρο τον ιστότοπο; Αυτή η δυνατότητα χρησιμοποιεί Javascript και cookies για την αποθήκευση της κατάστασης πριν την σύμπτυξη κάθε μπλοκ, και επηρεάζει μόνο την προσωπική οθόνη του χρήστη.';
$string['configallowusermailcharset'] = 'Εάν ενεργοποιηθεί, οι χρήστες μπορούν να επιλέξουν ένα σετ χαρακτήρων μηνυμάτων ηλεκτρονικού ταχυδρομείου στις προτιμήσεις ανταλλαγής μηνυμάτων.';
...
$string['configbloglevel'] = 'Η ρύθμιση αυτή σας επιτρέπει να περιορίσετε το επίπεδο εμφάνισης των ιστολογίων χρήστη στον ιστότοπο. Ας σημειωθεί πως ορίζεται το μέγιστο πλαίσιο του ΘΕΑΤΗ και όχι του συγγραφέα ή του είδους της ανάρτησης. Μπορείτε να απενεργοποιήσετε τα ιστολόγια και εντελώς, αν θέλετε.';
$string['configcalendarcustomexport'] = 'Ενεργοποίηση προσαρμογής του εύρους ημερομηνίας για την εξαγωγή του ημερολογίου';
$string['configcalendarexportsalt'] = 'Το τυχαίο αυτό κείμενο (salt) χρησιμοποιείται για τη βελτίωση της ασφάλειας των κουπονιών αυθεντικοποίησης τα οποία χρησιμοποιούνται για την εξαγωγή ημερολογίων. Παρακαλούμε σημειώστε πως όλα τα τρέχοντα κουπόνια ακυρώνονται εάν αλλάξετε αυτό το hash salt (εμπλουτισμός κατατεμαχισμού με μη-μυστική, τυχαία τιμή).';
$string['configcookiehttponly'] = 'Ενεργοποιεί νέες δυνατότητες της PHP 5.2.0 - τα προγράμματα περιήγησης είναι ρυθμισμένα να στέλνουν cookies μόνο με κανονικά αιτήματα http, τα cookies αυτά δε θα πρέπει να είναι προσβάσιμα από γλώσσες scripting. Αυτό δεν υποστηρίζεται από όλα τα προγράμματα περιήγησης και μπορεί να μην είναι πλήρως συμβατό με τον τρέχοντα κώδικα. Βοηθάει στην πρόληψη ενάντια σε ορισμένους τύπους επιθέσεων XSS.';
...
$string['configcourseoverviewfilesext'] = 'Μια λίστα διαχωρισμένων με κόμμα επιτρεπόμενων επεκτάσεων αρχείου για αρχεία περίληψης μαθήματος.';
$string['configcourseoverviewfileslimit'] = 'Ο μέγιστος αριθμός συνημμένων αρχείων σε μια περίληψη μαθήματος.';
...
$string['configcronclionly'] = 'Η εκτέλεση της εντολής χρονοπρογραμματισμού cron από περιηγητή μπορεί να εκθέσει ευαίσθητη πληροφορία σε ανώνυμους χρήστες. Έτσι, προτείνεται η εκτέλεση της cron μόνο μέσω γραμμής εντολών ή μέσω κωδικού πρόσβασης της cron για απομακρυσμένη πρόσβαση.';
$string['configcronremotepassword'] = 'Αυτό σημαίνει πως το cron.php δεν μπορεί να εκτελεστεί από έναν περιηγητή χωρίς την παροχή του κωδικού πρόσβασης χρησιμοποιώντας την παρακάτω μορφή της διεύθυνσης:<pre> http://site.example.com/admin/cron.php?password=opensesame </pre>Εάν αυτό μείνει κενό, τότε δεν απαιτείται κωδικός πρόσβασης.';
...
$string['configdebugsmtp'] = 'Ενεργοποίηση μηνυμάτων πληροφοριών αποσφαλμάτωσης κατά τη διάρκεια αποστολής μηνυμάτων ηλεκτρονικού ταχυδρομείου στον εξυπηρετητή SMTP.';
...
$string['configdefaultrequestcategory'] = 'Τα μαθήματα που δημιουργούνται μετά από αίτηση του χρήστη θα τοποθετούνται αυτόματα σ\' αυτή την κατηγορία.';
...
$string['configdeleteunconfirmed'] = 'Για ορισμένες μεθόδους αυθεντικοποίησης, όπως η αυτόματη εγγραφή με χρήση ηλεκτρονικού ταχυδρομείου, οι χρήστες θα πρέπει να επιβεβαιώσουν τον λογαριασμό τους εντός συγκεκριμένης χρονικής περιόδου. Με τη λήξη της περιόδου, διαγράφονται όλοι παλιοί ανεπιβεβαίωτοι λογαριασμοί.';
$string['configdenyemailaddresses'] = 'Για την απαγόρευση διευθύνσεων ηλεκτρονικού ταχυδρομείου από συγκεκριμένους τομείς εισάγετε τους εδώ με τον ίδιο τρόπο. Όλα οι υπόλοιποι τομείς θα γίνονται δεκτοί. Για την απαγόρευση υπο-τομέων προσθέστε τους τομείς με \'.\' στην αρχή π.χ. <strong>hotmail.com yahoo.co.uk .live.com</strong>';
...
$string['configeditorfontlist'] = 'Επιλέξτε τις γραμματοσειρές που θα εμφανίζονται στην πτυσσόμενη λίστα του επεξεργαστή κειμένου.';
$string['configemailchangeconfirmation'] = 'Απαίτηση επιβεβαίωσης μέσω ηλεκτρονικού ταχυδρομείου όταν οι χρήστες αλλάζουν τη διεύθυνση του ηλεκτρονικού τους ταχυδρομείου στο προφίλ τους.';
$string['configemailfromvia'] = 'Προσθέστε πληροφορίες στο τμήμα (πεδίο) «Από» του εξερχόμενου μηνύματος ηλεκτρονικού ταχυδρομείου. Αυτό πληροφορεί τον παραλήπτη από που ήλθε αυτό το μήνυμα ηλεκτρονικού ταχυδρομείου και βοηθά επίσης τους παραλήπτες στο να μην απαντήσουν κατα λάθος σε διευθύνσεις ηλεκτρονικού ταχυδρομείου μη-απάντησης.';
$string['configenableactivitychooser'] = 'Ο επιλογέας δραστηριοτήτων είναι ένα παράθυρο διαλόγου με μια σύντομη περιγραφή της κάθε δραστηριότητας και πόρου. Αν απενεργοποιηθεί, θα εμφανίζονται ξεχωριστά πτυσσόμενα μενού για τους πόρους και τις δραστηριότητες.';
...
$string['configenabledevicedetection'] = 'Ενεργοποιεί την ανίχνευση κινητών τηλεφώνων, έξυπνων τηλεφώνων, ταμπλετών ή τυπικών συσκευών (επιτραπέζιοι υπολογιστές, φορητοί, κ.λπ.) για την εφαρμογή θεμάτων και άλλων χαρακτηριστικών.';
...
$string['configenablerssfeedsdisabled'] = 'Δεν είναι διαθέσιμο γιατί οι τροφοδοσίες RSS είναι απενεργοποιημένες σε όλο τον ιστότοπο. Για να τις ενεργοποιήσετε, πηγαίνετε στις ρυθμίσεις μεταβλητών κάτω από τις ρυθμίσεις διαχείρισης.';
$string['configenablerssfeedsdisabled2'] = 'Οι τροφοδοσίες RSS είναι αυτή τη στιγμή απενεργοποιημένες σε επίπεδο ιστοτόπου. Μπορούν να ενεργοποιηθούν στις «Προχωρημένες επιλογές» στη «Διαχείριση ιστοτόπου».';
$string['configenablesafebrowserintegration'] = 'Αυτό προσθέτει την επιλογή «Απαιτείται Ασφαλής Περιήγηση σε Εξετάσεις» στο πεδίο «Ασφάλεια περιηγητή» στη φόρμα ρυθμίσεων κουίζ. Δείτε στο http://www.safeexambrowser.org/ για περισσότερες πληροφορίες.';
$string['configenablestats'] = 'Εάν επιλέξετε «ναι» εδώ,  η χρονο-προγραμματισμένη μέσω της εντολής cron εργασία του Moodle θα επεξεργαστεί τις καταγραφές και θα συλλέξει στατιστικά. Ανάλογα με τη κίνηση στον ιστότοπο, αυτό ίσως απαιτήσει χρόνο. Εάν ενεργοποιηθεί θα δείτε ενδιαφέροντα στατιστικά και γραφήματα για κάθε μάθημα ή με βάση όλο τον ιστότοπο.';
$string['configenabletrusttext'] = 'Από προεπιλογή το Moodle καθαρίζει προσεκτικά το κείμενο των χρηστών για την αφαίρεση πιθανών κακόβουλων δεσμών ενεργειών (script), πολυμέσων κτλ. τα οποία θα μπορούσαν να αποτελέσουν κίνδυνο για την ασφάλεια. Το σύστημα Trusted Content αποτελεί έναν τρόπο για να δώσετε σε συγκεκριμένους χρήστες, τους οποίους εμπιστευόσαστε, τη δυνατότητα να συμπεριλάβουν στα κείμενά τους αυτές τις προχωρημένες δυνατότητες ανενόχλητα. Για να γίνει αυτό απαιτείται η ενεργοποίηση αυτής εδώ της ρύθμισης και κατόπιν η απόδοση στο σύστημα Trusted Content άδειας χρήσης συγκεκριμένου ρόλου του Moodle. Κείμενα που δημιουργούνται ή ανεβαίνουν από αυτούς τους χρήστες θα σημειώνονται ως έμπιστα και δεν θα καθαρίζονται πριν την εμφάνιση.';
$string['configenablewebservices'] = 'Οι υπηρεσίες ιστού επιτρέπουν σε άλλα συστήματα να συνδεθούν σε αυτή την εγκατάσταση Moodle και να εκτελέσουν διάφορες λειτουργίες. Για επιπλέον ασφάλεια αυτή η επιλογή θα πρέπει να απενεργοποιηθεί εκτός αν τη χρησιμοποιείτε πραγματικά.';
...
$string['configextendedusernamechars'] = 'Ενεργοποιήστε αυτή τη ρύθμιση για να επιτρέψετε στους μαθητές να χρησιμοποιούν οποιονδήποτε χαρακτήρα στα ονόματα χρήστη τους (σημειώστε ότι αυτό δεν επηρεάζει τα πραγματικά τους ονόματα). Η προεπιλογή είναι «ανενεργή» η οποία περιορίζει τα ονόματα των χρηστών να περιλαμβάνουν μόνο αλφαριθμητικούς πεζούς χαρακτήρες, υπογράμμιση (_), παύλα (-), τελεία (.) ή το παπάκι (@).';
...
$string['configfilterall'] = 'Να φιλτράρονται όλες οι συμβολοσειρές, συμπεριλαμβανομένων των κεφαλίδων, τίτλων, μπάρας πλοήγησης κ.ο.κ.. Αυτό είναι χρήσιμο κυρίως όταν χρησιμοποιείται το φίλτρο multilang (πολλαπλών γλωσσών), ειδάλλως απλώς θα επιβαρύνει τον ιστότοπο για μικρό όφελος.';
...
$string['configfiltermatchonepertext'] = 'Τα αυτόματα φίλτρα διασύνδεσης παράγουν μόνο μία διασύνδεση για το πρώτο στιγμιότυπο κειμένου που ταιριάζει σε κάθε αντικείμενο κειμένου. Όλα τα άλλα αγνοούνται. Αυτή η ρύθμιση αγνοείται εάν η ρύθμιση για ένα ανά σελίδα είναι ενεργοποιημένη.';
...
$string['configgeoipfile'] = 'Τοποθεσία του δυαδικού (όχι απλού κειμένου) αρχείου δεδομένων του GeoIP City. Το αρχείο αυτό δεν αποτελεί κομμάτι της διανομής του Moodle και πρέπει να αποκτηθεί ξεχωριστά από την <a href="http://www.maxmind.com/">MaxMind</a>. Μπορείτε να αγοράσετε την εμπορική ή να χρησιμοποιήσετε τη δωρεάν έκδοση.<br />Απλώς κατεβάστε το αρχείο <a href="http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz" >http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz</a> και αποσυμπιέστε το στον φάκελο «{$a}» του εξυπηρετητή σας.';
...
$string['configidnumber'] = 'Η επιλογή αυτή καθοριζεί εάν (α) θα ζητείται από τους χρήστες αναγνωριστικός αριθμός, (β) θα ζητείται από τους χρήστες αναγνωριστικός αριθμός αλλά θα μπορούν να τον αφήσουν κενό ή (γ) θα ζητείται από τους χρήστες αναγνωριστικός αριθμός αλλά δε θα μπορούν να τον αφήσουν κενό. Αν δοθεί, ο αναγνωριστικός αριθμός των χρηστών εμφανίζεται στο προφίλ τους.';
$string['configintro'] = 'Σε αυτή τη σελίδα μπορείτε να ορίσετε διάφορες μεταβλητές ρυθμίσεων που βοηθούν στην ορθή λειτουργία του Moodle στον εξυπηρετητή σας. Μην ανησυχείτε πολύ για αυτό - οι προεπιλεγμένες ρυθμίσεις συνήθως λειτουργούν ικανοποιητικά και μπορείτε οποιαδήποτε στιγμή να έρθετε εδώ για αλλαγές.';
$string['configintroadmin'] = 'Σε αυτή τη σελίδα μπορείτε να ρυθμίσετε τον λογαριασμό του κύριου διαχειριστή ο οποίος θα έχει τον πλήρη έλεγχο του ιστοτόπου. Επιβεβαιώστε ότι χρησιμοποιείτε ασφαλές όνομα χρήστη και κωδικό πρόσβασης, καθώς και μια έγκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου. Μπορείτε να δημιουργήσετε περισσότερους λογαριασμούς διαχειριστή στη συνέχεια.';
...
$string['configlanglist'] = 'Αφήστε το κενό για να επιτρέψετε στους χρήστες να διαλέξουν από τις γλώσσες που έχουν εγκατασταθεί στο Moodle. Ωστόσο, μπορείτε να μικρύνετε το μενού γλώσσας εισάγοντας μια λίστα διαχωρισμένη με κόμμα των κωδικών των γλωσσών που θέλετε. π.χ. en, es_es, fr, it, el';
$string['configlangmenu'] = 'Επιλέξτε αν θέλετε να εμφανίζεται το γενικής χρήσης μενού γλωσσών στην αρχική σελίδα, στη σελίδα εισόδου/σύνδεσης κτλ.. Αυτό δεν επηρεάζει την ικανότητα του χρήστη να θέτει την προτιμώμενη γλώσσα στο δικό του προφίλ.';
...
$string['configloginhttps'] = 'Ενεργοποιώντας το, το Moodle θα χρησιμοποιήσει μια ασφαλή https σύνδεση μόνο για την σελίδα σύνδεσης/εισόδου (προφέροντας ασφαλή σύνδεση) και μετά θα επιστρέψει στην κανονική http URL διεύθυνση για γενική ταχύτητα. ΠΡΟΣΟΧΗ: αυτή η ρύθμιση ΑΠΑΙΤΕΙ το https να είναι ρητά ενεργοποιημένο στον εξυπηρετητή ιστού - αν δεν είναι, ΜΠΟΡΕΙ ΝΑ ΚΛΕΙΔΩΘΕΙΤΕ ΕΞΩ ΑΠΟ ΤΟΝ ΙΣΤΟΤΟΠΟ ΣΑΣ.';
$string['configloglifetime'] = 'Εδώ ορίζεται το χρονικό διάστημα που θέλετε να διατηρούνται οι καταγραφές για την δραστηριότητα των χρηστών. Οι καταγραφές πριν από αυτό το διάστημα διαγράφονται αυτόματα. Είναι καλύτερο να διατηρούνται οι καταγραφές όσο το δυνατόν περισσότερο. Αν όμως ο εξυπηρετητής έχει πολύ κίνηση και αντιμετωπίζετε προβλήματα απόδοσης, ίσως να πρέπει να μειώσετε το διάστημα αυτό. Τιμές κάτω από 30 δεν προτείνονται διότι μπορεί να μην λειτουργήσουν σωστά τα στατιστικά.';
$string['configlookahead'] = 'Μέρες προς προεπισκόπηση';
$string['configmailnewline'] = 'Χαρακτήρες αλλαγής γραμμής που χρησιμοποιούνται σε μηνύματα ηλεκτρονικού ταχυδρομείου. Το CRLF απαιτείται σύμφωνα με το RFC 822bis, ορισμένοι εξυπηρετητές ηλεκτρονικού ταχυδρομείου εκτελούν αυτόματη μετατροπή από LF σε CRLF, άλλοι εξυπηρετητές κάνουν λάθος μετατροπή από CRLF σε CRCRLF, ενώ άλλοι απορρίπτουν εντελώς τα μηνύματα με απλό LF (qmail για παράδειγμα). Δοκιμάστε να αλλάξετε αυτή τη ρύθμιση εάν έχετε προβλήματα με αγνοούμενα μηνύματα ή διπλές αλλαγές γραμμής.';
...
$string['configmaxusersperpage'] = 'Ο μέγιστος αριθμός χρηστών που εμφανίζονται κατά την επιλογή χρηστών για μάθημα, σύνολο χρηστών, ομάδα (συμμετεχόντων σε μάθημα), υπηρεσία ιστού κ.λπ.';
$string['configmessaging'] = 'Να είναι ενεργοποιημένο το σύστημα μηνυμάτων μεταξύ των χρηστών ιστοτόπου;';
$string['configmessagingallowemailoverride'] = 'Να επιτρέπεται οι χρήστες να λαμβάνουν ειδοποιήσεις με μηνύματα ηλεκτρονικού ταχυδρομείου σε μια ηλ. διεύθυνση διαφορετική από τη ηλ. διεύθυνση στο προφίλ τους.';
...
$string['configmessaginghidereadnotifications'] = 'Απόκρυψη αναγνωσμένων ειδοποιήσεων από γεγονότα όπως αναρτήσεις σε φόρουμ κατά την προβολή του ιστορικού μηνυμάτων';
...
$string['confignoreplyaddress'] = 'Μερικές φορές αποστέλλονται μηνύματα ηλεκτρονικού ταχυδρομείου για λογαριασμό του χρήστη (π.χ. αναρτήσεις σε φόρουμ). Η διεύθυνση ηλ.ταχυδρομείου που ορίζεται εδώ θα χρησιμοποιηθεί ως η διεύθυνση αποστολέα για αυτές τις περιπτώσεις όπου οι παραλήπτες δεν πρέπει να μπορούν να απαντούν απευθείας στον χρήστη (π.χ. όταν ο χρήστης επιλέγει να διατηρήσει την διεύθυνσή του ιδιωτική). Αυτή η ρύθμιση θα χρησιμοποιηθεί επίσης ως η διεύθυνση αποστολέα του φακέλου όταν αποστέλλονται μηνύματα.';
...
$string['configperfdebug'] = 'Εάν ενεργοποιηθεί, πληροφορίες απόδοσης θα εμφανίζονται στο υποσέλιδο του τυπικού θέματος.';
$string['configprofileroles'] = 'Λίστα ρόλων που είναι ορατοί στα προφίλ χρηστών και τη σελίδα συμμετοχής.';
$string['configprofilesforenrolledusersonly'] = 'Προς αποφυγή κακής χρήσης από spammer, οι περιγραφές των προφίλ χρηστών που δεν έχουν ακόμη εγγραφεί σε κανένα μάθημα είναι κρυφές. Οι νέοι χρήστες πρέπει να εγγραφονται σε τουλάχιστον ένα μάθημα πριν να μπορούν να προσθέσουν περιγραφή στο προφίλ τους.';
...
$string['configrecaptchaprivatekey'] = 'Συμβολοσειρά (ιδιωτικό κλειδί) που χρησιμοποιείται για την επικοινωνία μεταξύ του εξυπηρετητή Moodle και του εξυπηρετητή recaptcha. Κλειδιά ReCAPTCHA μπορείτε να προμηθευτείτε από <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configsessioncookiedomain'] = 'Αυτό σας επιτρέπει την αλλαγή του τομέα από όπου τα cookies του Moodle είναι διαθέσιμα. Αυτό είναι χρήσιμο για παραμετροποιήσεις του Moodle (π.χ. πρόσθετα για αυθεντικοποίηση ή εγγραφή) που χρειάζεται να μοιράζονται πληροφορίες για τη σύνοδο του Moodle με μια εφαρμογή ιστού σε έναν άλλο υποτομέα. <strong>ΠΡΟΣΟΧΗ: Συνιστάται να αφήσετε αυτή τη ρύθμιση στην προεπιλεγμένη επιλογή της (κενή) - μια λανθασμένη τιμή θα εμποδίσει κάθε πρόσβαση στο σύστημα.</strong>';
...
$string['configsitemailcharset'] = 'Αυτή η ρύθμιση καθορίζει το προεπιλεγμένο σύνολο χαρακτήρων (charset) για όλα τα μηνύματα ηλεκτρονικού ταχυδρομείου που αποστέλλονται από τον ιστότοπο.';
...
$string['configsmartpix'] = 'Με αυτή την επιλογή ενεργοποιημένη, τα εικονίδια σερβίρονται μέσω ενός PHP script που αναζητεί το τρέχον θέμα, έπειτα όλα τα θέματα-γονείς, έπειτα το Moodle φάκελο /pix. Αυτό μειώνει την ανάγκη αντιγραφής αρχείων εικόνων μέσα στα θέματα αλλά έχει κάποιο κόστος σε απόδοση.';
$string['configsmtpauthtype'] = 'Εδώ ορίζεται ο τύπος αυθεντικοποίησης που θα χρησιμοποιηθεί στον εξυπηρετητή smtp.';
$string['configsmtphosts'] = 'Δώστε το πλήρες όνομα ενός ή περισσότερων τοπικών εξυπηρετητών SMTP που πρέπει να χρησιμοποιεί το Moodle για να στέλνει μηνύματα ηλεκτρονικού ταχυδρομείου (π.χ. \'mail.auth.gr\' ή \'mail.auth.gr;mail.uoa.gr\').
Για να ορίσετε μια μη τυπική θύρα (port) (π.χ. εκτός από τη θύρα 25), μπορείτε να χρησιμοποιήσετε τη σύνταξη [server]:[port] (π.χ. \'mail.auth.gr:587\'). Για ασφαλείς συνδέσεις, η θύρα 465 συνήθως χρησιμοποιείται με SSL, η θύρα 587 συνήθως χρησιμοποιείται με TLS. Ορίστε το πρωτόκολλο ασφαλείας παρακάτω αν απαιτείται. Εάν αφήσετε αυτό το πεδίο κενό, το Moodle θα χρησιμοποιήσει την προεπιλεγμένη μέθοδο αποστολής μηνυμάτων ηλεκτρονικού ταχυδρομείου της PHP.';
...
$string['configstatsruntimedays'] = 'Ορίστε το μέγιστο αριθμό ημερών που επεξεργάζεται κάθε εκτέλεση στατιστικών. Όταν τα στατιστικά είναι επίκαιρα, θα γίνεται επεξεργασία μόνο μιας ημέρας οπότε ρυθμίστε αυτή την τιμή ανάλογα με το φόρτο του εξυπηρετητή, μειώνοντάς την εάν χρειάζονται μικρότεροι χρόνοι εκτέλεσης της εντολής χρονοπρογραμματισμού cron.';
$string['configstatsruntimestart'] = 'Τι ώρα να ξεκινά την επεξεργασία των στατιστικών η χρονο-προγραμματισμένη μέσω της εντολής cron εργασία; Καθορισμός διαφορετικών ωρών προτείνεται αν υπάρχουν πολλές εγκαταστάσεις Moodle στον ίδιο Η/Υ.';
...
$string['configstrictformsrequired'] = 'Εάν ενεργοποιηθεί, δεν επιτρέπεται οι χρήστες να εισάγουν ένα κενό διάστημα ή αλλαγή γραμμής μόνο σε υποχρεωτικά πεδία σε φόρμες.';
...
$string['configsupportemail'] = 'Αυτή η διεύθυνση ηλεκτρονικού ταχυδρομείου θα δημοσιεύεται σε χρήστες αυτού του ιστοτόπου ως η διεύθυνση επικοινωνίας για γενική βοήθεια (για παράδειγμα, όταν νέοι χρήστες δημιουργούν μόνοι τους, τούς λογαριασμούς τους). Εάν αυτή η διεύθυνση μείνει κενή τότε δε θα προσφέρεται αυτή η χρήσιμη δυνατότητα.';
$string['configsupportname'] = 'Αυτό είναι το όνομα του ατόμου (ή της οντότητας, γενικότερα) που θα παρέχει γενική βοήθεια μέσω της σχετικής διεύθυνσης ηλεκτρονικού ταχυδρομείου ή ιστοσελίδας.';
...
$string['configthemedesignermode'] = 'Κανονικά, όλες οι εικόνες θέματος και τα φύλλα στυλ αποθηκεύονται σε κρυφή μνήμη στους περιηγητές και στον εξυπηρετητή για ένα μεγάλο χρονικό διάστημα, για λόγους απόδοσης. Αν σχεδιάζετε θέματα ή αναπτύσσετε κώδικα, τότε πιθανότατα θέλετε να ενεργοποιήσετε αυτή τη λειτουργία έτσι ώστε να μην σας εμφανίζονται αποθηκευμένες εκδόσεις. Προειδοποίηση: αυτό θα κάνει τον ιστότοπό σας πιο αργό για όλους τους χρήστες! Εναλλακτικά, μπορείτε επίσης να ανανεώσετε την κρυφή μνήμη θεμάτων, μη αυτόματα, από τη σελίδα επιλογής Θέματος.';
$string['configthemelist'] = 'Αφήστε το κενό για να επιτρέπεται σε κάθε έγκυρο θέμα να χρησιμοποιείται. Εάν θέλετε να μικρύνετε το μενού των θεμάτων, μπορείτε να ορίσετε μια λίστα ονομάτων διαχωρισμένων με κόμμα εδώ (μην χρησιμοποιήσετε κενά). π.χ. τυπικό,orangewhite.';
$string['configtimezone'] = 'Εδώ βρίσκεται η προεπιλεγμένη ζώνη ώρας για την εμφάνιση ημερομηνιών. Κάθε χρήστης μπορεί να παρακάμψει αυτή τη ρύθμιση μέσα από το προφίλ του. Οι χρονο-προγραμματισμένες μέσω της εντολής cron εργασίες και άλλες ρυθμίσεις του ιστοτόπου καθορίζονται σε αυτή τη ζώνη ώρας. Θα πρέπει να αλλάξετε την ρύθμιση αν εμφανίζεται ως «Άκυρη ζώνη ώρας».';
...
$string['configverifychangedemail'] = 'Ενεργοποιεί την επιβεβαίωση αλλαγμένων διευθύνσεων ηλεκτρονικού ταχυδρομείου χρησιμοποιώντας τις ρυθμίσεις επιτρεπτών και μη επιτρεπτών τομέων DNS. Εάν αυτή η ρύθμιση είναι απενεργοποιημένη τότε οι τομείς τίθενται σε ισχύ μόνο κατά τη δημιουργία νέου χρήστη.';
...
$string['courselistshortnames_desc'] = 'Εάν ενεργοποιηθεί, θα εμφανίζονται τα σύντομα ονόματα μαθημάτων αντί για τα πλήρη ονόματα στις λίστες μαθημάτων. Αν απαιτείται, τα διευρυμένα ονόματα μαθημάτων μπορούν να προσαρμοστούν με την επεξεργασία της συμβολοσειράς γλώσσας \'courseextendednamedisplay\' χρησιμοποιώντας τη δυνατότητα προσαρμογής γλώσσας.';
...
$string['cron_help'] = 'Η δέσμη ενεργειών cron.php εκτελεί ένα πλήθος εργασιών σε διαφορετικά προγραμματισμένα διαστήματα, όπως η αποστολή ειδοποιήσεων μέσω ηλ.ταχυδρομείου για αναρτήσεις σε φόρουμ. Η δέσμη θα πρέπει να εκτελείται τακτικά - ιδανικά κάθε λεπτό.';
$string['cronremotepassword'] = 'Κωδικός πρόσβασης της εντολής χρονοπρογραμματισμού cron για απομακρυνσμένη πρόσβαση';
$string['cronwarning'] = 'Το <a href="{$a}">σενάριο συντήρησης cron.php</a> δεν έχει εκτελεστεί για τουλάχιστον 24 ώρες.';
$string['cronwarningcli'] = 'Το δέσμη ενεργειών συντήρησης cli/cron.php δεν έχει εκτελεστεί για τουλάχιστον 24 ώρες.';
...
$string['dndallowtextandlinks'] = 'Ανέβασμα με μεταφορά και απόθεση κειμένου/συνδέσμων';
...
Για να επαναφέρετε όλα τα πεδία στις προεπιλεγμένες τιμές, ακολουθήστε τον παραπάνω σύνδεσμο.
...
$string['emoticonsreset'] = 'Επαναφορά ρυθμίσεων εικονιδίων διάθεσης στις προεπιλεγμένες τιμές';
...
$string['forceloginforprofileimage_help'] = 'Εάν ενεργοποιηθεί, οι χρήστες πρέπει να συνδεθούν για να δουν εικόνες προφίλ χρήστη και η προεπιλεγμένη εικόνα χρήστη θα χρησιμοποιηθεί σε όλες τις ειδοποιήσεις ηλεκτρονικού ταχυδρομείου.';
...
$string['installhijacked'] = 'Η εγκατάσταση θα πρέπει να ολοκληρωθεί μέσω της αρχικής διεύθυνσης IP.';
$string['installsessionerror'] = 'Αδυναμία αρχικοποίησης της συνόδου PHP. Παρακαλούμε επιβεβαιώστε ότι ο περιηγητής σας αποδέχεται cookies.';
...
$string['iplookupinfo'] = 'Προεπιλεγμένα, το Moodle χρησιμοποιεί τον ελεύθερο online NetGeo (The Internet Geographic Database) εξυπηρετητή για την εύρεση τοποθεσιών διευθύνσεων IP. Δυστυχώς η βάση αυτή δε συντηρείται πλέον και μπορεί να επιστρέψει <em>λανθασμένα</em> δεδομένα. Προτείνεται η εγκατάσταση ενός τοπικού αντιγράφου της ελεύθερης βάσης δεδομένων GeoLite City από τη MaxMind.<br /> Η τοποθεσία της διεύθυνσης IP προβάλλεται σε έναν απλό χάρτη, χρησιμοποιώντας το Google Maps. Σημειώστε πως χρειάζεται να έχετε ένα λογαρισμό Google και να κάνετε αίτηση για ένα κλειδί Google Maps API ώστε να ενεργοποιήσετε τους διαδραστικούς χάρτες.';
$string['iplookupmaxmindnote'] = 'Αυτό το προϊόν περιλαμβάνει δεδομένα GeoLite2 που δημιουργήθηκαν από την MaxMind και διατίθενται από το <a href="http://www.maxmind.com">http://www.maxmind.com</a>.';
$string['ishttpswarning'] = 'Εντοπίστηκε ότι ο ιστότοπός σας δεν είναι ασφαλής καθώς δεν χρησιμοποιεί HTTPS. Προτείνεται η μετεγκατάσταση (μεταφορά/μετατροπή) του ιστοτόπου σας σε HTTPS για αυξημένη ασφάλεια και βελτιωμένη ολοκλήρωση με άλλα συστήματα.';
...
$string['legacyfilesaddallowed'] = 'Να επιτρέπεται η προσθήκη αρχείων μαθήματος παλαιού τύπου';
$string['legacyfilesaddallowed_help'] = 'Αν ένα μάθημα έχει αρχεία μαθήματος παλαιού τύπου, να επιτρέπεται η προσθήκη νέων αρχείων και φακέλων σε αυτό.';
$string['legacyfilesinnewcourses'] = 'Αρχεία μαθημάτων παλαιού τύπου σε νέα μαθήματα';
$string['legacyfilesinnewcourses_help'] = 'Από προεπιλογή οι περιοχές αρχείων μαθημάτων παλαιού τύπου είναι διαθέσιμες μόνο σε αναβαθμισμένα μαθήματα. Παρακαλούμε έχετε υπόψη ότι ορισμένα χαρακτηριστικά όπως δημιουργία και επαναφορά αντιγράφου ασφαλείας δραστηριότητας, δεν είναι συμβατά με αυτή τη ρύθμιση.';
...
$string['loginpasswordautocomplete_help'] = 'Εάν ενεργοποιηθεί, οι χρήστες δεν επιτρέπεται να αποθηκεύσουν τον κωδικό πρόσβασης του λογαριασμού τους στον περιηγητή τους.';
...
$string['logo_desc'] = 'Ένα πλήρες λογότυπο θα χρησιμοποιηθεί ως διακόσμηση από μερικά θέματα (εμφάνισης) (όπως τα βασικά θέματα). Αυτή η εικόνα μπορεί να είναι υψηλής ανάλυσης, επειδή θα μειωθεί κατά τη χρήση (και θα αποθηκευτεί σε κρυφή μνήμη για λόγους απόδοσης). Τα λογότυπα που είναι πιο πλατιά σε σχέση με το ύψος, συνήθως δίνουν καλύτερο αποτέλεσμα. Αποδεκτοί μορφότυποι: PNG και JPG.';
...
$string['maturitycoreinfo'] = 'Ο ιστότοπός σας εκτελεί επί του παρόντος ασταθή κώδικα ανάπτυξης "{$a}" έκδοσης.';
...
$string['mediapluginyoutube'] = 'Ενεργοποιηση φίλτρου συνδέσμων YouTube';
...
$string['multilangforceold'] = 'Επιβολή παλαιότερης πολυγλωσσικής σύνταξης: &lt;span&gt; χωρίς class="multilang" and &lt;lang&gt;';
...
$string['navshowfullcoursenames_help'] = 'Εάν ενεργοποιηθεί, στη πλοήγηση θα χρησιμοποιούνται τα πλήρη ονόματα μαθημάτων αντί για τα σύντομα.';
...
$string['notifyloginthreshold'] = 'Όριο για ειδοποιήσεις με μήνυμα ηλεκτρονικού ταχυδρομείου';
...
$string['opensslrequired'] = 'Η επέκταση OpenSSL της PHP απαιτείται τώρα από το Moodle για την παροχή ισχυρότερων κρυπτογραφικών υπηρεσιών.';
...
$string['outgoingmailconfig'] = 'Ρυθμίσεις εξερχόμενων μηνυμάτων ηλ. ταχυδρομείου';
...
$string['pathtodot'] = 'Διαδρομή (πλήρες όνομα αρχείου) ως το πρόγραμμα dot';
$string['pathtodot_help'] = 'Διαδρομή ως το πρόγραμμα dot. Πιθανώς κάτι σαν /usr/bin/dot. Για να μπορείτε να δημιουργείτε γραφικά από DOT αρχεία, πρέπει να έχετε εγκατεστημένο το εκτελέσιμο πρόγραμμα dot και εδώ την διαδρομή του (πλήρες όνομα αρχείου). Σημειώστε πως, προς το παρόν, αυτό χρησιμοποιείται από τις λειτουργίες προφίλ (Ανάπτυξη->Προφίλ) του ίδιου του Moodle.';
$string['pathtodu'] = 'Διαδρομή (πλήρες όνομα αρχείου) για το du';
$string['pathtogs'] = 'Διαδρομή (πλήρες όνομα αρχείου) για ghostscript';
$string['pathtogs_help'] = 'Στις περισσότερες εγκαταστάσεις Linux, αυτό μπορεί να παραμείνει ως \'/usr/bin/gs\'. Στα Windows θα είναι κάτι σαν \'c:\\gs\\bin\\gswin32c.exe\' (φροντίστε να μην υπάρχουν κενά στη διαδρομή - αν είναι αναγκαίο αντιγράψτε τα αρχεία \'gswin32c.exe\' και \'gsdll32.dll\' σε ένα νέο φάκελο χωρίς κενά στο πλήρες όνομα του φακέλου)';
$string['pathtopgdump'] = 'Διαδρομή (πλήρες όνομα αρχείου) για το pg_dump';
...
$string['pathtopgdumpinvalid'] = 'Μη έγκυρη διαδρομή για το pg_dump - είτε λάθος διαδρομή, είτε μη-εκτελέσιμο αρχείο';
$string['pathtopsql'] = 'Διαδρομή (πλήρες όνομα αρχείου) για το psql';
...
$string['pathtopsqlinvalid'] = 'Μη έγκυρη διαδρομή για το psql - είτε λάθος διαδρομή, είτε μη-εκτελέσιμο αρχείο';
$string['pathtopython'] = 'Διαδρομή (πλήρες όνομα αρχείου) για το Python';
$string['pathtopythondesc'] = 'Διαδρομή (πλήρες όνομα αρχείου) για το εκτελέσιμο αρχείο του Python (επιτρέπονται Python 2 ή Python 3)';
$string['pcreunicodewarning'] = 'Συνιστάται ιδιαίτερα να χρησιμοποιήσετε την επέκταση PCRE PHP που είναι συμβατή με χαρακτήρες Unicode.';
...
$string['pleaserefreshregistrationnewdata'] = 'Οι πληροφορίες εγγραφής έχουν αλλάξει. Επιβεβαιώστε το χρησιμοποιώντας το πλήκτρο «Ενημέρωση εγγραφής».';
...
$string['pluginscheckfailed'] = 'Αποτυχία ελέγχου εξαρτήσεων πρόσθετων για τα πρόσθετα:  {$a->pluginslist}';
...
$string['profilefieldlink_help'] = 'Για να μετατρέψετε το κείμενο σε έναν σύνδεσμο, καταχωρίστε μια διεύθυνση URL που περιέχει το $$, όπου το $$ θα αντικατασταθεί με το κείμενο. Για παράδειγμα, για να μετατρέψετε ένα αναγνωριστικό Twitter σε έναν σύνδεσμο, πληκτρολογήστε http://twitter.com/$$.';
...
$string['profilingallowme_help'] = 'Εάν ενεργοποιήσετε αυτή τη ρύθμιση, τότε, επιλεκτικά, μπορείτε να χρησιμοποιήσετε την παράμετρο PROFILEME οπουδήποτε (PGC) και να δημιουργήσετε προφίλ για αυτό το σενάριο. Ανάλογα, μπορείτε να χρησιμοποιήσετε την παράμετρο DONTPROFILEME για να αποτρέψετε τη δημιουργία προφίλ';
...
$string['profilingexcluded_help'] = 'Λίστα με διευθύνσεις URL (διαχωρισμένες με κόμμα, απόλυτες παραλείποντας δηλ. τη διαδρομή έως και το wwwroot, που να μπορούν να κληθούν) που θα αποκλειστούν από την δημιουργία προφίλ (για να μετρηθεί η απόδοσή τους αυτόματα) από αυτά που ορίζονται στη ρύθμιση «Προφίλ αυτών».';
...
$string['registermoodlenet'] = '<p> Θα θέλαμε να μείνουμε σε επαφή και να σας προσφέρουμε σπουδαία πράγματα για τον Moodle ιστότοπό σας! </ p> <p> Με την εγγραφή σας: </ p><ul>
<li> Θα είστε οι πρώτοι που θα μάθετε για σημαντικές ειδοποιήσεις όπως ειδοποιήσεις ασφαλείας και νέες διανομές/κυκλοφορίες του Moodle. </ li>
<li> Μπορείτε να έχετε πρόσβαση και να ενεργοποιήσετε τις ειδοποιήσεις κινητών τηλεφώνων από τον ιστότοπό σας Moodle μέσω της δωρεάν <a href="https://download.moodle.org/mobile/">εφαρμογής Moodle Mobile για κινητά</a> μας. </ li>
<li> Συμβάλλετε στην παγκόσμια κοινότητα <a href="https://moodle.net/stats/"> Moodle </a> που μας βοηθά να βελτιώσουμε το Moodle και τους ιστοτόπους της κοινότητας μας.</ li>
<li> Αν θέλετε, ο ιστότοπός σας μπορεί να περιλαμβάνεται στη <a href="https://moodle.net/sites/"> λίστα καταχωρημένων ιστοτόπων Moodle </a> στη χώρα σας. </ li> </ ul>.';
$string['registermoodleorg'] = 'Όταν καταχωρήσετε τον ιστότοπό σας';
$string['registermoodleorgli1'] = 'Θα μπείτε σε μια λίστα με χαμηλό όγκο για να λαμβάνεται σημαντικές ειδοποιήσεις, όπως ειδοποιήσεις ασφαλείας και νέων εκδόσεων/διανομών του Moodle.';
...
$string['requiredentrieschanged'] = '<strong> ΣΗΜΑΝΤΙΚΟ - ΠΑΡΑΚΑΛΩ ΔΙΑΒΑΣΤΕ <br/> (Αυτό το προειδοποιητικό μήνυμα θα εμφανιστεί μόνο κατά τη διάρκεια αυτής της αναβάθμισης)</strong><br/> Λόγω διόρθωσης σφαλμάτων, η συμπεριφορά των δραστηριοτήτων βάσης δεδομένων που χρησιμοποιούν τις ρυθμίσεις «Απαιτούμενες καταχωρίσεις» και «Απαιτούμενες καταχωρίσεις πριν από την προβολή» θα αλλάξει. Μια λεπτομερέστερη επεξήγηση των αλλαγών μπορείτε να διαβάσετε στο <a href="http://moodle.org/mod/forum/discuss.php?d=110928" target="_blank">φόρουμ αρθρώματος βάσης δεδομένων</a>. Για την αναμενόμενη συμπεριφορά αυτών των ρυθμίσεων μπορείτε επίσης να διαβάσετε στη<a href="http://docs.moodle.org/en/Adding/editing_a_database#Required_entries" target="_blank">Βοήθεια του Moodle (Moodle Docs)</a>. <br/><br/>Η αλλαγή αυτή επηρεάζει τις ακόλουθες βάσεις δεδομένων στο σύστημά σας: (Παρακαλούμε να αποθηκεύσετε αυτή τη λίστα και μετά την αναβάθμιση, να ελέγξετε ότι αυτές οι δραστηριότητες εξακολουθούν να λειτουργούν με τον τρόπο που ο θέλει ο διδάσκων.) <br/><strong >{$a->text}</strong> <br/>';
...
$string['sessioncookiedomain'] = 'Τομέας cookies';
$string['sessioncookiepath'] = 'Διαδρομή (πλήρες όνομα αρχείου) cookie';
...
$string['sitepolicyhandler_desc'] = 'Αυτό καθορίζει τον τρόπο διαχείρισης των πολιτικών και των συγκαταθέσεων χρηστών. Ο προεπιλεγμένος χειριστής (βασικός) επιτρέπει τον καθορισμό μιας διεύθυνσης URL πολιτικής ιστοτόπου και μιας διεύθυνσης URL πολιτικής ιστοτόπου για επισκέπτες. Ο (δια)χειριστής πολιτικών επιτρέπει τη ρύθμιση των πολιτικών του ιστότοπου, της ιδιωτικής ζωής και άλλων. Παρέχει επίσης τη δυνατότητα να εμφανίζονται οι συναινέσεις των χρηστών και, αν είναι απαραίτητο, να δίνεται συναίνεση εκ μέρους ανηλίκων.';
$string['sitepolicyhandlerplugin'] = '{$a->name} ({$a->component})';
$string['sitepolicy_help'] = 'Η διεύθυνση URL της πολιτικής ιστοτόπου που όλοι οι εγγεγραμμένοι χρήστες πρέπει να δουν και να συμφωνήσουν πριν από την πρόσβαση στον ιστότοπο. Λάβετε υπόψη ότι αυτή η ρύθμιση θα έχει αποτέλεσμα μόνο εάν ως διαχειριστής πολιτικής ιστότοπου έχει οριστεί ο προεπιλεγμένος (βασικός).';
...
$string['smtpdetail'] = 'Ρυθμίσεις SMTP (απλό πρωτόκολλο μεταφοράς ηλ. ταχυδρομείου) για αποστολή αλληλογραφίας';
...
$string['stickyblocksduplicatenotice'] = 'Εάν ένα μπλοκ που τοποθετείτε εδώ υπάρχει ήδη σε συγκεκριμένη σελίδα, θα δημιουργήσει αντίγραφο. Μόνο το καρφιτσωμένο μπλοκ δεν θα είναι επεξεργάσιμο, το αντίγραφο μπορείτε να το επεξεργαστείτε.';
...
$string['taskcompletiondaily'] = 'Σημείωση ολοκλήρωσης σε εκκίνηση';
...
$string['tasklegacycron'] = 'Επεξεργασία της εντολής χρονοπρογραμματισμού cron παλαιού τύπου για πρόσθετα';
$string['taskmessagingcleanup'] = 'Επεξεργασία παρασκηνίου για την ανταλλαγή μηνυμάτων';
$string['taskpasswordresetcleanup'] = 'Εκκαθάριση προσπαθειών επαναφοράς κωδικού πρόσβασης';
$string['taskplagiarismcron'] = 'Επεξεργασία παρασκηνίου για την εντολή χρονοπρογραμματισμού cron παλαιού τύπου σε πρόσθετα λογοκλοπής';
$string['taskportfoliocron'] = 'Επεξεργασία παρασκηνίου για πρόσθετα χαρτοφυλακίου';
$string['taskquestioncron'] = 'Επεξεργασία παρασκηνίου για μηχανή ερωτήσεων';
...
$string['themedesignermode'] = 'Κατάσταση λειτουργίας σχεδιασμού θέματος';
$string['themedesignermodewarning'] = 'Η λειτουργία σχεδιασμού θέματος είναι ενεργοποιημένη. Αυτό δεν πρέπει να ενεργοποιείται στους χώρους παραγωγής, καθώς μπορεί να μειώσει σημαντικά την απόδοση.';
$string['themelist'] = 'Λίστα θεμάτων';
$string['themenoselected'] = 'Δεν έχει επιλεγεί θέμα';
...
$string['tlswarning'] = 'Δεν ανιχνεύθηκε επέκταση PHP/cURL με υποστήριξη TLSv1.2. Ορισμένες υπηρεσίες ενδέχεται να μην λειτουργούν. Συνιστάται ιδιαίτερα να αναβαθμίσετε τις βιβλιοθήκες TLS.';
$string['tokenduration'] = 'Διάρκεια κουπονιού δημιουργημένου από το χρήστη';
$string['tokenduration_desc'] = 'Το χρονικό διάστημα για το οποίο είναι έγκυρο ένα κουπόνι υπηρεσιών ιστού που δημιουργήθηκε από έναν χρήστη (για παράδειγμα μέσω της εφαρμογής για κινητά).';
...
$string['unsettheme'] = 'Ακύρωση ορισμού θέματος';
...
$string['upgradeforumread'] = 'Μια καινούργια δυνατότητα προστέθηκε στο Moodle 1.5 για την ανίχνευση διαβασμένων/μη-διαβασμένων αναρτήσεων φόρουμ. Για να χρησιμοποιήσετε τη δυνατότητα αυτή πρέπει να  <a href="{$a}">ενημερώσετε τους πίνακές σας</a>.';
$string['upgradeforumreadinfo'] = 'Μια καινούργια δυνατότητα προστέθηκε στο Moodle 1.5 για την ανίχνευση διαβασμένων/μη-διαβασμένων αναρτήσεων φόρουμ. Για να χρησιμοποιήσετε τη δυνατότητα αυτή πρέπει να ενημερώσετε τους πίνακές σας με όλες τις πληροφορίες ανίχνευσης για υπάρχουσες αναρτήσεις. Ανάλογα με το μέγεθος της σελίδας σας αυτό μπορεί να πάρει αρκετό χρόνο (ώρες) και επιβαρύνει αρκετά την βάση δεδομένων, οπότε καλό είναι να εκτελεστεί σε μια ήσυχη περίοδο. Ωστόσο, η σελίδα θα συνεχίσει να λειτουργεί και οι χρήστες δεν θα επηρεαστούν. Αν ξεκινήσετε τη διαδικασία, αφήστε τη να ολοκληρωθεί (κρατήστε ανοιχτό το παράθυρο του περιηγητή σας). Ωστόσο, εάν σταματήσετε τη διαδικασία μπορείτε να αρχίσετε από την αρχή. Θέλετε να αρχίσει η διαδικασία αναβάθμισης τώρα;';
...
$string['userquota'] = 'Ποσόστωση χρήστη';
...
$string['verifychangedemail'] = 'Περιορισμός τομέων κατά την αλλαγή διευθύνσεων ηλεκτρονικού ταχυδρομείου';
