...
/**
 * Strings for component 'admin', language 'el', branch 'MOODLE_31_STABLE'
 *
 * @package   admin
...
$string['alternativefullnameformat'] = 'Εναλλακτική προβολή πλήρους ονόματος';
...
$string['availablesearchareas'] = 'Διαθέσιμες περιοχές για αναζήτηση';
...
$string['blockeditingmenu'] = 'Αποκλεισμός επεξεργασίας των μενού';
...
$string['configlangstringcache'] = 'Όλα τα αλφαριθμιτικά της γλώσσας βρίσκονται στην cache σε μεταγλωττισμένα αρχεία στον κατάλογο δεδομένων. Αν μεταφράζεται το Moodle ή αλλάζετε αλφαριθμιτικά στον πηγαίο κώδικα του Moodle τότε μπορεί να θέλετε να αλλάξετε αυτό σε μη ενεργό. Διαφορετικά αφήστε το για να δείτε τα οφέλη απόδοσης.';
...
$string['langstringcache'] = 'Τοποθετήστε όλα τα αλφαριθμιτικά της γλώσσας στην cache';
