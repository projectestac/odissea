...
/**
 * Strings for component 'admin', language 'el', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['allowcohortthemes'] = 'Επιτρέπονται θέματα συνόλων χρηστών';
...
$string['configallowcohortthemes'] = 'Εάν ενεργοποιηθεί, τότε τα θέματα μπορούν να οριστούν στο επίπεδο ενός συνόλου χρηστών. Αυτό θα επηρεάσει όλους τους χρήστες που ανήκουν σε ένα μόνο σύνολο ή περισσότερα από ένα αλλά με το ίδιο θέμα.';
...
$string['configallowview'] = 'Επιλέξτε τους ρόλους που θα βλέπει ο χρήστης, θα είναι σε θέση να φιλτράρει κ.λπ. με βάση τους ρόλους που έχει ήδη.';
...
$string['configdefaultrequestcategory'] = 'Τα μαθήματα που δημιουργούνται μετά από αίτηση του χρήστη θα τοποθετούνται αυτόματα σε αυτή την κατηγορία.';
...
$string['configdeleteincompleteusers'] = 'Μετά από αυτή την περίοδο, οποιοσδήποτε λογαριασμός χωρίς όνομα, επώνυμο ή διεύθυνση ηλεκτρονικού ταχυδρομείου, θα διαγράφεται.';
$string['configdeleteunconfirmed'] = 'Για ορισμένες μεθόδους αυθεντικοποίησης, όπως η αυτο-καταχώρηση με χρήση ηλεκτρονικού ταχυδρομείου, οι χρήστες θα πρέπει να επιβεβαιώσουν τον λογαριασμό τους εντός συγκεκριμένης χρονικής περιόδου. Με τη λήξη της περιόδου αυτής, διαγράφονται όλοι οι παλιοί ανεπιβεβαίωτοι λογαριασμοί.';
$string['configdenyemailaddresses'] = 'Για την απαγόρευση διευθύνσεων ηλεκτρονικού ταχυδρομείου από συγκεκριμένους τομείς εισάγετέ τους εδώ με τον ίδιο τρόπο. Όλα οι υπόλοιποι τομείς θα γίνονται δεκτοί. Για την απαγόρευση υπο-τομέων προσθέστε τους τομείς με «.» στην αρχή π.χ. <strong>hotmail.com yahoo.co.uk .live.com</strong>';
...
$string['configgeoipfile'] = 'Τοποθεσία του δυαδικού (όχι απλού κειμένου) αρχείου δεδομένων του GeoIP City. Το αρχείο αυτό δεν αποτελεί κομμάτι της διανομής του Moodle και πρέπει να αποκτηθεί ξεχωριστά από την <a href="https://www.maxmind.com/">MaxMind</a>. Μπορείτε να αγοράσετε την εμπορική ή να χρησιμοποιήσετε τη δωρεάν έκδοση.<br />Απλώς κατεβάστε το αρχείο <a href="https://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz" >https://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz</a> και αποσυμπιέστε το στον φάκελο «{$a}» του εξυπηρετητή σας.';
...
$string['configpasswordpolicy'] = 'Αν ενεργοποιηθεί, οι κωδικοί πρόσβασης των χρηστών θα ελέγχονται σύμφωνα με την πολιτική κωδικού πρόσβασης όπως καθορίζεται στις παρακάτω ρυθμίσεις. Η ενεργοποίηση της πολιτικής κωδικού πρόσβασης δεν θα επηρεάσει τους υπάρχοντες χρήστες μέχρι να αποφασίσουν ή να χρειαστεί να αλλάξουν τον κωδικό πρόσβασής τους.';
...
$string['configpathtophp'] = 'Διαδρομή προς το εκτελέσιμο αρχείο της PHP. Πιθανώς κάτι σαν /usr/bin/php. Εάν εισαγάγετε αυτό, τα σενάρια της εντολής χρονοπρογραμματισμού cron μπορούν να εκτελεστούν μέσω των ιστοσελίδων (διεπαφή ιστού) του διαχειριστή.';
...
$string['configprotectusernames'] = 'Αν είναι ενεργοποιημένη, η φόρμα υπενθύμισης κωδικού πρόσβασης δεν εμφανίζει υποδείξεις που θα επέτρεπαν σε κάποιον να μαντέψει ονόματα χρηστών ή διευθύνσεις ηλεκτρονικού ταχυδρομείου.';
...
$string['confirmcontextlock'] = 'Το πλαίσιο «{$a->contextname}» δεν είναι παγωμένο. Το πάγωμα θα το κάνει να είναι μόνο για ανάγνωση και θα εμποδίσει τους χρήστες να κάνουν αλλαγές. Είστε βέβαιοι ότι θέλετε να συνεχίσετε;';
...
$string['coursecontactduplicates_desc'] = 'Εάν ενεργοποιηθεί, οι χρήστες με περισσότερους από έναν από τους επιλεγμένους ρόλους επαφής για το μάθημα θα εμφανιστούν στην περιγραφή του μαθήματος με κάθε έναν από τους ρόλους τους. Διαφορετικά, θα εμφανίζονται με έναν μόνο ρόλο (όποιον από τους δύο παρατίθεται πιο πάνω στην ενότητα «Καθορισμός ρόλων» στη Διαχείριση ιστοτόπου).';
...
$string['courselistshortnames'] = 'Εμφάνιση διευρυμένων ονομάτων μαθημάτων';
...
$string['cron_help'] = 'Το σενάριο cron.php εκτελεί ένα πλήθος εργασιών σε διαφορετικά προγραμματισμένα διαστήματα, όπως η αποστολή ειδοποιήσεων μέσω ηλεκτρονικού ταχυδρομείου για αναρτήσεις σε φόρουμ. Το σενάριο θα πρέπει να εκτελείται τακτικά - ιδανικά κάθε λεπτό.';
...
$string['defaulthomepage'] = 'Aρχική σελίδα για χρήστες';
...
$string['enablesafebrowserintegration'] = 'Ενεργοποίηση ενσωμάτωσης του περιηγητή Safe Exam (για ασφαλείς εξετάσεις)';
...
$string['groupenrolmentkeypolicy_desc'] = 'Αν ενεργοποιηθεί, τα κλειδιά εγγραφής ομάδας θα ελέγχονται σύμφωνα με την πολιτική κωδικού πρόσβασης όπως καθορίζεται στις παραπάνω ρυθμίσεις.';
...
$string['iplookupgeoplugin'] = 'Η υπηρεσία <a href="https://www.geoplugin.com">geoPlugin</a> χρησιμοποιείται προς το παρόν για αναζήτηση γεωγραφικών πληροφοριών. Για πιο ακριβή αποτελέσματα σας προτείνουμε να εγκαταστήσετε ένα τοπικό αντίγραφο της βάσης δεδομένων MaxMind GeoLite.';
...
$string['messagingallusers'] = 'Να επιτρέπεται η ανταλλαγή μηνυμάτων σε επίπεδο ιστότοπου';
...
$string['mobilenotconfiguredwarning'] = 'Η εφαρμογή του Moodle για κινητά δεν είναι ενεργοποιημένη.';
...
$string['moodleapp_help'] = '<p>Αν έχετε έναν λογαριασμό σε έναν ιστότοπο Moodle, μπορείτε να έχετε πρόσβαση σε όλα τα μαθήματά σας στις κινητές συσκευές σας με την δωρεάν εφαρμογή μας για το Moodle για κινητά.</p>
<a href="https://moodle.com/mobile-app">Λήψη της εφαρμογής Moodle</a>';
$string['moodlebrandedapp'] = 'Επώνυμη εφαρμογή κινητού Moodle';
$string['moodlebrandedapp_help'] = '<p>Η επώνυμη εφαρμογή κινητών Moodle έχει όλες τις λειτουργίες της δωρεάν εφαρμογής για κινητά για το Moodle σε συνδυασμό με τη δική σας προσαρμοσμένη επωνυμία.</p>
<a href="https://moodle.com/branded-app">Σχετικά με την επώνυμη εφαρμογή κινητών Moodle</a>';
...
$string['pathtophp'] = 'Διαδρομή προς το εκτελέσιμο αρχείο της PHP';
...
$string['pathtosassc'] = 'Διαδρομή για το SassC';
$string['pathtosassc_help'] = 'Ο καθορισμός της θέσης του εκτελέσιμου αρχείου του SassC θα μεταβιβάσει την μεταγλώττιση SASS από την υλοποίηση PHP της Moodle στο SassC. Δείτε https://github.com/sass/sassc για περισσότερες πληροφορίες.';
...
<ul>
<li>Θα μπορείτε να εγγραφείτε για να λαμβάνετε ειδοποιήσεις για νέες διανομές Moodle, συναγερμούς/ειδοποιήσεις ασφαλείας και άλλα σημαντικά νέα.</li>
<li>Μπορείτε να έχετε πρόσβαση και να ενεργοποιήσετε τις προωθητικές ειδοποιήσεις κινητών τηλεφώνων από τον ιστότοπό σας Moodle μέσω της δωρεάν εφαρμογής μας <a href="https://download.moodle.org/mobile/">Εφαρμογή Moodle για κινητά</a>.</li>
...
* Μπορείτε να ενεργοποιήσετε τις προωθητικές ενημερώσεις εφαρμογής κινητών από τον ιστότοπό σας
...
$string['riskdataloss'] = 'Οι χρήστες μπορεί να κααταστρέψουν πολύ υλικό ή πληροφορίες';
