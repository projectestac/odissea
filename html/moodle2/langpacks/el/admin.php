...
$string['configemailfromvia'] = 'Προσθέστε πληροφορίες στο πεδίο «Από» του εξερχόμενου μηνύματος ηλε.ταχυδρομείου. Αυτό πληροφορεί τον παραλήπτη από που ήλθε αυτό το μήνυμα ηλε.ταχυδρομείου και βοηθά επίσης τους παραλήπτες στο να μην απαντήσουν κατα λάθος σε διευθύνσεις ηλε.ταχυδρομείου μη-απάντησης.';
...
$string['configextendedusernamechars'] = 'Ενεργοποιήστε αυτή τη ρύθμιση για να επιτρέψετε στους μαθητές να χρησιμοποιούν οποιονδήποτε χαρακτήρα στα ονόματα χρήστη τους (σημειώστε ότι αυτό δεν επηρεάζει τα πραγματικά τους ονόματα). Η προεπιλογή είναι «ανενεργό» και περιορίζει τα ονόματα των χρηστών στο να περιλαμβάνουν μόνο αλφαριθμητικούς πεζούς χαρακτήρες, κάτω παύλες (_), παύλες (-), τελείες (.) ή παπάκια (@).';
...
$string['configmaxeditingtime'] = 'Εδώ ορίζεται το χρονικό διάστημα που έχουν οι χρήστες για να επανεπεξεργαστούν αναρτήσεις σε φόρουμ, σχόλια σε γλωσσάρια κτλ. Συνήθως τα 30 λεπτά είναι μια καλή τιμή.';
...
$string['configmessagingallowemailoverride'] = 'Να επιτρέπεται οι χρήστες να λαμβάνουν ειδοποιήσεις με μηνύματα ηλε.ταχυδρομείου σε μια ηλ. διεύθυνση διαφορετική από τη ηλ. διεύθυνση στο προφίλ τους.';
...
$string['configpathtodu'] = 'Μονοπάτι για το πρόγραμμα du. Αν το συμπληρώσετε, τότε οι σελίδες που παρουσιάζουν τα περιεχόμενα φακέλων θα τρέχουν πολύ πιο γρήγορα για φακέλους με πολλά αρχεία.';
...
$string['configprofilesforenrolledusersonly'] = 'Προς παρεμπόδιση κακής χρήσης από spammer, οι περιγραφές των προφίλ χρηστών που δεν έχουν ακόμη εγγραφεί σε κανένα μάθημα είναι κρυφές. Οι νέοι χρήστες πρέπει να εγγραφονται σε τουλάχιστον ένα μάθημα πριν να μπορούν να προσθέσουν περιγραφή στο προφίλ τους.';
...
$string['datarootsecurityerror'] = '<p><strong>ΠΡΟΕΙΔΟΠΟΙΗΣΗ ΑΣΦΑΛΕΙΑΣ!</strong></p><p>Ο φάκελος dataroot βρίσκεται σε λάθος τοποθεσία και είναι εκτεθειμένος στο διαδίκτυο. Αυτό σημαίνει πως όλα τα ιδιωτικά σας αρχεία είναι διαθέσιμα σε οποιονδήποτε στον κόσμο και ορισμένα από αυτά μπορούν να χρησιμοποιηθούν από κάποιον cracker για την απόκτηση διαχειριστικής πρόσβασης στον ιστότοπό σας!</p>
...
$string['mbstringrequired'] = 'Για να βελτιωθεί η απόδοση του ιστότοπου, απαιτείται η εγκατάσταση της βιβλιοθήκης MBSTRING, ιδιαίτερα εάν ο ιστότοπός σας υποστηρίζει μη λατινικές γλώσσες.';
...
$string['moodleapp_help'] = '<p>Αν έχετε έναν λογαριασμό σε έναν ιστότοπο Moodle, μπορείτε να έχετε πρόσβαση σε όλα τα μαθήματά σας από τις κινητές συσκευές σας με την δωρεάν εφαρμογή κινητού μας για το Moodle.</p>
<a href="https://moodle.com/mobile-app">Λήψη της εφαρμογής κινητού Moodle</a>';
...
$string['smtpdetail'] = 'Ρυθμίσεις SMTP (απλό πρωτόκολλο μεταφοράς ηλε.ταχυδρομείου) για αποστολή αλληλογραφίας';
