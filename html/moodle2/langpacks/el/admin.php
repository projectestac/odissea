...
$string['configdebugsmtp'] = 'Ενεργοποίηση μηνυμάτων πληροφοριών αποσφαλμάτωσης κατά τη διάρκεια αποστολής μηνυμάτων ηλεκτρονικού ταχυδρομείου στον εξυπηρετητή SMTP. Για να έχει αυτή η ρύθμιση αποτέλεσμα, πρέπει η ρύθμιση «Μηνύματα αποσφαλμάτωσης» να οριστεί σε «Προγραμματιστής».';
...
$string['configdocroot'] = 'Καθορίζει τη διαδρομή προς τα Moodle Docs για παροχή τεκμηρίωσης ανάλογα με τα συγκεκριμένα συμφραζόμενα, μέσω των συνδέσμων «Moodle Docs για αυτή τη σελίδα» στο υποσέλιδο κάθε σελίδας. Αν το πεδίο παραμείνει κενό, οι σύνδεσμοι δεν θα εμφανιστούν.';
...
$string['themeresetcaches'] = 'Καθάρισε την κρυφή μνήμη αισθητικού θέματος';
