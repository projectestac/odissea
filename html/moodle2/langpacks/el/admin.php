...
/**
 * Strings for component 'admin', language 'el', branch 'MOODLE_32_STABLE'
 *
 * @package   admin
...
$string['allowedemaildomains'] = 'Επιτρεπόμενοι τομείς ηλεκτρονικού ταχυδρομείου';
$string['allowediplist'] = 'Λίστα επιτρεπτών IP';
$string['allowemailaddresses'] = 'Επιτρεπόμενοι τομείς ηλεκτρονικού ταχυδρομείου';
$string['allowframembedding'] = 'Επέτρεψε την ενσωμάτωση πλαισίου (frame)';
$string['allowframembedding_help'] = 'Αν είναι ενεργοποιημένη, αυτός ο ιστοχώρος μπορεί να ενσωματωθεί σε ένα πλαίσιο σε ένα απομακρυσμένο σύστημα, όπως συνιστάται όταν χρησιμοποιείτε το πρόσθετο εγγραφής "Δημοσίευση ως εργαλείο LTI". Διαφορετικά, συνιστάται να αφήσετε την ενσωμάτωση πλαισίου απενεργοποιημένη για λόγους ασφαλείας.';
...
$string['allowthemechangeonurl'] = 'Να επιτρέπεται αλλαγή θεμάτων στο URL';
$string['allowuserblockhiding'] = 'Να επιτρέπεται οι χρήστες να αποκρύπτουν μπλοκ';
$string['allowusermailcharset'] = 'Να επιτρέπεται οι χρήστες να αλλάζουν σετ χαρακτήρων';
...
$string['alternativefullnameformat'] = 'Μορφή εναλλακτικού πλήρους ονόματος';
...
$string['authpreventaccountcreation_help'] = 'Όταν ένας χρήστης επαληθεύεται, δημιουργείται αυτόματα ένας λογαριασμός στον ιστοχώρο αν δεν υπάρχει. Αν χρησιμοποιείται μια εξωτερική βάση δεδομένων, όπως το LDAP, για την αυθεντικοποίηση, αλλά επιθυμείτε να περιορίσετε την πρόσβαση στον ιστοχώρο σε χρήστες με έναν υπάρχοντα λογαριασμό μόνο, τότε αυτή η επιλογή θα πρέπει να ενεργοποιηθεί. Οι νέοι λογαριασμοί θα πρέπει να δημιουργηθούν με το χέρι ή μέσω της δυνατότητας μεταφόρτωσης χρηστών. Σημειώστε ότι αυτή η ρύθμιση δεν ισχύει για την αυθεντικοποίηση MNet.';
...
$string['bookmarkalreadyexists'] = 'Έχετε ήδη προσθέσει αυτήν τη σελίδα στους σελιδοδείκτες.';
$string['bookmarkdeleted'] = 'Ο σελιδοδείκτης διαγράφηκε.';
$string['bookmarkthispage'] = 'Προσθήκη της σελίδας στους σελιδοδείκτες';
$string['cacheapplication'] = 'Προσωρινή μνήμη εφαρμογής';
$string['cacheapplicationhelp'] = 'Τα στοιχεία της προσωρινής μνήμης μοιράζονται μεταξύ όλων των χρηστών και λήγουν μετά από ένα καθορισμένο χρόνο  ζωής (ttl).';
$string['cachejs'] = 'Προσωρινή μνήμη Javascript';
$string['cachejs_help'] = 'Η προσωρινή αποθήκευση και η συμπίεση Javascript βελτιώνει σημαντικά την απόδοση φόρτωσης σελίδας. Συνιστάται ιδιαίτερα για παραγωγικούς ιστοχώρους. Οι προγραμματιστές πιθανώς θα θέλουν να απενεργοποιήσουν αυτό το χαρακτηριστικό.';
$string['cacherequest'] = 'Ζήτηση προσωρινής μνήμης';
$string['cacherequesthelp'] = 'Προσωρινή μνήμη χρήστη που λήγει όταν ολοκληρωθεί η αίτηση. Σχεδιασμένο να αντικαθιστά περιοχές όπου χρησιμοποιούμε τις στατικές αποθηκεύσεις.';
$string['cachesession'] = 'Στιγμιότυπο προσωρινής αποθήκευσης';
$string['cachesessionhelp'] = 'Προσωρινή μνήμη χρήστη που λήγει όταν λήξει η συνεδρία του χρήστη. Σχεδιασμένο για να αποσυμφορίσει τη διόγκωση / καταπόνηση της συνεδρίας.';
$string['cachesettings'] = 'Ρυθμίσεις προσωρινής μνήμης';
...
$string['configallowattachments'] = 'Αν ενεργοποιηθεί, τα μηνύματα ηλεκτρονικού ταχυδρομείου που αποστέλλονται από τον ιστότοπο μπορούν να έχουν συνημμένα, όπως βραβεία (badges).';
...
$string['configallowemailaddresses'] = 'Αν θέλετε να περιορίσετε όλες τις καινούργιες διευθύνσεις ηλεκτρονικού ταχυδρομείου σε συγκεκριμένους τομείς, τις εισάγετε χωρισμένες με κενά. Όλοι οι άλλοι τομείς δεν θα γίνονται δεκτοι. Για να επιτρέπονται οι υποτομείς προσθέστε τον τομέα βάζοντας μπροστά \'.\' π.χ. <strong>ourcollege.edu.au .gov.au</strong>.';
$string['configallowguestmymoodle'] = 'Αν ενεργοποιηθεί οι επισκέπτες μπορούν να έχουν πρόσβαση στο τοίχο, αλλιώς οι επισκέπτες θα μεταφέρονται στην πρώτη σελίδα.';
...
$string['configallowusermailcharset'] = 'Αν ενεργοποιηθεί, οι χρήστες μπορούν να επιλέξουν την κωδικοποίηση ηλεκτρονικού ταχυδρομείου στις προτιμήσεις μηνυμάτων ηλεκτρονικού ταχυδρομείου.';
...
$string['configallusersaresitestudents'] = 'Να θεωρούνται όλοι οι χρήστες ως μαθητές, αναφορικά με τις δραστηριότητες της πρώτης σελίδας; Αν ναι, τότε κάθε επιβεβαιωμένος χρήστης θα μπορεί να συμμετέχει ως μαθητής στις δραστηριότητες αυτές. Αν όχι, τότε μόνο χρήστες που συμμετέχουν σε τουλάχιστον ένα μάθημα θα μπορούν να λάβουν μέρος στις δραστηριότητες αυτές. Μόνο οι διαχειριστές και ειδικά ορισμένοι διδάσκοντες μπορούν να ενεργήσουν ως διδάσκοντες για αυτές τις δραστηριότητες.';
...
$string['configautolang'] = 'Εντοπισμός προεπιλεγμένης γλώσσας από τις ρυθμίσεις του προγράμματος περιήγησης, αν είναι απενεργοποιημένο χρησιμοποιείται η προεπιλεγμένη γλώσσα του ιστοχώρου.';
...
$string['configcalendarexportsalt'] = 'Αυτό το τυχαίο κείμενο χρησιμοποιείται για τη βελτίωση της ασφάλειας των αδειοπλαισίων (tokens) αυθεντικοποίησης που χρησιμοποιούνται για την εξαγωγή ημερολογίων. Παρακαλώ σημειώστε πως όλα τα τρέχοντα tokens ακυρώνονται αν αλλάξετε αυτό το κλειδί.';
...
$string['configcronclionly'] = 'Η εκτέλεση του cron από ένα πρόγραμμα περιήγησης μπορεί να αποκαλύψει σημαντικές πληροφορίες σε ανώνυμους χρήστες. Έτσι, συνιστάται η εκτέλεση του cron μόνο από τη γραμμή εντολών ή να ορίσετε έναν κωδικό πρόσβασης στο cron για απομακρυσμένη πρόσβαση.';
$string['configcronremotepassword'] = 'Αυτό σημαίνει πως το cron.php δεν μπορεί να εκτελεστεί από ένα πρόγραμμα περιήγησης χωρίς την παροχή του κωδικού πρόσβασης χρησιμοποιώντας την παρακάτω μορφή URL:<pre>
    http://site.example.com/admin/cron.php?password=opensesame
</pre>Αν αυτό μείνει κενό, τότε δεν απαιτείται κωδικός πρόσβασης.';
$string['configcurlcache'] = 'Χρόνος ζωής για τη προσωρινή μνήμη cURL, σε δευτερόλεπτα.';
...
$string['configdeleteunconfirmed'] = 'Αν χρησιμοποιείτε αυθεντικοποίηση μέσω ηλεκτρονικού ταχυδρομείου, αυτή η ρύθμιση ορίζει την χρονική περίοδο μέσα στην οποία μια απόκριση από τους χρήστες θα γίνεται δεκτή. Μετά από αυτήν την περίοδο, οι μη επιβεβαιωμένοι λογαριασμοί διαγράφονται.';
$string['configdenyemailaddresses'] = 'Για την απαγόρευση διευθύνσεων ηλεκτρονικού ταχυδρομείου από συγκεκριμένους τομείς θα πρέπει να τις εισάγετε εδώ με τον ίδιο τρόπο. Όλα οι άλλοι τομείς θα γίνονται δεκτοί. Για την απαγόρευση υποτομένων προσθέστε τον τομέα βάζοντας μπροστά \'.\' π.χ. <strong>hotmail.com yahoo.co.uk .live.com</strong>';
...
$string['configemailchangeconfirmation'] = 'Απαίτηση επιβεβαίωσης μέσω ηλεκτρονικού ταχυδρομείου όταν οι χρήστες αλλάζουν τη διεύθυνσή ηλεκτρονικού ταχυδρομείου τους στο προφίλ τους.';
...
$string['configenableblogs'] = 'Αυτός ο διακόπτης παρέχει σε όλους τους χρήστες της ιστοσελίδας να έχουν το δικό τους blog.';
...
$string['configforcelogin'] = 'Κανονικά, η πρώτη σελίδα και η λίστα των μαθημάτων (αλλά όχι τα ίδια τα μαθήματα) μπορούν να προσπελαστούν από άτομα χωρίς να συνδεθούν στον ιστοχώρο. Αν θέλετε να αναγκάσετε τους χρήστες να συνδεθούν πριν κάνουν ΟΤΙΔΗΠΟΤΕ στον ιστοχώρο, τότε αυτή η ρύθμιση πρέπει να ενεργοποιηθεί.';
...
$string['configfrontpage'] = 'Τα επιλεγμένα αντικείμενα θα εμφανίζονται στην πρώτη σελίδα.';
$string['configfrontpagecourselimit'] = 'Μέγιστος αριθμός μαθημάτων';
$string['configfrontpagecourselimithelp'] = 'Μέγιστος αριθμός μαθημάτων που πρέπει να εμφανίζονται στην πρώτη σελίδα του ιστοχώρου στη λίστα των μαθημάτων.';
$string['configfrontpageloggedin'] = 'Τα επιλεγμένα αντικείμενα θα προβάλλονται στην πρώτη σελίδα του ιστοχώρου όταν συνδέεται ένας χρήστης.';
...
$string['configintroadmin'] = 'Σε αυτήν τη σελίδα μπορείτε να ρυθμίσετε τον λογαριασμό του κύριου διαχειριστή ο οποίος θα έχει τον πλήρη έλεγχο του ιστοχώρου. Επιβεβαιώστε ότι χρησιμοποιείτε ασφαλές όνομα χρήστη και κωδικό πρόσβασης, καθώς και μια έγκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου. Μπορείτε να δημιουργήσετε περισσότερους λογαριασμούς διαχειριστή στη συνέχεια.';
$string['configintrosite'] = 'Αυτή η σελίδα σας επιτρέπει να ρυθμίσετε την πρώτη σελίδα και το όνομα του νέου ιστοχώρου. Μπορείτε να επιστρέψετε αργότερα για την αλλαγή αυτών των ρυθμίσεων.';
...
$string['configlangstringcache'] = 'Αποθηκεύει προσωρινά όλα τα αλφαριθμητικά της γλώσσας σε μεταγλωττισμένα αρχεία στον κατάλογο δεδομένων. Αν μεταφράζετε το Moodle ή αλλάζετε αλφαριθμητικά στον πηγαίο κώδικα του Moodle τότε μπορεί να θέλετε να απενεργοποιήσετε την επιλογή. Διαφορετικά αφήστε την ενεργοποιημένη για να δείτε οφέλη απόδοσης.';
...
$string['configmailnewline'] = 'Χαρακτήρες εισαγωγής γραμμής που χρησιμοποιούνται σε μηνύματα ηλεκτρονικού ταχυδρομείου. Το CRLF απαιτείται σύμφωνα με το RFC 822bis, ορισμένοι διακομιστές ηλεκτρονικού ταχυδρομείου κάνουν αυτόματη μετατροπή από LF σε CRLF, άλλοι διακομιστές ηλεκτρονικού ταχυδρομείου κάνουν λάθος μετατροπή από CRLF σε CRCRLF ενώ άλλοι απορρίπτουν μηνύματα με απλό LF (qmail, για παράδειγμα). Δοκιμάστε να αλλάξετε αυτή τη ρύθμιση αν έχετε προβλήματα με μη παραδομένα μηνύματα ή διπλές νέες γραμμές.';
...
$string['configmaxusersperpage'] = 'Ο μέγιστος αριθμός χρηστών που εμφανίζονται στον επιλογή χρήστη σε μάθημα, ομάδα, ομάδα χρηστών, διαδικτυακή υπηρεσία κ.λπ.';
...
$string['configminpasswordlength'] = 'Οι κωδικοί πρόσβασης πρέπει να έχουν τουλάχιστον τόσους χαρακτήρες σε μέγεθος.';
...
$string['confignavshowcategories'] = 'Εμφάνιση κατηγοριών μαθημάτων στη γραμμή πλοήγησης και στα μπλοκ πλοήγησης. Αυτό δεν συμβαίνει με τα μαθήματα στα οποία είναι εγγεγραμμένος ο χρήστης, θα εξακολουθούν να εμφανίζονται στο μπλοκ Τα μαθήματα μου χωρίς κατηγορίες.';
...
$string['configsmtpmaxbulk'] = 'Μέγιστος αριθμός μηνυμάτων που θα στέλνονται σε κάθε σύνοδο SMTP. Η ομαδοποίηση των μηνυμάτων μπορεί να επιταχύνει την αποστολή. Τιμές μικρότερες από 2 επιβάλλουν τη δημιουργία μιας νέας συνεδρίας SMTP για κάθε μήνυμα.';
...
$string['configuseblogassociations'] = 'Θα έπρεπε οι χρήστες να μπορούν να οργανώνουν το ιστολόγιό τους συνδέοντας καταχωρήσεις με μαθήματα και αρθρώματα μαθημάτων;';
...
$string['configusesitenameforsitepages'] = 'Αν είναι ενεργοποιημένη, το σύντομο όνομα του ιστοχώρου θα χρησιμοποιηθεί για τον κόμβο σελίδων ιστοχώρου στην πλοήγηση και όχι το αλφαριθμητικό \'Σελίδες ιστοχώρου\'';
...
$string['configyuicomboloading'] = 'Αυτές οι επιλογές επιτρέπουν τη βελτιστοποίηση φόρτωσης συνδυασμένων αρχείων για τις βιβλιοθήκες YUI. Αυτή η ρύθμιση θα πρέπει να είναι ενεργοποιημένη σε παραγωγικού ιστοχώρους για λόγους απόδοσης.';
$string['confirmation'] = 'Επιβεβαίωση';
$string['confirmdeletecomments'] = 'Είστε έτοιμοι να διαγράψετε σχόλια, είστε σίγουροι;';
$string['confirmed'] = 'Επιβεβαιωμένο';
...
$string['curlcache'] = 'Χρόνος ζωής προσωρινής μνήμης cURL';
...
$string['debugstringids'] = 'Εμφάνιση προέλευσης αλφαριθμητικών γλώσσας';
...
$string['defaultformatnotset'] = 'Σφάλμα κατά τον καθορισμό της προεπιλεγμένης μορφής μαθήματος. Παρακαλούμε ελέγξτε τις ρυθμίσεις του ιστοχώρου.';
...
$string['devlibdirpresent'] = 'Οι κατάλογοι με βιβλιοθήκες ανάπτυξης όπως <em>vendor</em> ή <em>node_modules</em> δεν θα πρέπει να υπάρχουν σε δημόσιους ιστοχώρους. Δείτε την <a href="{$a->moreinfourl}">αναφορά επισκόπησης ασφαλείας</a> για περισσότερες λεπτομέρειες.';
...
* Εναλλακτικό κείμενο (προαιρετικό) - Αναγνωριστικό αλφαριθμητικού και στοιχείο του εναλλακτικού κειμένου του emoticon.';
...
$string['enablemobilewebservice'] = 'Ενεργοποίηση κινητών διαδικτυακών υπηρεσιών';
$string['enablerecordcache'] = 'Ενεργοποίηση Record Cache';
$string['enablerssfeeds'] = 'Ενεργοποίηση RSS feeds';
$string['enablesafebrowserintegration'] = 'Ενεργοποίηση ενσωμάτωσης Ασφαλής Περιήγηση σε Εξετάσεις';
...
$string['enablewebservices'] = 'Ενεργοποίηση διαδικτυακών υπηρεσιών';
...
$string['eventshandlersinuse'] = 'Τα ακόλουθα πρόσθετα στο σύστημά σας χρησιμοποιούν τους χειριστές που έχουν καταργηθεί Events 1 API: \'{$a}\'. Παρακαλούμε ενημερώστε τα ώστε να χρησιμοποιήσουν το Events 2 API. Δείτε https://docs.moodle.org/dev/Event_2#Event_dispatching_and_observers.';
...
$string['formatuninstallwithcourses'] = 'Υπάρχουν {$a->count} μαθήματα σε μόρφη {$a->format}. Η μορφή τους θα αλλάξει σε {$a->defaultformat} (προεπιλεγμένη μορφή για αυτόν τον ιστοχώρο). Ενδέχεται να χαθούν ορισμένα δεδομένα για τη συγκεκριμένη μορφή. Είστε βέβαιοι ότι θέλετε να συνεχίσετε;';
...
$string['frontpageloggedin'] = 'Αντικείμενα πρώτης σελίδας όταν είναι συνδεδεμένοι';
...
$string['gotofirst'] = 'Πήγαινε στο πρώτο αλφαριθμητικό που λείπει';
...
$string['guestroleid_help'] = 'Ο ρόλος αυτός εκχωρείται αυτόματα στον χρήστη που είναι επισκέπτης. Εκχωρείται επίσης προσωρινά στους μη εγγεγραμένους χρήστες που εισέρχονται στο μάθημα μέσω της λειτουργίας εγγραφής επισκέπτη στο μάθημα.';
...
$string['indexinginfo'] = 'Ο προτεινόμενος τρόπος για να ευρετηριάσετε τα περιεχόμενα του ιστοχώρου σας είναι να χρησιμοποιήσετε την προγραμματισμένη εργασία \'Ευρετηρίαση καθολικής  αναζήτησης\'';
...
$string['ishttpswarning'] = 'Εντοπίστηκε ότι ο ιστοχώρος σας δεν είναι ασφαλής καθώς δεν  χρησιμοποιεί HTTPS. Προτείνεται να μεταφέρετε τον ιστοχώρος σας σε HTTPS για αυξημένη ασφάλεια και βελτιωμένη ολοκλήρωση με άλλα συστήματα.';
...
$string['langcache_desc'] = 'Τοποθετήστε το μενού γλώσσας στην cache. Αν είναι ενεργοποιημένο, η λίστα των διαθέσιμων μεταφράσεων βρίσκεται στην cache. Η cache ανανεώνεται αυτόματα κατά την εγκατάσταση ή διαγραφή ενός γλωσσικού πακέτου μέσω του ενσωματωμένου εργαλείου διαχείρισης γλωσσικών πακέτων. Αν εγκαταστήσετε ένα νέο γλωσσικό πακέτο χειροκίνητα, θα πρέπει να χρησιμοποιήσετε την Εκκαθάριση όλων των χαρακτηριστικών της cache για να ανανεώσετε τον κατάλογο της cache.';
...
$string['langstringcache'] = 'Προσωρινή αποθήκευση όλων των αλφαριθμητικών της γλώσσας';
...
$string['legacyfilesinnewcourses_help'] = 'Από προεπιλογή, οι περιοχές αρχείων μαθημάτων παλαιότερων εκδόσεων είναι διαθέσιμες μόνο σε αναβαθμισμένα μαθήματα. Παρακαλώ σημειώστε ότι μερικά χαρακτηριστικά όπως ένα αντίγραφο ασφαλείας/επαναφοράς δραστηριότητας δεν είναι συμβατά με αυτή τη ρύθμιση.';
...
$string['localstringcustomization'] = 'Προσαρμογή τοπικών αλφαριθμητικών';
...
$string['lockoutemailbody'] = 'Ο λογαριασμός σας με όνομα χρήστη {$a->username} στον ιστοχώρο \'{$ a-> sitename}\'
...
Αν αυτό δεν λειτουργεί, τότε αντιγράψτε και επικολλήστε τη διεύθυνση στη γραμμή διευθύνσεων στο επάνω μέρος του παραθύρου του προγράμματος περιήγησης.
<br/><br/>
...
$string['loginpasswordautocomplete_help'] = 'Αν είναι ενεργοποιημένη, οι χρήστες δεν επιτρέπεται να αποθηκεύσουν τον κωδικό πρόσβασης του λογαριασμού τους στο πρόγραμμα περιήγησης.';
...
$string['logo_desc'] = 'Ένα πλήρες λογότυπο που θα χρησιμοποιηθεί ως διακόσμηση από μερικά θέματα (όπως τα βασικά θέματα). Αυτή η εικόνα μπορεί να είναι υψηλής ανάλυσης, επειδή θα μειωθεί κατά τη χρήση (και θα αποθηκευτεί προσωρινά για λόγους απόδοσης). Τα λογότυπα που είναι πιο πλατιά σε σχέση με το ύψος, συνήθως δίνουν καλύτερο αποτέλεσμα. Αποδεκτές μορφές: PNG και JPG.';
...
$string['maintenancemodeisscheduled'] = 'Αυτός ο ιστοχώρος θα μεταβεί στη λειτουργία συντήρησης σε {$a->min} λεπτά {$a->sec} δευτερόλεπτα';
$string['maintenancemodeisscheduledlong'] = 'Αυτός ο ιστοχώρος θα μεταβεί στη λειτουργία συντήρησης σε {$a->hour} ώρες {$a->min} λεπτά {$a->sec} δευτερόλεπτα';
...
$string['navadduserpostslinks_help'] = 'Αν είναι ενεργοποιημένη, θα προστεθούν δύο σύνδεσμοι σε κάθε χρήστη στην πλοήγηση για να βλέπουν τις συζητήσεις που έχει ξεκινήσει ο χρήστης και τις αναρτήσεις που έχει κάνει ο χρήστης σε ομάδες συζητήσεων σε ολόκληρο τον ιστοχώρο ή σε συγκεκριμένα μαθήματα.';
...
$string['navshowfrontpagemods_help'] = 'Αν ενεργοποιηθεί, οι δραστηριότητες της πρώτης σελίδας θα εμφανίζονται στην πλοήγηση κάτω από τις σελίδες του ιστοχώρου.';
...
$string['navsortmycoursessort_help'] = 'Καθορίζει αν τα μαθήματα εμφανίζονται στο μπλοκ Τα μαθήματά μου ανάλογα με τη σειρά ταξινόμησης (δηλ. η σειρά που έχει οριστεί στη Διαχείριση ιστοχώρου > Μαθήματα> Διαχείριση μαθημάτων και κατηγοριών) ή αλφαβητικά σύμφωνα με τη ρύθμιση μαθημάτων.';
$string['never'] = 'Ποτέ';
...
$string['numberofstrings'] = 'Συνολικός αριθμός αλφαριθμητικών: {$a->strings}<br />Λείπουν: {$a->missing} ({$a->missingpercent} %)';
$string['onlynoreply'] = 'Μόνο όταν προέρχεται από διεύθυνση μη-απάντηση';
$string['opcacherecommended'] = 'Η προσωρινή αποθήκευση PHP opcode βελτιώνει την απόδοση και μειώνει τις απαιτήσεις μνήμης, η επέκταση OPcache συνιστάται και υποστηρίζεται πλήρως.';
...
$string['passwordchangelogout_desc'] = 'Αν είναι ενεργοποιημένη, όταν αλλάξει ο κωδικός πρόσβασης, όλες οι συνεδρίες του προγράμματος περιήγησης τερματίζονται, εκτός από εκείνη στην οποία έχει οριστεί ο νέος κωδικός πρόσβασης. (Αυτή η ρύθμιση δεν επηρεάζει τις αλλαγές κωδικού πρόσβασης μέσω μαζικής μεταφόρτωσης χρηστών.)';
...
$string['purgecaches'] = 'Εκκαθάριση όλων των προσωρινών μνημών';
$string['purgecachesconfirm'] = 'Το Moodle μπορεί να αποθηκεύσει προσωρινά θέματα, javascript, αλφαριθμητικά γλώσσας, φιλτραρισμένο κείμενο, τροφοδοσίες rss και πολλά άλλα κομμάτια υπολογισμένων δεδομένων. Η εκκαθάριση αυτών των προσωρινών μνημών θα διαγράψει αυτά τα δεδομένα από το διακομιστή και θα αναγκάσει τα προγράμματα περιήγησης να επανακτήσουν δεδομένα, έτσι ώστε να είστε βέβαιοι ότι βλέπετε τις πιο ενημερωμένες τιμές που παράγει ο τρέχων κώδικάς. Δεν υπάρχει κίνδυνος στην εκκαθάριση των προσωρινών μνημών, αλλά ο ιστοχώρος σας ενδέχεται να εμφανιστεί πιο αργός για λίγο, έως ότου ο διακομιστής και οι πελάτες υπολογίσουν τη νέα πληροφορία και την αποθηκεύσουν στην προσωρινή μνήμη.';
$string['purgecachesfinished'] = 'Όλες οι προσωρινές μνήμες εκκαθαρίστηκαν';
...
$string['register'] = 'Καταχώρηση του ιστοχώρου σας';
$string['registermoodleorg'] = 'Όταν καταχωρήσετε τον ιστοχώρο σας';
...
$string['registermoodleorgli2'] = 'Στατιστικά σχετικά με τον ιστοχώρο σας θα προστεθεί στα {$a} της παγκόσμιας κοινότητας του Moodle .';
$string['registerwithmoodleorg'] = 'Καταχώρηση του ιστοχώρου σας';
$string['registration'] = 'Εγγραφή';
$string['registration_help'] = 'Συνιστάται να καταχωρήσετε τον ιστοχώρο σας για να λαμβάνετε ειδοποιήσεις ασφαλείας και να έχετε πρόσβαση στο Moodle.net, την πλατφόρμα κοινής χρήσης.';
$string['registrationwarning'] = 'Ο ιστοχώρος σας δεν έχει ακόμη καταχωρηθεί.';
...
$string['riskpersonalshort'] = 'Ρίσκο ιδιωτικότητας';
...
$string['sitesectionhelp'] = 'Αν επιλεγεί, μια ενότητα θέματος θα εμφανιστεί στην πρώτη σελίδα του ιστοχώρου.';
...
$string['updateavailablerecommendation'] = 'Συνιστάται ανεπιφύλακτα να ενημερώσετε τον ιστοχώρο σας στην τελευταία έκδοση για να αποκτήσετε όλες τις πρόσφατες διορθώσεις ασφάλειας και σφαλμάτων.';
...
$string['upgradepluginsinfo_help'] = 'Υπάρχουν διαθέσιμες ενημερώσεις για ορισμένα από τα πρόσθετα σας. Θα πρέπει να τα εγκαταστήσετε όλα πριν από την αναβάθμιση της βάσης δεδομένων του Moodle. Αν ο ιστοχώρος σας δεν υποστηρίζει την αυτόματη ανάπτυξη ενημερώσεων, θα πρέπει να κάνετε λήψη και εγκατάσταση των νέων εκδόσεων των πρόσθετων στο διακομιστή σας χειροκίνητα.';
