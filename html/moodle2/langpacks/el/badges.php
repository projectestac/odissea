...
$string['activatesuccess'] = 'Ενεργοποιηθήκε επιτυχώς η πρόσβαση στα διακριτικά';
$string['addalignment'] = 'Προσθέστε προσόν';
$string['addbadge'] = 'Προσθήκη διακριτικών';
$string['addbadgecriteria'] = 'Προσθήκη κριτηρίων διακριτικoύ';
...
$string['attachment'] = 'Προσθήκη διακριτικoύ στο μήνυμα';
$string['attachment_help'] = 'Αν ενεργοποιηθεί, στο μήνυμα ηλεκτρονικού ταχυδρομείου προς τον αποδέκτη, θα επισυναφθεί για λήψη, ένα αρχείο του εκδοθέντος διακριτικoύ. (Για να χρησιμοποιήσετε αυτή την επιλογή θα πρέπει να είναι ενεργοποιημένα τα συνημμένα στις «Ρυθμίσεις εμφάνισης ηλεκτρονικού ταχυδρομείου» στη Διαχείριση ιστοτόπου / Εξυπηρετητής / Ηλεκτρονικό ταχυδρομείο / Ρυθμίσεις εξερχόμενων μηνυμάτων ηλ. ταχυδρομείου.)';
$string['award'] = 'Απονομή διακριτικoύ';
...
$string['backpackavailability'] = 'Εξωτερική επικύρωση διακριτικoύ';
$string['backpackavailability_help'] = 'Για να μπορούν οι αποδέκτες του διακριτικoύ να αποδείξουν ότι κέρδισαν τα διακριτικά τους από εσάς, μια εξωτερική υπηρεσία σακιδίου (με διακριτικά) πρέπει να έχει πρόσβαση στον ιστότοπό σας και να επαληθεύει τα διακριτικά που εκδίδονται από αυτήν. Προς το παρόν, ο ιστότοπός σας δεν φαίνεται να είναι προσβάσιμος, πράγμα που σημαίνει ότι τα διακριτικά που έχετε ήδη εκδώσει ή πρόκειται να εκδώσετε στο μέλλον δεν μπορούν να εξακριβωθούν.<br /> ** Γιατί βλέπω αυτό το μήνυμα;<br /> ** Ίσως το firewall σας να εμποδίζει την πρόσβαση από χρήστες εκτός του δικτύου σας, ο ιστότοπός σας να προστατεύεται με κωδικό πρόσβασης ή να εκτελείτε τον ιστότοπο σε υπολογιστή που δεν είναι διαθέσιμος από το Διαδίκτυο (όπως μηχανή τοπικής ανάπτυξης).<br /> ** Πρόκειται για πρόβλημα;<br /> ** Θα πρέπει να διορθώσετε αυτό το ζήτημα σε οποιαδήποτε τοποθεσία παραγωγής όπου σχεδιάζετε να εκδίδετε διακριτικά, διαφορετικά οι αποδέκτες δεν θα μπορούν να αποδείξουν ότι κέρδισαν τα διακριτικά τους από εσάς. Αν ο ιστότοπός σας δεν είναι ακόμα σε λειτουργία, μπορείτε να δημιουργήσετε και να εκδώσετε δοκιμαστικά διακριτικά, εφόσον ο ιστότοπος θα είναι προσβάσιμος πριν ξεκινήσετε τη λειτουργία του.<br /> ** Τι γίνεται αν δεν μπορώ να κάνω ολόκληρο τον ιστότοπό μου δημόσια πρόσβασιμο;<br /> ** Η μόνη απαιτούμενη διεύθυνση URL για την επαλήθευση είναι η διεύθυνση [your-site-url]/badges/assertion.php. Έτσι εάν μπορείτε να τροποποιήσετε το firewall σας για να επιτρέψετε την εξωτερική πρόσβαση σε αυτό το αρχείο, η επαλήθευση του διακριτικoύ θα εξακολουθήσει να λειτουργεί.';
$string['backpackbadges'] = 'Έχετε {$a->totalbadges} διακριτικά/-ό που εμφανίζονται από {$a->totalcollections} συλλογές. <a href="mybackpack.php">Αλλαγή ρυθμίσεων σακιδίου</a>.';
$string['backpackcannotsendverification'] = 'Αδυναμία αποστολής μηνύματος επιβεβαίωσης με ηλεκτρονικό ταχυδρομείο';
$string['backpackconnection'] = 'Σύνδεση σακιδίου';
$string['backpackconnectioncancelattempt'] = 'Σύνδεση με τη χρήση διαφορετικής διεύθυνσης ηλ. ταχυδρομείου';
...
$string['backpackconnectionresendemail'] = 'Επανάληψη αποστολής με ηλεκτρονικό ταχυδρομείο του μηνύματος επιβεβαίωσης';
...
$string['backpackemail_help'] = 'Η συνδεδεμένη με το σακίδιο (με τα διακριτικά) σας διεύθυνση ηλ.ταχυδρομείου. Όσο είστε συνδεδεμένος/η, όποια διακριτικά σας απονεμηθούν σε αυτόν τον ιστότοπο θα συσχετιστούν με αυτή τη διεύθυνση.';
...
{$a->admin}';
$string['backpackemailverifyemailsubject'] = '{$a}: επιβεβαίωση διεύθυνσης ηλεκτρονικού ταχυδρομείου από την υπηρεσία Σακιδίου για διακριτικά';
$string['backpackemailverifypending'] = 'Ένα επιβεβαιωτικό μήνυμα ηλ.ταχυδρομείου στάλθηκε στο <strong>{$a}</strong>. Κάντε κλικ στο σύνδεσμο επιβεβαίωσης στο μήνυμα για να ενεργοποιήσετε τη σύνδεση με το Σακίδιο (με τα διακριτικά) σας.';
$string['backpackemailverifysuccess'] = 'Ευχαριστούμε για την επαλήθευση της ηλ.διεύθυνσής σας. Έχετε τώρα συνδεθεί με το σακίδιο (με τα διακριτικά) σας.';
$string['backpackemailverifytokenmismatch'] = 'Το κουπόνι στο σύνδεσμο στον οποίο πατήσατε δεν αντιστοιχεί στο αποθηκευμένο κουπόνι. Βεβαιωθείτε ότι κάνατε κλικ στο σύνδεσμο στο πιο πρόσφατο μήνυμα ηλεκτρονικού ταχυδρομείου που λάβατε.';
$string['backpackimport'] = 'Ρυθμίσεις εισαγωγής διακριτικoύ';
...
$string['badgedetails'] = 'Λεπτομέρειες διακριτικoύ';
...
$string['badgesalt'] = 'Salt (εμπλουτισμός κατατεμαχισμού με μη-μυστική, τυχαία τιμή, παρομοιάζεται με αλάτι) για τον κατατεμαχισμό της διεύθυνσης ηλ.ταχυδρομείου του αποδέκτη.';
$string['badgesalt_desc'] = 'Η χρήση μιας σύνοψης κατακερματισμού (hash, μη αντιστρεπτή αντιστοίχιση) επιτρέπει στις υπηρεσίες σακιδίου (με διακριτικά) να επιβεβαιώνουν την αυθεντικότητα της ταυτότητας ενός αποδέκτη διακριτικού χωρίς να αποκαλύπτουν την διεύθυνση ηλ.ταχυδρομείου του. Αυτή η ρύθμιση πρέπει να χρησιμοποιεί μόνο αριθμούς και γράμματα. Σημείωση: για να είναι εφικτή η επαλήθευση του αποδέκτη, παρακαλούμε αποφύγετε να αλλάξετε αυτή τη ρύθμιση, από τη στιγμή που θα ξεκινήσετε να εκδίδετε διακριτικά.';
$string['badgesdisabled'] = 'Τα διακριτικά δεν εχουν ενεργοποιηθεί σε αυτή τη σελίδα.';
...
$string['badgeurl'] = 'Σύνδεσμος εκδιδόμενου διακριτικoύ';
...
$string['configuremessage'] = 'Μήνυμα διακριτικoύ';
$string['connect'] = 'Σύνδεση';
$string['connected'] = 'Συνδεδεμένος';
$string['connecting'] = 'Γίνεται σύνδεση...';
$string['contact'] = 'Επικοινωνήστε';
$string['contact_help'] = 'Μια διεύθυνση ηλ.ταχυδρομείου συνδεδεμένη με τον εκδότη του διακριτικoύ';
...
$string['createbutton'] = 'Δημιουργία διακριτικoύ';
...
$string['criteriacreated'] = 'Τα κριτήρια διακριτικoύ δημιουργήθηκαν με επιτυχία';
$string['criteriadeleted'] = 'Τα κριτήρια διακριτικoύ διαγράφηκαν με επιτυχία';
...
$string['criteriaupdated'] = 'Τα κριτήρια διακριτικoύ ενημερώθηκαν με επιτυχία';
$string['criterror'] = 'Προβλήματα τρεχουσών ρυθμίσεων παραμέτρων';
$string['criterror_help'] = 'Αυτό το σύνολο από πεδία δείχνει όλες τις παραμέτρους που είχαν αρχικά προστεθεί σε αυτή την απαίτηση του διακριτικού αλλά δεν είναι πια διαθέσιμες. Προτείνεται να αποεπιλέξετε τέτοιες παραμέτρους για να βεβαιωθείτε ότι οι χρήστες στο μέλλον θα μπορούν να λαμβάνουν αυτό το διακριτικό.';
...
$string['error:backpackemailnotfound'] = 'Η διεύθυνση ηλεκτρονικού ταχυδρομείου «{$a}» δεν είναι συνδεδεμένη με ένα σακίδιο (με διακριτικά). Πρέπει να <a href="http://backpack.openbadges.org">δημιουργήσετε ένα σακίδιο (με τα διακριτικά σας)</a> για αυτό τον λογαριασμό ή να συνδεθείτε με άλλη διεύθυνση ηλ. ταχυδρομείου.';
$string['error:backpackloginfailed'] = 'Δεν μπορέσατε να συνδεθείτε με ένα εξωτερικό σακίδιο (με διακριτικά) για το εξής λόγο: {$a}';
$string['error:backpacknotavailable'] = 'Ο ιστότοπός σας δεν είναι προσβάσιμος από το Διαδίκτυο, έτσι όποια διακριτικά εκδόθηκαν από αυτόν τον ιστότοπο δεν μπορούν να επιβεβαιωθούν από εξωτερικές υπηρεσίες σακιδίου (με διακριτικά).';
...
$string['error:cannotact'] = 'Αδυναμία ενεργοποίησης διακριτικoύ.';
$string['error:cannotawardbadge'] = 'Αδυναμία απονομής διακριτικoύ σε χρήστη.';
$string['error:cannotdeletecriterion'] = 'Αυτό το κριτήριο δεν μπορεί να διαγραφεί.';
$string['error:cannotrevokebadge'] = 'Αδυναμία ανάκλησης διακριτικoύ από χρήστη.';
$string['error:clone'] = 'Αδυναμία αντιγραφής διακριτικoύ.';
$string['error:connectionunknownreason'] = 'Η σύνδεση ήταν μη επιτυχής αλλά δεν δόθηκε κάποια αιτιολόγηση.';
$string['error:duplicatename'] = 'Υπάχει ήδη διακριτικό στο σύστημα με αυτό το όνομα.';
...
$string['error:nosuchuser'] = 'Ο χρήστης με αυτή τη διεύθυνση ηλ.ταχυδρομείου δεν έχει έναν λογαριασμό στον τρέχοντα πάροχο υπηρεσίας σακιδίου (με διακριτικά).';
...
$string['eventbadgecriteriacreated'] = 'Τα κριτήρια διακριτικoύ δημιουργήθηκαν';
$string['eventbadgecriteriadeleted'] = 'Τα κριτήρια διακριτικoύ διαγράφηκαν';
$string['eventbadgecriteriaupdated'] = 'Τα κριτήρια διακριτικoύ ενημερώθηκαν';
...
$string['imageauthoremail'] = 'Διεύθυνση ηλεκτρονικού ταχυδρομείου του δημιουργού της εικόνας';
$string['imageauthoremail_help'] = 'Εάν έχει οριστεί, η διεύθυνση ηλεκτρονικού ταχυδρομείου του δημιουργού της εικόνας του διακριτικού εμφανίζεται στη σελίδα του διακριτικού.';
...
$string['issuancedetails'] = 'Λήξη διακριτικoύ';
$string['issuedbadge'] = 'Πληροφορίες διακριτικού που εκδόθηκε';
$string['issuerdetails'] = 'Στοιχεία εκδότη';
$string['issueremail'] = 'Διεύθυνση ηλεκτρονικού ταχυδρομείου';
$string['issueremail_help'] = 'Μια διεύθυνση ηλεκτρονικού ταχυδρομείου επικοινωνίας του οργανισμού που δημοσιεύει την έγκρισή του.';
...
$string['issuerurl_help'] = 'Ο ιστότοπος του οργανισμού που δημοσιεύει την έγκρισή του. Η διεύθυνση ιστού πρέπει να έχει ένα πρόθεμα http: // ή https: //.';
...
$string['never'] = 'Ποτέ';
$string['newbadge'] = 'Προσθήκη νέου διακριτικoύ';
...
$string['noterelated'] = 'Τα διακριτικά με σύνδεση μπορεί να επισημαίνονται ως σχετικά. Για παράδειγμα, διακριτικά με τα ίδια κριτήρια που εμφανίζονται σε διαφορετικές γλώσσες μπορούν να επισημαίνονται ως σχετικά. Οποιαδήποτε σχετικά διακριτικά εμφανίζονται στη σελίδα του διακριτικού.';
$string['nothingtoadd'] = 'Δεν υπάρχουν διαθέσιμα κριτήρια για προσθήκη.';
$string['notification'] = 'Ειδοποίηση δημιουργού διακριτικoύ';
...
$string['notifyweekly'] = 'Εβδομαδιαίως';
...
$string['status'] = 'Κατάσταση διακριτικoύ';
...
$string['viewbadge'] = 'Εμφάνιση διακριτικoύ που εκδόθηκε';
