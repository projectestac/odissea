...
$string['attachment_help'] = 'Αν ενεργοποιηθεί, στο μήνυμα ηλε.ταχυδρομείου προς τον αποδέκτη, θα επισυναφθεί για λήψη, ένα αρχείο του εκδοθέντος διακριτικoύ. (Για να χρησιμοποιήσετε αυτή την επιλογή θα πρέπει να είναι ενεργοποιημένα τα συνημμένα στις «Ρυθμίσεις εμφάνισης ηλε.ταχυδρομείου» στη Διαχείριση ιστοτόπου / Εξυπηρετητής / Ηλε.ταχυδρομείο / Ρυθμίσεις εξερχόμενων μηνυμάτων ηλε.ταχυδρομείου.)';
...
$string['backpackavailability'] = 'Εξωτερική επαλήθευση διακριτικoύ';
...
$string['contact_help'] = 'Μια διεύθυνση ηλε.ταχυδρομείου συνδεδεμένη με τον εκδότη του διακριτικoύ';
