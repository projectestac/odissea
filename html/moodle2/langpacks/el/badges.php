...
$string['attachment_help'] = 'Αν ενεργοποιηθεί, στο μήνυμα ηλεκτρονικού ταχυδρομείου προς τον αποδέκτη, θα επισυναφθεί για λήψη, ένα αρχείο του εκδοθέντος διακριτικoύ. (Για να χρησιμοποιήσετε αυτή την επιλογή θα πρέπει να είναι ενεργοποιημένα τα συνημμένα στη Διαχείριση ιστοτόπου > Πρόσθετα > Εκροές μηνυμάτων > Ηλεκτρονικό ταχυδρομείο.)';
...
$string['backpackbadges'] = 'Έχετε {$a->totalbadges} διακριτικό(α) που εμφανίζονται από {$a->totalcollections} συλλογές. <a href="mybackpack.php">Αλλαγή ρυθμίσεων σακιδίου</a>.';
...
$string['backpackemailverifyemailbody'] = 'Γεια σας, μια νέα σύνδεση στο σακίδιο σας (με διακριτικά) στο OpenBadges ζητήθηκε από τον ιστότοπο \'{$a->sitename}\' με χρήση της διεύθυνσής σας ηλ.ταχυδρομείου.
Για να επιβεβαιώσετε και να ενεργοποιήσετε την σύνδεση στο σακίδιό σας, παρακαλούμε πηγαίνετε στο {$a->link}. Στα περισσότερα προγράμματα ηλ.ταχυδρομείου, αυτό θα εμφανιστεί ως ένας μπλε σύνδεσμος στον οποίο μπορείτε απλώς να κάνετε κλικ. Αν αυτό δεν λειτουργήσει, τότε μπορείτε να κάνετε αποκοπή κι επικόλληση της διεύθυνσης στην γραμμή διευθύνσεων στο πάνω μέρος του περιηγητή ιστού σας. Αν χρειάζεστε βοήθεια, παρακαλούμε επικοινωνήστε με τον διαχειριστή του ιστοτόπου, {$a->admin}';
$string['backpackemailverifyemailsubject'] = '{$a}: επιβεβαίωση διεύθυνσης ηλ.ταχυδρομείου από την υπηρεσία Σακιδίου από την OpenBadges';
...
$string['error:backpackemailnotfound'] = 'Η διεύθυνση ηλ.ταχυδρομείου \'{$a}\' δεν είναι συνδεδεμένη με ένα σακίδιο (με διακριτικά). Πρέπει να <a href="http://backpack.openbadges.org">δημιουργήσετε ένα σακίδιο (με τα διακριτικά) σας</a> για αυτό τον λογαριασμό ή να συνδεθείτε με άλλη διεύθυνση ηλ.ταχυδρομείου.';
...
$string['error:invalidbadgeurl'] = 'Άκυρος μορφότυπος διεύθυνσης URL εκδότη διακριτικού.';
...
$string['error:parameter'] = 'Προειδοποίηση: Τουλάχιστον μία παράμετρος πρέπει να επιλεγεί για να εξασφαλιστεί σωστή ροή λειτουργίας της έκδοσης διακριτικών.';
...
$string['messagebody'] = '<p>Σας έχει απονεμηθεί το διακριτικό "%badgename%"!</p> <p>Περισσότερες πληροφορίες για αυτό το διακριτικό μπορούν να βρεθούν στην %badgelink% σελίδα πληροφοριών διακριτικού.</p> <p>Μπορείτε να διαχειριστείτε και να κάνετε λήψη του διακριτικού από την {$a} σελίδα σας.</p>';
...
$string['nobackpackcollections'] = 'Δεν επιλέχθηκαν καθόλου συλλογές διακριτικών.  <a href="mybackpack.php">Προσθέστε συλλογές</a>.';
...
$string['viewbadge'] = 'Προβολή διακριτικoύ που εκδόθηκε';
