...
$string['errorprocessingresponses'] = 'Ocorreu um erro enquanto processava as suas respostas ({$a}). Clique em continuar para retornar à página em que você estava e tente novamente.';
