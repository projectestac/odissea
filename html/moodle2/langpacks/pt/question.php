...
$string['deletequestionscheck'] = '<p>Tem a certeza absoluta de que pretende apagar as seguintes perguntas?<br /><br />{$a}';
...
$string['movingcategoryandfiles'] = 'Tem a certeza que pretende mover a categoria {$a->name} e todas as categorias filhas para o contexto "{$a->contexto}"?<br /> Foram encontrados {$a->urlcount} ficheiros ligados a perguntas em {$a->fromareaname}; quer copiar ou mover esses ficheiros para {$a->toareaname}?';
$string['movingcategorynofiles'] = 'Tem a certeza que pretende mover a categoria "{$a->name}" e todas as  categorias filhas para o contexto de "{$a->contexto}"?';
...
$string['notenoughdatatomovequestions'] = 'Tem que indicar os códigos das perguntas que pretende mover.';
...
$string['technicalinforesponsesummary'] = 'Sumário da resposta: {$a}';
