...
/**
 * Strings for component 'quiz', language 'pt', branch 'MOODLE_36_STABLE'
 *
 * @package   quiz
...
Esta configuração afeta apenas as perguntas e os comportamentos das perguntas (como por exemplo: Feedback imediato ou Interativo com múltiplas tentativas) que permitem ao aluno finalizar a pergunta antes de submeter a tentativa.';
...
$string['emailoverduesubject'] = 'Data limite ultrapassada: {$a->quizname}';
$string['empty'] = 'Vazio';
...
$string['messageprovider:attempt_overdue'] = 'Aviso quando as tentativas do teste estão a atingir a data limite';
...
$string['overduemustbesubmittedby'] = 'Esta tentativa excedeu a data limite. Já devia ter submetido a mesma. Se pretende ter avaliação nesta tentativa, deve submetê-la até {$a}. Se não submeter até lá, não irá obter nota para esta tentativa.';
...
$string['quiz:emailwarnoverdue'] = 'Obter uma notificação quando uma tentativa ultrapassou a data limite e tem de ser submetida.';
...
$string['stateoverdue'] = 'Data limite ultrapassada';
