...
$string['completeregistration'] = 'Registo completo em Moodle.net';
...
$string['courseunpublished'] = 'A disciplina {$a->courseshortname} já não está partilhada em {$a->hubname}.';
$string['courseurl'] = 'URL da disciplina';
$string['courseurl_help'] = 'URL da disciplina que é apresentado como uma hiperligação nos resultados das pesquisas.';
...
$string['description_help'] = 'Esta descrição será apresentada na lista de disciplinas em Moodle.net.';
$string['detectednotexistingpublication'] = '{$a->hubname} está a mostrar uma disciplina que já não existe. Informe o administrador de {$a->hubname} que a publicação número {$a->id} deve ser apagada.';
...
$string['errorcourseinfo'] = 'Ocorreu um erro ao obter meta-informação da disciplina de ({$a}). Por favor, repita a operação mais tarde: volte a aceder a esta página ou atualize/recarregue a página. Em alternativa, pode optar por continuar o seu registo com a meta-informação predefinida seguinte.';
...
$string['existingscreenshotnumber'] = '{$a} imagens disponíveis. Apenas poderá consultar estas imagens quando o administrador de Moodle.net disponibilizar esta disciplina';
...
$string['mobileservicesenabled'] = 'Serviços móveis ativados ({$a})';
...
$string['notregisteredonhub'] = 'O administrador terá que registar este site em Moodle.net para que possa partilhar uma disciplina. Contacte o administrador do site.';
...
$string['publish'] = 'Partilhar disciplina';
$string['publishcourse'] = 'Partilhar {$a}';
$string['publishcourseon'] = 'Partilhar em {$a}';
$string['publishedon'] = 'Partilha de disciplinas';
...
$string['removefromhub'] = 'Remover de Moodle.net';
...
$string['selecthubinfo'] = 'Um hub de comunidade é um servidor que disponibiliza listas de disciplinas. Só é possível partilhar disciplinas num hub se o site estiver registado nesse hub. Se o hub onde pretende fazer o registo não está na lista contacte o administrador do site.';
...
$string['sendingsize'] = 'Por favor, aguarde enquanto o ficheiro da disciplina é enviado ({$a->total}Mb)…';
...
$string['shared'] = 'Disponível para descarregar';
...
$string['unpublish'] = 'Terminar partilha';
$string['unpublishalladvertisedcourses'] = 'Remover todas as disciplinas disponíveis para inscrição que estavam a ser partilhadas em Moodle.net';
$string['unpublishalluploadedcourses'] = 'Remover todas as disciplinas disponíveis para descarregar que estavam a ser partilhadas em Moodle.net';
$string['unpublishconfirmation'] = 'Tem a certeza de que pretende apagar a disciplina "{$a->courseshortname}" de "{$a->hubname}"?';
...
$string['xmlrpcdisabledpublish'] = 'Não é possível partilhar nem gerir disciplinas partilhadas porque a extensão XML-RPC do PHP não está instalada ou não está ativa no servidor.';
