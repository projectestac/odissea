...
$string['advertisepublication_help'] = 'Esta disciplina será listada no Moodle.net como uma disciplina em que as pessoas podem inscrever-se e participar. O autoregisto baseado em email deve ser ativado no site e é necessário ativar a auto-inscrição nesta disciplina.';
$string['all'] = 'Todo(a)s';
...
$string['errorcoursewronglypublished'] = 'Moodle.net reportou um erro de publicação. Por favor tente mais tarde.';
...
$string['errorunpublishcourses'] = 'Ocorreu um erro inesperado no processo de remoção da disciplinas de Moodle.net. Por favor tente mais tarde (ação recomendada) ou contacte o administrador de Moodle.net.';
$string['errorws'] = '{$a}';
