...
/**
 * Strings for component 'hub', language 'pt', branch 'MOODLE_32_STABLE'
 *
 * @package   hub
...
$string['siteregistrationcontact_help'] = 'Se ativar esta opção, outras pessoas poderão contactá-lo através de um formulário de contacto disponível no hub. O seu e-mail não será divulgado.';
...
$string['unpublishconfirmation'] = 'Tem a certeza de que pretende apagar a disciplina "{$a->courseshortname}" do hub "{$a->hubname}"?';
