...
$string['journalmail'] = '{$a->teacher} colocou comentário(s) na sua entrada de diário para \'{$a->journal}\'

Pode visualizá-lo anexada à sua entrada de diário:

    {$a->url}';
$string['journalmailhtml'] = '{$a->teacher} colocou comentário(s) na sua entrada de diário para  \'<i>{$a->journal}</i>\'<br /><br />
Pode visualizá-lo anexada à sua <a href="{$a->url}">entrada de diário</a>.';
$string['journal:manageentries'] = 'Gerir entradas de diário';
$string['journalname'] = 'Nome do diário';
$string['journalquestion'] = 'Questão do diário';
