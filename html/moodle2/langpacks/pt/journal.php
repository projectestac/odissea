...
/**
 * Strings for component 'journal', language 'pt', branch 'MOODLE_36_STABLE'
 *
 * @package   journal
...
$string['journalmail'] = '{$a->teacher} publicou um comentário na sua entrada de diário em \'{$a->journal}\'

Pode visualizá-lo anexado à sua entrada de diário:

    {$a->url}';
$string['journalmailhtml'] = '{$a->teacher} publicou um comentário na sua entrada de diário em \'<i>{$a->journal}</i>\'<br /><br />
Pode visualizá-lo anexado à sua <a href="{$a->url}">entrada de diário</a>.';
$string['journal:manageentries'] = 'Gerir entradas de diário';
...
$string['viewallentries'] = 'Visualizar {$a} entradas de diário';
