...
/**
 * Strings for component 'simplecertificate', language 'pt', branch 'MOODLE_26_STABLE'
 *
...
$string['openwindow'] = 'Clique no botão para abrir o seu certificado numa nova janela do navegador.';
