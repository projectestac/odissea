...
$string['privacy:metadata:mnet_external:currentlogin'] = 'A autenticação atual para este utilizador.';
...
$string['privacy:metadata:mnet_external:emailstop'] = 'Uma preferência para parar o envio de emails ao utilizador.';
...
$string['privacy:metadata:mnet_external:idnumber'] = 'Um número de identificação dado pela instituição.';
...
$string['privacy:metadata:mnet_external:lastaccess'] = 'A data em que o utilizaodr acedeu pela última vez.';
...
$string['privacy:metadata:mnet_external:maildigest'] = 'A configuração para o envio de emails automáticos para este utilizador.';
$string['privacy:metadata:mnet_external:maildisplay'] = 'A preferência para o utilizador sobre a exibição do seu email para outros utilizadores.';
...
$string['privacy:metadata:mnet_external:skype'] = 'O identificador de Skype para este utilizador.';
$string['privacy:metadata:mnet_external:suspended'] = 'A marca para exibir se o utilizador foi suspenso deste sistema.';
$string['privacy:metadata:mnet_external:timezone'] = 'O fuso horário em que o utilizador reside.';
...
$string['privacy:metadata:mnet_log:course'] = 'O ID do sistema remoto da disciplina onde a ação ocorreu.';
$string['privacy:metadata:mnet_log:coursename'] = 'O nome completo do sistema remoto da disciplina onde a ação ocorreu.';
$string['privacy:metadata:mnet_log:hostid'] = 'O ID MNet do sistema remoto';
$string['privacy:metadata:mnet_log:info'] = 'Informação adicional sobre a ação.';
$string['privacy:metadata:mnet_log:ip'] = 'O endereço de IP utilizado na altura em que a ação ocorreu.';
$string['privacy:metadata:mnet_log:module'] = 'O módulo do sistema remoto onde o evento ocorreu.';
$string['privacy:metadata:mnet_log:remoteid'] = 'O ID remoto do utilizador que levou a cabo a ação no sistema remoto.';
