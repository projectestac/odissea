...
$string['reopenplanconfirm'] = 'Deseja reabrir o plano de aprendizagem \'{$a}\'? Neste caso, o estado das competências dos utilizadores que foi registado no momento em que o plano foi concluído anteriormente será apagado, e o plano voltará a estar ativo.';
...
$string['totalrequiredtocomplete'] = 'Total necessário para completar';
$string['unlinkcompetencycourse'] = 'Deseja desassociar a competência \'{$a}\' da disciplina?';
$string['unlinkcompetencyplan'] = 'Deseja desassociar a competência \'{$a}\' do plano de aprendizagem?';
$string['unlinkcompetencytemplate'] = 'Deseja desassociar a competência \'{$a}\' do modelo de plano de aprendizagem?';
...
$string['unlinkplantemplateconfirm'] = 'Deseja desassociar o plano de aprendizagem \'{$a}\' do seu modelo? Qualquer alteração efetuada ao modelo deixará de ser aplicada ao plano de aprendizagem. Esta ação é irreversível.';
