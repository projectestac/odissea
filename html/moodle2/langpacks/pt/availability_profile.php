...
/**
 * Strings for component 'availability_profile', language 'pt', branch 'MOODLE_36_STABLE'
 *
...
$string['requires_isempty'] = 'O campo <strong>{$a->field}</strong> está vazio';
$string['requires_isequalto'] = 'O campo <strong>{$a->field}</strong> é igual a <strong>{$a->value}</strong>';
$string['requires_isnotempty'] = 'O campo <strong>{$a->field}</strong> não está vazio';
$string['requires_notendswith'] = 'O campo <strong>{$a->field}</strong> não termina com <strong>{$a->value}</strong>';
