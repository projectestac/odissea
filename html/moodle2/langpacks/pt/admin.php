...
/**
 * Strings for component 'admin', language 'pt', branch 'MOODLE_28_STABLE'
 *
 * @package   admin
...
$string['configautologinguests'] = 'Pretende que utilizadores não autenticados que acedam a disciplinas que permitem acesso a visitantes sejam autenticados atomaticamente como tal?';
...
$string['configclamfailureonupload'] = 'Se configurou o Clam para verificar ficheiros, mas ele está configurado incorretamente ou não iniciar por algum motivo, como deve ele proceder? Se optar por "Tratar ficheiros como infetados", eles serão postos na área de quarentena ou apagados. Se escolher "Tratar ficheiros como sem vírus", os ficheiros serão processados normalmente. Em qualquer dos casos os administradores serão notificados da falha do Clam. Se optar por "Tratar ficheiros como infetados", e por algum motivo o Clam não iniciar (geralmente porque inseriu um pathtoclam inválido), TODOS os ficheiros recebidos serão colocados em quarentena, ou apagados. Tenha cautela com esta definição.';
$string['configcookiehttponly'] = 'Ativa a nova funcionalidade da versão 5.2.0 do PHP: os browsers só podem enviar cookies com pedidos HTTP reais e as cookies não devem ser acessíveis pelas linguagens de script. Esta funcionalidade não é suportada por todos os browsers e poderá não ser totalmente compatível com o código atual. Ajuda a evitar alguns tipos de ataques XSS.';
...
$string['configdoctonewwindow'] = 'Se ativar esta opção, as hiperligações para a documentação do Moodle serão abertos numa nova janela do browser.';
...
$string['configslasharguments'] = 'A utilização dos "slash arguments" (que utilizam <em>PATH_INFO</em>) é necessária para a correta visualização de pacotes SCORM e Recursos com múltiplos ficheiros. Caso o seu browser não suporte "slash arguments", e não consiga configurá-lo, poderá desativar este parâmetro, embora vá fazer com que algumas coisas não funcionem. <br />Nota: A utilização de "slash arguments" será necessária em futuras versões do Moodle.';
...
$string['configtimezone'] = 'Fuso horário predefinido usado para mostrar datas - cada utilizador poderá alterar o seu fuso horário na configuração do seu perfil. Se selecionar "Hora local do servidor" o Moodle utilizará as definições do sistema operativo do servidor, contudo, o valor "Hora local do Servidor" nos perfis dos utilizadores fará com que seja utilizado o valor definido nesta configuração. Recomenda-se que atualize os fusos horários e depois selecione um fuso horário específico para a sua região.';
...
$string['emoticonsreset'] = 'Clique nesta hiperligação para repor as configurações originais dos emoticons';
...
$string['logstorenotrequired'] = 'Não é necessária a unidade de armazenamento de registos';
$string['logstoressupported'] = 'Unidades de armazenamento de registos que suportam este relatório';
...
$string['mypage'] = 'Valores predefinidos da \'Minha página principal\'';
...
$string['navexpandmycourses'] = 'Mostrar \'As minhas disciplinas\' expandidas na \'Minha página principal\'';
$string['navexpandmycourses_desc'] = 'Se ativar esta opção, \'As minhas disciplinas\' são inicialmente exibidas de forma expandida no bloco Navegação na \'Minha página principal\'.';
...
$string['taskbackupcleanup'] = 'Limpar tabelas de cópias de segurança e registos';
...
$string['taskplagiarismcron'] = 'A processar módulos de antiplágio...';
...
$string['tasksendfailedloginnotifications'] = 'Enviar notificações de tentativas de login falhadas';
