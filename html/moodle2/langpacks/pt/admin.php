...
$string['configallowblockstodock'] = 'Se ativar estaopção e for permitido pelo tema selecionado, os utilizadores podem mover blocos para uma consola especial.';
...
$string['searchallavailablecourses_desc'] = 'Em algumas situações, o mecanismo de busca pode não funcionar ao pesquisar num grande número de disciplinas. Defina para pesquisar apenas as disciplinas inscritas se precisar de restringir o número de disciplinas a pesquisar.';
...
$string['tokenduration_desc'] = 'Período de tempo durante o qual um token de web services criado por um utilizador (por exemplo, via aplicação móvel) é válido.';
