...
/**
 * Strings for component 'admin', language 'pt', branch 'MOODLE_31_STABLE'
 *
 * @package   admin
...
$string['availablesearchareas'] = 'Áreas disponíveis para pesquisa global';
...
$string['blockeditingmenu_desc'] = 'Se ativar esta opção, quando o modo de edição está ativo, muitos dos ícones de edição dos blocos serão exibidos num menu de seleção. Isto reduz o conteúdo no ecrã, pois os ícones só serão mostrados quando necessários.';
...
$string['configallowcategorythemes'] = 'Se ativar esta opção, será possível escolher um tema para uma categoria. Esse tema será usado em todas as disciplinas da categoria e das respetivas subcategorias, a menos que tenham definido o seu próprio tema. ATENÇÃO: O uso de temas para as categorias pode prejudicar o desempenho.';
...
$string['modeditingmenu_desc'] = 'Se ativar esta opção, quando o modo de edição está ativo na página da disciplina, muitos dos ícones de edição de atividade serão exibidos num menu de seleção. Isto reduz o conteúdo no ecrã, pois os ícones só serão mostrados quando necessários.';
...
$string['navexpandmycourses'] = 'Mostrar \'As minhas disciplinas\' expandidas no Painel do utilizador';
$string['navexpandmycourses_desc'] = 'Se ativar esta opção, \'As minhas disciplinas\' são inicialmente exibidas de forma expandida no bloco Navegação no Painel do utilizador.';
...
$string['pathtogs_help'] = 'Na maioria das instalações Linux, isto pode ficar definido como  \'/usr/bin/gs\'. Em Windows será algo como \'c:gsbingswin32c.exe\' (certifique-se de que não existem espaços no caminho - se necessário, copie os ficheiros \'gswin32c.exe\' e \'gsdll32.dll\' para uma nova pasta sem espaços no caminho).';
