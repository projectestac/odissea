...
/**
 * Strings for component 'admin', language 'pt', branch 'MOODLE_34_STABLE'
 *
 * @package   admin
...
$string['ageofdigitalconsentmap_desc'] = 'Valor predefinido da idade mínima de consentimento, e a idade de qualquer país em que esta difere do padrão, pode ser especificada aqui. Digite cada idade numa nova linha com formato: código do país, idade (separada por uma vírgula). A idade padrão é indicada com * no lugar do código do país. Os códigos de país são os especificados na ISO 3166-2.';
...
$string['allowguestmymoodle'] = 'Permitir o acesso de visitantes ao Painel do utilizador';
$string['allowindexing'] = 'Permitir indexação pelos motores de busca';
$string['allowindexing_desc'] = 'Esta opção determina se os motores de busca podem indexar o seu site. "Todo o site" permitirá que os motores de busca pesquisem em todas as páginas, incluindo as de entrada e registo, o que significa que os sites com a opção "Forçar autenticação" ativada são igualmente indexados. Para evitar o risco de spam envolvido com a página de entrada ser pesquisável, use "Todo o site, exceto autenticação". "Não indexar" indicará aos motores de busca que não indexem nenhuma página. Tenha em atenção que esta é apenas uma tag no cabeçalho do site. Cabe ao mecanismo de pesquisa respeitar a tag ou  não.';
$string['allowindexingeverywhere'] = 'Em todas as páginas';
$string['allowindexingexceptlogin'] = 'Em todas as páginas excepto páginas de entrada e autenticação';
...
$string['configallowedemaildomains'] = 'Liste os domínios de e-mail que podem ser divulgados na secção "De" do e-mail enviado. O valor predefinido de "Vazio" usará o endereço de Não responder (no-reply) para todos os e-mails enviados. O uso de caracteres especiais é permitido, por exemplo, *.example.com permitirá os e-mails enviados de qualquer subdomínio de example.com, mas não de example.com propriamente dito. Para esta última será necessária uma entrada em separado.';
...
$string['configcourseswithsummarieslimit'] = 'Número máximo de disciplinas com resumo a exibir numa lista de disciplinas. A partir deste número será exibida uma lista simples, sem resumos.';
$string['configcronclionly'] = 'Executar o cron através do navegador web pode expor informação importante a utilizadores anónimos. Portanto recomenda-se a execução do cron apenas a partir da linha de comandos ou a definição de uma senha do cron para acesso remoto.';
...
$string['configdbsessions'] = 'Se ativar esta opção, a base de dados será usada para guardar a informação sobre as sessões abertas. Note que, alterando esta definição irá encerrar todas as sessões de todos os utilizadores (incluindo a sua). Se estiver a utilizar MySQL, certifique-se de que o parâmetro "max_allowed_packet" em my.cnf (ou my.ini) é 4M ou maior. Outros parâmetros podem ser configurados diretamente em config.php. Ver config-dist.php para saber mais. Esta opção desaparece se especificar "session driver" no ficheiro config.php.';
...
$string['configdebugpageinfo'] = 'Se ativar esta opção surgirá informação da página no rodapé.';
...
$string['configdisplayloginfailures'] = 'Isto irá exibir informação aos utilizadores sobre as tentativas de autenticação falhadas.';
...
$string['configemailfromvia'] = 'Adicione informações na secção "De" do e-mail de saída. Isto informa o destinatário da origem do e-mail e ajuda também a evitar que os destinatários respondam acidentalmente a endereços de e-mail \'no-reply\'.';
$string['configenableactivitychooser'] = 'A seleção rápida é uma caixa de diálogo com uma breve descrição de cada atividade e recurso. Se desativar esta opção, em vez da caixa de diálogo serão exibidas listas pendentes em separado para os recursos e atividades.';
...
$string['configextendedusernamechars'] = 'Se ativar esta opção os utilizadores poderão utilizar quaisquer caracteres nos seus nomes de utilizador (note que esta opção não afeta os seus nomes de utilizador atuais). Esta opção está desativada por predefinição, para limitar os caracteres nos nomes de utilizador a caracteres alfanuméricos em minúsculas, traço de sublinhado (_), hífen (-), ponto (.) e a arroba (@).';
...
$string['configfilterall'] = 'Se ativar esta opção serão filtrados todos os textos, incluindo cabeçalhos, títulos, barra de navegação e outros. É muito útil quando se utiliza o filtro multilingue, caso contrário apenas criará carga extra no seu site com vantagens pouco significativas.';
...
$string['configgeoipfile'] = 'Localização do ficheiro binário de dados do GeoLite2 City. Este ficheiro não faz parte da distribuição do Moodle e deverá ser obtido separadamente em <a href="http://www.maxmind.com/">MaxMind</a>.<br />É possível comprar uma versão comercial ou utilizar a versão gratuita. Pode descarregar o ficheiro em <a href="http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz" >http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz</a> e extraí-lo para a diretoria "{$a}" no seu servidor.';
...
$string['configprotectusernames'] = 'Se ativar esta opção, a página de recuperação de senha não mostra nenhuma pista que possibilite saber se o nome de utilizador ou o endereço de e-mail existem no site.';
...
$string['configsessioncookiepath'] = 'Se precisar de alterar para onde os navegadores enviam os cookies do Moodle, pode alterar esta configuração para especificar uma sub-pasta do seu site. Caso contrário, o caminho por predefinição \'/\' servirá.';
...
$string['configtempdatafoldercleanup'] = 'Remove os ficheiros de dados temporários da pasta de dados anteriores ao intervalo de tempo selecionado.';
...
$string['courseswithsummarieslimit'] = 'Número máximo de disciplinas com resumo';
...
$string['debugstringids_desc'] = 'Se ativar esta opção, será exibida a componente e identificador de cada string exibida se adicionar \'?strings=1\' ou \'&strings=1\' ao URL.';
...
$string['environmenterrorupgrade'] = 'Advertência: deve resolver todos os problemas de ambiente (erros) detetados, antes de atualizar para esta versão do Moodle! Continuar a atualização sem resolver esses problemas, poderá ter consequências, como por exemplo a perda de dados. Tem a certeza que pretende continuar com a atualização?';
...
$string['indexdata'] = 'Dados de índice';
...
$string['linkcoursesections_help'] = 'Tentar sempre fornecer uma interligação entre as secções da disciplina. As secções das disciplinas são habitualmente visualizadas apenas como hiperligações caso o formato da disciplina esteja definido para apresentar apenas uma secção por página. Se esta opção estiver ativa, será sempre disponibilizada uma hiperligação.';
...
$string['lockoutwindow_desc'] = 'Tempo de observação para o limite de bloqueio. O contador de tentativas falhadas será reiniciado após este período, caso não hajam tentativas de autenticação falhadas.';
...
$string['navadduserpostslinks_help'] = 'Se ativar esta opção, serão adicionadas duas hiperligações a cada utilizador na navegação para ver os tópicos que o utilizador iniciou e as mensagens que submeteu em fóruns em todo o site ou em disciplinas específicas.';
...
$string['navshowfullcoursenames_help'] = 'Se ativar esta opção, o nome completo das disciplinas será usado no bloco Navegação em vez do nome curto.';
...
$string['nohttpsformobilewarning'] = 'É recomendado que ative a utilização do protocolo HTTPS com um certificado válido. A aplicação Moodle para dispositivos móveis tentará sempre usar a ligação segura em primeiro lugar.';
...
$string['noreplydomaindetail'] = 'Configurações para endereços Não responder e domínios configurados';
...
$string['oauthrefreshtokenexpired'] = 'O token de atualização para um dos serviços OAuth {$a->issuer} no seu site {$a->siteurl} expirou. Isto limitará a funcionalidade de qualquer módulo que use este serviço. Para corrigir este problema, visite a página de configuração dos Serviços OAuth 2 e clique no ícone "Ligar conta do sistema" na linha da tabela para este serviço. Não se esqueça de autenticar-se cada vez com a mesma conta de serviço para o sistema OAuth.';
$string['oauthrefreshtokenexpiredshort'] = 'O token de atualização do OAuth {$a->issuer} no seu site {$a->siteurl} expirou.';
$string['onlynoreply'] = 'Apenas a partir de um endereço Não responder';
...
$string['passwordchangelogout'] = 'Terminar a sessão após a alteração da senha';
...
$string['passwordchangetokendeletion'] = 'Remover o acesso ao web service por token após alteração da senha';
...
$string['passwordreuselimit_desc'] = 'Número de vezes que um utilizador necessita de alterar a senha antes de ser permitida a sua reutilização. As hashes das senhas utilizadas anteriormente são armazenadas numa base de dados local. Esta opção poderá não ser compatível com alguns plugins externos de autenticação';
$string['pathtodot'] = 'Caminho para o programa <strong>dot</strong>';
$string['pathtodot_help'] = 'Caminho para o programa <strong>dot</strong>. Em Linux é algo como /usr/bin/dot. Em Windows é algo como C:\\Program Files (x86)\\Graphviz2.38\\bin\\dot.exe. Em Mac é algo como /opt/local/bin/dot. Para ser possível gerar gráficos a partir de ficheiros DOT é necessário que este programa esteja instalado no servidor e o respetivo ficheiro executável do programa. deve ser indicado aqui.';
...
$string['recaptchapublickey'] = 'Chave do site ReCAPTCHA';
...
$string['registration_help'] = 'É recomendável que registe o seu site em Moodle.org para que receba notificações e alertas de segurança, e poder aceder à nossa comunidade Moodle.';
...
$string['searchallavailablecourses_desc'] = 'Em algumas situações, o mecanismo de busca pode não funcionar ao pesquisar num grande número de disciplinas. Defina para pesquisar apenas as disciplinas inscritas se precisar restringir o número de disciplinas a pesquisar.';
...
$string['searchindexwhendisabled_desc'] = 'Permite que a tarefa agendada crie o índice de pesquisa mesmo quando a pesquisa está desativada. Isso é útil se pretende criar o índice antes que a funcionalidade de pesquisa apareça para os alunos.';
$string['searchinsettings'] = 'Pesquisar nas configurações';
$string['searchlastrun'] = 'Última execução (tempo, # documentos, # registos, # ignorar)';
...
$string['searchreindexindex'] = 'Voltar a indexar todos os conteúdos do site';
...
$string['soaprecommended'] = 'A instalação da extensão opcional SOAP é útil para serviços web e alguns módulos.';
...
$string['taskanalyticscleanup'] = 'Limpeza da análise';
...
$string['taskgradecron'] = 'A processar a Pauta...';
$string['tasklegacycron'] = 'Cron de retrocompatibilidade a processar módulos...';
$string['taskmessagingcleanup'] = 'A processar mensagens...';
...
$string['taskportfoliocron'] = 'A processar módulos de portfólio...';
...
$string['taskstatscron'] = 'A processar estatísticas...';
$string['tasktagcron'] = 'A processar palavras-chave...';
...
$string['tlswarning'] = 'Não foi detetada nenhuma extensão PHP/cURL com suporte TLSv1.2. Alguns serviços poderão não funcionar. É altamente recomendada a atualização das suas bibliotecas TLS.';
$string['tokenduration'] = 'Duração do token criado pelo utilizador';
$string['tokenduration_desc'] = 'Tempo durante o qual o token criado pelo utilizador é válido nos serviços web  (via aplicação móvel, por exemplo).';
...
$string['unsupporteddbfileformat'] = 'A sua base de dados utiliza o formato de ficheiro Antelope. O suporte total ao UTF-8 no MySQL e MariaDB requer o formato de ficheiro Barracuda. Por favor, converta as tabelas para o formato de ficheiro Barracuda. Para mais detalhes, consulte a documentação sobre <a href="https://docs.moodle.org/en/admin/environment/custom check/mysql full unicode support">suporte total ao unicode no MySQL</a>.';
...
$string['unsupporteddbtablerowformat'] = 'A sua base de dados possui tabelas que usam o formato de ficheiro Antelope. É recomendável que converta as tabelas para o formato de ficheiro Barracuda. Para mais informações acerca de ferramentas de conversão de tabelas InnoDB para Barracuda, consulte a documentação <a href="https://docs.moodle.org/en/cli">Administration via command line</a>.';
...
$string['updateavailablerecommendation'] = 'É altamente recomendável que atualize o seu site para a versão mais recente para resolver todas as falhas de segurança.';
...
$string['userbulkdownload'] = 'Exportar utilizadores como';
...
$string['xmlrpcrecommended'] = 'A extensão XMLRPC é útil para serviços web e redes Moodle';
