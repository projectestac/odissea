...
$string['configcookiesecure'] = 'Se o servidor apenas usa ligações HTTPS, recomenda-se a utilização de cookies seguras. Ao ativar, verifique que o servidor não está a aceitar pedidos http:// nem existe redireccionamento permanente para endereços HTTPS. Quando o endereço <em>wwwroot</em> (definido no ficheiro config.php) não começa por https:// esta configuração é desativada automaticamente.';
...
$string['configdoctonewwindow'] = 'Se ativar esta opção, as hiperligações para a documentação do Moodle serão abertos numa nova janela do navegador.';
...
$string['configenablesafebrowserintegration'] = 'Adicionar a opção \'Forçar Safe Exam Browser\' ao campo \'Segurança de navegador no formulário de configurações do teste. Para mais informações, consultar a página <a href="http://www.safeexambrowser.org/" target="_blank">http://www.safeexambrowser.org/</a>';
...
$string['configshowcommentscount'] = 'Mostrar número total de comentários. Tem como desvantagem a necessidade de uma ligação adicional à base de dados quando mostra a hiperligação dos comentários.';
...
$string['configusesitenameforsitepages'] = 'Se ativar esta opção, o nome curto do site será utilizado para a hiperligação para as Páginas do site, na barra de navegação em vez de \'Páginas do site\'';
...
$string['courseswithsummarieslimit'] = 'N.º limite de Disciplinas com resumo';
...
$string['linkadmincategories_help'] = 'Se ativar esta opção, as categorias de configuração de administração do site serão exibidas como hiperligações na navegação.';
