...
/**
 * Strings for component 'admin', language 'pt', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['configcourseoverviewfileslimit'] = 'Número máximo de ficheiros que podem ser mostrados junto da descrição da disciplina, na página da lista de disciplinas. O primeiro ficheiro de imagem adicionado é usado como a imagem da disciplina na vista geral da disciplina no Painel do utilizador; quaisquer ficheiros adicionais são mostrados apenas na página de lista de disciplinas.';
...
-Suporte Moodle|https://moodle.org/support
-Documentação Moodle|https://docs.moodle.org|Moodle Docs
-Documentação Moodle em Alemão|https://docs.moodle.org/de|Documentação em Alemão|de
-###
...
$string['configfullnamedisplay'] = 'Forma como os nomes completos são mostrados. Na generalidade dos sites a forma mais comum é "nome + apelido", mas é possível ocultar o apelido ou mostrar de acordo com o critério definido no pacote linguístico do idioma que estiver a ser usado (alguns idiomas têm convenções diferentes).
...
Podem se usudos os seguintes espaços reservados: firstname, lastname, firstnamephonetic, lastnamephonetic, middlename, e alternatename.';
...
$string['confirmcontextlock'] = '\'{$a->contextname}\' está atualmente desbloqueado. O bloqueio fará com que seja só de leitura e impede que os utilizadores façam alterações. Tem a certeza de que pretende continuar?';
$string['confirmcontextunlock'] = '{$a->contextname} está atualmente bloqueado. O desbloqueio permitirá aos utilizadores fazerem alterações. Tem a certeza de que pretende continuar?';
$string['confirmdeletecomments'] = 'Tem a certeza de que pretende apagar comentários?';
$string['confirmed'] = 'Confirmado';
$string['contextlockappliestoadmin'] = 'O bloqueio de contextos aplica-se a administradores';
...
Na maioria dos programas de e-mail, isto deverá aparecer como uma hiperligação azul na qual poderá clicar. Se isto não acontecer, então copie e cole o endereço na barra de endereços que se encontra no topo do seu navegador.
...
$string['moodleapp_help'] = '<p>Se tem uma conta num site Moodle, pode aceder a todas as suas disciplinas nos seus dispositivos móveis com a Aplicação móvel Moodle.</p>
<a href="https://moodle.com/mobile-app">Obter a Aplicação móvel Moodle</a>';
...
$string['registermoodlenet'] = '<p>Gostaríamos muito de ficar em contacto para lhe disponibilizar coisas importantes para o seu site Moodle!</p><p>Ao registar o seu site:</p><ul><li>Pode subscrever-se para receber notificações de novos lançamentos do Moodle, alertas de segurança e outras notícias importantes.</li><li>Pode aceder e ativar o envio de notificações móveis a partir do seu site através da <a href="https://download.moodle.org/mobile/">Aplicação móvel Moodle</a> gratuita.</li><li>Está a contribuir para as nossas <a href="https://moodle.net/stats/">estatísticas Moodle</a> da comunidade mundial, que nos ajudam a melhorar o Moodle e os sites da nossa comunidade.</li><li>Se desejar, o seu site pode ser incluído na <a href="https://moodle.net/sites/">lista de sites Moodle registados</a> no seu país.</li></ul>';
...
$string['sessioncookiepath'] = 'Caminho para o cookie';
...
$string['sixtyfourbitswarning'] = 'Foi detetado que seu site não está a usar uma versão do PHP de 64 bits. É recomendável que atualize o seu site para garantir compatibilidade futura.';
...
$string['unsupporteddbtablerowformat'] = 'Na sua base de dados existem tabelas que usam o formato de ficheiro Antelope. É recomendável que converta as tabelas para o formato de ficheiro Barracuda. Para mais informações acerca de ferramentas de conversão de tabelas InnoDB para Barracuda, consulte a documentação sobre <a href="https://docs.moodle.org/en/cli">Administração via linha de comandos</a>.';
