...
$string['configcustomusermenuitems'] = 'Pode configurar os conteúdos do menu do utilizador (exceto o link de terminar sessão, que é automaticamente adicionado). Cada linha é separada pelo carácter \'|\' e consiste em 1) uma string no formato "langstringname, componentname" ou como texto simples, 2) um URL, e 3) um ícone, seja em píxeis ou um URL. Os separadores podem ser usados através da adição de uma linha de um ou mais caracteres \'#\' onde desejado.';
...
$string['configdndallowtextandlinks'] = 'Permite que, em simultâneo com a possibildiade de arrastar e largar ficheiros para uma página de disciplina, possa arrastar e largar texto e links. Note que arrastar texto para o Firefox, ou entre diferentes navegadores não é fiável, podendo resultar no carregamento de nenhuma informação ou o texto carregado ficar corrompido.';
