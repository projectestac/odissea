...
/**
 * Strings for component 'choicegroup', language 'pt', branch 'MOODLE_32_STABLE'
 *
 * @package   choicegroup
...
$string['choicegroupopen'] = 'Abertura';
$string['choicegroupoptions'] = 'Opções de escolha';
$string['choicegroupoptions_help'] = 'Aqui pode especificar quais os grupos disponíveis para os participantes poderem escolher.
...
$string['expired'] = 'Esta atividade encerrou em {$a} e já não está disponível';
...
$string['systemdefault_date'] = 'Padrão do Sistema (data de criação do grupo)';
