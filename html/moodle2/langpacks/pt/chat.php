...
$string['deletesessionsure'] = 'Tem a certeza que pretende apagar a gravação desta sessão?';
...
$string['sessionstart'] = 'A próxima sessão de chat irá iniciar em {$a->date}, ({$a->fromnow} a partir de agora)';
