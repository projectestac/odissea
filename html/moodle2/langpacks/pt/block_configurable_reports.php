...
/**
 * Strings for component 'block_configurable_reports', language 'pt', branch 'MOODLE_31_STABLE'
 *
...
$string['activitypost'] = 'Submissões na atividade';
...
$string['badtablewidth'] = 'Largura incorreta. Deve ser em % ou valor absoluto';
$string['bar'] = 'Barras';
$string['barsummary'] = 'Gráfico de barras';
$string['blockname'] = 'Relatórios configuráveis';
$string['calcs'] = 'Cálculos';
$string['categories'] = 'Categorias';
$string['categoryfield'] = 'Campo de categoria';
$string['categoryfieldorder'] = 'Ordem do campo de categoria';
$string['ccoursefield'] = 'Condição de campo da disciplina';
$string['cellalign'] = 'Alinhamento da célula';
$string['cellsize'] = 'Dimensão da célula';
$string['cellwrap'] = 'Arranjo de texto da célula';
$string['column'] = 'Coluna';
$string['columnandcellproperties'] = 'Propriedades da coluna e célula';
$string['columncalculations'] = 'Cálculos da coluna';
$string['columns'] = 'Colunas';
$string['comp_calcs'] = 'Cálculos';
$string['custom'] = 'Customizado';
$string['customdateformat'] = 'Formato de data customizado';
$string['customsql'] = 'SQL customizado';
$string['datatables_first'] = 'Primeiro';
$string['datatables_infoempty'] = 'A mostrar de 0 até 0 de 0 entradas';
