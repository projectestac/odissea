...
$string['confirmdeletefilewithhref'] = 'Tem a certeza que pretende apagar este ficheiro? Existem {$a} ligações que usam este ficheiro como origem. Se continuar as ligações serão convertidas em cópias.';
$string['confirmdeletefolder'] = 'Tem a certeza que pretende apagar esta pasta? Todos os ficheiros e subpastas serão removidos.';
...
$string['confirmrenamefile'] = 'Tem a certeza que pretende renomear/mover este ficheiro? Existem {$a} ligações que usam este ficheiro como origem. Se continuar as ligações serão convertidas em cópias.';
$string['confirmrenamefolder'] = 'Tem a certeza que pretende renomear/mover esta pasta? Se continuar os ficheiros ligados a estes serão convertidos em cópias..';
...
$string['folderexists'] = 'Nome da pasta já está a ser usado, por favor use outro nome';
...
$string['openpicker'] = 'Escolher ficheiro...';
