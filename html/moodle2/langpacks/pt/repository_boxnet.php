...
/**
 * Strings for component 'repository_boxnet', language 'pt', branch 'MOODLE_34_STABLE'
 *
...
$string['privacy:metadata:repository_boxnet:query'] = 'Pesquisa de texto do utilizador no repositório box';
