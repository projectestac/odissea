...
$string['docmodifiedon'] = 'Última atualização a {$a}';
...
$string['indexwhendisabledfullnotice'] = 'Atualmente, a indexação não é permitida quando a pesquisa está desativada. Para ativar, por favor, veja a configuração <a href="{$a->url}">searchindexwhendisabled</a>.';
...
$string['runindexertest'] = 'Teste de execução de indexador';
