...
$string['privacy:metadata:assessmentid'] = 'Identificador da avaliação';
$string['privacy:metadata:authorid'] = 'Identificação do autor da submissão';
$string['privacy:metadata:dimensiongrade'] = 'Nota na dimensão da avaliação';
$string['privacy:metadata:dimensionid'] = 'Identificador da dimensão da avaliação';
...
$string['privacy:metadata:reviewerid'] = 'Identificação do utilizador que fornece a avaliação';
...
$string['privacy:metadata:submissionid'] = 'Identificador da submissão';
...
$string['privacy:metadata:userid'] = 'Identificação do utilizador da nota calculada';
...
$string['privacy:metadata:workshopid'] = 'Identificador da atividade workshop';
$string['privacy:metadata:workshopsubmissions'] = 'Contém informação sobre submissões do módulo workshop';
$string['privacy:request:delete:content'] = 'O conteúdo foi apagado a pedido do utilizador.';
