...
$string['calendardue'] = '{$a} está fora de prazo';
...
$string['confirmbatchgradingoperation'] = 'Tem a certeza que pretende {$a->operation} para {$a->count} alunos?';
...
$string['downloadasfolders_help'] = 'Se a submissão do trabalho consistir em mais do que um ficheiro, ao descarregar as submissões, estas vêm guardadas em pastas separadas. Cada submissão é colocada numa pasta separada, sendo mantida a estrutura de quaisquer sub-pastas e os nomes dos ficheiros não serão alterados.';
...
$string['fixrescalednullgradesconfirm'] = 'Tem certeza de que pretende corrigir as notas erradas? Todas as notas afetadas serão removidas. Isto pode afetar os totais da disciplina.';
...
$string['inactiveoverridehelp'] = '* O aluno não se encontra num grupo ou não tem o papel correto para realizar este trabalho';
...
$string['noteam_desc'] = 'Este trabalho requer submissão em grupos. Como não é membro de nenhum grupo não é possível criar uma submissão. Por favor,contacte o seu professor para ser adicionado a um grupo.';
...
$string['overdue'] = '<font color="red">Trabalho entregue com atraso de {$a}</font>';
$string['override'] = 'Exceção';
$string['overridedeletegroupsure'] = 'Tem a certeza que pretende apagar a exceção para o grupo {$a}?';
$string['overridedeleteusersure'] = 'Tem a certeza que pretende apagar a exceção para o utilizador {$a}?';
...
$string['privacy:metadata:assigndownloadasfolders'] = 'Se o utilizador submeter ficheiros múltiplos, devem ser descarregados em pastas';
$string['privacy:metadata:assignfeedbackpluginsummary'] = 'Dados de feedback para o trabalho';
$string['privacy:metadata:assignfilter'] = 'Opções de filtro tais como "Submetido", "Não submetido", "Requer avaliação" e "Prolongar o prazo"';
...
$string['privacy:metadata:assignoverrides'] = 'Armazena informação sobreposta do trabalho';
...
$string['privacy:metadata:userid'] = 'Identificador para o utilizador.';
...
$string['submittedearly'] = 'O trabalho foi submetido \'{$a}\' antes do fim do prazo';
