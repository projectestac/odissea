...
$string['deleterolesure'] = '<p>Tem a certeza que pretende apagar o papel "{$a->name} ({$a->shortname})"?</p><p>Atualmente existem {$a->count} utilizadores atribuídos a esse papel.</p>';
