...
$string['analytics:listinsights'] = 'Mostrar percepções';
...
$string['backup:backuptargethub'] = 'Cópia de segurança para publicar em Moodle.net';
...
$string['community:add'] = 'Use o bloco da comunidade para pesquisar em Moodle.net e localizar disciplinas';
...
$string['confirmroleprevent'] = 'Tem a certeza que pretende remover <strong>{$a->role}</strong> da lista dos papéis permitidos para a capacidade {$a->cap} no contexto {$a->context}?';
$string['confirmroleunprohibit'] = 'Tem a certeza que pretende remover <strong>{$a->role}</strong> da lista dos papéis proibidos para a capacidade {$a->cap} no contexto {$a->context}?';
...
$string['course:ignoreavailabilityrestrictions'] = 'Ignorar restrições de disponibilidade';
...
$string['course:publish'] = 'Publicar uma disciplina';
...
$string['deleterolesure'] = '<p>Tem a certeza que pretende apagar o papel "{$a->name} ({$a->shortname})"?</p><p>Atualmente existem {$a->count} utilizadores atribuídos a este papel.</p>';
...
$string['errorroleshortnametoolong'] = 'O nome curto não pode exceder os 100 carateres';
...
$string['privacy:metadata:role_assignments:userid'] = 'O Id de utilizador';
$string['privacy:metadata:role_capabilities'] = 'Capacidades do papel';
$string['privacy:metadata:role_capabilities:capability'] = 'O nome da capacidade.';
$string['privacy:metadata:role_capabilities:modifierid'] = 'O Id do utilizador que criou ou modificou a capacidade.';
$string['privacy:metadata:role_capabilities:permission'] = 'Permissão para a capacidade: herdar, permitir, impedir, proibir.';
$string['privacy:metadata:role_capabilities:roleid'] = 'O id do papel.';
$string['privacy:metadata:role_capabilities:tableexplanation'] = 'Esta tabela armazena as capacidade e a visão global das capacidade de um papel em particular num contexto particular.';
$string['privacy:metadata:role_capabilities:timemodified'] = 'A data de quando a capacidade foi criada ou modificada.';
...
$string['restore:restoretargethub'] = 'Restaurar disciplinas a partir de ficheiros descarregados de Moodle.net';
...
$string['webservice:managealltokens'] = 'Gerir tokens dos serviço web dos utilizadores';
