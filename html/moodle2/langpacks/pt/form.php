...
/**
 * Strings for component 'form', language 'pt', branch 'MOODLE_31_STABLE'
 *
 * @package   form
...
$string['modstandardels'] = 'Opções gerais de módulo';
$string['month'] = 'Mês';
...
$string['somefieldsrequired'] = 'Os campos assinalados com {$a} são de preenchimento obrigatório.';
$string['time'] = 'tempo';
