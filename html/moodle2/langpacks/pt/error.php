...
$string['categoryidnumbertaken'] = 'Este número de identificação já é usado por outra categoria';
...
$string['csvfewcolumns'] = 'Não existem colunas suficientes, verifique a definição do delimitador';
...
$string['restorechecksumfailed'] = 'Ocorreu um problema com o restauro das informações armazenadas na sua sessão. Verifique os limites da memória do PHP e/ou da base de dados. O processo de restauro foi parado.';
...
$string['storedfilecannotcreatefile'] = 'Não é possível criar ficheiro de pool de ficheiro local. Por favor, verifique as permissões em dataroot e o espaço disponível em disco.';
