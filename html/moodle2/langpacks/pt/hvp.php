...
$string['emailconfirmsmall'] = 'Obrigado por submeter as suas respostas em \'{$a->hvpname}\'';
...
$string['missingcoreversion'] = 'O sistema não conseguiu instalar a componente \'<em>{$a->%component}</em>\' do pacote. É requerida uma versão mais atual do módulo H5P. Neste site está instalada a versão {$a->%current} e é requerida a versão {$a->%required} ou superior. Considere fazer uma atualização e tentar novamente.';
