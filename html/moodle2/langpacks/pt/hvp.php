...
$string['missingcoreversion'] = 'O sistema não conseguiu instalar a componente <em>{$a->%component}</em> do pacote, é requerido um versão mais atual do plugin H5P. Este site encontra-se na versão {$a->%current}, e a versão requerido é a {$a->%required} ou mais. Considere fazer uma atualização e tentar novamente.';
...
$string['missinglibraryfile'] = 'O ficheiro "{$a->%file}" está ausente da biblioteca: "{$a->%name}"';
$string['missinglibraryjson'] = 'Não foi possível encontrar o ficheiro library.json com formato JSON válido para biblioteca {$a->%name}';
$string['missinglibraryproperty'] = 'A propriedade {$a->%property} necessária não foi encontrada em {$a->%library}';
$string['missingmbstring'] = 'A extensão PHP mbstring  não está carregada. H5P precisa dessa extensão para funcionar corretamente';
$string['missingparameters'] = 'Ausência de parâmetros';
$string['missinguploadpermissions'] = 'Note que as bibliotecas podem existir no ficheiro enviado, mas não tem permissão para fazer efetuar o carregamento de novas bibliotecas. Entre em contacto com o administrador do site.';
...
$string['noextension'] = 'O ficheiro enviado não é um pacote HTML5 válido (não tem a extensão de arquivo .h5p).';
...
$string['nopermissiontosaveresult'] = 'Não tem permissão para salvar resultados deste conteúdo.';
...
$string['nounzip'] = 'O ficheiro enviado não é um pacote HTML5 válido (Nós somos incapazes de descompactá-lo)';
...
$string['nowriteaccess'] = 'Ocorreu um problema com o acesso de escrito do servidor. Certifique-se de que seu servidor permite escrever na sua pasta de dados.';
$string['noziparchive'] = 'A sua versão do PHP não suporta ZipArchive.';
$string['oldphpversion'] = 'Sua versão do PHP está desatualizada. H5P requer a versão 5.2 para funcionar corretamente. Recomenda-se a versão 5.6 ou posterior.';
...
$string['onlyupdate'] = 'Atualizar somente bibliotecas existentes';
...
$string['validatingh5pfailed'] = 'Validação do pacote h5p falhou.';
