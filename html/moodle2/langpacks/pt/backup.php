...
$string['configrestorecalendarevents'] = 'Define o valor predefinido para o restauro dos eventos do calendário.';
...
$string['errorfilenametoolong'] = 'O comprimento do nome do ficheiro tem de ser menor que 255 carateres';
...
$string['filereferencesnotsamesite'] = 'O ficheiro de cópia de segurança é de outro site, as referências a ficheiros não podem ser restauradas';
$string['filereferencessamesite'] = 'O ficheiro de cópia de segurança é deste site, as referências a ficheiros podem ser restauradas';
...
$string['privacy:metadata:backup_controllers'] = 'A lista de operações backup';
...
$string['privacy:metadata:backup_controllers:timecreated'] = 'A data em que a ação foi criada.';
$string['privacy:metadata:backup_controllers:timemodified'] = 'A data em que a ação foi modificada.';
