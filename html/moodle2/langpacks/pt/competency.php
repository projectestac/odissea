...
/**
 * Strings for component 'competency', language 'pt', branch 'MOODLE_36_STABLE'
 *
 * @package   competency
...
$string['errorcannotchangeapastduedate'] = 'A data de fim já foi ultrapassada; não pode ser alterada.';
$string['errorcannotsetduedateinthepast'] = 'A data de fim não pode ser definida para uma data anterior.';
$string['errorcannotsetduedatetoosoon'] = 'A data de fim está muito próxima.';
...
$string['errorscaleconfiguration'] = 'A escala deve ser configurada selecionando os itens predefinido e de proficiência.';
...
$string['privacy:metadata:timemodified'] = 'A data/hora em que o registo foi editado';
