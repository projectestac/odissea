...
$string['modgrade_help'] = 'Selecione o tipo de nota a utilizar nesta atividade. Se selecionar a opção \'Escala\', poderá selecionar o tipo de escala a usar a partir do menu de seleção. Se selecionar a opção \'Nota\', poderá seguidamente definir a nota máxima disponível para esta atividade.';
...
$string['useridnumberwarning'] = 'Os utilizadores sem um número de identificação são excluídos da exportação, pois não podem ser importados';
