...
$string['unsubscribeallconfirm'] = 'Tem subscrição ativa em {$a->forums} fóruns e {$a->discussions} discussões. Tem a certeza que deseja cancelar a subscrição de todos os fóruns e desativar a auto-subscrição de discussões?';
