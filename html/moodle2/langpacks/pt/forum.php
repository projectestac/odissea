...
$string['blockafter_help'] = 'Especifica o número máximo de mensagens que cada utilizador pode submeter num determinado período de tempo. Utilizadores com a permissão mod/forum:postwithoutthrottling estão isentos destes limites.';
$string['blockperiod'] = 'Período de tempo';
$string['blockperioddisabled'] = 'Não bloquear';
$string['blockperiod_help'] = 'Os alunos podem ser impedidos de submeter mais de um determinado número de mensagens no período de tempo aqui especificado. Os utilizadores com a permissão mod/forum:postwithoutthrottling estão isentos destes limites.';
