...
$string['confirmsubscribe'] = 'Tem a certeza que pretende subscrever o fórum \'{$a}\'?';
...
$string['confirmunsubscribe'] = 'Tem a certeza que pretende cancelar a subscrição do fórum \'{$a}\'?';
...
$string['deletesure'] = 'Tem a certeza que pretende apagar esta mensagem?';
$string['deletesureplural'] = 'Tem a certeza que pretende apagar esta mensagem e todas as suas respostas? (número de respostas: {$a})';
...
$string['trackingtype_help'] = 'A sinalização de mensagens permite que os participantes identifiquem facilmente os tópicos do fórum que ainda não leram pois estes surgem assinalados.
...
$string['unsubscribeallconfirm'] = 'Tem subscrição ativa em {$a->forums} fóruns e {$a->discussions} discussões. Tem a certeza que pretende cancelar a subscrição de todos os fóruns e desativar a auto-subscrição de discussões?';
