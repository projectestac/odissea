...
$string['confirmeventseriesdelete'] = 'O evento "{$a->name}" faz parte de uma série de eventos. Pretende apagar apenas este evento ou todos os eventos {$a- count} da série?';
...
$string['invalideventtype'] = 'O tipo de evento que selecionou é inválido.';
...
$string['privacy:metadata:calendar:event:timestart'] = 'A data de início do evento.';
...
$string['showeventtype'] = 'Mostrar eventos {$a}';
