...
/**
 * Strings for component 'logstore_database', language 'pt', branch 'MOODLE_28_STABLE'
 *
...
$string['buffersize_help'] = 'Número de entradas de registos inseridos numa operação de base de dados em série, o que melhora o desempenho.';
...
$string['databasesettings_help'] = 'Detalhes da ligação para o registo externo de base de dados: {$a}';
$string['databasetable'] = 'Tabela de base de dados';
$string['databasetable_help'] = 'Nome da tabela onde os registos serão armazenados. Esta tabela deve ter uma estrutura idêntica à utilizada por logstore_standard (mdl_logstore_standard_log).';
...
$string['pluginname'] = 'Registo externo de base de dados';
$string['pluginname_desc'] = 'Um módulo de registo que armazena entradas de registos numa tabela de base de dados externa.';
$string['read'] = 'Ler';
