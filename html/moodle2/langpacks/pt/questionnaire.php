...
$string['confirmdelquestion'] = 'Tem certeza de que deseja apagar a questão na posição {$a}?';
...
$string['confpage_help'] = 'Titulo (a negrito) e texto da mensagem que é mostrado na página de \'Confirmação\' após o participante responder/completar o questionário. (Se definir um URL, este tem precedência em relação ao texto de confirmação).< br/>Se deixar este campo em branco, será exibida uma mensagem predefinida (**Obrigado por ter preenchido o questionário**).';
...
$string['event_non_respondents_viewed'] = 'Visualizado Não responderam (Sem resposta)';
...
$string['maxdigitsallowed_help'] = 'Ao usar o máx. de carateres permitidos e nº de casas pode especificar o comprimento e o número de casas decimais necessários.';
...
$string['navigate_help'] = 'Ativar questões Sim/Não e Botões de Rádio de modo a ter questões dependentes das escolhas de repostas no questionário.';
