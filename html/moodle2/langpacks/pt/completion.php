...
$string['areyousureoverridecompletion'] = 'Tem a certeza de que pretende substituir o estado atual de conclusão desta atividade para este utilizador e a assinalar como "{$a}"?';
...
$string['err_settingslocked'] = 'Um ou mais alunos já cumprem os critérios definidos e, por isso, as opções de configuração foram bloqueadas. Desbloquear as opções de verificação de conclusão apagará os dados existentes dos utilizadores e poderá causar alguma confusão.';
...
$string['privacy:metadata:course'] = 'Identificador da disciplina';
