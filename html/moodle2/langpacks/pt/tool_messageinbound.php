...
/**
 * Strings for component 'tool_messageinbound', language 'pt', branch 'MOODLE_28_STABLE'
 *
...
$string['incomingmailconfiguration'] = 'Configuração de entrada de emails';
$string['incomingmailserversettings'] = 'Definições do servidor de entrada de emails';
...
$string['messageinboundgeneralconfiguration_desc'] = 'O processamento de entrada de mensagens permite-lhe receber e processar emails dentro do Moodle. Isto pode ser aplicado em vários casos, nomeadamente para enviar respostas a tópicos de fórum por email ou adicionar ficheiros aos ficheiros privados do utilizador.';
