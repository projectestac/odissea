...
/**
 * Strings for component 'lesson', language 'pt', branch 'MOODLE_34_STABLE'
 *
 * @package   lesson
...
$string['allowofflineattempts'] = 'Permitir que a Lição seja concluída em modo offline usando a aplicação móvel';
$string['allowofflineattempts_help'] = 'Se ativar esta opção, um utilizador da aplicação móvel pode descarregar a lição e tentar fazê-la offline. Todas as respostas possíveis e respostas corretas serão também descarregadas.
...
$string['lessoneventcloses'] = 'Fecha em {$a}';
$string['lessoneventopens'] = 'Abre em {$a}';
...
$string['mediafile'] = 'Ficheiros de Media relacionados';
...
$string['offlinedatamessage'] = 'Já trabalhou nesta tentativa usando um dispositivo móvel. Os dados foram salvos pela última vez neste site há {$a} atrás. Verifique que não possui trabalhos por guardar.';
...
$string['privacy:metadata:attempts:timeseen'] = 'Hora a que a tentativa foi feita';
...
$string['privacy:metadata:branch:timeseen'] = 'A hora a que a página foi visualizada';
...
$string['privacy:metadata:grades:completed'] = 'a data em que a avaliação foi atribuída';
...
$string['privacy:metadata:overrides:available'] = 'Hora a que os alunos podem iniciar a tentativa da lição';
...
$string['privacy:metadata:timer:starttime'] = 'A data em que iniciou a tentativa';
$string['privacy:metadata:timer:timemodifiedoffline'] = 'O último momento em que a atividade foi registada na aplicação móvel';
...
$string['studentoutoftimeforreview'] = 'Atenção: Terminou o tempo disponível para rever esta lição';
$string['studentresponse'] = 'Resposta de {$a}';
$string['submit'] = 'Submeter';
$string['submitname'] = 'Submeter nome';
$string['teacherjumpwarning'] = 'Nesta lição, há páginas que seguem para {$a->cluster} ou para {$a->unseen}. Esta sequência será ignorada e a lição seguirá para a página seguinte. Para testar a sequência das páginas, assuma o papel de aluno.';
