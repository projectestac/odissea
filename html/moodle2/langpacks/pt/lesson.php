...
$string['completionendreached_desc'] = 'O aluno terá de chegar ao final da lição para completar esta atividade';
...
$string['groupsnone'] = 'Não existem grupos para esta disciplina';
