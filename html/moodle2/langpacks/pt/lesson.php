...
$string['eventhighscoreadded'] = 'Pontuação máxima adicionada';
$string['eventhighscoresviewed'] = 'Pontuações máximas visualizadas';
...
$string['viewhighscores'] = 'Ver lista das melhores notas';
