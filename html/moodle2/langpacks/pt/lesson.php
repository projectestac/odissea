...
/**
 * Strings for component 'lesson', language 'pt', branch 'MOODLE_28_STABLE'
 *
 * @package   lesson
...
$string['mediafile_help'] = 'Para incluir uma janela de pop-up no início da lição, escolha o ficheiro a exibir. Todas as páginas da lição incluirão uma hiperligação para reabrir o pop-up, se necessário.';
