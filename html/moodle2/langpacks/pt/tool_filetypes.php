...
$string['delete_confirmation'] = 'Tem a certeza absoluta que quer eliminar <strong>.{$a}</strong>?';
...
$string['revert_confirmation'] = 'Tem a certeza que deseja restaurar <strong>.{$a}</strong> para as predefinições Moodle, descartando todas as alterações?';
