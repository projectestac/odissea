...
$string['addtoyourcontacts'] = 'Adicionar aos seus contactos';
$string['ago'] = '{$a} atrás';
...
$string['deleteallconfirm'] = 'Tem a certeza que pretende eliminar esta conversação por completo?';
$string['deleteallmessages'] = 'Eliminar todas as mensagens';
$string['deleteselectedmessages'] = 'Eliminar as mensagens selecionadas';
...
$string['noncontacts'] = 'Sem contactos';
...
$string['shownotificationwindownonew'] = 'Mostrar janela de notificação sem novas notificações';
$string['shownotificationwindowwithcount'] = 'Mostrar janela de notificação com {$a} notificações novas';
$string['strftimedaydatetime'] = '%A, %d %B %Y, %H:%M';
$string['timenosee'] = 'Última vez que fui visto online (em minutos)';
$string['timesent'] = 'Hora de envio';
$string['togglemessagemenu'] = 'Alternar o menu de mensagens';
...
$string['viewinganotherusersmessagearea'] = 'Está a visualizar a área de mensagem de outro utilizador.';
