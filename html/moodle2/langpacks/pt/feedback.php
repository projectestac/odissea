...
$string['confirmdeleteentry'] = 'Tem a certeza que pretende apagar esta resposta?';
...
$string['feedbackcompleted'] = '{$a->username} concluído {$a->feedbackname}';
...
$string['saving_failed_because_missing_or_false_values'] = 'Ocorreu um erro ao guardar devido a valores em falta ou incoerentes';
