...
/**
 * Strings for component 'calendar', language 'ko', branch 'MOODLE_32_STABLE'
 *
 * @package   calendar
...
$string['editevent'] = '일정 편집';
$string['erroraddingevent'] = '이벤트 추가 실패';
$string['errorbadsubscription'] = '달력 구독이 없습니다.';
$string['errorbeforecoursestart'] = '강좌가 시작되기 전에는 일정을 설정할 수 없음';
...
$string['hideuserevents'] = '사용자 이벤트 숨기기';
$string['hourly'] = '매 시간';
$string['ical'] = '아이칼';
...
$string['quickdownloadcalendar'] = '즉시 내려받기/달력에 기재';
...
$string['sat'] = '토';
$string['saturday'] = '토요일';
$string['showcourseevents'] = '강좌 이벤트 보기';
$string['showglobalevents'] = '글로벌 이벤트 표시';
$string['showgroupsevents'] = '모둠 이벤트 표시';
$string['shown'] = '보여짐';
$string['showuserevents'] = '사용자 이벤트 표시';
...
$string['tt_hidecourse'] = '강좌 일정 보임(감추려면 클릭)';
$string['tt_hideglobal'] = '전체 일정 보임(감추려면 클릭)';
$string['tt_hidegroups'] = '모듬 일정 보임(감추려면 클릭)';
$string['tt_hideuser'] = '사용자 일정 보임(감추려면 클릭)';
$string['tt_showcourse'] = '강좌 일정 감춤(보이려면 클릭)';
$string['tt_showglobal'] = '사이트 일정 감춤(보이려면 클릭)';
