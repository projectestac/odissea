...
/**
 * Strings for component 'tag', language 'ko', branch 'MOODLE_31_STABLE'
 *
 * @package   tag
...
$string['page-tag-search'] = '태그 검색 페이지';
$string['page-tag-x'] = '모든 태그 페이지';
$string['ptags'] = '사용자 정의 태그';
$string['relatedblogs'] = ' 최신 블로그 게시글';
...
$string['rsstitle'] = '사용자 {$a} 의 강좌 태그 RSS 피드';
$string['search'] = '검색';
