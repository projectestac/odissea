...
/**
 * Strings for component 'qtype_numerical', language 'ko', branch 'MOODLE_36_STABLE'
 *
...
$string['answererror'] = '오류';
$string['answermustbenumberorstar'] = '답은 숫자이거나 \'*\'이어야 합니다.';
$string['answerno'] = '답안 {$a}';
$string['decfractionofquestiongrade'] = '질문 성적의 소수(0-1)로';
$string['decfractionofresponsegrade'] = '응답 성적의 소수(0-1)로';
...
$string['leftexample'] = '$1.00와 같이 왼쪽에';
$string['manynumerical'] = '수치적 답만 선택적으로 단위를 사용하여 채점될 것입니다.';
...
$string['oneunitshown'] = '수치적 답만 채점될 것입니다. 단위1이 보여질것입니다.';
$string['onlynumerical'] = '수치적인 답만 채점될 것입니다. 단위가 허용되지 않습니다.';
...
$string['unitnotselected'] = '단위가 선택되지 않았습니다.';
...
$string['validnumberformats_help'] = '* 보통의 수 13500.67 : 13 500.67 : 13500,67: 13 500,67
* 만일 천 단위 구분자로 , 를 사용하면 소수점은 13,500.67 : 13,500. 에서와 같이 항상  . 으로 표시해야 합니다.
* 지수형식 예를 들면 1.350067 * 10<sup>4</sup>은 1.350067 E4 : 1.350067 E04 를 사용하십시요.';
