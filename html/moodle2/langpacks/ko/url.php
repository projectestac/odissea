...
/**
 * Strings for component 'url', language 'ko', branch 'MOODLE_36_STABLE'
 *
 * @package   url
...
$string['configsecretphrase'] = '이 비밀 단계는 서버에게 파라메터로 전달되는 암호화된 코드 값을 만드는데 사용됩니다. 암호화된 코드는 현재 사용자의 IP주소와 암호구절을 합친것의 md5 값에 의해 만들어집니다. 즉 코드=md5(IP.암호구절)입니다. IP주소는 변하고 다른 컴퓨터에 의해 공유될 수 있으므로 믿을만한 것이 아니라는 것을 주목하십시요.';
...
* 자동- URL에 대한 최적 표시 옵션이 자동으로 선택됩니다.
* 엠베드 - URL이 찾아가기 막대 아래에 URL 설명 및 기타 블록과 함께 페이지 안에 표시됩니다.
* 강제 다운로드 - 사용자는 URL을 다운 받도록 요청받습니다.
* 열기 - URL이 새 브라우저 창에 표시됩니다.
* 팝업 안에 - URL이 새 브라우저 창에 메뉴나 주소 막대없이 표시됩니다.
