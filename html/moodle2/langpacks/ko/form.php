...
/**
 * Strings for component 'form', language 'ko', branch 'MOODLE_28_STABLE'
 *
 * @package   form
...
$string['advancedelement'] = '고급 항목';
$string['close'] = '닫기';
$string['day'] = '일';
$string['display'] = '표시';
$string['err_alphanumeric'] = '알파벳이나 숫자만 입력하시오.';
$string['err_email'] = '쓸 수 있는 이메일 주소를 입력하시오.';
$string['err_lettersonly'] = '문자만 입력하시오.';
$string['err_maxfiles'] = '여기에  {$a}이상의 파일을 첨부할 수 없습니다.';
$string['err_maxlength'] = '{$a->format} 글자 미만의 문자를 입력하시오.';
$string['err_minlength'] = '최소 {$a->format} 글자 이상의 문자를 입력하시오.';
$string['err_nonzero'] = '0이 아닌 숫자만 입력하시오.';
$string['err_nopunctuation'] = '쉼표나 세미콜론 등이 없는 문자만 입력하시오.';
...
$string['selected'] = '선택됨';
$string['showadvanced'] = '고급 표시';
$string['showless'] = '덜 보기';
$string['showmore'] = '더 보기';
$string['somefieldsrequired'] = '이 양식에는 {$a}로 표시된 필수 항목이 있습니다';
$string['time'] = '시간';
