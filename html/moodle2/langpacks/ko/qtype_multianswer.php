...
/**
 * Strings for component 'qtype_multianswer', language 'ko', branch 'MOODLE_36_STABLE'
 *
...
$string['confirmquestionsaveasedited'] = '수정한 대로 질문을 저장할 것을 확인';
$string['confirmsave'] = '확인 후 저장 {$a}';
$string['correctanswer'] = '정답';
$string['correctanswerandfeedback'] = '정답 및 피드백';
$string['decodeverifyquestiontext'] = '질문 문장 복호 및 검증';
$string['layout'] = '서식';
$string['layouthorizontal'] = '라디오 버튼의 수편 배치';
$string['layoutselectinline'] = '문서내 펼침 목록';
$string['layoutundefined'] = '정의되지 않은 서식';
...
$string['questiondeleted'] = '질문 삭제됨';
$string['questioninquiz'] = '<ul>  <li>질문의 추가 혹은 삭제, </li>  <li>지문에서 질문 순서 변경,</li>  <li>질문 유형 변경 (수치형, 단답형, 선다형). </li></ul>';
$string['questionnotfound'] = '질문영역 #{$a} 에서 질문를 찾을 수 없음';
...
$string['unknownquestiontypeofsubquestion'] = '알 수 없는 질문 유형: 질문 영역 # {$a->sub} 의 {$a->type}';
$string['warningquestionmodified'] = '<b>경고</b>';
$string['youshouldnot'] = '<b>하지 말아야 할일</b>';
