...
/**
 * Strings for component 'imscp', language 'ko', branch 'MOODLE_36_STABLE'
 *
 * @package   imscp
...
$string['areabackup'] = '팩 보관';
$string['areacontent'] = '콘텐츠';
...
$string['page-mod-imscp-x'] = 'IMS 콘텐츠 패키지 모듈 페이지';
$string['pluginadministration'] = 'IMSCP 관리';
$string['pluginname'] = 'IMS 콘덴츠팩키지';
$string['toc'] = 'TOC';
