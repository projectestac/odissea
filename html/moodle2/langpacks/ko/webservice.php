...
/**
 * Strings for component 'webservice', language 'ko', branch 'MOODLE_36_STABLE'
 *
 * @package   webservice
...
$string['cannotcreatetoken'] = '서비스 {$a}에 대한 웹 서비스 토큰을 생성 할 권한이 없습니다.';
...
$string['criteriaerror'] = '기준에 대해 검색 할 수있는 권한이 없습니다.';
...
$string['forbiddenwsuser'] = '확인되지 않은, 삭제된, 정지 또는 게스트 사용자를 위한 토큰을 만들 수 없습니다';
$string['function'] = '함수';
$string['functions'] = '함수';
...
$string['unnamedstringparam'] = '문자열 매개변수에 이름이 없습니다.';
