...
/**
 * Strings for component 'enrol', language 'ko', branch 'MOODLE_28_STABLE'
 *
 * @package   enrol
...
$string['enroltimecreated'] = '등록이 만들어졌습니다.';
...
$string['errorthresholdlow'] = '통지 임계값은 최소 1일 이상이어야 합니다.';
$string['errorwithbulkoperation'] = '대량 등록 변경을 처리하는 도중에 오류가 있었습니다.';
$string['eventuserenrolmentcreated'] = '강좌에 등록된 사용자';
$string['eventuserenrolmentdeleted'] = '강좌에서 등록해지된 사용자';
$string['eventuserenrolmentupdated'] = '강좌 등록해지가 업데이트되었습니다.';
$string['expirynotify'] = '등록이 만료되기 전에 통지';
$string['expirynotifyall'] = '등록수행자 및 등록된 사용자';
$string['expirynotifyenroller'] = '등록수행자';
$string['expirynotifyhour'] = '등록 만료 통지를 보내는 시간';
$string['expirythreshold'] = '통지 임계값';
...
$string['testsettingsheading'] = '테스트 등록 설정 - {$a}';
