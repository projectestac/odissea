...
/**
 * Strings for component 'quiz_grading', language 'ko', branch 'MOODLE_31_STABLE'
 *
...
$string['alldoneredirecting'] = '모든 선택된 시도가 채점되었습니다. 질문 목록으로 되돌아 갑니다.';
$string['alreadygraded'] = '이미 채점됨';
$string['alsoshowautomaticallygraded'] = '자동으로 채점된 질문 보여주기';
...
$string['gradeattemptsneedsgrading'] = '채점이 필요한 것들  ({$a}).';
$string['graded'] = '(채점됨)';
...
$string['invalidquestionid'] = 'ID {$a}인 채점 가능한 질문을 찾을 수 없습니다.';
...
$string['tograde'] = '채점할';
$string['total'] = '합계';
$string['unknownquestion'] = '알수 없는 질문';
