...
$string['auth_ldap_rolecontext_help'] = 'O contexto LDAP usado para seleccionar para asignación <i>{$a->localname}</i>. Separar varios grupos con «;». Normalmente algo así como «cn={$a->shortname},ou=staff,o=myorg».';
...
$string['syncroles'] = 'Sincronizar os roles do sistema desde LDAP';
