...
$string['clicktosubscribe'] = 'Non está subscrito a esta discusión. Prema para subscribirse.';
$string['clicktounsubscribe'] = 'Está subscrito a esta discusión. Prema para cancelar a subscrición.';
$string['completiondiscussions'] = 'Os alumnos deben crear discusión:';
$string['completiondiscussionsdesc'] = 'O alumno debe crear polo menos {$a} discusión(s)';
...
$string['completionpostsdesc'] = 'O alumno debe publicar polo menos {$a} discusión(s) ou resposta(s)';
...
$string['disallowsubscription_help'] = 'Este foro foi configurado para que non poida subscribirse ás discusións.';
...
$string['discussionpinned_help'] = 'As discusións fixadas aparecerán na parte superior dun foro.';
...
$string['discussionsubscribestart'] = 'Enviarme copias por correo dos comentarios nesta discusión';
$string['discussionsubscribestop'] = 'Non quero enviar copias por correo dos comentarios nesta discusión';
$string['discussionsubscription'] = 'Subscrición á discusión';
$string['discussionsubscription_help'] = 'Ao subscribirse a unha discusión, recibirá notificacións de novas publicacións para esa discusión.';
...
* Predeterminado - segue as configuracións de resumo atopadas no seu perfil de usuario. Se actualiza o seu perfil, entón, este cambio reflectirase aquí tamén;
...
$string['eventdiscussionpinned'] = 'Discusión fixada';
$string['eventdiscussionsubscriptioncreated'] = 'Creada a subscrición á discusión';
$string['eventdiscussionsubscriptiondeleted'] = 'Eliminada a subscrición á discusión';
$string['eventdiscussionunpinned'] = 'Discusión desprendida';
...
$string['forcedreadtracking_desc'] = 'Permite que os foros poidan configurarse a seguimento forzado de lectura. Resultará nun rendemento diminuído para algúns usuarios, particularmente en cursos con moitos foros e comentarios nos foros. Cando está desconectado, calquera foro que houbera estado previamente configurado a «Forzado» tratarase como opcional.';
$string['forcesubscribed'] = 'Este foro obriga a todos a estaren subscritos';
...
$string['forum:pindiscussions'] = 'Fixar discusións';
...
$string['invaliddigestsetting'] = 'Forneceu unha configuración incorrecta de resumo de correo';
...
$string['lockdiscussionafter'] = 'Bloquea as discusións após un período de inactividade';
$string['lockdiscussionafter_help'] = 'As discusións poden bloquearse automaticamente após transcorrido un tempo determinado dende a última resposta.

Os usuarios con capacidade para responder a discusións bloqueadas poden desbloquear unha discusión respondendo a ela.';
...
$string['nextdiscussiona'] = 'Seguinte discusión: {$a}';
...
$string['postbymailsuccess'] = 'Parabéns, o seu comentario no foro co asunto «{$a->subject}» engadiuse satisfactoriamente. Pode velo en {$a->discussionurl}.';
...
$string['privacy:discussionsubscriptionpreference'] = 'Seleccionou a seguinte preferencia de subscrición de discusión para este foro: «{$a->preference}"»';
...
$string['privacy:metadata:forum_discussions'] = 'Información sobre as discusións individuais dos foros que creou un usuario';
$string['privacy:metadata:forum_discussions:assessed'] = 'TODOD - qué almacena este campo';
$string['privacy:metadata:forum_discussions:name'] = 'O nome da discusión, como foi escollido polo autor.';
$string['privacy:metadata:forum_discussions:timemodified'] = 'O momento no que se modificou a discusión por última vez';
$string['privacy:metadata:forum_discussion_subs'] = 'Información sobre as subscricións a discusións individuais do foro';
$string['privacy:metadata:forum_discussion_subs:discussionid'] = 'O ID da discusión á que estivo subscrito.';
$string['privacy:metadata:forum_discussion_subs:preference'] = 'A hora de inicio da subscrición.';
$string['privacy:metadata:forum_discussion_subs:userid'] = 'O ID do usuario coa subscrición á discusión.';
$string['privacy:metadata:forum_discussions:userid'] = 'O ID do usuario que creou a discusión';
$string['privacy:metadata:forum_discussions:usermodified'] = 'O  ID do usuario que modificou a discusión por algún motivo.';
...
$string['privacy:metadata:forum_posts:discussion'] = 'A discusión na que está o comentario.';
...
$string['privacy:metadata:forum_queue:discussionid'] = 'ID do foro de discusión';
...
$string['privacy:metadata:forum_read:discussionid'] = 'A discusión na que está o comentario.';
...
$string['privacy:metadata:preference:autosubscribe'] = 'Se se subscribe ás discusións ao responder a comentarios dentro delas.';
...
$string['privacy:request:delete:discussion:name'] = 'Eliminar a petición do autor';
$string['privacy:request:delete:post:message'] = 'O contido deste comentario foi eliminado a petición do seu autor.';
$string['privacy:request:delete:post:subject'] = 'Eliminar a petición do autor';
...
$string['subscribediscussion'] = 'Subscribirse a esta discusión';
...
$string['timedhidden'] = 'Estado temporal: agachado dos alumnos';
$string['timedposts'] = 'Comentarios con tempo límite';
$string['timedvisible'] = 'Estado temporal: visíbel por todos os usuarios';
...
$string['unsubscribeallconfirmdiscussions'] = 'Agora está subscrito a {$a->discussions} discusións. Confirma que quere cancelar a subscrición de todas as discusións e desactivar a subscrición automática ás discusións?';
$string['unsubscribeallconfirmforums'] = 'Agora está subscrito a {$a->forums} foros. Confirma que quere cancelar a subscrición de todos os foros e desactivar a subscrición automática ás discusións?';
...
$string['unsubscribediscussion'] = 'Cancelar a subscrición a esta discusión';
$string['unsubscribediscussionlink'] = 'Cancelar a subscrición a esta discusión: {$a}';
...
$string['viewthediscussion'] = 'Ver a discusión';
