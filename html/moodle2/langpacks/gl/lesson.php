...
/**
 * Strings for component 'lesson', language 'gl', branch 'MOODLE_34_STABLE'
 *
 * @package   lesson
...
$string['additionalattemptsremaining'] = 'Completada. Vostede pode volver intentar esta lección';
...
$string['addnewgroupoverride'] = 'Engadir substitución de grupo';
$string['addnewuseroverride'] = 'Engadir substitución de usuario';
...
$string['editoverride'] = 'Substituír a edición';
...
$string['groupoverrides'] = 'Substitucións de grupo';
...
$string['inactiveoverridehelp'] = '* O alumno non ten o grupo correcto ou o rol para ver/intentar a lección';
...
$string['invalidoverrideid'] = 'O id de substitución é incorrecto';
...
$string['notenoughtimespent'] = 'Vostede completou esta lección en {$a->timespent}, o que é menor que o tempo requirido de {$a->timerequired}. É probábel que Vostede necesite intentar resolver a lección de novo.';
...
$string['other'] = 'Outra';
$string['outof'] = 'De {$a}';
$string['override'] = 'Substituír';
$string['overridedeletegroupsure'] = 'Confirma que quere eliminar esta substitución do grupo {$a}?';
$string['overridedeleteusersure'] = 'Confirma que quere eliminar a substitución do usuario {$a}?';
$string['overridegroup'] = 'Substituír grupo';
$string['overridegroupeventname'] = '{$a->lesson} - {$a->group}';
$string['overrides'] = 'Substitucións';
$string['overrideuser'] = 'Substituír usuario';
...
$string['removealluseroverrides'] = 'Eliminar todas as substitucións de usuario';
...
$string['saveoverrideandstay'] = 'Gardar e introducir outra substitución';
...
$string['useroverrides'] = 'Substitución do usuario';
