...
/**
 * Strings for component 'block_rss_client', language 'gl', branch 'MOODLE_36_STABLE'
 *
...
$string['pickfeed'] = 'Seleccionar unha fonte de noticias';
$string['pluginname'] = 'Fontes remotas de RSS';
$string['privacy:metadata:block_rss_client:description'] = 'A descrición da fonte RSS.';
$string['privacy:metadata:block_rss_client:preferredtitle'] = 'O título preferido (personalizado) da fonte RSS.';
$string['privacy:metadata:block_rss_client:shared'] = 'Se a fonte RSS está dispoñíbel para todos os cursos.';
$string['privacy:metadata:block_rss_client:skiptime'] = 'O tempo definido en segundos que agardará o cron entre os reintentos das fontes RSS que non funcionan.';
$string['privacy:metadata:block_rss_client:skipuntil'] = 'O tempo máximo definido que o cron tentará abrir fontes RSS falladas.';
$string['privacy:metadata:block_rss_client:tableexplanation'] = 'A información do bloque RSS almacénase aquí.';
