...
/**
 * Strings for component 'portfolio_flickr', language 'gl', branch 'MOODLE_31_STABLE'
 *
...
$string['hidefrompublicsearches'] = 'Agochas estas imaxes das buscas públicas?';
...
$string['setupinfodetails'] = 'Para obter a chave da API e a cadea secreta, entre en Flickr e <a href="{$a->applyurl}">solicite unha nova chave</a>. Unha vez sexan xeradas a súa chave nova e o seu secreto, siga a ligazón de «Edit auth flow for this app» na páxina. Seleccione «App Type» a «Web Application». No campo «Callback URL», poña o valor: <br /><code>{$a->callbackurl}</code><br />Opcionalmente, tamén pode fornecer o seu logotipo e a descrición do seu sitio Moodle. Estes valores poden estabelecerse despois na <a href="{$a->keysurl}">páxina</a> que lista as súas aplicacións Flickr.';
$string['sharedsecret'] = 'Cadea secreta';
$string['title'] = 'Título';
