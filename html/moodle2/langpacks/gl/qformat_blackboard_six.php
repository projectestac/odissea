...
/**
 * Strings for component 'qformat_blackboard_six', language 'gl', branch 'MOODLE_34_STABLE'
 *
...
$string['errormanifest'] = 'Produciuse un erro ao procesar o documento do manifesto IMS';
$string['filenothandled'] = 'Este ficheiro contén referencia a un material do ficheiro {$a} que actualmente non é manexado pola importación';
$string['imagenotfound'] = 'O ficheiro de imaxe coa ruta {$a} non foi atopado na importación.';
$string['importedcategory'] = 'Categoría importada {$a}';
$string['importnotext'] = 'Falta texto de pregunta en ficheiro XML';
