...
/**
 * Strings for component 'block_course_overview', language 'gl', branch 'MOODLE_32_STABLE'
 *
...
$string['forcedefaultmaxcourses'] = 'Forzar o máximo de cursos';
$string['forcedefaultmaxcoursesdesc'] = 'Se estabelece isto, o usuario non será quen de cambiar o seu axuste persoal.';
$string['fullpath'] = 'Todas as categorías e subcategorías';
$string['hiddencoursecount'] = 'Ten {$a} curso agochado';
$string['hiddencoursecountplural'] = 'Ten {$a} cursos agochados';
$string['hiddencoursecountwithshowall'] = 'Ten {$a->coursecount} curso agochado ({$a->showalllink})';
$string['hiddencoursecountwithshowallplural'] = 'Ten {$a->coursecount} cursos agochados ({$a->showalllink})';
...
$string['showchildren'] = 'Amosar os descendentes';
$string['showchildrendesc'] = 'No caso de cursos descendentes, ordenar baixo o título do curso principal?';
$string['showwelcomearea'] = 'Amosar a área de benvida';
$string['showwelcomeareadesc'] = 'Amosar a área de benvida por riba da lista de cursos?';
$string['view_edit_profile'] = '(ver e editar o seu perfil)';
$string['welcome'] = 'Benvido/a {$a}';
$string['youhavemessages'] = 'Ten {$a} sen ler';
$string['youhavenomessages'] = 'Non ten nada sen ler';
