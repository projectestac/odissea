...
/**
 * Strings for component 'workshopform_accumulative', language 'gl', branch 'MOODLE_36_STABLE'
 *
...
$string['mustchoosegrade'] = 'Ten que seleccionar unha cualificación para este aspecto';
...
$string['scalename3'] = 'Bo/Pobre (3 puntos)';
$string['scalename4'] = 'Excelente/Moi pobre (4 puntos)';
$string['scalename5'] = 'Excelente/Moi pobre (5 puntos)';
$string['scalename6'] = 'Excelente/Moi pobre (7 puntos)';
