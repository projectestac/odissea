...
/**
 * Strings for component 'report_eventlist', language 'gl', branch 'MOODLE_31_STABLE'
 *
...
$string['affectedtable'] = 'Táboa afectada';
$string['all'] = 'Todas';
$string['clear'] = 'Limpar';
$string['component'] = 'Compoñente';
$string['create'] = 'crear';
$string['crud'] = 'Tipo de consulta na base de datos';
