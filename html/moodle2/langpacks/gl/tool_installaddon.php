...
/**
 * Strings for component 'tool_installaddon', language 'gl', branch 'MOODLE_36_STABLE'
 *
...
$string['installfromrepo'] = 'Instalar engadidos desde o directorio de engadidos de Moodle';
$string['installfromrepo_help'] = 'Vai ser redirixido cara o directorio de engadidos de Moodle para buscar e instalar un engadido. Tome nota de que o nome completo do seu sitio, URL e versión principal serán enviados, para facerlle máis sinxelo o proceso de instalación';
$string['installfromzip'] = 'Instalar engadido desde archivo ZIP';
$string['installfromzipfile'] = 'Paquete Zip';
$string['installfromzipfile_help'] = 'O paquete ZIP do engadido debe conter exactamente un directorio que coincida co nome do engadido. O ZIP será extraido cara a localización apropiada para o tipo de engadido. Se o paquete foi descargado desde o directorio de engadidos de Moodle, entón terá esta estrutura.';
...
$string['installfromzipsubmit'] = 'Instalar engadido desde o archivo ZIP';
...
$string['remoterequestnoninstallable'] = 'Hai unha solicitude para instalar o engadido {$a->name} ({$a->component}) versión {$a->version} desde o directorio de engadidos de Moodle cara este sitio. Porén, fallou a revisión previa á instalación do engadido (código da razón: {$a->reason}).';
$string['remoterequestpermcheck'] = 'Hai unha solicitude para instalar o engadido {$a->name} ({$a->component}) versión {$a->version} desde o directorio de engadidos de Moodle cara este sitio. Porén, a localización do tipo de engadido <strong>{$a->typepath}</strong> é <strong> non escribíbel</strong>. Necesita darlle acceso para escritura ao usuario do servidor web na localización do tipo do engadido. Unha vez que se outorgue o acceso de escritura, prema no botón de continuar para repetir a revisión.';
