...
/**
 * Strings for component 'tool_customlang', language 'gl', branch 'MOODLE_31_STABLE'
 *
...
$string['checkin'] = 'Gardar as cadeas no paquete de idioma';
...
$string['filtercomponent'] = 'Amosar as cadeas destes compoñentes';
$string['filtercustomized'] = 'Só as personalizadas';
$string['filtermodified'] = 'Só as modificadas';
$string['filteronlyhelps'] = 'Só a axuda';
$string['filtershowstrings'] = 'Amosar as cadeas';
$string['filterstringid'] = 'Identificador de cadea';
$string['filtersubstring'] = 'Só as cadeas que conteñan';
$string['headingcomponent'] = 'Compoñente';
$string['headinglocal'] = 'Personalización local';
$string['headingstandard'] = 'Texto estándar';
$string['headingstringid'] = 'Cadea';
$string['markinguptodate'] = 'Marcando a personalización como actualizada';
$string['markinguptodate_help'] = 'A tradución personalizada pode quedar obsoleta se os paquetes co inglés orixinal ou a tradución principal foi modificada posteriormente á personalización do seu sitio. Revise a tradución personalizada; se ve que está actualizada marque a caixiña, En caso contrario, edítea de novo.';
