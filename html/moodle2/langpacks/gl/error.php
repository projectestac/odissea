...
$string['nocapabilitytousethisservice'] = 'O usuario non ten a funcionalidade requirida para usar este servizo';
...
$string['oauth1accesstoken'] = 'Erro de OAuth 1.0 : No obtivemos a marca para acceso.';
$string['oauth1requesttoken'] = 'Error de OAuth 1.0: Non obtivemos a marca para acceso; o provedor de servizos podería estar caído temporalmente.';
...
$string['sitepolicynotagreed'] = 'Non aceptou a política do sitio: <a href="{$a}">Prema aquí para abrir a política do sitio.</a>';
