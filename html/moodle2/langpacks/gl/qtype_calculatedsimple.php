...
/**
 * Strings for component 'qtype_calculatedsimple', language 'gl', branch 'MOODLE_32_STABLE'
 *
...
$string['atleastonewildcard'] = 'Debe existir polo menos un comodín <strong>{x..}</strong> presente nas fórmulas para a resposta correcta';
$string['converttocalculated'] = 'Gardar como unha nova pregunta calculada regular';
