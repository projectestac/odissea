...
/**
 * Strings for component 'report_backups', language 'gl', branch 'MOODLE_34_STABLE'
 *
...
$string['backupofcourselogs'] = 'Rexistros de copias seguridade de {$a}';
$string['logsofbackupexecutedon'] = 'Rexistros de seguridade executado en {$a}';
