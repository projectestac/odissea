...
/**
 * Strings for component 'imscp', language 'gl', branch 'MOODLE_31_STABLE'
 *
 * @package   imscp
...
$string['areabackup'] = 'Arquivo do paquete';
$string['areacontent'] = 'Contido';
$string['contentheader'] = 'Contido';
$string['deploymenterror'] = 'Erro no contido do paquete!';
