...
/**
 * Strings for component 'tool_uploadcourse', language 'gl', branch 'MOODLE_31_STABLE'
 *
...
$string['cachedef_helper'] = 'Axudante de almacenamento na caché';
$string['cannotdeletecoursenotexist'] = 'Non é posíbel eliminar un curso que non existe';
$string['cannotgenerateshortnameupdatemode'] = 'Non é posíbel xerar un nome curto cando están permitidas as actualizacións';
...
$string['cannotrenameshortnamealreadyinuse'] = 'Non é posíbel renomear o curso, o nome curto xa existe';
$string['cannotupdatefrontpage'] = 'Está prohibido modificar a páxina principal';
$string['canonlyrenameinupdatemode'] = 'Só é posíbel0 renomear un curso cando está permitida a a actualización';
...
$string['coursefile_help'] = 'Este ficheiro semella se un ficheiro CSV.';
...
$string['courseshortnamegenerated'] = 'Xerado no nome curto de curso: {$a}';
$string['courseshortnameincremented'] = 'Nome curto de curso incrementado {$a->from} -> {$a->to}';
$string['coursestotal'] = 'Total de cursos: {$a}';
$string['coursesupdated'] = 'Cursos actualizados: {$a}';
$string['coursetemplatename'] = 'Restaurar desde este curso após envialo';
$string['coursetemplatename_help'] = 'Escriba un nome curto de curso para usar como modelo para a creación de todos os cursos.';
...
$string['createall'] = 'Crear todos, incrementar o nome curto se for necesario';
...
$string['generatedshortnamealreadyinuse'] = 'O nome curto xerado xa está a ser empregado';
$string['generatedshortnameinvalid'] = 'O nome curto xerado é incorrecto';
$string['id'] = 'ID';
$string['idnumberalreadyinuse'] = 'O número ID xa está a ser usado por un curso';
$string['importoptions'] = 'Opcións de importación';
$string['invalidbackupfile'] = 'Ficheiro de copia de seguridade incorrecto';
$string['invalidcourseformat'] = 'Formato incorrecto de curso';
$string['invalidcsvfile'] = 'Ficheiro CVS de entrada incorrecto';
$string['invalidencoding'] = 'Codificación incorrecta';
$string['invalideupdatemode'] = 'O modo de actualización seleccionado é incorrecto';
$string['invalidmode'] = 'O modo seleccionado é incorrecto';
$string['invalidroles'] = 'Nomes de rol incorrectos: {$a}';
$string['invalidshortname'] = 'Nome curto incorrecto';
$string['missingmandatoryfields'] = 'Falta(n) valor(es) para campos obrigatorios: {$a}';
$string['missingshortnamenotemplate'] = 'Falta o nome curto e non foi estabelecido o modelo de nome curto';
...
$string['rowpreviewnum_help'] = 'Número de filas do ficheiro CSV que se verán na seguinte páxina. Esta opción ten como obxectivo limitar o tamaño da próxima páxina.';
$string['shortnametemplate'] = 'Modelo para xerar o nome curto';
$string['shortnametemplate_help'] = 'O nome curto do curso é o amosado na navegación. Pode usar a sintaxe de modelo aquí (%f = fullname, %i = idnumber), ou escribir un valor inicial que é incrementado.';
$string['templatefile'] = 'Restaurar desde este ficheiro após envialo';
...
$string['updatemissing'] = 'Encher os datos que faltan desde os datos CSV e os valores predeterminados';
...
* Os nomes de campo necesarios son nome curto, nome completo e categoría';
