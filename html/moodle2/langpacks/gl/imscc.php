...
/**
 * Strings for component 'imscc', language 'gl', branch 'MOODLE_34_STABLE'
 *
 * @package   imscc
...
$string['enable_cc_import_description'] = 'Esta opción activa a importación do Cartucho Común (Common Cartridge (MS-CC)) utilizando a funcionalidade de restauración estándar. Observe que require que estean instaladas no servidor as extensións PHP5, DOM, XSL y LIBXML (2.3.60 ou posterior)';
