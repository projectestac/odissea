...
/**
 * Strings for component 'rating', language 'fr', branch 'MOODLE_36_STABLE'
 *
 * @package   rating
...
$string['rate'] = 'Évaluer';
$string['ratepermissiondenied'] = 'Vous n\'avez pas les droits d\'accès requis pour évaluer cet élément';
