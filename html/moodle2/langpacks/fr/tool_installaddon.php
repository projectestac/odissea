...
$string['validationresult0_help'] = 'Un problème sérieux a été détecté et l\'installation de ce plugin n\'est pas sûre. Veuillez consulter l\'historique de validation pour plus de détails';
$string['validationresult1'] = 'Validation passée !';
$string['validationresult1_help'] = 'Le paquetage du plugin a été validé et aucun problème sérieux n\'a été détecté.';
$string['validationresult2_help'] = 'Aucun problème sérieux n\'a été détecté. Vous pouvez poursuivre l\'installation du plugin. Consultez les messages de l\'historique de validation pour plus de détails et d\'éventuels avertissements.';
