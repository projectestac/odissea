...
/**
 * Strings for component 'auth_mnet', language 'fr', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_mnet
...
$string['privacy:metadata:mnet_external:city'] = 'La localité de l\'utilisateur.';
...
$string['privacy:metadata:mnet_external:idnumber'] = 'Le numéro d\'identification donné à l\'utilisateur par l\'institution.';
...
$string['privacy:metadata:mnet_external:timezone'] = 'Le fuseau horaire dans lequel réside l\'utilisateur.';
...
$string['privacy:metadata:mnet_session'] = 'Les informations de chaque session utilisateur MNet sur un système distant sont enregistrées de manière temporaire.';
...
$string['privacy:metadata:mnet_session:token'] = 'L\'identifiant unique de session.';
$string['privacy:metadata:mnet_session:useragent'] = 'Chaîne de caractères indiquant l\'agent utilisateur qui accède à la page.';
