...
/**
 * Strings for component 'tool_filetypes', language 'fr', branch 'MOODLE_31_STABLE'
 *
...
$string['description_help'] = 'Description brève d\'un type de fichier, par exemple « Libre ePUB ». Si votre plateforme est proposée en plusieurs langues et utilise le filtre multilingue, vous pouvez utiliser ici la syntaxe multilingue pour indiquer des descriptions en plusieurs langues.';
...
$string['mimetype_help'] = 'Le type MIME associé à ce type de fichier, par exemple « application/x-mobipocket-ebook »';
