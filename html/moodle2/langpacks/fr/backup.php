...
$string['configrestorehistories'] = 'Détermine le réglage par défaut pour la restauration des historiques, lorsqu\'ils ont été inclus dans la sauvegarde.';
$string['configrestorelogs'] = 'Si ce réglage est activé, les historiques seront restaurés par défaut si elles ont été inclues dans la sauvegarde.';
$string['configrestoreroleassignments'] = 'Si ce réglage est activé, les attributions de rôles seront restaurées par défaut si elles ont été inclues dans la sauvegarde.';
...
$string['configrestoreuserscompletion'] = 'Si ce réglage est activé, les informations d\'achèvement des utilisateurs seront restaurées par défaut si elles ont été inclues dans la sauvegarde.';
...
$string['privacy:metadata:backup_controllers:timecreated'] = 'La date et l\'heure à laquelle l\'action a été créée';
$string['privacy:metadata:backup_controllers:timemodified'] = 'La date et l\'heure à laquelle l\'action a été modifiée';
...
$string['rootsettingenrolments'] = 'Inclure les méthode d\'inscription';
