...
/**
 * Strings for component 'enrol_manual', language 'fr', branch 'MOODLE_34_STABLE'
 *
...
$string['status_help'] = 'Ce réglage détermine si des utilisateurs peuvent être inscrits manuellement par un utilisateur disposant des droits d\'accès requis, par exemple un enseignant, via un lien dans l\'administration du cours.';
