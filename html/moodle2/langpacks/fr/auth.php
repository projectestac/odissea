...
$string['privacy:metadata:userpref:loginlockout'] = 'Indique si le compte de l\'utilisateur est verrouillé en raison de tentatives de connexion échouées, et la date à laquelle le compte est verrouillé';
