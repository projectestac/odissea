...
$string['privacy:metadata:grades:completed'] = 'La date et l\'heure à laquelle la note a été donnée';
...
$string['privacy:metadata:timer:starttime'] = 'La date et l\'heure à laquelle la tentative a commencé';
