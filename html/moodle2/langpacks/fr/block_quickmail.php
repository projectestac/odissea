...
/**
 * Strings for component 'block_quickmail', language 'fr', branch 'MOODLE_26_STABLE'
 *
...
$string['admin_email_send_receipt'] = 'Adresse électronique d\'envoi et de réception de l\'administrateur';
$string['allowstudents'] = 'Autoriser les étudiants à utiliser Courriel';
$string['allowstudentsdesc'] = 'Autoriser les étudiants à utiliser Courriel. Si vous choisissez "Jamais", le bloc ne peut pas être configuré pour permettre aux étudiants d\'accéder au niveau cours.';
...
$string['draftssuccess'] = 'Brouillon';
$string['email'] = 'Message';
$string['email_error'] = 'Envoi impossible à: {$a->firstname} {$a->lastname} ({$a->email})';
$string['email_error_field'] = 'Le contenu ne peut pas être vide: {$a}';
...
$string['failed_to_send_to'] = 'Echec de l\'envoi à';
...
$string['logsuccess'] = 'tous les messages ont été envoyés avec succès';
$string['message'] = 'Message';
$string['message_body_as_follows'] = 'corps de message suivant';
$string['message_failure'] = 'des utilisateurs n\'ont pas reçu ce message';
$string['messageprovider:broadcast'] = 'Envoyer des messages d\'émission en utilisant l\'adresse électronique de l\'administrateur.';
$string['message_sent_to'] = 'Message envoyé à';
...
$string['no_email_address'] = 'Echec de l\'envoi {$a}';
...
$string['sendadmin'] = 'Envoyer un courrier électronique d\'administration';
$string['send_again'] = 'envoyer à nouveau';
$string['send_email'] = 'Envoyer le message';
$string['sent_success'] = 'tous les messages ont été envoyés avec succès';
$string['sent_successfully_to_the_following_users'] = 'envoyé avec succès aux utilisateurs suivants:';
$string['sig'] = 'Signature';
$string['signature'] = 'Signatures';
$string['something_broke'] = 'Il semblerait que l\'adresse électronique soit hors service ou qu\'un dysfonctionnement dans l\'envoi se soit produit';
$string['status'] = 'état';
