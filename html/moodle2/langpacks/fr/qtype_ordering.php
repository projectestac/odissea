...
/**
 * Strings for component 'qtype_ordering', language 'fr', branch 'MOODLE_32_STABLE'
 *
...
$string['addingordering'] = 'Ajouter une question de type ordonnancement';
...
**Tout ou rien**
: Si tous les objets sont à la bonne position, alors la meilleure note est attribuée. Sinon, le score attribué est de zéro.

**Position absolue**
: Un objet est considéré comme correct si il se trouve à la même position que dans la bonne réponse. Le score le plus haut possible pour cette question est **le même que* le nombre d\'éléments affichés à l\'étudiant.

**Position relative au prochain élément (en excluant le dernier)**
: Un élément est considéré comme correct si il est suivi par le même élément que dans la bonne réponse. L\'élément en dernière position n\'est pas vérifié. Ainsi, le score le plus haut possible pour la question est **un point de moins** que le nombre d\'éléments affichés à l\'étudiant.

**Position relative à l\'élément suivant (en incluant le dernier)**
: Un élément est considéré comme correct si il est suivi par le même élément que dans la bonne réponse. Ceci inclut le dernier élément. Ainsi, le score le plus haut possible pour la question est **le même que** que le nombre d\'éléments affichés à l\'étudiant.

**Relative aux éléments suivants et précédents**
: Un élément est considéré comme correct si les éléments suivants et précédents sont les mêmes que ceux de la bonne réponse. Le premier élément ne doit pas avoir d\'élément le précédent, et le dernier élément ne doit pas avoir d\'élément le suivant. Ainsi, il y a deux points possibles pour chaque élément, et le score le plus haut possible est égale à **deux fois** le nombre d\'éléments affichés à l\'étudiant.

**Relative à TOUS les éléments suivants et précédents**
: Un élément est considéré comme correct si il est précédé et suivi par les mêmes éléments que ceux de la réponse juste. L\'ordre des éléments précédents n\'importe pas, et l\'ordre des éléments suivant non-plus. Ainsi, si ***n*** éléments sont affichés à l\'étudiant, le nombre de points disponibles pour chaque élément est de ***(n-1)***, et la note la plus haute possible à cette question est de ***n x (n - 1)***, ce qui équivaut à ***(n² - n)***
...
$string['relativeallpreviousandnext'] = 'Relatif à TOUS les éléments suivants et précédents';
