...
/**
 * Strings for component 'hvp', language 'fr', branch 'MOODLE_31_STABLE'
 *
 * @package   hvp
...
$string['addedandupdatelibraries'] = 'Ajouter {$a->%new} de nouvelles bibliothèques H5P et mettre à jour {$a->%old} les anciennes.';
...
$string['availableversion'] = 'Mise à jour disponible';
...
$string['hvp:updatesavailable'] = 'Recevoir des notifications lorsqu\'une nouvelle version d\'H5P est disponible.';
...
$string['invalidlibrary'] = 'Bibliothèque non valide';
...
$string['messageprovider:updates'] = 'Notifications des mises à jour d\'H5P disponibles';
...
$string['title'] = 'Titre';
$string['unabletodownloadh5p'] = 'Autoriser le téléchargement d\'un fichier H5P';
...
$string['updatesavailable'] = 'Des mises à jour sont disponibles pour vos contenus H5P.';
$string['updatesavailablemsgpt1'] = 'Des mises à jour sont disponibles pour les contenus H5P que vous avez installés sur votre site Moodle.';
$string['updatesavailabletitle'] = 'De nouvelles mises à jour de H5P sont disponibles';
...
$string['whyupdatepart1'] = 'Vous pouvez lire pourquoi il est important de faire les mises à jour et leurs avantages sur la page suivante : <a {$a}>Why Update H5P</a>.';
$string['year'] = 'Année';
