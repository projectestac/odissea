...
$string['ccattributionnc'] = 'Attribution (CC BY)';
...
$string['ccattributionsa'] = '(CC BY-ND)';
...
$string['invalidsemanticstype'] = 'Erreur interne : le type de contenu « {$a->@type} » est inconnu. Le content est supprimé!';
...
$string['invalidxapiresult'] = 'Aucun résultat xAPI a été trouvé pour cette combinaison contenu et identifiant utilisateur';
$string['javascriptloading'] = 'En attente du Javascript...';
$string['libraries'] = 'Bibliothèques H5P';
$string['librarydirectoryerror'] = 'Le nom du répertoire doit correspondre au nom du "moteur" ou au nom du "moteur"-version majeure.version mineure (Répertoire: {$a->%directoryName} , nom du moteur: {$a->%machineName}, version majeure : {$a->%majorVersion}, version mineure : {$a->%majorVersion})';
...
$string['maxpostsizetoosmall'] = 'Votre taille de post PHP max est assez petite. Avec votre configuration actuelle, vous ne pouvez pas télécharger des fichiers de plus de {$a->%number}  MB. Cela peut être un problème lorsque vous essayez de télécharger des fichiers H5Ps, des images et des vidéos. Envisagez de l\'augmenter à plus de 5 Mo';
$string['maxscore'] = 'Score maximum';
$string['maxuploadsizetoosmall'] = 'Votre taille de téléchargement PHP max est assez petite. Avec votre configuration actuelle, vous ne pouvez pas télécharger des fichiers de plus de {$a->%number} MB. Cela peut être un problème lorsque vous essayez de télécharger des fichiers H5Ps, des images et des vidéos. S\'il vous plaît, envisagez de l\'augmenter à plus de 5 Mo.';
...
$string['nowriteaccess'] = 'Un problème d\'accès au serveur en écriture a été détecté. Assurez-vous que votre serveur peut écrire dans votre dossier de données.';
...
$string['privacy:metadata:hvp_xapi_results:description'] = 'Description, tâche ou question de l\'activité sur laquelle ll\'action a été effectuée.';
...
$string['privacy:metadata:hvp_xapi_results:response'] = 'La réponse que l\'utilisateur a envoyée.';
...
$string['reuseContent'] = 'Réutiliser l\'activité';
$string['reuseDescription'] = 'Réutiliser cette activité.';
...
$string['sitekeydescription'] = 'La clé de site est un code secret qui identifie de manière unique ce site avec le Hub.';
$string['sitekeyregistered'] = 'Vous avez reçu une clé unique qui vous identifie avec le Hub lors de la réception de nouvelles mises à jour. La clé est disponible pour l\'affichage dans la page "Paramètres H5P".';
$string['size'] = 'Taille';
...
$string['upgradeinvalidtoken'] = 'Erreur, clé de sécurité invalide !';
...
$string['upgradenothingtodo'] = 'Il n\'y a pas d\'activités à mettre à jour.';
