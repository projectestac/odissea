...
$string['ffmpeg_details'] = 'FFMPEG doit être installé sur votre serveur Moodle avec désignation du chemin système. Il devra prendre en charge la conversion en MP3. Essayez d\'abord en ligne de commande. Par exemple : ffmpeg-i somefile.flv somefile.mp3 . C\'est encore « expérimental »';
...
$string['videotranscodedetails'] = 'Conversion automatique des fichiers vidéo enregistrés ou téléversés au format MP4 avant de les stocker dans Moodle. Fonctionne seulement lorsque vous utilisez le serveur tokyo.poodll.com, ou les enregistrements téléversés si vous utilisez FFMPEG.';
