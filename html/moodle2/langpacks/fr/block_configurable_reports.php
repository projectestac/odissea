...
$string['filterenrolledstudents'] = 'Etudiants inscrits au cours';
...
$string['filterrole_summary'] = 'Filtrer les rôles système (Enseignant, Etudiant, ...)';
...
$string['reportlimitinfo'] = 'Limiter le nombre de lignes qui sont affichées dans le tableau de rapport ( valeur par défaut: 5000 lignes. Il vaut mieux fixer une limite , afin que les utilisateurs ne surchargent pas la base de données )';
...
$string['sqlsyntaxhighlight'] = 'Sélectionner la syntaxe SQL';
$string['sqlsyntaxhighlightinfo'] = 'Sélectionner la syntaxe SQL dans l\'éditeur de code (CodeMirror JS library)';
...
$string['usercompletion'] = 'Etat d\'achèvement du cours par l\'utilisateur';
$string['usercompletionsummary'] = 'Etat d\'achèvement du cours';
