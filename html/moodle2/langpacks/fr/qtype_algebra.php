...
/**
 * Strings for component 'qtype_algebra', language 'fr', branch 'MOODLE_26_STABLE'
 *
...
Equivalence: Ceci est la plus simple de toutes les méthodes. Elle n\'effectue que les règles basiques de comparaisons entre des expressions algébriques.';
...
$string['illegalvarname'] = 'Nom de la variable illégal \'{$a}\' : même nom qu\'une fonction de l\'analyseur ou constante spéciale.';
