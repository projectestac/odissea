...
/**
 * Strings for component 'recordingsbn', language 'fr', branch 'MOODLE_26_STABLE'
 *
...
$string['view_delete_confirmation'] = 'Êtes-vous sûr de vouloir effacer cet enregistrement ?';
