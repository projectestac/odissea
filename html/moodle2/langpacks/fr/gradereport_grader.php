...
/**
 * Strings for component 'gradereport_grader', language 'fr', branch 'MOODLE_34_STABLE'
 *
...
$string['privacy:metadata:preference:grade_report_grader_collapsed_categories'] = 'Liste des catégories à minimiser dans le carnet de notes';
...
$string['privacy:request:preference:grade_report_grader_collapsed_categories'] = 'Certaines catégories du carnet de notes sont minimisées dans le cours « {$a->name} ».';
