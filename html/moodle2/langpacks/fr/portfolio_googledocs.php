...
/**
 * Strings for component 'portfolio_googledocs', language 'fr', branch 'MOODLE_28_STABLE'
 *
...
$string['oauth2upgrade_message_content'] = 'Le plugin de portfolio Google Drive a été désactivé durant la mise à jour à Moodle 2.3. Pour le réactiver, votre site doit être enregistré auprès de Google, comme décrit dans la documentation {$a->docsurl}, afin d\'obtenir un ID client et un secret. L\'ID client et le secret pourront alors être utilisé pour configurer tous les plugins Google Drive et Picasa.';
...
$string['oauth2upgrade_message_subject'] = 'Information importante au sujet du plugin de portfolio Google Drive';
