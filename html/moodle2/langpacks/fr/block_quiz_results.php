...
/**
 * Strings for component 'block_quiz_results', language 'fr', branch 'MOODLE_31_STABLE'
 *
...
$string['bestgroupgrade'] = 'Le groupe avec la moyenne la plus haute :';
$string['bestgroupgrades'] = 'Les {$a} groupes avec la moyenne la plus haute :';
