...
/**
 * Strings for component 'admin', language 'fr', branch 'MOODLE_28_STABLE'
 *
 * @package   admin
...
$string['navexpandmycourses'] = 'Initialement déplier Mes cours sur Ma page';
$string['navexpandmycourses_desc'] = 'Si ce réglage est activé, Mes cours sont initialement dépliés dans le bloc de navigation de Ma page.';
...
$string['pleaserefreshregistration'] = 'Votre site a été enregistré. Vous pouvez mettre à jour cet enregistrement à votre guise. Par défaut, la tâche programmée adéquate mettra à jour votre enregistrement périodiquement.';
...
$string['taskcompletioncron'] = 'Calcul des données d\'achèvement';
...
$string['taskplagiarismcron'] = 'Traitement en tâche de fond des plugins de détection de plagiat';
