...
$string['cannotaddrss'] = 'Vous n\'avez pas les droits d\'accès requis pour ajouter des flux RSS';
...
$string['cannotdeletecourse'] = 'Vous n\'avez pas l\'autorisation de supprimer ce cours';
...
$string['cannotservefile'] = 'Impossible de fournir le fichier. Problème de configuration du serveur.';
...
$string['grouphasidnumber'] = 'Le groupe « {$a} » a un identifiant et a été vraisemblablement créé automatiquement par un système externe. Vous n\'avez pas l\'autorisation de le supprimer.';
$string['groupinghasidnumber'] = 'Le groupement « {$a} » a un identifiant et a été vraisemblablement créé automatiquement par un système externe. Vous n\'avez pas l\'autorisation de le supprimer.';
...
$string['invalidbulkenrolop'] = 'Opération d\'inscription en lot non valide demandée.';
...
$string['nopermissiontoimportact'] = 'Vous n\'avez pas les droits d\'accès requis pour importer des activités dans ce cours';
...
$string['wscouldnotcreateecoursenopermission'] = 'WS - Impossible de créer le cours - Pas d\'autorisation';
