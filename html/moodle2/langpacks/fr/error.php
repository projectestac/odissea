...
$string['nopermissiontodelentry'] = 'Vous n\'avez pas les permissions requises pour supprimer les articles d\'autres utilisateurs !';
...
$string['storedfilecannotcreatefile'] = 'Impossible de créer un fichier local de pool. Veuillez vérifier les droits d\'accès au dossier de données ainsi que l\'espace disque disponible.';
...
$string['usernotavailable'] = 'Vous n\'avez pas les permissions requises pour consulter les coordonnées de cet utilisateur';
