...
/**
 * Strings for component 'moodle', language 'fr', branch 'MOODLE_32_STABLE'
 *
 * @package   moodle
...
$string['courseduration_desc'] = 'La durée du cours est utilisée pour calculer la date de fin du cours. Cette date de fin n\'est utilisée que dans les rapports. Les utilisateurs pourront entrer dans le cours même après cette date.';
...
$string['enddate_help'] = 'La date de fin de cours n\'est utilisée que dans les rapports. Les utilisateurs pourront entrer dans le cours même après cette date.';
