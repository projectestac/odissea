...
/**
 * Strings for component 'moodle', language 'fr', branch 'MOODLE_34_STABLE'
 *
 * @package   moodle
...
$string['backuperrorinvaliddestination'] = 'Le dossier de destination des sauvegardes n\'existe pas ou n\'est pas accessible en écriture.';
...
$string['considereddigitalminor'] = 'Vous êtes considéré comme un mineur numérique.';
...
$string['coursenotyetstarted'] = 'Le cours n\'a pas encore débuté';
...
$string['digitalminor_desc'] = 'Pour créer un compte sur ce site, veuillez demander à votre représentant légal de contacter la personne suivante.';
...
$string['eventconfiglogcreated'] = 'Historique de configuration créé';
...
$string['explanationdigitalminor'] = 'Cette information est requise pour déterminer si vous avez l\'âge de la majorité numérique. Cet âge est celui qu\'une personne doit avoir pour pourvoir donner son consentement à l\'accès et au stockage par un tiers des données personnelles la concernant.';
...
$string['gettheselogs'] = 'Consulter ces historiques';
$string['go'] = 'Valider';
...
$string['indicator:nostudent'] = 'Il n\'y a pas d\'étudiant';
$string['indicator:nostudent_help'] = 'Cet indicateur montre que ce cours n\'a pas d\'étudiant.';
$string['indicator:noteacher'] = 'Il n\'y a pas d\'enseignant';
$string['indicator:noteacher_help'] = 'Cet indicateur montre que ce cours n\'a pas d\'enseignant.';
...
$string['legacylogginginuse'] = 'L\'écriture des historiques obsolètes est activée sur ce site. Ceci n\'est désormais plus supporté. Veuillez modifier les réglages pour enregistrer les historiques d\'une manière supportée actuellement, par exemple « standard » ou « externe ».';
...
$string['locktimeout'] = 'L\'opération s\'est interrompue dans l\'attente d\'un verrouillage.';
...
$string['messagedselecteduserfailed'] = 'Le message n\'a pas été envoyé à l\'utilisateur {$a->fullname}.';
...
$string['modvisible_help'] = 'Si la disponibilité est réglée sur « Afficher sur la page du cours », l\'activité ou la ressource est disponible pour les étudiants (éventuellement sujette à des restrictions d\'accès définies par l\'enseignant).<br /><br />
Si la disponibilité est réglée sur « Cacher pour les étudiants », l\'activité ou la ressource n\'est disponible que pour les utilisateurs avec la permission de voir les activités cachées (par défaut, les utilisateurs dont le rôle est enseignant ou enseignant non éditeur).';
$string['modvisiblehiddensection'] = 'Disponibilité';
$string['modvisiblehiddensection_help'] = 'Si la disponibilité est réglée sur « Cacher pour les étudiants », l\'activité ou la ressource n\'est disponible que pour les utilisateurs avec la permission de voir les activités cachées (par défaut, les utilisateurs dont le rôle est enseignant ou enseignant non éditeur).<br /><br />
...
$string['modvisiblewithstealth_help'] = 'Si la disponibilité est réglée sur « Afficher sur la page du cours », l\'activité ou la ressource est disponible pour les étudiants (éventuellement sujette à des restrictions d\'accès définies par l\'enseignant).<br /><br />
Si la disponibilité est réglée sur « Cacher pour les étudiants », l\'activité ou la ressource n\'est disponible que pour les utilisateurs avec la permission de voir les activités cachées (par défaut, les utilisateurs dont le rôle est enseignant ou enseignant non éditeur).<br /><br />
...
$string['newpictureusernotsetup'] = 'Une image de profil ne peut être ajouté que lorsque toutes les informations requises pour le profil ont été enregistrées.';
...
$string['newsitemsnumber_help'] = 'Le forum des annonces est un forum spécial qui est créé automatiquement dans le cours. L\'abonnement y est forcé par défaut, et seuls les utilisateurs avec les permissions adéquates (par défaut les enseignants) peuvent y poster des messages.
...
$string['nocourseactivity'] = 'Il n\'y a pas assez d\'activité entre les dates de début et de fin du cours';
$string['nocourseendtime'] = 'Le cours n\'a pas de date de fin';
$string['nocourses'] = 'Aucun cours';
$string['nocoursesections'] = 'Pas de section de cours';
...
$string['nocoursestudents'] = 'Pas d\'étudiant';
...
$string['notifyloginfailuresmessageend'] = 'Vous pouvez consulter ces historiques à l\'adresse {$a}';
...
$string['privacy:metadata:log:time'] = 'La date et l\'heure de l\'événement';
...
$string['privacy:metadata:upgrade_log:backtrace'] = 'Tout trace en lien avec cette étape de la mise à jour.';
...
$string['someallowguest'] = 'Des cours peuvent être accessibles aux visiteurs anonymes';
...
Cette vue ne reflète pas toujours parfaitement ce que verra réellement un utilisateur avec ce rôle (<a href="https://docs.moodle.org/en/Switch_roles">plus d\'infos ici</a>).';
$string['tag'] = 'Tag';
$string['tagalready'] = 'Ce tag existe déjà';
$string['tagmanagement'] = 'Ajouter/supprimer des tags...';
$string['tags'] = 'Tags';
$string['target:coursedropout'] = 'Étudiants en risque de décrochage';
$string['target:coursedropout_help'] = 'Cette cible décrit si l\'étudiant est considéré comme risquant le décrochage.';
$string['targetlabelstudentdropoutno'] = 'Sans risque';
$string['targetlabelstudentdropoutyes'] = 'Étudiant en risque de décrochage';
$string['targetlabelteachingno'] = 'Pas d\'enseignement';
$string['targetlabelteachingyes'] = 'Des utilisateurs avec capacités d\'enseignement ont accès au cours';
$string['target:noteachingactivity'] = 'Pas d\'enseignement';
$string['target:noteachingactivity_help'] = 'Cette cible décrit si des cours devant commencer la semaine prochaine ont des activités d\'enseignement.';
...
$string['timesplitting:deciles'] = 'Dixièmes';
$string['timesplitting:decilesaccum'] = 'Dixièmes cumulatifs';
$string['timesplitting:decilesaccum_help'] = 'Cette méthode de division temporelle divise le cours en dixièmes (10 parties égales), dont chaque prédiction est basée sur les données de tous les précédents dixièmes.';
$string['timesplitting:deciles_help'] = 'Cette méthode de division temporelle divise le cours en dixièmes (10 parties égales), dont chaque prédiction est basée uniquement sur les données du précédent dixième.';
$string['timesplitting:nosplitting'] = 'Pas de division temporelle';
$string['timesplitting:nosplitting_help'] = 'Aucune méthode de division temporelle n\'est définie pour ce modèle.';
$string['timesplitting:quarters'] = 'Trimestres';
$string['timesplitting:quartersaccum'] = 'Trimestres cumulatifs';
$string['timesplitting:quartersaccum_help'] = 'Cette méthode de division temporelle divise le cours en quart (4 parties égales), dont chaque prédiction est basée sur les données de tous les précédents quarts.';
$string['timesplitting:quarters_help'] = 'Cette méthode de division temporelle divise le cours en quart (4 parties égales), dont chaque prédiction est basée uniquement sur les données du précédent quart.';
$string['timesplitting:singlerange'] = 'Intervalle simple';
$string['timesplitting:singlerange_help'] = 'Cette méthode de division temporelle considère la totalité du cours comme une seule entité.';
$string['timesplitting:weekly'] = 'Semaines';
$string['timesplitting:weeklyaccum'] = 'Semaines cumulatives';
$string['timesplitting:weeklyaccum_help'] = 'Cette méthode de division temporelle divise le cours en semaines (7 jours), dont chaque prédiction est basée sur les données de toutes les semaines précédentes.';
$string['timesplitting:weekly_help'] = 'Cette méthode de division temporelle divise le cours en semaines (7 jours), dont chaque prédiction est basée uniquement sur les données de la semaine précédente.';
