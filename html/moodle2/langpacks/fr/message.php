...
/**
 * Strings for component 'message', language 'fr', branch 'MOODLE_36_STABLE'
 *
 * @package   message
...
$string['nogroupmessages'] = 'Pas de conversation de groupe';
...
$string['searchnocontactsfound'] = 'Aucun contact trouvé';
$string['searchnomessagesfound'] = 'Aucun message trouvé';
$string['searchnononcontactsfound'] = 'Aucun non contact trouvé';
