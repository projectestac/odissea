...
$string['addtoyourcontacts'] = 'Ajouter à vos contacts';
$string['ago'] = 'Il y a {$a}';
...
$string['deleteallconfirm'] = 'Voulez-vous vraiment supprimer l\'intégralité de cette conversation ?';
...
$string['managemessageoutputs'] = 'Gestion de la notification des messages';
...
$string['removefromyourcontacts'] = 'Retirer de vos contacts';
...
$string['togglemessagemenu'] = 'Ouvrir/fermer le menu messages';
...
$string['viewinganotherusersmessagearea'] = 'Vous consultez la zone des messages d\'un autre utilisateur';
