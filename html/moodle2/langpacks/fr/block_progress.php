...
$string['submittednotcomplete_colour_descr'] = 'Code couleur HTML pour les éléments envoyés, mais pas encore complété';
$string['submittednotcomplete_colour_title'] = 'Couleur pour envoyé mais pas complété';
