...
$string['gradepublishing_help'] = 'La publication des notes permet d\'importer et d\'exporter des notes au moyen d\'une URL, sans être connecté à Moodle. Si elle est activée, les administrateurs et utilisateurs au bénéfice de la permission de publier les notes (par défaut, uniquement les utilisateurs ayant le rôle de gestionnaire) peuvent avoir accès aux réglages de publications des notes dans le carnet de notes de chaque cours.';
