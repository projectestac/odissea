...
/**
 * Strings for component 'block_myoverview', language 'fr', branch 'MOODLE_36_STABLE'
 *
...
$string['aria:favourites'] = 'Afficher les cours favoris';
$string['aria:future'] = 'Afficher les cours à venir';
$string['aria:groupingdropdown'] = 'Menu déroulant de filtre';
$string['aria:hiddencourses'] = 'Afficher les cours cachés';
$string['aria:hidecourse'] = 'Cacher {$a} de l\'affichage';
...
$string['hidden'] = 'Cours cachés';
$string['hiddencourses'] = 'Cachés';
$string['hidecourse'] = 'Cacher de l\'affichage';
$string['inprogress'] = 'En cours';
$string['lastaccessed'] = 'Dernier accès';
$string['list'] = 'Liste';
$string['morecourses'] = 'Plus de cours';
$string['myoverview:addinstance'] = 'Ajouter un bloc Vue d\'ensemble des cours';
