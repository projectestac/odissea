...
/**
 * Strings for component 'auth_ldap', language 'fr', branch 'MOODLE_26_STABLE'
 *
 * @package   auth_ldap
...
$string['auth_ldap_preventpassindb_key'] = 'Mettre les mots de passe en cache';
