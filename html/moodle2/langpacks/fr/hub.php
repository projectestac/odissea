...
$string['errorhublisting'] = 'Une erreur est survenue lors de la récupération de la liste des serveurs d\'échanges depuis Moodle.org. Veuillez réessayer plus tard ({$a}).';
