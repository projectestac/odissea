...
/**
 * Strings for component 'forum', language 'fr', branch 'MOODLE_34_STABLE'
 *
 * @package   forum
...
$string['messageinboundnopostforum'] = 'Impossible de poster votre réponse, car vous n\'avez pas le droit de poster dans le forum {$a->forum->name} .';
...
$string['privacy:metadata:forum_queue:discussionid'] = 'L\'identifiant de la discussion de forum';
$string['privacy:metadata:forum_queue:postid'] = 'L\'identifiant du message de forum';
...
$string['subscribediscussion'] = 'S\'abonner à cette discusion';
