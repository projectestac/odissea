...
/**
 * Strings for component 'feedback', language 'fr', branch 'MOODLE_31_STABLE'
 *
 * @package   feedback
...
$string['bold'] = 'Gras';
$string['calendarend'] = 'Le feedback {$a} se ferme';
$string['calendarstart'] = 'Le feedback {$a} s\'ouvre';
...
$string['non_respondents_students'] = 'Participants sans réponse ({$a})';
...
$string['relateditemsdeleted'] = 'Toutes les réponses à cette question seront également supprimées.';
