...
/**
 * Strings for component 'qtype_match', language 'fr', branch 'MOODLE_28_STABLE'
 *
 * @package   qtype_match
...
$string['nomatchinganswer'] = 'Vous devez indiquer une correspondance pour la question « {$a} ».';
