...
/**
 * Strings for component 'tool_dbtransfer', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['enablemaintenance_help'] = 'このオプションを有効にした場合、データベース移行中および移行後にメンテナンスモードが有効にされます。これにより移行が完了するまですべてのユーザによるアクセスを防ぐことができます。サイト管理者は通常動作を再開させるためconfig.phpを更新した後に「 $CFG->dataroot/climaintenance.html 」ファイルを手動削除する必要があることに留意してください。';
$string['exportdata'] = 'データをエクスポートする';
$string['notargetconectexception'] = '申し訳ございません、ターゲットデータベースに接続できません。';
$string['options'] = 'オプション';
$string['pluginname'] = 'データベース転送';
$string['privacy:metadata'] = 'データベース転送プラグインはどのような個人データも保存しません。';
...
$string['transferdbintro'] = 'このスクリプトはデータベースのコンテンツすべてを別のデータベースサーバに転送します。主にデータを異なるデータベースタイプに移行する場合に使用されます。';
