...
$string['deleteinstanceconfirm'] = 'あなたは登録方法「 {$a->name} 」を削除しようとしています。この登録方法を使用して受講登録している {$a->users} 名のユーザすべては登録解除され、ユーザ評定、グループメンバーシップ、フォーラム購読のようなコース関連データすべてが削除されます。
...
$string['instanceeditselfwarningtext'] = 'あなたはこの登録方法により、このコースに受講登録されています。変更することにより、このコースに対するあなたのアクセスに影響する場合があります。';
