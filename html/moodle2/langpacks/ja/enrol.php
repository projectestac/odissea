...
$string['addinstance'] = '受講登録方法を追加する';
...
$string['deleteinstanceconfirm'] = 'あなたは受講登録方法「 {$a->name} 」を削除しようとしています。この登録方法を使用して受講登録している {$a->users} 名のユーザすべては受講登録解除され、ユーザ評定、グループメンバーシップ、フォーラム購読のようなコース関連データすべてが削除されます。

本当に続けてもよろしいですか?';
$string['deleteinstanceconfirmself'] = 'あなたがこのコースにアクセスできるインスタンス「 {$a->name} 」を本当に削除してもよろしいですか? 続ける場合、あなたはこのコースにアクセスできなくなります。';
$string['deleteinstancenousersconfirm'] = 'あなたは受講登録方法「 {$a->name} 」を削除しようとしています。本当に続けてもよろしいですか?';
...
$string['enrolcohortusers'] = 'ユーザを受講登録する';
$string['enrollednewusers'] = '新しい {$a} 名のユーザが正常に受講登録されました。';
$string['enrolledusers'] = '受講登録済みユーザ';
$string['enrolledusersmatching'] = '合致する受講登録済みユーザ';
$string['enrolme'] = 'このコースに私を登録する';
$string['enrolmentinstances'] = '受講登録方法';
$string['enrolmentnew'] = '{$a} の新しい登録';
$string['enrolmentnewuser'] = '{$a->user} がコース 「 {$a->course} 」に受講登録しました。';
...
$string['enrolxusers'] = '{$a} 名のユーザを受講登録する';
...
$string['eventuserenrolmentcreated'] = 'ユーザがコースに受講登録されました。';
...
$string['expirynotifyall'] = '登録者および受講登録済みユーザ';
...
$string['extremovedaction_help'] = '外部登録ソースからユーザ登録が削除された場合に実施する処理を選択してください。コース受講登録解除時、いくつかのユーザデータおよび設定がコースから削除されることに留意してください。';
$string['extremovedkeep'] = 'ユーザの受講登録状態を保持する';
$string['extremovedsuspend'] = 'コース受講登録を無効にする';
$string['extremovedsuspendnoroles'] = 'コース受講登録を無効にして、ロールを削除する';
...
$string['instanceeditselfwarningtext'] = 'あなたはこの受講登録方法により、このコースに受講登録されています。変更することにより、このコースに対するあなたのアクセスに影響する場合があります。';
...
$string['otheruserdesc'] = '以下のユーザはこのコースに受講登録されていませんが、コース内でのロールが継承または割り当てられています。';
$string['participationactive'] = 'アクティブ';
$string['participationstatus'] = 'ステータス';
$string['participationsuspended'] = '一時停止';
$string['periodend'] = '-> {$a}';
$string['periodnone'] = '受講登録日時 {$a}';
...
$string['totalenrolledusers'] = '受講登録済みユーザ数: {$a}';
