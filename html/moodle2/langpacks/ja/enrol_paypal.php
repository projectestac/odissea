...
$string['enrolperiod_help'] = '受講登録が有効な場合の登録期間です。ユーザが受講登録された時点で開始します。この設定が無効にされた場合、受講登録期間は無制限となります。';
$string['enrolstartdate'] = '開始日';
$string['enrolstartdate_help'] = 'この設定を有効にした場合、ユーザはこの日以降のみ受講受講登録することができます。';
...
$string['paypal:manage'] = '受講登録済みユーザを管理する';
$string['paypal:unenrol'] = 'ユーザをコースから登録解除する';
$string['paypal:unenrolself'] = '自分自身をコースから登録解除する';
$string['pluginname'] = 'PayPal';
$string['pluginname_desc'] = 'PayPalモジュールでは、あなたは有料のコースを設定することができます。コースの費用がゼロの場合、学生は受講登録時に支払いを求められません。サイト全体に適用されるデフォルトの費用をここで設定します。また、コース設定でコース個別の費用を設定することができます。コース費用はサイト全体の費用に優先されます。';
