...
/**
 * Strings for component 'enrol_paypal', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['pluginname_desc'] = 'PayPalモジュールではあなたは有料のコースを設定することができます。コースの費用がゼロの場合、学生は登録時に支払いを求められません。サイト全体に適用されるデフォルトの費用をここで設定します。また、コース設定でコース個別の費用を設定することができます。コース費用はサイト全体の費用に優先されます。';
