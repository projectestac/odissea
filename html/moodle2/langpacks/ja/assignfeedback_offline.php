...
/**
 * Strings for component 'assignfeedback_offline', language 'ja', branch 'MOODLE_34_STABLE'
 *
...
$string['ignoremodified'] = 'スプレッドシートよりも最近にMoodle内のレコードが修正されている場合、レコードの更新を許可します。';
