...
/**
 * Strings for component 'assignfeedback_offline', language 'ja', branch 'MOODLE_28_STABLE'
 *
...
$string['ignoremodified_help'] = '評定ワークシートがMoodleからダウンロードされた場合、それぞれの評点に関する最終更新日時を含みます。このワークシートがダウンロードされた後にMoodle内の評点が更新された場合、Moodleは評定アップロード時に更新情報の上書きを拒否します。このオプションを選択した場合、Moodleは安全チェックを無効にして、複数評定者による他の評定者の評定のオーバーライトを可能とします。';
