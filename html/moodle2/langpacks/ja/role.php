...
$string['highlightedcellsshowdefault'] = '下記テーブルでハイライトされているパーミッションは上で現在選択されているロールアーキタイプのデフォルトです。';
$string['highlightedcellsshowinherit'] = '下記にハイライトされたセルは継承されるパーミッションを示してしています。あなたが実際に変更したいパーミッションとは別にしてすべてを継承のままにしてください。';
...
$string['privacy:metadata:role_capabilities:tableexplanation'] = 'このテーブルは特定のコンテクストにおける特定のロールのケイパビリティおよびケイパビリティのオーバーライドを保存します。';
