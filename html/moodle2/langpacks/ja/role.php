...
$string['hidden'] = '非表示';
$string['highlightedcellsshowdefault'] = '下記テーブルでハイライトされているパーミッションは、現在上で選択されているロールアーキタイプのデフォルトです。';
...
$string['notabletoassignroleshere'] = 'あなたはここでロールを割り当てることはできません。';
