...
/**
 * Strings for component 'media', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   media
...
$string['mediaformats_desc'] = 'これらの設定において、プレイヤーが有効にされた場合、メディアフィルタ (有効にされた場合)、ファイルまたは埋め込みオプションを設定したURLリソースによって、ファイルを埋め込むことができます。有効にされていない場合、これらのフォーマットは埋め込まれません。同時にユーザは手動でダウンロードまたはこれらのリソースのリンクをたどることができます。
