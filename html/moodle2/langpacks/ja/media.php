...
/**
 * Strings for component 'media', language 'ja', branch 'MOODLE_31_STABLE'
 *
 * @package   media
...
$string['html5video_desc'] = '拡張子*.webm、*.m4v、*.ogv、*.mp4等のオーディオファイルです。主にモバイルデバイスで使用されます (フォーマットのサポートはブラウザに依存します)。';
...
$string['legacywmp_desc'] = '拡張子*.aviおよび*.wmvのファイルです。WindowsのInternet Explorerに完全互換します。恐らく、他のブラウザまたはオペレーティングシステムにおいて、問題が生じる可能性があります。';
$string['mediaformats'] = '利用可能なプレイヤ';
$string['mediaformats_desc'] = 'これらの設定において、プレイヤが有効にされた場合、メディアフィルタ (有効にされた場合)、ファイルまたは埋め込みオプションを設定したURLリソースによって、ファイルを埋め込むことができます。有効にされていない場合、これらのフォーマットは埋め込まれません。同時にユーザは手動でダウンロードまたはこれらのリソースのリンクをたどることができます。

2つのプレイヤが同じフォーマットをサポートする場合、モバイルフォン等、異なるデバイスでの互換性が増します。単一のオーディオまたはビデオクリップに対して、異なるフォーマットのファイルを複数提供することにより、互換性を増すことができます。';
$string['mediasettings'] = 'メディア埋め込み';
$string['mp3audio'] = 'MP3オーディオ';
$string['mp3audio_desc'] = '拡張子*.mp3のファイルです。Flowplayerを使用して再生します。Flashプラグインを必要とします。';
