...
/**
 * Strings for component 'enrol_mnet', language 'ja', branch 'MOODLE_36_STABLE'
 *
 * @package   enrol_mnet
...
$string['error_multiplehost'] = 'このホストに関していくつかのMNet登録プラグインインスタンスがすでに存在しています。1ホストあたり1つのインスタンスのみ、または「すべてのホスト」が許可されます。';
$string['instancename'] = '登録方法名';
$string['instancename_help'] = 'あなたは任意でこのMNet登録方法のインスタンスをリネームすることができます。空白にした場合、リモートホストおよびあちらのユーザに割り当てられるロールを含むデフォルトのインスタンス名が使用されます。';
$string['mnet:config'] = 'MNet登録インスタンスを設定する';
$string['mnet_enrol_description'] = 'このサービスを公開することで、あなたのサーバに作成したコースに対して {$a} の管理者は自分の学生を登録することができます。
<br />
<ul>
...
<br />
このサービスに登録することで、あなたの学生を {$a} のコースに登録することができます。
<br />
<ul>
...
$string['privacy:metadata'] = 'ＭＮｅｔリモート登録プラグインはいかなる個人データも保存しません。';
