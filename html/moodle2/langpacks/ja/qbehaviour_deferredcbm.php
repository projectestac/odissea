...
/**
 * Strings for component 'qbehaviour_deferredcbm', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
確信のないことを認めることで、最高評点を取得することができます。例えばあなたが3つのうち1つ以上正しくないと思う場合、C=1と入力することでマイナス点のリスクを避けることができます。';
