...
$string['mustbeteacher'] = 'このページを閲覧するには、あなたは教師である必要があります。';
...
$string['remotedownloadnotallowed'] = 'あなたのサーバにコンポーネントをダウンロードすることができません (allow_url_fopenが無効です)。<br /><br /><a href="{$a->url}">{$a->url}</a>ファイルを手動でダウンロードして、サーバの「 {$a->dest} 」にコピーした後、解凍してください。';
...
$string['socksnotsupported'] = 'PHP4ではSOCKS5プロクシはサポートされていません。';
