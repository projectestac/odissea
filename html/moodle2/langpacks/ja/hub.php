...
$string['policyagreeddesc'] = '私はMoodle.netの<a href="{$a}" target="_blank">プライバシー通知およびデータ処理に関する同意書</a>に同意します。';
...
$string['unregisterexplained'] = 'URL {$a} のサイトがMoodle.netに登録されている場合、その登録は削除されます。';
