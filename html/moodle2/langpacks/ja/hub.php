...
/**
 * Strings for component 'hub', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   hub
...
$string['advertise'] = '人が参加できるようこのコースを公開する';
$string['advertised'] = '公開';
$string['advertiseon'] = 'このコースを {$a} で公開する';
$string['advertiseonhub'] = 'このコースをハブで公開する';
$string['advertiseonmoodleorg'] = 'このコースをmoodle.orgで公開する';
$string['advertisepublication_help'] = '人がこのコースを探して受講登録できるようコミュニティハブ上にあなたのコースを広告します。';
$string['all'] = 'すべて';
...
$string['notregisteredonhub'] = 'あなたのコースを公開する前に管理者は少なくとも1つのコースをハブに登録する必要があります。あなたのサイト管理者にご連絡ください。';
$string['notregisteredonmoodleorg'] = 'あなたの管理者はこのサイトをmoodle.orgに登録する必要があります。';
$string['operation'] = '操作';
$string['orenterprivatehub'] = '代わりに、プライベートハブのURLを入力してください:';
...
$string['privacy_help'] = 'ハブでは登録サイトを一覧表示することができます。ハブが登録サイトを公開している場合、あなたのサイトをリストに表示するかどうか選択することができます。';
$string['private'] = 'プライベート';
$string['privatehuburl'] = 'プライベートハブURL';
...
$string['registermoochtips'] = 'moodle.netに登録するためには、あなたのサイトがmoodle.orgに登録される必要があります。';
...
$string['selecthubforadvertise'] = '広告のためにハブを選択する';
$string['selecthubforsharing'] = 'アップロードのためにハブを選択する';
$string['selecthubinfo'] = 'コミュニティハブはコースを一覧表示するサーバです。このMoodleサイトが登録されているハブにのみ、あなたのコースを公開することができます。あなたが希望するハブが下記に表示されていない場合、あなたのサイト管理者にご連絡ください。';
$string['sendfollowinginfo'] = '詳細情報';
$string['sendfollowinginfo_help'] = '次の情報は全体的な統計のためだけに送信されます。送信された情報はサイト一覧に公開されることはありません。';
...
$string['sharepublication_help'] = 'このコースをコミュニティハブサーバにアップロードすることにより、人がダウンロードして自分のMoodleサイトにインストールできるようになります。';
...
$string['sitedesc'] = '説明';
$string['sitedesc_help'] = 'あなたのサイト説明がサイト一覧に表示されます。プレインテキストのみ使用してください。';
$string['siteemail'] = 'メールアドレス';
$string['siteemail_help'] = '必要に応じてサイト管理者が連絡できるようあなたはメールアドレスを提供する必要があります。このメールアドレスは他の目的に使用されることはありません。直接個人のメールアドレスではなく、役職に関係するメールアドレス (例: sitemanager@example.com) の入力をお勧めします。';
...
$string['siteregistrationemail_help'] = 'この設定を有効にした場合、あなたにセキュリティ問題等の重要な情報を知らせるため、ハブ管理者はメール送信することができます。';
...
$string['siteurl_help'] = 'URLはこのサイトのアドレスです。プライバシー設定にて人のサイトアドレス閲覧を許可している場合、このURLが使用されます。';
...
$string['url'] = 'ハブURL';
$string['urlalreadyregistered'] = 'あなたのサイトはすでにこのハブに登録されているようです。これは何らかの問題が生じたことを意味します。再度登録できるようハブ管理者にあなたの登録解除を申請してください。';
