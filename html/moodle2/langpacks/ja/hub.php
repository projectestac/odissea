...
$string['advertiseonhub'] = '人が参加できるようこのコースを共有する';
...
$string['errorotherhubsnotsupported'] = 'このページはMoodle.net以外のサイトへの登録には使用できません。';
...
$string['errorws'] = '{$a}';
$string['existingscreenshotnumber'] = '{$a} 件のスクリーンショットがあります。Moodle.net管理者があなたのコースを有効にした後、これらのスクリーンショットを閲覧することができるようになります。';
...
$string['selecthubinfo'] = 'コミュニティハブはコースを一覧表示するサーバです。このMoodleサイトが登録されているハブでのみあなたのコースを共有することができます。あなたの希望するハブが下記に表示されていない場合、あなたのサイト管理者にご連絡ください。';
...
$string['siteemail_help'] = '必要に応じてMoodle HQがあなたに連絡できるようメールアドレスを提供する必要があります。あなたが下記を許可する場合、このメールアドレスは他の目的に使用される場合があります。個人のメールアドレスではなく役職に関係する一般的なメールアドレス (例: sitemanager@example.com) の入力をお勧めします。';
...
$string['unregistrationerror'] = 'Moodle.netからのサイト登録解除中にエラーが発生しました: {$a}';
...
$string['url'] = 'ハブURL';
$string['urlalreadyregistered'] = 'あなたのサイトはすでにこのMoodle.netに登録されているようです。これは何らかの問題が生じたことを意味します。再度登録できるようMoodle.net管理者にあなたの登録解除を申請してください。';
...
$string['xmlrpcdisabledpublish'] = 'サーバでXML-RPC拡張モジュールが有効にされていません。あなたはコースを共有または共有済みコースを管理することができません。';
