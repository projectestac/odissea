...
あなたのパスワードを変更するには下記のウェブアドレスにアクセスしてください:
...
$string['existingstudents'] = '受講登録済み学生';
...
$string['frontpageenrolledcourselist'] = '受講登録済みコース';
...
<li type=disc>今後、受講登録したコースにアクセスするために必要なものは、ユーザ名とパスワードのみです。 このページの左側のユーザ名とパスワードの入力欄を利用してください。</li>
</ul>
</ol>';
...
$string['nostudentsyet'] = 'このコースにはまだ学生が受講登録されていません。';
...
$string['notenrolled'] = '{$a} はこのコースに受講登録されていません。';
$string['notenrolledprofile'] = 'コースに受講登録されていないため、このユーザのプロファイルを閲覧できません。';
...
$string['passwordforgotteninstructions2'] = 'パスワードをリセットするにはあなたのユーザ名またはメールアドレスを以下に入力してください。私たちがデータベース内であなたを探すことができた場合、再度アクセスするためのインストラクションを記載したメールをあなたのメールアドレス宛に送信します。';
...
$string['paymentthanks'] = 'お支払いありがとうございます! あなたは次のコースに受講登録されました:<br /> 「 {$a} 」';
...
$string['profilenotshown'] = 'このユーザが少なくとも1つのコースに受講登録されるまで、プロファイル自己紹介欄は表示されません。';
...
$string['youneedtoenrol'] = 'この操作を実行するにはあなたはこのコースに受講登録する必要があります。';
