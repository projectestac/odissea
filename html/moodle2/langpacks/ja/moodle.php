...
/**
 * Strings for component 'moodle', language 'ja', branch 'MOODLE_26_STABLE'
 *
 * @package   moodle
...
$string['addedtogroupnotenrolled'] = 'コースに受講登録されていないため、グループ「 {$a} 」に追加されませんでした。';
$string['addfilehere'] = 'ここにファイルを追加する';
...
$string['addlinkhere'] = 'ここにリンクを追加する';
...
$string['backupgradebookhistoryhelp'] = 'このオプションを有効にした場合、自動バックアップに評定履歴が含まれます。この機能を動作させるには、サーバ設定において評定履歴を無効 (disablegradehistory) にしてはならないことに留意してください。';
$string['backupincludemoduleshelp'] = '自動バックアップにおいて、コースモジュールにユーザデータを含めるかどうか選択してください。';
...
$string['backupsitefileshelp'] = 'このオプションを有効にした場合、コースで使用されたサイトファイルが自動バックアップに含まれます。';
$string['backuptakealook'] = 'あなたの次のバックアップログをご覧ください: {$a}';
$string['backupuserfileshelp'] = '自動バックアップにユーザファイル (例 プロファイルイメージ) を含めるかどうか選択してください。';
...
$string['categoriesandcoures'] = 'コースカテゴリおよびコース';
...
$string['city'] = '都道府県';
$string['clambroken'] = 'あなたの管理者がアップロードファイルに対するウイルスチェックを有効にしていますが、設定が正しくありません。<br />あなたのファイルは正常にアップロードされませんでした。あなたの管理者宛に対応するようメールが送信されました。<br />後ほどこのファイルのアップロードをお試しください。';
...
$string['clamlostandactinglikevirus'] = '加えて、MoodleはClamの動作失敗時にファイルをウイルスとして扱うよう設定されています。あなたが修正するまで、原則的に学生はファイルをアップロードできないことを意味します。';
$string['clammovedfile'] = 'あなたが指定した隔離用ディレクトリにファイルが移動されました。新しい保存場所は {$a} です。';
...
重要なクッキーはセッションクッキーで、通常MoodleSessionと呼ばれます。継続的にログインして各ページに移動するため、ブラウザをクッキー利用可にしてください。 ログアウトまたはブラウザを閉じた場合、(ブラウザとサーバの) クッキーは破棄されます。

もう1つのクッキーは純粋に便宜的な理由で使用され、通常 <b>MOODLEID と呼ばれます。このクッキーは、あなたのユーザ名をブラウザに憶えさせるために使用されます。これはあなたがサイトへ戻ったときに、ログインページにユーザ名が初めから入力されていることを意味します。このクッキーを拒否しても大丈夫です - しかし、ログイン時にあなたのユーザ名を毎回入力する必要があります。';
$string['cookiesnotenabled'] = '残念ですが、あなたのブラウザでは、クッキーの設定が有効にされていません。';
$string['copy'] = 'コピー';
...
$string['coursehelpnewsitemsnumber'] = 'コースページの最新ニュースブロック内に表示されるニュースフォーラムの最新アイテム数です。ゼロに設定した場合、最新ニュースボックスは表示されません。';
$string['coursehelpnumberweeks'] = 'コース内のセクション数です (特定のコースフォーマットのみに適用されます)。';
$string['coursehelpshowgrades'] = '評定表の表示を有効にします。個々の活動に関して、評定表の表示を抑制するものではありません。';
...
$string['courseoverviewfiles'] = 'コース概要ファイル';
$string['courseoverviewfilesext'] = 'コース概要ファイル拡張子';
$string['courseoverviewfiles_help'] = 'イメージのようなコース概要ファイルはコース概要と共に表示されます。';
$string['courseoverviewfileslimit'] = 'コース概要ファイル制限';
...
$string['dndenabled_inbox'] = 'ここにドラッグ＆ドロップして、ファイルを追加することができます。';
...
$string['dndworkingfile'] = 'コースにファイルをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
$string['dndworkingfilelink'] = 'コースにファイルまたはリンクをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
$string['dndworkingfiletext'] = 'コースにファイルまたはテキストをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
$string['dndworkingfiletextlink'] = 'コースにファイル、テキストまたはリンクをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
$string['dndworkinglink'] = 'コースにリンクをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
$string['dndworkingtext'] = 'コースにテキストをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
$string['dndworkingtextlink'] = 'コースにテキストまたはリンクをアップロードするには、コースセクションにドラッグ＆ドロップしてください。';
...
$string['duplicate'] = '複製';
$string['duplicateconfirm'] = '本当に {$a->modtype} 「 {$a->modname} 」を複製してもよろしいですか?';
$string['duplicatecontcourse'] = 'コースに戻る';
$string['duplicatecontedit'] = '新しいコピーを編集する';
$string['duplicatesuccess'] = '{$a->modtype} 「 {$a->modname} 」が正常に複製されました。';
...
$string['edhelpfontfamily'] = 'フォントファミリ属性はフォントファミリの一覧および一般的なフォントファミリ名です。フォントファミリ名はカンマで区切ってください。';
...
$string['editorcleanonpaste'] = 'ペースト時にWord HTMLを削除する';
...
<p>サイト管理者にご連絡ください。</p>';
$string['emailpasswordconfirmnotsent'] = '<p>あなたが提供したユーザ詳細では、既存のユーザアカウントを特定できません。</p>
<p>あなたが入力した情報を確認して、再度お試しください。問題が持続する場合、サイト管理者にご連絡ください。</p>';
...
$string['filetoolarge'] = '- アップロードするには大きすぎます。';
...
$string['frontpagedescriptionhelp'] = 'この概要は「コース/サイト概要」ブロックを使用してフロントページに表示すること、またはフロントページのトピックセクションに含むことができます。';
...
$string['grade'] = '評点';
$string['grades'] = '評定';
$string['gravatarenabled'] = 'このサイトでは<a href="http://www.gravatar.com/">Gravatar</a>が有効にされています。あなたがプロファイル写真をアップロードしていない場合、MoodleはGravatarよりプロファイル写真の取得を試みます。';
$string['group'] = 'グループ';
...
$string['hiddensections_help'] = 'ここでは学生に非表示セクションを折りたたんだ形で (恐らくウィークリーフォーマットのコースで休日を示すため)　表示するか、完全に隠すか指定します。';
...
$string['loginaspasswordexplain'] = '<p>この機能を使用するには、特別な「ログインパスワード」を入力する必要があります。<br />パスワードが分からない場合、サーバ管理者にお聞きください。</p>';
...
$string['maxbytesforfile'] = 'ファイル「 {$a} 」が最大許容サイズを超えています。';
...
$string['maxnumberweeks_desc'] = 'ドロップダウンメニューに表示されるセクション数の最大値です (特定のコースフォーマットのみに適用されます)。';
...
$string['maxsizeandattachments'] = '新しいファイルの最大サイズ: {$a->size} / 最大添付: {$a->attachments}';
$string['maxsizeandattachmentsandareasize'] = '新しいファイルの最大サイズ: {$a->size} - 最大添付数: {$a->attachments} - 全体の制限: {$a->areasize}';
...
$string['modchooserdisable'] = '活動チューザ OFF';
$string['modchooserenable'] = '活動チューザ ON';
...
$string['mustconfirm'] = 'あなたのログイン情報を確認してください。';
...
パスワードを変更する場合は、次のページにアクセスしてください:
...
$string['newpicture_help'] = '新しい画像を追加するには、イメージ (JPGまたはPNGフォーマット) を閲覧および選択して「プロファイルを更新する」をクリックしてください。イメージは正方形にトリミングおよび100x100ピクセルにリサイズされます。';
$string['newsitem'] = 'ニュースアイテム';
$string['newsitems'] = 'ニュースアイテム';
$string['newsitemsnumber'] = 'ニュースアイテムの表示件数';
$string['newsitemsnumber_help'] = 'この設定ではコースページの最新ニュースブロックに、何件の最新項目を表示するか設定します。「0 件のニュースアイテムを表示する」を選択した場合、最新ニュースブロックは表示されません。';
...
$string['notifyloginfailuresmessagestart'] = '前回、あなたに通知されて以来の {$a} におけるログイン失敗一覧です。';
$string['notifyloginfailuressubject'] = '{$a} :: ログイン失敗通知';
$string['notincluded'] = 'バックアップ対象外';
$string['notingroup'] = '申し訳ございません、この活動を閲覧するためには、あなたはグループに属している必要があります。';
...
$string['pageshouldredirect'] = 'このページは自動的にリダイレクトされます。何も起こらない場合、下記の「続ける」リンクをクリックしてください。';
...
$string['paymentinstant'] = '下のボタンをお使いください。お支払いおよび受講登録がすぐに完了します!';
...
$string['policyaccept'] = '私は内容を理解および同意します。';
$string['policyagree'] = 'このサイトを継続して利用するには、あなたは使用許諾に同意する必要があります。同意しますか?';
...
$string['publicsitefileswarning3'] = '注意: ここに置いたファイルはURLを知っている (または推測できる) 誰でもアクセスすることができます。<br />セキュリティ上の理由から、バックアップファイルは安全なbackupdataフォルダのみに保存してください。';
$string['publish'] = '公開';
$string['question'] = '問題';
...
$string['registrationyes'] = 'はい、私に重要事項を通知してください';
$string['reject'] = '拒否';
...
$string['resetinfo'] = 'このページでは活動および他の設定を保持しながら、コースのユーザデータを空にすることができます。下記アイテムを選択して、このページを実行することにより、このコースから選択されたユーザデータが完全に削除されますので注意してください!';
...
$string['resortbyfullname'] = 'フルネーム順';
$string['resortbyidnumber'] = 'IDナンバー順';
$string['resortbyshortname'] = '省略名順';
$string['resortcourses'] = 'コースを並べ替える';
$string['resortsubcategoriesbyidnumber'] = 'サブカテゴリをIDナンバーで並べ替える';
$string['resortsubcategoriesbyname'] = 'サブカテゴリを名称で並べ替える';
...
$string['rsskeyshelp'] = 'セキュリティおよびプライバシーを保証するため、RSSフィードURLにはユーザを識別するための特別なトークンを含みます。これにより、RSSフィード経由でアクセスできないMoodleエリアにユーザがアクセスすることを防ぎます。</p><p>このトークンはMoodleがRSSフィードを生成する場所にあなたが初回アクセスした時点で自動的に作成されます。あなたがRSSフィードトークンに問題があると感じた場合、リセットリンクをクリックすることで新しいトークンをリクエストすることができます。この場合、あなたの現在のRSSフィードURLが無効になることに留意してください。';
...
$string['scalestip'] = 'カスタム評価尺度を作成するには、コース管理メニューにある「評価尺度..」を使用してください。';
$string['scalestip2'] = 'カスタム評価尺度を作成するには、コース管理メニューにある「評定」リンクをクリックした後、「評価尺度」を選択してください。';
...
$string['searchhelp'] = '<p>あなたは同時に複数の言葉で探すことができます。:</p>
<ul>
<li>単語 : テキストの中に含まれる単語を探します。</li>
<li>+単語 : 合致する単語を検索します。</li>
<li>-単語 : この単語を含まない検索をします。</li>
</ul>';
...
$string['selectmoduletoviewhelp'] = 'ヘルプを表示するには、活動またはリソースを選択してください。
...
$string['setpasswordinstructions'] = 'あなたの新しいパスワードを以下に入力および再入力した後、「パスワードを設定する」をクリックしてください。<br />あなたの新しいパスワードが保存され、ログインします。';
$string['settings'] = '設定';
...
$string['showdescription_help'] = 'このオプションを有効にした場合、上記説明文がコースページ内の活動またはリソースのリンクの下に表示されます。';
...
$string['sortcategoriesbyidnumber'] = 'カテゴリをIDナンバーで並べ替える';
$string['sortcategoriesbyname'] = 'カテゴリを名称で並べ替える';
$string['sortcoursesbyfullname'] = 'コースをフルネームで並べ替える';
$string['sortcoursesbyidnumber'] = 'コースをIDナンバーで並べ替える';
$string['sortcoursesbyshortname'] = 'コースを省略名で並べ替える';
$string['sorting'] = '並べ替え';
...
$string['switchrolereturn'] = '私の通常ロールに戻る';
...
$string['tocreatenewaccount'] = '新しいアカウント作成をスキップする';
$string['today'] = '本日';
...
$string['uploadlimitwithsize'] = '{$a->contextname} アップロード制限 ({$a->displaysize})';
...
$string['usemessageform'] = 'または、下記フォームを使用して、選択した学生にメッセージを送信してください。';
$string['user'] = 'ユーザ';
...
$string['virusfoundlater'] = '{$a->date} に {$a->filename} というファイル名でコース {$a->course} にあなたがアップロードしたファイルにウイルスが発見されました。以下、あなたのファイルに対して実施された処理の概要です:

{$a->action}

これが提出した課題の場合、あなたの教師が閲覧できるよう再度提出してください。';
$string['virusfoundlateradmin'] = '管理者の方! {$a->date} に{$a->filename} というファイル名でコース {$a->course} へユーザ {$a->user} によってアップロードされたファイルにウイルスが発見されました。以下、ファイルに対して実施された処理の概要です:
...
* 共通ノートを追加する - 1名以上の参加者に同じノートを追加します。';
