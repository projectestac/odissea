...
$string['clamfailed'] = 'Clam AVの起動に失敗しました。 エラーメッセージは {$a} です。Clamからの出力結果は次のとおりです:';
$string['clamlost'] = 'Moodleはファイルアップロード時にclamが動作するよう設定されていますが、Clam AVのパス {$a} が正しくありません。';
...
$string['deletecategorycheck'] = '本当にこのカテゴリ<b>「 {$a} 」</b>を完全に削除してもよろしいですか? 親カテゴリがある場合、このカテゴリ内すべてのコースが親カテゴリに移動されます。親カテゴリが無い場合、その他のカテゴリに移動されます。';
...
$string['youneedtoenrol'] = 'この操作を実行するには、あなたは、このコースに受講登録する必要があります。';
