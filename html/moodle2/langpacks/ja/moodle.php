...
$string['backupgradebookhistoryhelp'] = 'この設定を有効にした場合、自動バックアップに評定履歴が含まれます。この機能を動作させるには、サーバ設定において評定履歴を無効 (disablegradehistory) にしてはならないことに留意してください。';
...
$string['english'] = '英語';
$string['enrolmentmethods'] = '受講登録方法';
