...
/**
 * Strings for component 'repository_flickr_public', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['flickr_public:view'] = 'ファイルピッカ内のFlickrパブリックリポジトリを使用する';
...
$string['modification'] = '私の作品の修正を許可します';
