...
$string['namenews_help'] = 'コースアナウンスメントフォーラムはアナウンスメントのための特別なフォーラムです。コース作成時に自動手的に作成されます。コースには1つのアナウンスメントフォーラムのみ設置することができます。教師および管理者のみアナウンスメントを投稿することができます。「最新アナウンスメント」ブロックでは最新のアナウンスメントを表示します。';
...
$string['postmailinfolink'] = 'これは {$a->coursename} に投稿された記事のコピーです。
