...
$string['cannotaddsubscriber'] = 'このフォーラムにID {$a} のメール購読ユーザを追加できませんでした!';
...
$string['cannotcreateinstanceforteacher'] = '教師用フォーラムに対して新しいコースモジュールインスタンスを作成できませんでした。';
...
$string['cannotremovesubscriber'] = 'このフォーラムからID {$a} のメール購読ユーザを削除できませんでした!';
...
$string['configenabletimedposts'] = '新しいフォーラムディスカッションの表示期間の設定を許可したい場合、「Yes」を選択してください  (完全にテストされていないため、実験用です)。';
...
$string['digestsentusers'] = '正常にメールダイジェストが {$a} 名のユーザに送信されました。';
...
$string['discussionsubscribestart'] = 'このディスカッションの投稿のコピーを私にメール送信してください';
$string['discussionsubscribestop'] = 'このディスカッションの投稿のコピーを私にメール送信しないでください';
...
$string['existingsubscribers'] = '既存のメール購読ユーザ';
...
$string['forumtracked'] = '現在、投稿は未読管理されています。';
$string['forumtrackednot'] = '現在、投稿は未読管理されていません。';
...
$string['mailnow'] = '今すぐメール送信する';
$string['manydiscussions'] = '1ページあたりのディスカッション数';
$string['markalldread'] = 'このディスカッションの投稿すべてを既読にする。';
$string['markallread'] = 'このフォーラムの投稿すべてを既読にする。';
...
$string['messageinboundfilesizeexceeded'] = '合計添付サイズ ({$a->filesize}) がフォーラムで許可された最大サイズ ({$a->maxbytes}) を超えているため、あなたの返信を投稿することはができません。';
$string['messageinboundforumhidden'] = '現在、フォーラムは利用できないため、あなたの返信を投稿することはできません。';
...
$string['namenews_help'] = 'ニュースフォーラムは、サイトのそれぞれのコースおよびフロントページに自動的に作成される全般的なお知らせ用のフォーラムです。1コースあたり1つのニュースフォーラムのみ設置されます。教師および管理者のみ新しいフォーラムに投稿することができます。「最新ニュース」ブロックではニュースフォーラムから最新のディスカッションを表示します。';
...
$string['replies'] = '返信';
$string['repliesmany'] = '返信数: {$a}';
$string['repliesone'] = '返信数: {$a}';
$string['reply'] = '返信';
...
$string['resettrackprefs'] = 'フォーラムの未読管理プリファレンスすべてを削除する';
...
$string['subscribeall'] = '全員のメール購読を登録する';
...
$string['subscribenone'] = '全員のメール購読を解除する';
...
$string['unsubscribeallconfirm'] = '現在、あなたは {$a->forums} 件のフォーラムおよび {$a->discussions} 件のディスカッションをメール購読しています。本当にすべてのフォーラムおよびディスカッションのメール購読を解除して、フォーラム自動メール購読を無効にしてもよろしいですか?';
