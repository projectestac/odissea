...
/**
 * Strings for component 'admin', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   admin
...
$string['confignavcourselimit'] = 'ここではユーザが未ログインまたはコースに受講登録されていない場合に表示されるコース数を制限します。';
$string['confignavshowallcourses'] = 'ここではコースに受講登録されているユーザがナビゲーション内にコース (すべてのコース一覧) およびマイコース (受講登録しているコース一覧) を閲覧できるかどうか決定します。';
$string['confignavshowcategories'] = 'ナビゲーションバーおよびナビゲーションブロックにコースカテゴリを表示します。この設定変更は現在ユーザが受講登録しているコースには反映されません。これらのコースでのナビゲーションバーおよびナビゲーションブロックはカテゴリなしのマイコース下に表示されます。';
...
$string['configprofilesforenrolledusersonly'] = 'スパム送信者による乱用を避けるため、コースに受講登録されていないユーザに関するプロファイルの自己紹介欄が非表示にされます。プロファイルの自己紹介欄にコンテンツを追加するには新しいユーザは少なくとも1つのコースに受講登録する必要があります。';
...
$string['configstatsuserthreshold'] = 'この設定では統計計算に含まれるコースの受講登録済みユーザ最少数を指定します。';
...
$string['guestroleid_help'] = 'このロールは自動的にゲストユーザに割り当てられます。また、パスワードなしで受講できるコースにゲスト受講登録プラグイン経由で入ったユーザに対しても一時的に割り当てられます。';
...
$string['navexpandmycourses'] = 'マイホームにマイコースを展開表示する';
$string['navexpandmycourses_desc'] = 'この設定を有効にした場合、最初からマイホームのナビゲーションブロックにマイコースが展開表示されます。';
...
$string['pleaserefreshregistration'] = 'あなたのサイトがmoodle.orgに登録されました。あなたはいつでも登録を手動で更新することができます。デフォルトでは、定期的にあなたの更新を「サイト登録」スケジュールタスクが自動更新します。';
...
$string['profilesforenrolledusersonly'] = 'プロファイルを受講登録済みユーザのみに表示する';
...
$string['taskcompletioncron'] = '完了データを計算する';
...
$string['taskplagiarismcron'] = '盗作プラグインのバックグラウンド処理';
