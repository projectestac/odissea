...
$string['maxtimelimit_desc'] = 'Moodleが許可するPHP最大実行時間を出力表示なしで制限するには、ここに値 (秒) を入力してください。ゼロはMoodleのデフォルト制限が使用されることを意味します。あなたが独自の制限時間を持ったフロントエンドサーバを使用する場合、この値を低くすることでPHPエラーをログに受け付けることになります。CLIスクリプトには適用されません。';
