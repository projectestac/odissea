...
$string['configproxytype'] = 'ウェブプロクシのタイプです (SOCKS5をサポートするにはPHP5およびcURL拡張モジュールが必要です)。';
...
$string['pathtogs_help'] = 'ほとんどのLinuxインストールの場合、ここは「/usr/bin/gs」のままにしてください。Windowsでは「c:gsbingswin32c.exe」のようになります (パスの間にスペースがないことを確認してください - 必要であれば、ファイル「gswin32c.exe」および「gsdll32.dll」をパス内にスペースを入れずに新しいフォルダにコピーしてください)。';
