...
$string['clickflag'] = '問題にフラグする';
$string['clicktoflag'] = '将来的な参照のため、この問題にフラグします。';
...
$string['flagthisquestion'] = 'この問題にフラグする';
...
* 評点が一覧に無い場合、エラーにする - 一覧に無い評点が問題に含まれている場合、エラーが表示され、その問題はインポートされません。
* 評点が一覧に無い場合、最も近い評点を使用する - 一覧に無い評点が問題に含まれている場合、評点は一覧の中で一番近い値に変更されます。';
