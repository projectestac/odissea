...
/**
 * Strings for component 'tool_cohortroles', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['assign'] = '割り当て';
$string['assignroletocohort'] = 'すべてのコーホートメンバーにユーザコンテクストロールを割り当てる';
...
$string['existingcohortroles'] = '既存のコーホートロール割り当て';
$string['managecohortroles'] = 'ユーザロールをコーホートに割り当てる';
$string['noassignableroles'] = '現在、ユーザコンテクストで割り当てることのできるロールはありません。<a href="../../roles/manage.php">ロールを管理する</a>';
...
$string['removecohortroleassignmentconfirm'] = '本当にこのコーホートロール割り当てを削除してもよろしいですか? このユーザのロールが他のすべてのユーザコンテクストで削除されます。';
$string['selectcohorts'] = 'コーホートを選択する';
$string['selectrole'] = 'ロールを選択する';
$string['selectusers'] = 'ロールを割り当てるユーザを選択する';
$string['taskname'] = 'コーホートロール割り当てを同期する';
$string['thisuserroles'] = 'このユーザに関連するロール割り当て';
