...
$string['oauth2upgrade_message_content'] = 'Moodle 2.3へのアップグレードの一環として、Google Driveリポジトリプラグインは無効にされました。プラグインを再度有効にするにはクライアントIDおよび秘密鍵を取得するため、ドキュメンテーション「 {$a->docsurl} 」に記述されているようにあなたのサイトをGoogleに登録する必要があります。クライアントIDおよび秘密鍵はすべてのGoogle DriveおよびPicasaプラグイン設定に使用することができます。';
