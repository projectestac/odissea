...
/**
 * Strings for component 'cachestore_file', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['prescan_help'] = 'この設定を有効にした場合、キャッシュが最初に使用され、スキャンデータに対してファイルリクエストが最初にチェックされる時点でディレクトリがスキャンされます。あなたが遅いファイルシステムを使用してファイル処理がボトルネックを発生させている場合、これは役に立ちます。';
