...
$string['advanced:clipboard_msg'] = 'コピー/切り取り/貼り付けはMozillaおよびFirefoxでは使用できません。この件に関して、詳細情報を閲覧しますか?';
...
$string['advanced_dlg:image_title'] = 'イメージの挿入/編集';
...
$string['advanced:image_desc'] = 'イメージの挿入/編集';
...
$string['advanced:toolbar_focus'] = 'ツールボタンへジャンプ - 「Alt+Q」、エディタにジャンプする - 「Alt-Z」、エレメントパスにジャンプする - 「Alt-X」';
...
$string['advimage_dlg:dialog_title'] = 'イメージの挿入/編集';
...
$string['advimage:image_desc'] = 'イメージの挿入/編集';
...
$string['common:clipboard_msg'] = 'コピー/切り取り/貼り付けはFirefoxおよびMozillaでは使用できません。この件に関して、詳細情報を閲覧しますか?';
...
$string['media_dlg:preload'] = 'プリロードする';
...
$string['media_dlg:qt_stream_warn'] = 'RTSPストリーミングリソースを高度な設定タブのQTソースフィールドに入力してください。ソースフィールドにはストリーミングではないバージョーンを入力してください。';
...
$string['media_dlg:swstretchstyle'] = '伸縮スタイル';
...
$string['paste_dlg:text_title'] = 'ウィンドウにテキストを貼り付けるには、あなたのキーボードの「CTRL+V」を使用してください。';
$string['paste_dlg:word_title'] = 'ウィンドウにテキストを貼り付けるには、あなたのキーボードの「CTRL+V」を使用してください。';
$string['paste:paste_text_desc'] = 'プレインテキストとして貼り付ける';
$string['paste:paste_word_desc'] = 'Wordから貼り付け';
$string['paste:plaintext_mode'] = '現在、ペーストはプレインテキストモードです。通常ペーストモードに戻るには、再度クリックしてください。あなたが何かを貼り付けた場合、通常ペーストモードに戻ります。';
$string['paste:plaintext_mode_stick'] = '現在、ペーストはプレインテキストモードです。通常ペーストモードに戻るには、再度クリックしてください。';
...
$string['save:cancel_desc'] = 'すべての変更を破棄';
...
$string['searchreplace_dlg:replaceall'] = 'すべて置換';
...
$string['style_dlg:title'] = 'CSSスタイル編集';
...
$string['table_dlg:cell_col'] = 'カラム内のセルすべてを更新する';
