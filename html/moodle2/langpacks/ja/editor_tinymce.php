...
/**
 * Strings for component 'editor_tinymce', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['advanced:bullist_desc'] = '番号なしリストを挿入/編集する';
...
$string['advanced:custom1_desc'] = 'ここにあなたの説明を入力してください。';
...
$string['advanced_dlg:colorpicker_picker_tab'] = 'ピッカー';
...
$string['advanced_dlg:link_target_blank'] = '新しいウィンドウで開く';
$string['advanced_dlg:link_target_same'] = '同じウィンドウで開く';
...
$string['advanced:numlist_desc'] = '番号つきリストを挿入/削除する';
...
$string['advimage_dlg:example_img'] = '概観プレビューイメージ';
...
$string['advlink_dlg:popup_location'] = 'アドレスバーを表示する';
...
$string['autosave:restore_content'] = '自動保存コンテンツをリストアします。';
$string['autosave:unload_msg'] = 'このページから他のページへ移動した場合、あなたの編集内容は破棄されます。';
...
$string['common:clipboard_msg'] = 'コピー/切り取り/貼り付けはFirefoxおよびMozillaでは使用できません。この件に関して詳細情報を閲覧しますか?';
$string['common:clipboard_no_support'] = '現在、あなたのブラウザでは対応していません。代わりにキーボードのショートカットキーをお使いください。';
$string['common:close'] = '閉じる';
$string['common:edit_confirm'] = 'このテキストエリアでWYSIWYGモードに切り替えますか?';
...
$string['customtoolbar_desc'] = 'それぞれの行にはカンマで区切られたボタン名一覧を含みます。グループのセパレータにはラップ (wrap) を使用してください。空白行は無視されます。デフォルトのTinyMCEのボタンに関して<a href="{$a}" target="_blank">{$a}</a>をご覧ください。<br />2番目および3番目のツールバーの可視性は切り替え可能であるのに対して、最初の行は常に表示されます。';
...
$string['searchreplace_dlg:notfound'] = '検索を完了しました。検索文字列が見つかりませんでした。';
...
$string['simple:numlist_desc'] = '番号つきリストを挿入/削除する';
...
$string['spellchecker:learn_word'] = '言葉を学習する';
...
$string['table:col'] = '列';
$string['table:col_after_desc'] = '列を後に挿入する';
$string['table:col_before_desc'] = '列を前に挿入する';
$string['table:copy_row_desc'] = 'テーブル行をコピーする';
$string['table:cut_row_desc'] = 'テーブル行を切り取る';
$string['table:del'] = 'テーブルを削除する';
$string['table:delete_col_desc'] = '列を削除する';
...
$string['table_dlg:cell_title'] = 'テーブルセルのプロパティ';
...
$string['table_dlg:missing_scope'] = '本当にこのテーブルのヘッダセルのスコープを設定せずに続けてもよろしいですか? スコープがない場合、障害のあるユーザに関して、テーブルに表示されるコンテンツまたはデータの理解が難しくなる可能性があります。';
...
$string['table_dlg:row_title'] = 'テーブル行のプロパティ';
...
$string['table:row_desc'] = 'テーブル行のプロパティ';
...
$string['visualchars:desc'] = '制御文字を表示/非表示にする';
...
$string['xhtmlxtras_dlg:attribs_title'] = '属性を挿入/削除する';
...
$string['xhtmlxtras_dlg:title_del_element'] = 'エレメントを削除する';
$string['xhtmlxtras_dlg:title_ins_element'] = 'エレメントを挿入する';
