...
$string['beepnewmessage'] = '通知のポップアップ時に音を鳴らす';
...
$string['keywordssearchresultstoomany'] = '検索結果: {$a} 件以上のメッセージが見つかりました。あなたの検索を見直してください。';
...
$string['managemessageoutputs'] = 'メッセージアウトプット管理';
...
$string['noreply'] = 'このメッセージには返信しないでください。';
...
$string['outputdisabled'] = '出力無効';
$string['outputdoesnotexist'] = 'メッセージアウトプットがありません。';
$string['outputenabled'] = '出力有効';
