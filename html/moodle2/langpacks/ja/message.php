...
$string['addtoyourcontacts'] = 'あなたのコンタクトに追加する';
$string['ago'] = '{$a} 前';
...
$string['deleteallconfirm'] = '本当にこの会話すべてを削除してもよろしいですか?';
...
$string['newmessagesearch'] = '新しいメッセージを送信する連絡先を選択または検索してください。';
...
$string['notificationpreferences'] = '通知プリファレンス';
...
$string['removefromyourcontacts'] = 'あなたのコンタクトから削除する';
...
$string['togglemessagemenu'] = 'メッセージメニューに切り替える';
...
$string['viewinganotherusersmessagearea'] = 'あなたは別のユーザのメッセージエリアを表示しています。';
