...
/**
 * Strings for component 'table', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   table
...
$string['downloadas'] = 'テーブルデータをダウンロードする: {$a->formatsmenu} {$a->downloadbutton}';
$string['downloadcsv'] = 'CSVテキストファイル';
