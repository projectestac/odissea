...
/**
 * Strings for component 'logstore_database', language 'ja', branch 'MOODLE_28_STABLE'
 *
...
$string['filters_help'] = '記録から行動を除外するフィルタを有効にします。';
...
$string['read'] = '閲覧';
$string['tablenotfound'] = '指定されたテーブルが見つかりませんでした。';
$string['teaching'] = '教える';
