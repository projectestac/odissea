...
/**
 * Strings for component 'enrol_meta', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   enrol_meta
...
$string['syncall'] = 'すべての受講登録済みユーザを同期する';
$string['syncall_desc'] = 'この設定を有効にした場合、親コースにロールがない場合でも受講登録済みユーザすべてが同期されます。この設定を無効にした場合、少なくとも1つの同期ロールが割り当てられているユーザのみ、子コースに受講登録されます。';
