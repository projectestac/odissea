...
/**
 * Strings for component 'workshopallocation_scheduled', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['currentstatusnext_help'] = '場合によっては、すでに実行された後でも割り当てが自動的にスケジュールされることがあります。例えば提出終了日時が延長された場合にこのような処理が発生します。';
