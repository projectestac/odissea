...
/**
 * Strings for component 'workshopallocation_scheduled', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'スケジュール割り当てプラグインはいかなる個人データも保存しません。誰が誰を評価したかという実際の個人データはワークショップモジュール自体に保存されます。データは評価詳細をエクスポートすることを目的として整形されます。';
