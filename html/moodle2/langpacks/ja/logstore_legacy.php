...
$string['loglegacy_help'] = 'このプラグインではログデータをレガシーログテーブル (mdl_log) に記録します。この機能は新しく効率の良いロギングプラグインに置き換えられました。そのため、あなたが古いログテーブルを直接参照している古いカスタムレポートを使用している場合のみ、このプラグインを動作させてください。レガシーログに書き込むことによりロードを増やすことになるため、パフォーマンスの理由から、必要で無い場合はこのプラグインを無効にしてください。';
