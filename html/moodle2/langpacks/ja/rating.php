...
/**
 * Strings for component 'rating', language 'ja', branch 'MOODLE_31_STABLE'
 *
 * @package   rating
...
$string['rolewarning_help'] = '評価を送信するためには、ユーザは「moodle/rating:rate」ケイパビリティおよび活動個別のケイパビリティが必要です。次のロールが割り当てられたユーザはアイテムを評価することができます。このロールのリストは管理ブロック内のパーミッションリンク経由で修正することができます。';
