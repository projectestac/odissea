...
/**
 * Strings for component 'tool_lpimportcsv', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'コンピテンシーフレームワークをインポートするプラグインはどのような個人データも保存しません。';
...
$string['scaleconfiguration'] = '尺度設定';
