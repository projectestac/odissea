...
/**
 * Strings for component 'availability_grade', language 'ja', branch 'MOODLE_28_STABLE'
 *
...
$string['requires_max'] = 'あなたが <strong>{$a}</strong> の適切な評点を取得してる場合';
...
$string['requires_range'] = 'あなたが <strong>{$a}</strong> の特定の評点を取得してる場合';
$string['title'] = '評点';
