...
$string['showonlyactiveenrol_help'] = 'この設定では評定表レポート内で有効な受講登録済みユーザのみを表示するかどうか決定します。この設定を有効にした場合、一時停止したユーザは評定表内に表示されません。';
...
$string['showrank_help'] = 'それぞれの評定項目に関して、クラス内のユーザの位置を表示するかどうか指定してください。';
