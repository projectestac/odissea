...
$string['aggregationcoefextrasum_help'] = '追加点チェックボックスがチェックされた場合、評定項目の最大評点はカテゴリの最大評点に追加されません。結果として、すべての評定項目の最大評点に到達達することなくカテゴリの最大評点 (またはサイト管理者が有効にした場合、最大評点を超えた値) に到達することができるようになります。';
...
隠す場合、非表示項目は除外されます。表示または非表示に係わらず、教師は常に項目すべての計算された合計を閲覧することができるため、この場合、教師に表示される合計は異なります。非表示項目を含む場合、学生は非表示項目も計算することができます。';
