...
$string['aggregationcoefextra_help'] = '総計において、「自然」または「評点の単純加重平均」および追加点チェックボックスがチェックされた場合、評定項目の最大評点はカテゴリの最大評点に追加されません。結果として、すべての評定項目の最大評点に到達することなくカテゴリの最大評点に到達することができるようになります。 サイト管理者が最大評点を超えた評点を有効にした場合、評点は最大評点を越す可能性があります。
...
$string['aggregationcoefextrasum_help'] = '追加点チェックボックスがチェックされた場合、評定項目の最大評点はカテゴリの最大評点に追加されません。結果として、すべての評定項目の最大評点に到達達することなくカテゴリの最大評点 (または、サイト管理者が有効にした場合、最大評点を超えた値) に到達することができるようになります。';
