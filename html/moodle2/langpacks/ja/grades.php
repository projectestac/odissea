...
$string['aggregationcoefextrasum_help'] = '追加点チェックボックスがチェックされた場合、評定項目の最大評点はカテゴリの最大評点に追加されません。結果として、すべての評定項目の最大評点に達することなくカテゴリの最大評点 (または、サイト管理者が有効にした場合、最大評点を超えた値) に到達することができるようになります。';
...
$string['includescalesinaggregation_help'] = 'あなたはすべてのコースのすべての評定表を通して、評価尺度がすべての総合評点に数として含まれるかどうか変更することができます。注意: この設定を変更することで、すべての総合評点は強制的に再計算されます。';
...
$string['overridden'] = 'オーバーライド (優先)';
$string['overridden_help'] = 'この設定が有効にされた場合、関連した活動内で評点が変更されないようになります。
...
$string['overridesitedefaultgradedisplaytype'] = 'サイトデフォルトをオーバーライド (優先) する';
...
$string['rangesdecimalpoints_help'] = 'この設定ではそれぞれの範囲に表示する小数点以下桁数、またはカテゴリ全体または評定項目の小数点設定を使用 (I継承) するか決定します。';
