...
/**
 * Strings for component 'tool_templatelibrary', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'テンプレートライブラリプラグインはいかなる個人データも保存しません。';
$string['search'] = '検索';
