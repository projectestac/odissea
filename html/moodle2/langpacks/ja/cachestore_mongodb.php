...
/**
 * Strings for component 'cachestore_mongodb', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['extendedmode_help'] = 'この設定を有効にした場合、プラグインとの連携にフルキーセットが使用されます。現在のところ、内部的には使用されませんが、あなたは簡単にMongoDBプラグインを検索および調査することができます。この設定を有効にすることで、少しだけ負荷が増大します。そのため、あなたが必要な場合のみ有効にしてください。';
...
$string['usesafevalue_help'] = 'あなたはsafeオプションの使用に関して、特定の値を指定することができます。ここでは完了したとみなされる前に処理を完了する必要のあるサーバ数を決定します。';
