...
$string['installexception'] = 'プラグインのインストール中にエラーが発生しました。エラーに関する詳細を表示するには、デバッグモードを有効にしてください。';
...
$string['remoterequestpluginfoexception'] = 'プラグイン {$a->name} ({$a->component}) バージョン {$a->version} の情報取得中にエラーが発生しました。プラグインをインストールすることはできません。エラーに関する詳細情報を閲覧するには、デバッグモードを有効にしてください。';
