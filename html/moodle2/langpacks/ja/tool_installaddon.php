...
/**
 * Strings for component 'tool_installaddon', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['installfromzipfile_help'] = 'ZIPパッケージにはプラグイン名と一致するディレクトリ1つのみ含む必要があります。ZIPはプラグインタイプに適切な場所に解凍されます。Moodleプラグインディレクトリからダウンロードした場合、パッケージはこの形式になっています。';
...
$string['installfromziptype_help'] = 'コンポーネント名が正しく宣言されているプラグインでは、インストーラが自動的にプラグインタイプを検出することができます。自動検出が失敗した場合、正しいプラグインタイプを手動選択してください。注意: 正しくないプラグインタイプが指定された場合、インストール処理が失敗する可能性があります。';
