...
$string['enrolstartdate_help'] = 'この設定を有効にした場合、ユーザはこの日以降のみ受講登録することができます。';
...
$string['status_help'] = '「新しい受講登録を許可する」を無効にした上でこの設定を有効にした場合、事前に自己登録したユーザのみコースにアクセスすることができます。この設定を無効にした場合、既存の自己登録は利用停止されて新しいユーザは自己登録できなくなるため、この自己登録方法は効果的に無効にされます。';
