...
/**
 * Strings for component 'grading', language 'ja', branch 'MOODLE_31_STABLE'
 *
 * @package   grading
...
$string['searchtemplate_help'] = 'あなたは評定フォームを検索して、新しいフォームのテンプレートとしてここで使用することができます。フォーム名、説明またはフォーム本文に使われている単語を入力してください。言葉を検索するには検索後を二重引用符 (") で囲んでください。
