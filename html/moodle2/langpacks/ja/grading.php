...
/**
 * Strings for component 'grading', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   grading
...
$string['formnotavailable'] = '高度な評定方法が選択されましたが、現在のところ評定フォームを利用できません。管理ブロック内のリンクを使用して、最初に評定フォームを定義してください。';
...
$string['searchtemplate_help'] = 'あなたは評定フォームを検索して、新しいフォームのテンプレートとしてここで使用することができます。フォーム名、説明またはフォーム本文に使われている単語を入力してください。言葉を検索するには、検索後を二重引用符 (") で囲んでください。
