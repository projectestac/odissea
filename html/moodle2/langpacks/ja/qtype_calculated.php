...
$string['addmoreanswerblanks'] = 'さらに答えの入力欄を追加する';
...
$string['atleastoneanswer'] = 'あなたは少なくとも1つの答えを入力する必要があります。';
...
$string['editdatasets_help'] = 'ワイルドカード値はそれぞれのワイルドカードフィールドに数値を入力した後、追加ボタンをクリックして作成することができます。10またはそれ以上の値を生成するには追加ボタンをクリックする前に必要な値の生成数を選択してください。一様分布は値域の数値が同程度に生成されることを意味します。対数一様分布は下限の数値が生成されやすいことを意味します。';
...
$string['forceregenerationall'] = 'すべてのワイルドカードの再生成を強制する';
$string['forceregenerationshared'] = '非共有ワイルドカードのみ再生成を強制する';
...
$string['nocoherencequestionsdatyasetcategory'] = '問題ID {$a->qid} に関してカテゴリID {$a->qcat} が共有ワイルドカード {$a->name} のカテゴリID {$a->sharedcat} に一致しません。問題を編集してください。';
...
$string['oneanswertrueansweroutsidelimits'] = '少なくとも1つの答えが真の値の範囲外にあります。<br />高度なパラメータで利用できる答えの許容誤差設定を修正してください。';
...
';
$string['youmustaddatleastoneitem'] = 'この問題を保存する前にあなたは少なくとも1つのデータセットアイテムを追加する必要があります。';
$string['youmustaddatleastonevalue'] = 'この問題を保存する前にあなたは少なくとも1つのワイルドカード値を追加する必要があります。';
