...
/**
 * Strings for component 'privacy', language 'ja', branch 'MOODLE_36_STABLE'
 *
 * @package   privacy
...
$string['privacy:metadata'] = 'プライバシーサブシステムはどのような自身のデータも保存しません。データを記述、エクスポート、削除するためコンポーネントおよびインターフェース間でチャネルとして動作するよう設計されています。';
