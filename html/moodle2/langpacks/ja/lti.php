...
* **アクティブ** - これらのツールプロバイダは管理者により承認および設定されています。このサイト内すべてのコースで利用できます。コンシューマ鍵および共通秘密鍵が入力された場合、このサイトおよびリモートツール間において安全な通信チャネルを提供する信頼関係が確立されます。

* **保留** - これらのツールプロバイダはパッケージインポート経由で登録されていますが、管理者から設定されていない状態です。コンシューマ鍵および共通秘密鍵がある場合、またはそれらを必要としない場合、教師はこれらのプロバイダのツールを利用できます。

* **拒否** - これらのツールプロバイダは管理者がサイトにおいて利用できるようにする意図がない旨、フラグが立てられた状態です。コンシューマ鍵および共通秘密鍵がある場合、またはそれらを必要としない場合、教師はこれらのプロバイダのツールを利用できます。';
