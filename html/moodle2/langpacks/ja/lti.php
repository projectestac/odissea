...
$string['enableemailnotification_help'] = 'この設定を有効にした場合、ツール送信が評定された時点で学生に対して通知メールが送信されます。';
...
$string['services_help'] = 'あなたがツールプロバイダに提供したいサービスを選択してください。1つ以上のサービスを選択してください。';
