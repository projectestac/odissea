...
$string['uninstalldelete'] = 'データベースからプラグイン「 {$a->name} 」に関するすべてのデータが削除されました。プラグイン自体の再インストールを防ぐにはあなたのサーバからフォルダ「 {$a->rootdir} 」を手動削除してください。書き込み権のためMoodleはフォルダを削除することはできません。';
