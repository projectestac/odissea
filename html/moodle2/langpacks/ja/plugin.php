...
$string['notwritable_help'] = 'あなたは自動更新適用を有効にしています。また、このプラグインに利用可能な更新があります。しかし、プラグインファイルに書き込み権がないため、更新を自動的にインストールすることができません。

利用可能な更新を自動的にインストールできるようプラグインフォルダおよびコンテンツすべてに書き込めるようにしてください。';
...
$string['pluginchecknotice'] = 'このページではアップグレード中、あなたが注意する必要のあるプラグインを表示しています。ハイライトされた項目にはインストール予定の新しいプラグイン、アップグレードされる予定の更新プラグイン、そして不明のプラグインを含みます。利用可能な更新がある場合、プラグインもハイライトされています。新しいバージョンのプラグインがあるか確認して、このMoodleアップグレードを続ける前にソースコードの更新をお勧めします。';
$string['plugindisable'] = '無効';
$string['plugindisabled'] = '無効';
$string['pluginenable'] = '有効';
$string['pluginenabled'] = '有効';
$string['release'] = 'リリース';
$string['requiredby'] = '次に必要: {$a}';
...
$string['type_enrol'] = '受講登録方法';
$string['type_enrol_plural'] = '受講登録方法';
