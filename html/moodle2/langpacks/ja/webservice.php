...
$string['createservicedescription'] = 'サービスは一連のウェブサービス関数です。あなたはユーザに新しいサービスへのアクセスを許可します。<strong>サービスを追加する</strong>ページで「有効」および「認証済みユーザのみ」オプションをチェックしてください。次に「必須ケイパビリティなし」を選択してください。';
$string['createserviceforusersdescription'] = 'サービスは一連のウェブサービス関数です。あなたはユーザに新しいサービスへのアクセスを許可します。<strong>サービスを追加する</strong>ページで「有効」オプションをチェック、「認証済みユーザのみ」オプションのチェックを外してください。次に「必須ケイパビリティなし」を選択してください。';
...
$string['selectspecificuserdescription'] = '認証済みユーザとしてウェブサービスユーザを追加します。';
$string['service'] = 'サービス';
...
$string['serviceusersmatching'] = '合致する認証済みユーザ';
