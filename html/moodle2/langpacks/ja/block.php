...
$string['defaultregion_help'] = 'テーマではブロックを表示するために1つまたはそれ以上の名称付きブロック領域を定義することができます。この設定では、あなたがこのブロックをデフォルトで表示させたい場所を定義します。必要であれば、特定のページ上で場所をオーバーライド (優先) させることができます。';
