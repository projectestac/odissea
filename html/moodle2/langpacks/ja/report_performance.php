...
/**
 * Strings for component 'report_performance', language 'ja', branch 'MOODLE_32_STABLE'
 *
...
$string['check_backup_comment_disable'] = 'この設定を有効にした場合、バックアップ処理中、パフォーマンスは影響を受けます。有効にした場合、混雑しない時間帯にバックアップがスケジュールされます。';
...
$string['check_cachejs_details'] = 'JavaScriptキャッシングおよび圧縮はページ読み込みのパフォーマンスを大幅に改善します。プロダクションサイトでの使用を強くお勧めします。';
...
$string['check_themedesignermode_comment_disable'] = 'この設定を有効にした場合、イメージおよびスタイルシートはキャッシュされません。結果として、パフォーマンスが顕著に悪化することになります。';
