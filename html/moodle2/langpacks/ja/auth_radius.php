...
/**
 * Strings for component 'auth_radius', language 'ja', branch 'MOODLE_28_STABLE'
 *
 * @package   auth_radius
...
$string['auth_radiuschangepasswordurl_key'] = 'パスワード変更URL';
...
$string['auth_radiustypemschapv1'] = 'Microsoft CHAPバージョン1';
$string['auth_radiustypemschapv2'] = 'Microsoft CHAPバージョン2';
$string['auth_radiustypepap'] = 'PAP';
$string['pluginname'] = 'RADIUSサーバ';
