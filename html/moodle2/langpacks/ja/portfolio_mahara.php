...
/**
 * Strings for component 'portfolio_mahara', language 'ja', branch 'MOODLE_34_STABLE'
 *
...
$string['err_networkingoff_help'] = 'MNetは完全に無効にされています。このプラグインを設定する前に有効にしてください。問題が修正されるまでこのプラグインのインスタンスはすべて非表示にされます - 再度、あなたは手動でインスタンスを表示する必要があります。インスタンスが表示されるまで使用することはできません。';
