...
/**
 * Strings for component 'repository_picasa', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata:repository_picasa'] = 'Picasaウェブアルバムリポジトリプラグインはいかなる個人データも保存しません。しかし、ユーザデータをMoodleからリモートシステムに転送します。';
