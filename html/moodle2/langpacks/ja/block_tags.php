...
$string['morewelcome'] = '「タグ詳細」タグクラウドへようこそ。タグはユーザにより作成されたリンクです。タグではお気に入りのコース、あなたのブログまたはプロファイルをあなたの言葉でカテゴリ分けすることができます。異なるグループのタグは「表示:」行にリンクとして表示され、「並べ替え順:」行で並べ替えることができます。';
