...
/**
 * Strings for component 'qtype_ddimageortext', language 'ja', branch 'MOODLE_28_STABLE'
 *
...
$string['formerror_disallowedtags'] = 'あなたはドラッグ可能なテキストドラッグアイテムタイプとして許可されていないHTMLタグを使用しました。';
...
$string['pluginname_help'] = '背景イメージファイルを選択してドラッグ可能イメージを選択するかテキストを入力した後、ドラッグされるための背景イメージのドロップゾーンを定義してください。';
$string['pluginnamesummary'] = 'イメージまたはテキストラベルを背景イメージのドロップゾーンにドラッグ＆ドロップします。';
$string['previewareaheader'] = 'プレビュー';
$string['previewareamessage'] = '背景イメージを選択してドラッグ可能なイメージを選択するかドラッグ可能にされるテキストを入力してください。そして、それぞれの「ドロップゾーン」のドラッグアイテムを選択した後、学生がドラッグする場所にドラッグしてください。';
