...
$string['accessrestrictions'] = 'アクセス制限';
$string['addrestriction'] = '制限を追加する ...';
$string['and'] = 'および';
$string['condition_group'] = '制限セット';
$string['condition_group_info'] = '複雑な条件に適用するため、一連の入れ子の制限を追加します。';
...
$string['hidden_all'] = 'ユーザが条件に合致しない場合、完全に非表示にする';
$string['hidden_individual'] = 'ユーザがこの条件に合致しない場合、完全に非表示にする';
$string['hidden_marker'] = '(そうでない場合は非表示)';
$string['hide_verb'] = '非表示にするにはクリック';
...
$string['list_and'] = 'すべて:';
$string['list_and_hidden'] = 'すべて (そうでない場合は非表示):';
$string['listheader_multi_after'] = '以下の条件';
$string['listheader_multi_and'] = 'すべて';
$string['listheader_multi_before'] = '合致';
$string['listheader_multi_or'] = 'どれか';
$string['listheader_sign_before'] = '学生';
$string['listheader_sign_neg'] = '合致しない必要がある';
$string['listheader_sign_pos'] = '合致する必要がある';
$string['listheader_single'] = '> 以下の条件に対して';
$string['list_or'] = 'どれか:';
$string['list_or_hidden'] = 'どれか (そうでない場合は非表示):';
$string['list_root_and'] = '以下に合致しない限り利用できません:';
$string['list_root_and_hidden'] = '以下に合致しない限り利用できません (非表示):';
