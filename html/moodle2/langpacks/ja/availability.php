...
/**
 * Strings for component 'availability', language 'ja', branch 'MOODLE_32_STABLE'
 *
...
$string['list_root_and'] = '次に合致しない限り利用できません:';
$string['list_root_and_hidden'] = '次に合致しない限り利用できません (非表示):';
