...
$string['contactadmin'] = '有効にするには、あなたの管理者にご連絡ください。';
$string['core'] = 'コア';
...
$string['manageruleslink'] = 'あなたは {$a} ページにてルールを管理することができます。';
$string['managesubscriptions'] = 'イベントモニタリング';
$string['managesubscriptionslink'] = 'あなたは {$a} ページにてルールを購読することができます。';
...
$string['selectcourse'] = '利用可能なモジュール一覧を取得するには、このレポートにコースレベルででアクセスしてください。';
