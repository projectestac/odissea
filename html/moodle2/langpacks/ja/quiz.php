...
$string['containercategorycreated'] = 'このカテゴリは下記原因によりサイトレベルで移動されたすべてのオリジナルカテゴリを保存するため作成されました。';
...
$string['overduehandlinggraceperiod'] = '開いている受験を送信できる場合は猶予期間を設けますがさらに問題に解答することはできません';
...
これにより学生が答えを共有することは難しくなりますがあなたと特定の問題に関して議論することも難しくなります。';
