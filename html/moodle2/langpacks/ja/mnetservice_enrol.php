...
$string['noroamingusers'] = 'リモートコースに受講登録するにはユーザはシステムコンテクスト内にケイパビリティ「 {$a} 」を必要とします。現在、このケイパビリティを持ったユーザ存在しません。「続ける」ボタンをクリックすることで、あなたのサイトの1つまたはそれ以上のロールに必要なケイパビリティを割り当てます。';
$string['otherenrolledusers'] = '他の受講登録済みユーザ';
