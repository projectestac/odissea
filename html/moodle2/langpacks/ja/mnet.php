...
$string['expireyourkeyexplain'] = 'Moodleは (デフォルトで) 28日ごとに自動的に公開鍵をローテートしますが、あなたはこの公開鍵をいつでも「手動で」失効させることができます。これはあなたがこのキーを信用できなくなった場合のみ有用です。公開鍵の交換は即座に自動実行されます。<br />この公開鍵を削除することで、あなたが手動でそれぞれのMoodle管理者に連絡して新しいキーを提供するまで、他のシステムと通信できなくなります。';
