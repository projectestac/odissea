...
$string['transport_help'] = 'これらのオプションでは相互認証が必要です。そのため、リモートホストに署名SSL証明書を強制するには、あなたのサーバも同様に署名SSL証明書を持つ必要があります。';
...
$string['xmlrpc-missing'] = 'この機能を使用するには、あなたのPHPビルドにXML-RPCをインストールする必要があります。';
