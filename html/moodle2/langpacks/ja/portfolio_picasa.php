...
$string['nooauthcredentials_help'] = 'Picasaポートフォリオプラグインを使用するにはあなたはポートフォリオ設定にてOAuth認証情報を設定する必要があります。';
$string['oauth2upgrade_message_content'] = 'Moodle 2.3へのアップグレードの一環として、Picasaポートフォリオプラグインは無効にされました。プラグインを再度有効にするにはクライアントIDおよび秘密鍵を取得するため、ドキュメンテーション「 {$a->docsurl} 」に記述されているようにあなたのサイトをGoogleに登録する必要があります。クライアントIDおよび秘密鍵はすべてのGoogle DriveおよびPicasaプラグイン設定に使用することができます。';
