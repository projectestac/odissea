...
/**
 * Strings for component 'quiz_overview', language 'ja', branch 'MOODLE_26_STABLE'
 *
...
$string['allattemptscontributetograde'] = 'すべての受験は、ユーザの最終評点に提供されます。';
...
$string['highlightinggraded'] = '最終評点に提供される受験は、ハイライトされています。';
$string['needed'] = '必要';
$string['noattemptsonly'] = '未受験の {$a} のみ表示/ダウンロードする';
$string['noattemptstoregrade'] = '再評定する受験はありません。';
$string['nogradepermission'] = 'あなたには、この小テストを評定するパーミッションがありません。';
$string['onlyoneattemptallowed'] = 'この小テストでは、ユーザあたり1回の受験が許可されています。';
$string['optallattempts'] = 'すべての受験';
$string['optallstudents'] = '小テストを受験または未受験のすべての {$a}';
$string['optattemptsonly'] = '小テストを受験した {$a}';
$string['optnoattemptsonly'] = '小テストを未受験の {$a}';
$string['optonlyregradedattempts'] = '再評定された/再評定が必要だとマークされた受験のみ';
$string['overview'] = '評定';
$string['overviewdownload'] = '概要のダウンロード';
$string['overviewfilename'] = '評定';
$string['overviewreport'] = '評定レポート';
$string['overviewreportgraph'] = '評点範囲に到達した学生の全体数';
...
$string['showdetailedmarks'] = 'それぞれの問題評点';
