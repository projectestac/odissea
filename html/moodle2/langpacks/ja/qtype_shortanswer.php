...
/**
 * Strings for component 'qtype_shortanswer', language 'ja', branch 'MOODLE_31_STABLE'
 *
...
$string['filloutoneanswer'] = '1つ以上の考えられる答えを入力してください。空白の答えは使用されません。「*」は、どのような文字にでも合致するワイルドカードとして使用することができます。最初の組み合わせの答えは、評点とフィードバックを決定するため使用されます。';
...
$string['pluginnamesummary'] = '様々な答えのモデルと比較して評定される、1つまたは少数の言葉を入力することができます。答えには、ワイルドカードを含むことができます。';
