...
/**
 * Strings for component 'repository_webdav', language 'ja', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'WebDAVリポジトリプラグインはどのような個人データも保存しません。しかし、ユーザデータをMoodleからリモートシステムに転送します。';
