...
/**
 * Strings for component 'enrol_guest', language 'ja', branch 'MOODLE_31_STABLE'
 *
 * @package   enrol_guest
...
$string['allowguests'] = 'このコースにはゲストユーザも入ることができます。';
$string['guestaccess_withoutpassword'] = 'ゲストアクセス';
$string['guestaccess_withpassword'] = 'ゲストアクセス (要パスワード)';
$string['guest:config'] = 'ゲストアクセスインスタンスを設定する';
$string['password'] = 'パスワード';
$string['password_help'] = 'パスワードにより、パスワードを知っているゲストのみコースにアクセスすることができます。ゲストはコースアクセス時、毎回パスワードの入力を求められます。';
$string['passwordinvalid'] = 'アクセスパスワードが正しくありません、再度お試しください。';
$string['passwordinvalidhint'] = 'アクセスパスワードが正しくありません、もう一度お試しください。<br />(ヒント - 「 {$a} 」で始まります)';
...
$string['showhint_desc'] = 'ゲストアクセスパスワードの最初の文字を表示します。';
