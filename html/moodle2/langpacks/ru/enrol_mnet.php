...
/**
 * Strings for component 'enrol_mnet', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   enrol_mnet
...
$string['mnet:config'] = 'Настраивать экземпляры способа записи «Запись на курс для пользователей сети MNet»';
