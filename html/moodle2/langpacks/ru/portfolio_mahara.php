...
/**
 * Strings for component 'portfolio_mahara', language 'ru', branch 'MOODLE_28_STABLE'
 *
...
$string['err_networkingoff_help'] = 'Сетевое взаимодействие MNet отключено полностью. Включите его перед попыткой настроить этот плагин. Любые экземпляры этого плагина будут невидимы, пока это не будет исправлено - Вы должны будете вручную сделать их видимыми. До этого они не смогут использоваться.';
