...
$string['alertsheading'] = 'Уведомление пользователям';
...
$string['analyticssiteurldesc'] = 'Для аналитики Piwik введите свой URL-адрес без http(s) и слэша в конце';
...
$string['fontselectdesc'] = 'Выберите шрифт из списка доступных сочетаний. Вы можете здесь, при необходимости, также отключить использование шрифтов Google.';
...
$string['pagebackgrounddesc'] = 'Загрузите свое изображение для фона страницы. Это изображение будет фоном всех страниц. Если изображение не загружено, то будет использоваться изображение по умолчанию.';
