...
/**
 * Strings for component 'moodle', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   moodle
...
$string['edulevelteacher'] = 'Обучающие';
...
$string['eventcoursemoduleinstancelistviewed'] = 'Просмотрен список экземпляров модуля в курсе';
$string['eventcoursemoduleupdated'] = 'Модуль курса обновлен';
$string['eventcoursemoduleviewed'] = 'Просмотрен модуль курса';
...
$string['eventcourseuserreportviewed'] = 'Просмотрен отчет участника курса';
$string['eventcourseviewed'] = 'Просмотрен курс';
$string['eventemailfailed'] = 'Не удалось отправить сообщение электронной почты';
$string['eventname'] = 'Название события';
$string['eventrecentactivityviewed'] = 'Просмотрен отчет о последних действиях';
...
$string['usernameemail'] = 'Имя пользователя / E-mail';
