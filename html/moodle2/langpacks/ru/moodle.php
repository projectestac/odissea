...
/**
 * Strings for component 'moodle', language 'ru', branch 'MOODLE_32_STABLE'
 *
 * @package   moodle
...
$string['courseduration_desc'] = 'Длительность курса используется для вычисления даты окончания курса по умолчанию. Дата окончания курса используется только в отчетах. Пользователи по-прежнему могут зайти в курс после даты его окончания.';
...
$string['enddate_help'] = 'Дата окончания курса используется только в отчетах. Пользователи по-прежнему могут зайти в курс после даты его окончания.';
...
$string['eventcourseinformationviewed'] = 'Просмотренные описания курсов';
