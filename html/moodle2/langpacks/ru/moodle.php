...
/**
 * Strings for component 'moodle', language 'ru', branch 'MOODLE_26_STABLE'
 *
 * @package   moodle
...
$string['bulkmovecoursessuccess'] = 'Успешно перемещено {$a->courses} курса(ов) в категорию «{$a->category}»';
...
$string['categoriesandcoures'] = 'Категории курсов и курсы';
...
$string['courseoverviewfiles'] = 'Файлы описания курса';
$string['courseoverviewfilesext'] = 'Расширения файлов описания курса';
$string['courseoverviewfiles_help'] = 'Файлы описания курса (например, изображения) отображаются в списке курсов рядом с описанием.';
$string['courseoverviewfileslimit'] = 'Ограничение на количество файлов описания курса';
...
* Дайджест - полные сообщения - Вы будете получать ежедневное электронное письмо, содержащее полный текст каждого сообщения форума;
* Дайджест - только темы - Вы будете получать одно письмо в день, содержащее только темы каждого сообщения форума. Вы можете выбрать различные настройки для каждого форума, если хотите.';
...
$string['enrolmentmethods'] = 'Методы записи';
...
$string['eventuserlistviewed'] = 'Просмотрен список пользователей';
$string['eventuserloggedout'] = 'Пользователь вышел';
$string['eventuserprofileviewed'] = 'Просмотрен профиля пользователя';
...
$string['maxbytesforfile'] = 'Файл {$a} больше максимально допустимого размера.';
...
$string['resortbyfullname'] = 'По полному названию';
$string['resortbyidnumber'] = 'По идентификационному номеру';
$string['resortbyshortname'] = 'По краткому названию';
$string['resortcourses'] = 'Отсортировать курсы';
$string['resortsubcategoriesbyidnumber'] = 'Отсортировать подкатегории по идентификационному номеру';
$string['resortsubcategoriesbyname'] = 'Отсортировать подкатегории по имени';
...
$string['searchhelp'] = '<p>Вы можете искать одновременно несколько слов и осуществить более точный поиск следующим образом:</p>
<ul>
...
$string['setpasswordinstructions'] = 'Пожалуйста, введите и повторите ниже новый пароль, затем нажмите кнопку «Установить пароль». <br /> Новый пароль будет сохранен, и Вы зайдёте на сайт.';
...
$string['sortcategoriesbyidnumber'] = 'Отсортировать категории по идентификационному номеру';
$string['sortcategoriesbyname'] = 'Отсортировать категории по названию';
$string['sortcoursesbyfullname'] = 'Отсортировать курсы по полному названию';
$string['sortcoursesbyidnumber'] = 'Отсортировать курсы по идентификационному номеру';
$string['sortcoursesbyshortname'] = 'Отсортировать курсы по краткому названию';
...
$string['visible_help'] = 'Этот параметр определяет, будет ли курс отображаться в списке курсов. Пользователи, кроме преподавателей и администраторов, не смогут войти в курс.';
