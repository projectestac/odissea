...
$string['mediaformats_desc'] = 'Если в этих настройках плееры включены, то можно использовать с медиа-фильтром (если он включен) внедренные в страницу медиа-файлы или ресурсы Файл или Гиперссылка с параметром «Внедренное». Если плееры не включены, то медиа-форматы не внедряются и пользователи только могут вручную скачать файл или следовать по ссылкам на эти ресурсы.

Если два плеера поддерживают тот же формат, то это позволяет увеличить совместимость с различными устройствами, например с мобильными телефонами. Можно еще больше увеличить совместимость, обеспечивая для одного аудио- или видео-ресурса несколько файлов в различных форматах.';
