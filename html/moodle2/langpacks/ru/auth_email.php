...
/**
 * Strings for component 'auth_email', language 'ru', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_email
...
$string['auth_emailrecaptcha'] = 'Добавляет форму для подтверждения визуального/звукового элемента на страницу самостоятельной регистрации пользователей с использованием электронной почты. Это защищает ваш сайт от спамеров. Более подробную информацию смотрите на http://www.google.com/recaptcha.';
