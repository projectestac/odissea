...
/**
 * Strings for component 'badges', language 'ru', branch 'MOODLE_36_STABLE'
 *
 * @package   badges
...
$string['attachment_help'] = 'Если параметр включен, файл выданного значка будет вложен в электронное письмо получателю для скачивания. Для использования этой возможности вложения должны быть разрешены в «Администрирование > Плагины > Способы доставки сообщений > Электронная почта».';
...
$string['backpackconnectionunexpectedresult'] = 'Не удалось подключится к Вашей коллекции наград. Пожалуйста, повторите попытку.<br><br>Если проблема не исчезает, свяжитесь с администратором.';
...
{$a->admin}';
$string['backpackemailverifyemailsubject'] = '{$a}: подтверждение электронной почты коллекции наград OpenBadges';
...
$string['criteria_7_help'] = 'Разрешает выдавать значок пользователям на основе других значков, которые они получили.';
...
$string['error:invalidbadgeurl'] = 'Неверный формат URL-адреса эмитента. URL должен иметь префикс http:// или https://.';
...
$string['error:nobadges'] = 'Нет значков уровня курса или сайта с разрешенным доступом для добавления в качестве критерия.';
...
$string['personaconnection_help'] = 'Persona представляет собой систему идентификации в сети с использованием имеющегося у вас адреса электронной почты. Коллекция наград Open Badges использует Persona как систему авторизации, поэтому, чтобы иметь возможность подключиться к Open Badges, Вам необходимо использовать учетную запись Persona.
...
$string['targetname_help'] = 'Компетенция, навык или стандарт, которые охватывает значок.';
