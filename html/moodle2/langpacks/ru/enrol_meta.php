...
/**
 * Strings for component 'enrol_meta', language 'ru', branch 'MOODLE_26_STABLE'
 *
 * @package   enrol_meta
...
$string['meta:config'] = 'Настраивать экземпляры способа записи на курс «Связь с метакурсом»';
$string['meta:selectaslinked'] = 'Выбирать курс в качестве родительского в способе записи на курс «Связь с метакурсом»';
