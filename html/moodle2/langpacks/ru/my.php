...
$string['alldashboardswerereset'] = 'Все настройки страниц «Моя домашняя страница» были сброшены к значениям по умолчанию.';
...
$string['reseteveryonesdashboard'] = 'Сбросить страницу «Моя домашняя страница» для всех пользователей';
