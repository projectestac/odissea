...
/**
 * Strings for component 'hotpot', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   hotpot
...
$string['removegradeitem_help'] = 'Будет ли удалена оценка за этот элемент курса?

**Нет**
: Оценки за этот элемент курса не будет удалена из журнала оценок Moodle

**Да**
: Если для максимальной или взвешенной оценка в этом модуле HotPot установлено значение ноль, то оценка за этот элемент курса будет удалена из журнала успеваемости Moodle.';
