...
$string['eventbatchsetmarkerallocationviewed'] = 'Просмотрена страница массового закрепления оценщиков.';
$string['eventbatchsetworkflowstateviewed'] = 'Просмотрена страница массовой установки этапа оценивания.';
...
$string['eventgradingformviewed'] = 'Просмотрена форма оценивания';
$string['eventgradingtableviewed'] = 'Просмотрена таблица оценивания';
$string['eventidentitiesrevealed'] = 'Раскрыты личности студентов.';
$string['eventmarkerupdated'] = 'Обновлено распределение оценщиков';
$string['eventrevealidentitiesconfirmationpageviewed'] = 'Просмотрена страница подтверждения раскрытия личностей студентов.';
...
$string['eventsubmissionformviewed'] = 'Просмотрена форма представления ответов';
...
$string['eventsubmissionstatusviewed'] = 'Просмотрена страница состояния представленного ответа.';
...
$string['revealidentitiesconfirm'] = 'Вы уверены, что хотите раскрыть личности студентов для этого задания? Эта операция не может быть отменена. После того, как личности студентов будут раскрыты, баллы окажутся в журнале оценок.';
