...
/**
 * Strings for component 'data', language 'ru', branch 'MOODLE_36_STABLE'
 *
 * @package   data
...
$string['calendarend'] = 'База данных закрывается {$a}';
$string['calendarstart'] = 'База данных открывается {$a}';
...
$string['modulename_help'] = 'Модуль «База данных» позволяет участникам создавать, обслуживать и искать записи из совокупности. Структура записей определяется преподавателем через количество полей. Типы полей включают флажки, переключатели, выпадающие списки, меню, текстовые области, гиперссылки, изображения и загружаемые файлы.

Визуальное отображение информации при просмотре и редактировании записей в базе данных определяется шаблонами базы данных. Элементы «База данных» могут совместно использоваться в курсах в виде заготовок, а преподаватель может также импортировать и экспортировать записи в базу данных.
...
$string['page-mod-data-x'] = 'Любая страница модуля База данных';
...
$string['requiredentries'] = 'Требуется записей для завершения (устар.)';
...
$string['requiredentrieswarning'] = 'Этот параметр был заменен параметром «Требовать записи» завершения активного элемента';
