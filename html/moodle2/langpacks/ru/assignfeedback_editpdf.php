...
/**
 * Strings for component 'assignfeedback_editpdf', language 'ru', branch 'MOODLE_31_STABLE'
 *
...
$string['pathtounoconvpathdesc'] = 'Пожалуйста, обратите внимание, что комментирование PDF требует задания пути к unoconv в {$a}.';
$string['pen'] = 'Ручка';
...
$string['test_unoconvisdir'] = 'Путь unoconv указывает на папку, пожалуйста, включите программу хnoconv в указанный вами путь';
...
$string['test_unoconvok'] = 'Путь хnoconv выглядит правильно настроенным.';
