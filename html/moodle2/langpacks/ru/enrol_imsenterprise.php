...
/**
 * Strings for component 'enrol_imsenterprise', language 'ru', branch 'MOODLE_28_STABLE'
 *
...
$string['imsenterprise:config'] = 'Настроить экземпляры записи из файла IMS Enterprise';
$string['imsenterprisecrontask'] = 'Обработка файла записи';
