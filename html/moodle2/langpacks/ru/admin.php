...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   admin
...
$string['allowguestmymoodle'] = 'Разрешить гостям доступ к домашней странице';
...
$string['configallowguestmymoodle'] = 'Открывает гостевой доступ к домашней странице. Если отключено, то гость перенаправляется на главную страницу сайта.';
...
$string['configmymoodleredirect'] = 'Этот параметр принудительно перенаправляет на домашнюю страницу пользователей, не являющихся администраторами, и заменяет верхний уровень сайта на домашней страницей.';
...
$string['gravatardefaulturl_help'] = 'Сервис Gravatar требует указания изображения по умолчанию, которое отображается, если не удалось найти аватар для данного пользователя. Нужно указать полный URL-адрес к картинке. Если оставить это поле пустым, то Moodle попробует автоматически подобрать наиболее подходящее изображение для данной страницы.  Также обратите внимание, что Gravatar поддерживает ряд кодов, которые могут быть использованы для <a href="https://en.gravatar.com/site/implement/images/#default-image">создания изображения по умолчанию</a>.';
...
$string['mypage'] = 'Настройки по умолчанию домашней страницы';
...
$string['navexpandmycourses'] = 'Отображать блок «Мои курсы» раскрытым на домашней странице';
$string['navexpandmycourses_desc'] = 'При включенном параметре блок «Мои курсы» изначально отображается раскрытым в навигационном блоке на домашней странице.';
...
$string['taskcompletioncron'] = 'Вычисление данных о завершении';
...
$string['taskplagiarismcron'] = 'Обработка проверки на плагиат в фоновом режиме';
