...
$string['navexpandmycourses'] = 'Отображать развернутым блок «Мои курсы» в Личном кабинете';
$string['navexpandmycourses_desc'] = 'При включенном параметре блок «Мои курсы» изначально отображается развернутым в навигационном блоке в Личном кабинете.';
