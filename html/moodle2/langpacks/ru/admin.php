...
$string['configenableactivitychooser'] = 'Выбор элементов - это диалоговое окно с кратким описанием каждого вида активного элемента и ресурса. При отключенной функции вместо этого предоставляются отдельные раскрывающиеся меню ресурсов и активных элементов.';
...
$string['enableactivitychooser'] = 'Включить выбор элементов';
