...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_34_STABLE'
 *
 * @package   admin
...
$string['configcustomusermenuitems'] = 'Вы можете настроить содержимое меню пользователя (за исключением ссылки «Выход», которая добавляется автоматически). Каждая строка разделяется символами | и состоит из: 1) строки в форме «названиеязыка, названиекомпонента» или обычного текста, 2) адреса URL и 3) иконки в виде картинки или в виде URL. Также возможно создание разделительной линии путем добавления в нужном месте строки из одного или нескольких символов #.';
...
$string['configgeoipfile'] = 'Расположение двоичного файла данных GeoIP2 City. Этот файл не распространяется вместе с Moodle и должен быть получен отдельно, от <a href="http://www.maxmind.com/"> MaxMind</a>. Вы можете купить коммерческую версию или использовать бесплатную.<br /> Просто скачайте файл <a href="http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz" >http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz</a> и распакуйте его в каталог «{$a}» своего сервера.';
...
$string['iplookupmaxmindnote'] = 'В этой программе используется база данных GeoLite2 компании MaxMind, доступная по адресу: <a href="http://www.maxmind.com/">http://www.maxmind.com/</a>.';
...
$string['mobilenotconfiguredwarning'] = 'Moodle Mobile не включен.';
