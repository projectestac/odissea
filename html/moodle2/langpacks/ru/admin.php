...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_32_STABLE'
 *
 * @package   admin
...
$string['devlibdirpresent'] = 'Каталоги с библиотеками разработок, такими как <em>vendor</em> или <em>node_modules</em> не должны располагаться на общедоступных сайтах. Подробнее см. в <a href="{$a->moreinfourl}">отчете об обзоре безопасности</a>.';
...
$string['maintenancemodeisscheduledlong'] = 'Этот сайт будет переключен в режим обслуживания в {$a->hour} час. {$a->min} мин. {$a->sec} сек.';
...
$string['unsuspenduser'] = 'Активация учетной записи';
