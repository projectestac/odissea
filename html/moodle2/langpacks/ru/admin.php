...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['agedigitalconsentverification'] = 'Проверка возраста цифрового согласия';
$string['agedigitalconsentverification_desc'] = 'Включает проверку возраста цифрового согласия перед отображением страницы регистрации для самостоятельно регистрирующихся пользователей. Это защищает ваш сайт от несовершеннолетних, регистрирующихся без согласия родителей/опекунов. Несовершеннолетним предоставляется подробная <a target="_blank" href="{$a}"> информация о поддержке </a> для дальнейшей помощи.';
$string['ageofdigitalconsentmap'] = 'Возраст цифрового согласия';
$string['ageofdigitalconsentmap_desc'] = 'Здесь можно указать возраст цифрового согласия по умолчанию и его значение в любой стране, где он отличается от возраста по умолчанию. Введите каждое значение возраста с новой строки в формате: код страны, возраст (разделяя из запятой). Для возраста по умолчанию вместо кода страны введите *. Коды стран указываются в соответствии с ISO 3166-2.';
...
Чтобы этот параметр вступил в силу, для настройки «Сообщения об отладке» должно быть установлено значение «Разработчик».';
...
$string['configgeoipfile'] = 'Расположение двоичного файла данных GeoIP2 City. Этот файл не распространяется вместе с Moodle и должен быть получен отдельно, от <a href="https://www.maxmind.com/"> MaxMind</a>. Вы можете купить коммерческую версию или использовать бесплатную.<br /> Просто скачайте файл <a href="https://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz" >https://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz</a> и распакуйте его в каталог «{$a}» своего сервера.';
...
$string['configpasswordpolicy'] = 'При включенном параметре сложность паролей пользователей будет проверяться по политике паролей; её настройки указаны ниже. Включение политики паролей не повлияет на существующих пользователей, пока они не попробуют изменить свой пароль.';
...
$string['configrecaptchaprivatekey'] = 'Строка символов (закрытый ключ), используемая для взаимодействия между вашим сервером Moodle и сервером recaptcha. Ключи ReCAPTCHA могут быть получены с сайта <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
$string['configrecaptchapublickey'] = 'Строка символов (открытый ключ), используемая для отображения элемента reCAPTCHA в форме самостоятельной регистрации. Ключи ReCAPTCHA могут быть получены с сайта <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['contextlocking_desc'] = 'Этот параметр обеспечивает доступ только для чтения для выбранных категорий, курсов, активных элементов или блоков.';
...
$string['coursecontactduplicates_desc'] = 'Если включено, пользователи с более чем одной из выбранных ролей контакта курса будут отображаться в описании курса с каждой из своих ролей. В противном случае они будут отображаться только с одной ролью (в зависимости от того, какая находится выше в разделе «Определить роли» в Управлении сайтом).';
...
$string['cronwarning'] = '<a href="{$a}">Скрипт обслуживания cron.php</a> не запускался уже более 24 часов.';
$string['cronwarningcli'] = 'Скрипт обслуживания cli/cron.php не запускался уже более 24 часов.';
...
$string['invalidagedigitalconsent'] = 'Неправильный возраст цифрового согласия: {$a}';
...
$string['loginpasswordautocomplete_help'] = 'При включенном параметре пользователи не смогут сохранять пароли в браузере.';
...
$string['moodleapp_help'] = '<p>Если у вас есть учетная запись на сайте Moodle, вы можете получить доступ ко всем своим курсам на своих мобильных устройствах с помощью нашего бесплатного мобильного приложения для Moodle. </p>
<a href="https://moodle.com/mobile-app"> Загрузите приложение Moodle </a>';
...
$string['registermoodlenet'] = '<p>Мы бы хотели оставаться на связи и сообщать вам важные вещи о вашем сайте на Moodle!</p><p>Регистрируясь:</p><ul><li>Вы будете одним из первых получать важные уведомления, такие как предупреждения о безопасности и новые выпуски Moodle.</li><li>Вы можете получить доступ и активировать мобильные push-уведомления с вашего сайта Moodle через наше бесплатное приложение <a href="https://download.moodle.org/mobile/">Moodle Mobile</a>.</li><li>Вы вносите свой вклад в нашу <a href="https://moodle.net/stats/">статистику Moodle</a> мирового сообщества, что помогает нам улучшать Moodle и сайты нашего сообщества.</li><li>Если вы хотите, сайт может быть включен в <a href="https://moodle.net/sites/">список зарегистрированных сайтов Moodle</a> в вашей стране.</li></ul>';
...
$string['sitepolicyhandler'] = 'Обработчик политики сайта';
$string['sitepolicyhandlercore'] = 'По умолчанию (ядро)';
$string['sitepolicyhandler_desc'] = 'Определяет как управляются политики и согласия пользователей. Обработчик по умолчанию (ядро) включает URL пользовательского соглашения и URL пользовательского соглашения для гостей, которые необходимо задать. Обработчик политик включает пользовательское соглашение, политику конфиденциальности и другие политики, которые нужно задать. Он также включает согласия пользователей, которые можно просмотреть и, при необходимости, дать согласие от имени несовершеннолетнего.';
...
$string['taskquestioncron'] = 'Фоновый процесс подсистемы вопросов';
...
$string['updatenotificationfooter'] = 'Ваш сайт Moodle {$a->siteurl} настроен на автоматическую проверку обновлений. Вы получили это сообщение, потому что являетесь администратором сайта. Вы можете отключить автоматическую проверку обновлений (Администрирование - Сервер - Уведомления об обновлениях). Вы можете настроить способ доставки этого сообщения на странице настроек своего профиля.';
...
$string['upgradekeyreq'] = 'Требуется обновление ключа';
