...
$string['courseexplanation'] = 'Этот инструмент создает стандартные испытательные курсы, которые включают несколько разделов, элементов курса и файлов.
...
**Не используйте эту функцию на рабочей системе.** Используйте только на сервере разработчика. (Чтобы избежать случайного использования, эта функция отключена до тех пор, пока не будет выбран уровень отладки - РАЗРАБОТЧИК).';
...
$string['progress_createassignments'] = 'Создание задания ({$a})';
