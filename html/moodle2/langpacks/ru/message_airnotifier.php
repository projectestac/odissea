...
/**
 * Strings for component 'message_airnotifier', language 'ru', branch 'MOODLE_28_STABLE'
 *
...
$string['nodevices'] = 'Нет зарегистрированных устройств. Устройства автоматически будут появляться после того как вы установите приложение Moodle Mobile и добавите этот сайт.';
...
$string['requestaccesskey'] = 'Ключ запроса доступа';
