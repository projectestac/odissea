...
/**
 * Strings for component 'role', language 'ru', branch 'MOODLE_32_STABLE'
 *
 * @package   role
...
$string['restore:viewautomatedfilearea'] = 'Видеть область автоматически созданных резервных копий';
$string['risks'] = 'Риски';
