...
/**
 * Strings for component 'role', language 'ru', branch 'MOODLE_31_STABLE'
 *
 * @package   role
...
$string['restore:viewautomatedfilearea'] = 'Просматривать область автоматически созданных резервных копий';
$string['risks'] = 'Риски';
