...
/**
 * Strings for component 'role', language 'ru', branch 'MOODLE_26_STABLE'
 *
 * @package   role
...
$string['assignroles_help'] = 'Назначая роль пользователю, Вы предоставляете ему права, определенные в этой роли, для текущего уровня (контекста) и всех «более низких» уровней.
...
$string['blog:associatecourse'] = 'Это право больше не используется и ни за что не отвечает.';
$string['blog:associatemodule'] = 'Это право больше не используется и ни за что не отвечает.';
...
$string['community:add'] = 'Использовать блок «Поиск в общественных каталогах» для поиска каталогов и курсов';
...
$string['eventroleallowassignupdated'] = 'Обновлено разрешение на назначение роли';
$string['eventroleallowoverrideupdated'] = 'Обновлено разрешение на переопределение роли';
$string['eventroleallowswitchupdated'] = 'Обновлено разрешение на переключение между ролями';
$string['eventroleassigned'] = 'Роль назначена';
$string['eventrolecapabilitiesupdated'] = 'Обновлены права для роли';
...
$string['my:configsyspages'] = 'Настраивать системные шаблоны для страницы «Мой Moodle»';
