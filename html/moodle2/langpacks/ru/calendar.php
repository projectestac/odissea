...
/**
 * Strings for component 'calendar', language 'ru', branch 'MOODLE_32_STABLE'
 *
 * @package   calendar
...
$string['hidecourseevents'] = 'Скрыть события курса';
$string['hideglobalevents'] = 'Скрыть общие события';
$string['hidegroupsevents'] = 'Скрыть события групп';
$string['hideuserevents'] = 'Скрыть события пользователей';
...
$string['showcourseevents'] = 'Показать события курса';
$string['showglobalevents'] = 'Показать общие события';
$string['showgroupsevents'] = 'Показать события групп';
$string['shown'] = 'показано';
$string['showuserevents'] = 'Показать события пользователя';
