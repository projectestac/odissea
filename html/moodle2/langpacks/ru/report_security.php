...
/**
 * Strings for component 'report_security', language 'ru', branch 'MOODLE_32_STABLE'
 *
...
$string['check_noauth_details'] = '<p>Метод <em>Не использовать аутентификацию</em> не предназначен для сайтов в промышленной эксплуатации. Пожалуйста, отключите его, если это не сайт для разработки и тестирования.</p>';
$string['check_noauth_error'] = 'Метод <em>Не использовать аутентификацию</em> не может использоваться на сайтах в промышленной эксплуатации.';
