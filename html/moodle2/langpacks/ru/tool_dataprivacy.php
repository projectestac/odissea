...
$string['explanationtitle'] = 'Иконки, используемые на этой странице и что они значат.';
$string['external'] = 'Дополнительный';
$string['externalexplanation'] = 'На этом сайте установлен дополнительный плагин.';
...
$string['httpwarning'] = 'Любые данные, загруженные с этого сайта, не могут быть зашифрованы. Обратитесь к системному администратору и попросите установить SSL на этом сайте.';
...
$string['noexpiredcontexts'] = 'Этот уровень контекста не имеет данных, для которых истек срок хранения.';
...
$string['pluginregistrytitle'] = 'Реестр соответствия конфиденциальности плагинов';
...
$string['requiresattentionexplanation'] = 'Этот плагин не осуществляет API конфиденциальности Moodle. Если этот плагин хранит какие-либо личные данные, он не может быть экспортирован или удален из-за системы конфиденциальности Moodle.';
...
$string['userlistexplanation'] = 'Этот плагин имеет основного провайдера, но также должен иметь список пользователей провайдера для полной поддержки функций конфиденциальности.';
$string['userlistnoncompliant'] = 'Отсутствует список пользователей провайдера';
