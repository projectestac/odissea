...
/**
 * Strings for component 'book', language 'ru', branch 'MOODLE_26_STABLE'
 *
 * @package   book
...
$string['event_chapter_created'] = 'Глава создана';
$string['event_chapter_deleted'] = 'Глава удалена';
$string['event_chapter_updated'] = 'Глава обновлена';
