...
$string['allowaccountssameemail_desc'] = 'При включенном параметре несколько учетных записей пользователей может иметь одинаковый адрес электронной почты. Это может привести к проблемам безопасности и сохранения конфиденциальности, например, с письмом подтверждения изменения пароля.';
...
$string['auth_fieldlockfield'] = 'Значение блокировки ({$a})';
...
$string['auth_sync_suspended'] = 'При включенном параметре атрибут блокировки будет использован для обновления статуса блокировки локальной учетной записи пользователя.';
$string['auth_sync_suspended_key'] = 'Синхронизировать статус блокировки локальных пользователей';
...
$string['auth_updatelocalfield'] = 'Обновить внутренних ({$a})';
...
$string['auth_updateremotefield'] = 'Обновить внешних ({$a})';
