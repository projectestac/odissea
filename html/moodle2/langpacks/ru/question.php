...
/**
 * Strings for component 'question', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   question
...
$string['categorymove'] = 'В категории «{$a->name}» содержатся вопросы. Количество вопросов: {$a->count}. Среди них могут быть старые, скрытые вопросы, а также вопросы, которые используются в существующих тестах или в сохраненных попытках прохождения тестов.<br />Укажите другую категорию, в которую следует переместить эти вопросы.';
...
$string['specificfeedback'] = 'Отзыв для конкретного варианта ответа';
