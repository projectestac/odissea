...
$string['maximumfacility'] = 'Максимум легкости';
$string['median'] = 'Медиана оценок (для {$a})';
$string['medianfacility'] = 'Медиана легкости';
$string['minimumfacility'] = 'Минимум легкости';
...
$string['statistics:componentname'] = 'Отчет по тесту «Статистика»';
