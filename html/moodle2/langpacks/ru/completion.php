...
/**
 * Strings for component 'completion', language 'ru', branch 'MOODLE_34_STABLE'
 *
 * @package   completion
...
$string['completionexpecteddesc'] = 'Ожидается завершение {$a}';
$string['completionexpectedfor'] = '{$a->instancename} должно быть завершено';
...
$string['configcompletiondefault'] = 'Значение по умолчанию для отслеживания завершения при создании новых элементов курса.';
...
$string['defaultcompletion'] = 'Настройки по умолчанию для завершения элемента курса';
...
$string['enablecompletion_help'] = 'При включенном параметре условия завершения элемента курса могут быть заданы как в его настройках, так и в настройках условий завершения курса.
...
$string['eventdefaultcompletionupdated'] = 'Настройки по умолчанию для завершения элемента курса обновлены';
...
$string['updateactivities'] = 'Обновить статус завершения отмеченных элементов курса';
