...
/**
 * Strings for component 'completion', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   completion
...
$string['enablecompletion_help'] = 'При включенном параметре условия завершения активного элемента могут быть заданы как в его настройках, так и в настройках условий завершения курса.';
