...
/**
 * Strings for component 'label', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   label
...
$string['modulename_help'] = 'Пояснение позволяет на странице курса вставлять текст и мультимедиа между ссылками на другие ресурсы и элементы курса.. Пояснения очень универсальны и могут улучшить внешний вид курса при продуманном использовании.
