...
$string['eventtracksviewed'] = 'Просмотрено трэков';
...
$string['trackid'] = 'Id';
$string['trackid_help'] = 'Этот идентификатор, который задает ваш пакет SCORM для этого вопроса. Спецификация SCORM не позволяет передать полный текст вопроса.';
