...
$string['configgetfiletimeout'] = 'Тайм-аут в секундах для загрузки внешнего файла в Moodle.';
...
$string['confirmdelete'] = 'Вы уверены, что хотите удалить этот репозиторий - {$a}? Если Вы выберете «Продолжить и загрузить», то файлы по ссылкам на внешний источник будут загружены в Moodle, но этот процесс может занять много времени.';
...
$string['confirmremove'] = 'Вы уверены, что хотите удалить этот репозиторий, его опции и <strong>все его экземпляры</strong> - {$a}? Если Вы выберете «Продолжить и загрузить», то файлы по ссылкам на внешний источник будут загружены в Moodle, но этот процесс может занять много времени.';
