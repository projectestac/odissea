...
/**
 * Strings for component 'feedback', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   feedback
...
$string['cannotunmap'] = 'Проблема с базой данных, не удается отключиться.';
...
$string['url_for_continue'] = 'Ссылка на следующий активный элемент';
$string['url_for_continue_help'] = 'По умолчанию, после ответа на Обратную связь кнопка «Продолжить» переводит на страницу курса. Вы можете задать ссылку на следующий активный элемент, введя здесь URL-адрес этого элемента.';
