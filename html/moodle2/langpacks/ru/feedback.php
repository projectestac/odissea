...
$string['bold'] = 'Жирный';
$string['calendarend'] = 'Обратная связь закрывается {$a}';
$string['calendarstart'] = 'Обратная связь открывается {$a}';
...
$string['relateditemsdeleted'] = 'Все ответы пользователей на этот вопрос также будут удалены.';
