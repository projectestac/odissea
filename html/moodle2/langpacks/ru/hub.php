...
/**
 * Strings for component 'hub', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   hub
...
$string['registeredon'] = 'Каталоги, в которых зарегистрирован этот сайт';
$string['registeredsites'] = 'Зарегистрированные сайты';
$string['registermoochtips'] = 'Чтобы зарегистрироваться в каталоге Moodle.net, необходимо зарегистрировать сайт на Moodle.org';
