...
/**
 * Strings for component 'enrol_self', language 'ru', branch 'MOODLE_31_STABLE'
 *
 * @package   enrol_self
...
$string['keyholder'] = 'Вы должны получить этот ключ для записи от:';
...
$string['self:holdkey'] = 'Отображается как владелец ключа для самостоятельной записи';
