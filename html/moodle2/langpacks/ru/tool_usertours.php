...
Также может быть указан идентификатор строки языкового пакета в формате «идентификатор,компонент» (без кавычек и пробела после запятой).';
$string['tour1_content_addingblocks'] = 'Хорошенько подумайте перед добавлением любых блоков на страницы Вашего сайта. Блоки не отображаются в мобильно приложении Moodle, поэтому для удобства пользователей желательно убедиться, что с Вашим сайтом можно работать и без каких-либо блоков.';
