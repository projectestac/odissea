...
$string['aggregatesubcatsupgradedgrades'] = 'Обратите внимание: Настройка «Учитывать оценки из подкатегорий при расчете итоговой» была удалена в процессе обновления сайта. Поскольку «Учитывать оценки из подкатегорий при расчете итоговой» ранее использовалась в этом курсе, рекомендуется просмотреть это изменение в журнале оценок.';
