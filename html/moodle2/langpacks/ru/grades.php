...
/**
 * Strings for component 'grades', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   grades
...
$string['aggregateonlygraded'] = 'Учитывать только заполненнные оценки';
...
$string['aggregationcoefextra_help'] = 'Если итоговая оценка рассчитывается как «Естественный» или как «Простое среднее взвешенное оценок» и галочка «Дополнительный балл» включена, то максимальная оценка за оцениваемый элемент не добавляется к максимальной оценке за категорию, что позволяет получить максимальную оценку в категории, не получая максимальный балл за каждый из элементов этой категории. Если администратор сайта разрешил оценки больше максимальной, то можно получить оценку больше максимальной.

Если итоговая оценка рассчитывается как «Среднее оценок (с учетом доп. баллов)» и значение дополнительного балла больше нуля, то дополнительный балл выступает в качестве коэффициента, на которой умножается оценка перед добавлением ее к итогу после вычисления среднего.';
...
$string['gradebookcalculationswarning'] = 'Примечание: Было обнаружено несколько ошибок в вычислении оценок, показываемых в журнале оценок. Рекомендуется исправить ошибки, нажав на кнопку ниже, хотя это приведет к тому, что некоторые оценки изменятся. Подробности можно найти в  <a href="{$a->url}">Gradebook calculation changes</a>, где рассматриваются отличия между версиями {$a->gradebookversion} и {$a->currentversion}.';
...
$string['modgrade_help'] = 'Выберите тип оценивания, который будет использован для этого активного элемента. Если выбрана «шкала», то Вы можете выбрать нужную шкалу в выпадающем списке. При использовании оценивания в «баллах» Вы можете задать максимальную оценку, доступную для этого элемента.';
$string['modgrademaxgrade'] = 'Максимальный балл';
...
$string['removeallcoursegrades_help'] = 'При установленном флажке все элементы оценки, вручную добавленные в журнал оценок, будут удалены вместе с оценками и данными, относящимися к переопределенным, исключенным, скрытым и заблокированным оценкам. Останутся только оценки, связанные с активными элементами.';
$string['removeallcourseitems'] = 'Удалить все элементы и категории';
$string['removeallcourseitems_help'] = 'При установленном флажке все категории и элементы оценки, вручную добавленные в журнал оценок, будут удалены вместе с оценками и данными, относящимися к переопределенным, исключенным, скрытым и заблокированным оценкам. Останутся только оценки, связанные с активными элементами.';
$string['report'] = 'Отчет';
