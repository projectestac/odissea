...
/**
 * Strings for component 'auth_db', language 'ru', branch 'MOODLE_32_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbhost'] = 'Компьютер, на котором расположен сервер базы данных. Используйте название системного источника данных DSN при использовании ODBC.';
