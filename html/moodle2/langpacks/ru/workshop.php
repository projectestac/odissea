...
/**
 * Strings for component 'workshop', language 'ru', branch 'MOODLE_31_STABLE'
 *
 * @package   workshop
...
$string['allowedfiletypesforoverallfeedback_help'] = 'Разрешенные типы файлов, прикрепляемых к отзыву, можно ограничить, задав список расширений файлов через запятую, например, «mp4, mp3, png, jpg». Если поле оставлено пустым, то разрешены любые типы файлов.';
$string['allowedfiletypesforsubmission'] = 'Разрешенные типы файлов, прикрепляемых к ответу';
$string['allowedfiletypesforsubmission_help'] = 'Разрешенные типы файлов, прикрепляемых к ответу, можно ограничить, задав список расширений файлов через запятую, например, «mp4, mp3, png, jpg». Если поле оставлено пустым, то разрешены любые типы файлов.';
