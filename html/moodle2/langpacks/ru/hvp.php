...
/**
 * Strings for component 'hvp', language 'ru', branch 'MOODLE_34_STABLE'
 *
 * @package   hvp
...
$string['enabledownload'] = 'Кнопка «Скачать»';
...
$string['hvp:viewresults'] = 'Посмотреть результат контента H5P';
...
$string['modulename_help'] = 'Модуль деятельности H5P позволяет вам создавать интерактивный контент, такой как интерактивные видео, наборы вопросов, задания Drag and Drop, вопросы с множественным выбором ответа, презентации и многое другое.
...
$string['welcomecommunity'] = 'Мы надеемся, что вы будете наслаждаться H5P и участвовать в нашем растущем сообществе через наши <a {$a->forums}>форумы</a> и чаты <a {$a->gitter}>H5P на Gitter</a>';
