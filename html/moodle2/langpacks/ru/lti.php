...
/**
 * Strings for component 'lti', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   lti
...
$string['external_tool_types'] = 'Типы внешних инструментов';
...
$string['manage_tools'] = 'Управление типами внешних приложений';
...
$string['register_warning'] = 'Может понадобиться некоторое время, чтобы открыть страницу регистрации. Если она не открывается, убедитесь, что в параметрах конфигурации введен правильный URL-адрес.';
...
$string['toolproxy_help'] = 'Регистрации внешних инструментов позволяют администраторам сайта Moodle настроить внешние инструменты с доверенностью инструмента, полученным от поставщика инструмента, поддерживающего LTI 2.0.  URL-адрес регистрации предоставляется поставщиком инструмента и является всем необходимым, что требуется, чтобы начать процесс. Возможности и службы, предлагаемые поставщиком инструмента, выбираются при настройке новой регистрации.
Регистрации инструментов, перечисленные на этой странице, разделены на четыре категории:

* **Настроено** - Эти регистрации инструментов были созданы, но процесс регистрации еще не был начат.
...
* **Принято** - Эти регистрации инструментов были одобрены; ресурсы, указанные в доверенности инструмента, будут появляться на странице «Типы внешних инструментов» с начальным статусом «В ожидании».
