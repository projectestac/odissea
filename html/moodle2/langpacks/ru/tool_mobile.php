...
/**
 * Strings for component 'tool_mobile', language 'ru', branch 'MOODLE_36_STABLE'
 *
 * @package   tool_mobile
...
$string['forcedurlscheme'] = 'Если вы хотите, чтобы в окне браузера открывалось бы только ваше фирменное приложение, укажите здесь схему его URL; в ином случае оставьте поле пустым.';
...
$string['iosappid'] = 'Уникальный идентификатор приложения';
...
$string['pluginname'] = 'Инструменты Moodle Mobile';
