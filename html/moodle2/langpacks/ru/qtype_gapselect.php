...
/**
 * Strings for component 'qtype_gapselect', language 'ru', branch 'MOODLE_28_STABLE'
 *
...
$string['errormissingchoice'] = 'Пожалуйста, проверьте текст вопроса: {$a} не найден среди вариантов выбора! Только номера ответов, которые присутствуют в вариантах выбора, могут быть использованы как метки-заполнители.';
...
$string['pluginname_help'] = 'Напишите текст, например «[[1]] перепрыгивает через [[2]]», затем ниже введите возможные слова для меток 1 и 2.';
