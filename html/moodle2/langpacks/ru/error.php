...
$string['invaliddatarootpermissions'] = 'При попытке создать каталог обнаружены неправильные настройки прав доступа. Включите отладку для получения более подробной информации.';
...
$string['mssqlrcsmodemissing'] = 'База данных не использует режим READ_COMMITTED_SNAPSHOT, что может привести к неправильным результатам, особенно в ситуациях одновременной работы большого количества пользователей. Пожалуйста, включите его для правильного поведения. Более подробную информацию можно найти в документации <a href="https://docs.moodle.org/en/Installing_MSSQL_for_PHP">Installing MSSQL for PHP</a>.';
