...
/**
 * Strings for component 'backup', language 'ru', branch 'MOODLE_26_STABLE'
 *
 * @package   backup
...
$string['configgeneralbadges'] = 'Задайте значения по умолчанию для включения значков в резервную копию';
...
$string['configgeneralquestionbank'] = 'При включенном параметре банк вопросов по умолчанию будет включен в резервные копии. ОБРАТИТЕ ВНИМАНИЕ: выключение этого параметра отключит резервное копирование активных элементов,  использующих  банк вопросов (например, тесты).';
...
$string['errortgznozlib'] = 'Выбранный файл в новом формате резервной копии и не может быть восстановлен, так как расширение PHP zlib недоступно в этой системе.';
...
$string['generalbadges'] = 'Включить значки';
