...
/**
 * Strings for component 'availability', language 'ru', branch 'MOODLE_28_STABLE'
 *
...
$string['list_root_and'] = 'Не доступно, пока не выполнено:';
$string['list_root_and_hidden'] = 'Не доступно (скрыто), пока не выполнено:';
$string['list_root_or'] = 'Не доступно, пока не выполнено одно из:';
