...
class auth_plugin_odissea extends auth_plugin_base {
    ...
    function process_config($config) {
        ...
        $config->gicar_contexts = array_map(create_function('$x', 'return textlib::strtolower(trim($x));'),
                                      $config->gicar_contexts);
    ...
    function ldap_connect($host_url, $ldapversion, $binddn, $bindpwd) {
        ...
        if($ldapconnection = ldap_connect_moodle($host_url, $ldapversion,
...
//        }
    ...
    function ldap_find_userdn($ldapconnection, $extusername, $contexts, $user_attribute) {
        ...
        return ldap_find_userdn($ldapconnection, $extusername, $ldap_contexts, $this->config->objectclass,
                                $user_attribute, $this->config->search_sub);
    }
