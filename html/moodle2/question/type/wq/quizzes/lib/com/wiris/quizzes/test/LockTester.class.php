...
class com_wiris_quizzes_test_LockTester {
	...
	public function run() {
		$v = new com_wiris_quizzes_impl_FilePersistentVariables();
		...
		haxe_Log::trace("" . _hx_string_rec($n, ""), _hx_anonymous(array("fileName" => "LockTester.hx", "lineNumber" => 22, "className" => "com.wiris.quizzes.test.LockTester", "methodName" => "run")));
