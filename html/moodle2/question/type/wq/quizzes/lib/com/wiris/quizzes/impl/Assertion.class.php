...
com_wiris_quizzes_impl_Assertion::$CURRENCY_UNITS_LIST = "\$, " . com_wiris_quizzes_impl_Assertion_3() . ", " . com_wiris_quizzes_impl_Assertion_4() . ", " . com_wiris_quizzes_impl_Assertion_5() . ", kr, Fr, " . com_wiris_quizzes_impl_Assertion_6() . ", " . com_wiris_quizzes_impl_Assertion_7() . ", Ñ€ÑƒÐ±, BTC";
