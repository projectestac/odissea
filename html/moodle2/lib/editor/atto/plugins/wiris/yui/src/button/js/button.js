...
Y.namespace('M.atto_wiris').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        window._wrs_int_conf_file = 'integration/configurationjs.php';
    ...
    /**
     * Doubleclick in img.Wirisformula handler
     * */
    ...
    _updateEditorImgHandlers: function() {
        this.editor.all('img.Wirisformula').each(function(img){
            img.detachAll('dblclick');
            img.on('dblclick', this._handleFormulaDoubleClick, this);
        }, this);
    },
    /**
