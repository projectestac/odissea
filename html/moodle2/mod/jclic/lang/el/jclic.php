...
$string['modulename_help'] = 'Το <a href="https://clic.xtec.cat" target="_blank">JClic</a>  είναι ένα έργο του Υπουργείου Παιδείας της Καταλωνίας. Αποτελείται από εφαρμογές ανοιχτού λογισμού που επιτρέπουν τη δημιουργία αρκετών τύπων πολυμεσικών εκπαιδευτικών δραστηριοτήτων: παζλ, παιχνίδια αντιστοίχισης, δραστηριότητες κειμένου, σταυρόλεξα, αναζήτηση λέξεων και άλλα. Επιπροσθέτως, το <a href="https://clic.xtec.cat/db/listact_ca.jsp" target="_blank">ClicZone</a>  προσφέρει ένα αποθετήριο όπου θα βρείτε περισσότερες από χίλιες έτοιμες δραστηριότητες, οι οποίες δημιουργήθηκαν από εκπαιδευτικούς και άλλους επαγγελματίες της εκπαίδευσης, οι οποίοι επιθυμούν τον διαμοιρασμό της δουλειάς τους.
