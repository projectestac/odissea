...
$string['keepnavigationvisible_help'] = 'Keep page navigation visible on the same page';
$string['whatgrade_help'] = 'This preference sets the default attempts grading';
$string['pluginadministration'] = 'Remote Content administration';
$string['pluginname'] = 'Remote content';
$string['rcontent:update'] = 'Update';
$string['modulename'] = 'Remote content';
$string['modulename_help'] =  'Remote Content administration';
...
$string['chooseaction'] = 'Choose an status ...';
// ********** FI
...
$string['keepnavigationvisibleyes'] = 'Yes';
...
$string['nounits'] = 'No units to report';
...
$string['POR_CORREGIR'] = 'TO_CORRECT';
...
$string['viewreport'] = 'View reports';
$string['viewscores'] = 'View scores';
$string['vol'] = 'Vol';
...
$string['wsautenticationerror']='Authentication web services responsed with a error';
