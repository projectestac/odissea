...
$string['pluginname'] = 'Continguts remots';
$string['pluginadministration'] = 'Administració de continguts remots';
$string['keepnavigationvisible_help'] = 'Manté visible la navegació en la mateixa pàgina';
$string['whatgrade_help'] = 'Aquesta prefer&egrave;ncia fixa el valor per defecte sobre la calificació d\'intents';
$string['modulename'] = 'Continguts remots';
$string['modulename_help'] = 'Administració de continguts remots';
...
$string['chooseaction'] = 'Tria un estat...';
// ********** FI
$string['chooseafile'] = 'Tria o penja un fitxer';
$string['chooseparameter'] = 'Trieu un paràmetre';
$string['clicktoopen'] = 'Per obrir el document feu clic en aquest enllaç:';
$string['code'] = 'Codi';
$string['comments'] = 'Comentari';
$string['configallowlocalfiles'] = 'Quan creeu un nou recurs de tipus fitxer, són permesos els enllaços a fitxers d\'un sistema local com ara un CD-ROM o un disc dur? Això pot ser útil en una aula on tots els estudiants tenen accés a un CD-ROM o a dispositius en xarxa comuns. L\'utilització d\'aquesta característica pot requerir canvis en els paràmetres de seguretat dels navegadors.';
$string['configautofilerenamesettings'] = 'Actualitza automàticament les referències a fitxers i directoris quan se\'ls canviï el nom a l\'administrador de fitxers.';
$string['configblockdeletingfilesettings'] = 'Bloca la supressió de fitxers i directoris utilitzats als recursos. Tingueu en compte, però, que les imatges i altres fitxers utilitzats dins d\'una pàgina HTML no estaran protegits.';
...
$string['configfilterexternalpages'] = 'Si habiliteu aquest paràmetre, tots els recursos externs (pàgines web, fitxers HTML penjats) seran processats pels filtres definits en aquest lloc (p. e. s\'hi podran afegir enllaços automàtics a un glossari). Si activeu aquesta opció podeu alentir significativament les pàgines dels cursos; utilitzeu-la amb precaució i només si realment la necessiteu.';
...
$string['detailid']='Id detall';
$string['detailtypeid']='Id tipus detall';
...
$string['fetchclienterror'] = 'S\'ha produït un error quan s\'intentava recuperar la pàgina web (probablement l\'URL és erroni).';
$string['fetcherror'] = 'S\'ha produït un error quan s\'intentava recuperar la pàgina web.';
$string['fetchservererror'] = 'S\'ha produït un error quan s\'intentava recuperar la pàgina web (probablement un error de programa).</p>';
...
$string['frametypedesc'] = 'Aquesta prefer&egrave;ncia fixa el m&egrave;tode per defecte per mostrar el marc de l\'activitat';
...
$string['newwidth'] = 'Amplada de la finestra';
...
$string['note'] = 'Nota';
$string['notefile'] = 'Per penjar més fitxers al curs (de manera que apareguin en aquesta llista) feu servir el <a href=\"{$a}\">Gestor de fitxers</a>.';
...
$string['popupblocked'] = 'Si una nova finestra no apareix, {$a}';
$string['popupblockedlinkname'] = 'feu clic aqu&iacute; per iniciar l\'activitat';
//************ FI

//MARSUPIAL *********** AFEGIT -> Add new values POR_CORREGIR and CORREGIDO
//2011.05.17 @mmartinez
$string['POR_CORREGIR'] = 'PER_CORREGIR';
...
$string['rcontent:update'] = 'Actualitzar';
...
$string['registersperreportpage'] = 'Registres per p&agrave;gina';
$string['registersperreportpageinfo'] = 'Introdu&iuml;u el nombre de registres per p&agrave;gina per als informes';
//*********** FI
...
$string['resourcetypehtml'] = 'Crea una pàgina web';
...
$string['resourcetypetext'] = 'Crea una pàgina de text';
...
$string['viewreport'] = 'Consulta informes';
$string['viewscores'] = 'Consulta puntuacions';
...
$string['whatgradedesc'] = 'Aquesta prefer&egrave;ncia fixa el valor per defecte sobre la qualificació d\'intents';
$string['wsautenticationerror']='El servei web d\'autenticació ha respost amb un error';
