...
$string['roles'] = 'Rols a exportar';
$string['roles_help'] = 'Els usuaris amb els rols seleccionats s\'exportaran per a l\'anàlisi, si no se\'n selecciona cap, s\'exportaran tots els rols.';
$string['excludedusers'] = 'Usuaris a excloure';
$string['excludedusers_help'] = 'Llista d\'identificadors d\'usuari separats per comes que seran exclosos de l\'exportació per a l\'anàlisi.';
$string['periodicity'] = 'Periodicitat';
...
$string['delete_profile'] = 'Elimina el perfil {$a}';
$string['delete_profile_confirm'] = 'Esteu segurs que voleu esborrar el perfil?';
