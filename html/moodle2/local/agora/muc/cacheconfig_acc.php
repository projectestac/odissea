...
$configuration = array (
    ...
    'stores' => array (
        ...
        'agora_store_usu' => array (
            'name' => 'agora_store_usu',
            'plugin' => 'file',
            'configuration' =>
            array (
                'path' => '/dades/odissea/cache_ins/'.$CFG->dbuser,
                'autocreate' => true
            ),
            'features' => 6,
            'modes' => 3,
