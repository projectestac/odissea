...
- feat: Compatibility with Moodle 5.2.
- fix: Naming conventions.
- fix: Update plugin to match standard Moodle plugin requirements.
- fix: Prevent TinyMCE upload to modify formula renderization.
