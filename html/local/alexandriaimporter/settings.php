...
if ($hassiteconfig) {
    ...
    $checkedyesno = array('' => get_string('no'), '1' => get_string('yes'));
    $settings->add(new admin_setting_configselect('local_alexandriaimporter/show_description',
        get_string('showdescription', 'local_alexandriaimporter'), get_string('showdescriptiondesc', 'local_alexandriaimporter'),
        0, $checkedyesno));
}
