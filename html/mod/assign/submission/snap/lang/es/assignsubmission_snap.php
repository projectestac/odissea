...
$string['distros_help'] = 'Se necesita una distribución funcional (como  Snap!-Berkeley, la opción que viene por defecto).
    ...
    Hay que mantener el "código" al hacer cambios (url...) para mantener la correspondencia con las tareas anteriores.
    La primera "distro" es la opción por defecto, para las nuevas tareas y para las que tengan una ahora deshabilitada.';
$string['enabled'] = 'Snap!';
