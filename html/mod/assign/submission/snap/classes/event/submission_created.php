...
/**
 * The assignsubmission_snap submission_created event.
 *
...
/**
 * The assignsubmission_snap submission_created event class.
 *
 * @package   assignsubmission_snap
 * @copyright 2020 Sara Arjona <sara@moodle.com> and Joan Guillén <jguille2@xtec.cat>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_created extends \mod_assign\event\submission_created {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' created an Snap! submission " .
