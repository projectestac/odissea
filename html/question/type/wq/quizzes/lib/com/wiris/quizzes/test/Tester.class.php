...
class com_wiris_quizzes_test_Tester {
	...
	public function testCompatibility() {
		...
		haxe_Log::trace("Test compatibility OK!", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 2099, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "testCompatibility")));
	}
	...
	public function onServiceResponse($id, $res, $q, $qi) {
		try {
			...
			haxe_Log::trace("Test " . $id . " OK!", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 2002, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "onServiceResponse")));
			$this->endCall();
		}catch(Exception $�e) {
			$_ex_ = ($�e instanceof HException) ? $�e->e : $�e;
			$e = $_ex_;
			{
				haxe_Log::trace("Failed test " . $id . "!!!", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 2005, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "onServiceResponse")));
	...
	public function testCache() {
		...
		if($t2 >= $t1) {
			haxe_Log::trace("WARNING: Uncached question was faster than cached one! time miss: " . _hx_string_rec($t1, "") . "ms, time hit: " . _hx_string_rec($t2, "") . "ms.", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 1603, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "testCache")));
		}
	}
	...
	public function testPerformance() {
		...
		haxe_Log::trace($expanded, _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 1534, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "testPerformance")));
	}
	...
	public function testFloatEval() {
		...
		if($this->apiVersion === com_wiris_quizzes_test_Tester::$QUIZZES3) {
			...
			$q = $quizzes->newQuestion();
			$qi = $quizzes->newQuestionInstance($q);
			$q->setAlgorithm("<wiriscalc version=\"3.2\">\x0A" . "  <title>\x0A" . "    <math xmlns=\"http://www.w3.org/1998/Math/MathML\">\x0A" . "      <mtext>Untitled&#xa0;calc</mtext>\x0A" . "    </math>\x0A" . "  </title>\x0A" . "  <properties>\x0A" . "    <property name=\"decimal_separator\">.</property>\x0A" . "    <property name=\"digit_group_separator\">\x0A" . "    </property>\x0A" . "    <property name=\"float_format\">mr</property>\x0A" . "    <property name=\"imaginary_unit\">i</property>\x0A" . "    <property name=\"implicit_times_operator\">false</property>\x0A" . "    <property name=\"item_separator\">,</property>\x0A" . "    <property name=\"lang\">en</property>\x0A" . "    <property name=\"precision\">4</property>\x0A" . "    <property name=\"quizzes_question_options\">true</property>\x0A" . "    <property name=\"save_settings_in_cookies\">false</property>\x0A" . "    <property name=\"times_operator\">·</property>\x0A" . "    <property name=\"use_degrees\">false</property>\x0A" . "  </properties>\x0A" . "  <session version=\"3.0\" lang=\"en\">\x0A" . "    <task>\x0A" . "      <title>\x0A" . "        <math xmlns=\"http://www.w3.org/1998/Math/MathML\">\x0A" . "          <mtext>Sheet 1</mtext>\x0A" . "        </math>\x0A" . "      </title>\x0A" . "      <group>\x0A" . "        <command>\x0A" . "          <input>\x0A" . "            <math xmlns=\"http://www.w3.org/1998/Math/MathML\">\x0A" . "              <mi mathvariant=\"normal\">a</mi>\x0A" . "              <mo>=</mo>\x0A" . "              <mn>1000000</mn>\x0A" . "              <mo>.</mo>\x0A" . "            </math>\x0A" . "          </input>\x0A" . "          <output>\x0A" . "            <math xmlns=\"http://www.w3.org/1998/Math/MathML\">\x0A" . "              <mrow>\x0A" . "                <mn>1000000</mn>\x0A" . "                <mo>.</mo>\x0A" . "              </mrow>\x0A" . "            </math>\x0A" . "          </output>\x0A" . "        </command>\x0A" . "        <command>\x0A" . "          <input>\x0A" . "            <math xmlns=\"http://www.w3.org/1998/Math/MathML\"/>\x0A" . "          </input>\x0A" . "        </command>\x0A" . "      </group>\x0A" . "    </task>\x0A" . "  </session>\x0A" . "  <constructions>\x0A" . "    <construction group=\"1\">{&quot;elements&quot;:[],&quot;constraints&quot;:[],&quot;displays&quot;:[],&quot;handwriting&quot;:[]}</construction>\x0A" . "  </constructions>\x0A" . "</wiriscalc>");
