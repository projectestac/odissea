...
class com_wiris_quizzes_test_Tester {
	...
	public function testEvaluateRandomVariables() {
		...
		$algorithm = "<wiriscalc version=\"3.2\">\x0A" . "  <title>\x0A" . "    <math xmlns=\"http://www.w3.org/1998/Math/MathML\">\x0A" . "      <mtext>Untitled calc</mtext>\x0A" . "    </math>\x0A" . "  </title>\x0A" . "  <session version=\"3.0\" lang=\"en\">\x0A" . "    <task>\x0A" . "      <title>\x0A" . "        <math xmlns=\"http://www.w3.org/1998/Math/MathML\">\x0A" . "          <mtext>Sheet 1</mtext>\x0A" . "        </math>\x0A" . "      </title>\x0A" . "      <group>\x0A" . "        <algorithm># Automatically generated by WirisQuizzes.\x0A" . "a = random(1, 5);\x0A" . "b = random(2, 5);\x0A" . "        </algorithm>\x0A" . "        <command>\x0A" . "          <input>\x0A" . "            <math xmlns=\"http://www.w3.org/1998/Math/MathML\"/>\x0A" . "          </input>\x0A" . "        </command>\x0A" . "      </group>\x0A" . "    </task>\x0A" . "  </session>\x0A" . "</wiriscalc>";
